---
title: Высокий уровень доступности и аварийное восстановление
...
- Убедитесь, что у вас есть подходящие разрешения для настройки WSFC в Active Directory. Если возникают проблемы, см. раздел [Пошаговое руководство по отказоустойчивому кластеру: настройка учетных записей в Active Directory](/previous-versions/windows/it-pro/windows-server-2008-R2-and-2008/cc731002(v=ws.10)).

Более подробные сведения о WSFC см. в статье [Отказоустойчивые кластеры](/previous-versions/windows/it-pro/windows-server-2008-R2-and-2008/cc732488(v=ws.10)).
...
## <a name="feedback-comments"></a>Комментарии отзыва
