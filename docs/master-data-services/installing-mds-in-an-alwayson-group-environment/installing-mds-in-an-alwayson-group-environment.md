...
8. На странице **Выбор реплик** откройте вкладку **Прослушиватель** и выполните указанные ниже действия. См. рис. 18.
   ...
   1\. Установите флажок **Создать прослушиватель группы доступности**, чтобы настроить прослушиватель группы доступности для подключения к базе данных MDS.

   2\. Введите **DNS-имя прослушивателя**, например MDSSQLServer.
