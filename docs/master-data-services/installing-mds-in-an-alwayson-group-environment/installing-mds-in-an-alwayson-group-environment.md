...
**Автоматический переход на другой ресурс**: если выбран автоматический переход на другой ресурс, то в случае сбоя первичной реплики для группы доступности автоматически выполняется переход на вторичную реплику. Этот параметр можно включить только для реплик с синхронной фиксацией.
