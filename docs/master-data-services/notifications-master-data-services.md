---
title: "Уведомления (службы Master Data Services) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  ...
  - "уведомления [Master Data Services], об уведомлениях"
  - "электронная почта [службы Master Data Services]"
  - "электронная почта [службы Master Data Services], об уведомлениях по электронной почте"
