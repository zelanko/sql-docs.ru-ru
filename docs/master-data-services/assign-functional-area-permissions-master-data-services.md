---
description: Назначение разрешений для функциональной области (службы Master Data Services)
title: Назначение разрешений для функциональной области
ms.custom: ''
ms.date: 03/01/2017
ms.prod: sql
ms.prod_service: mds
...
### <a name="to-assign-functional-area-permissions"></a>Назначение разрешений для функциональной области  
