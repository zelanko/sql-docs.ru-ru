---
title: "Имена входа, пользователи и роли базы данных (службы Master Data Services) | Microsoft Docs"
ms.custom: ""
ms.date: "03/04/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "безопасность [службы Master Data Services], роли базы данных"
  - "база данных [службы Master Data Services], пользователи"
  - "безопасность [службы Master Data Services], пользователи базы данных"
  - "база данных [службы Master Data Services], роли"
  - "база данных [службы Master Data Services], имена входа"
  - "безопасность [службы Master Data Services], имена входа базы данных"
