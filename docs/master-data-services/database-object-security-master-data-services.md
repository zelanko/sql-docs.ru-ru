---
title: "Защита объектов базы данных (службы Master Data Services) | Microsoft Docs"
ms.custom: ""
ms.date: "03/04/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "база данных [службы Master Data Services], безопасность объектов"
  - "безопасность [службы Master Data Services], объекты базы данных"
