---
title: "Пользователи и группы (службы Master Data Services) | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "пользователи [службы Master Data Services]"
  - "группы [службы Master Data Services]"
  - "пользователи [службы Master Data Services], о пользователях"
  - "группы [службы Master Data Services], о группах"
