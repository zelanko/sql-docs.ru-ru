 ...
 *Профиль database Mail* — это набор учетных записей Почты базы данных. *Учетная запись Database* Mail [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] содержит информацию, которая используется для отправки сообщений электронной почты на сервер SMTP. При создании профиля и учетной записи в [!INCLUDE[ssMDScfgmgr](../includes/ssmdscfgmgr-md.md)]учетная запись автоматически добавляется в профиль и ее информация используется при рассылке электронной почты.  
...
|Имя элемента управления|Описание|  
|------------------|-----------------|  
|**Адрес электронной почты**|Введите адрес электронной почты для этой учетной записи. Это адрес электронной почты, что электронная почта отправляется с, и он должен быть в формате *email_name*@*domain_name*. Пример адреса электронной почты: sales@contoso.com.|  
...
|**Для этого сервера требуется безопасное соединение (SSL)**|Шифрование связи с помощью Transport Layer Security (TLS), ранее известного как Безопасный слой розеток (SSL).|  
...
|Имя элемента управления|Описание|  
|------------------|-----------------|  
|**Проверка подлинности Windows с использованием учетных данных службы компонента Database Engine**|Укажите, что Почта базы данных должна использовать учетные данные учетной записи [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] [!INCLUDE[ssDEnoversion](../includes/ssdenoversion-md.md)] службы Windows для проверки подлинности на сервере SMTP.|  
|**Базовая аутентификация**|Укажите, что компонент Database Mail будет использовать отдельные имя пользователя и пароль для проверки подлинности на SMTP-сервере. Эта информация будет использоваться только для проверки подлинности на почтовом сервере, при этом учетная запись не обязана соответствовать пользователю [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] или пользователю компьютера, на котором выполняется [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)].|  
...
## <a name="see-also"></a>См. также:  
 [Страница конфигурации базы данных &#40;master Data Services Configuration Manager&#41;](../master-data-services/database-configuration-page-master-data-services-configuration-manager.md)   
