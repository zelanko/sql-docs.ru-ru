---
title: "Развертывание моделей (службы Master Data Services) | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "03/01/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "пакеты развертывания [Master Data Services], о пакетах развертывания"
  - "развертывание пакетов [службы Master Data Services]"
