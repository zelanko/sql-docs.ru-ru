---
title: "Способ определения разрешений (Master Data Services) | Документы Microsoft"
ms.custom: 
ms.date: 03/01/2017
...
## <a name="see-also"></a>См. также:  
 ...
 [Перекрывающиеся модели и разрешений элемента &#40; Службы Master Data Services &#41;](../master-data-services/overlapping-model-and-member-permissions-master-data-services.md)  
