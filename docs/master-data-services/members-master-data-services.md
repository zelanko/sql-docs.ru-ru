---
title: Элементы
description: В Master Data Services элементы — это физические основные данные, такие как велосипед дорожной 150 в сущности «продукт» или конкретный клиент в сущности «Клиент».
ms.custom: ''
ms.date: 03/17/2017
ms.prod: sql
ms.prod_service: mds
