---
title: "Промежуточная таблица консолидированных элементов (службы Master Data Services) | Microsoft Docs"
ms.custom: ""
ms.date: "04/01/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "база данных [службы Master Data Services], промежуточная таблица атрибутов"
...
---
# Промежуточная таблица консолидированных элементов (службы Master Data Services)
