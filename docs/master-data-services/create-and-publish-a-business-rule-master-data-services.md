...
description: Узнайте, как создать бизнес-правило в Master Data Services для обеспечения точности основных данных. После создания правила опубликуйте его, чтобы применить правило.
ms.custom: ''
ms.date: 03/01/2017
ms.prod: sql
ms.prod_service: mds
