...
## <a name="view-information"></a>Сведения о представлении  
 Для всех созданных представлений в сетке создается строка с 10 столбцами. В следующей таблице приводится описание этих столбцов.  
...
-   **On**: Дата и время создания представления.  
  
-   **Кем Обновлено**: имя пользователя, который последним обновил представление.  
  
-   **On**: Дата и время последнего обновления представления.  
