---
title: "Разрешения на элементы иерархии (службы Master Data Services) | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "элементы [Master Data Services], разрешения"
  - "разрешения [Master Data Services], элементы"
