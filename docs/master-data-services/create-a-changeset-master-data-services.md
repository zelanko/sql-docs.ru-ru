---
title: "Создание набора изменений (Master Data Services) | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "03/01/2017"
...
---
# Создание набора изменений (Master Data Services)
...
## Создание локального набора изменений  
...
## Создание набора изменений для утверждения  
