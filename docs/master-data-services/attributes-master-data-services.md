---
title: Атрибуты
description: Сведения об атрибутах, которые являются объектами в Master Data Services сущностях. Значения атрибутов описывают элементы сущности.
ms.custom: ''
ms.date: 03/15/2017
ms.prod: sql
ms.prod_service: mds
