---
title: "Разрешения коллекции (службы основных данных) | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "коллекции [Master Data Services], разрешения"
  - "разрешения [Master Data Services], коллекции"
...
---
# Разрешения коллекции (службы основных данных)
