---
title: "Функциональная область системного администрирования (диспетчер основных данных) | Microsoft Docs"
ms.custom: ""
ms.date: "04/01/2016"
...
---
# Функциональная область системного администрирования (диспетчер основных данных)
