---
title: "Удаление разрешений для объекта модели (службы Master Data Services) | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "удаление разрешений для объекта модели [службы Master Data Services]"
  - "разрешения [службы Master Data Services], удаление разрешений для объекта модели"
  - "модели [службы Master Data Services], удаление разрешений для объекта"
...
### Удаление разрешений объекта модели  
