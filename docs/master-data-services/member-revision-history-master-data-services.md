---
title: "Журнал изменений элемента (Master Data Services) | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "03/01/2017"
...
---
# Журнал изменений элемента (Master Data Services)
...
## Просмотр и управление журналом изменений по сущности  
...
## Просмотр и управление журналом изменений по элементу  
