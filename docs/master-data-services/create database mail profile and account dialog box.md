---
title: "Диалоговое окно &#171;Создание профиля электронной почты и учетной записи базы данных&#187; (диспетчер конфигурации служб Master Data Services) | Microsoft Docs"
ms.custom: ""
ms.date: "03/23/2017"
...
manager: "jhubbard"
---
# Диалоговое окно &#171;Создание профиля электронной почты и учетной записи базы данных&#187; (диспетчер конфигурации служб Master Data Services)
...
## Профиль и учетная запись компонента Database Mail  
...
## Исходящий (SMTP) почтовый сервер  
  
|Имя элемента управления|Description|  
|------------------|-----------------|  
|**Адрес электронной почты**|Введите адрес электронной почты для этой учетной записи. Это адрес электронной почты, с которого отправляются электронные письма, и он должен соответствовать формату *имя_электронной_почты*@*имя_домена*. Пример такого адреса электронной почты: sales@contoso.com.|  
...
|**Адрес электронной почты для ответных сообщений**|Необязательный параметр. Введите адрес электронной почты, который будет использоваться для ответов на электронные сообщения, отправляемые от имени этой учетной записи. Пример такого адреса электронной почты: admin@contoso.com.|  
