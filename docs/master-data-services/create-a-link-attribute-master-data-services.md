---
title: "Создание атрибута ссылки (службы Master Data Services) | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "03/15/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "атрибуты [службы Master Data Services], создание атрибутов ссылки"
  - "создание атрибутов ссылки [службы Master Data Services]"
...
---
# Создание атрибута ссылки (службы Master Data Services)
