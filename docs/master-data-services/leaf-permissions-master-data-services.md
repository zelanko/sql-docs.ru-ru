...
|**Создания**|Пользователь может создавать конечные элементы и назначать значения атрибутов во время создания.|  
|**Обновляют**|Пользователь может обновлять конечные элементы и атрибуты.|  
...
|**Создания**|Пользователь может назначать значения при создании элементов.|  
|**Обновляют**|Пользователь может обновлять атрибуты.|  
|**Удаление**|Не влияет|  
