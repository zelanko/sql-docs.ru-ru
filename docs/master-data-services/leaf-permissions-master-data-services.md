...
|**Создать**|Пользователь может создавать конечные элементы и назначать значения атрибутов во время создания.|  
...
|**Запрет**|Запрет любого доступа к конечным элементам.|  
...
|**Создать**|Пользователь может назначать значения при создании элементов.|  
|**Обновление**|Пользователь может обновлять атрибуты.|  
|**Удаление**|Не влияет.|  
|**Запрет**|Атрибут не отображается.<br /><br /> Примечание. Нельзя явно запретить доступ к атрибутам "Имя" и "Код".|  
