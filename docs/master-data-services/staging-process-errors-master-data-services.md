---
title: "Ошибки промежуточного процесса (службы Master Data Services) | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "промежуточный процесс [службы Master Data Services], сообщения об ошибках"
...
---
# Ошибки промежуточного процесса (службы Master Data Services)
...
|210041|«ROOT» не является допустимым элементом кода.|Значение **MemberCode** содержит слово «ROOT».|Конечный элемент<br /><br /> Объединены<br /><br /> Связь|  
