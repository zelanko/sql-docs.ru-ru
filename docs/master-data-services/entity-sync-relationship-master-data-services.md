...
description: Синхронизация сущностей — односторонняя, повторяемая синхронизация между версиями сущности, которая позволяет совместно использовать данные сущностей между моделями Master Data Services.
ms.custom: ''
ms.date: 03/01/2017
ms.prod: sql
ms.prod_service: mds
