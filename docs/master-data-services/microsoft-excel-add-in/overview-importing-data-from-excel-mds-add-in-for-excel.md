---
title: "Обзор импорта данных из Excel (надстройка MDS для Excel) | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "03/01/2017"
...
---
# Обзор импорта данных из Excel (надстройка MDS для Excel)
...
## Одновременная публикация несколькими пользователями  
...
## Проверка бизнес-правил и другие проверки  
...
|Слияние конфликтов, чтобы можно было опубликовать изменения.|[Слияние конфликтов (надстройка MDS для Excel)](../../master-data-services/microsoft-excel-add-in/merge-conflicts-mds-add-in-for-excel.md)|  
