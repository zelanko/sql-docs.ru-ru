---
description: Диалоговое окно «Фильтр» (надстройка MDS для Excel)
title: Диалоговое окно «Фильтр»
...
## <a name="see-also"></a>См. также:  
 [Фильтровать данные перед экспортом надстройка MDS для Excel &#40;&#41;](../../master-data-services/microsoft-excel-add-in/filter-data-before-exporting-mds-add-in-for-excel.md)   
