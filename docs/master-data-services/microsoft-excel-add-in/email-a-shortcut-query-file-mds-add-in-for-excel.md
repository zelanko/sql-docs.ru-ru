---
title: "Отправка файла ярлыка запроса по электронной почте (надстройка MDS для Excel) | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
---
# Отправка файла ярлыка запроса по электронной почте (надстройка MDS для Excel)
