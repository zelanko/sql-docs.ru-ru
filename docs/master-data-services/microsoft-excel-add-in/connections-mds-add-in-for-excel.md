---
title: "Соединения (настройка MDS для Excel) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
---
# Соединения (настройка MDS для Excel)
...
## Автоматическое соединение и загрузка часто используемых данных  
