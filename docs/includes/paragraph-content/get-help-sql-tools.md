...
---
## <a name="infotipmediainfo-tippng-get-help-for-sql-tools"></a>![info_tip](../media/info-tip.png) Получение справки по средствам SQL

- [Сообщение о проблеме Git в Azure Data Studio](https://github.com/Microsoft/azuredatastudio/issues)
- [Участие в разработке Azure Data Studio](https://github.com/Microsoft/azuredatastudio)
- [Форум клиентских средств SQL](https://social.msdn.microsoft.com/Forums/home?forum=sqltools)
...
- [Комментарии или предложения для SSMS и SSDT — UserVoice](https://aka.ms/sqlfeedback)
