...
- [Стек администратор баз данных Exchange (тег sql-server) — задать вопросы по SQL Server](https://dba.stackexchange.com/questions/tagged/sql-server)
    - [Стек переполнения (тег sql сервера) — также имеет некоторые ответы на вопросы о разработке SQL](http://stackoverflow.com/questions/tagged/sql-server) 
