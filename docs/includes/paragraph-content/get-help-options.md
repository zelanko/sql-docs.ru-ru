...
ms.locfileid: "68212338"
---
## <a name="info_tipmediainfo-tippng-get-help"></a>![info_tip](../media/info-tip.png) Справка
...
- [Transact-SQL — форум MSDN](https://social.msdn.microsoft.com/Forums/en-US/home?forum=transactsql)
...
- [DBA Stack Exchange (tag sql-server) — вопросы по SQL Server](https://dba.stackexchange.com/questions/tagged/sql-server)
- [Stack Overflow (tag sql-server) — ответы на некоторые вопросы по разработке на SQL](https://stackoverflow.com/questions/tagged/sql-server) 
