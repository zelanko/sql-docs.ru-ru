...
|[Определяемые пользователем табличные типы](/previous-versions/sql/sql-server-2008/bb522526(v=sql.100)) в электронной документации на SQL Server|Описывает использование определяемых пользователем табличных типов для объявления возвращающих табличное значение параметров.|  
