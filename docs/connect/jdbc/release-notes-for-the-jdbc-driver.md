...
| :---------------- | :------ |
| Скачайте последние обновления для драйвера JDBC версии 8.2. | &bull; &nbsp; [Центр загрузки Майкрософт](https://go.microsoft.com/fwlink/?linkid=2116870)<br/>&bull; &nbsp; [GitHub, 8.2.1](https://github.com/Microsoft/mssql-jdbc/releases/tag/v8.2.1)<br/>&bull; &nbsp; [Maven Central](https://search.maven.org/search?q=g:com.microsoft.sqlserver) |
| Полностью соответствует спецификации API JDBC версии 4.2. | JAR-файлам в пакете 8.2 имена присваиваются с учетом совместимости версий Java.<br/><br/>Например, файл mssql-jdbc-8.2.1.jre11.jar из пакета 8.2 должен использоваться с Java 11. |
...
Microsoft JDBC Driver версии 8.2.1 для SQL Server теперь совместим с пакетом Java Development Kit (JDK) версии 13.0 наряду с JDK версий 11.0 и 1.8.
...
| :--------- | :------ |
| Microsoft JDBC Driver версии 8.2.1 для SQL Server теперь поддерживает Always Encrypted с безопасными анклавами. Подробные сведения можно найти здесь: Always Encrypted с безопасными анклавами. |
...
| :---------- | :------ |
| Повышена производительность Microsoft JDBC Driver версии 8.2.1 для SQL Server при извлечении темпоральных типов данных из SQL Server. | Это изменение устраняет ненужные преобразования темпоральных типов данных, исключая использование java.util.Calendar, где это возможно. |
...
| :------------------- | :------ |
| Начиная с версии 8.2.1, драйвер Microsoft JDBC Driver для SQL Server использует библиотеку mssql-jdbc_auth-\<версия>-\<архитектура>.dll вместо sqljdbc_auth.dll при проверке подлинности посредством Azure Active Directory. | &nbsp; |
