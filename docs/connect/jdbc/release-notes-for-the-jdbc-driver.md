...
Microsoft 7.0 драйвера JDBC для SQL Server полностью соответствует спецификации API JDBC 4.2. JAR-файлы в пакете 7.0 присваиваются в соответствии с совместимость версий Java. Например mssql-jdbc-7.0.0.jre10.jar файл из пакета 7.0 можно использовать с помощью Java 10.
...
Microsoft 7.0 драйвера JDBC для SQL Server reintroduces ранее удаленных конструктор, для `SQLServerColumnEncryptionAzureKeyVaultProvider`, разрешенных проверки подлинности с помощью пользовательского метода, реализованных на `SQLServerKeyVaultAuthenticationCallback` для получения маркера доступа.
...
Microsoft 7.0 драйвера JDBC для SQL Server был обновлен его maven зависимостью от azure-activedirectory-library-for-java (ADAL4J) до версии 1.6.0. См. дополнительные сведения о [зависимостях](../../connect/jdbc/feature-dependencies-of-microsoft-jdbc-driver-for-sql-server.md).
...
>
> Был сделан еще одно улучшение для обновления версии зависимые библиотеки Azure Key Vault до 1.0.0, а новый JAR-файлы (версии 6.2.2) были выпущены на 19 октября 2017 г.
>
> Загрузите последние обновления в JDBC Driver 6.2 на [центра загрузки Майкрософт](https://go.microsoft.com/fwlink/?linkid=852460), [GitHub](https://github.com/Microsoft/mssql-jdbc/releases/tag/v6.2.2), и [центрального репозитория Maven](http://search.maven.org/#search%7Cgav%7C1%7Cg%3A%22com.microsoft.sqlserver%22%20AND%20a%3A%22mssql-jdbc%22). Обновите ваши проекты для использования 6.2.2 выпуска JAR-файлы. См. заметки о выпуске [v6.2.1](https://github.com/Microsoft/mssql-jdbc/releases/tag/v6.2.1) и [v6.2.2](https://github.com/Microsoft/mssql-jdbc/releases/tag/v6.2.2) для получения дополнительных сведений.
