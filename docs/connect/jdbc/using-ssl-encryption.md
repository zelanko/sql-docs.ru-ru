...
ms.locfileid: "38023952"
---
# <a name="using-ssl-encryption"></a>Использование SSL-шифрования
[!INCLUDE[Driver_JDBC_Download](../../includes/driver_jdbc_download.md)]

  SSL-шифрование позволяет передавать по сети зашифрованные данные между экземпляром [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)] и клиентским приложением.  
...
|[Соединение с помощью SSL-шифрования](../../connect/jdbc/connecting-with-ssl-encryption.md)|Описание подключения к базе данных [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)] с использованием новых свойств соединения, относящихся к SSL.|  
