...
От выбора версии драйвера также зависит набор доступных функций. Для получения дополнительных сведений о том, какой JAR-файл выбрать, см. статью [Требования к системе для драйвера JDBC](../../connect/jdbc/system-requirements-for-the-jdbc-driver.md).  
...
Если используется JDBC Driver 6.4, настройте путь к классу, чтобы включить файл **mssql-jdbc-6.4.0.jre7.jar**, **mssql-jdbc-6.4.0.jre8.jar или **mssql-jdbc-6.4.0.jre9.jar**.
...
Дополнительные сведения о том, как подключиться к источникам данных и использовать URL-адрес подключения, см. в статьях [Формирование URL-адреса соединения](../../connect/jdbc/building-the-connection-url.md) и [Задание свойств соединения](../../connect/jdbc/setting-the-connection-properties.md).  
