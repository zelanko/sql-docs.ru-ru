...
> [!NOTE]  
> До выпуска 6.2.0 драйвера JDBC, правильное использование Cross сферы Kerberos, необходимо явно задать **serverSpn**.
>
> По состоянию на 6.2.0 выпуска, драйвер будут иметь возможность создавать **serverSpn** по умолчанию, даже при использовании Cross сферы Kerberos. Несмотря на то, что можно использовать **serverSpn** явно слишком. 
 ...
 **Выберите auth_scheme sys.dm_exec_connections где session_id =\@\@spid**  
