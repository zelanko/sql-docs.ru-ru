...
|Раздел|Description|  
|-----------|-----------------|  
|[Закрытие объектов не во время работы](../../connect/jdbc/closing-objects-when-not-in-use.md)|Описывается важность закрытия объектов драйвера JDBC, когда в них больше нет необходимости.|  
