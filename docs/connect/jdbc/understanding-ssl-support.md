---
title: Общие сведения о поддержке шифрования | Документация Майкрософт
ms.custom: ''
ms.date: 09/12/2019
ms.prod: sql
...
>
> Дополнительные сведения о настройке TLS для [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] см. в разделе [Enable encrypted connections to the ядро СУБД](../../database-engine/configure-windows/enable-encrypted-connections-to-the-database-engine.md).  
...
## <a name="validating-server-tls-certificate"></a>Проверка сертификата TLS сервера  
