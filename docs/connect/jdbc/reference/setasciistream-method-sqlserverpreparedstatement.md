...
|Имя|Описание|  
|----------|-----------------|  
|[Метод setAsciiStream(int, java.io.InputStream)](../../../connect/jdbc/reference/setasciistream-method-int-java-io-inputstream.md)|Задает указанный номер параметра в объект заданного java.io.InputStream.|  
