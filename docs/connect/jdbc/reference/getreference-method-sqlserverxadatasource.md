---
title: "Метод getReference (SQLServerXADataSource) | Документы Microsoft"
ms.custom: 
ms.date: 01/19/2017
...
ms.openlocfilehash: 898c37cb6286123ba30b16066346511ea8668734
ms.sourcegitcommit: 2713f8e7b504101f9298a0706bacd84bf2eaa174
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 11/18/2017
---
# <a name="getreference-method-sqlserverxadatasource"></a>Метод getReference (SQLServerXADataSource)
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]

  Возвращает ссылку на это [SQLServerXADataSource](../../../connect/jdbc/reference/sqlserverxadatasource-class.md) объекта.  
