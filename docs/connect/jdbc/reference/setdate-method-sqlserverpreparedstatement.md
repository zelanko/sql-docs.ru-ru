---
title: Метод (SQLServerPreparedStatement) setDate | Документы Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "32841049"
---
# <a name="setdate-method-sqlserverpreparedstatement"></a>setDate метод (SQLServerPreparedStatement)
