---
title: "Конструктор SQLServerResource () | Документы Microsoft"
ms.custom: 
ms.date: 01/19/2017
...
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]
  ...
  Инициализирует новый экземпляр [SQLServerResource](../../../connect/jdbc/reference/sqlserverresource-class.md) класса. Этот конструктор предназначен только для внутреннего использования.  
