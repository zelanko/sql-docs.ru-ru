...
## <a name="remarks"></a>Remarks  
 Этот метод storesLowerCaseQuotedIdentifiers задается методом storesLowerCaseQuotedIdentifiers в интерфейсе Java. SQL. DatabaseMetaData.  
