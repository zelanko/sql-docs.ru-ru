...
ms.locfileid: "66788970"
---
# <a name="sqlserverexception-members"></a>Элементы SQLServerException
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]

  В следующих таблицах перечислены элементы, доступ к которым предоставляется классом [SQLServerException](../../../connect/jdbc/reference/sqlserverexception-class.md).  
