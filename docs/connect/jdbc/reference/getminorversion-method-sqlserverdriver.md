---
title: Метод getMinorVersion (SQLServerDriver) | Документы Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
 ...
 **Int** , содержащий дополнительный номер версии драйвера JDBC.  
  
## <a name="remarks"></a>Замечания  
 Этот метод getMinorVersion указывается с помощью метода getMinorVersion в интерфейсе java.sql.Driver.  
