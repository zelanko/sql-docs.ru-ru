---
title: Метод Жетдефаулттрансактионисолатион (SQLServerDatabaseMetaData) | Документация Майкрософт
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="remarks"></a>Remarks  
 Этот метод Жетдефаулттрансактионисолатион задается методом Жетдефаулттрансактионисолатион в интерфейсе Java. SQL. DatabaseMetaData.  
