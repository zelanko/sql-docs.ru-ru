---
title: "Конструктор SQLServerException (java.lang.String, java.lang.Throwable) | Документы Microsoft"
ms.custom: 
ms.date: 01/19/2018
...
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]
  ...
  Инициализирует новый экземпляр [SQLServerException](../../../connect/jdbc/reference/sqlserverexception-class.md) класса для заданного **строка** объекта и **объект** объекта.
