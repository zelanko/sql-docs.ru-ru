...
## <a name="remarks"></a>Remarks  
 Этот метод supportsCatalogsInProcedureCalls задается методом supportsCatalogsInProcedureCalls в интерфейсе Java. SQL. DatabaseMetaData.  
