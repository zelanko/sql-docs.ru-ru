...
## <a name="remarks"></a>Remarks  
 Этот метод supportsSubqueriesInComparisons задается методом supportsSubqueriesInComparisons в интерфейсе Java. SQL. DatabaseMetaData.  
