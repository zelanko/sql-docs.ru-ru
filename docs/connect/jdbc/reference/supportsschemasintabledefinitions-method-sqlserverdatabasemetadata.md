...
## <a name="remarks"></a>Remarks  
 Этот метод supportsSchemasInTableDefinitions задается методом supportsSchemasInTableDefinitions в интерфейсе Java. SQL. DatabaseMetaData.  
