---
title: Метод (SQLServerConnection) createStatement | Документы Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "32828863"
---
# <a name="createstatement-method-sqlserverconnection"></a>createStatement метод (SQLServerConnection)
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]

  Создает [SQLServerStatement](../../../connect/jdbc/reference/sqlserverstatement-class.md) объект для отправки инструкций SQL в базу данных.  
