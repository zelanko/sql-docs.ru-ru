---
title: Метод Суппортсноннуллаблеколумнс (SQLServerDatabaseMetaData) | Документация Майкрософт
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="remarks"></a>Remarks  
 Этот метод Суппортсноннуллаблеколумнс задается методом Суппортсноннуллаблеколумнс в интерфейсе Java. SQL. DatabaseMetaData.  
