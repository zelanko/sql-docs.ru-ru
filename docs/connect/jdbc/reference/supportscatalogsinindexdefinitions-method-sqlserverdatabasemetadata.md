---
title: Метод Суппортскаталогсининдексдефинитионс | Документация Майкрософт
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="remarks"></a>Remarks  
 Этот метод Суппортскаталогсининдексдефинитионс задается методом Суппортскаталогсининдексдефинитионс в интерфейсе Java. SQL. DatabaseMetaData.  
