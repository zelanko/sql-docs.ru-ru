---
title: "Метод supportsAlterTableWithDropColumn | Документы Microsoft"
ms.custom: 
ms.date: 01/19/2017
...
## <a name="remarks"></a>Замечания  
 Этот метод supportsAlterTableWithDropColumn указывается с помощью метода supportsAlterTableWithDropColumn в интерфейсе java.sql.DatabaseMetaData.  
