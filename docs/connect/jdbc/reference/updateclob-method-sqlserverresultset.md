---
title: "Метод updateClob (SQLServerResultSet) | Документы Microsoft"
ms.custom: 
ms.date: 01/19/2017
...
|[updateClob метод &#40; int, java.io.Reader &#41;](../../../connect/jdbc/reference/updateclob-method-int-java-io-reader.md)|Обновляет указанный столбец заданным объектом Reader.|  
