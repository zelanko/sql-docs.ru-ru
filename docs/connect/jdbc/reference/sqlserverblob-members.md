...
|Название|Описание|  
|----------|-----------------|  
|[Бесплатно](../../../connect/jdbc/reference/free-method-sqlserverblob.md)|Этот метод освобождает большой двоичный объект и занятые им ресурсы.|  
