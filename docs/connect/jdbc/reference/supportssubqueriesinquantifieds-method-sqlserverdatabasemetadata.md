...
## <a name="remarks"></a>Remarks  
 Этот метод supportsSubqueriesInQuantifieds задается методом supportsSubqueriesInQuantifieds в интерфейсе Java. SQL. DatabaseMetaData.  
