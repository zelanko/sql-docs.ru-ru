...
## <a name="remarks"></a>Remarks  
 Этот метод supportsMixedCaseQuotedIdentifiers задается методом supportsMixedCaseQuotedIdentifiers в интерфейсе Java. SQL. DatabaseMetaData.  
