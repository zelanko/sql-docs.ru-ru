---
title: Метод Жетколумнтипе (SQLServerResultSetMetaData) | Документация Майкрософт
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="remarks"></a>Remarks  
 Этот метод Жетколумнтипе задается методом Жетколумнтипе в интерфейсе Java. SQL. ResultSetMetaData.  
