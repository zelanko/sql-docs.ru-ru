---
title: Метод Суппортсопенкурсорсакроссроллбакк | Документация Майкрософт
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="remarks"></a>Remarks  
 Этот метод Суппортсопенкурсорсакроссроллбакк задается методом Суппортсопенкурсорсакроссроллбакк в интерфейсе Java. SQL. DatabaseMetaData.  
