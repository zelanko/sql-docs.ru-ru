...
|[getTimestamp](../../../connect/jdbc/reference/gettimestamp-method-datetimeoffset.md)|Возвращает точку во времени, представленную данным объектом **DateTimeOffset**, в формате java.sql.Timestamp.|  
