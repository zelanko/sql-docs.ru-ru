---
title: Метод supportsSchemasInProcedureCalls | Документы Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="remarks"></a>Замечания  
 Этот метод supportsSchemasInProcedureCalls указывается с помощью метода supportsSchemasInProcedureCalls в интерфейсе java.sql.DatabaseMetaData.  
