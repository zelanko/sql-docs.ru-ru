...
## <a name="remarks"></a>Remarks  
 Этот метод supportsOpenCursorsAcrossCommit задается методом supportsOpenCursorsAcrossCommit в интерфейсе Java. SQL. DatabaseMetaData.  
