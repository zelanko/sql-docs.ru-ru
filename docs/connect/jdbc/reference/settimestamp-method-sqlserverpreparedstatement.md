---
title: "Метод (SQLServerPreparedStatement) setTimestamp | Документы Microsoft"
ms.custom: 
ms.date: 01/19/2017
...
---
# <a name="settimestamp-method-sqlserverpreparedstatement"></a>setTimestamp метод (SQLServerPreparedStatement)
