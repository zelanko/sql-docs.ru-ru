...
## <a name="remarks"></a>Remarks  
 Этот метод Супортсдатадефинитионанддатаманипулатионтрансактионс задается методом Супортсдатадефинитионанддатаманипулатионтрансактионс в интерфейсе Java. SQL. DatabaseMetaData.  
