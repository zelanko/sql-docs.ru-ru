---
title: Конструктор SQLServerDriver () | Документы Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "32847973"
---
# <a name="sqlserverdriver-constructor-"></a>Конструктор SQLServerDriver ()
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]

  Инициализирует новый экземпляр [SQLServerDriver](../../../connect/jdbc/reference/sqlserverdriver-class.md) класса.  
