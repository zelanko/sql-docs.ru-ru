---
title: Метод Суппортсфуллаутержоинс (SQLServerDatabaseMetaData) | Документация Майкрософт
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="remarks"></a>Remarks  
 Этот метод Суппортсфуллаутержоинс задается методом Суппортсфуллаутержоинс в интерфейсе Java. SQL. DatabaseMetaData.  
