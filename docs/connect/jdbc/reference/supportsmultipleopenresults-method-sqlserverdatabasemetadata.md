---
title: Метод Суппортсмултиплеопенресултс (SQLServerDatabaseMetaData) | Документация Майкрософт
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="remarks"></a>Remarks  
 Этот метод Суппортсмултиплеопенресултс задается методом Суппортсмултиплеопенресултс в интерфейсе Java. SQL. DatabaseMetaData.  
