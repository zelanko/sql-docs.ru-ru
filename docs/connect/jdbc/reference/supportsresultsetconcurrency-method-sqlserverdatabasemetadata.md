---
description: Метод supportsResultSetConcurrency (SQLServerDatabaseMetaData)
...
## <a name="concurrency-sqlserverresultset-types"></a>Типы параллелизма SQLServerResultSet  
