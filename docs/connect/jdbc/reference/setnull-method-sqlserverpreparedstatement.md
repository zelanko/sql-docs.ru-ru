---
title: Метод (SQLServerPreparedStatement) setNull | Документы Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "32844409"
---
# <a name="setnull-method-sqlserverpreparedstatement"></a>setNull метод (SQLServerPreparedStatement)
