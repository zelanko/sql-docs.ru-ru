---
title: Метод setTime (int, java.sql.Time) | Документы Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="remarks"></a>Замечания  
 Этот метод setTime определяется setTime-метод в интерфейсе java.sql.PreparedStatement.  
