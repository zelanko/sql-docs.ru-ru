...
7.2 драйвера Microsoft JDBC поддерживает JDBC 4.2 и 4.3 спецификации (частично) и включает в себя две библиотеки классов JAR в пакете установки следующим образом:

| JAR                        | Спецификации для JDBC            | Версия JDK |
| -------------------------- | ----------------------------- | ----------- |
| mssql-jdbc-7.2.1.jre11.jar | JDBC 4.3 (частично) и 4.2 | JDK 11.0    |
