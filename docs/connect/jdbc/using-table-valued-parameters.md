...
| Имя                                                                                                    | Описание                                                                                                                                                                                                                                                                                                |
| ------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| открытый окончательный void setStructured (int parameterIndex, строка tvpName, SQLServerDataTable tvpDataTable)    | Заполняет возвращающие табличное значение параметра с таблицей данных. parameterIndex является индексом параметра, tvpName — это имя табличное значение параметра и tvpDataTable является исходный объект таблицы данных.                                                                                                          |
