---
title: Использование escape-последовательностей SQL в JDBC
description: Согласно определению API JDBC, драйвер Microsoft JDBC Driver for SQL Server поддерживает использование escape-последовательностей SQL.
ms.custom: ''
ms.date: 08/12/2019
ms.prod: sql
