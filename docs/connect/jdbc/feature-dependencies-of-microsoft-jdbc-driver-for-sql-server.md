...
- `adal4j`— Azure библиотека Active Directory для Java для возможности проверки подлинности Azure Active Directory и компонент Azure Key Vault (необязательно)
