...
```  
 ...
 Чтобы использовать новый уровень изоляции моментального снимка [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)], можно использовать одну из констант SQLServerConnection следующим образом:  
