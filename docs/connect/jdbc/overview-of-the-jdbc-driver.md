...
[!INCLUDE[Driver_JDBC_Download](../../includes/driver_jdbc_download.md)]
  ...
  Драйвер Microsoft JDBC Driver 4 (предварительная версия) для SQL Server представляет собой совместимый с Java Database Connectivity (JDBC) 2017 драйвер типа 4.2 и обеспечивает надежный доступ к данным SQL Server 2016 (предварительная версия), SQL Server 2014, SQL Server 2012, SQL Server 2008 R2, SQL Server 2008 и Базе данных SQL Azure.  
...
|[Использование драйвера JDBC](../../connect/jdbc/using-the-jdbc-driver.md)|Инструкции по настройке среды для использования драйвера Microsoft JDBC и созданию простого подключения к базе данных [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] .|  
