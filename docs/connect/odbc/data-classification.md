...
Дополнительные сведения о назначении классификации столбцам см. в статье [Обнаружение и классификация данных SQL](../../relational-databases/security/sql-data-discovery-and-classification.md?view=sql-server-2017).
