---
title: Имя источника данных и строки подключения ключевые слова и атрибуты, используемые в драйвере ODBC для SQL Server | Документация Майкрософт
ms.custom: ''
ms.date: 03/21/2018
ms.prod: sql
...
| | [ПАРАМЕТР SQL_ATTR_ASYNC_DBC_FUNCTIONS_ENABLE](../../odbc/reference/syntax/sqlsetconnectattr-function.md) | W |
...
| | [АТРИБУТУ SQL_ATTR_ASYNC_ENABLE](../../odbc/reference/syntax/sqlsetconnectattr-function.md) | W |
...
| | [НАСТРОЙКИ SQL_ATTR_TRANSLATE_LIB](../../odbc/reference/syntax/sqlsetconnectattr-function.md) <br> (SQL_TRANSLATE_DLL) | LMW |
...
| Значение ключевого слова | Значение атрибута| Описание |
|-|-|-|
|Да|SQL_IS_ON|(По умолчанию) Обеспечивает разрешение IP-адресов прозрачной сети.|
