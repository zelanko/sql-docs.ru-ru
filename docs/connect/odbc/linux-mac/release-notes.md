...
ODBC Driver 13.1 для [! INCLUDEssNoVersion] добавляет поддержку постоянного шифрования и Azure Active Directory при использовании в сочетании с Microsoft SQL Server 2016. 
