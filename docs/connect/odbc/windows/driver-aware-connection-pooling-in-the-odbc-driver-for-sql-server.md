...
- При использовании Azure Active Directory и пулов соединений с учетом драйверов, драйвер также использует значение Authentication для определения членства в пуле соединений.
