...
Выбирает режим проверки подлинности из следующего вида:
- **SQL Server** с именем для входа и пароль
- **Встроенная Windows** проверки подлинности, используя учетную запись пользователя вошедшего в систему
- **Пароль Active Directory** с именем для входа и пароль
- **Интегрированные службы Active Directory** проверки подлинности, используя учетную запись пользователя вошедшего в систему
- **Интерактивная проверка подлинности Active Directory** с использованием имени пользователя

См. в разделе [2 экран мастера источника данных](../../../connect/odbc/windows/dsn-wizard-2.md) Дополнительные сведения о режимах проверки подлинности.
...
Указывает идентификатор входа SQL Server или Azure Active Directory для использования для подключения, если **режим проверки подлинности** присваивается **SQL Server** или **пароль Active Directory** или **Active Directory интерактивных**. В противном случае **идентификатор входа** отключенного поля.

### <a name="password"></a>Пароль

Указывает пароль для идентификатора входа SQL Server или Azure Active Directory, используемый для соединения, если **режим проверки подлинности** присваивается **SQL Server** или **парольActiveDirectory**. В противном случае **пароль** отключенного поля.
