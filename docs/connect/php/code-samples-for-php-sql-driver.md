...
ms.locfileid: "47694970"
---
# <a name="code-samples-for-the-microsoft-drivers-for-php-for-sql-server"></a>Примеры кода для драйверов Майкрософт для PHP для SQL Server
[!INCLUDE[Driver_PHP_Download](../../includes/driver_php_download.md)]


* [Пример приложения (драйвер SQLSRV)](../../connect/php/example-application-sqlsrv-driver.md)  
* [Пример приложения &#40;драйвера PDO_SQLSRV&#41;](../../connect/php/example-application-pdo-sqlsrv-driver.md)  
