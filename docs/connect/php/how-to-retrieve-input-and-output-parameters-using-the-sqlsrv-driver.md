---
title: Руководство. Извлечение параметров ввода-вывода с помощью драйвера SQLSRV | Документация Майкрософт
ms.custom: ''
ms.date: 04/12/2018
ms.prod: sql
ms.reviewer: ''
...
---
# <a name="how-to-retrieve-input-and-output-parameters-using-the-sqlsrv-driver"></a>Руководство. извлечь параметры ввода и вывода с помощью драйвера SQLSRV
