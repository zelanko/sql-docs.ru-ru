---
title: "PHP Linux и Mac драйверы установки учебник | Документы Microsoft"
ms.date: 07/13/2017
...
---
# <a name="php-linux-and-mac-drivers-installation-tutorial"></a>PHP Linux и Mac драйверы установки учебника
Следующие инструкции предполагают чистую среду и показано, как установить PHP 7.x Microsoft ODBC driver, Apache и Microsoft PHP драйверы для Ubuntu 15.10, 16.04, RedHat 7, Debian 8 и Mac OS X.
## <a name="installing-the-drivers-on-ubuntu-1510-for-php-70"></a>Установка драйверов на Ubuntu 15.10 для PHP 7.0
Без пакета PHP 7.1 доступен для Ubuntu 15.10.
...
```
Чтобы протестировать установку, в разделе **тестирования установки** в конце этого документа.
 
## <a name="installing-the-drivers-on-ubuntu-1604-for-php-70"></a>Установка драйверов на Ubuntu 16.04 для PHP 7.0
### <a name="step-1-install-php"></a>Шаг 1. Установить PHP 
```
sudo su
apt-get update
...
Чтобы протестировать установку, в разделе **тестирования установки** в конце этого документа.
 
## <a name="installing-the-drivers-on-ubuntu-1604-for-php-71"></a>Установка драйверов на Ubuntu 16.04 для PHP 7.1
### <a name="step-1-install-php"></a>Шаг 1. Установить PHP 
```
sudo su
...
Чтобы протестировать установку, в разделе **тестирования установки** в конце этого документа.
 
## <a name="installing-the-drivers-on-red-hat-7-for-php-70-and-71"></a>Установка драйверов в Red Hat 7 для PHP 7.0 и 7.1
### <a name="step-1-install-php"></a>Шаг 1. Установить PHP 
Чтобы установить PHP 7.1, замените remi php70 remi php71 в следующих командах: 
```
sudo su
...
Чтобы протестировать установку, в разделе **тестирования установки** в конце этого документа.
 
## <a name="installing-the-drivers-on-debian-8-for-php-70"></a>Установка драйверов в Debian 8 для PHP 7.0
### <a name="step-1-install-php"></a>Шаг 1. Установить PHP 
```
sudo su
...
Чтобы протестировать установку, в разделе **тестирования установки** в конце этого документа.
 
## <a name="installing-the-drivers-on-debian-8-for-php-71"></a>Установка драйверов в Debian 8 для PHP 7.1
### <a name="step-1-install-php"></a>Шаг 1. Установить PHP 
```
sudo su
apt-get install curl apt-transport-https 
...
Чтобы протестировать установку, в разделе **тестирования установки** в конце этого документа.
 
## <a name="installing-the-drivers-on-macos-el-capitan-and-sierra"></a>Установка драйверов в MacOS El Capitan и Сьерра
### <a name="step-1-install-php"></a>Шаг 1. Установить PHP 
Чтобы установить PHP 7.1, замените php70 php71 в следующих командах:
```
...
Чтобы протестировать этот пример скрипта, создайте файл с именем testsql.php в/var/www/html и (/ usr/локальной/var/www/htdocs на MacOS) и скопируйте следующий скрипт, заменив сервера, базы данных, имя пользователя и пароль, соответствующим образом. 
```
<?php
...
?>
```
Укажите в браузере http://localhost/testsql.php (http://localhost:8080/testsql.php на MacOS). Теперь можно подключиться к базе данных SQL Server/Azure SQL.
