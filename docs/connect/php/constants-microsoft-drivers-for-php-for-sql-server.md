...
Константы, перечисленные на [веб-сайте PDO](http://go.microsoft.com/fwlink/?LinkID=187441) , допустимы в [!INCLUDE[ssDriverPHP](../../includes/ssdriverphp_md.md)].  
...
Следующая таблица содержит константы, которые используются для описания типов данных PHP. Дополнительные сведения о типах данных PHP см. в статье [Типы PHP](http://go.microsoft.com/fwlink/?LinkId=104881).  
