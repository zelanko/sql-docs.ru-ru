---
title: Как отправить данные в виде потока | Документация Майкрософт
ms.custom: ''
ms.date: 02/28/2019
ms.prod: sql
...
## <a name="example-sending-stream-data-using-sqlsrvsendstreamdata"></a>Пример. отправка потоковых данных с помощью sqlsrv_send_stream_data
