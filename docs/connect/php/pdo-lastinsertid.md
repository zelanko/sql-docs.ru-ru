...
Если имя последовательности, не указано, недавно добавленных и строка идентификатора для строки.
Если указано имя последовательности, недавно добавленных и строка идентификатора для последовательности.
Если вызов метода завершается ошибкой, возвращается пустая строка.
  
## <a name="remarks"></a>Remarks  
Поддержка PDO была добавлена в версии 2.0 [!INCLUDE[ssDriverPHP](../../includes/ssdriverphp_md.md)].  
Между устройством версии 2.0 и 4.3 необязательный параметр имеет имя таблицы и возвращает значение идентификатора строки, недавно добавленных на заданную таблицу.
Начиная с версии 5.0, необязательный параметр рассматривается как имя последовательности и возвращает значение последовательности, недавно добавленных для предоставленной последовательности имя.
Если предоставлено имя таблицы для версий после 4.3, `lastInsertId` возвращает пустую строку.
