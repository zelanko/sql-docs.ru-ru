---
title: 'PDO:: Ластинсертид | Документация Майкрософт'
ms.custom: ''
ms.date: 07/31/2018
ms.prod: sql
...
Если имя последовательности не указано, строка идентификатора для самой последней добавленной строки.
Если указано имя последовательности, то добавляется строка идентификатора для последней добавленной последовательности.
В случае сбоя вызова метода возвращается пустая строка.
  
## <a name="remarks"></a>Remarks  
Поддержка PDO была добавлена в версии 2.0 [!INCLUDE[ssDriverPHP](../../includes/ssdriverphp_md.md)].  
Между версиями 2,0 и 4,3 необязательным параметром является имя таблицы, а возвращаемое значение — это идентификатор строки, которая в последнее время добавлена в указанную таблицу.
Начиная с 5,0, необязательный параметр рассматривается как имя последовательности, а возвращаемое значение — это последовательность, которая была добавлена последними для указанного имени последовательности.
