...
description: Преобразования, выполняемые с сервера клиенту
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
