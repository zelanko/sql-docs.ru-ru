...
description: Сеансы в драйвер OLE DB для SQL Server
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
...
```  
 ...
 Подключение драйвер OLE DB для объектов сеанса SQL Server в экземпляр [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] могут возникнуть существенные издержки для приложений, которые постоянно создают и освобождают объекты сеанса. Издержки можно уменьшить путем управления драйвер OLE DB для SQL Server объекты сеанса эффективно. Драйвер OLE DB для приложений SQL Server, можно сохранить [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] подключения объекта сеанса активным, поддерживая ссылку по крайней мере один интерфейс объекта.  
