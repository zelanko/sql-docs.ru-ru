...
Загрузить последнюю версию драйвера OLE DB для SQL Server перейдите в центр загрузки Майкрософт.
...
>  Все необходимые настройки реестра для драйвера OLE DB для SQL Server, выполненных в процессе установки.  
 ...
 Драйвер OLE DB для SQL Server файлов заголовков и библиотек (msoledbsql.h и msoledbsql.lib) устанавливаются в следующий каталог:  
