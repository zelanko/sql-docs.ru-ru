---
title: Драйвер OLE DB для SQL Server (OLE DB) | Документы Microsoft
description: Драйвер OLE DB для SQL Server (OLE DB)
ms.custom: ''
ms.date: 03/26/2018
...
---
# <a name="ole-db-driver-for-sql-server-ole-db"></a>Драйвер OLE DB для SQL Server (OLE DB)
