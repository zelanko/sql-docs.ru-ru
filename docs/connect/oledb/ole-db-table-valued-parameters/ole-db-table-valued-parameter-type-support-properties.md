...
|-----------------|--------------------|  
|SSPROP_COL_COMPUTED|Чтение и запись в R/W<br /><br /> По умолчанию: VARIANT_FALSE<br /><br /> Тип: VT_BOOL<br /><br /> Описание: значение VARIANT_TRUE означает, что столбец является вычисляемым. VARIANT_FALSE означает, что столбец не является вычисляемым.|  
