...
description: Отправка данных BLOB на SQL Server с помощью интерфейсов IROWSETFASTLOAD и ISEQUENTIALSTREAM
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
