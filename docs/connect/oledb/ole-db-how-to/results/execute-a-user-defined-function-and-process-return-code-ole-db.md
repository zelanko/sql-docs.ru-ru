---
title: Выполнение определяемой пользователем функции и Обрабатывание кода возврата (OLE DB) | Документы Microsoft
description: Выполнение определяемой пользователем функции и обрабатывание кода возврата использует драйвер OLE DB для SQL Server
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
...
## <a name="see-also"></a>См. также  
 [Результаты инструкции по обработке &#40;OLE DB&#41;](../../../oledb/ole-db-how-to/results/processing-results-how-to-topics-ole-db.md)  
