...
description: Трассировка OLE DB драйвера для SQL Server и доступа к диагностическим сведениям в журнале расширенных событий
ms.custom: ''
ms.date: 06/12/2018
ms.prod: sql
...
## <a name="control-file"></a>Управляющий файл  
 Содержимое драйвера OLE DB для управляющего файла SQL Server (CTRL. GUID):  
...
## <a name="mof-file"></a>MOF-файл  
 Содержимое драйвера OLE DB для SQL Server MOF-файла:  
