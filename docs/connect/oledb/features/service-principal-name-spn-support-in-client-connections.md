...
description: Поддержка имени участника службы (SPN) в клиентских соединениях
ms.custom: ''
ms.date: 06/12/2018
ms.prod: sql
...
## <a name="ole-db-syntax-supporting-spns"></a>Имена участников-служб OLE DB синтаксис поддержки  
