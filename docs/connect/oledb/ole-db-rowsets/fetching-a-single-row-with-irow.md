...
description: Получение одной строки с помощью интерфейса IRow драйвера OLE DB для SQL Server
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
