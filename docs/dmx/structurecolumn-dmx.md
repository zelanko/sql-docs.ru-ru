...
### <a name="sample-query-1-returning-a-column-from-the-mining-structure"></a>Пример запроса 1: Получение столбец из структуры интеллектуального анализа данных  
