---
description: StructureColumn (расширения интеллектуального анализа данных)
...
## <a name="result-type"></a>Тип результата  
 Возвращаемый тип зависит от типа столбца, на который указывает ссылка в \<structure column name> параметре. Например, если указанный столбец структуры интеллектуального анализа данных содержит скалярное значение, то функция возвращает скалярное значение.  
