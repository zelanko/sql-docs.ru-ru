---
title: Типы данных (DMX) | Документы Microsoft
ms.custom: ''
ms.date: 03/02/2016
...
-   Дата  
 ...
 Дополнительные сведения о данных, типах, [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] поддерживает, см. [типы данных &#40; интеллектуального анализа данных &#41;](../analysis-services/data-mining/data-types-data-mining.md).  
