...
-   В третьем примере показано использование параметра EXTEND_MODEL_CASES для обновления модели интеллектуального анализа данных с новыми данными.  
 ...
 Дополнительные сведения о работе с моделями временных рядов, см. Учебник по интеллектуальному анализу данных, [занятии 2: построение сценария прогнозирования &#40;учебнике по интеллектуальному данных&#41; ](https://msdn.microsoft.com/library/9a988156-c900-4c22-97fa-f6b0c1aea9e2) и [времени серии прогноза расширений интеллектуального анализа данных Учебник](https://msdn.microsoft.com/library/38ea7c03-4754-4e71-896a-f68cc2c98ce2).  
