...
-   В третьем примере показано использование параметра EXTEND_MODEL_CASES для обновления модели интеллектуального анализа данных с новыми данными.  
 ...
 Дополнительные сведения о работе с моделями временных рядов см. в учебнике по интеллектуальному анализу данных, [Урок 2. Создание сценария прогнозирования &#40;учебнике по интеллектуальному анализу данных&#41;](/previous-versions/sql/sql-server-2016/ms169846(v=sql.130)) и [УЧЕБНИКа по DMX-прогнозам временных рядов](/previous-versions/sql/sql-server-2016/cc879270(v=sql.130)).  
...
|11/25/2008 0:00|68|  
 ...
 Количество: M200 по тихоокеанскому времени. EXTEND_MODEL_CASES:  
...
## <a name="see-also"></a>См. также  
 ...
 [Примеры запросов модели временных рядов](/analysis-services/data-mining/time-series-model-query-examples)   
