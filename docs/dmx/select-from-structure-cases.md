...
## <a name="examples"></a>Примеры  
 Следующие примеры основаны на структуре интеллектуального анализа данных, целевой рассылке, основанной на [!INCLUDE[ssAWDWsp](../includes/ssawdwsp-md.md)] базе данных и связанных моделях интеллектуального анализа данных. Дополнительные сведения см. в разделе [учебник по основам интеллектуального анализа данных](/previous-versions/sql/sql-server-2016/ms167167(v=sql.130)).  
