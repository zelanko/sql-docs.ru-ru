---
title: СОЗДАНИЕ МОДЕЛИ ИНТЕЛЛЕКТУАЛЬНОГО АНАЛИЗА ДАННЫХ (РАСШИРЕНИЯ ИНТЕЛЛЕКТУАЛЬНОГО АНАЛИЗА ДАННЫХ) | Документация Майкрософт
ms.date: 06/07/2018
ms.prod: sql
 ...
 **CREATE MINING MODEL** инструкция создает новую модель интеллектуального анализа данных, основанный на списка определений столбцов, алгоритма и списка параметров алгоритма.  
...
-   Указывает запрос на прогнозирование, указывающий алгоритму на необходимость прогнозирования данного столбца, **PREDICT** или **PREDICT_ONLY** предложение  
  
-   Связь со столбцом атрибутов (обязательна, только если он применяется), определяемая по **RELATED TO** предложение  
