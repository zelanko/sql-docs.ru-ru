...
> [!NOTE]  
>  Детализация поддерживается не всеми типами моделей интеллектуального анализа данных. Сведения о моделях, поддерживающих детализацию, см. в разделе [запросы детализации &#40;&#41;интеллектуального анализа данных ](https://docs.microsoft.com/analysis-services/data-mining/drillthrough-queries-data-mining).  
