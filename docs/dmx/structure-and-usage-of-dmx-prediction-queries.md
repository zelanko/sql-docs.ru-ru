...
-   **Из*** \< модели>* **прогнозируемое соединение**      
...
-   Функции, возвращающие столбец данных.  
 ...
 Элемент **из** * \< модели>* **прогнозирующего Join** определяет исходные данные, которые будут использоваться для создания прогноза. Для одноэлементного запроса — это последовательность значений, назначенных столбцам. Для пустого прогнозируемого соединения оставляется пустое значение.  
