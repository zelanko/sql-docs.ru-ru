...
|[УДАЛЕНИЕ МОДЕЛИ ИНТЕЛЛЕКТУАЛЬНОГО АНАЛИЗА ДАННЫХ &#40;DMX&#41;](../dmx/drop-mining-model-dmx.md)|Удаляет модель интеллектуального анализа данных из базы данных.|  
...
|[ЭКСПОРТ &#40;РАСШИРЕНИЙ ИНТЕЛЛЕКТУАЛЬНОГО АНАЛИЗА ДАННЫХ&#41;](../dmx/export-dmx.md)|Экспортирует модель или структуру интеллектуального анализа данных и ассоциируемые объекты в ABF-файл.|  
|[ИМПОРТ &#40;РАСШИРЕНИЙ ИНТЕЛЛЕКТУАЛЬНОГО АНАЛИЗА ДАННЫХ&#41;](../dmx/import-dmx.md)|Импортирует модель или структуру интеллектуального анализа данных и ассоциируемые объекты из ABF-файла.|  
