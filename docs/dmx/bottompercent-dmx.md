...
## <a name="remarks"></a>Примечания  
 Функция **BottomPercent** возвращает нижние строки в порядке возрастания ранга. Ранг основан на вычисленном значении \<ранжирующего выражения > аргументе для каждой строки, так что сумма \<ранжирующего выражения > значений не меньше заданного процента, указанного в \<процентах > параметр. **BottomPercent** возвращает наименьшее количество возможных элементов, при этом соблюдая указанное процентное значение.  
