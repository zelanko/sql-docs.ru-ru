...
## <a name="example-1-add-a-model-to-a-structure"></a>Пример 1. Добавление модели интеллектуального анализа данных к структуре  
...
## <a name="example-2-add-a-filtered-model-to-a-structure"></a>Пример 2. Добавление к структуре модели интеллектуального анализа данных с фильтрованием  
...
## <a name="example-3-add-a-filtered-model-to-a-structure-with-a-nested-table"></a>Пример 3. Добавление модели интеллектуального анализа данных с фильтрованием к структуре, содержащей вложенную таблицу  
