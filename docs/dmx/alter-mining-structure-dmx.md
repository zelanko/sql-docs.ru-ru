...
## <a name="example-3-add-a-filtered-model-to-a-structure-with-a-nested-table"></a>Пример 3. Добавление в структуру с вложенной таблицей, модели с фильтром  
