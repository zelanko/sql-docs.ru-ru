...
-   Используйте функцию [интеллектуального анализа данных &#40;&#41; кластера](../dmx/cluster-dmx.md) для возврата наиболее вероятного кластера.  
...
-   Используйте функцию [PredictHistogram &#40;DMX&#41; ](../dmx/predicthistogram-dmx.md) для возврата гистограммы вероятности входного варианта, существующего в каждом кластере модели.  
