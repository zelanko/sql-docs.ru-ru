...
## <a name="see-also"></a>См. также статью  
 [Справочник по &#40;функциям&#41; расширений интеллектуального анализа данных DMX](../dmx/data-mining-extensions-dmx-function-reference.md)   
 [Расширения &#40;интеллектуального анализа&#41; функций](../dmx/functions-dmx.md)   
