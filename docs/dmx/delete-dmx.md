...
|.|Результат|  
|---------------|------------|  
|УДАЛИТЬ из структуры структуры интеллектуального анализа данных* \<>*<br /><br /> or<br /><br /> Удаление из структуры структуры интеллектуального анализа данных* \<>*. СОДЕРЖАНИ|Выполняет ProcessClear в структуре интеллектуального анализа данных. Все содержимое структуры интеллектуального анализа данных и связанных с ней моделей интеллектуального анализа данных удаляется.|  
