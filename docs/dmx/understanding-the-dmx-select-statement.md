...
|Тип запроса|Description|  
|----------------|-----------------|  
|SELECT DISTINCT FROM  *\<модели >*|Возвращает все значения состояний модели интеллектуального анализа данных для заданного столбца.<br /><br /> Доменом данных для этого типа запроса является модель интеллектуального анализа данных.<br /><br /> [SELECT DISTINCT FROM &#60; модели &#62; &#40; расширений интеллектуального анализа данных &#41;](../dmx/select-distinct-from-model-dmx.md)<br /><br /> [Содержимого запросов &#40; интеллектуального анализа данных &#41;](../analysis-services/data-mining/content-queries-data-mining.md)|  
|SELECT FROM  *\<модели >*. СОДЕРЖИМОЕ|Возвращает содержимое, описывающее модель интеллектуального анализа данных.<br /><br /> Доменом данных для этого типа запроса является набор строк схемы содержимого.<br /><br /> [SELECT FROM &#60; модели &#62;. СОДЕРЖИМОЕ &#40; расширений интеллектуального анализа данных &#41;](../dmx/select-from-model-content-dmx.md)<br /><br /> [Содержимого запросов &#40; интеллектуального анализа данных &#41;](../analysis-services/data-mining/content-queries-data-mining.md)|  
...
|Тип запроса|Description|  
|----------------|-----------------|  
|SELECT INTO  *\<новой модели >*|Создает копию модели интеллектуального анализа данных.<br /><br /> Доменом для этого типа запроса является модель интеллектуального анализа данных.<br /><br /> [ИНСТРУКЦИЯ SELECT INTO &#40; РАСШИРЕНИЙ ИНТЕЛЛЕКТУАЛЬНОГО АНАЛИЗА ДАННЫХ &#41;](../dmx/select-into-dmx.md)|  
...
|Тип запроса|Description|  
|----------------|-----------------|  
|SELECT FROM  *\<модели >*. ВАРИАНТЫ|Возвращает варианты, использовавшиеся для обучения модели интеллектуального анализа данных.<br /><br /> Доменом для этого типа запроса является модель интеллектуального анализа данных.<br /><br /> [SELECT FROM &#60; модели &#62;. ВАРИАНТЫ &#40; расширений интеллектуального анализа данных &#41;](../dmx/select-from-model-cases-dmx.md)<br /><br /> [Создание запросов детализации с помощью расширений интеллектуального анализа данных](../analysis-services/data-mining/create-drillthrough-queries-using-dmx.md)|  
...
|SELECT FROM  *\<структуры >*. ВАРИАНТЫ|Возвращает строки подробных данных из базовой структуры интеллектуального анализа данных, даже если при обучении модели интеллектуального анализа данных какие-то сведения не использовались.<br /><br /> [SELECT FROM &#60; структура &#62;. ВАРИАНТЫ](../dmx/select-from-structure-cases.md)<br /><br /> [Запросы детализации &#40; интеллектуального анализа данных &#41;](../analysis-services/data-mining/drillthrough-queries-data-mining.md)|  
