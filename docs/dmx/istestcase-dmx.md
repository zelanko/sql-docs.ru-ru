...
```  
 ...
 Дополнительные сведения о запросах вариантов, используемых в интеллектуальном анализе данных, см. в разделе [Выбор из &#60;модели&#62;. Примеры &#40;расширений&#41; интеллектуального анализа данных](../dmx/select-from-model-cases-dmx.md) и [Выбор &#60;из структуры&#62;. ВАРИАНТОВ](../dmx/select-from-structure-cases.md).  
