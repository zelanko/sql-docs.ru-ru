---
description: INSERT INTO (расширения интеллектуального анализа данных)
...
ms.locfileid: "91726165"
---
# <a name="insert-into-dmx"></a>INSERT INTO (расширения интеллектуального анализа данных)
[!INCLUDE[ssas](../includes/applies-to-version/ssas.md)]

  Служит для обработки заданного объекта интеллектуального анализа данных. Дополнительные сведения об обработке моделей интеллектуального анализа данных и структур интеллектуального анализа данных см. в разделе [требования к обработке и рекомендации &#40;&#41;интеллектуального анализа ](/analysis-services/data-mining/processing-requirements-and-considerations-data-mining).  
...
|ВСТАВИТЬ в модель интеллектуального анализа данных *\<model>* , содержащую исходный запрос<br /><br /> или<br /><br /> ВСТАВИТЬ в структуру интеллектуального анализа данных *\<structure>* , содержащую исходный запрос|Либо структура, либо модель уже включает содержимое.|Ошибка при выполнении процесса. Перед выполнением этой операции необходимо очистить объекты с помощью инструкции [DELETE &#40;расширений интеллектуального анализа данных&#41;](../dmx/delete-dmx.md).|  
