...
|ВСТАВИТЬ в модель интеллектуального анализа данных *\<model>* , содержащую исходный запрос<br /><br /> or<br /><br /> ВСТАВИТЬ в структуру интеллектуального анализа данных *\<structure>* , содержащую исходный запрос|Либо структура, либо модель уже включает содержимое.|Ошибка при выполнении процесса. Перед выполнением этой операции необходимо очистить объекты с помощью инструкции [DELETE &#40;расширений интеллектуального анализа данных&#41;](../dmx/delete-dmx.md).|  
