...
-   **/\* ... \*/ (косая черта звездочка пары символов).** Эти символы комментариев используются при написании комментария в одной строке с выполняемым кодом, для комментирования целой строки, а также для написания комментариев внутри выполняемого кода. [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] все, что расположено между символами open (/ *) к паре комментарий (\*/) как часть комментария. Для создания многострочных комментариев следует начать комментарий с помощью пары символов (/\*), а закончить его с помощью пары закрывающим (\*/). Строки написанного таким образом комментария не должны включать никаких других символов комментариев. Дополнительные сведения об этом символе комментария см. в разделе [косая черта-звездочка &#40;комментарий&#41; &#40;расширений интеллектуального анализа данных&#41;](../dmx/slash-star-comment-dmx.md).  
