---
title: "Полнотекстовый поиск в XML-столбцах | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "XML-столбцы [полнотекстовый поиск]"
...
---
# Полнотекстовый поиск в XML-столбцах
...
## Пример. Комбинирование полнотекстового поиска с XML-запросами  
...
## Пример. Полнотекстовый поиск XML-значений с использованием выделения корней  
