---
title: "Продвижение часто используемых XML-значений с помощью вычисляемых столбцов | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "продвижение свойств [XML в SQL Server]"
  - "продвижение свойств [XML в SQL Server]"
...
---
# Продвижение часто используемых XML-значений с помощью вычисляемых столбцов
...
### Пример: создание пользовательской функции для формирования набора строк на основе экземпляра XML  
...
### Пример: поиск экземпляров XML, включающих авторов с одним и тем же именем  
...
### Пример: решение, основанное на использовании потоковой функции CLR, возвращающей табличное значение  
