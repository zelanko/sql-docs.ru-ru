...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)] Ниже приведены условия, при которых именованные столбцы наборов строк сопоставляются с учетом регистра с итоговым XML-документом:  
