---
title: "Просмотр хранимой коллекции схем XML | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "коллекции схем [SQL Server], просмотр"
  - "схемы XML [SQL Server], просмотр"
  - "CREATE XML SCHEMA COLLECTION, инструкция"
  - "xml_schema_namespace, функция"
  - "коллекции схем XML [SQL Server], просмотр"
  - "отображение коллекций XML-схем"
  - "просмотр коллекций XML-схем"
