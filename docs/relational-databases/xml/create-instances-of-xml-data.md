---
title: "Создание экземпляров XML-данных | Microsoft Docs"
ms.custom: ""
ms.date: "03/16/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "строчные экземпляры приведения типа [XML в SQL Server]"
  - "XML [SQL Server], типизированный"
  - "тип данных XML [SQL Server], создание экземпляров"
  - "приведение строчных экземпляров [XML в SQL Server]"
  - "типизированный XML"
  - "формирование XML-экземпляров [SQL Server]"
  - "XML [SQL Server], создание экземпляров"
  - "пробел [XML в SQL Server]"
...
### Пример: приведение строкового значения к типизированному значению xml и присваивание его столбцу  
...
### Пример: преобразование строкового значения в типизированное значение xml и присваивание его переменной  
