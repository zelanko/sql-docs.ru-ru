---
title: "Создание встроенных схем XDR | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "XDR-схемы [SQL Server]"
  - "создание встроенных схем XDR [SQL Server]"
  - "XMLDATA, параметр"
  - "Предложение FOR XML, создание встроенных схем XDR"
