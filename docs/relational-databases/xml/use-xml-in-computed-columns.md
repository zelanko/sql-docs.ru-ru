---
title: "Использование XML в вычисляемых столбцах | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "вычисляемые столбцы, XML"
  - "XML [SQL Server], вычисляемые столбцы"
...
## Создание вычисляемых столбцов из XML-столбцов  
