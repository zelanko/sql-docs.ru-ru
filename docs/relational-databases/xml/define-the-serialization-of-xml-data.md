---
title: "Определение сериализации XML-данных | Microsoft Docs"
ms.custom: ""
ms.date: "03/06/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "правила преобразования в сущности [XML в SQL Server]"
  - "последовательное упорядочение"
  - "повторный синтаксический разбор сериализованных XML-структур"
  - "кодировка [XML в SQL Server]"
  - "XML [SQL Server], сериализация"
  - "тип данных XML [SQL Server], сериализация"
  - "типизированный XML"
