...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)] Можно запретить разрешение либо на создание коллекции схем XML, либо на использование уже существующей.  
