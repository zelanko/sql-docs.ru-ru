---
title: "XML-индексы (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  - "удаление индексов"
  - "удаление индексов"
  - "вторичные индексы [XML в SQL Server]"
  - "тип данных xml [SQL Server], индексы"
  - "удаление индексов"
  - "PATH, индекс"
  - "DROP_EXISTING, предложение"
  - "XML [SQL Server], индексы"
  - "первичные индексы [XML в SQL Server]"
  - "индексы [SQL Server], XML"
  - "XML-индексы [SQL Server], вторичные"
  - "большие двоичные объекты, XML-индексы"
  - "отключение индексов"
  - "XML-индексы [SQL Server], изменение"
  - "XML-индексы [SQL Server]"
  - "XML-индексы [SQL Server], первичные"
  - "изменение индексов"
  - "XML-индексы [SQL Server], удаление"
  - "VALUE, индекс"
  - "XML-индексы [SQL Server], тип данных xml"
  - "PROPERTY, индекс"
