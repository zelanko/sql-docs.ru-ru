---
title: "Коллекции XML-схем (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  ...
  - "коллекции схем XML [SQL Server], о коллекциях схем XML"
  - "метаданные [SQL Server], коллекции схем XML"
  - "запросы [XML в SQL Server], коллекции схем XML"
  - "коллекции схем [SQL Server]"
  - "схемы [SQL Server], XML"
  - "XML [SQL Server], коллекции схем"
  - "коллекции XML-схем [SQL Server]"
  - "коллекции схем [SQL Server], о коллекциях схем XML"
...
### Пример: перечисление пространств имен XML, входящих в коллекцию схем XML  
...
### Пример: вывод конкретной схемы из коллекции схем XML  
