---
title: "Определение метасвойств в инструкции OPENXML | Microsoft Docs"
ms.custom: ""
ms.date: "03/04/2017"
...
helpviewer_keywords: 
  ...
  - "метасвойства [XML в SQL Server]"
  - "невостребованные данные"
  - "извлечение сведений из узлов XML [SQL Server]"
  - "инструкция OPENXML, метасвойства"
...
|**@mp:prev**|Предыдущий элемент того же уровня. Благодаря этому можно получить сведения о порядке элементов документа.<br /><br /> Атрибут**@mp:prev** содержит идентификатор XML предыдущего соседнего элемента, который является потомком того же родителя. У первого элемента в списке соседних узлов атрибут **@mp:prev** равен значению NULL.|  
...
### A. Сопоставление столбцов набора строк OPENXML с метасвойствами  
...
### Б. Получение всего XML-документа  
