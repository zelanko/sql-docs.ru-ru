...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)] Этот пример иллюстрирует, как обращение к данным столбца переполнения осуществляется с помощью директивы **XMLTEXT** в инструкции `SELECT`, использующей режим EXPLICIT.  
