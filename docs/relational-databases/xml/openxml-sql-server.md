---
title: "Инструкция OPENXML (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  ...
  - "запись XML, инструкция OPENXML"
  - "инструкция OPENXML, запрос XML"
  - "атрибутивное сопоставление"
  - "инструкция SELECT [SQL Server], ключевое слово OPENXML"
  - "шаблоны столбцов [XML в SQL Server]"
  - "шаблоны строк [XML в SQL Server]"
  - "rowpattern [XML в SQL Server]"
  - "запросы [XML в SQL Server], инструкция OPENXML"
  - "XML [SQL Server], инструкция OPENXML"
