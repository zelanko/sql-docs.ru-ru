...
### <a name="how-to-create-a-selective-xml-index"></a>Как создать селективный XML-индекс  
...
### <a name="how-to-alter-a-selective-xml-index"></a>Как изменить селективный XML-индекс  
...
### <a name="how-to-drop-a-selective-xml-index"></a>Как удалить селективный XML-индекс  
