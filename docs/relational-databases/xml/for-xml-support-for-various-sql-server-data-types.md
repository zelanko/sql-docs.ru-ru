...
|Раздел|Описание|  
|-----------|-----------------|  
|[Поддержка FOR XML для XML-данных](../../relational-databases/xml/for-xml-support-for-the-xml-data-type.md)|Описывает работу предложения FOR XML с типом данных **xml** .|  
