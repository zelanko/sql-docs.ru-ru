...
> Начиная с [!INCLUDE[ssSQL15](../includes/sssql15-md.md)] с пакетом обновления 1 (SP1) секционированные таблицы и индексы также поддерживаются в выпуске [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] Standard Edition. 
