...
> -  ***[Предполагаемый план выполнения](../relational-databases/performance/display-the-estimated-execution-plan.md)***, то есть скомпилированный план.        
