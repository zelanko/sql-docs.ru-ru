---
title: "Развертывание приложения уровня данных | Microsoft Docs"
ms.custom: ""
ms.date: "01/31/2017"
...
helpviewer_keywords: 
  ...
  - "развертывание приложения уровня данных"
  - "приложение уровня данных [SQL Server], развертывание"
  - "инструкции [приложение уровня данных], развертывание"
  - "мастер [приложение уровня данных], развертывание"
 ...
 **Отмена** — завершение работы мастера без развертывания приложения уровня данных.  
 ...
 [&#91;Мастер развертывания&#93;](#UsingDeployDACWizard)  
...
##  <a name="Deploy"></a> Страница «Развертывание»  
