---
title: "Импорт файла BACPAC для создания новой пользовательской базы данных | Microsoft Docs"
ms.custom: ""
ms.date: "01/31/2017"
 ...
 **Для Базы данных SQL Azure:**  
 ...
 - Раздел **[Импорт файла BACPAC для создания новой базы данных SQL Azure](https://azure.microsoft.com/documentation/articles/sql-database-import/)** содержит пошаговые инструкции по использованию портала Azure, PowerShell, среды SSMS или SqlPackage.  
