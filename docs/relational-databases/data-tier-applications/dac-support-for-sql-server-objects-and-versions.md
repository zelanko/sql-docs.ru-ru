---
title: "Поддержка приложений уровня данных для объектов и версий SQL Server | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "приложение уровня данных [SQL Server], поддерживаемые объекты"
  - "объекты [SQL Server], приложения уровня данных"
