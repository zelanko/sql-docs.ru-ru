...
##  <a name="data-tier-application-support-by-the-versions-of-sql-server"></a><a name="SupportByVersion"></a> Поддержка приложений уровня данных в различных версиях SQL Server  
...
##  <a name="data-deployment-limitations"></a><a name="DeploymentLimitations"></a> Ограничения развертывания данных  
