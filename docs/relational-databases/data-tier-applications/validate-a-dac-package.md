---
title: "Проверка пакета приложения уровня данных | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "приложение уровня данных [SQL Server], проверка"
  - "приложение уровня данных [SQL Server], сравнение"
  - "проверка приложения уровня данных"
  - "сравнение приложений уровня данных"
  - "приложение уровня данных [SQL Server], просмотр"
  - "просмотр приложения уровня данных"
...
2.  **Обновление приложения уровня данных с использованием следующих средств:**  [просмотр содержимого приложения уровня данных](#ViewDACContents), [просмотр изменений базы данных](#ViewDBChanges), [просмотр действий по обновлению](#ViewUpgradeActions), [сравнение приложений уровня данных](#CompareDACs)  
...
##  <a name="CompareDACs"></a> Сравнение приложений уровня данных  
