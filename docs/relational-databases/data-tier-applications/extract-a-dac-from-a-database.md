---
title: "Извлечение приложения уровня данных из базы данных | Microsoft Docs"
ms.custom: ""
ms.date: "07/18/2016"
...
helpviewer_keywords: 
  ...
  - "инструкции [приложение уровня данных], извлечение"
  - "приложение уровня данных [SQL Server], извлечение"
  - "wizard [DAC], extract"
...
###  <a name="SetProperties"></a> Страница задания свойств  
...
###  <a name="ValidateSummary"></a> Страница проверки и сводки  
