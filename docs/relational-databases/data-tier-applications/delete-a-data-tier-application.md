---
title: "Удаление приложения уровня данных | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  - "инструкции [приложение уровня данных], удаление"
  - "приложение уровня данных [SQL Server], удаление"
  - "мастер [приложение уровня данных], удаление"
  - "удаление DAC"
