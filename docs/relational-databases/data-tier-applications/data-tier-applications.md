---
title: "Приложения уровня данных | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "08/12/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "проектирование выделенных административных соединений (DAC)"
  - "как [DAC]"
  - "приложение уровня данных [SQL Server], проектирование"
  - "мастер [DAC]"
...
|Описывает процесс размещения содержимого пакета приложения уровня данных в папке, где администратор базы данных может следить за действиями DAC перед развертыванием приложения на рабочем сервере.|[Распаковка пакета DAC](../../relational-databases/data-tier-applications/unpack-a-dac-package.md)|  
