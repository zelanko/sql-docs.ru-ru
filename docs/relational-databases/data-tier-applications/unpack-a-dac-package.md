---
title: "Распаковка пакета DAC | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "мастер [приложение уровня данных], распаковка"
  - "приложение уровня данных [SQL Server], распаковка"
  - "инструкции [приложение уровня данных], распаковка"
  - "распаковка DAC"
