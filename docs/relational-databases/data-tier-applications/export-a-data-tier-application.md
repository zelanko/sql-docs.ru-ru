---
title: "Экспорт приложения уровня данных | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "03/14/2017"
...
f1_keywords: 
  ...
  - "sql13.swb.exportdac.settings.f1"
helpviewer_keywords: 
  - "инструкции [приложение уровня данных], экспорт"
  - "мастер [приложение уровня данных], экспорт"
  - "экспорт приложения уровня данных"
  - "приложение уровня данных [SQL Server], экспорт"
