---
title: "Отключение сжатия таблицы или индекса | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "сжатие данных [SQL Server], отключение"
...
---
# Отключение сжатия таблицы или индекса
...
5.  На странице **Выбор типа сжатия** выберите **Отсутствует** в качестве типа сжатия, который будет применен к каждой секции индекса, для которого требуется отключить сжатие данных. После завершения нажмите кнопку **Далее**.  
