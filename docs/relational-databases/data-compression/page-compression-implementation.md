---
title: "Реализация сжатия страниц | Microsoft Docs"
ms.custom: ""
ms.date: "06/30/2016"
...
3.  Повторяющиеся префиксные значения в данном столбце заменяются ссылкой на соответствующий префикс. Если значение строки совпадает с выбранным префиксным значением не полностью, то частичные совпадения все еще могут быть отражены.  
 ...
 ![Страница до префиксного сжатия](../../relational-databases/data-compression/media/skt-tblcompression1c.gif "Страница до префиксного сжатия")  
 ...
 ![Страница после префиксного сжатия](../../relational-databases/data-compression/media/tblcompression2.gif "Страница после префиксного сжатия")  
...
## Сжатие словаря  
 ...
 ![Страница после словарного сжатия](../../relational-databases/data-compression/media/tblcompression3.gif "Страница после словарного сжатия")  
