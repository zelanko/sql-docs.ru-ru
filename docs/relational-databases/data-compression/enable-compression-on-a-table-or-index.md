---
title: "Включение сжатия таблицы или индекса | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  - "мастер сжатия данных"
  - "сжатие [SQL Server], включение"
...
#### Чтобы включить сжатие таблицы или индекса:  
