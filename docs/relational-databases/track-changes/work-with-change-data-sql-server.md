...
##  <a name="validating-lsn-boundaries"></a><a name="LSN"></a> Проверка границ номера LSN  
...
##  <a name="query-function-scenarios"></a><a name="Scenarios"></a> Сценарий функции запроса  
