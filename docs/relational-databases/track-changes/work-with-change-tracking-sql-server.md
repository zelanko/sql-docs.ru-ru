---
description: Работа с отслеживанием изменений (SQL Server)
...
##  <a name="how-change-tracking-handles-changes-to-a-database"></a><a name="Handles"></a> Как система отслеживания изменений обрабатывает изменения в базе данных  
...
##  <a name="change-tracking-and-data-restore"></a><a name="DataRestore"></a> Изменение отслеживания и восстановление данных  
