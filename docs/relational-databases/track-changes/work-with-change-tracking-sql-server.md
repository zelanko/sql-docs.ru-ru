---
title: "Работа с отслеживанием изменений (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "08/08/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "отслеживание изменений [SQL Server], внесение изменений"
  - "отслеживание изменений [SQL Server], устранение неполадок"
  - "обновление данных [SQL Server]"
  - "устранение неполадок [SQL Server], отслеживание изменений"
  - "изменения в данных [SQL Server]"
  - "отслеживание изменений в данных [SQL Server]"
  - "данные [SQL Server], изменение"
  - "отслеживание изменений [SQL Server], восстановление данных"
  - "отслеживание изменений [SQL Server], обеспечение согласованных результатов"
  - "отслеживание изменений [SQL Server], обработка изменений"
...
-   Функция CHANGETABLE(CHANGES …) поэтому возвращает сведения обо всех изменениях, произошедших после последней версии синхронизации.  
     ...
     ![Пример результатов запроса на отслеживание изменений](../../relational-databases/track-changes/media/queryoutput.gif "Пример результатов запроса на отслеживание изменений")  
