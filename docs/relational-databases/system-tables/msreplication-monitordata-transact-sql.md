...
|**agent_name**|**имеет sysname**|Имя задания агента репликации.|  
|**job_id**|**UNIQUEIDENTIFIER**|Идентификатор GUID задания агента репликации.|  
|**состояние**|**int**|Состояние агента репликации, может принимать одно из следующих значений:<br /><br /> **1** = запущено<br /><br /> **2** = успех<br /><br /> **3** = выполняется<br /><br /> **4** = бездействие<br /><br /> **5** = повторная попытка<br /><br /> **6** = сбой|  
...
|**distdb**|**имеет sysname**|Имя базы данных распространителя для данной подписки.|  
