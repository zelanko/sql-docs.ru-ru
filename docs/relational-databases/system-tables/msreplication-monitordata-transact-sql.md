...
|**Аргумент job_id**|**uniqueidentifier**|Идентификатор GUID задания агента репликации.|  
...
|**isagentrunningnow**|**bit**|Флаг, указывающий, если задание агента выполняется, где значение **1** означает, что задание выполняется.|  
