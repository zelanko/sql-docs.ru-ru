...
Данные из системных таблиц можно просмотреть с помощью представлений системных каталогов. Чтобы обновить метаданные в системной базовой таблице, используйте соответствующий интерфейс TSQL (например, инструкции DDL). Системные таблицы нельзя обновлять вручную. При выполнении непосредственного обновления системных таблиц SQL Server сообщает о следующих сообщениях.
