...
|__$reason_code|**int**|Код разрешения конфликта. Принимается одно из следующих значений:<br /><br /> 0<br /><br /> 1<br /><br /> 2<br /><br /> <br /><br /> Дополнительные сведения см. в разделе **__ $ reason_text**.|  
|__$reason_text|**nvarchar (720)**|Разрешение конфликта. Принимается одно из следующих значений:<br /><br /> 1 = Разрешен<br /><br /> 2 = Не разрешен<br /><br /> 0 = Неизвестно|  
