...
|__$conflict_type|**int**|Тип конфликта, который может принимать одно из следующих значений:<br /><br /> 1: Обновление не удалось, поскольку Локальная строка была изменена другим обновлением либо была удалена и затем вновь вставляется.<br /><br /> 2: Не удалось выполнить обновление, поскольку Локальная строка уже удалена.<br /><br /> 3: Delete, не удалось, поскольку Локальная строка была изменена другим обновлением либо была удалена и затем вновь вставляется.<br /><br /> 4: Не удалось удалить, поскольку Локальная строка уже удалена.<br /><br /> 5: Вставка не удалась, поскольку Локальная строка уже была вставлена или вставлена, а затем обновлен.|  
