...
|**dest_table**|**имеет sysname**|Имя целевой таблицы.|  
...
|**name**|**имеет sysname**|Имя, ассоциированное со статьей, уникальное внутри публикации.|  
...
|**dest_owner**|**имеет sysname**|Владелец таблицы в целевой базе данных.|  
