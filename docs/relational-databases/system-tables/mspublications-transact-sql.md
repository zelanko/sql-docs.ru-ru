...
|**thirdparty_flag**|**bit**|Указывает, является [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] ли публикация базой данных:<br /><br /> **** = 0[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)].<br /><br /> **1** = источник данных, отличный [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]от.|  
