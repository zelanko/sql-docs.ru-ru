...
|**allow_subscription_copy**|**бит**|Указывает, допускается ли возможность копирования базы данных подписки.|  
