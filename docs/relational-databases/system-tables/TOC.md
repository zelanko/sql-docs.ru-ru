# [Обзор](system-tables-transact-sql.md)  
# [Таблицы расширенных событий — trace_xe_action_map](extended-events-tables-trace-xe-action-map.md)  
# [Таблицы расширенных событий — trace_xe_event_map](extended-events-tables-trace-xe-event-map.md)  
# [Таблицы приложений уровня данных — sysdac_history_internal](data-tier-application-tables-sysdac-history-internal.md)  
# [Таблицы приложений уровня данных — sysdac_instances_internal](data-tier-application-tables-sysdac-instances-internal.md)  
# [Сопоставление системных таблиц с системными представлениями](mapping-system-tables-to-system-views-transact-sql.md)  
# [Системные базовые таблицы](system-base-tables.md)  
# [Таблицы резервного копирования и восстановления](backup-and-restore-tables-transact-sql.md)  
...
# [Таблицы системы отслеживания измененных данных](change-data-capture-tables-transact-sql.md)  
...
# [Таблицы планов обслуживания базы данных](database-maintenance-plan-tables-transact-sql.md)  
...
# [Таблицы служб Integration Services](integration-services-tables-transact-sql.md)  
...
# [Таблицы доставки журналов](log-shipping-tables-transact-sql.md)  
...
# [Таблицы агента SQL Server](sql-server-agent-tables-transact-sql.md)  
...
# [Таблицы репликации](replication-tables-transact-sql.md)  
