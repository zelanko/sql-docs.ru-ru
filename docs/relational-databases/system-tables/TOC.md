...
# [Таблицы приложения уровня данных — sysdac_history_internal](data-tier-application-tables-sysdac-history-internal.md)  
# [Таблицы приложения уровня данных — sysdac_instances_internal](data-tier-application-tables-sysdac-instances-internal.md)  
...
# [Резервное копирование и восстановление таблиц](backup-and-restore-tables-transact-sql.md)  
...
# [Таблицы плана обслуживания базы данных](database-maintenance-plan-tables-transact-sql.md)  
