...
|**membership_eval_proc_name**|**имеет sysname**|Имя процедуры, выполняющей оценку текущих идентификаторов секций строк в **MSmerge_contents**.|  
...
|**expand_proc**|**имеет sysname**|Имя процедуры, переоценивающей идентификаторы секций для дочерних строк новой вставленной родительской строки и для родительских строк после изменения секций или удаления.|  
