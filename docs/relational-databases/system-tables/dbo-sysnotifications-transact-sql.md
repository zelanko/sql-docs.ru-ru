---
title: "dbo.sysnotifications (Transact-SQL) | Документы Microsoft"
ms.custom: 
ms.date: 03/04/2017
...
|**notification_method**|**tinyint**|Способ уведомления:<br /><br /> **1** = E-mail<br /><br /> **2** = пейджер<br /><br /> **4** = **netsend**<br /><br /> **7** = All|  
