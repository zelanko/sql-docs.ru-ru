...
|**use_web_sync**|**бит**|Указывает, может ли подписка быть синхронизирована через протокол HTTP или нет. Значение **1** означает, что эта функция включена.|  
