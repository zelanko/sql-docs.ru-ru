...
|**server_name**|**имеет sysname**|Имя сервера.|  
|**места**|**nvarchar(200)**|Расположение указанного целевого сервера.|  
...
|**состояние**|**int**|Состояние целевого сервера:<br /><br /> **1** = обычная<br /><br /> **2** = ожидается повторная синхронизация<br /><br /> **4** = предположительно вне сети|  
