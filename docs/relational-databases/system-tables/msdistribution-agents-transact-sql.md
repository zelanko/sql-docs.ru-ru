...
|**local_job**|**бит**|Указывает, существует ли задание агента SQL Server на локальном распространителе.|  
...
|**offload_enabled**|**бит**|Указывает, может ли агент быть активизирован удаленно.<br /><br /> **0** указывает, что агент не может быть активирован удаленно.<br /><br /> **1** указывает, что агент может быть активизирован удаленно и на удаленном компьютере, указанном в *offload_server* свойство.|  
...
|**reset_partial_snapshot_progress**|**бит**|Установлен, если частично загруженный моментальный снимок будет отменен, затем загружен с самого начала.|  
...
|**оптимизированные для памяти**|**бит**|1 указывает, что подписчик может использоваться для таблиц, оптимизированных для памяти.|  
