...
|**autogen**|**bit**|Показывает, что хранимые процедуры автоматически созданы.<br /><br /> **0** = false, созданы не автоматически.<br /><br /> **1** = true, автоматический.|  
...
|**identity_support**|**bit**|Определяет, включена ли автоматическая обработка диапазона идентификаторов при использовании очереди обновления.  **0** поддержки диапазона означает, что ни одна учетная запись.|  
