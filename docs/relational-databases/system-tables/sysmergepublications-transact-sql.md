...
|-----------------|---------------|-----------------|  
|**издателя**|**sysname**|Имя сервера по умолчанию.|  
...
|**compress_snapshot**|**bit**|Указывает, сжимается ли моментальный **alt_snapshot_folder** снимок, записанный в alt_snapshot_folder [!INCLUDE[msCoName](../../includes/msconame-md.md)] расположение, в формат CAB-файла. значение **0** указывает, что файл не сжат.|  
