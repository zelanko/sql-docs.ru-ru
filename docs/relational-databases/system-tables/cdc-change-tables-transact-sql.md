...
|**partition_switch**|**бит**|Указывает, может ли команда **переключения секций** **инструкции ALTER TABLE** выполняться для таблицы, для которой включена система отслеживания измененных данных. Значение 0 указывает на то, что переключение секций заблокировано. Несекционированные таблицы всегда возвращают значение 1.|  
