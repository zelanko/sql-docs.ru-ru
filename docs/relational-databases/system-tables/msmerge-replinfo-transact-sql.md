...
|**use_interactive_resolver**|**бит**|Показывает, используется ли интерактивный сопоставитель во время проверки согласованности.<br /><br /> **0** = не использует интерактивный арбитр конфликтов.<br /><br /> **1** = использование интерактивного сопоставителя.|  
