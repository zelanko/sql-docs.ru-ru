---
title: sysschemaarticles (Transact-SQL) | Документация Майкрософт
ms.custom: ''
ms.date: 06/10/2016
ms.prod: sql
...
|**pre_creation_cmd**|**tinyint**|Указывает операцию, которую должна выполнять система при обнаружении на подписчике объекта с тем же именем, которое содержится в моментальном снимке, применяемом для статьи:<br /><br /> **0** = nothing.<br /><br /> **1** = удалить целевую таблицу.<br /><br /> **2** = очистить целевую таблицу.<br /><br /> **3** = усечь целевую таблицу.|  
