---
title: "Получение сведений о представлении | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  - "представления [SQL Server], сведения о состоянии "
  - "метаданные [SQL Server], представления"
  - "зависимости [SQL Server], представления"
  - "отображение сведений о представлении"
  - "представления [SQL Server], метаданные"
  - "просмотр сведений о представлении"
  - "сведения о состоянии [SQL Server], представления"
