...
-   Инструкция SELECT в определении представления не должна содержать следующие элементы языка Transact-SQL:  
    ...
    |**float**\*, **text**, **ntext**, **image**, **XML**или **filestream** |Вложенный запрос|Предложение OVER, включающее статистические функции или агрегатные оконные функции.|  
