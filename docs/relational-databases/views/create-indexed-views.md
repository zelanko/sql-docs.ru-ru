---
title: "Создание индексированных представлений | Microsoft Docs"
ms.custom: ""
ms.date: "05/27/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "индексированные представления [SQL Server], создание"
  - "кластеризованные индексы, представления"
  - "CREATE INDEX, инструкция"
  - "large_value_types_out_of_row, параметр"
  - "индексированные представления [SQL Server]"
  - "представления [SQL Server], индексированные представления"
...
-   Инструкция SELECT в определении представления не должна содержать следующие элементы языка Transact-SQL:  
    ...
    |Столбцы **float**\*, **text**, **ntext**, **image**, **XML** или **filestream**|Вложенный запрос|Предложение OVER, включающее статистические функции или агрегатные оконные функции.|  
    ...
    |CHECKSUM_AGG|||  
     ...
     \** Индексированное представление может содержать столбцы типа **float**, но они не могут включаться в ключ кластеризованного индекса.  
