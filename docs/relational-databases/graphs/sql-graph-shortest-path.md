...
* **‘+’** : Повторите действия 1 или более раз. Завершить работу, как только найден кратчайший путь.
* **{1,n}** : Повторите действия 1 на "n" раз. Завершить работу, как только найден кратчайший.
