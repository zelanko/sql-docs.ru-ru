---
title: "Написание инструкций Transact-SQL, адаптированных к международному использованию | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "написание инструкций, адаптированных к международному использованию"
  - "вопросы международного использования Transact-SQL"
  - "вопросы международного использования [SQL Server], Transact-SQL"
  - "вопросы международного использования ядра СУБД [SQL Server], Transact-SQL"
  - "инструкции [SQL Server], международные"
  - "вопросы международного использования баз данных [SQL Server], Transact-SQL"
  - "даты [SQL Server], вопросы международного использования"
