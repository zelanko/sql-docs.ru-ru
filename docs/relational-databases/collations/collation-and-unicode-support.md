...
-   Представленное в [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] новое семейство параметров сортировки дополнительных символов (SC) может использоваться с типами данных **nchar**, **nvarchar** и **sql_variant**. Например: `Latin1_General_100_CI_AS_SC`или (при использовании параметров сортировки для японского языка) `Japanese_Bushu_Kakusu_100_CI_AS_SC`.    
  > [!NOTE]    
