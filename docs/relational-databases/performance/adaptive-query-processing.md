...
> [!NOTE]
> Функция обратной связи с временно предоставляемым буфером памяти в строковом режиме реализована в общедоступной предварительной версии.  
