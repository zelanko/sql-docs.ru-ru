...
На общем уровне [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] выполняет запрос следующим образом:
...
[Создание пользовательских функций (ядро СУБД)](../../relational-databases/user-defined-functions/create-user-defined-functions-database-engine.md#TVF)  
