---
title: Раздельное сохранение событий профиля статистики Showplan XML
description: Сведения о том, как сохранять события профиля статистики XML showplan, захваченные при трассировках, в файлы с помощью SQL Server Profiler. Открытие файлов в SQL Server Management Studio.
