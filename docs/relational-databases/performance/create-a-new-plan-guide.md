...
##  <a name="create-a-plan-guide-using-ssms"></a><a name="SSMSProcedure"></a> Создание структуры плана с использованием SSMS  
...
2.  Щелкните правой кнопкой мыши папку **Структуры планов** и выберите команду **Создать структуру плана...** . ![выбор_структуры_плана](../../relational-databases/performance/media/select-plan-guide.png)
...
##  <a name="create-a-plan-guide-using-t-sql"></a><a name="TsqlProcedure"></a> Создание структуры плана с использованием T-SQL  
