---
title: "Отображение предполагаемого плана выполнения | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  - "масштаб [SQL Server]"
  - "предполагаемый план выполнения [SQL Server]"
  - "отображение планов выполнения"
  - "просмотр планов выполнения"
  - "планы выполнения [SQL Server], отображение"
  - "настройка отображения плана выполнения [SQL Server]"
  - "изменение отображения плана выполнения"
  - "пользовательский масштаб [SQL Server]"
