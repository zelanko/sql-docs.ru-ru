...
description: Сведения о том, как сохранять события XML showplan, захваченные при трассировках, в отдельные файлы с помощью SQL Server Profiler. Открытие файлов в SQL Server Management Studio.
