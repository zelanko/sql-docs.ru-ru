...
Дополнительные сведения см. в разделе [Основные сведения об адаптивных соединениях](../../relational-databases/performance/joins.md#adaptive).
