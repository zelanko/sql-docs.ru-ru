...
Вы можете включить отложенную компиляцию табличных переменных в Базе данных SQL Azure. Для этого включите уровень совместимости 150 для той базы данных, к которой вы подключаетесь при выполнении нужного запроса.
