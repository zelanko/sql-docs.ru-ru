---
title: "Вопросы использования тестовых серверов | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "издержки [помощник по настройке ядра СУБД]"
  - "издержки при настройке [SQL Server]"
  - "уменьшение загрузки при настройке рабочего сервера"
  - "помощник по настройке ядра СУБД [SQL Server], тестовые серверы"
  - "xp_msver, хранимая процедура"
  - "тестовые серверы [помощник по настройке ядра СУБД]"
  - "рабочие серверы [SQL Server]"
  - "разгрузка издержек при настройке [SQL Server]"
