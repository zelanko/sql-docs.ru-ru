...
description: Сведения о том, как хранилище запросов позволяет отслеживать производительность скомпилированного машинного кода для рабочих нагрузок выполняющейся в памяти OLTP.
ms.custom: ''
ms.date: 03/29/2016
ms.prod: sql
