...
description: Сведения о том, как использовать сводки, рекомендации, отчеты и журналы настройки, создаваемые помощником по настройке ядра СУБД в процессе установки SQL Server.
