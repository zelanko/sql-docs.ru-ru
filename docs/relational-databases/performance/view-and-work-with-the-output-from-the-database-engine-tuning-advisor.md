---
title: "Просмотр и работа с выходными данными помощника по настройке ядра СУБД | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  - "просмотр журналов"
  - "рекомендации [помощник по настройке ядра СУБД]"
  - "сводка по настройке [SQL Server]"
  - "Помощник по настройке ядра СУБД [SQL Server], рекомендации"
  - "Помощник по настройке ядра СУБД [SQL Server], журналы"
  - "Помощник по настройке ядра СУБД [SQL Server], просмотр выходных данных"
  - "Помощник по настройке ядра СУБД [SQL Server], отчеты"
  - "Журналы [SQL Server], настройка"
  - "Отчеты [SQL Server], настройка"
  - "просмотр выходных данных по настройке"
...
> [!NOTE]  
>  Если в служебной программе командной строки **dta** с помощью аргумента **-ox** задана запись выходных данных в XML-файл, можно открыть и просмотреть выходной XML-файл, выбрав пункт **Открыть файл** в меню **Файл** в [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)]. Дополнительные сведения см. в разделе [Use SQL Server Management Studio](../../ssms/use-sql-server-management-studio.md). Сведения о программе командной строки **dta** см. в разделе [dta, программа](../../tools/dta/dta-utility.md).  
  
#### Просмотр рекомендаций по настройке с помощью GUI помощника по настройке ядра СУБД  
  
1.  Настройте базу данных, используя графический пользовательский интерфейс помощника по настройке компонента Database Engine или программу командной строки **dta**. Дополнительные сведения см. в разделе [Start and Use the Database Engine Tuning Advisor](../../relational-databases/performance/start-and-use-the-database-engine-tuning-advisor.md). Если нужно использовать существующий сеанс настройки, пропустите этот шаг и перейдите к шагу 2.  
...
#### Просмотр сводок и отчетов по настройке с помощью GUI помощника по настройке ядра СУБД  
...
#### Реализация вручную рекомендаций по настройке с помощью интерфейса GUI помощника по настройке ядра СУБД  
  
1.  Настройте базу данных с помощью графического пользовательского интерфейса помощника по настройке ядра СУБД или программы командной строки **dta** . Дополнительные сведения см. в разделе [Start and Use the Database Engine Tuning Advisor](../../relational-databases/performance/start-and-use-the-database-engine-tuning-advisor.md). Если нужно использовать существующий сеанс настройки, пропустите этот шаг и перейдите к шагу 2.  
...
#### Автоматическая реализация рекомендаций по настройке с помощью программы командной строки dta  
...
5.  Проверьте входной XML-файл, сохраненный на этапе 4, на соответствие XML-схеме помощника по настройке ядра СУБД. При установке [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]эта схема была размещена в следующем месте:  
    ...
    ```  
     ...
     XML-схема помощника по настройке компонента Database Engine также доступна в сети по адресу [http://schemas.microsoft.com/sqlserver/2004/07/dta](http://schemas.microsoft.com/sqlserver/2004/07/dta).  
...
##  <a name="ReviewEvaluateClone"></a> Просмотр, оценка и клонирование сеансов настройки  
 ...
 Перед началом просмотра сеанса настройки для экземпляра [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]необходимо создать сеансы настройки на экземпляре сервера, настроив рабочую нагрузку с использованием помощника по настройке ядра СУБД. Дополнительные сведения см. в разделе [Start and Use the Database Engine Tuning Advisor](../../relational-databases/performance/start-and-use-the-database-engine-tuning-advisor.md).  
  
### Просмотр существующих сеансов настройки  
...
1.  Запустите графический пользовательский интерфейс помощника по настройке ядра СУБД. Дополнительные сведения см. в разделе [Start and Use the Database Engine Tuning Advisor](../../relational-databases/performance/start-and-use-the-database-engine-tuning-advisor.md).  
...
### Оценка существующих сеансов настройки как гипотетических конфигураций  
...
### Клонирование существующих сеансов настройки  
...
##### Создание новых сеансов настройки посредством клонирования существующих сеансов  
...
### Меню действий/Применить рекомендованные параметры  
