---
title: "Указание механизма параметризации запросов с помощью структур плана | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  ...
  - "PARAMETERIZATION FORCED, параметр"
  - "PARAMETERIZATION, параметр"
  - "PARAMETERIZATION SIMPLE, параметр"
  - "параметризация [SQL Server]"
  - "переопределение механизма параметризации"
  - "структуры планов [SQL Server], параметризация"
  - "параметризованные запросы [SQL Server]"
