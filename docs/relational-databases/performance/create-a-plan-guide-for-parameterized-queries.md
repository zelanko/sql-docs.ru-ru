...
description: Сведения о создании структуры плана, которой сопоставляется любой запрос заданной параметризованной формы и которая принуждает SQL Server параметризовать такой запрос.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
