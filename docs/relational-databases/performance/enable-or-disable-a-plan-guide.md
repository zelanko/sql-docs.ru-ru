...
description: Сведения о том, как отключить и включить структуры плана с помощью SQL Server Management Studio или Transact-SQL. Отключение или включение одной или всех структур плана в базе данных.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
