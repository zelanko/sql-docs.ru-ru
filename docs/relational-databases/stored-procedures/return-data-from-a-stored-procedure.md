...
description: Узнайте, как вернуть данные из процедуры в вызывающую программу, используя результирующие наборы, параметры вывода и коды возврата.
ms.custom: ''
ms.date: 03/16/2017
ms.prod: sql
