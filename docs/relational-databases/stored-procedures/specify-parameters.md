...
description: Узнайте, как передавать значения параметрам и как каждый из атрибутов параметров используется во время вызова процедуры.
ms.custom: ''
ms.date: 03/16/2017
ms.prod: sql
