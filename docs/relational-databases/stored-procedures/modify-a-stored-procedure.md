---
title: "Изменение хранимой процедуры | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  ...
  - "изменение хранимых процедур"
  - "хранимые процедуры [SQL Server], изменение"
...
-   **Изменение процедуры с помощью:** [SQL Server Management Studio](#SSMSProcedure), [Transact-SQL](#TsqlProcedure)  
