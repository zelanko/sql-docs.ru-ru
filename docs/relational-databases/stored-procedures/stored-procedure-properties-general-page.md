...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)] Отображает сведения о хранимой процедуре. Все сведения предназначены только для чтения.  
