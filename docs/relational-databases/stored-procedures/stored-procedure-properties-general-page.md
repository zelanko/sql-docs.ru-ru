...
description: Узнайте, как использовать свойства хранимой процедуры (страница "Общие") для просмотра сведений о хранимой процедуре только для чтения.
ms.custom: ''
ms.date: 03/16/2017
ms.prod: sql
