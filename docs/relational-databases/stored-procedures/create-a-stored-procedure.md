...
description: Узнайте, как создать хранимую процедуру Transact-SQL с помощью SQL Server Management Studio и инструкции Transact-SQL CREATE PROCEDURE.
ms.custom: ''
ms.date: 03/16/2017
ms.prod: sql
ms.reviewer: ''
