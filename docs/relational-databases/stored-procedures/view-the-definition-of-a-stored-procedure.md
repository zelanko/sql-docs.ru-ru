---
title: "Просмотр определения хранимой процедуры | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "хранимые процедуры [SQL Server], просмотр"
...
-   **Просмотр определения процедуры с помощью:** [SQL Server Management Studio](#SSMSProcedure), [Transact-SQL](#TsqlProcedure)  
