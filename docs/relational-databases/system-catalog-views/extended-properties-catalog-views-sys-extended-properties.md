---
title: sys.extended_properties (Трансакт-СЗЛ) Документы Майкрософт
ms.custom: ''
ms.date: 03/15/2017
ms.prod: sql
...
ms.locfileid: "81388572"
---
# <a name="extended-properties-catalog-views---sysextended_properties"></a>Расширенные просмотры каталога свойств - sys.extended_properties
...
## <a name="see-also"></a>См. также:  
 ...
 [Расширенные просмотры каталога свойств &#40;&#41;«Трансакт-СЗЛ»](https://msdn.microsoft.com/library/f39fd324-efd4-4468-884c-bf77ed1a026f)   
 [sys.fn_listextendedproperty &#40;&#41;"Трансакт-СЗЛ"](../../relational-databases/system-functions/sys-fn-listextendedproperty-transact-sql.md)   
 [sp_addextendedproperty&#41;&#40;«Трансакт-СЗЛ»](../../relational-databases/system-stored-procedures/sp-addextendedproperty-transact-sql.md)   
 [sp_dropextendedproperty&#41;&#40;](../../relational-databases/system-stored-procedures/sp-dropextendedproperty-transact-sql.md)   
 [sp_updateextendedproperty &#40;&#41;«Трансакт-СЗЛ»](../../relational-databases/system-stored-procedures/sp-updateextendedproperty-transact-sql.md)  
