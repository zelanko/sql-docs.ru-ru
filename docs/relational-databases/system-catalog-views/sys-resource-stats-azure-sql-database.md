...
|sku|**nvarchar(128)**|Уровень служб базы данных. Допустимы следующие значения:<br /><br /> Basic<br /><br /> Standard<br /><br /> Premium<br /><br />Общее назначение<br /><br />Критические задачи для бизнеса|  
...
## <a name="remarks"></a>Примечания  
 Данные, возвращаемые функцией **sys. resource_stats** , выражаются в процентах от максимально допустимого уровня служб на уровне производительности, который вы используете.  
