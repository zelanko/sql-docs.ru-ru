...
|**is_autogrow_all_files**|**bit**|**Применимо к**: [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] (с [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] до [текущей версии](http://go.microsoft.com/fwlink/p/?LinkId=299658)).<br /><br /> 1 = при создании файла в файловой группе удовлетворяет, порога автоматического увеличения, все файлы в файловой группе расти.<br /><br /> 0 = при создании файла в файловой группе удовлетворяет, растет порога автоматического увеличения, только этот файл. Это значение по умолчанию.|  
