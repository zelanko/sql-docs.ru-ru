...
[!INCLUDE[tsql-appliesto-xxxxxx-asdb-xxxx-xxx-md](../../includes/tsql-appliesto-xxxxxx-asdb-xxxx-xxx-md.md)]
  ...
  Возвращает сведения о параметрах брандмауэра на уровне сервера, связанных с [!INCLUDE[ssSDSfull](../../includes/sssdsfull-md.md)]ом [!INCLUDE[msCoName](../../includes/msconame-md.md)].  
