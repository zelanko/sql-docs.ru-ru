---
title: Представления каталога сборки среды CLR (Transact-SQL) | Документация Майкрософт
ms.custom: ''
ms.date: 03/15/2017
ms.prod: sql
...
ms.locfileid: "47601163"
---
# <a name="clr-assembly-catalog-views-transact-sql"></a>Представления каталога с информацией о сборках среды CLR (Transact-SQL)
