...
[!INCLUDE[tsql-appliesto-xxxxxx-xxxx-asdw-pdw-md](../../includes/tsql-appliesto-xxxxxx-xxxx-asdw-pdw-md.md)]
 ...
 В [!INCLUDE[ssSDW](../../includes/sssdw-md.md)] этом разделе перечислены представления [!INCLUDE[ssPDW](../../includes/sspdw-md.md)] каталога и.  
  
## <a name="includesssdwincludessssdw-mdmd-and-includesspdwincludessspdw-mdmd-catalog-views"></a>[!INCLUDE[ssSDW](../../includes/sssdw-md.md)]Представления [!INCLUDE[ssPDW](../../includes/sspdw-md.md)] каталога и  
...
## <a name="includesssdwincludessssdw-mdmd-catalog-views"></a>[!INCLUDE[ssSDW](../../includes/sssdw-md.md)]Представления каталога
 ...
 Следующие представления каталога применимы только [!INCLUDE[ssSDW](../../includes/sssdw-md.md)] к:
...
## <a name="includesspdwincludessspdw-mdmd-catalog-views"></a>[!INCLUDE[ssPDW](../../includes/sspdw-md.md)]Представления каталога
 ...
 Следующие представления каталога применимы только [!INCLUDE[ssPDW](../../includes/sspdw-md.md)] к:
