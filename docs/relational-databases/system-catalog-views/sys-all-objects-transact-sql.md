---
title: sys.all_objects (Transact-SQL) | Документы Microsoft
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
|is_ms_shipped|**бит**|Объект, созданный с помощью внутреннего компонента [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)].|  
