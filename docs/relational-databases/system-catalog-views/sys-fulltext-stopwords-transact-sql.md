...
|**stopword**|**nvarchar(64)**|Термин, соответствующий стоп-слову.|  
|**language**|**sysname**|Значение псевдонима в [sys.fulltext_languages](../../relational-databases/system-catalog-views/sys-fulltext-languages-transact-sql.md), соответствующее значению кода языкового стандарта (**LCID**), либо строковое представление числового значения кода языка.|  
