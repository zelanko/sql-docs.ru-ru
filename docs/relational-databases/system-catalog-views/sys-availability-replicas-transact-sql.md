...
|**secondary_role_allow_connections_desc**|**nvarchar(60)**|Описание **secondary_role_allow_connections**, используя один из:<br /><br /> Нет<br /><br /> READ_ONLY<br /><br /> ALL|  
