...
|**идентификатор_группы**|**uniqueidentifier**|Уникальный идентификатор группы доступности, к которой относится реплика.|  
