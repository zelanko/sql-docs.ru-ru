...
|optimize_for_sequential_key|**бит**|1 = для секции включена оптимизация вставки последней страницы.<br><br>0 = значение по умолчанию. Для секции включена оптимизация вставки последней страницы.|
