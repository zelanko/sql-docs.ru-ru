...
|-----------------|---------------|-----------------|  
|**type**|**int**|Тип события или группы событий, которое вызывает срабатывание триггера.|  
|**type_name**|**Nvarchar(64)**|Имя события или группы событий. Это может быть указан в предложении FOR [CREATE TRIGGER](../../t-sql/statements/create-trigger-transact-sql.md) инструкции.|  
