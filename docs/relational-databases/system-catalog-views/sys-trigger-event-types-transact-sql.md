...
|**type_name**|**nvarchar(64)**|Имя события или группы событий. Здесь можно указать в предложении FOR [CREATE TRIGGER](../../t-sql/statements/create-trigger-transact-sql.md) инструкции.|  
