...
|**default_database**|**имеет sysname**|Имя базы данных по умолчанию, заданное в параметре DATABASE.<br /><br /> NULL = указан параметр DEFAULT.|  
|**default_namespace**|**nvarchar (384)**|Пространство имен по умолчанию, указанное в параметре NAMESPACE `https://tempuri.org` =, или значение, если вместо него был указан аргумент Default.|  
