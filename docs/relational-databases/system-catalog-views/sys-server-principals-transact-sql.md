...
|**is_fixed_role**|**bit**|Возвращает 1, если участник является одной из предопределенных ролей сервера. Дополнительные сведения см. в разделе [Роли уровня сервера](../../relational-databases/security/authentication-access/server-level-roles.md).|  
