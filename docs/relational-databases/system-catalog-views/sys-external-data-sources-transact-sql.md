...
|type_desc|**nvarchar(255)**|Тип источника данных отображается в виде строки.|HADOOP, RDBMS, SHARD_MAP_MANAGER, RemoteDataArchiveTypeExtDataSource|  
|type|**tinyint**|Тип источника данных отображается в виде числа.|0 — HADOOP<br /><br /> 1 — СУРБД<br /><br /> 2 - SHARD_MAP_MANAGER<br /><br /> 3 - RemoteDataArchiveTypeExtDataSource|  
