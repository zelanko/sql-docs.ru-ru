...
|**max_query_wait_time_ms**|**bigint**|Максимальное '' ожидания ЦП '' время для плана запроса в пределах интервала статистической обработки и категория (указывается в миллисекундах) ожидания.|
