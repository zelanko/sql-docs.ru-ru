...
|**источник_данных**|**nvarchar(4000)**|Свойство соединения источника данных OLE DB.|  
...
|**каталог**|**sysname**|Свойство соединения каталога OLE DB. NULL — если нет.|  
...
|**is_linked**|**bit**|0 = является сервером старого стиля, добавленные с помощью **sp_addserver**, с помощью различных RPC и распределенных транзакций поведения.<br /><br /> 1 = стандартный связанный сервер.|  
