...
> [!NOTE]
> **sys. pdw_permanent_table_mappings** содержит сопоставления с постоянными таблицами и не включает в себя сопоставления временных или внешних таблиц.
