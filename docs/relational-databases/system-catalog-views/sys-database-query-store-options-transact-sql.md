...
|**size_based_cleanup_mode**|**smallint**|Определяет, будет ли автоматически активирована очистка, когда общий объем данных приблизится к верхней границе ограничения.<br /><br /> 0 = OFF - не будет автоматически активирована Очистка на основе размера.<br /><br /> **1** = AUTO - Очистка на основе активируется автоматически при достижении размера на диске размер **90 процентов** из *max_storage_size_mb*. Это значение конфигурации по умолчанию.<br /><br />Эта очистка сначала удаляет самые дешевые и самые старые запросы. Он останавливается, когда приблизительно **80 процентов** из *max_storage_size_mb* достижения.|  
