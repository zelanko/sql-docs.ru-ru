...
**Применимо к** [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] :[!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] (и более поздней версии), [!INCLUDE[sqldbesa](../../includes/sqldbesa-md.md)].
...
|**max_storage_size_mb**|**bigint**|Максимальный размер диска для хранилища запросов в мегабайтах (МБ). Значение по умолчанию — **100** МБ.<br />Для [!INCLUDE[sqldbesa](../../includes/sqldbesa-md.md)] выпуска Premium значение по умолчанию — 1 ГБ [!INCLUDE[sqldbesa](../../includes/sqldbesa-md.md)] , а для выпуска Basic — 10 МБ.<br /><br /> Измените с помощью `ALTER DATABASE <database> SET QUERY_STORE (MAX_STORAGE_SIZE_MB = <size>)` инструкции.|  
