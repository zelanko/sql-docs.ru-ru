...
|**is_message_forwarding_enabled**|**бит**|Осуществляет пересылку сообщений поддержки конечных точек. Изначально установлено значение **0** (отключено). Не допускает значения NULL.|  
...
## <a name="see-also"></a>См. также  
 ...
 [Создание конечной ТОЧКИ & #40; Transact-SQL & #41;](../../t-sql/statements/create-endpoint-transact-sql.md)  
