...
|**Идентификатор order_column_id**|**int**|Идентификатор столбца сортировки. **Идентификатор order_column_id** уникально только в пределах **object_id**.<br /><br /> **Идентификатор order_column_id** представляет положение этого столбца в порядок.|  
|**Идентификатор column_id**|**int**|Идентификатор столбца в **object_id**.<br /><br /> **Идентификатор column_id** уникально только в пределах **object_id**.|  
|**is_descending изменен**|**bit**|1 — столбец сортировки имеет направление сортировки по убыванию.<br /><br /> 0 — столбец сортировки имеет направление сортировки по возрастанию.|  
