---
title: "sys.symmetric_keys (Transact-SQL) | Документы Microsoft"
ms.custom: 
ms.date: 03/07/2017
...
|-----------------|---------------|-----------------|  
|**name**|**sysname**|Имя ключа. Уникально в пределах базы данных c4database.|  
...
|**длина_ключа**|**int**|Длина ключа в битах.|  
