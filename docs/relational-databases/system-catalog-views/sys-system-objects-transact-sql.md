...
|is_ms_shipped|**bit**|Объект создается с помощью внутреннего [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] компонента.|  
