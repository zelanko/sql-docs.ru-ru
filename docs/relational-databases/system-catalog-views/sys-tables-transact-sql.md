...
|history_table_id|**int**|**Применимо к**: с [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] до [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] и [!INCLUDE[sssdsfull](../../includes/sssdsfull-md.md)].<br /><br /> Если в temporal_type (2, 4) возвращает object_id таблицы, которая хранит данные журналов, в противном случае возвращает значение NULL.|  
|is_remote_data_archive_enabled|**бит**|**Применяется к**: [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] через [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] и [!INCLUDE[sssdsfull](../../includes/sssdsfull-md.md)]<br /><br /> Указывает, является ли таблица с включенным Stretch.<br /><br /> 0 = таблица не включена.<br /><br /> 1 = таблица является совместимую со Stretch.<br /><br /> Дополнительные сведения см. в разделе [Stretch Database](../../sql-server/stretch-database/stretch-database.md).|  
...
|history_retention_period|**int**|**Применяется к**: [!INCLUDE[sssdsfull](../../includes/sssdsfull-md.md)]. <br/><br/>Числовое значение, представляющее продолжительность срока хранения журнала в единицах, задаваемых с history_retention_period_unit. |  
|history_retention_period_unit|**int**|**Применяется к**: [!INCLUDE[sssdsfull](../../includes/sssdsfull-md.md)]. <br/><br/>Числовое значение, представляющее тип единицы измерения срока хранения журнала. <br /><br />-1: БЕСКОНЕЧНЫЙ <br /><br />3: ДЕНЬ <br /><br />4: НЕДЕЛИ <br /><br />5: МЕСЯЦ <br /><br />6: ГОД |  
|history_retention_period_unit_desc|**nvarchar(10)**|**Применяется к**: [!INCLUDE[sssdsfull](../../includes/sssdsfull-md.md)]. <br/><br/>Текстовое описание типа единицы срока хранения журнала. <br /><br />INFINITE <br /><br />DAY <br /><br />WEEK <br /><br />MONTH <br /><br />YEAR |  
