...
## <a name="see-also"></a>См. также статью  
 [Функции секционирования представления &#40;каталога  Transact&#41; -SQL](../../relational-databases/system-catalog-views/partition-function-catalog-views-transact-sql.md)  
