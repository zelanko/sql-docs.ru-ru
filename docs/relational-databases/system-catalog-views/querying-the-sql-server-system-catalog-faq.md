---
title: Запросив системный каталог SQL Server часто задаваемые вопросы | Документация Майкрософт
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
-   [Как найти параметры, зависящие от указанного определяемого пользователем типа данных CLR или псевдонима типа данных?](#_FAQ24)  
  
-   [Определение ограничения CHECK, зависящие от указанного типа пользовательских данных CLR](#_FAQ25)  
  
-   [Определение представления, функции Transact-SQL и Transact-SQL хранимой процедуры, зависящие от указанного определяемого пользователем типа данных CLR или псевдонима типа?](#_FAQ26)  
...
-   [Как найти все таблицы, у которых нет индекса?](#_FAQ4)  
  
-   [Как найти все таблицы, у которых нет первичного ключа?](#_FAQ3)  
  
-   [Как найти все таблицы, содержится столбец идентификаторов?](#_FAQ5)  
...
-   [Как найти все сущности, которые были изменены в течение последних N дней?](#_FAQ6)  
...
-   [Как найти все столбцы, которые используются в выражении вычисляемого столбца?](#_FAQ21)  
...
-   [Как определить параметры для указанной хранимой процедуры или функции?](#_FAQ10)  
...
-   [Как найти всех владельцев сущностей, содержащихся в определенной схеме?](#_FAQ2)  
  
-   [Как найти разрешения, предоставленные или отклоненные для указанного участника?](#_FAQ18)  
...
###  <a name="_FAQ2"></a> Как найти всех владельцев сущностей, содержащихся в определенной схеме?  
...
###  <a name="_FAQ4"></a> Как найти все таблицы, у которых нет индекса?  
...
###  <a name="_FAQ5"></a> Как найти все таблицы, содержится столбец идентификаторов?  
 Перед запуском следующего запроса замените `<database_name>` действительным именем базы данных.  
...
###  <a name="_FAQ10"></a> Как определить параметры для указанной хранимой процедуры или функции?  
...
###  <a name="_FAQ6"></a> Как найти все сущности, которые были изменены в течение последних N дней?  
...
###  <a name="_FAQ18"></a> Как найти разрешения, предоставленные или отклоненные для указанного участника?  
...
###  <a name="_FAQ21"></a> Как найти все столбцы, которые используются в выражении вычисляемого столбца?  
 Перед запуском следующего запроса замените `<database_name>` действительным именем.  
...
###  <a name="_FAQ22"></a> Как найти столбцы, зависящие от указанного определяемого пользователем типа данных CLR или псевдонима типа данных?  
 Перед запуском следующего запроса замените `<database_name>` действительным именем и `<schema_name.data_type_name>` с допустимым, с квалификатором схемы CLR определяемого пользователем типа или имя типа с квалификатором схемы псевдоним. Следующий запрос требует членства в **db_owner** роли или разрешения на просмотр всех зависимых столбцов и вычисляемый столбец метаданных в базе данных.  
...
###  <a name="_FAQ24"></a> Как найти параметры, зависящие от указанного определяемого пользователем типа данных CLR или псевдонима типа данных?  
...
###  <a name="_FAQ25"></a> Определение ограничения CHECK, зависящие от указанного типа пользовательских данных CLR  
 Перед запуском следующего запроса замените `<database_name>` действительным именем и `<schema_name.data_type_name>` с допустимым, с квалификатором схемы имя определяемого пользователем типа CLR.  
...
###  <a name="_FAQ30"></a> Как найти все объекты, которые имеют с определенным названием столбца?  
