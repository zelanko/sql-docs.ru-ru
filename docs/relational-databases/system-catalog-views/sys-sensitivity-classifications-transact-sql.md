...
[ДОБАВЛЕНИЕ CLASSIFICTION ЧУВСТВИТЕЛЬНОСТИ (Transact-SQL)](../../t-sql/statements/add-sensitivity-classification-transact-sql.md)

[DROP CLASSIFICTION ЧУВСТВИТЕЛЬНОСТИ (Transact-SQL)](../../t-sql/statements/drop-sensitivity-classification-transact-sql.md)
