...
# [База данных SQL Azure](azure-sql-database-catalog-views.md)  
...
# [Сборщик данных](data-collector-views-transact-sql.md)  
...
# [Пространства данных](data-spaces-transact-sql.md)  
...
# [Представления компонента Database Mail](database-mail-views-transact-sql.md)  
...
# [Базы данных и файлы](databases-and-files-catalog-views-transact-sql.md)  
...
# [Расширенные события](extended-events-catalog-views-transact-sql.md)  
## [sys.database_event_session_targets (база данных SQL Azure)](sys-database-event-session-targets-azure-sql-database.md)  
## [sys.database_event_session_fields (база данных SQL Azure)](sys-database-event-session-fields-azure-sql-database.md)  
## [sys.database_event_session_events (база данных SQL Azure)](sys-database-event-session-events-azure-sql-database.md)  
## [sys.database_event_session_actions (база данных SQL Azure)](sys-database-event-session-actions-azure-sql-database.md)  
## [sys.database_event_sessions (база данных SQL Azure)](sys-database-event-sessions-azure-sql-database.md)  
...
# [Внешние операции](external-operations-catalog-views-transact-sql.md)  
...
# [Представления управления на основе политик](policy-based-management-views-transact-sql.md)  
...
# [Хранилище запросов](query-store-catalog-views-transact-sql.md)  
...
# [Скалярные типы](scalar-types-catalog-views-transact-sql.md)  
...
# [Компонент Service Broker](service-broker-catalog-views-transact-sql.md)  
...
# [Пространственные данные](spatial-data-catalog-views.md)  
...
# [Хранилище данных SQL](sql-data-warehouse-and-parallel-data-warehouse-catalog-views.md)  
