...
|**подключение**|**Регулирование**|*\<код причины >*|**reason_code**|2|*Примечание: Применяется только к версии 11 базы данных Azure SQL.*<br /><br /> Запрос регулируется.  Код причины регулирования:  *\<код причины >*. Дополнительные сведения см. в разделе [регулирование ресурсов ядра](http://msdn.microsoft.com/library/windowsazure/dn338079.aspx).|  
