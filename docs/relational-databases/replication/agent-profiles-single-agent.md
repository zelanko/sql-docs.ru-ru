---
title: "Профили агента (один агент) | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
helpviewer_keywords: 
  - "диалоговое окно «Профиль агента»"
 ...
 **Тип**  
 Тип профиля: **пользователя** (пользовательская) или **системы** (предустановленный).  
