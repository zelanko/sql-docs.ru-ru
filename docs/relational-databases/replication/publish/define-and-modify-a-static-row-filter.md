---
title: "Определение и изменение статического строкового фильтра | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "изменение фильтров, статическая строка"
  - "статические фильтры строк"
  - "фильтры [репликация SQL Server], статическая строка"
...
1.  На **Фильтрация строк таблицы** страница мастера создания публикаций или **Фильтрация строк** Страница **Свойства публикации — \< публикации>** диалоговое окно, выберите фильтр в **Отфильтрованные таблицы** панели, а затем щелкните **Изменить**.  
...
1.  На **Фильтрация строк таблицы** страница мастера создания публикаций или **Фильтрация строк** Страница **Свойства публикации — \< публикации>** диалоговое окно, выберите фильтр в **Отфильтрованные таблицы** панели, а затем щелкните **Удаление**.  
...
2.  На издателе в базе данных публикации выполните хранимую процедуру [sp_articlefilter & #40; Transact-SQL & #41;](../../../relational-databases/system-stored-procedures/sp-articlefilter-transact-sql.md). Укажите имя статьи для **@article**, имя публикации для **@publication**, имя фильтра для **@filter_name**, и предложение фильтрации для **@filter_clause** (не включая `WHERE`).  
  
3.  При необходимости определения фильтра столбцов см. раздел [Define and Modify a Column Filter](../../../relational-databases/replication/publish/define-and-modify-a-column-filter.md). В противном случае — выполнение [sp_articleview & #40; Transact-SQL & #41;](../../../relational-databases/system-stored-procedures/sp-articleview-transact-sql.md). Укажите имя публикации для **@publication**, имя фильтруемой статьи для **@article**, и предложение фильтра, указанный на шаге 2 для **@filter_clause**. Будут созданы объекты синхронизации для отфильтрованной статьи.  
  
#### Изменение статического фильтра строк для моментального снимка публикации транзакций  
  
1.  На издателе в базе данных публикации выполните хранимую процедуру [sp_articlefilter & #40; Transact-SQL & #41;](../../../relational-databases/system-stored-procedures/sp-articlefilter-transact-sql.md). Укажите имя статьи для **@article**, имя публикации для **@publication**, имя для нового фильтра для **@filter_name**, и новое предложение фильтрации для **@filter_clause** (не включая `WHERE`). Поскольку это изменение приведет к недействительности данных в существующие подписки, укажите значение **1** для **@force_reinit_subscription**.  
  
2.  На издателе в базе данных публикации выполните хранимую процедуру [sp_articleview & #40; Transact-SQL & #41;](../../../relational-databases/system-stored-procedures/sp-articleview-transact-sql.md). Укажите имя публикации для **@publication**, имя фильтруемой статьи для **@article**, и предложение фильтра, указанное на шаге 1 для **@filter_clause**. В результате будет повторно создано представление, определяющее опубликованную статью.  
...
1.  На издателе в базе данных публикации выполните хранимую процедуру [sp_articlefilter & #40; Transact-SQL & #41;](../../../relational-databases/system-stored-procedures/sp-articlefilter-transact-sql.md). Укажите имя статьи для **@article**, имя публикации для **@publication**, значение NULL для **@filter_name**, и значение NULL для **@filter_clause**. Поскольку это изменение приведет к недействительности данных в существующие подписки, укажите значение **1** для **@force_reinit_subscription**.  
...
1.  На издателе в базе данных публикации выполните хранимую процедуру [sp_addmergearticle & #40; Transact-SQL & #41;](../../../relational-databases/system-stored-procedures/sp-addmergearticle-transact-sql.md). Укажите предложение фильтрации для **@subset_filterclause** (не включая `WHERE`). Дополнительные сведения см. в статье [Define an Article](../../../relational-databases/replication/publish/define-an-article.md).  
...
1.  На издателе в базе данных публикации выполните хранимую процедуру [sp_changemergearticle & #40; Transact-SQL & #41;](../../../relational-databases/system-stored-procedures/sp-changemergearticle-transact-sql.md). Укажите имя публикации для **@publication**, имя фильтруемой статьи для **@article**, значение **subset_filterclause** для **@property**, и новое предложение фильтрации для **@value** (не включая `WHERE`). Поскольку это изменение приведет к недействительности данных в существующие подписки, укажите значение 1 для **@force_reinit_subscription**.  
