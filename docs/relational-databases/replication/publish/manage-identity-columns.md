...
3.  На вкладке **Свойства** диалогового окна **Article Свойства статьи — \<Статья>** в разделе **Управление диапазонами идентификаторов** введите значения для одного или нескольких из следующих параметров: **Размер диапазона издателя**, **Размер диапазона на стороне подписчика** и **Процентный порог выделения диапазона**.  
