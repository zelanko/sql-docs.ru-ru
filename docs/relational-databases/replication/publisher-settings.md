---
title: "Настройки издателя | Microsoft Docs"
ms.custom: ""
ms.date: "03/04/2017"
...
helpviewer_keywords: 
  - "диалоговое окно «Настройки издателя»"
 ...
 **Соединение с издателем**  
 Щелкните для запуска **подключение к серверу** диалоговое окно позволяет просмотреть и изменить свойства соединения и учетные данные, монитор репликации использует для соединения с издателем.  
