---
title: Предупреждения (Сведения о публикации транзакций)
description: Описание вкладки "Предупреждения" диалогового окна "Сведения о публикации транзакций".
