---
title: "Занятие&#160;2. Создание подписки на публикацию слиянием | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
8.  На странице "Безопасность агента слияния" нажмите кнопку с многоточием (**…**), введите \<*имя_компьютера>***\repl_merge** в поле **Учетная запись процессора**, введите пароль для этой учетной записи, нажмите кнопку **ОК**, кнопку **Далее** и еще раз кнопку **Далее**.  
