---
title: "Урок 3. Настройка распространения | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
---
# Урок 3. Настройка распространения
...
5.  Введите **\\\\**\<*имя_компьютера>***\repldata** в текстовом поле **Папка моментальных снимков**, где \<*имя_компьютера>* является именем издателя, а затем нажмите кнопку **Далее**.  
...
2.  На странице **Общее** щелкните **Поиск** и в поле **Введите имя объекта** введите \<*Имя_компьютера>***\repl_snapshot**, где \<*Имя_компьютера>* является именем локального сервера издателя, щелкните **Проверить имена** и нажмите кнопку **ОК**.  
