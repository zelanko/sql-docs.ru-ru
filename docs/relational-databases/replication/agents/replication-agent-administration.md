---
title: "Администрирование агента репликации | Microsoft Docs"
ms.custom: ""
ms.date: "08/24/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "агент моментальных снимков, администрирование"
  - "агент чтения журнала, администрирование"
  - "агент чтения очереди, администрирование"
  - "общие агенты [репликация SQL Server]"
  - "агент слияния, администрирование"
  - "агент распространителя, администрирование"
  - "агенты [репликация SQL Server], администрирование"
  - "задание очистки репликации [SQL Server]"
  - "администрирование репликации, агенты"
  - "репликация [SQL Server], администрирование"
  - "независимые агенты [репликация SQL Server]"
...
-   [!INCLUDE[ssManStudioFull](../../../includes/ssmanstudiofull-md.md)] и монитор репликации: [Запуск и остановка агента репликации & #40; SQL Server Management Studio & #41;](../../../relational-databases/replication/agents/start-and-stop-a-replication-agent-sql-server-management-studio.md)  
...
## Профили агентов  
 ...
 Сведения о прямом указании параметров командной строки см. в разделе [Основные понятия исполняемых файлов агента репликации](../../../relational-databases/replication/concepts/replication-agent-executables-concepts.md).  
