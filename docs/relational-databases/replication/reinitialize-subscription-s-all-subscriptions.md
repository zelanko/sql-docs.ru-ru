---
title: "Повторная инициализация подписок — все подписки | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
---
# Повторная инициализация подписок — все подписки
   **Повторная инициализация подписок** диалоговое окно позволяет пометить все подписки публикации для повторной инициализации. Повторная инициализация заключается в том, что к каждому подписчику применяется моментальный снимок; эта задача выполняется агентом распространителя для подписок на публикации транзакций и агентом слияния для подписок на публикации слиянием.  
