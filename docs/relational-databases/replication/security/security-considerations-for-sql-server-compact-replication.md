---
title: Рекомендации по безопасности (репликация Compact)
description: Рекомендации по безопасности для репликации баз данных выпуска SQL Server Compact.
