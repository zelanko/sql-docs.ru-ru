...
description: Модель безопасности агента репликации в SQL Server предоставляет возможность точного управления учетными записями, в которых агенты репликации выполняются и устанавливают соединения.
ms.custom: ''
ms.date: 04/26/2018
ms.prod: sql
