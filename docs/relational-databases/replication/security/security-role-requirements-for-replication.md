...
description: Ознакомьтесь с уровнем проверки подлинности, необходимым для распространенных задач настройки и обслуживания репликации в SQL Server.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
