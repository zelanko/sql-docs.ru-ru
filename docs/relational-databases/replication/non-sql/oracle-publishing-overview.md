---
title: "Обзор публикации Oracle | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "публикация [репликация SQL Server], публикация Oracle"
  - "репликация моментального снимка [SQL Server], публикация Oracle"
  - "публикация Oracle [репликация SQL Server]"
  - "репликация транзакций, публикация Oracle"
  - "публикация Oracle [репликация SQL Server], о публикации Oracle"
