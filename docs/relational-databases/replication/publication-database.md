---
title: "База данных публикации | Microsoft Docs"
ms.custom: ""
ms.date: "03/03/2017"
...
-   Выполняет **sp_replicationdboption** и устанавливает параметр **публикации** (для публикаций транзакций или моментальных снимков) или **публикации слиянием** (для публикаций слиянием) для **True**.  
...
## См. также:  
 ...
 [sp_replicationdboption & #40; Transact-SQL и #41;](../../relational-databases/system-stored-procedures/sp-replicationdboption-transact-sql.md)  
