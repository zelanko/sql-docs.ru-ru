...
-   [Папка моментальных снимков](../../relational-databases/replication/snapshot-folder.md)  
  
-   [База данных распространителя](../../relational-databases/replication/distribution-database.md)  
  
-   [Издатели](../../relational-databases/replication/publishers.md)  
