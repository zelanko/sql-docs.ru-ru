---
title: Свойства издателя — издатель, страница "Общие" | Документация Майкрософт
ms.custom: ''
ms.date: 03/01/2017
ms.prod: sql
...
ms.locfileid: "32959979"
---
# <a name="publisher-properties---publisher-general"></a>Свойства издателя — издатель, страница «Общие»
...
2.  Повторно настройте публикацию и распространение. Дополнительные сведения см. в статье [Настройка публикации и распространения](../../relational-databases/replication/configure-publishing-and-distribution.md).  
