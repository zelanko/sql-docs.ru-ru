---
title: Диалоговые окна репликации в среде SQL Server Management Studio
description: Ссылка на статьи с описанием различных диалоговых окон для репликации в SQL Server Management Studio.
...
[!INCLUDE[appliesto-ss-asdbmi-xxxx-xxx-md](../../includes/appliesto-ss-asdbmi-xxxx-xxx-md.md)]
  Этот раздел содержит сведения о ряде диалоговых окон репликации, доступных в [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)]:  
  
-   [Безопасность агента моментальных снимков](../../relational-databases/replication/snapshot-agent-security.md)  
  
-   [Безопасность агента чтения журнала](../../relational-databases/replication/log-reader-agent-security.md)  
  
-   [Безопасность агента распространителя](../../relational-databases/replication/distribution-agent-security.md)  
  
-   [Безопасность агента слияния](../../relational-databases/replication/merge-agent-security.md)  
...
-   [Проверка подписок](../../relational-databases/replication/validate-subscriptions.md)  
