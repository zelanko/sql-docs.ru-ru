...
description: Монитор репликации SQL Server предоставляет систематический обзор действий репликации, а также обеспечивает поиск сведений о конкретном агенте.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
