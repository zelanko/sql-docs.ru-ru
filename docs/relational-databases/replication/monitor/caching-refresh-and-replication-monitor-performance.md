...
-   Если с момента последнего создания кэша происходили изменения в журнале агента, время ожидания равно меньшему из следующих значений: 4 секунды или время, затраченное на создание предыдущего кэша.  
  
-   Если с момента последнего создания кэша не происходило никаких изменений в журнале агента (могли быть другие изменения), время ожидания равно большему из следующих значений: 30 секунд или время, затраченное на создание предыдущего кэша.  
