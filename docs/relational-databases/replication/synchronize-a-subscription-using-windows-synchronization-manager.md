---
title: Синхронизация подписки (диспетчер синхронизации Windows)
description: Узнайте, как синхронизировать подписки с помощью диспетчера синхронизации Windows.
