---
title: Все подписки (транзакции — SSMS)
description: Описывает вкладку "Все подписки" для выбранной публикации транзакций в SQL Server Management Studio.
