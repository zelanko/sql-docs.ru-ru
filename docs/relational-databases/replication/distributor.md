---
title: "Распространитель | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
 ...
 **Добавить**  
 Если сервер будет использоваться как распространитель, отсутствует в списке, нажмите кнопку **Добавить** для идентификации сервера и добавьте его в список.  
