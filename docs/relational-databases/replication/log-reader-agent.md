---
description: Агент чтения журнала.
...
ms.locfileid: "88493952"
---
# <a name="log-reader-agent"></a>Агент чтения журнала.
[!INCLUDE [SQL Server SQL MI](../../includes/applies-to-version/sql-asdbmi.md)]
   В диалоговом окне **Агент чтения журнала** приводятся подробные сведения об агенте чтения журнала, включая состояние, данные журнала, информационные сообщения и возможные сообщения об ошибках.  
