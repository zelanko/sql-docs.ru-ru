---
title: "Данные об издателе, агенты | Microsoft Docs"
ms.custom: ""
ms.date: "03/07/2017"
...
-   Задания обслуживания, которые отображаются для всех публикаций.  
 ...
 Дополнительные сведения об этих заданиях см. в разделе [Администрирование агента репликации](../../relational-databases/replication/agents/replication-agent-administration.md).  
  
## Параметры  
 Чтобы отобразить сведения об агенте или задании, выберите **типы агентов и заданий** раскрывающееся меню. Чтобы получить дополнительные сведения и задачи, связанные с агентом или заданием, щелкните правой кнопкой мыши строку агента или задания и в контекстном меню выберите нужный пункт. Чтобы изменить способ отображения данных в сетке, щелкните правой кнопкой мыши сетку, а затем один из следующих параметров.  
