---
title: Сведения о распространителе, список просмотра подписок (публикация моментальных снимков в SQL 2005 и более поздних версиях) | Документация Майкрософт
ms.custom: ''
ms.date: 03/20/2017
ms.prod: sql
...
---
# <a name="distributor-info-subscription-watch-list-snapshot-pub-sql-2005"></a>Сведения о распространителе, список просмотра подписок (публикация моментальных снимков в SQL 2005 и более поздних версиях)
