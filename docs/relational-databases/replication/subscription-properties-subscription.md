...
-   В[Subscription Properties - Publisher](../../relational-databases/replication/subscription-properties-publisher.md) рассматриваются свойства подписок, доступные на издателе (для подписок по запросу и принудительных подписок).  
