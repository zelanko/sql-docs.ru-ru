---
title: "Свойства публикации, фильтрация строк | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
---
# Свойства публикации, фильтрация строк
...
-   Использовать фильтры соединения для расширения фильтрации статей объединенных таблиц на относящиеся к ним статьи таблиц.  
 ...
 Дополнительные сведения о параметрах фильтрации см. в разделе [Фильтрация опубликованных данных](../../relational-databases/replication/publish/filter-published-data.md).  
