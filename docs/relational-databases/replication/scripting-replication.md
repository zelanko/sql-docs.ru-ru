---
title: "Создание сценариев репликации | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "скрипты [репликация SQL Server], объекты репликации"
  - "производительность репликации слиянием [репликация SQL Server]"
  - "репликация [SQL Server], написание скриптов"
  - "репликация моментального снимка [SQL Server], написание скриптов"
  - "скрипты [репликация SQL Server]"
  - "репликация транзакций, написание скриптов"
...
3.  Щелкните правой кнопкой мыши публикацию или подписку, затем нажмите кнопку **Сформировать сценарии**.  
  
4.  Укажите параметры в **Формирование скрипта SQL — \< Объект_репликации>** диалоговое окно.  
...
2.  Щелкните правой кнопкой мыши **репликации** папку и выберите пункт **Сформировать сценарии**.  
