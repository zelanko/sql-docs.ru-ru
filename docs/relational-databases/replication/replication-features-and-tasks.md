---
title: "Функции и задачи репликации | Документация Майкрософт"
ms.custom: 
ms.date: 07/11/2016
...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] Найдите сведения, необходимые проектировщику, разработчику, аналитику и администратору для проектирования и внедрения решений репликации.  
...
-   [Репликация в базу данных SQL](../../relational-databases/replication/replication-to-sql-database.md)  
  
-   [Агенты репликации](../../relational-databases/replication/agents/replication-agents.md)  
...
##  <a name="Interoperability"></a> Совместимость репликации и компонентов высокого уровня доступности  
