---
title: Обновляемые подписки (транзакции)
description: Описание функции обновляемых подписок, доступной для репликации транзакций в SQL Server.
