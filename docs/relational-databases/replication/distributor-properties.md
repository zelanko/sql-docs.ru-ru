---
title: диалоговое окно «Свойства распространителя»
description: Описание различных страниц в диалоговом окне "Свойства распространителя" в SQL Server Management Studio (SSMS).
