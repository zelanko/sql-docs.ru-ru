---
title: "Инициализация подписки на публикацию транзакций без моментального снимка | Microsoft Docs"
ms.custom: ""
ms.date: "03/07/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "репликация транзакций, инициализация"
  - "репликация [SQL Server], инициализация"
...
-   [! ВКЛЮЧИТЬ [ssManStudioFull] (.. / Token/ssManStudioFull_md.md)]: [Enable Initialization with a Backup for Transactional Publications &#40;SQL Server Management Studio&#41;](../../relational-databases/replication/enable initialization with backup for transactional publications.md)  
  
-   Программирование репликации Transact-SQL: [Инициализация подписки на публикацию транзакций из резервной копии и #40; Программирование репликации Transact-SQL и #41;](../../relational-databases/replication/initialize a transactional subscription from a backup.md)  
...
-   Столбцы подписанных типа timestamp в восстановленной базе данных должны быть преобразованы в **binary(8)** столбцы: скопируйте содержимое таблиц, содержащих столбцы типа timestamp, в новые таблицы, схемы, за исключением наличия **binary(8)** столбцов вместо столбцов отметки времени, удалите исходные таблицы и присвойте новым таблицам с теми же именами, что и исходные таблицы.  
