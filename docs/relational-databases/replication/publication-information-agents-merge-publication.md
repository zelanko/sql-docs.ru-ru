---
title: "Сведения о публикации, агенты (публикация слиянием) | Microsoft Docs"
ms.custom: ""
ms.date: "03/07/2017"
...
---
# Сведения о публикации, агенты (публикация слиянием)
 ...
 **Агент**  
 Агент моментальных снимков. Это единственный агент, связанный с публикацией слиянием. Агент слияния связан с подписками на эту публикацию. Дополнительные сведения см. в разделе [Просмотр сведений и выполнение задач для агентов, связанных с подпиской и #40; Монитор репликации & #41;](../../relational-databases/replication/monitor/view information and perform tasks for subscription agents.md).  
