---
description: Мастер создания подписки (справочник пользовательского интерфейса)
...
-   [Добавить подписчик, отличный от подписчика SQL Server](../../relational-databases/replication/add-non-sql-server-subscriber.md)  
...
-   [Инициализировать подписки](../../relational-databases/replication/initialize-subscriptions.md)  
