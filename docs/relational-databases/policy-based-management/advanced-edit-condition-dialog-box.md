...
|Функция|Подпись|Описание|Аргументы|Возвращаемое значение|Пример|  
|--------------|---------------|-----------------|---------------|------------------|-------------|  
