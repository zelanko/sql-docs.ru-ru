...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] Это правило проверяет, указано ли в [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] значение по умолчанию для маски сходства, равное 0. Параметр маски сходства динамически управляет соответствием процессоров.  
