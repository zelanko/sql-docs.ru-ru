---
title: "Подписка базы данных на категорию политики или отмена подписки | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
---
# Подписка базы данных на категорию политики или отмена подписки
...
#### Подписка базы данных на категорию политики  
...
#### Отмена подписки базы данных на категорию политики  
