...
# [Стойкость пароля имени входа SQL Server](sql-server-login-password-strength.md)
...
# [Создание политики, отключенной по умолчанию](create-the-off-by-default-policy.md)
# [Сохранение значения маски сходства по умолчанию](keep-the-affinity-mask-default-value.md)
# [Создание нового условия управления на основе политик](create-a-new-policy-based-management-condition.md)
...
# [Истечение срока действия пароля имени входа SQL Server](sql-server-login-password-expiration.md)
# [Учебник. Администрирование серверов с помощью управления на основе политик](tutorial-administering-servers-by-using-policy-based-management.md)
...
# [Создание политики имен финансов](create-the-finance-name-policy.md)
...
# [Настройка сервера для выполнения политики «Отключено по умолчанию»](configure-a-server-to-run-the-off-by-default-policy.md)
...
# [Подписка на политику имен финансов и ее проверка](subscribe-to-and-check-the-finance-name-policy.md)
