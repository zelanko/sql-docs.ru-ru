---
title: "Создание политики, отключенной по умолчанию | Microsoft Docs"
ms.custom: ""
ms.date: "02/27/2017"
...
manager: "jhubbard"
---
# Создание политики, отключенной по умолчанию
...
4.  В области **Выражение** в поле **Поле** выберите **@DatabaseMailEnabled**, в поле **Оператор** выберите **=**, а в поле **Значение** выберите **False**.  
...
[Настройка сервера для выполнения политики «Отключено по умолчанию»](../../relational-databases/policy-based-management/configure-a-server-to-run-the-off-by-default-policy.md)  
