---
title: "Настройка сервера для выполнения политики &#171;Отключено по умолчанию&#187; | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
manager: "jhubbard"
---
# Настройка сервера для выполнения политики &#171;Отключено по умолчанию&#187;
...
### Запуск политики «Отключено по умолчанию»  
...
5.  При соответствии компонента [!INCLUDE[ssDE](../../includes/ssde-md.md)] политике в области **Результаты** отобразится зеленый круг с галочкой. Если компонент [!INCLUDE[ssDE](../../includes/ssde-md.md)] не соответствует политике, отобразится красный круг со знаком «X».  
