...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] В этой задаче создается условие с именем "Mail Off", основанное на аспекте "Настройка контактной зоны". Затем создается политика с именем «Отключена по умолчанию».  
