---
title: "Учебник. Администрирование серверов с помощью управления на основе политик | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
applies_to: 
  - "SQL Server 2016"
helpviewer_keywords: 
  - "учебники [управление на основе политик]"
  - "Управление на основе политик, учебники"
...
---
# Учебник. Администрирование серверов с помощью управления на основе политик
...
[Урок 1. Создание и применение политики, отключенной по умолчанию](../../relational-databases/policy-based-management/lesson-1-create-and-apply-an-off-by-default-policy.md)  
