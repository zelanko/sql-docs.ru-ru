...
## <a name="example"></a>Пример  
 ...
 Второй ( [!INCLUDE[tsql](../../includes/tsql-md.md)]) пример кода создает сборку в базе данных master.  
 ...
 Четвертый ( [!INCLUDE[tsql](../../includes/tsql-md.md)]) пример кода удаляет сборку из базы данных master.  
