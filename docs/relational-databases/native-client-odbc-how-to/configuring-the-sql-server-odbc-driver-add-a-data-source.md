...
ms.locfileid: "37421513"
---
# <a name="configuring-the-sql-server-odbc-driver---add-a-data-source"></a>Настройка драйвера ODBC для SQL Server — Добавление источника данных
