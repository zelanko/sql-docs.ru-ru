 ...
 **Фаза фиксации**  
 ...
 [!INCLUDE[ssDEnoversion](../includes/ssdenoversion-md.md)] приложения могут управлять распределенными транзакциями посредством [!INCLUDE[tsql](../includes/tsql-md.md)] или API базы данных. Дополнительные сведения см. в статье [BEGIN DISTRIBUTED TRANSACTION (Transact-SQL)](../t-sql/language-elements/begin-distributed-transaction-transact-sql.md).  
...
|**Сериализуемый**|нет|нет|нет|  
 ...
 [!INCLUDE[tsql](../includes/tsql-md.md)] скрипты используют инструкцию SET TRANSACTION ISOLATION LEVEL.  
...
###### <a name="deadlock-in-systemhealth-session"></a>Блокировка в сеансе system_health
