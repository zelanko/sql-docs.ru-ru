---
title: "Поиск свойств документа с использованием списков свойств поиска | Microsoft Docs"
ms.custom: ""
ms.date: "03/06/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "полнотекстовый поиск [SQL Server], списки свойств поиска"
  - "полнотекстовый поиск [SQL Server], свойства"
  - "списки свойств поиска [SQL Server]"
  - "поиск свойства [SQL Server], сведения"
  - "полнотекстовые индексы [SQL Server], списки свойств поиска"
  - "списки свойств поиска [SQL Server], сведения"
  - "поиск свойства [SQL Server]"
...
7.  Выберите один из следующих вариантов.  
    ...
    -   **Создание на основе существующего списка свойств поиска**  
     ...
     Дополнительные сведения см. в статье [New Search Property List](../Topic/New%20Search%20Property%20List.md).  
