---
title: "Выбор языка при создании полнотекстового индекса | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  ...
  - "полнотекстовые индексы [SQL Server], языки"
  - "вопросы международного использования [компонент Full-Text Search]"
  - "парадигматические модули [полнотекстовый поиск]"
  - "вопросы применения по всему миру [компонент Full-Text Search]"
  - "полнотекстовый поиск [SQL Server], вопросы международного использования"
  - "языки [SQL Server], полнотекстовые индексы"
...
-   В комплекте с SQL Server поставляются включенные по умолчанию средства разбиения по словам для огромного количества языков.  
