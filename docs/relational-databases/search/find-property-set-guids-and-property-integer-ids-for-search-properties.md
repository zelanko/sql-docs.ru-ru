...
##  <a name="finding-values-for-a-search-property-from-a-windows-property-description"></a><a name="propdesc"></a> Поиск значений для списка свойств поиска с помощью описания свойства Windows  
