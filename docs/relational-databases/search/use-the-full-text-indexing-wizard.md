---
title: "Использование мастера полнотекстового индексирования | Microsoft Docs"
ms.custom: ""
ms.date: "08/19/2016"
...
helpviewer_keywords: 
  - "мастер полнотекстового индексирования"
  - "полнотекстовый поиск [SQL Server], мастер полнотекстового индексирования"
