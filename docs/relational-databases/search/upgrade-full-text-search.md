---
title: "Обновление полнотекстового поиска | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "полнотекстовый поиск [SQL Server], установка"
  - "миграция полнотекстовых индексов [SQL Server]"
  - "обновление средства полнотекстового поиска"
  - "установка компонента Full-Text Search"
  - "полнотекстовый поиск [SQL Server], обновление"
