---
title: "Настройка учетной записи службы средства запуска управляющей программы полнотекстовой фильтрации | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "полнотекстовый поиск [SQL Server], учетная запись средства запуска службы FDHOST (MSSQLFDLauncher)"
  - "средство запуска службы FDHOST (MSSQLFDLauncher) [SQL Server]"
...
---
# Настройка учетной записи службы средства запуска управляющей программы полнотекстовой фильтрации
...
-   [Рекомендации по безопасности](#rec)  
  
-   [Настройка учетной записи службы](#setting)  
  
-   [Если Служба запуска управляющей программы полнотекстовой фильтрации SQL Server не запускается](#error)  
  
##  <a name="setting"></a> Настройка учетной записи службы  
  
#### Настройка учетной записи службы запуска управляющей программы полнотекстовой фильтрации SQL Server для полнотекстового поиска  
...
##  <a name="error"></a> Если Служба запуска управляющей программы полнотекстовой фильтрации SQL Server не запускается  
