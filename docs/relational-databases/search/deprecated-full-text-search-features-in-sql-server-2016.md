---
title: "Нерекомендуемые функции полнотекстового поиска в SQL Server&#160;2016 | Microsoft Docs"
ms.custom: ""
ms.date: "08/19/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "устаревшие функции [полнотекстовый поиск]"
  - "полнотекстовый поиск [SQL Server], нерекомендуемые функции"
  - "полнотекстовые запросы [SQL Server], с учетом расположения"
...
---
# Нерекомендуемые функции полнотекстового поиска в SQL Server&#160;2016
  В этом разделе описаны устаревшие функции полнотекстового поиска, по-прежнему доступные в [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]. Эти функции будут удалены в следующем выпуске [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]. Не используйте устаревшие функции в новых приложениях.  
  
 Наблюдать за использованием нерекомендуемых функций можно с помощью событий трассировки и объекта производительности **SQL Server:Deprecated Features** . Дополнительные сведения см. в разделе [Использование объектов SQL Server](../../relational-databases/performance-monitor/use-sql-server-objects.md).  
