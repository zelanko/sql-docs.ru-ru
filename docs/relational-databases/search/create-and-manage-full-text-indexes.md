---
title: "Создание и управление полнотекстовыми индексами | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "полнотекстовые индексы [SQL Server], сведения"
