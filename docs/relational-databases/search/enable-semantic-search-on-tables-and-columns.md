---
title: "Включение семантического поиска на таблицы и столбцы | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "семантический поиск [SQL Server], включение"
...
###  <a name="HowToEnableAlter"></a> Практическое руководство. Создание семантического индекса, если есть полнотекстовый индекс  
 ...
 **Добавить семантический индекс с помощью среды SQL Server Management Studio**  
 Изменение столбцов, для которых включен семантический или полнотекстовый индекс, выполняется на странице **Столбцы полнотекстового индекса** диалогового окна **Свойства полнотекстового индекса**. Дополнительные сведения см. в разделе [Управление полнотекстовыми индексами](../Topic/Manage%20Full-Text%20Indexes.md).  
...
###  <a name="drophow"></a> Практическое руководство. Удаление семантического индекса  
...
###  <a name="HowToCheckEnabled"></a> Практическое руководство. Проверка того, включен ли семантический поиск по объектам базы данных  
...
###  <a name="doctypes"></a> Практическое руководство. Определение того, какие типы документов могут быть проиндексированы  
