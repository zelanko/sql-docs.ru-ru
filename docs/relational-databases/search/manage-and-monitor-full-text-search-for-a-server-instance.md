---
title: "Управление и наблюдение за полнотекстовым поиском для экземпляра сервера | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  ...
  - "полнотекстовый поиск [SQL Server], управление серверами"
