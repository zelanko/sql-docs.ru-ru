---
title: "Ограничение количества результатов поиска с использованием функции RANK | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "ранжирование строк [полнотекстовый поиск]"
  - "ранжирующие по релевантности значения [полнотекстовый поиск]"
  - "полнотекстовый поиск [SQL Server], ранжирование"
  - "ранжирование индексов [полнотекстовый поиск]"
  - "ранжированные результаты [полнотекстовый поиск]"
  - "ранжирование [полнотекстовый поиск]"
  - "построчные ранжирующие значения [полнотекстовый поиск]"
