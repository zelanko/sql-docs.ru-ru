...
-   Частота передачи набора элементов сбора: каждые 15 минут.  
 ...
 Каталог UMDW можно настроить: \<Системный диск>:\Program Files\Microsoft SQL Server\MSSQL10_50.<имя_UCP>\MSSQL\Data\\\, где \<Системный диск> — это обычно диск C:\. Файл журнала, UMDW_\<GUID>_LOG, находится в том же каталоге.  
