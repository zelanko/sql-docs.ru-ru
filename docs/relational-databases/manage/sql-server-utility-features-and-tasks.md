---
title: "Функции и задачи служебной программы SQL Server | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "служебная программа SQL Server [SQL Server]"
  - "точка управления служебной программой"
  - "темп роста служебной программы"
  - "многосерверное управление"
  - "точка управления служебной программой"
  - "многосерверное управление [SQL Server]"
...
## Преимущества служебной программы SQL Server  
...
|Описывает, как устранять неполадки служебной программы SQL server.|[Устранение неполадок служебной программы SQL Server](../Topic/Troubleshoot%20the%20SQL%20Server%20Utility.md)|  
...
|Ссылки на разделы справки F1 по UtilityExplorer.|[Справка F1 проводника служебной программы](../../relational-databases/manage/справка-f1-проводника-служебной-программы.md)|  
