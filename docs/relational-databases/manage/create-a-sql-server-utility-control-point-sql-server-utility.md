---
title: создать точку управления служебной программы SQL Server (служебная программа SQL Server)
description: Получите помощь по выявлению узких мест использования ресурсов и возможностей консолидации путем создания точки управления служебной программой (UCP) SQL Server.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
## <a name="wizard-steps"></a>Шаги мастера  
 ![Создание точки управления служебной программой](../../relational-databases/manage/media/create-ucp.gif "Create_UCP")  
  
 В следующих разделах содержатся сведения о каждой странице потока операций мастера по созданию нового пункта управления программой [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] . Чтобы запустить мастер для создания точки управления программой (UCP), откройте область обозревателя программ из меню "Вид" в SSMS, а затем нажмите кнопку ![Создать UCP](../../relational-databases/manage/media/create-ucp.gif "Create_UCP") **Создать UCP** в верхней части области обозревателя программ.  
