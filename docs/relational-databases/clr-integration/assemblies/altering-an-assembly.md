...
description: Используйте ALTER ASSEMBLY для обновления сборок, зарегистрированных в SQL Server. Также можно изменить набор разрешений и добавить исходный код или другие файлы для сборки.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
