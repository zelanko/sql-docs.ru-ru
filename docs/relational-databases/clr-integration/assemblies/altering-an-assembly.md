---
title: Изменение Ассамблеи (ru) Документы Майкрософт
description: Используйте ALTER ASSEMBLY для обновления сборок, зарегистрированных в сервере S'L. Можно также изменить набор разрешений и добавить исходный код или другие файлы для сборки.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
...
```  
 ...
 Если набор разрешений сборки изменяется с **SAFE** на **EXTERNAL_ACCESS** или **UNSAFE,** сначала должен быть создан асимметричный ключ и соответствующий логин с разрешением **EXTERNAL ACCESS ASSEMBLY** или **unSAFE ASSEMBLY** для сборки. Дополнительные сведения см. в статье [Creating an Assembly](../../../relational-databases/clr-integration/assemblies/creating-an-assembly.md).  
