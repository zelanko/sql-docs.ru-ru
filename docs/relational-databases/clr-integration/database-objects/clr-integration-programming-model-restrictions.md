...
description: SQL Server выполняет проверку кода управляемых объектов базы данных при их первой регистрации с помощью инструкции CREATE ASSEMBLY и во время выполнения.
ms.custom: ''
ms.date: 03/17/2017
ms.prod: sql
ms.reviewer: ''
...
-   Используется **Создание сборки из**_ \<location> ,_ а все сборки, на которые имеются ссылки, и их зависимости доступны в *\<location>* .  
  
-   Используется **Создание сборки из**_ \<bytes ...> ,_ а все ссылки указываются через пробелы, разделенные пробелом.  
