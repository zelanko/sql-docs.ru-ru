...
-   Вы используете **CREATE ASSEMBLY из**  _расположения\<>,_ а все сборки, на которые имеются ссылки, и их зависимости доступны в *\<расположении >* .  
  
-   Используется **Создание сборки из** _\<байт... >,_ а все ссылки указываются с помощью разделенных пробелами байтов.  
