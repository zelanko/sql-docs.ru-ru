...
description: С помощью Microsoft Visual Studio можно разрабатывать объекты базы данных CLR для SQL Server, развертывать их на тестовом сервере и распространять на рабочие серверы.
ms.custom: ''
ms.date: 03/16/2017
ms.prod: sql
ms.reviewer: ''
