...
|Возможность вызова машинного кода|нет|Нет|Да|  
 ...
 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] использует уровень политики CAS на уровне узла, чтобы задать политику узла, которая предоставляет один из трех наборов разрешений, в зависимости от набора разрешений, хранимого в [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] каталоги. Управляемый код, выполняемый внутри базы данных, всегда получает один из этих наборов разрешений доступа для кода.  
