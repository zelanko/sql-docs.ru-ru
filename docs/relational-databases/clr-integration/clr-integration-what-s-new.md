---
title: "Какой &#39; новые возможности интеграции со средой CLR | Документы Microsoft"
ms.date: 03/03/2017
...
---
# <a name="clr-integration---what39s-new"></a>Интеграция со средой CLR - что &#39; s New
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]Ниже перечислены новые возможности в интеграции со средой CLR в [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)]:  
