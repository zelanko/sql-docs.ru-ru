...
-   Поколении 0: Хранит все транзакции, которые были зафиксированы раньше самой старой активной транзакции. Версии строк, сформированные этими транзакциями, сразу же доступны для сборки мусора.  
  
-   Поколения 1-14: хранятся транзакции с меткой времени больше самой старой активной транзакции. Выполнить сбор мусора для этих версий строк нельзя. Каждое поколение может содержать до 16 транзакций. Всего в этих поколениях может быть 224 (14 * 16) транзакции.  
  
-   Создание 15: Остальные транзакции с меткой времени больше самой старой активной транзакции помещаются в поколение 15. Как и в поколении 0, количество транзакций в поколении 15 неограниченно.  
