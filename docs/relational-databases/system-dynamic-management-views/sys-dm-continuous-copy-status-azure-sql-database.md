...
|**partner_server**|**имеет sysname**|Имя связанного сервера базы данных SQL.|  
|**partner_database**|**имеет sysname**|Имя связанной базы данных на связанном сервере базы данных SQL.|  
...
## <a name="remarks"></a>Remarks  
 Представление **sys. dm_continuous_copy_status** создается в базе данных **ресурсов** и отображается во всех базах данных, включая логическую реплику. Однако запрос к этому представлению в логической базе данных master выдает лишь пустой набор.  
