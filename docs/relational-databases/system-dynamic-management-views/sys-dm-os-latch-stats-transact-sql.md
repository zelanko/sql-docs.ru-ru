...
> [!NOTE]  
> Чтобы вызвать это из [!INCLUDE[ssSDWfull](../../includes/sssdwfull-md.md)] или [!INCLUDE[ssPDW](../../includes/sspdw-md.md)], используйте имя **sys. dm_pdw_nodes_os_latch_stats**.  
...
> [!NOTE]  
> `sys.dm_os_latch_stats` не следит за запросами на кратковременную блокировку, которые были предоставлены немедленно, или с ошибкой, не дожидаясь ее ожидания.  
