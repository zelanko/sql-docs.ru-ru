 ...
 **Sys.dm_cryptographic_provider_sessions** представление роли public для текущего соединения. Чтобы просмотреть все криптографические соединения, необходимо иметь **УПРАВЛЕНИЯ** разрешений сервера.  
