...
|**is_primary_replica**|**бит**|Возвращает 1, если реплика является первичной, либо 0, если она вторична.<br /><br />**Применяется к:** [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] через [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)].|  
