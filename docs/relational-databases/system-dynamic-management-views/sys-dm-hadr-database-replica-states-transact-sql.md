...
|**идентификатор_группы**|**uniqueidentifier**|Идентификатор группы доступности, к которой принадлежит база данных.|  
...
|**is_primary_replica**|**bit**|Возвращает 1, если реплика является первичной, либо 0, если она вторична. Применимо к SQL Server 2014 и более поздних версий.|  
