...
|**database_state_desc**|**nvarchar(60)**|Описание **database_state** реплики доступности.<br /><br /> ONLINE<br /><br /> RESTORING<br /><br /> RECOVERING<br /><br /> RECOVERY_PENDING<br /><br /> SUSPECT<br /><br /> EMERGENCY<br /><br /> OFFLINE<br /><br /> **Примечание:** то же, что **state_desc** столбца в представлении каталога sys.databases.|  
