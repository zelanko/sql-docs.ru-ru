---
title: sys.dm_tran_locks (Трансакт-СЗЛ) Документы Майкрософт
ms.custom: ''
ms.date: 03/30/2017
ms.prod: sql
...
> [!NOTE]  
> Для вызова [!INCLUDE[ssSDWfull](../../includes/sssdwfull-md.md)] этого [!INCLUDE[ssPDW](../../includes/sspdw-md.md)]от или, используйте имя **sys.dm_pdw_nodes_tran_locks**.  
  
|Имя столбца|Тип данных|Описание|  
|-----------------|---------------|-----------------|  
|**resource_type**|**nvarchar(60)**|Представляет тип ресурса. Значение может быть одним из следующих: DATABASE, FILE, OBJECT, PAGE, KEY, EXTENT, RID, APPLICATION, METADATA, HOBT или ALLOCATION_UNIT.|  
...
|**request_mode**|**nvarchar(60)**|Режим запроса. Режимом для предоставленных запросов является режим предоставления, для запросов в ожидании — запрашиваемый режим. <br /><br /> NULL = Блокировки нет. Играет роль заполнителя.<br /><br /> Sch-S (стабильность схемы) - гарантирует, что элемент схемы, такой как таблица или индекс, не отбрасывается, в то время как любой сеанс удерживает блокировку стабильности схемы на элементе схемы.<br /><br /> Sch-M (модификация схемы) - должен проводиться любой сессией, которая хочет изменить схему указанного ресурса. Заверяет, что другие сеансы не имеют ссылок на обозначенный объект.<br /><br /> S (Общий) - Холдинговой сессии предоставляется общий доступ к ресурсу.<br /><br /> U (Обновление) - Указывает на блокировку обновления, приобретенную на ресурсах, которые в конечном итоге могут быть обновлены. Используется для предотвращения распространенной формы взаимоблокировки, которая происходит, если несколько сеансов блокируют ресурсы для возможного обновления в будущем.<br /><br /> X (Эксклюзив) - Холдинговой сессии предоставляется эксклюзивный доступ к ресурсу.<br /><br /> IS (Intent Shared) - указывает на намерение разместить блокировки S на каком-либо подведомственном ресурсе в иерархии блокировки.<br /><br /> IU (Намеренное обновление) - указывает на намерение разместить блокировки U на каком-либо подчиненном ресурсе в иерархии блокировки.<br /><br /> IX (Intent Exclusive) - указывает на намерение разместить X-блокировки на каком-либо подчиненном ресурсе в иерархии блокировки.<br /><br /> SIU (Общее обновление намерения) - указывает общий доступ к ресурсу с целью приобретения блокировок обновлений на подчиненных ресурсах в иерархии блокировки.<br /><br /> SIX (Общий умысел Exclusive) - указывает общий доступ к ресурсу с целью приобретения эксклюзивных блокировок на подчиненных ресурсах в иерархии блокировки.<br /><br /> UIX (Обновление Намерение Эксклюзив) - Указывает на удержание блокировки обновления на ресурсе с целью приобретения эксклюзивных блокировок на подчиненных ресурсах в иерархии блокировки.<br /><br /> BU - Используется при оптовых операциях.<br /><br /> RangeS_S (общий ключ-диапазон и блокировка общих ресурсов) - указывает на сериационную сканную дальность.<br /><br /> RangeS_U (общий ключ-диапазон и блокировка ресурсов обновления) - указывает на сериационную сканирование обновления.<br /><br /> RangeI_N (вставить замок Key-Range и Null Resource) - используется для тестирования диапазонов перед вставкой нового ключа в индекс.<br /><br /> RangeI_S - блокировка преобразования клавиш и диапазонов, созданная путем перекрытия RangeI_N и S-замков.<br /><br /> RangeI_U - блокировка преобразования клавиш и диапазонов, созданная путем перекрытия RangeI_N и U-замков.<br /><br /> RangeI_X - блокировка преобразования клавиш и диапазонов, созданная в связи с перекрытием RangeI_N и X-замков.<br /><br /> RangeX_S - блокировка преобразования ключей и диапазона, созданная путем перекрытия RangeI_N и RangeS_S. RangeS_S.<br /><br /> RangeX_U - блокировка преобразования клавиш, созданная путем перекрытия RangeI_N и RangeS_U замков.<br /><br /> RangeX_X (Эксклюзивный ключ-диапазон и эксклюзивный замок ресурсов) - Это блокировка преобразования, используемая при обновлении ключа в диапазоне.|  
|**request_type**|**nvarchar(60)**|Тип запроса. Значение LOCK.|  
|**request_status**|**nvarchar(60)**|Текущее состояние запроса. Возможные значения: GRANTED, CONVERT, WAIT, LOW_PRIORITY_CONVERT, LOW_PRIORITY_WAIT или ABORT_BLOCKERS. Для получения дополнительной информации о низкоприоритетных ожиданиях и прервать блокаторы, см. *low_priority_lock_wait* разделе [ALTER INDEX &#40;&#41;Transact-S'L ](../../t-sql/statements/alter-index-transact-sql.md).|  
|**request_reference_count**|**смолинт**|Возвращает приблизительное количество случаев, когда этот ресурс был запрошен одним и тем же объектом.|  
...
|**pdw_node_id**|**Int**|**Применяется к:** [!INCLUDE[ssSDWfull](../../includes/sssdwfull-md.md)][!INCLUDE[ssPDW](../../includes/sspdw-md.md)]<br /><br /> Идентификатор для узла, в который находится этот дистрибутив.|  
...
-   Табличные подсказки блокировки для указания уровня блокировки для отдельной ссылки таблицы в предложении FROM. Для синтаксиса и ограничений см [&#41;&#40;. ](../../t-sql/queries/hints-transact-sql-table.md)  
...
## <a name="locks"></a><a name="locks"></a>Замки
...
|FILE|<file_id> file_id|Идентификатор файла, представляемого данным ресурсом.|  
...
|METADATA.XML_INDEX_QNAME|object_id = O, $qname_id = Q|[!INCLUDE[ssInternalOnly](../../includes/ssinternalonly-md.md)]|  
 ...
 Следующие XEvents связаны с разделом **SWITCH** и онлайн-восстановлением индекса. Для получения информации о синтаксисе [&#41;&#40;](../../t-sql/statements/alter-index-transact-sql.md) [&#41;&#40;](../../t-sql/statements/alter-table-transact-sql.md) см.  
...
-   ddl_with_wait_at_low_priority  
 ...
 Существующий **progress_report_online_index_operation** XEvent для онлайн-операций индекса был расширен за счет добавления **partition_number** и **partition_id.**  
...
[sys.dm_tran_database_transactions&#41;&#40;"Трансакт-СЗЛ"](../../relational-databases/system-dynamic-management-views/sys-dm-tran-database-transactions-transact-sql.md)      
...
[Представления и функции, связанные с динамическим управлением, &#40;&#41;](../../relational-databases/system-dynamic-management-views/transaction-related-dynamic-management-views-and-functions-transact-sql.md)      
