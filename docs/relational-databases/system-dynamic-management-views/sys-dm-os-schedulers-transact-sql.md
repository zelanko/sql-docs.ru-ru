...
> [!NOTE]  
>  Чтобы вызвать эту функцию [!INCLUDE[ssSDWfull](../../includes/sssdwfull-md.md)] из [!INCLUDE[ssPDW](../../includes/sspdw-md.md)]или, используйте имя **sys. dm_pdw_nodes_os_schedulers**.  
...
|quantum_length_us|**bigint**|
  [!INCLUDE[ssInternalOnly](../../includes/ssinternalonly-md.md)] Отображает такт планировщика, используемый SQLOS.|  
...
-   Узел NUMA `0` сопоставлен ЦП `1`, а узел NUMA `1` сопоставлен ЦП `0`. 
  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] обычно сначала использует узел NUMA, отличный от узла 0.  
