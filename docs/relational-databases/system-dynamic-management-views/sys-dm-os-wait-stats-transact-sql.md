...
|AM_INDBUILD_ALLOCATION |Только для внутреннего применения. <br />**Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|AM_SCHEMAMGR_UNSHARED_CACHE |Только для внутреннего применения. <br />**Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|ASSEMBLY_FILTER_HASHTABLE |Только для внутреннего применения. <br />**Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
...
|ASYNC_OP_COMPLETION |Только для внутреннего применения. <br />**Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|ASYNC_OP_CONTEXT_READ |Только для внутреннего применения. <br />**Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|ASYNC_OP_CONTEXT_WRITE |Только для внутреннего применения. <br />**Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|ASYNC_SOCKETDUP_IO |Только для внутреннего применения. <br />**Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
...
|АРХИВАЦИЯ |Имеет место, когда задача блокируется как часть процесса резервного копирования.| 
...
|BLOB_METADATA |Только для внутреннего применения. <br />**Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|бмпаллокатион |Происходит с параллельными планами пакетного режима при синхронизации выделения большого растрового фильтра. Если ожидание избыточно и не может быть уменьшено путем настройки запросов (например, добавлением индексов), рассмотрите возможность настройки параметра cost threshold for parallelism или уменьшите степень параллелизма.<br />**Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
...
|бпсорт |Происходит с параллельными планами пакетного режима при синхронизации сортировки набора данных между несколькими потоками. Если ожидание избыточно и не может быть уменьшено путем настройки запросов (например, добавлением индексов), рассмотрите возможность настройки параметра cost threshold for parallelism или уменьшите степень параллелизма. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
...
|BROKER_DISPATCHER |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
...
|BROKER_FORWARDER |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
...
|BROKER_START |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|BROKER_TASK_SHUTDOWN |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
...
|BROKER_TASK_SUBMIT |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|BROKER_TO_FLUSH |Происходит, когда Service Broker "ленивый" очищает объекты передачи в памяти для рабочей таблицы.| 
|BROKER_TRANSMISSION_OBJECT |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|BROKER_TRANSMISSION_TABLE |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|BROKER_TRANSMISSION_WORK |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
...
|CHANGE_TRACKING_WAITFORCHANGES |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
...
|CHECK_SCANNER_MUTEX |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|CHECK_TABLES_INITIALIZATION |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|CHECK_TABLES_SINGLE_SCAN |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|CHECK_TABLES_THREAD_BARRIER |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
...
|кмемпартитионед |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
...
|COLUMNSTORE_BUILD_THROTTLE |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|COLUMNSTORE_COLUMNDATASET_SESSION_LIST |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|COMMIT_TABLE |Только для внутреннего применения.| 
|CONNECTION_ENDPOINT_LOCK |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|каунтрековеримгр |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|CREATE_DATINISERVICE |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|кксконсумер |Происходит с параллельными планами запросов, когда поток-потребитель ожидает отправки строк потоком-производителю. Это обычная часть параллельного выполнения запроса. <br /> **Применимо к**: [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] (начиная [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] с с [!INCLUDE[ssSQL17](../../includes/sssql17-md.md)] пакетом обновления 2 (SP2), CU3),[!INCLUDE[ssSDS](../../includes/sssds-md.md)]|
...
|DBCC_SCALE_OUT_EXPR_CACHE |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
...
|DBSEEDING_FLOWCONTROL |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|DBSEEDING_OPERATION |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
...
|DIRECTLOGCONSUMER_LIST |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|DIRTY_PAGE_POLL |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|DIRTY_PAGE_SYNC |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|DIRTY_PAGE_TABLE_LOCK |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
...
|DISPATCHER_PRIORITY_QUEUE_SEMAPHORE |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
...
|DPT_ENTRY_LOCK |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|DROP_DATABASE_TIMER_TASK |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
...
|DTCNEW_ENLIST |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|DTCNEW_PREPARE |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|DTCNEW_RECOVERY |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|DTCNEW_TM |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|DTCNEW_TRANSACTION_ENLISTMENT |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|дткпнтсинк |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
...
|ENABLE_EMPTY_VERSIONING |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
...
|EXTERNAL_RG_UPDATE |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|EXTERNAL_SCRIPT_NETWORK_IO |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] до текущей.| 
|EXTERNAL_SCRIPT_PREPARE_SERVICE |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|EXTERNAL_SCRIPT_SHUTDOWN |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|EXTERNAL_WAIT_ON_LAUNCHER, |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|FABRIC_HADR_TRANSPORT_CONNECTION |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|FABRIC_REPLICA_CONTROLLER_LIST |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|FABRIC_REPLICA_CONTROLLER_STATE_AND_CONFIG |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|FABRIC_REPLICA_PUBLISHER_EVENT_PUBLISH |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|FABRIC_REPLICA_PUBLISHER_SUBSCRIBER_LIST |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|FABRIC_WAIT_FOR_BUILD_REPLICA_EVENT_PROCESSING |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
...
|FEATURE_SWITCHES_UPDATE |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|FFT_NSO_DB_KILL_FLAG |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|FFT_NSO_DB_LIST |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|FFT_NSO_FCB |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|FFT_NSO_FCB_FIND |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|FFT_NSO_FCB_PARENT |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|FFT_NSO_FCB_RELEASE_CACHED_ENTRIES |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|FFT_NSO_FCB_STATE |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|FFT_NSO_FILEOBJECT |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|FFT_NSO_TABLE_LIST |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|FFT_NTFS_STORE |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|FFT_RECOVERY |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|FFT_RSFX_COMM |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|FFT_RSFX_WAIT_FOR_MEMORY |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|FFT_STARTUP_SHUTDOWN |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|FFT_STORE_DB |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|FFT_STORE_ROWSET_LIST |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|FFT_STORE_TABLE |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|FILE_VALIDATION_THREADS |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|FILESTREAM_CACHE |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|FILESTREAM_CHUNKER |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|FILESTREAM_CHUNKER_INIT |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|FILESTREAM_FCB |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|FILESTREAM_FILE_OBJECT |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|FILESTREAM_WORKITEM_QUEUE |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|FILETABLE_SHUTDOWN |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|FOREIGN_REDO |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] до текущей.| 
|FORWARDER_TRANSITION |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
...
|FT_MASTER_MERGE_COORDINATOR |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
...
|FT_PROPERTYLIST_CACHE |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
...
|GDMA_GET_RESOURCE_OWNER |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|GHOSTCLEANUP_UPDATE_STATS |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] и более поздним версиям.| 
|гхостклеанупсинкмгр |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|GLOBAL_QUERY_CANCEL |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] и более поздним версиям.| 
|GLOBAL_QUERY_CLOSE |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|GLOBAL_QUERY_CONSUMER |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] и более поздним версиям.| 
|GLOBAL_QUERY_PRODUCER |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] и более поздним версиям.| 
|GLOBAL_TRAN_CREATE |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|GLOBAL_TRAN_UCS_SESSION |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|GUARDIAN |Указано только в ознакомительных целях. Не поддерживается. Совместимость с будущими версиями не гарантируется.| 
|HADR_AG_MUTEX |Возникает, когда Always On инструкция DDL или команда отказоустойчивой кластеризации Windows Server ожидает монопольного доступа на чтение и запись к конфигурации группы доступности. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|HADR_AR_CRITICAL_SECTION_ENTRY |Возникает, когда Always On инструкция DDL или команда отказоустойчивой кластеризации Windows Server ожидает монопольного доступа на чтение и запись к состоянию среды выполнения локальной реплики связанной группы доступности. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|HADR_AR_MANAGER_MUTEX |Возникает в том случае, когда операция завершения работы реплики доступности ожидает окончания запуска либо операция запуска реплики доступности ожидает окончания операции завершения. Только для внутреннего использования. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|HADR_AR_UNLOAD_COMPLETED |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
...
|HADR_BACKUP_BULK_LOCK |База данных-источник Always On получила запрос на резервное копирование от базы данных-получателя и ожидает завершения обработки запроса в фоновом потоке при получении или освобождении блокировки BulkOp. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|HADR_BACKUP_QUEUE |Фоновый поток резервного копирования базы данных-источника Always On ожидает нового рабочего запроса от базы данных-получателя. (как правило, это происходит, когда база данных-источник удерживает журнал BulkOp и ожидает, чтобы база данных-получатель указывала на то, что база данных-источник может снять блокировку). <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|HADR_CLUSAPI_CALL |Поток SQL Server ожидает переключения из режима, не являющегося вытесненным (запланированный на SQL Server), в режим с вытеснением (запланированный операционной системой) для вызова API отказоустойчивой кластеризации Windows Server. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|HADR_COMPRESSED_CACHE_SYNC |Ожидание доступа к кэшу сжатых блоков журнала, который используется, чтобы избежать избыточного сжатия блоков журнала, отправленных в несколько баз данных-получателей. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|HADR_CONNECTIVITY_INFO |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|HADR_DATABASE_FLOW_CONTROL |Ожидание отправки сообщений участнику, когда количество сообщений в очереди достигло максимума. Означает, что просмотр журнала выполняется быстрее, чем отправка по сети. Эта проблема возникает, только если отправка по сети выполняется медленнее, чем ожидалось. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
...
|HADR_DATABASE_WAIT_FOR_RECOVERY |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|HADR_DATABASE_WAIT_FOR_RESTART |Ожидание перезапуска базы данных в Always On управления группами доступности. В нормальных условиях это не проблема с клиентом, так как ожидается ожидание. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|HADR_DATABASE_WAIT_FOR_TRANSITION_TO_VERSIONING |Запрос к объектам в доступной для чтения базе данных-получателе группе доступности Always On блокируется при управлении версиями строк при ожидании фиксации или отката всех транзакций, которые были выполнены, когда вторичная реплика была включена для рабочих нагрузок чтения. Этот тип ожидания гарантирует, что версии строк будут доступны до выполнения запроса в режиме изоляции моментального снимка. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|HADR_DB_COMMAND |Ожидание ответов на диалоговые сообщения (требующие явного ответа от другой стороны с помощью Always Onной инфраструктуры сообщений). Этот тип ожидания используется несколькими типами сообщений. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|HADR_DB_OP_COMPLETION_SYNC |Ожидание ответов на диалоговые сообщения (требующие явного ответа от другой стороны с помощью Always Onной инфраструктуры сообщений). Этот тип ожидания используется несколькими типами сообщений. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|HADR_DB_OP_START_SYNC |Инструкция DDL Always On или команда отказоустойчивой кластеризации Windows Server ожидает сериализованного доступа к базе данных доступности и ее состоянию выполнения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
...
|HADR_DBSEEDING |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|HADR_DBSEEDING_LIST |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|HADR_DBSTATECHANGE_SYNC |Управление параллелизмом ожидание обновления внутреннего состояния реплики базы данных. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|HADR_FABRIC_CALLBACK |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|HADR_FILESTREAM_BLOCK_FLUSH |Диспетчер транспорта FILESTREAM Always On ожидает завершения обработки блока журнала. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|HADR_FILESTREAM_FILE_CLOSE |Диспетчер транспорта FILESTREAM Always On ожидает обработки следующего файла FILESTREAM и закрытия его обработчика. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|HADR_FILESTREAM_FILE_REQUEST |Вторичная реплика Always On ожидает, пока первичная реплика отправит все запрошенные файлы FILESTREAM во время отмены. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|HADR_FILESTREAM_IOMGR |Диспетчер транспорта FILESTREAM Always On ожидает блокировки R/W, которая защищает ФАЙЛовый диспетчер ввода-вывода Always On во время запуска или завершения работы. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|HADR_FILESTREAM_IOMGR_IOCOMPLETION |Диспетчер ввода-вывода FILESTREAM Always On ожидает завершения ввода-вывода. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|HADR_FILESTREAM_MANAGER |Диспетчер транспорта FILESTREAM Always On ожидает блокировки R/W, которая защищает диспетчер транспорта FILESTREAM Always On во время запуска или завершения работы. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|HADR_FILESTREAM_PREPROC |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|HADR_GROUP_COMMIT |Механизм обработки фиксации транзакций ожидает, пока будет разрешена групповая фиксация, чтобы поместить несколько записей о фиксации транзакций в один блок журнала. Ожидание является ожидаемым условием, которое оптимизирует операции ввода-вывода журнала, записи и отправки. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|HADR_LOGCAPTURE_SYNC |Управление параллелизмом во время записи в журнал или применения объекта при создании или удалении операций просмотра. Это ожидаемое ожидание, когда партнеры меняют состояние или состояние соединения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|HADR_LOGCAPTURE_WAIT |Ожидание момента, когда записи журнала станут доступны. Это может произойти в том случае, если ожидается создание новых записей журнала соединениями или завершение ввода-вывода при чтении журнала, который не находится в кэше. Это ожидаемое ожидание, если просмотр журнала обнаруживается до конца журнала или считывается с диска. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|HADR_LOGPROGRESS_SYNC |Ожидание управления параллелизмом при обновлении состояния выполнения журналов реплик базы данных. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|HADR_NOTIFICATION_DEQUEUE |Фоновая задача, которая обрабатывает уведомления WSFC, ожидает следующего уведомления. Только для внутреннего использования. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
...
|HADR_NOTIFICATION_WORKER_STARTUP_SYNC |Фоновая задача ожидает окончания запуска фоновой задачи, которая обрабатывает уведомления WSFC. Только для внутреннего использования. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|HADR_NOTIFICATION_WORKER_TERMINATION_SYNC |Фоновая задача ожидает завершения работы фоновой задачи, которая обрабатывает уведомления WSFC. Только для внутреннего использования. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|HADR_PARTNER_SYNC |Ожидание управления параллелизмом в списке партнеров. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|HADR_READ_ALL_NETWORKS |Ожидание доступа к списку сетей WSFC для чтения или записи. Только для внутреннего применения. Примечание. ядро поддерживает список сетей WSFC, которые используются в динамических административных представлениях (например, sys. dm_hadr_cluster_networks) или для проверки Always On инструкций Transact-SQL, ссылающихся на сведения о сети WSFC. Этот список обновляется при запуске ядра, связанных с WSFC уведомлениях, а внутренняя Always On перезагрузке (например, при потере и повторном получении кворума WSFC). Обычно задачи будут блокироваться, пока выполняется обновление в этом списке. , <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|HADR_RECOVERY_WAIT_FOR_CONNECTION |Ожидание подключения базы данных-получателя к базе данных-источнику до начала восстановления. Это ожидаемое время ожидания, которое может увеличиться, если соединение с базой данных-источником замедлит установку. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|HADR_RECOVERY_WAIT_FOR_UNDO |Механизм восстановления базы данных ожидает, пока база данных-получатель закончит фазу восстановления и инициализации, которая вернет ее к общей временной точке в журнале с базой данных-источником. Это ожидаемое время ожидания после отработки отказа. Ход отмены можно отслеживать с помощью системного монитора Windows (Perfmon. exe) и динамических административных представлений. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|HADR_REPLICAINFO_SYNC |Ожидание обновления состояния текущей реплики с помощью управления параллелизмом. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|HADR_SEEDING_CANCELLATION |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|HADR_SEEDING_FILE_LIST |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|HADR_SEEDING_LIMIT_BACKUPS |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|HADR_SEEDING_SYNC_COMPLETION |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|HADR_SEEDING_TIMEOUT_TASK |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|HADR_SEEDING_WAIT_FOR_COMPLETION |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|HADR_SYNC_COMMIT |Механизм обработки фиксации транзакций ожидает, пока синхронизированные базы данных-получатели запишут журнал на диск. Это ожидание также отражается в счетчике производительности «Задержка транзакции». Этот тип ожидания ожидается для синхронизированных групп доступности и указывает время отправки, записи и подтверждения журнала в базах данных-получателях. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|HADR_SYNCHRONIZING_THROTTLE |Ожидание, пока механизм обработки фиксации транзакции разрешит синхронизацию базы данных-получателя с окончанием журнала базы данных-источника для перехода в синхронизированное состояние. Это ожидаемое время ожидания при перехвате базы данных-получателя. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
...
|HADR_TDS_LISTENER_SYNC_PROCESSING |Используется в конце Always On инструкции Transact-SQL, которая требует запуска или остановки прослушивателя группы доступности. Поскольку операция запуска/завершения выполняется асинхронно, пользовательский поток будет блокироваться с использованием этого типа ожидания до тех пор, пока не будет известно о ситуации прослушивателя. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|HADR_THROTTLE_LOG_RATE_GOVERNOR |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
...
|HADR_THROTTLE_LOG_RATE_LOG_SIZE |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] и более поздним версиям.| 
|HADR_THROTTLE_LOG_RATE_SEEDING |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] и более поздним версиям.| 
|HADR_THROTTLE_LOG_RATE_SEND_RECV_QUEUE_SIZE |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] и более поздним версиям.| 
|HADR_TIMER_TASK |Ожидание получения блокировки на объект задачи таймера. Используется также для реализации фактического ожидания между моментами времени, когда выполняется работа. Например, для задачи, которая выполняется каждые 10 секунд после одного выполнения, Always On группы доступности ожидают повторного планирования задачи в течение 10 секунд, а также сюда включается ожидание. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|HADR_TRANSPORT_DBRLIST |Ожидание доступа к списку реплик базы данных транспортного уровня. Используется для взаимоблокировки, предоставляющей доступ к ней. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|HADR_TRANSPORT_FLOW_CONTROL |Ожидание, когда количество неподтвержденных Always On сообщений превышает пороговое значение управления потоком. Это происходит в зависимости от реплики доступности в реплике (не на основе базы данных). <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|HADR_TRANSPORT_SESSION |Always On группы доступности ожидают изменения или доступа к базовому транспортному состоянию., <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|HADR_WORK_POOL |Управление параллелизмом ожидание объекта фоновой рабочей задачи "группы доступности Always On". <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|HADR_WORK_QUEUE |Always On фоновый рабочий поток групп доступности, ожидающих назначения новой работы. Это ожидаемое время ожидания, когда существуют готовые рабочие процессы, ожидающие новой работы, что является нормальным состоянием. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|HADR_XRF_STACK_ACCESS |Доступ (Поиск, Добавление и удаление) расширенного стека вилки восстановления для базы данных доступности Always On. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|HCCO_CACHE |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|HK_RESTORE_FILEMAP |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|HKCS_PARALLEL_MIGRATION |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|HKCS_PARALLEL_RECOVERY |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|хтбуилд |Происходит с параллельными планами пакетного режима при синхронизации сборки хэш-таблицы на входной стороне хэш-соединений и агрегирования. Если ожидание избыточно и не может быть уменьшено путем настройки запросов (например, добавлением индексов), рассмотрите возможность настройки параметра cost threshold for parallelism или уменьшите степень параллелизма. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
...
|HTTP_STORAGE_CONNECTION |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|IMPPROV_IOWAIT |Происходит, когда SQL Server ожидает завершения операции ввода-вывода Bulkload.| 
|INSTANCE_LOG_RATE_GOVERNOR |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
...
|IO_QUEUE_LIMIT |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
...
|LATCH_KP |Имеет место при ожидании кратковременной блокировки KP (удержания). Не включает в себя буферные кратковременные блокировки или кратковременные блокировки меток транзакции. Список ожиданий кратковременной блокировки\_ \* доступен в представлении sys. dm_os_latch_stats. Обратите внимание на то, что в представлении sys.dm_os_latch_stats ожидания LATCH_NL, LATCH_SH, LATCH_UP, LATCH_EX и LATCH_DT сгруппированы.| 
...
|LCK_M_BU_ABORT_BLOCKERS |Имеет место, когда задача ожидает получения блокировки для массового обновления (BU) с блокаторами аварийного завершения. (Относится к параметру Wait с низким приоритетом инструкции ALTER TABLE и ALTER INDEX.), <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|LCK_M_BU_LOW_PRIORITY |Имеет место, когда задача ожидает получения блокировки для массового обновления (BU) с низким приоритетом. (Относится к параметру Wait с низким приоритетом инструкции ALTER TABLE и ALTER INDEX.), <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
...
|LCK_M_IS_LOW_PRIORITY |Имеет место, когда задача ожидает получения блокировки с намерением коллективного доступа (IS) с низким приоритетом. (Относится к параметру Wait с низким приоритетом инструкции ALTER TABLE и ALTER INDEX.), <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
...
|LCK_M_IU_LOW_PRIORITY |Имеет место, когда задача ожидает получения блокировки с намерением обновления (IU) с низким приоритетом. (Относится к параметру Wait с низким приоритетом инструкции ALTER TABLE и ALTER INDEX.), <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
...
|LCK_M_IX_LOW_PRIORITY |Имеет место, когда задача ожидает получения блокировки с намерением монопольного доступа (IX) с низким приоритетом. (Относится к параметру Wait с низким приоритетом инструкции ALTER TABLE и ALTER INDEX.), <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
...
|LCK_M_S_ABORT_BLOCKERS |Имеет место, когда задача ожидает получения совмещаемой блокировки с блокаторами аварийного завершения. (Относится к параметру Wait с низким приоритетом инструкции ALTER TABLE и ALTER INDEX.), <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|LCK_M_S_LOW_PRIORITY |Имеет место, когда задача ожидает получения совмещаемой блокировки с низким приоритетом. (Относится к параметру Wait с низким приоритетом инструкции ALTER TABLE и ALTER INDEX.), <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|LCK_M_SCH_M |Имеет место, когда задача ожидает получения блокировки на изменение схемы.| 
|LCK_M_SCH_M_ABORT_BLOCKERS |Возникает, когда задача ожидает получения блокировки на изменение схемы с блокаторами аварийного завершения. (Относится к параметру Wait с низким приоритетом инструкции ALTER TABLE и ALTER INDEX.), <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|LCK_M_SCH_M_LOW_PRIORITY |Возникает, когда задача ожидает получения блокировки на изменение схемы с низким приоритетом. (Относится к параметру Wait с низким приоритетом инструкции ALTER TABLE и ALTER INDEX.), <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|LCK_M_SCH_S |Имеет место, когда задача ожидает получения совмещаемой блокировки схемы.| 
|LCK_M_SCH_S_ABORT_BLOCKERS |Возникает, когда задача ожидает получения совмещаемой блокировки схемы с блокаторами аварийного завершения. (Относится к параметру Wait с низким приоритетом инструкции ALTER TABLE и ALTER INDEX.), <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|LCK_M_SCH_S_LOW_PRIORITY |Возникает, когда задача ожидает получения совмещаемой блокировки схемы с низким приоритетом. (Относится к параметру Wait с низким приоритетом инструкции ALTER TABLE и ALTER INDEX.), <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|LCK_M_SIU |Имеет место, когда задача ожидает получения совмещаемой блокировки с намерением обновления.| 
|LCK_M_SIU_ABORT_BLOCKERS |Имеет место, когда задача ожидает получения совмещаемой блокировки обновления с блокаторами аварийного завершения. (Относится к параметру Wait с низким приоритетом инструкции ALTER TABLE и ALTER INDEX.), <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|LCK_M_SIU_LOW_PRIORITY |Возникает, когда задача ожидает получения совмещаемой блокировки обновления с низким приоритетом. (Относится к параметру Wait с низким приоритетом инструкции ALTER TABLE и ALTER INDEX.), <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
...
|LCK_M_U_ABORT_BLOCKERS |Имеет место, когда задача ожидает получения блокировки обновления с блокаторами аварийного завершения. (Относится к параметру Wait с низким приоритетом инструкции ALTER TABLE и ALTER INDEX.), <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|LCK_M_U_LOW_PRIORITY |Имеет место, когда задача ожидает получения блокировки обновления с низким приоритетом. (Относится к параметру Wait с низким приоритетом инструкции ALTER TABLE и ALTER INDEX.), <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
...
|LCK_M_X_ABORT_BLOCKERS |Имеет место, когда задача ожидает получения монопольной блокировки с блокаторами аварийного завершения. (Относится к параметру Wait с низким приоритетом инструкции ALTER TABLE и ALTER INDEX.), <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|LCK_M_X_LOW_PRIORITY |Имеет место, когда задача ожидает получения монопольной блокировки с низким приоритетом. (Относится к параметру Wait с низким приоритетом инструкции ALTER TABLE и ALTER INDEX.), <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|LOG_POOL_SCAN |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|LOG_RATE_GOVERNOR |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
...
|LOGCAPTURE_LOGPOOLTRUNCPOINT |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
...
|LOGMGR_PMM_LOG |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
...
|LOGPOOL_CACHESIZE |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|LOGPOOL_CONSUMER |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|LOGPOOL_CONSUMERSET |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|LOGPOOL_FREEPOOLS |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|LOGPOOL_MGRSET |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|LOGPOOL_REPLACEMENTSET |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|LOGPOOLREFCOUNTEDOBJECT_REFDONE |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|LOWFAIL_MEMMGR_QUEUE |Имеет место при ожидании доступности памяти для использования.| 
|MD_AGENT_YIELD |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|MD_LAZYCACHE_RWLOCK |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|MEMORY_ALLOCATION_EXT |Имеет место при выделении памяти из внутреннего пула памяти SQL Server или операционной системы. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|MEMORY_GRANT_UPDATE |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] и более поздним версиям.| 
|METADATA_LAZYCACHE_RWLOCK |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssKilimanjaro_md](../../includes/sskilimanjaro-md.md)] только. |  
|мигратионбуффер |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] и более поздним версиям.| 
...
|нетворксксмлмгрлоад |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|NODE_CACHE_MUTEX |Только для внутреннего применения.| 
|OLEDB |Происходит, когда SQL Server вызывает поставщик SQL Server Native Client OLE DB. Этот тип ожидания не используется для синхронизации. Он указывает на длительность вызовов поставщика OLE DB.| 
...
|PARALLEL_REDO_DRAIN_WORKER |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|PARALLEL_REDO_FLOW_CONTROL |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|PARALLEL_REDO_LOG_CACHE |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|PARALLEL_REDO_TRAN_LIST |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|PARALLEL_REDO_TRAN_TURN |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|PARALLEL_REDO_WORKER_SYNC |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|PARALLEL_REDO_WORKER_WAIT_WORK |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|PERFORMANCE_COUNTERS_RWLOCK |Только для внутреннего применения.| 
|PHYSICAL_SEEDING_DMV |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|POOL_LOG_RATE_GOVERNOR |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
...
|PREEMPTIVE_AUDIT_ACCESS_EVENTLOG |Происходит, если планировщик операционной системы SQLOS [!INCLUDE[ssNoVersion_md](../../includes/ssnoversion-md.md)] переключается в режим с вытеснением, чтобы записать событие аудита в журнал событий Windows. <br /> **Применимо к**: [!INCLUDE[ssKilimanjaro_md](../../includes/sskilimanjaro-md.md)] только. |  
|PREEMPTIVE_AUDIT_ACCESS_SECLOG |Происходит, если планировщик SQLOS переключается в режим с вытеснением, чтобы записать событие аудита в журнал безопасности Windows. <br /> **Применимо к**: [!INCLUDE[ssKilimanjaro_md](../../includes/sskilimanjaro-md.md)] только. |  
...
|PREEMPTIVE_HADR_LEASE_MECHANISM |Always On группы доступности. расписание диспетчера аренды для диагностики служба поддержки Майкрософт. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|PREEMPTIVE_HTTP_EVENT_WAIT |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|PREEMPTIVE_HTTP_REQUEST |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
...
|PREEMPTIVE_OS_GETFINALFILEPATHBYHANDLE |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
...
|PREEMPTIVE_OS_PDH_WMI_INIT |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|PREEMPTIVE_OS_PIPEOPS |Только для внутреннего применения.| 
|PREEMPTIVE_OS_PROCESSOPS |Только для внутреннего применения.| 
|PREEMPTIVE_OS_QUERYCONTEXTATTRIBUTES |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
...
|PREEMPTIVE_OS_VERIFYTRUST |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
...
|PREEMPTIVE_SP_SERVER_DIAGNOSTICS |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
...
|PREEMPTIVE_XE_CX_FILE_OPEN |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|PREEMPTIVE_XE_CX_HTTP_CALL |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
...
|PRU_ROLLBACK_DEFERRED |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|PWAIT_ALL_COMPONENTS_INITIALIZED |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|PWAIT_COOP_SCAN |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|PWAIT_DIRECTLOGCONSUMER_GETNEXT |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|PWAIT_EVENT_SESSION_INIT_MUTEX |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|PWAIT_FABRIC_REPLICA_CONTROLLER_DATA_LOSS |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|PWAIT_HADR_ACTION_COMPLETED |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|PWAIT_HADR_CHANGE_NOTIFIER_TERMINATION_SYNC |Имеет место, когда фоновая задача ожидает завершения фоновой задачи, которая получает (через опрос) уведомления отказоустойчивой кластеризации Windows Server. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
...
|PWAIT_HADR_FAILOVER_COMPLETED |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|PWAIT_HADR_JOIN |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|PWAIT_HADR_OFFLINE_COMPLETED |Операция удаления группы доступности Always On ожидает перехода целевой группы доступности в режим «вне сети» перед удалением объектов отказоустойчивой кластеризации Windows Server. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|PWAIT_HADR_ONLINE_COMPLETED |Операция создания или отработки отказа группы доступности Always On ожидает перехода целевой группы доступности в режим "в сети". <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|PWAIT_HADR_POST_ONLINE_COMPLETED |Операция удаления группы доступности Always On ожидает завершения выполнения фоновой задачи, которая была запланирована как часть предыдущей команды. Например, это может быть фоновая задача, которая превращает базы данных доступности в основные базы данных. Инструкция DROP AVAILABILITY GROUP DDL должна ждать завершения этой фоновой задачи, чтобы избежать конкуренции. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|PWAIT_HADR_SERVER_READY_CONNECTIONS |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|PWAIT_HADR_WORKITEM_COMPLETED |Внутреннее ожидание: поток ожидает завершения асинхронной рабочей задачи. Это ожидаемое ожидание и предназначено для использования в CSS. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|PWAIT_HADRSIM |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|PWAIT_LOG_CONSOLIDATION_IO |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|PWAIT_LOG_CONSOLIDATION_POLL |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|PWAIT_MD_LOGIN_STATS |Имеет место в процессе внутренней синхронизации в метаданных по статистике имени входа. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|PWAIT_MD_RELATION_CACHE |Имеет место во время внутренней синхронизации в метаданных таблицы или индекса. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|PWAIT_MD_SERVER_CACHE |Имеет место во время внутренней синхронизации в метаданных связанных серверов. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|PWAIT_MD_UPGRADE_CONFIG |Имеет место во время внутренней синхронизации при обновлении конфигураций на уровне сервера. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|PWAIT_PREEMPTIVE_APP_USAGE_TIMER |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] и более поздним версиям.| 
|PWAIT_PREEMPTIVE_AUDIT_ACCESS_WINDOWSLOG |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|PWAIT_QRY_BPMEMORY |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|PWAIT_REPLICA_ONLINE_INIT_MUTEX |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|PWAIT_RESOURCE_SEMAPHORE_FT_PARALLEL_QUERY_SYNC |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|PWAIT_SBS_FILE_OPERATION |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] и более поздним версиям.| 
|PWAIT_XTP_FSSTORAGE_MAINTENANCE |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|PWAIT_XTP_HOST_STORAGE_WAIT |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|QDS_ASYNC_CHECK_CONSISTENCY_TASK |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|QDS_ASYNC_PERSIST_TASK |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|QDS_ASYNC_PERSIST_TASK_START |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|QDS_ASYNC_QUEUE |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|QDS_BCKG_TASK |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|QDS_BLOOM_FILTER |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|QDS_CLEANUP_STALE_QUERIES_TASK_MAIN_LOOP_SLEEP |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|QDS_CTXS |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|QDS_DB_DISK |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|QDS_DYN_VECTOR |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|QDS_EXCLUSIVE_ACCESS |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|QDS_HOST_INIT |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] и более поздним версиям.| 
|QDS_LOADDB |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|QDS_PERSIST_TASK_MAIN_LOOP_SLEEP |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|QDS_QDS_CAPTURE_INIT |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|QDS_SHUTDOWN_QUEUE |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|QDS_STMT |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|QDS_STMT_DISK |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|QDS_TASK_SHUTDOWN |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|QDS_TASK_START |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|QE_WARN_LIST_SYNC |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
...
|QRY_PARALLEL_THREAD_MUTEX |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|QRY_PROFILE_LIST_MUTEX |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|QUERY_ERRHDL_SERVICE_DONE |Указано только в ознакомительных целях. Не поддерживается. <br /> **Применимо к**: [!INCLUDE[ssKilimanjaro_md](../../includes/sskilimanjaro-md.md)] только. |  
|QUERY_WAIT_ERRHDL_SERVICE |Указано только в ознакомительных целях.  Не поддерживается. <br /> **Применимо к**: [!INCLUDE[ssKilimanjaro_md](../../includes/sskilimanjaro-md.md)] только.  |  
...
|QUERY_TASK_ENQUEUE_MUTEX |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
...
|RBIO_WAIT_VLF |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] и более поздним версиям.| 
|RBIO_RG_STORAGE |Происходит, когда масштабируемый узел базы данных масштабируется из-за отложенного потребления журнала на серверах страниц. <br /> Область **применения**: масштабирование базы данных SQL Azure.|
|RBIO_RG_DESTAGE |Происходит, когда масштабируемый узел базы данных масштабируется в соответствии с задержкой использования журнала долговременным хранилищем журналов. <br /> Область **применения**: масштабирование базы данных SQL Azure.|
|RBIO_RG_REPLICA |Происходит, когда масштабируемый узел базы данных масштабируется из-за отложенного использования журнала вторичными узлами реплик. <br /> Область **применения**: масштабирование базы данных SQL Azure.|
|RBIO_RG_LOCALDESTAGE |Происходит при регулируемом масштабировании масштабируемого узла базы данных в связи с задержкой использования журнала службой журнала. <br /> Область **применения**: масштабирование базы данных SQL Azure.|
|RECOVER_CHANGEDB |Имеет место в процессе синхронизации состояния базы данных в режиме «горячего» резервирования.| 
|RECOVERY_MGR_LOCK |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|REDO_THREAD_PENDING_WORK |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|REDO_THREAD_SYNC |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|REMOTE_BLOCK_IO |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] и более поздним версиям.| 
|REMOTE_DATA_ARCHIVE_MIGRATION_DMV |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|REMOTE_DATA_ARCHIVE_SCHEMA_DMV |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|REMOTE_DATA_ARCHIVE_SCHEMA_TASK_QUEUE |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
...
|REPL_TRANFSINFO_ACCESS |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|REPL_TRANHASHTABLE_ACCESS |Только для внутреннего применения.| 
|REPL_TRANTEXTINFO_ACCESS |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
...
|RESERVED_MEMORY_ALLOCATION_EXT |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
...
|RESOURCE_GOVERNOR_IDLE |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
...
|RESOURCE_SEMAPHORE_SMALL_QUERY |Имеет место в случае, когда небольшой запрос не может быть выполнен немедленно из-за других параллельных запросов. Время ожидания не должно превышать нескольких секунд, так как при невозможности выделения запрошенной памяти в течение нескольких секунд сервер передает запрос в главный пул памяти для запросов. Высокие значения ожиданий могут указывать на чрезмерное количество параллельных небольших запросов, в то время как главный пул памяти заблокирован ожидающими запросами. <br /> **Применимо к**: [!INCLUDE[ssKilimanjaro_md](../../includes/sskilimanjaro-md.md)] только. |  
|RESTORE_FILEHANDLECACHE_ENTRYLOCK |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|RESTORE_FILEHANDLECACHE_LOCK |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|RG_RECONFIG |Только для внутреннего применения.| 
|ROWGROUP_OP_STATS |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|ROWGROUP_VERSION |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|RTDATA_LIST |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|SATELLITE_CARGO |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|SATELLITE_SERVICE_SETUP |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|SATELLITE_TASK |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|SBS_DISPATCH |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] и более поздним версиям.| 
|SBS_RECEIVE_TRANSPORT |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] и более поздним версиям.| 
|SBS_TRANSPORT |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] и более поздним версиям.| 
|SCAN_CHAR_HASH_ARRAY_INITIALIZATION |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|SEC_DROP_TEMP_KEY |Имеет место после неудачной попытки удаления временного ключа безопасности перед повторной попыткой.| 
|SECURITY_CNG_PROVIDER_MUTEX |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] и более поздним версиям.| 
|SECURITY_CRYPTO_CONTEXT_MUTEX |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|SECURITY_DBE_STATE_MUTEX |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|SECURITY_KEYRING_RWLOCK |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
...
|SECURITY_RULETABLE_MUTEX |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|SEMPLAT_DSI_BUILD |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|SEQUENCE_GENERATION |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|SEQUENTIAL_GUID |Имеет место при получении нового последовательного значения идентификатора GUID.| 
|SERVER_IDLE_CHECK |Имеет место в процессе синхронизации состояния простоя экземпляра SQL Server, когда монитор ресурсов пытается объявить SQL Server экземпляр как бездействующий или пытается выполнить выход из системы.| 
|SERVER_RECONFIGURE |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|SESSION_WAIT_STATS_CHILDREN |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|SHARED_DELTASTORE_CREATION |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
...
|SLEEP_BUFFERPOOL_HELPLW |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|SLEEP_DBSTARTUP |Имеет место в процессе запуска базы данных при ожидании восстановления всех баз данных.| 
|SLEEP_DCOMSTARTUP |Происходит один раз в течение максимума во время запуска экземпляра SQL Server во время ожидания завершения инициализации DCOM.| 
|SLEEP_MASTERDBREADY |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|SLEEP_MASTERMDREADY |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|SLEEP_MASTERUPGRADED |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|SLEEP_MEMORYPOOL_ALLOCATEPAGES |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|SLEEP_MSDBSTARTUP |Имеет место при ожидании трассировки SQL запуска базы данных msdb.| 
|SLEEP_RETRY_VIRTUALALLOC |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
...
|SLEEP_WORKSPACE_ALLOCATEPAGE |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|SLO_UPDATE |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|смсинк |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|SNI_CONN_DUP |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|SNI_CRITICAL_SECTION |Происходит во время внутренней синхронизации в SQL Server сетевых компонентах.| 
|SNI_HTTP_WAITFOR_0_DISCON |Происходит при SQL Server завершении работы, пока ожидаются необработанные HTTP-соединения.| 
...
|SNI_WRITE_ASYNC |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] и более поздним версиям.| 
...
|SOCKETDUPLICATEQUEUE_CLEANUP |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
...
|SOS_LOCALALLOCATORLIST |Имеет место в процессе внутренней синхронизации в диспетчере памяти [!INCLUDE[ssNoVersion_md](../../includes/ssnoversion-md.md)]. <br /> **Применимо к**: [!INCLUDE[ssKilimanjaro_md](../../includes/sskilimanjaro-md.md)] только. |  
|SOS_MEMORY_TOPLEVELBLOCKALLOCATOR |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
...
|SOS_PHYS_PAGE_CACHE |Определяет время ожидания потока для получения объекта взаимного исключения, который он должен получить перед выделением физических страниц или перед возвращением этих страниц операционной системе. Ожидание этого типа появляется только в том случае, если экземпляр SQL Server использует память AWE. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|SOS_PROCESS_AFFINITY_MUTEX |Имеет место в процессе синхронизации доступа для обработки настроек схожести.| 
|SOS_RESERVEDMEMBLOCKLIST |Происходит во время внутренней синхронизации в диспетчере SQL Server памяти. <br /> **Применимо к**: [!INCLUDE[ssKilimanjaro_md](../../includes/sskilimanjaro-md.md)] только. |  
...
|SOS_SYNC_TASK_ENQUEUE_EVENT |Имеет место при запуске задачи в синхронном режиме. Большинство задач в SQL Server запускаются асинхронно, в котором управление возвращается в начало сразу после того, как запрос задачи был помещен в рабочую очередь.| 
...
|SOSHOST_EVENT |Происходит, когда размещенный компонент, например CLR, ожидает SQL Server объект синхронизации событий.| 
...
|SOSHOST_MUTEX |Происходит, когда размещенный компонент, например CLR, ожидает объект синхронизации SQL Server Mutex.| 
|SOSHOST_RWLOCK |Происходит, когда размещенный компонент, например CLR, ожидает объект синхронизации SQL Server чтения и записи.| 
|SOSHOST_SEMAPHORE |Происходит, когда размещенный компонент, например CLR, ожидает объект синхронизации SQL Serverного семафора.| 
...
|SP_PREEMPTIVE_SERVER_DIAGNOSTICS_SLEEP |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|SP_SERVER_DIAGNOSTICS_BUFFER_ACCESS |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|SP_SERVER_DIAGNOSTICS_INIT_MUTEX |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|SP_SERVER_DIAGNOSTICS_SLEEP |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
...
|SQLTRACE_BUFFER_FLUSH |Имеет место, когда задача ожидает сохранения фоновой задачей буферов трассировки на диск каждые четыре секунды. <br /> **Применимо к**: [!INCLUDE[ssKilimanjaro_md](../../includes/sskilimanjaro-md.md)] только. |  
|SQLTRACE_FILE_BUFFER |Происходит во время синхронизации буферов трассировки во время трассировки файла. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|SQLTRACE_FILE_READ_IO_COMPLETION |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|SQLTRACE_FILE_WRITE_IO_COMPLETION |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|SQLTRACE_INCREMENTAL_FLUSH_SLEEP |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|SQLTRACE_LOCK |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssKilimanjaro_md](../../includes/sskilimanjaro-md.md)] только. |  
|SQLTRACE_PENDING_BUFFER_WRITERS |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
...
|STARTUP_DEPENDENCY_MANAGER |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|TDS_BANDWIDTH_STATE |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|TDS_INIT |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|TDS_PROXY_CONTAINER |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
...
|TEMPORAL_BACKGROUND_PROCEED_CLEANUP |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] и более поздним версиям.| 
|TERMINATE_LISTENER |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
...
|UCS_ENDPOINT_CHANGE |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|UCS_MANAGER |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|UCS_MEMORY_NOTIFICATION |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|UCS_SESSION_REGISTRATION |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|UCS_TRANSPORT |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|UCS_TRANSPORT_STREAM_CHANGE |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
...
|VDI_CLIENT_COMPLETECOMMAND |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|VDI_CLIENT_GETCOMMAND |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|VDI_CLIENT_OPERATION |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|VDI_CLIENT_OTHER |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|VERSIONING_COMMITTING |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
...
|WAIT_SCRIPTDEPLOYMENT_REQUEST |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|WAIT_SCRIPTDEPLOYMENT_WORKER |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|WAIT_XLOGREAD_SIGNAL |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] и более поздним версиям.| 
|WAIT_XTP_ASYNC_TX_COMPLETION |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|WAIT_XTP_CKPT_AGENT_WAKEUP |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|WAIT_XTP_CKPT_CLOSE |Имеет место при ожидании завершения контрольной точки. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|WAIT_XTP_CKPT_ENABLED |Происходит при отключении контрольных точек и ожидании включения контрольных точек. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|WAIT_XTP_CKPT_STATE_LOCK |Происходит при синхронизации проверки состояния контрольной точки. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
...
|WAIT_XTP_GUEST |Происходит, когда механизму выделения памяти базы данных необходимо отключить получение уведомлений о нехватке памяти. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|WAIT_XTP_HOST_WAIT |Происходит, когда ядро СУБД инициирует ожидания и реализуется узлом. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|WAIT_XTP_OFFLINE_CKPT_BEFORE_REDO |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|WAIT_XTP_OFFLINE_CKPT_LOG_IO |Происходит, когда автономная контрольная точка ожидает завершения операций чтения журнала. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|WAIT_XTP_OFFLINE_CKPT_NEW_LOG |Происходит, когда автономная контрольная точка ожидает сканирования новых записей журнала. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|WAIT_XTP_PROCEDURE_ENTRY |Происходит, когда процедура удаления ожидает завершения всех текущих выполнений этой процедуры. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|WAIT_XTP_RECOVERY |Происходит, когда восстановление базы данных ожидает завершения восстановления оптимизированных для памяти объектов. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|WAIT_XTP_SERIAL_RECOVERY |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] и более поздним версиям.| 
|WAIT_XTP_SWITCH_TO_INACTIVE |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|WAIT_XTP_TASK_SHUTDOWN |Имеет место при ожидании завершения потока выполняющейся в памяти OLTP. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|WAIT_XTP_TRAN_DEPENDENCY |Имеет место при ожидании зависимостей транзакций. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
...
|WAITFOR_PER_QUEUE |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
...
|WINDOW_AGGREGATES_MULTIPASS |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|WINFAB_API_CALL |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|WINFAB_REPLICA_BUILD_OPERATION |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|WINFAB_REPORT_FAULT |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
...
|XDB_CONN_DUP_HASH |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|XDES_HISTORY |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|XDES_OUT_OF_ORDER_LIST |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|XDES_SNAPSHOT |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|ксдестсвермгр |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
...
|XE_CALLBACK_LIST |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
|XE_CX_FILE_READ |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
...
|XE_FILE_TARGET_TVF |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|XE_LIVE_TARGET_TVF |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.| 
...
|XE_PACKAGE_LOCK_BACKOFF |Указано только в ознакомительных целях. Не поддерживается. <br /> **Применимо к**: [!INCLUDE[ssKilimanjaro_md](../../includes/sskilimanjaro-md.md)] только. |  
...
|XIO_CREDENTIAL_MGR_RWLOCK |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|XIO_CREDENTIAL_RWLOCK |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|XIO_EDS_MGR_RWLOCK |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] и более поздним версиям.| 
|XIO_EDS_RWLOCK |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] и более поздним версиям.| 
|XIO_IOSTATS_BLOBLIST_RWLOCK |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] и более поздним версиям.| 
|XIO_IOSTATS_FCBLIST_RWLOCK |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] и более поздним версиям.| 
|XIO_LEASE_RENEW_MGR_RWLOCK |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|XTP_HOST_DB_COLLECTION |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|XTP_HOST_LOG_ACTIVITY |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|XTP_HOST_PARALLEL_RECOVERY |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|XTP_PREEMPTIVE_TASK |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|XTP_TRUNCATION_LSN |Только для внутреннего применения. <br /> **Применимо к**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] и более поздним версиям.| 
|XTPPROC_CACHE_ACCESS |Имеет место при доступе ко всем объектам кэша хранимых процедур, скомпилированным в собственном формате. <br /> **Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и более поздним версиям.| 
|XTPPROC_PARTITIONED_STACK_CREATE |Возникает при выделении структуры кэша хранимых процедур для каждого NUMA, скомпилированной в собственном режиме (для каждой конкретной процедуры должна быть выполнена одна потоковая передача). <br /> **Применимо к**: [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] и более поздним версиям.|
