...
|**socket_count** |**int** | **Применимо к:** с [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] с пакетом обновления 2 (SP2) по [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)].<br /><br />Указывает число разъемов процессора, доступных в системе. |  
|**cores_per_socket** |**int** | **Применимо к:** с [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] с пакетом обновления 2 (SP2) по [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)].<br /><br />Указывает число процессоров на каждый сокет, доступный в системе. |  
|**numa_node_count** |**int** | **Применимо к:** с [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] с пакетом обновления 2 (SP2) по [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)].<br /><br />Указывает количество узлов NUMA, доступных в системе. В этом столбце содержатся физические узлы NUMA, а также мягкие узлы NUMA. |  
