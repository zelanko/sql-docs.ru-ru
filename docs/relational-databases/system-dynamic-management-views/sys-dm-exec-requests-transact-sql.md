...
|is_resumable |**бит** |**Область применения**: [!INCLUDE[sssqlv14-md](../../includes/sssqlv14-md.md)] и более поздних версий.<br /><br /> Указывает, является ли запрос возобновляемой операцией с индексом. |  
...
Затем, чтобы найти сведения о блокировке, используйте скопированный `transaction_id` с системной функцией **sys. dm_tran_locks**.  
