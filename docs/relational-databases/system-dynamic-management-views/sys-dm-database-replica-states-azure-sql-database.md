---
title: sys. DM _database_replica_states (база данных SQL Azure) | Документация Майкрософт
ms.custom: ''
ms.date: 05/22/2019
ms.prod: sql
ms.reviewer: ''
...
|Имя столбца|Data type|Описание (в основной реплике)|  
|-----------------|---------------|----------------------------------------|  
|**database_id**|**int**|Идентификатор базы данных.|  
|**group_id**|**ssNoversion**|Идентификатор группы доступности, к которой принадлежит база данных.|  
|**replica_id**|**ssNoversion**|Идентификатор реплики доступности в группе доступности.|  
|**group_database_id**|**ssNoversion**|Идентификатор базы данных из группы доступности. Этот идентификатор совпадает на всех репликах, к которым присоединена эта база данных.|  
...
|**is_primary_replica**|**бит**|Возвращает 1, если реплика является первичной, или 0, если это вторичная реплика в группе доступности, к которой принадлежит база данных. Это не относится к базе данных-источнику или получателю в распределенной группе доступности или связи активной георепликации.<br /><br />**Применимо к**: с [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] до [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)].|  
...
|**synchronization_health**|**tinyint**|Отражает пересечение состояния синхронизации базы данных, присоединенной к группе доступности в реплике доступности, и режим доступности реплики доступности (режим синхронной фиксации или асинхронной фиксации), один из следующие значения.<br /><br /> 0 = неработоспособен. **Synchronization_state** базы данных — 0 (а не синхронизация).<br /><br /> 1 = частично работоспособно. База данных в реплике доступности с синхронной фиксацией считается частично работоспособной, если **synchronization_state** равен 1 (синхронизация).<br /><br /> 2 = работоспособный. База данных в реплике доступности с синхронной фиксацией считается работоспособной, если **synchronization_state** имеет значение 2 (синхронизировано), а база данных в реплике доступности с асинхронной фиксацией считается работоспособной, если **synchronization_state** равно 1 (синхронизация).|  
...
|**database_state_desc**|**nvarchar(60)**|Описание **database_state** реплики доступности.<br /><br /> ONLINE<br /><br /> RESTORING<br /><br /> RECOVERING<br /><br /> RECOVERY_PENDING<br /><br /> SUSPECT<br /><br /> EMERGENCY<br /><br /> OFFLINE<br /><br /> **Примечание.** То же, что и столбец **state_desc** в таблице sys. databases.|  
