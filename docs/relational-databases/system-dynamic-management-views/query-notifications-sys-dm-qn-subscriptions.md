...
|-----------------|---------------|-----------------|  
|**удостоверения**|**int**|Идентификатор подписки.|  
...
## <a name="see-also"></a>См. также:  
 ...
 [УДАЛИТЬ подписку на уведомления о ЗАПРОСах &#40;&#41;Transact-SQL](../../t-sql/language-elements/kill-query-notification-subscription-transact-sql.md)  
