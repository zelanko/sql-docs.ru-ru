...
> **Примечание.** Чтобы вызвать это из [!INCLUDE[ssSDWfull](../../includes/sssdwfull-md.md)] или [!INCLUDE[ssPDW](../../includes/sspdw-md.md)], используйте имя **sys. dm_pdw_nodes_exec_sessions**.  
...
**[!INCLUDE[ssNoVersion_md](../../includes/ssnoversion-md.md)]:** Для просмотра всех сеансов на сервере требуется `VIEW SERVER STATE` разрешение на [!INCLUDE[ssNoVersion_md](../../includes/ssnoversion-md.md)].  
**[!INCLUDE[ssSDS_md](../../includes/sssds-md.md)]:** Для просмотра всех соединений с текущей базой данных требуется `VIEW DATABASE STATE`. не удается предоставить `VIEW DATABASE STATE` в базе данных `master`. 
