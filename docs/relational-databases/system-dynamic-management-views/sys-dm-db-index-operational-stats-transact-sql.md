...
-   Разрешение на просмотр состояния сервера для возврата сведений обо всех базах данных с помощью шаблона Database @*database_id* = null    
