...
|**pages_allocated_count**|**int**|**Применимо к** [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] : [!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)]с до.<br /><br /> Число страниц, выделенных данным объектом. Не допускает значение NULL.|  
...
|**max_pages_allocated_count**|**int**|**Применимо к** [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] : [!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)]с до.<br /><br /> Максимальное число страниц, выделенных данным объектом. Не допускает значение NULL.|  
