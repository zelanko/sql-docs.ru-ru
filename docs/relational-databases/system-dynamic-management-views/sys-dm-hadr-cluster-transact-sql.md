---
title: "sys.dm_hadr_cluster (Transact-SQL) | Документы Microsoft"
ms.custom: 
ms.date: 06/10/2016
...
|-----------------|---------------|-----------------|  
|**имя_кластера**|**nvarchar(128)**|Имя кластера WSFC, содержащего экземпляры [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)], в которых включена поддержка [!INCLUDE[ssHADR](../../includes/sshadr-md.md)].|  
...
|**quorum_type_desc**|**varchar(50)**|Описание **quorum_type**, одно из:<br /><br /> NODE_MAJORITY<br /><br /> NODE_AND_DISK_MAJORITY<br /><br /> NODE_AND_FILE_SHARE_MAJORITY<br /><br /> NO_MAJORITY:_DISK_ONLY|  
...
|**quorum_state_desc**|**varchar(50)**|Описание **quorum_state**, одно из:<br /><br /> UNKNOWN_QUORUM_STATE<br /><br /> NORMAL_QUORUM<br /><br /> FORCED_QUORUM|  
