 ...
 **Индексы**  
 ...
 Если кластеризованный индекс отключен, или если принудительно некластеризованного индекса, возникает следующая ошибка: «обработчик запросов не удалось предоставить план, так как индекс "%. \*ls для таблицы или представления "%. \*ls отключен.» Для повторного включения данных объектов необходимо перестроить индексы после обновления путем вызова **ALTER INDEX ON... ПЕРЕСТРОИТЬ**.  
  
 **Куч**  
  
 При использовании таблицы с отключенной кучей возникает следующая ошибка. Для повторного включения данных объектов, перестройте после обновления путем вызова **ALTER INDEX все ON... ПЕРЕСТРОИТЬ**.  
