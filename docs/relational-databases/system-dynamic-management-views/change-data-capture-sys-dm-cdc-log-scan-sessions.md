...
|**длитель**|**bigint**|Продолжительность сеанса в секундах.<br /><br /> Значение 0 означает, что сеанс не содержит транзакций системы отслеживания измененных данных.<br /><br /> Если **session_id** = 0, то сумма длительности (в секундах) всех сеансов с транзакциями системы отслеживания измененных данных.|  
