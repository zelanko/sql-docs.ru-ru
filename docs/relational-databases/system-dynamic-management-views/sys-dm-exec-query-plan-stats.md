...
Это функция по требованию, требующий [флаг трассировки](../../t-sql/database-console-commands/dbcc-traceon-trace-flags-transact-sql.md) 2451 требуется включить.   
...
<sup>1</sup> это относится к инструкции Showplan, который содержит только узел оператор задания корневого каталога (SELECT). 
