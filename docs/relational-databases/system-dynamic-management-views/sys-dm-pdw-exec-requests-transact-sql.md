...
|database_id|**int**|Идентификатор базы данных, используемые контекстом явное (например, используйте DB_X).|В разделе с кодом в [sys.databases &#40; Transact-SQL &#41; ](../../relational-databases/system-catalog-views/sys-databases-transact-sql.md).|  
