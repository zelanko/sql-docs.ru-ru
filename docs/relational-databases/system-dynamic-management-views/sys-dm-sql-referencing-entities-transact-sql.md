---
title: sys.dm_sql_referencing_entities (Transact-SQL) | Документы Microsoft
ms.custom: ''
ms.date: 06/10/2016
ms.prod: sql
 ...
 *< Referenced_class >* :: = {ОБЪЕКТА | ТИП | XML_SCHEMA_COLLECTION | PARTITION_FUNCTION}  
