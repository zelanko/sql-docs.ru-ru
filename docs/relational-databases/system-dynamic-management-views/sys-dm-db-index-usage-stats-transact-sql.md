...
## <a name="remarks"></a>Remarks  
 ...
 Во время обновления [!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)]до [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)], или [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)]записи в sys. dm_db_index_usage_stats удаляются. Начиная с [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)]версии, записи сохраняются в том виде, в котором [!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)]они были раньше.  
