...
|-----------------|---------------|-----------------|-----------|  
|pdw_node_id|**int**|Идентификатор затрагиваемого узла.<br /><br /> pdw_node_id и thread_id формируют ключ для этого представления.|См. раздел node_id в [sys. dm_pdw_nodes &#40;&#41;Transact-SQL ](../../relational-databases/system-dynamic-management-views/sys-dm-pdw-nodes-transact-sql.md).|  
