...
|**функция ERROR_STATE**|**int**|Если происходит сбой обновления схемы архив удаленных данных, состояние ошибки, возникшей; в противном случае — значение null. Функция error_state указывает условие или расположение, где произошла ошибка.|  
