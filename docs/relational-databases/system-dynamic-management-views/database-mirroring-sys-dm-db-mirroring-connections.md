...
---
# <a name="database-mirroring---sysdmdbmirroringconnections"></a>Базы данных зеркальное отображение — sys.dm_db_mirroring_connections
...
|**transport_stream_id**|**uniqueidentifier**|Идентификатор [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] подключения сетевой интерфейс (SNI), используемый в данном соединении по протоколу TCP/IP.|  
