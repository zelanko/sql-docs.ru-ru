 ...
 *stoplist_id*  
 Идентификатор списка стоп-слов, если таковое имеется, используемый средством разбиения по словам, идентифицируемый *lcid*. *stoplist_id* — **int**. Если указать значение «NULL» используется без списка стоп-слов. Если указано значение 0, используется системный список стоп-слов.  
