...
|Состояние|**smallint**|0 — СОЗДАНО ПРЕДВАРИТЕЛЬНО<br /><br /> 1 — В ПРОЦЕССЕ СОЗДАНИЯ<br /><br /> 2 — ACTIVE<br /><br /> 3. ЦЕЛЬ СЛИЯНИЯ<br /><br /> 8-ОЖИДАНИЕ УСЕЧЕНИЯ ЖУРНАЛА|  
...
|encryption_status_desc|**nvarchar(60)**|0 => НЕЗАШИФРОВАННЫЕ<br /><br /> 1 => ЗАШИФРОВАНО КЛЮЧОМ 1<br /><br /> 2 => ЗАШИФРОВАНО КЛЮЧОМ 2. Допустимо только для активных файлов.|  
...
## <a name="use-cases"></a>Варианты использования  
 Хранилище, используемое In-Memory OLTP, можно оценить следующим образом:  
