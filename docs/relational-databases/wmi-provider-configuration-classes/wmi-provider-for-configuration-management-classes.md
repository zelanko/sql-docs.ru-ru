---
title: Поставщик WMI для классов управления конфигурацией
description: Обнаружение и реализация функций, предоставляемых инструментарий управления Windows (WMI). Выберите один из этих классов для Configuration Manager.
ms.custom: ''
ms.date: 03/06/2017
ms.prod: sql
