---
title: Свойство NumberOfFlags (класс SInstance) | Документация Майкрософт
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "62515499"
---
# <a name="numberofflags-property-sinstance-class"></a>Свойство NumberOfFlags (класс SInstance)
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]
  Возвращает число флагов для экземпляра [!INCLUDE[msCoName](../../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)].  
...
## <a name="property-valuereturn-value"></a>Значение свойства/возвращаемое значение  
 Объект **uint32** значение, указывающее число флагов для экземпляра [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)].  
