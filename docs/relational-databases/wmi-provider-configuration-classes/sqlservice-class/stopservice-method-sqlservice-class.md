---
title: "Метод StopService (класс SqlService) | Документы Microsoft"
ms.custom: 
ms.date: 03/03/2017
...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]Пытается перевести службу в остановленное состояние.  
