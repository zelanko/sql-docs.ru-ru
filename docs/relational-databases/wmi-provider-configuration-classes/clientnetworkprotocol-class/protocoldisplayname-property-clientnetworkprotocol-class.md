---
title: "Свойство ProtocolDisplayName (класс ClientNetworkProtocol) | Документы Microsoft"
ms.custom: 
ms.date: 03/14/2017
...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]
  Возвращает отображаемое имя сетевого протокола клиента, заданные [Настройка клиентских протоколов](http://technet.microsoft.com/library/ms181035.aspx).  
