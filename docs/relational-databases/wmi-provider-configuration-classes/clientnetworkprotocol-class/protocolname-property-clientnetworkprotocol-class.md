...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]
  Получает имя текущего сетевого протокола, заданного [Настройка клиентских протоколов](https://technet.microsoft.com/library/ms181035.aspx).  
...
## <a name="property-valuereturn-value"></a>Значение свойства/возвращаемое значение  
 Строковое значение, указывающее имя текущего сетевого протокола, ссылается [Setordervalue (класс ClientNetworkProtocol)](https://technet.microsoft.com/library/ms179295.aspx).  
