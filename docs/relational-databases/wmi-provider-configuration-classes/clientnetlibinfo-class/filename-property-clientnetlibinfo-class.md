---
title: "Свойство FileName (класс ClientNetLibInfo) | Документы Microsoft"
ms.custom: 
ms.date: 03/03/2017
...
apitype: MOFDef
helpviewer_keywords: FileName property
...
ms.openlocfilehash: 733854aeebcda58d1932a987f99c5ef6ef2d9b0a
...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]Возвращает имя файла клиента файла сетевой библиотеки.  
...
## <a name="property-valuereturn-value"></a>Значение свойства/возвращаемое значение  
 Строковое значение, определяющее имя файла сетевой библиотеки клиента.  
