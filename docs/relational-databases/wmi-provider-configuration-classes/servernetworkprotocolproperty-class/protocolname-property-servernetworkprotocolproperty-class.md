---
title: "Свойство ProtocolName (класс ServerNetworkProtocolProperty) | Документы Microsoft"
ms.custom: 
ms.date: 03/14/2017
...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]Возвращает имя протокола, владеющего указанным свойством.  
