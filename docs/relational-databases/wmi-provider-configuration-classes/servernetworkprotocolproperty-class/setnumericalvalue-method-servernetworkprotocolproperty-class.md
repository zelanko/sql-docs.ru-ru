---
description: Метод SetNumericalValue (класс ServerNetworkProtocolProperty)
title: Метод SetNumericalValue (класс servernetworkprotocolproperty)
