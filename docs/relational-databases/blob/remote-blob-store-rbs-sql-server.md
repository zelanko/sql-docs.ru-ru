---
title: "Удаленное хранилище больших двоичных объектов (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "11/03/2016"
...
##  <a name="a-namerbsresourcesa-rbs-resources"></a><a name="rbsresources"></a> Ресурсы RBS  
...
##  <a name="a-namekeyrotationa-key-rotation-script"></a><a name="Key_rotation"></a> Скрипт смены ключей  
