---
title: "Создание, изменение и удаление таблиц FileTables | Microsoft Docs"
ms.custom: ""
ms.date: "03/06/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "таблицы FileTable [SQL Server], изменение"
  - "таблицы FileTable [SQL Server], удаление"
  - "таблицы FileTable [SQL Server], создание"
 ...
 **Соглашение об именах для системных ограничений**  
 Системные ограничения, описанные выше, должны именоваться в формате **\<тип_ограничения>_\<имя_таблицы>[\_\<имя_столбца>]\_\<уникализатор>**, где:  
...
-   *\<уникализатор>\>* — это формируемая системой строка, уникальным образом идентифицирующая ограничение. Эта строка может содержать имя таблицы FileTable и уникальный идентификатор.  
