...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] Вы можете считывать и записывать данные в больших двоичных объектах FILESTREAM, используя интерфейсы API Win32. Требуются следующие шаги.  
