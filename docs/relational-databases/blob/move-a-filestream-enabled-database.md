...
description: Узнайте, как переместить базу данных с поддержкой FILESTREAM. Узнайте, какие скрипты Transact-SQL следует использовать в редакторе запросов SQL Server Management Studio.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
