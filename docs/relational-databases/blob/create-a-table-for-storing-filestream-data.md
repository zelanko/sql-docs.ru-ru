...
description: Узнайте, как создавать таблицу для хранения данных FILESTREAM в SQL Server. Узнайте, какие столбцы и атрибуты используются в коде Transact-SQL.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
