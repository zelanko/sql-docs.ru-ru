...
description: Узнайте, как использовать API файлового ввода-вывода с таблицами FileTable, и узнайте, какие операции файловой системы совместимы с таблицами FileTable.
ms.custom: ''
ms.date: 08/25/2016
ms.prod: sql
...
###  <a name="using-virtual-network-names-vnns-with-always-on-availability-groups"></a><a name="vnn"></a> Использование имен виртуальной сети для групп доступности AlwaysOn  
