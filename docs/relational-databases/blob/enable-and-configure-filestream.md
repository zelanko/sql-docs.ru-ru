...
description: Чтобы использовать FILESTREAM, сначала включите его в экземпляре ядра СУБД SQL Server. Узнайте, как включить FILESTREAM с помощью диспетчера конфигурации SQL Server.
ms.custom: ''
ms.date: 08/23/2017
ms.prod: sql
ms.reviewer: ''
