...
description: Сведения об использовании инструкций Transact-SQL INSERT, UPDATE и DELETE для доступа к данным FILESTREAM и управления ими.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
