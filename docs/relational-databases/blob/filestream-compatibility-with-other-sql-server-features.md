---
title: "Совместимость FILESTREAM с другими компонентами SQL Server | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "FILESTREAM [SQL Server], другие функции SQL Server и"
  - "FILESTREAM [SQL Server], ограничения"
