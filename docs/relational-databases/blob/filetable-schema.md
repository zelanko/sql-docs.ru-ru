...
description: Узнайте о предварительно определенной и фиксированной схеме таблиц FileTable, функции SQL Server, которая использует структуру каталогов для хранения файлов.
ms.custom: ''
ms.date: 03/01/2017
ms.prod: sql
