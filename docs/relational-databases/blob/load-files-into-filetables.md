...
description: Узнайте, как загружать и переносить файлы в таблицы FileTable в SQL Server, если файлы хранятся различными способами. Сведения об операциях с массовыми загрузками.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
