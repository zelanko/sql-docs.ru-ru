...
helpviewer_keywords: 
  ...
  - "FILESTREAM [SQL Server], описание"
  - "FILESTREAM [SQL Server], обзор"
...
##  Связанные задачи  
 [Включение и настройка FILESTREAM](../../relational-databases/blob/enable-and-configure-filestream.md)  
  ...
  [Доступ к данным FILESTREAM с помощью Transact-SQL](../../relational-databases/blob/access-filestream-data-with-transact-sql.md)  
