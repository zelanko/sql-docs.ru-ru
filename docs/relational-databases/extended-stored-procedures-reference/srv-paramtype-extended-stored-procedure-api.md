...
description: Узнайте, как srv_paramtype в API расширенных хранимых процедур Возвращает тип данных параметра вызова удаленной хранимой процедуры.
ms.custom: ''
ms.date: 03/17/2017
ms.prod: sql
