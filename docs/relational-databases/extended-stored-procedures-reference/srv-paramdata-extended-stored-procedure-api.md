...
description: Дополнительные сведения о srv_paramdata. srv_paramdata возвращает значение параметра вызова удаленной хранимой процедуры.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
