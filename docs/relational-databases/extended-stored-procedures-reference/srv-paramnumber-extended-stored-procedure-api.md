...
description: Узнайте, как srv_paramnumber в API расширенных хранимых процедур возвращает номер параметра вызова удаленной хранимой процедуры.
ms.custom: ''
ms.date: 03/03/2017
ms.prod: sql
