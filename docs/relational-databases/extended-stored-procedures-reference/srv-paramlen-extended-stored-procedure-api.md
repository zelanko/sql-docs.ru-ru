...
## <a name="returns"></a>Возвращает  
 Фактическая длина данных параметра в байтах. При наличии не *n*й параметр или удаленная хранимая процедура отсутствует, возвращается значение -1. Если *n*-го параметра равно NULL, то возвращается 0.  
