...
description: Узнайте, как srv_rpcoptions в API расширенных хранимых процедур Возвращает параметры времени выполнения для текущей удаленной хранимой процедуры.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
