...
description: Процесс классификации регулятора ресурсов SQL Server назначает входящие сеансы группе рабочей нагрузки с учетом характеристик сеанса.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
