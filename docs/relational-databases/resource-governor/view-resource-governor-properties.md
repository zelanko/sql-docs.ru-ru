...
description: Сведения о том, как создать или настроить сущности Resource Governor с помощью страницы свойств Resource Governor в SQL Server Management Studio.
ms.custom: ''
ms.date: 07/18/2016
ms.prod: sql
ms.reviewer: ''
