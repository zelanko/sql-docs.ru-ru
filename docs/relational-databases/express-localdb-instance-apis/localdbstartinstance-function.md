---
title: "Функция LocalDBStartInstance | Документы Microsoft"
ms.custom: 
ms.date: 03/06/2017
...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]Запускает указанный экземпляр SQL Server Express LocalDB.  
