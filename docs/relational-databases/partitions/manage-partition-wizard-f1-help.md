---
title: "Справка F1 мастера управления секциями | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  - "мастера [среда SQL Server Management Studio], см. «Мастер управления секциями»"
...
---
# Справка F1 мастера управления секциями
...
### Запуск мастера управления секциями  
 ...
 **Управлять секционированными данными в сценарии со скользящим окном**  
 ...
 ![Значок стрелки, используемый со ссылкой «В начало»](../../analysis-services/instances/media/uparrow16x16.png "Значок стрелки, используемый со ссылкой «В начало»") [В этом разделе](#Top)  
...
### Параметры повторяющихся расписаний  
...
### Параметры однократных типов расписаний  
