...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]
 ...
 ![Схема потока поставщик WMI для событий сервера](../../relational-databases/wmi-provider-server-events/media/wmi-provider-functional-spec.gif "схема потока поставщик WMI для событий сервера")  
...
```  
 ...
 Пример [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] приложения агента управления, использующего поставщик WMI для событий сервера, см. в разделе [пример: создание SQL Server Agent оповещений с помощью поставщика WMI для событий сервера](http://technet.microsoft.com/library/ms186385.aspx). Пример приложения для управления, использующего поставщик WMI для событий сервера в управляемом коде, см. в разделе [пример: использование поставщика событий WMI в управляемом коде](http://technet.microsoft.com/library/ms179315.aspx). Дополнительные сведения можно также получить о WMI в [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[dnprdnshort](../../includes/dnprdnshort-md.md)] SDK.  
