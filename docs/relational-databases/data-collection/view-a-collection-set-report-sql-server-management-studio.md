---
title: "Просмотр отчета о наборе элементов сбора (среда SQL Server Management Studio) | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
helpviewer_keywords: 
  - "наборы элементов сбора [SQL Server], просмотр отчетов"
  - "отчеты [SQL Server], просмотр набора элементов сбора"
...
### Просмотр отчета набора элементов сбора  
