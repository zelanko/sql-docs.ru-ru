---
description: Создание пользовательского набора элементов сбора — тип сборщика "Универсальный запрос T-SQL"
title: Создание пользовательского набора элементов сбора — тип сборщика "Универсальный запрос T-SQL"
ms.date: 06/03/2020
ms.prod: sql
ms.reviewer: ''
