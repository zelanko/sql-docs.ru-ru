---
title: "Добавление элемента сбора в набор элементов сбора (Transact-SQL) | Microsoft Docs"
ms.custom: ""
ms.date: "03/07/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "элементы сбора [SQL Server]"
  - "наборы элементов сбора [SQL Server], добавление элементов"
