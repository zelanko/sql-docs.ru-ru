---
title: "Просмотр и изменение расписаний набора элементов сбора (среда SQL Server Management Studio) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  - "наборы элементов сбора [SQL Server], изменение расписаний"
  - "расписания [SQL Server], изменение набора элементов сбора"
  - "наборы элементов сбора [SQL Server], просмотр расписаний"
  - "расписания [SQL Server], просмотр набора элементов сбора"
...
---
# Просмотр и изменение расписаний набора элементов сбора (среда SQL Server Management Studio)
...
### Просмотр расписаний набора элементов сбора  
...
### Изменение расписаний набора элементов сбора в режиме с кэшированием  
...
### Изменение расписания набора элементов сбора в режиме без кэширования  
