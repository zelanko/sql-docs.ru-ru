---
title: "Отчеты наборов элементов сбора системных данных | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "сборщик данных [SQL Server], активность сервера"
  - "активность сервера [SQL Server]"
  - "отчеты [SQL Server], сбор данных"
  - "отчеты [SQL Server], использование места на диске"
  - "наборы элементов сбора [SQL Server], отчеты"
  - "сборщик данных [SQL Server], отчеты"
  - "отчеты [SQL Server], статистика запросов"
  - "отчеты статистики запросов [SQL Server]"
  - "отчеты использования дискового пространства [SQL Server]"
...
### Отчет набора сбора «Занято места на диске»  
...
#### Вложенный отчет «Занято места на диске — база данных: \<имя_базы_данных>»  
...
#### Вложенный отчет «Занято места на диске под базу данных: \<имя_базы_данных>»  
...
#### Отчет «Журнал статистики запросов»  
...
#### Вложенный отчет «Сведения о запросе»  
...
#### Вложенный отчет «Сведения о плане запроса»  
...
## Отчет «Журнал активности сервера»  
