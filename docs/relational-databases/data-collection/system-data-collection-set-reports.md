...
description: Сборщик данных предоставляет отчет для каждого набора элементов сбора системных данных для наблюдения за емкостью системы и производительностью системы в SQL Server.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
...
|[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Действие|По графику активности [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] можно получить различные сведения об активности [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] . Ниже перечислены отчеты, которые можно получить с помощью щелчка в точке линейного графика «Число компиляций SQL-кода в секунду»:<br /><br /> <br /><br /> Подключения и сеансы<br /><br /> Requests<br /><br /> Коэффициент попадания в кэш планов<br /><br /> Характеристики базы данных tempdb|  
