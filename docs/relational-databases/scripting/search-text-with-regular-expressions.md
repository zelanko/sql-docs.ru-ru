...
|Или|&#124;|Совпадает с выражением до или после символа OR (&#124;). В основном используется в группах. Например, строка "(хвойный&#124;лиственный) лес" совпадает со строками "хвойный лес" и "лиственный лес".|  
