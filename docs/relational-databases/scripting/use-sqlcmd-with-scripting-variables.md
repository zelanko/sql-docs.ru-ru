---
title: "Использование программы sqlcmd с переменными скрипта | Microsoft Docs"
ms.custom: ""
ms.date: "03/23/2017"
...
dev_langs: 
  - "TSQL"
helpviewer_keywords: 
  - "Сценарии [SQL Server], программа sqlcmd"
  - "Переменные [SQL Server], сценарии"
  - "переменные скрипта[SQL Server]"
  - "программа sqlcmd, сценарии"
  - "setvar, команда"
