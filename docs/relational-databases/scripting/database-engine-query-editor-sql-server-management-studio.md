---
title: "Редактор запросов компонента Database Engine (среда SQL Server Management Studio) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
dev_langs: 
  - "TSQL"
helpviewer_keywords: 
  - "редактор запросов [компонент Database Engine]"
  - "Редактор Transact-SQL, см. редактор запросов [компонент Database Engine]"
  - "Редактор запросов компонента Database Engine [компонент Database Engine]"
  - "редактор запросов [ядро СУБД], панель инструментов"
  - "редакторы [SQL Server Management Studio], редактор запросов ядра СУБД"
  - "редактор запросов [ядро СУБД], функции"
  - "SQL Server Management Studio [SQL Server], редактор запросов ядра СУБД"
