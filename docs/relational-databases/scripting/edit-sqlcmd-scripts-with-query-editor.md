---
title: "Изменение скриптов SQLCMD при помощи редактора запросов | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "скрипты [SQL Server], скрипты SQLCMD"
  - "скрипты SQLCMD"
  - "изменение скриптов"
  - "редактор запросов [ядро СУБД], скрипты SQLCMD"
