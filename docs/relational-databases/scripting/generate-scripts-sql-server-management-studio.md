---
title: "Формирование скриптов (среда SQL Server Management Studio) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
###  <a name="OEScriptAsMenu"></a> Меню «Создать скрипт для» в обозревателе объектов  
...
4.  Щелкните объект правой кнопкой мыши, наведите указатель на пункт **Сформировать скрипт как \<тип объекта>**, например **Сформировать скрипт как таблицу**.  
...
3.  Щелкните правой кнопкой мыши первый объект для создания скрипта, наведите указатель на пункт **Сформировать скрипт как \<тип объекта>**, а в списке **Сохранить как** выберите **Новое окно редактора запросов** в качестве места назначения вывода.  
  
4.  Перейдите ко второму объекту, который необходимо включить в скрипт.  
  
5.  Щелкните объект правой кнопкой мыши, наведите указатель на пункт **Сформировать скрипт как \<тип объекта>**, а в списке **Сохранить как** выберите **Буфер обмена** в качестве места назначения вывода.  
...
7.  Щелкните правой кнопкой мыши один из выделенных объектов и выберите пункт **Сформировать скрипт как \<тип объекта>**.  
