---
title: "Использование программы sqlcmd | Microsoft Docs"
ms.custom: ""
ms.date: "03/23/2017"
...
dev_langs: 
  - "TSQL"
helpviewer_keywords: 
  - "Инструкции Transact-SQL, выполнение"
  - "программы командной строки [SQL Server], sqlcmd"
  - "инструкции [SQL Server], выполнение"
  - "программа sqlcmd, о программе sqlcmd"
...
-   Параметры проверки подлинности (**-E**, **-U** и **-P**), с помощью которых задаются учетные данные, используемые программой **sqlcmd** для подключения к экземпляру [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)].  
...
-   Параметр выходных данных (**-o**), с помощью которого задается файл, куда программа **sqlcmd** помещает выходные данные.  
...
## Интерактивный запуск инструкций Transact-SQL с помощью программы sqlcmd  
 С помощью программы **sqlcmd** можно интерактивно запускать инструкции [!INCLUDE[tsql](../../includes/tsql-md.md)] из окна командной строки. Для интерактивного выполнения инструкций [!INCLUDE[tsql](../../includes/tsql-md.md)] с помощью программы **sqlcmd** запустите ее без параметров **-Q**, **-q**, **-Z** или **-i**, чтобы задать входные файлы или запросы. Например:  
