---
title: "Запуск отладчика Transact-SQL | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "отладчик Transact-SQL, требование системного администратора"
  - "отладчик Transact-SQL, поддерживаемые версии"
  - "редактор запросов [ядро СУБД], контекстное меню"
  - "отладка [SQL Server], отладчик Transact-SQL"
  - "отладчик Transact-SQL, контекстное меню редактора запросов"
  - "отладчик Transact-SQL, остановка"
  - "отладчик Transact-SQL, меню отладки"
  - "отладка [SQL Server]"
  - "отладчик Transact-SQL, панель инструментов отладки"
  - "отладчик Transact-SQL, сочетания клавиш"
  - "отладчик Transact-SQL, запуск"
...
|Команда меню «Отладка»|Команда контекстного меню редактора|Кнопка на панели инструментов|Сочетание клавиш|Действие|  
|------------------------|-----------------------------|--------------------|-----------------------|------------|  
