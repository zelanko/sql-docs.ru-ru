---
title: "Мастер формирования и публикации скриптов | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  - "базы данных [SQL Server], публикация"
  - "публикация баз данных"
  - "скрипты [SQL Server], формирование"
  - "скрипты [SQL Server], публикация"
  - "базы данных [SQL Server], формирование скриптов"
  - "Мастер публикации базы данных"
...
## Создание скриптов в хранилище данных Azure SQL  
