---
title: "Настройка счетчика числа попаданий | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  - "Отладчик Transact-SQL, число попаданий в точку останова"
...
## Соображения в отношении счетчика числа попаданий  
...
#### Просмотр или сброс текущего счетчика числа попаданий  
