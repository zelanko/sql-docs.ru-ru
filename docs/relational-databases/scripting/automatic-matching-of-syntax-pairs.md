---
title: "Автоматическое сопоставление синтаксических пар | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "IntelliSense [SQL Server], выделение разделителей"
  - "IntelliSense [SQL Server], сопоставление синтаксических пар"
