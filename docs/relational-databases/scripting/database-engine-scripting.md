---
title: "Работа со сценариями компонента Database Engine | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "скрипты [SQL Server], PowerShell"
  - "скрипты [SQL Server]"
  - "работа со скриптами [компонент SQL Server Database Engine]"
  - "работа со скриптами [ядро СУБД SQL Server], PowerShell"
...
-   Чтобы запустить файл с помощью командлета **Invoke-Sqlcmd** в скриптах [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] PowerShell, укажите параметр **-QueryFromFile**.  
...
|Описывает порядок использования программы **sqlcmd** для выполнения скриптов [!INCLUDE[tsql](../../includes/tsql-md.md)] из командной строки, включая возможность интерактивной разработки скриптов.|[Связанные инструкции по sqlcmd](../Topic/sqlcmd%20How-to%20Topics.md)|  
