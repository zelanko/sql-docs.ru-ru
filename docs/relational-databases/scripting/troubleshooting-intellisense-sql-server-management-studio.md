---
title: "Устранение сбоев в работе IntelliSense (среда SQL Server Management Studio) | Microsoft Docs"
ms.custom: ""
ms.date: "03/23/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "недоступные параметры [технология IntelliSense]"
  - "IntelliSense [SQL Server], устранение неполадок"
  - "IntelliSense [SQL Server], недоступные параметры"
  - "устранение неполадок [технология IntelliSense]"
