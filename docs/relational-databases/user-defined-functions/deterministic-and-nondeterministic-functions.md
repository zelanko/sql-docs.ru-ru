---
title: "Детерминированные и недетерминированные функции | Microsoft Docs"
ms.custom: ""
ms.date: "09/28/2016"
...
helpviewer_keywords: 
  ...
  - "расширенные хранимые процедуры [SQL Server], вызывающие функции"
  - "детерминированные функции"
  - "пользовательские функции [SQL Server], детерминированные"
