---
title: "Создание функций CLR | Microsoft Docs"
ms.custom: ""
ms.date: "03/16/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "функции CLR [SQL Server]"
  - "пользовательские функции [SQL Server], среда CLR"
