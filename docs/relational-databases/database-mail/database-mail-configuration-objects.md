---
title: "Объекты конфигурации компонента Database Mail | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  - "компонент Database Mail [SQL Server], объекты конфигурации"
  - "компонент Database Mail [SQL Server], учетные записи"
  - "объекты конфигурации [компонент Database Mail]"
  - "компонент Database Mail [SQL Server], профили"
  - "профили [SQL Server], компонент Database Mail"
...
-   [Связи объектов конфигурации компонента Database Mail](#VisualElement)  
  
-   [Учетная запись компонента Database Mail](#DBAccount)  
  
-   [Профиль компонента Database Mail](#DBProfile)  
  
-   [Задачи конфигурации компонента Database Mail](#RelatedTasks)  
  
-   [Дополнительные задачи конфигурации компонента Database Mail (системная хранимая процедура)](#Add_Tasks)  
  
-   [Дополнительные ссылки](#RelatedContent)  
