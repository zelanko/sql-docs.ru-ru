---
description: Настройка компонента Database Mail
...
##  <a name="using-database-mail-configuration-wizard"></a><a name="DBWizard"></a> Использование мастера настройки компонента Database Mail  
...
###  <a name="new-account-page"></a><a name="NewAccount"></a> Страница создания учетной записи  
...
###  <a name="new-profile-page"></a><a name="NewProfile"></a> Страница создания профиля  
...
###  <a name="manage-accounts-and-profiles-page"></a><a name="AccountsProfiles"></a> Страница управления учетными записями и профилями  
...
###  <a name="manage-profile-security-public-tab"></a><a name="ProfileSecurityPublic"></a> Управление безопасностью профиля, вкладка «Открытый»  
...
###  <a name="manage-profile-security-private-tab"></a><a name="ProfileSecurityPrivate"></a> Управление безопасностью профиля, вкладка «Закрытый»  
...
###  <a name="configure-system-parameters"></a><a name="SystemParameters"></a> Установка системных параметров  
...
###  <a name="complete-the-wizard-page"></a><a name="CompleteWizard"></a> Страница завершения мастера  
 ...
 **Устранение проблем**  
 Щелкните ссылку, чтобы открыть раздел [Устранение неполадок компонента Database Mail](/previous-versions/sql/sql-server-2008-r2/ms188663(v=sql.105))электронной документации.  
  
 [Мастера настройки компонента Database Mail](#DBWizard)  
  
##  <a name="using-templates"></a><a name="Template"></a> С помощью шаблонов  
