---
title: "Настройка компонента Database Mail | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
 ...
 **Просмотр или изменение системных параметров**  
 ...
 [Мастер настройки компонента Database Mail](#DBWizard)  
 ...
 **Адрес электронной почты**  
 Введите адрес электронной почты для этой учетной записи. Это адрес электронной почты отправителя. Например, учетная запись агента версии [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] может отправлять электронную почту с адреса SqlAgent@Adventure-Works.com.  
...
###  <a name="AddAccount"></a> Страница добавления учетной записи в профиль  
 ...
 **Просмотр, редактирование или удаление существующего профиля. Можно также управлять учетными записями, связанными с данным профилем.**  
...
###  <a name="SystemParameters"></a> Настройка параметров системы  
...
###  <a name="TestEmail"></a> Страница отправки тестового сообщения по электронной почте  
...
##  <a name="Template"></a> Использование шаблонов  
