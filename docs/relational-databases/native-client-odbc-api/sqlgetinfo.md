...
|SQL_CONVERT_BIGINT|Преобразование типа данных ODBC SQL_BIGINT не поддерживается. Драйвер ODBC для собственного клиента [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] поддерживает тип данных [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] **Decimal (19, 0)** как тип ODBC SQL_DECIMAL. См. раздел SQL_CONVERT_DECIMAL далее.|  
...
|SQL_CONVERT_DATE|Преобразование типа данных ODBC SQL_TYPE_DATE не поддерживается. Драйвер ODBC для собственного клиента [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] поддерживает тип данных [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] **DateTime** типа ODBC SQL_TYPE_TIMESTAMP. См. раздел SQL_CONVERT_TIMESTAMP далее.|  
...
|SQL_CONVERT_DOUBLE|Преобразование типа данных ODBC SQL_DOUBLE не поддерживается. Драйвер ODBC для собственного клиента [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] поддерживает тип данных ODBC SQL_DOUBLE как SQL_FLOAT. См. раздел SQL_CONVERT_FLOAT далее.|  
...
|SQL_CONVERT_TIME|Преобразование типа данных ODBC SQL_TYPE_TIME не поддерживается. Драйвер ODBC для собственного клиента [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] поддерживает тип данных [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]**DateTime** типа ODBC SQL_TYPE_TIMESTAMP. См. раздел SQL_CONVERT_TIMESTAMP далее.|  
...
## <a name="see-also"></a>См. также раздел  
   [функции SQLGetInfo](https://go.microsoft.com/fwlink/?LinkId=59354)  
