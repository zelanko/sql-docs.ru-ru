...
|SQL_CREATE_ASSERTION|Ложь.|  
|SQL_CREATE_CHARACTER_SET|Ложь.|  
|SQL_CREATE_COLLATION|Ложь.|  
|SQL_CREATE_DOMAIN|Ложь.|  
|SQL_CREATE_SCHEMA|SQL_CS_AUTHORIZATION SQL_CS_CREATE_SCHEMA|  
|SQL_CREATE_TABLE|SQL_CT_CREATE_TABLE|  
|SQL_CREATE_TRANSLATION|Ложь.|  
...
|SQL_DROP_ASSERTION|Ложь.|  
|SQL_DROP_CHARACTER_SET|Ложь.|  
|SQL_DROP_COLLATION|Ложь.|  
|SQL_DROP_DOMAIN|Ложь.|  
|SQL_DROP_SCHEMA|DROP SCHEMA не поддерживается|  
|SQL_DROP_TABLE|SQL_DT_DROP_TABLE|  
|SQL_DROP_TRANSLATION|Ложь.|  
...
|SQL_SQL92_DATETIME_FUNCTIONS|Ложь.|  
|SQL_SQL92_FOREIGN_KEY_DELETE_RULE|Ложь.|  
|SQL_SQL92_FOREIGN_KEY_UPDATE_RULE|Ложь.|  
|SQL_SQL92_GRANT|SQL_SG_WITH_GRANT_OPTION|  
|SQL_SQL92_NUMERIC_VALUE_FUNCTIONS|Ложь.|  
