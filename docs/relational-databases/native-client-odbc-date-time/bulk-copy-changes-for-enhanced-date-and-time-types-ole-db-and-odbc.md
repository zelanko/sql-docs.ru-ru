...
|Тип файлового хранилища|Объем памяти в байтах|Формат хранения|  
|-----------------------|---------------------------|--------------------|  
|datetime (d)|8|TDS|  
...
## <a name="bcp-types-in-sqlnclih"></a>Типы BCP в sqlncli.h  
 В файле sqlncli.h определены следующие типы, используемые в расширениях API-интерфейсов BCP для ODBC. Эти типы передаются с помощью параметра *Еусердататипе* IBCPSession:: BCPColFmt в OLE DB.  
