...
## <a name="down-level-client-behavior"></a>Работа в клиентах низкого уровня  
 ...
 Если клиентское приложение нижнего уровня выполняется на [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] (или более позднем) сервере, на котором были внесены изменения схемы типов даты и времени, ожидаемое поведение выглядит следующим образом:  
  
|Тип SQL Server 2005|Тип [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] (или более поздней)|Клиентский тип ODBC|Преобразование результата (из SQL в C)|Преобразование параметров (из C в SQL)|  
|--------------------------|----------------------------------------------|----------------------|------------------------------------|---------------------------------------|  
