---
title: sys. sysfilegroups (Transact-SQL) | Документация Майкрософт
ms.custom: ''
ms.date: 03/15/2017
ms.prod: sql
...
|**состояние**|**int**|0x8 = только для чтения<br /><br /> 0x10 = по умолчанию|  
|**Группа**|**имеет sysname**|Имя файловой группы.|  
