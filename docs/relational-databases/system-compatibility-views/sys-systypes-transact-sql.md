...
|**domain**|**int**|Идентификатор хранимой процедуры, содержащей проверку целостности для этого типа данных.|  
...
|**переменная**|**бит**|Тип данных с переменной длиной.<br /><br /> 1 = True<br /><br /> 0 = False.|  
