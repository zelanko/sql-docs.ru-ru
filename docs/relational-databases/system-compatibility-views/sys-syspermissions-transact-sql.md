---
title: sys.syspermissions (Transact-SQL) | Документация Майкрософт
ms.custom: ''
ms.date: 03/15/2017
ms.prod: sql
...
|**Объект, предоставляющий разрешение**|**smallint**|Идентификатор пользователя, группы или роли, который предоставляет или запрещает разрешение.|  
