...
ms.locfileid: "70148578"
---
# <a name="smo-programming-languages"></a>Языки программирования SMO
[!INCLUDE[appliesto-ss-asdb-asdw-xxx-md](../../includes/appliesto-ss-asdb-asdw-xxx-md.md)]

  В этом разделе описывается, как [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] программировать управляющие объекты (SMO [!INCLUDE[msCoName](../../includes/msconame-md.md)] ) C# в Visual .NET.
  
|Раздел|Описание|  
|-----------|-----------------|  
|[Начало работы в Visual C&#35; .NET](../../relational-databases/server-management-objects-smo/smo-programming-getting-started-in-visual-csharp-net.md)|Содержит сведения о том, как начать написание программы SMO в C# Visual .NET|  
