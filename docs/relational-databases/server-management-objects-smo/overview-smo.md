...
-   Конечные точки HTTP для управления SOAP-запросами. Дополнительные сведения см. в разделе [реализации конечных точек](../../relational-databases/server-management-objects-smo/tasks/implementing-endpoints.md).  
...
-   Дополнительные возможности скриптов этап 3 (скрипт создается за три шага; обнаружения зависимостей, создания списка, создание скрипта)  
