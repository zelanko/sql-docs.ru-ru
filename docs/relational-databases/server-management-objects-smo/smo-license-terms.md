---
title: Общие управляющие объекты (SMO) - условия лицензионного соглашения SQL Server | Документы Microsoft
ms.custom: ''
ms.date: 08/06/2017
ms.prod: sql
ms.reviewer: ''
...
**ОБЩИЕ УПРАВЛЯЮЩИЕ ОБЪЕКТЫ MICROSOFT SQL SERVER 2017 Г.**
...
&nbsp;&nbsp;Можно установить и использовать любое количество копий программного обеспечения на ваших устройствах для проектирования, разработки и тестирования своих программ.
...
* для любого распространяемого кода, с расширением имени файла .dll распределите только результаты выполнения распространяемого кода через связующий объект с вашей программы.
