---
title: Общие управляющие объекты (SMO) — условия лицензионного соглашения SQL Server | Документация Майкрософт
ms.custom: ''
ms.date: 08/08/2018
ms.prod: sql
ms.reviewer: ''
...
ms.locfileid: "52502290"
---
# <a name="sql-server-shared-management-objects-smo-license-terms"></a>Общие условия лицензионного соглашения на использование объектов (SMO) управления SQL Server
...
&nbsp;&nbsp;Вы можете установить и использовать любое количество копий программного обеспечения на устройствах для проектирования, разработки и тестирования своих программ.
...
*   Вы можете копировать и распространять форму объектного кода программного обеспечения («распространяемый код») в разрабатываемых вами программ и
...
* в отношении любого распространяемого кода с расширением имени файла .dll распределите только результаты выполнения распространяемого кода через связующий объект с вашей программой;
...
**3. ОБЛАСТЬ ДЕЙСТВИЯ ЛИЦЕНЗИИ.** Программное обеспечение не продается, а лицензируется. Если применяемое право не дает вам дополнительных прав, Майкрософт сохраняет за собой все права, не предоставленные в настоящем соглашении явно, косвенно, подразумеваемым или иным способом. Вы можете использовать программное обеспечение только в соответствии с тем, что явно разрешено в данном соглашении. При этом вы обязаны соблюдать все технические ограничения в программном обеспечении, которые позволяют вам использовать его лишь определенными способами. Не может выполнять какие-либо из следующих:

- Обойти все технические ограничения в программном обеспечении.
- Реконструировать, декомпилировать или дизассемблировать программное обеспечение, за исключением того, и только в степени, которая явно разрешена применимым законом, несмотря на это ограничение.
- Создайте больше копий программного обеспечения, не определенные в настоящем соглашении или разрешено применимым законодательством, несмотря на это ограничение.
- Совместное использование, публикация, сдавать в аренду или программное обеспечение в аренду или предоставлять его как автономное размещенное решение для других пользователей.
...
**8.    ТЕХНИЧЕСКАЯ ПОДДЕРЖКА.** Так как это программное обеспечение предоставляется «как есть», корпорация Microsoft не предоставляет для него техническую поддержку.
...
**ДЛЯ АВСТРАЛИИ — у вас есть предусмотренные законом гарантии в соответствии с австралийским законом и ничто в настоящих условиях является затрагивает эти права.**
...
> [!NOTE]
> Раздел 3 по 8 августа 2018 г. были обновлены.
