---
description: Атрибуты инструкции, влияющие на возвращающие табличное значение параметры
title: Атрибуты, влияющие на параметры Table-Valued
ms.custom: ''
ms.date: 03/06/2017
ms.prod: sql
