...
[!INCLUDE[SNAC_Deprecated](../../includes/snac-deprecated.md)]
 ...
 Еще один пример, демонстрирующий табличное значение параметров см. в разделе [использование возвращающих табличные значения параметры &#40; ODBC &#41;](../../relational-databases/native-client-odbc-how-to/use-table-valued-parameters-odbc.md).  
