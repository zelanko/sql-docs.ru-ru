...
ms.locfileid: "87247050"
---
# <a name="sql-server-native-client-commands-generating-multiple-rowset-results"></a>SQL Server Native Client команды, создающие результаты с несколькими наборами строк
