---
title: "Руководство по архитектуре потоков и задач | Microsoft Docs"
ms.custom: ""
ms.date: "10/26/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "руководство, архитектура потоков и задач"
...
### параметр «использование упрощенных пулов»
...
### Назначение аппаратных потоков процессорам
...
* Для серверов с включенным параметром гиперпоточности, произведенных до 2009 года включительно, значение параметра MAXDOP не должно превышать количества физических процессоров.  


Дополнительные сведения о максимальной степени параллелизма см. в статье [Задание параметра максимальной степени параллелизма для оптимальной производительности](../relational-databases/policy-based-management/set-the-max-degree-of-parallelism-option-for-optimal-performance.md).
...
### Использование приложения SQL Trace и SQL Server Profiler
...
### Задание количества файлов данных базы данных tempdb
...
### Компоненты SQL Server, которые поддерживают более 64 процессоров
