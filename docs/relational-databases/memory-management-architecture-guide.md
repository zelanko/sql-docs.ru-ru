---
title: "Руководство по архитектуре управления памятью | Microsoft Docs"
ms.custom: ""
ms.date: "10/21/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "руководство, архитектура управления памятью"
...
### <a name="providing-the-maximum-amount-of-memory-to-includessnoversiontokenssnoversionmdmd"></a>Выделение [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] максимального объема памяти
...
> [!NOTE]
> Более старые версии [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] можно запустить в 32-разрядной операционной системе. При доступе более чем к 4 ГБ памяти в 32-разрядной операционной системе требуется использовать расширения AWE для управления памятью. Это необязательно, если [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] выполняется в 64-разрядных операционных системах. Дополнительные сведения о расширениях AWE см. в документации по [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] 2008: [Адресное пространство процесса](https://msdn.microsoft.com/library/ms189334) и [Управление памятью для больших баз данных](https://msdn.microsoft.com/library/ms191481).   
...
## <a name="memory-used-by-includessnoversiontokenssnoversionmdmd-objects-specifications"></a>Требования к объему памяти для хранения объектов [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]
