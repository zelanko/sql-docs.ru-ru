---
description: создать трассировку (Transact-SQL)
...
### <a name="a-create-a-trace"></a>A. Создание трассировки
...
### <a name="b-populate-the-trace-file"></a>Б. Заполнение файла трассировки
...
### <a name="c-stop-the-trace"></a>В. Остановка трассировки
...
### <a name="d-examine-the-trace-file"></a>Г. Изучение файла трассировки
