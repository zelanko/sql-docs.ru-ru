---
title: "Трассировка SQL | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
## Архитектура трассировки SQL  
 ...
 ![Процесс трассировки событий компонента Database Engine](../../relational-databases/sql-trace/media/tracarch.gif "Процесс трассировки событий компонента Database Engine")  
 ...
 *Эти столбцы данных заполняются по умолчанию для всех событий.  
 ...
 \*\*Дополнительные сведения о столбце данных **ObjectType** см. в разделе [Столбец события ObjectType Trace](../../relational-databases/event-classes/objecttype-trace-event-column.md).  
...
|Описывает просмотр сведений фильтра трассировки с помощью встроенных функций.|[Просмотр сведений фильтров (Transact-SQL)](../../relational-databases/sql-trace/view-filter-information-transact-sql.md)|  
