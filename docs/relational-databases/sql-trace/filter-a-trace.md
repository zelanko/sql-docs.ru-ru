---
title: "Фильтрация трассировки | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
|Не похоже|NOT LIKE|Определяет то, что данные событий трассировки не должны быть похожи на введенный текст. Допускает множественные значения.|  
