...
`[ @primary_id = ] 'primary_id'` Идентификатор базы данных-источника для конфигурации доставки журналов. *primary_id* — **uniqueidentifier** и не может иметь значение NULL.  
