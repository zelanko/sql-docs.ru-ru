...
## <a name="permissions"></a>Разрешения  
 хранимая процедура **sp_check_for_sync_trigger** может быть выполнена любым пользователем с разрешениями SELECT в системном представлении [sys. Objects](../../relational-databases/system-catalog-views/sys-objects-transact-sql.md) .  
