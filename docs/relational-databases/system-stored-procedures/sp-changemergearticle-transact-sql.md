...
||**false**|Репликация инструкций DELETE не выполняется.<br /><br /> ** \* \* Важно \* !** Если присвоить параметру **delete_tracking** **значение false** , результаты не конвергенции будут удалены, а удаленные строки необходимо будет удалить вручную.|  
