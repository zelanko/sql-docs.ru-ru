...
|**run_requested_source**|**имеет sysname**|Источник запроса на выполнение задания. Одно из двух значений:<br /><br /> **1** = запуск по расписанию<br /><br /> **2** = запустить в ответ на предупреждение<br /><br /> **3** = запуск при запуске<br /><br /> **4** = запуск пользователем<br /><br /> **6** = запуск в расписании ПРОСТОя ЦП|  
...
|**Сообщение**|**nvarchar(1024)**|Сообщение, сформированное во время последнего выполнения задания.|  
