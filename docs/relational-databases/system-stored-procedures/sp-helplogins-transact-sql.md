...
## <a name="arguments"></a>Аргументы  
 ...
 Имя входа. *Имя входа* — **sysname**, значение по умолчанию NULL. *Имя входа* должен существовать, если указано. Если *входа* — не указано, возвращаются сведения обо всех имен входа.  
