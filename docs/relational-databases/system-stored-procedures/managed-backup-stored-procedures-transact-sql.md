---
title: Управляемые хранимые процедуры резервного копирования (Transact-SQL) | Документация Майкрософт
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
[!INCLUDE[tsql-appliesto-ss2016-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2016-xxxx-xxxx-xxx-md.md)]
  ...
  Следующие хранимые процедуры можно использовать для настройки [!INCLUDE[ss_smartbackup](../../includes/ss-smartbackup-md.md)].  
