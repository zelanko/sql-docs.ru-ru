---
description: Хранимые процедуры каталога (Transact-SQL)
...
:::row:::
    :::column:::
        [sp_column_privileges, хранимая процедура](../../relational-databases/system-stored-procedures/sp-column-privileges-transact-sql.md)
        ...
        [sp_pkeys, хранимая процедура](../../relational-databases/system-stored-procedures/sp-pkeys-transact-sql.md)
