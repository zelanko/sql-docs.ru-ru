...
|**shouldalert**|**bit**|— Должно быть создано оповещение при превышении порогового значения для этой публикации; значение **1** указывает, должно быть создано предупреждение.|  
|**IsEnabled**|**bit**|— Если мониторинг включен для этой метрики производительности репликации для этой публикации; значение **1** указывает, что наблюдение включено.|  
