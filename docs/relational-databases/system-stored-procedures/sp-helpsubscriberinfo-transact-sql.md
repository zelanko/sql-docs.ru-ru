...
|**frequency_interval**|**int**|Значение, применяемое к частоте, установленной аргументом *frequency_type*.|  
|**frequency_relative_interval**|**int**|Дата агента распространителя, используемого при *frequency_type* равно **32** (относительно ежемесячно):<br /><br /> **1** = первый<br /><br /> **2** = секунды<br /><br /> **4** = третий<br /><br /> **8** = четвертый<br /><br /> **16** = последний|  
|**frequency_recurrence_factor**|**int**|Коэффициент повторения, используемый *frequency_type*.|  
|**frequency_subday**|**int**|Частота изменения расписания в течение заданного периода:<br /><br /> **1** = однократно<br /><br /> **2** = секунды<br /><br /> **4** = минута<br /><br /> **8** = час|  
