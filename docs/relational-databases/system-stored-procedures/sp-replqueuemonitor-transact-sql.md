...
## <a name="arguments"></a>Аргументы  
 ...
 [**@queuetype=** ] **"***queuetype***"** ]  
 Тип очереди, в которой хранятся транзакции. *queuetype* — **tinyint** значение по умолчанию **0**, и может принимать одно из следующих значений.  
