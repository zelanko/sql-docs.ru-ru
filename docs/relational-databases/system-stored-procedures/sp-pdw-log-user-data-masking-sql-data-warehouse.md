...
`[ @masking_mode = ] masking_mode` Определяет, включено ли прозрачное шифрование журнала пользователя данных маскирование. *masking_mode* — **int**, и может принимать одно из следующих значений:  
