...
|**латенцисрешолд**|**int**|Порог задержки, установленный для публикации транзакций.|  
|**експиратионсрешолд**|**int**|Порог истечения, установленный для публикации в случае публикации слиянием.|  
|**ажентнотруннингсрешолд**|**int**|Порог, установленный для самого долгого времени, в течение которого агент не работает.|  
|**субскриптионкаунт**|**int**|Количество подписок на публикацию.|  
|**руннингдистаженткаунт**|**int**|Количество агентов распространителя, запущенных для публикации.|  
