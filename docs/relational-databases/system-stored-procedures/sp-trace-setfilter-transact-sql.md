...
## <a name="arguments"></a>Аргументы  
 ...
 [  **@comparison_operator=** ] *comparison_operator*  
 Задает тип сравнения, которое будет выполнено. *comparison_operator* — **int**, не имеет значения по умолчанию. В таблице содержатся операторы сравнения и представляющие их значения.  
