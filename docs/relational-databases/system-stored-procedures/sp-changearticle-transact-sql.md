...
|**fire_triggers_on_snapshot**|**true**|Реплицированные пользовательские триггеры срабатывают при применении исходного моментального снимка.<br /><br /> Примечание: для триггеры были реплицированы Битовая маска *schema_option* должна содержать значение **0x100**.|  
