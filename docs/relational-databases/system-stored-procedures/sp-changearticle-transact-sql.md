...
||**Нет**|Очищает все параметры состояния в таблице [sysarticles](../../relational-databases/system-tables/sysarticles-transact-sql.md) и помечает статью как неактивную.|  
