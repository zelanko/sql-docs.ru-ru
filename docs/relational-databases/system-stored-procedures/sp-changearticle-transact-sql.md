...
|**fire_triggers_on_snapshot**|**условия**|Реплицированные пользовательские триггеры срабатывают при применении исходного моментального снимка.<br /><br /> Примечание. для репликации триггеров значение битовой маски *schema_option* должно включать значение **0x100**.|  
||**IsFalse**|Реплицированные пользовательские триггеры не срабатывают при применении исходного моментального снимка.|  
...
||**удален**|Удаляет целевую таблицу.|  
