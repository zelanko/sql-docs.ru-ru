...
`[ @reserved = ] reserved` Указывает, возвращаются ли данные о существующих публикациях и подписках. *зарезервированные* — **бит**, со значением по умолчанию 0. Если **1**, результирующий набор включает сведения о базе данных, указанной, имеет ли все существующие публикации или подписки.  
