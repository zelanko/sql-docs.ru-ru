...
## <a name="arguments"></a>Аргументы  
 ...
 [  **@join_filterclause=** ] *join_filterclause*  
 Предложение соединения, который должен использоваться для соединения дочерней статьи, определяемое *статье*и родительской статьей, указанной аргументом *join_article*, для определения строк, указывающих фильтр слияния. *join_filterclause* — **nvarchar(1000)**.  
