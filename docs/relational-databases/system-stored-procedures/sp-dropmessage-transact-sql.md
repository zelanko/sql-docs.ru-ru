---
title: sp_dropmessage (Transact-SQL) | Документы Microsoft
ms.custom: ''
ms.date: 06/10/2016
ms.prod: sql
...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]
  ...
  Удаляет заданное пользовательское сообщение об ошибке из экземпляра [!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)]. Пользовательские сообщения можно просмотреть с помощью **sys.messages** представления каталога.  
...
## <a name="arguments"></a>Аргументы  
 [  **@msgnum =** ] *аргумент message_number*  
 Номер удаляемого сообщения. *Аргумент message_number* должен быть пользователем сообщение сообщением с номером более 50000. *Аргумент message_number* — **int**, значение по умолчанию NULL.  
  
 [  **@lang =** ] **"***языка***"**  
 Язык удаляемого сообщения. Если **все** указан, все языковые версии *аргумент message_number* удаляются. *Язык* — **sysname**, значение по умолчанию NULL.  
...
## <a name="remarks"></a>Замечания  
 Если не **все** указан для *языка*, все локализованные версии сообщения необходимо удалить до США. Английская версия сообщения может быть удалена.  
