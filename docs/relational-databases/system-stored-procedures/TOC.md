...
## [Темпоральная таблица — sys.sp_cleanup_temporal_history](temporal-table-sys-sp-cleanup-temporal-history.md)  
## [Темпоральная таблица — sp_xtp_flush_temporal_history](temporal-table-sp-xtp-flush-temporal-history.md)  
# Резервная копия моментального снимка
## [Резервная копия моментального снимка — sp_delete_backup_file_snapshot](snapshot-backup-sp-delete-backup-file-snapshot.md)  
## [Резервная копия моментального снимка — sp_delete_backup](snapshot-backup-sp-delete-backup.md)  
# PolyBase
...
# [Правила брандмауэра (база данных SQL Azure)](firewall-rules-stored-procedures-azure-sql-database.md)  
...
# [Семантический поиск и полнотекстовый поиск](full-text-search-and-semantic-search-stored-procedures-transact-sql.md)  
...
# [OLE-автоматизация](ole-automation-stored-procedures-transact-sql.md)  
...
# [База данных Stretch, расширенные](stretch-database-extended-stored-procedures-transact-sql.md)  
