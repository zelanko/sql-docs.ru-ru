# [Обзор](system-stored-procedures-transact-sql.md)  
# [Пространственные индексы](spatial-index-stored-procedures-arguments-and-properties.md)  
...
## [Временная таблица - sys.sp_cleanup_temporal_history](temporal-table-sys-sp-cleanup-temporal-history.md)  
## [Временная таблица - sp_xtp_flush_temporal_history](temporal-table-sp-xtp-flush-temporal-history.md)  
# Резервное копирование моментальных снимков
## [Резервное копирование моментальных снимков - sp_delete_backup_file_snapshot](snapshot-backup-sp-delete-backup-file-snapshot.md)  
## [Резервное копирование моментальных снимков - sp_delete_backup](snapshot-backup-sp-delete-backup.md)  
# PolyBase
## [Хранимые процедуры PolyBase - sp_polybase_join_group](polybase-stored-procedures-sp-polybase-join-group.md)  
## [Хранимые процедуры PolyBase - sp_polybase_leave_group](polybase-stored-procedures-sp-polybase-leave-group.md)  
# FileStream и Filetable
## [FileStream и FileTable - sp_filestream_force_garbage_collection](filestream-and-filetable-sp-filestream-force-garbage-collection.md)  
## [FileStream и FileTable - sp_kill_filestream_non_transacted_handles](filestream-and-filetable-sp-kill-filestream-non-transacted-handles.md)  
# Активная георепликация
## [sp_wait_for_database_copy_sync](active-geo-replication-sp-wait-for-database-copy-sync.md)  
# [Каталог](catalog-stored-procedures-transact-sql.md)  
...
# [Система отслеживания измененных данных](change-data-capture-stored-procedures-transact-sql.md)  
...
## [процедуру sys.sp_cdc_get_captured_columns](sys-sp-cdc-get-captured-columns-transact-sql.md)  
...
# [Курсор](cursor-stored-procedures-transact-sql.md)  
## [Хранимая процедура sp_cursor_list](sp-cursor-list-transact-sql.md)  
...
## [Хранимая процедура sp_cursorfetch](sp-cursorfetch-transact-sql.md)  
...
## [процедура sp_describe_cursor](sp-describe-cursor-transact-sql.md)  
## [sp_describe_cursor_columns](sp-describe-cursor-columns-transact-sql.md)  
## [процедура sp_describe_cursor_tables](sp-describe-cursor-tables-transact-sql.md)  
...
# [Сборщик данных](data-collector-stored-procedures-transact-sql.md)  
## [sp_syscollector_create_collection_item](sp-syscollector-create-collection-item-transact-sql.md)  
## [функция sp_syscollector_create_collection_set](sp-syscollector-create-collection-set-transact-sql.md)  
## [sp_syscollector_create_collector_type](sp-syscollector-create-collector-type-transact-sql.md)  
## [функция sp_syscollector_delete_collection_item](sp-syscollector-delete-collection-item-transact-sql.md)  
## [функция sp_syscollector_delete_collection_set](sp-syscollector-delete-collection-set-transact-sql.md)  
...
## [функция sp_syscollector_update_collection_set](sp-syscollector-update-collection-set-transact-sql.md)  
## [sp_syscollector_update_collector_type, хранимая процедура](sp-syscollector-update-collector-type-transact-sql.md)  
## [sp_syscollector_upload_collection_set](sp-syscollector-upload-collection-set-transact-sql.md)  
# [Ядро СУБД](database-engine-stored-procedures-transact-sql.md)  
...
## [процедура sp_depends](sp-depends-transact-sql.md)  
...
## [Хранимая процедура sp_droptype](sp-droptype-transact-sql.md)  
...
## [sp_execute_remote (база данных SQL Azure)](sp-execute-remote-azure-sql-database.md)  
...
## [процедура sp_getapplock](sp-getapplock-transact-sql.md)  
...
## [Хранимая процедура sp_helpindex](sp-helpindex-transact-sql.md)  
...
## [процедура sp_indexoption](sp-indexoption-transact-sql.md)  
...
## [процедура sp_rename](sp-rename-transact-sql.md)  
...
## [Хранимая процедура sp_unbindefault](sp-unbindefault-transact-sql.md)  
...
# [План обслуживания базы данных](database-maintenance-plan-stored-procedures-transact-sql.md)  
...
## [Хранимая процедура sp_delete_maintenance_plan_db](sp-delete-maintenance-plan-db-transact-sql.md)  
...
# [Распределенные запросы](distributed-queries-stored-procedures-transact-sql.md)  
...
## [процедура sp_testlinkedserver](sp-testlinkedserver-transact-sql.md)  
# [Правила брандмауэра (база данных Azure SQL)](firewall-rules-stored-procedures-azure-sql-database.md)  
## [sp_set_firewall_rule (база данных SQL Azure)](sp-set-firewall-rule-azure-sql-database.md)  
## [sp_set_database_firewall_rule (база данных SQL Azure)](sp-set-database-firewall-rule-azure-sql-database.md)  
## [sp_delete_firewall_rule (база данных SQL Azure)](sp-delete-firewall-rule-azure-sql-database.md)  
## [sp_delete_database_firewall_rule (база данных SQL Azure)](sp-delete-database-firewall-rule-azure-sql-database.md)  
# [Компонент Full-Text Search и семантический поиск](full-text-search-and-semantic-search-stored-procedures-transact-sql.md)  
## [sp_fulltext_catalog](sp-fulltext-catalog-transact-sql.md)  
## [sp_fulltext_column](sp-fulltext-column-transact-sql.md)  
## [sp_fulltext_database, хранимая процедура](sp-fulltext-database-transact-sql.md)  
...
## [использованные](sp-help-fulltext-catalog-components-transact-sql.md)  
...
# [Общие расширенные](general-extended-stored-procedures-transact-sql.md)  
...
# [Доставка журналов](log-shipping-stored-procedures-transact-sql.md)  
## [sp_add_log_shipping_primary_database](sp-add-log-shipping-primary-database-transact-sql.md)  
## [sp_add_log_shipping_primary_secondary, хранимая процедура](sp-add-log-shipping-primary-secondary-transact-sql.md)  
## [sp_add_log_shipping_secondary_database](sp-add-log-shipping-secondary-database-transact-sql.md)  
## [sp_add_log_shipping_secondary_primary, хранимая процедура](sp-add-log-shipping-secondary-primary-transact-sql.md)  
...
## [sp_delete_log_shipping_primary_secondary, хранимая процедура](sp-delete-log-shipping-primary-secondary-transact-sql.md)  
...
## [sp_help_log_shipping_primary_database, хранимая процедура](sp-help-log-shipping-primary-database-transact-sql.md)  
## [sp_help_log_shipping_primary_secondary](sp-help-log-shipping-primary-secondary-transact-sql.md)  
## [sp_help_log_shipping_secondary_database, хранимая процедура](sp-help-log-shipping-secondary-database-transact-sql.md)  
## [sp_help_log_shipping_secondary_primary, хранимая процедура](sp-help-log-shipping-secondary-primary-transact-sql.md)  
...
# [Управляемое резервное копирование](managed-backup-stored-procedures-transact-sql.md)  
...
# [Хранилище данных управления](management-data-warehouse-stored-procedures-transact-sql.md)  
...
# [OLE-автоматизации](ole-automation-stored-procedures-transact-sql.md)  
## [Синтаксис иерархии объектов](object-hierarchy-syntax-transact-sql.md)  
...
## [метод sp_OAStop](sp-oastop-transact-sql.md)  
# [Управление на основе политик](policy-based-management-stored-procedures-transact-sql.md)  
## [процедура sp_syspolicy_add_policy_category](sp-syspolicy-add-policy-category-transact-sql.md)  
## [процедура sp_syspolicy_add_policy_category_subscription](sp-syspolicy-add-policy-category-subscription-transact-sql.md)  
## [процедура sp_syspolicy_configure](sp-syspolicy-configure-transact-sql.md)  
## [процедура sp_syspolicy_delete_policy_category](sp-syspolicy-delete-policy-category-transact-sql.md)  
## [процедура sp_syspolicy_delete_policy_category_subscription](sp-syspolicy-delete-policy-category-subscription-transact-sql.md)  
## [процедура sp_syspolicy_delete_policy_execution_history](sp-syspolicy-delete-policy-execution-history-transact-sql.md)  
## [процедура sp_syspolicy_purge_health_state](sp-syspolicy-purge-health-state-transact-sql.md)  
## [процедура sp_syspolicy_purge_history](sp-syspolicy-purge-history-transact-sql.md)  
## [процедура sp_syspolicy_rename_condition](sp-syspolicy-rename-condition-transact-sql.md)  
## [процедура sp_syspolicy_rename_policy](sp-syspolicy-rename-policy-transact-sql.md)  
## [функция sp_syspolicy_rename_policy_category](sp-syspolicy-rename-policy-category-transact-sql.md)  
## [процедура sp_syspolicy_repair_policy_automation](sp-syspolicy-repair-policy-automation-transact-sql.md)  
## [процедура sp_syspolicy_set_config_enabled](sp-syspolicy-set-config-enabled-transact-sql.md)  
## [процедура sp_syspolicy_set_config_history_retention](sp-syspolicy-set-config-history-retention-transact-sql.md)  
## [процедура sp_syspolicy_set_log_on_success](sp-syspolicy-set-log-on-success-transact-sql.md)  
## [процедура sp_syspolicy_subscribe_to_policy_category](sp-syspolicy-subscribe-to-policy-category-transact-sql.md)  
## [процедура sp_syspolicy_unsubscribe_from_policy_category](sp-syspolicy-unsubscribe-from-policy-category-transact-sql.md)  
## [процедура sp_syspolicy_update_policy_category](sp-syspolicy-update-policy-category-transact-sql.md)  
## [процедура sp_syspolicy_update_policy_category_subscription](sp-syspolicy-update-policy-category-subscription-transact-sql.md)  
# [Хранилище запросов](query-store-stored-procedures-transact-sql.md)  
...
# [Безопасность](security-stored-procedures-transact-sql.md)  
## [sp_add_trusted_assembly](sys-sp-add-trusted-assembly-transact-sql.md)  
## [sp_addapprole, хранимая процедура](sp-addapprole-transact-sql.md)  
## [sp_addlogin](sp-addlogin-transact-sql.md)  
## [sp_addremotelogin](sp-addremotelogin-transact-sql.md)  
## [Хранимая процедура sp_addrole](sp-addrole-transact-sql.md)  
## [sp_addrolemember](sp-addrolemember-transact-sql.md)  
## [sp_addserver, хранимая процедура](sp-addserver-transact-sql.md)  
...
## [sp_change_users_login, хранимая процедура](sp-change-users-login-transact-sql.md)  
...
## [sp_dropapprole, хранимая процедура](sp-dropapprole-transact-sql.md)  
...
## [команду sp_refresh_parameter_encryption](sp-refresh-parameter-encryption-transact-sql.md)  
## [Хранимая процедура sp_remoteoption](sp-remoteoption-transact-sql.md)  
...
# [Хранилище данных SQL](sql-data-warehouse-stored-procedures.md)  
...
# [SQL Server, агент](sql-server-agent-stored-procedures-transact-sql.md)  
...
## [Хранимая процедура sp_add_proxy](sp-add-proxy-transact-sql.md)  
...
## [sp_delete_targetserver, хранимая процедура, хранимая процедура](sp-delete-targetserver-transact-sql.md)  
## [sp_delete_targetservergroup](sp-delete-targetservergroup-transact-sql.md)  
## [sp_delete_targetsvrgrp_member, хранимая процедура](sp-delete-targetsvrgrp-member-transact-sql.md)  
## [процедуру sp_detach_schedule](sp-detach-schedule-transact-sql.md)  
...
## [Хранимая процедура sp_help_operator](sp-help-operator-transact-sql.md)  
...
## [Хранимая процедура sp_update_alert](sp-update-alert-transact-sql.md)  
...
# [Приложение SQL Server Profiler](sql-server-profiler-stored-procedures-transact-sql.md)  
## [Хранимая процедура sp_trace_create](sp-trace-create-transact-sql.md)  
## [Хранимая процедура sp_trace_generateevent](sp-trace-generateevent-transact-sql.md)  
...
# [Расширенная база данных Stretch](stretch-database-extended-stored-procedures-transact-sql.md)  
...
## [использованием sp_db_selective_xml_index](sp-db-selective-xml-index-transact-sql.md)  
# [Репликация](replication-stored-procedures-transact-sql.md)  
...
## [Хранимая процедура sp_adddynamicsnapshot_job](sp-adddynamicsnapshot-job-transact-sql.md)  
...
## [sp_addscriptexec, хранимая процедура](sp-addscriptexec-transact-sql.md)  
...
## [Хранимая процедура sp_change_agent_parameter](sp-change-agent-parameter-transact-sql.md)  
## [Хранимая процедура sp_change_agent_profile](sp-change-agent-profile-transact-sql.md)  
...
## [sp_changedistpublisher, хранимая процедура](sp-changedistpublisher-transact-sql.md)  
...
## [sp_copymergesnapshot, хранимая процедура](sp-copymergesnapshot-transact-sql.md)  
...
## [sp_dropdynamicsnapshot_job, хранимая процедура](sp-dropdynamicsnapshot-job-transact-sql.md)  
## [Хранимая процедура sp_dropmergealternatepublisher](sp-dropmergealternatepublisher-transact-sql.md)  
...
## [sp_enumdsn, хранимая процедура](sp-enumdsn-transact-sql.md)  
...
## [Хранимая процедура sp_get_distributor](sp-get-distributor-transact-sql.md)  
## [sp_get_redirected_publisher](sp-get-redirected-publisher-transact-sql.md)  
## [процедуры sp_getagentparameterlist](sp-getagentparameterlist-transact-sql.md)  
...
## [процедура sp_help_peerconflictdetection](sp-help-peerconflictdetection-transact-sql.md)  
...
## [Хранимая процедура sp_helpdistpublisher](sp-helpdistpublisher-transact-sql.md)  
## [sp_helpdistributiondb](sp-helpdistributiondb-transact-sql.md)  
## [sp_helpdistributor](sp-helpdistributor-transact-sql.md)  
## [хранимую процедуру](sp-helpdistributor-properties-transact-sql.md)  
...
## [sp_helpmergeconflictrows, хранимая процедура](sp-helpmergeconflictrows-transact-sql.md)  
## [sp_helpmergedeleteconflictrows](sp-helpmergedeleteconflictrows-transact-sql.md)  
## [Хранимая процедура sp_helpmergefilter](sp-helpmergefilter-transact-sql.md)  
...
## [процедура sp_helppublication](sp-helppublication-transact-sql.md)  
...
## [Хранимая процедура sp_helpreplfailovermode](sp-helpreplfailovermode-transact-sql.md)  
## [sp_helpreplicationdboption](sp-helpreplicationdboption-transact-sql.md)  
## [Хранимая процедура sp_helpreplicationoption](sp-helpreplicationoption-transact-sql.md)  
...
## [работу sp_registercustomresolver](sp-registercustomresolver-transact-sql.md)  
...
## [Хранимая процедура sp_removedbreplication](sp-removedbreplication-transact-sql.md)  
## [sp_removedistpublisherdbreplication](sp-removedistpublisherdbreplication-transact-sql.md)  
## [Процедура sp_repladdcolumn](sp-repladdcolumn-transact-sql.md)  
...
## [sp_replmonitorhelppublicationthresholds, хранимая процедура](sp-replmonitorhelppublicationthresholds-transact-sql.md)  
## [sp_replmonitorhelppublisher, хранимая процедура](sp-replmonitorhelppublisher-transact-sql.md)  
...
## [Хранимая процедура sp_script_synctran_commands](sp-script-synctran-commands-transact-sql.md)  
...
## [sp_scriptsubconflicttable, хранимая процедура](sp-scriptsubconflicttable-transact-sql.md)  
## [sp_setdefaultdatatypemapping](sp-setdefaultdatatypemapping-transact-sql.md)  
## [Хранимая процедура sp_setreplfailovermode](sp-setreplfailovermode-transact-sql.md)  
## [sp_setsubscriptionxactseqno](sp-setsubscriptionxactseqno-transact-sql.md)  
## [процедура sp_showpendingchanges](sp-showpendingchanges-transact-sql.md)  
...
## [sp_validatemergesubscription, хранимая процедура](sp-validatemergesubscription-transact-sql.md)  
