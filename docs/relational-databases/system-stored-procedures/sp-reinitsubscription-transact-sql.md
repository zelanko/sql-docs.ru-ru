...
`[ @destination_db = ] 'destination_db'`Имя целевой базы данных. *destination_db* имеет тип **sysname**и значение по умолчанию ALL.  
