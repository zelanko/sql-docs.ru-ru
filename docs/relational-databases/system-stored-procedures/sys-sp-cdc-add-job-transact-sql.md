 ...
 *Непрерывная* допустим только для заданий записи.  
 ...
 [ **@pollinginterval** ] **=** _опроса\_интервал_  
 ...
 *хранение* допустим только для заданий очистки.  
 ...
 [  **@threshold =** ] **"**_удалить\_пороговое значение_**"**  
