...
|**0x400000000000**|Реплицирует все некластеризованные индексы columnstore для таблиц|  
|**0x800000000000**|Реплицирует все некластеризованные индексы columnstore флитеред для таблиц.|  
