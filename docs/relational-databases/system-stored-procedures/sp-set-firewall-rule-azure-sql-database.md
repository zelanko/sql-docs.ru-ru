...
## <a name="remarks"></a>Примечания  
 ...
 При добавлении параметра брандмауэра на уровне сервера `0.0.0.0`, в котором начальный и конечный IP-адреса равны, вы включаете доступ [!INCLUDE[ssSDS](../../includes/sssds-md.md)] к серверу из Azure. Укажите значение параметра *Name* , которое поможет вам запомнить параметры брандмауэра на уровне сервера.  
...
## <a name="permissions"></a>Разрешения  
 Только имя входа субъекта уровня сервера, созданное процессом подготовки или участником Azure Active Directory, назначенным администратором, может создавать или изменять правила брандмауэра на уровне сервера. Чтобы выполнить sp_set_firewall_rule, пользователь должен быть подключен к базе данных master.  
  
## <a name="examples"></a>Примеры  
 Следующий код создает параметр брандмауэра на уровне сервера с именем `Allow Azure` , который обеспечивает доступ из Azure. Выполните следующую инструкцию в виртуальной базе данных master.  
...
```  
 ...
 Следующий код создает параметр брандмауэра уровня сервера `Example setting 1` только для IP-адреса `0.0.0.2`. Затем хранимая процедура вызывается снова для обновления конечного IP-адреса на `0.0.0.4`, в этом параметре брандмауэра. `sp_set_firewall_rule` При этом создается диапазон, который разрешает IP `0.0.0.2`- `0.0.0.3`адресам `0.0.0.4` , и доступ к серверу.  
...
## <a name="see-also"></a>См. также  
 ...
 [Практическое руководство. Настройка параметров брандмауэра (база данных SQL Azure)](https://azure.microsoft.com/documentation/articles/sql-database-configure-firewall-settings/)   
