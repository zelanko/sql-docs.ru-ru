...
`[ @notify_email_operator_name = ] 'email_name'`Адрес электронной почты пользователя, которому отправляется сообщение электронной почты при достижении *email_level* . *email_name* имеет тип **sysname**и значение по умолчанию NULL.  
...
`[ @notify_page_operator_name = ] 'page_name'`Имя пользователя, которому будет присвоена страница после завершения этого задания. *page_name*имеет тип **sysname**и значение по умолчанию NULL.  
 ...
 **@originating_server** существует в **sp_add_job,** но отсутствует в списке arguments. **@originating_server** зарезервировано для внутреннего использования.  
  
 После выполнения **sp_add_job** для добавления задания **sp_add_jobstep** можно использовать для добавления шагов, выполняющих действия для задания. **sp_add_jobschedule** можно использовать для создания расписания, [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] используемого службой агента для выполнения задания. Используйте **sp_add_jobserver** , чтобы задать [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] экземпляр, в котором выполняется задание, и **sp_delete_jobserver** , [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] чтобы удалить задание из экземпляра.  
...
-   **SQLAgentOperatorRole**  
 ...
 Только члены предопределенной роли сервера **sysadmin** могут устанавливать или изменять значение для **@owner_login_name** параметра. Если пользователи, не являющиеся членами роли **sysadmin** и не изменяют значение **@owner_login_name** , выполнение этой хранимой процедуры завершается ошибкой и возвращается ошибка.  
