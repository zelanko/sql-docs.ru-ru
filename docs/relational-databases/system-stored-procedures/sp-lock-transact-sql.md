...
|**Состояние**|**nvarchar(5)**|Состояние запроса блокировки:<br /><br /> CNVRT: Блокировка, преобразованная в другом режиме, но преобразование заблокирован другим процессом, удерживающим блокировку в конфликтном режиме.<br /><br /> GRANT: Блокировка получена.<br /><br /> WAIT. Блокировка занята другим процессом, удерживающим блокировку в конфликтном режиме.|  
