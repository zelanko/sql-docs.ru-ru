...
## <a name="arguments"></a>Аргументы  
 [  **@spid1 =** ] **"***session ID1***"**  
 — [!INCLUDE[ssDE](../../includes/ssde-md.md)] Числовой идентификатор сеанса из **sys.dm_exec_sessions** для которого пользователю требуются сведения о блокировке. *Session ID1* — **int** со значением по умолчанию NULL. Выполнение **sp_who** для получения сведений о сеансе. Если *session ID1* не указан, отображается информация обо всех блокировках.  
  
 [  **@spid2 =** ] **"***сеанса ID2***"**  
 Другой [!INCLUDE[ssDE](../../includes/ssde-md.md)] числовой идентификатор сеанса из **sys.dm_exec_sessions** , может иметь блокировку в то же время, как *session ID1* и о том, какие пользователю также требуются сведения. *сеанс ID2* — **int** со значением по умолчанию NULL.  
...
|**Состояние**|**nvarchar(5)**|Состояние запроса блокировки:<br /><br /> CNVRT: Блокировка, преобразованная в другом режиме, но преобразование заблокирован другим процессом, удерживающим блокировку в конфликтном режиме.<br /><br /> Предоставление: Блокировка получена.<br /><br /> Ожидание: Блокировка занята другим процессом, удерживающим блокировку в конфликтном режиме.|  
