...
|**article name**|**имеет sysname**|Имя статьи.|  
|**base object**|**nvarchar (257)**|Имя базовой таблицы, заданной в статье или в хранимой процедуре.|  
|**Объект destination**|**имеет sysname**|Имя целевой таблицы (таблицы подписки).|  
...
|**dest_owner**|**имеет sysname**|Имя владельца целевого объекта.|  
|**source_owner**|**имеет sysname**|Владелец исходного объекта.|  
|**unqua_source_object**|**имеет sysname**|Имя исходного объекта без учета имени его владельца.|  
|**sync_object_owner**|**имеет sysname**|Владелец представления, определяющего опубликованную статью. .|  
|**unqualified_sync_object**|**имеет sysname**|Имя представления, определяющего опубликованную статью, без учета имени владельца.|  
|**filter_owner**|**имеет sysname**|Владелец фильтра.|  
|**unqua_filter**|**имеет sysname**|Имя фильтра без учета имени его владельца.|  
