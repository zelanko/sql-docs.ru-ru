...
> [!NOTE]  
>  не следует указывать *Издатель* при запросе сведений о статье, [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] опубликованной издателем.  
...
|**вертикальная секция**|**bit**|Указывает, включено ли вертикальное секционирование для статьи; значение **1** означает, что вертикальное секционирование включено.|  
...
|**schema_option**|**Binary (8)**|Битовая карта параметра создания схемы для заданной статьи. Полный список значений аргумента **schema_option** см. в [разделе &#40;sp_addarticle Transact-&#41;SQL](../../relational-databases/system-stored-procedures/sp-addarticle-transact-sql.md).|  
...
|**publisher_identity_range**|**int**|Размер диапазона для диапазона идентификаторов на издателе, если в статье *identityrangemanagementoption* задано значение **Auto** или **auto_identity_range** установлено значение **true**.|  
|**identity_range**|**bigint**|Размер диапазона для диапазона идентификаторов на подписчике, если в статье *identityrangemanagementoption* задано значение **Auto** или **auto_identity_range** установлено значение **true**.|  
