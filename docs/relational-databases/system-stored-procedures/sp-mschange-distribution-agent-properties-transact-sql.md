...
|**subscriber_security_mode**|**одного**|Проверка подлинности Windows.<br /><br /> [!INCLUDE[ssNoteWinAuthentication](../../includes/ssnotewinauthentication-md.md)]|  
...
||**одного**|Сервер источника данных ODBC|  
