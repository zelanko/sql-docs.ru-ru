...
`[ @defdb = ] 'database'` — Имя новой базы данных по умолчанию. *База данных* — **sysname**, не имеет значения по умолчанию. *База данных* уже должен существовать.  
