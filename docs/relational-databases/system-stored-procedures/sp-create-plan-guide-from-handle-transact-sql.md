---
title: sp_create_plan_guide_from_handle (Transact-SQL) | Документы Microsoft
ms.custom: ''
ms.date: 03/16/2017
ms.prod: sql
...
## <a name="arguments"></a>Аргументы  
 ...
 [ @statement_start_offset =] { *statement_start_offset* | NULL}]  
 Идентифицирует начальную позицию инструкции внутри пакета, указываемого параметром *plan_handle*. *statement_start_offset* — **int**, значение по умолчанию NULL.  
