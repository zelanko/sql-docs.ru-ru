...
## <a name="arguments"></a>Аргументы  
 [  **\@номер_сообщения =** ] *msg_id*  
 Идентификатор сообщения. *msg_id* — **int** значение по умолчанию NULL. *msg_id* для ошибки, определенные пользователем сообщения может быть в диапазоне от 50 001 до 2 147 483 647. Сочетание *msg_id* и *языка* должно быть уникальным; ошибка возвращается, если такой идентификатор уже задан для указанного языка.  
  
 [  **\@серьезность =** ]*серьезности*  
