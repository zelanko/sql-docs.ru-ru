...
[!INCLUDE[tsql-appliesto-ss2016-asdb-xxxx-xxx-md](../../includes/tsql-appliesto-ss2016-asdb-xxxx-xxx-md.md)]
  ...
  Анализирует указанный [!INCLUDE[tsql](../../includes/tsql-md.md)] инструкции и его параметры, чтобы определить, какие параметры соответствуют столбцам базы данных, защищенных с помощью функции постоянного шифрования. Возвращает метаданные шифрования для параметров, которые соответствуют зашифрованным столбцам.  
...
-   Результирующий набор, описывающий криптографических ключей, настроенным для столбцов базы данных, параметры указанного [!INCLUDE[tsql](../../includes/tsql-md.md)] соответствующие инструкции.  
  
-   Результирующий набор, описывающие параметры, каким образом конкретные должны быть зашифрованы. Этот результирующий набор ссылок ключами, описанными в первый результирующий набор.  
...
|**column_master_key_store_provider_name**|**sysname**|Имя поставщика хранилища ключей, который содержит главный ключ столбца, который использовался для создания зашифрованного значения ключа шифрования столбца.|  
|**column_master_key_path**|**nvarchar(4000)**|Путь к разделу главного ключа столбца, который использовался для создания зашифрованного значения ключа шифрования столбца.|  
...
|**column_encryption_normalization_rule_version**|**tinyint**|Номер версии алгоритмом нормализации по типу.|  
