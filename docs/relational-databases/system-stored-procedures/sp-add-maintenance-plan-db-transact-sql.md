...
`[ @db_name = ] 'database_name'` Указывает имя базы данных для добавления к плану обслуживания. База данных должна быть создана или уже существовать до добавления в план. Аргумент *database_name* имеет тип **sysname**.  
