...
`[ @objname = ] 'name'` — Имя любого объекта в **sysobjects** или любого определяемого пользователем типа данных в **systypes** таблицы. *имя* — **nvarchar (** 776 **)**, значение по умолчанию NULL. Имена баз данных неприемлемы.  Имена из двух или трех частей должны содержать разделители, например "<Человек>.<Тип_адреса>" или [<Человек>.<Тип_адреса>].   
...
## <a name="result-sets"></a>Результирующие наборы  
 Результирующие наборы, возвращаемые зависят от того *имя* будет указано, когда он указан, и какой объект базы данных.  
...
3.  Если *имя* — это любой объект базы данных, кроме типа данных, **sp_help** возвращает этот результирующий задано, а также дополнительные результирующие наборы, основанные на тип указанного объекта.  
    ...
    -   Дополнительный результирующий набор, возвращаемый для объектов столбца:  
        ...
        |**Вычисляемый**|**varchar(** 35 **)**|Указывает, являются ли значения в столбце вычисляемыми: Yes или No.|  
        ...
        |**Допускает значения NULL**|**varchar(** 35 **)**|Указывает, допустимы ли для столбца значения NULL: Yes или No.|  
    ...
    -   Дополнительный результирующий набор, возвращаемый для файловых групп:  
        ...
        |Имя столбца|Тип данных|Описание|  
        |-----------------|---------------|-----------------|  
        |**Data_located_on_filegroup**|**nvarchar(** 128 **)**|Файловая группа, в которой расположены данные: главная, вторичная или группа журнала транзакций.|  
    ...
    -   Дополнительный результирующий набор, возвращаемый для ограничений:  
        ...
        |**status_enabled**|**varchar(** 8 **)**|Указывает, включено ли ограничение: Enabled, Disabled или N/A.<br /><br /> Применимо только для ограничений CHECK и FOREIGN KEY.|  
