...
|**база данных издателя**|**имеет sysname**|Имя базы данных издателя.|  
...
|**имя для входа издателя**|**имеет sysname**|Идентификатор входа, используемый на издателе для проверки подлинности [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)].|  
...
|**distributor_login**|**имеет sysname**|Идентификатор входа, используемый на распространителе для проверки подлинности [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)].|  
...
|**ftp_address**|**имеет sysname**|Только для обратной совместимости.|  
|**ftp_port**|**int**|Только для обратной совместимости.|  
|**ftp_login**|**имеет sysname**|Только для обратной совместимости.|  
