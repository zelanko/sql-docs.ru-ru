...
|**NONE**|Категория для класса, отличных от **задания**.|  
 ...
 [  **@suffix=** ] *суффикс*  
 Указывает, является ли **category_type** столбца в результирующем наборе — идентификатор или имя. *суффикс* — **бит**, значение по умолчанию **0**. **1** показывает **category_type** как имя, и **0** отображает их в качестве идентификатора.  
