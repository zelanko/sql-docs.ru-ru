...
|Значение|Описание|  
|-----------|-----------------|  
|**КАЖДОГО**|Сведения об аспекте задания|  
...
|**одного**|Выполняющиеся.|  
|**2**|Ожидающие потока.|  
|**3-5**|Ожидающие повторной попытки.|  
|**четырех**|Бездействующие.|  
|**5.0**|Приостановленные.|  
...
|**безымян**|**имеет sysname**|Имя задания.|  
...
|**категори**|**имеет sysname**|Категория задания.|  
|**владельцев**|**имеет sysname**|Владелец задания.|  
...
|**notify_email_operator**|**имеет sysname**|Имя адреса электронной почты уведомляемого оператора.|  
|**notify_netsend_operator**|**имеет sysname**|Имя компьютера или пользователя, используемое при отправке сетевых сообщений.|  
|**notify_page_operator**|**имеет sysname**|Имя компьютера или пользователя, используемое при отправке сообщения на пейджер.|  
...
|**номер_версии**|**int**|Версия задания (автоматически обновляется при каждом изменении задания).|  
...
|**current_execution_step**|**имеет sysname**|Текущий этап выполнения задания.|  
...
|**Тип**|**int**|Тип задания.<br /><br /> 1 = Локальное задание.<br /><br /> **2** = многосерверное задание.<br /><br /> **0** = задание не имеет целевых серверов.|  
...
|**Метки**|**nvarchar (4000)**|**Битовая маска** значений, управляющих поведением шага.|  
...
|**schedule_name**|**имеет sysname**|Имя расписания (уникально только для данного задания).|  
...
### <a name="a-list-information-for-all-jobs"></a>а. Вывод списка сведений обо всех заданиях  
...
### <a name="b-listing-information-for-jobs-matching-a-specific-criteria"></a>B. Вывод сведений о заданиях, совпадающих с определенным критерием  
...
### <a name="c-listing-all-aspects-of-information-for-a-job"></a>C. Вывод всех аспектов сведений о задании  
