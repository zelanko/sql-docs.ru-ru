...
-   Метод возвращает массив в качестве выходного параметра.  
 ...
 Если указано, *parametername* должно быть имя [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[vbprvb](../../includes/vbprvb-md.md)] именованного параметра. Обратите внимание, что  **@** *parametername*не [!INCLUDE[tsql](../../includes/tsql-md.md)] локальной переменной. Знак (**@**) удаляется, и *parametername*передается на объект OLE, что имя параметра. Все именованные параметры должны указываться после указания всех позиционных параметров.  
