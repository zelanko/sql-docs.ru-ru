...
## <a name="arguments"></a>Аргументы  
 ...
 [  **@parameter_name=**] **"***parameter_name***"**  
 Имя параметра, который необходимо удалить. *имя_параметра* — **sysname**, значение по умолчанию **%**. Если **%**, удаляются все параметры для данного профиля.  
