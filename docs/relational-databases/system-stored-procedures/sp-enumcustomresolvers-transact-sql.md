...
`[ @distributor = ] 'distributor'` — Имя распространителя, где находится пользовательский Сопоставитель. *распространитель* — **sysname**, значение по умолчанию NULL. *Этот параметр является устаревшим и будет удален в будущем выпуске.*  
