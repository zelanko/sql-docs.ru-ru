---
title: "sp_help_jobcount (Transact-SQL) | Документы Microsoft"
ms.custom: 
ms.date: 03/14/2017
...
## <a name="arguments"></a>Аргументы  
 [ **@schedule_id=** ] *schedule_id*  
 Идентификатор расписания, сведения о котором следует возвратить. *schedule_id* — **int**, не имеет значения по умолчанию. Либо *schedule_id* или *schedule_name* может быть указан.  
...
-   **SQLAgentOperatorRole**  
 ...
 Только члены **sysadmin** могут просматривать количество заданий, принадлежащих другим пользователям.  
