...
[!INCLUDE[appliesto-ss-asdbmi-xxxx-xxx-md](../../includes/appliesto-ss-asdbmi-xxxx-xxx-md.md)]
  ...
  Отображает или изменяет свойства издателя для издателей, не от[!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]. Эта хранимая процедура выполняется на распространителе.  
 ...
 **sp_publisherproperty** используется в репликации транзакций для издателей, отличных от [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)].  
