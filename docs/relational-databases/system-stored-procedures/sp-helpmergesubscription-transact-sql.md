...
## <a name="arguments"></a>Аргументы  
 ...
 [  **@publisher=**] **"***издателя***"**  
 Имя издателя. Издатель должен быть действительным сервером. *издатель*— **sysname**, значение по умолчанию **%**, который возвращает сведения обо всех издателях.  
