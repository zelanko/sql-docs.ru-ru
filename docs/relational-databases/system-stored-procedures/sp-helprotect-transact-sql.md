...
## <a name="arguments"></a>Аргументы  
 [  **@name =** ] **"**_аргумент object_statement_**"**  
 ...
 Имя участника, для которого возвращаются разрешения. *security_account* — **sysname**, значение по умолчанию NULL, когда возвращаются все участники текущей базы данных. *security_account* должен существовать в текущей базе данных.  
  
 [  **@grantorname =** ] **"**_grantor_**"**  
 Имя участника, который предоставил разрешения. *Объект, предоставляющий разрешение* — **sysname**, значение по умолчанию NULL, который возвращает сведения о разрешениях, предоставляемых любым участником в базе данных.  
  
 [  **@permissionarea =** ] **"**_тип_**"**  
 Символьная строка, указывающее, следует ли отображать разрешений на объект (строка символов **o**), разрешения на выполнение инструкций (строка символов **s**), или оба (**ОС**). *Тип* — **varchar(10)**, значение по умолчанию **ОС**. *Тип* может быть любым сочетанием **o** и **s**с или без запятые или пробелы между **o** и **s**.  
