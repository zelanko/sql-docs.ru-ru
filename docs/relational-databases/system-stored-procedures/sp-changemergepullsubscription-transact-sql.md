...
|**use_ftp**|**условия**|Для получения моментальных снимков используется FTP вместо обычного протокола.|  
||**IsFalse**|Получение моментальных снимков с помощью обычного протокола.|  
|**use_web_sync**|**условия**|Подписку можно синхронизировать через HTTP.|  
||**IsFalse**|Подписку нельзя синхронизировать через HTTP.|  
|**use_interactive_resolver**|**условия**|При проверке используется интерактивный сопоставитель.|  
||**IsFalse**|Интерактивный сопоставитель не используется.|  
