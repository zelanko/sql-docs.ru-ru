---
title: процедура sp_syspolicy_set_log_on_success (Transact-SQL) | Документация Майкрософт
ms.custom: ''
ms.date: 08/09/2016
ms.prod: sql
...
`[ @value = ] value` Определяет, является ли успешное выполнение политик заносится в журнал. *значение* — **sqlvariant**, и может принимать одно из следующих значений:  
...
## <a name="remarks"></a>Примечания  
 ...
 Когда *значение* только значение 0 или значение «false», ошибка заносится в журнал политик.  
