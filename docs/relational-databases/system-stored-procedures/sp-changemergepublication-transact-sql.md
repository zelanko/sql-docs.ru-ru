 ...
 **sp_changemergepublication** используется в репликации слиянием.  
 ...
 Изменение следующих свойств требует создания нового моментального снимка. Вам необходимо указать значение **1** для *подписки потребуют* параметра.  
