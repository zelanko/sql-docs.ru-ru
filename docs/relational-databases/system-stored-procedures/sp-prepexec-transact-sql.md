 ...
 *справиться*  
 — Это созданный идентификатор *маркера.* [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] *Handle* является обязательным параметром с возвращаемым значением **int** .  
