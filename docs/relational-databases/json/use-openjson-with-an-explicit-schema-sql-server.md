---
description: Использование функции OPENJSON с явной схемой (SQL Server)
title: Использование функции OPENJSON с явной схемой
ms.date: 06/03/2020
ms.prod: sql
ms.technology: ''
ms.topic: conceptual
...
## <a name="example---load-json-into-a-ssnoversion-table"></a>Пример загрузки объекта JSON в таблицу [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] .  
