---
title: "Часто задаваемые вопросы о JSON в SQL Server | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "07/07/2016"
...
### Для получения длинных текстовых значений вместо JSON_VALUE используйте параметр OPENJSON.  
