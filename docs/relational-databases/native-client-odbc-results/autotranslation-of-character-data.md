...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)]
 ...
 Если для параметра автоперевода задано значение "Да", драйвер ODBC для собственного клиента [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] использует Юникод для преобразования данных, перемещаемых между SQL_C_CHARными переменными на клиенте, и **символьными**, **varchar**или **текстовыми** столбцами, переменными или параметрами в [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] СУБД  
  
-   При отправке данных из переменной SQL_C_CHAR на клиенте в столбец **типа char**, **varchar**или **Text** , переменную или параметр в [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] базе данных драйвер ODBC сначала преобразует из SQL_C_CHAR в Юникод, используя ACP клиента. , а затем из Юникода обратно в символ с помощью ACP сервера.  
  
-   При отправке данных из столбца, переменной или параметра **типа char**, **varchar**или **Text** в [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] базу данных в SQL_C_CHARую переменную на клиенте, [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] драйвер ODBC для собственного клиента сначала ПРЕОБРАЗУЕТ символы в Юникод с помощью ACP. сервера, а затем обратно на SQL_C_CHAR с помощью ACP клиента.  
