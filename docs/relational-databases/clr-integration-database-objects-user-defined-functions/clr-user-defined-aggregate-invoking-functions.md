...
-   Текущий пользователь должен иметь **EXECUTE** разрешений на определяемую пользователем агрегатную функцию.  
...
## <a name="example-2"></a>Пример 2  
 В следующем примере показана статистическая функция, имеющая два параметра в **Accumulate** метод.  
