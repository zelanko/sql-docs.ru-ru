...
## <a name="return-code-values"></a>Значения кода возврата  
 ...
 E_UNEXPECTED  
 Метод был вызван для набора строк массового копирования, ранее не делает недействительными [IRowsetFastLoad::Commit](../../relational-databases/native-client-ole-db-interfaces/irowsetfastload-commit-ole-db.md) метод.  
