 ...
 *pwszTable*[in]  
 ...
 Если аргумент eDirection имеет значение BCP_DIRECTION_OUT и инструкция SELECT указывается с помощью **BCPControl** метод до **BCPExec** вызывается метод, *pwszTable*аргумент должен иметь значение NULL.  
