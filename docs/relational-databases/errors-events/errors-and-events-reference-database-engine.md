...
description: Сведения о выбранных ядром СУБД SQL Server сообщениях об ошибках, которые требуют дальнейшего объяснения и использования ссылок на внешние ресурсы.
ms.custom: ''
ms.date: 10/15/2019
ms.prod: sql
ms.reviewer: ''
