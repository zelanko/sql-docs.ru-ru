...
|Идентификатор события|10771|  
|Источник события|MSSQLSERVER|  
|Компонент|SQLEngine|  
|Символическое имя|P3_HEKATON_TABLE_IMP|  
|Текст сообщения|*Построение* "*функция*" еще не реализовано для оптимизированных в памяти таблиц.|  
