---
title: "Степени серьезности ошибок компонента Database Engine | Microsoft Docs"
ms.custom: ""
ms.date: "03/16/2017"
...
helpviewer_keywords: 
  ...
  - "степени серьезности [SQL Server]"
  - "определение серьезности ошибки"
  - "ошибки [агент SQL Server], серьезность"
...
## См. также:  
 ...
 [Системные функции (Transact-SQL)](../../t-sql/functions/system-functions-transact-sql.md)   
