---
description: Возвращающие табличное значение параметры (собственный клиент SQL Server)
...
[!INCLUDE [SQL Server](../../../includes/applies-to-version/sql-asdb-asdbmi-asa-pdw.md)]
 ...
 Сведения о параметрах, возвращающих табличное значение, и OLE DB см. этой [статье](../../../relational-databases/native-client-ole-db-table-valued-parameters/table-valued-parameters-ole-db.md).  
