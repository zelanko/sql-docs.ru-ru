...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]
 ...
 При открытии ** \@ \@** соединения базы данных ПО умолчанию будет установлено значение -1 ("неограниченный").  
...
## <a name="querying-for-filestream-columns"></a>Запрос столбцов FILESTREAM  
 ...
 Функции каталога, такие как S'LColumns в ODBC, не будут сообщать, является ли столбец колонкой FILESTREAM.  
...
## <a name="down-level-compatibility"></a>Совместимость на низком уровне  
 Если ваш клиент был составлен [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] с использованием версии Native Client, [!INCLUDE[ssVersion2005](../../../includes/ssversion2005-md.md)] [!INCLUDE[ssCurrent](../../../includes/sscurrent-md.md)]которая была включена с, и приложение подключается к, **varbinary(max)** поведение будет совместимо с [!INCLUDE[ssVersion2005](../../../includes/ssversion2005-md.md)]. Это означает, что максимальный размер возвращаемых данных будет ограничен 2 ГБ. Для результирующих значений больше 2 ГБ произойдет усечение, и будет возвращено сообщение "Усечение строковых данных справа".  
 ...
 Для клиентов, которые используют S'LOLEDB или [!INCLUDE[ssVersion2005](../../../includes/ssversion2005-md.md)] других [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] поставщиков, которые были выпущены до версии Родной Клиент, **varbinary(max)** будут отображены к изображению.  
