...
description: Узнайте, как использовать файлы заголовка и библиотеки SQL Server Native Client для разработки приложения. Скопируйте необходимые файлы в среду разработки.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
