...
|**Network**|Допустимые значения: **dbnmpntw** (именованные каналы) и **dbmssocn** (TCP/IP).<br /><br /> Это ошибка одновременное указание значения для **сети** ключевое слово и префикса протокола на **сервера** ключевое слово.|  
