...
description: Чтобы использовать новые функции, появившиеся в SQL Server 2005, в существующих приложениях, использующих ADO, должен использоваться поставщик SQL Server Native Client OLE DB.
ms.custom: ''
ms.date: 03/16/2017
ms.prod: sql
ms.reviewer: ''
...
-   `DataTypeCompatibility=80`  
 ...
 Дополнительные сведения о ключевых словах строки подключения ADO, поддерживаемых в [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] собственном клиенте, см. в разделе [Использование ключевых слов строки подключения с SQL Server Native Client](../../../relational-databases/native-client/applications/using-connection-string-keywords-with-sql-server-native-client.md).  
