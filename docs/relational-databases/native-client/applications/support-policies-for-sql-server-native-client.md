---
title: Политики поддержки
description: Узнайте о SQL Server Native Client поддерживаемых SQL Server версиях, операционных системах и политиках поддержки для ADO, BCP, ODBC и OLE DB.
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
ms.custom: ''
