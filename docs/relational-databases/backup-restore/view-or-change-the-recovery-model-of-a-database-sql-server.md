...
description: Узнайте, как переключить базу данных SQL Server с одной модели восстановления на другую с помощью SQL Server Management Studio или Transact-SQL.
