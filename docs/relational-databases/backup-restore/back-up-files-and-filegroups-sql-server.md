---
title: "Создание резервных копий файлов и файловых групп (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "08/02/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "создание резервных копий файловых групп [SQL Server]"
  - "резервные копии файлов [SQL Server], инструкции"
  - "создание резервных копий файлов [SQL Server]"
  - "резервные копии [SQL Server], создание"
  - "файловые группы [SQL Server], резервное копирование"
...
-   Дополнительные сведения об ограничениях см. в разделе [Общие сведения о резервном копировании](../../relational-databases/backup-restore/backup-overview-sql-server.md).  
...
## Создание резервных копий файлов и файловых групп с помощью SSMS   
...
## Создание резервных копий файлов и файловых групп с помощью T-SQL
...
1.  Используйте командлет **Backup-SqlDatabase** и укажите **Files** в качестве значения параметра **-BackupAction**. Также укажите один из следующих параметров:  
    ...
    -   Чтобы создать резервную копию определенного файла, укажите параметр **-DatabaseFile***String*, где *String* ― это один или несколько файлов базы данных для резервного копирования.  
  
    -   Чтобы создать резервную копию всех файлов из заданной файловой группы, укажите параметр **-DatabaseFileGroup***String*, где *String* ― это одна или несколько файловых групп базы данных для резервного копирования.  
