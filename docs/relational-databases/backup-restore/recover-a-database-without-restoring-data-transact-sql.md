---
title: "Восстановление базы данных без восстановления данных (Transact-SQL) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "восстановление [SQL Server], только восстановление"
  - "сценарий только восстановления [сервер SQL Server]"
  - "восстановление баз данных [SQL Server], только восстановление"
  - "восстановление [SQL Server], только восстановление"
  - "восстановление базы данных [SQL Server]"
  - "восстановление баз данных [SQL Server], только восстановление"
  - "восстановление [SQL Server], без восстановления данных"
...
-   База данных находится в режиме ожидания, поэтому необходимо сделать ее доступной для обновлений без применения еще одной резервной копии журналов.  
 ...
 Синтаксис инструкции [RESTORE](../Topic/RESTORE%20\(Transact-SQL\).md) для восстановления базы данных только по журналу транзакций:  
...
## Восстановление файлов только по журналу транзакций  
 ...
 Синтаксис инструкции [RESTORE](../Topic/RESTORE%20\(Transact-SQL\).md) для восстановления файлов только по журналу транзакций:  
