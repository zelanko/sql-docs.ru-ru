...
description: Эта статья содержит сведения о восстановлении полной резервной копии базы данных SQL Server с использованием среды SQL Server Management Studio.
ms.custom: ''
ms.date: 11/16/2016
ms.prod: sql
...
1. Введите подписанный URL-адрес в поле форматированного текста **Подписанный URL-адрес:** .
1. Нажмите кнопку **ОК** , чтобы открыть диалоговое окно **Поиск файла резервной копии в Microsoft Azure** .
1. Разверните узел **Контейнеры** и перейдите к `https://mystorageaccount.blob.core.windows.net/myfirstcontainer`.
1. Удерживая клавишу ctrl, выберите файлы `Sales_stripe1of2_20160601.bak` и `Sales_stripe2of2_20160601.bak`.
1. Нажмите кнопку **ОК**.
1. Нажмите кнопку **OK** , чтобы вернуться на страницу **Общие** .
1. Нажмите кнопку **Параметры** на панели **Выбрать страницу** .
1. в разделе **Параметры восстановления** установите флажок **Перезаписать существующую базу данных (WITH REPLACE)** .
1. В разделе **Резервная копия заключительного фрагмента журнала** снимите флажок **Делать резервную копию заключительного фрагмента журнала перед восстановлением**.
1. В разделе **Соединения с сервером** установите флажок **Закрыть существующие подключения к целевой базе данных**.
1. Нажмите кнопку **ОК**.
...
1. Выполните все действия в диалоговом окне **Соединение с подпиской Microsoft** и нажмите кнопку **ОК** , чтобы вернуться в диалоговое окно **Выбор расположения файла резервной копии** .  См. дополнительные сведения в статье [Соединение с подпиской Microsoft Azure](../../relational-databases/backup-restore/connect-to-a-microsoft-azure-subscription.md) .
1. Нажмите кнопку **ОК** в диалоговом окне **Выбор расположения файла резервной копии** , чтобы открыть диалоговое окно **Поиск файла резервной копии в Microsoft Azure** .
1. Разверните узел **Контейнеры** и перейдите к `https://mystorageaccount.blob.core.windows.net/myfirstcontainer`.
1. Выберите файл резервной копии и нажмите кнопку **ОК**.
1. Нажмите кнопку **OK** , чтобы вернуться на страницу **Общие** .
1. Нажмите кнопку **ОК**.
