---
title: "Резервные копии моментальных снимков файлов для файлов базы данных в Azure | Microsoft Docs"
ms.custom: 
  - "IAAS"
  - "SQL2016_New_Updated"
ms.date: "05/23/2016"
...
-   Есть учетная запись Azure?  Затем перейдите **[сюда](https://azure.microsoft.com/marketplace/partners/microsoft/sqlserver2016ctp3evaluationwindowsserver2012r2/?wt.mc_id=sqL16_vm)**, чтобы запустить виртуальную машину с уже установленным [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)].  
  
## Использование моментальных снимков для резервного копирования файлов базы данных, хранящихся в Azure  
  
### Что представляет собой резервная копия моментальных снимков файлов [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]  
...
## Резервное копирование базы данных и журнала с помощью резервной копии моментальных снимков файлов  
...
## Восстановление из резервной копии моментальных снимков файлов [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]  
...
## Восстановление из резервной копии моментальных снимков файлов [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] до точки во времени  
...
## Удаление отдельной резервной копии моментальных снимков файлов базы данных  
