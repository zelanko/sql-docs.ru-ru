---
title: "Восстановление разностной резервной копии базы данных (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "полные разностные резервные копии [SQL Server]"
  - "восстановление баз данных [SQL Server], полные разностные резервные копии"
  - "резервные копии баз данных [SQL Server], полные разностные резервные копии"
  - "восстановление баз данных [SQL Server], полные разностные резервные копии"
  - "резервное копирование баз данных [SQL Server], полные разностные резервные копии"
