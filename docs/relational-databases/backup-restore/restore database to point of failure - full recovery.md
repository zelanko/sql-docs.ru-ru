---
title: "Восстановление базы данных до точки сбоя в модели полного восстановления (Transact-SQL) | Microsoft Docs"
ms.custom: ""
ms.date: "03/23/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "точка сбоя [SQL Server]"
  - "восстановление баз данных [SQL Server], точка отказа"
  - "восстановление баз данных [SQL Server], точка отказа"
...
2.  Восстановите базу данных из ее полной резервной копии, взяв за основу следующую инструкцию [RESTORE DATABASE](../Topic/RESTORE%20\(Transact-SQL\).md) :  
