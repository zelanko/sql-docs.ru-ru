...
description: Узнайте, как на SQL Server просматривать данные и файлы журналов в резервном наборе данных с помощью SQL Server Management Studio или Transact-SQL.
