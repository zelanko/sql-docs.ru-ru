---
title: "Восстановление базы данных до помеченной транзакции (среда SQL Server Management Studio) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  - "восстановления баз данных [SQL Server], помеченные транзакции"
  - "восстановление баз данных [SQL Server], помеченные транзакции"
