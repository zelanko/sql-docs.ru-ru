---
title: "Поэтапное восстановление (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "частичные обновления [SQL Server]"
  - "поэтапные восстановления [SQL Server]"
  - "поэтапное восстановление [SQL Server]"
  - "восстановление [SQL Server], сценарий поэтапного восстановления"
