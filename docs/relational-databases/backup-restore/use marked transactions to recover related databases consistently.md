---
title: "Использование помеченных транзакций для согласованного восстановления связанных баз данных (модель полного восстановления) | Microsoft Docs"
ms.custom: ""
ms.date: "03/23/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "метки транзакций [SQL Server]"
  - "помеченные транзакции [SQL Server]"
  - "восстановление баз данных [SQL Server], вставка меток транзакций для"
  - "восстановление [SQL Server], связанные базы данных"
  - "восстановление баз данных [SQL Server], восстановление связанных баз данных"
  - "восстановление баз данных [SQL Server], связанные базы данных"
  - "помеченные транзакции [SQL Server], создание"
  - "BEGIN TRAN...WITH MARK, инструкция"
  - "двухфазная фиксация"
...
manager: "jhubbard"
---
# Использование помеченных транзакций для согласованного восстановления связанных баз данных (модель полного восстановления)
