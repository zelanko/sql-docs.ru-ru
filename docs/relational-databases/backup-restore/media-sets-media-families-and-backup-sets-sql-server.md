---
title: "Наборы носителей, семейства носителей и резервные наборы данных (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "07/18/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "наборы носителей [SQL Server], сведения о наборах носителей"
  - "резервные носители [SQL Server], сведения о резервных носителях"
  - "резервные копии [SQL Server], наборы носителей"
  - "наборы носителей [SQL Server]"
  - "заголовки носителей [SQL Server]"
  - "резервные наборы данных [SQL Server], сведения о резервных наборах данных"
  - "резервные носители [SQL Server], наборы носителей"
  - "резервные копии [SQL Server], семейства носителей"
  - "резервные носители [SQL Server], семейства носителей"
  - "семейства носителей [SQL Server]"
  - "резервные копии [SQL Server], резервные наборы данных"
  - "резервные наборы данных [SQL Server]"
...
> **ПРИМЕЧАНИЕ.** Для предотвращения потери данных в случае повреждения носителя (ленты или файла на диске), наборы носителей можно сделать зеркальными. Дополнительные сведения см. в разделе [Зеркальные наборы носителей резервных копий (SQL Server)](../../relational-databases/backup-restore/mirrored-backup-media-sets-sql-server.md).  
...
##  <a name="Appending"></a> Присоединение к существующим резервным наборам данных  
...
##  <a name="Overwriting"></a> Перезапись резервных наборов копий  
...
-   Срок действия резервных копий на носителе еще не истек. (При указании аргумента SKIP срок действия не проверяется.)  
     ...
     Дата истечения срока хранения указывает день, когда истечет срок хранения резервной копии, и она сможет быть заменена другой копией. Дату истечения срока хранения резервной копии можно указать при ее создании. По умолчанию дата истечения срока хранения определяется набором параметров **media retention** хранимой процедуры **sp_configure**. Дополнительные сведения см. в разделе [sp_configure (Transact-SQL)](../../relational-databases/system-stored-procedures/sp-configure-transact-sql.md).  
