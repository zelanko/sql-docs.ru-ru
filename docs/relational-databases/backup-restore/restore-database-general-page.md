---
title: "Восстановление базы данных (страница &#171;Общие&#187;) | Microsoft Docs"
ms.custom: ""
ms.date: "07/01/2016"
...
> [!NOTE]  
>  Если задача восстановления выполняется в среде [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)], можно создать соответствующий сценарий [!INCLUDE[tsql](../../includes/tsql-md.md)]RESTORE[ на языке ](../Topic/RESTORE%20\(Transact-SQL\).md), щелкнув **Скрипт** и выбрав место назначения для сценария.  
