...
description: В этом примере показано поэтапное восстановление только некоторых файловых групп в SQL Server базы данных с использованием простой модели восстановления.
