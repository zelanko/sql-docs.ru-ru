...
description: Узнайте, как восстанавливать страницы в SQL Server с помощью SQL Server Management Studio или Transact-SQL. Восстановление поврежденных страниц без восстановления всей базы данных.
ms.custom: ''
ms.date: 03/15/2017
ms.prod: sql
