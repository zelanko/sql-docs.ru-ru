...
description: В этой статье показано, как создать зашифрованную резервную копию в SQL Server с помощью Transact-SQL. Вы можете выполнить резервное копирование на диск или в службу хранилища Azure.
ms.custom: ''
ms.date: 08/04/2016
ms.prod: sql
...
-   Учетная запись хранения Windows и контейнер. Дополнительные сведения см. в разделе [Занятие 1. Создание объектов службы хранилища Azure](/previous-versions/sql/sql-server-2016/jj720557(v=sql.130)).  
