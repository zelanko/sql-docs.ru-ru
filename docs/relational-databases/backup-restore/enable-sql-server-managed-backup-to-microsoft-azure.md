---
title: "Включение управляемого резервного копирования SQL Server в Microsoft Azure | Microsoft Docs"
ms.custom: ""
ms.date: "10/03/2016"
...
## Как включить и настроить [!INCLUDE[ss_smartbackup](../../includes/ss-smartbackup-md.md)] с параметрами по умолчанию  
...
#### Как включить [!INCLUDE[ss_smartbackup](../../includes/ss-smartbackup-md.md)]  
