---
title: "Удаление резервных файлов больших двоичных объектов с активной арендой | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
> [!IMPORTANT]  
>  Если запущена оболочка PowerShell 2.0, то могут возникнуть проблемы при загрузке сборки Microsoft WindowsAzure.Storage.dll. Рекомендуем обновить PowerShell, чтобы решить эту проблему. Можно также использовать следующее решение для PowerShell 2.0:  
>   
...
2.  При отсутствии больших двоичных объектов с заблокированными арендами появится следующее сообщение:  
     ...
     **Аренда \<URL-адрес большого двоичного объекта> — это аренда восстановления. Такое сообщение появится, только если у вас есть большой двоичный объект с активной арендой восстановления.**  
