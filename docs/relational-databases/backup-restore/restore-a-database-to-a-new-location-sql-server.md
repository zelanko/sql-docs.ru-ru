...
description: В этой статье описано, как восстановить базу данных SQL Server в новую папку и переименовать ее с помощью SQL Server Management Studio или Transact-SQL.
ms.custom: ''
ms.date: 08/05/2016
ms.prod: sql
