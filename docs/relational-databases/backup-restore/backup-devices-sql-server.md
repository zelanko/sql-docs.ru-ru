...
##  <a name="specify-a-backup-file-using-its-physical-name-transact-sql"></a><a name="BackupFileUsingPhysicalName"></a> Указание файла резервной копии по его физическому имени (Transact-SQL)  
...
##  <a name="specify-a-backup-tape-using-its-physical-name-transact-sql"></a><a name="BackupTapeUsingPhysicalName"></a> Указание ленточного устройства резервного копирования по его физическому имени (Transact-SQL)  
...
###  <a name="tape-specific-backup-and-restore-options-transact-sql"></a><a name="TapeOptions"></a> Параметры BACKUP и RESTORE для ленточных устройств (Transact-SQL)  
...
##  <a name="use-a-logical-backup-device"></a><a name="LogicalBackupDevice"></a> Использование логического устройства резервного копирования  
...
##  <a name="archive-sql-server-backups"></a><a name="Archiving"></a> Архивация резервных копий SQL Server  
