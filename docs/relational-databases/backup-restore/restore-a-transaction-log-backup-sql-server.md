---
title: "Восстановление резервной копии журнала транзакций (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  ...
  - "создание резервных копий журналов транзакций [SQL Server], восстановление"
  - "резервные копии журналов транзакций [SQL Server], восстановление"
  - "восстановление журналов транзакций [SQL Server], восстановление резервных копий"
  - "восстановление журналов транзакций [SQL Server], среда SQL Server Management Studio"
