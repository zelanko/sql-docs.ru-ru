---
title: "Обзор процессов восстановления (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "восстановление таблиц [SQL Server]"
  - "резервные копии [SQL Server], сценарии восстановления"
  - "резервные копии баз данных [SQL Server], сценарии восстановления"
  - "восстановление баз данных [SQL Server]"
  - "восстановление из копии [SQL Server]"
  - "восстановление [SQL Server]"
  - "восстановление таблиц [SQL Server]"
  - "восстановление баз данных [SQL Server], о восстановлении баз данных"
  - "восстановления баз данных [SQL Server], сценарии"
...
-   Страница данных (*восстановление страницы*)  
 ...
 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] работает во всех поддерживаемых операционных системах. Дополнительные сведения о поддерживаемых операционных системах см. в разделе [Требования к оборудованию и программному обеспечению для установки SQL Server 2016](../../sql-server/install/hardware-and-software-requirements-for-installing-sql-server-2016.md). Сведения о поддержке резервных копий более ранних версий [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] см. в подразделе "Поддержка совместимости" раздела [RESTORE (Transact-SQL)](../Topic/RESTORE%20\(Transact-SQL\).md).  
...
-   Запрещено восстановление до заданной точки.  
 ...
 Если приведенные выше ограничения противоречат задачам восстановления, рекомендуется использовать модель полного восстановления. Дополнительные сведения см. в разделе [Общие сведения об устройствах резервного копирования (SQL Server)](../../relational-databases/backup-restore/backup-overview-sql-server.md).  
