...
description: Узнайте о полном восстановлении базы данных SQL Server, при котором все данные восстанавливаются до соответствующей точки во времени.
ms.custom: ''
ms.date: 03/15/2017
ms.prod: sql
