...
description: В SQL Server на странице "Общие" можно указать или просмотреть общие свойства логического устройства резервного копирования, в том числе задать имя устройства.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
