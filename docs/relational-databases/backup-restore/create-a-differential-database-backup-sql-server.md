---
title: Разностное резервное копирование
description: В этой статье описано, как создать разностную резервную копию базы данных в SQL Server с помощью SQL Server Management Studio или Transact-SQL.
