---
title: "Разностные резервные копии (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  ...
  - "разностные резервные копии, сведения"
...
-   [Общие сведения о разностных резервных копиях](#Overview)  
  
-   [Разностное резервное копирование баз данных только для чтения](#ReadOnlyDbs)  
