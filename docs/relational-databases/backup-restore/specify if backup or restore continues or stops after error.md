---
title: "Определение, продолжает ли операция резервного копирования или восстановления работу после возникновения ошибки (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "03/29/2017"
...
helpviewer_keywords: 
  ...
  - "резервное копирование баз данных [SQL Server], ошибки"
  - "резервные копии [SQL Server], ошибки"
  - "резервные копии баз данных [SQL Server], ошибки"
...
3.  В инструкции [RESTORE](../Topic/RESTORE%20\(Transact-SQL\).md) укажите параметр CONTINUE_AFTER ERROR для продолжения или STOP_ON_ERROR для остановки. По умолчанию в случае ошибки операция останавливается. В этом примере операция восстановления настраивается на продолжение работы в случае ошибки.  
...
## См. также:  
 [Инструкция RESTORE FILELISTONLY (Transact-SQL)](../Topic/RESTORE%20FILELISTONLY%20\(Transact-SQL\).md)   
