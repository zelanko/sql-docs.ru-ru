...
description: В SQL Server используйте диалоговое окно "Содержимое устройства", чтобы просмотреть сведения о резервном копировании, описывающие устройство, носитель, набор носителей, набор или наборы резервных копий.
ms.custom: ''
ms.date: 03/01/2017
ms.prod: sql
