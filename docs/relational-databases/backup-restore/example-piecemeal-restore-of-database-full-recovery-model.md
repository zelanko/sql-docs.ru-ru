---
title: 'Поэтапное восстановление: модель полного восстановления'
description: В этом примере показано поэтапное восстановление базы данных в SQL Server с использованием модели полного восстановления, начиная с резервной копии заключительного фрагмента журнала.
