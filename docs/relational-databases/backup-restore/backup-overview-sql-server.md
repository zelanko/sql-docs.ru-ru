...
description: Сведения о компоненте резервного копирования SQL Server, включая типы резервных копий и ограничения, а также устройства резервного копирования и резервные носители.
ms.custom: ''
ms.date: 07/15/2016
ms.prod: sql
