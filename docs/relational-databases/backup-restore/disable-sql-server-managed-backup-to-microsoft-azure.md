---
title: "Отключение управляемого резервного копирования SQL Server в Microsoft Azure | Microsoft Docs"
ms.custom: ""
ms.date: "03/04/2017"
...
#### Чтобы отключить [!INCLUDE[ss_smartbackup](../../includes/ss-smartbackup-md.md)] для конкретной базы данных, выполните следующие действия.  
...
#### Чтобы отключить [!INCLUDE[ss_smartbackup](../../includes/ss-smartbackup-md.md)] для всех баз данных, выполните указанные ниже действия.  
...
#### Чтобы отключить параметры конфигурации [!INCLUDE[ss_smartbackup](../../includes/ss-smartbackup-md.md)] по умолчанию, выполните следующие действия.  
...
##  <a name="InstancePause"></a> Приостановка [!INCLUDE[ss_smartbackup](../../includes/ss-smartbackup-md.md)] на уровне экземпляра  
 Возможны ситуации, когда требуется приостановить службы [!INCLUDE[ss_smartbackup](../../includes/ss-smartbackup-md.md)] на короткий период времени.  Системная хранимая процедура **managed_backup.sp_backup_master_switch** позволяет отключить службу [!INCLUDE[ss_smartbackup](../../includes/ss-smartbackup-md.md)] на уровне экземпляра.  Та же хранимая процедура используется для возобновления [!INCLUDE[ss_smartbackup](../../includes/ss-smartbackup-md.md)]. Параметр @state определяет, следует включить или отключить [!INCLUDE[ss_smartbackup](../../includes/ss-smartbackup-md.md)].  
  
#### Чтобы приостановить службы [!INCLUDE[ss_smartbackup](../../includes/ss-smartbackup-md.md)] с помощью Transact-SQL, выполните следующие действия.  
...
#### Возобновление работы [!INCLUDE[ss_smartbackup](../../includes/ss-smartbackup-md.md)] с помощью Transact-SQL  
