...
description: В SQL Server можно выполнять резервное копирование и восстановление целой файловой группы без указания каждого файла по отдельности.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
