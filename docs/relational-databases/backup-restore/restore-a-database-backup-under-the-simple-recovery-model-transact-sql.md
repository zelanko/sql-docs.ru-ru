...
description: В этой статье объясняется, как восстановить полную резервную копию базы данных SQL Server в простой модели восстановления с помощью Transact-SQL.
