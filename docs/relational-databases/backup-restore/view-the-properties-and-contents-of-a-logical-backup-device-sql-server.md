---
title: "Просмотр свойств и содержимого логического устройства резервного копирования (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "03/15/2017"
...
helpviewer_keywords: 
  ...
  - "резервное копирование баз данных [SQL Server], свойства"
  - "отображение свойств резервных копий"
  - "устройства резервного копирования [SQL Server], просмотр сведений"
  - "просмотр свойств резервных копий"
  - "резервные копии баз данных [SQL Server], свойства"
...
###  <a name="Security"></a> Безопасность  
 Сведения о безопасности см. в статье [RESTORE LABELONLY (Transact-SQL)](../Topic/RESTORE%20LABELONLY%20\(Transact-SQL\).md).  
...
#### Просмотр свойств и содержимого логического устройства резервного копирования  
...
3.  Используйте инструкцию [RESTORE LABELONLY](../Topic/RESTORE%20LABELONLY%20\(Transact-SQL\).md) . В этом примере возвращаются сведения о логическом устройстве резервного копирования `AdvWrks2008R2Backup`.  
