---
title: "Модели восстановления (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "07/16/2016"
...
helpviewer_keywords: 
  ...
  - "модель восстановления с неполным протоколированием [SQL Server]"
  - "восстановление [SQL Server], модель восстановления"
  - "восстановление журналов транзакций [SQL Server], модели восстановления"
  - "резервное копирование баз данных [SQL Server], модели восстановления"
  - "модели восстановления [SQL Server], сведения"
  - "резервные копии журналов транзакций [SQL Server]"
  - "простая модель восстановления [SQL Server]"
  - "резервные копии [SQL Server], модели восстановления"
  - "модели восстановления [SQL Server]"
  - "модели восстановления [SQL Server], управление журналом транзакций"
  - "восстановление баз данных [SQL Server], модели восстановления"
  - "восстановление журналов транзакций [SQL Server]"
  - "журналы [SQL Server], модели восстановления"
  - "восстановление баз данных [SQL Server], модели восстановления"
  - "модель полного восстановления [SQL Server]"
  - "резервное копирование журналов транзакций [SQL Server], модели восстановления"
