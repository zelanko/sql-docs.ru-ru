---
title: "Создание резервной копии журнала транзакций при повреждении базы данных (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  ...
  - "резервное копирование [SQL Server]. поврежденная база данных"
  - "резервные копии журналов транзакций [SQL Server], поврежденные базы данных"
