---
title: "Восстановление базы данных (страница &#171;Параметры&#187;) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
> [!NOTE]  
>  При указании задачи восстановления с помощью среды [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)] можно создать соответствующий скрипт на языке [!INCLUDE[tsql](../../includes/tsql-md.md)], содержащий инструкции RESTORE для этой задачи восстановления. Для создания скрипта нажмите кнопку **Скрипт** и выберите для него назначение. Дополнительные сведения о синтаксисе инструкции RESTORE см. в разделе [RESTORE (Transact-SQL)](../Topic/RESTORE%20\(Transact-SQL\).md).  
 ...
 **Сохранить параметры репликации [WITH KEEP_REPLICATION]**  
 ...
 Выбор этого параметра равнозначен использованию параметра KEEP_REPLICATION в инструкции [RESTORE](../Topic/RESTORE%20\(Transact-SQL\).md).  
