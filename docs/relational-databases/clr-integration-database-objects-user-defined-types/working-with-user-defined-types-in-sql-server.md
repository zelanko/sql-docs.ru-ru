...
description: Доступ к функциональным возможностям определяемого пользователем типа можно получить в SQL Server языке Transact-SQL с помощью обычного синтаксиса запросов. Определение таблиц и столбцов определяемого пользователем типа и обработка данных определяемого пользователем типа.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
