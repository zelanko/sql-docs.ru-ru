...
|**repl_freq**|**tinyint**|Частота репликации:<br /><br /> **0** = зависит от транзакции (репликация транзакций).<br /><br /> **1** = запланированное обновление таблицы (моментальный снимок).|  
|**status**|**tinyint**|Состояние публикации:<br /><br /> **0** = неактивно.<br /><br /> **1** = активно.|  
|**sync_method**|**tinyint**|Метод синхронизации.<br /><br /> **0** = собственная программа массового копирования программа (BCP).<br /><br /> **1** = символьная программа BCP.<br /><br /> **3** = параллельный режим, это означает, что используется собственный BCP, но таблицы во время создания моментального снимка не блокируются.<br /><br /> **4** = Concurrent_c, то, что символ, используемый BCP, но таблицы не блокируются во время создания моментального снимка.|  
