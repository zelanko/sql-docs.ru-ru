...
|**membership_eval_proc_name**|**sysname**|Имя процедуры, выполняющей оценку текущих идентификаторов секций строк в [MSmerge_contents &#40;&#41;Transact-SQL ](../../relational-databases/system-tables/msmerge-contents-transact-sql.md).|  
...
|**logical_record_deleted_view_rule**|**sysname**|Аналогично **logical_record_view**, за исключением того, что он отображает дочерние строки в таблице Deleted в триггерах Update и DELETE.|  
