...
|**dest_db**|**имеет sysname**|Имя базы данных подписки.|  
...
|**login_name**|**имеет sysname**|Имя входа, которое используется при подключении к издателю для добавления подписки.|  
