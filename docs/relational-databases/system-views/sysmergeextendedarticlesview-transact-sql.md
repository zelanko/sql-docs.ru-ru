---
title: "sysmergeextendedarticlesview (Transact-SQL) | Документы Microsoft"
ms.custom: 
ms.date: 03/06/2017
...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]
  ...
  **Sysmergeextendedarticlesview** представление предоставляет статьи сведения. Это представление хранится в базе данных публикации на издателе и в базе данных подписки на подписчике.  
