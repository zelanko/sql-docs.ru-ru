...
description: Список членов и типов сборки Microsoft.VisualBasic.dll, значения атрибута защиты узла (HPA) которых запрещены.
