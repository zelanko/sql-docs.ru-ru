---
title: Запрещенные типы и участники системы.dll Документы Майкрософт
description: Программирование S'L Server CLR запрещает тип или участника с определенными значениями для enum HostProtectionResource. В этой статье перечислены значения System.dll, запрещенные.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
...
## <a name="see-also"></a>См. также:  
 ...
 [Запрещенные типы и члены в System.Data.dll](../../relational-databases/clr-integration-security-host-protection-attributes/disallowed-types-and-members-in-system-data-dll.md)   
