...
description: SQL Server программировании CLR не разрешает тип или член с определенными значениями перечисления Хостпротектионресаурце. В этой статье перечислены System.dll запрещенные значения.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
