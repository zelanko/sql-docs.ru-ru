...
description: Среда CLR предоставляет механизм для комментирования управляемых API в .NET Framework с такими атрибутами, как Шаредстате, Synchronization и Екстерналпроцессмгмт.
