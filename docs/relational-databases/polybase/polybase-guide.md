...
[!INCLUDE[tsql-appliesto-ss2016-xxxx-asdw-pdw_md](../../includes/tsql-appliesto-ss2016-xxxx-asdw-pdw-md.md)]
  ...
  PolyBase — это технология, которая принимает и объединяет реляционные и нереляционные данные с сервера SQL Server.  В SQL Server 2016 она позволяет выполнять запросы к внешним данным в хранилище BLOB-объектов Azure или Hadoop. Для включения вычислений для Hadoop запросы оптимизируются. В хранилище данных SQL Azure можно импортировать данные из хранилища BLOB-объектов Azure и Azure Data Lake Store.
  
Используйте инструкции Transact-SQL (T-SQL), чтобы перемещать данные между реляционными таблицами в SQL Server и нереляционными данными в хранилище BLOB-объектов Azure или Hadoop. Кроме того, можно запрашивать внешние данные из запроса T-SQL и соединять их с реляционными данными.  
