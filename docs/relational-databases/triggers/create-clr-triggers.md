---
title: "Создание триггеров CLR | Microsoft Docs"
ms.custom: ""
ms.date: "03/16/2017"
...
helpviewer_keywords: 
  - "Триггеры CRL"
  - "триггеры DML, триггеры CLR"
  - "триггеры DDL, триггеры CLR"
...
-   Определите триггер как класс языка, поддерживаемого платформой .NET Framework. Дополнительные сведения о программировании триггеров CLR см. в разделе [Триггеры CLR](../Topic/CLR%20Triggers.md). После этого следует скомпилировать класс, чтобы создать сборку в [!INCLUDE[dnprdnshort](../../includes/dnprdnshort-md.md)], используя компилятор соответствующего языка.  
