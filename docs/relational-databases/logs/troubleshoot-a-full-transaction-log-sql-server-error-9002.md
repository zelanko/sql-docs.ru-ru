---
title: "Устранение неполадок при переполнении журнала транзакций (ошибка SLQ Server 9002) | Microsoft Docs"
ms.custom: ""
ms.date: "08/05/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "журналы [SQL Server], переполнение"
  - "устранение неполадок [SQL Server], переполнение журнала транзакций"
  - "9002 (ошибка в ядре СУБД)"
  - "журналы транзакций [SQL Server], усечение"
  - "резервное копирование журналов транзакций [SQL Server], переполненные журналы"
  - "журналы транзакций [SQL Server], переполненный журнал"
  - "полные журналы транзакций [SQL Server]"
...
## Завершение длительной транзакции
