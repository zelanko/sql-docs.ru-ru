---
title: "Журнал транзакций (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "02/01/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "журналы транзакций [SQL Server], о журналах"
  - "базы данных [SQL Server], журналы транзакций"
  - "журналы [SQL Server], журналы транзакций"
...
Журнал транзакций — это важная составляющая базы данных. Если система даст сбой, этот журнал поможет вам вернуть базу данных в согласованное состояние. Удаляя или перемещая этот журнал, вы должны понимать все последствия этого действия. 
 ...
 > **Забавный факт** Известные рабочие точки, от которых следует начинать применение журналов транзакций при восстановлении базы данных, создаются контрольными точками. Дополнительные сведения см. в разделе [Database Checkpoints &#40;SQL Server&#41;](../../relational-databases/logs/database-checkpoints-sql-server.md).  
...
### <a name="recovery-of-all-incomplete-transactions-when-includessnoversiontokenssnoversionmdmd-is-started"></a>Восстановление всех незавершенных транзакций при запуске [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]
...
##  <a name="a-namecharacteristicsatransaction-log-characteristics"></a><a name="Characteristics"></a>Характеристики журнала транзакций

Далее следуют характеристики журнала транзакций [!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)]. 
...
##  <a name="a-nametruncationa-transaction-log-truncation"></a><a name="Truncation"></a> Усечение журнала транзакций  
...
##  <a name="a-namefactorsthatdelaytruncationa-factors-that-can-delay-log-truncation"></a><a name="FactorsThatDelayTruncation"></a> Факторы, которые могут вызвать задержку усечения журнала  
...
##  <a name="a-nameminimallyloggeda-operations-that-can-be-minimally-logged"></a><a name="MinimallyLogged"></a> Операции, допускающие минимальное протоколирование  
...
-   Операции SELECT [INTO](../Topic/INTO%20Clause%20\(Transact-SQL\).md) .  
