---
title: "просматривать файлы журнала в режиме &#171;вне сети&#187; | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "средство просмотра файлов журнала, просмотр журналов вне сети"
  - "файлы журнала вне сети"
...
-   Разрешение на чтение для папки, содержащей файлы журналов ошибок. По умолчанию файлы журналов ошибок находятся по следующему пути (где \<*Диск>* представляет диск, на котором установлен [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)], а \<*Имя_экземпляра*> является именем экземпляра [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]):  
