---
title: "Управление устойчивостью транзакций | Microsoft Docs"
ms.custom: ""
ms.date: "09/16/2016"
...
###  <a name="a-namebkmkdbcontrola-database-level-control"></a><a name="bkmk_DbControl"></a> Управление на уровне базы данных    
...
###  <a name="a-namecompiledproccontrola-atomic-block-level-control-natively-compiled-stored-procedures"></a><a name="CompiledProcControl"></a> Управление на уровне атомарного блока — скомпилированные в собственном коде хранимые процедуры    
...
###  <a name="a-namebkmkt-sqlcontrola-commit-level-control-includetsqltokentsqlmdmd"></a><a name="bkmk_T-SQLControl"></a>Управление на уровне ФИКСАЦИИ — [!INCLUDE[tsql](../../includes/tsql-md.md)]    
...
##  <a name="a-namebkmkothersqlfeaturesa-delayed-durability-and-other-includessnoversiontokenssnoversionmdmd-features"></a><a name="bkmk_OtherSQLFeatures"></a> Отложенная устойчивость и другие функции службы [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]    
...
##  <a name="a-namebkmkdatalossa-when-can-i-lose-data"></a><a name="bkmk_DataLoss"></a> Когда я могу потерять данные?    
...
### <a name="includessnoversiontokenssnoversionmdmd-shutdown-and-restart"></a>Выключение и перезагрузка [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]    
