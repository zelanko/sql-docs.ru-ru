---
title: "Справка средства просмотра журнала F1 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
---
# Справка средства просмотра журнала F1
 ...
 **Сводка по файлу журнала**  
 Эта информационная панель содержит сводку данных по фильтрации файла журнала. Если файл не фильтруется, на панели отображается текст **без фильтров**. Если фильтр применяется к журналу, отображается следующий текст: **Фильтрация записей журнала, где **\<критерии фильтрации>.  
...
## См. также:  
 ...
 [открыть средство просмотра журнала](../../relational-databases/logs/open-log-file-viewer.md)   
