...
description: Рекомендации из справки F1 для часто отображаемых столбцов, разрешений и других параметров средства просмотра файлов журнала в SQL Server.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
