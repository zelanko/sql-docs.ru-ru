---
title: "Наблюдение за использованием памяти | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "настройка баз данных [SQL Server], память"
  - "мониторинг производительности сервера [SQL Server], использование памяти"
  - "изоляция памяти [SQL Server]"
  - "коэффициент подкачки [SQL Server]"
  - "память [SQL Server], мониторинг использования"
  - "мониторинг [SQL Server], использование памяти"
  - "условия нехватки памяти"
  - "мониторинг базы данных [SQL Server], использование памяти"
  - "доступная память [SQL Server]"
  - "ошибки страниц [SQL Server]"
  - "мониторинг производительности [SQL Server], использование памяти"
  - "производительность сервера [SQL Server], память"
