---
title: "Создание предупреждения для базы данных SQL Server | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "производительность базы данных [SQL Server], предупреждения"
  - "предупреждения [SQL Server], создание"
  - "пороги [SQL Server]"
  - "предупреждения базы данных [SQL Server]"
  - "настройка баз данных [SQL Server], предупреждения"
  - "мониторинг производительности [SQL Server], предупреждения"
  - "мониторинг производительности сервера [SQL Server], предупреждения"
  - "мониторинг базы данных [SQL Server], предупреждения"
  - "производительность сервера [SQL Server], предупреждения"
...
---
# Создание предупреждения для базы данных SQL Server
