---
title: "Создание диаграмм, предупреждений, журналов и отчетов | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "системный монитор [SQL Server], диаграммы и отчеты"
  - "диаграммы [SQL Server]"
  - "отчеты [SQL Server]"
  - "отчеты [SQL Server], создание"
  - "системный монитор Windows [SQL Server], диаграммы и отчеты"
  - "журналы [SQL Server], системный монитор"
  - "системный монитор [SQL Server], журналы"
  - "системный монитор Windows [SQL Server], журналы"
...
---
# Создание диаграмм, предупреждений, журналов и отчетов
