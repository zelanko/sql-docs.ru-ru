...
description: Сведения об объекте Transactions, который предоставляет счетчики для отслеживания активных транзакций в ядре СУБД и их влияния на SQL Server.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
