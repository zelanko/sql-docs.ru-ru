...
description: Сведения об объекте SQLServer:Deprecated Features, который предоставляет счетчик для наблюдения за функциями, обозначенными как устаревшие.
ms.custom: ''
ms.date: 05/03/2016
ms.prod: sql
...
## <a name="see-also"></a>См. также:  
 ...
 [Нерекомендуемые функции ядра СУБД в SQL Server 2016](../../database-engine/discontinued-database-engine-functionality-in-sql-server.md)   
 [Неподдерживаемые функции полнотекстового поиска в SQL Server 2016](../../database-engine/discontinued-database-engine-functionality-in-sql-server.md)   
