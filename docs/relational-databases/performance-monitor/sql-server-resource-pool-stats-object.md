...
|**Средняя продолжительность операции чтения с диска, мс, базовая**|Только для внутреннего использования.|
|**Ср. вр. записи на диск (мс)**|Среднее время (мс) операции записи на диск.|  
|**Средняя продолжительность операции записи на диск, мс, базовая**|Только для внутреннего использования.|
