---
title: "Использование объектов SQL Server | Microsoft Docs"
ms.custom: ""
ms.date: "03/17/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "производительность сервера [SQL Server], объекты для мониторинга"
  - "мониторинг базы данных [SQL Server], объекты для мониторинга"
  - "диаграммы [SQL Server]"
  - "системный монитор [SQL Server], счетчики"
  - "счетчики [SQL Server], в списке"
  - "объекты [SQL Server], мониторинг производительности"
  - "объекты [SQL Server], системный монитор Windows"
  - "счетчики производительности [SQL Server], о счетчиках производительности"
  - "системный монитор [SQL Server], объекты"
  - "счетчики производительности [SQL Server]"
  - "счетчики [SQL Server], о счетчиках производительности"
  - "настройка баз данных [SQL Server], объекты для мониторинга"
  - "производительность базы данных [SQL Server], объекты для мониторинга"
  - "SQL Server, объекты"
  - "мониторинг производительности [SQL Server], объекты для мониторинга"
  - "системный монитор Windows [SQL Server], объекты"
  - "системный монитор Windows [SQL Server], счетчики"
  - "счетчики [SQL Server]"
  - "счетчики производительности [SQL Server], в списке"
