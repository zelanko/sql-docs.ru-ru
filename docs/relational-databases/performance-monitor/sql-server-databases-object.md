---
title: "SQL Server, объект Databases | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
|**Записи таблицы фиксации**|Размер находящейся в памяти части таблицы фиксации для базы данных. Дополнительные сведения см. в разделе [sys.dm_tran_commit_table (Transact-SQL)](../Topic/sys.dm_tran_commit_table%20\(Transact-SQL\).md).|  
...
|**Запросы к пулу журналов по усечению/с**|Непопадания в кэш пула вследствие запроса блокировки после номера LSN усечения.|
