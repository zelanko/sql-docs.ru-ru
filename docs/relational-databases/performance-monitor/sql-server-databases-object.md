...
|**Базовый коэффициент попаданий в кэш журнала**|Только для внутреннего использования.| 
...
|**Базовый счетчик запросов к пулу журналов**|Только для внутреннего использования.| 
...
|**Основа для задержки DLC XTP-контроллера**|Только для внутреннего использования.| 
