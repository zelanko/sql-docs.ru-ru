...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]По умолчанию элемент сложного типа в схеме XSD с заметками сопоставляется схемы таблицы (представления) с тем же именем в указанной базе данных, а элемент или атрибут простого типа сопоставляется со столбцом с тем же именем в таблице.  
