...
### <a name="b-mapping-an-xml-element-to-a-database-column"></a>B. Сопоставление XML-элемента со столбцом базы данных  
