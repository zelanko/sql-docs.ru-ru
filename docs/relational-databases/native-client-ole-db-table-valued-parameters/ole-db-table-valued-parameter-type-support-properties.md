---
title: Тип параметра, оцененный таблицей OLE DB (Свойства)
ms.custom: ''
ms.date: 03/06/2017
ms.prod: sql
...
|DBPROP_BOOKMARKS<br /><br /> DBPROP_LITERALBOOKMARKS|R/W: Только для чтения<br /><br /> По умолчанию: VARIANT_FALSE<br /><br /> Описание: использование закладок для объектов наборов строк возвращающего табличное значение параметра не допускается.|  
...
|-----------------|--------------------|  
|SSPROP_COL_COMPUTED|R/W: Читать/писать<br /><br /> По умолчанию: VARIANT_FALSE<br /><br /> Тип: VT_BOOL<br /><br /> Описание: значение VARIANT_TRUE означает, что столбец является вычисляемым. VARIANT_FALSE означает, что столбец не является вычисляемым.|  
|||
