...
description: Сведения о двух моделях, которые поставщик SQL Server Native Client OLE DB поддерживает, чтобы потребитель указал данные для строк параметров, возвращающих табличное значение.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
