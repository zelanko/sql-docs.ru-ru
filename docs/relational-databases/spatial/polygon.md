---
title: "Многоугольник | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "03/06/2017"
...
helpviewer_keywords: 
  ...
  - "Polygon, геометрический подтип [SQL Server]"
...
## Экземпляры многоугольников  
 ...
 ![Примеры объектов Polygon типа geometry](../../relational-databases/spatial/media/polygon.png "Примеры объектов Polygon типа geometry")  
