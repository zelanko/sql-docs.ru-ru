---
title: "Общие сведения о пространственных индексах | Microsoft Docs"
ms.custom: ""
ms.date: "09/12/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "пространственные индексы [SQL Server]"
...
>  Декомпозиция пространства в пространственный индекс не зависит от единиц измерения в данных приложения.  
 ...
 ![Полигоны и линии помещаются в сетку уровня 1 размером 4 на 4](../../relational-databases/spatial/media/spndx-level-1-objects.png "Полигоны и линии помещаются в сетку уровня 1 размером 4 на 4")  
...
3.  Соединяет плоские пирамиды для создания неевклидовой плоскости.  
 ...
 ![Проекция эллипсоида на плоскость](../../relational-databases/spatial/media/spndx-geodetic-projection.png "Проекция эллипсоида на плоскость")  
