 ...
 *column_list*  
 ...
 \*  
 Указывает, что все полнотекстовых индексированных столбцов в *таблицы* следует использовать для поиска по заданному условию. Если не определен аргумент *language_term*, язык для всех столбцов таблицы должен быть одинаковым.  
