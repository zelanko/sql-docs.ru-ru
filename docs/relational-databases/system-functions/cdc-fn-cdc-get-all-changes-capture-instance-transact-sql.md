...
|-----------------|---------------|-----------------|  
|**__ $ start_lsn**|**двоичный (10)**|Номер LSN фиксации, связанный с изменением, хранящим последовательность фиксации данного изменения. Все изменения, зафиксированные в одной транзакции, имеют общий номер LSN фиксации.|  
|**__ $ seqval**|**двоичный (10)**|Последовательное значение, используемое для упорядочивания изменений строк в пределах транзакции.|  
...
|**\<Захваченные столбцы исходной таблицы>**|различные|Оставшиеся столбцы, возвращенные функцией, представляют собой отслеживаемые столбцы, определенные в момент создания экземпляра отслеживания. Если в списке отслеживаемых столбцов не указано ни одного столбца, возвращаются все столбцы в исходной таблице.|  
...
## <a name="examples"></a>Примеры  
 Доступно [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)] несколько шаблонов, демонстрирующих использование функций запросов системы отслеживания измененных данных. Эти шаблоны доступны в меню **вид** в [!INCLUDE[ssManStudio](../../includes/ssmanstudio-md.md)]. Дополнительные сведения см. в разделе [Обозреватель шаблонов](../../ssms/template/template-explorer.md).  
