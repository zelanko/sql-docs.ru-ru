...
-   @closed_high_end_point = 1  
     ...
     В результирующий набор включаются только строки в таблице изменений cdc. < capture_instance > _CT, фиксации, времени меньше по сравнению с превышающее значение end_time...  
