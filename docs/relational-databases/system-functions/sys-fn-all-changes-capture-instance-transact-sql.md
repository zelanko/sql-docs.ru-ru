...
2.  выполнить скрипт, чтобы создать функцию-оболочку.  
 ...
 Результирующий набор, возвращаемый функцией-оболочкой **All Changes** , возвращает __ $ start_lsn \_ \_и $seqval столбцы таблицы изменений в виде столбцов \__CDC_STARTLSN и \__CDC_SEQVAL соответственно. В нем следуют только те столбцы, которые были записаны в параметре * \@column_list* при создании оболочки. Если * \@column_list* имеет значение null, возвращаются все отслеживания исходных столбцов. За исходными столбцами следует столбец операции, \__CDC_OPERATION, который является столбцом из одного или двух символов, идентифицирующим операцию.  
