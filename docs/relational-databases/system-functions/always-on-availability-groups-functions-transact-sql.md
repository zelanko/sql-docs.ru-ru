---
title: "Функции (Transact-SQL) группы доступности Always On | Документы Microsoft"
ms.custom: 
ms.date: 03/17/2017
...
---
# <a name="always-on-availability-groups-functions-transact-sql"></a>Функции (Transact-SQL) группы доступности Always On
