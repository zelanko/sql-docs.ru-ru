---
title: Функции (Transact-SQL), группах доступности AlwaysOn | Документация Майкрософт
ms.custom: ''
ms.date: 03/17/2017
ms.prod: sql
...
---
# <a name="always-on-availability-groups-functions-transact-sql"></a>Функции (Transact-SQL), группах доступности AlwaysOn
[!INCLUDE[tsql-appliesto-ss2012-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2012-xxxx-xxxx-xxx-md.md)]

  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] предоставляет следующие функции групп доступности AlwaysOn.  
