---
title: Выполнение хранимой процедуры с использованием ODBC CALL и обработка выходных данных | Документация Майкрософт
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
5.  Вызовите **Execute** команду (в данном случае вызов хранимой процедуры).  
