...
-   [Выполнение хранимой процедуры &#40; С помощью синтаксиса RPC &#41; и обработки возвращаемых кодов и выходные параметры &#40; OLE DB &#41;](../../../relational-databases/native-client-ole-db-how-to/results/execute-stored-procedure-with-rpc-and-process-output.md)  
  
-   [Выполнение определяемой пользователем функции и обработки возвращаемого кода &#40; OLE DB &#41;](../../../relational-databases/native-client-ole-db-how-to/results/execute-a-user-defined-function-and-process-return-code-ole-db.md)  
