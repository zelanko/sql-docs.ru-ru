---
title: Выделение ручки соединения (ru) Документы Майкрософт
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "81307788"
---
# <a name="allocating-a-connection-handle"></a>Выделение дескриптора соединения
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)]

  Прежде, чем приложение может подключиться к источнику данных или драйверу, оно должно выделить дескриптор соединения. Это делается путем вызова **S'LAllocHandle** с параметром *HandleType,* установленным для SQL_HANDLE_DBC и *Вхотила,* указывающей на инициализированную ручку среды.  
