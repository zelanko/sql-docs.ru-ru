---
title: "Преобразование существующего скрипта трассировки SQL в сеанс расширенных событий | Microsoft Docs"
ms.custom: ""
ms.date: "03/04/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "трассировка SQL, преобразование скрипта в расширенные события"
  - "расширенные события [SQL Server], преобразование скрипта трассировки SQL"
...
## Получение идентификатора трассировки  
...
## Определение эквивалентов расширенных событий  
