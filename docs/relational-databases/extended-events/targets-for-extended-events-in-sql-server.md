---
title: "Целевые объекты для расширенных событий в SQL Server | Microsoft Docs"
ms.custom: ""
ms.date: "08/08/2016"
...
---
# Целевые объекты для расширенных событий в SQL Server
...
В языке Transact-SQL инструкция [CREATE EVENT SESSION](CREATE EVENT SESSION %28Transact-SQL%29.md) является центральным элементом для расширенных событий. Для записи инструкции часто требуется список и описание из следующих элементов:
...
#### Пример выходных данных, захваченных event_counter
...
### Пример *поля* события для histogram
...
#### Поиск соответствующих полей для пары для начального и конечного событий
...
#### CREATE EVENT SESSION с ring_buffer
...
### Выходные данные XML, полученные ring_buffer для lock_acquired
...
## Пространства имен XEvent .NET и C&#x23;
