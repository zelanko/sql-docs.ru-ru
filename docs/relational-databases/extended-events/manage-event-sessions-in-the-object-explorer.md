---
title: "Управление сеансами событий в обозревателе объектов | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
## Создание сеанса расширенных событий  
 Дополнительные сведения о создании сеанса расширенных событий см. в разделе [Create an Extended Events Session](../Topic/Create%20an%20Extended%20Events%20Session.md).  
...
5.  Выберите пункт **Открыть \<файл из…>Open** и найдите сеанс (XML-файл), который требуется импортировать.  
...
## Включение определения сеанса событий в скрипт с помощью [!INCLUDE[tsql](../../includes/tsql-md.md)]  
