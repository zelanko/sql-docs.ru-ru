...
### <a name="watch-live-data"></a>Просмотр данных, передаваемых в режиме реального времени
...
<a name="appendix1"></a>
## <a name="appendix-selects-to-ascertain-permission-owner-in-advance"></a>Приложение. Инструкции SELECT для предварительного определения владельца разрешения
