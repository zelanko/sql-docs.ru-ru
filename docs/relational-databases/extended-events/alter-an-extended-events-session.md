---
title: "Изменение сеанса расширенных событий | Microsoft Docs"
ms.custom: ""
ms.date: "03/06/2017"
...
## Как изменить сеанс расширенных событий с помощью мастера расширенных событий SQL Server  
...
## См. также:  
 ...
 [Создание сеанса расширенных событий с помощью редактора запросов](../Topic/Create%20an%20Extended%20Events%20Session%20Using%20Query%20Editor.md)  
