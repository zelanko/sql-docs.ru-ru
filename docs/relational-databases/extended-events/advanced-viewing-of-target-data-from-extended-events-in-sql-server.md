---
title: "Расширенный просмотр целевых данных из расширенных событий в SQL Server | Microsoft Docs"
ms.custom: ""
ms.date: "10/04/2016"
...
### Б.1. Открытие XEL-файла путем выбора "Файл" > "Открыть" > "Файл"
