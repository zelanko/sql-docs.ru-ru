---
title: "Связанные серверы (компонент Database Engine) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "OLE DB, связанные серверы"
  - "поставщик OLE DB, связанные серверы"
  - "управление серверами [SQL Server], связанные серверы"
  - "связанные серверы [SQL Server]"
  - "распределенные запросы [SQL Server], связанные серверы"
  - "серверы [SQL Server], связанные"
  - "удаленные серверы [SQL Server], связанные серверы"
  - "связанные серверы [SQL Server], о связанных серверах"
