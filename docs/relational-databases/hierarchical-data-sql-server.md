---
title: "Иерархические данные (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "иерархии [SQL Server], поддерживаемые таблицы"
  - "hierarchyid [ядро СУБД], общие сведения"
  - "иерархические таблицы [Database Engine]"
  - "SqlHierarchyId"
  - "hierarchyid [компонент Database Engine]"
  - "иерархические запросы [SQL Server], использование типа данных hierarchyid"
