...
description: Узнайте, как выполняющаяся в памяти OLTP обеспечивает полную устойчивость для оптимизированных для памяти таблиц, используя журнал транзакций и сохранение изменений данных в хранилище на диске.
ms.custom: ''
ms.date: 03/20/2017
ms.prod: sql
