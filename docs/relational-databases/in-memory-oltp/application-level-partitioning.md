...
description: Ознакомьтесь с примером, который обрабатывает заказы. Это приложение хранит последние заказы в таблице, оптимизированной для памяти, а более ранние заказы — в таблице на диске.
ms.custom: ''
ms.date: 03/01/2017
ms.prod: sql
...
## <a name="see-also"></a>См. также:  
 [Примеры кода In-Memory OLTP](./sample-database-for-in-memory-oltp.md)  
