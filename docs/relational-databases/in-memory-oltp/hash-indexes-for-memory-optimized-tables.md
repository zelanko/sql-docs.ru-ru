---
title: "Хэш-индексы для оптимизированных для памяти таблиц | Microsoft Docs"
ms.custom: 
  - "MSDN content"
  - "MSDN - SQL DB"
ms.date: "08/29/2016"
...
### Б.1. Основные сведения о производительности  
...
### Б.2. Ограничения для объявления  
...
### Б.4. Версии строк и сбор мусора  
...
## В. Настройка числа контейнеров хэш-индекса  
...
> [AZURE.NOTE] При добавлении большего числа контейнеров цепочка записей, которые имеют повторяющееся значение, не уменьшается. Степень повторяемости значения используется для того, чтобы решить, правильный ли тип имеет индекс, а не для определения числа контейнеров.  
  
  
  
### В.1. Практические величины  
...
### В.2. В индексе слишком много повторяющихся значений?  
...
## Г. Устранение неполадок, связанных с числом контейнеров хэш-индекса  
  
В этом разделе рассказывается, как устранять неполадки, связанные с числом контейнеров хэш-индекса.  
  
### Г.1. Отслеживание статистики для цепочек и пустых контейнеров  
...
### Г.2. Демонстрация цепочек и пустых контейнеров  
...
### Д.1. Хэш-индексы с несколькими столбцами  
