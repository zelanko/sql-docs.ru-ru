---
title: "Оценка требований к объему памяти для таблиц, оптимизированных для памяти | Microsoft Docs"
ms.custom: ""
ms.date: "12/02/2016"
...
###  <a name="a-namebkmkexampletablea-example-memory-optimized-table"></a><a name="bkmk_ExampleTable"></a> Пример оптимизированной для памяти таблицы  
...
###  <a name="a-namebkmkmemoryfortablea-memory-for-the-table"></a><a name="bkmk_MemoryForTable"></a> Память для таблицы  
...
###  <a name="a-namebkmkindexmeemorya-memory-for-indexes"></a><a name="bkmk_IndexMeemory"></a> Память для индексов  
...
Сведения о принципах работы хэш-индексов в оптимизированных для памяти таблицах [!INCLUDE[hek_2](../../includes/hek-2-md.md)] см. в разделе [Хэш-индексы](../Topic/Hash%20Indexes.md).  
...
###  <a name="a-namebkmkmemoryforrowversionsa-memory-for-row-versioning"></a><a name="bkmk_MemoryForRowVersions"></a> Память для управления версиями строк
...
###  <a name="a-namebkmktablevariablesa-memory-for-table-variables"></a><a name="bkmk_TableVariables"></a> Память для табличных переменных
...
###  <a name="a-namebkmkmemoryforgrowtha-memory-for-growth"></a><a name="bkmk_MemoryForGrowth"></a> Память под будущее увеличение
