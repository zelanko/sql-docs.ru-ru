---
title: "Изменение таблиц с оптимизацией для памяти | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "10/04/2016"
...
---
# Изменение таблиц с оптимизацией для памяти
...
## Ведение журнала ALTER TABLE для таблиц, оптимизированных для памяти
