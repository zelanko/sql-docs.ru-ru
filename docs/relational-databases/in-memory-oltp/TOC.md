...
## [Отслеживание производительности хранимых процедур, скомпилированных в собственном коде](monitoring-performance-of-natively-compiled-stored-procedures.md)  
...
## [Использование контрольной точки для таблиц, оптимизированных для памяти](checkpoint-operation-for-memory-optimized-tables.md)  
...
## [Поддержка управляющих объектов SQL Server для выполняющейся в памяти OLTP](sql-server-management-objects-support-for-in-memory-oltp.md)  
## [Поддержка служб SQL Server Integration Services для выполняющейся в памяти OLTP](sql-server-integration-services-support-for-in-memory-oltp.md)  
## [Поддержка среды SQL Server Management Studio для выполняющейся в памяти OLTP](sql-server-management-studio-support-for-in-memory-oltp.md)  
...
## [Помощник по компиляции в собственный код](native-compilation-advisor.md)  
