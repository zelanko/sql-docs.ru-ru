...
description: Сравните хранилища таблиц на диске с хранилищем таблиц, оптимизированных для памяти в категориях DDL, Structure, индексов, операций DML и фрагментации данных.
