---
title: "Поддержка среды SQL Server Management Studio для In-Memory OLTP | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
## Поддерживаемые функции в [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)]  
...
## Неподдерживаемые функции в [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)]  
