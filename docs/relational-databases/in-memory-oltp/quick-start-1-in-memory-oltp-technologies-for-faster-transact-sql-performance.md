---
title: "Краткое руководство 1. Технологии выполнения OLTP в памяти для повышения производительности службы Transact-SQL | Microsoft Docs"
ms.custom: ""
ms.date: "03/23/2017"
...
- [Руководство по индексам columnstore](Columnstore%20Indexes%20Guide.xml)  
  
  
> [AZURE.NOTE] Двухминутный видеоролик о функциях выполнения в памяти доступен на странице [Базы данных SQL Azure — технологии выполнения в памяти](http://channel9.msdn.com/Blogs/Windows-Azure/Azure-SQL-Database-In-Memory-Technologies). Видеоролик выпущен в декабре 2015 г.  
...
#### <a name="real-time-operational-analytics"></a>Операционная аналитика в реальном времени
...
Чтобы гарантированно обеспечить этот уровень для оптимизированных для памяти таблиц в межконтейнерной транзакции, [измените параметры базы данных](ALTER%20DATABASE%20SET%20Options%20%28Transact-SQL%29.xml), выполнив следующий запрос T-SQL.  
...
- [Управление памятью для компонента "Выполняющаяся в памяти OLTP"](Managing%20Memory%20for%20In-Memory%20OLTP.xml)  
...
- [Резервное копирование и восстановление оптимизированных для памяти таблиц](Backup,%20Restore,%20and%20Recovery%20of%20Memory-Optimized%20Tables.xml)  
