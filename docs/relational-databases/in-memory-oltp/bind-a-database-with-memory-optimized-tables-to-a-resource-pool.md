...
description: Узнайте, как создать отдельный пул ресурсов, чтобы управлять потреблением памяти для базы данных SQL Server с таблицами, оптимизированными для памяти.
