...
\<!--   
Indexes_for_Memory-Optimized_Tables.md, который является...  
...
Заменяет dn511012.aspx, который является....  
CAPS guid: {86805eeb-6972-45d8-8369-16ededc535c7}  
  
GeneMi 05.05.2016, четверг, 17:25(хэш содержимого перемещен в новую дочернюю статью e922cc3a-3d6e-453b-8d32-f4b176e98488).  
-->  
