---
title: "Индексы для оптимизированных для памяти таблиц | Microsoft Docs"
ms.custom: 
  - "MSDN content"
  - "MSDN - SQL DB"
ms.date: "10/24/2016"
...
Индексы *columnstore* рассматриваются в [другой статье](Columnstore%20Indexes%20Guide.xml).  
  
  
## A. Синтаксис индексов, оптимизированных для памяти  
...
### A.1 Пример кода для синтаксиса  
...
## Б. Природа индексов, оптимизированных для памяти  
...
## В. Повторяющиеся значения ключа индекса
...
## Г. Сравнение с использованием каждого типа индекса  
...
### D.1. Преимущества некластеризованных индексов  
...
### D.3. Сводная таблица для сравнения преимуществ каждого типа индекса  
  
  
В следующей таблице перечислены все операции, поддерживаемые различными типами индексов.  
  
  
| Операция | Оптимизированная для памяти, <br/> хэш | Оптимизированный для памяти, <br/> некластеризованный | Дисковая <br/> (не)кластеризованная |  
| :-------- | :--------------------------- | :----------------------------------- | :------------------------------------ |  
