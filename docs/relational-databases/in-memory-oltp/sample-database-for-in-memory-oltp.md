...
1.  Скачайте и запустите установочный пакет x64 RML Utilities со следующей страницы: [Скачать Report Markup Language (RML) для SQL Server](https://www.microsoft.com/en-us/download/details.aspx?id=4511)
