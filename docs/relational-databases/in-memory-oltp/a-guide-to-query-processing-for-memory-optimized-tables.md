---
title: "Руководство по обработке запросов для таблиц, оптимизированных для памяти | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
## [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Обработка запросов для дисковых таблиц  
 ...
 ![Канал обработки запросов в SQL Server.](../../relational-databases/in-memory-oltp/media/hekaton-query-plan-3.gif "Канал обработки запросов в SQL Server.")  
...
## Доступ к оптимизированным для памяти таблицам с помощью интерпретируемого кода [!INCLUDE[tsql](../../includes/tsql-md.md)]  
 ...
 ![Канал обработки запросов для интерпретируемых инструкций tsql.](../../relational-databases/in-memory-oltp/media/hekaton-query-plan-4.gif "Канал обработки запросов для интерпретируемых инструкций tsql.")  
...
||Скомпилированные в собственном коде|Интерпретируемые|  
|-|-----------------------|-----------------|  
 ...
 **Пробное сохранение параметров**  
 ...
 Пробное сохранение параметров не используется для компиляции хранимых процедур, скомпилированных в собственном коде. Предполагается, что у всех параметров хранимой процедуры значения UNKNOWN (неизвестны). Как и интерпретируемые хранимые процедуры, скомпилированные в собственном коде хранимые процедуры также поддерживают указание **OPTIMIZE FOR** . Дополнительные сведения см. в разделе [Указания запросов (Transact-SQL)](../Topic/Query%20Hints%20\(Transact-SQL\).md).  
...
```  
 ...
 ![Статистика и соединения столбцов.](../../relational-databases/in-memory-oltp/media/hekaton-query-plan-9.gif "Статистика и соединения столбцов.")  
