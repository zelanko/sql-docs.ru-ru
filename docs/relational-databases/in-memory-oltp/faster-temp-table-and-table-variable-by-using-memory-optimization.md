...
## <a name="d-scenario-table-variable-can-be-memory_optimizedon"></a>Г. Сценарий: табличная переменная может иметь параметр MEMORY_OPTIMIZED=ON  
