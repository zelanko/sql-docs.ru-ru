---
title: Оптимизация памяти для улучшения производительности временной таблицы и табличных переменных
description: Узнайте, как конвертировать временные таблицы, табличные переменные или возвращающие табличные значения параметры в оптимизированные для памяти таблицы и табличные переменные с целью повышения производительности.
