...
|Операция|изменение схемы|Оптимизированные для памяти таблицы и скомпилированные в собственном коде хранимые процедуры не поддерживают изменения схемы, например **sp_rename**.<br /><br /> Попытка внести определенные изменения схемы приведет к ошибке 12320. Операции, для которых требуется изменить версию схемы, например переименование, не поддерживаются оптимизированными для памяти таблицами.<br /><br /> Разрешены некоторые изменения схемы с помощью инструкции ALTER TABLE и ALTER PROCEDURE.<br/><br/>**Область применения:** [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)].<br/>Начиная с версии [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)], поддерживается sp_rename.| 
