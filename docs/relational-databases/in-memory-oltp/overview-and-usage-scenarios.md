---
title: "Общие сведения и сценарии использования | Microsoft Docs"
ms.custom: ""
ms.date: "11/22/2016"
...
---
# Общие сведения и сценарии использования
...
- [Quorum doubles key database’s workload while lowering utilization by 70% by leveraging In-Memory OLTP in Azure SQL Database](http://customers.microsoft.com/story/quorum-doubles-key-databases-workload-while-lowering-dtu-with-sql-database) (Компания Quorum удвоила рабочую нагрузку основной базы данных и сократила использование ресурсов на 70 %, применяя выполняющуюся в памяти OLTP в Базе данных SQL Azure).
