---
title: "Определение, должна ли таблица или хранимая процедура быть перенесена в In-Memory OLTP | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "03/01/2017"
...
## Отчеты об анализе производительности транзакции  
...
## Создание контрольных списков миграции выполняющейся в памяти OLTP  
