...
description: Узнайте о мониторинге и устранении проблем использования памяти выполняющейся в памяти OLTP, которые имеют иные шаблоны, чем таблицы на диске в SQL Server.
ms.custom: ''
ms.date: 03/17/2017
ms.prod: sql
