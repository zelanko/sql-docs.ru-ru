---
title: "Категория событий Locks | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Locks, категория событий [SQL Server]"
  - "классы событий SQL Server, категория событий Locks"
  - "классы событий [SQL Server], категория событий Locks"
  - "укрупнение блокировки [SQL Server], категория событий Locks"
