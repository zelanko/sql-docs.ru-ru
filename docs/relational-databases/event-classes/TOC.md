...
# [Object:Altered, класс событий](object-altered-event-class.md)
...
# [Соединение зеркального отображения базы данных, класс событий](database-mirroring-connection-event-class.md)
...
# [Категория событий Errors and Warnings (компонент Database Engine)](errors-and-warnings-event-category-database-engine.md)
...
# [Руководство по классам событий SQL Server](sql-server-event-class-reference.md)
...
# [Класс пользовательских событий](user-configurable-event-class.md)
