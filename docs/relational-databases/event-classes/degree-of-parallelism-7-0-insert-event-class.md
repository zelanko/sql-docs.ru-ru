...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] События класса **Degree of Parallelism (7.0 Insert)** происходят каждый раз, когда [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] выполняет инструкцию SELECT, INSERT, UPDATE или DELETE.  
