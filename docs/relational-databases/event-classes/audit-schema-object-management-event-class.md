...
---
# <a name="audit-schema-object-management-event-class"></a>Audit Schema Object Management, класс событий
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] Класс событий **Audit Schema Object Management** возникает при создании, изменении или удалении объектов сервера.  
  
## <a name="audit-schema-object-management-event-class-data-columns"></a>Столбцы данных класса событий Audit Schema Object Management  
...
|**EventSubClass**|**int**|Тип подкласса события.<br /><br /> 1 = создать<br /><br /> 2 = изменить<br /><br /> 3 = удалить<br /><br /> 4 = создать дамп<br /><br /> 8 = перенос<br /><br /> 11 = загрузить|21|Да|  
