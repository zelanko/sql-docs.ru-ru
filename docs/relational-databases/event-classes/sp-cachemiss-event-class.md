---
title: "Класс событий SP:CacheMiss | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
## Столбцы данных класса событий SP:CacheMiss  
...
|EventClass|**int**|Тип события = 34.|27|Нет|  
...
|TextData|**ntext**|Текст кэшируемого кода SQL. Если столбец TextData заполнен, то столбец ObjectName не заполняется.|1|Да|  
...
## См. также:  
 ...
 [Класс событий SP:CacheInsert](../../relational-databases/event-classes/sp-cacheinsert-event-class.md)  
