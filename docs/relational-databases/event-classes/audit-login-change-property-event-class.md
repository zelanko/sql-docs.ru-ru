...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] Класс событий **Audit Login Change Property** происходит при запуске хранимых процедур **sp_defaultdb** и **sp_defaultlanguage** или инструкции ALTER LOGIN для изменения свойства имени входа.  
