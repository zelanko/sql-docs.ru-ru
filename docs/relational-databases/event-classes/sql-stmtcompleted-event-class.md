...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] Класс событий SQL:StmtCompleted указывает на то, что инструкция [!INCLUDE[tsql](../../includes/tsql-md.md)] выполнена.  
