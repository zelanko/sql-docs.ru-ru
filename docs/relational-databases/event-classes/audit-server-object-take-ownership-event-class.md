---
description: Audit Server Object Take Ownership, класс событий
...
ms.locfileid: "96126742"
---
# <a name="audit-server-object-take-ownership-event-class"></a>Audit Server Object Take Ownership, класс событий
[!INCLUDE [SQL Server - ASDB](../../includes/applies-to-version/sql-asdb.md)]
   Класс событий **Audit Server Object Take Ownership** возникает в случае смены владельца для объектов в области сервера.  
