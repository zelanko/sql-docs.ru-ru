...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] Класс событий **Audit Server Object Take Ownership** возникает в случае смены владельца для объектов в области сервера.  
