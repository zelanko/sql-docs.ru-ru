...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] Класс событий **Audit Database Object Access** возникает при обращении к объектам базы данных, например схемам.  
  
## <a name="audit-database-object-access-event-class-data-columns"></a>Столбцы данных класса событий Audit Database Object Access  
