---
description: Audit Database Object Access, класс событий
...
ms.locfileid: "97476475"
---
# <a name="audit-database-object-access-event-class"></a>Audit Database Object Access, класс событий
[!INCLUDE [SQL Server - ASDB](../../includes/applies-to-version/sql-asdb.md)]
   Класс событий **Audit Database Object Access** возникает при обращении к объектам базы данных, например схемам.  
