...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] Класс событий SQL:BatchStarting указывает на начало выполнения пакета [!INCLUDE[tsql](../../includes/tsql-md.md)].  
