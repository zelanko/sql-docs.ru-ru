---
description: Audit Server Object GDR, класс событий
...
ms.locfileid: "88410631"
---
# <a name="audit-server-object-gdr-event-class"></a>Audit Server Object GDR, класс событий
[!INCLUDE [SQL Server - ASDB](../../includes/applies-to-version/sql-asdb.md)]
   События класса **Audit Server Object GDR** возникают, когда какой-либо пользователь Microsoft SQL Server выполняет команду GRANT, REVOKE или DENY для разрешения на доступ к объекту сервера.  
