...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] Класс событий **Audit Server Principal Impersonation** возникает в том случае, если в области сервера производится олицетворение, например через EXECUTE AS \<*имя_для_входа*>.  
