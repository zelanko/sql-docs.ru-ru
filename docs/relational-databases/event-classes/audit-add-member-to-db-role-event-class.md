---
title: "Класс событий Audit Add Member to DB Role | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Audit Add Member to DB Role, класс событий"
...
---
# Класс событий Audit Add Member to DB Role
...
## Столбцы данных класса событий Audit Add Member to DB Role  
...
|**TargetUserName**|**nvarchar**|Имя пользователя, для которого изменяется членство в роли.|39|Да|  
...
## См. также:  
 ...
 [Хранимая процедура sp_droprolemember (Transact-SQL)](../../relational-databases/system-stored-procedures/sp-droprolemember-transact-sql.md)  
