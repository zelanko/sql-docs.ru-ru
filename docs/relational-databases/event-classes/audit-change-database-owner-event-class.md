---
description: Класс событий Audit Change Database Owner
...
ms.locfileid: "97440095"
---
# <a name="audit-change-database-owner-event-class"></a>Класс событий Audit Change Database Owner
[!INCLUDE [SQL Server - ASDB](../../includes/applies-to-version/sql-asdb.md)]
   События класса **Audit Change Database Owner** происходят при использовании инструкции ALTER AUTHORIZATION для изменения владельца базы данных и при условии, что необходимые разрешения проверены.  
...
|**EventClass**|**int**|Тип события = 152.|27|Нет|  
...
|**Успешно**|**int**|1 = успешное завершение. 0 = неуспешное завершение. Например, значение 1 означает успешную проверку наличия разрешения, а 0 означает ошибку при этой проверке.|23|Да|  
|**TargetLoginName**|**nvarchar**|Имя целевого имени входа для действий, направленных на имя входа.|42|Да|  
|**TargetLoginSid**|**image**|Идентификатор безопасности целевого имени входа для действий, направленных на имя входа.|43|Да|  
