---
title: "Класс событий QN:Subscription | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "классы событий [SQL Server], QN:Subscription"
...
---
# Класс событий QN:Subscription
  Событие QN:Subscription возвращает данные о подписках на уведомления.  
  
## Столбцы данных класса событий QN:Subscription  
