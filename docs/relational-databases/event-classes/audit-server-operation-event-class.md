---
description: Audit Server Operation, класс событий
...
ms.locfileid: "97468065"
---
# <a name="audit-server-operation-event-class"></a>Audit Server Operation, класс событий
[!INCLUDE [SQL Server - ASDB](../../includes/applies-to-version/sql-asdb.md)]
   События класса **Audit Server Operation** возникают при выполнении таких операций аудита безопасности, как настройка параметров, ресурсов, доступа к внешним ресурсам или авторизации.  
