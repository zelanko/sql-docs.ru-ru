...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] События класса **Audit Server Alter Trace** возникают для всех инструкций, проверяющих наличие разрешения ALTER TRACE. В их число входят инструкции, служащие для создания или конфигурирования трассировки, а также для указания фильтра трассировки.  
