---
title: "Класс событий Audit App Role Change Password | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Audit App Role Change Password, класс событий"
...
---
# Класс событий Audit App Role Change Password
  Класс событий **Audit App Role Change Password** возникает при каждом изменении пароля роли приложения.  
  
## Столбцы данных класса событий Audit App Role Change Password  
