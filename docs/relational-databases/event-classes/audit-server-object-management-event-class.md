...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] События класса **Audit Server Object Management** возникают в случае использования инструкций CREATE, ALTER или DROP для объектов сервера.  
  
## <a name="audit-server-object-management-event-class-data-columns"></a>Столбцы данных класса событий Audit Server Object Management  
