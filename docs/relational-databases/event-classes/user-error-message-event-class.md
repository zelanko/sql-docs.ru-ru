...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] Класс событий User Error Message содержит сообщение об ошибке в том виде, в каком его видит пользователь при возникновении ошибки или исключения. Текст сообщения содержится в поле TextData.  
  
## <a name="user-error-message-event-class-data-columns"></a>Столбцы данных класса событий User Error Message  
...
|EventClass|**int**|Тип события = 162.|27|Нет|  
