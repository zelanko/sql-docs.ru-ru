...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] Событие класса TM: Save Tran Starting указывает на начало выполнения запроса SAVE TRANSACTION. Запрос отправляется клиентом через интерфейс управления транзакциями.  
