...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] Событие класса событий SQL:StmtStarting указывает на запуск инструкции языка [!INCLUDE[tsql](../../includes/tsql-md.md)].  
