...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] Класс событий Prepare SQL указывает, что SqlClient, ODBC, OLE DB или DB-Library подготовили инструкцию или инструкции [!INCLUDE[tsql](../../includes/tsql-md.md)] к исполнению.  
