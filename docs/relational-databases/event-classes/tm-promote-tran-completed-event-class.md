...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] Класс событий TM:Promote Tran Completed указывает на то, что был выполнен запрос PROMOTE TRANSACTION. Запрос отправляется клиентом через интерфейс управления транзакциями.  
