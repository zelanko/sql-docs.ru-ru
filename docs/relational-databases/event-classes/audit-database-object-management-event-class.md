...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] Класс событий **Database Object Management** возникает при выполнении инструкций CREATE, ALTER или DROP над объектами базы данных, например схемами.  
