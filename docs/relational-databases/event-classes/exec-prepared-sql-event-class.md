...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] Класс событий Exec Prepared SQL указывает, что приложение, использующее технологию SqlClient, ODBC, OLE DB или DB-Library, выполнило одну или несколько подготовленных инструкций языка [!INCLUDE[tsql](../../includes/tsql-md.md)].  
  
## <a name="exec-prepared-sql-event-class-data-columns"></a>Столбцы данных класса событий Exec Prepared SQL  
...
|EventClass|**int**|Тип события = 72.|27||  
|EventSequence|**int**|Последовательность данного события в запросе.|51||  
|GroupID|**int**|Идентификатор группы рабочей нагрузки, в которой запускается событие трассировки SQL.|66|Да|  
|Дескриптор|**int**|Дескриптор подготовленной инструкции SQL.|33|Да|  
