...
description: См. возможные значения столбца событий трассировки типа Object, который используется в различных событиях трассировки в SQL Server.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
