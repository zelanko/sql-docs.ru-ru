---
title: "Класс событий Audit Schema Object Take Ownership | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Audit Schema Object Take Ownership, класс событий"
...
---
# Класс событий Audit Schema Object Take Ownership
...
## Столбцы данных класса событий Audit Schema Object Take Ownership  
...
|**ObjectType**|**int**|Значение, представляющее тип объекта, связанного с событием. Значение, возвращаемое для данного столбца, представляет собой сочетание соответствующего значения в столбце **type** в представлении каталога **sys.objects** и значений, перечисленных в статье [Столбец события ObjectType Trace](../../relational-databases/event-classes/objecttype-trace-event-column.md).|28|Да|  
|**OwnerName**|**nvarchar**|Имя пользователя базы данных, владеющего объектом. |37|Да|  
|**ParentName**|**nvarchar**|Имя схемы, в которой содержится объект.|59|Да|  
