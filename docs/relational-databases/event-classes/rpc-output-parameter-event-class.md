...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] События класса RPC Output Parameter отслеживают значения выходных параметров в вызовах удаленных процедур после выполнения этих вызовов.  
