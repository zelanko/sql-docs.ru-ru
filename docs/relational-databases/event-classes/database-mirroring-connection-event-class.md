---
title: "Соединение зеркального отображения базы данных, класс событий | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
---
# Соединение зеркального отображения базы данных, класс событий
...
## Столбцы данных класса событий Database Mirroring:Connection  
