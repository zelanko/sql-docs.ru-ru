...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] Класс событий **Audit Database Operation** возникает при выполнении в базе данных таких операций, как установка контрольной точки или подписка на уведомления о запросе.  
