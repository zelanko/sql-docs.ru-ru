---
description: Класс событий Audit Backup и Restore
...
ms.locfileid: "88384860"
---
# <a name="audit-backup-and-restore-event-class"></a>Класс событий Audit Backup и Restore
 [!INCLUDE [SQL Server](../../includes/applies-to-version/sqlserver.md)]
   Класс событий **Audit Backup/Restore** возникает каждый раз, когда выдается команда на резервное копирование или восстановление.  
