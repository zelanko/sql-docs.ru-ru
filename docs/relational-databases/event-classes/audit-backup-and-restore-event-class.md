...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] Класс событий **Audit Backup/Restore** возникает каждый раз, когда выдается команда на резервное копирование или восстановление.  
  
## <a name="audit-backuprestore-event-class-data-columns"></a>Столбцы данных класса событий Audit Backup/Restore  
...
|**EventClass**|**int**|Тип события = 115.|27|нет|  
|**EventSequence**|**int**|Последовательность данного события в запросе.|51|нет|  
|**EventSubClass**|**int**|Тип подкласса события.<br /><br /> 1 = Backup<br /><br /> 2 = Restore<br /><br /> 3 = BackupLog|21|Да|  
...
|**TextData**|**ntext**|Текст инструкции резервного копирования или восстановления на языке SQL.|1|Да|  
