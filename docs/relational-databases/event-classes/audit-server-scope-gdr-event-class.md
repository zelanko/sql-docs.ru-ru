...
---
# <a name="audit-server-scope-gdr-event-class"></a>Audit Server Scope GDR, класс событий
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] События класса **Audit Server Scope GDR** возникают в случае, когда инструкции GRANT, REVOKE или DENY выполняются для разрешений в области действия сервера, например для создания имени входа.  
  
## <a name="audit-server-scope-gdr-event-class-data-columns"></a>Столбцы данных класса событий Audit Server Scope GDR  
...
|**EventClass**|**int**|Тип события = 170.|27|Нет|  
