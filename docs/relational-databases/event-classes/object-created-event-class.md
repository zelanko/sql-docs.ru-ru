...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] События класса Object:Created указывают на то, что объект был создан, например, с помощью инструкций CREATE INDEX, CREATE TABLE или CREATE DATABASE.  
