---
title: "Создание уникальных индексов | Microsoft Docs"
ms.custom: ""
ms.date: "02/17/2017"
...
helpviewer_keywords: 
  - "уникальные индексы"
  - "проектирование индексов [SQL Server], уникальных"
  - "кластеризованные индексы, уникальные"
  - "индексы [SQL Server], уникальные"
  - "некластеризованные индексы [SQL Server], уникальные"
  - "уникальные индексы, рекомендации по проектированию"
