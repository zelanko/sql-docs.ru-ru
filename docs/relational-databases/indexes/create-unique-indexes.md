...
12. Необязательное действие: В основной сетке в разделе **Конструктор таблиц** выберите **Пропустить повторяющиеся ключи**, а затем выберите в списке пункт **Да**. Сделайте это, если необходимо пропустить попытки добавления данных, создающих повторяющиеся ключи в уникальном индексе.  
  
13. Щелкните **Закрыть**.  
  
14. В меню **Файл** выберите **Сохранить**_имя\_таблицы_.  
...
4.  Щелкните правой кнопкой мыши папку **Индексы**, последовательно выберите **Создать индекс** и **Некластеризованный индекс…** .  
...
8.  В диалоговом окне **Выбор столбцов из**_имя\_таблицы_ установите флажки для столбцов таблицы, добавляемых к уникальному индексу.  
