---
title: "Требования к месту на диске для DDL-операций индекса | Microsoft Docs"
ms.custom: ""
ms.date: "02/17/2017"
...
helpviewer_keywords: 
  ...
  - "индексы [SQL Server], требования к месту на диске"
  - "временное место на диске [SQL Server]"
