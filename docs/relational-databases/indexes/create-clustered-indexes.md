---
title: "Создание кластеризованных индексов | Microsoft Docs"
ms.custom: ""
ms.date: "02/17/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "создание индексов [SQL Server], кластеризованные индексы"
  - "кластеризованные индексы, создание"
  - "кластеризованные индексы, ограничение PRIMARY KEY"
  - "кластеризованные индексы, ограничение UNIQUE"
  - "индексы [SQL Server], кластеризованные"
