---
title: "Руководящие принципы для операций с индексами | Microsoft Docs"
ms.custom: ""
ms.date: "03/09/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "кластеризованные индексы, операции в сети"
  - "Операции с индексами в сети"
  - "индексы [SQL Server], операции в сети"
  - "место на диске [SQL Server], индексы"
  - "некластеризованные индексы [SQL Server], операции в сети"
  - "журналы транзакций [SQL Server], индексы"
