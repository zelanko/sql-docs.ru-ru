---
title: "Параметр SORT_IN_TEMPDB для индексов | Microsoft Docs"
ms.custom: ""
ms.date: "02/17/2017"
...
helpviewer_keywords: 
  ...
  - "место на диске [SQL Server], индексы"
  - "место [SQL Server], индексы"
  - "база данных tempdb [SQL Server], индексы"
  - "индексы [SQL Server], база данных tempdb"
  - "создание индексов [SQL Server], база данных tempdb"
