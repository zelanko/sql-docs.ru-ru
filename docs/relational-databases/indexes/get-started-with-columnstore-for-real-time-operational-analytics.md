---
title: "Начало работы с Columnstore для получения операционной аналитики в реальном времени | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "03/08/2016"
...
## Пояснения к операционной аналитике в реальном времени  
...
### Пример А. Доступ к горячим данным из индекса сбалансированного дерева и теплым данным из индекса columnstore  
