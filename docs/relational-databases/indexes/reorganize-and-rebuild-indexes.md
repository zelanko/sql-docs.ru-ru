---
title: "Реорганизация и перестроение индексов | Microsoft Docs"
ms.custom: ""
ms.date: "04/29/2016"
...
helpviewer_keywords: 
  - "дефрагментация больших объектов"
  - "индексы [SQL Server], реорганизация"
  - "реорганизация индекса [SQL Server]"
  - "реорганизация индексов"
  - "дефрагментация типов данных больших объектов"
  - "фрагментация индекса [SQL Server]"
  - "перестроение индекса [SQL Server]"
  - "перестроение индексов"
  - "индексы [SQL Server], перестроение"
  - "дефрагментация индексов"
  - "некластеризованные индексы [SQL Server], дефрагментация"
  - "фрагментация [SQL Server]"
  - "дефрагментация индексов [SQL Server]"
  - "данные LOB [SQL Server], дефрагментация"
  - "кластеризованные индексы, дефрагментация"
