...
> [!NOTE]
> [!INCLUDE[ssManStudio](../../includes/ssManStudio-md.md)] не может использоваться для расчета фрагментации индексов columnstore в SQL Server и не может использоваться для расчета фрагментации любых индексов в базе данных SQL Azure. См. пример с [!INCLUDE[tsql](../../includes/tsql-md.md)][далее](#TsqlProcedureFrag).
