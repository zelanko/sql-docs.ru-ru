...
<sup>1</sup> Индекс может быть перестроен как в рабочем режиме, так и при отключении. Реорганизация индекса всегда выполняется в режиме в сети. Чтобы добиться доступности, подобной варианту с реорганизацией, следует перестраивать индексы в режиме в сети.  
