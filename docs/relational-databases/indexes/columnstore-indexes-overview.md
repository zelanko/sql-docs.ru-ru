...
Индекс columnstore хранилища deltastore может содержать несколько разностных групп строк.  Все разностные группы строк совокупно называются хранилищем *deltastore*.   
