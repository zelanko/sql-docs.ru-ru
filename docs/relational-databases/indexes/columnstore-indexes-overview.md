---
title: "Руководство по индексам columnstore | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "03/07/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "cоздание индексов, columnstore"
  - "индексы [SQL Server], columnstore"
  - "индекс columnstore"
  - "индекс columnstore с описанием"
  - "xVelocity, индексы columnstore"
...
|Создание высокопроизводительных индексов сolumnstore для хранилищ данных|[Индексы сolumnstore для хранилищ данных](../Topic/Columnstore%20Indexes%20for%20Data%20Warehousing.md)|Описывает использование индексов сбалансированного дерева в таблицах columnstore для создания высокопроизводительных запросов к хранилищу данных.|  
|Использование индекса сбалансированного дерева для принудительного применения ограничения PRIMARY KEY в таблице columnstore|[Индексы сolumnstore для хранилищ данных](../Topic/Columnstore%20Indexes%20for%20Data%20Warehousing.md)|Показывает, как объединить индексы сбалансированного дерева и columnstore для принудительного применения ограничений PRIMARY KEY для индекса columnstore.|  
...
|Загрузка данных в индекс columnstore|[Загрузка данных индексов ColumnStore](../Topic/Columnstore%20Indexes%20Data%20Loading.md)||  
