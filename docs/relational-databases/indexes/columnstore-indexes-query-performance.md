---
title: "Производительность запросов индексов columnstore | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "01/27/2017"
 ...
 **Какие группы строк пропускаются при полном сканировании таблицы?**    
 ...
 Дополнительные сведения о группах строк см. в разделе [Руководство по индексам Columnstore](../Topic/Columnstore%20Indexes%20Guide.md)    
...
-   Поддерживаются следующие статистические операторы: MIN, MAX, SUM, COUNT, AVG.    
    
-   Поддерживается любой тип данных размером не более 64 бит.  Например, поддерживается bigint, так как его размер — 8 байт, но decimal (38,6) не поддерживает, так как его размер — 17 байт. Типы string не поддерживаются.    
