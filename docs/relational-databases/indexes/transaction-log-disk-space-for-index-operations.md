---
title: "Место на диске журнала транзакций для операций обработки индекса | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "место на диске для индекса [SQL Server]"
  - "место [SQL Server], индексы"
  - "журналы транзакций [SQL Server], место на диске"
  - "место на диске [SQL Server], журналы транзакций"
  - "пространство [SQL Server], журналы транзакций"
