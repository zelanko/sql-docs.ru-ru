---
title: "Об операциях с индексом в сети | Microsoft Docs"
ms.custom: ""
ms.date: "02/17/2017"
...
helpviewer_keywords: 
  ...
  - "индексы источника [SQL Server]"
  - "существующие ранее индексы [SQL Server]"
  - "индексы назначения [SQL Server]"
  - "временный индекс сопоставления [SQL Server]"
  - "сопоставления временного индекса [SQL Server]"
