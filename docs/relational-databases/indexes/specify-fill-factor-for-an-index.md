---
title: "Укажите коэффициент заполнения для индекса | Microsoft Docs"
ms.custom: ""
ms.date: "02/17/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "коэффициент заполнения [SQL Server]"
  - "разбиение страниц [SQL Server]"
...
###  <a name="Performance"></a> Вопросы производительности  
