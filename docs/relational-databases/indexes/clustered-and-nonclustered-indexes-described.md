---
title: "Описания кластеризованных и некластеризованных индексов | Microsoft Docs"
ms.custom: ""
ms.date: "11/01/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "оптимизатор запросов [SQL Server], использование индекса"
  - "основное понятие об индексах [SQL Server]"
