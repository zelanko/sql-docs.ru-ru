...
description: Изучите и смягчите угрозы для автономных баз данных, включая те, которые связаны с процессом проверки подлинности USER WITH PASSWORD в SQL Server.
ms.custom: ''
ms.date: 03/14/2016
ms.prod: sql
...
## <a name="see-also"></a>См. также:  
 ...
 [Переход на частично автономную базу данных](../../relational-databases/databases/migrate-to-a-partially-contained-database.md)  
