---
title: "Мгновенная инициализация файлов базы данных | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "инициализация файлов [SQL Server]"
  - "мгновенная инициализация файлов [SQL Server]"
  - "быстрая инициализация файла (SQL Server)"
  - "инициализация файла [SQL Server]"
