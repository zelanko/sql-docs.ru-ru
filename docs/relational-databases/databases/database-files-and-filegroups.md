...
Если в [ включена ](../../relational-databases/databases/database-instant-file-initialization.md)мгновенная инициализация файлов (IFI)[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)], выделение нового пространства для файлов данных будет происходить с минимальной нагрузкой.
