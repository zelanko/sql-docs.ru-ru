---
title: "Файлы и файловые группы базы данных | Microsoft Docs"
ms.custom: ""
ms.date: "10/11/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "базы данных [SQL Server], файлы"
  - "файловые группы [SQL Server]"
  - "журналы транзакций [SQL Server], о журналах"
  - "журналы транзакций [SQL Server], файлы"
  - "MDF-файлы"
  - "файлы данных [SQL Server]"
  - "файловые группы по умолчанию"
  - "файлы [SQL Server], о файлах и файловых группах"
  - "вторичные файлы [SQL Server]"
  - "файлы журналов [SQL Server]"
  - "NDF-файлы"
  - "файлы [SQL Server]"
  - "LDF-файлы"
  - "файлы базы данных [SQL Server]"
  - "базы данных [SQL Server], файловые группы"
  - "файловые группы [SQL Server], типы"
  - "первичные файловые группы [SQL Server]"
  - "пользовательские файловые группы [SQL Server]"
  - "файловые группы [SQL Server], о файловых группах"
  - "первичные файлы [SQL Server]"
  - "типы файлов [SQL Server]"
