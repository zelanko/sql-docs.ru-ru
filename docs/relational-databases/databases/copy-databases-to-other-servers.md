---
title: "Копирование баз данных на другие серверы | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "серверы [SQL Server], копирование баз данных между"
  - "массовый экспорт [SQL Server], между серверами"
  - "копирование баз данных [SQL Server]"
  - "миграция баз данных [SQL Server]"
  - "перемещение баз данных"
  - "копирование баз данных"
  - "массовый импорт [SQL Server], между серверами"
