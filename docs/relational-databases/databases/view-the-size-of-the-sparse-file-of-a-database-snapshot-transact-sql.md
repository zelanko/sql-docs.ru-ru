---
title: "Просмотр размера разреженного файла снимка базы данных (Transact-SQL) | Microsoft Docs"
ms.date: "07/28/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "моментальные снимки [моментальные снимки базы данных SQL Server], разреженные файлы"
  - "место [SQL Server], разреженные файлы"
  - "разреженные файлы [SQL Server]"
  - "размер [SQL Server], разреженные файлы"
  - "максимальный размер разреженного файла"
  - "моментальные снимки базы данных [SQL Server], разреженные файлы"
  - "место [SQL Server], моментальные снимки базы данных"
