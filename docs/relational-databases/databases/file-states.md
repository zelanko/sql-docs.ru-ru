---
title: "Состояния файла | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "состояние восстановления файла [SQL Server]"
  - "проверка состояний файла"
  - "текущие состояния файла"
  - "поверка состояний файловых групп"
  - "состояния файлов [SQL Server]"
  - "оперативное состояние файла"
  - "автономное состояние файла [SQL Server]"
  - "просмотр состояний файловых групп"
  - "просмотр состояний файлов"
  - "подозрительное состояние файла"
  - "состояние восстановления файла [SQL Server]"
  - "текущее состояние файловой группы"
  - "состояние ожидания восстановления файла [SQL Server]"
  - "отображение состояний файла"
  - "состояния [SQL Server], файлы"
  - "отображение состояний файловых групп"
  - "состояние несуществующего файла"
