---
title: "База данных tempdb | Microsoft Docs"
ms.custom: ""
ms.date: "03/04/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Временные таблицы [SQL Server], база данных tempdb"
  - "База данных tempdb [SQL Server], сведения о tempdb"
  - "временные хранимые процедуры [SQL Server]"
...
|TRUSTWORTHY|OFF|Нет|  
 ...
 Описание этих баз данных см. в статье [Параметры ALTER DATABASE SET (Transact-SQL)](../Topic/ALTER%20DATABASE%20SET%20Options%20\(Transact-SQL\).md).  
