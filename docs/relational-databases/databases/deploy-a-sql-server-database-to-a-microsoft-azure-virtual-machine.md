---
title: "Развертывание базы данных SQL Server в виртуальной машине Microsoft Azure | Microsoft Docs"
ms.date: "07/29/2016"
...
helpviewer_keywords: 
  ...
  - "Развертывание в виртуальной машине Azure"
  - "Миграция в Azure"
  - "Виртуальная машина Windows Azure"
  - "Миграция на виртуальную машину Azure"
  - "Миграция в облако"
  - "Среда SQL Server Management Studio"
  - "SSMS"
  - "Мастер развертывания базы данных"
  - "Развертывание базы данных SQL Server в Azure"
...
---
# Развертывание базы данных SQL Server в виртуальной машине Microsoft Azure
...
-   Виртуальная машина Microsoft Azure или образ из коллекции, который планируется использовать для создания виртуальных машин, должны иметь настроенный и запущенный [адаптер для облака SQL Server](Cloud%20Adapter%20for%20SQL%20Server.md).  
  
-   Необходимо настроить открытую конечную точку под [адаптер для облака SQL Server](Cloud%20Adapter%20for%20SQL%20Server.md) в шлюзе Microsoft Azure с частным портом 11435.  
...
## См. также:  
 [Адаптер для облака для SQL Server](../Topic/Cloud%20Adapter%20for%20SQL%20Server.md)   
