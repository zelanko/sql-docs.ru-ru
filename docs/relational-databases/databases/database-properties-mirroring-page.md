...
description: Узнайте, как настроить свойства зеркального отображения и просмотреть состояние сеанса зеркального отображения. Узнайте, как запустить, приостановить или удалить сеанс зеркального отображения.
ms.custom: ''
ms.date: 08/25/2016
ms.prod: sql
...
|Состояние зеркального отображения.|Предпринятое действие|  
|-|-|  
