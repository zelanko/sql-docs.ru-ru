---
title: "Перемещение системных баз данных | Microsoft Docs"
ms.custom: ""
ms.date: "08/26/2016"
...
helpviewer_keywords: 
  ...
  - "база данных tempdb [SQL Server], перемещение"
  - "системные базы данных [SQL Server], перемещение"
  - "запланированное обслуживание диска [SQL Server]"
  - "перемещение баз данных"
  - "база данных msdb [SQL Server], перемещение"
  - "перемещение файлов базы данных"
  - "перемещение файлов базы данных"
  - "запланированные перемещения базы данных [SQL Server]"
  - "база данных master [SQL Server], перемещение"
  - "шаблон базы данных [SQL Server], перемещение"
  - "Resource, база данных [SQL Server]"
...
1.  С помощью следующего запроса убедитесь, что в базе данных msdb включен компонент [!INCLUDE[ssSB](../../includes/sssb-md.md)].  
    ...
    ```  
     ...
     Дополнительные сведения о включении [!INCLUDE[ssSB](../../includes/sssb-md.md)] см. в разделе [ALTER DATABASE (Transact-SQL)](../../t-sql/statements/alter-database-transact-sql.md).  
