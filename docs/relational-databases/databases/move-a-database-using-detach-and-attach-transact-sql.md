---
title: "Перенос базы данных путем отсоединения и присоединения (язык Transact-SQL) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  ...
  - "перенос баз данных [SQL Server]"
  - "отсоединение баз данных [SQL Server]"
  - "перемещение баз данных [SQL Server]"
  - "отсоединение баз данных [SQL Server]"
  - "присоединение баз данных [SQL Server]"
