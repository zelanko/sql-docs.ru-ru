---
title: "Добавление файлов данных или журналов в базу данных | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  ...
  - "добавление файлов"
  - "добавление файлов журнала"
  - "добавление файлов [SQL Server], шаги"
  - "файлы [SQL Server], добавление"
...
7.  Выберите файловую группу, в которую следует добавить файл данных, или **\<новая файловая группа>\>**, чтобы создать новую. Журналы транзакций не могут быть помещены в файловые группы.  
