---
title: "Моментальные снимки базы данных (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "08/08/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "статические представления баз данных"
  - "моментальные снимки [моментальные снимки базы данных SQL Server]"
  - "базы данных-источники [SQL Server]"
  - "моментальные снимки [моментальные снимки базы данных SQL Server], о моментальных снимках базы данных"
  - "моментальные снимки базы данных [SQL Server]"
  - "представления базы данных в режиме только для чтения"
  - "моментальные снимки [SQL Server], о моментальных снимках базы данных"
...
-   Экземпляр сервера должен работать на выпуске [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)], который поддерживает моментальные снимки баз данных. Дополнительные сведения см. в разделе [Функции, поддерживаемые различными выпусками SQL Server 2016](../Topic/Features%20Supported%20by%20the%20Editions%20of%20SQL%20Server%202016.md).  
