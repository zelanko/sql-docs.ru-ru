---
title: "Оценка размера кластеризованного индекса | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
helpviewer_keywords: 
  ...
  - "некластеризованные индексы [SQL Server], размер таблицы"
...
## Шаг 2. Расчет пространства, используемого для хранения данных индекса  
