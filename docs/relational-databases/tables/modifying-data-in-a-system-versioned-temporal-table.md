...
Когда**SWITCH PARTITION IN**, **TRUNCATE** , **SWITCH PARTITION OUT** (для текущей таблицы) и **SWITCH PARTITION IN**(для таблицы журнала) не работают.  
