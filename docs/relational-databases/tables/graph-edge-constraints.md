---
description: Ограничения ребер графа
...
Сведения о технологии графов в SQL Server см. в статье [Graph processing with SQL Server and Azure SQL Database](../graphs/sql-graph-overview.md) (Обработка графов с помощью SQL Server и Базы данных SQL Azure).
