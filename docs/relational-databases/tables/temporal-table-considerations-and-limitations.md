---
title: "Рекомендации и ограничения для темпоральной таблицы | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "01/24/2017"
...
-   Инструкция **TRUNCATE TABLE** не поддерживается, если **SYSTEM_VERSIONING** имеет значение **ON**  
