...
> **ПРИМЕЧАНИЕ.**  Использование Stretch Database применимо только к [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] и не может применяться к [!INCLUDE[sqldbesa](../../includes/sqldbesa-md.md)].  
...
> **ПРИМЕЧАНИЕ.** Stretch Database перемещает данные в Azure. Таким образом, необходимо иметь учетную запись Azure и подписку для выставления счетов. Чтобы получить бесплатную пробную учетную запись Azure, щелкните [Бесплатная пробная версия на один месяц](https://azure.microsoft.com/pricing/free-trial/).  
