---
title: "Создание таблицы с помощью типа данных hierarchyid | Microsoft Docs"
ms.custom: ""
ms.date: "02/27/2017"
...
[Заполнение иерархической таблицы с помощью иерархических методов](../../relational-databases/tables/populating-a-hierarchical-table-using-hierarchical-methods.md)  
