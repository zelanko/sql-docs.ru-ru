---
title: "Запрос данных в темпоральной таблице с системным управлением версиями | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "03/28/2016"
...
### Использование представлений с вложенным предложением AS OF в темпоральных запросах  
