---
description: Дублирование структур таблиц
title: Дублирование структур таблиц | Документация Майкрософт
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "91725025"
---
# <a name="duplicate-table-structures"></a>Дублирование структур таблиц
