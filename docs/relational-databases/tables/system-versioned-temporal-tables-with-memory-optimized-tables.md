...
---
# <a name="system-versioned-temporal-tables-with-memory-optimized-tables"></a>Темпоральные таблицы с системным управлением версиями и таблицы, оптимизированные для памяти
...
## <a name="the-data-flush-task"></a>Задачи сброса данных  
 ...
 Можно принудительно выполнить сброс данных, вызвав [sp_xtp_flush_temporal_history](../../relational-databases/system-stored-procedures/temporal-table-sp-xtp-flush-temporal-history.md) и указав схему и имя таблицы:   
