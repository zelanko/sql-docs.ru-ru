...
|Идентификатор события|277|  
|Источник события|Среда выполнения локальной базы данных SQL Server 12.0|  
|Компонент|API среды выполнения локальной базы данных|  
|Текст сообщения|Истекло время ожидания внутри метода API экземпляра локальной базы данных.|  
  
## <a name="explanation"></a>Объяснение  
 При попытке получения блокировок синхронизации истекло время ожидания.  
  
## <a name="user-action"></a>Действие пользователя  
 Повторить попытку запрошенной операции.  
