...
## <a name="updgid-attribute"></a>Атрибут updg:id  
 Если диаграмма обновления вставляет только записи, диаграмма обновления не требует атрибута **атрибута updg: ID** . Дополнительные сведения о **атрибута updg: ID**см. в разделе [Обновление данных с помощью &#40;XML диаграмм обновления&#41;SQLXML 4,0](../../../relational-databases/sqlxml-annotated-xsd-schemas-xpath-queries/updategrams/updating-data-using-xml-updategrams-sqlxml-4-0.md).  
...
```  
 ...
 Диаграмма обновления задает **xsi: nil** для элемента **\<fname >** в блоке **\<после >** блока. Поэтому при выполнении этой диаграммы обновления значение NULL вставляется для столбца first_name таблицы.  
