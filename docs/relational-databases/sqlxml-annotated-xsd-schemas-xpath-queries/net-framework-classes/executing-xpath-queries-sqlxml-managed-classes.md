---
title: "Выполнение запросов XPath (управляемые классы SQLXML) | Документы Microsoft"
ms.custom: 
ms.date: 03/14/2017
...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]Этот пример иллюстрирует, как выполняются запросы XPath к схеме сопоставления.  
