...
description: Сведения об объекте Склксмладаптер, который предоставляет методы, которые упрощают взаимодействие с набором данных в .NET Framework.
ms.date: 03/16/2017
ms.prod: sql
