...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]Поскольку Массовая загрузка XML записи создаются в момент включения узлов в области видимости, а затем отправляются в корпорацию Майкрософт [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] при их выходе из области, для записи данных должны находиться в пределах области узла.  
