...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]Массовая загрузка XML обрабатывает **sql: сопоставлен** заметки в схеме XSD, как ожидалось — то есть если схема сопоставления указывает **sql: сопоставлен = «false»** для любого элемента или атрибута, Массовая загрузка XML не Попытка сохранить связанные данные в соответствующем столбце.  
