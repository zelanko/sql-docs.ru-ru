...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]Microsoft [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Массовая загрузка XML объектная модель состоит из свойство sqlxmlbulkload. Этот объект поддерживает следующие свойства и методы.  
...
-   Возвращает данные переполнения для любого столбца, обозначенного с помощью [SQL: Overflow-поле](../../../relational-databases/sqlxml-annotated-xsd-schemas-xpath-queries/bulk-load-xml/annotation-interpretation-sql-overflow-field.md) в [тип данных xml](../../../t-sql/xml/xml-transact-sql.md) формат.  
