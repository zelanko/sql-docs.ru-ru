...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]Типы данных, указанных в схеме сопоставления (тип XSD или XDR и **SQL: DataType**) обычно учитываются, за исключением следующих случаев:  
