...
![Снимок экрана с обозревателем объектов, в котором отображается раскрывающийся список "Подключение" и выбран параметр "Ядро СУБД".](../relational-databases/media/object-explorer.png)
...
![Снимок экрана: диалоговое окно "Соединение с сервером" с выбранным полем "Имя сервера".](../relational-databases/media/connect-to-server.png)
...
![Снимок экрана: диалоговое окно "Создание имени входа" с выбранным полем "Имя входа".](../relational-databases/media/new-login.png)
