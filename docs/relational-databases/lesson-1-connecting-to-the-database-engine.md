...
<a name="when-you-install-the-includessdenoversionincludesssdenoversion-mdmd-the-tools-that-are-installed-depend-upon-the-edition-and-your-setup-choices-this-lesson-reviews-the-principal-tools-and-shows-you-how-to-connect-and-perform-a-basic-function-authorizing-more-users"></a>Набор средств, устанавливаемых с компонентом [!INCLUDE[ssDEnoversion](../includes/ssdenoversion-md.md)], зависит от выпуска и от параметров, заданных при установке. На этом уроке рассматриваются важнейшие средства, а также показываются способы подключения и выполнения одной из базовых функций (разрешение входа дополнительным пользователям).  
 -  
 <a name="-this-lesson-contains-the-following-tasks"></a>— Это занятие содержит следующие задачи.  
 -  
 <a name="-----tools-for-getting-startedtools"></a>--   [Средства для начала работы](#tools)  
 -  
 <a name="-----connecting-with-management-studioconnect"></a>--   [Подключение с помощью среды Management Studio](#connect)  
 -  
 <a name="-----authorizing-additional-connectionsadditional"></a>--   [Разрешение дополнительных подключений](#additional)  
 -  
 ...
 -  
 -### Пример базы данных  
 — Примеры баз данных и примеры с [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] не поставляются. Большинство примеров, описанных в электронной документации по [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] , используют образец базы данных [!INCLUDE[ssSampleDBobject](../includes/sssampledbobject-md.md)] .  
 -  
 ...
 — В более старых версиях Windows в меню **Пуск** наведите указатель на пункт **Все программы**, затем на пункт [!INCLUDE[ssCurrentUI](../includes/sscurrentui-md.md)] и выберите **SQL Server Management Studio**.  
 -  
 -##### Запуск диспетчера конфигурации SQL Server  
 -  
 — В текущих версиях Windows на **начальной** странице введите **Диспетчер конфигурации** и выберите **Диспетчер конфигурации SQL Server *версия***.   
 ...
 -  
 -## <a name="connect"></a>Подключение с помощью среды Management Studio  
 ...
 -  
 -##### Определение имени экземпляра ядра СУБД  
 -  
 ...
 -  
 -##### Подтверждение того, что ядро СУБД запущено  
 -  
 ...
 -
 — При установке [!INCLUDE[ssNoVersion_md](../includes/ssnoversion-md.md)] была выбрана по меньшей мере одна учетная запись администратора. Выполнив вход в Windows с правами администратора, выполните указанные ниже действия.
 -  
