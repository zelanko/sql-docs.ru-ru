...
4. Выберите все столбцы, которые необходимо маскировать, и требуемую функцию маскирования. Доступные типы маскирования: **смешение**, **групповое смешение**, маскирование **одним значением**, маскирование **значениями NULL** и маскирование **составными строками**. 
 ...
 Примечание. Большинство функций маскирования имеют дополнительные параметры. Для маскирования смешением статическое маскирование данных предоставляет параметр по умолчанию. Для маскирования групповым смешением, маскирования одним значением и маскирования составными строками пользователю необходимо настроить параметры. Чтобы изменить или задать параметры, щелкните **Настроить…** и укажите (измените) значение параметра в появившемся диалоговом окне. Подробное описание каждой функции маскирования см. в разделе [Функции маскирования](#masking-functions).
