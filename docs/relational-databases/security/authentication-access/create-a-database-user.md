...
##  <a name="Understanding"></a> Основные сведения о типах пользователей  
 [!INCLUDE[ssManStudio](../../../includes/ssmanstudio-md.md)] предлагает шесть вариантов при создании пользователя базы данных. На схеме ниже в зеленой рамке приведены 6 вариантов и их краткое описание.  
