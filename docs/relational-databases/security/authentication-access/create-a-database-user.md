...
helpviewer_keywords: 
  - "пользователи базы данных, создание"
  - "создание пользователей с помощью среды Management Studio"
  - "сопоставление пользователей"
  - "пользователи [SQL Server], создание"
  - "добавление пользователя базы данных [SQL Server]"
  - "пользователи базы данных, сопоставление\"
  - "CREATE USER [среда Management Studio]"
  - "пользователи [SQL Server], добавление"
  - "сопоставление пользователей базы данных"
