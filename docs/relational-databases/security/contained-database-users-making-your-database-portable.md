---
title: "Пользователи автономной базы данных — создание переносимой базы данных | Microsoft Docs"
ms.custom: ""
ms.date: "08/17/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "автономная база данных, пользователи"
  - "пользователь [SQL Server], о пользователях автономной базы данных"
...
## Традиционная модель имени для входа и пользователя  
...
### [!INCLUDE[ssSDS](../../includes/sssds-md.md)] Брандмауэры  
