---
title: "Создание спецификация аудита для сервера и базы данных | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  - "аудиты [SQL Server], создание спецификации базы данных"
  - "аудит базы данных [SQL Server]"
