...
|DATABASE|ALTER ANY SENSITIVITY CLASSIFICATION|ALSP<br />Применимо к [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] (начиная с SQL Server vNext (15.x) до текущей версии), базе данных SQL.|DATABASE|CONTROL SERVER|
