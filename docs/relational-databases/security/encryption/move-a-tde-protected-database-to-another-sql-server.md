---
title: "Переместить базу данных, защищаемую прозрачным шифрованием, в другой экземпляр SQL Server | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Прозрачное шифрование данных, перемещение"
  - "прозрачное шифрование данных, перемещение базы данных"
...
---
# Переместить базу данных, защищаемую прозрачным шифрованием, в другой экземпляр SQL Server
...
9. В диалоговом окне **Поиск файлов базы данных***имя_сервера* выберите присоединяемый к новому серверу файл базы данных и нажмите кнопку **ОК**.  
     ...
     **"** *\<имя_базы_данных>* **" сведения о базе данных**  
