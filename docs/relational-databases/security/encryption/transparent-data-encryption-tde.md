---
title: "Прозрачное шифрование данных (TDE) | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "03/09/2017"
...
helpviewer_keywords: 
  ...
  - "ключ шифрования базы данных, сведения"
  - "TDE"
  - "ключ шифрования базы данных"
  - "TDE, сведения"
  - "Прозрачное шифрование данных, сведения"
  - "шифрование [SQL Server], прозрачное шифрование данных"
 ...
 **Иерархия шифрования**  
 ...
 ![Показывает иерархию, описанную в этом разделе.](../../../relational-databases/security/encryption/media/tde-architecture.gif "Показывает иерархию, описанную в этом разделе.")  
...
|[Параметры ALTER DATABASE SET &#40;Transact-SQL&#41;](../Topic/ALTER%20DATABASE%20SET%20Options%20\(Transact-SQL\).md)|Объясняет параметр **ALTER DATABASE** , который используется для включения TDE.|  
