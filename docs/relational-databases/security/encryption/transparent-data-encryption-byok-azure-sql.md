...
- Настройте хранилище ключей с [обратимым удалением](https://docs.microsoft.com/azure/key-vault/key-vault-ovw-soft-delete) для защиты от потери данных на случай случайного или злонамеренного удаления ключа или хранилища ключей.  Это **обязательное требование** для прозрачного шифрования данных при использовании технологии BYOK:  
  - Ресурсы с обратимым удалением хранятся в течение 90 дней, в течение которых их можно восстановить или удалить.
