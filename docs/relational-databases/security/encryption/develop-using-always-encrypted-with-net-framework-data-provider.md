---
title: Разработка с использованием постоянного шифрования с поставщиком данных .NET Framework | Документация Майкрософт
ms.custom: ''
ms.date: 08/09/2016
ms.prod: sql
...
В этой статье содержатся сведения о разработке приложений .NET с помощью функции [постоянного шифрования](../../../relational-databases/security/encryption/always-encrypted-database-engine.md) и [поставщика данных .NET Framework для SQL Server](https://msdn.microsoft.com/library/kb9s9ks0(v=vs.110).aspx).
...
Обратите внимание, что включение постоянного шифрования недостаточно для успешного шифрования или расшифровки. Необходимо также проверить выполнение следующих условий:
...
> [!NOTE]
> Запросы могут выполнять сравнение на равенство для столбцов, если они шифруются с помощью детерминированного шифрования. Дополнительные сведения см. в подразделе *Выбор детерминированного или случайного шифрования* раздела [Always Encrypted (ядро СУБД)](../../../relational-databases/security/encryption/always-encrypted-database-engine.md).
...
Обратите внимание, что несмотря на то, что установка доверенных путей повышает безопасность приложения, вам потребуется изменять код или/и конфигурацию приложения при каждой смене главного ключа столбца (или при изменении пути к главному ключу столбца). 
...
Обратите внимание, что параметр AllowEncryptedValueModifications доступен в .NET Framework 4.6.1 и более поздних версиях.
