---
title: "Расширенное управление ключами с помощью хранилища ключей Azure (SQL Server) | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "07/22/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Расширенное управление ключами с помощью хранилища ключей"
  - "Прозрачное шифрование данных с помощью расширенного управления ключами и хранилища ключей"
  - "Расширенное управление ключами с хранилищем ключей"
  - "Прозрачное шифрование данных, расширенное управление ключами и хранилище ключей"
  - "Управление ключами с помощью хранилища ключей"
  - "Соединитель SQL Server, описание"
