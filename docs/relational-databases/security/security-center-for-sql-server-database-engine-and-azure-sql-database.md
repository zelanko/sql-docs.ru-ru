---
title: "Центр обеспечения безопасности для базы данных Azure SQL и SQL Server Database Engine | Microsoft Docs"
ms.custom: 
  - "MSDN content"
  - "MSDN - SQL DB"
ms.date: "01/31/2017"
...
helpviewer_keywords: 
  ...
  - "безопасность баз данных [SQL Server]"
  - "базы данных [SQL Server], безопасность"
...
## См. также:  
 ...
 [Функции и задачи компонента Database Engine](../Topic/Database%20Engine%20Features%20and%20Tasks.md)  
