---
title: "Маскирование динамических данных | Microsoft Docs"
ms.custom: ""
ms.date: "09/26/2016"
...
*  Центральная политика маскирования данных применяется непосредственно к полям в базе данных.
*  Можно назначить привилегированных пользователей или роли, которые имеют доступ к конфиденциальным данным.
*  DDM предоставляет возможности полного и частичного маскирования, а также возможность случайной маски для числовых данных.
*  Простые команды [!INCLUDE[tsql_md](../../includes/tsql-md.md)] помогают определять маски и управлять ими.
