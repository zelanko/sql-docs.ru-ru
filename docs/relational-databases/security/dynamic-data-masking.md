...
*  DDM предоставляет возможности полного и частичного маскирования, а также случайную маску для числовых данных.
*  Простые команды [!INCLUDE[tsql_md](../../includes/tsql-md.md)] позволяют определять маски и управлять ими.
