---
title: "Выбор режима проверки подлинности | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  ...
  - "мастер установки SQL Server, страница "Режим проверки подлинности""
  - "выбор режима проверки подлинности"
  - "проверка подлинности [SQL Server], выбор режима"
