---
title: "Иерархия разрешений (компонент Database Engine) | Microsoft Docs"
ms.custom: ""
ms.date: "03/23/2016"
...
helpviewer_keywords: 
  - "безопасность [SQL Server], запрет доступа"
  - "иерархии [SQL Server], разрешения"
  - "защищаемые объекты [SQL Server]"
  - "безопасность [SQL Server], разрешения"
  - "разрешения [SQL Server], иерархия"
  - "безопасность [SQL Server], предоставление доступа"
...
[!INCLUDE[tsql-appliesto-ss2008-all_md](../../includes/tsql-appliesto-ss2008-all-md.md)]
 ...
 ![Диаграмма иерархий разрешений компонента Database Engine](../../relational-databases/security/media/wj-security-layers.gif "Диаграмма иерархий разрешений компонента Database Engine")  
