...
description: Механизмы политики паролей Windows применяются к имени входа, которое использует проверку подлинности SQL Server, и к пользователю автономной базы данных с паролем.
ms.custom: ''
ms.date: 01/16/2019
ms.prod: sql
