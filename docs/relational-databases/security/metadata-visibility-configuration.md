---
title: "Настройка видимости метаданных | Microsoft Docs"
ms.custom: ""
ms.date: "03/17/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "видимость вспомогательных компонентов [SQL Server]"
  - "метаданные [SQL Server], видимость"
  - "разрешения [SQL Server], доступ к метаданным"
  - "просмотр метаданных"
  - "объекты [SQL Server], метаданные"
  - "отображение метаданных"
  - "метаданные базы данных [SQL Server]"
  - "метаданные [SQL Server], разрешения"
...
|||  
|-|-|  
|представлений каталога;|[!INCLUDE[ssDE](../../includes/ssde-md.md)] Хранимые процедуры компонента **sp_help**|  
...
|Системные таблицы репликации|Репликация и хранимые процедуры **sp_help** агента [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]|  
...
-   Хранимые процедуры**sp_help** агента [!INCLUDE[ssDE](../../includes/ssde-md.md)] могут возвращать только подмножество строк или значение NULL.  
...
## См. также:  
 ...
 [Представления совместимости (Transact-SQL)](../Topic/Compatibility%20Views%20\(Transact-SQL\).md)  
