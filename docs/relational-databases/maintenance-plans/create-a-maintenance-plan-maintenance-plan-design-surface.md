---
title: "Создание планов обслуживания (область конструктора планов обслуживания) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "область конструктора планов обслуживания"
...
11. Задание параметров отчета  
    ...
    2.  В диалоговом окне **Отчеты и ведение журнала** в области **Отчеты**выберите **Сформировать текстовый файл отчета** , **Отправить отчет адресату по электронной почте** или оба варианта.  
        ...
        2.  В зависимости от выбора выше введите имя и полный путь к новому файлу или файлу, который будет дополняться, указав данные в полях **Папка** или **Имя файла** . Либо нажмите кнопку с многоточием **(…)** и выберите путь к папке или имя файла в диалоговом окне **Поиск папки —***имя_сервера* или **Поиск файлов базы данных —***имя_сервера*.  
