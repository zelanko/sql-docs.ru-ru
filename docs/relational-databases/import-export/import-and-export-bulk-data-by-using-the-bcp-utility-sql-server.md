---
title: "Массовый импорт и экспорт данных с использованием программы bcp (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "09/28/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "массовый экспорт [SQL Server], служебная программа bcp"
  - "массовый импорт [SQL Server], служебная программа bcp"
  - "служебная программа bcp [SQL Server], о программе bcp"
