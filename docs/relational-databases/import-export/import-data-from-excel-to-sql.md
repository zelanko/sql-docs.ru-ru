...
| Экспорт сначала в текст                        | Непосредственно из Excel                             |
| :------------------------------------------ |:----------------------------------------------- |
...
| [BCP](#bcp)                                 |Функция [OPENROWSET](#openrowset)               |
...
> [!NOTE]
> В Azure функции OPENROWSET и OPENDATASOURCE доступны только в Управляемом экземпляре Базы данных SQL.
