---
title: "Определение длины префикса в файлах данных с помощью программы bcp (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "07/28/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "служебная программа bcp [SQL Server], длина префикса"
  - "длина префикса [SQL Server]"
  - "значения длины [SQL Server], символы префикса"
  - "форматы данных [SQL Server], длина префикса"
