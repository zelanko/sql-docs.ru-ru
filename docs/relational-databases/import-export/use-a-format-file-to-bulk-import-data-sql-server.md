---
title: "Использование файла форматирования для массового импорта данных (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "09/20/2016"
...
helpviewer_keywords: 
  ...
  - "файлы форматирования [SQL Server], импорт данных с помощью"
