---
title: "Использование файла форматирования для пропуска поля данных (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "09/19/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "файлы форматирования [SQL Server], пропуск полей данных"
  - "пропуск полей данных при импортировании"
