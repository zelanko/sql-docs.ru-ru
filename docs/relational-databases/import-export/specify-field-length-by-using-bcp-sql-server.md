---
title: "Указание длины поля с помощью программы bcp (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  ...
  - "длины полей по умолчанию"
  - "длина поля [SQL Server]"
  - "форматы данных [SQL Server], длина поля"
  - "служебная программа bcp [SQL Server], длина поля"
...
|XML|0|  
 ...
 \*Дополнительные сведения о типах данных **decimal** и **numeric** см. в разделе [decimal и numeric (Transact-SQL)](../../t-sql/data-types/decimal-and-numeric-transact-sql.md).  
