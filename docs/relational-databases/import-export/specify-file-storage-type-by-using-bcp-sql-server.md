---
title: "Указание типа файлового хранилища с помощью программы bcp (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "программа bcp [SQL Server], типы файловых хранилищ"
  - "импорт данных, типы файловых хранилищ"
  - "собственный формат данных [SQL Server]"
  - "типы файловых хранилищ [SQL Server]"
  - "форматы данных [SQL Server], типы файловых хранилищ"
...
-   Для массового импорта данных в экземпляр [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] из файла данных укажите тип файлового хранилища **char** для типов, для которых данные хранятся в символьном формате, а для данных, хранящихся в формате собственного типа данных, укажите один из типов файлового хранилища.  
    ...
    |Тип файлового хранилища|Введите в командной строке|  
    |-----------------------|-----------------------------|  
    |**char;***|**c**[**har**]|  
    |**varchar**|**c[har]**|  
    |**nchar**|**w**|  
...
|Тип файлового хранилища|Тип данных файла|  
|-----------------------|-------------------------|  
|**char;***|SQLCHAR|  
|**varchar**|SQLCHAR|  
|**nchar**|SQLNCHAR|  
