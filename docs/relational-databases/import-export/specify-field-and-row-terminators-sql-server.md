---
title: "Определение признаков конца поля и строки (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "08/10/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Служебная программа bcp [SQL Server], знаки завершения"
  - "признаки конца поля [SQL Server]"
  - "Форматы данных [SQL Server], знаки завершения"
