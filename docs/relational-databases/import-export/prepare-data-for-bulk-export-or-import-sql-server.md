---
title: "Подготовка данных к массовому экспорту или импорту (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "массовый импорт [SQL Server], планирование"
  - "массовый импорт [SQL Server], из CSV-файла"
  - "форматы данных [SQL Server], операции планирования"
  - "CSV-файлы [SQL Server]"
  - "поля в кавычках в CSV-файлах [SQL Server]"
