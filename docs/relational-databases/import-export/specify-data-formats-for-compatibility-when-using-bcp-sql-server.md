---
title: "Указание форматов данных для совместимости с помощью программы bcp (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Массовый экспорт [SQL Server], совместимость"
  - "Массовый импорт [SQL Server], совместимость"
  - "Совместимость [SQL Server], форматы данных"
  - "Форматы данных [SQL Server], совместимость"
  - "Служебная программа bcp [SQL Server], совместимость"
...
-   [Атрибуты формата данных в инструкции bcp](#bcpDataFormatAttr)  
  
-   [Обзор приглашений, относящихся к полям](#FieldSpecificPrompts)  
  
-   [Хранение данных полей в файле форматирования в формате, отличном от XML](#FieldByFieldNonXmlFF)  
