---
title: "Импорт данных в собственном и символьном формате из предыдущих версий SQL Server | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "предыдущие версии [SQL Server], форматы данных импорта и экспорта"
  - "ключ -V"
  - "форматы данных [SQL Server], предыдущие версии"
  - "предыдущие версии [SQL Server], форматы данных импорта и экспорта"
