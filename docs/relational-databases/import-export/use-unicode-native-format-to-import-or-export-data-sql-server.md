---
title: "Использование собственного формата Юникода для импорта или экспорта данных (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "09/30/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Юникод [SQL Server], массовый импорт и экспорт"
  - "форматы данных [SQL Server], собственный формат Юникода"
