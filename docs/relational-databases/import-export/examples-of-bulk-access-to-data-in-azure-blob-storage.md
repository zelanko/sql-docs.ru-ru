...
description: В этих примерах Transact-SQL показано, как использовать инструкции BULK INSERT и OPENROWSET для прямого доступа к файлу в учетной записи хранилища BLOB-объектов Azure.
