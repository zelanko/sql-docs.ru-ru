---
title: "Пропуск столбца таблицы с помощью файла форматирования (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "08/05/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "пропуск столбцов при импорте"
  - "файлы форматирования [SQL Server], пропуск столбцов"
