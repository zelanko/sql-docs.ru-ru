...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]В этом разделе описывается способ выполнения [!INCLUDE[msCoName](../../includes/msconame-md.md)] инструкции языка запросов инструментария (WQL) управления Windows для поставщика WMI для управления компьютером.  
