...
Совокупные сведения об ожиданиях доступны в динамическом административном представлении *sys.dm_os_wait_stats*. Наиболее распространенным типом конфликтов кратковременных блокировок является конфликт за буфер, который проявляется в увеличении времени ожидания для кратковременных блокировок с типом ожидания (*wait_type*) **PAGELATCH\_\*** . Небуферные кратковременные блокировки группируются в типе ожидания **LATCH\*** . Как показано на следующем рисунке, сначала необходимо оценить систему ожиданий в целом с помощью динамического административного представления *sys.dm_os_wait_stats*, чтобы определить доли общего времени ожидания, связанные с буферными и небуферными кратковременными блокировками. При наличии небуферных кратковременных блокировок необходимо также проверить динамическое административное представление *sys.dm_os_latch_stats*.
