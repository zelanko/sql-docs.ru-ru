---
title: Совместимость с платформой DAC | Документация Майкрософт
ms.custom:
- SSDT
ms.date: 02/09/2017
ms.prod: sql
...
Можно загрузить более новую версию SSDT со страницы [Установка последней версии SQL Server Data Tools](http://go.microsoft.com/fwlink/?LinkID=616714).  
