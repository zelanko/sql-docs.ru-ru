...
1.  В **обозревателе решений** щелкните правой кнопкой мыши проект **TradeDev** и выберите **Импорт** и **Приложение уровня данных (\*.dacpac)** в контекстном меню.  
