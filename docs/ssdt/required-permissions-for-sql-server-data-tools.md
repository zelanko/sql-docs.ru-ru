...
|Развертывание обновлений в существующую базу данных|Вы должны быть допустимым пользователем базы данных. Вам также нужно быть членом роли **db_ddladmin**, владеть схемой или объектами, которые требуется создать или изменить в целевой базе данных. Для работы в скриптах, выполняемых перед развертыванием и после него, с более сложными концепциями, например именами входа или связанными серверами, требуются дополнительные разрешения.<br /><br />**ПРИМЕЧАНИЕ.** При развертывании в базе данных master вам также требуется разрешение **VIEW ANY DEFINITION** на сервере, куда выполняется развертывание.|  
