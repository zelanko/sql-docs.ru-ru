...
| Добавления | Сведения |
|-----------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Службы Integration Services (SSIS) | Устранена проблема, из-за которой части пакета не могли быть сохранены правильно из-за выбора предыдущей целевой версии SQL Server. |
