---
title: Практическое руководство. Определение структуры и добавление фрагментов кода к скриптам Transact-SQL | Документация Майкрософт
ms.custom:
- SSDT
ms.date: 02/09/2017
ms.prod: sql
