...
> [!Note]
> SSDT поддерживает две последние версии Visual Studio. После выпуска Visual Studio 2019 версии SSDT для Visual Studio 2015 и более ранних версий больше не обновляются. SSDT для Visual Studio 2010 больше недоступен. Дополнительные сведения см. в разделе *Часто задаваемые вопросы* в [этой записи блога группы разработчиков SSDT](https://blogs.msdn.microsoft.com/ssdt/2017/03/10/sql-server-data-tools-17-0-rc-and-ssdt-in-vs2017/).
