...
Этот журнал изменений относится к службе [SQL Server Data Tools (SSDT) для Visual Studio 2015](https://msdn.microsoft.com/library/mt204009.aspx), выпущенной с [SQL Server 2016](https://msdn.microsoft.com/library/ms130214.aspx).  
  
Подробные сведения о новых и измененных функциях см. в [блоге группы разработчиков SSDT](https://blogs.msdn.microsoft.com/ssdt/).  

## <a name="ssdt-165-for-sql-server-2016"></a>SSDT 16.5 (для SQL Server 2016)
