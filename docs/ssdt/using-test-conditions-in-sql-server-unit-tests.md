...
description: Сведения об условиях тестов в модульных тестах SQL Server. Узнайте, как использовать предварительно определенные условия и отрицательное тестирование, а также просматривать сведения о пользовательских условиях.
ms.prod: sql
ms.technology: ssdt
ms.topic: conceptual
f1_keywords:
