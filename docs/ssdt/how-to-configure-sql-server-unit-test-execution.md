...
3.  Чтобы закрыть диалоговое окно **Конфигурация теста SQL Server —''** '' **, нажмите кнопку <projectname>OК**.  
...
5.  Чтобы закрыть диалоговое окно **Конфигурация теста SQL Server —''** '' **, нажмите кнопку <projectname>OК**.  
