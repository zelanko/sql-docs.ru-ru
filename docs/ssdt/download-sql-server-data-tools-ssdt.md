...
> - SSDT для Visual Studio 2017 (15.8.2) не поддерживает разработку пакетов, содержащих источники или назначения Teradata. Использование SSDT для Visual Studio 2017 (15.8).
