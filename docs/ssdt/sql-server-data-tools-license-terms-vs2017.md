---
title: SQL Server Data Tools и Visual Studio 2017. Условия лицензии | Документация Майкрософт
ms.custom: ''
ms.date: 08/04/2017
ms.prod: sql
...
**MICROSOFT SQL SERVER DATA TOOLS ДЛЯ VISUAL STUDIO 2017**
---  
...
&nbsp;&nbsp;**а.    Установка и использование.**  
   ...
   * Если программное обеспечение включает в себя Microsoft Visual Studio 2017, с Microsoft SQL Server Data Tools можно использовать только Microsoft Visual Studio 2017.
     
&nbsp;&nbsp;**б.    Другие программы корпорации Майкрософт.**  

   * Программное обеспечение включает в себя другие технологии Microsoft SQL Server, Microsoft Visual Studio 2017, .NET Framework, Распространяемый компонент Visual C++ для Visual Studio 2017 и среду выполнения Microsoft Report Viewer 2016 в сочетании с лицензируемым здесь программным обеспечением. Эти компоненты регулируются отдельными соглашениями и собственными политиками поддержки программных продуктов, о чем говорится в лицензионных условиях, включенных в каталог установки для этих компонентов или в папку "Licenses" для программного обеспечения.  
...
Процесс использования карт Bing также регулируется условиями использования карт Bing конечным пользователем (https://go.microsoft.com/?linkid=9710837) и заявлением о конфиденциальности для карт Bing (https://go.microsoft.com/fwlink/?LinkID=248686).  
