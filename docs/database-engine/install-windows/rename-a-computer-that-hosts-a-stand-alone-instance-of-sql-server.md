---
title: "Переименование компьютера, на который установлен изолированный экземпляр SQL Server | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "ошибки удаленных входов в систему [SQL Server]"
  - "имена отдельных компьютеров [SQL Server]"
  - "имена [SQL Server], изолированные экземпляры SQL Server"
  - "переименование отдельных экземпляров SQL Server"
  - "sysservers, системная таблица"
  - "удаление удаленных имен входа в систему"
  - "удаление удаленных имен входа в систему"
  - "удаление удаленных имен входа в систему"
...
### Переименование компьютера, на котором расположен изолированный экземпляр [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]  
...
-   Выберите данные из @@SERVERNAME или sys.servers. Функция @@SERVERNAME возвращает новое имя, а в таблице sys.servers отображается новое имя. В следующем примере показано использование функции @@SERVERNAME.  
