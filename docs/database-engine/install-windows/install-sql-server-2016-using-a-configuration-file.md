---
title: "Установка SQL Server 2016 с помощью файла конфигурации | Документы Майкрософт"
ms.custom: 
ms.date: 01/20/2016
...
---
# <a name="install-sql-server-2016-using-a-configuration-file"></a>Установка SQL Server 2016 с помощью файла конфигурации
