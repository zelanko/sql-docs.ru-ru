---
title: "Обновление реплицируемых баз данных | Microsoft Docs"
ms.custom: ""
ms.date: "02/16/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "обновления баз данных, реплицированных слиянием [репликация SQL Server]"
  - "репликация [SQL Server], обновление"
  - "репликация транзакций, обновление баз данных"
  - "репликация моментального снимка [SQL Server], обновление баз данных"
...
## Обновление до выпусков Standard Edition, Workgroup Edition и Express Edition  
 Перед обновлением с одного выпуска [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] до другого проверьте, что используемые функции поддерживаются в выпуске, до которого производится обновление. Дополнительные сведения см. в разделе "Репликация" статьи [Функции, поддерживаемые в выпусках SQL Server 2016](../Topic/Features%20Supported%20by%20the%20Editions%20of%20SQL%20Server%202016.md).  
