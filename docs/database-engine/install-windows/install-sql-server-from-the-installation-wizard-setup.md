...
1. Начиная с SQL Server 2019 перед установкой Polybase на компьютере больше не требуется предварительно устанавливать Oracle JRE 7 с обновлением 51 (или более поздней версии). Выбор установки компонента Polybase приведет к добавлению страницы **Расположение установки Java** в программу установки SQL Server. Она отображается после страницы **Конфигурация экземпляра**. На странице "Расположение установки Java" можно установить Azul Zulu OpenJRE, включенный в состав установки SQL Server 2019, или указать расположение другого JRE или JDK, уже установленного на этом компьютере.

1. Начиная с SQL Server 2019 Java входит в состав расширений языка. Выбор установки компонента Java приведет к добавлению страницы **Расположение установки Java** в диалоговое окно установки SQL Server, отображаемое после страницы **Конфигурация экземпляра**. На странице **Расположение установки Java** можно установить Zulu OpenJRE, включенный в состав установки SQL Server 2019, или указать расположение другого JRE или JDK, уже установленного на этом компьютере.
