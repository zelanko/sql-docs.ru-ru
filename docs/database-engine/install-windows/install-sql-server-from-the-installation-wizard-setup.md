...
-   [Установка бесплатных выпусков SQL Server 2016 напрямую из Интернета](../../database-engine/install-windows/install-sql-server.md) 
