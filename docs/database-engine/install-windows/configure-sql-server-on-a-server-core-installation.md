...
-   [Установка роли сервера на сервер, на котором работает Server Core из Windows Server 2008 R2: обзор](http://go.microsoft.com/fwlink/?LinkId=245960)
  
-   [Установка компонентов Windows на сервер, на котором работает Server Core из Windows Server 2008 R2: обзор](http://go.microsoft.com/fwlink/?LinkId=245961)
...
##  <a name="BKMK_ConfigureRemoteAccess"></a> Настройка удаленного доступа для [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] при работе на Server Core  
 Чтобы настроить удаленный доступ к экземпляру [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)], который запускается в Windows Server Core, выполните действия, описанные ниже.  
...
## <a name="see-also"></a>См. также:  
 [Установка SQL Server 2016 на Server Core](../../database-engine/install-windows/install-sql-server-on-server-core.md)   
