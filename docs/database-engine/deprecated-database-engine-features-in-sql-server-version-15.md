...
ms.locfileid: "75252726"
---
# <a name="deprecated-database-engine-features-in-includesssqlv15-mdincludessssqlv15-mdmd"></a>Нерекомендуемые функции ядра СУБД в [!INCLUDE[sssqlv15-md](../includes/sssqlv15-md.md)]
