---
title: "Наблюдение за доставкой журналов (Transact-SQL) | Microsoft Docs"
ms.custom: ""
ms.date: "03/06/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "доставка журналов [агент SQL Server], состояние"
  - "таблицы журналов [SQL Server]"
  - "журнальные данные [SQL Server], доставка журналов"
  - "доставка журналов [SQL Server], мониторинг"
  - "предупреждения [SQL Server], доставка журналов"
  - "сведения о состоянии [SQL Server], доставка журналов"
  - "мониторинг доставки журналов [SQL Server]"
