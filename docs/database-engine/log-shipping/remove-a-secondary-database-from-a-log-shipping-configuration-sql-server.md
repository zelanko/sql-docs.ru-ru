---
title: Удаление получателя доставки журналов
description: Узнайте, как удалить базу данных — получателя доставки журналов с помощью SQL Server Management Studio или Transact-SQL.
