---
title: "Сведения о доставке журналов (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "05/17/2016"
...
helpviewer_keywords: 
  ...
  - "доставка журналов [SQL Server], задания"
  - "задания копирования [SQL Server]"
  - "базы данных-источники [SQL Server]"
  - "доставка журналов [SQL Server], мониторинг"
  - "доставка журналов [SQL Server], о доставке журналов"
  - "задания предупреждения [SQL Server]"
  - "доступность [SQL Server]"
  - "задания [SQL Server], доставка журналов"
  - "серверы мониторинга [SQL Server]"
  - "задания восстановления [SQL Server]"
  - "доставка журналов [SQL Server]"
  - "задания резервного копирования [SQL Server]"
