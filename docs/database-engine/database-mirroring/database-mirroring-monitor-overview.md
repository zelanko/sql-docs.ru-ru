 ...
 *<ИМЯ_СИСТЕМЫ>*[**\\***<имя_экземпляра>*]  
 ...
 где *<SYSTEM_NAME>* — это имя системы, на которой расположен экземпляр сервера. Для не заданного по умолчанию экземпляра сервера имя экземпляра также отображается: *<ИМЯ_СИСТЕМЫ>***\\***<имя_экземпляра>*.  
