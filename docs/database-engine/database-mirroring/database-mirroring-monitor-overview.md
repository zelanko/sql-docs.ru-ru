---
title: "Обзор монитора зеркального отображения баз данных | Microsoft Docs"
ms.custom: ""
ms.date: "03/07/2017"
...
helpviewer_keywords: 
  - "монитор зеркального отображения баз данных [SQL Server], интерфейс"
 ...
 *\<Имя_базы_данных>* **(** *\<Состояние>* **,** *\<ОСНОВНОЙ_СЕРВЕР>* **->** *\<ЗЕРКАЛЬНЫЙ СЕРВЕР>* **)**  
