...
description: Используйте эту доступную только для чтения страницу монитора зеркального отображения баз данных для просмотра предупреждений в связи с событиями, происходящими при зеркальном отображении баз данных, и пороговых значений, при которых выдаются предупреждения (если они доступны).
ms.custom: ''
ms.date: 03/07/2017
ms.prod: sql
