---
title: "Использование пороговых значений предупреждений и оповещений в метриках производительности зеркального отображения (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "наблюдение за зеркальным отображением баз данных [SQL Server]"
  - "пороги [SQL Server]"
  - "зеркальное отображение базы данных [SQL Server], управление в среде SQL Server Management Studio"
  - "предупреждения [SQL Server], зеркальное отображение базы данных"
  - "зеркальное отображение базы данных [SQL Server], мониторинг"
  - "предупреждения [зеркальное отображение базы данных]"
