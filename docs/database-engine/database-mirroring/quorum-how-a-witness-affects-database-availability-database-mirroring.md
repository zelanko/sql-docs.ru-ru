---
title: "Кворум. Как следящий сервер влияет на доступность базы данных (зеркальное отображение базы данных) | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "кворум [SQL Server], зеркальное отображение базы данных"
  - "работа без поддержки в зеркальном отображении базы данных [SQL Server]"
  - "кворум «следящий сервер-участник» [SQL Server]"
  - "участники [SQL Server], кворум "участник-участник""
  - "следящий сервер [SQL Server], кворум"
  - "состояние наличия кворума [SQL Server]"
  - "кворум [SQL Server]"
  - "зеркальная база данных [SQL Server]"
  - "полный кворум [SQL Server]"
...
-   *Кворум "участник-участник"* состоит из двух участников.  
 ...
 ![Кворумы: полный; следящий и участник; оба участники](../../database-engine/database-mirroring/media/dbm-failovautoquorum.gif "Кворумы: полный; следящий и участник; оба участники")  
...
-   Сеанс теряет кворум.  
    ...
    -   Если основной сервер остается отключенным, а зеркальный и следящий заново подключаются друг к другу, то автоматическая отработка отказа невозможен из-за возможной потери данных. Поэтому база данных остается недоступной, пока основной сервер вновь не подключится к сеансу.  
