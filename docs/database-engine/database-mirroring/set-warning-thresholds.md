---
title: "Установка порогов предупреждений | Microsoft Docs"
ms.custom: ""
ms.date: "03/07/2017"
...
-   **Подключено к ** *server_instance_name*  
    ...
    > [!NOTE]  
    >  Для пользователей, не являющихся членами предопределенной роли сервера **sysadmin**, это значение состояния принимает вид **Подключен к ***имя_экземпляра_сервера* ** (ограниченные разрешения)**.  
