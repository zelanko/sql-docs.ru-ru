...
description: Сведения о мониторе зеркального отображения баз данных, системных хранимых процедурах и том, как работает мониторинг зеркального отображения баз данных, включая задание монитора зеркального отображения баз данных.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
##  <a name="monitoring-mirroring-status"></a><a name="MonitoringStatus"></a> Наблюдение за состоянием зеркального отображения  
...
###  <a name="tools-for-monitoring-database-mirroring-status"></a><a name="tools_for_monitoring_dbm_status"></a> Средства для контроля над состоянием зеркального отображения базы данных  
...
###  <a name="status-displayed-by-the-database-mirroring-monitor"></a><a name="perf_metrics_of_dbm_monitor"></a> Состояние, отображаемое монитором зеркального отображения баз данных  
...
##  <a name="additional-sources-of-information-about-a-mirrored-database"></a><a name="AdditionalSources"></a> Дополнительные источники сведений о зеркальной базе данных  
...
###  <a name="database-mirroring-metadata"></a><a name="DbmMetadata"></a> Метаданные зеркального отображения базы данных  
...
###  <a name="database-mirroring-performance-counters"></a><a name="DbmPerfCounters"></a> Счетчики производительности зеркального отображения базы данных  
...
###  <a name="database-mirroring-event-notifications"></a><a name="DbmEventNotif"></a> Уведомления о событиях зеркального отображения базы данных  
