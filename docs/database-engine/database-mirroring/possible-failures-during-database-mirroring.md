---
title: "Возможные неполадки при зеркальном отображении базы данных | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "период ожидания [зеркальное отображение базы данных SQL Server]"
  - "кратковременные ошибки [SQL Server]"
  - "зеркальное отображение базы данных [SQL Server], устранение неполадок"
  - "ошибки времени ожидания [SQL Server]"
  - "устранение неполадок [SQL Server], зеркальное отображение базы данных"
  - "постоянные ошибки"
  - "неудачно завершившиеся сеансы зеркального отображения базы данных [SQL Server]"
