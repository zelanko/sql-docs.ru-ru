...
description: Узнайте, как указать сетевой адрес сервера для конечной точки зеркального отображения базы данных. При настройке сеанса зеркального отображения базы данных для каждого экземпляра сервера требуется адрес.
