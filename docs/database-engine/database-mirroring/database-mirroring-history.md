---
title: "Журнал зеркального отображения базы данных | Microsoft Docs"
ms.custom: ""
ms.date: "03/07/2017"
...
---
# Журнал зеркального отображения базы данных
...
|**Скорость отправки**|Скорость, с которой информация о транзакциях передается на экземпляр зеркального сервера, КБ в секунду.|  
