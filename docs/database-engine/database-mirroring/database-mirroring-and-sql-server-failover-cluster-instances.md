...
description: Вы можете сочетать зеркальное отображение баз данных и экземпляры отказоустойчивых кластеров SQL Server. Узнайте о режиме высокой производительности и режиме высокого уровня безопасности с отработкой отказа и без нее.
