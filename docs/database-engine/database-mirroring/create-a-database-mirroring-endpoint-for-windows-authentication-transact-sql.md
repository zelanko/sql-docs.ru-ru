...
description: Использование Transact-SQL для создания конечной точки зеркального отображения базы данных с помощью проверки подлинности Windows.
