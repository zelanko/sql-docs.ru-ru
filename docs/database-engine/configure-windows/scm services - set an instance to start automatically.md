---
title: "Настройка автоматического запуска экземпляра SQL Server (диспетчер конфигурации SQL Server) | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "03/23/2017"
...
helpviewer_keywords: 
  ...
  - "SQL Server, автоматический запуск"
  - "запуск SQL Server, автоматически"
...
manager: "jhubbard"
---
# Настройка автоматического запуска экземпляра SQL Server (диспетчер конфигурации SQL Server)
...
4.  В диалоговом окне **SQL Server \<***имя_экземпляра***> Свойства** установите для параметра **Режим запуска** значение **Автоматически**.  
...
## См. также:  
 ...
 [Подключение к другому компьютеру (диспетчер конфигурации SQL Server)](../../database-engine/configure-windows/connect-to-another-computer-sql-server-configuration-manager.md)   
