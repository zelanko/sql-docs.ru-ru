...
description: Ознакомьтесь с монитором SQL Server. Узнайте, как использовать его модули монитора репликации и монитора зеркального отображения баз данных. Просмотрите разрешения, необходимые для его работы.
ms.custom: ''
ms.date: 03/04/2017
ms.prod: sql
