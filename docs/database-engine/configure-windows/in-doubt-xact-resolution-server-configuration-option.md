---
title: "Параметр конфигурации сервера &#171;in-doubt xact resolution&#187; | Microsoft Docs"
ms.custom: ""
ms.date: "03/02/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "распределенные транзакции [SQL Server], неразрешенные транзакции"
  - "неразрешенные транзакции"
  - "in-doubt xact resolution, параметр"
