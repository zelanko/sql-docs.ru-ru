---
title: "изменить стартовую учетную запись службы для SQL Server (диспетчер конфигурации SQL Server) | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "01/06/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "службы SQL Server, изменение стартовой учетной записи"
  - "стартовые учетные записи [SQL Server]"
  - "изменение стартовых учетных записей для служб"
...
---
# изменить стартовую учетную запись службы для SQL Server (диспетчер конфигурации SQL Server)
...
#### Изменение стартовой учетной записи службы SQL Server  
