...
description: Изучите параметр affinity I/O mask. Используйте его для повышения производительности потоков SQL Server, которые выдают операции ввода-вывода, привязывая дисковый ввод-вывод к указанным ЦП.
ms.custom: ''
ms.date: 07/06/2017
ms.prod: sql
