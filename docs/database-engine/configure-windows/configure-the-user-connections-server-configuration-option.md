---
title: "Настройка параметра конфигурации сервера user connections | Microsoft Docs"
ms.custom: ""
ms.date: "03/02/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "одновременные соединения [SQL Server]"
  - "user connections, параметр [SQL Server]"
  - "пользователи [SQL Server], одновременные соединения"
  - "максимальное количество одновременных соединений пользователей"
  - "соединения [SQL Server], одновременные"
