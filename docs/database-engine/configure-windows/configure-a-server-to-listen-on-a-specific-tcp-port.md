...
description: Сведения о том, как с помощью диспетчера конфигурации SQL Server настроить ядро СУБД для прослушивания определенного порта вместо заданного по умолчанию порта 1433.
ms.custom: ''
ms.date: 04/25/2017
ms.prod: sql
