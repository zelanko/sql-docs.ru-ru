...
description: Информация о включении параметра "Блокировка страниц в памяти". Сведения о том, как с его помощью повысить производительность за счет хранения данных в физической памяти вместо их записи в область подкачки на диске.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
