---
title: "Изменение режима проверки подлинности сервера | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  - "учетная запись sa"
  - "проверка подлинности [SQL Server], смена режимов"
  - "режим проверки подлинности сервера [SQL Server]"
