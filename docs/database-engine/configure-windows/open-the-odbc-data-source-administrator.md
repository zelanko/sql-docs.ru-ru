...
description: Узнайте, как открывать администратор источников данных ODBC в различных операционных системах. Этот компонент Windows можно использовать для создания источников данных ODBC и управления ими.
ms.custom: ''
ms.date: 11/07/2016
ms.prod: sql
