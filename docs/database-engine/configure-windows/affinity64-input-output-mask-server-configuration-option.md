...
description: Описание параметра affinity64 I/O mask. Сведения о том, как использовать его для привязки операций дискового ввода-вывода SQL Server к конкретному подмножеству процессоров.
ms.custom: ''
ms.date: 03/02/2017
ms.prod: sql
