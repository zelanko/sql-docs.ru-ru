...
## <a name="description"></a>Описание  
 ...
 Дополнительные сведения о включении **LocalDB** в приложение см. в документации [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] [Общие сведения о локальных данных](https://docs.microsoft.com/previous-versions/visualstudio/visual-studio-2012/ms233817(v=vs.110)), [Пошаговое руководство. Создание базы данных LocalDB SQL Server](https://docs.microsoft.com/previous-versions/visualstudio/visual-studio-2012/ms233763(v=vs.110)) и [Пошаговое руководство. Подключение к данным в базе данных LocalDB SQL Server (формы Windows)](https://docs.microsoft.com/previous-versions/visualstudio/visual-studio-2012/ms171890(v=vs.110)).  
  
 Дополнительные сведения об API **LocalDB** см. в [справочнике по SQL Server Express LocalDB](../../relational-databases/sql-server-express-localdb-reference.md).  
