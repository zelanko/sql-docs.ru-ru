...
helpviewer_keywords: 
  ...
  - "LocalDB, описанная"
  - "локальная среда выполнения базы данных"
  - "база данных файла"
  - "LocalDB"
...
-   Чтобы скачать и установить SQL Server 2016 Express, перейдите в **[Центр загрузки](http://www.microsoft.com/download/details.aspx?id=52679)**. Компонент LocalDB выбирается во время установки. В **Центре загрузки** LocalDB доступен для **выборочной установки** или при скачивании носителя. Если вы скачиваете носитель, выберите **Express Advanced** или пакет **LocalDB**. 
  
-   Есть учетная запись Azure?  Затем перейдите **[сюда](https://azure.microsoft.com/en-us/marketplace/partners/microsoft/sqlserver2016ctp33evaluationwindowsserver2012r2/?wt.mc_id=sqL16_vm)**, чтобы запустить виртуальную машину с уже установленным [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)].  
