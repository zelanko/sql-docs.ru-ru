---
title: "Параметры запуска службы Database Engine | Microsoft Docs"
ms.custom: ""
ms.date: "07/21/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Однопользовательский режим [SQL Server], параметр запуска"
  - "изменение параметров запуска по умолчанию"
  - "Режим минимальной конфигурации [SQL Server], параметр запуска"
  - "параметры запуска по умолчанию"
  - "временное изменение параметров запуска по умолчанию [SQL Server]"
  - "параметры запуска [SQL Server]"
  - "Запуск SQL Server, параметры"
...
## О параметрах запуска  
 ...
 Параметры запуска можно задать в диспетчере конфигурации [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]. Дополнительные сведения см. в статье [Настройка параметров запуска сервера (диспетчер конфигурации SQL Server)](../../database-engine/configure-windows/configure-server-startup-options-sql-server-configuration-manager.md).  
