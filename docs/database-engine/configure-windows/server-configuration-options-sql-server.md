---
title: "Параметры конфигурации сервера (SQL Server) | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "03/02/2017"
...
helpviewer_keywords: 
  - "конфигурация контактной зоны [SQL Server], sp_configure"
  - "параметры конфигурации [SQL Server], когда вступают в силу"
  - "управление сервером [SQL Server], параметры конфигурации"
  - "SQL Server Management Studio [SQL Server], серверы"
  - "серверы [SQL Server], настройка"
  - "параметры конфигурации [SQL Server], настройка"
  - "параметры [SQL Server], конфигурация"
  - "RECONFIGURE, инструкция"
  - "производительность [SQL Server], серверы"
  - "параметры конфигурации [SQL Server]"
  - "RECONFIGURE WITH OVERRIDE, инструкция"
  - "SQL Server, настройка"
  - "sp_configure"
  - "хранимые процедуры [SQL Server], параметры конфигурации"
  - "конфигурация сервера [SQL Server]"
  - "администрирование SQL Server, параметры конфигурации"
...
-   SC = Самонастраивающиеся параметры.  
    ...
    |[external scripts enabled](../../database-engine/configure-windows/external-scripts-enabled-server-configuration-option.md) (RR)<br /><br /> **Область применения**: [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] (от [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] до [текущей версии](http://go.microsoft.com/fwlink/p/?LinkId=299658)).|0|1|0|  
    ...
    |[PolyBase Hadoop and Azure blob storage](../../database-engine/configure-windows/polybase-connectivity-configuration-transact-sql.md) (RP)<br /><br /> **Область применения**: [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] (от [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] до [текущей версии](http://go.microsoft.com/fwlink/p/?LinkId=299658)).|0|7|0|   
