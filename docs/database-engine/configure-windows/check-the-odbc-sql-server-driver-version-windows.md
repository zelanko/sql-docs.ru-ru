---
title: "Проверка версии драйвера ODBC для SQL Server (Windows) | Microsoft Docs"
ms.custom: ""
ms.date: "11/07/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "номер версии драйвера [ODBC]"
  - "драйверы ODBC, номер версии"
...
---
# Проверка версии драйвера ODBC для SQL Server (Windows)
...
#### <a name="to-check-the-odbc-sql-server-driver-version-32bit-odbc"></a>Проверка версии драйвера ODBC SQL Server (32-разрядная версия ODBC)  
