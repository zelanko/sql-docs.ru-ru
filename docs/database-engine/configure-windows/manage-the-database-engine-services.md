...
description: Ознакомьтесь со службами, доступными в SQL Server. Узнайте, как запустить диспетчер конфигурации SQL Server, который можно использовать для управления различными службами.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
