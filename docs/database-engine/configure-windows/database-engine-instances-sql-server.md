---
title: "Экземпляры компонента Database Engine (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
## См. также:  
 ...
 [Возможности перекрестного экземпляра компонента Database Engine](../../relational-databases/database-engine-cross-instance-features.md)  
