---
title: "Параметры конфигурации сервера &#171;Server Memory&#187; | Microsoft Docs"
ms.custom: ""
ms.date: "03/02/2017"
...
helpviewer_keywords: 
  ...
  - "max server memory, параметр"
  - "виртуальная память [SQL Server]"
  - "VMM"
  - "параметры памяти сервера [SQL Server]"
  - "серверы [SQL Server], память"
  - "буферный пул [SQL Server]"
  - "min server memory, параметр"
  - "настройка параметров памяти вручную [SQL Server]"
  - "память [SQL Server], серверы"
