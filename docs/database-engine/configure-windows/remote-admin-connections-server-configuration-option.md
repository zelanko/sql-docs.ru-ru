...
description: Поймите, как приложения на удаленных компьютерах могут использовать DAC. Узнайте, как включить эту возможность с помощью параметра remote admin connections хранимой процедуры.
ms.custom: ''
ms.date: 03/02/2017
ms.prod: sql
