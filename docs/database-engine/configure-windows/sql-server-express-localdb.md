...
- Есть учетная запись Azure? Перейдите на [эту страницу](https://azure.microsoft.com/services/virtual-machines/sql-server/), чтобы запустить виртуальную машину с уже установленным SQL Server.
