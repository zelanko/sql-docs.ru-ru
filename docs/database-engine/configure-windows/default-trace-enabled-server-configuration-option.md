...
description: Описание параметра default trace enabled. Сведения о том, как трассировка по умолчанию может помочь в устранении неполадок.
ms.custom: ''
ms.date: 03/02/2017
ms.prod: sql
