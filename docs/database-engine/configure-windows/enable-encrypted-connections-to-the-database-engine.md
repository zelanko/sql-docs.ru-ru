...
2. В диалоговом окне **Свойства протоколов для** _\<имя экземпляра>_ **Свойства** на вкладке **Сертификат** выберите необходимый сертификат из раскрывающегося списка **Сертификат** и нажмите кнопку **ОК**.  
