...
description: Изучите параметр recovery interval. Узнайте, как его значение влияет на частоту выделения SQL Server автоматических контрольных точек для базы данных.
ms.custom: ''
ms.date: 03/02/2017
ms.prod: sql
