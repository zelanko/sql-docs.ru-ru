...
description: Узнайте о расширении буферного пула и его преимуществах, в число которых входит улучшенная пропускная способность ввода-вывода. Ознакомьтесь с рекомендациями по включению этой функции.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
