---
title: "Подключение к SQL Server через прокси-сервер (диспетчер конфигурации SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "12/15/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "удаленный прокси-сервер WinSock"
  - "прокси-сервер RWS"
  - "локальные таблицы адресов (LATs)"
  - "прокси-серверы [SQL Server]"
  - "подключения [SQL Server], прокси-сервер"
  - "прокси-сервер Microsoft [SQL Server]"
  - "локальные таблицы адресов [SQL Server] "
...
##  <a name="a-namessmsprocedurea-using-sql-server-configuration-manager"></a><a name="SSMSProcedure"></a> Использование диспетчера конфигурации SQL Server  
