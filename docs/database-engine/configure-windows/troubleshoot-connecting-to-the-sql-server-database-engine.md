---
title: "Устранение неполадок при соединении с компонентом SQL Server Database Engine | Microsoft Docs"
ms.custom: ""
ms.date: "02/07/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "устранение неполадок, соединение с компонентом Database Engine"
  - "соединение с компонентом Database Engine, устранение неполадок"
...
---
# Устранение неполадок при соединении с компонентом SQL Server Database Engine
...
* В этой статье отсутствуют сведения о подключения к SQL Azure. Справочные сведения см. в статье [Устранение неполадок подключения к базе данных SQL Azure](https://azure.microsoft.com/en-us/documentation/articles/sql-database-troubleshoot-common-connection-issues/). 

## Сбор сведений об экземпляре SQL Server
