...
-  `CREATE OR ALTER <object>` — синтаксис теперь доступен для [процедур](../t-sql/statements/create-procedure-transact-sql.md), [представлений](../t-sql/statements/create-view-transact-sql.md), [функций](../t-sql/statements/create-function-transact-sql.md) и [триггеров](../t-sql/statements/create-trigger-transact-sql.md).
...
-   [Расширения Transact-SQL](#transact-sql-enhancements)
-   [Улучшения системного представления](#system-view-enhancements)
-   [Улучшения в системе безопасности](#security-enhancements)
