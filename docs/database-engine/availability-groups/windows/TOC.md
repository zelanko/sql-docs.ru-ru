...
# [Присоединение базы данных-получатели к группе доступности](join-a-secondary-database-to-an-availability-group-sql-server.md)
...
# [Распределенные группы доступности](distributed-availability-groups-always-on-availability-groups.md)
# [Обновление экземпляров реплики группы доступности AlwaysOn](upgrading-always-on-availability-group-replica-instances.md)
...
# [Доступность репликации не имеет исправной роли](availability-replica-does-not-have-a-healthy-role.md)
# [Страница ввода паролей (мастер добавления реплики)](enter-passwords-page-add-replica-wizard.md)
...
# [Укажите страницу имени группы доступности (мастер создания группы доступности/мастер добавления базы данных)](specify availability group name page.md)
# [Группы доступности AlwaysOn: взаимодействие](always-on-availability-groups-interoperability-sql-server.md)
# [Страница результатов (мастера групп доступности AlwaysOn)](results-page-always-on-availability-group-wizards.md)
...
# [Укажите URL-адрес конечной точки при добавлении или изменении реплики доступности](specify endpoint url - adding or modifying availability replica.md)
# [WSFC служба кластеров работает в режиме вне сети](wsfc-cluster-service-is-offline.md)
...
# [Страница проверки (мастера групп доступности AlwaysOn)](validation-page-always-on-availability-group-wizards.md)
...
# [Экземпляры отказоустойчивого кластера AlwaysOn](always-on-client-connectivity-sql-server.md)
...
# [Транзакции между базами данных и распределенные транзакции для групп доступности AlwaysOn и зеркального отображения базы данных (SQL Server)](transactions - always on availability and database mirroring.md)
...
# [Устранение неполадок с конфигурацией групп доступности AlwaysOn](troubleshoot-always-on-availability-groups-configuration-sql-server.md)
# [Создание группы доступности (Transact-SQL)](create-an-availability-group-transact-sql.md)
# [Состояние синхронизации данных некоторых баз данных доступности не является исправным](data-synchronization-state-of-some-availability-database-is-not-healthy.md)
...
# [Подключение к странице существующих вторичных реплик (мастер добавления реплики: мастер добавления баз данных)](connect to existing secondary replicas page.md)
...
# [Использование мастера добавления базы данных в группу доступности](use-the-add-database-to-availability-group-wizard-sql-server-management-studio.md)
# [Создание и настройка групп доступности](creation-and-configuration-of-availability-groups-sql-server.md)
# [Некоторые реплики доступности не имеют исправной роли](some-availability-replicas-do-not-have-a-healthy-role.md)
...
# [Настройка сжатия для группы доступности](tune-compression-for-availability-group.md)
...
# [Автоматическая инициализация группы доступности Always On](автоматическая-инициализация-группы-доступности-always-on.md)
...
# [Изменение режима отработки отказа для реплики доступности](change-the-failover-mode-of-an-availability-replica-sql-server.md)
...
# [Состояние синхронизации данных баз данных доступности не является исправным](data-synchronization-state-of-availability-database-is-not-healthy.md)
...
# [Выбор страницы начальной синхронизации данных (мастера группы доступности AlwaysOn)](select-initial-data-synchronization-page-always-on-availability-group-wizards.md)
...
# [Укажите страницу реплик (мастер создания группы доступности: мастер добавления реплики)](specify-replicas-page-new-availability-group-wizard-add-replica-wizard.md)
...
# [Добавление базы данных в группу доступности](add-a-database-to-an-availability-group-sql-server.md)
...
# [Основные группы доступности](basic-availability-groups-always-on-availability-groups.md)
# [Группа доступности не готова для автоматического перехода на другой ресурс](availability-group-is-not-ready-for-automatic-failover.md)
# [Необходимые условия для перехода от использования доставки журналов к использованию групп доступности AlwaysOn (SQL Server)](prereqs migrating log shipping to always on availability groups.md)
...
# [Экземпляры отказоустойчивого кластера AlwaysOn](analysis-services-with-always-on-availability-groups.md)
# [Режимы доступности](availability-modes-always-on-availability-groups.md)
# [База данных-получатель не подключена](secondary-database-is-not-joined.md)
...
# [Группа доступности в режиме вне сети](availability-group-is-offline.md)
