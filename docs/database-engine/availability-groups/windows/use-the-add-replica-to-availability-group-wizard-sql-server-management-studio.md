---
title: Добавление реплики в группу доступности с помощью мастера в SSMS — SQL Server
...
> [!IMPORTANT]  
>  После добавления реплики см. подраздел «Дальнейшие действия. После добавления реплики" в статье [Добавление вторичной реплики в группу доступности (SQL Server)](../../../database-engine/availability-groups/windows/add-a-secondary-replica-to-an-availability-group-sql-server.md).  
