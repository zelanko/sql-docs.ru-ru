---
title: "Использование мастера добавления реплики в группу доступности (среда SQL Server Management Studio) | Microsoft Docs"
ms.custom: ""
ms.date: "05/17/2016"
...
-   **Добавление реплики с помощью параметра** [Использование мастера добавления реплики в группу доступности (среда SQL Server Management Studio)](#SSMSProcedure)  
