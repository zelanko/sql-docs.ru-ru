---
title: "Возможные сбои во время сеансов между репликами доступности (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "05/17/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "устранение неполадок [SQL Server, "HADR"]"
...
---
# Возможные сбои во время сеансов между репликами доступности (SQL Server)
...
### Механизм превышения времени ожидания  
