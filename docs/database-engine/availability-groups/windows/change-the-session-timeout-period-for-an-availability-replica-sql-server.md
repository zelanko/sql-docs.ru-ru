---
title: "Изменение периода ожидания сеанса для реплики доступности (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "05/17/2016"
...
helpviewer_keywords: 
  ...
  - "группы доступности [SQL Server], время ожидания сеанса"
  - "время ожидания сеанса [SQL Server]"
