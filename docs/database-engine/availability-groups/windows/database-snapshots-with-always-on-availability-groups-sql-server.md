---
title: "Моментальные снимки баз данных для групп доступности AlwaysOn (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "05/17/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "моментальные снимки баз данных [SQL Server], группы доступности AlwaysOn"
