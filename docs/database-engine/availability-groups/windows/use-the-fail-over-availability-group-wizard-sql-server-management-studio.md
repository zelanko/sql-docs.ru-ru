---
title: "Использование мастера отработки отказа группы доступности (Среда SQL Server Management Studio) | Microsoft Docs"
ms.custom: ""
ms.date: "05/17/2016"
...
helpviewer_keywords: 
  - "переход на другой ресурс [SQL Server], переход на другой ресурс"
  - "группы доступности [SQL Server], мастеры"
...
---
# Использование мастера отработки отказа группы доступности (Среда SQL Server Management Studio)
...
-   **Перед началом работы выполните следующие действия.**  
     ...
     [Необходимые условия для использования мастера отработки отказа группой доступности](#Prerequisites)  
  
     [Безопасность](#Security)  
  
-   **Переход на другой ресурс группы доступности с помощью следующих средств.**  
  
     [Среда SQL Server Management Studio](#SSMSProcedure)  
  
-   **[!INCLUDE[ssAoFoAgWiz](../../../includes/ssaofoagwiz-md.md)] страниц:**  
  
     [Страница "Выбор новой первичной реплики"](#SelectNewPrimaryReplica) (далее в этом разделе)  
  
     [Страница "подключение к реплике"](#ConnectToReplica) (далее в этом разделе)  
  
     [Страниц "Подтверждение возможной потери данных"](#ConfirmPotentialDataLoss) (далее в этом разделе)  
  
     [Страница "Сводка" (мастера групп доступности AlwaysOn)](../../../database-engine/availability-groups/windows/summary-page-always-on-availability-group-wizards.md)  
  
     [Страница "Ход выполнения" (мастера групп доступности AlwaysOn)](../../../database-engine/availability-groups/windows/progress-page-always-on-availability-group-wizards.md)  
  
     [Страница "Результаты" (мастера групп доступности AlwaysOn)](../../../database-engine/availability-groups/windows/results-page-always-on-availability-group-wizards.md)  
...
## Помощь для страниц, которые имеются только в этом мастере  
...
-   [Страница «Подтверждение возможной потери данных»](#ConfirmPotentialDataLoss)  
...
###  <a name="SelectNewPrimaryReplica"></a> Страница «Выбор новой первичной реплики»  
 ...
 **Состояние кворума**  
 Отображает одно из следующих значений состояния кворума WSFC для реплики доступности.  
...
###  <a name="ConfirmPotentialDataLoss"></a> Страниц «Подтверждение возможной потери данных»  
...
#### Параметры на странице «Подтверждение возможной потери данных»  
...
###  <a name="ConnectToReplica"></a> Страница «подключение к реплике»  
