...
description: Как выполнить плановый или принудительный ручной переход группы доступности Always On на другой ресурс с помощью SQL Server Management Studio (SSMS), Transact-SQL (T-SQL) или SQL PowerShell.
