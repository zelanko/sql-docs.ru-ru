...
Группу доступности, независимую от домена, можно использовать не только в многосайтовом развертывании или в сценариях аварийного восстановления. Ее можно развернуть в одном-единственном центре обработки данных, а также использовать с[основной группой доступности](https://msdn.microsoft.com/library/mt614935.aspx) (так называемой группой доступности Standard Edition) для получения такой же архитектуры, которая раньше достигалась путем зеркального отображения базы данных с использованием сертификатов.
