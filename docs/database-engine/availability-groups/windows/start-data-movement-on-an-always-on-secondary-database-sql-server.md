---
title: Запуск перемещения данных в базу данных-получатель
description: Узнайте, как запустить перемещение данных для базы данных-получателя, участвующей в группе доступности Always On на SQL Server.
