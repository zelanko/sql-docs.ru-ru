...
description: Сведения о приостановке перемещения данных для базы данных в группе доступности Always On с помощью SQL Server Management Studio (SSMS), Transact-SQL (T-SQL) или PowerShell.
