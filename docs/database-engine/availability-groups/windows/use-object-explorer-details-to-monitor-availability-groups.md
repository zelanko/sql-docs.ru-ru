...
description: Узнайте, как использовать SQL Server Management Studio для мониторинга существующих групп доступности Always On, реплик доступности и баз данных доступности, а также управления ими.
ms.custom: ''
ms.date: 05/17/2016
ms.prod: sql
ms.reviewer: ''
...
|**синхронизировано;**|База данных синхронизирована с базой данных-источником в текущей первичной реплике, если таковая имеется, либо на последней первичной реплике.<br /><br /> Примечание. В режиме высокой производительности база данных никогда не находится в состоянии "Синхронизировано".|  
...
|Значение|Описание|  
|-----------|-----------------|  
|Синхронизация|База данных-получатель приняла записи журнала транзакций базы данных-источника, которые еще не записаны на диск (не зафиксированы).<br /><br /> Примечание. В режиме асинхронной фиксации состояние синхронизации — всегда **Синхронизировано**.|  
|||  
