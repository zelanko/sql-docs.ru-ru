---
title: "Режимы доступности (группы доступности AlwaysOn) | Microsoft Docs"
ms.custom: ""
ms.date: "05/17/2016"
...
helpviewer_keywords: 
  ...
  - "группы доступности [SQL Server], асинхронная фиксация"
  - "режим доступности с синхронной фиксацией"
  - "группы доступности [SQL Server], синхронная фиксация"
  - "режим доступности с асинхронной фиксацией"
...
-   [Режим доступности с асинхронной фиксацией](#AsyncCommitAvMode)  
  
-   [Режим доступности с синхронной фиксацией](#SyncCommitAvMode)  
