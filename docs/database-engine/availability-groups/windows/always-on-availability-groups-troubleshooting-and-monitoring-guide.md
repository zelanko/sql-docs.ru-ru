...
##  <a name="troubleshooting-scenarios"></a><a name="BKMK_SCENARIOS"></a> Сценарии устранения неполадок  
...
##  <a name="monitoring-availability-groups"></a><a name="BKMK_MONITOR"></a> Мониторинг групп доступности  
