---
title: "Отслеживание групп доступности (Transact-SQL) | Microsoft Docs"
ms.custom: ""
ms.date: "05/17/2016"
...
helpviewer_keywords: 
  ...
  - "Динамические административные представления [SQL Server], группы доступности AlwaysOn"
  ...
  - "представления каталога [SQL Server], группы доступности AlwaysOn"
 ...
 **Имена столбцов [!INCLUDE[ssHADR](../../../includes/sshadr-md.md)]:** replica_id, group_database_id  
 ...
 **Имена столбцов:** group_id, listener_id, dns_name, port, is_conformant, ip_configuration_string_from_cluster  
...
## См. также:  
 ...
 [Мониторинг групп доступности (SQL Server)](../../../database-engine/availability-groups/windows/monitoring-of-availability-groups-sql-server.md)  
