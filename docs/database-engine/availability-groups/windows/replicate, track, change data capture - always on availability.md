---
title: "Репликация, отслеживание изменений, изменение данных и группы доступности AlwaysOn (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "03/23/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "отслеживание изменений [SQL Server], группы доступности AlwaysOn"
  - "система отслеживания измененных данных [SQL Server], группы доступности AlwaysOn"
...
-   [Обзор репликации в группах доступности AlwaysOn](#Overview)  
  
    -   [Перенаправление издателя](#PublisherRedirect)  
  
    -   [Изменения в агентах репликации для поддержки групп доступности AlwaysOn](#Changes)  
  
    -   [Хранимые процедуры поддержки AlwaysOn](#StoredProcs)  
  
    -   [Система отслеживания измененных данных](#CDC)  
  
    -   [Отслеживание изменений](#CT)  
  
-   [Предварительные условия, ограничения и предложения для использования репликации в сочетании с группами доступности AlwaysOn](#Prereqs)  
