---
title: "Использование раздела &#171;Подробности обозревателя объектов&#187; для мониторинга групп доступности (среда SQL Server Management Studio) | Microsoft Docs"
ms.custom: ""
ms.date: "03/23/2017"
...
manager: "jhubbard"
---
# Использование раздела &#171;Подробности обозревателя объектов&#187; для мониторинга групп доступности (среда SQL Server Management Studio)
...
-   **Подробности обозревателя объектов:**  
     ...
     [Подробные сведения о группах доступности](#AvGroupsDetails)  
 ...
 **Роль**  
 Указывает текущую роль реплик доступности: **Первичная** или **Вторичная**. Сведения о ролях [!INCLUDE[ssHADR](../../../includes/sshadr-md.md)] см. в разделе [Обзор групп доступности AlwaysOn (SQL Server)](../../../database-engine/availability-groups/windows/overview-of-always-on-availability-groups-sql-server.md).  
