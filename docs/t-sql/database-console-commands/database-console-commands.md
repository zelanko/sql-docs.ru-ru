...
|||  
|-|-|  
|[КОНТРОЛЬНАЯ ТОЧКА](../../t-sql/language-elements/checkpoint-transact-sql.md)|[KILL STATS JOB](../../t-sql/language-elements/kill-stats-job-transact-sql.md)|  
|[ИНСТРУКЦИЯ DBCC](../../t-sql/database-console-commands/dbcc-transact-sql.md)|[RECONFIGURE](../../t-sql/language-elements/reconfigure-transact-sql.md)|  
|[KILL](../../t-sql/language-elements/kill-transact-sql.md)|[ЗАВЕРШЕНИЕ РАБОТЫ](../../t-sql/language-elements/shutdown-transact-sql.md)|  
