...
Аргумент NOTRUNCATE применим только к файлам данных. NONTRUNCATE не влияет на файл журнала.  
...
Данную ситуацию можно представить и другим способом: 40 процентов желаемого свободного пространства + 70 процентов от полного файла данных (7 МБ из 10 МБ) больше, чем 100 процентов. Любой _целевой\_процент_ больше 30 не приведет к сжатию файла данных. Сжатия не будет, поскольку сумма освобождаемого процента и текущего процента, занятого в файле данных, превышает 100 процентов.
...
-   Операция сжатия наиболее эффективна после выполнения другой операции. Такая операция создает неиспользуемое пространство, например операция усечения или удаления таблицы.  
