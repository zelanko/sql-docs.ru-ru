...
|IsSystemTable|Table|Системная таблица.<br /><br /> 1 = True<br /><br /> 0 = False.<br /><br /> Базовый тип данных: **int**|  
...
|IsTable|Table|Таблица.<br /><br /> 1 = True<br /><br /> 0 = False.<br /><br /> Базовый тип данных: **int**|  
...
|IsUserTable|Table|Пользовательская таблица.<br /><br /> 1 = True<br /><br /> 0 = False.<br /><br /> Базовый тип данных: **int**|  
...
|TableDeleteTrigger|Table|У таблицы есть триггер DELETE.<br /><br /> >1 = идентификатор первого триггера указанного типа.<br /><br /> Базовый тип данных: **int**|  
|TableDeleteTriggerCount|Table|В таблице существует указанное число триггеров типа DELETE.<br /><br /> Не NULL = Число триггеров DELETE.<br /><br /> Базовый тип данных: **int**|  
...
|TableFullTextChangeTrackingOn|Table|**Область применения**: начиная с [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] до [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)].<br /><br /> Для таблицы включено полнотекстовое отслеживание изменений.<br /><br /> 1 = TRUE<br /><br /> 0 = FALSE<br /><br /> Базовый тип данных: **int**|  
...
|TableFullTextSemanticExtraction|Table|**Область применения**: начиная с [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] до [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)].<br /><br /> Таблица поддерживает семантическое индексирование.<br /><br /> 1 = True<br /><br /> 0 = False.<br /><br /> Базовый тип данных: **int**|  
|TableHasActiveFulltextIndex|Table|**Область применения**: начиная с [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] до [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)].<br /><br /> Таблица имеет активный полнотекстовый индекс.<br /><br /> 1 = True<br /><br /> 0 = False.<br /><br /> Базовый тип данных: **int**|  
|TableHasCheckCnst|Table|Таблица имеет ограничение CHECK.<br /><br /> 1 = True<br /><br /> 0 = False.<br /><br /> Базовый тип данных: **int**|  
|TableHasClustIndex|Table|Таблица имеет кластеризованный индекс.<br /><br /> 1 = True<br /><br /> 0 = False.<br /><br /> Базовый тип данных: **int**|  
|TableHasDefaultCnst|Table|Таблица имеет ограничение DEFAULT.<br /><br /> 1 = True<br /><br /> 0 = False.<br /><br /> Базовый тип данных: **int**|  
|TableHasDeleteTrigger|Table|У таблицы есть триггер DELETE.<br /><br /> 1 = True<br /><br /> 0 = False.<br /><br /> Базовый тип данных: **int**|  
|TableHasForeignKey|Table|Таблица имеет ограничение FOREIGN KEY.<br /><br /> 1 = True<br /><br /> 0 = False.<br /><br /> Базовый тип данных: **int**|  
|TableHasForeignRef|Table|На таблицу есть ссылки по ограничению FOREIGN KEY.<br /><br /> 1 = True<br /><br /> 0 = False.<br /><br /> Базовый тип данных: **int**|  
|TableHasIdentity|Table|Таблица содержит столбец идентификаторов.<br /><br /> 1 = True<br /><br /> 0 = False.<br /><br /> Базовый тип данных: **int**|  
|TableHasIndex|Table|Таблица имеет индекс какого-либо типа.<br /><br /> 1 = True<br /><br /> 0 = False.<br /><br /> Базовый тип данных: **int**|  
|TableHasInsertTrigger|Table|Объект имеет триггер INSERT.<br /><br /> 1 = True<br /><br /> 0 = False.<br /><br /> Базовый тип данных: **int**|  
|TableHasNonclustIndex|Table|Таблица содержит некластеризованный индекс:<br /><br /> 1 = True<br /><br /> 0 = False.<br /><br /> Базовый тип данных: **int**|  
|TableHasPrimaryKey|Table|Таблица содержит первичный ключ.<br /><br /> 1 = True<br /><br /> 0 = False.<br /><br /> Базовый тип данных: **int**|  
|TableHasRowGuidCol|Table|Таблица содержит свойство ROWGUIDCOL для столбца **uniqueidentifier**.<br /><br /> 1 = True<br /><br /> 0 = False.<br /><br /> Базовый тип данных: **int**|  
|TableHasTextImage|Table|Таблица содержит столбец **text**, **ntext** или **image**.<br /><br /> 1 = True<br /><br /> 0 = False.<br /><br /> Базовый тип данных: **int**|  
|TableHasTimestamp|Table|Таблица содержит столбец **timestamp**.<br /><br /> 1 = True<br /><br /> 0 = False.<br /><br /> Базовый тип данных: **int**|  
|TableHasUniqueCnst|Table|Таблица имеет ограничение UNIQUE.<br /><br /> 1 = True<br /><br /> 0 = False.<br /><br /> Базовый тип данных: **int**|  
|TableHasUpdateTrigger|Table|Объект содержит триггер UPDATE:<br /><br /> 1 = True<br /><br /> 0 = False.<br /><br /> Базовый тип данных: **int**|  
|TableHasVarDecimalStorageFormat|Table|Для таблицы включен формат хранения **vardecimal**.<br /><br /> 1 = True<br /><br /> 0 = False.|  
|TableInsertTrigger|Table|Таблица содержит триггер INSERT.<br /><br /> >1 = идентификатор первого триггера указанного типа.<br /><br /> Базовый тип данных: **int**|  
|TableInsertTriggerCount|Table|В таблице существует указанное число триггеров типа INSERT.<br /><br /> >0 = количество триггеров INSERT.<br /><br /> Базовый тип данных: **int**|  
|TableIsFake|Table|Таблица реально не существует. Компонент [!INCLUDE[ssDE](../../includes/ssde-md.md)] материализует ее внутренним образом по запросу.<br /><br /> 1 = True<br /><br /> 0 = False.<br /><br /> Базовый тип данных: **int**|  
|TableIsLockedOnBulkLoad|Table|Таблица заблокирована в связи с **bcp** или заданием BULK INSERT.<br /><br /> 1 = True<br /><br /> 0 = False.<br /><br /> Базовый тип данных: **int**|  
...
|TableIsPinned|Table|Таблица закреплена для хранения в кэше данных.<br /><br /> 0 = False.<br /><br /> Эта функция не поддерживается в [!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)] и более поздних версиях.|  
|TableTextInRowLimit|Table|Для таблицы установлен параметр TEXT IN ROW.<br /><br /> > 0 = Максимальная длина текста в строке (в байтах).<br /><br /> 0 = Параметр текста в строке не установлен.<br /><br /> Базовый тип данных: **int**|  
|TableUpdateTrigger|Table|Таблица содержит триггер UPDATE.<br /><br /> > 1 = идентификатор первого триггера указанного типа.<br /><br /> Базовый тип данных: **int**|  
|TableUpdateTriggerCount|Table|В таблице существует указанное число триггеров типа UPDATE.<br /><br /> >0 = количество триггеров UPDATE.<br /><br /> Базовый тип данных: **int**|  
