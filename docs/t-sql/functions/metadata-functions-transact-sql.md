...
|[APPLOCK_TEST](../../t-sql/functions/applock-test-transact-sql.md)|[СЛЕДУЮЩЕЕ ЗНАЧЕНИЕ ДЛЯ](../../t-sql/functions/next-value-for-transact-sql.md)|  
...
|[ИМЯ_ФАЙЛА](../../t-sql/functions/file-name-transact-sql.md)|[SCOPE_IDENTITY](../../t-sql/functions/scope-identity-transact-sql.md)|  
...
|[FILEPROPERTY](../../t-sql/functions/fileproperty-transact-sql.md)|[ФУНКЦИЯ TYPE_NAME](../../t-sql/functions/type-name-transact-sql.md)|  
...
|[FULLTEXTSERVICEPROPERTY](../../t-sql/functions/fulltextserviceproperty-transact-sql.md)|[ВЕРСИЯ](../../t-sql/functions/version-transact-sql-metadata-functions.md)|  
