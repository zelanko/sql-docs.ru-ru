...
## <a name="examples-includesssdwfullincludessssdwfull-mdmd-and-includesspdwincludessspdw-mdmd"></a>Примеры: [!INCLUDE[ssSDWfull](../../includes/sssdwfull-md.md)] и[!INCLUDE[ssPDW](../../includes/sspdw-md.md)]  
 В следующих примерах используется шести системных функций, которые возвращают текущую дату и время для возврата даты и времени. Значения возвращаются последовательно и поэтому могут различаться на доли секунды.  
