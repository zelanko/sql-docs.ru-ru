...
## <a name="remarks"></a>Замечания  
 SWITCHOFFSET используется для приведения **datetimeoffset** к значению смещения часового пояса, отличного от изначального. SWITCHOFFSET не обновляет сохраненное значение.   
