...
*стиль*  
Целочисленное выражение, указывающее, как функцию CONVERT для преобразования *выражение*. Если стиль имеет значение NULL, возвращается NULL. Диапазон определяется *data_type*. Дополнительные сведения см. в разделе «Примечания».
  
## <a name="return-types"></a>Возвращаемые типы
Возвращает *выражение* преобразуется в *data_type*.

[Перейти к 15 примеры в конце этого раздела](#BKMK_examples)
