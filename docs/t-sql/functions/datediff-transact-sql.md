...
Если возвращаемое значение вне допустимого диапазона для **int** (-2147483648 использовать +2,147,483,647), возвращается сообщение об ошибке. Для **миллисекунды**, Максимальная разница между *startdate* и *enddate* — 24 дня, 20 часов, 31 минута и 23,647 секунд. Для **второй**, Максимальная разница составляет 68 лет.
...
## <a name="datepart-boundaries"></a>Границы, указываемые аргументом datepart  
