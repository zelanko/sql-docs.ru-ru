...
ms.locfileid: "66826873"
---
# <a name="set-result-set-caching-transact-sql-applies-to-azure-sql-data-warehouse-gen2-only-preview"></a>SET RESULT SET CACHING (Transact-SQL) (применимо только для хранилища данных SQL Azure 2-го поколения, предварительная версия)
