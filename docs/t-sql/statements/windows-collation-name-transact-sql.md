...
**BIN** — указывает подлежащий использованию двоичный порядок сортировки, применяющийся для обеспечения обратной совместимости.

**BIN2** — определяет двоичный порядок сортировки, использующий семантику сравнения кодовых точек.
