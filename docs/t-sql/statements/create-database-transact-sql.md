...
DIRECTORY_NAME = \<directory_name> **Применимо к**: [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] и более новой версии
...
ELASTIC_POOL (name = \<имя_эластичного_пула>) **Применимо к:** Только отдельные и включенные в пул базы данных. Не применяется к базам данных на уровне служб "Гипермасштабирование".
...
> |||||
> |-|-|-|-|
> |[SQL Server](create-database-transact-sql.md?view=sql-server-2017)| [Отдельная база данных/эластичный пул Базы данных SQL<br />](create-database-transact-sql.md?view=azuresqldb-current)| **_\* Управляемый экземпляр Базы данных SQL<br />\*_** | [Azure Synapse<br />Analytics](create-database-transact-sql.md?view=azure-sqldw-latest) | [Analytics Platform<br />System (PDW)](create-database-transact-sql.md?view=aps-pdw-2016) |
...
[Инструкция ALTER DATABASE в Azure Synapse Analytics](../../t-sql/statements/alter-database-transact-sql.md?view=aps-pdw-2016-au7) позволяет позднее изменить значения максимального размера или целевого уровня службы.
