...
Определяет поведение конкретных баз данных для совместимости с указанной версией [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]. См. дополнительные сведения о [других параметрах ALTER DATABASE](../../t-sql/statements/alter-database-transact-sql.md).
...
|[!INCLUDE[ssSDSfull](../../includes/sssdsfull-md.md)] отдельная база данных/эластичный пул|12|130|150, 140, 130, 120, 110, 100|
...
>
> Если в целом вам требуется уровень 140, но по определенной причине вы предпочитаете модель **оценки кратности** [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)], соответствующую уровню совместимости 110, см. описание [ALTER DATABASE SCOPED CONFIGURATION](../../t-sql/statements/alter-database-scoped-configuration-transact-sql.md) и, в частности, ключевого слова `LEGACY_CARDINALITY_ESTIMATION = ON`.
>
