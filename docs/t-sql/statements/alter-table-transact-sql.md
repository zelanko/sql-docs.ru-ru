...
HISTORY_RETENTION_PERIOD = { **INFINITE** | number {DAY | DAYS | WEEK | WEEKS | MONTH | MONTHS | YEAR | YEARS} } — **применяется к** [!INCLUDE[ssSDSfull](../../includes/sssdsfull-md.md)].
