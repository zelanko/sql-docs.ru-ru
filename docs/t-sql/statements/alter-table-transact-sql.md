...
>  
> Не удается изменить столбец, включенный в ограничение первичного ключа с **NOT NULL** для **NULL**.  
  
Если выполняется изменение столбца, зашифрованные с помощью `ENCRYPTED WITH`, можно изменить тип данных в совместимый тип данных (такие как INT в BIGINT), но не может изменить любые параметры шифрования.  
...
-   `ALTER COLUMN … ADD/DROP PERSISTED`не поддерживается для сети.  
  
-   `ALTER COLUMN … ADD/DROP ROWGUIDCOL/NOT FOR REPLICATION`не затрагивается сети alter столбца.  
 ...
 **Применяется к**: [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] через [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] и [!INCLUDE[ssSDSfull](../../includes/sssdsfull-md.md)].  
 ...
 Переопределяет **максимальная степень параллелизма** параметр конфигурации только во время обработки. Дополнительные сведения см. в разделе [Настройка параметра конфигурации сервера max degree of parallelism](../../database-engine/configure-windows/configure-the-max-degree-of-parallelism-server-configuration-option.md).  
 ...
 **Применяется к**: [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] через [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] и [!INCLUDE[ssSDSfull](../../includes/sssdsfull-md.md)].  
 ...
 SWITCH [СЕКЦИИ *source_partition_number_expression* ] TO [ *schema_name ***.* *] *target_table* [СЕКЦИИ *target_partition_number_expression* ]  
 **Применяется к**: [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] через [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] и [!INCLUDE[ssSDSfull](../../includes/sssdsfull-md.md)].  
...
```    
**Применяется к**: [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)].  
...
## <a name="examples-includesssdwfullincludessssdwfull-mdmd-and-includesspdwincludessspdw-mdmd"></a>Примеры: [!INCLUDE[ssSDWfull](../../includes/sssdwfull-md.md)] и[!INCLUDE[ssPDW](../../includes/sspdw-md.md)]  
 Следующие примеры A, C помощью `FactResellerSales` в таблицу [!INCLUDE[ssawPDW](../../includes/ssawpdw-md.md)] базы данных.  
...
### <a name="f-using-switch-to-move-a-partition-to-a-history-table"></a>Е. Перемещение секции в таблицу журнала с помощью КОММУТАТОРА  
