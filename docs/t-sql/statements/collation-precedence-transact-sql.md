---
title: "Очередность параметров сортировки (Transact-SQL) | Документы Microsoft"
ms.custom: 
ms.date: 03/15/2017
...
-   Преобразование кодовой страницы для **текст** типы данных не допускаются. Не удается привести **текст** выражение параметров сортировки в другие, если они имеют разные кодовые страницы. Нельзя пользоваться оператором присвоения для двух текстовых операндов, имеющих различные кодовые страницы в параметрах сортировки.  
