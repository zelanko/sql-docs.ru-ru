 ...
 *n*  
 ...
 Дополнительные сведения см, подключен ленточный накопитель. в разделе [Backup Devices &#40;SQL Server&#41;](../../relational-databases/backup-restore/backup-devices-sql-server.md), подключен ленточный накопитель.  
