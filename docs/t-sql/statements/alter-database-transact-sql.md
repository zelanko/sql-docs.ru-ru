...
**Применимо к:** уровень производительности "Оптимизация под гибкость"

Максимально допустимый размер базы данных. Размер базы данных не может превышать MAXSIZE.

**Применимо к:** уровень производительности "Оптимизация под вычисление"
...
SERVICE_OBJECTIVE — определяет уровень производительности. Дополнительные сведения о целевых уровнях служб для [!INCLUDE[ssSDW_md](../../includes/sssdw-md.md)] см. на странице [Уровни производительности](https://azure.microsoft.com/documentation/articles/performance-tiers/).
