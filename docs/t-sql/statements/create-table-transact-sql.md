...
Создает новую таблицу FileTable. Нет необходимости указывать столбцы, так как таблица FileTable имеет фиксированное схему. Дополнительные сведения о таблицах FileTable см. в [этой статье](../../relational-databases/blob/filetables-sql-server.md).
...
Дополнительные сведения о предложении COLLATE см. в [этой статье](~/t-sql/statements/collations.md).
