...
> [!NOTE]
> Параметрами сортировки сервера для управляемого экземпляра базы данных SQL Azure являются **SQL_Latin1_General_CP1_CI_AS**, и их нельзя изменить.
