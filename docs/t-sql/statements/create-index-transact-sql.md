...
Создает реляционный индекс для таблицы или представления. Также называется индекс rowstore, так как он является либо кластеризованный или некластеризованный индекс сбалансированного дерева. До появления данных в таблице, можно создать индекс rowstore. Используйте индекс rowstore для повышения производительности запросов, особенно в том случае, если запросы выбрать определенные столбцы или требуются значения должны быть отсортированы в определенном порядке.  
  
> [!NOTE]  
> [!INCLUDE[ssSDW](../../includes/sssdw-md.md)]и [!INCLUDE[ssPDW](../../includes/sspdw-md.md)] в настоящее время не поддерживает ограничения уникальности. Примеры, любые ссылки на ограничения уникальности применимы только к [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] и [!INCLUDE[ssSDS](../../includes/sssds-md.md)].    
...
-   Начиная с [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] и [!INCLUDE[ssSDS](../../includes/sssds-md.md)], с помощью некластеризованного индекса для индекса columnstore для повышения производительности запросов хранилища данных. Дополнительные сведения см. в разделе [индексы Columnstore - хранилище данных](../../relational-databases/indexes/columnstore-indexes-data-warehouse.md).  
...
Создание индекса, задающего логическое упорядочение для таблицы. Логический порядок строк в некластеризованном индексе не влияет на их физический порядок.  
 ...
 Если не указано иное, по умолчанию тип индекса — НЕКЛАСТЕРИЗОВАННЫЙ.  
...
> [!NOTE]  
> Параллельные операции с индексами доступны не во всех выпусках [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]. Список функций, поддерживаемых различными выпусками [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)], в разделе [выпуски и поддерживаемые функции для SQL Server 2016](../../sql-server/editions-and-supported-features-for-sql-server-2016.md) и [выпуски и поддерживаемые функции для 2017 г. SQL Server](../../sql-server/editions-and-components-of-sql-server-2017.md).  
...
-   Rowstore кластеризованный или некластеризованный индекс, в таблице хранилища данных, когда индекс columnstore уже существует. Это поведение отличается от SMP [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] разрешающее индексы rowstore и columnstore в одной таблице могут существовать.  
...
## <a name="version-notes"></a>Заметки о версии  
 [!INCLUDE[ssSDS](../../includes/sssds-md.md)]не поддерживает параметры файловой группы и filestream.  
