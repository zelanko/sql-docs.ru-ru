...
\<файл_или_группа_файлов > [ **,**...  *n*  ] Определяет файл базы данных или файловой группы для включения в резервную копию файлов используется только с инструкцией BACKUP DATABASE, или указывает только для чтения файла или файловой группы, включаемые в частичную резервную копию.  
