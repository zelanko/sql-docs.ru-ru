 ...
 *select_stmt*  
 ...
 ORDER (\<order_clause>) Указывает порядок, в котором возвращаются результаты из функции с табличным значением. Дополнительные сведения см. в подразделе «Руководство по использованию порядка сортировки» далее в этом разделе.  
