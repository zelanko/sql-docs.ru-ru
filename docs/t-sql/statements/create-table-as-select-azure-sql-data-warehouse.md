---
description: CREATE TABLE AS SELECT (хранилище данных SQL Azure)
title: CREATE TABLE AS SELECT (хранилище данных SQL Azure) | Документы Майкрософт
ms.custom: ''
ms.date: 10/07/2016
...
> [!NOTE]  
> Поскольку с помощью CTAS можно создавать таблицы, в этом разделе мы не будем повторять содержимое раздела CREATE TABLE. Вместо этого мы опишем различия между инструкциями CTAS и CREATE TABLE. Сведения об инструкции CREATE TABLE см. в разделе [Инструкция CREATE TABLE (хранилище данных SQL Azure)](https://msdn.microsoft.com/library/mt203953/). 
...
Дополнительные сведения и инструкции по выбору столбца распределения см. в подразделе [Параметры распределения таблицы](https://msdn.microsoft.com/library/mt203953/#TableDistributionOptions) раздела, посвященного инструкции CREATE TABLE. 
...
Дополнительные сведения см. в подразделе [Параметры секционирования таблицы](https://msdn.microsoft.com/library/mt203953/#TablePartitionOptions) раздела, посвященного инструкции CREATE TABLE.
...
Разрешения на создание таблицы см. в подразделе [Разрешения](https://msdn.microsoft.com/library/mt203953/#Permissions) раздела, посвященного инструкции CREATE TABLE. 
  
<a name="general-remarks-bk"></a>
  
## <a name="general-remarks"></a>Общие замечания
Дополнительные сведения см. в подразделе [Общие замечания](https://msdn.microsoft.com/library/mt203953/#GeneralRemarks) раздела, посвященного инструкции CREATE TABLE.
...
## <a name="locking-behavior"></a>Режим блокировки  
 Дополнительные сведения см. в подразделе [Режим блокировки](https://msdn.microsoft.com/library/mt203953/#LockingBehavior) раздела, посвященного инструкции CREATE TABLE.
...
В этом примере используется образец базы данных AdventureWorksDW. Чтобы загрузить версию хранилища данных SQL, обратитесь к разделу [Пример загрузки данных в хранилище данных SQL](https://azure.microsoft.com/documentation/articles/sql-data-warehouse-load-sample-databases/).
...
Поскольку хранилище данных SQL не поддерживает соединения ANSI в предложении `FROM` инструкции `UPDATE`, потребуется немного изменить этот код SQL Server.
...
## <a name="see-also"></a>См. также:  
 ...
 [CREATE TABLE (хранилище данных SQL Azure)](../../t-sql/statements/create-table-azure-sql-data-warehouse.md) [DROP TABLE (Transact-SQL)](../../t-sql/statements/drop-table-transact-sql.md)   
