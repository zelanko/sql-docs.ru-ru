...
Создайте элемент метаданных главного ключа столбца для главного ключа столбца. Главный ключа столбца сохраняется в пользовательском хранилище главных ключей столбцов.  
