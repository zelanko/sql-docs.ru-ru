...
> [!IMPORTANT]
> База данных SQL Azure не поддерживает чтение данных из файлов Windows, но позволяет читать их из хранилища больших двоичных объектов Azure.
