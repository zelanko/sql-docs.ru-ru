...
:::row:::
    ...
    :::column-end:::
    :::column:::
        [База данных SQL](alter-login-transact-sql.md?view=azuresqldb-current)
    :::column-end:::
    :::column:::
        [База данных SQL<br /> — управляемый экземпляр](alter-login-transact-sql.md?view=azuresqldb-mi-current)
    :::column-end:::
    :::column:::
