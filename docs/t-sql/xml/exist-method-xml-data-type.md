...
### <a name="example-specifying-the-exist-method-against-a-typed-xml-variable"></a>Пример: применение метода exist() по отношению к типизированной переменной xml  
...
### <a name="example-specifying-the-exist-method-against-an-xml-type-column"></a>Пример: применение метода exist() по отношению к столбцу типа xml  
