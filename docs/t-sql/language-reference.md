...
- [SQL Operations Studio (предварительная версия)](https://docs.microsoft.com/sql/sql-operations-studio/download).  
...
Справку в Интернете ищите на [форуме MSDN по Transact-SQL](http://social.msdn.microsoft.com/Forums/en-US/home?forum=transactsql).  
