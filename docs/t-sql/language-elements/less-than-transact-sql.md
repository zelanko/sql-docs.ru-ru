---
title: "&lt;(Меньше) (Transact-SQL) | Документы Microsoft"
ms.custom: 
ms.date: 03/13/2017
...
### <a name="b-using--to-compare-two-variables"></a>Б. С помощью < для сравнения двух переменных  
