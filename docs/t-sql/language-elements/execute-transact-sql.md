...
|Термин|Определение|  
|----------|----------------|  
|{<br /><br /> column_name<br /><br /> Тип данных<br /><br /> [ COLLATE collation_name]<br /><br /> [NULL &#124; NOT NULL]<br /><br /> }|См. в следующей таблице.|  
...
|имя_таблицы &#124; view_name &#124; table_valued_function_name|Указывает, что будут возвращены столбцы, указанные в таблице, представлении или возвращающей табличное значение функции. Табличные переменные, временные таблицы и синонимы не поддерживаются синтаксисом объектов AS.|  
