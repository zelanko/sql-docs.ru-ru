...
## <a name="remarks"></a>Remarks  
 ...
 Каждая инструкция WAITFOR имеет связанный с ней поток. Если на одном сервере задано множество инструкций WAITFOR, многие потоки могут застревать, ожидая выполнения этих инструкций. [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] отслеживает число потоков инструкций WAITFOR и случайным образом завершает работу некоторых из этих потоков, если на сервере начинает не хватать для них ресурсов.  
