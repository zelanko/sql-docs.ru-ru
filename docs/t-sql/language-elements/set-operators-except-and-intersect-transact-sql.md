---
title: "EXCEPT и INTERSECT (Transact-SQL) | Документы Microsoft"
ms.custom: 
ms.date: 03/16/2017
...
## <a name="arguments"></a>Аргументы  
 ...
 Спецификация запроса или выражение не может возвращать **xml**, **текст**, **ntext**, **изображение**, или недвоичные столбцов определяемого пользователем типа данных CLR так как эти типы данных не являются сравнимыми.  
  
 EXCEPT  
 Возвращает все уникальные значения из запроса слева от оператора EXCEPT, которые не возвращены в результатах выполнения правого запроса.  
...
3.  Операторы EXCEPT и UNION обрабатываются слева направо в соответствии с их позицией в выражении.  
 ...
 При отображении операции EXCEPT с помощью средства графического отображения плана в [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)], операция представляется как [левое антиполусоединение](../../relational-databases/showplan-logical-and-physical-operators-reference.md), и операция INTERSECT отображается в виде [левое полусоединение](../../relational-databases/showplan-logical-and-physical-operators-reference.md).  
