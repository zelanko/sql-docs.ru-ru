...
Типы точных числовых данных, использующие целые значения. Для экономии места в базе данных, используйте наименьший тип данных, надежно может содержать все возможные значения. Например так как ни один живет быть более 255 лет tinyint будет достаточно для возраст человека. Однако поскольку здания может быть более 255 лет tinyint не будет достаточно для построения возраста.
