...
```  
 ...
 Преобразование в **date** завершается сбоем, и появляется сообщение об ошибке 206: "Конфликт типов операндов: тип date несовместим с типом time".  
