...
- Для минимизации проблем с преобразованием символов рекомендуем использовать типы данных Юникода **nchar** или **nvarchar** (если используется более ранняя версия [!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)]).   

Если вы используете **char** или **varchar**, мы рекомендуем:
- использовать **char**, если размеры записей данных в столбцах одинаковые;  
- использовать **varchar**, если размеры записей данных в столбцах существенно отличаются;  
