...
## <a name="interoperability"></a>Совместимость  
 ...
 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] позволяет обновлять строки через представления. Так как в определение представления может быть включено предложение TOP, определенные строки могут исчезнуть из представления из-за обновления, если строки больше не соответствуют требованиям выражения TOP.  
