...
*WITH_RECOMMENDATIONS* возвращает план запроса с рекомендациями по оптимизации производительности инструкции SQL.  
...
**Пример выходных данных для EXPLAIN WITH_RECOMMENDATIONS** (предварительная версия)
