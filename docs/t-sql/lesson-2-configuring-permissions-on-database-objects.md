---
title: "Занятие 2: Настройка разрешений на объекты базы данных | Документы Microsoft"
ms.custom: 
ms.date: 03/01/2017
