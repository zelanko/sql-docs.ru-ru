---
title: "STPolyFromText (тип данных geography) | Документы Microsoft"
ms.custom: 
ms.date: 07/30/2017
 ...
 *polygon_tagged_text*  
 Является WKT-представление **geographyPolygon** экземпляр, который необходимо вернуть. *polygon_tagged_text* — **nvarchar(max)** выражение.  
