...
ms.locfileid: "65938056"
---
# <a name="extended-static-geometry-methods"></a>Расширенные статические геометрические методы
[!INCLUDE[tsql-appliesto-ss2008-asdb-xxxx-xxx-md](../../includes/tsql-appliesto-ss2008-asdb-xxxx-xxx-md.md)]

  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] поддерживает несколько расширений для статических геометрических методов консорциума OGC.  
