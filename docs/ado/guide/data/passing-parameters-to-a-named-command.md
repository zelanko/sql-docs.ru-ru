...
```  
 ...
 Обратите внимание на то, что все входные параметры должны указываться до любой выходной переменной, и типы данных параметров должны совпадать, или может быть преобразован в те из соответствующих полей. Следующая инструкция:  
