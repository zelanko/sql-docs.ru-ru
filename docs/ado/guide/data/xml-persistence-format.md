...
```  
 ...
 Определения схемы соответствуют [спецификации W3C XML-данных](https://www.w3.org/TR/1998/NOTE-XML-data/) и могут быть полностью проверены (Хотя проверка не будет выполнена в Internet Explorer 5). XML-данных в настоящее время является форматом только поддерживаемые схемы сохраняемости набора записей.  
