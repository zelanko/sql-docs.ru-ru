...
|Номер|Константа Еррорвалуинум|Описание/возможные причины|
|------------|-----------------------------|----------------------------------|
...
|**3220**|**адерркантчанжепровидер**|Указанный поставщик отличается от того, который уже используется.|
...
|**3705**|**адерробжектопен**|Операция не разрешена, если объект открыт. Открытый объект не может быть открыт. Поля не могут быть добавлены к открытому **набору записей**.|
