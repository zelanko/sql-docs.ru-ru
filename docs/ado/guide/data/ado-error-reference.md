...
|**3727**|**adErrURLDoesNotExist**|Либо исходный URL-адрес, либо родительский объект URL-адреса назначения не существует. Опечатка в URL-адресе источника или назначения. Возможно, у `https://mysite/photo/myphoto.jpg` вас есть `https://mysite/photos/myphoto.jpg` необходимость. Сообщение об ошибке в родительском URL-адресе (в *photo* данном случае Photo *вместо Photos)* вызвало ошибку.|
