...
Поставщики данных представляют различные источники данных, такие как базы данных SQL, индексированные последовательные файлы, электронные таблицы, хранилища документов и файлы почты. Поставщики предоставляют данные единообразно, используя общую абстракцию, которая называется набором строк.  
 ...
 Например, возможности и возможности поставщика OLE DB для SQL Server, который используется для доступа к базам данных Microsoft SQL Server, значительно отличается от поставщика Microsoft OLE DB для публикации в Интернете, который используется для доступа к файлу. сохраняет на веб-сервере.
