...
-   [Определение режима редактирования](../../../ado/guide/data/determining-edit-mode.md)

-   [С помощью AddNew в интерпретации и пакетного режима](../../../ado/guide/data/using-addnew-in-immediate-and-batch-modes.md)
