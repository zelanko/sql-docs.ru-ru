...
|\<exp поле >|(\<relation-exp>) &#124;<br /><br /> \<вычисляется exp >&#124;<br /><br /> \<aggregate-exp> &#124;<br /><br /> \<новый exp >|  
...
|\<aggregate-exp>|SUM (\<полное поле имя->)&#124;<br /><br /> AVG (\<полное поле имя->)&#124;<br /><br /> MIN (\<полное поле имя->)&#124;<br /><br /> MAX (\<полное поле имя->)&#124;<br /><br /> COUNT(\<qualified-alias> &#124; \<qualified-name>) &#124;<br /><br /> STDEV (\<полное поле имя->)&#124;<br /><br /> ЛЮБОЙ (\<полное поле имя->)|  
