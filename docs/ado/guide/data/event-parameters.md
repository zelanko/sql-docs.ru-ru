...
|-----------|-----------------|  
|**адстатусок**|Передается обоим событиям. Это значение означает, что операция, вызвавшая событие, завершилась успешно.|  
|**адстатусеррорсоккурред**|Передается только для завершения событий. Это значение означает, что операция, вызвавшая событие, завершилась неудачно или событие будет отменено операцией. Дополнительные сведения см. в параметре *ошибки* .|  
