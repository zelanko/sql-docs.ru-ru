...
|Часть|Description|  
|----------|-----------------|  
|**соединиться**|Литеральная строка, которая изменяет строку подключения.|  
...
|**параметры**|Литеральная строка, используемая, если идентификатор не указан или не найден.|  
