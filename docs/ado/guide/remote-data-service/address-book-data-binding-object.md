...
|Параметр|Описание|  
|---------------|-----------------|  
|[СЕРВЕР](../../../ado/reference/rds-api/server-property-rds.md)|При использовании HTTP, значением является имя компьютера сервера, предшествует `http://`.|  
