...
|---------------|-----------------|
|**Маркер окна**|Указывает описатель окна, используемый для запроса дополнительных сведений.|
...
|**Предупреждение**|Указывает, следует ли запрашивать пользователя во время установки соединения.|
