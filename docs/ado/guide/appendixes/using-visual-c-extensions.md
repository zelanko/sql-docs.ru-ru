...
## <a name="binding-entry-macros"></a>Макросы записи привязки
 ...
 Дополнительные сведения см. в разделе [типы данных о приложении](https://msdn.microsoft.com/e3a0533a-2196-4eb0-a31e-92fe9556ada6), ссылки на программиста OLE DB.
