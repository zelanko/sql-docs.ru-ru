---
title: Обновлено - ADO для документации по SQL Server | Документы Microsoft
description: Отображение фрагментов обновленное содержимое для последних измененных в документации, для объектов данных ActiveX (ADO) для Microsoft SQL Server.
manager: craigg
author: MightyPen
ms.author: genemi
ms.topic: article
...
ms.locfileid: "32435485"
---
# <a name="new-and-recently-updated-activex-data-objects-ado-for-sql-server"></a>Новые и недавно обновленные: объекты данных ActiveX (ADO) для SQL Server
...
- *Предметной области:* &nbsp; **объектов данных ActiveX (ADO) для SQL Server**.
