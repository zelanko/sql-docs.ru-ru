...
> [!NOTE]
> ADO.NET отличается от ADO. Обсуждается начиная с ADO.NET и многие другие драйверы подключения SQL и им подобных языков [драйверы SQL Server](../connect/sql-connection-libraries.md).
