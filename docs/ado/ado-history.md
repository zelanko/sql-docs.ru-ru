...
В междоменной работе со скриптами с ненадежных сайтов отключены следующие операции: **Stream.SaveToFile**, **Stream.LoadFromFile**, **Recordset.Save** и **Recordset.Open**. Они используются в сочетании с флагом **adCmdFile** или с поставщиком сохраняемости Microsoft OLE DB (MSPersist).
