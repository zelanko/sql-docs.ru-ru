---
title: "Поместите объект свойства, методы и события | Документы Microsoft"
...
---
# <a name="position-object-properties-methods-and-events"></a>Поместите объект свойства, методы и события
## <a name="propertiescollections"></a>Свойства и коллекции  
 [Элементы коллекции](../../../ado/reference/ado-md-api/members-collection-ado-md.md)  
  
 [Порядковый номер свойства (позиция)](../../../ado/reference/ado-md-api/ordinal-property-ado-md-position.md)  
