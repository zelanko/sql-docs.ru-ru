...
-   Определить **оси** с [имя](../../../ado/reference/ado-md-api/name-property-ado-md.md) свойства.  
  
-   Итерации каждой позиции по **оси** с помощью [позиций](../../../ado/reference/ado-md-api/positions-collection-ado-md.md) коллекции.  
