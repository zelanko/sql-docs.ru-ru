---
title: "Измерение объекта свойства, методы и события | Документы Microsoft"
...
---
# <a name="dimension-object-properties-methods-and-events"></a>Свойства объекта измерения, методы и события
