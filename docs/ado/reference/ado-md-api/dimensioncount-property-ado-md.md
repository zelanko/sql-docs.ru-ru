---
title: Свойство DimensionCount (ADO MD) | Документы Microsoft
ms.prod: sql
...
ms.locfileid: "35283973"
---
# <a name="dimensioncount-property-ado-md"></a>Свойство DimensionCount (ADO MD)
Показывает число измерений в [оси](../../../ado/reference/ado-md-api/axis-object-ado-md.md).  
