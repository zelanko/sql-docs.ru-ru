---
title: Пример CubeDef (VBScript) | Документы Microsoft
ms.prod: sql
...
ms.locfileid: "35283563"
---
# <a name="cubedef-example-vbscript"></a>Пример CubeDef (VBScript)
Этот пример отображает метаданные куба на веб-странице.  
