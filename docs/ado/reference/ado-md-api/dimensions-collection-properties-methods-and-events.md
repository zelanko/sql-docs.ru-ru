---
title: "Измерения в коллекции свойства, методы и события | Документы Microsoft"
...
---
# <a name="dimensions-collection-properties-methods-and-events"></a>Свойства коллекции измерений, методы и события
