---
title: Коллекция CubeDefs (многомерные Объекты ADO) | Документация Майкрософт
ms.prod: sql
...
ms.locfileid: "63226111"
---
# <a name="cubedefs-collection-ado-md"></a>Коллекция CubeDefs (многомерные объекты ADO)
Содержит [CubeDef](../../../ado/reference/ado-md-api/cubedef-object-ado-md.md) объекты, представляющие куба из многомерной каталога.  
  
## <a name="remarks"></a>Примечания  
 **CubeDefs** является стандартной коллекции ADO. С помощью свойства и методы коллекции сделайте следующее:  
