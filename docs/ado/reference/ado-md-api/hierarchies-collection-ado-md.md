---
title: Коллекция hierarchies (многомерные Объекты ADO) | Документация Майкрософт
ms.prod: sql
...
ms.locfileid: "66709227"
---
# <a name="hierarchies-collection-ado-md"></a>Коллекция Hierarchies (многомерные объекты ADO)
Содержит набор [иерархии](../../../ado/reference/ado-md-api/hierarchy-object-ado-md.md) объекты из измерения.  
  
## <a name="remarks"></a>Примечания  
 **Иерархии** является стандартной коллекции ADO. С помощью свойства и методы коллекции сделайте следующее:  
