---
title: Свойство ParentSameAsPrev (многомерные Объекты ADO) | Документация Майкрософт
ms.prod: sql
...
ms.locfileid: "66708730"
---
# <a name="parentsameasprev-property-ado-md"></a>Свойство ParentSameAsPrev (многомерные объекты ADO)
Указывает ли родительский этой позиции [член](../../../ado/reference/ado-md-api/member-object-ado-md.md) же родителем непосредственно предшествующего элемента.  
