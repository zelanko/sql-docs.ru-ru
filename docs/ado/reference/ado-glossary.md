...
## <a name="c"></a>C  
 ...
 COM-компонент  
 Двоичный файл, например .dll, .ocx и некоторые файлы .exe —, поддерживающий стандарт COM для создания объектов. Такой файл содержит код для один или несколько фабрик классов, COM-классов, механизмы запись реестра, загрузки кода и т. д.  
