---
title: Свойства, методы и события коллекции Tables | Документация Майкрософт
ms.prod: sql
...
## <a name="methods"></a>Методы  
 [Метод Append (таблицы)](../../../ado/reference/adox-api/append-method-adox-tables.md)  
