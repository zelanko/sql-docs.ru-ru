---
title: Коллекции ADOX | Документы Microsoft
ms.prod: sql
...
|||  
|-|-|  
|[Столбцы](../../../ado/reference/adox-api/columns-collection-adox.md)|Содержит все **столбца** объекты из таблицы, индекса или ключа.|  
...
|[Процедуры](../../../ado/reference/adox-api/procedures-collection-adox.md)|Содержит все **процедура** объектов каталога.|  
