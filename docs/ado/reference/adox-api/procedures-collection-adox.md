---
title: Коллекция процедур (ADOX) | Документы Microsoft
ms.prod: sql
...
-   Возвращает число процедур, содержащихся в коллекции с [число](../../../ado/reference/ado-api/count-property-ado.md) свойство.  
