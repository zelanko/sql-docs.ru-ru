---
title: Примеры кода ADOX | Документы Microsoft
ms.prod: sql
...
ms.locfileid: "35284699"
---
# <a name="adox-code-examples"></a>Примеры кода ADOX
Позволяет в следующих примерах кода демонстрируется использование ADOX объекты, методы, свойства и события.  
...
-   [Примеры кода ADOX в Microsoft Visual Basic](../../../ado/reference/adox-api/adox-code-examples-in-microsoft-visual-basic.md)  
