---
title: Индексы в коллекции свойства, методы и события | Документы Microsoft
ms.prod: sql
...
## <a name="methods"></a>Методы  
 [Append-метод (индексы)](../../../ado/reference/adox-api/append-method-adox-indexes.md)  
