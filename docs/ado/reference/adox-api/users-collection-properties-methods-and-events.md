---
title: "Свойства коллекции пользователей, методы и события | Документы Microsoft"
...
---
# <a name="users-collection-properties-methods-and-events"></a>Свойства коллекции пользователей, методы и события
...
## <a name="methods"></a>Методы  
 [Append-метод (пользователей)](../../../ado/reference/adox-api/append-method-adox-users.md)  
