---
title: Свойства коллекции столбцов, методы и события | Документы Microsoft
ms.prod: sql
...
ms.locfileid: "35285303"
---
# <a name="columns-collection-properties-methods-and-events"></a>Свойства коллекции столбцов, методы и события
