---
title: Свойства, методы и события коллекции Columns | Документация Майкрософт
ms.prod: sql
...
## <a name="methods"></a>Методы  
 [Метод Append (столбцы)](../../../ado/reference/adox-api/append-method-adox-columns.md)  
