---
title: Ключи коллекции свойства, методы и события | Документация Майкрософт
ms.prod: sql
...
## <a name="methods"></a>Методы  
 [Append-метод (ключи)](../../../ado/reference/adox-api/append-method-adox-keys.md)  
