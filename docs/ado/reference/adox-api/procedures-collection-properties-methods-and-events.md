---
title: Процедуры свойств коллекции, методы и события | Документы Microsoft
ms.prod: sql
...
ms.locfileid: "35286643"
---
# <a name="procedures-collection-properties-methods-and-events"></a>Процедуры свойств коллекции, методы и события
...
## <a name="methods"></a>Методы  
 [Append-метод (процедуры)](../../../ado/reference/adox-api/append-method-adox-procedures.md)  
