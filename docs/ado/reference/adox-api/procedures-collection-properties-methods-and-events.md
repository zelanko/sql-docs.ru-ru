---
title: Процедуры свойства, методы и события коллекции | Документация Майкрософт
ms.prod: sql
...
## <a name="methods"></a>Методы  
 [Append-метод (процедур)](../../../ado/reference/adox-api/append-method-adox-procedures.md)  
