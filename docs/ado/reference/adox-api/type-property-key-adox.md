...
## <a name="settings-and-return-values"></a>Параметры и возвращаемые значения  
 Задает или возвращает **длинное** значение, которое может быть одной из констант [кэйтипинум](../../../ado/reference/adox-api/keytypeenum.md) . Значение по умолчанию — **адкэйпримари**.  
