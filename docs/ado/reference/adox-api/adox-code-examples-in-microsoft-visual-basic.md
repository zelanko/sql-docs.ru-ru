...
-   [Свойство Command, пример коллекции Parameters (Visual Basic)](./parameters-collection-command-property-example-vb.md)  
  
-   [Пример свойства CommandText, Коллекция Views (Visual Basic)](./views-collection-commandtext-property-example-vb.md)  
...
-   [Примеры типа ключа, RelatedColumn, RelatedTable и UpdateRule, пример метода Append для ключей (Visual Basic)](./keys-append-method-key-type-relatedcolumn-relatedtable-example-vb.md)  
  
-   [Пример свойств Name, Columns и Tables Append (Visual Basic)](./columns-and-tables-append-methods-name-property-example-vb.md)  
  
-   [Примеры свойств NumericScale и Precision (VB)](./adox-code-example-numericscale-and-precision-properties-example-vb.md)  
...
-   [Свойство типа таблицы, метод Close для соединения, пример (VB)](./connection-close-method-table-type-property-example-vb.md)  
