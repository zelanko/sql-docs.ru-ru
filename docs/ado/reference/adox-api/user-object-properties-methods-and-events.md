---
title: Свойства объекта пользователя, методы и события | Документация Майкрософт
ms.prod: sql
...
ms.locfileid: "66705638"
---
# <a name="user-object-properties-methods-and-events"></a>Свойства, методы и события объекта User
