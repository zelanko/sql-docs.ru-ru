---
title: Команда и пример свойства CommandText (VB) | Документы Microsoft
ms.prod: sql
...
ms.locfileid: "35285323"
---
# <a name="command-and-commandtext-properties-example-vb"></a>Команда и пример свойства CommandText (Visual Basic)
