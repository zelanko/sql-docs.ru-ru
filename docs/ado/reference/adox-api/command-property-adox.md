---
title: "Свойства (ADOX) команды | Документы Microsoft"
...
---
# <a name="command-property-adox"></a>Свойство команды (ADOX)
...
## <a name="remarks"></a>Замечания  
 Произошла ошибка при получении и задании этого свойства, если поставщик не поддерживает сохранение команды.  
  
## <a name="applies-to"></a>Объект применения  
  
|||  
|-|-|  
|[Объект процедуры (ADOX)](../../../ado/reference/adox-api/procedure-object-adox.md)|[Объект представления (ADOX)](../../../ado/reference/adox-api/view-object-adox.md)|  
