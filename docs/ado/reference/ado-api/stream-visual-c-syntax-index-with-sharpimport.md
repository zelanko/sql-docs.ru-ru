---
title: 'Поток (Visual C++ синтаксис индекс с #import) | Документы Microsoft'
ms.prod: sql
...
ms.locfileid: "35282543"
---
# <a name="stream-visual-c-syntax-index-with-import"></a>Поток (Visual C++ синтаксис индекс с #import)
