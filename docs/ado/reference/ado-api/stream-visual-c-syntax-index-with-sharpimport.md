---
title: 'Stream (индекс синтаксиса Visual C++ с #import) | Документация Майкрософт'
ms.prod: sql
...
ms.locfileid: "67930681"
---
# <a name="stream-visual-c-syntax-index-with-import"></a>Stream (индекс синтаксиса Visual C++ с #import)
