---
title: Обновление и пример методы CancelUpdate (VC ++) | Документы Microsoft
ms.prod: sql
...
ms.locfileid: "35282783"
---
# <a name="update-and-cancelupdate-methods-example-vc"></a>Обновление и пример методы CancelUpdate (VC ++)
