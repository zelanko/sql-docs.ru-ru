---
description: Примеры методов Update и CancelUpdate (Visual C++)
title: Примеры методов Update и CancelUpdate (Visual c++) | Документация Майкрософт
ms.prod: sql
