---
title: Параметр (ADO для синтаксиса Visual C++) | Документы Microsoft
ms.prod: sql
...
ms.locfileid: "35280503"
---
# <a name="parameter-ado-for-visual-c-syntax"></a>Параметр (ADO для синтаксиса Visual C++)
