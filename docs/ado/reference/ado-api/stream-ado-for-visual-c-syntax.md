---
title: Поток (ADO для синтаксиса Visual C++) | Документы Microsoft
ms.prod: sql
...
ms.locfileid: "35282523"
---
# <a name="stream-ado-for-visual-c-syntax"></a>Поток (ADO для синтаксиса Visual C++)
