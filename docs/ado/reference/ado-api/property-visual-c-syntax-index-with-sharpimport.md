---
title: 'Свойство (Visual C++ синтаксис указатель с #import) | Документы Microsoft'
ms.prod: sql
...
ms.locfileid: "35280755"
---
# <a name="property-visual-c-syntax-index-with-import"></a>Свойство (Visual C++ синтаксис указатель с #import)
