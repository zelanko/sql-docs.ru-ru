...
|**адерркантчанжепровидер**|3220 -2146825068 0X800A0C94|Указанный поставщик отличается от уже используемого.|  
...
|**адеррколумннотонсисров**|3726-2146824562 0x800A0E8E|Запись не содержит этого поля.|  
...
|**адерробжектопен**|3705-2146824583 0x800A0E79|Операция не разрешена, если объект открыт.|  
...
|**адеррсчемавиолатион**|3722-2146824566 0x800A0E8A|Значение данных конфликтует с типом данных или ограничениями поля.|  
...
|**адеррурлдоеснотексист**|3727 -2146824561 0x800A0E8F|Либо исходный URL-адрес, либо родительский объект URL-адреса назначения не существует.|  
|**адеррурлнамедровдоеснотексист**|3737 -2146824551 0x800A0E99|Запись с именем по этому URL-адресу не существует.|  
