...
|**адделете**|0x1000800|Поддерживает метод [Delete](../../../ado/reference/ado-api/delete-method-ado-recordset.md) для удаления записей.|  
...
|**адупдате**|0x1008000|Поддерживает метод [Update](../../../ado/reference/ado-api/update-method.md) для изменения существующих данных.|  
|**адупдатебатч**|0x10000|Поддерживает пакетное обновление (методы[UpdateBatch](../../../ado/reference/ado-api/updatebatch-method.md) и [CancelBatch](../../../ado/reference/ado-api/cancelbatch-method-ado.md) ) для передачи групп изменений поставщику.|  
