---
title: Пример свойства точности (VC ++) и NumericScale | Документы Microsoft
ms.prod: sql
...
ms.locfileid: "35279903"
---
# <a name="numericscale-and-precision-properties-example-vc"></a>Пример свойства точности (VC ++) и NumericScale
