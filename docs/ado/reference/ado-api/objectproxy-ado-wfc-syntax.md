 ...
 *аргументы*  
 Необязательный. Массив объектов, которые являются аргументов метода на сервере. Типами данных Java автоматически преобразуются в типы данных, подходящий для использования на сервере.
