---
title: 'ConnectionEvents (Visual C++ синтаксис индекс с #import) | Документы Microsoft'
ms.prod: sql
...
---
# <a name="connectionevents-visual-c-syntax-index-with-import"></a>ConnectionEvents (Visual C++ синтаксис индекс с #import)
