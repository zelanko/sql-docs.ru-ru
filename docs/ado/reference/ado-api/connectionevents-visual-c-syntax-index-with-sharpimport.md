---
description: 'Коннектионевентс (индекс синтаксиса Visual C++ с #import)'
title: 'Коннектионевентс (индекс синтаксиса Visual C++ с #import) | Документация Майкрософт'
ms.prod: sql
