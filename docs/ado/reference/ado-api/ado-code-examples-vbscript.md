...
-   [Пример методов Execute, Requery и Clear](../../../ado/reference/ado-api/execute-requery-and-clear-methods-example-vbscript.md)  
  
-   [Пример метода Move](../../../ado/reference/ado-api/move-method-example-vbscript.md)  
  
-   [Пример методов MoveFirst, MoveLast, MoveNext и MovePrevious](../../../ado/reference/ado-api/movefirst-movelast-movenext-and-moveprevious-methods-example-vbscript.md)  
