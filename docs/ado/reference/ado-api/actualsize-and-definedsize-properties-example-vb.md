---
title: "ActualSize и DefinedSize-пример свойства (Visual Basic) | Документы Microsoft"
...
---
# <a name="actualsize-and-definedsize-properties-example-vb"></a>ActualSize и DefinedSize-пример свойства (Visual Basic)
