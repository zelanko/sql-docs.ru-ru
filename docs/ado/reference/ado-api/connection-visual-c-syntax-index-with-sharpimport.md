---
title: 'Подключение (Visual C++ синтаксис индекс с #import) | Документы Microsoft'
ms.prod: sql
...
ms.locfileid: "35277105"
---
# <a name="connection-visual-c-syntax-index-with-import"></a>Подключение (Visual C++ синтаксис индекс с #import)
