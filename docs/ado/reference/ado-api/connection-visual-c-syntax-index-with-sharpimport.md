---
title: 'Подключение (индекс синтаксиса Visual C++ с #import) | Документация Майкрософт'
ms.prod: sql
...
ms.locfileid: "47617012"
---
# <a name="connection-visual-c-syntax-index-with-import"></a>Подключение (индекс синтаксиса Visual C++ с #import)
