---
title: ADO для индекса синтаксис Visual C++ для модели COM | Документы Microsoft
ms.prod: sql
...
-   [Объект подключения](../../../ado/reference/ado-api/connection-ado-for-visual-c-syntax.md)  
