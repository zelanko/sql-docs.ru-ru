---
description: Пример свойств EOS и LineSeparator и метод Скиплине (Visual Basic)
title: Примеры свойств EOS и LineSeparator и метода Скиплине (Visual Basic) | Документация Майкрософт
ms.prod: sql
