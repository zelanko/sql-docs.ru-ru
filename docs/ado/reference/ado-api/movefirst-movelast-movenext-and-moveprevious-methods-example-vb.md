---
title: Перемещение указателя записи из примера набора записей (Visual Basic) | Документация Майкрософт
ms.prod: sql
