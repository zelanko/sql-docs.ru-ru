---
title: Открытие и закрытие примере методы (Visual Basic) | Документы Microsoft
ms.prod: sql
...
ms.locfileid: "35279883"
---
# <a name="open-and-close-methods-example-vb"></a>Открытие и закрытие примере методы (Visual Basic)
