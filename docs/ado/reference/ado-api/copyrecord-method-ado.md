 ...
 *Назначение*  
 Необязательный. Объект **строка** значение, содержащее URL-адрес, место, где *источника* будут скопированы.  
 ...
 *Пароль*  
 Необязательный. Объект **строка** значение, содержащее пароль, который при необходимости, проверяет ли *UserName*.  
