---
title: Параметры свойства, методы и события коллекции | Документация Майкрософт
ms.prod: sql
...
ms.locfileid: "67931681"
---
# <a name="parameters-collection-properties-methods-and-events"></a>Параметры коллекции свойства, методы и события
...
## <a name="methods"></a>Методы  
 [Append-метод](../../../ado/reference/ado-api/append-method-ado.md)  
