---
title: 'Recordset (индекс синтаксиса Visual C++ с #import) | Документация Майкрософт'
ms.prod: sql
...
ms.locfileid: "66711925"
---
# <a name="recordset-visual-c-syntax-index-with-import"></a>Recordset (индекс синтаксиса Visual C++ с #import)
