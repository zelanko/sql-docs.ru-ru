---
title: Поля (ADO для синтаксиса Visual C++) | Документы Microsoft
ms.prod: sql
...
ms.locfileid: "35278433"
---
# <a name="field-ado-for-visual-c-syntax"></a>Поля (ADO для синтаксиса Visual C++)
