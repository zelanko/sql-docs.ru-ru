---
title: 'Команда (Visual C++ синтаксис индекс с #import) | Документы Microsoft'
ms.prod: sql
...
ms.locfileid: "35276713"
---
# <a name="command-visual-c-syntax-index-with-import"></a>Команда (Visual C++ синтаксис индекс с #import)
