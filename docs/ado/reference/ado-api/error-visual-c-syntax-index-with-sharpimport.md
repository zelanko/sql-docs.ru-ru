---
title: "Ошибка (Visual C++ синтаксис индекс с #import) | Документы Microsoft"
...
---
# <a name="error-visual-c-syntax-index-with-import"></a>Ошибка (Visual C++ синтаксис индекс с #import)
