---
title: 'Ошибка (индекс синтаксиса Visual C++ с #import) | Документация Майкрософт'
ms.prod: sql
...
ms.locfileid: "47798592"
---
# <a name="error-visual-c-syntax-index-with-import"></a>Ошибка (индекс синтаксиса Visual C++ с #import)
