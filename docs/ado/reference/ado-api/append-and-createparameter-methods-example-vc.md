---
title: Добавление и пример методы CreateParameter (VC ++) | Документы Microsoft
ms.prod: sql
...
ms.locfileid: "35275773"
---
# <a name="append-and-createparameter-methods-example-vc"></a>Добавление и пример методы CreateParameter (VC ++)
