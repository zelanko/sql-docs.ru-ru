...
## <a name="remarks"></a>Примечания  
 ...
 Каждый из типов данных является фиксированной или переменной длины. Типы фиксированной длины должен быть определен с размером-1, так как размер определяется предварительно и определение размера по-прежнему требуется. Типы данных переменной длины позволяют размер от 1 до 32767.  
...
|Длина|Константа|Number|Подстановки|  
|------------|--------------|------------|------------------|  
