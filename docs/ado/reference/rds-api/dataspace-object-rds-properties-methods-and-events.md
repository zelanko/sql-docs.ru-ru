---
title: "Свойства объекта пространства данных (RDS), методы и события | Документы Microsoft"
...
---
# <a name="dataspace-object-rds-properties-methods-and-events"></a>Свойства объекта пространства данных (RDS), методы и события
> [!IMPORTANT]
