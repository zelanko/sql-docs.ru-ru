...
В процессе ETL используются хранимые процедуры в этой схеме. Они получают данные, необходимые из различных таблиц, за период, предусмотренного [ETL-пакета](https://msdn.microsoft.com/library/mt734218.aspx).
