...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]Инструкции по установке и конфигурации для WideWorldImportersDW базы данных.
