...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]Расширенный World Importers OLTP базы данных инструкции по установке и конфигурации.
