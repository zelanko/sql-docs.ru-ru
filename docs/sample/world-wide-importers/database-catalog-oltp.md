...
|Configuration_PopulateLargeSaleTable|Применение изменений enterprise edition, а затем заполняет больший объем данных для календарного года 2012 как дополнительные данные журнала.|
