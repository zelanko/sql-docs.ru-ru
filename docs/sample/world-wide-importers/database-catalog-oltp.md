...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]База данных WideWorldImporters содержит все сведения о транзакциях и ежедневных данных для продажи и покупки, а также данные датчика для автомобилей и холодные комнаты.
