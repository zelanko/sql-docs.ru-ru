---
title: Справочник по языку служб аналитики | Документация Майкрософт
ms.date: 06/04/2018
ms.prod: sql
...
ms.locfileid: "62521391"
---
# <a name="analysis-services-language-reference"></a>Справочник по языку служб Analysis Services


  [Справочник по выражениям анализа данных (DAX)](https://msdn.microsoft.com/70a82136-0926-4a91-bcb3-e18e82593b0d)  
 ...
 [Функции VBA в многомерных выражениях и выражениях анализа данных (DAX)](../mdx/vba-functions-in-mdx-and-dax.md)  
