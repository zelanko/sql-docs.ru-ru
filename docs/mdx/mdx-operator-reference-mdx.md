...
|Раздел|Описание|  
|-----------|-----------------|  
|[--& #40; Комментарий & #41; & #40; Многомерные Выражения & #41;](../mdx/comment-mdx-operator-reference.md)|Обозначает текст комментариев пользователя.|  
...
|[Комментарий & #40; Многомерные Выражения & #41;](../mdx/comment-mdx.md)|Обозначает текст комментариев пользователя.|  
|[& #40; Комментарий & #41; & #40; Многомерные Выражения & #41;](../mdx/comment-mdx-double-slash.md)|Обозначает текст комментария пользователя.|  
