---
description: Stdev (многомерные выражения)
...
## <a name="remarks"></a>Remarks  
 Функция **STDEV** использует формулу несмещенной совокупности, а функция [StDevP](../mdx/stdevp-mdx.md) использует формулу смещенной совокупности.  
