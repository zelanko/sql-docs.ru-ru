 ...
 **USE_EQUAL_ALLOCATION:** каждой конечной ячейке, которая участвует в обновлении ячейки будут назначены одинаковые значения в соответствии со следующим выражением.  
 ...
 **USE_WEIGHTED_ALLOCATION:** каждой конечной ячейке, которая участвует в обновлении ячейки будут назначены одинаковые значения, основанный на следующее выражение.  
  
```  
<leaf cell value> = < New Value> * Weight_Expression  
```  
  
 **USE_WEIGHTED_INCREMENT:** каждой конечной ячейке, которая участвует в обновлении ячейки, изменяется в соответствии с следующее выражение.  
