---
title: Обновлено - многомерных Выражений для документации по SQL Server | Документы Microsoft
description: Отображение фрагментов обновленное содержимое для последних измененных в документации для многомерных выражений (MDX) для Microsoft SQL Server.
manager: craigg
author: MightyPen
ms.author: genemi
ms.topic: article
...
---
# <a name="new-and-recently-updated-multidimensional-expressions-mdx-for-sql-server"></a>Новые и недавно обновленные: многомерных выражений (MDX) для SQL Server
...
- *Предметной области:* &nbsp; **многомерных выражений (MDX) для SQL Server**.
