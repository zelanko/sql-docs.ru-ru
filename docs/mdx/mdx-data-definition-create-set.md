...
## <a name="remarks"></a>Примечания  
 ...
 Инструкция CREATE SET создает именованный набор, доступный в течение сеанса, к которому, следовательно, можно обращаться в нескольких запросах в сеансе. Дополнительные сведения см. в разделе [многомерные выражения &#40;&#41;вычисляемых элементов с областью действия сеанса](https://docs.microsoft.com/analysis-services/multidimensional-models/mdx/mdx-calculated-members-session-scoped-calculated-members).  
  
 Также можно определить именованный набор только для одного запроса. Чтобы определить такой набор, в инструкции SELECT укажите предложение WITH. Дополнительные сведения о предложении WITH см. в статье [Создание именованных наборов &#40;с областью&#41;действия запроса многомерных выражений](https://docs.microsoft.com/analysis-services/multidimensional-models/mdx/mdx-named-sets-creating-query-scoped-named-sets).  
...
## <a name="scope"></a>`Scope`  
 ...
 Область запроса  
 Видимость и время жизни набора ограничиваются данным запросом. Набор определяется в отдельном запросе. Область запроса имеет приоритет по сравнению с областью сеанса. Дополнительные сведения см. в статье [Создание именованных наборов &#40;с областью&#41;действия запроса многомерных выражений](https://docs.microsoft.com/analysis-services/multidimensional-models/mdx/mdx-named-sets-creating-query-scoped-named-sets).  
