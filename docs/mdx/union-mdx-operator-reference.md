---
title: + (Объединение) (МНОГОМЕРНЫЕ ВЫРАЖЕНИЯ) | Документация Майкрософт
ms.date: 06/04/2018
ms.prod: sql
 ...
 **+ (Объединение множеств)** оператор функционально эквивалентен [объединения &#40;многомерных Выражений&#41; ](../mdx/union-mdx.md) функции.  
