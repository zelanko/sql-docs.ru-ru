...
-   OR  
 ...
 Дополнительные сведения об операторах в многомерных Выражениях см. в разделе [Справочник по операторам Многомерных &#40;многомерных Выражений&#41;](../mdx/mdx-operator-reference-mdx.md).  
