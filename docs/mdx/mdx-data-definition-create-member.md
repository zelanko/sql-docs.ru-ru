...
|NON_EMPTY_BEHAVIOR|Мера или набор, используемые для определения поведения вычисляемых элементов при разрешении пустых ячеек.<br /><br /> **Предупреждение .это\* свойство являетсяустаревшим.\* \* \*** Не задавайте его. Дополнительные сведения см. в разделе [Нерекомендуемые функции служб Analysis Services в SQL Server 2016](https://docs.microsoft.com/analysis-services/deprecated-analysis-services-features-in-sql-server-2016) .|  
