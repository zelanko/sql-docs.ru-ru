...
-   **значение true,** Если первый параметр имеет значение, либо больше или равно значению второго параметра.  
  
-   **false** Если первый параметр имеет значение меньше, чем значение второго параметра.  
  
-   **значение true,** Если оба параметра имеют значение null или один параметр имеет значение null, а оставшийся параметр является 0.  
