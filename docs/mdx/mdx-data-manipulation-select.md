...
|**HL Mountain Frame**|**$ 3 365 069,27**|**$ 174,11**|**0,01 %**|  
 ...
 Поведение автоматической проверки существования можно изменить с помощью параметра "автосуществование = [1 | 2 | 3]" в строке подключения. см. раздел [поддерживаемые &#40;XMLA&#41; Properties XMLA](https://docs.microsoft.com/bi-reference/xmla/xml-elements-properties/propertylist-element-supported-xmla-properties) и <xref:Microsoft.AnalysisServices.AdomdClient.AdomdConnection.ConnectionString%2A> использование параметра.  
  
## <a name="examples"></a>Примеры  
 В следующем примере возвращается сумма `Measures.[Order Quantity]` элемента, агрегированная за первые восемь месяцев 2003 календарного года, которые содержатся `Date` в измерении, из куба **Adventure Works** .  
...
## <a name="see-also"></a>См. также  
 ...
 [Запрос многомерных выражений для запросов и осей &#40;срезов&#41;](~/analysis-services/multidimensional-models/mdx/mdx-query-and-slicer-axes-restricting-the-query.md)  
