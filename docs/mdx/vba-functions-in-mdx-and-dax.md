...
|Синус|Только многомерные выражения||  
...
|Коммутатор|Только многомерные выражения||  
