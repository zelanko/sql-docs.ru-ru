...
2. Запустите сценарий PowerShell со следующими аргументами:
    ...
    - **CollectionTimeInSeconds**: Количество времени, в течение которого вы хотите собирать данные счетчиков производительности.
...
- Предотвратить обновление цены
    - **/ SkuRecommendationPreventPriceRefresh**: Запрещает обновление цены. Используйте, если выполняется в автономном режиме.
...
- **MetricName** — независимо от того, имеется ли метрики был выполнен.
