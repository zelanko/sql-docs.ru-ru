...
- Оценка запросов SQL от внешнего приложения, например запросов SQL в C# исходном коде. Пользователи могут использовать набор средств миграции доступа к данным, чтобы создать полный отчет JSON для запросов SQL, используемых C# в исходном коде, а затем передать отчет в помощник по миграции данных.
