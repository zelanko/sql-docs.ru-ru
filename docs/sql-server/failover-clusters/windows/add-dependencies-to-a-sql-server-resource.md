---
title: "добавить зависимости к ресурсу SQL Server | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "зависимости ресурсов [SQL Server]"
  - "отказоустойчивая кластеризация [SQL Server], зависимости"
  - "кластеры [SQL Server], зависимости"
  - "зависимости [SQL Server], кластеризация"
...
---
# добавить зависимости к ресурсу SQL Server
