---
title: "Обновление экземпляра отказоустойчивого кластера SQL Server (программа установки) | Microsoft Docs"
ms.custom: ""
ms.date: "01/22/2016"
...
helpviewer_keywords: 
  ...
  - "кластеры [SQL Server], обновление"
  - "отказоустойчивые кластеры [SQL Server], создание кластеров"
  - "кластеры [SQL Server], создание"
  - "отказоустойчивые кластеры [SQL Server], обновление"
...
#### Обновление отказоустойчивого кластера [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]  
...
11. На странице «Обновление полнотекстового поиска» укажите параметры обновления для обновляемых баз данных. Дополнительные сведения см. в разделе [Параметры обновления полнотекстового поиска](../Topic/Full-Text%20Search%20Upgrade%20Options.md).  
...
## Обновление отказоустойчивого кластера с несколькими подсетями [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]  
  
#### Обновление до отказоустойчивого кластера [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] с несколькими подсетями (Существующий кластер [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] не является кластером с несколькими подсетями).  
...
-   [Использование преимуществ новых функций SQL Server 2016](../Topic/Take%20Advantage%20of%20New%20SQL%20Server%202016%20Features.md)  
