...
-   [Обновления поддерживаемых версий и выпусков](../../../database-engine/install-windows/supported-version-and-edition-upgrades.md). Убедитесь, что текущая версия операционной системы Windows позволяет обновить текущую версию [!INCLUDE[ssCurrent](../../../includes/sscurrent-md.md)] до версии [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]. Например, невозможно напрямую обновить экземпляр отказоустойчивого кластера SQL Server 2005 до версии [!INCLUDE[ssCurrent](../../../includes/sscurrent-md.md)] или обновить отказоустойчивый кластер, запущенный в [!INCLUDE[winxpsvr-md](../../../includes/winxpsvr-md.md)].  
...
## <a name="upgrade-a-multi-subnet-failover-cluster"></a>Обновление отказоустойчивого кластера с несколькими подсетями  

Выполните следующие шаги, чтобы обновить экземпляр отказоустойчивого кластера SQL Server в среде с несколькими подсетями. 
