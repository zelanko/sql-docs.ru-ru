---
title: "Отказоустойчивая кластеризация Windows Server (WSFC) с SQL Server | Microsoft Docs"
ms.custom: ""
ms.date: "01/18/2017"
...
##  <a name="AlwaysOnWsfcRelationship"></a> Связь компонентов SQL Server AlwaysOn с WSFC  
 ...
 ![Диаграмма контекста компонента SQL Server AlwaysOn](../../../sql-server/failover-clusters/windows/media/alwaysoncomponentcontextdiagram.gif "Диаграмма контекста компонента SQL Server AlwaysOn")  
