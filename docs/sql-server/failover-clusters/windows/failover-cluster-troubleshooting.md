---
title: "Диагностика отказоустойчивого кластера | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "10/21/2015"
...
ms.topic: "article"
helpviewer_keywords: 
  - "устранение неполадок, отказоустойчивая кластеризация"
  - "отказоустойчивая кластеризация, устранение неполадок"
  - "устранение неполадок кластера"
