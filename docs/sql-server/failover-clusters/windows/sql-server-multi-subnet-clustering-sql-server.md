---
title: "Кластеры SQL Server с несколькими подсетями [SQL Server] | Microsoft Docs"
ms.custom: ""
ms.date: "09/01/2016"
...
##  <a name="VisualElement"></a> Отказоустойчивый кластер SQL Server с несколькими подсетями (2 узла, 2 подсети)  
 ...
 ![Архитектура c несколькими подсетями c MultiSubnetFailover](../../../sql-server/failover-clusters/windows/media/multi-subnet-architecture-withmultisubnetfailoverparam.gif "Архитектура c несколькими подсетями c MultiSubnetFailover")  
...
|Отказоустойчивые кластеры Windows|[Отказоустойчивые многосайтовые кластеры Windows 2008 R2](http://www.microsoft.com/windowsserver2008/en/us/failover-clustering-multisite.aspx)|  
