---
title: "Диагностика пользователей, утративших связь с учетной записью (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "07/14/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "пользователи, утратившие связь с учетной записью"
  - "учетные данные [SQL Server], пользователи, утратившие связь с учетной записью"
  - "устранение неполадок [SQL Server], учетные записи пользователей"
  - "учетные записи пользователей [SQL Server], пользователи, утратившие связь с учетной записью"
  - "отработка отказа [SQL Server], управление метаданными"
  - "зеркальное отображение базы данных [SQL Server], метаданные"
  - "пользователи [SQL Server], утратившие связь с учетной записью"
