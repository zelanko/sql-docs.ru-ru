---
title: "Добавление или удаление узлов отказоустойчивого кластера SQL Server (программа установки) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  ...
  - "отказоустойчивый кластер [SQL Server], узлы"
  - "удаление узлов"
  - "обслуживание кластеров [SQL Server]"
  - "удаление узлов"
...
#### Добавление узла в существующий отказоустойчивый кластер [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]  
...
#### Удаление узла из существующего отказоустойчивого кластера [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]  
