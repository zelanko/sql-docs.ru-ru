---
title: "Требования к оборудованию и программному обеспечению для установки SQL Server 2016 | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "03/23/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Программа установки [SQL Server], программное обеспечение"
  - "программное обеспечение [SQL Server]"
  - "установка SQL Server, программное обеспечение"
  - "операционные системы [SQL Server], требования к SQL Server"
  - "Программа установки [SQL Server], поддержка версий на разных языках"
  - "операционные системы [SQL Server], поддержка версий на разных языках"
  - "сетевые подключения [SQL Server], требования"
  - "место на диске [SQL Server], установки SQL Server"
  - "WOW [SQL Server]"
  - "Программа установки [SQL Server], оборудование"
  - "зависимости [SQL Server], установки SQL Server"
  - "требования к кластерному оборудованию [SQL Server]"
  - "конечные точки [SQL Server], установки SQL Server"
  - "Интернет [SQL Server], установки SQL Server"
  - "оборудование [SQL Server]"
  - "Windows on Windows [SQL Server]"
  - "установка SQL Server, оборудование"
  - "программа проверки конфигурации установки"
  - "SCC [SQL Server]"
  - "операционные системы [SQL Server]"
  - "пространство [SQL Server], установки SQL Server"
  - "средство проверки конфигурации системы"
  - "установка SQL Server, поддержка версий на разных языках"
  - "Интернет [SQL Server]"
  - "место [SQL Server]"
  - "расширенная системная поддержка [SQL Server]"
  - "64-разрядный выпуск [SQL Server]"
  - "отказоустойчивая кластеризация [SQL Server]"
  - "отказоустойчивая кластеризация [SQL Server], требования к оборудованию"
  - "32-разрядный выпуск [SQL Server]"
  - "локали [SQL Server], установки SQL Server"
  - "поддержка версий на разных языках"
  - "место на диске [SQL Server]"
  - "локализованные версии SQL Server"
ms.assetid: 09bcf20b-0a40-4131-907f-b61479d5e4d8
caps.latest.revision: 333
ms.author: "mikeray"
manager: "jhubbard"
---
# Требования к оборудованию и программному обеспечению для установки SQL Server 2016
...
-   [Требования к оборудованию и программному обеспечению](../../sql-server/install/hardware-and-software-requirements-for-installing-sql-server-2016.md#hwswr)  
  
-   [Требования к процессору, памяти и операционной системе](../../sql-server/install/hardware-and-software-requirements-for-installing-sql-server-2016.md#pmosr)  
  
-   [Поддержка версий на разных языках](../../sql-server/install/hardware-and-software-requirements-for-installing-sql-server-2016.md#CrossLanguageSupport)  
  
-   [Требования к месту на диске](../../sql-server/install/hardware-and-software-requirements-for-installing-sql-server-2016.md#HardDiskSpace)  
  
-   [Типы хранилищ для файлов данных](../../sql-server/install/hardware-and-software-requirements-for-installing-sql-server-2016.md#StorageTypes)  
  
-   [Установка SQL Server на контроллере домена](../../sql-server/install/hardware-and-software-requirements-for-installing-sql-server-2016.md#DC_support)  
  
##  <a name="a-namehwswra-hardware-and-software-requirements"></a><a name="hwswr"></a> Требования к оборудованию и программному обеспечению  
...
|Жесткий диск|Для [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] требуется как минимум 6 ГБ свободного места на диске.<br/><br/> Требования к месту на диске определяются набором устанавливаемых компонентов [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] . Дополнительные сведения см. в подразделе [Требования к месту на диске](../../sql-server/install/hardware-and-software-requirements-for-installing-sql-server-2016.md#HardDiskSpace) далее в этом разделе. Сведения о поддерживаемых типах хранилищ для файлов данных см. в разделе [Storage Types for Data Files](../../sql-server/install/hardware-and-software-requirements-for-installing-sql-server-2016.md#StorageTypes).|  
...
##  <a name="a-namepmosra-processor-memory-and-operating-system-requirements"></a><a name="pmosr"></a> Требования к процессору, памяти и операционной системе  
...
-   [Основные выпуски SQL Server 2016](../../sql-server/install/hardware-and-software-requirements-for-installing-sql-server-2016.md#TOP_Principal)  
  
-   [Дополнительные выпуски SQL Server 2016](../../sql-server/install/hardware-and-software-requirements-for-installing-sql-server-2016.md#TOP_Breadth)  
...
###  <a name="a-nametopprincipala-principal-editions-of-includesscurrenttokensscurrentmdmd"></a><a name="TOP_Principal"></a> Основные выпуски [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]  
...
###  <a name="a-nametopbreadtha-breadth-editions-of-includesscurrenttokensscurrentmdmd"></a><a name="TOP_Breadth"></a> Дополнительные выпуски [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]  
...
##  <a name="a-namecrosslanguagesupporta-cross-language-support"></a><a name="CrossLanguageSupport"></a> Поддержка версий на разных языках  
...
##  <a name="a-nameharddiskspacea-hard-disk-space-requirements"></a><a name="HardDiskSpace"></a> Требования к месту на диске  
...
##  <a name="a-namestoragetypesa-storage-types-for-data-files"></a><a name="StorageTypes"></a> Типы хранилищ для файлов данных  
...
-   Общая папка SMB  
    ...
    > [!NOTE]  
    >  Хранилище SMB не поддерживается для файлов данных автономных или кластерных установок служб [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] . Вместо этого используйте непосредственно подключенное хранилище или сеть хранения данных.  
...
##  <a name="a-namedcsupporta-installing-includessnoversiontokenssnoversionmdmd-on-a-domain-controller"></a><a name="DC_support"></a> Установка [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] на контроллере домена  
 Исходя из соображений безопасности, не рекомендуется устанавливать [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] на контроллере домена. Программа установки [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] не заблокирует установку на компьютере, который является контроллером домена, однако при этом будут применены следующие ограничения.  
