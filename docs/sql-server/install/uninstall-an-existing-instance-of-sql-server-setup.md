---
title: "Удаление существующего экземпляра SQL Server (программа установки) | Microsoft Docs"
ms.custom: ""
ms.date: "01/27/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "удаление экземпляров SQL Server"
  - "удаление экземпляров SQL Server"
  - "удаление SQL Server"
  - "экземпляры SQL Server, удаление"
  - "удаление SQL Server"
...
### Удаление экземпляра [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]  
  
1.  Чтобы начать процесс удаления, перейдите на страницу **Панель управления** , а затем на страницу **Программы и компоненты**.  
  
2.  Щелкните правой кнопкой мыши пункт **[!INCLUDE[msCoName](../../includes/msconame-md.md)][!INCLUDE[ssSQL14](../../includes/sssql14-md.md)]** и выберите **Удалить**. Нажмите кнопку **Удалить**. Будет запущен мастер установки [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] .  
...
### Если удаление не было выполнено успешно  
