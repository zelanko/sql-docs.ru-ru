---
title: "Установка компонентов бизнес-аналитики SQL Server&#160;2016 | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "03/23/2017"
...
manager: "erikre"
---
# Установка компонентов бизнес-аналитики SQL Server&#160;2016
...
## Компоненты бизнес-аналитики SQL Server  
...
> [!NOTE] SQL Server Data Tools (SSDT) не входят в состав SQL Server 2016. [Скачайте SQL Server Data Tools](http://go.microsoft.com/fwlink/?LinkID=616714).
  
## См. также:  
 [Новые возможности служб Reporting Services (SSRS)](http://msdn.microsoft.com/ru-ru/bc909063-6b84-4b3a-80d2-e93fc04b4b9d)   
 [Новые возможности в службах Analysis Services](../../analysis-services/what-s-new-in-analysis-services.md)   
 [Новые возможности в службах Integration Services](../Topic/What's%20New%20in%20Integration%20Services.md)   
