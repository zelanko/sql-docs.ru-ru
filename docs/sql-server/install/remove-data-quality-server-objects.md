---
title: "Удаление объектов служб Data Quality Services | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
---
# Удаление объектов служб Data Quality Services
...
## Удаление сервера DQS с экземпляра SQL Server  
...
-   \##Имена входа ##MS_dqs_db_owner_login## и ##MS_dqs_service_login##.  
...
## Удаление экземпляра SQL Server, содержащего сервер DQS  
