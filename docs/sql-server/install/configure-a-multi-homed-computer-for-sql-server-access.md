---
title: "Настройка многосетевого компьютера для доступа к SQL Server | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "порты [SQL Server], многосетевой компьютер"
  - "многосетевой компьютер [SQL Server] настройка портов"
  - "системы брандмауэров [ядро СУБД], многосетевой компьютер"
...
#### Определение IP-адресов и портов, используемых [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]  
...
2.  В области консоли **диспетчера конфигурации [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]** разверните узел **Сетевая конфигурация [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]**, **Протоколы для \<имя экземпляра>**, а затем дважды щелкните **TCP/IP**.  
