...
ms.locfileid: "55771340"
---
# <a name="sql-server-offline-help-and-help-viewer"></a>Автономная справка SQL Server и окно справки

[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]

Окно справки (Майкрософт) позволяет вам скачать и установить пакеты справки SQL Server из Интернет-источников или с диска для просмотра в автономном режиме. Окно справки устанавливается в составе SQL Server Management Studio (SSMS) или Visual Studio (VS). В этой статье описываются инструменты для установки окна справки, процедура установки автономного содержимого и способ просмотра справки для [!INCLUDE[ssSQL14_md](../includes/sssql14-md.md)], SQL Server 2016 и SQL Server 2017.
...
Окно справки имеет две версии.  Каждая версия поддерживает разные версии содержимого SQL Server.  Формат автономной документации со временем изменился, поэтому прежние версии окна справки не поддерживают более новые версии документации:
- Версия 2.x поддерживает справку по SQL Server 2016 и SQL Server 2017. 
- Версия 1.x поддерживает справку по [!INCLUDE[ssSQL14_md](../includes/sssql14-md.md)]. Окно справки не поддерживает параметры прокси-сервера и формат ISO.


|**Инструмент**|**Устанавливаемая версия окна справки**|
|---------|---------|
|[Visual Studio 2017*](https://docs.microsoft.com/visualstudio/install/install-visual-studio?view=vs-2017) | Версия 2.3|
|[SQL Server Management Studio 18.x](https://docs.microsoft.com/sql/ssms/download-sql-server-management-studio-ssms) | Версия 2.2|
...
> - При установке SQL Server 2017 окно справки не устанавливается. Окно справки больше не входит в состав установки SQL Server.
...
В SSMS 17.x, Visual Studio 2015 и Visual Studio 2017 используется окно справки 2.x, которое поддерживает справку по SQL Server 2016 и 2017. 
...
(*) обозначает содержимое из первой общедоступной версии содержимого справки по SQL Server 2017, а также прежнее содержимое справки по SQL Server 2016. Эта документация будет удалена, так как отдельная и полная документация по SQL Server 2016 и 2017 содержит изменения по состоянию на январь 2019 г.  
...
1. В меню "Справка" наведите указатель на пункт **Задать параметры справки** и выберите пункт **Запустить в браузере** или **Запустить в средстве просмотра справки**.
2. Нажмите клавишу F1, щелкните **Справка** или значок **?**. (если они доступны в диалоговом окне), чтобы открыть контекстно-зависимый раздел справки в Интернете в выбранной среде.
