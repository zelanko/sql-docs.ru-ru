---
title: "Задание максимальной вместимости SQL Server | Microsoft Docs"
ms.date: "03/09/2017"
...
helpviewer_keywords: 
  - "объекты [SQL Server]"
  - "спецификация вместимости количества [SQL Server]"
  - "Размер [SQL Server], спецификации емкости"
  - "количество объектов"
  - "спецификации вместимости [SQL Server]"
  - "спецификации максимальной вместимости [SQL Server]"
  - "размер [SQL Server]"
  - "спецификации вместимости репликаций [SQL Server]"
  - "Объекты [SQL Server], спецификации емкости"
  - "Ядро СУБД [SQL Server], спецификации емкости"
...
|Ссылок на таблицы внешнего ключа для таблицы||Исходящие = 253. Входящие = 10 000.|Ограничения см. в разделе [Create Foreign Key Relationships](../relational-databases/tables/создание-связей-по-внешнему-ключу.md).|  
...
|--------------------------------------------------|-|---------------------------------------------------|  
|Статей (публикация слиянием)||256|  
