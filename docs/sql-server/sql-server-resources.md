---
title: "Ресурсы по SQL Server | Документация Майкрософт"
ms.custom:
- SQL2016_New_Updated
ms.date: 11/28/2016
...
---
# <a name="sql-server-resources"></a>Ресурсы по SQL Server
...
-   [Блог рабочей группы Power Pivot и служб SQL Server Analysis Services](https://blogs.msdn.microsoft.com/analysisservices/tag/powerpivot/)  
