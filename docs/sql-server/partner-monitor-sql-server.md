...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] Мы предлагаем вам большой выбор передовых отраслевых инструментов для мониторинга служб SQL Server. В этой статье указаны партнеры корпорации Майкрософт, которые предлагают решения мониторинга, поддерживающие Microsoft SQL Server.
