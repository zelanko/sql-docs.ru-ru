---
title: "Резервное копирование баз данных с поддержкой Stretch (база данных Stretch) | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "06/14/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "база данных Stretch, резервное копирование"
  - "резервные копии (база данных Stretch)"
...
---
# Резервное копирование баз данных с поддержкой Stretch (база данных Stretch)
...
> [!NOTE] С увеличением объема данных, временно сохраняемых базой данных Stretch в промежуточной таблице, увеличивается объем необходимого места в SQL Server.
