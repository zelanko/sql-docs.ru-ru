---
title: "Заметки о выпуске SQL Server vNext | Microsoft Docs"
ms.custom: ""
ms.date: "03/12/2017"
ms.prod: "sql-vnext"
ms.reviewer: ""
...
---
# Заметки о выпуске SQL Server vNext
...
- [Заметки о выпуске служб SQL Server Reporting Services](../reporting-services/заметки-о-выпуске-служб-reporting-services.md) публикуются в разделе, посвященном службам Reporting Services.
...
**Проблема и последствия для клиентов:** если для типа журнала транзакций сущностей в [!INCLUDE[ssMDSshort_md](../includes/ssmdsshort-md.md)] задано значение **Атрибут** (значение по умолчанию — **Член**), следующие сценарии завершаются с ошибкой:
...
**Проблема и последствия для клиентов:** когда на компьютере установлена функция масштабного развертывания [!INCLUDE[ssIS_md](../includes/ssis-md.md)], удаление каталога **SSISDB** может завершиться сбоем со следующей ошибкой: "Не удалось удалить имя входа ‘…’, поскольку пользователь в настоящий момент подключен к системе". 
