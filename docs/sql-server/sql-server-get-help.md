...
ms.locfileid: "58221966"
---
# <a name="sql-server-help-and-feedback"></a>Справка и отзывы по SQL Server
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md.md](../includes/appliesto-ss-asdb-asdw-pdw-md.md)]

Мы заинтересованы в ваших предложениях по улучшению наших продуктов и документации. Мы не всегда можем ответить лично, но обязательно передадим ваши отзывы нужному специалисту или группе. 

## <a name="i-want-to-give-feedback-on-sql-server"></a>Я хочу оставить отзыв по SQL Server
...
Есть несколько блогов по SQL Server, где вы сможете найти самые свежие сведения об SQL Server. 
