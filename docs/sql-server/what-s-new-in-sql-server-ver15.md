...
[!INCLUDE[sql-server-2019](../includes/sssqlv15-md.md)] основан на нововведениях в области интеллектуальных баз данных предыдущих выпусков, чтобы он [просто работал быстрее](https://blogs.msdn.microsoft.com/bobsql/tag/it-just-runs-faster/). Эти улучшения помогают преодолеть известные узкие места, связанные с нехваткой ресурсов, и предоставляют возможность настройки сервера базы данных для обеспечения прогнозируемой производительности во всех рабочих нагрузках.
