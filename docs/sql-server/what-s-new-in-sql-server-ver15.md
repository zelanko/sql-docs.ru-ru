...
Ознакомительная версия для сообщества (CTP) 2.0 является первым общедоступным выпуском [!INCLUDE[sql-server-2019](../includes/sssqlv15-md.md)]. Ниже приведены функции, которые добавлены или улучшены в [!INCLUDE[sql-server-2019](../includes/sssqlv15-md.md)] CTP 2.0.
