...
2.  Щелкните правой кнопкой мыши горизонтальную ось > **свойства горизонтальной оси**.  
...
## <a name="4-rotate-the-axis-labels-on-the-horizontal-axis"></a>4. Поворот меток осей на горизонтальной оси  
...
3.  Щелкните правой кнопкой мыши горизонтальную ось > **свойства горизонтальной оси**.  
...
2.  Щелкните правой кнопкой мыши условные обозначения диаграммы > **свойства условных обозначений**.  
...
5.  Так как в этом учебнике имеется только одна категория, условные обозначения не требуются (необязательно). Чтобы удалить его, щелкните правой кнопкой мыши условные обозначения > **удалить условные обозначения**.  
...
3.  На **Главная** вкладка > **номер** щелкните **валюты** кнопки. Метки оси изменятся, отображая формат валюты.  
...
5.  Щелкните правой кнопкой мыши вертикальную ось > **свойства вертикальной оси**.  
...
9. Щелкните правой кнопкой мыши вертикальную ось > **показывать название оси**. 

10. Щелкните правой кнопкой мыши заголовок вертикальной оси > **свойства заголовка оси**.  
...
## <a name="8-show-all-the-labels-on-the-horizontal-x-axis"></a>8. Отображение всех меток на оси по горизонтали (x)
...
5.  Выберите **Январь — Декабрь 2015 г.**и на **Главная** вкладка > **шрифта** раздел > задать размер шрифта **10**.  
...
Учебник «Добавление гистограммы к отчету» завершен. Дополнительные сведения о диаграммах см. в разделе [диаграммы &#40; Построитель отчетов и службы SSRS &#41; ](../reporting-services/report-design/charts-report-builder-and-ssrs.md) и [спарклайны и гистограммы &#40; Построитель отчетов и службы SSRS &#41; ](../reporting-services/report-design/sparklines-and-data-bars-report-builder-and-ssrs.md).  
