---
title: Учебники по службам Reporting Services | Документация Майкрософт
description: Изучение возможностей SQL Server 2016 Reporting Services (SSRS) или более поздней версии, SQL Server Data Tools (SSDT) и построителя отчетов с помощью демонстрационных данных.
ms.date: 11/07/2017
...
## <a name="create-a-basic-table-report"></a>[Создание простого табличного отчета](../reporting-services/create-a-basic-table-report-ssrs-tutorial.md)
...
## <a name="create-a-data-driven-subscription"></a>[Создание управляемой данными подписки](../reporting-services/create-a-data-driven-subscription-ssrs-tutorial.md)
...
## <a name="create-a-drillthrough-40rdlc41-report-with-parameters-using-reportviewer"></a>[Создание детализированного (RDLC) отчета с параметрами с помощью ReportViewer](../reporting-services/create-drillthrough-rdlc-report-with-parameters-reportviewer.md)
...
## <a name="report-builder-tutorials"></a>[Учебники по построителю отчетов](../reporting-services/report-builder-tutorials.md)
