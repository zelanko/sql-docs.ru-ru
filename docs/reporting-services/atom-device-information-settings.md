...
description: Информация о настройках сведений об устройстве для модуля подготовки отчетов Atom, который поддерживает отправку имени веб-канала Atom и используемой кодировки.
ms.date: 03/16/2017
