...
3.  Используйте веб-портал отчетов, чтобы присвоить роли, регламентирующие доступ к папке Home (папка верхнего уровня в иерархии папок сервера отчетов), каждому пользователю или группе, которым необходимо предоставить доступ.  
  
4.  На уровне сайта на странице параметров сайта на веб-портале создайте назначения ролей системного уровня для каждого пользователя и группы с использованием стандартных ролей **Системный пользователь** и **Системный администратор**.  
