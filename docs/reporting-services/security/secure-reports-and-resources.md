---
title: "Защищенные отчеты и ресурсы | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "безопасность [службы Reporting Services], отчеты"
  - "безопасность [службы Reporting Services], ресурсы"
  - "отчеты [службы Reporting Services], безопасность"
  - "конфиденциальные отчеты [службы Reporting Services]"
  - "ресурсы [службы Reporting Services], безопасность"
...
3.  Злоумышленник создает ссылку на веб-страницу или на сервер отчетов, указывая значение параметра в виде "javascript:\<вредоносный_скрипт>" и отправляет эту ссылку кому-либо еще, выполняя атаку с заманиванием.  
