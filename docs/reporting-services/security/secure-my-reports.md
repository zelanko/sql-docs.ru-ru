---
title: "Обеспечение безопасности &#171;Моих отчетов&#187; | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  ...
  - "личные папки [службы Reporting Services]"
  - "рабочее пространство пользователей [службы Reporting Services]"
  - "безопасность [службы Reporting Services], папка "Мои отчеты""
...
-   пользовательская папка "Мои отчеты", находящаяся в папке "Папки пользователей\\\*\<имя пользователя>*\Мои отчеты";  
