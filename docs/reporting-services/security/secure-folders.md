---
title: "Обеспечение защиты папок | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "папки с повышенной защитой [службы Reporting Services]"
  - "папки с пониженной защитой"
  - "папки [службы Reporting Services], безопасность"
  - "безопасность [службы Reporting Services], папки"
