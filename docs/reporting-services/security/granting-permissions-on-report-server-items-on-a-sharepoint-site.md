...
-   Разрешение позволяет выполнить конкретную задачу. Службы [!INCLUDE[SPF2010](../../includes/spf2010-md.md)] предоставляют 33 стандартных разрешения, которые можно объединить в уровень разрешений.  
