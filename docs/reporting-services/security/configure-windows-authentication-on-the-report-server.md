---
title: "Настройка проверки подлинности Windows на сервере отчетов | Документы Microsoft"
ms.custom: 
ms.date: 08/26/2016
...
-   Значения в полях \<Explicit > будет содержать имена участников-служб, настроенные в Active Directory для [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] учетной записи службы.  
