---
title: "Роли и разрешения (службы Reporting Services) | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "элементы управления доступом [службы Reporting Services]"
  - "разрешения [службы Reporting Services], сведения о разрешениях"
  - "безопасность [службы Reporting Services], управление доступом и идентификаторами"
  - "проверка подлинности [службы Reporting Services]"
  - "разрешения [службы Reporting Services]"
  - "безопасность [службы Reporting Services], на основе ролей"
  - "идентификатор [службы Reporting Services]"
...
## Управление доступом и удостоверениями в собственном режиме  
...
## Управление удостоверениями и доступом в режиме интеграции с SharePoint  
