---
title: "Работа с общими наборами данных (веб-портал) | Microsoft Docs"
ms.custom: ""
ms.date: "03/23/2017"
...
manager: "erikre"
---
# Работа с общими наборами данных (веб-портал)
...
- [Создание общего набора данных](#create)  
  
- [Управление существующим общим набором данных](#manage)  
...
> [!NOTE] Если общий набор данных не отображается в папке, убедитесь, что вы просматриваете наборы данных. Выберите **Вид** в строке меню в правом верхнем углу веб-портала. Убедитесь, что установлен флажок **Наборы данных**.  
  
1.  Щелкните **значок многоточия (…)** возле набора данных, которым требуется управлять.  
...
> [!NOTE] Настройка срока действия не обновляет кэш. Без плана обновления кэша данные будут обновляться при следующем выполнении набора данных.  
...
> [!NOTE] Для создания плана обновления кэша должен быть запущен агент SQL Server.  
