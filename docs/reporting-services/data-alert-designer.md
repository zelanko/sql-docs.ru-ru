...
description: Сведения о, определениях предупреждений данных и о том, как создавать и изменять такие определения в конструкторе предупреждений данных.
ms.date: 07/02/2017
...
### <a name="email-settings"></a>Параметры электронной почты  
 ...
 По умолчанию темой сообщения электронной почты является **Предупреждение данных для \<alert name>** . Можно изменить тему в соответствии со своими потребностями.  
