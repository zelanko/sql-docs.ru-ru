---
title: "Предварительный просмотр отчетов | Microsoft Docs"
ms.custom: ""
ms.date: "05/05/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "конструктор отчетов [службы Reporting Services], предварительный просмотр отчетов"
  - "предварительный просмотр отчетов [службы Reporting Services]"
  - "печать предварительных просмотров"
  - "тестовые серверы [службы Reporting Services]"
...
-   Нажатием кнопки **Запуск** на стандартной панели инструментов [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] среды ![ssrs_ssdt_startdebug](../../reporting-services/reports/media/ssrs-ssdt-startdebug.png "ssrs_ssdt_startdebug").  
