...
description: Узнайте, как использовать функции развертывания в SQL Server Data Tools (SSDT) для публикации отчетов на сервере отчетов.
ms.date: 06/01/2016
