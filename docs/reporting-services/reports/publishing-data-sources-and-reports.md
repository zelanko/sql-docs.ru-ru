...
description: Узнайте, как опубликовать источник данных и отчеты, чтобы пользователи, имеющие доступ к серверу отчетов или сайту SharePoint, могли запускать этот отчет.
ms.date: 03/07/2017
