...
description: Используйте заголовки SOAP в Reporting Services для пакетных операций в одной транзакции, управления состоянием сеанса и получения свойств на основе пути или идентификатора элемента.
ms.date: 03/06/2017
