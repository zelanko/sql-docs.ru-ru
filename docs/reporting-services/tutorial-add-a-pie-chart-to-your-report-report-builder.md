...
2.  Если не отображается на панели свойств, на **представление** вкладка > **Показать или скрыть** группы > выберите **свойства**.  
...
4.  Выберите **как процент от общего объема продаж**и на **Главная** вкладка > **шрифта** раздел > задать размер шрифта **10**.  
...
Учебник «Добавление круговой диаграммы в отчет» успешно завершен. Дополнительные сведения о диаграммах см. в разделе [диаграммы &#40; Построитель отчетов и службы SSRS &#41; ](../reporting-services/report-design/charts-report-builder-and-ssrs.md) и [спарклайны и гистограммы &#40; Построитель отчетов и службы SSRS &#41; ](../reporting-services/report-design/sparklines-and-data-bars-report-builder-and-ssrs.md).  
