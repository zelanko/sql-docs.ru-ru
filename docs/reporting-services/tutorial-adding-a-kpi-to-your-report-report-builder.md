---
title: "Учебник: Добавление ключевого показателя Эффективности в отчет (построитель отчетов) | Документы Microsoft"
ms.custom: 
ms.date: 06/15/2016
...
4. На **Главная** вкладка > **номер** > **валюты**. Ячейки изменятся, отображая содержимое в формате валюты.
...
2.  В таблице, щелкните правой кнопкой мыши маркер столбца для столбца Sales > **вставить столбец** > **право**. В таблицу добавится новый столбец.  
...
4.  На **вставить** вкладку > **визуализации данных** > **датчика**, а затем щелкните область конструктора вне таблицы.   
...
10. В **свойства указателя-линии** диалоговое > **указатель** вкладка > **тип указателя**, убедитесь, что **панель** выбран. 
 
11. Нажмите кнопку **ОК**.  
  
12. Щелкните правой кнопкой мыши шкалу датчика и выберите пункт **Свойства шкалы**.  
  
13. В **свойства линейной шкалы** диалоговое окно "> **Общие** установите **максимальное** значение 25 000.  
...
2.  В таблице, щелкните правой кнопкой мыши маркер столбца для столбца линейной ключевого показателя Эффективности, добавленного в предыдущей процедуре > **вставить столбец** > **право**. В таблицу добавится новый столбец.  
...
5.  На **вставить** вкладка > **визуализации данных** > дважды щелкните **индикатора.**  
