---
title: "Учебник. Добавление в отчет ключевого показателя эффективности (построитель отчетов) | Microsoft Docs"
ms.custom: ""
ms.date: "06/15/2016"
...
2.  [Организация данных и выбор макета в мастере таблиц или матриц](#CompleteWizard)  
...
### Создание таблицы с внедренным набором данных  
...
### Разбиение данных по группам и выбор макета 
...
### Форматирование дат и денежных единиц
