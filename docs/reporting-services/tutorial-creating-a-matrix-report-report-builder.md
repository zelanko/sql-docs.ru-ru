---
title: "Учебник. Создание матричного отчета (построитель отчетов) | Microsoft Docs"
ms.custom: ""
ms.date: "06/23/2016"
...
2.  [Организация данных и выбор макета в мастере новой таблицы или матрицы](#Groups)  
