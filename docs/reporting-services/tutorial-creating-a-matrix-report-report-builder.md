---
title: "Учебник: Создание матричного отчета (построитель отчетов) | Документы Microsoft"
ms.custom: 
ms.date: 06/23/2016
...
3.  На **Главная** вкладка > **номер** > **валюты**. Ячейки изменятся, отображая содержимое в формате валюты.  
...
6.  На **границы** вкладка > **предустановок** > **нет**.
...
3.  На **вставить** вкладка > **заголовок** > **Добавление заголовка**.  
