...
![Снимок экрана матричного отчета построителя отчетов.](../reporting-services/media/report-builder-matrix-tutorial.png)
...
6.  Перетащите поле "Количество" в область **Значения**.  
    ...
    ![Снимок экрана, показывающий мастер размещения полей построителя отчетов.](../reporting-services/media/report-builder-arrange-fields-report-wizard.png)  
...
13. Нажмите кнопку **Готово**.  
    ...
    ![Снимок экрана, показывающий группы строк и столбцов построителя отчетов.](../reporting-services/media/report-builder-row-and-column-groups.png)
...
![Снимок экрана, на котором показан расширенный матричный отчет построителя отчетов.](../reporting-services/media/report-builder-expand-matrix.png)
...
3.  На вкладке **Главная** выберите **Число** > **Валюта**. Ячейки изменятся, отображая содержимое в формате валюты.  
    ...
    ![Снимок экрана, показывающий "Образцы значений" в построителе отчетов.](../reporting-services/media/report-builder-placeholder-value.png)
...
![Снимок экрана, показывающий рабочие дни, отображаемые в матричном отчете построителя отчетов.](../reporting-services/media/report-builder-matrix-weekdays.png)
...
4.  Щелкните матрицу, чтобы сбоку и сверху от нее появились маркеры строк и столбцов.  
    ...
    ![Снимок экрана с маркерами столбцов и строк в матричном отчете построителя отчетов.](../reporting-services/media/report-builder-column-handles.png)
...
2.  Выберите ячейку, содержащую `[Territory].` 
    ...
    >**Примечание.** Выделите ячейку, а не текст в ней. Свойство WritingMode доступно только для ячейки.
     ...
     ![Снимок экрана, показывающий ячейку территории в матричном отчете построителя отчетов.](../reporting-services/media/report-builder-select-territory-cell.png)
