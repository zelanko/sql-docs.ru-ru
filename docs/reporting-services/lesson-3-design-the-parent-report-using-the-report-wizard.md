...
description: Узнайте, как спроектировать родительский отчет с помощью мастера отчетов в конструкторе отчетов после создания подключения к данным и таблицы данных для родительского отчета.
ms.date: 05/18/2016
