...
![Снимок экрана: диаграмма времени для мобильного отчета.](../../reporting-services/mobile-reports/media/mobile-report-time-chart.png)
...
![Снимок экрана: диаграмма категорий для мобильного отчета.](../../reporting-services/mobile-reports/media/mobile-report-category-chart.png)   
...
![Снимок экрана: диаграмма итоговых значений для мобильного отчета.](../../reporting-services/mobile-reports/media/mobile-report-totals-chart.png)
...
![Снимок экрана: сравнительная диаграмма времени для мобильного отчета.](../../reporting-services/mobile-reports/media/mobile-report-comparison-time-chart.png)
...
![Снимок экрана: воронкообразная диаграмма для мобильного отчета.](../../reporting-services/mobile-reports/media/mobile-report-funnel-chart.png)
...
![Снимок экрана: диаграмма дерева группы для мобильного отчета.](../../reporting-services/mobile-reports/media/mobile-report-group-treemap.png)
...
1. Перетащите элемент **Каскадная диаграмма** с вкладки **Макет** в рабочую область конструирования и при необходимости [получите для него данные](../../reporting-services/mobile-reports/data-for-reporting-services-mobile-reports.md).
    ...
    ![Снимок экрана: значок каскадной диаграммы для мобильного отчета.](../../reporting-services/mobile-reports/media/mobile-report-waterfall-chart-icon.png)
...
2.  Откройте вкладку **Данные** и в области **Свойства данных** выберите поле категории для элемента **Координаты категории** и числовое поле для элемента **Основной ряд** : 
    ...
    ![Снимок экрана: данные каскадной диаграммы для мобильного отчета.](../../reporting-services/mobile-reports/media/mobile-report-waterfall-data.png)
    
3. На вкладке **Макет** каскадная диаграмма доступна для предварительного просмотра.

   ![Снимок экрана: каскадная диаграмма для мобильного отчета.](../../reporting-services/mobile-reports/media/mobile-report-waterfall-chart.png)
