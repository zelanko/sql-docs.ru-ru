...
* Выберите **данные** вкладке и в **свойства данных**выберите **параметры** рядом с числового поля > выберите другую статистическую обработку.
...
3. Если диаграммы необходимо использовать данные, которые еще не включены в отчет, выберите **данные** вкладка > **добавлять данные** для [получение данных из Excel или общего набора данных](../../reporting-services/mobile-reports/data-for-reporting-services-mobile-reports.md).

3. В области **Свойства данных** в поле **Основной ряд** выбран вариант **SimulatedTable**. Щелкните стрелку в поле и выберите таблицу.

5. При установке **структуру данных** для **по столбцам** (на **макета** вкладка > **визуальные свойства** панели), здесь в **свойства данных** области, можно выбрать несколько столбцов, числовых значений.
