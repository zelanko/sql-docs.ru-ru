---
title: "Добавление датчиков в мобильные отчеты | Службы Reporting Services | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# Добавление датчиков в мобильные отчеты | Службы Reporting Services
...
В [!INCLUDE[PRODUCT_NAME](../../includes/product-name.md)] все датчики имеют по меньшей мере одно общее свойство: основное значение, заданное в числовом поле в одной из таблиц данных в мобильном отчете.  
...
## Задание основного значения и значения сравнения
...
## Задание свойств визуальных элементов для датчика
...
### Установка направления значения: "Лучше подходят более высокие значения" или "Лучше подходят более низкие значения"
...
### Установка границ диапазона датчика
...
### Форматирование чисел в датчике  
