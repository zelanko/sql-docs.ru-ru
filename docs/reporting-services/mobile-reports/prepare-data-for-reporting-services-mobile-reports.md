...
description: Издатель мобильных отчетов SQL Server поддерживает сложные операции с данными, такие как фильтрация, агрегирование и временной срез. Узнайте, как подготовить данные для этих операций.
ms.date: 02/08/2016
