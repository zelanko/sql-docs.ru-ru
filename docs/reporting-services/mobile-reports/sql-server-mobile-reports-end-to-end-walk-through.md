...
5. Выберите необходимое агрегирование. Ключевые показатели эффективности могут отображать только одно число, так что поля будут агрегированы для отображения этого числа.
   ...
   ![Снимок экрана: раздел "Выбор поля из AWSalesYTD" с разделом агрегата "Среднее".](../../reporting-services/mobile-reports/media/reporting-services-kpi-pick-aggregation.png)
...
4. Вы можете выбрать разные агрегирования, чтобы получить одно число для поля **Основное значение** и еще одно для поля **Значение сравнения**. По умолчанию эти числа — суммы.
   ...
   ![Снимок экрана: "Параметры" или "Значение сравнения".](../../reporting-services/mobile-reports/media/ssrs-mobile-report-donut-sum.png)

5. Выберите **Предварительный просмотр** , чтобы посмотреть, как это выглядит. 

   ![Снимок экрана: результаты предварительного просмотра кольцевой диаграммы для мобильного отчета.](../../reporting-services/mobile-reports/media/ssrs-mobile-report-donut-preview.png)
...
1. На вкладке **Макет** перетащите список выбора в правую часть карты дерева, а затем перетащите правый нижний угол, чтобы на экране отображались две клетки в ширину и пять клеток в высоту (по высоте полотна). 
   ...
   ![Снимок экрана: список выбора мобильного отчета.](../../reporting-services/mobile-reports/media/ssrs-mobile-report-selection-list.png)
...
2. На вкладке **Данные** в разделе **Свойства данных** задайте для элементов **Ключи** и **Метки** то поле в ваших данных, которое необходимо отфильтровать.
   ...
   ![Снимок экрана: раздел свойств данных в списке выбора мобильного отчета.](../../reporting-services/mobile-reports/media/ssrs-mobile-report-selection-list-data-properties.png)
