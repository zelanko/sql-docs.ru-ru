...
description: Издатель мобильных отчетов для SQL Server может получать доступ к данным практически из любого источника с помощью общего источника данных, настроенного на веб-портале Reporting Services.
ms.date: 03/30/2017
