---
title: "Занятие&#160;8. Создание фильтра данных | Microsoft Docs"
ms.custom: ""
ms.date: "05/18/2016"
...
---
# Занятие&#160;8. Создание фильтра данных
...
### Добавление критерия фильтра к табликсу в дочернем отчете  
...
### Создание функции, которая выбирает нефильтрованные данные из таблицы PurchaseOrdeDetail  
...
### Добавление обработчика событий, который связывает таблицу данных PurchaseOrderDetail с дочерним отчетом  
