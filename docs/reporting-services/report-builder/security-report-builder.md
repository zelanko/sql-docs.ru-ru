...
##  <a name="Data"></a> Общие сведения о безопасности для данных отчета и внешних источников данных  
 ...
 Дополнительные сведения о защите данных см. в статье [Центр безопасности для SQL Server ядро СУБД и базы данных SQL Azure](../../relational-databases/security/security-center-for-sql-server-database-engine-and-azure-sql-database.md). 
