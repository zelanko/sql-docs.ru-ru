...
description: В построителе отчетов можно опубликовать отчет на сервере отчетов. Другие пользователи могут его просматривать. При каждом запуске опубликованного отчета будут отображаться самые последние данные.
ms.date: 03/01/2017
...
1.  В построителе отчетов нажмите кнопку **Сохранить**. Откроется диалоговое окно **Сохранить как** _\<Report Item>_ .  
...
1.  Нажмите кнопку «Построитель отчетов» и выберите **Сохранить как**. Откроется диалоговое окно **Сохранить как** _\<Report Item>_ .  
...
## <a name="see-also"></a>См. также:  
 ...
 [Экспорт отчета в файл другого типа (построитель отчетов и службы SSRS)](/previous-versions/sql/)  
