---
title: Поиск и просмотр отчетов на веб-портале (построитель отчетов) | Документация Майкрософт
description: Диспетчер отчетов — это веб-инструмент, включающее в себя функции просмотра отчетов и управления ими. Он устанавливается как часть сервера отчетов.
ms.date: 03/01/2017
...
## <a name="navigating-the-folder-hierarchy-in-report-manager"></a>Переход по иерархии папок в диспетчере отчетов  
 ...
 ![Лента диспетчера отчетов и навигация](../../reporting-services/report-builder/media/rs-reportmanager-ribbon.gif "Лента диспетчера отчетов и навигация")  
