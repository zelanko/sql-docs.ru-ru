---
title: "Поиск и просмотр отчетов на веб-портале (построитель отчетов и службы SSRS) | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
## Переход по иерархии папок в диспетчере отчетов  
 ...
 ![Лента диспетчера о��четов и навигация](../../reporting-services/report-builder/media/rs-reportmanager-ribbon.gif "Лента диспетчера о��четов и навигация")  
