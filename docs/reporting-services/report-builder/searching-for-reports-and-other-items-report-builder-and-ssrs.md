...
## <a name="see-also"></a>См. также  
 [Поиск и просмотр отчетов в диспетчере отчетов &#40; Построитель отчетов и службы SSRS &#41;](/sql-docs/docs/reporting-services/report-builder/finding-and-viewing-reports-with-a-browser-report-builder-and-ssrs)   
