...
description: Чтобы улучшить качество отчетов, выводимых на печать при просмотре в браузере, а также напечатать несколько страниц, можно использовать клиентские функции печати в SQL Server Reporting Services.
ms.date: 03/14/2017
