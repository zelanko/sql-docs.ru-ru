...
description: Построитель отчетов — это инструмент для создания отчетов с разбивкой на страницы. Чтобы создать отчет, укажите данные для получения, место их получения и способ отображения.
ms.date: 05/10/2019
