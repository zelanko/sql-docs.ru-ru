---
title: "Режим конструктора (построитель отчетов) отчета | Документы Microsoft"
ms.custom: 
ms.date: 03/01/2017
