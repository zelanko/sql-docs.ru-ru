...
description: В этой статье описываются элементы управления в окне построителя отчетов, используемые для добавления, выбора и организации ресурсов отчета и изменения свойств элементов отчета.
ms.date: 03/01/2017
...
# <a name="report-design-view-report-builder"></a>Представление конструктора отчетов (построитель отчетов)
 ...
 ![Режим конструктора в построителе отчетов](../../reporting-services/report-builder/media/ssrb-designview.png "Режим конструктора в построителе отчетов")  
...
##  <a name="parameters-pane"></a><a name="Ribbon"></a> Панель параметров  
...
##  <a name="the-report-part-gallery"></a><a name="ReptPartGallery"></a> Галерея элементов отчетов  
...
##  <a name="the-grouping-pane-report-builder"></a><a name="GroupPane"></a> Панель «Группирования» (построитель отчетов)  
 ...
 ![Группы строк в построителе отчетов](../../reporting-services/report-builder/media/ssrb-rowgroups.png "Группы строк в построителе отчетов")  
