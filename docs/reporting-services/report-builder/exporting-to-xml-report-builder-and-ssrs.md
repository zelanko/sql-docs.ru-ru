...
description: В построителе отчетов модуль подготовки отчетов в формате XML подготавливает отчет с разбиением на страницы к просмотру в формате XML. Импортируйте XML в базу данных, используйте его в качестве сообщения или отправляйте в приложения.
ms.date: 03/07/2017
...
##  <a name="xml-specific-rendering-rules"></a><a name="XMLSpecificRenderingRules"></a> Правила подготовки отчетов в формате XML  
...
##  <a name="duplicate-names"></a><a name="DuplicateName"></a> Повторяющиеся имена  
