---
title: "Интерактивные возможности различных модулей подготовки отчетов к просмотру (построитель отчетов и службы SSRS) | Microsoft Docs"
ms.custom: ""
ms.date: "03/23/2017"
...
## Интерактивные возможности в различных выходных форматах  
...
### Ссылки детализации к другим отчетам  
...
### Переключаемые элементы в пределах отчета  
...
### Гиперссылки, указывающие на внешнее веб-содержимое или изображения  
...
### Запрашиваемые параметры, получаемые во время выполнения  
...
### Фильтры, применяемые во время выполнения  
...
## См. также  
 ...
 [Матрицы (построитель отчетов и службы SSRS)](../Topic/Matrices%20\(Report%20Builder%20and%20SSRS\).md)   
