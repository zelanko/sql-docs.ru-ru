...
description: В построителе отчетов модуль подготовки отчетов в формате Excel подготавливает отчет с разбивкой на страницы к формату Office Open XML для использования в Microsoft Excel.
ms.date: 01/09/2017
...
##  <a name="excel-limitations"></a><a name="ExcelLimitations"></a> Ограничения Excel  
...
##  <a name="report-items-in-excel"></a><a name="ReportItemsExcel"></a> Элементы отчета в Excel  
...
##  <a name="worksheet-tab-names"></a><a name="WorksheetTabNames"></a> Имена вкладок листа  
...
##  <a name="page-headers-and-footers"></a><a name="PageHeadersFooters"></a> Верхние и нижние колонтитулы страницы  
...
##  <a name="changing-reports-at-run-time"></a><a name="ConditionalFormat"></a> Изменение отчетов во время выполнения  
