---
title: "Экспорт в Microsoft Excel (построитель отчетов и службы SSRS) | Документы Microsoft"
ms.custom: 
ms.date: 01/09/2017
...
-   Максимальная высота строки — 409 пунктов. Если содержимое строки приводит к увеличению ее высоты более 409 пунктов, в ячейку Excel отображает частичного объем текста до 409 пунктов. Остальная часть содержимого ячейки будет по-прежнему в ячейке (до Excel максимальное количество символов из 32 767).

-  Так как максимальная высота строки — 409 пунктов, если что-нибудь более 409 пунктов определенных высота ячейки в отчете, Excel разделяет содержимое ячейки на несколько строк.
...
### <a name="report-row-groups-and-column-groups"></a>Группы строк и группы столбцов отчета  
 ...
 ![Отчет в веб-портале Reporting Services](../../reporting-services/report-builder/media/ssrb-excelexportssrs.png "отчета в веб-портале Reporting Services")  
 ...
 ![Отчет экспортировать в Excel, со строками](../../reporting-services/report-builder/media/ssrb-exportedexcellines.png "экспортировать отчет в Excel, со строками")  
 ...
 ![Отчет экспортировать в Excel, в плоский формат](../../reporting-services/report-builder/media/ssrb-excelexportnomatrix.png "отчет экспортировать в Excel, в плоский формат")  
