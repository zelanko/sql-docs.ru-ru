...
description: Построитель отчетов предложит преобразовать некоторые пользовательские элементы отчета, которые имеют неподдерживаемые функции, в новый формат определения отчета.
ms.date: 08/17/2018
