...
description: Построитель отчетов позволяет выполнять экспорт для просмотра отчета в других приложениях. Для печати экспортируйте отчет, если приложение содержит нужные вам функции печати.
ms.date: 03/14/2017
