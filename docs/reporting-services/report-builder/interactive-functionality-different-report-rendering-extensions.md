...
description: Reporting Services позволяет взаимодействовать с отчетом с разбиением на страницы во время выполнения. В этой статье описывается работа интерактивных функций в конкретных форматах.
ms.date: 03/07/2017
