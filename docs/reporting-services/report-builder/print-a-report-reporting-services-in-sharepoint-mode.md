---
title: "Печать отчетов (службы Reporting Services в режиме SharePoint) | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Печать отчетов, веб-приложение SharePoint"
  - "печать отчетов"
...
---
# Печать отчетов (службы Reporting Services в режиме SharePoint)
...
### Печать отчетов из меню «Действия»  
