---
title: "Экспорт отчетов (построитель отчетов и службы SSRS) | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "09/11/2015"
...
-   [Экспорт отчета из построителя отчетов](#bkmk_export_from_rb)  
  
-   [Экспорт отчета с веб-портала служб Reporting Services](#bkmk_export_from_rm)  
  
-   [Экспорт отчета из библиотеки SharePoint](#bkmk_export_from_sharepoint)  
  
-   [Типы модулей подготовки отчетов](#RendererTypes)  
  
-   [Форматы файлов, в которые можно экспортировать отчеты при просмотре](#ExportFormats)  
  
-   [Формирование веб-каналов данных из отчета](#GeneratingDataFeedsFromReport)  
  
-   [Устранение неполадок, связанных с экспортированными отчетами](#Troubleshooting)  
  
-   [Другие методы экспорта отчетов](#OtherWaysExportingReports)  
...
1.  На **домашней** странице веб-портала [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] найдите отчет, который необходимо экспортировать.  
...
|CSV|Данные|Модуль подготовки отчетов в формате с разделителями-запятыми (CSV) готовит отчеты для просмотра в виде плоских представлений данных стандартизованного текстового вида. Этот формат легко читается и может использоваться для обмена со многими приложениями.<br /><br /> Дополнительные сведения см. в разделе [Экспорт в CSV-файл (построитель отчетов и службы SSRS)](../../reporting-services/report-builder/exporting-to-a-csv-file-report-builder-and-ssrs.md).|  
|EXCELOPENXML|Мягкие разрывы страниц|При просмотре отчетов отображается как Excel в меню экспорта. Модуль подготовки отчетов Excel преобразует отчет для просмотра в качестве документа Excel (XLSX), совместимого с [!INCLUDE[ofprexcel](../../includes/ofprexcel-md.md)] 2013.  Дополнительные сведения см. в разделе [Экспорт в Microsoft Excel (построитель отчетов и службы SSRS)](../../reporting-services/report-builder/exporting-to-microsoft-excel-report-builder-and-ssrs.md).|  
