---
title: Формирование веб-каналов данных из отчета (построитель отчетов) | Документация Майкрософт
description: Можно создавать веб-каналы данных, совместимые с Atom, из отчетов с разбивкой на страницы. Используйте веб-каналы в приложениях, таких как Power Pivot или Power BI, которые могут использовать потоки данных.
ms.date: 05/30/2017
