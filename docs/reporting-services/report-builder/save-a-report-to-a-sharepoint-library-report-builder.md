...
description: В этой статье описываются требования и процессы, необходимые для сохранения отчетов на сервере отчетов, настроенном для интеграции с SharePoint.
ms.date: 03/01/2017
