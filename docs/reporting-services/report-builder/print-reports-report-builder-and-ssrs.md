...
description: Просмотреть и распечатать отчет можно на веб-портале или в приложении, которое используется для его просмотра. Клиентский компьютер выполняет обработку печати по требованию.
ms.date: 05/24/2018
