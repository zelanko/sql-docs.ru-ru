...
description: 'Сведения о двух типах предупреждающих сообщений по электронной почте, доступных в предупреждениях об изменении данных служб SQL Server Reporting: сообщениях с результатами предупреждения об изменении данных и сообщениях с описаниями ошибок.'
ms.date: 07/02/2017
...
##  <a name="data-alert-messages"></a><a name="DataAlertMessages"></a> Предупреждающие сообщения  
