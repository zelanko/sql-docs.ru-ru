---
title: "Работа с подписками (веб-портал) | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
---
# Работа с подписками (веб-портал)
...
> [!NOTE] Должна быть запущена служба агента SQL Server.   
  
![ssRSWebPortal-subscriptions1](../reporting-services/media/ssrswebportal-subscriptions1.png)  
   
Чтобы открыть страницу "Подписки", нажмите кнопку **многоточие (...)** в отчете, выберите **Управление**, а затем — **Подписки**.  
...
## Создание или изменение подписки  
...
### Набор данных, управляемый данными  
