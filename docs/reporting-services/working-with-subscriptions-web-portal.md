...
description: Узнайте, как использовать страницу "Подписки" для просмотра всех подписок для текущего отчета в Reporting Services.
ms.date: 01/31/2020
...
Вы также можете запустить подписку в любой момент, выбрав **Запустить сейчас** на странице подписки.
...
[Создание подписок для работающих в основном режиме серверов отчетов и управление этими подписками](subscriptions/create-and-manage-subscriptions-for-native-mode-report-servers.md)
