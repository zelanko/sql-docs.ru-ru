---
title: "Ссылка на параметр доступа по URL-адресу | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "09/09/2015"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Отчеты [службы Reporting Services], параметры отображения"
  - "Доступ по URL-адресу [службы Reporting Services], параметры отображения отчетов"
