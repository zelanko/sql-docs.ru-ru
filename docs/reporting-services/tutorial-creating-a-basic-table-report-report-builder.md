---
title: "Учебник. Создание простого табличного отчета (построитель отчетов) | Microsoft Docs"
ms.custom: ""
ms.date: "06/23/2016"
...
---
# Учебник. Создание простого табличного отчета (построитель отчетов)
...
1.  [Создание отчета с помощью мастера](#CreateTable)  
  
    1.  [Указание подключения к данным в мастере таблиц](#DataConnection)  
  
    2.  [Создание запроса в мастере таблиц](#Query)  
  
    3.  [Организация данных в группы в мастере таблиц](#Groups)  
