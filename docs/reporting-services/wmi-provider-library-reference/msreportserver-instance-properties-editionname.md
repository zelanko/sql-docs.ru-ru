---
title: "Свойство EditionName (WMI MSReportServer_Instance) | Документы Microsoft"
ms.custom: 
ms.date: 03/01/2017
...
---
# <a name="msreportserverinstance-properties---editionname"></a>Свойства MSReportServer_Instance - EditionName
...
## <a name="property-value"></a>Значение свойства  
 Строка **string** , которая содержит понятное для пользователя имя выпуска сервера отчетов.  
