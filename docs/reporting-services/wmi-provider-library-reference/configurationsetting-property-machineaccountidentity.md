---
title: "Свойство MachineAccountIdentity (WMI) | Документы Microsoft"
ms.custom: 
ms.date: 03/01/2017
...
---
# <a name="configurationsetting-property---machineaccountidentity"></a>Свойство ConfigurationSetting - MachineAccountIdentity
...
## <a name="see-also"></a>См. также  
 [Свойства MSReportServer_ConfigurationSetting](../../reporting-services/wmi-provider-library-reference/msreportserver-configurationsetting-properties.md)  
