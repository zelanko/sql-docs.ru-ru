---
title: "Свойство SMTPServer (WMI MSReportServer_ConfigurationSetting) | Документы Microsoft"
ms.custom: 
ms.date: 03/01/2017
...
---
# <a name="configurationsetting-property---smtpserver"></a>Свойство ConfigurationSetting - SMTPServer
