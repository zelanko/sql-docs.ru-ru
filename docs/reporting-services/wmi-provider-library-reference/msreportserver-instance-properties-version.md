---
title: "Свойство Version (WMI MSReportServer_Instance) | Документы Microsoft"
ms.custom: 
ms.date: 03/01/2017
...
---
# <a name="msreportserverinstance-properties---version"></a>Свойства MSReportServer_Instance - версии
