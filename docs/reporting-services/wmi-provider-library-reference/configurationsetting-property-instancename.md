---
title: "Свойство InstanceName (WMI MSReportServer_ConfigurationSetting) | Документы Microsoft"
ms.custom: 
ms.date: 03/01/2017
...
---
# <a name="configurationsetting-property---instancename"></a>Свойство ConfigurationSetting - имя_экземпляра
