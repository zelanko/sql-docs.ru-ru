---
title: "Свойство InstanceID (WMI MSReportServer_Instance) | Документы Microsoft"
ms.custom: 
ms.date: 03/01/2017
...
---
# <a name="msreportserverinstance-properties---instanceid"></a>Свойства MSReportServer_Instance - InstanceID
