---
title: "Класс MSReportServer_Instance | Документы Microsoft"
ms.custom: 
ms.date: 03/01/2017
...
---
# <a name="msreportserverinstance-class"></a>MSReportServer_Instance, класс
 ...
 Список всех элементов этого типа см. в разделе [Элементы MSReportServer_Instance](../../reporting-services/wmi-provider-library-reference/msreportserver-instance-members.md).  
