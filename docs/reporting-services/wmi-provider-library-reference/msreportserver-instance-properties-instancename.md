---
title: "Свойство InstanceName (WMI MSReportServer_Instance) | Документы Microsoft"
ms.custom: 
ms.date: 03/01/2017
...
---
# <a name="msreportserverinstance-properties---instancename"></a>Свойства MSReportServer_Instance - имя_экземпляра
