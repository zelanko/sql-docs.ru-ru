---
title: "Предупреждения об изменении данных в службах Reporting Services | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
-   **Доставка предупреждений об изменении данных получателям.**Служба оповещений создает экземпляр предупреждения об изменении данных и отправляет предупреждающее сообщение получателям по электронной почте.  
 ...
 ![Рабочий процесс выдачи предупреждений служб Reporting Services](../reporting-services/media/rs-alertingworkflow.gif "Рабочий процесс выдачи предупреждений служб Reporting Services")  
