...
description: Сведения о средстве просмотра HTML-страниц и панели инструментов отчета, а также о просмотре отчетов по запросу с сервера отчетов.
ms.date: 03/14/2017
