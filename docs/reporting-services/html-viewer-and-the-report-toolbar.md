---
title: "Средство просмотра HTML-страниц и панель инструментов отчета | Microsoft Docs"
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  ...
  - "панель инструментов отчета [службы Reporting Services]"
...
## Панель инструментов отчета  
 ...
 ![Панель инструментов «Отчеты»](../reporting-services/media/ssrs-htmlviewer-toolbar.gif "Панель инструментов «Отчеты»")  
...
|![Форматы экспорта](../reporting-services/media/htmlviewer-export.png "Форматы экспорта")|**Форматы экспорта**|Открыть новое окно браузера и подготовить отчет к просмотру в выбранном формате. Доступные форматы определяются модулями подготовки отчетов, которые установлены на сервере отчетов. Формат TIFF рекомендуется для печати. Нажмите кнопку **Экспорт** , чтобы просмотреть отчет в выбранном формате.|  
|![Значок схемы документа](../reporting-services/media/htmlviewer-docmap.png "Значок схемы документа")|**Значок схемы документа**|Показать или скрыть панель схемы документа в отчете, включающем в себя такую схему. Схема документа — это элемент управления навигацией по отчету, подобный панели навигации на веб-сайте. Можно перейти к определенной группе, странице или вложенному отчету, щелкнув соответствующий элемент схемы документа.|  
|![Значок принтера](../reporting-services/media/printer-icon.png "Значок принтера")|**Значок принтера**|Открыть диалоговое окно «Печать», чтобы указать параметры печати и распечатать отчет. При первом использовании щелчок значка вызывает приглашение загрузить элемент управления печатью.|  
...
|![Кнопка обновления страницы в браузере на панели инструментов «Отчет»](../reporting-services/media/htmlviewer-refresh.png "Кнопка обновления страницы в браузере на панели инструментов «Отчет»")|**Значок обновления отчета**|Обновить отчет. Данные для активных отчетов будут обновлены. Кэшированные отчеты будут заново загружены из местоположения, в котором они хранятся.|  
|![htmlviewer_datafeed](../reporting-services/media/htmlviewer-datafeed.png "htmlviewer_datafeed")|**Значок канала данных**|Создание каналов данных с помощью отчетов.|  
