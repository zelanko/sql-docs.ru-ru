---
title: "Устранение неполадок при подключении к серверу и базе данных (службы Reporting Serivces). | Microsoft Docs"
ms.custom: ""
ms.date: "02/28/2016"
...
---
# Устранение неполадок при подключении к серверу и базе данных (службы Reporting Serivces).
