---
title: "Управление предупреждениями данных в диспетчере предупреждений данных | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# Управление предупреждениями данных в диспетчере предупреждений данных
...
### Просмотр списка своих предупреждений  
...
### Редактирование определения предупреждения  
