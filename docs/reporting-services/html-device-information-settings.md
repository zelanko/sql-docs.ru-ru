---
title: "Настройки сведений об устройстве HTML | Документы Microsoft"
ms.date: 03/16/2017
...
|**StreamRoot (\*)**|Путь, используемый в качестве префикса значения атрибута **src** в элементе IMG в HTML-отчете, возвращаемом сервером отчетов. По умолчанию сервер отчетов предоставляет путь. Можно использовать этот параметр, чтобы указать корневой путь для изображений в отчет (например, **http://\<имя_сервера >/ресурсы/companyimages**).|  
