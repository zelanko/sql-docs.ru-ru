...
---
# <a name="behavior-changes-to-sql-server-reporting-services--in-sql-server-2016"></a>Изменения в работе служб SQL Server Reporting Services в выпуске SQL Server 2016
