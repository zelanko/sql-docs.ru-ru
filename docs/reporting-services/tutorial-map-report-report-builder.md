---
title: "Учебник. Отчет-карта (построитель отчетов) | Microsoft Docs"
ms.custom: ""
ms.date: "08/31/2016"
...
## Требования  
Для работы с учебником сервер отчетов необходимо настроить для поддержки карт Bing в качестве фона. Дополнительные сведения см. в разделе [План поддержки отчетов-карт](http://msdn.microsoft.com/ru-ru/5ddc97a7-7ee5-475d-bc49-3b814dce7e19). 
...
2.  Дважды щелкните карту, чтобы отобразить панель **Слои карты**. На панели инструментов нажмите кнопку **Мастер создания слоя** ![rs_IconMapLayerWizard](../reporting-services/media/rs-iconmaplayerwizard.png "rs_IconMapLayerWizard"). 
...
2.  Дважды щелкните карту, чтобы отобразить панель **Слой карты**. На панели инструментов нажмите кнопку **Мастер создания слоя** ![rs_IconMapLayerWizard](../reporting-services/media/rs-iconmaplayerwizard.png "rs_IconMapLayerWizard").  
...
2.  Дважды щелкните карту, чтобы отобразить панель **Слой карты**. На панели инструментов нажмите кнопку **Добавить слой** ![rs_IconMapAddLayer](../reporting-services/media/rs-iconmapaddlayer.png "rs_IconMapAddLayer").  
...
2.  Дважды щелкните карту, чтобы отобразить панель **Слой карты**. На панели инструментов нажмите кнопку **Добавить слой** ![rs_IconMapAddLayer](../reporting-services/media/rs-iconmapaddlayer.png "rs_IconMapAddLayer"), а затем выберите **Слой точек**.  
