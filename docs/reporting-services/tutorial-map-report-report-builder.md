---
title: Руководство. Отчет-карта (построитель отчетов) | Документация Майкрософт
ms.date: 08/31/2016
...
ms.locfileid: "63041669"
---
# <a name="tutorial-map-report-report-builder"></a>Руководство. Отчет-карта (построитель отчетов)
