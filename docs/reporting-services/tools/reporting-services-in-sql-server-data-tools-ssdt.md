...
description: Узнайте, как использовать среду разработки конструктора отчетов SQL Server Data Tools в Microsoft Visual Studio с целью создания решений для Reporting Services.
ms.date: 05/30/2017
...
##  <a name="solutions-and-projects"></a><a name="bkmk_SolutionsandProjects"></a> Решения и проекты  
...
##  <a name="configurations"></a><a name="bkmk_Configurations"></a> Конфигурации  
...
##  <a name="report-server-projects"></a><a name="bkmk_ReportServerProjects"></a> Проекты «Сервер отчетов»  
...
##  <a name="report-designer-windows-and-panes"></a><a name="bkmk_ReportDesignerWindowsandPanes"></a> Окна и панели конструктора отчетов  
...
###  <a name="report-data-pane"></a><a name="bkmk_ReportDataPane"></a> Область данных отчета  
...
###  <a name="grouping-pane"></a><a name="bkmk_GroupingPane"></a> Панель группировки  
...
###  <a name="toolbox"></a><a name="bkmk_Toolbox"></a> Область элементов  
...
###  <a name="properties-pane"></a><a name="bkmk_PropertiesPane"></a> Панель «Свойства»  
...
###  <a name="output"></a><a name="bkmk_Output"></a> Вывод  
...
###  <a name="document-outline"></a><a name="bkmk_DocumentOutline"></a> Структура документа  
...
###  <a name="task-list"></a><a name="bkmk_TaskList"></a> Список задач  
...
##  <a name="report-designer-design-view"></a><a name="bkmk_ReportDesignerDesignView"></a> Представление конструктора в конструкторе отчетов  
...
##  <a name="report-designer-preview"></a><a name="bkmk_ReportDesignerPreview"></a> Средство предварительного просмотра в конструкторе отчетов  
...
##  <a name="report-designer-menus"></a><a name="bkmk_ReportDesignerMenus"></a> Меню конструктора отчетов  
...
###  <a name="format-menu"></a><a name="FormatMenu"></a> Меню «Формат»  
...
###  <a name="report-menu"></a><a name="ReportMenu"></a> Меню «Отчет»  
...
###  <a name="view-menu"></a><a name="ViewMenu"></a> Представление меню  
...
###  <a name="project-menu"></a><a name="ProjectMenu"></a> Меню «Проект»  
...
##  <a name="report-designer-toolbars"></a><a name="bkmk_ReportDesignerToolbars"></a> Панели инструментов конструктора отчетов  
...
##  <a name="source-control"></a><a name="bkmk_SourceControl"></a> Система управления версиями  
...
##  <a name="custom-report-templates"></a><a name="bkmk_CustomReportTemplates"></a> Пользовательские шаблоны отчетов  
...
##  <a name="command-line-support-for-sql-server-data-tools"></a><a name="bkmk_CommandLineSupportForssdt"></a> Поддержка командной строки для SQL Server Data Tools  
...
##  <a name="keyboard-shortcuts-in-reporting-services"></a><a name="bkmk_KeyboardShortcuts"></a> Сочетания клавиш в службах Reporting Services  
