---
title: "Инструментальные средства служб Reporting Services | Microsoft Docs"
ms.custom: ""
ms.date: "05/31/2016"
...
helpviewer_keywords: 
  ...
  - "компоненты [службы Reporting Services]"
  - "компоненты [службы Reporting Services], о компонентах"
  - "[службы Reporting Services], компоненты"
  - "SSRS, компоненты"
  - "отчеты [службы Reporting Services], инструменты"
  - "SQL Server Reporting Services, компоненты"
  - "SQL Server Reporting Services, инструменты"
  - "архитектура [службы Reporting Services]"
...
## Средства управления содержимым отчетов  
