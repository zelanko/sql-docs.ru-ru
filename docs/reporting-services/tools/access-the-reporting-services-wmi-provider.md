---
title: "Доступ к поставщику WMI для служб Reporting Services | Microsoft Docs"
ms.custom: ""
ms.date: "11/02/2016"
...
helpviewer_keywords: 
  - "поставщик WMI [службы Reporting Services]"
  - "программирование [службы Reporting Services]"
...
|-----------|---------------|-----------------|  
|MSReportServer_Instance|root\Microsoft\SqlServer\ReportServer\RS_*\<имя_закодированного_экземпляра>*\v13|Основные сведения, необходимые клиенту для подключения к установленному серверу отчетов.|  
|MSReportServer_ConfigurationSetting|root\Microsoft\SqlServer\ReportServer\RS_*\<имя_закодированного_экземпляра>*\v13\Admin|Представляет установочные параметры и параметры времени выполнения для экземпляра сервера отчетов. Эти параметры хранятся в файле конфигурации для сервера отчетов.<br /><br /> **\*\* Важно. \*\*** Этот класс доступен только для пользователей с правами администратора.|  
...
## Получение доступа к классам WMI Server с использованием PowerShell  
