...
description: Сведения о служебной программе rskeymgmt, которая управляет симметричным ключом, обеспечивающим защиту конфиденциальных данных сервера отчетов от несанкционированного доступа.
ms.date: 03/20/2017
...
## <a name="file-location"></a>Расположение файла  
 Программа Rskeymgmt.exe находится в каталоге **\<*drive*>:\Program Files\Microsoft SQL Server\110\Tools\Binn** или **\<*drive*>:\Program Files (x86)\Microsoft SQL Server\110\Tools\Binn**. Программу можно запустить из любой папки файловой системы.  
