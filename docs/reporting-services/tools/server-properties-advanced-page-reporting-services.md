...
**SupportedHyperlinkSchemes** ***(только сервер отчетов Microsoft Power BI)***. Задает разделенный запятыми список схем URI, которые можно определять для действий гиперссылок, разрешенных к обработке. Чтобы включить все схемы гиперссылок, укажите значение "&ast;". Например, значение "http,https" разрешает гиперссылки на "https://www. contoso.com", но удаляет гиперссылки на "mailto:bill@contoso.com" или "javascript:window.open(‘www.contoso.com’, ‘_blank’)". Значение по умолчанию — "&ast;".
