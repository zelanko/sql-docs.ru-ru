---
title: "Форматирование файла скрипта служб Reporting Services | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "скрипты [службы Reporting Services], форматы"
  - "форматы [службы Reporting Services], файлы скриптов"
