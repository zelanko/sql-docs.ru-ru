...
-   [Удаление объектов из каталога](../../reporting-services/tools/delete-catalog-items-management-studio.md)  
  
-   [Страница свойств задания](../../reporting-services/tools/job-properties-management-studio.md)  
