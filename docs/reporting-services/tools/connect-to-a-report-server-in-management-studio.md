---
title: "Подключение к серверу отчетов в среде Management Studio | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  ...
  - "подключения [службы Reporting Services], сервер отчетов"
  - "регистрация серверов отчетов"
  - "серверы отчетов [службы Reporting Services], регистрация"
...
3.  В диалоговом окне **Соединение с сервером** введите URL-адрес сайт SharePoint. В следующем примере показан синтаксис: http://\<веб сервер>/сайты/\<сайт>.  
...
|Сервер отчетов в режиме интеграции с SharePoint, подключенный через сайт SharePoint:<br /><br /> http://\<веб-сервер>/<SharePointSite>\>|Просмотр и задание свойств сервера и значений по умолчанию.<br /><br /> Просмотр и отмена заданий.<br /><br /> Создание и управление общими расписаниями, определенными для сайта, с которым установлено соединение.<br /><br /> Просмотр уровней разрешений, определенных для сайта, с которым установлено соединение.|Уровень разрешений «Полный доступ» на сайте SharePoint, с которым установлено соединение.|  
