---
title: "Примеры URL-адресов для элементов опубликованного отчета на сервере отчетов в режиме SharePoint (SSRS) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
|------------|-----------------|  
|Сервер SharePoint.|http://тестовый_сервер|  
|Сайт или дочерний сайт сервера SharePoint.|http://тестовый_сервер/сайт/дочерний_сайт|  
|Образец отчета Company Sales в папке **Общие документы** в развертывании [!INCLUDE[winSPServ](../../includes/winspserv-md.md)] или [!INCLUDE[SPF2010](../../includes/spf2010-md.md)] .|http://тестовый_сервер/тестовый_сайт/Общие%20документы/Company%20Sales.rdl|  
