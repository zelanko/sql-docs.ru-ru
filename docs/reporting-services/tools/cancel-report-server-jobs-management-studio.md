...
description: Узнайте, как использовать параметры в диалоговом окне "Отмена заданий сервера отчетов" для просмотра или отмены выполняющихся отчетов.
ms.date: 03/01/2017
