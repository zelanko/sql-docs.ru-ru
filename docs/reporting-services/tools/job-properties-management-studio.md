...
description: Сведения о странице свойств задания в SQL Server Management Studio, где можно просмотреть информацию о заданиях на сервере отчетов.
ms.date: 03/01/2017
