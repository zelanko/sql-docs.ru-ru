...
description: Узнайте о служебной программе rs.exe, которая позволяет управлять сервером отчетов программными средствами с помощью скриптов на языке Microsoft Visual Basic.
ms.date: 03/14/2017
