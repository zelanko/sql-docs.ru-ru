...
description: Узнайте о поддержке сценариев и использовании командлетов PowerShell для серверов отчетов в режиме интеграции с SharePoint в Reporting Services.
ms.date: 09/14/2015
