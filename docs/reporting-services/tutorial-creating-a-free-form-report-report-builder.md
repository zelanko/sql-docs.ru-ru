...
![Снимок экрана отчета в свободной форме построителя отчетов.](../reporting-services/media/report-builder-free-form-report-complete.png)
...
7.  Щелкните значок **Запуск** (!), чтобы запустить запрос.  
    ...
    ![Снимок экрана: конструктор запросов, отображающий данные, доступные для отображения в отчете в свободной форме построителя отчетов.](../reporting-services/media/report-builder-free-form-tutorial-data.png) 
...
2.  Щелкните внутри поля со списком, щелкните правой кнопкой мыши панель вверху списка и выберите пункт **Свойства табликса**.  
    ...
    ![Снимок экрана, показывающий параметр свойств табликса для отчета в свободной форме построителя отчетов.](../reporting-services/media/report-builder-free-form-tablix-properties.png) 
...
1.  На панели "Группы строк" щелкните правой кнопкой мыши группу подробностей, выберите пункт **Добавить группу** , а затем пункт **Родительская группа**.  
    ...
    ![Снимок экрана, показывающий, как добавить родительскую группу в отчет в свободной форме построителя отчетов.](../reporting-services/media/report-builder-free-form-add-parent-group.png)  
...
4.  Щелкните правой кнопкой мыши столбец "Территория" в списке и выберите команду **Удалить столбцы**.  
    ...
    ![Снимок экрана, показывающий, как удалить столбец из отчета в свободной форме построителя отчетов.](../reporting-services/media/report-builder-free-form-delete-columns.png)
...
![Снимок экрана: построитель отчетов покажет вертикальный рисунок, состоящий из светло-серого прямоугольника.](../reporting-services/media/report-builder-free-form-gray-rectangle.png)
...
4.  Перетащите поле `[Territory]` из ListDataSet в области "Данные отчета" в текстовое поле и поместите его после надписи "Информационный бюллетень для ".  
    ...
    ![Снимок экрана, показывающий, как перетащить поле «Территория» в отчет в свободной форме построителя отчетов.](../reporting-services/media/report-builder-free-form-territory-field.png)
...
24. [!INCLUDE[clickOK](../includes/clickok-md.md)]  
    ...
    ![Снимок экрана, показывающий текстовое поле в отчете в свободной форме построителя отчетов.](../reporting-services/media/report-builder-free-form-text-box.png)
...
31. Выберите поле со списком. Выделите две двусторонние стрелки и переместите их в верхнюю часть страницы.  
    ...
    ![Снимок экрана, показывающий, как перетащить список в отчете в свободной форме построителя отчетов.](../reporting-services/media/report-builder-drag-list.png)
...
![Снимок экрана, показывающий предварительный просмотр страницы бюллетеня из отчета в свободной форме построителя отчетов.](../reporting-services/media/report-builder-newsletter-page-preview.png)
...
12. Выбрав таблицу, в области **Группа строк** щелкните правой кнопкой мыши элемент **Сведения** > **Добавить итог** > **После**.  
    ...
    ![Снимок экрана, показывающий, как добавить итоги в отчете в свободной форме построителя отчетов.](../reporting-services/media/report-builder-free-form-table-totals.png)
  
13. Выделите ячейку в столбце Product и введите **Итого**.

    ![Снимок экрана: ячейка в столбце Product с итогом, введенным в него.](../reporting-services/media/report-builder-free-form-type-total.png)
...
![Снимок экрана, показывающий предварительный просмотр таблицы из отчета в свободной форме построителя отчетов.](../reporting-services/media/report-builder-free-form-with-table.png)
...
16. При необходимости сделайте область диаграммы выше путем перетаскивания.
     ...
     ![Снимок экрана, показывающий круговую диаграмму для добавления к отчету в свободной форме построителя отчетов.](../reporting-services/media/report-builder-free-form-pie.png)
...
15. Щелкните правой кнопкой мыши условные обозначения и выберите команду **Удалить условные обозначения**.  
    ...
    ![Снимок экрана, показывающий гистограмму для добавления к отчету в свободной форме построителя отчетов.](../reporting-services/media/report-builder-free-form-column.png)
...
1.  Выделите прямоугольник, который вы создали и в который добавили диаграммы ранее на этом занятии.  
    ...
    ![Снимок экрана, показывающий, как просмотреть свойство Name в отчете в свободной форме построителя отчетов.](../reporting-services/media/report-builder-free-form-rectangle-name.png) 
  
2.  Щелкните круговую диаграмму.  
  
3.  Проверьте, что свойство **Parent** на панели **Свойства** показывает имя прямоугольника.  
  
     ![Снимок экрана, показывающий, как просмотреть свойство Parent в отчете в свободной форме построителя отчетов.](../reporting-services/media/report-builder-free-form-pie-parent.png) 
