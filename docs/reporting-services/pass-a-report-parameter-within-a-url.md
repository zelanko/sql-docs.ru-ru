...
description: Сведения о том, как передавать параметры отчета непосредственно в подсистему обработки отчетов, включив их в URL-адрес отчета.
ms.date: 03/01/2017
