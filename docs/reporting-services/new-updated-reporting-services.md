...
1. [Журнал изменений для SQL Server Reporting Services](change-log-sql-server-reporting-services.md)
2. [Разработка с помощью API REST для служб Reporting Services](developer/rest-api.md)
3. [Веб-часть средства просмотра отчетов на сайте SharePoint](report-server-sharepoint/report-viewer-web-part-sharepoint-site.md)
4. [Параметры сайта SharePoint для веб-части "Средство просмотра отчетов"](report-server-sharepoint/report-viewer-web-part-sharepoint-site-settings.md)
...
1. [Установка служб SQL Server Reporting Services](#TitleNum_1)
2. [Развертывание веб-части "Средство просмотра отчетов" служб SQL Server Reporting Services на сайте SharePoint](#TitleNum_2)
...
### <a name="1-nbsp-install-sql-server-reporting-servicesinstall-windowsinstall-reporting-servicesmd"></a>1. &nbsp; [Установка служб Reporting Services на SQL Server](install-windows/install-reporting-services.md)
...
**Настройка вашего сервера отчетов**


После нажатия кнопки **Настроить сервер отчетов** в программе установки откроется **Диспетчер конфигурации сервера отчетов**. Дополнительные сведения см. в разделе [Report Server Configuration Manager--reporting-services-configuration-manager-native-mode.md).

Для завершения первоначальной настройки служб Reporting Services необходимо [create a report server database--ssrs-report-server-create-a-report-server-database.md). Для выполнения этого шага требуется сервер базы данных SQL Server.
...
Дополнительные сведения см. в разделе [Configure the report server service account--configure-the-report-server-service-account-ssrs-configuration-manager.md).
...
### <a name="2-nbsp-deploy-the-sql-server-reporting-services-report-viewer-web-part-on-a-sharepoint-sitereport-server-sharepointdeploy-report-viewer-web-partmd"></a>2. &nbsp; [Развертывание веб-части "Средство просмотра отчетов" служб SQL Server Reporting Services на сайте SharePoint](report-server-sharepoint/deploy-report-viewer-web-part.md)

*Обновлено: 30.11.2017* &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; ([Назад](#TitleNum_1))
