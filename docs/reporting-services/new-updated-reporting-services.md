...
1. [Журнал изменений для SQL Server Reporting Services](#TitleNum_1)
...
### <a name="1-nbsp-change-log-for-sql-server-reporting-serviceschange-log-sql-server-reporting-servicesmd"></a>1. &nbsp; [Журнал изменений для SQL Server Reporting Services](change-log-sql-server-reporting-services.md)

*Обновление: 27.04.2018* &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; ([Далее](#TitleNum_2))
...
- *Версия 14.0.600.744. Дата выпуска: 25 апреля 2018 г.*
    - Исправления ошибок:
...
- *Версия 14.0.600.689. Дата выпуска: 28 января 2018 г.*
    - Исправления ошибок:
...
*Обновлено: 10.04.2018* &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; ([Назад](#TitleNum_1))
