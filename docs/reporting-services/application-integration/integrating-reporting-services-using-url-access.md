---
title: "Интеграция отчетов служб с использованием URL | Документы Microsoft"
ms.custom: 
ms.date: 03/14/2017
...
## <a name="in-this-section"></a>В этом разделе  
 [Использование доступа по URL-адрес в веб-приложения](../../reporting-services/application-integration/integrating-reporting-services-using-url-access-web-application.md)  
