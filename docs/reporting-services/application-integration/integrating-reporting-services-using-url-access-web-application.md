...
description: Доступ по URL-адресам в Reporting Services специально разработан таким образом, чтобы можно было получить доступ по сети к отдельным отчетам.
ms.date: 03/16/2017
