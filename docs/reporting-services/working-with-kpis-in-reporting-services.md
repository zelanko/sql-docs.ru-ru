...
- Каковы минимальный размер достижение?  
...
| См. также | Возможность задать ссылку детализации. Эта ссылка может быть мобильного отчета, опубликованного на портале или пользовательский URL-адрес. |
...
При выборе **мобильный отчет**, можно выбрать в диалоговом окне назначения.

   ![Мобильный отчет](media/rscreatekpi-related-content-mobile-report.png)

Если теперь щелкнуть ключевого показателя Эффективности на портале, эскиз мобильного отчета отображается в области связанных содержимого раскрывающегося списка. Щелкнув эскиз вы прямого перехода к этому отчету.

Можно также указать пользовательский URL-адрес. Эта задача может быть любым: веб-сайт, на сайте SharePoint, URL-адрес, отчетом служб SSRS (которая позволит передавать параметры жестко закодировано).

![Пользовательский URL-адрес](media/rscreatekpi-related-content-custom-url.png)

Если теперь щелкнуть ключевого показателя Эффективности, URL-адрес отображается в области связанного содержимого.

Можно только добавить один мобильный отчет или один настраиваемый URL-адрес.
