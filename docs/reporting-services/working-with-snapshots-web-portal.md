---
title: "Работа моментальными снимками (веб-портал) | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
Вы можете управлять созданием моментальных снимков для отчета, нажав кнопку с многоточием **(...)** в отчета, выбрав **Управление** и **Кэширование** или **Моментальные снимки журнала**.  
