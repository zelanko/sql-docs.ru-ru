...
3. Из области **Данные отчета** перетащите поле `[Date]` на панель **Группы строк**. Поместите это поле над строкой **=(Сведения)**.
    ...
    >
    >![группа дат добавлена](media/rs-basictablegroups1design.png "группа дат добавлена")
...
5. Удалите исходные столбцы выражений `[Date]` и `[Order]` справа от двойной линии. Выберите маркеры двух столбцов, щелкните их правой кнопкой мыши и выберите **Удалить столбцы**. Конструктор отчетов удаляет выражения отдельных строк, поэтому отображаются только выражения группы.
    ...
    ![Выберите столбцы для удаления](media/rs-basictablegroupsdeletecols.gif "Выберите столбцы для удаления")
...
7. Щелкните **ОК**, чтобы применить форматирование.
   ...
   ![Режим конструктора: базовая таблица с итоговой суммой заказов](media/rs-basictablesumlinetotaldesign.gif "Режим конструктора: базовая таблица с итоговой суммой заказов")
...
5. Щелкните **ОК**, чтобы применить форматирование.
   ...
   ![Задание оранжевого цвета фона](media/rs-basictablesumdaytotaldesign.gif "rs_BasicTableSumDayTotalDesign")
...
5. Щелкните **ОК**, чтобы применить форматирование.
    ...
    ![Режим конструктора: итоговое значение в базовой таблице](media/rs-basictablesumgrandtotaldesign.gif "Режим конструктора: итоговое значение в базовой таблице")
