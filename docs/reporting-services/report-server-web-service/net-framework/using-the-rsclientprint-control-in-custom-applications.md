...
|--------------|----------|----------|-----------------|  
|ServerPath|В|Строка|Создает виртуальный каталог для сервера отчетов (например, `https://adventure-works/reportserver`).|  
