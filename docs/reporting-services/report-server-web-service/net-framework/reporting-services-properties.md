...
description: Сервер отчетов определяет глобальные системные свойства и свойства отдельных элементов. Приложения могут добавлять определяемые пользователем свойства к свойствам системы и элементов.
ms.date: 03/14/2017
