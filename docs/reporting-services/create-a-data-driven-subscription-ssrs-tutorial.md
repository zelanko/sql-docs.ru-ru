---
title: "Создание управляемой данными подписки (учебник по службам SSRS) | Microsoft Docs"
ms.custom: ""
ms.date: "05/26/2016"
...
applies_to: 
  - "SQL Server 2016"
helpviewer_keywords: 
  - "подписки [службы Reporting Services], учебники"
  - "пошаговые руководства [службы Reporting Services]"
