...
description: Узнайте, что такое поставщик WMI, как найти экземпляр сервера отчетов и как получить доступ к поставщику WMI программным способом.
ms.date: 11/02/2016
