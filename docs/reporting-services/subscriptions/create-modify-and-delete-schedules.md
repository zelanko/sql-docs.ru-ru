...
description: Создание, изменение и удаление общих расписаний Reporting Services. Для работы в собственном режиме используйте веб-портал или Management Studio. Для режима интеграции с SharePoint используйте приложение служб.
ms.date: 06/11/2019
...
## <a name="create-delete-or-modify-a-shared-schedule-web-portal"></a><a name="bkmk_native"></a> Создание, удаление или изменение общего расписания (веб-портал)
...
1. На веб-портале выберите на панели инструментов **Параметры** ![ssrs_portal_settings_gear](../../reporting-services/subscriptions/media/ssrs-portal-settings-gear.png).  

   >[!NOTE]  
   >Если кнопка **Параметры** недоступна, значит у вас нет разрешений на доступ к параметрам веб-сайта.  

1. Выберите **Свойства сайта** в раскрывающемся меню.
1. Выберите вкладку **Расписания** .
1. Щелкните **+ Новое расписание**. (Чтобы изменить существующее расписание, щелкните его имя.)
1. Введите описательное имя расписания.
1. Выберите **Час**, **День**, **Неделя**или **Месяц**. Щелкните **Однократно** , чтобы расписание сработало только один раз. Дополнительные настройки появляются после задания базовых параметров расписания.
1. Выберите дату запуска расписания (необязательно). Значением по умолчанию является текущая дата. Можно отложить запуск расписания, выбрав более позднюю дату.
1. Введите дату прекращения действия расписания (необязательно). При наступлении этой даты расписание прекращает работу, но не удаляется.
1. Выберите время для запуска расписания.
1. Щелкните **ОК**.

### <a name="to-delete-a-shared-schedule-web-portal"></a>Удаление общего расписания (веб-портал)

1. На веб-портале выберите на панели инструментов элементы **Параметры** ![ssrs_portal_settings_gear](../../reporting-services/subscriptions/media/ssrs-portal-settings-gear.png).
2. Выберите **Свойства сайта** в раскрывающемся меню.
3. Выберите вкладку **Расписания** .
4. Установите флажок рядом с общим расписанием, которое нужно удалить, и нажмите кнопку **Удалить**.

### <a name="create-delete-or-modify-a-shared-schedule--management-studio"></a>Создание, удаление и изменение общих расписаний (Management Studio)
...
## <a name="see-also"></a>См. также раздел
 ...
 [Кэширование отчетов (SSRS)](../../reporting-services/report-server/caching-reports-ssrs.md)  
