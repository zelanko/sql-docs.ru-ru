---
title: "Создание, изменение и удаление расписаний | Microsoft Docs"
ms.custom: ""
ms.date: "07/01/2016"
...
helpviewer_keywords: 
  ...
  - "общие расписания [службы Reporting Services]"
  - "изменение расписаний"
  - "исключение расписаний"
  - "общие расписания [службы Reporting Services], создание"
  - "общие расписания [службы Reporting Services], изменение"
  - "расписания [службы Reporting Services], удаление"
  - "удаление расписаний"
  - "расписания [службы Reporting Services], создание"
  - "расписания [службы Reporting Services], изменение"
  - "общие расписания [службы Reporting Services], удаление"
...
**Примечание.** Если вы не уверены, что общее расписание используется, удалите его в [!INCLUDE[ssManStudio](../../includes/ssmanstudio-md.md)] на веб-портале. [!INCLUDE[ssManStudio](../../includes/ssmanstudio-md.md)] предоставляет те же функции управления общим расписанием, что и диспетчер отчетов, но содержит дополнительную страницу «Отчеты» с именами всех отчетов, использующих общее расписание.  
 ...
 ## Удаление расписания, связанного с отчетами  
...
### Удаление общего расписания (веб-портал)  
...
### Создание, удаление и изменение общих расписаний (среда Management Studio)  
...
### Создание или изменение общего расписания (среда Management Studio)  
...
##### Удаление общего расписания (среда Management Studio)  
...
### Создание общих расписаний (режим интеграции с SharePoint)  
...
### Удаление общих расписаний (режим интеграции с SharePoint)  
