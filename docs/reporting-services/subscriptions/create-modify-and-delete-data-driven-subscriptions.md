...
description: Эта статья описывает, как создать, изменить и удалить управляемую данными подписку. Также здесь приведены советы по определению запроса для получения сведений о подписке.
ms.date: 06/12/2019
...
##  <a name="managing-and-deleting-a-data-driven-subscription"></a><a name="bkmk_manage_and_delete"></a> Управление управляемой данными подпиской и ее удаление  
...
##  <a name="creating-and-modifying-a-data-driven-subscription"></a><a name="bkmk_create_and_modify"></a> Создание и изменение управляемой данными подписки  
...
##  <a name="defining-a-query-that-retrieves-subscription-information"></a><a name="bkmk_define_query"></a> Определение запроса, который получает сведения о подписке  
...
##  <a name="running-the-subscription"></a><a name="bkmk_run_subscription"></a> Выполнение подписки  
