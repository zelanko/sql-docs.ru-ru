...
# <a name="create-modify-and-delete-data-driven-subscriptions"></a>Создание, изменение и удаление управляемых данными подписок
 ...
 Чтобы создать управляемую данными подписку или изменить существующую подписку, используйте **управление** > **подписок** страницы на веб-портале. **Подписок** странице приведены пошаговые инструкции, пошаговые инструкции для создания или изменения параметров подписки. Чтобы получить доступ к созданной подписке, используйте страницу **Мои подписки** или список "Подписки" в отчете. Сведения о создании управляемой данными подписки см. в разделе [Создание управляемой данными подписки (учебник по службам SSRS)](../../reporting-services/create-a-data-driven-subscription-ssrs-tutorial.md).  
...
1. На веб-портале, перейдите к папке, где находится отчет, щелкните правой кнопкой мыши отчет и выберите **управление** в раскрывающемся меню.  
  
2. Выберите вкладку **Подписки** .  
  
3. Выберите **+ Новая подписка** на **подписок** страницы.  
...
3. Установите флажок рядом с подпиской, вы хотите изменить и выберите **изменить**. Управляемые данными подписки будет иметь значение «управляемые данными» в **тип** столбца.  
...
## <a name="see-also"></a>См. также раздел  
 ...
 [Работа с подписками (веб-портал)](../../reporting-services/working-with-subscriptions-web-portal.md) [используйте Мои подписки (сервер отчетов собственный режим)](../../reporting-services/subscriptions/use-my-subscriptions-native-mode-report-server.md)  
