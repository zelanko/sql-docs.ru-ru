...
description: Сведения о том, как использовать модуль доставки библиотеки SharePoint в Reporting Services с помощью подписки со страницы приложения на сайте SharePoint.
ms.date: 03/14/2017
