---
title: "Доставка библиотек SharePoint в службах Reporting Services | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "интеграция с SharePoint [службы Reporting Services], доставка отчетов"
  - "доставка отчетов [службы Reporting Services]"
  - "подписки [службы Reporting Services], доставка библиотек SharePoint"
