---
title: "Отслеживание подписок служб Reporting Services  | Microsoft Docs"
ms.custom: ""
ms.date: "03/07/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "подписки [Reporting Services], неактивные"
  - "подписки [Reporting Services], состояние"
  - "отслеживание [Reporting Services], подписки"
  - "сведения о состоянии [службы Reporting Services]"
  - "неактивные подписки [службы Reporting Services]"
...
|\<*номер*> ошибка|Число уведомлений обработчика планирования и доставки о невозможности доставки или прекращении повторных попыток.|  
