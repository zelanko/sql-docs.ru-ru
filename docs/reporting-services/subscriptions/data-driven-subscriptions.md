...
description: Сведения об управляемых данными подписках, которые обеспечивают возможность использования данных динамической подписки, получаемых от внешнего источника данных во время выполнения.
ms.date: 05/20/2019
