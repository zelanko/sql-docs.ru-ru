---
title: "Использование PowerShell для смены и перечисления владельцев подписок служб Reporting Services и запуска подписки | Microsoft Docs"
ms.custom: ""
ms.date: "03/23/2017"
...
-   Вывод списка подписок: [перечисление ReadSubscription](../Topic/ReportOperation%20Enumeration.md) в отчете И пользователь является владельцем подписки ИЛИ ReadAnySubscription.  
...
-   Вывод списка подписок: ManageAlerts ИЛИ [CreateAlerts](https://technet.microsoft.com/library/microsoft.sharepoint.spbasepermissions.aspx) в отчете И пользователь является владельцем подписки и подписка является подпиской по времени.  
