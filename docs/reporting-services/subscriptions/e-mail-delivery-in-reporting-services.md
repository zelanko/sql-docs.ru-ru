---
title: "Доставка электронной почтой в службах Reporting Services | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "подписки [службы Reporting Services], электронная почта"
  - "электронная почта [службы Reporting Services]"
  - "почта [службы Reporting Services]"
...
## Параметры электронной почты, основанные на ролях, для основного режима  
