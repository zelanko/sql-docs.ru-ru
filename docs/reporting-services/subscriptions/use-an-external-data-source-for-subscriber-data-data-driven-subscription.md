---
title: "Использование внешнего источника данных подписчика (управляемая данными подписка) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "источники данных подписчика [службы Reporting Services]"
  - "подписки [службы Reporting Services], внешние источники данных"
  ...
  - "источники данных [службы Reporting Services], подписки"
...
## Настройка параметров доставки с помощью изменяющихся данных из базы данных подписчика  
