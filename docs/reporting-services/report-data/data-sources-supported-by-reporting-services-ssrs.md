...
|SQL Server 2016|15.00|15.00.01| 
 ...
 Также можно создавать модели на основе базы данных Teradata. Дополнительные сведения см. в следующем техническом документе на веб-сайте Teradata: [Службы Microsoft SQL Server 2012 Reporting Services и корпорация Teradata](https://www.teradata.com/white-papers/Microsoft-SQL-Server-2012-Reporting-Services-and-Teradata-Corporation/?type=WP).  
