...
description: Узнайте, как обновлять источники данных, встроенные в отчеты, и совместно используемые источники данных, сохраненные в библиотеке документов SharePoint.
ms.date: 03/01/2017
