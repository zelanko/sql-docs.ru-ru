---
title: Тип соединения ODBC | Документация Майкрософт
description: В этой статье о типе соединения OLE DB вы узнаете, как создать источник данных.
ms.date: 03/17/2017
