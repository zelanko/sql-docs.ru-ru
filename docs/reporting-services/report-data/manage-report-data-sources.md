---
title: "Управление источниками данных отчета | Microsoft Docs"
ms.custom: ""
ms.date: "03/17/2017"
...
helpviewer_keywords: 
  ...
  - "опубликованные отчеты [службы Reporting Services], подключения к источникам данных"
  - "общие источники данных [службы Reporting Services]"
  - "источники данных [службы Reporting Services], управление"
...
|Добавление свойств соединения с источником данных в файл определения отчета (RDL).|конструктор отчетов|[Создание внедренного или общего источника данных (службы SSRS)](../Topic/Create%20an%20Embedded%20or%20Shared%20Data%20Source%20\(SSRS\).md)|  
...
|Создание на сервере отчетов совместно используемого элемента источника данных.|Диспетчер отчетов|[Создание, удаление или изменение общего источника данных (диспетчер отчетов)](../Topic/Create,%20Delete,%20or%20Modify%20a%20Shared%20Data%20Source%20\(Report%20Manager\).md)|  
