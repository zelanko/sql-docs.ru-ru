...
description: Узнайте, как определить параметры запроса в конструкторе запросов многомерных выражений для Analysis Services.
ms.date: 03/14/2017
...
4.  В столбце **Параметр** щелкните **\<Enter Parameter>** , а затем введите имя параметра.  
