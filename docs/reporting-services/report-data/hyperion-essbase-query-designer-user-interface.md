...
description: Узнайте, как использовать пользовательский интерфейс конструктора запросов Hyperion Essbase для получения данных при обработке отчета.
ms.date: 03/01/2017
...
|![Удаление](../../reporting-services/report-data/media/rsqdicon-delete.gif "DELETE")|Удаление выбранного элемента из запроса. Используйте эту кнопку для удаления выбранных строк в панели «Фильтр».|  
