...
description: Сведения о типе соединения Analysis Services для многомерных выражений (SSRS), позволяющем получать метаданные для использования в качестве данных отчета.
ms.date: 03/17/2017
