---
title: "Использование ODC-файла подключения к данным Office в отчетах (службы Reporting Services в режиме интеграции с SharePoint) | Microsoft Docs"
ms.custom: ""
ms.date: "03/23/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "файлы подключения к данным Office (ODC)"
  - "интеграция с SharePoint [Reporting Services], общие источники данных"
  - "ODC-файлы"
...
13. Чтобы выбрать файл и сохранить изменения, дважды нажмите кнопку [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)]ОК******.  
