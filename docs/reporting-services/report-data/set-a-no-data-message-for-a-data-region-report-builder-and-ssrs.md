---
title: Установка сообщения об отсутствии данных для области данных (построитель отчетов) | Документация Майкрософт
description: Узнайте, как настроить сообщение об отсутствии данных, которое будет отображаться в отчете, готовом к просмотру, вместо пустой области данных.
ms.date: 03/03/2017
