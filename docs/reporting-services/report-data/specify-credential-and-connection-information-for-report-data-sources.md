---
title: "Задание учетных данных и сведениях о соединении для источников данных отчета | Microsoft Docs"
ms.custom: ""
ms.date: "03/17/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "параметр «без учетных данных» [службы Reporting Services]"
  - "олицетворение [службы Reporting Services]"
  - "олицетворение пользователя [службы Reporting Services]"
  ...
  - "автоматическая обработка отчетов [службы Reporting Services]"
  - "отчеты [службы Reporting Services], безопасность"
  ...
  - "запрашиваемые учетные данные [службы Reporting Services]"
  - "несколько соединений"
  - "сохраненные учетные данные [службы Reporting Services]"
  - "безопасность [службы Reporting Services], источники данных"
  - "встроенная безопасность Windows [службы Reporting Services]"
...
-   Учетные данные источника данных, введенные в [диалоговом окне "Свойства источника данных" — "Учетные данные" (построитель отчетов)](../Topic/Data%20Source%20Properties%20Dialog%20Box,%20Credentials%20\(Report%20Builder\).md) для внедренного источника данных.  
...
-   Учетные данные источника данных, указанные в [диалоговом окне "Ввод учетных данных для источника данных" (построитель отчетов)](../../reporting-services/report-data/enter-data-source-credentials-dialog-box-report-builder.md) при выполнении запроса набора данных, обновлении полей набора данных или предварительном просмотре отчета.  
 ...
 Дополнительные сведения см. в разделе [Диалоговое окно "Свойства источника данных" — "Общие" (построитель отчетов)](../Topic/Data%20Source%20Properties%20Dialog%20Box,%20General%20\(Report%20Builder\).md) и [Предварительный просмотр отчетов в построителе отчетов](../../reporting-services/report-builder/previewing-reports-in-report-builder.md).  
