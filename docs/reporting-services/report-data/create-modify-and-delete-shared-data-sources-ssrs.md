---
title: "Создание, изменение и удаление общих источников данных (SSRS) | Microsoft Docs"
ms.custom: ""
ms.date: "03/17/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "изменение свойств источников данных"
  - "общие источники данных [службы Reporting Services]"
  - "удаление общих источников данных"
  - "роли [Reporting Services], общие источники данных"
  - "источники данных [службы Reporting Services], общие"
  - "источники данных [Reporting Services], изменение свойств"
  - "удаление общих источников данных"
...
# Создание, изменение и удаление общих источников данных (SSRS)
 ...
 ![Значок общего источника данных](../../reporting-services/report-data/media/hlp-16datasource.png "Значок общего источника данных")  
...
## Создание и изменение общих источников данных  
 ...
 **Создание общего источника данных в диспетчере отчетов**  
 ...
 **Изменение общего источника данных в диспетчере отчетов**  
...
1.  В диспетчере отчетов перейдите на страницу **Содержимое** и выполните одну из следующих последовательностей действий.  
...
## Импорт общих источников данных  
...
## Общие источники данных в SharePoint  
