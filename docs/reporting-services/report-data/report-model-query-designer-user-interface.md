...
|Results pane|Отображает результаты запроса. Чтобы выполнить запрос, щелкните правой кнопкой мыши любую область и выберите команду **Выполнить** либо нажмите кнопку **Выполнить** (![Выполнить запрос](../../reporting-services/report-data/media/rsqdicon-run.gif "Выполнить запрос")) на панели инструментов.|  
...
|![Отменить действие](../../reporting-services/report-data/media/rsqdicon-undo.gif "Отменить действие")|Отменить последнее действие.|  
|![Повторить действие](../../reporting-services/report-data/media/rsqdicon-redo.gif "Повторить действие")|Повторить последнее действие.|  
...
## <a name="see-also"></a>См. также:  
 ...
 [Подключение к модели отчета (службы SSRS)](../../reporting-services/report-data/report-model-connection-ssrs.md)   
