---
title: "Сообщить модели пользовательский интерфейс конструктора запросов | Документы Microsoft"
ms.custom: 
ms.date: 03/01/2017
...
|Панель результатов|Отображает результаты запроса. Чтобы выполнить запрос, щелкните правой кнопкой мыши любую область и нажмите кнопку **запуска**, или нажмите кнопку **запуска** (![выполните запрос](../../reporting-services/report-data/media/rsqdicon-run.gif "выполните запрос")) на панели инструментов.|  
...
## <a name="text-based-query-designer"></a>Текстовый конструктор запросов  
 ...
 ![Конструктор запросов на языке семантических моделей общего](../../reporting-services/report-data/media/rsqd-dsawmodel-smql-generic.gif "конструктор запросов на языке семантических моделей общего")  
