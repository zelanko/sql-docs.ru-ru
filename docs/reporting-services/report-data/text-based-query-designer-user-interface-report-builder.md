---
title: "Текстовый пользовательский интерфейс конструктора запросов (построитель отчетов) | Документы Microsoft"
ms.custom: 
ms.date: 03/14/2017
...
|![Выполните запрос](../../reporting-services/report-data/media/rsqdicon-run.gif "выполнения запроса")|Выполнить запрос и показать результирующий набор в панели результатов.|  
...
### <a name="command-type-storedprocedure"></a>Тип команды StoredProcedure  
 ...
 ![Хранимая процедура в конструкторе запросов на основе текста](../../reporting-services/report-data/media/rs-relational-text-sp.gif "хранимой процедуры в конструкторе запросов на основе текста")  
