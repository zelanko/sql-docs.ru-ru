---
title: Тип подключения к Hyperion Essbase | Документация Майкрософт
description: Узнайте, как извлечь многомерные данные из внешнего источника данных Hyperion Essbase, чтобы включить их в отчет.
ms.date: 03/17/2017
...
##  <a name="query-parameters"></a><a name="Parameters"></a> Параметры запроса  
