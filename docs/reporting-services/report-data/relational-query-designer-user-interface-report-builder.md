...
description: Узнайте, как использовать графический конструктор запросов для просмотра метаданных, интерактивного создания запроса, а также для просмотра его результатов.
ms.date: 03/14/2017
...
#### <a name="group-and-aggregate"></a>Группировка и агрегатная обработка.  
 ...
 Дополнительные сведения о [!INCLUDE[tsql](../../includes/tsql-md.md)] см. в [Справочнике по Transact-SQL &#40;компонент Database Engine&#41;](../../t-sql/language-reference.md).  
