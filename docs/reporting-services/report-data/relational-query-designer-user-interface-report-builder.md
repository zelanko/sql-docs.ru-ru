---
title: "Пользовательский интерфейс конструктора реляционных запросов (построитель отчетов) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  ...
  - "доступ к данным, конструктор запросов"
