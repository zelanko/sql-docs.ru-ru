...
description: Узнайте, как использовать конструктор запросов к спискам SharePoint для просмотра метаданных списка SharePoint, интерактивного создания запроса, а также для просмотра его результатов.
ms.date: 03/14/2017
