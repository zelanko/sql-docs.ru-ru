---
title: "Синтаксис пути к элементу для XML-данных отчета (SSRS) | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "синтаксис ElementPath"
  - "XML [службы Reporting Services], получение данных"
...
|**Элемент**|Значение именованного подэлемента. Например, Customers {}/Customer {}/LastName извлекает значения только для элемента LastName.|  
...
|Порядок|Qty|Идентификатор|FirstName|LastName|Customer.ID|xmlns|  
|-----------|---------|--------|---------------|--------------|-----------------|-----------|  
...
|FirstName|LastName|Идентификатор|  
|---------------|--------------|--------|  
|Bobby|Moore|11|  
|Crystal|Hu|20|  
|Wyatt|Diaz|33|  
...
|Order.ID|FirstName|LastName|Идентификатор|  
|--------------|---------------|--------------|--------|  
|1|Bobby|Moore|11|  
|2|Bobby|Moore|11|  
|8|Crystal|Hu|20|  
