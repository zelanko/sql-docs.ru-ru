---
title: "Средства проектирования запросов (SSRS) | Microsoft Docs"
ms.custom: ""
ms.date: "03/20/2017"
...
helpviewer_keywords: 
  ...
  - "конструктор запросов многомерных выражений [службы Reporting Services]"
  ...
  - "обычный конструктор запросов. См. текстовый конструктор запросов"
  - "службы Reporting Services, конструкторы запросов"
  - "семантические запросы [службы Reporting Services]"
...
## См. также  
 ...
 [Создание внедренного или общего источника данных (службы SSRS)](../Topic/Create%20an%20Embedded%20or%20Shared%20Data%20Source%20\(SSRS\).md)  
