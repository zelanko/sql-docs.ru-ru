---
title: "Сервер отчетов служб Reporting Services (режим SharePoint) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
-   [Добавление дополнительного сервера отчетов в ферму (горизонтально масштабируемые службы SSRS)](../../reporting-services/install-windows/add-an-additional-report-server-to-a-farm-ssrs-scale-out.md).  
 ...
 Сведения о новых возможностях данного выпуска см. в подразделе "SharePoint" раздела [Новые возможности служб Reporting Services (SSRS)](../Topic/What's%20New%20in%20Reporting%20Services%20\(SSRS\).md).  
