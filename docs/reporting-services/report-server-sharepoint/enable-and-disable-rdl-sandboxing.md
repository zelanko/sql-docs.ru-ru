...
description: С помощью песочницы для языка определения отчетов можно определять и ограничивать использование типов ресурсов клиентами, где несколько клиентов используют одну веб-ферму серверов отчетов.
ms.date: 09/25/2017
...
|**MaxResourceSize**|Максимально допустимый размер внешнего ресурса (КБ).<br /><br /> Значение по умолчанию: 100|  
...
|**MaxArrayResultLength**|Максимальное число элементов для возвращаемого значения выражения языка определения отчетов, допустимое в массиве.<br /><br /> Значение по умолчанию: 100|  
...
|**Участники**|Для списка типов, включенных в элемент **\<Types>** , представляет список имен членов, запрещенных в выражениях языка определения отчетов.|  
...
-   метод **New** в [!INCLUDE[vbprvb](../../includes/vbprvb-md.md)];  
