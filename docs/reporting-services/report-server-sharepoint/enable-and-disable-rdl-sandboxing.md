---
title: "Включение и отключение &#171;песочницы&#187; для языка определения отчетов | Microsoft Docs"
ms.custom: ""
ms.date: "03/20/2017"
...
|**AllowNew**|Логический атрибут элемента **Allow**, указывающий, разрешено ли создание новых экземпляров этого типа в выражениях языка определения отчетов или в элементах языка определения отчетов **\<Class>**.<br /><br /> Примечание. Если режим **RDLSandboxing** включен, то новые массивы не могут создаваться в выражениях языка определения отчетов, независимо от значения **AllowNew**.|  
...
-   метод **New** [!INCLUDE[vbprvb](../../includes/vbprvb-md.md)];  
