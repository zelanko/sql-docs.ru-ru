---
title: "Веб-часть средства просмотра отчетов на сайте SharePoint | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
# Веб-часть средства просмотра отчетов на сайте SharePoint
 ...
 ![Веб-часть средства просмотра отчетов](../../reporting-services/report-server-sharepoint/media/rs-sharepointrvwebpart.gif "Веб-часть средства просмотра отчетов")  
