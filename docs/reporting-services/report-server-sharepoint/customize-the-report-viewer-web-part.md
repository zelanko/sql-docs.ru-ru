---
title: "Настройка веб-части средства просмотра отчетов | Microsoft Docs"
ms.custom: ""
ms.date: "03/07/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "интеграция с SharePoint [службы Reporting Services], просмотр отчетов"
  - "веб-части [службы Reporting Services]"
...
---
# Настройка веб-части средства просмотра отчетов
...
### Изменение значений свойств по умолчанию  
...
### Настройка средства просмотра отчетов, внедренного в веб-страницу  
...
### Пользовательские свойства веб-части средства просмотра отчетов  
...
|Отображение кнопки веб-канала ATOM|Показывает или скрывает кнопку веб-канала ATOM на панели инструментов.<br /><br /> ![htmlviewer_datafeed](../../reporting-services/media/htmlviewer-datafeed.png "htmlviewer_datafeed")|  
