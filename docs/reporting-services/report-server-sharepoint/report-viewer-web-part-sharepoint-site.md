---
title: "Веб-часть \"Средство просмотра отчетов\" на сайте SharePoint | Документы Майкрософт"
ms.custom: 
ms.date: 09/25/2017
...
---
# <a name="report-viewer-web-part-on-a-sharepoint-site"></a>Веб-часть "Средство просмотра отчетов" на сайте SharePoint
