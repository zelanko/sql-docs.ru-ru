---
title: "Добавить веб-части средства просмотра отчетов на веб-страницу | Документы Microsoft"
ms.custom: 
ms.date: 03/07/2017
...
---
# <a name="add-the-report-viewer-web-part-to-a-web-page"></a>добавить на веб-страницу веб-часть средства просмотра отчетов
