...
description: SQL Server Reporting Services позволяют интегрировать среду отчетов с продуктом SharePoint для использования возможностей совместной работы, предоставляемых сайтами SharePoint.
ms.date: 08/17/2018
