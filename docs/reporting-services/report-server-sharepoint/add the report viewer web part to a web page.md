---
title: "добавить на веб-страницу веб-часть средства просмотра отчетов (службы Reporting Services в режиме интеграции с SharePoint) | Microsoft Docs"
ms.custom: ""
ms.date: "03/23/2017"
...
manager: "erikre"
---
# добавить на веб-страницу веб-часть средства просмотра отчетов (службы Reporting Services в режиме интеграции с SharePoint)
...
### Внедрение отчета на веб-страницу  
