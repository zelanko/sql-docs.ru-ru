...
## <a name="1c-organize-drillthrough-report-data-into-groups"></a><a name="DLayout"></a>1в. Организация данных детализированного отчета в группы  
...
## <a name="1d-add-drillthrough-report-subtotals-and-totals"></a><a name="DTotals"></a>1г. Добавление подытогов и итогов детализированного отчета  
...
## <a name="5-set-hidden-parameter-property"></a><a name="DParameter"></a>5. Задание свойства «Скрытый» для параметра  
...
## <a name="1a-add-embedded-data-source"></a><a name="MConnection"></a>1a. Добавление внедренного источника данных  
...
## <a name="1b-create-embedded-dataset"></a><a name="MMDXQuery"></a>1б. Создание внедренного набора данных  
...
## <a name="1c-organize-main-report-data-into-groups"></a><a name="MLayout"></a>1в. Организация данных основного отчета в группы  
При выборе полей для группирования данных создается матрица со строками и столбцами, отображающими подробные и агрегированные данные.  
...
## <a name="1d-add-main-report-subtotals-and-totals"></a><a name="MTotals"></a>1г. Добавление подытогов и итогов основного отчета  
...
## <a name="5-set-internal-parameter-property"></a><a name="MParameter"></a>5. Задание свойства «Внутренний» для параметра  
