...
description: Узнайте, как расширить возможности обработки данных в Reporting Services путем настройки данных отчета, механизмов уведомления и систем безопасности.
ms.date: 03/14/2017
