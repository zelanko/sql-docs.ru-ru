...
description: Обеспечение пользовательской безопасности с помощью платформы разработки Reporting Services API для расширения системы безопасности Reporting Services.
ms.date: 03/14/2017
