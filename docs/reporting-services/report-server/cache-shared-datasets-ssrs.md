---
title: "Общий набор данных в кэше (служба SSRS) | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
## Кэширование общих наборов данных  
 ...
 Можно указать, как долго данные должны храниться в кэше до истечения срока их действия. Дополнительные сведения см. в разделе [Страница "Кэширование", "Общие наборы данных" (диспетчер отчетов)](../Topic/Caching%20Page,%20Shared%20Datasets%20\(Report%20Manager\).md).  
...
-   Необходимо иметь разрешения ReadPolicy и UpdatePolicy на общий набор данных.  
 ...
 Планы обновления кэша применяются и к общим наборам данных, и к отчетам. Дополнительные сведения см. в разделе [Параметры обновления кэша (диспетчер отчетов)](../Topic/Cache%20Refresh%20Options%20\(Report%20Manager\).md).  
