...
description: Узнайте больше о журналах трассировки в Reporting Services, которые содержат подробные сведения об операциях службы сервера отчетов.
