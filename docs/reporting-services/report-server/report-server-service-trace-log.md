---
title: "Журнал трассировки службы сервера отчетов | Microsoft Docs"
ms.custom: ""
ms.date: "03/16/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "журналы [службы Reporting Services], трассировка"
  - "трассировки [службы Reporting Services]"
  - "сведения о системе [службы Reporting Services]"
  - "версии [службы Reporting Services]"
