---
title: "Управление сервером отчетов служб Reporting Services в собственном режиме | Microsoft Docs"
ms.custom: ""
ms.date: "03/17/2017"
...
helpviewer_keywords: 
  ...
  - "серверы отчетов [службы Reporting Services], настройка"
...
### Основная конфигурация  
 ...
 [Настройка учетной записи службы (диспетчер конфигурации служб SSRS)](../Topic/Configure%20a%20Service%20Account%20\(SSRS%20Configuration%20Manager\).md)  
...
### Дополнительные или необязательные параметры настройки  
 ...
 Описывает дополнительные шаги, которые необходимо выполнить для соединения с сервером отчетов или диспетчером отчетов по URL-адресу http://localhost.  
