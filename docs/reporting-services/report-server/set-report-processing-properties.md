...
# <a name="set-report-processing-properties"></a>Установка свойств обработки отчетов
 ...
 Чтобы задать свойства выполнения отчета, перейдите к отчету на веб-портале, щелкните правой кнопкой мыши отчет и выберите **управление** из раскрывающегося меню.
