---
title: "Переименование компьютера, на котором установлен сервер отчетов | Microsoft Docs"
ms.custom: ""
ms.date: "03/20/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "переименование серверов отчетов"
...
---
# Переименование компьютера, на котором установлен сервер отчетов
...
## Переименование компонента SQL Server Database Engine  
