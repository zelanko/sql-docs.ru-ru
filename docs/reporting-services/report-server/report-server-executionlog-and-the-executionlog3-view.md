---
title: "Журнал выполнения сервера отчетов и представление ExecutionLog3 | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "журналы [службы Reporting Services], выполнение"
  - "журналы выполнения [службы Reporting Services]"
