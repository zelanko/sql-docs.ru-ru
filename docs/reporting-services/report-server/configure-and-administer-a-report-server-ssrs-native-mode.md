---
title: "Настройка и администрирование сервера отчетов (службы Reporting Services в собственном режиме) | Microsoft Docs"
ms.custom: ""
ms.date: "03/18/2017"
...
helpviewer_keywords: 
  ...
  - "развертывание [Reporting Services], параметры компонента"
  - "серверы отчетов [Reporting Services], параметры компонента"
  - "параметры конфигурации [службы Reporting Services]"
  - "администрирование служб Reporting Services"
  - "компоненты [службы Reporting Services], настройка"
  - "настройка серверов [службы Reporting Services]"
