...
description: Сведения об администрировании развертывания Reporting Services, включая резервное копирование и восстановление баз данных сервера отчетов и управление ключами шифрования.
ms.date: 03/14/2017
