---
title: "Домены приложений для приложений сервера отчетов | Microsoft Docs"
ms.custom: ""
ms.date: "03/20/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "домены приложений [службы Reporting Services]"
  - "повторное использование доменов приложений"
