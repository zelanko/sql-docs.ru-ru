---
title: "Управление содержимым сервера отчетов (службы Reporting Services в собственном режиме) | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "03/01/2017"
...
helpviewer_keywords: 
  ...
  - "опубликованные отчеты [службы Reporting Services], управление"
  - "серверы отчетов [службы Reporting Services], управление содержимым"
  - "управление содержимым [службы Reporting Services]"
