...
##  <a name="bkmk_sum"></a> Сводка по собственному режиму  
...
##  <a name="bkmk_referenceimage"></a> Создание ссылки на ресурс с изображением из отчета  
