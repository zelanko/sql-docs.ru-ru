---
title: "Обработка больших отчетов | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "обработка отчетов [службы Reporting Services], большие отчеты"
  - "разрывы страниц [службы Reporting Services]"
  - "большие отчеты"
  - "размер [SQL Server], отчеты"
  - "распространение отчетов [службы Reporting Services], большие отчеты"
...
## Рекомендации по подготовке к просмотру  
