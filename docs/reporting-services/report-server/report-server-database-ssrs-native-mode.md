...
description: Узнайте, как установка Reporting Services в собственном режиме разделяет постоянное хранилище данных и временное хранилище данных на две базы данных.
ms.date: 06/06/2019
