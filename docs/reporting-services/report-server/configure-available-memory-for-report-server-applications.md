...
#### <a name="about-aspnet-memory-configuration-settings"></a>Сведения о параметрах конфигурации памяти ASP.NET  
 Несмотря на то, что 2016 и более поздних версий отчетов сервера веб-службы и веб-портал — это приложения HTML5, предыдущие версии, [!INCLUDE[vstecasp](../../includes/vstecasp-md.md)] приложений, они не реагируют на параметры конфигурации памяти, указываемые в **processModel**  раздел файла Machine.config для [!INCLUDE[vstecasp](../../includes/vstecasp-md.md)] приложений, работающих в IIS 5.0 и более поздней версии режим совместимости. [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] считывают параметры конфигурации памяти только из файла RSReportServer.config.  
