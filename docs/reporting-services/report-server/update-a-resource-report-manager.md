...
4.  Выберите страницу **Свойства**, а затем щелкните **Заменить**.  
  
5.  В диалоговом окне **Открыть** перейдите в каталог, содержащий файл, который вы намерены добавить в качестве ресурса.  
...
7.  Щелкните **Открыть**, чтобы передать файл ресурса, и сохраните изменения на сервере отчетов.  
