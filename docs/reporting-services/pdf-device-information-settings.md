...
|**EmbedFonts**|Позволяет указать, нужно ли вставить шрифты в PDF-файл. Размер файла будет больше, но шрифты отчета будут правильно отображаться для всех клиентов. Если указать значение **None**, внедрение шрифтов будет отключено.|  
