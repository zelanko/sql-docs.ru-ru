...
description: Узнайте подробнее о настройках сведений об устройстве для подготовки отчетов Reporting Services к просмотру в формате PPTX.
ms.date: 09/11/2015
