---
title: "Учебник. Добавление линейчатой диаграммы к отчету (построитель отчетов) | Microsoft Docs"
ms.custom: ""
ms.date: "06/15/2016"
...
---
# Учебник. Добавление линейчатой диаграммы к отчету (построитель отчетов)
...
4.  [Изменение порядка сортировки по вертикальной оси](#Sort)  
  
5.  [Перемещение условных обозначений](#Legend)  
  
6.  [Задание заголовка для диаграммы](#ChartTitle)  
