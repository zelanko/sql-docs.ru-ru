---
title: Руководство. Добавление линейчатой диаграммы к отчету (построитель отчетов) | Документация Майкрософт
ms.date: 06/15/2016
...
ms.locfileid: "63041189"
---
# <a name="tutorial-add-a-bar-chart-to-your-report-report-builder"></a>Руководство. Добавление линейчатой диаграммы в отчет (построитель отчетов)
...
## <a name="ChartType"></a>2. Создание линейчатой диаграммы  
...
## <a name="AllValues"></a>3. Отображение всех имен на вертикальной оси  
...
## <a name="Sort"></a>4. Изменение порядка сортировки по вертикальной оси  
