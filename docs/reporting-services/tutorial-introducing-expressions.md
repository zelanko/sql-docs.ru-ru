---
title: "Учебник. Общие сведения о выражениях | Microsoft Docs"
ms.custom: ""
ms.date: "09/16/2016"
...
### Форматирование цветных прямоугольников
...
3.  В окне свойств данных щелкните **Использовать набор данных, внедренный в отчет**.  
...
5.  В диалоговом окне **Выражение** разверните узел **Общие функции** и выберите **Дата и время**.  
...
13. В списке **Категория** еще раз щелкните **Дата и время**, а затем в списке **Элемент** дважды щелкните **Now**.  
