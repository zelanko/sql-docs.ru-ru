...
description: Узнайте, как обеспечить еще один уровень защиты от недопустимых запросов с помощью соответствующей обработки исключений, используя блоки try/catch.
ms.date: 03/06/2017
