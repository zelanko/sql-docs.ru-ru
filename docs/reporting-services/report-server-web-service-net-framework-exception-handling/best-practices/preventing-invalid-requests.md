...
description: Узнайте, как предотвратить недопустимые запросы, проведя анализ потока работы приложения и убедившись в том, что все запросы, направляемые на сервер отчетов, являются допустимыми.
ms.date: 03/16/2017
