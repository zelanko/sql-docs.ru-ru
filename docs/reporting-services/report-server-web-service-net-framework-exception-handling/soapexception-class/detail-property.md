 ...
 **ProductVersion**  
 Версия [!INCLUDE[ssRSnoversion](../../../includes/ssrsnoversion-md.md)]. Максимальная длина составляет 15 символов. Формат номера версии должен быть следующим: 8.00.0xxx.00.  
