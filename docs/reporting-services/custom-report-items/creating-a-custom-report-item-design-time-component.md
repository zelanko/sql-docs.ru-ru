...
description: Узнайте, как создать компонент времени разработки пользовательского элемента отчета. Этот компонент предоставляет активированную область конструктора, которая может принимать операции перетаскивания.
ms.date: 03/14/2017
