...
description: Узнайте, как настроить внешний вид веб-портала для вашего бизнеса с помощью пакета фирменной символики. Пакет фирменной символики разработан таким образом, чтобы для его использования не требовались глубокие знания CSS.
ms.topic: conceptual
author: maggiesMSFT
ms.author: maggies
...
![Снимок экрана: диалоговое окно "Выбор цветовой палитры".](../reporting-services/media/ssrsbrandingmobilereportpublisher.png)  
...
2.  Выберите пункт **Настройки сайта**.  
    ...
    ![Снимок экрана: раскрывающийся список "Параметры" с выделенным параметром "Параметры сайта".](../reporting-services/media/ssrsgearmenu.png)  
  
3.  Выберите раздел **Фирменная символика**.  
  
    ![Снимок экрана: страница "Параметры сайта" с выбранным параметром "Фирменная символика".](../reporting-services/media/ssrsbranding.png) 
