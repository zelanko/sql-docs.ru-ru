---
title: "Обновление и перенос служб Reporting Services | Microsoft Docs"
ms.custom: ""
ms.date: "08/18/2016"
...
helpviewer_keywords: 
  ...
  - "службы SQL Server Reporting Services (SSRS), обновление"
...
##  <a name="bkmk_side_by_side"></a> Параллельная установка  
 [!INCLUDE[ssRSCurrent](../../includes/ssrscurrent-md.md)] Собственный режим можно установить параллельно с развертыванием служб [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] или в собственном режиме [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)].  
...
-   Ознакомьтесь с требованиями, чтобы определить, поддерживает ли оборудование и программное обеспечение службы [!INCLUDE[ssRSCurrent](../../includes/ssrscurrent-md.md)]. Дополнительные сведения см. в разделе [Требования к оборудованию и программному обеспечению для установки SQL Server 2016](../../sql-server/install/hardware-and-software-requirements-for-installing-sql-server-2016.md).  
...
-   Создайте резервную копию симметричного ключа. Дополнительные сведения см. в разделе [Резервное копирование и восстановление ключей шифрования служб Reporting Services](../../reporting-services/install-windows/back-up-and-restore-reporting-services-encryption-keys.md).  
...
4.  Программа установки создает новые папки для программных файлов [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]. К числу программных папок для установки служб [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] относится MSRS13.\<*имя_экземпляра*>.  
...
### [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] в [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]  
 ...
 **Конечная среда:** [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)], SharePoint 2013 или SharePoint 2016.   
...
### [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] в [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]  
...
### [!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)] в [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]  
...
-   Собственный режим: см. статью [Резервное копирование и восстановление ключей шифрования служб Reporting Services](../../reporting-services/install-windows/back-up-and-restore-reporting-services-encryption-keys.md)  
