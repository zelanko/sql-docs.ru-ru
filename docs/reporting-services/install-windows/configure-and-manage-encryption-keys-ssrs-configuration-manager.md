---
title: "Настройка ключей шифрования и управление ими (диспетчер конфигурации служб SSRS) | Microsoft Docs"
ms.custom: ""
ms.date: "03/23/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "ключи шифрования [службы Reporting Services]"
  - "закрытые ключи [службы Reporting Services]"
  - "криптография [службы Reporting Services]"
  - "симметричные ключи [службы Reporting Services]"
  - "шифрование [службы Reporting Services]"
  - "открытые ключи [службы Reporting Services]"
