---
title: "Инициализация сервера отчетов (диспетчер конфигурации служб SSRS) | Microsoft Docs"
ms.custom: ""
ms.date: "03/23/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "серверы отчетов [службы Reporting Services], инициализация"
  - "процесс инициализации [службы Reporting Services]"
  - "проверка инициализаций сервера отчетов"
  - "масштабные развертывания [службы Reporting Services]"
  - "инициализация серверов отчетов [службы Reporting Services]"
  - "проверка инициализаций сервера отчетов"
