...
## <a name="encryption-functionality-in-reporting-services"></a>Возможности шифрования в службах Reporting Services  
 ...
 Кроме того, начиная с 2019, базу данных сервера отчетов можно настроить с помощью прозрачное шифрование данных в SQL Server, чтобы обеспечить дополнительную защиту для неактивных данных.
