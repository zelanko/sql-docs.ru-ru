---
title: "Резервирование URL-адресов при развертывании сервера отчетов на нескольких экземплярах (диспетчер конфигурации служб SSRS) | Microsoft Docs"
ms.custom: ""
ms.date: "03/23/2017"
...
manager: "erikre"
---
# Резервирование URL-адресов при развертывании сервера отчетов на нескольких экземплярах (диспетчер конфигурации служб SSRS)
...
|Именованный (МойИменованныйЭкземпляр)|http://+:80/reportserver_МойИменованныйЭкземпляр|  
