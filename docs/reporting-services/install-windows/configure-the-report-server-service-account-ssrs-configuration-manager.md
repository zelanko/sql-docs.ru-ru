...
| **Групповая управляемая учетная запись службы (gMSA)** | Автономные управляемые учетные записи служб впервые появились в Windows Server 2008 R2 и Windows 7. Они являются управляемыми учетными записями в домене, которые обеспечивают автоматическое управление паролями и упрощенное управление именами участников служб, включая делегирование управления другим администраторам. **Групповая управляемая учетная запись службы** предоставляет те же функциональные возможности в домене, но расширяет эту функциональность на несколько серверов. |
