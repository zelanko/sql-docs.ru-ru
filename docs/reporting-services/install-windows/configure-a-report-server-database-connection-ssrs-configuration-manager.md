---
title: "Настройка подключения к базе данных сервера отчетов (диспетчер конфигурации служб Reporting Services) | Microsoft Docs"
ms.custom: ""
ms.date: "05/31/2016"
...
helpviewer_keywords: 
  ...
  - "соединения [службы Reporting Services]"
  - "серверы отчетов [службы Reporting Services], подключения"
  - "база данных сервера отчетов"
  - "базы данных [службы Reporting Services], подключения"
  - "безопасность [службы Reporting Services], подключения баз данных"
