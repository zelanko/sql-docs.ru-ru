---
title: "Использование диспетчера конфигурации служб Reporting Services (собственный режим) | Microsoft Docs"
ms.custom: ""
ms.date: "06/01/2016"
...
helpviewer_keywords: 
  ...
  - "компоненты [службы Reporting Services], средство настройки служб Reporting Services"
