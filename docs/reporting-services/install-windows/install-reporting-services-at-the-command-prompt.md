---
title: "Установка служб Reporting Services из командной строки | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "08/15/2016"
...
---
# Установка служб Reporting Services из командной строки
...
## См. также:  
 ...
 [Параметры SysPrep](../../database-engine/install-windows/install-sql-server-2016-from-the-command-prompt.md#SysPrep)   
 [Установка Power Pivot из командной строки](http://msdn.microsoft.com/ru-ru/7f1f2b28-c9f5-49ad-934b-02f2fa6b9328)  
