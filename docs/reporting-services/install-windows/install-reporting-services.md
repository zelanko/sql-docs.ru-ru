...
- [Установка сервера отчетов служб Reporting Services в основном режиме](install-reporting-services-native-mode-report-server.md)
...
- [Установка служб Reporting Services из командной строки](../../reporting-services/install-windows/install-reporting-services-at-the-command-prompt.md)
...
[Новые возможности служб Reporting Services](http://msdn.microsoft.com/en-us/bc909063-6b84-4b3a-80d2-e93fc04b4b9d)  
