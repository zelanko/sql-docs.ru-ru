---
title: "Обновление базы данных сервера отчетов | Microsoft Docs"
ms.custom: ""
ms.date: "03/15/2017"
 ...
 **Режим SharePoint:** в режиме интеграции служб [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)][!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] с SharePoint база данных сервера отчетов фактически является коллекцией баз данных, созданных для каждого экземпляра приложения службы [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)].  
...
#### Обновление базы данных в собственном режиме с помощью скриптов  
 Для обновления базы данных сервера отчетов можно использовать скрипты WMI. Дополнительные сведения см. в статье [Метод GenerateDatabaseUpgradeScript (WMI MSReportServer_ConfigurationSetting)](../../reporting-services/wmi-provider-library-reference/generatedatabaseupgradescript-method-wmi-msreportserver-configurationsetting.md).  
...
## См. также:  
 ...
 [Мастер изменения базы данных (диспетчер конфигураций)](../Topic/Change%20Database%20Wizard%20\(Configuration%20Manager\).md)   
