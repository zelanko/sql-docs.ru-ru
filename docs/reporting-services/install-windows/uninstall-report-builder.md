---
title: "Удаление построителя отчетов | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
### Удаление построителя отчетов с панели управления  
...
### Удаление построителя отчетов из командной строки  
