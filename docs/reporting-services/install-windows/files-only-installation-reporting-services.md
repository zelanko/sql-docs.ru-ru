---
title: "Установка в режиме &#171;только файлы&#187; (службы Reporting Services) | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "установка только файлов [службы Reporting Services]"
...
---
# Установка в режиме &#171;только файлы&#187; (службы Reporting Services)
...
## Случаи, в которых следует выбирать режим «только файлы»  
...
## Установка в режиме «только файлы»  
...
#### Пример скрипта командной строки  
...
#### Мастер установки  
 При выборе служб [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] на странице выбора компонентов программа установки открывает страницу настройки служб [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)], позволяя указать режим установки. Чтобы выбрать установку в режиме "только файлы", на странице настройки службы [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] выберите параметр **Установить, но не настраивать сервер отчетов**.  
