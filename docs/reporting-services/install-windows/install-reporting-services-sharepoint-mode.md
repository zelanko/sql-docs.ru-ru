---
title: "Установка режима интеграции с SharePoint для служб Reporting Services | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "06/01/2016"
...
helpviewer_keywords: 
  ...
  - "установка служб Reporting Services, режим интеграции с SharePoint"
...
## В этом разделе  
 ...
 [Настройка электронной почты для приложения служб Reporting Services (SharePoint 2013 и SharePoint 2016)](http://msdn.microsoft.com/ru-ru/38fc34a6-aae7-4dde-9ad2-f1eee0c42a9f)  
