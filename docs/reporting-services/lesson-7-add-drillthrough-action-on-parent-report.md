---
title: "Занятие 7. Добавление операции детализации к родительскому отчету | Microsoft Docs"
ms.custom: ""
ms.date: "05/18/2016"
...
---
# Занятие 7. Добавление операции детализации к родительскому отчету
...
### Добавление действия детализации в родительский отчет  
...
5.  В разделе **Указать отчет** введите имя дочернего отчета.  
    ...
    > [!NOTE] Не включайте в имя отчета расширение файла.  
