...
description: Узнайте, как добавить параметр к отчету Reporting Services с разбивкой на страницы, чтобы его читатели могли фильтровать данные по одному или нескольким значениям.
ms.date: 03/14/2017
...
ms.locfileid: "93043782"
---
# <a name="tutorial-add-a-parameter-to-your-report-report-builder"></a>Руководство по Добавление параметра к отчету (построитель отчетов)
...
![Снимок экрана, показывающий, что в отчет с разбивкой на страницы можно добавить параметр.](../reporting-services/media/report-builder-parameter-tutorial.png)
...
## <a name="1-create-a-matrix-report-and-dataset-in-the-table-or-matrix-wizard"></a><a name="Setup"></a>1. Создание матричного отчета и набора данных с помощью мастера таблицы или матрицы  
...
## <a name="3-add-a-query-parameter-to-create-a-report-parameter"></a><a name="Query"></a>3. Добавьте параметр запроса, чтобы создать параметр отчета  
...
## <a name="4-change-default-data-type-and-other-properties-for-a-report-parameter"></a><a name="ChangeDefaultProperties"></a>4. Изменение типа данных по умолчанию и других свойств параметра отчета  
...
## <a name="4a-add-a-dataset-to-provide-available-values-and-display-names"></a><a name="AddDataset"></a>4а. Добавление набора данных для отображения значений и отображаемых имен  
...
## <a name="4b-specify-available-values-to-show-in-a-list"></a><a name="AvailableValues"></a>4б. Указание доступных значений, отображаемых в списке 
...
## <a name="4c-specify-a-default-value"></a><a name="DefaultValues"></a>4в. Указание значения по умолчанию 
...
## <a name="4d-look-up-a-namevalue-pair"></a><a name="NameValue"></a>4г. Поиск пары "имя-значение"  
...
6.  Измените **знак равенства** (=) на **IN** в предложении [!INCLUDE[tsql](../includes/tsql-md.md)] **WHERE** в последней строке запроса:  
...
19. В раскрывающемся списке снимите флажок **Выбрать все** , чтобы очистить список, установите флажки "Contoso Catalog Store" и "Contoso Asia Online Store", а затем нажмите кнопку **Просмотр отчета**.  
    ...
    ![Снимок экрана, на котором показано, что можно выбрать несколько параметров для добавления в отчет.](../reporting-services/media/report-builder-parameter-multiselect.png)
  
 
## <a name="8-add-a-boolean-parameter-for-conditional-visibility"></a><a name="Boolean"></a>8. Добавление логического параметра для обеспечения условной видимости  
