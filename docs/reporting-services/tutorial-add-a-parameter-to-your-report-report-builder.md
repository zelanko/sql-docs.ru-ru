---
title: "Учебник. Добавление параметра к отчету (построитель отчетов) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
2.  [Упорядочение данных и выбор макета в мастере](#CompleteWizard)  
...
4.  [Изменение типа данных по умолчанию и других свойств параметра отчета](#ChangeDefaultProperties)  
    ...
    2.  [Указание доступных значений, отображаемых в списке](#AvailableValues)  
  
    3.  [Указание значения по умолчанию](#DefaultValues)  
  
    4.  [Поиск пары "имя-значение"](#NameValue)  
...
6.  Нажмите кнопку **Выполнить** для предварительного просмотра отчета. Средство просмотра отчетов выводит запрос **Идентификатор магазина:** для параметра *@StoreID*.  
...
Для параметра *@StoreID* в средстве просмотра отчетов отображается значение "Contoso North America Online Store", так как это первое значение в результирующем наборе для набора данных **Stores**. Отчет отображает число продаж цифровых фотоаппаратов в магазине с идентификатором **199**.  
...
*  [Функция Lookup](../reporting-services/report-design/lookup-function-report-builder-and-ssrs.md)   
