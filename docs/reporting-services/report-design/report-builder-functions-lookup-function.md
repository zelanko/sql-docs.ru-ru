---
title: Функция Lookup (построитель отчетов) | Документация Майкрософт
description: Используйте функцию Lookup для возврата первого совпадающего значения для заданного имени из набора данных, содержащего пары "имя-значение".
ms.date: 03/07/2017
