...
description: Ознакомьтесь со способами использования линий, цветов, областей данных и изображений в построителе отчетов. Визуально привязывайте элементы друг к другу для улучшения удобочитаемости в построителе отчетов.
ms.date: 03/01/2017
...
## <a name="see-also"></a>См. также:  
 ...
 [Диалоговое окно "Заливка" (построитель отчетов и службы SSRS)](/previous-versions/sql/)  
