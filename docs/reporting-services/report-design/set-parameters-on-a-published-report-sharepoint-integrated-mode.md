...
description: Узнайте, как с помощью построителя отчетов задать параметры в определении отчета или после публикации отчета, а затем запустить параметризованный отчет.
ms.date: 03/07/2017
