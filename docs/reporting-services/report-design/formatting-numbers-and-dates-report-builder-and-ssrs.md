...
# <a name="formatting-numbers-and-dates-report-builder-and-ssrs"></a>Форматирование чисел и дат (построитель отчетов и службы SSRS)
 ...
 Диаграммная область данных обычно используется для отображения дат на оси категорий (x) и значений на оси значений (y). Чтобы задать формат для диаграммы, щелкните правой кнопкой мыши ось и выберите **Свойства оси**. На оси значений можно задать формат только для чисел. Дополнительные сведения см. в разделе [Formatting Axis Labels on a Chart &#40;Report Builder and SSRS&#41;](../../reporting-services/report-design/formatting-axis-labels-on-a-chart-report-builder-and-ssrs.md).  
