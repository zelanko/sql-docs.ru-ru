---
title: "Форматирование меток оси в виде значений даты или валюты (построитель отчетов и службы SSRS) | Microsoft Docs"
ms.custom: ""
ms.date: "03/03/2017"
...
## Форматирование меток оси X как месячных интервалов  
...
## Форматирование меток оси Y с помощью формата валюты  
