---
title: "Добавление действия &quot;Развернуть&quot; или &quot;Свернуть&quot; к элементу (построитель отчетов и службы SSRS) | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
2.  Щелкните правой кнопкой в любом месте строки заголовка панели "Группирование" и выберите **Дополнительно**. Режим панели «Группирование» включается для показа базовой структуры отображения строк и столбцов в области конструктора.  
     ...
     ![Панель группировки с меню "Расширенный режим"](../../reporting-services/report-design/media/groupingpane-advancedmode.png "Панель группировки с меню "Расширенный режим"")  
