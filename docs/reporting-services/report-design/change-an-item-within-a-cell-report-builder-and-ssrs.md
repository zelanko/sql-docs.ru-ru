...
description: Замена элемента, не являющегося контейнером, такого как текстовое поле, линия или изображение, в отчетах с разбивкой на страницы с помощью нового элемента отчета в построителе отчетов.
ms.date: 03/01/2017
