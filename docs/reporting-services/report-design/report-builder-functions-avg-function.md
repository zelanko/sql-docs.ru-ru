---
title: "Функция AVG (построитель отчетов и службы SSRS) | Документы Microsoft"
ms.custom: 
ms.date: 03/07/2017
...
---
# <a name="report-builder-functions---avg-function"></a>Функции построителя - отчета Avg, функция
 ...
 *expression*  
 (**Float**) Выражение, к которому применяется статистическая обработка.  
