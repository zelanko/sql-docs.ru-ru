...
description: Управление отображением многоугольников, линий и точек путем установки параметров и правил или переопределения параметров для внедренных элементов карты в построителе отчетов.
ms.date: 03/07/2017
