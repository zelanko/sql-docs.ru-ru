...
description: Узнайте, как использовать точечные диаграммы со значениями, представленными положением точек на диаграмме, для сравнения статистических данных по категориям в построителе отчетов.
ms.date: 03/03/2017
