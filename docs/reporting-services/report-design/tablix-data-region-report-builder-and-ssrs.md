---
title: Область данных табликса (построитель отчетов) | Документация Майкрософт
description: Узнайте, как отобразить данные отчета с разбивкой на страницы в ячейках. В построителе отчетов упорядочите данные в строки и столбцы с областью данных табликса.
ms.date: 03/07/2017
