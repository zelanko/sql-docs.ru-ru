---
title: "Эффекты рельефа, объемные и другие эффекты в диаграмме (построитель отчетов и службы SSRS) | Microsoft Docs"
ms.custom: ""
ms.date: "03/23/2017"
...
manager: "erikre"
---
# Эффекты рельефа, объемные и другие эффекты в диаграмме (построитель отчетов и службы SSRS)
...
## Координатные трехмерные диаграммы  
...
### Изменение пустого пространства в объемной диаграмме  
...
### Изменение проекции объемной диаграммы  
