---
title: "Детализация, углубленная детализация, вложенные отчеты и вложенные области данных (построитель отчетов и службы SSRS) | Microsoft Docs"
ms.custom: ""
ms.date: "03/23/2017"
...
|Характерная особенность|вложенном отчете|углубленной детализацией|вложена|  
|-----------|---------------|------------------|------------|  
