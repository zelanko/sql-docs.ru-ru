---
title: "настроить параметры опубликованного отчета (службы Reporting Services в режиме интеграции с SharePoint) | Microsoft Docs"
ms.custom: ""
ms.date: "03/23/2017"
...
helpviewer_keywords: 
  ...
  - "параметры отчета [службы Reporting Services]"
...
manager: "erikre"
---
# настроить параметры опубликованного отчета (службы Reporting Services в режиме интеграции с SharePoint)
