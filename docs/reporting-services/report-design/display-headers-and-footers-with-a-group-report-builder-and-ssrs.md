...
## <a name="see-also"></a>См. также:  
 [Ячейки области данных Табликса, строк и столбцов (построитель отчетов) и службы SSRS](/sql-docs/docs/reporting-services/report-design/tablix-data-region-report-builder-and-ssrs)   
