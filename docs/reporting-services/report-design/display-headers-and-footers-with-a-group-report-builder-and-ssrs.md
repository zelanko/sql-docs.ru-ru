---
title: "Отображение верхних и нижних колонтитулов в группе (построитель отчетов и службы SSRS) | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
# Отображение верхних и нижних колонтитулов в группе (построитель отчетов и службы SSRS)
 ...
 Чтобы повторять все заголовки столбцов или строк на многих страницах, можно задать свойства для области данных табликса. Дополнительные сведения см. в разделе [Отображение заголовков строк и столбцов на нескольких страницах (построитель отчетов и службы SSRS)](https://msdn.microsoft.com/library/dd207045.aspx).  
...
### Сохранение статической строки вместе с набором динамических строк, связанных с группой строк  
...
### Сохранение статической строки вместе с набором динамических столбцов, связанных с группой столбцов  
...
## См. также:  
 [Ячейки, строки и столбцы области данных табликса (построитель отчетов и службы SSRS)](https://msdn.microsoft.com/library/dd220587.aspx)   
