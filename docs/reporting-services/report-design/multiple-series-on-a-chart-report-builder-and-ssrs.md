---
title: "Несколько рядов на диаграмме (построитель отчетов и службы SSRS) | Microsoft Docs"
ms.custom: ""
ms.date: "03/07/2017"
...
## Использование нормированных диаграмм и диаграмм с накоплением  
...
## Использование вспомогательной оси  
...
## Использование областей диаграммы  
...
## Использование диаграмм диапазонов  
