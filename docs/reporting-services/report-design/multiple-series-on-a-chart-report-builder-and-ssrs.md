...
description: Узнайте, как использовать несколько рядов на диаграмме при отображении двух связанных рядов данных в построителе отчетов, таких как цена и объем, доходы и налоги.
ms.date: 03/07/2017
