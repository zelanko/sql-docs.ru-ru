---
title: Добавление фонового изображения (построитель отчетов) | Документация Майкрософт
description: Узнайте, как внедрить изображение в определение отчета, чтобы добавить его к различным элементам отчета, включая текстовые поля, списки и верхний колонтитул страницы.
ms.date: 03/01/2017
