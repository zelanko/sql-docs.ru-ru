---
title: "Линейчатые диаграммы (построитель отчетов и службы SSRS) | Microsoft Docs"
ms.custom: ""
ms.date: "03/03/2017"
...
---
# Линейчатые диаграммы (построитель отчетов и службы SSRS)
...
## Условия применения данных для линейчатых диаграмм  
