---
title: Форматирование меток оси на диаграмме (построитель отчетов) | Документация Майкрософт
description: Узнайте, как форматировать метки осей на диаграмме с помощью диалогового окна или области свойств в построителе отчетов, чтобы классифицировать и отображать связи.
ms.date: 03/03/2017
...
-   Выберите параметр **Скалярная ось** в диалоговом окне **Свойства оси** . При этом на ось, не содержащую значения группирования данных, будут добавлены числовые значения (либо значения дата-время). Дополнительные сведения см. в разделе [Диалоговое окно "Свойства оси" — "Параметры оси" (построитель отчетов и службы SSRS)](https://msdn.microsoft.com/library/b276e210-7a12-48ae-971b-7dabae51df11).  
