---
title: Таблицы, матрицы и списки (построитель отчетов) | Документация Майкрософт
description: Узнайте о таблицах, матрицах и списках — областях данных табликса, которые отображают данные отчета с разбивкой на страницы, упорядоченные по строкам и столбцам в построителе отчетов.
ms.date: 03/14/2017
...
##  <a name="matrix"></a><a name="Matrix"></a> Матрица  
...
##  <a name="list"></a><a name="List"></a> Список  
...
##  <a name="building-and-configuring-a-table-matrix-or-list"></a><a name="BuildingConfiguringTableMatrixList"></a> Построение и настройка таблицы, матрицы или списка  
