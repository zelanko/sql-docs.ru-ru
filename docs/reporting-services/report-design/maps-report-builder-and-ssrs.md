---
title: "Карты (построитель отчетов и службы SSRS) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
-   **Отчеты галереи карт.** Пространственные данные внедряются в отчеты, находящиеся в коллекции карт. По умолчанию программной папкой коллекции карт является *\<диск>*:\Program Files\Microsoft SQL Server\Report Builder \MapGallery.  
