---
title: Карты (построитель отчетов) | Документация Майкрософт
description: Узнайте, как добавить карту в отчет с разбивкой на страницы, отображающий бизнес-данные в географическом контексте, в построителе отчетов.
ms.date: 08/17/2018
...
##  <a name="adding-a-map-to-your-report"></a><a name="Process"></a> Добавление карты к отчету  
...
##  <a name="adding-data-to-a-map"></a><a name="AddingData"></a> Добавление данных на карту  
...
-   **Отчеты галереи карт.** Пространственные данные внедряются в отчеты, находящиеся в коллекции карт. По умолчанию программной папкой коллекции карт является *\<drive>* :\Program Files\Microsoft SQL Server\Report Builder\MapGallery.  
...
-   Из источника пространственных данных:  
    ...
    -   **Name** (Имя). . Поле, содержащее название города.  
...
##  <a name="understanding-the-map-viewport"></a><a name="Viewport"></a> Основные сведения об окне просмотра карты  
...
##  <a name="adding-a-bing-map-tiles-layer"></a><a name="TileLayer"></a> Добавление мозаичного слоя Bing map  
...
-   Мозаичный тип. Поддерживаются следующие стили:  
    ...
    -   **Гибридная среда**. Отображает сочетание стилей **Дорожный** и **Воздушный** .  
...
##  <a name="understanding-map-layers-and-map-elements"></a><a name="MapLayers"></a> Основные сведения о слоях карты и элементах карты  
...
##  <a name="understanding-map-legends-color-scale-and-distance-scale"></a><a name="Legends"></a> Основные сведения об условных обозначениях, цветовой шкале и шкале расстояний  
...
##  <a name="troubleshooting-maps"></a><a name="Troubleshooting"></a> Устранение неполадок карт  
