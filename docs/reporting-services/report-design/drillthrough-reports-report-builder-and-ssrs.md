---
title: Детализированные отчеты (построитель отчетов) | Документация Майкрософт
description: Обнаружение детализированных отчетов, которые открываются при выборе ссылки в отчете для получения сведений об элементе в исходном сводном отчете в построителе отчетов.
ms.date: 03/07/2017
