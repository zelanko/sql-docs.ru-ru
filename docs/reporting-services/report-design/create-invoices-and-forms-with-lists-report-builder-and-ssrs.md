---
title: "Создание счета-фактуры и формы со списками (построитель отчетов и службы SSRS) | Microsoft Docs"
ms.custom: ""
ms.date: "03/07/2017"
...
##  <a name="AddingList"></a> Добавление списка к отчету  
 ...
 ![Элемент отчета «Новый список» в области конструктора](../../reporting-services/report-design/media/rs-listtemplatenew.png "Элемент отчета «Новый список» в области конструктора")  
  
 При выборе списка в области конструктора появляются маркеры строки и столбца, как показано на следующем рисунке.  
  
 ![Элемент «Новый список» добавлен с панели элементов и выделен](../../reporting-services/report-design/media/rs-listtemplatenewselected.png "Элемент «Новый список» добавлен с панели элементов и выделен")  
