...
##  <a name="adding-a-list-to-your-report"></a><a name="AddingList"></a> Добавление списка к отчету  
...
##  <a name="displaying-data-in-a-free-form-layout"></a><a name="DisplayingLayout"></a> Отображение данных в макете свободной формы  
...
##  <a name="displaying-data-with-one-level-of-grouping"></a><a name="DisplayingGrouping"></a> Отображение данных с одним уровнем группирования  
