---
title: "Добавление в диаграмму стилей рельефа, приподнятости и текстуры (построитель отчетов и службы SSRS) | Microsoft Docs"
ms.custom: ""
ms.date: "03/23/2017"
...
>  На одной диаграмме не могут применяться объемный и рельефный или приподнятый стили. Если для диаграммы включен объемный стиль, свойство PieDrawingStyle не будет выводиться.  
 ...
 ![Круговая диаграмма, нарисованная вогнутым стилем](../../reporting-services/report-design/media/rs-piedrawingeffects-concave.png "Круговая диаграмма, нарисованная вогнутым стилем")  
