...
description: Узнайте, как использовать параметры в выражениях для настройки данных и внешнего вида отчета на основе выбора пользователя в построителе отчетов.
ms.date: 03/07/2017
