---
title: "Функция CountDistinct (построитель отчетов и службы SSRS) | Документы Microsoft"
ms.custom: 
ms.date: 03/07/2017
...
---
# <a name="report-builder-functions---countdistinct-function"></a>Функции построителя - отчета CountDistinct, функция
