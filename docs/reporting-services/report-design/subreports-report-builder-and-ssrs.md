...
description: Отображение отчета внутри другого отчета. Отображение и сохранение обоих отчетов в одной папке сервера в построителе отчетов.
ms.date: 03/07/2017
