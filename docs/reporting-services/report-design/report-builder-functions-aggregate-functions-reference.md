---
title: Справочник по агрегатным функциям (построитель отчетов) | Документация Майкрософт
description: Чтобы включить в отчет статистические значения, используйте в выражениях в построителе отчетов встроенные агрегатные функции.
ms.date: 03/07/2017
