---
title: Функция LookupSet (построитель отчетов) | Документация Майкрософт
description: Сведения о функции LookupSet, которая возвращает набор совпадающих значений для заданного имени из набора данных, содержащего пары "имя-значение".
ms.date: 03/07/2017
