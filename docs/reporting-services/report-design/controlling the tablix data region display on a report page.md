---
title: "Управление отображением области данных табликса на странице отчетов (построитель отчетов и службы SSRS) | Microsoft Docs"
ms.custom: ""
ms.date: "03/23/2017"
...
## Управление внешним видом данных  
...
## Управление расположением области данных табликса и ее расширением на странице  
...
## Управление подготовкой к просмотру области данных табликса на странице  
...
## Управление подготовкой к просмотру групп строк и столбцов табликса  
