...
description: Узнайте о том, сколько страниц будет в отчете с разбиением на странице и как на этих страницах размещаются элементы отчета в построителе отчетов.
ms.date: 12/16/2019
