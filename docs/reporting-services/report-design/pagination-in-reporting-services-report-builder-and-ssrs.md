---
title: "Разбиение на страницы в службах Reporting Services (построитель отчетов и службы SSRS) | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
### Поля  
 ...
 ![Физическая ст��аница с полями и полезной областью.](../../reporting-services/report-design/media/rspagemargins.gif "Физическая ст��аница с полями и полезной областью.")  
