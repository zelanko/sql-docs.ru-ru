---
title: Разбиение на страницы (построитель отчетов и службы SSRS) | Документация Майкрософт
description: Разбиение на страницы определяет, сколько страниц будет в отчете и как на этих страницах размещаются элементы отчета. Разбиение на страницы в Reporting Services выполняется модулем подготовки отчетов, который вы применяете для просмотра и доставки отчета.
ms.date: 12/16/2019
...
### <a name="margins"></a>Поля  
 ...
 ![Физическая страница с полями и используемой областью.](../../reporting-services/report-design/media/rspagemargins.gif "Физическая страница с полями и используемой областью.")  
