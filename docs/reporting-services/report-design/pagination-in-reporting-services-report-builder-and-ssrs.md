---
title: "Разбиение на страницы в службах Reporting Services (построитель отчетов и службы SSRS) | Документы Microsoft"
ms.custom: 
ms.date: 03/01/2017
...
### <a name="margins"></a>Поля  
 ...
 ![Физическая страница с полями и может использоваться области. ] (../../reporting-services/report-design/media/rspagemargins.gif "Физической страницы, с полями и может использоваться области.")  
