---
title: "Пользовательский код и ссылок на сборки в выражениях в конструкторе отчетов (службы SSRS) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "элементы [службы Reporting Services], выражения"
  - "данные [службы Reporting Services], выражения"
  - "выражения [службы Reporting Services], о выражениях"
  - "выражения [службы Reporting Services]"
  - "службы SSRS, выражения"
  - "формулы [службы Reporting Services]"
  - "управление данными [службы Reporting Services]"
  - "службы SQL Server Reporting Services, выражения"
...
##  <a name="Common"></a> Включение ссылок к наиболее часто используемым функциям  
 Для просмотра упорядоченного по категориям списка часто используемых функций, встроенных в службы [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)], используется диалоговое окно **Выражение**. При развертывании **Общие функции** и щелчке по категории в панели **Элемент** отображается список функций, включенных в выражение. Общие функции включают классы из пространств имен <xref:System.Math> и <xref:System.Convert> [!INCLUDE[dnprdnshort](../../includes/dnprdnshort-md.md)] и функций библиотеки времени выполнения [!INCLUDE[vbprvb](../../includes/vbprvb-md.md)]. Для удобства существует просмотр в диалоговом окне **Выражение** наиболее часто используемых функций, где они перечислены по категориям: текст, дата и время, математические, проверка, выполнение программы, статистическая обработка, финансовые, преобразование и прочие. Менее часто используемые функции не отображаются в списке, но тем не менее могут использоваться в выражении.  
