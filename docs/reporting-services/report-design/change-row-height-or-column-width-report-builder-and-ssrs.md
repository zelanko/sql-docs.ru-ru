---
title: "Изменение высоты строки или ширины столбца (построитель отчетов и службы SSRS) | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
### Для изменения высоты строки перемещением маркеров строки  
...
### Для изменения высоты строки настройкой параметров ячейки  
...
2.  На отображаемой вкладке **Свойства** , измените свойство **Высота** , а затем щелкните где-нибудь за пределами вкладки **Свойства** .  
     ...
     ![Вкладка Свойства для выбранной ячейки таблицы](../../reporting-services/report-design/media/cell-propertiespane.png "Вкладка Свойства для выбранной ячейки таблицы")  
  
### Отключение автоматического расширения строки по вертикали  
