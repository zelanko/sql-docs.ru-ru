...
description: Использование полосковых линий в горизонтальном или вертикальном диапазоне, чтобы улучшить удобочитаемость, выделить даты или конкретный диапазон ключей в построителе отчетов.
ms.date: 03/01/2017
