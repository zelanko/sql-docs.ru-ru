...
description: Узнайте, как добавить в отчет с разбиением на страницы несколько областей данных, чтобы предоставить несколько представлений для одного и того же набора данных отчета в построителе отчетов.
ms.date: 05/30/2017
