---
title: "Функция Max (построитель отчетов и службы SSRS) | Документы Microsoft"
ms.custom: 
ms.date: 03/07/2017
...
---
# <a name="report-builder-functions---max-function"></a>Функции построителя отчетов - Max, функция
