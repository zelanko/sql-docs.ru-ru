---
title: Функция RowNumber (построитель отчетов) | Документация Майкрософт
description: Используйте функцию RowNumber в построителе отчетов, чтобы вернуть количество строк для указанной области.
ms.date: 03/07/2017
