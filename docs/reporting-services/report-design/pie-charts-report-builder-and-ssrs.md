---
title: "Круговые диаграммы (построитель отчетов и службы SSRS) | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
---
# Круговые диаграммы (построитель отчетов и службы SSRS)
...
## Данные для отображения на круговой диаграмме  
...
## Применение стилей рисования к круговой диаграмме  
 ...
 ![Стили отображения круговой диаграммы](../../reporting-services/report-design/media/rs-piedrawingeffects-concave2.png "Стили отображения круговой диаграммы")  
  
 Дополнительные сведения см. в разделе [Добавление в диаграмму стилей рельефа, приподнятости и текстуры (построитель отчетов и службы SSRS)](../../reporting-services/report-design/add-bevel-emboss-and-texture-styles-to-a-chart-report-builder-and-ssrs.md).  
  
## Отображение процентных значений на круговой диаграмме  
 ...
 ![Круговая диаграмма с метками точек данных, заданными в процентах](../../reporting-services/report-design/media/rs-piechartpercentages.png "Круговая диаграмма с метками точек данных, заданными в процентах")  
  
## Предотвращение перекрытия меток на круговой диаграмме  
...
## Объединение мелких срезов на круговой диаграмме  
