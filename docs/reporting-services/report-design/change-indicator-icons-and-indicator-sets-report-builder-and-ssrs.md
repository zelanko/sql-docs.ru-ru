---
title: "Изменение значков индикаторов и наборов индикаторов (построитель отчетов и службы SSRS) | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
---
# Изменение значков индикаторов и наборов индикаторов (построитель отчетов и службы SSRS)
...
## Изменение цвета значка индикатора  
...
3.  Нажмите стрелку вниз в столбце **Цвет** рядом со значком, который требуется изменить, и щелкните нужный цвет либо нажмите **Без цвета**или **Дополнительные цвета**.  
     ...
     Если вы нажали **Дополнительные цвета**, откроется диалоговое окно **Выбор цвета** , позволяющее выбирать цвета из широкого массива. Дополнительные сведения о параметрах см. в разделе [Диалоговое окно "Выбор цвета" (построитель отчетов и службы SSRS)](../Topic/Select%20Color%20Dialog%20Box%20\(Report%20Builder%20and%20SSRS\).md). Нажмите кнопку **ОК** , чтобы закрыть диалоговое окно **Выбор цвета** .  
...
## Пользовательское изображение в качестве значка индикатора  
...
## Добавление значка к набору индикаторов  
...
## Удаление значка из набора индикаторов  
