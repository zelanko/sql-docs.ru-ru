---
title: "Изучение возможностей области данных табликса (построитель отчетов и службы SSRS) | Microsoft Docs"
ms.custom: ""
ms.date: "03/07/2017"
...
---
# Изучение возможностей области данных табликса (построитель отчетов и службы SSRS)
...
## Преобразование списка по умолчанию в список групп  
...
## Создание ступенчатых отображений  
...
## Добавление соседней группы подробностей  
