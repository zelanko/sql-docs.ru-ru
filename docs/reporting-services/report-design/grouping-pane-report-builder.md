...
description: Отображение групп строк и столбцов для текущей выбранной области данных табликса. Сведения о панели группировки в построителе отчетов.
ms.date: 08/17/2018
