...
##  <a name="DataGrouping"></a> Изменение группирования данных для слоя  
 ...
 Дополнительные сведения см. в статье о том,[ как импортировать файлы фигур в SQL Server и агрегировать пространственные данные](https://go.microsoft.com/fwlink/?LinkID=214991).  
