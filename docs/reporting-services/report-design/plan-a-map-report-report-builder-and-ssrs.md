...
description: Упрощайте понимание информации и принятие мер посредством представления аналитических данных на географическом фоне с помощью карт в отчетах с разбивкой на страницы в построителе отчетов.
ms.date: 03/14/2017
