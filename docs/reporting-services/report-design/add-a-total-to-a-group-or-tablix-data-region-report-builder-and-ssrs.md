...
description: Добавляйте итоги к области данных табликса или ко всей области данных в отчете с разбиением на страницы в построителе отчетов.
ms.date: 12/16/2019
