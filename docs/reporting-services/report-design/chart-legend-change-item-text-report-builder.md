...
description: Узнайте, как изменять текст элемента условных обозначений для отображения дополнительных сведений об отдельных точках данных в построителе отчетов.
ms.date: 03/01/2017
