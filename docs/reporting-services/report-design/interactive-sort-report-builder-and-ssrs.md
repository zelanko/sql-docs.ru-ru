...
-   **Синхронизировать ли сортировку для нескольких областей данных**. Отчет можно спроектировать таким образом, чтобы в случае, если пользователь изменит порядок сортировки, операция сортировки выполнялась бы и в других областях данных, производных от данного предка.  
