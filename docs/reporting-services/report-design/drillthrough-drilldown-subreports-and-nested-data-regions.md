...
description: Упорядочение данных, чтобы показать отношение общего к частному, и вывод данных во вложенный отчет или отдельный детализированный отчет.
ms.date: 03/07/2017
