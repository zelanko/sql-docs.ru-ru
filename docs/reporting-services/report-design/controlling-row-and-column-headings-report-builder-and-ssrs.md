...
description: Узнайте, как использовать в отчете с разбивкой на страницы в построителе отчетов табличную, матричную или списочную область данных, которая может занимать несколько страниц по горизонтали или по вертикали.
ms.date: 12/19/2019
