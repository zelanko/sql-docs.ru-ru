...
###  <a name="matrix"></a><a name="Matrix"></a> Матрица  
 ...
 ![Просмотр подготовленной для просмотра матрицы с развернутыми группами](../../reporting-services/report-design/media/rs-basicmatrixpreview.gif "Просмотр подготовленной для просмотра матрицы с развернутыми группами")  
