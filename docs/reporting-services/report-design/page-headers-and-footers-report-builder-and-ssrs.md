---
title: Верхние и нижние колонтитулы страницы (построитель отчетов) | Документация Майкрософт
description: Ознакомьтесь с различными элементами, которые можно добавлять в верхние и нижние колонтитулы в построителе отчетов, включая текст, изображения, прямоугольники, границы, цвет фона и выражения.
ms.date: 03/01/2017
