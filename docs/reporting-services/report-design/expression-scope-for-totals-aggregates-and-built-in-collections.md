...
description: Изучите различные значения области в выражениях для суммирования, агрегирования и встроенных коллекций в отчетах в построителе отчетов.
ms.date: 03/07/2017
