...
description: Сведения об использовании типа вспомогательной оси для сравнения двух отдельных диапазонов данных в построителе отчетов.
ms.date: 05/30/2017
