---
title: Управление разрывами страниц, заголовками, столбцами и строками (построитель отчетов) | Документация Майкрософт
description: Оптимизируйте просмотр и печать таблиц, списков и изображений с помощью изменения длины страниц, столбцов, заголовков и строк в построителе отчетов.
ms.date: 03/07/2017
...
# <a name="controlling-page-breaks-headings-columns-and-rows-report-builder-and-ssrs"></a>Управление разрывами страниц, заголовками, столбцами и строками (построитель отчетов и службы SSRS)
 ...
 Можно добавлять разрывы страниц в элементы отчета, такие как таблицы, матрицы, списки, диаграммы, датчики и изображения. Также можно добавлять разрывы страниц в группы в составе таблицы, матрицы или списка. Разрывы страниц можно добавлять перед группами, после групп и между группами. Разрывы страницы между группами по умолчанию в отчет не добавляются.  
  
 Дополнительные сведения см. в разделах [Отображение заголовков строк и столбцов на нескольких страницах (построитель отчетов и службы SSRS)](../../reporting-services/report-design/display-row-and-column-headers-on-multiple-pages-report-builder-and-ssrs.md) и [Сохранение заголовков видимыми при прокрутке отчета (построитель отчетов и службы SSRS)](../../reporting-services/report-design/keep-headers-visible-when-scrolling-through-a-report-report-builder-and-ssrs.md).  
