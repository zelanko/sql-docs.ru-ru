...
description: Сведения о коллекции ReportItems. Эти текстовые поля в построителе отчетов находятся в текущей области верхнего колонтитула, нижнего колонтитула или текста отчета.
ms.date: 03/01/2017
