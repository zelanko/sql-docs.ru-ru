---
title: Ячейки, строки и столбцы в табликсе | Документация Майкрософт
description: Чтобы эффективнее управлять отображением данных в строках и столбцах области данных табликса в отчете SQL Server Reporting Services с разбиением на страницы, важно уметь правильно назначать строки и столбцы для подробных данных, группирований, меток и итогов.
ms.date: 12/16/2019
...
ms.locfileid: "75252401"
---
# <a name="cells-rows--columns-in-a-tablix-data-region-report-builder-and-ssrs"></a>Ячейки, строки и столбцы в области данных табликса (построитель отчетов и службы SSRS)
...
## <a name="displaying-data-on-rows-and-columns"></a>Отображение данных в строках и столбцах  
 ...
 ![Режим конструктора, добавлены строки итогов для группы и таблицы](../../reporting-services/report-design/media/rs-basictablegroupstotalscolordesign.gif "Режим конструктора, добавлены строки итогов для группы и таблицы")  
 ...
 ![Предварительный просмотр, таблица с итогами по группам, последние строки](../../reporting-services/report-design/media/rs-basictablegroupstotalscolorpreviewbottom.gif "Предварительный просмотр, таблица с итогами по группам, последние строки")  
