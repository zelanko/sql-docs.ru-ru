...
2.  Щелкните правой кнопкой мыши слой, на котором находятся нужные данные, а затем выберите пункт **Правило цвета***\<тип элемента карты>*.  
...
3.  Выберите параметр **Отображать данные с помощью** \<тип правила>. Чтобы использовать параметры распределения, нужно создать диапазоны на странице **Распределение** на основании аналитических данных, связанных со слоем.  
...
## <a name="see-also"></a>См. также:  
 ...
 [Добавить, изменить или удалить карту или слой карты &#40; Построитель отчетов и службы SSRS &#41;](../../reporting-services/report-design/add-change-or-delete-a-map-or-map-layer-report-builder-and-ssrs.md)   
