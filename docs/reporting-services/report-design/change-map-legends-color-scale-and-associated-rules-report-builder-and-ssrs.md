---
title: "Изменение карты условные обозначения цвет шкалы связанных правил в построителе отчетов-SSRS | Документы Microsoft"
ms.custom: 
ms.date: 03/07/2017
...
1.  В режиме конструктора щелкните правой кнопкой мыши условные обозначения и откройте  *\<элемент отчета >***свойства** страницы.  
  
2.  В разделе **Позиция**щелкните место, где должны отображаться условные обозначения относительно области отображения.  
  
3.  Чтобы отобразить условные обозначения вне области просмотра, выберите **Показать \<элемент отчета > за пределами окна просмотра**.  
...
2.  Щелкните правой кнопкой мыши слой, на котором находятся нужные данные и нажмите кнопку  *\<тип элемента карты >***правило цвета**.  
...
2.  Щелкните правой кнопкой мыши слой, на котором находятся нужные данные и нажмите кнопку  *\<тип элемента карты >***правило**.  
  
3.  Убедитесь, что **визуализация данных с помощью** \< *тип правила*> выбран.  
...
3.  Выберите параметр правила цвета, который нужно использовать. Чтобы отобразить элементы в условных обозначений или цветовой шкалы карты, необходимо выбрать один из **визуализация данных с помощью** \<тип правила > Параметры.  
