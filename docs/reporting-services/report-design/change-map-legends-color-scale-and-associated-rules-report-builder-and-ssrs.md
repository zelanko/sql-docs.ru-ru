...
1.  В конструкторе щелкните правой кнопкой мыши условные обозначения и откройте страницу _Свойства\<_ **элемент отчета>** .  
...
2.  Щелкните правой кнопкой мыши слой, на котором находятся нужные данные, а затем выберите пункт _Правило цвета\<_ **тип элемента карты>** .  
...
2.  Щелкните правой кнопкой мыши слой, на котором находятся нужные данные, и затем выберите пункт _Правило\<_ **тип элемента карты>** .  
