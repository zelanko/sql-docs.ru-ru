---
title: Функция First (построитель отчетов) | Документация Майкрософт
description: Используйте функцию First, чтобы вернуть первое значение в заданной области указанного выражения в построитель отчетов.
ms.date: 03/07/2017
