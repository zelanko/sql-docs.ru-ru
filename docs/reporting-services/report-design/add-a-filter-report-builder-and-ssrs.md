...
2.  Выделите область данных в области конструирования и щелкните правой кнопкой мыши пункт _Свойства\<_ **область данных>** . Для датчика выберите пункт **Свойства панели датчиков**. Откроется диалоговое окно _Свойства\<_ **область данных>** .  
