---
title: Создание матрицы (построитель отчетов) | Документация Майкрософт
description: Отображение сгруппированных данных и сводных сведений в матрице, которая предоставляет функциональные возможности в построителе отчетов аналогично перекрестным вкладкам и сводным таблицам.
ms.date: 03/07/2017
...
##  <a name="adding-a-matrix-to-your-report"></a><a name="AddingMatrix"></a> Добавление матрицы к отчету  
