---
title: Ссылки на коллекцию полей набора данных (построитель отчетов) | Документация Майкрософт
description: Создание набора данных для вывода отдельных или сводных значений в области данных отчета построителя отчетов.
ms.date: 03/01/2017
