...
description: Сведения о правилах, применяемых к тексту отчета и его содержимому при подготовке отчета к просмотру в построителе отчетов.
ms.date: 03/07/2017
