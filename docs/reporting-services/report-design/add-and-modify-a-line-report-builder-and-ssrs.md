...
description: Настраивайте внешний вид отчетов в построителе отчетов, добавляя графические элементы в отдельные разделы или изменяя свойства линий, влияющие на цвет или стиль.
ms.date: 03/01/2017
