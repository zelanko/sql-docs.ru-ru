---
title: Подготовка к просмотру элементов отчета (построитель отчетов) | Документация Майкрософт
description: Узнайте, как элементы отчета, такие как число, размер и расположения, влияют на разбиение на страницы при подготовке к просмотру в построителе отчетов.
ms.date: 03/07/2017
