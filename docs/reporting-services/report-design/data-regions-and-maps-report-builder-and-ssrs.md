---
title: Области данных и карты (построитель отчетов) | Документация Майкрософт
description: Изучите типы и характеристики областей данных и сопоставлений, чтобы спроектировать отображение набора данных отчета в построителе отчетов.
ms.date: 03/14/2017
