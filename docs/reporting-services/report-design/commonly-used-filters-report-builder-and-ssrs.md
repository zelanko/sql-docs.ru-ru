---
title: Часто используемые фильтры (построитель отчетов) | Документация Майкрософт
description: Изучите эти примеры фильтров вместе с уравнениями фильтра, заданными для создания фильтра в построителе отчетов.
ms.date: 03/07/2017
