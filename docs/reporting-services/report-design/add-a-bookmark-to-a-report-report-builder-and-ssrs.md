...
# <a name="add-a-bookmark-to-a-report-report-builder-and-ssrs"></a>Добавление в отчет закладки (построитель отчетов и службы SSRS)
 ...
 Закладку можно добавить к любому элементу отчета; ссылку на закладку можно добавить к любому элементу, имеющему свойство **Action** , например текстовому полю, изображению или вычисляемому ряду в диаграмме. Дополнительные сведения см. в разделе [Диалоговое окно "Свойства действия" (построитель отчетов и службы SSRS)](https://msdn.microsoft.com/library/2c5d915b-4f97-42cf-b8f1-49ca3ff3d0f9).  
