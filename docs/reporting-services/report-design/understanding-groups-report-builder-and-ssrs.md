---
title: Основные сведения о группах (построитель отчетов) | Документация Майкрософт
description: Получите представление о том, как группа организует представление набора данных отчета в отчете с разбивкой на страницы в построителе отчетов.
ms.date: 03/07/2017
