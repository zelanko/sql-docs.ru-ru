---
title: "Фигурные диаграммы (построитель отчетов и службы SSRS) | Microsoft Docs"
ms.custom: ""
ms.date: "03/03/2017"
...
# Фигурные диаграммы (построитель отчетов и службы SSRS)
 ...
 ![Воронкообразная диаграмма](../../reporting-services/report-design/media/rs-funnelchart.png "Воронкообразная диаграмма")  
...
## Условия применения данных для фигурных диаграмм  
