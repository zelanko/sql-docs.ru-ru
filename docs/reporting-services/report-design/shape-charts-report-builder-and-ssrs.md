---
title: Фигурные диаграммы (построитель отчетов) | Документация Майкрософт
description: Узнайте, как использовать фигурные диаграммы в построителе отчетов для отображения значений данных в процентах от целого. Фигурные диаграммы часто используются для отображения результатов сравнения значений в наборе с учетом пропорций.
ms.date: 03/03/2017
