...
description: Управляйте содержимым, структурой и интерактивными возможностями отчета с помощью выражений, которые позволяют получать, отображать, фильтровать и форматировать данные в построителе отчетов.
ms.date: 09/06/2016
...
-   [Руководство. Общие сведения о выражениях](../tutorial-introducing-expressions.md)
