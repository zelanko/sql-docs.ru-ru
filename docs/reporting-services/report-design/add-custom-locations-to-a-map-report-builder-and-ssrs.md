...
description: Узнайте, как добавить пользовательские расположения на карту, добавленную в отчет с разбивкой на страницы в построителе отчетов.
ms.date: 03/07/2017
