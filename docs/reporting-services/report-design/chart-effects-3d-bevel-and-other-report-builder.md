...
description: Сведения о том, как трехмерные эффекты можно использовать, чтобы добавить глубину и увеличить визуальную привлекательность для диаграмм в построителе отчетов.
ms.date: 03/01/2017
