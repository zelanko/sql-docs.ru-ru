---
title: Форматирование точек данных на диаграмме (построитель отчетов) | Документация Майкрософт
description: Сведения о различных типах форматирования точек данных на диаграммах в отчетах в построителе отчетов.
ms.date: 03/03/2017
...
|#MIN|Минимальное значение Y в ряду.|All|`=Min(Fields!MyDataField.Value)`|  
