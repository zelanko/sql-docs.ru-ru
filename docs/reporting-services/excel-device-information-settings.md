---
title: "Настройки сведений об устройстве Excel | Microsoft Docs"
ms.custom: ""
ms.date: "03/16/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "настройки сведений об устройстве [службы Reporting Services], подготовка к просмотру в формате Excel"
  - "Excel [службы Reporting Services], подготовка к просмотру"
...
---
# Настройки сведений об устройстве Excel
