...
description: Узнайте, как форматировать текст различными способами в отчете Reporting Services с разбивкой на страницы. Например, вы можете поэкспериментировать с различными форматами.
ms.date: 05/30/2017
...
ms.locfileid: "93243805"
---
# <a name="tutorial-format-text-report-builder"></a>Руководство по Форматирование текста (построитель отчетов)
...
![Снимок экрана с отформатированным отчетом построителя отчетов.](../reporting-services/media/report-build-format-report.png) 
...
3.  На странице **Размещение полей** перетащите поля **Territory** , **LinkText** и **Product** в **Группы строк** , поле **Sales** — в **Значения** , а затем нажмите кнопку **Далее**.  
    ...
    ![Снимок экрана, показывающий, как разместить текстовые поля в построителе отчетов.](../reporting-services/media/report-builder-text-arrange-fields.png)
...
6.  Нажмите кнопку **Запустить**.  
    ...
    ![Снимок экрана, показывающий два итога в отчете построителя отчетов.](../reporting-services/media/report-builder-format-2-totals.png)
...
11. Выбрав три ячейки, щелкните правой кнопкой мыши одну из них и выберите пункт **Удалить строки**.  
    ...
    ![Снимок экрана, показывающий, как удалить строки из отчета построителя отчетов.](../reporting-services/media/report-builder-format-delete-rows.png)
  
12. Нажмите кнопку **Запустить**.  

    Теперь имеется только одна строка "Итого".
    
    ![Снимок экрана, показывающий одну сумму в отчете построителя отчетов.](../reporting-services/media/report-builder-format-one-total.png)
...
9. Нажмите кнопку **Запустить**.  
    ...
    ![Снимок экрана, показывающий текст с гиперссылкой в отчете построителя отчетов.](../reporting-services/media/report-builder-format-hyperlink.png)
...
5.  Найдите свойство WritingMode на панели "Свойства" и измените его значение с **По умолчанию** на **Rotate270**.  
    ...
    ![Снимок экрана: поле "Территория" в отчете построителя отчетов.](../reporting-services/media/report-builder-select-territory-cell.png)
...
![Снимок экрана, показывающий значения "Территория", повернутые на 270 градусов.](../reporting-services/media/report-builder-format-rotate-270.png)
...
![Снимок экрана, показывающий отчет с переформатированным форматом построения.](../reporting-services/media/report-build-format-report.png)
...
![Снимок экрана, показывающий форматированный текст в отчете построителя отчетов.](../reporting-services/media/report-builder-format-html.png)
...
В построителе отчетов предусмотрено несколько способов форматирования текста. [Руководство. Создание отчета в свободной форме](../reporting-services/tutorial-creating-a-free-form-report-report-builder.md) содержит дополнительные примеры.  
