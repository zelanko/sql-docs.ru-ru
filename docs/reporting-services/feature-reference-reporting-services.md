---
title: "Справочник (службы Reporting Services) по компонентам | Документы Microsoft"
ms.custom: 
ms.date: 03/14/2017
...
## <a name="see-also"></a>См. также раздел  
 ...
 [Службы Reporting Services отчеты &#40; Службы SSRS &#41;](../reporting-services/reports/reporting-services-reports-ssrs.md)   
