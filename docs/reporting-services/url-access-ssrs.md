---
title: "Доступ по URL-адресу (SSRS) | Microsoft Docs"
ms.custom: ""
ms.date: "03/03/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "доступ по URL-адресу [службы Reporting Services]"
  - "ссылки [службы Reporting Services], доступ по URL-адресу"
  - "доступ по URL-адресу [службы Reporting Services], о доступе по URL-адресу"
  - "параметры [службы Reporting Services], доступ по URL-адресу"
  - "серверы отчетов [службы Reporting Services], доступ по URL-адресу"
  - "гиперссылки [службы Reporting Services]"
...
|Передача отчету параметров отчета.|[Передать параметр отчета в URL-адресе](../reporting-services/pass-a-report-parameter-within-a-url.md)|  
...
## См. также  
 [Передать параметр отчета в URL-адресе](../reporting-services/pass-a-report-parameter-within-a-url.md)   
