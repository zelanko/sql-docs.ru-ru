...
2.  Выберите **Набор данных**.  
    ...
    ![Снимок экрана, показывающий раскрывающийся список создания с вызванным параметром "Набор данных".](../reporting-services/media/ssrsdataset-newdataset.png)  
...
1.  Щелкните **многоточие (…)** рядом с набором данных, которым требуется управлять.  
    ...
    ![Снимок экрана, показывающий, выбор пользователем многоточия для набора данных.](../reporting-services/media/ssrsdataset-ellipse.png)  
  
2.  Выберите **Управление** , после чего откроется экран редактирования.  
  
    ![Снимок экрана с выбранным многоточием и выбранным параметром УПРАВЛЕНИЕ.](../reporting-services/media/ssrsdataset-manage.png)  
...
![Снимок экрана, показывающий экран свойств диалогового окна "Изменить продажи компании".](../reporting-services/media/ssrsdataset-properties.png)  
...
![Снимок экрана, показывающий экран "Кэширование" диалогового окна "Изменить продажи компании" с выбранным параметром "Всегда запускать этот отчет".](../reporting-services/media/ssrsdataset-caching1.png)  
...
![Снимок экрана, показывающий экран "Кэширование" диалогового окна "Изменить продажи компании" с копиями кэша этого отчета и их использование при выборе параметра доступности.](../reporting-services/media/ssrsdataset-caching2.png)  
...
![Снимок экрана, где выбран параметр "Срок действия кэша истекает по расписанию".](../reporting-services/media/ssrsdataset-caching3.png)  
...
![Снимок экрана, показывающий диалоговое окно "Изменить продажи компании" с параметром "Создать план обновления кэша".](../reporting-services/media/ssrsdataset-caching4.png)  
