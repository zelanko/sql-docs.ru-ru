---
title: "Настройки сведений об устройстве CSV | Microsoft Docs"
ms.custom: ""
ms.date: "03/16/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "CSV [службы Reporting Services]"
  - "настройки сведений об устройстве [службы Reporting Services], подготовка к просмотру в формате CSV"
...
---
# Настройки сведений об устройстве CSV
