...
Эта статья содержит сведения о создании записной книжки в актуальном выпуске [**Azure Data Studio**](../azure-data-studio/download.md) и создании собственных записных книжек с помощью разных ядер.
