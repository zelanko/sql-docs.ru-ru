---
title: Создание фрагментов кода студии данных Azure | Документация Майкрософт
...
1. Откройте *палитру команд* (**Shift + Ctrl + P**) и тип *фрагмент*и выберите **предпочтения: Откройте фрагменты пользователя**:
