...
6 июня 2019 &nbsp;  /  &nbsp; версии: 1.8.0 

&nbsp;

| Изменить | Сведения |
| :----- | :------ |
| Версия расширения центра серверов управления (CMS) | Серверы централизованного управления хранится список экземпляров SQL Server, организованных в одну или несколько групп серверов централизованного управления. Пользователи могут подключаться к свои существующие серверы CMS и управлять серверами как добавление и удаление серверов. Чтобы узнать больше, прочитайте [здесь](https://docs.microsoft.com/sql/relational-databases/administer-multiple-servers-using-central-management-servers) |
...
- Расширения администрирования базы данных для Windows
    - Не удается запустить свойства с отключенного сервера узла
    - Не удается запустить свойства для серверов Azure
    - Не все объекты имеют диалоговые окна свойств
    - Диалоговые окна занять много времени для запуска
    - Ошибки запуска серверов с помощью некоторых типов соединений (например AAD)
- Записные книжки
    - [5838](https://github.com/microsoft/azuredatastudio/issues/5838) разрешить пользователям использовать систему Python для записных книжек
- Сравнение схем
    - [5804](https://github.com/microsoft/azuredatastudio/issues/5804) сравнения схем задачи Показывать контекстного меню по умолчанию "Отмена", которое не выполняет никаких действий
