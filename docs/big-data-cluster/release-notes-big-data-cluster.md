...
| Усовершенствования внешней таблицы | Внешние таблицы источника данных HADOOP введите теперь поддерживает чтение строки до 1 МБ в размер. Внешние таблицы (ODBC, пул носителей, данные пула) теперь поддержки строк, по ширине таблицы SQL Server. |
