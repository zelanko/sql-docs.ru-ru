...
Скрипты развертывания может помочь развертывания Kubernetes и кластерами больших данных за один шаг. Они также часто предоставляют значения по умолчанию для необходимые переменные среды. Пример сценария развертывания кластера больших данных в службе Azure Kubernetes (AKS), см. в разделе [развертывание 2019 SQL Server, больших данных кластера с помощью сценария развертывания (AKS)](quickstart-big-data-cluster-deploy.md).
...
Развернуть кластер больших данных и Kubernetes в AKS с помощью один сценарий, см. следующий пример:

- [Развертывание кластера SQL Server 2019 больших данных с помощью сценария развертывания (AKS)](quickstart-big-data-cluster-deploy.md)

Подробные пошаговые инструкции по развертыванию кластеров больших данных, с помощью AKS, kubeadm и MiniKube см. в следующей статье:
