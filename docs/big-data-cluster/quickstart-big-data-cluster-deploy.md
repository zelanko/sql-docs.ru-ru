...
1. При появлении запроса введите указанные ниже сведения.
   ...
   | **Размер машины** | [Размер машины](https://docs.microsoft.com/azure/virtual-machines/windows/sizes), который следует использовать для узлов в кластере AKS (по умолчанию **Standard_L8s**). |
