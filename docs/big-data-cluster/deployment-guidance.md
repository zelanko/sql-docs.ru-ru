...
|---|---|
| **aks разработки и тестирования** | Служба Azure Kubernetes (AKS) |
| **kubeadm разработки и тестирования** | Несколько компьютеров (kubeadm) |
| **minikube — разработка и тестирование** | Minikube |
