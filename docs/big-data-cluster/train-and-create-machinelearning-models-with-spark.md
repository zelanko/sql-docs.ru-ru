---
title: Обучение и создание моделей машинного обучения Spark
description: Использовать PySpark для обучения и создания моделей машинного обучения с помощью Spark | SQL Server
...
Пример — Пошаговое руководство по с помощью фрагментов кода, которые могут быть использованы из книжки Studio данных Azure и каждой ячейки выполнения сразу за раз. Дополнительные сведения о подключении с помощью Spark в записной книжке см. в разделе [здесь] (записные книжки guidance.md)
...
1. Приступая к работе с PySpark записных книжек см. в разделе [здесь.](notebooks-guidance.md)
