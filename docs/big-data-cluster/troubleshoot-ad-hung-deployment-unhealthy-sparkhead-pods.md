...
## <a name="check-the-hdfs-and-sparkservices"></a>Проверка служб HDFS и Spark 
...
:::image type="content" source="media/troubleshoot-ad-hung-deployment-unhealthy-sparkhead-pods/missing_reverse_lookup_zone_entry_for_domain_controller_add.png" alt-text="Отсутствует запись зоны обратного поиска для контроллера домена":::
