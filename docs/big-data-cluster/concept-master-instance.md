...
description: В этой статье описывается экземпляр SQL Server master в [!INCLUDE[big-data-clusters-2019](../includes/ssbigdataclusters-ver15.md)].
author: MikeRayMSFT
ms.author: mikeray
...
В этой статье описывается роль *экземпляра SQL Server master* в кластере больших данных для SQL Server 2019. Главный экземпляр — это SQL Server экземпляр, работающий в кластере больших данных для управления подключением, масштабируемыми запросами, метаданными и пользовательскими базами данных, а также службами машинного обучения.
...
С [!INCLUDE[big-data-clusters-2019](../includes/ssbigdataclusters-ver15.md)]помощью вы можете больше узнать о корпоративном озерае данных. Аналитики и разработчики SQL Server могут:
