...
description: Эта статья описывает главный экземпляр SQL Server в кластере больших данных SQL Server 2019 (предварительная версия).
author: MikeRayMSFT
ms.author: mikeray
...
С помощью кластеров больших данных SQL Server 2019 вы можете больше узнать о корпоративных озерах данных. Аналитики и разработчики SQL Server могут:
