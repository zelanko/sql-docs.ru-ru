...
Так же как и другие настройки, параметры хранилища можно указать в файлах конфигурации кластера во время развертывания для каждого пула и уровня управления. Если в спецификациях пула нет параметров конфигурации хранилища, применяются параметры хранилища уровня управления. Вот пример раздела конфигурации хранилища, который можно включить в спецификацию:
