---
title: Мониторинг кластера с помощью портала администрирования кластера | Документация Майкрософт
description: ''
author: yualan
ms.author: alayu
manager: craigg
...
ms.locfileid: "48796404"
---
# <a name="introduction-to-the-cluster-administration-portal"></a>Общие сведения о портале администрирования кластера
Если вы хотите отслеживать или Устранение неполадок кластера больших данных SQL Server, используйте портал администрирования кластера. 
...
> [!NOTE]
> Это будет быть предупреждение системы безопасности при доступе к веб-страницы, так как мы используем создан SSL-сертификаты. В будущих выпусках мы предоставим возможность предоставлять свои собственные сертификаты со знаком.
