...
В Azure Data Studio, нажмите клавишу F1 и нажмите кнопку **новое подключение** и вы можете подключиться к вашей конечной точки кластера больших данных SQL Server.
