---
title: "Invoke-PolicyEvaluation, командлет | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Управление на основе политик, Invoke-PolicyEvaluation"
  - "Управление на основе политик, PowerShell"
  - "Invoke-PolicyEvaluation, командлет"
  - "Командлеты [SQL Server], Invoke-PolicyEvaluation"
