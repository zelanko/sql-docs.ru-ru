---
title: Настройка учетной записи службы панели запуска SQL Server - службы машинного обучения SQL Server
