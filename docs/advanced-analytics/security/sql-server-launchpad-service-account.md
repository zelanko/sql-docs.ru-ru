---
title: Настройка учетной записи службы панели запуска SQL Server доверенные | Документация Майкрософт
description: Как изменить панель запуска SQL Server доверенные службы учетная запись, используемая для выполнения внешних скриптов SQL Server.
ms.prod: sql
