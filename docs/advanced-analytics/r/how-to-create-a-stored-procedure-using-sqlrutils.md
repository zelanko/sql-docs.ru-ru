...
Все переменные, используемые функцией, должен быть определен внутри функции или должен быть определен в качестве входных параметров. См. [пример кода](#samples) в этой статье.
