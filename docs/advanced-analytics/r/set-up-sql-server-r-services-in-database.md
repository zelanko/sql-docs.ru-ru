...
4. В **введите имена выбираемых объектов**, тип **SQLRUserGroup**, а затем выберите **проверить имена**.  
    Имя локальной группы, связанной с панели запуска экземпляра службы должно разрешаться примерно *instancename\SQLRUserGroup*. 
5. Нажмите кнопку **ОК**.
