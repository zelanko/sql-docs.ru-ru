...
|Привязка — ошибка 6 | Привязка не выполнена | Произошла ошибка при отмене привязки значения экземпляра. Эта ошибка может возникать при запуске установщика MLS без выбора любых компонентов.|
