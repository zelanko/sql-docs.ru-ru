...
Как правило переключение на новую модель обслуживания гарантирует, что специалисты по анализу данных можно всегда использовать последнюю версию R или Python. Дополнительные сведения об условиях современных политика жизненного цикла см. в разделе [временной шкалы поддержки для Microsoft R Server](https://docs.microsoft.com/machine-learning-server/resources-servicing-support).
