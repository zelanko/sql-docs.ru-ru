...
Как правило отдельные установщики предоставляются открытым исходным кодом и собственных компонентов. Мастер установки SQL Server гарантирует, что они установлены в правильном порядке. Тем не менее, некоторых версий может обновить только один набор компонентов. В разделе [таблицы установщиков](#bkmk_2017Installers) версии подробные сведения.

**Для R**

Язык R поддерживается в SQL Server 2016 и более поздних версий. 
...
Язык Python требуется SQL Server 2017 или более поздней версии. 
...
6. Завершите работу мастера установки SQL Server.
7. Выполните необходимые действия после установки, чтобы убедитесь, что служба включена.
