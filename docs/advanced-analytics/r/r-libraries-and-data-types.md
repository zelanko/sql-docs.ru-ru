...
Следующие типы данных, поддерживаемые [системой типов SQL Server](https://msdn.microsoft.com/library/ms187752.aspx), могут создавать проблемы при передаче в код R:
