...
Следующие типы данных, поддерживаемые [системой типов SQL Server](/sql-docs/docs/t-sql/data-types/data-types-transact-sql), могут создавать проблемы при передаче в код R:
