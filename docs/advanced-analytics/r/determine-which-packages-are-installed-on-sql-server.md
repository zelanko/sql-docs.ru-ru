...
---
#  <a name="get-r-and-python-package-information-on-sql-server"></a>Получение информации о пакете R и Python в SQL Server
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md-winonly](../../includes/appliesto-ss-xxxx-xxxx-xxx-md-winonly.md)]

Иногда при работе с несколькими средами или установок R и Python, необходимо убедиться, что код, который вы используете использует среду ожидаемый Python или нужной рабочей области для R. Например при обновлении машинного обучения компонентов с помощью привязки, путь к библиотеке R может быть в той же папке по умолчанию. Кроме того Если вы устанавливаете R клиента или экземпляр изолированный сервер, может потребоваться несколько библиотек R на компьютере.

Примеры в этой статье показано, как получить полный путь к версии библиотеки, который используется SQL Server.

## <a name="get-the-current-r-library"></a>Получение текущей библиотеки R

Для **R** в любой версии SQL Server, выполните следующую инструкцию, чтобы проверить библиотеки по умолчанию для текущего экземпляра:
...
## <a name="get-the-current-python-library"></a>Получение текущей библиотеки Python
