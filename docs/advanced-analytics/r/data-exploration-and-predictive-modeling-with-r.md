---
title: Просмотр данных и прогнозное моделирование с помощью R в машинном обучении SQL Server | Документы Microsoft
ms.prod: sql
...
В этой статье описаны усовершенствования процесса обработки и анализа данных, которые возможны при интеграции с SQL Server.
