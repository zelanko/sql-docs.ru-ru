---
title: Управление и интеграцию рабочих нагрузок машины обучения в SQL Server | Документация Майкрософт
