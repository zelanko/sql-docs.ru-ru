---
title: Обновление и установка часто задаваемые вопросы (FAQ) - службы машинного обучения SQL Server
...
+ Обновление до последней версии или выпуска службы, как можно скорее, чтобы устранить все проблемы, которые были исправлены в последних выпусках.

**Применимо к:** SQL Server 2016 R Services, служб SQL Server 2017 машинного обучения (в базе данных)
...
- В настоящее время невозможно установить [!INCLUDE[rsql_productname](../../includes/rsql-productname-md.md)] в отказоустойчивом кластере. Тем не менее Предварительная версия SQL Server 2019 обеспечивают поддержку отработки отказа, если вы хотите оценить эту возможность в тестовой среде. Дополнительные сведения см. в разделе [новые](../what-s-new-in-sql-server-machine-learning-services.md).
...
+ [Используйте SqlBindR для обновления компонентов машинного обучения](../install/upgrade-r-and-python.md)
