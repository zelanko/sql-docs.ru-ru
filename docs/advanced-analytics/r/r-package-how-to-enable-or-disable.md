---
title: "Как включить или отключить управление пакетами R | Документация Майкрософт"
ms.custom: 
ms.date: 12/21/2016
...
---
# <a name="r-package---how-to-enable-or-disable"></a>Пакеты R — включение или отключение
