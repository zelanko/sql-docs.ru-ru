...
1. Запустите мастер установки SQL Server 2017. 
...
1. Откройте [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)]. 
    ...
    > 
    > Можно также использовать [Azure Data Studio](../../azure-data-studio/what-is.md), который поддерживает административных задач и запросов к SQL Server.
