...
###  <a name="bkmk_configureAccounts"></a> Включить неявную проверку подлинности для учетной записи группы ограниченные группы пользователей SQL (SQLRUserGroup)
