...
* [Службы машинного обучения — часто задаваемые вопросы по обновлению и установке](../r/upgrade-and-installation-faq-sql-server-r-services.md)

Используйте эти пользовательские отчеты, чтобы проверить состояние установки экземпляра и устранить неполадки.
