---
title: Установка моделей предварительно обученной машинного обучения в SQL Server | Документация Майкрософт
...
1. Запуск **RGUI. EXE** в C:\Program Files\Microsoft SQL Server\MSSQL14. MSSQLSERVER\R_SERVICES\bin\x64.
