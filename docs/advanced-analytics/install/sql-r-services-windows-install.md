...
### <a name="enable-implied-authentication-for-the-launchpad-account-group"></a>Включить неявную проверку подлинности для учетной записи группы панели запуска
...
###  <a name="give-your-users-read-write-or-ddl-permissions-to-the-database"></a>Предоставление пользователям чтение, запись или DDL разрешений в базе данных
