---
title: "Занятие&#160;1. Работа с данными SQL Server с помощью языка R (глубокое погружение в обработку и анализ данных) | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "09/30/2016"
...
---
# Занятие&#160;1. Работа с данными SQL Server с помощью языка R (глубокое погружение в обработку и анализ данных)
...
> [!NOTE]  
> Если данные только считываются, учетной записи, используемой для выполнения скриптов R, требуются только разрешения SELECT (роль **db_datareader**) для указанной базы данных. Однако в этом учебнике вам потребуются права администратора DDL с целью подготовки базы данных и создания таблиц для сохранения результатов оценки.  
...
## См. также:  
[Глубокое погружение в обработку и анализ данных](http://msdn.microsoft.com/library/mt637368(SQL.130).aspx)  
