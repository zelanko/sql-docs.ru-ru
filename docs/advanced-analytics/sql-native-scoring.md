...
Прогноз доступен во всех выпусках ядра СУБД SQL Server 2017 и включен по умолчанию, включая SQL Server 2017 Службы машинного обучения в Windows, SQL Server 2017 (Windows), SQL Server 2017 (Linux) или базу данных SQL Azure. Вам не нужно устанавливать R, Python или включать дополнительные функции.
