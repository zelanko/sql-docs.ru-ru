---
title: Масштабирование параллельного выполнения внешних скриптов в службах машинного обучения SQL Server | Документация Майкрософт
description: Как изменить пул учетных записей пользователей для масштабирования службы машинного обучения SQL Server.
ms.prod: sql
