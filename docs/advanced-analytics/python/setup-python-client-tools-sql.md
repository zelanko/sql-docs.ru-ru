...
1. Скачайте сценарий установки.
  ...
  + [https://aka.ms/mls-py](https://aka.ms/mls-py)устанавливает версию 9.2.1 пакетов Microsoft Python. Эта версия соответствует экземпляру SQL Server по умолчанию. 

  + [https://aka.ms/mls93-py](https://aka.ms/mls93-py)устанавливает пакеты Microsoft Python версии 9,3. Эта версия лучше подходит, если удаленный SQL Server экземпляр [привязан к Machine Learning Server 9,3](../install/upgrade-r-and-python.md).
...
4. Введите и выполните `print(revoscalepy.__version__)` , чтобы вернуть сведения о версии. Вы должны увидеть 9.2.1 или 9.3.0. [На сервере](../package-management/r-package-information.md)можно использовать любую из этих версий с revoscalepy.
