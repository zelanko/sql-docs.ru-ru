---
title: Настройка клиентских средств Python для использования с SQL Server машинного обучения | Документы Microsoft
ms.prod: sql
...
ms.locfileid: "31203806"
---
# <a name="set-up-python-client-tools-for-use-with-sql-server-machine-learning"></a>Настройка Python клиентские средства для работы с SQL Server машинного обучения
