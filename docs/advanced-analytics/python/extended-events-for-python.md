---
title: Расширенные события для Python в машинном обучении SQL Server | Документы Microsoft
ms.prod: sql
...
---
# <a name="extended-events-for-python-in-sql-server-machine-learning"></a>Расширенные события для Python в машинном обучении SQL Server
