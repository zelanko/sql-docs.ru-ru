...
Для любой версии SQL Server выполните следующую инструкцию, чтобы проверить библиотеке пакетов R по умолчанию для текущего экземпляра.
