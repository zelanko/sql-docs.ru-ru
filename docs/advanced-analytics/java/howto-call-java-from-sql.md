...
2. Отправка скомпилированных классов в JAR-файл и другие зависимости в базу данных при помощи [внешняя библиотека](#external-library) DDL. Этот параметр доступен для Windows только в CTP-версии 2.3. Поддержка Linux будет добавлена в более поздней версии CTP-версии.
