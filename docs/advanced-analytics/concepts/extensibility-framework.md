...
Платформа расширяемости была представлена в SQL Server 2016 для поддержки среды выполнения R. В SQL Server 2017 и более поздних версий поддерживается Python.
...
|-------------------|-----------|---------------------|
| RLauncher. dll для языка R | [Расширение R](extension-r.md) | SQL Server 2016 и более поздние версии |
| Писонлаунчер. dll для Python 3,5 | [Расширение Python](extension-python.md) | SQL Server 2017 и более поздних версий |
...
**Вспомогательная функция SQL** — это API расширяемости, включенный в ядро СУБД, который поддерживает внешний код или внешние среды выполнения, C++реализованные с помощью C или.
