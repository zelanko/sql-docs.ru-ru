...
В настоящее время не поддерживается для служб машинного обучения (R и Python) в базе данных SQL Azure. Поддержка уже запланирована, но есть не запланированная дата их выпуска в данный момент.  
