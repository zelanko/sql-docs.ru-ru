...
### [Внедренные R в хранимые процедуры и функции](tutorials/sqldev-in-database-r-for-sql-developers.md)
#### [1 — Получение данных и сценариев](tutorials/sqldev-download-the-sample-data.md)
#### [2 — Настройка среды](r/sqldev-import-data-to-sql-server-using-powershell.md)
#### [3 - визуализируйте данные с помощью R в хранимые процедуры](tutorials/sqldev-explore-and-visualize-the-data.md)
#### [4 - Создание компонентов данных, с использованием R в функции T-SQL](tutorials/sqldev-create-data-features-using-t-sql.md)
#### [5 — обучение и сохранить в SQL](r/sqldev-train-and-save-a-model-using-t-sql.md)
#### [6 - предсказать результаты](tutorials/sqldev-operationalize-the-model.md)
