...
Данные о скорости автомобиля содержат два столбца: "мощность" (`hp`) и "`wt`вес" (). На основе этих данных вы создадите обобщенную линейную модель (GLM), которая оценивает вероятность того, что транспортный автомобиль перемещается вручную.
...
Чтобы узнать об обработке типов данных R в SQL Server, следуйте указаниям в этом кратком руководстве:
