...
description: Пошаговое руководство по выполнению пользовательского скрипта R в SQL Server с помощью функций RevoScaleR.
ms.prod: sql
...
ms.locfileid: "73726543"
---
# <a name="run-custom-r-functions-on-sql-server-using-rxexec"></a>Выполнение пользовательских функций R в SQL Server с помощью rxExec
