...
+ На сервере SQL Server должны быть установлены библиотеки с открытым кодом или сторонние библиотеки, которые используются в функции, включая зависимости. Дополнительные сведения см. в статье [Установка новых пакетов R](../r/install-additional-r-packages-on-sql-server.md).
