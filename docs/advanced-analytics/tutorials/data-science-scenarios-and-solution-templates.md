...
description: В этой статье описываются шаблоны, которые демонстрируют практические приемы и предоставляют стандартные блоки для быстрой реализации собственного решения. Каждый шаблон предназначен для решения определенной проблемы в конкретной области или отрасли.
ms.prod: sql
...
Шаблоны — это образцы решений, которые демонстрируют практические приемы и предоставляют стандартные блоки для быстрой реализации собственного решения. Каждый шаблон предназначен для решения определенной проблемы в конкретной области или отрасли. Каждый шаблон охватывает различные задачи: от подготовки данных и формирования характеристик до обучения модели и оценки. Используйте эти шаблоны для изучения принципов работы служб [!INCLUDE[rsql_productname](../../includes/rsql-productname-md.md)]. Затем вы можете настроить шаблон в соответствии с конкретной ситуацией и создать собственное решение. 
