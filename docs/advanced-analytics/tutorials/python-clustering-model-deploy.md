---
title: Учебник. Развертывание модели в Python для категоризации клиентов
...
В [третьей части](python-clustering-model-build.md)вы узнали, как создать и обучить модель кластеризации K-средних в Python.

## <a name="prerequisites"></a>Предварительные требования

* В четвертой части этой серии руководств предполагается, что вы выполнили предварительные требования к первой части и выполнили [**шаги,** ](python-clustering-model.md)описанные в части [**две**](python-clustering-model-prepare-data.md) и [**третий**](python-clustering-model-build.md).
...
Предположим, вы хотите отправить рекламное письмо клиентам в кластере 0, неактивной группе (вы можете увидеть, как четыре кластера были описаны в [третьей части](python-clustering-model-build.md#analyze-the-results) этого руководства). Следующий код выбирает адреса электронной почты клиентов в кластере 0.
