---
title: Учебник. Подготовка данных для кластеризации в Python
...
В второй части серии руководств из четырех частей вы импортируете и готовите данные из базы данных SQL с помощью Python. Далее в этой серии вы будете использовать эти данные для обучения и развертывания модели кластеризации в Python с помощью SQL Server Службы машинного обучения.
...
* В части 2 этого учебника предполагается, что вы выполнили предварительные требования к первой [**части**](tutorial-python-clustering-model.md).
...
> [Учебник. Создание прогнозной модели на языке Python с помощью SQL Server Службы машинного обучения](tutorial-python-clustering-model-build.md)
