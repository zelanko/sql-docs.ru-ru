---
title: Учебник. Создание модели кластеризации в Python
...
ms.locfileid: "70211978"
---
# <a name="tutorial-build-a-clustering-model-in-python-with-sql-server-machine-learning-services"></a>Учебник. Создание модели кластеризации в Python с помощью SQL Server Службы машинного обучения
...
* В третьей части этого руководства предполагается, что вы выполнили предварительные требования к первой [**части**](tutorial-python-clustering-model.md)и выполнили действия, описанные в [**второй части**](tutorial-python-clustering-model-prepare-data.md).
...
Четыре кластера означают использование переменных, определенных в [первой части](tutorial-python-clustering-model-prepare-data.md#separate-customers):
...
> [Учебник. Развертывание модели кластеризации в Python с помощью SQL Server Службы машинного обучения](tutorial-python-clustering-model-deploy.md)