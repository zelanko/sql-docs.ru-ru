...
Description: Создание базы данных, содержащей набор данных Iris и таблицу для хранения моделей. Этот набор данных используется в упражнения, в котором показано, как программы-оболочки для языка R или Python код в хранимую процедуру SQL Server.
ms.prod: sql
