...
### <a name="22-hang-when-executing-r-scripts-containing-parallel-execution"></a>22. Система прекращает отвечать на запросы при выполнении скриптов R, включающих параллельное выполнение
