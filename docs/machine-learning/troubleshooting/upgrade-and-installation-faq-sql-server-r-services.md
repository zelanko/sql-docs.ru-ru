---
title: Вопросы и ответы по установке и обновлению
description: Ответы на некоторые распространенные вопросы по установке и обновлению функций машинного обучения в SQL Server.
ms.prod: sql
...
ms.locfileid: "87253758"
---
# <a name="installation-and-upgrade-faq-for-sql-server-machine-learning-or-r-server"></a>Часто задаваемые вопросы по установке и обновлению функций машинного обучения в SQL Server или R Server
[!INCLUDE [SQL Server](../../includes/applies-to-version/sqlserver.md)]

В этой статье приводятся ответы на некоторые распространенные вопросы по установке функций машинного обучения в SQL Server. Здесь также рассматриваются общие вопросы об обновлениях.
