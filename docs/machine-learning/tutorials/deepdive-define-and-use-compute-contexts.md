...
description: Узнайте о функции RxInSqlServer, которая позволяет определить контекст вычислений для удаленного экземпляра SQL Server.
ms.prod: sql
...
> [Вычисление сводной статистики в локальных и удаленных контекстах вычислений](../../machine-learning/tutorials/deepdive-create-and-run-r-scripts.md)