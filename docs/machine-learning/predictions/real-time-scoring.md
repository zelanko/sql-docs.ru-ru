...
Дополнительные сведения об оценке в SQL Server см. в статье [Создание прогнозов с помощью службы машинного обучения в SQL Server](how-to-do-realtime-scoring.md).
