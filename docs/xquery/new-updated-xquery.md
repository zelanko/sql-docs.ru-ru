---
title: Обновлено - XQuery для документации по SQL Server | Документы Microsoft
description: Отображение фрагментов обновленное содержимое для последних измененных в документации, XQuery для Microsoft SQL Server.
manager: craigg
author: MightyPen
ms.author: genemi
ms.topic: article
...
ms.locfileid: "32739306"
---
# <a name="new-and-recently-updated-xquery-for-sql-server"></a>Новые и недавно обновленные: XQuery для SQL Server
...
- *Предметной области:* &nbsp; **XQuery для SQL Server**.
