...
### <a name="example-function-over-union-type"></a>Пример использование функции с объединенным типом  
...
### <a name="example-operator-over-union-type"></a>Пример использование оператора с объединенным типом  
