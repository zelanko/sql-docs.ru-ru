...
## <a name="using-computed-constructors"></a>Использование вычисляемых конструкторов  
 , и делает это по-другому. В данном случае указываются ключевые слова, которые идентифицируют тип узла, подлежащий построению. Поддерживается использование только следующих ключевых слов:  
