...
|ge|Больше или равно|  
 ...
 Например, следующий запрос получает \<Picture> элементы для модели продукта, для которой размер изображения — "Малый:  
...
-   \<Size>Значение элемента сравнивается с указанным атомарным значением "Small".  
