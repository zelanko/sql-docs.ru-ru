...
|Раздел|Description|  
|-----------|-----------------|  
|[SQL Server &#40;XML-данных&#41;](../relational-databases/xml/xml-data-sql-server.md)|Описание поддержки типа данных **XML**в методах [!INCLUDE[ssDE](../includes/ssde-md.md)] и методов, которые можно использовать для этого типа данных. Тип данных **XML** формирует модель входных данных XQuery, на которой выполняются выражения XQuery.|  
