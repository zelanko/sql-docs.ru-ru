...
- Теперь во встроенных отчетах служб SSIS отображаются журналы масштабированного выполнения SSIS в CTP 2.1.
- Приложение для управления масштабированием служб SSIS
  - Общие сведения о мастере масштабирования.
  - Простое добавление рабочей роли в масштабное развертывание.
...
- Обозреватель объектов: исправлена ошибка, из-за которой узел "Базы данных" не разворачивался при подключении к базе данных Azure, созданной в результате копирования.
