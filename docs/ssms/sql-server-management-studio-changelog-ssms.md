...
- Устранена проблема, из-за которой функция статистики активных запросов переставала отвечать на запросы, когда она запускалась из монитора активности и использовалась аутентификация SQL. 
