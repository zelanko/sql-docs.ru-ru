...
## <a name="ssms-172download-sql-server-management-studio-ssmsmd"></a>[SQL Server Management Studio 17.2](download-sql-server-management-studio-ssms.md)
...
### <a name="analysis-services-as"></a>Службы Analysis Services
...
### <a name="integration-services-is"></a>Службы Integration Services
...
- Постоянное шифрование: исправлена проблема, из-за которой в создаваемом файле журнала отсутствовали данные, созданные DacFx.
...
* Добавлено диалоговое окно «Резервное копирование по URL-адресу», позволяющее создавать учетные данные хранилища Azure для резервных копий SQL Server 2016. Это диалоговое окно упрощает сохранение резервных копий базы данных в учетной записи хранения Azure.
