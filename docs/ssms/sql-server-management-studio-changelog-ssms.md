...
- Это первый выпуск SSMS, который полностью *поддерживает* [!INCLUDE[sql-server-2019](..\includes\sssqlv15-md.md)] (уровень совместимости compatLevel 150 и т. д.).
