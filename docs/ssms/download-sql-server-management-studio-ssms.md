...
*Предварительная версия 5* — это вторая общедоступная предварительная версия SSMS 18.0. Если на компьютере установлена предыдущая предварительная версия SSMS 18.0, перед установкой предварительной версии 5 ее необходимо удалить.

**Сведения о версии**

- Номер выпуска: 18.0 (предварительная версия 5)<br>
...
## <a name="available-languages-ssms-180-preview-5"></a>Доступные языки (SSMS 18.0, предварительная версия 5)

Этот выпуск SSMS можно установить на следующих языках.

SQL Server Management Studio 18.0 (предварительная версия 5):<br>
[Китайский (упрощенное письмо)](https://go.microsoft.com/fwlink/?linkid=2041155&clcid=0x804) | [Китайский (традиционное письмо)](https://go.microsoft.com/fwlink/?linkid=2041155&clcid=0x404) | [Английский (США)](https://go.microsoft.com/fwlink/?linkid=2041155&clcid=0x409) | [Французский](https://go.microsoft.com/fwlink/?linkid=2041155&clcid=0x40c) | [Немецкий](https://go.microsoft.com/fwlink/?linkid=2041155&clcid=0x407) | [Итальянский](https://go.microsoft.com/fwlink/?linkid=2041155&clcid=0x410) | [Японский](https://go.microsoft.com/fwlink/?linkid=2041155&clcid=0x411) | [Корейский](https://go.microsoft.com/fwlink/?linkid=2041155&clcid=0x412) | [Португальский (Бразилия)](https://go.microsoft.com/fwlink/?linkid=2041155&clcid=0x416) | [Русский](https://go.microsoft.com/fwlink/?linkid=2041155&clcid=0x419) | [Испанский](https://go.microsoft.com/fwlink/?linkid=2041155&clcid=0x40a)

Пакет обновления SQL Server Management Studio 18.0 (обновление до версии 18.0):<br>
В настоящее время варианты обновления недоступны. Если на компьютере установлена предыдущая предварительная версия SSMS 18.0, перед установкой предварительной версии 5 ее необходимо удалить.
...
## <a name="new-in-this-release-ssms-180-preview-5"></a>Новые возможности в этом выпуске (SSMS 18.0, предварительная версия 5)

SSMS 18.0 (предварительная версия 5) — это новейшая версия SQL Server Management Studio. Поколение 18.x среды SSMS поддерживает почти все функциональные возможности выпусков SQL Server 2008–SQL Server 2019 (предварительная версия).
...
## <a name="supported-operating-systems-ssms-180-preview-5"></a>Поддерживаемые операционные системы (SSMS 18.0, предварительная версия 5)
...
## <a name="release-notes-ssms-180-preview-5"></a>Заметки о выпуске (SSMS 18.0, предварительная версия 5)

Ниже приведены известные проблемы в SSMS 18.0 (предварительная версия 5).
