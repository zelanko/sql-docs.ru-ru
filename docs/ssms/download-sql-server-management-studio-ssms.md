...
[Доступна общедоступная предварительная версия 7 SSMS 18.0](#ssms-180-preview-7). Это новейшее поколение *SQL Server Management Studio* с поддержкой [!INCLUDE[sql-server-2019](../includes/sssqlv15-md.md)].
...
## <a name="ssms-180-preview-7"></a>SSMS 18.0 (предварительная версия 7)

**Доступна общедоступная предварительная версия 7 SSMS 18.0. Это новейшее поколение *SQL Server Management Studio* с поддержкой [!INCLUDE[sql-server-2019](../includes/sssqlv15-md.md)]!**

**[![скачать](../ssdt/media/download.png) Скачать SQL Server Management Studio 18.0 (предварительная версия 7)](https://go.microsoft.com/fwlink/?linkid=2078638)**

*Предварительная версия 7* — это новейшая общедоступная предварительная версия SSMS 18.0. Если на компьютере установлена предыдущая предварительная версия SSMS 18.0, перед установкой предварительной версии 7 ее необходимо удалить.

**Сведения о версии**

- Номер выпуска: 18.0 (предварительная версия 7)<br>
...
## <a name="available-languages-ssms-180-preview-7"></a>Доступные языки (SSMS 18.0, предварительная версия 7)

Этот выпуск SSMS можно установить на следующих языках.

SQL Server Management Studio 18.0 (предварительная версия 7):<br>
[Китайский (упрощенное письмо)](https://go.microsoft.com/fwlink/?linkid=2078638&clcid=0x804) | [Китайский (традиционное письмо)](https://go.microsoft.com/fwlink/?linkid=2078638&clcid=0x404) | [Английский (США)](https://go.microsoft.com/fwlink/?linkid=2078638&clcid=0x409) | [Французский](https://go.microsoft.com/fwlink/?linkid=2078638&clcid=0x40c) | [Немецкий](https://go.microsoft.com/fwlink/?linkid=2078638&clcid=0x407) | [Итальянский](https://go.microsoft.com/fwlink/?linkid=2078638&clcid=0x410) | [Японский](https://go.microsoft.com/fwlink/?linkid=2078638&clcid=0x411) | [Корейский](https://go.microsoft.com/fwlink/?linkid=2078638&clcid=0x412) | [Португальский (Бразилия)](https://go.microsoft.com/fwlink/?linkid=2078638&clcid=0x416) | [Русский](https://go.microsoft.com/fwlink/?linkid=2078638&clcid=0x419) | [Испанский](https://go.microsoft.com/fwlink/?linkid=2078638&clcid=0x40a)

Пакет обновления SQL Server Management Studio 18.0 (обновление до версии 18.0):<br>
В настоящее время варианты обновления недоступны. Если на компьютере установлена предыдущая предварительная версия SSMS 18.0, перед установкой предварительной версии 7 ее необходимо удалить.
...
## <a name="new-in-this-release-ssms-180-preview-7"></a>Новые возможности в этом выпуске (SSMS 18.0, предварительная версия 7)

SSMS 18.0 (предварительная версия 7) — это новейшая версия SQL Server Management Studio. Поколение 18.x среды SSMS поддерживает почти все функциональные возможности выпусков SQL Server 2008–SQL Server 2019 (предварительная версия).
...
## <a name="supported-sql-offerings-ssms-180-preview-7"></a>Поддерживаемые предложения SQL (SSMS 18.0, предварительная версия 7)
...
## <a name="supported-operating-systems-ssms-180-preview-7"></a>Поддерживаемые операционные системы (SSMS 18.0, предварительная версия 7)
...
<sup>*</sup> Требуется версия 1607 (10.0.14939) или более поздняя
...
## <a name="release-notes-ssms-180-preview-7"></a>Заметки о выпуске (SSMS 18.0, предварительная версия 7)
