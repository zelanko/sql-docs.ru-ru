...
| Обозреватель объектов | Исправлена проблема, из-за которой при переименовании баз данных в обозревателе объектов отображались неверные имена. Дополнительные сведения см. на сайте [UserVoice](https://feedback.azure.com/forums/908035/suggestions/37638472). |
