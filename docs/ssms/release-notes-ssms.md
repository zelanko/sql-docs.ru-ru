...
Скачать: &nbsp; &nbsp; [Скачать SSMS 18.1](download-sql-server-management-studio-ssms.md)<br/>
...
| Высокое разрешение | Фиксированный макет страницы *Создание расписания задания*. См. дополнительные сведения на [форуме обратной связи](https://feedback.azure.com/forums/908035/suggestions/37632094). |
...
| Средство просмотра журнала | Устранена проблема, когда в SSMS всегда открывается журнал текущего сервера (или агента), даже в том случае, если дважды щелкнуть старый архив в обозревателе объектов. См. дополнительные сведения на [форуме обратной связи](https://feedback.azure.com/forums/908035/suggestions/37633648). |
| Установка SSMS | Исправлена проблема, которая вызывала ошибку программы установки SSMS, если путь к журналу установки содержит пробелы. См. дополнительные сведения на [форуме обратной связи](https://feedback.azure.com/forums/908035/suggestions/37496110). |
| Установка SSMS | Устранена проблема, когда происходил выход из SSMS сразу после отображения экране-заставки. </br> Дополнительные сведения см. на сайтах: [форум обратной связи](https://feedback.azure.com/forums/908035/suggestions/37502512), [SSMS отказывается запускаться](https://dba.stackexchange.com/questions/238609/ssms-refuses-to-start) и [Администраторы баз данных](https://dba.stackexchange.com/questions/237086/sql-server-management-studio-18-wont-open-only-splash-screen-pops-up). |
...
| Обозреватель объектов | Исправлена проблема, при которой *отключенный* пункт меню оставался включен даже после отключения заданного индекса. См. дополнительные сведения на [форуме обратной связи](https://feedback.azure.com/forums/908035/suggestions/37735375). |
| Отчеты | Исправление отчетов фактически выводит GrantedQueryMemory в КБ (отчет панели мониторинга производительности SQL). См. дополнительные сведения на [форуме обратной связи](https://feedback.azure.com/forums/908035/suggestions/37167289). |
...
| Написание скриптов и SMO | Исправлена ошибка, из-за которой команда "Создать скрипт" в графовой таблице вызывает сбой при создании данных. См. дополнительные сведения на [форуме обратной связи](https://feedback.azure.com/forums/908035-sql-server/suggestions/32898466). |
...
| Агент SQL Server | Исправлена проблема, которая вызывала аварийное завершение SSMS при работе с окном "Свойства задания". См. дополнительные сведения на [форуме обратной связи](https://feedback.azure.com/forums/908035/suggestions/37164244). |
