...
|обозревателе объектов|Исправлена проблема в конфигурации Database Mail, при которой состояние флажка SSL не сохранялось. См. раздел https://feedback.azure.com/forums/908035-sql-server/suggestions/32895541. |
