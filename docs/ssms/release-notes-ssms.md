...
- При переключении между несколькими окнами запросов в SSMS 18.0 возникают проблемы перерисовки. См. раздел [UserVoice](https://feedback.azure.com/forums/908035/suggestions/37474042). Для решения этой проблемы можно отключить аппаратное ускорение в разделе **Сервис** > **Параметры**.
...
| Установка SSMS | Устранена проблема, которая вызывала ошибку программы установки SSMS при наличии пробелов в пути к журналу установки. Дополнительные сведения см. на сайте [UserVoice](https://feedback.azure.com/forums/908035/suggestions/37496110). |
