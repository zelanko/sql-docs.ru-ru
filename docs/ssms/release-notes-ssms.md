...
| Написание скриптов и SMO | [API Оценки SQL](../sql-assessment-api/sql-assessment-api-overview.md) — добавлена поддержка управляемого экземпляра SQL Azure. |
