...
Более подробный учебник по использованию мастера формирования и публикации скриптов см. на странице [Учебник. Мастер формирования скриптов](https://docs.microsoft.com/sql/ssms/tutorials/scripting-ssms#script-databases).
...
###  <a name="provider-configuration-page"></a><a name="ProvConfig"></a> Страница «Конфигурация поставщика»  
