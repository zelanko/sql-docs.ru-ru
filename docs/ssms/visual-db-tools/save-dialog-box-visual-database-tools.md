...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)] Отображается, если сохранить изменения в конструкторе таблиц, касающиеся других таблиц. Это диалоговое окно позволяет подтвердить то, какие таблицы будут сохранены.  
