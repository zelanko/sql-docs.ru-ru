...
|-----------------------|---------------|  
|![Значок визуальных инструментов для баз данных](../../ssms/visual-db-tools/media/dv3wbi7.gif "Visual Database Tools icon")<br /><br />![Значок визуальных инструментов для баз данных](../../ssms/visual-db-tools/media/dv3wbi8.gif "Visual Database Tools icon")<br /><br />![Значок визуальных инструментов для баз данных](../../ssms/visual-db-tools/media/dv3wbi9.gif "Visual Database Tools icon")<br /><br />![Значок визуальных инструментов для баз данных](../../ssms/visual-db-tools/media/dv3wbia.gif "Visual Database Tools icon")|Указывает, появляется ли тот или иной столбец данных в результирующем наборе запроса (запрос Select) или этот столбец используется в запросе Update, Insert From, Make Table либо Insert Into. Выберите столбец для добавления к результатам. При выборе значения **(все столбцы)** в выходных данных появляются все столбцы с данными.<br /><br />Этот значок используется при изменении состояния флажков в соответствии с типом создаваемого запроса. При создании запроса Delete возможность выбора отдельных столбцов не предусматривается.|  
|![Значок визуальных инструментов для баз данных](../../ssms/visual-db-tools/media/dv3wbib.gif "Visual Database Tools icon")<br /><br />![Значок визуальных инструментов для баз данных](../../ssms/visual-db-tools/media/dv3wbic.gif "Visual Database Tools icon")|Указывает на то, что используемый столбец данных используется для упорядочивания результатов запроса (является частью предложения ORDER BY). Этот значок появляется с буквами A-Z при сортировке по возрастанию и с буквами Z-A при сортировке по убыванию.|  
