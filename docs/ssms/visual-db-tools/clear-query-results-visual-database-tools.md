---
description: Очистка результатов запросов (визуальные инструменты для баз данных)
title: Очистка результатов запросов
...
-   Щелкните правой кнопкой мыши на [панели результатов](../../ssms/visual-db-tools/results-pane-visual-database-tools.md), выберите **Панель**и щелкните **Очистить результаты**.  
