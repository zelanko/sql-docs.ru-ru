---
title: "Определение нескольких условий поиска для одного столбца | Документация Майкрософт"
ms.custom: 
ms.date: 01/19/2017
...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)] Иногда может понадобиться сочетание нескольких условий поиска для одного столбца. Например, может понадобиться:  
