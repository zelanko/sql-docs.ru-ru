---
description: Добавление новых строк на панель результатов (визуальные инструменты для баз данных)
...
Если при сохранении строки произойдет ошибка, конструктор запросов и представлений отобразит соответствующее сообщение, а затем осуществит возврат к редактируемой строке. Затем можно:  
