---
description: Навигация по конструктору запросов и представлений (визуальные инструменты для баз данных)
title: Перемещение по конструктору запросов и представлений
...
|Кому|Сочетание клавиш|Щелкните|  
|------|---------|---------|  
