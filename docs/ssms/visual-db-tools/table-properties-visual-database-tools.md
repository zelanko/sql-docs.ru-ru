---
description: Свойства таблицы (визуальные инструменты для баз данных)
...
[Проектирование таблиц](../../ssms/visual-db-tools/design-tables-visual-database-tools.md)  
