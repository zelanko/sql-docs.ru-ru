...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)] В конструкторе диаграмм баз данных можно работать как при помощи мыши, так и при помощи клавиатуры. Дополнительные сведения об особых методах, использованных в конструкторе диаграмм баз данных, см. в следующих таблицах.  
