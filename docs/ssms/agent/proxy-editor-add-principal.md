...
При помощи этой страницы можно предоставить участникам сервера доступ к учетной записи-посреднику агента [!INCLUDE[msCoName](../../includes/msconame_md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] .  
