---
title: Изменение задания агента главного сервера SQL Server
...
В следующих разделах описано, как изменить главное задание агента [!INCLUDE[msCoName](../../includes/msconame_md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)].  
...
[Изменение шагов главного задания агента SQL Server](../../ssms/agent/change-steps-of-a-sql-server-agent-master-job.md)  
  
[Remove Steps from a SQL Server Agent Master Job](../../ssms/agent/remove-steps-from-a-sql-server-agent-master-job.md)  
  
[Изменение целевого сервера, связанного с главным заданием агента SQL Server](../../ssms/agent/modify-the-target-server-s-associated-with-a-sql-server-agent-master-job.md)  
