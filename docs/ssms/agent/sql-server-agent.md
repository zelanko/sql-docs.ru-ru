...
[!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)] — это служба Microsoft Wвdows, выполняющая запланированные административные задачи, которые называются *заданиями* в [!INCLUDE[ssCurrent](../../includes/sscurrent_md.md)].  
