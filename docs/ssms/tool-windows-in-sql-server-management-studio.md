...
Все средства в среде [!INCLUDE[ssManStudioFull](../includes/ssmanstudiofull_md.md)] взаимодействуют друг с другом. Например, можно:  
