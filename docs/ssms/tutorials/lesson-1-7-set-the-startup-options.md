...
---
# <a name="lesson-1-7---set-the-startup-options"></a>Занятие 1–7. Настройка параметров запуска
...
[Восстановление установленной по умолчанию конфигурации среды SQL Server Management Studio](../../tools/sql-server-management-studio/lesson-1-8-restore-the-default-sql-server-management-studio-configuration.md)  
