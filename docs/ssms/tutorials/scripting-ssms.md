...
2. Нажмите кнопку **Далее** на странице **Сводка**. После нажмите кнопку **Далее** еще раз, чтобы создать скрипт в окне **Новый запрос**. 
3. Откройте диалоговое окно **Найти** (CTRL+F). Щелкните стрелку вниз, чтобы открыть пункт **Заменить**. Вверху, в строке **Найти**, введите *AdventureWorks2016*. Внизу, в строке **Заменить**, введите *AdventureWorks2016b*. 
4. Выберите **Заменить все**, чтобы заменить все значения *AdventureWorks2016* на *AdventureWorks2016b*. 
