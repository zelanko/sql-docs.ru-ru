...
В следующей статье приводятся дополнительные советы и рекомендации по использованию SSMS, например сведения о том, как найти журнал ошибок SQL Server и определить имя экземпляра SQL. 
