...
ms.locfileid: "56662768"
---
# <a name="tutorial-using-templates-in-sql-server-management-studio"></a>Учебник. Использование шаблонов в среде SQL Server Management Studio
