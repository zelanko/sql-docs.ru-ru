...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)] ограничивает диалоговые окна выбора объектов только нужными типами объектов.  
