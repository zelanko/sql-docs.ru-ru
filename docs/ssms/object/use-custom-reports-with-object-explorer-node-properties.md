...
3.  В среде [!INCLUDE[ssManStudio](../../includes/ssmanstudio_md.md)]щелкните узел в обозревателе объектов, укажите **Отчеты**и выберите "Пользовательские отчеты". В диалоговом окне **Открытие файла** перейдите в папку пользовательских отчетов, выберите файл отчета и нажмите кнопку **Открыть**.  
