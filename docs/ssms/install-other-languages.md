...
[Среда SSMS доступна на нескольких языках](download-sql-server-management-studio-ssms.md#available-languages-ssms-179), но установщик SSMS блокирует установку на компьютерах, если языковой стандарт операционной системы не соответствует языку SSMS. 
