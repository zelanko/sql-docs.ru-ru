...
[Среда SSMS доступна на нескольких языках](download-sql-server-management-studio-ssms.md#available-languages-ssms-180-preview), но установщик SSMS блокирует установку на компьютерах, если языковой стандарт операционной системы не соответствует языку SSMS. 
...
3. После изменения языка операционной системы, [установите версию SSMS на том же языке](download-sql-server-management-studio-ssms.md#available-languages-ssms-180-preview). Во время первой установки нового языка SSMS используйте полный пакет. Пакет обновления можно использовать для последующих установок.
