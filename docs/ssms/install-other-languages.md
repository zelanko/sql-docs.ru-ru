...
[Среда SSMS доступна на нескольких языках](download-sql-server-management-studio-ssms.md#available-languages-ssms-1791), но установщик SSMS блокирует установку на компьютерах, если языковой стандарт операционной системы не соответствует языку SSMS. 
...
3. После изменения языка операционной системы [можно установить одну из нескольких языковых версий SSMS](download-sql-server-management-studio-ssms.md#available-languages-ssms-1791). Во время первой установки нового языка SSMS используйте полный пакет. Пакет обновления можно использовать для последующих установок.
