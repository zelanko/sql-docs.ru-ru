...
description: "Отрывки из недавно обновленного содержимого в документации по SQL Server Management Studio (SSMS) для Microsoft SQL Server."
services: na
documentationcenter: 
author: MightyPen
manager: jhubbard
...
1. [Изменение регистрационных данных сервера (SQL Server Management Studio)](register-servers/change-a-server-s-registration-sql-server-management-studio.md)
2. [Изменение имени зарегистрированного сервера или зарегистрированной группы серверов](register-servers/change-the-name-of-registered-server-or-registered-server-group.md)
3. [Подключение к зарегистрированному серверу (SQL Server Management Studio)](register-servers/connect-to-a-registered-server-sql-server-management-studio.md)
4. [Создание центрального сервера управления и группы серверов](register-servers/create-a-central-management-server-and-server-group.md)
5. [Создание нового зарегистрированного сервера (среда SQL Server Management Studio)](register-servers/create-a-new-registered-server-sql-server-management-studio.md)
6. [Создание или изменение группы серверов (SQL Server Management Studio)](register-servers/create-or-edit-a-server-group-sql-server-management-studio.md)
7. [Отключение от зарегистрированного сервера (SQL Server Management Studio)](register-servers/disconnect-from-a-registered-server-sql-server-management-studio.md)
8. [Выполнение инструкций на нескольких серверах одновременно](register-servers/execute-statements-against-multiple-servers-simultaneously.md)
9. [Экспорт сведений о зарегистрированном сервере (SQL Server Management Studio)](register-servers/export-registered-server-information-sql-server-management-studio.md)
10. [Импорт сведений о зарегистрированном сервере (SQL Server Management Studio)](register-servers/import-registered-server-information-sql-server-management-studio.md)
11. [Перемещение зарегистрированного сервера или зарегистрированной группы серверов](register-servers/move-a-registered-server-or-registered-server-group.md)
12. [Регистрация подключенного сервера (SQL Server Management Studio)](register-servers/register-a-connected-server-sql-server-management-studio.md)
13. [Справка F1 по зарегистрированным серверам](register-servers/registered-servers-f1-help.md)
14. [Регистрация серверов](register-servers/register-servers.md)
15. [Удаление зарегистрированного сервера (SQL Server Management Studio)](register-servers/remove-a-registered-server-sql-server-management-studio.md)
16. [Удаление группы серверов (SQL Server Management Studio)](register-servers/remove-a-server-group-sql-server-management-studio.md)
17. [Просмотр зарегистрированных серверов в среде SQL Server Management Studio](register-servers/view-registered-servers-in-sql-server-management-studio.md)
18. [Сочетания клавиш среды SQL Server Management Studio](sql-server-management-studio-keyboard-shortcuts.md)
19. [Программа SSMS](ssms-utility.md)
20. [Урок 1-1. Запуск SQL Server Management Studio](tutorials/lesson-1-1-start-sql-server-management-studio.md)
21. [Урок 1-2. Подключение к зарегистрированным серверам и обозревателю объектов](tutorials/lesson-1-2-connect-with-registered-servers-and-object-explorer.md)
22. [Урок 1-3. Изменение структуры среды](tutorials/lesson-1-3-change-the-environment-layout.md)
23. [Урок 1-4. Отображение окна запроса](tutorials/lesson-1-4-display-the-query-window.md)
24. [Урок 1-5. Отображение страницы "Сведения об обозревателе объектов"](tutorials/lesson-1-5-show-the-object-explorer-details-page.md)
25. [Урок 1-6. Выбор схемы сочетаний клавиш](tutorials/lesson-1-6-select-the-keyboard-shortcut-scheme.md)
26. [Урок 1-7. Настройка параметров запуска](tutorials/lesson-1-7-set-the-startup-options.md)
27. [Урок 1-8. Восстановление конфигурации SQL Server Management Studio по умолчанию](tutorials/lesson-1-8-restore-the-default-sql-server-management-studio-configuration.md)
28. [Урок 1-9. Сводка. Базовая навигация](tutorials/lesson-1-9-summary-basic-navigation.md)
29. [Занятие 1. Основные возможности перемещения в среде SQL Server Management Studio](tutorials/lesson-1-basic-navigation-in-sql-server-management-studio.md)
30. [Урок 2-1. Подключение к редактору запросов](tutorials/lesson-2-1-connecting-with-query-editor.md)
31. [Урок 2-2. Добавление отступов](tutorials/lesson-2-2-adding-indentation.md)
32. [Урок 2-3. Разворачивание окна редактора запросов](tutorials/lesson-2-3-maximizing-query-editor.md)
33. [Урок 2-4. Использование комментариев](tutorials/lesson-2-4-using-comments.md)
34. [Урок 2-5. Другие способы просмотра окна кода](tutorials/lesson-2-5-other-ways-of-viewing-the-code-window.md)
35. [Урок 2-6. Создание скрипта таблицы](tutorials/lesson-2-6-script-a-table.md)
36. [Занятие 2. Создание инструкций на языке Transact-SQL](tutorials/lesson-2-writing-transact-sql.md)
37. [Урок 3-1. Создание скриптов на основе шаблонов](tutorials/lesson-3-1-create-scripts-using-templates.md)
38. [Урок 3-2. Создание настраиваемых шаблонов](tutorials/lesson-3-2-create-custom-templates.md)
39. [Урок 3-3. Сохранение скриптов в виде проектов или решений](tutorials/lesson-3-3-save-scripts-as-projects-or-solutions.md)
40. [Урок 3-4. Сводка. Решения и проекты скриптов](tutorials/lesson-3-4-summary-solutions-and-script-projects.md)
41. [Урок 3. Работа с шаблонами, решениями и проектами скриптов](tutorials/lesson-3-working-with-templates-solutions-and-script-projects.md)
42. [Руководство: SQL Server Management Studio](tutorials/tutorial-sql-server-management-studio.md)
...
- Обозреватель объектов: исправлена проблема, из-за которой узел "Базы данных" не разворачивался при подключении к базе данных Azure, созданной с помощью команды копирования AS COPY.
