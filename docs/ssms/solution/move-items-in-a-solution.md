...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)] Элементы проектов [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull_md.md)] — это запросы, подключения и прочие файлы. В обозревателе решений можно перемещать запросы и прочие файлы между проектами, но соединения перемещать нельзя.  
