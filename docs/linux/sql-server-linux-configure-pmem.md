...
В это статье описывается настройка энергонезависимой памяти (PMEM) для SQL Server на Linux. Поддержка PMEM в Linux появилась в предварительной версии SQL Server 2019.
