...
- Обновление до общедоступной версии выпуска [!INCLUDE[ssSQL17](../includes/sssql17-md.md)] поддерживаются только из CTP 2.1 или более поздней версии. 
