---
title: Настройка групп доступности Always On и экземпляров отказоустойчивого кластера для конфигураций с несколькими подсетями в Linux
description: ''
author: MikeRayMSFT
ms.author: mikeray
ms.reviewer: vanto
