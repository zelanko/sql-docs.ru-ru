...
2. Обновление экземпляров SQL Server, размещения вторичных реплик.
    ...
    A. Сначала обновите асинхронные вторичные реплики.
   ...
   b.1. Остановить ресурса на узел, содержащий вторичную реплику, предназначенных для обновления
   ...
   ```
   b.2. Обновление SQL Server на вторичной реплике
   ...
   ```
   b.3. Удаление ограничения расположения
