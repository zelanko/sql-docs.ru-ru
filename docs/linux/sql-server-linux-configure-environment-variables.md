...
Для настройки предварительной версии SQL Server 2019 на Linux можно использовать несколько различных переменных среды. Эти переменные используются в двух сценариях:
