...
1. Настройте новый репозиторий.
   ...
   | Ubuntu | CU | "sudo перелистывание https://packages.microsoft.com/keys/microsoft.asc \| добавить apt sudo ключа - & & sudo добавить apt репозиториев «$(curl https://packages.microsoft.com/config/ubuntu/16.04/mssql-server-2017.list)» " |
   | Ubuntu | GDR | "sudo перелистывание https://packages.microsoft.com/keys/microsoft.asc \| добавить apt sudo ключа - & & sudo добавить apt репозиториев «$(curl https://packages.microsoft.com/config/ubuntu/16.04/mssql-server-2017-gdr.list)» " |
