...
description: В этом руководстве показано, как настроить репликацию моментального снимка SQL Server в Linux.
author: MikeRayMSFT
ms.author: mikeray
ms.reviewer: vanto
ms.date: 09/24/2018
...
ms.locfileid: "68130111"
---
# <a name="configure-replication-with-t-sql"></a>Настройка репликации с помощью T-SQL

[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md-linuxonly](../includes/appliesto-ss-xxxx-xxxx-xxx-md-linuxonly.md)] 

В этом руководстве вы настроите репликацию моментального снимка SQL Server в Linux для двух экземпляров SQL Server с помощью Transact-SQL. Издатель и распространитель будут одним экземпляром, а подписчик — отдельным экземпляром.
...
1. Включите агенты репликации SQL Server в Linux. Разрешите агенту SQL Server использовать агенты репликации. На обоих хост-компьютерах выполните приведенные ниже команды в терминале. 
...
1. Создайте образцы базы данных и таблицы в издателе, которые будут служить статьями для публикации.
...
1. Выполнение заданий агента репликации
  ...
  Выполните следующий запрос, чтобы получить список заданий:
