---
title: Настройка NFS для хранилища экземпляра отказоустойчивого кластера — SQL Server на Linux
description: ''
author: MikeRayMSFT
ms.author: mikeray
ms.reviewer: vanto
...
5. Повторите эти действия в других узлах.
