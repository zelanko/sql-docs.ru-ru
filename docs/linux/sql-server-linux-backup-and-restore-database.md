...
При выполнении команды SQL Server предложит ввести пароль. После того как вы введете пароль, оболочка вернет результаты работы резервного копирования. Например:
