...
> [!TIP]
> Если вы случайно, используйте параметр NORECOVERY, но нет дополнительных файлов резервных копий журнала, выполните команду `RESTORE DATABASE demodb` без дополнительных параметров. Будет завершить восстановление и оставить базу данных в рабочем состоянии.
