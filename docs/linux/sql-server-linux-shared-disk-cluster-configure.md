...
Чтобы выполнить следующий сценарий начала до конца, требуется две машины для развертывания двух узлов кластера и другой сервер для хранения. Шаги, описанные ниже описываются настройки этих серверов.
