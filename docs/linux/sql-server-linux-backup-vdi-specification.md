...
| Возвращаемые значения | Аргумент | Объяснение
| ----- | ----- | ------ |
| |**NOERROR** | Возвращает конфигурацию.
...
| Параметры | Аргумент | Объяснение
| ----- | ----- | ------ |
| |**timeout** |Это время ожидания в миллисекундах. Используйте INFINTE для неограниченного времени ожидания. Укажите 0 для опроса для команды. VD_E_TIMEOUT возвращается в том случае, если ни одной команды в настоящее время недоступно. Если возникает тайм-аут, клиент решает следующее действие.
...
| Возвращаемые значения | Аргумент | Объяснение
| ----- | ----- | ------ |
| |**NOERROR** |Команды, которые были выбраны.
...
| Возвращаемые значения | Аргумент | Объяснение
| ----- | ----- | ------ |
| |**NOERROR** |Завершение отмечались правильно.
...
| Возвращаемые значения | Аргумент | Объяснение
| ----- | ----- | ------ |
| |**NOERROR**|Прерывание уведомления успешно отправлено.
...
| Возвращаемые значения | Аргумент | Объяснение
| ----- | ----- | ------ |
| |**NOERROR** |Это значение возвращается, когда набор виртуального устройства была успешно закрыт.
