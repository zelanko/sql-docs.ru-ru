...
1. Установка SQL Server 2017 в Linux. Инструкции см. в разделе [установить SQL Sever](sql-server-linux-setup.md). Включить `hadr` через mssql-conf.
