...
> [!IMPORTANT]
> SQL Server 2017 г RC2 требует libsss_nss_idmap0, не предоставляемых репозиториев SLES по умолчанию. Его можно установить из пакета SDK SP2 SLES версии 12.
