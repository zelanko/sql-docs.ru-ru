...
## <a name="enable-sql-server-agent"></a><a id="enablesqlagent"></a> Включение агента SQL Server

Включите агент SQL Server, и он запустится автоматически с SQL Server
...
## <a name="troubleshooting"></a><a id="troubleshooting"></a> Устранение неполадок
