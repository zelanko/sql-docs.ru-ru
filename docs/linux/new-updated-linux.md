...
1. [Настройка служб интеграции SQL Server в Linux с conf служб ssis](sql-server-linux-configure-ssis.md)
2. [Выпуски и поддерживаемых функций 2017 г. SQL Server в Linux](sql-server-linux-editions-and-components-2017.md)
3. [Выполнение в Linux с cron пакетов служб интеграции SQL Server расписание](sql-server-linux-schedule-ssis-packages.md)
