...
layout: HubPage
hide_bc: true
title: 'SQL Server: запрос данных'
description: Ознакомьтесь с функциями, которые позволяют легко запрашивать данные, хранящиеся в базе данных SQL Server.
ms.topic: hub-page
ms.prod: sql
featureFlags:
- clicktale
...
<div id="main" class="v2">
    ...
    <div class="container">
        <h1>SQL Server: стандарт Данные запросов</h1>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Компонент Full-text Search</h3>
                                                    <p>Полнотекстовые индексы включают один или несколько символьных столбцов таблицы, а полнотекстовый поиск позволяет создавать к ним запросы.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Соединения</h3>
                                                    <p>Рассматриваются различные операции сортировки, пересечения и объединения, выполняемые SQL Server при использовании соединений. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p> Вложенным запросом называется запрос, помещаемый в инструкцию SELECT, INSERT, UPDATE или DELETE или в другой вложенный запрос. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Синонимы</h3>
                                                    <p>Объект базы данных, который обеспечивает уровень абстракции, защищающий клиентские приложения от изменений, производимых в имени или местоположении базовых объектов. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Определяемые пользователем функции</h3> 
                                                    <p>Подпрограммы, которые принимают параметры, выполняют действие и возвращают результат этого действия в виде значения. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
