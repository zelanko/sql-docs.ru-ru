...
layout: HubPage
hide_bc: true
title: 'SQL Server: установка и обновление'
description: Сведения о том, как установить или обновить SQL Server и связанные службы.
ms.topic: hub-page
ms.prod: sql
author: MashaMSFT
ms.author: mathoma
...
<div id="main" class="v2">
    ...
    <div class="container">
        <h1>SQL Server: стандарт установка или обновление</h1>
                    ...
                    <li class="panelItem" data-index="0">
                        ...
                        <ul class="cardsD panelContent singlePanelContent" id="products1" style="margin-top: 0px; display: flex;">
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Установка SQL Server</h3>
                                                    <p>Общие сведения о разных параметрах установки SQL Server.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Установка служб SQL Server Analysis Services (SSAS)</h3>
                                                    <p>Подсистема аналитики данных, предоставляющая семантические модели данных корпоративного уровня для бизнес-отчетов и клиентских приложений, таких как Power BI, Excel, Reporting Services и других отчетов с визуализацией данных. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Установка служб SQL Server Integration Services (SSIS)</h3>
                                                    <p> Службы Integration Services можно использовать при решении сложных бизнес-задач путем копирования и загрузки файлов, загрузки хранилищ данных, очистки и интеллектуального анализа данных, а также управления объектами и данными SQL Server. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Установка служб SQL Server Reporting Services (SSRS)</h3>
                                                    <p>Это решение для создания, публикации отчетов и управления ими, а также для их доставки нужным пользователям разнообразными способами, например посредством просмотра в веб-браузере, на мобильном устройстве или в папке входящих сообщений электронной почты. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Обновление служб SQL Server Analysis Services (SSAS)</h3>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Обновление служб SQL Server Integration Services (SSIS)</h3>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <li>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Обновление служб SQL Server Reporting Services (SSRS)</h3>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                             ...
                             <li class="fullSpan">
                                <div class="container intro">
                                <h2>Миграция на сервер SQL Server</h2> 
                            </li>
                             <li>
