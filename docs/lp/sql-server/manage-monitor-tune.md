...
layout: HubPage
hide_bc: true
title: 'SQL Server: управление, мониторинг, настройка'
description: Ознакомьтесь с функциями, с помощью которых можно администрировать, отслеживать и настраивать SQL Server.
ms.topic: hub-page
featureFlags:
- clicktale
...
<div id="main" class="v2">
    ...
    <div class="container">
        <h1>SQL Server: стандарт Управление, мониторинг и настройка</h1>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Управление жизненным циклом базы данных</h3>
                                                    <p>Комплексный подход к управлению схемой базы данных, данными и метаданными для приложения базы данных.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Сжатие данных</h3>
                                                    <p>Компонент SQL Server, содействующий сжатию данных, чтобы они занимали меньше места на дисках. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Компонент Database Mail</h3>
                                                    <p>Решение уровня предприятия для отправки сообщений электронной почты из ядра СУБД SQL Server. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Управление на основе политик</h3>
                                                    <p>Система на основе политики для управления одним или несколькими экземплярами SQL Server.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Настройка автоматических планов по управлению SQL Server.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Расширенные события</h3>
                                                    <p>Общая система обработки событий для систем SQL Server.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>SQLDiag</h3>
                                                    <p>Служебная программа общего назначения, собирающая журналы и данные в SQL Server. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>SQL Profiler</h3>
                                                    <p>Создание, анализ и замена трассировок действия SQL Server, а также управление ими. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Новая функция SQL 2017, позволяющая автоматически обнаруживать потенциальные проблемы с производительностью. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Оценка количества элементов</h3>
                                                    <p>Позволяет оценить количество строк, возвращаемых запросом, и используется для создания плана выполнения.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Индексы</h3>
                                                    <p>Структура на диске, связанная с таблицей или представлением, позволяющая ускорить получение данных.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Секции</h3>
                                                    <p>Позволяет передавать данные между единицами, такими как группы файлов. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Структуры планов</h3>
                                                    <p>Компонент SQL Server, позволяющий вручную вводить план выполнения для конкретного запроса.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Регулятор ресурсов</h3>
                                                    <p>Указывает ограничения на объем ЦП, число операций ввода-вывода и объем памяти, которые могут применяться запросами приложения. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Статистика</h3>
                                                    <p>Предоставляет ядру SQL Server сведения о том, как данные распределяются, и используется для создания планов выполнения.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
