---
title: Свойства коллекции ошибок, методы и события | Документы Microsoft
ms.prod: sql
...
---
# <a name="errors-collection-properties-methods-and-events"></a>Свойства коллекции ошибок, методы и события
...
## <a name="methods"></a>Методы  
 [Clear-метод](../../../ado/reference/ado-api/clear-method-ado.md)  
