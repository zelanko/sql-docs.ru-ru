---
title: 'RecordsetEvents (Visual C++ синтаксис индекс с #import) | Документы Microsoft'
ms.prod: sql
...
---
# <a name="recordsetevents-visual-c-syntax-index-with-import"></a>RecordsetEvents (Visual C++ синтаксис индекс с #import)
