---
title: Набор записей (ADO для синтаксиса Visual C++) | Документы Microsoft
ms.prod: sql
...
---
# <a name="recordset-ado-for-visual-c-syntax"></a>Набор записей (ADO для синтаксиса Visual C++)
