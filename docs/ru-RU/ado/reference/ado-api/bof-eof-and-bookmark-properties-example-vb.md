...
```  
 ...
 В этом примере используется **закладки** и [фильтра](../../../ado/reference/ado-api/filter-property.md) свойства для создания ограниченное представление **записей**. Доступны только записи ссылается массив закладок.  
