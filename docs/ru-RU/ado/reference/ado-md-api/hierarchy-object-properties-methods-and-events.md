---
title: Иерархии объект свойства, методы и события | Документы Microsoft
ms.prod: sql
...
---
# <a name="hierarchy-object-properties-methods-and-events"></a>Иерархии объект свойства, методы и события
## <a name="propertiescollections"></a>Свойства и коллекции  
 [Свойство Description](../../../ado/reference/ado-md-api/description-property-ado-md.md)  
  
 [Коллекция уровней](../../../ado/reference/ado-md-api/levels-collection-ado-md.md)  
