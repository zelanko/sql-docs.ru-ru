---
title: DateCreated и DateModified примере свойства (VC ++) | Документы Microsoft
ms.prod: sql
...
---
# <a name="datecreated-and-datemodified-properties-example-vc"></a>DateCreated и DateModified примере свойства (VC ++)
