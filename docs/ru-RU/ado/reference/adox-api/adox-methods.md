...
|||  
|-|-|  
|[Append (столбцы)](../../../ado/reference/adox-api/append-method-adox-columns.md)|Добавляет новый **столбца** объект **столбцы** коллекции.|  
|[Append (группы)](../../../ado/reference/adox-api/append-method-adox-groups.md)|Добавляет новый **группы** объект **группы** коллекции.|  
|[Append (индексы)](../../../ado/reference/adox-api/append-method-adox-indexes.md)|Добавляет новый **индекс** объект **индексы** коллекции.|  
|[Append (ключи)](../../../ado/reference/adox-api/append-method-adox-keys.md)|Добавляет новый **ключ** объект **ключей** коллекции.|  
|[Append (процедуры)](../../../ado/reference/adox-api/append-method-adox-procedures.md)|Добавляет новый **процедура** объект **процедуры** коллекции.|  
