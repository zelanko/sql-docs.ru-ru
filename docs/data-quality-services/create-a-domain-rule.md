...
|Значение содержит|Допустимы только значения, все символы которых в любом порядке содержатся в операнде.|Пример операнда: А1<br /><br /> Допустимые значения: А1, AA1<br /><br /> Недопустимое значение: 1A, AA|  
|Значение не содержит|Допустимы только значения, которые не содержатся в операнде.|Пример операнда: А1<br /><br /> Допустимые значения: 1A, AA<br /><br /> Недопустимые значения: А1, AA1|  
...
|Значение является числом|Допустимы только значения с числовым типом данных SQL Server, в том числе int, decimal, float и т. д.|Пример операнда: Недоступно<br /><br /> Допустимые значения: 1, 25, 345,1234<br /><br /> Недопустимые значения: 2b, bcdef|  
|Значение является датой/временем|Допустимы только значения с типом данных «дата-время» SQL Server, в том числе datetime, time, date и т. д.|Пример операнда: Недоступно<br /><br /> Допустимые значения: 1916-06-04; 1916-06-04 18:24:24; March 21, 2001; 5/18/2011; 18:24:24<br /><br /> Недопустимые значения: March 213, 2006|  
