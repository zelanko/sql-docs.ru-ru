...
|Значение не соответствует шаблону|Допустимы только значения, которые не соответствуют шаблону символов, цифр или специальных символов в операнде.|Пример операнда: A1 (значение не должно соответствовать шаблону *любого* одного символа, за которым следует *любая* одна цифра.)<br /><br /> Допустимые значения: AB1, A,: 5<br /><br /> Недопустимые значения: B7, c9|  
