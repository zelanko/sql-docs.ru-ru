...
3.  Из **списка доменов** на **домена управления** страницы, щелкните правой кнопкой мыши домен, который необходимо связать новый домен, а затем нажмите кнопку **Создать связанный домен**.  
...
##  <a name="Map"></a> Сопоставление двух полей со связанными доменами  
...
-   Параметры в **ссылочных данных**, **правил домена**, **значения домена**, и **связей на основе терма** вкладки страницы управления домена могут быть изменены для связанного домена или домена, он связан, и изменения будут унаследованы другим доменом.  
