---
title: Установка свойств домена
ms.date: 11/08/2011
ms.prod: sql
...
##  <a name="Set"></a>Задание свойств домена  
...
3.  Нажмите кнопку **Готово** , чтобы завершить операцию управления доменами, как описано в разделе [End the Domain Management Activity](https://msdn.microsoft.com/library/ab6505ad-3090-453b-bb01-58435e7fa7c0).  
...
###  <a name="Name"></a>Имя домена и описание  
...
###  <a name="Leading"></a>Использовать ведущие значения  
...
###  <a name="Normalize"></a>Нормализовать строку  
...
###  <a name="Format"></a>Форматировать выходные данные в  
...
###  <a name="Speller"></a>Включить средство проверки орфографии  
...
###  <a name="Syntax"></a>Отключить алгоритмы ошибок синтаксиса  
