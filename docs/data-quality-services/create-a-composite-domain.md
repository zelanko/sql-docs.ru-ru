---
description: Создание составного домена
title: Создание составного домена
ms.date: 11/22/2011
ms.prod: sql
...
6.  Нажмите кнопку **Готово** , чтобы завершить операцию управления доменами, как описано в разделе [Завершение операции по управлению доменами](/previous-versions/sql/sql-server-2016/hh510411(v=sql.130)).  
