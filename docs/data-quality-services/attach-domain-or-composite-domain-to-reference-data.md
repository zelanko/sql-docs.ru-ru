---
title: "Добавление домена или составного домена к ссылочным данным | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
###  <a name="Prerequisites"></a> Предварительные требования  
 Необходимо настроить [!INCLUDE[ssDQSnoversion](../includes/ssdqsnoversion-md.md)] (DQS) для использования служб ссылочных данных. В разделе [Настройка DQS на использование ссылочных данных](../data-quality-services/configure-dqs-to-use-reference-data.md).  
...
8.  В диалоговом окне **Каталог поставщиков ссылочных данных в сети** выполните следующие действия.  
    ...
    3.  Нажмите кнопку **ОК** , чтобы сохранить изменения и закрыть диалоговое окно **Каталог поставщиков ссылочных данных в сети** .  
        ...
        > [!NOTE]  
        >  -   В диалоговом окне **Каталог поставщиков ссылочных данных в сети** в узле **DataMarket Data Quality Services** содержатся все поставщики служб ссылочных данных, на которые пользователь подписан в Windows Azure Marketplace. Если вы настроили прямую ссылку на online сторонних поставщиков служб данных в DQS, они будут отображаться в другом узле называется **сторонние непосредственные сетевые поставщики** (теперь не доступен, как прямые интерактивном справочнике по сторонних поставщиков служб данных настраиваются в DQS).  
