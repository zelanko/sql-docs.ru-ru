...
---
# Создание связей на основе термина
 ...
 **Связи на основе термина и управление доменами**  
 ...
 Если связь на основе термина применяется в управлении доменами, службы DQS применяют изменения в процессах обнаружения знаний, очистки и сопоставления, но не изменяют само значение домена в соответствии со связью на основе термина. Другими словами Если ввести и принять связь на основе термина в **связей на основе терма** Вкладка **управления доменами** страницы, изменения не будут совершаться в **значения домена** же страницы. Это позволяет впоследствии изменить связь на основе термина.  
...
-   Если значение, измененное связью на основе термина в домене, но не является синонимом, будут показаны в **исправление для** столбце **исправленные** вкладке **Управление и просмотр результатов** страницы с указанием причины, задать связь на основе термина.  
...
4.  Щелкните **связей на основе терма** вкладки.  
...
5.  Создайте связи на основе термина следующим образом:  
    ...
    4.  Щелкните **Добавить новые связи** снова, чтобы добавить другую связь на основе термина.  
    ...
    7.  **Программа проверки орфографии**. Если значение в столбце **Значение** или **Исправить на** имеет волнистое красное подчеркивание, средство проверки орфографии предлагает исправления. Щелкните правой кнопкой мыши значение с нижним подчеркиванием и выберите одно из значений, рекомендуемых средством проверки орфографии. Также можно щелкнуть **Добавить** в контекстном меню, чтобы сохранить исходное значение. Дополнительные сведения см. в разделах [Use the DQS Speller](../data-quality-services/use-the-dqs-speller.md) и [Set Domain Properties](../data-quality-services/set-domain-properties.md).  
        ...
        > [!NOTE]  
        >  Для использования средства проверки орфографии, то можно включить его в **Свойства домена** страницы, или если она отключена в **Свойства домена** страницы, можно щелкнуть **Включить или отключить средство проверки орфографии** значок **связей на основе терма** страницы, чтобы включить его на этой странице.  
  
6.  Щелкните **Применить изменения** Применение связей на основе термина в домене.  
  
7.  Нажмите кнопку **Готово** , чтобы завершить операцию управления доменами, как описано в разделе [End the Domain Management Activity](../Topic/End%20the%20Domain%20Management%20Activity.md).  
  
##  <a name="FollowUp"></a> Дальнейшие действия. После создания связей на основе термина  
 После создания связей на основе термина можно выполнить другие задачи управления доменами с текущим доменом, выполнить обнаружение набора знаний для добавления набора знаний к домену или добавить политику сопоставления к домену. Дополнительные сведения см. в разделе [Обнаружение знаний](../data-quality-services/perform-knowledge-discovery.md), [Управление доменом](../data-quality-services/managing-a-domain.md), или [Создание политики сопоставления](../data-quality-services/create-a-matching-policy.md).  
