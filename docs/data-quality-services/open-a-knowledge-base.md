...
-   **Обнаружение — сопоставление**. База знаний была закрыта на странице **Управление базой знаний: сопоставление**. База знаний заблокирована, и действия «Управление доменами» и «Сопоставление» недоступны.  
  
-   **Обнаружение — обнаружение**. База знаний была закрыта на странице **Управление базой знаний: анализ**. База знаний заблокирована, и действие «Управление доменами» недоступно.  
  
-   **Обнаружение — управление значениями**. База знаний была закрыта на странице **Управление базой знаний: управление терминами доменов**. База знаний заблокирована, и действие "Управление доменами" недоступно.  
