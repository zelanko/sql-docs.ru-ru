---
title: "Запуск файла DQSInstaller.exe для завершения установки сервера служб DQS | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
---
# Запуск файла DQSInstaller.exe для завершения установки сервера служб DQS
...
##  <a name="CommandPrompt"></a> Запуск файла DQSInstaller.exe из командной строки  
