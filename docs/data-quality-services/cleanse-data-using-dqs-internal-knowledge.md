...
-   **Предлагаемые значения**: количество значений домена, которые были предложены.  
