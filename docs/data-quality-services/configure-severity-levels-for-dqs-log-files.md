...
-   **Критическая**ошибка: критические ошибки среды выполнения, которые могут привести к серьезным или непредвиденным результатам.  
  
-   **Ошибка**: другие ошибки времени выполнения.  
  
-   **Предупреждать**: предупреждение о событиях, которые могут привести к ошибке.  
  
-   **Info**: сведения об общих событиях, которые не являются ошибкой или предупреждением. К примеру, запущен процесс DQS.  
  
-   **Отладка**: подробные (подробно) сведения о событии.  
...
##  <a name="ConfigureActivity"></a>Настройка степени серьезности на уровне действия  
