...
##  <a name="Answer"></a> Ответы на которые должны с помощью DQS  
...
-   **Очистка данных:** Изменение или удаление обогащение данных неправильные или неполные данные, с помощью автоматизированной и интерактивные процессы. Дополнительные сведения см. в статье [Data Cleansing](../data-quality-services/data-cleansing.md).  
  
-   **Сопоставление:** Выявление семантических дубликатов в процессе на основе правил, который позволяет определить условия сопоставления и исключение дубликатов. Дополнительные сведения см. в статье [Data Matching](../data-quality-services/data-matching.md).  
  
-   **Службы ссылочных данных:** проверка качества данных с использованием служб поставщика ссылочных данных. Можно использовать службы эталонных данных из [Microsoft Azure Marketplace](http://azure.microsoft.com/marketplace/) для очистки, проверки, соответствует и дополнять данные. Дополнительные сведения см. в статье [Reference Data Services in DQS](../data-quality-services/reference-data-services-in-dqs.md).  
...
-   **База знаний:** служб качества данных — знаниях решение, которое анализирует данные на основе набора знаний, построенного с помощью DQS. Это позволяет создавать процессы по обеспечению качества данных, которые постоянно совершенствуют знания о данных и при этом постоянно повышают их качество.  
  
 На следующем рисунке показан процесс DQS.  
  
 ![Обработка DQS](../data-quality-services/media/dqs-process.gif "Обработка DQS")  
  
##  <a name="KnowledgeDrivenSolution"></a> Решение на основе знаний  
 База знаний DQS является репозиторием трех типов знаний: out of box знания, знания, созданные [!INCLUDE[ssDQSServer](../includes/ssdqsserver-md.md)], и знания, созданные пользователем. DQS позволяет хранить знания о данных в базе знаний, добавлять бизнес-правила и изменять знания по мере необходимости, а затем применять их для проверки целостности и правильности данных. После построения базы знаний вы можете постоянно совершенствовать ее и многократно использовать в различных процессах по повышению качества данных.  
...
-   **Проект качества данных** , который предлагает изменения в исходных данных на основе знаний в базе знаний.  
 ...
 Дополнительные сведения см. в разделе [базы знаний DQS и домены](../data-quality-services/dqs-knowledge-bases-and-domains.md) и [проекты качества данных & #40; DQS & #41;](../data-quality-services/data-quality-projects-dqs.md).  
