---
description: Общие сведения о службах Data Quality Services
...
##  <a name="the-business-need-for-dqs"></a><a name="BusinessNeed"></a> Потребность бизнеса в DQS  
...
##  <a name="answering-that-need-with-dqs"></a><a name="Answer"></a> Ответ на потребности с DQS  
...
-   **Сопоставление:** выявление семантических дубликатов в процессе, основанном на правилах, который позволяет определить содержание сопоставления и исключение дубликатов. Дополнительные сведения см. в статье [Сопоставление данных](../data-quality-services/data-matching.md).  
...
##  <a name="a-knowledge-driven-solution"></a><a name="KnowledgeDrivenSolution"></a> Решение на основе знаний  
...
##  <a name="dqs-components"></a><a name="Components"></a> Компоненты DQS  
...
##  <a name="data-quality-functionality-in-integration-services-and-master-data-services"></a><a name="Processes"></a> Функции качества данных в службах Integration Services и Master Data Services  
