...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md-winonly](../includes/appliesto-ss-xxxx-xxxx-xxx-md-winonly.md)]
 ...
 ![Маленький значок папки с файлами](https://docs.microsoft.com/analysis-services/analysis-services/media/filefolder-small.png "Маленький значок папки") **Разработка и реализация решения по обеспечению качества данных**  
 [Клиентское приложение DQS](../data-quality-services/data-quality-client-application.md)  
 ...
 [Профилирование данных и уведомления в DQS](../data-quality-services/data-profiling-and-notifications-in-dqs.md)  
  
 ![Маленький значок папки с файлами](https://docs.microsoft.com/analysis-services/analysis-services/media/filefolder-small.png "Маленький значок папки") **Администрирование служб Data Quality Services**  
 [администрирование DQS](../data-quality-services/dqs-administration.md)  
  
 [Безопасность DQS](../data-quality-services/dqs-security.md)  
