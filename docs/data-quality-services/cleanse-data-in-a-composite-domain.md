...
-   Исходные данные состоят из нескольких полей (например, это «Имя», «Отчество» и «Фамилия»), которые сопоставлены с отдельными доменами внутри составного домена.  
 ...
 Пример сопоставления составных доменов к источнику данных, в разделе [присоединить домен или составной домен со ссылочными данными](../data-quality-services/attach-domain-or-composite-domain-to-reference-data.md).  
  
##  <a name="CDCorrection"></a> Коррекция данных с использованием определительных междоменных правил  
 Междоменные правила в составном домене позволяют определять отношения между отдельными доменами в составном домене. Междоменные правила учитываются при выполнении очистки для исходных данных с использованием составных доменов. Помимо информирования о допустимости междоменное правило, определяющим *затем* междоменное правило **значение равно**, также исправляет данные во время проведения очистки данных.  
...
|Microsoft Office 2010|Microsoft Inc.|2010|  
 ...
 При тестировании определяющим *затем* междоменное правило **значение равно**,  **Тестирование правила для составного домена** диалоговое окно содержит новый столбец **исправить на**, что отображаются правильные данные. В проекте очистки качества данных этого конкретные междоменное правило изменяет данные с уверенностью 100% и **Причина** отображается следующее сообщение: исправлено правилом "*\< имя правила междоменных >*". Дополнительные сведения о междоменных правилах см. в разделе [Создать междоменное правило](../data-quality-services/create-a-cross-domain-rule.md).  
...
##  <a name="DataProfiling"></a> Профилирование данных для составных доменов  
 ...
 Подробные сведения о данных профилирования во время очистки см. в разделе [статистические данные профилировщика](../data-quality-services/cleanse-data-using-dqs-internal-knowledge.md#Profiler) в [очистки данных с помощью DQS & #40; внутренний & #41; Базы знаний](../data-quality-services/cleanse-data-using-dqs-internal-knowledge.md).  
