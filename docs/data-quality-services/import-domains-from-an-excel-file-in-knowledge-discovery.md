---
title: Импорт доменов из файла Excel в обнаружении знаний
description: Узнайте, как импортировать домены из файла Excel во время обнаружения знаний для SQL Server Data Quality Services (DQS)
