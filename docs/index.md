                        ...
                        <ul id="databases" class="cardsW">
                            ...
                            <li class="fullSpan">
                                <div class="container intro" style="color: #535353; font-family: segoe-ui_light,Segoe UI Light,Segoe WP,Helvetica Neue,Helvetica,sans-serif;">
                                    <p>Управление реляционными данными с помощью баз данных SQL в вашем центре данных или в Azure. Использование машинного обучения и аналитики для анализа данных SQL. </p>
                                </div>
                            </li>
                                        ...
                                        <div class="card">
                                            <div class="cardText">
                                                <div style="height:100px; border-bottom-color: #dbdbdb; border-bottom-width: 1px; border-bottom-style: solid; position: relative;">
                                                   <h3 style="bottom: 20px; color: rgb(110, 110, 110); font-family: segoe-ui_light,Segoe UI Light,Segoe WP,Helvetica Neue,Helvetica,sans-serif; font-size: 2rem; vertical-align: bottom; position: absolute;">Базы данных</h3>
                                                </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardText">
                                                ...
                                                <h4 class="likeAnH3" style="margin: 1rem 0px;">Образцы на GitHub</h4>
                                                <ul>
                                                    <li><a href="https://github.com/Microsoft/sql-server-samples/tree/master/samples">Примеры кода</a></li>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardText">
                                                <div style="height:100px; border-bottom-color: #dbdbdb; border-bottom-width: 1px; border-bottom-style: solid; position: relative;">
                                                   <h3 style="bottom: 20px; color: rgb(110, 110, 110); font-family: segoe-ui_light,Segoe UI Light,Segoe WP,Helvetica Neue,Helvetica,sans-serif; font-size: 2rem; vertical-align: bottom; position: absolute;">Аналитика данных</h3>
                                                </div>
                                                <h4 class="likeAnH3" style="margin: 1rem 0px;">Анализ</h4>
                                                <ul>
                                                ...
                                                <h4 class="likeAnH3" style="margin: 1rem 0px;">Отчет</h4>
                                                <ul>
