...
![Значок стрелки, используемый для ссылки возврата в начало](../release-notes/media/uparrow16x16.gif "Значок стрелки, используемый для ссылки возврата в начало")[В начало](#top)  
...
-   Службы Master Data Services 2014, размещенные в базе данных ядра СУБД SQL Server в SQL Server 2012 с установленными службами Data Quality Services 2012.  
