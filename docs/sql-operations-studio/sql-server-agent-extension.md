---
title: SQL Operations Studio расширение агента SQL Server (Предварительная версия) | Документация Майкрософт
description: Расширение агента SQL Server для SQL Operations Studio (Предварительная версия)
ms.custom: tools|sos
ms.date: 07/19/2018
...
ms.locfileid: "39147036"
---
# <a name="sql-server-agent-extension"></a>Расширение агента SQL Server

Расширение агента SQL Server — это расширение для управления и устранения неполадок задания агента SQL и конфигурации. Это расширение сейчас доступна Предварительная версия.
