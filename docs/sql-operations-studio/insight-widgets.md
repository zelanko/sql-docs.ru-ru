---
title: Использовать анализ мини-приложения для наблюдения за серверами и базами данных в SQL Operations Studio (preview) | Документы Microsoft
description: Дополнительные сведения о insight мини-приложения в SQL Operations Studio (preview).
ms.custom: tools|sos
ms.date: 11/15/2017
