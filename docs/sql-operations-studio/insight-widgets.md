---
title: Использовать анализ мини-приложения для отслеживания серверов и баз данных в SQL Operations Studio (Предварительная версия) | Документация Майкрософт
description: Дополнительные сведения о insight мини-приложения в SQL Operations Studio (Предварительная версия).
ms.custom: tools|sos
ms.date: 11/15/2017
ms.prod: sql
ms.technology: ssops
