...
### <a name="1-nbsp-download-and-install-sql-operations-studio-previewdownloadmd"></a>1. &nbsp;[Загрузки и установки Studio операций SQL (Предварительная версия)](download.md)

*Обновлено: 2018-01-18* &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; 
