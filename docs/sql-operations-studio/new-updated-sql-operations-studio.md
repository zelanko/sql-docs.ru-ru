...
1. [Создание и использование фрагментов кода для быстрого создания скриптов Transact-SQL (T-SQL) в[!INCLUDE[name-sos](../includes/name-sos-short.md)]](code-snippets.md)
2. [Панели мониторинга в[!INCLUDE[name-sos](../includes/name-sos-short.md)]](dashboards.md)
3. [Загрузите и установите[!INCLUDE[name-sos](../includes/name-sos.md)]](download.md)
4. [Подключение [!INCLUDE[name-sos](../includes/name-sos-short.md)] к экземпляру SQL Server с использованием проверки подлинности Windows — Kerberos](enable-kerberos.md)
5. [[!INCLUDE[name-sos](../includes/name-sos.md)]ВОПРОСЫ И ОТВЕТЫ](faq.md)
6. [Управление серверами и базами данных с помощью Insight мини-приложения в[!INCLUDE[name-sos](../includes/name-sos-short.md)]](insight-widgets.md)
7. [Встроенная терминалов](integrated-terminal.md)
8. [Сочетания клавиш в[!INCLUDE[name-sos](../includes/name-sos.md)]](keyboard-shortcuts.md)
9. [Краткое руководство: Использование [!INCLUDE[name-sos](../includes/name-sos-short.md)] для подключения и запроса базы данных Azure SQL](quickstart-sql-database.md)
10. [Краткое руководство: Использование [!INCLUDE[name-sos](../includes/name-sos-short.md)] для подключения и запроса данных в хранилище данных SQL Azure](quickstart-sql-dw.md)
11. [Краткое руководство: Подключение и запрос с использованием SQL Server[!INCLUDE[name-sos](../includes/name-sos-short.md)]](quickstart-sql-server.md)
12. [Группы серверов в[!INCLUDE[name-sos](../includes/name-sos-short.md)]](server-groups.md)
13. [Пользователь и параметры рабочей области](settings.md)
14. [С помощью системы управления версиями в[!INCLUDE[name-sos](../includes/name-sos-short.md)]](source-control.md)
15. [Резервное копирование и восстановление с помощью[!INCLUDE[name-sos](../includes/name-sos-short.md)]](tutorial-backup-restore-sql-server.md)
16. [Учебник: Построение пользовательского представления мини-приложения](tutorial-build-custom-insight-sql-server.md)
17. [Учебник: Добавление *пять самых медленных запросов* пример мини-приложения на панель мониторинга базы данных](tutorial-qds-sql-server.md)
18. [Учебник: Использование редактора Transact-SQL для создания объектов базы данных-[!INCLUDE[name-sos](../includes/name-sos-short.md)]](tutorial-sql-editor.md)
19. [Учебник: Включите таблицу места использования примера insight мини-приложения с помощью[!INCLUDE[name-sos](../includes/name-sos-short.md)]](tutorial-table-space-sql-server.md)
20. [Включение или отключение сбора данных об использовании[!INCLUDE[name-sos](../includes/name-sos-short.md)]](usage-data-collection.md)
21. [Что такое [!INCLUDE[name-sos](../includes/name-sos.md)]?](what-is.md)
