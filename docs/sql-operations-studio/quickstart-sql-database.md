---
title: 'Краткое руководство: Подключение и запрос к базе данных Azure SQL с помощью SQL Operations Studio (Предварительная версия) | Документация Майкрософт'
