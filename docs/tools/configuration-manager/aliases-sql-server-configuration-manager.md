---
title: Псевдонимы (диспетчер конфигурации SQL Server)
description: Узнайте, как создать псевдоним в диспетчере конфигурации SQL Server, чтобы можно было использовать альтернативное имя при соединении с экземпляром SQL Server.
