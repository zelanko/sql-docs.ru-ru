---
title: "Средство запуска управляющей программы полнотекстовой фильтрации SQL (вкладка &#171;Вход&#187;) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
---
# Средство запуска управляющей программы полнотекстовой фильтрации SQL (вкладка &#171;Вход&#187;)
 ...
 Используйте **Вход в систему** вкладке **Свойства запуска управляющей программы полнотекстовой фильтрации Full-text SQL** диалоговое окно используется для указания учетной записи, используемой [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] полнотекстовой службы, чтобы изменить пароль учетной записи и для запуска и остановки службы. Изменение пароля учетной записи вступает в силу после перезапуска службы.  
 ...
 **Сетевая служба**  
 Рекомендуется не использовать учетную запись сетевой службы для [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] служб или [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] службы агента. Для этих служб больше подходят учетные записи «Локальный пользователь» или «Пользователь домена».  
