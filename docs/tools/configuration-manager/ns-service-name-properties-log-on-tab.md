...
---
# <a name="nsltservice-namegt-properties-log-on-tab"></a>NS$&lt;имя службы&gt; свойства (на вкладка журнала)
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]Используйте **вход в систему** вкладке **свойства служб Notification Services** для указания учетной записи, используемой [!INCLUDE[ssNS](../../includes/ssns-md.md)] , а также для запуска и остановки службы.  
