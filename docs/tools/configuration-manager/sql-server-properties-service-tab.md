...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]Используйте **службы**на вкладке **свойств MSSQLSERVER** диалогового окна для просмотра или указания следующих параметров.  
