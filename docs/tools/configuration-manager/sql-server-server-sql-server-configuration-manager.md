---
title: "SQL Server &lt;сервера&gt; (диспетчер конфигурации SQL Server) | Документы Microsoft"
ms.custom: 
ms.date: 03/14/2017
...
---
# <a name="sql-server-ltservergt-sql-server-configuration-manager"></a>SQL Server &lt;сервера&gt; (диспетчер конфигурации SQL Server)
