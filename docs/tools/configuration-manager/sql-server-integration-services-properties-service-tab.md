---
title: "Свойства служб SQL Server Integration Services (вкладка &#171;Служба&#187;) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
---
# Свойства служб SQL Server Integration Services (вкладка &#171;Служба&#187;)
  Используйте вкладку **Служба** диалогового окна [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)]Свойства** служб **, чтобы просмотреть или задать представленные ниже параметры.  
