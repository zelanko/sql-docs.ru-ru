---
title: "Свойства TCP/IP (вкладка &#171;Протоколы&#187;) | Microsoft Docs"
ms.custom: ""
ms.date: "08/24/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "TCP/IP [SQL Server], параметры конфигурации"
...
## См. также:  
 ...
 [Создание допустимой строки подключения с использованием протокола TCP/IP](https://msdn.microsoft.com/library/ms191260.aspx)  
