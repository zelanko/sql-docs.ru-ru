---
title: "Регистрация серверов | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  - "подключения [SQL Server], зарегистрированные серверы"
  - "регистрация серверов"
  - "серверы [SQL Server], регистрация"
  - "управление серверами [SQL Server], регистрация серверов"
  - "регистрация серверов [SQL Server]"
