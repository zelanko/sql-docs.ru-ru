---
title: "Добавление отступов | Microsoft Docs"
ms.custom: ""
ms.date: "02/27/2017"
...
## Добавление отступов кода  
  
#### Добавление отступа для нескольких строк кода  
...
#### Изменение указанного по умолчанию отступа  
...
2.  Последовательно раскройте элементы **Текстовый редактор**и **Все языки**, а затем нажмите **Вкладки** и установите необходимые значения отступов. Обратите внимание, что можно изменять как значения отступов, так и значение табуляции, а также указать, следует ли заменять знаки табуляции пробелами.  
    ...
    ![Внешний вид диалогового окна «Вкладки»](../../tools/sql-server-management-studio/media/tabsdialog.gif "Внешний вид диалогового окна «Вкладки»")  
  
3.  Нажмите кнопку **ОК**.  
  
## Следующая задача занятия  
[Разворачивание окна редактора запросов](../../tools/sql-server-management-studio/maximizing-query-editor.md)  
