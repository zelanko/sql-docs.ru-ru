---
title: "Создание пользовательских шаблонов | Microsoft Docs"
ms.custom: ""
ms.date: "02/27/2017"
...
helpviewer_keywords: 
  - "tql"
  - "шаблоны [Transact-SQL], создание"
  - "шаблоны [Transact-SQL]"
...
[Сохранение скриптов в виде проектов или решений](../../tools/sql-server-management-studio/save-scripts-as-projects-or-solutions.md)  
