---
title: "Сочетания клавиш среды SQL Server Management Studio | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Среда SQL Server Management Studio [SQL Server], сочетания клавиш"
  - "сочетания клавиш [среда SQL Server Management Studio]"
  - "сочетания для вызова меню [среда SQL Server Management Studio]"
  - "Редактор запросов [SQL Server Management Studio], сочетания клавиш"
  - "сочетания клавиш [среда SQL Server Management Studio]"
  - "сочетания клавиш [SQL Server Management Studio]"
  - "сочетания клавиш [SQL Server Management Studio], список сочетаний клавиш"
  - "сочетания клавиш [среда SQL Server Management Studio]"
  - "сочетания клавиш"
...
# Сочетания клавиш среды SQL Server Management Studio
  [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)] предлагает пользователям две схемы сочетаний клавиш на выбор. По умолчанию используется схема [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)], при которой применяются те же сочетания клавиш, что и в [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] 2010. [!INCLUDE[ssManStudio](../../includes/ssmanstudio-md.md)] также предлагает схему сочетаний клавиш, аналогичную стандартной схеме из [!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)]. Чтобы изменить схему сочетаний клавиш или добавить новые сочетания клавиш, выберите в меню **Сервис** пункт **Параметры**. Выберите предпочтительную клавиатурную схему на вкладке **Среда** страницы **Клавиатура**.  
...
|Отобразить диалоговое окно **Открытие файла** для открытия существующего файла|CTRL + O<br /><br /> либо<br /><br /> CTRL + SHIFT + G|CTRL + O|  
...
|Перейти к окну следующего средства|ALT + F6<br /><br /> либо<br /><br /> F6 в редакторе запросов [!INCLUDE[ssDE](../../includes/ssde-md.md)]|ALT + F6|  
...
|Перейти к окну, выбранному в предыдущий раз|SHIFT + ALT + F6<br /><br /> либо<br /><br /> SHIFT + F6 в редакторе запросов [!INCLUDE[ssDE](../../includes/ssde-md.md)]|SHIFT + ALT + F6|  
...
|Отобразить окно **Список задач**|CTRL + \\, T<br /><br /> либо<br /><br /> CTRL + \\, CTRL + T|CTRL + ALT + K|  
...
|Отобразить окно «Список ошибок» (только редактор [!INCLUDE[tsql](../../includes/tsql-md.md)])|CTRL + \\, CTRL + E<br /><br /> либо<br /><br /> CTRL + \\, E|CTRL + \\, CTRL + E|  
...
|Отменить последнее действие по изменению кода|CTRL + Z<br /><br /> либо<br /><br /> ALT + BACKSPACE|CTRL + Z|  
|Восстановить отмененное действие|CTRL + SHIFT + Z<br /><br /> либо<br /><br /> CTRL + Y<br /><br /> либо<br /><br /> ALT + SHIFT + BACKSPACE|CTRL + SHIFT + Z<br /><br /> либо<br /><br /> CTRL + Y<br /><br /> либо<br /><br /> ALT + SHIFT + BACKSPACE|  
...
|Выполнение фрагмента кода, выделенного в редакторе запросов, или всего кода из редактора запросов, если ничего не выделено|F5<br /><br /> либо<br /><br /> CTRL + SHIFT + E|F5<br /><br /> либо<br /><br /> CTRL + E<br /><br /> либо<br /><br /> ALT + X|  
...
|Удалить символ, расположенный слева от курсора|BACKSPACE<br /><br /> либо<br /><br /> SHIFT +<br /><br /> BACKSPACE|BACKSPACE<br /><br /> либо<br /><br /> SHIFT +<br /><br /> BACKSPACE|  
...
|Отобразить диалоговое окно **Быстрая проверка**|CTRL + ALT + Q<br /><br /> либо<br /><br /> SHIFT + F9|CTRL + ALT + Q|  
...
|Действие|[!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]|[!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)]|  
|------------|-----------------------------|---------------------------------|  
|Показать список элементов|CTRL + J|CTRL + ПРОБЕЛ<br /><br /> либо<br /><br /> CTRL + J|  
|Дополнить слово|CTRL + ПРОБЕЛ<br /><br /> либо<br /><br /> ALT + ВПРАВО|ALT + ВПРАВО|  
...
|Действие|[!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]|[!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)]|  
|------------|-----------------------------|---------------------------------|  
|Справка|F1<br /><br /> либо<br /><br /> SHIFT + F1|F1|  
...
|Действие|[!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]|[!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)]|  
|------------|-----------------------------|---------------------------------|  
|Вырезать (удалить выделенный элемент и поместить его в буфер обмена)|CTRL + X<br /><br /> либо<br /><br /> SHIFTRLT + DELETE|CTRL + X<br /><br /> либо<br /><br /> SHIFT + DELETE|  
|Вырезать все выделенные строки или текущую строку, если ничего не выделено.|CTRL + L<br /><br /> либо<br /><br /> CTRL + SHIFT + L|Нет эквивалента|  
|Скопировать данные в буфер обмена|CTRL+C<br /><br /> либо<br /><br /> CTRL + INSERT|CTRL+C<br /><br /> либо<br /><br /> CTRL + INSERT|  
|Вставить данные из буфера обмена в позицию вставки|CTRL + V<br /><br /> либо<br /><br /> SHIFT + INSERT|CTRL + V<br /><br /> либо<br /><br /> SHIFT + INSERT|  
|Вставка элемента из буфера обмена в позицию ввода с его автоматическим выделением|CTRL + SHIFT + V<br /><br /> либо<br /><br /> CTRL + enseSHIFT + INSERT|Нет эквивалента|  
...
## Сочетания клавиш в конструкторе  
