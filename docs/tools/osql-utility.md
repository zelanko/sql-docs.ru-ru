---
title: "Программа osql | Microsoft Docs"
ms.custom: ""
ms.date: "03/16/2017"
...
helpviewer_keywords: 
  ...
  - "EXIT, команда"
  - "операционные системы [SQL Server], команды"
  - "osql, программа [SQL Server]"
  - "хранимые процедуры [SQL Server], командная строка"
  - "скрипты [SQL Server], командная строка"
  - "RESET, команда"
  - "GO, команда"
  - "программы командной строки [SQL Server], osql"
  - "CTRL+C, команда"
...
## Вставка примечаний  
 В инструкцию Transact-SQL, отправляемую программой **osql** в [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)], можно включать комментарии. Допускаются два типа стиля комментариев: -- и /*…\*/.  
