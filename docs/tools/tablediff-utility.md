---
title: "Программа tablediff | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  ...
  - "сравнение таблиц [SQL Server]"
  - "служебные программы командной строки [SQL Server], tablediff"
  - "устранение неполадок [репликация SQL Server], отсутствие конвергенции"
  - "расхождение [SQL Server]"
