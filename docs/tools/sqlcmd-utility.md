...
Можно попробовать программу sqlcmd из оболочки облако Azure как предварительно установленные по умолчанию: [ ![запуска оболочки облака](https://shell.azure.com/images/launchcloudshell.png "запуска оболочки облака")](https://shell.azure.com)
