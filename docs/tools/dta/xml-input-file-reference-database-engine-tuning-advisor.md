---
title: "Справочник по входным XML-файлам (помощник по настройке ядра СУБД) | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
dev_langs: 
  - "XML"
helpviewer_keywords: 
  - "Помощник по настройке ядра СУБД [SQL Server], входные XML-файлы"
  - "ссылка на входной файл [помощник по настройке ядра СУБД]"
  - "входные XML-файлы [помощник по настройке ядра СУБД]"
...
---
# Справочник по входным XML-файлам (помощник по настройке ядра СУБД)
