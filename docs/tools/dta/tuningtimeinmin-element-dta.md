---
title: Элемент TuningTimeInMin (DTA)
description: В служебной программе DTA элемент TuningTimeInMin определяет максимальную продолжительность сеанса настройки в минутах.
ms.prod: sql
