---
title: "Просмотр рекомендаций по настройке | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
1.  Запустите помощник по настройке компонента [!INCLUDE[ssDE](../../includes/ssde-md.md)] . См. раздел [Запуск помощника по настройке ядра СУБД](../../tools/dta/launching-database-engine-tuning-advisor.md). Убедитесь в том, что установлено соединение с экземпляром [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)], который использовался в практической работе [Настройка рабочей нагрузки](../../tools/dta/tuning-a-workload.md).  
...
[Просмотр отчетов настройки](../../tools/dta/viewing-tuning-reports.md)  
