---
title: "Урок 1: Основные средства перемещения базы данных настройке ядра СУБД | Документы Microsoft"
ms.custom: 
ms.date: 03/01/2017
...
## <a name="next-task-in-this-lesson"></a>Следующая задача этого занятия  
[Запуск помощника по настройке ядра СУБД](../../tools/dta/lesson-1-1-launching-database-engine-tuning-advisor.md)  
