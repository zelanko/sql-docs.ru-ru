---
title: "dta, программа | Microsoft Docs"
ms.custom: ""
ms.date: "01/09/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "структуры физического проектирования [SQL Server]"
  - "программы командной строки [SQL Server], dta"
  - "dta, программа"
  - "настройка баз данных [SQL Server], помощник по настройке ядра СУБД"
  - "рабочие нагрузки [SQL Server], анализ"
  - "программа dta, о программе dta"
  - "производительность [SQL Server], помощник по настройке ядра СУБД"
  - "помощник по настройке ядра СУБД [SQL Server], командная строка"
  - "оптимизация баз данных [SQL Server]"
...
## Примеры  
 **A. Настройка рабочей нагрузки, которая содержит в рекомендации индексы и индексированные представления**  
