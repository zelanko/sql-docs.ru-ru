...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../includes/appliesto-ss-asdb-asdw-pdw-md.md)]
 ...
 ![Значок ссылки на раздел](../database-engine/configure-windows/media/topic-link.gif "значок ссылки на раздел") о синтаксических обозначениях, используемых для **bcp** синтаксиса, в разделе [синтаксические обозначения Transact-SQL &#40; Transact-SQL &#41; ](../t-sql/language-elements/transact-sql-syntax-conventions-transact-sql.md).  
 ...
 ***имя_представления***<a name="vw_name"></a>   
