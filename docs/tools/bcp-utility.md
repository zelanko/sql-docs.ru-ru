---
title: "Программа bcp | Microsoft Docs"
ms.custom: ""
ms.date: "09/26/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "bcp, программа [SQL Server]"
  - "экспорт данных"
  - "экспорт строк [SQL Server]"
  - "копирование данных [SQL Server], программа bcp"
  - "программы командной строки [SQL Server], bcp"
  - "таблицы [SQL Server], импорт данных"
  - "импорт столбцов [SQL Server]"
  - "программа bcp [SQL Server], параметры команд"
  - "экспорт файлов [SQL Server]"
  - "массовое копирование [SQL Server]"
  - "программа bcp [SQL Server], о программе bcp"
  - "таблицы [SQL Server], экспорт данных"
  - "импорт строк [SQL Server]"
  - "импорт данных, программа bcp"
  - "импорт файла [SQL Server]"
  - "экспорт столбцов [SQL Server]"
...
[!INCLUDE[tsql-appliesto-ss2008-all_md](../includes/tsql-appliesto-ss2008-all-md.md)]
 ...
 ![Значок ссылки на раздел](../database-engine/configure-windows/media/topic-link.png "Значок ссылки на раздел") Сведения о синтаксических обозначениях в программе **bcp** см в разделе [Синтаксические обозначения в Transact-SQL (Transact-SQL)](../t-sql/language-elements/transact-sql-syntax-conventions-transact-sql.md).  
...
bcp [<a href="#db_name">имя_БД.</a>] <a href="#schema">schema</a>.{<a href="#tbl_name">имя_таблицы</a> | <a href="#vw_name">имя_представления</a> | <a href="#query">"запрос"</a> {<a href="#in">in</a> <a href="#data_file">файл_данных</a> | <a href="#out">out</a> <a href="#data_file">файл_данных</a> | <a href="#qry_out">queryout</a> <a href="#data_file">файл_данных</a> | <a href="#format">format</a> <a href="#format">nul</a>} <a>                                                                                                         </a> [<a href="#a">-a размер_пакета</a>] [<a href="#b">-b размер_пакета</a>] [<a href="#c">-c</a>] [<a href="#C">-C { ACP | OEM | RAW | кодовая_страница } </a>] [<a href="#d">-d имя_БД</a>] [<a href="#e">-e файл_ошибки</a>] [<a href="#E">-E</a>] [<a href="#f">-f файл_форматирования</a>] [<a href="#F">-F первая_строка</a>] [<a href="#h">-h"hint [,...n]"</a>] [<a href="#i">-i входной_файл</a>] [<a href="#k">-k</a>] [<a href="#K">-K намерение_приложения</a>] [<a href="#L">-L последняя_строка</a>] [<a href="#m">-m макс_ошибок</a>] [<a href="#n">-n</a>] [<a href="#N">-N</a>] [<a href="#o">-o выходной_файл</a>] [<a href="#P">-P пароль</a>] [<a href="#q">-q</a>] [<a href="#r">-r термин_строки</a>] [<a href="#R">-R</a>] [<a href="#S">-S [имя_сервера[\имя_экземпляра]</a>] [<a href="#t">-t термин_поля</a>] [<a href="#T">-T</a>] [<a href="#U">-U ИД_имени_для_входа</a>] [<a href="#v">-v</a>] [<a href="#V">-V (80 | 90 | 100 | 110 | 120 | 130 ) </a>] [<a href="#w">-w</a>] [<a href="#x">-x</a>]
</pre></td></tr></table>  
 ...
 **-S** ***имя_сервера*** [\\***имя_экземпляра***]<a name="S"></a>
...
Служебную программу bcp можно скачать отдельно от [пакета дополнительных компонентов Microsoft SQL Server 2016](https://www.microsoft.com/download/details.aspx?id=526760).  Выберите `ENU\x64\MsSqlCmdLnUtils.msi` или `ENU\x86\MsSqlCmdLnUtils.msi`.
...
> [!NOTE]  
>  Файлы форматирования используются в тех случаях, когда поля файла данных отличаются от столбцов таблицы, например: по количеству, порядку или типу данных. Дополнительные сведения см. в статье [Файлы форматирования для импорта или экспорта данных (SQL Server)](../relational-databases/import-export/format-files-for-importing-or-exporting-data-sql-server.md).  
