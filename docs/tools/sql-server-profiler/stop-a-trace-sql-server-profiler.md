---
title: Прекращение трассировки
titleSuffix: SQL Server Profiler
description: Узнайте, как прерывать трассировку, выполняемую в SQL Server Profiler, изменять свойства, которые необходимо настроить, и сохранять записанные данные.
ms.prod: sql
