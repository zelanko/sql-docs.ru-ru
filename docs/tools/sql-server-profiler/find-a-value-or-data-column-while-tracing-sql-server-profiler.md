...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] В этом разделе объясняется, как выполнять поиск заданного значения или столбца данных в выходных данных трассировки во время ее выполнения, используя приложение [!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)].  
...
5.  Чтобы найти предыдущее вхождение значения, нажмите кнопку **Найти предыдущее**.  
