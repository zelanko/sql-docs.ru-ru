...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]В этом разделе описана фильтрация событий по времени окончания с помощью события [!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)].  
