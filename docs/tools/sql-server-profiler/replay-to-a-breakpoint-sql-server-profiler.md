...
description: Упростите отладку, установив точки останова, чтобы воспроизведение приостанавливалось при определенных событиях. Используйте SQL Server Profiler, чтобы задать точки останова в файле или таблице трассировки.
ms.prod: sql
