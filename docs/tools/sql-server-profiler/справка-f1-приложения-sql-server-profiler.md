---
title: "Справка F1 приложения SQL Server Profiler | Microsoft Docs"
ms.custom: ""
ms.date: "03/23/2017"
...
helpviewer_keywords: 
  - "Profiler [SQL Server Profiler], справка"
  - "SQL Server Profiler, справка"
  - "диалоговое окно «Свойства трассировки»"
  - "диалоговое окно «Свойства шаблона трассировки»"
  - "Диалоговое окно "Свойства файла трассировки""
  - "диалоговое окно «Список счетчиков производительности»"
  - "диалоговое окно «Общие параметры»"
  - "диалоговое окно «Выбор таблицы рабочей нагрузки»"
  - "диалоговое окно «Целевая таблица»"
...
# Справка F1 приложения SQL Server Profiler
 ...
 ## Свойства трассировки (вкладка "Общие")
 ...
 **Включить время остановки трассировки**  
 Задает дату и время завершения и закрытия трассировки. Вкладка **Выбор событий** диалогового окна **Свойства трассировки** используется для просмотра и указания трассируемых событий и столбцов данных.  
  
 ## Свойства трассировки (вкладка «Выбор событий»)
...
#### Параметры  
 ...
 Для определения фильтра щелкните заголовок столбца данных и введите критерии фильтра. Отфильтрованные столбцы данных отображаются значком фильтра слева от метки столбца в диалоговом окне **Изменение фильтра** . Дополнительные сведения см. в разделе [SQL Server Profiler - Edit Filter](../Topic/SQL%20Server%20Profiler%20-%20Edit%20Filter.md).  
...
## Свойства шаблона трассировки (вкладка «Общие»)
...
## Изменение свойств шаблона трассировки (вкладка «Общие»)
 ...
 **Применять как шаблон по умолчанию для выбранного типа сервера**  
 ...
 ## Свойства шаблона трассировки (вкладка «Выбор событий»)
 ...
 **Систематизировать столбцы**  
 ...
 ## Свойства файла трассировки (вкладка «Общие») 
 ...
 **Изменен**  
 ...
 ## Свойства файла трассировки (вкладка «Выбор событий»)
 ...
 **Систематизировать столбцы**  
 ...
 ## Свойства таблицы трассировки (вкладка «Выбор событий»)
 ...
 **Систематизировать столбцы**  
 После выбора **событий** и столбцов данных для трассировки нажмите кнопку **Упорядочить столбцы**, чтобы принудительно переупорядочить столбцы в окне результатов трассировки.  
  ...
  ## Приложение SQL Server Profiler — предел для счетчиков производительности
...
### Выбор объектов производительности и счетчиков для сопоставления с трассировкой  
...
2.  Установите флажки рядом со счетчиками, которые необходимо сопоставить с файлом трассировки приложения [!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)] .  
 ...
 ## Приложение SQL Server Profiler — Сервис/Параметры (страница «Общие параметры»)
...
> **ПРИМЕЧАНИЕ.** При установке и снятии этого флажка изменяется формат отображения столбцов времени, таких как **StartTime** и **EndTime**. Однако это не приводит к изменению значений параметров **DateTime**, передаваемых в языковых событиях или удаленных вызовах процедур (вызовах RPC).  
...
### Параметры переключения на файл продолжения  
 ...
 **Интервал опроса монитора исправности по умолчанию (сек)**  
 ...
 ## Приложение SQL Server Profiler — Исходная таблица/Помощник по настройке ядра СУБД — Выбор таблицы рабочей нагрузки
...
#### Параметры  
 **SQL Server**  
 Указывает экземпляр SQL Server, к которому в данный момент установлено подключение. Это поле заполняется автоматически и не может быть изменено.  
 ...
 **Table**  
 ...
 ## Приложение SQL Server Profiler — Целевая таблица
 ...
 **Таблица**  
 ...
 ## Приложение SQL Server Profiler — конфигурация воспроизведения (базовые параметры воспроизведения)
 ...
 **Отобразить результаты воспроизведения**  
 ...
 ## Приложение SQL Server Profiler — Конфигурация воспроизведения (дополнительные параметры воспроизведения)
 ...
 **Интервал ожидания монитора заблокированных процессов (сек)**  
 ...
 ## Приложение SQL Server Profiler — диалоговое окно «Поиск»
 ...
 **Найти ранее**  
 ...
 ## Приложение SQL Server Profiler — организация столбцов
 ...
 **Вниз**  
 ...
 ## Приложение SQL Server Profiler — изменение фильтра
...
> **ПРИМЕЧАНИЕ.** Для столбцов данных строкового типа критерии фильтрации будут показаны как строковое значение LIKE или NOT LIKE.  
...
#### Параметры  
 **Тип сервера**  
 Выберите тип сервера, на котором необходимо выбрать шаблон. Этот параметр доступен, только если осуществляется экспорт шаблона.  
