---
title: "Воспроизведение трассировок | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "SQL Server Profiler, воспроизведение трассировок"
  ...
  - "модуль воспроизведения [приложение SQL Server Profiler]"
  - "события [SQL Server], воспроизведение трассировок"
  - "Profiler [SQL Server Profiler], воспроизведение трассировок"
...
# Воспроизведение трассировок
 ...
 Воспроизведение трассировки поддерживает отладку с использованием параметров **Точка останова** и **Выполнить до курсора** в меню **Воспроизведение** [!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)]. Эти команды особенно помогают при анализе длинных скриптов, позволяя разбить воспроизведение на короткие сегменты, которые могут быть последовательно проанализированы.  
