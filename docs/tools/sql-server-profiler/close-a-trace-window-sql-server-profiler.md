...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]Описывается, как закрыть окно трассировки для трассировки, которые находятся под управлением или для сохраненных трассировок, просматриваемых с помощью [!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)].  
