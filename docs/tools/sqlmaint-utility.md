 ...
 **-DelHtmlRpt** \<*time_period*>  
 Задает удаление всех отчетов в формате HTML в каталоге отчетов, если интервал времени с момента создания отчета превышает значение \<*time_period*>. **-DelHtmlRpt** ищет файлы, имена которых соответствуют шаблону, сформированному на основе параметра *html_file*. Если значение аргумента *html_file* равно C:\Program Files\Microsoft SQL Server\Mssql\Backup\AdventureWorks2012_maint.htm, параметр **-DelHtmlRpt** предпишет программе **sqlmaint** удалить все файлы, имена которых соответствуют шаблону C:\Program Files\Microsoft SQL Server\Mssql\Backup\AdventureWorks2012_maint\*.htm и которые являются более старыми, чем указано в значении \<*time_period*>.  
 ...
 **-DelBkUps**< *time_period* >  
 Задает удаление всех файлов резервных копий в каталоге резервных копий, если интервал времени с момента создания резервной копии превышает значение \<*time_period*>.  
