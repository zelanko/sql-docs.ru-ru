...
SSMA для MySQL предназначен для работы с MySQL 4.1 или более поздних версиях, а также всех выпусков SQL Server 2005, SQL Server 2008, SQL Server 2012, SQL Server 2014, SQL Server 2016, 2017 г. SQL Server и базу данных SQL Azure.  
