---
title: Параметры командной строки в консоли SSMA (MySQLToSQL) | Документация Майкрософт
ms.prod: sql
ms.custom: ''
ms.date: 01/19/2017
ms.reviewer: ''
...
Невозможно ввести любой параметр или пароль в качестве параметра командной строки. В противном случае он приводит к ошибке. Дополнительные сведения см. [управление паролями](http://msdn.microsoft.com/4ffbc587-ea3f-49ad-bc42-a654f672325e) раздел.  
...
Табличного отображения команд консоли SSMA параметры командной строки, см. в разделе [приложение 1 &#40;MySQLToSQL&#41;](../../ssma/mysql/appendix-1-mysqltosql.md).  
...
-   Для указания пароля или экспорта / импорта пароли, см. в разделе [управление паролями &#40;MySQLToSQL&#41;](../../ssma/mysql/managing-passwords-mysqltosql.md).  
  
-   Для создания отчетов, см. в разделе [Создание отчеты &#40;MySQLToSQL&#41;](../../ssma/mysql/generating-reports-mysqltosql.md).  
  
-   Для устранения неполадок в консоли, см. в разделе [Устранение неполадок &#40;MySQLToSQL&#41;](../../ssma/mysql/troubleshooting-mysqltosql.md).  
