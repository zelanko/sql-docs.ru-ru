...
1.  В меню **файл** выберите пункт **создать проект** . Раскроется диалоговое окно **Новый проект**. В меню **Файл** выберите пункт **Создать проект**. Раскроется диалоговое окно **Новый проект**.  
