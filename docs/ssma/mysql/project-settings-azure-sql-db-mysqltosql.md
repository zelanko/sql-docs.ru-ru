---
title: Параметры проекта (база данных Azure SQL) (MySQLToSQL) | Документация Майкрософт
ms.prod: sql
ms.custom: ''
ms.date: 01/19/2017
ms.reviewer: ''
...
-   Используйте диалоговое окно Параметры проекта по умолчанию, чтобы задать параметры конфигурации для всех проектов. Для доступа к параметрам SQL Azure, на **средства** меню, выберите **параметры DefaultProject**, выберите тип проекта миграции SQL Azure из **целевой версии миграции** drop до доступа параметров на панели SQL Azure, нажмите кнопку **Общие** в нижней части левой панели, а затем выберите **SQL Azure**.  
