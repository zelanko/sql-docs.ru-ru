...
В следующей таблице показано, какие объекты MySQL преобразуются, а также итоговые [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] объекты.  
  
|||  
|-|-|  
|**Объекты MySQL**|**Результирующие SQL Server объекты**|  
|Таблицы с зависимыми объектами, такими как индексы|SSMA создает таблицы с зависимыми объектами. Таблица преобразуется со всеми индексами и ограничениями. Индексы преобразуются в отдельные [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] объекты.<br /><br />**Сопоставление пространственных типов данных** может выполняться только на уровне узла таблицы.<br /><br />Дополнительные сведения о параметрах преобразования таблиц см. в разделе [Параметры преобразования](conversion-settings-mysqltosql.md) .|  
