...
Дополнительные сведения о файлах сценария образец консоли, в разделе [работа с файлами скриптов образца консоли &#40;MySQLToSQL&#41;](../../ssma/mysql/working-with-the-sample-console-script-files-mysqltosql.md)  
