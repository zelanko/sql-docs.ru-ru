...
В выпуске v8.1 SSMA для MySQL дополнено целевой набор исправлений, призванных повысить качество и метрики преобразования, а также исправления для:
...
В выпуске за апрель 2014 SSMA для MySQL содержит следующие изменения:  
