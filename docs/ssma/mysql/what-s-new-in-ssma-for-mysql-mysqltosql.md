...
В выпуске версии 8.0 SSMA для MySQL была улучшена для предоставления целевых исправлений, предназначенный для повышения качества и преобразования метрики. Этот выпуск также предлагает следующие новые функции:
