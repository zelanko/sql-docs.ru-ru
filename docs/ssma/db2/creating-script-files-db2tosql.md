---
title: Создание файлов сценария (DB2ToSQL) | Документация Майкрософт
ms.prod: sql
ms.custom: ''
ms.date: 01/19/2017
ms.reviewer: ''
...
ms.locfileid: "52520643"
---
# <a name="creating-script-files-db2tosql"></a>Создание файлов сценария (DB2ToSQL)
...
7.  **Остановите операцию:** Во время середине операции, если пользователь хочет остановить операцию, затем **«Ctrl + C»** можно использовать сочетание клавиш. SSMA для DB2 консоли будет ожидать завершения операции и завершает выполнение консоли.  
...
Например перенос данных обычно конкретной таблицы в базе данных DB2 следует иерархии: Схемы -&gt; таблицы.  
...
Полный список команд сценария можно найти в [выполнение команд консоли SSMA &#40;DB2ToSQL&#41;](../../ssma/db2/executing-the-ssma-console-db2tosql.md)  
...
Следующий шаг в работе консоли — [Создание файлов переменных значений &#40;DB2ToSQL&#41;](../../ssma/db2/creating-variable-value-files-db2tosql.md).  
