---
title: Выполнение команд консоли SSMA (DB2ToSQL) | Документация Майкрософт
ms.prod: sql
ms.custom: ''
ms.date: 01/19/2017
ms.reviewer: ''
...
ms.locfileid: "52395197"
---
# <a name="executing-the-ssma-console-db2tosql"></a>Выполнение команд консоли SSMA (DB2ToSQL)
Корпорация Майкрософт предоставляет широкий набор сценариев файл команды для выполнения и контроля над SSMA действий. В последующих разделах подробно описано же. В консольном приложении используется определенные команды файла стандартный сценарий как перечисленные в этом разделе.  
...
/>  
```  
SSMA для DB2 консольное приложение поддерживает обратную совместимость. Можно открывать проекты, созданные в предыдущей версии SSMA.  
...
Команды миграции преобразовать схему целевой базы данных в исходной схеме и переносит данные на целевой сервер. В выходных данных консоли по умолчанию для команды миграции — «Full» выходной отчет с отсутствия сообщений подробные сведения об ошибке: Только сводку в корневой узел дерева на объект источника.  
...
Перенос данных: Переносит данные источника к целевому объекту.  
...
-   `sql` Задает инструкции sql DB2 для преобразования, один или несколько операторов могут быть разделены с помощью «;»  
...
Сведения о образцами файлов сценария консоли, см. в разделе [работа с образцами файлов сценария консоли &#40;DB2ToSQL&#41;](../../ssma/db2/working-with-the-sample-console-script-files-db2tosql.md)  
  
Следующий шаг зависит от требований проекта:  
  
-   Для указания пароля или экспорта / импорта пароли, см. в разделе [управление паролями &#40;DB2ToSQL&#41;](../../ssma/db2/managing-passwords-db2tosql.md).  
  
-   Для создания отчетов, см. в разделе [Создание отчеты &#40;DB2ToSQL&#41;](../../ssma/db2/generating-reports-db2tosql.md).  
  
-   Для устранения неполадок в консоли, см. в разделе [Устранение неполадок &#40;DB2ToSQL&#41;](../../ssma/db2/troubleshooting-db2tosql.md).  
