...
/>  
```  
SSMA для консольного приложения DB2 поддерживает обратную совместимость. Можно открывать проекты, созданные в предыдущей версии SSMA.  
...
Команды миграции преобразовать схему целевой базы данных в исходной схеме и переносит данные на целевой сервер. Задание для миграции команд вывод на консоль по умолчанию — «Полная» выходные данные отчет с отсутствия сообщений подробные сведения об ошибке: только сводки на корневой узел дерева объекта источника.  
...
Перенос данных: выполняется миграция исходных данных в целевой объект.  
...
-   `sql` Задает инструкции sql DB2 для преобразования, можно разделить один или несколько операторов с помощью «;»  
...
Сведения о файлах сценария образец консоли, в разделе [работа с файлами скриптов образца консоли &#40;DB2ToSQL&#41;](../../ssma/db2/working-with-the-sample-console-script-files-db2tosql.md)  
  
Следующий шаг зависит от требований проекта:  
  
-   Для указания пароля или экспорта / импорта паролей см. в разделе [управление паролями &#40;DB2ToSQL&#41;](../../ssma/db2/managing-passwords-db2tosql.md).  
  
-   Для создания отчетов, в разделе [создания отчетами &#40;DB2ToSQL&#41;](../../ssma/db2/generating-reports-db2tosql.md).  
  
-   Для устранения неполадок в консоли, в разделе [Устранение неполадок &#40;DB2ToSQL&#41;](../../ssma/db2/troubleshooting-db2tosql.md).  
