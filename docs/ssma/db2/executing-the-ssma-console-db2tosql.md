...
На файлы скриптов образца консоли Подробнее [работа с консоли скрипт образцы файлов &#40; DB2ToSQL &#41;](../../ssma/db2/working-with-the-sample-console-script-files-db2tosql.md)  
