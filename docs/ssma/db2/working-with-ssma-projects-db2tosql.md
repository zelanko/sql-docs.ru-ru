...
ms.locfileid: "63244659"
---
# <a name="working-with-ssma-projects-db2tosql"></a>Работа с проектами SSMA (DB2ToSQL)
Для переноса баз данных DB2 в [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)], создании проекта SSMA. Проект — это файл, который содержит следующие сведения:  
  
-   Метаданные о базах данных DB2, необходимо выполнить перенос [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)].  
...
5.  Повторите шаги 1 – 3 для миграции, синхронизации, загрузка системных объектов, графического пользовательского интерфейса и сопоставления типов страниц.  
    ...
    -   Сведения о параметрах для синхронизации [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)], см. в разделе [параметры проекта&#40;синхронизации&#41; &#40;DB2ToSQL&#41;](../../ssma/db2/project-settings-synchronization-db2tosql.md).  
...
Для переноса данных из баз данных DB2 в [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)], необходимо сначала создать проект.  
...
Следующий шаг в процессе миграции является [подключение к базе данных DB2](https://msdn.microsoft.com/5eb5801d-f0c3-4127-97c0-0b1ef49f4844).  
