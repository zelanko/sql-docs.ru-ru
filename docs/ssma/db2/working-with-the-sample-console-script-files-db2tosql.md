...
4.  **SqlStatementConversionSample.xml:** Этот пример позволяет создать соответствующий `t-sql` скрипт для базы данных-источника `sql` команды, предоставленной в качестве входных данных.  
