...
|Раздел|Описание|  
|-----------|---------------|  
|[Новые возможности в SSMA для DB2](http://msdn.microsoft.com/1cc38f85-3caa-42d0-8c76-a380c1d15c67)|Новые возможности в этой версии SSMA для DB2|  
...
|[Работа с SSMA для DB2 консоли](http://msdn.microsoft.com/29d8787c-632e-4ff7-9ccc-3f7ad40480ec)|Содержит документацию по SSMA консольного приложения|  
|[Получение SSMA для DB2 помощь](http://go.microsoft.com/fwlink/?LinkID=708538&clcid=0x409)|Сведения о получении дополнительной помощи.|  
