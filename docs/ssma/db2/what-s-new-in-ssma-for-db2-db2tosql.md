...
* Поддержка символа перевода строки в Юникоде (NEL)
...
Выпуск версии SSMA для DB2 усовершенствован с целью устранения проблем с подключением к базе данных SQL Azure из средства консоли SSMA и отсутствующим столбцом COUNT_BIG в объявлении views во время преобразования. Кроме того, эта версия включает целевой набор исправлений, предназначенный для улучшения качества и метрики преобразования, а также исправления для:
...
## <a name="november-2014"></a>Ноябрь 2014
