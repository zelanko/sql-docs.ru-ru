...
После подключения к DB2, подключения [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]к и настройки параметров проекта и сопоставления данных можно преобразовать объекты базы данных DB2 в [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] объекты базы данных.  
...
В следующей таблице показано, какие объекты DB2 преобразованы, а также [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] итоговые объекты.  
