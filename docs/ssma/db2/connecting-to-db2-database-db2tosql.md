...
При подключении к базе данных, SSMA считывает метаданные базы данных и добавляет эти метаданные в файл проекта. Эти метаданные используются с SSMA при преобразовании данных объектов [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)] синтаксис, и когда оно переносит данные [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)]. Можно просматривать эти метаданные в панели обозревателя метаданных DB2 и просмотрите свойства отдельных объектов базы данных.  
