...
- SQL Server 2017 в Windows и Linux (Предварительная версия)
...
-   Консультационные услуги — для партнеров через миграций, go [портал для партнеров](https://www.platformmodernization.org/Pages/default.aspx).  
