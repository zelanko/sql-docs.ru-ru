...
ms.locfileid: "38985246"
---
# <a name="working-with-ssma-projects-oracletosql"></a>Работа с проектами SSMA (OracleToSQL)
Для переноса баз данных Oracle в [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)], создании проекта SSMA. Проект — это файл, который содержит следующие сведения:  
...
5.  Повторите шаги 1 – 3 для миграции, синхронизации, загрузка системных объектов, графического пользовательского интерфейса и сопоставления типов страниц.  
    ...
    -   Сведения о параметрах для синхронизации [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)], см. в разделе [параметры проекта&#40;синхронизации&#41; &#40;OracleToSQL&#41;](../../ssma/oracle/project-settings-synchronization-oracletosql.md).  
...
Для переноса данных из баз данных Oracle в [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)], необходимо сначала создать проект.  
...
Следующий шаг в процессе миграции является [подключение к базе данных Oracle (OracleToSQL)](http://msdn.microsoft.com/e276cdbf-3ebc-4ba8-b40d-a7a42befa2b6).  
