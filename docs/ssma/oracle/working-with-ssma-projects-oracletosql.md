...
Следующим шагом процесса миграции является [Подключение к Oracle Database (OracleToSQL)](./connecting-to-oracle-database-oracletosql.md).  
