...
На файлы скриптов образца консоли Подробнее [работа с консоли скрипт образцы файлов &#40; OracleToSQL &#41;](../../ssma/oracle/working-with-the-sample-console-script-files-oracletosql.md)  
