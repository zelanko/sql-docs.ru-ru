...
* Удалите параметр CAST как FLOAT для столбцов BINARY_FLOAT и BINARY_DOUBLE в запросе на миграцию данных по умолчанию.
...
## <a name="january-2016"></a>2016 января
...
## <a name="april-2014"></a>Апрель 2014
...
## <a name="january-2012"></a>2012 января
...
* Добавлены улучшения при преобразовании объектов:  
  * Packages DBMS_LOB, Добавлено преобразование DBMS_SQL.  
