...
Любой параметр или пароль невозможно ввести в качестве параметра командной строки. В противном случае он приводит к ошибке. Дополнительные сведения см. в [управление паролями](http://msdn.microsoft.com/en-us/8c7d9f8e-06bb-476c-bbd2-15b61d5bba3c) раздела.  
