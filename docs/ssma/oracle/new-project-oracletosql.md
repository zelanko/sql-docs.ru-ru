---
title: "Новый проект (OracleToSQL) | Документы Microsoft"
...
**Название**  
Введите имя проекта. SSMA будет добавлять расширение файла.  
  
**Местоположение**  
Введите или найдите папку или сетевую папку, чтобы сохранить проект.  
