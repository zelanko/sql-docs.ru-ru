...
7.  **Операция остановки:** во время промежуточного операции, если пользователь хочет остановить эту операцию, затем **«Ctrl + C»** можно использовать сочетание клавиш. SSMA для консоли Oracle будет ожидать завершения операции и прекращает выполнение консоли.  
