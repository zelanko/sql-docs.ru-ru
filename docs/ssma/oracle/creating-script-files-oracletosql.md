---
description: Создание файлов сценария (OracleToSQL)
title: Создание файлов скриптов (OracleToSQL) | Документация Майкрософт
ms.prod: sql
ms.custom: ''
ms.date: 01/19/2017
ms.reviewer: ''
...
7.  **Операция завершения:** При выполнении средней операции, если пользователь хочет прерывать операцию, можно использовать сочетание клавиш **CTRL + C** . SSMA для консоли Oracle будет ждать завершения операции и завершит выполнение консоли.  
...
Параметры соединения с сервером можно определить в файле скрипта или в файле соединения с сервером. Дополнительные сведения см. в разделе [Создание файлов подключения к серверу &#40;OracleToSQL&#41;](../../ssma/oracle/creating-the-server-connection-files-oracletosql.md) .  
...
Например, типичная миграция данных для определенной таблицы в базе данных Oracle соответствует иерархии: schema- &gt; Table.  
...
Полный список команд сценария можно найти в статьях [выполнение консоли SSMA &#40;OracleToSQL&#41;](../../ssma/oracle/executing-the-ssma-console-oracletosql.md)  
