...
Подключение к базе данных SQL Azure остается активным до тех пор, пока проект не будет закрыт. При повторном открытии проекта необходимо повторно подключиться к базе данных SQL Azure, если требуется активное подключение к серверу. Вы можете работать автономно, пока вы не загрузит объекты базы данных в базу данных SQL Azure и не перенесете данные.  
...
2.  В диалоговом окне Соединение введите или выберите имя сервера базы данных SQL Azure.  
...
-   Сведения о настройке сопоставления между схемами Sybase и базами данных и схемами БД SQL Azure см. в статье [сопоставление схем ASE Sybase с SQL Server схемами &#40;SybaseToSQL&#41;](../../ssma/sybase/mapping-sybase-ase-schemas-to-sql-server-schemas-sybasetosql.md)  
...
-   Если не нужно выполнять какие – либо из этих задач, можно преобразовать определения объектов базы данных Sybase в определения объектов базы данных SQL Azure. Дополнительные сведения см. в статье [Преобразование объектов базы данных SYBASE ASE &#40;SybaseToSQL&#41;](../../ssma/sybase/converting-sybase-ase-database-objects-sybasetosql.md)  
