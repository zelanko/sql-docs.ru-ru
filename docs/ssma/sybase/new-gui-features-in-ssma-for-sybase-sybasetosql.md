...
Эта функция позволяет выбрать один из двух стандартных windows разметка или создайте собственный макет. Для доступа к меню разметки, в меню "Вид" выберите макетов. Затем можно выбрать один из существующих макетов, добавить новый макет, или управление макетами.  
