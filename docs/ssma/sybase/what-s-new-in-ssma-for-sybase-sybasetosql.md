...
Выпуск SSMA для Access версии 8.0 была улучшена для предоставления целевых исправлений, предназначенный для повышения качества и преобразования метрики. Кроме того этот выпуск предлагает следующие новые функции:
