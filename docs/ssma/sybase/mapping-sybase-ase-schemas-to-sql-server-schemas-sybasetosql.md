...
2.  В области справа щелкните **сопоставление схемы** вкладки.  
    ...
    Вы увидите список всех баз данных ASE с их схем, а затем целевое значение. Этот целевой объект обозначается в нотации двух частей (*database.schema*) в [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)] или SQL Azure, где объекты и данные будут перенесены.  
...
Если настроить сопоставление между схему ASE и [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)] или схему SQL Azure, можно отменить сопоставление значения по умолчанию.  
...
Если вы хотите анализировать преобразование объектов Sybase ASE в [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)] или объекты, SQL Azure, вы можете [создать отчет о преобразовании](http://msdn.microsoft.com/eb996b7c-1eef-4f73-b5e6-2fa6faf7336c). В противном случае вы можете [преобразовать определения объектов базы данных ASE](http://msdn.microsoft.com/509cb65d-2f54-427a-83d7-37919cc4e3e3) в [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)] или определения объектов SQL Azure.  
