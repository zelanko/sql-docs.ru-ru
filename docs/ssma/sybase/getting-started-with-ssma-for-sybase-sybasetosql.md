...
|Меню|Description|  
|--------|---------------|  
|**File**|Содержит команды для работы с проектами, подключения к SAP ASE, а также подключения [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] к базе данных SQL Azure или к ней.|  
