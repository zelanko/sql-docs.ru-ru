...
> [!NOTE]  
> Можно выбрать имеющиеся [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)] или объекты базы данных SQL Azure, которые не были преобразованы из ASE баз данных. Тем не менее эти объекты не будет повторно создан или изменен с SSMA.  
