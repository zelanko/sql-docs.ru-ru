...
5.  Повторите шаги 1 – 3 для миграции SQL Azure, загрузка объектов, графического пользовательского интерфейса и сопоставления типов страниц.  
    ...
    -   Дополнительные сведения о параметрах для загрузки объектов в [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)], см. в разделе [параметры проекта &#40;синхронизации&#41; &#40;SybaseToSQL&#41;](../../ssma/sybase/project-settings-synchronization-sybasetosql.md).  
...
Для переноса данных из баз данных ASE для [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)] или SQL Azure, необходимо сначала создать проект.  
...
3.  Чтобы повторно подключиться к [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)] или SQL Azure, на **файл** меню, выберите **повторно подключиться к SQL Server** / **повторно подключиться к SQL Azure**.  
  
## <a name="next-step"></a>Следующий шаг  
Следующий шаг в процессе миграции является [подключение к Sybase ASE](http://msdn.microsoft.com/a45a2330-9175-4c9e-af38-ef920e350614).  
