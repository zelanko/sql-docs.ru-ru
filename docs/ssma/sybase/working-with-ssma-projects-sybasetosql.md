---
description: Работа с проектами SSMA (SybaseToSQL)
...
5.  Повторите шаги 1-3 для миграции, SQL Azure, загрузки объектов, графического пользовательского интерфейса и сопоставления типов.  
    ...
    -   Сведения о параметрах загрузки объектов в [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] см. в разделе [Project Settings &#40;Synchronization&#41; &#40;SybaseToSQL&#41;](../../ssma/sybase/project-settings-synchronization-sybasetosql.md).  
...
Чтобы перенести данные из баз данных ASE в [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] или SQL Azure, необходимо сначала создать проект.  
