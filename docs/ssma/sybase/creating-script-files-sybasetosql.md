...
7.  **Остановите операцию:** Во время середине операции, если пользователь хочет остановить операцию, затем **«Ctrl + C»** можно использовать сочетание клавиш. SSMA для Sybase консоли будет ожидать завершения операции и завершает выполнение консоли.  
...
Например перенос типичных данных конкретной таблицы в базе данных Sybase соответствует иерархии: База данных -&gt;схемы -&gt;таблицы.  
