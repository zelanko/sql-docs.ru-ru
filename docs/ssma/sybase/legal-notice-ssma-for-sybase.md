---
title: Юридическое уведомление (SSMA для СУБД Sybase) | Документы Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
ms.reviewer: ''
...
---
# <a name="legal-notice-ssma-for-sybase"></a>Юридическое уведомление (SSMA для СУБД Sybase)
