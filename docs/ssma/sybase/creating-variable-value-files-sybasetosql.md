---
title: Создание файлов значение переменной (SybaseToSQL) | Документы Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
ms.reviewer: ''
...
ms.locfileid: "34778530"
---
# <a name="creating-variable-value-files-sybasetosql"></a>Создание файлов значение переменной (SybaseToSQL)
...
Следующий шаг в работе консоли — [Создание файлов подключения сервера &#40;SybaseToSQL&#41;](../../ssma/sybase/creating-the-server-connection-files-sybasetosql.md)  
  
## <a name="see-also"></a>См. также  
[Создание файлов сервера (Sybase)](http://msdn.microsoft.com/en-us/35ef396f-9f98-429d-9fc5-4f413d08fb37)  
