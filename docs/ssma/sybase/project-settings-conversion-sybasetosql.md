...
**Режим по умолчанию/Optimistic:** преобразования и пометить с предупреждением  
  
**Полный режим:** Марк с ошибкой  
...
**Режим по умолчанию/Optimistic**: простое преобразование  
  
**Полный режим**: приведен к фиксированной длины  
...
**Полный режим**: пустая строка, ни одного числового  
...
-   **Перенос с помощью функции ISNULL:** Если этот параметр имеет значение, каждый неконстантное «string_expression» в объединение будет преобразовано с ISNULL(string_expression) и пустые значения будут заменены на пустую строку.  
  
-   **Сохранить текущий синтаксис**  
  
Если выбран режим преобразования в **режим** », вкладка «SSMA применяется следующий параметр:  
  
**Режим по умолчанию/Optimistic:** сохранить текущий синтаксис  
  
**Полный режим:** обернуть функция ISNULL  
...
**Режим по умолчанию:** преобразования и пометить с предупреждением  
  
**Режим оптимистичного:** простое преобразование  
  
**Полный режим:** преобразовать и исправления  
...
**Режим по умолчанию/Optimistic:** создать новую строку  
...
**Режим по умолчанию/Optimistic:** исключить столбец  
...
**Режим по умолчанию/оптимистичного:** Да  
...
**Режим по умолчанию/Optimistic/Full:** Марк с ошибкой  
...
**Режим по умолчанию/Optimistic:** не используйте  
...
**Режим по умолчанию/Optimistic режим/Full:** Replace-функция  
