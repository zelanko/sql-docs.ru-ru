...
Создание new-project: Создание нового проекта SSMA.  
...
Закрыть проект: закрытие проекта миграции.  
...
База данных access нагрузки: используется для загрузки файлов баз данных access  
...
связь с таблицами: Эта команда связывает таблице источника (доступ) на целевую таблицу.  
