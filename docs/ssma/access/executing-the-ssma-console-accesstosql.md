...
Сведения о файлах сценария образец консоли, в разделе [работа с FilesExecuting сценария образец консоли консоли SSMA &#40;AccessToSQL&#41;](../../ssma/access/working-sample-console-script-filesexecuting-ssma-console-accesstosql.md)  
