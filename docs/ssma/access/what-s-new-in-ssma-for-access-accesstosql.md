...
В выпуске v8.1 SSMA для Access дополнено целевых исправлений, которые предназначены для улучшения показателей качества и преобразования.
...
В выпуске версии 8.0 SSMA для Access дополнено целевых исправлений, предназначенный для повышения качества и преобразования метрики. Этот выпуск также предлагает следующие новые функции:
...
В выпуске v7.10 SSMA для Access дополнено целевых исправлений, обеспечивает дополнительную безопасность и защиту конфиденциальности в соответствии с изменения в глобальным требованиям.
...
- Целевых исправлений, повышающих качество и преобразования метрики.
- В зависимости от спроса популярных 32-разрядная версия SSMA для Access — обратно. По сравнению с предыдущей реализации (до v7.4), существует два пакета установщика, но они не могут быть установленных side-by-side. Таким образом необходимо выбрать наиболее подходящий версию для компонентов подключения что у вас есть. Всегда предпочтительнее использовать 64-разрядной версии, если это возможно.

## <a name="ssma-v76"></a>SSMA v7.6
В выпуске v7.6 SSMA для Access повышается с целевых исправлений, повышающих качество и преобразования метрик и поддержка SQL Server 2017 (Предварительная версия). Поддержка SQL Server 2017 в Windows и Linux в общедоступной предварительной версии и не должны использоваться для миграции в рабочей среде.

## <a name="ssma-v75"></a>SSMA v7.5
В выпуске версии 7.5 SSMA для Access дополнено несколько улучшений, чтобы обеспечить большую доступность для людей с ограниченными возможностями.
...
Предварительный выпуск SSMA для Access марта 2016 г. добавлена поддержка миграции на SQL Server 2016.  
...
Июль 2011 г. выпуск SSMA для Access добавляет улучшены сообщения об ошибках во время переноса данных.  
...
SSMA для Access выпуска июня 2008 г. добавлена поддержка баз данных Access 2007.  
