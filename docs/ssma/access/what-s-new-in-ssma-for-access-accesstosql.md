...
В выпуске v8.2 SSMA для Access дополнено целевых исправлений, которые предназначены для улучшения показателей качества и преобразования.
