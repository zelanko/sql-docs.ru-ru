...
|Раздел|Description|  
|-----------|---------------|  
|[Новые возможности SSMA для Access](http://msdn.microsoft.com/en-us/a24d3fc0-6911-4bfa-828a-197abf222e02)|Список всех изменений в выпусках SSMA.|  
...
|[Начало работы с SQL Server Migration Assistant для Access &#40; AccessToSQL &#41;](../../ssma/access/getting-started-with-sql-server-migration-assistant-for-access-accesstosql.md)|Вводит SSMA и пользовательский интерфейс.|  
...
|[Работа с SSMA для доступа к консоли](http://msdn.microsoft.com/en-us/ef94e843-9f88-45a2-86c4-a0af268738c4)|Содержит документацию по SSMA консольного приложения|  
