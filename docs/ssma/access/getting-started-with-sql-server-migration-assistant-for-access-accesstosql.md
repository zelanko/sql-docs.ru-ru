...
Справа от каждого обозреватель метаданных находятся вкладки, которые описывают выбранного объекта. Например, при выборе таблицы в обозревателе метаданных доступ четырех вкладок: **таблицы**, **сопоставления типов**, **свойства**, и **данных** . Если выбрать таблицу в [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] обозреватель метаданных, отображаются три вкладки: **таблицы**, **SQL**, и **данных**.  
