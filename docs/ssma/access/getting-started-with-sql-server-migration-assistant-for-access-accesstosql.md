...
|Кнопка|Функция|  
|----------|------------|  
|**Преобразовать, загрузить и перенести**|Преобразует базы данных Access, загружает объекты, преобразованные в [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)] или базу данных SQL Azure, и переносит данные в [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)] или базу данных SQL Azure за один шаг.|  
