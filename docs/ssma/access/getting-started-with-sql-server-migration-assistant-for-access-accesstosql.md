...
|Меню|Описание|  
|--------|---------------|  
|**Файл**|Содержит команды для мастера миграции, работы с проектами, добавления и удаления файлов базы данных Access, а также подключения [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] к БД или базе данных SQL Azure.|  
