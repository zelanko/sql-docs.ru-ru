...
При определении свойств соединения, также указать базу данных, где объекты и данные будут перенесены. После подключения к SQL Azure, вы можете настроить это сопоставление на уровне схемы доступа. Дополнительные сведения см. в разделе [сопоставление баз данных Access со схемами SQL Server](http://msdn.microsoft.com/69bee937-7b2c-49ee-8866-7518c683fad4)  
...
-   Чтобы настроить сопоставление схем доступа и баз данных SQL Azure и схемы, см. в разделе [баз данных Access сопоставления со схемами SQL Server](http://msdn.microsoft.com/69bee937-7b2c-49ee-8866-7518c683fad4).  
  
-   Чтобы настроить параметры конфигурации для проектов, см. в разделе [Настройка параметров проекта](http://msdn.microsoft.com/0a7304df-2f35-4453-96ef-7ac83dea1167).  
...
-   Если у вас нет для выполнения этих задач, можно преобразовать определения объектов базы данных Access в определения объектов SQL Azure. Дополнительные сведения см. в разделе [преобразование баз данных Access](http://msdn.microsoft.com/e0ef67bf-80a6-4e6c-a82d-5d46e0623c6c)  
