---
title: Глобальные параметры (в окне выходных данных) (AccessToSQL) | Документы Microsoft
...
---
# <a name="global-settings-output-window-accesstosql"></a>Глобальные параметры (в окне выходных данных) (AccessToSQL)
