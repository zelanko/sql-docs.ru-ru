...
- [!INCLUDE[msCoName](../../includes/msconame_md.md)].NET Framework версии 4.7.2 или более поздней версии. .NET Framework можно найти в разделе [Microsoft .NET Guide](https://docs.microsoft.com/dotnet/framework/).
