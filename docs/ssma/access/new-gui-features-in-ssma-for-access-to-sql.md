---
title: Новые функции графического пользовательского интерфейса в SSMA для Access to SQL | Документация Майкрософт
ms.prod: sql
ms.custom: ''
ms.date: 01/19/2017
ms.reviewer: ''
...
ms.locfileid: "68083622"
---
# <a name="new-gui-features-in-ssma-for-access-to-sql"></a>Новые функции графического пользовательского интерфейса в SSMA для Access to SQL
В этой главе описываются новые возможности в SSMA пользовательского интерфейса  
  
## <a name="layouts"></a>Макеты  
Эта функция позволяет выбрать один из двух стандартных windows разметка или создайте собственный макет. Для доступа к меню разметки, в меню "Вид" выберите макетов. Затем можно выбрать один из существующих макетов, добавьте текущий макет или управление макетами.  
