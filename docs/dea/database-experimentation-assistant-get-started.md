---
title: Начало работы с Database Experimentation Assistant
...
ms.locfileid: "74056715"
---
# <a name="get-started-with-database-experimentation-assistant-sql-server"></a>Начало работы с Database Experimentation Assistant (SQL Server)
...
1. Введите или выберите следующие сведения:
   ...
   - **Имя трассировки**: имя создаваемого файла трассировки. Не используйте имя трассировки, использующее соглашение об именовании файла ролловера, например Каптуренаме\_NNN.
