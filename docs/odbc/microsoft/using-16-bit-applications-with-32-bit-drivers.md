---
description: Использование 16-разрядных приложений с 32-разрядными драйверами
...
## <a name="administration"></a>Администрирование  
 ...
 В Windows в Windows (16-разрядный для 32-разрядный), дополнительная библиотека DLL преобразования с именем Ds32gt.dll преобразует 16-битные значения аргументов, передаваемые через 32-разрядную библиотеку DLL, обратно в 16-разрядную.  
...
|Odbcadm.exe|16-разрядная программа администрирования ODBC|
