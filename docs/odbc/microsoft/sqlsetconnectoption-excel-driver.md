...
|SQL_AUTOCOMMIT|Драйвер Microsoft Excel поддерживает только SQL_AUTOCOMMIT, задаваемого (состояние по умолчанию), так как они не поддерживают транзакции.|  
