---
title: Настройка драйвера ODBC Visual FoxPro | Документы Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
Сведения о загрузке и установке драйвера Visual FoxPro ODBC см. в разделе [драйвера ODBC для Visual FoxPro](http://go.microsoft.com/fwlink/?LinkId=121318) на загрузки MSDN.  
 ...
 Используйте программу Microsoft Visual FoxPro Установка драйвера для драйвера ODBC для выполнения следующих:  
  
-   Добавьте новые компоненты.  
  
-   Удалить установленные компоненты.  
  
-   Переустановите восстановление отсутствующих файлов и параметров.  
