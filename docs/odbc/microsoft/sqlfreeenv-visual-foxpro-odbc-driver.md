---
title: "SQLFreeEnv (драйвер ODBC для Visual FoxPro) | Документы Microsoft"
ms.custom: 
ms.date: 01/19/2017
...
---
# <a name="sqlfreeenv-visual-foxpro-odbc-driver"></a>SQLFreeEnv (драйвер ODBC для Visual FoxPro)
> [!NOTE]  
