...
-   [Архитектура драйверов для настольных баз данных](../../odbc/microsoft/desktop-database-drivers-architecture.md)  
  
-   [Журнал драйверов для настольных баз данных](../../odbc/microsoft/history-of-the-desktop-database-drivers.md)  
  
-   [Поддержка продуктов](../../odbc/microsoft/product-support.md)  
  
-   [Реализация драйверы для настольных баз данных](../../odbc/microsoft/implementing-desktop-database-drivers.md)  
  
-   [Рекомендации по программированию драйвер Microsoft Access](../../odbc/microsoft/microsoft-access-driver-programming-considerations.md)  
  
-   [Рекомендации по программированию драйвера Microsoft Excel](../../odbc/microsoft/microsoft-excel-driver-programming-considerations.md)  
  
-   [Рекомендации по программированию драйвера Paradox](../../odbc/microsoft/paradox-driver-programming-considerations.md)  
  
-   [Рекомендации по программированию драйвера dBASE](../../odbc/microsoft/dbase-driver-programming-considerations.md)  
  
-   [Рекомендации по программированию драйвера текстового файла](../../odbc/microsoft/text-file-driver-programming-considerations.md)  
  
-   [Дополнительные поддерживаемые SQL-грамматику ODBC](../../odbc/microsoft/additional-supported-odbc-sql-grammar.md)  
  
-   [Ограничения](../../odbc/microsoft/limitations.md)  
  
-   [Ошибок ODBC](../../odbc/microsoft/odbc-errors.md)  
  
-   [Поддерживаемые ODBC функций API](../../odbc/microsoft/supported-odbc-api-functions.md)
