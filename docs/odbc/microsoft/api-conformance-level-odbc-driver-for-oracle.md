---
title: Уровень соответствия API-Интерфейс (драйвер ODBC для Oracle) | Документы Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "32900239"
---
# <a name="api-conformance-level-odbc-driver-for-oracle"></a>Уровень соответствия API-Интерфейс (драйвер ODBC для Oracle)
> [!IMPORTANT]  
>  Этот компонент будет удален в будущих версиях Windows. Избегайте использования этого компонента в новых разработках и запланируйте изменение существующих приложений, в которых он применяется. Вместо этого используйте драйвер ODBC, предоставляемого корпорацией Oracle.  
  
 Драйвер ODBC для Oracle поддерживает [функций API уровня ядра](../../odbc/microsoft/core-level-api-functions-odbc-driver-for-oracle.md) и [функций API уровня 1](../../odbc/microsoft/level-1-api-functions-odbc-driver-for-oracle.md). Драйвер также поддерживает следующие [функций API уровня 2](../../odbc/microsoft/level-2-api-functions-odbc-driver-for-oracle.md):  
