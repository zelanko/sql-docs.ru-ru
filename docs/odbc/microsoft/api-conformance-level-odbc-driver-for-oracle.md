---
title: Уровень соответствия API (драйвер ODBC для Oracle) | Документация Майкрософт
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "47654902"
---
# <a name="api-conformance-level-odbc-driver-for-oracle"></a>Уровень соответствия API (драйвер ODBC для Oracle)
> [!IMPORTANT]  
>  Этот компонент будет удален в будущих версиях Windows. Избегайте использования этого компонента в новых разработках и запланируйте изменение существующих приложений, в которых он применяется. Вместо этого используйте драйвер ODBC, предоставляемого корпорацией Oracle.  
  
 Драйвер ODBC для Oracle поддерживает [функции API уровня ядра](../../odbc/microsoft/core-level-api-functions-odbc-driver-for-oracle.md) и [функции API уровня 1](../../odbc/microsoft/level-1-api-functions-odbc-driver-for-oracle.md). Драйвер также поддерживает следующие [функции API уровня 2](../../odbc/microsoft/level-2-api-functions-odbc-driver-for-oracle.md):  
