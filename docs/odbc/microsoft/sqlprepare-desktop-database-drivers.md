---
title: СЗЛПодготовка (Драйверы настольных баз данных) Документы Майкрософт
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
Заявление, подготовленное с неправильным числом столбцов, возвращает ошибку во время выполнения, а не при подготовке оператора.
