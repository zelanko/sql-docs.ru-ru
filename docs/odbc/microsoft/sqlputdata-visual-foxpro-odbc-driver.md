---
title: "SQLPutData (драйвер ODBC для Visual FoxPro) | Документы Microsoft"
ms.custom: 
ms.date: 01/19/2017
...
---
# <a name="sqlputdata-visual-foxpro-odbc-driver"></a>SQLPutData (драйвер ODBC для Visual FoxPro)
> [!NOTE]  
