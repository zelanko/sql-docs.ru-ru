---
title: Поддерживаемые типы данных (драйвер ODBC для Oracle) | Документация Майкрософт
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
>  Этот компонент будет удален в будущих версиях Windows. Избегайте использования этого компонента в новых разработках и запланируйте изменение существующих приложений, в которых он применяется. Вместо этого используйте драйвер ODBC, предоставляемого корпорацией Oracle.  
 ...
 Драйвер ODBC для Oracle поддерживает все типы данных Oracle 7.3; Тем не менее он поддерживает любой из новых типов данных Oracle8, перечисленные здесь.  
