...
## <a name="remarks"></a>Примечания  
 В следующей таблице описаны каждой части **Col *** n* запись.  
...
|**CurrencyNegFormat**|Может использоваться одно из следующих значений:<br /><br /> -   ($1)<br />-   –$1<br />-   $–1<br />-   $1–<br />-   (1$)<br />-   –1$<br />-   1–$<br />-   1$–<br />-   –1 $<br />-   –$ 1<br />-   1 $–<br />-   $ 1–<br />-   $ –1<br />-   1– $<br />-   ($ 1)<br />-   (1 $)<br /><br /> В этом примере показано знак доллара, но его следует заменить с соответствующим **CurrencySymbol** значение на практике.|  
