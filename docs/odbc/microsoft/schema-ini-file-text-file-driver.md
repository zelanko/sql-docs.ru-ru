...
|Описатель формата|Формат таблицы|Format. ini, инструкция|  
|----------------------|------------------|---------------------------------|  
...
|*type*|Ниже приведены типы данных.<br /><br /> **Типы данных Microsoft Jet**<br /><br /> bit<br /><br /> Byte<br /><br /> Short<br /><br /> Long<br /><br /> Валюта<br /><br /> Single<br /><br /> Double<br /><br /> DateTime<br /><br /> Text<br /><br /> Memo<br /><br /> **Типы данных ODBC** Char (то же, что и текст)<br /><br /> Float (то же, что и Double)<br /><br /> Целое число (то же, что и короткий)<br /><br /> Лонгчар (то же, что и МЕМО)<br /><br /> *Формат* даты и времени|  
