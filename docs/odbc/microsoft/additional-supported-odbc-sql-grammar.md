---
title: "Дополнительные поддерживаемые SQL-грамматику ODBC | Документы Microsoft"
ms.custom: 
ms.date: 01/19/2017
...
-   [Инструкции ALTER TABLE](../../odbc/microsoft/alter-table-statement.md) (Core)  
  
-   Двоичные литералы (расширенная)  
...
-   IN (*списке значений*) (основной)  
  
-   [Jet: Внешние соединения](../../odbc/microsoft/jet-outer-joins.md) (расширенный)  
  
-   Инструкция SELECT (расширенный) (включая GROUP BY, HAVING и предложения UNION)  
  
-   Вложенные запросы (подзапросы) (основной)  
