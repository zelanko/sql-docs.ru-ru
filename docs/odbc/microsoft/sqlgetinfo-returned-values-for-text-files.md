---
title: S'LGetInfo Вернула значения для текстовых файлов (ru) Документы Майкрософт
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
