---
title: Поддерживаемые варианты (драйвер ODBC для Oracle) | Документы Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
>  Этот компонент будет удален в будущих версиях Windows. Избегайте использования этого компонента в новых разработках и запланируйте изменение существующих приложений, в которых он применяется. Вместо этого используйте драйвер ODBC, предоставляемого корпорацией Oracle.  
 ...
 Драйвер ODBC для Oracle поддерживает следующие параметры (SQLGetConnectOption) и функции уровня 1 SQLSetConnectOption ():  
  
-   SQL_ACCESS_MODE ([SQLGetConnectOption](../../odbc/microsoft/level-1-api-functions-odbc-driver-for-oracle.md)только ())  
...
-   [SQL_TXN_ISOLATION](../../odbc/microsoft/connect-options.md)  
 ...
 Драйвер ODBC для Oracle поддерживает следующие параметры (SQLGetStmtOption) и функции уровня 1 SQLSetStmtOption ():  
