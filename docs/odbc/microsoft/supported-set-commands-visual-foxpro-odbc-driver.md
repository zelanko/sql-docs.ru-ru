---
description: Поддерживаемые команды SET (драйвер ODBC для Visual FoxPro)
title: Поддерживаемые команды SET (драйвер ODBC для Visual FoxPro) | Документация Майкрософт
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
