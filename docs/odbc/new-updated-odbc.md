---
title: Обновлено - ODBC для SQL Server docs | Документы Microsoft
description: Отображение фрагментов обновленное содержимое для последних измененных в документации ODBC (Open Database Connectivity) для Microsoft SQL Server.
manager: craigg
author: MightyPen
ms.author: genemi
ms.topic: article
...
ms.locfileid: "32559252"
---
# <a name="new-and-recently-updated-odbc-for-sql-server"></a>Новые и недавно обновленные: ODBC для SQL Server
...
- *Предметной области:* &nbsp; **ODBC (Open Database Connectivity) для SQL Server**.
