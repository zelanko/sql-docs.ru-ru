...
|-----------------|-----------------|  
|Пользователь|Пользовательские имена DSN являются локальными для компьютера и может использоваться только текущим пользователем. Они регистрируются в дереве реестра HKEY_CURRENT_USER.|  
