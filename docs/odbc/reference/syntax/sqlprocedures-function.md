---
description: Функция SQLProcedures
...
|NUM_INPUT_PARAMS (ODBC 2,0)|4|Недоступно|Зарезервировано для будущего использования. Приложения не должны полагаться на данные, возвращаемые в этих результирующих столбцах.|  
|NUM_OUTPUT_PARAMS (ODBC 2,0)|5|Недоступно|Зарезервировано для будущего использования. Приложения не должны полагаться на данные, возвращаемые в этих результирующих столбцах.|  
|NUM_RESULT_SETS (ODBC 2,0)|6|Недоступно|Зарезервировано для будущего использования. Приложения не должны полагаться на данные, возвращаемые в этих результирующих столбцах.|  
...
|Возвращение параметров и столбцов результирующего набора процедуры|[Функция SQLProcedureColumns](../../../odbc/reference/syntax/sqlprocedurecolumns-function.md)|  
