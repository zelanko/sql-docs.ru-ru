...
|NUM_INPUT_PARAMS (ODBC 2,0)|4|Недоступно|Зарезервировано для последующего использования. Приложения не должны полагаться на данные, возвращаемые в этих результирующих столбцах.|  
|NUM_OUTPUT_PARAMS (ODBC 2,0)|5|Недоступно|Зарезервировано для последующего использования. Приложения не должны полагаться на данные, возвращаемые в этих результирующих столбцах.|  
|NUM_RESULT_SETS (ODBC 2,0)|6|Недоступно|Зарезервировано для последующего использования. Приложения не должны полагаться на данные, возвращаемые в этих результирующих столбцах.|  
