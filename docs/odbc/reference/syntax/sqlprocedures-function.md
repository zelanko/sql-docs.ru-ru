...
|NUM_INPUT_PARAMS (ODBC 2.0)|4|Н/Д|Зарезервировано для будущего использования. Приложения, не следует полагаться на данные, возвращаемые в этих столбцах результата.|  
|NUM_OUTPUT_PARAMS (ODBC 2.0)|5|Н/Д|Зарезервировано для будущего использования. Приложения, не следует полагаться на данные, возвращаемые в этих столбцах результата.|  
|NUM_RESULT_SETS (ODBC 2.0)|6|Н/Д|Зарезервировано для будущего использования. Приложения, не следует полагаться на данные, возвращаемые в этих столбцах результата.|  
