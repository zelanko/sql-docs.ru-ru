 ...
 **SQLNumResultCols** может возвращать любое значение SQLSTATE, которое может быть возвращено **SQLPrepare** или **SQLExecute** при вызове после **SQLPrepare** и до **SQLExecute**, в зависимости от того, когда источник данных оценивает инструкцию SQL связан с инструкцией.  
