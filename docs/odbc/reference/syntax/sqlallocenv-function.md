 ...
 **Сводка**  
 В ODBC 3. *x*, ODBC 2. *x* функция x **SQLAllocEnv** была заменена на **функцию SQLAllocHandle**. Дополнительные сведения см. в разделе [функция функцию SQLAllocHandle](../../../odbc/reference/syntax/sqlallochandle-function.md).  
