...
|ODBC_ERROR_REQUEST_FAILED|Сбой запроса|Аргумент *фремоведсн* имеет значение true; Однако не удалось удалить одно или несколько имен DSN. Сбой вызова **склконфигдривер** с запросом на ODBC_REMOVE_DRIVER.|  
