...
|диагидентифиер|Тип возвращаемого значения|Возвращает|  
|--------------------|-----------------|-------------|  
