...
|HY109|Недопустимое положение курсора|\**StatementText* автономной позиционированные обновления или удаления инструкции и курсор был установлен (по **SQLSetPos** или **SQLFetchScroll**) на строку, которая была удалена или не удалось извлечь.|  
