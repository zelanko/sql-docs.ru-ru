...
## <a name="comments"></a>Комментарии  
 ...
 Если *лпсзнаме* содержит допустимое имя транслятора, оно будет выбрано. \<В противном случае> переводчика не выбран.  
  
 Если пользователь не выбрал \<транслятор>, содержимое *лпсзнаме*, *лпсзпас*и *пвоптион* не будет затронуты. **Склжеттранслатор** устанавливает значение *пкбнамеаут* и *пкбпасаут* в 0 и возвращает true.  
