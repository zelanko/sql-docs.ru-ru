...
ms.locfileid: "47844362"
---
# <a name="sqlinstalldrivermanager-function"></a>Функция SQLInstallDriverManager
**Соответствие стандартам**  
 Версии Introduced: ODBC 1.0: устаревшими в Windows XP с пакетом обновления 2, пакет обновления 1 для Windows Server 2003 и более поздних операционных системах  
