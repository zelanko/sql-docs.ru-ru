...
## <a name="diagnostics"></a>Диагностика  
 ...
 Для всех этих SQLSTATE, которые могут возвращать SQL_SUCCESS_WITH_INFO или SQL_ERROR (за исключением 01XXX SQLSTATE), SQL_SUCCESS_WITH_INFO возвращается при возникновении ошибки в одной или нескольких строках операции многострочные, а SQL_ERROR возвращается при возникновении ошибки в операция с одной строкой.  
