...
ms.locfileid: "47815182"
---
# <a name="sqlbulkoperations-function"></a>Функция SQLBulkOperations
**Соответствие стандартам**  
 Версия была введена: ODBC 3.0 соответствует стандартам: ODBC  
...
## <a name="returns"></a>Возвращает  
 Значение SQL_SUCCESS, SQL_SUCCESS_WITH_INFO, SQL_NEED_DATA, SQL_STILL_EXECUTING, значение SQL_ERROR или SQL_INVALID_HANDLE.  
