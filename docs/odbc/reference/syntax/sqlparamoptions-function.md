 ...
 **Сводка**  
 Функция ODBC 2,0 **SQLParamOptions** была заменена в ODBC 3. *x* по вызовам [SQLSetStmtAttr](../../../odbc/reference/syntax/sqlsetstmtattr-function.md).  
