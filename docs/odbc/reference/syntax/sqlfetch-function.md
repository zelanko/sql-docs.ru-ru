...
|HY107|Значение строки вне допустимого диапазона|Значение, указанное в атрибуте оператора SQL_ATTR_CURSOR_TYPE, было SQL_CURSOR_KEYSET_DRIVENо, но значение, указанное в атрибуте инструкции SQL_ATTR_KEYSET_SIZE, было больше 0 и меньше значения, указанного в SQL_ATTR_ROW_ARRAY_ Атрибут инструкции SIZE.|  
...
|----------------------|-----------|--------------|-----------------|  
|SQL_DESC_ARRAY_SIZE|ард|Верхний колонтитул|Атрибут инструкции SQL_ATTR_ROW_ARRAY_SIZE|  
|SQL_DESC_ARRAY_STATUS_PTR|IRD|Верхний колонтитул|Атрибут инструкции SQL_ATTR_ROW_STATUS_PTR|  
|SQL_DESC_BIND_OFFSET_PTR|ард|Верхний колонтитул|Атрибут инструкции SQL_ATTR_ROW_BIND_OFFSET_PTR|  
|SQL_DESC_BIND_TYPE|ард|Верхний колонтитул|Атрибут инструкции SQL_ATTR_ROW_BIND_TYPE|  
|SQL_DESC_COUNT|ард|Верхний колонтитул|Аргумент *columnNumber* объекта **SQLBindCol**|  
...
|SQL_DESC_ROWS_PROCESSED_PTR|IRD|Верхний колонтитул|Атрибут инструкции SQL_ATTR_ROWS_FETCHED_PTR|  
