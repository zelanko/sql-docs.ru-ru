...
-   Ссылки на связанные функции  
 ...
 Стандартный уровень соответствия для интерфейса командной строки может принимать одно из следующих: ISO 92, Open Group, ODBC или не рекомендуемые к использованию. Функция, отмечен как ISO-92-совместимую также отображается в Open Group версии 1, из-за Open Group является чисто надмножеством ISO-92. Функции, как открыть группу с также появляется в ODBC 3. *x*, так как ODBC 3. *x* является чисто надмножеством Open Group версии 1. Функции, которые помечаются как совместимые с ODBC отображается ни одна из стандарта. С тегами как нерекомендуемые функции был объявлен устаревшим в ODBC 3. *x*.  
