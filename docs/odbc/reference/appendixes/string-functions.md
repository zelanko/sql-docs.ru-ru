...
|Компонент|Описание|  
|--------------|-----------------|  
|**ASCII(** _string_exp_ **)**  (ODBC 1.0)|Возвращает код ASCII первого символа указанного *строковое_выражение* как целое число.|  
...
|**LCASE(** _string_exp_ **)** (ODBC 1.0)|Возвращает строку, в *строковое_выражение*, все прописные буквы алфавита, преобразованную в нижний регистр.|  
