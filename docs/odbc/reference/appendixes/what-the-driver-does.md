...
|**SQLBulkOperations**|Если ODBC *3.x* драйвер должны работать с ODBC *2.x* приложений, использующих **SQLSetPos** с *операции* из SQL_ADD, драйвер должен поддерживает **SQLSetPos** с *операции* из SQL_ADD в дополнение к **SQLBulkOperations** с *операции* из SQL _ДОБАВИТЬ.|  
