...
|**КВАРТАЛ (** *выражение_даты* **)** (ODBC 1.0)|Возвращает квартал в *выражение_даты* виде целочисленного значения в диапазоне от 1 до 4, где 1 представляет 1 января по 31 марта.|  
