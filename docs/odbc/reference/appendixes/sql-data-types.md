...
|SQL_LONGVARCHAR|LONG VARCHAR|Символьные данные переменной длины. Максимальная длина зависит от источника данных. 8|  
...
|SQL_WLONGVARCHAR|лонгвварчар|Символьные данные в Юникоде с переменной длиной. Максимальная длина зависит от источника данных|  
...
|SQL_LONGVARBINARY|LONG VARBINARY|Двоичные данные переменной длины. Максимальная длина зависит от источника данных. 8|  
