...
|Тип SQL<br /><br /> идентификатор|данные SQL;<br /><br /> value|Тип C<br /><br /> идентификатор|Буфер<br /><br /> длина|**таржетвалуептр*|SQLSTATE|  
|-----------------------------|------------------------|---------------------------|-----------------------|------------------------|--------------|  
...
|SQL_DECIMAL|1234,56|SQL_C_SSHORT|не учитывается|1234|01S07|  
