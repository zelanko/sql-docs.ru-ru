...
|c|Текущая функция. Текущая функция выполнялась асинхронно.|  
|d|Требуются данные. Функция вернула SQL_NEED_DATA.|  
|e|Ошибка. Функция вернула SQL_ERROR.|  
...
|Nr|Нет результатов. Инструкция не создаст результирующий набор или не создаст его.|  
