...
```  
 ...
 Поскольку ODBC не требует тип данных для возвращаемых значений из скалярные функции (так как функции часто являются связанными с источником данных), приложения должны использовать скалярная функция CONVERT всякий раз, когда возможность принудительно выполнить преобразование типов данных.  
