---
title: Разработка драйвера ODBC (ru) Документы Майкрософт
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "81287899"
---
# <a name="developing-an-odbc-driver"></a>Разработка драйвера ODBC
В этом разделе содержатся темы, в которые обсуждаются способы разработки драйвера ODBC.  
