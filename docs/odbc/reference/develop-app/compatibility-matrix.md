...
|Замененное приложение|Совместимость|Совместимость|Совместимость|Не совместимые [3]|  
 ...
 [3] в этой конфигурации могут завершиться сбоем для работы, поскольку существуют функции ODBC в *2.x* не входящие в стандарты, такие как закладки.  
  
 [4] в этой конфигурации могут завершиться сбоем для работы, поскольку существуют функции ODBC в *3.x* не входящие в стандарты, такие как закладки.  
