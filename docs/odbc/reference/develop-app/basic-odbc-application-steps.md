---
title: Основные шаги приложения ODBC Документы Майкрософт
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
В этом разделе описывается общий поток приложений ODBC. Маловероятно, что любое приложение вызывает все эти функции именно в этом порядке. Однако в большинстве приложений используются некоторые варианты этих шагов. Основные шаги приложения показаны на следующей иллюстрации.  
