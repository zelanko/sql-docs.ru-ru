---
title: Основные шаги приложения ODBC | Документация Майкрософт
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "81306055"
---
# <a name="basic-odbc-application-steps"></a>Общие шаги по работе с приложением ODBC
В этом разделе описывается общий поток приложений ODBC. Маловероятно, что любое приложение вызывает все эти функции именно в этом порядке. Однако большинство приложений используют некоторые разновидности этих шагов. Основные шаги приложения показаны на следующем рисунке.  
