...
## <a name="usage-scenario-retrieve-an-image-in-parts-from-a-result-set"></a>Сценарий использования: Извлечение изображения в частях из результирующего набора  
