...
-   [Курсоры](../../../odbc/reference/develop-app/cursors.md)  
  
-   [Выборка строки данных](../../../odbc/reference/develop-app/fetching-a-row-of-data.md)  
  
-   [Получение данных типа Long](../../../odbc/reference/develop-app/getting-long-data.md)
