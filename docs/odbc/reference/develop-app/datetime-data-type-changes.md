...
|SQL_C_TYPE_TIMESTAMP (93)|Ошибка (интеллектуальный анализ данных)|Ошибка (интеллектуальный анализ данных)|SQL_C_TIMESTAMP (11)|Нет сопоставления [2]|  
 ...
 [1] в результате использования это ODBC *3.x* приложение, которое работает с ODBC *2.x* драйвер может использовать коды даты, времени или метки времени, возвращаемые в результирующие наборы, возвращаемые функциями каталога.  
  
 [2] в результате использования это ODBC *3.x* приложение, которое работает с ODBC *3.x* драйвер может использовать коды даты, времени или метки времени, возвращаемые в результирующие наборы, возвращаемые функциями каталога.  
