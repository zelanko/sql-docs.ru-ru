...
-   HYT00 (истекло время ожидания)  
 ...
 Полный список SQLSTATE и какие функции возвращают их, см. в разделе [коды ошибок ODBC приложение A:](../../../odbc/reference/appendixes/appendix-a-odbc-error-codes.md). Подробное описание условий, при которых каждая функция может возвращать определенного SQLSTATE см. в разделе этой функции.
