 ...
 **ЗАДАЙТЕ** _идентификатор столбца_ **=** {*выражение* &#124; **NULL**}  
  
 [ **,** _идентификатор столбца_ **=** {*выражение* &#124; **NULL**}]...  
 ...
 **INSERT INTO** _имя таблицы_[ **(** _идентификатор столбца_ [ **,** _столбец идентификаторов_]... **)** ]  
 ...
 {*спецификация запроса* &#124; **значения (** _вставки значение_ [ **,** _вставки значение_]... **)** }  
