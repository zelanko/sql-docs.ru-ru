...
|Параметр<br /><br /> значение|Параметр<br /><br /> SQL<br /><br /> тип данных|Переменная (C)<br /><br /> тип данных|Значение в <br /><br /> привязка<br /><br /> переменная|Значение в <br /><br /> Длина и индикатор<br /><br /> buffer [d]|  
|-------------------------|-----------------------------------------|----------------------------------|-------------------------------------|----------------------------------------------------|  
