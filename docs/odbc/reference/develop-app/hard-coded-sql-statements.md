...
```  
 ...
 Существует несколько преимуществ жестко запрограммированных инструкциях SQL. Для проверки при записи приложения; Это проще, чем инструкции, сформированные во время выполнения; и они упрощают приложения.  
