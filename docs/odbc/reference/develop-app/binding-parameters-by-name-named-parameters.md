...
```  
 ...
 В этой процедуре, первый параметр @title_id, имеет значение по умолчанию 1. Приложение может использовать следующий код для вызова этой процедуры, таким образом, что он указывает только один динамический параметр. Этот параметр представляет собой именованный параметр с именем «\@квоты».  
