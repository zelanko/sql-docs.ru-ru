...
-   **Чистые ODBC 2.**  
     ***x* повторной компиляции приложения** чисто ODBC 2. *x* приложение, которое были перекомпилированы с помощью файлы заголовков ODBC 3.5, задав аргумент ODBCVER = 0x0250.  
  
-   **Чистые ODBC 2.**  
     ***x* приложения Юникода** чисто ODBC 2. *x* перекомпилировать приложение, которое является совместимой с Юникодом и использует тип данных SQL_WCHAR.  
