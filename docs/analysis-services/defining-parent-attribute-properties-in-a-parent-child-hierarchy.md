---
title: "Определение свойств родительского атрибута в иерархии &#171;родители-потомки&#187; | Microsoft Docs"
ms.custom: ""
ms.date: "02/27/2017"
...
Дополнительные сведения см. в разделе [Измерения "родители-потомки"](../analysis-services/multidimensional-models/parent-child-dimensions.md), [Атрибуты в иерархиях типа "родители-потомки"](../analysis-services/multidimensional-models/attributes-in-parent-child-hierarchies.md).  
...
10. ![Сводная таблица, отображающая иерархию Employees](../analysis-services/media/l4-employee-1.gif "Сводная таблица, отображающая иерархию Employees")  
...
4.  Во второй строке **\*** в столбце **Имя** введите **Уровень сотрудника \***, а затем щелкните третью строку.  
    ...
    ![Диалоговое окно «Шаблон именования уровней»](../analysis-services/media/l4-namingtemplate.gif "Диалоговое окно «Шаблон именования уровней»")  
...
5.  Перетащите иерархию **Сотрудники** в область "Метки строк".  
    ...
    ![Измененная иерархия Employees](../analysis-services/media/l4-employee-2.png "Измененная иерархия Employees")  
  
## Следующая задача занятия  
[Автоматическое группирование элементов атрибута](../analysis-services/automatically-grouping-attribute-members.md)  
  
## См. также:  
[Измерения «родители-потомки»](../analysis-services/multidimensional-models/parent-child-dimensions.md)  
[Атрибуты в иерархиях типа «родители-потомки»](../analysis-services/multidimensional-models/attributes-in-parent-child-hierarchies.md)  
