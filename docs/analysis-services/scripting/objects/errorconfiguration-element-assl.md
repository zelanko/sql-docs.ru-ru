---
title: "Элемент ErrorConfiguration (ASSL) | Документы Microsoft"
ms.custom: 
ms.date: 03/06/2017
...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]Задает параметры обработки ошибок, которые могут возникать при обработке родительского элемента.  
...
## <a name="remarks"></a>Remarks  
 Соответствующий элемент в объектной модели Analysis Management объекты AMO — это <xref:Microsoft.AnalysisServices.ErrorConfiguration>.  
