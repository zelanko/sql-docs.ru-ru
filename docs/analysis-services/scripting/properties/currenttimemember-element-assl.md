...
# <a name="currenttimemember-element-assl"></a>Элемент CurrentTimeMember (ASSL)
  Определяет текущий элемент измерения времени, связанного с [ключевого показателя эффективности](../../../analysis-services/scripting/objects/kpi-element-assl.md) элемента.  
