...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]Содержит выражение набора, определяющее список разрешений, которые отклоняются для связанного атрибута.  
