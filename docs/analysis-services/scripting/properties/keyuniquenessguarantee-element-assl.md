...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]Определяет, гарантируется ли связь между ключом атрибута и его имя и связи со связанными атрибутами, недействителен.  
