...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]Содержит фрагмент XML-документа, который описывает [трассировки](../../../analysis-services/scripting/objects/trace-element-assl.md) фильтра.  
