...
# <a name="audit-element-assl"></a>Элемент Audit (ASSL)
  Указывает, что [трассировки](../../../analysis-services/scripting/objects/trace-element-assl.md) элемент не может удалять любые события, даже если это приводит к снижению производительности сервера.  
