...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]Содержит идентификатор (ID) измерения куба, который связывает измерение интеллектуального анализа данных к группе мер.  
