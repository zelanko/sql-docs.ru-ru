---
title: Введите элемент (DimensionAttribute) (ASSL) | Документация Майкрософт
ms.date: 5/8/2018
ms.prod: sql
ms.custom: assl
ms.reviewer: owend
...
|*Страны*|Атрибут представляет страну или регион.|  
|*Округ*|Атрибут представляет округ.|  
...
|*Отчетный месяц*|Атрибут представляет месяцы в финансовом календаре.|  
...
|*Person*|Атрибут представляет человека|  
...
|*Имя проекта*|Атрибут представляет имя проекта.|  
|*Дата начала проекта*|Атрибут представляет дату начала проекта.|  
|*Продвижение*|Атрибут представляет продвижение.|  
...
|*Количественный*|Атрибут представляет количественный атрибут.|  
...
|*Кварталов*|Атрибут представляет кварталы.|  
...
|*Регулярные*|Атрибут представляет обычный атрибут.|  
...
|*Триместр*|Атрибут представляет триместры.|  
...
|*Лет*|Атрибут представляет годы.|  
 ...
 Перечисление, соответствующее допустимым значениям для **тип** в объекты управления Analysis AMO объектной модели это <xref:Microsoft.AnalysisServices.AttributeType>.  
  
 Элемент, соответствующий родителю параметра **тип** в объекты управления Analysis AMO объектной модели это <xref:Microsoft.AnalysisServices.DimensionAttribute>.  
