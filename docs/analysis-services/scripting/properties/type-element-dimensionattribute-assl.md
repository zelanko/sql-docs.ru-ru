...
|*Заказчики*|Атрибут представляет заказчика.|  
...
|*Точка*|Атрибут представляет точку.|  
|*PostalCode*|Атрибут представляет почтовый код.|  
...
|*Promotion*|Атрибут представляет продвижение.|  
...
|*Количественное измерение*|Атрибут представляет количественный атрибут.|  
...
|*Regular*|Атрибут представляет обычный атрибут.|  
