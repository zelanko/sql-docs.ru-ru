...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]Указывает дату и время, когда [трассировки](../../../analysis-services/scripting/objects/trace-element-assl.md) остановки элемента.  
