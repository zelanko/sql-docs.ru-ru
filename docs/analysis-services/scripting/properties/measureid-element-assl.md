...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]Связывает [мер](../../../analysis-services/scripting/objects/measure-element-assl.md) элемента с родительским элементом.  
