...
ms.locfileid: "34030665"
---
# <a name="calculations-element-assl"></a>Элемент Calculations (ASSL)
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]
  Содержит коллекцию элементов [PerspectiveCalculation](../../../analysis-services/scripting/data-type/perspectivecalculation-data-type-assl.md) элементы, связанные с [перспективы](../../../analysis-services/scripting/objects/perspective-element-assl.md) элемента.  
