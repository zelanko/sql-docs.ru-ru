...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]Определяет абстрактный производный тип данных, представляющий привязку к табличному элементу, например таблицы или измерение куба.  
