...
# <a name="perspectivehierarchy-data-type-assl"></a>Тип данных PerspectiveHierarchy (ASSL)
  Определяет тип-примитив, представляющий сведения об иерархии в [PerspectiveDimension](../../../analysis-services/scripting/data-type/perspectivedimension-data-type-assl.md) элемента.  
