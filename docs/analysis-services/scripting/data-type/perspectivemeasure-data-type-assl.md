...
# <a name="perspectivemeasure-data-type-assl"></a>Тип данных PerspectiveMeasure (ASSL)
  Определяет тип-примитив, представляющий сведения о мере в [PerspectiveMeasureGroup](../../../analysis-services/scripting/data-type/perspectivemeasuregroup-data-type-assl.md) элемента.  
