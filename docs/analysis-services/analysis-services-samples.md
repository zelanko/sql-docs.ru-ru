...
ms.locfileid: "68184479"
---
# <a name="analysis-services-samples"></a>Примеры Analysis Services
[!INCLUDE[ssas-appliesto-sqlas-aas](../includes/ssas-appliesto-sqlas-aas.md)]

  Здесь используйте сведения, чтобы найти образцы баз данных и проектов, которые помогут вам узнать о и тестируйте решение служб Analysis Services.
  

## <a name="samples-on-github"></a>Образцы на GitHub

[Репозиторий Git для служб Analysis Services](https://github.com/Microsoft/Analysis-Services) включает примеры кода и проекты сообщества.
