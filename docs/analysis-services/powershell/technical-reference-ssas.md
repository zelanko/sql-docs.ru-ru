...
[!INCLUDE[ssas-appliesto-sqlas](../../includes/ssas-appliesto-sqlas.md)]Чтобы найти нужный раздел в этом разделе, используйте панель содержимого обозревателя слева...  
