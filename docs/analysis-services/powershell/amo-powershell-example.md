---
title: "Пример объекта AMO PowerShell | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
---
# Пример объекта AMO PowerShell
  Ниже приводится пример сценария PowerShell, который вызывает объект управления для служб Analysis Services (объект AMO), чтобы создать табличную базу данных (уровень совместимости 1200), основанную на реляционной базе данных SQL Server.  
  
 Пример приводится исключительно для демонстрации. Сценарий в примере не включает определение связей между таблицами и импорт данных.  Таким образом, это скорее фрагмент кода, а не готовый для выполнения сценарий. Чтобы сделать его функциональным, следует добавить другие вспомогательные функции и дополнительные команды для выполнения недостающих действий.  
  
## Пример DatabaseGenerate.ps1  
...
## См. также  
 ...
 [Справочник по компоненту Analysis Services PowerShell](../../analysis-services/powershell/analysis-services-powershell-reference.md)   
 [Управляющие объекты служб Analysis Services (AMO)](../Topic/Analysis%20Services%20Management%20Objects%20\(AMO\).md)   
