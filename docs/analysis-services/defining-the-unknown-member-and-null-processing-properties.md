---
title: "Определение свойств Unknown Member и Null Processing | Microsoft Docs"
ms.custom: ""
ms.date: "02/27/2017"
...
4.  Разверните элемент **Assembly Components** на уровне **Category**, а затем разверните элемент **Assembly Components** на уровне **Subcategory**.  
    ...
    ![Уровень «Название продукта» с компонентами сборки](../analysis-services/media/l4-assemblycomponents-1.gif "Уровень «Название продукта» с компонентами сборки")  
