---
title: "Столбцы данных событий обработки запросов | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
---
# Столбцы данных событий обработки запросов
...
## Начало вычисления непустого значения  
...
## Текущее вычисление непустого значения  
...
## Конец вычисления непустого значения  
...
## Начало сериализации результатов  
...
## Текущая сериализация результатов  
...
## Конец сериализации результатов  
...
## Начало выполнения скрипта многомерных выражений  
...
## Текущее выполнение скрипта многомерных выражений  
...
## Конец выполнения скрипта многомерных выражений  
...
## Подробный вложенный куб запроса  
...
## Получение данных из статистической обработки  
...
## Совпадение кэша запросов VertiPaq SE  
