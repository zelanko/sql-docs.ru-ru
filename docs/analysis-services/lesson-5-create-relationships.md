---
title: "Занятие 5. Создание связей | Microsoft Docs"
ms.custom: ""
ms.date: "02/27/2017"
...
## Следующий шаг  
Чтобы продолжить изучение этого занятия, перейдите к следующему занятию: [Занятие 6. Создание вычисляемых столбцов](../analysis-services/lesson-6-create-calculated-columns.md).  
