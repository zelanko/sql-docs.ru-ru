...
1.  Откройте в конструкторе кубов куб [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] Tutorial и перейдите на вкладку **Ключевые показатели эффективности** .  
    ...
    ![Ключевые показатели эффективности вкладке конструктора кубов](../analysis-services/media/l7-kpi-1.gif "KPIs tab конструктора кубов")  
...
2.  На панели инструментов вкладки **Ключевые показатели эффективности** нажмите кнопку **Создать ключевой показатель** .  
    ...
    ![Пустой шаблон ключевого показателя Эффективности в панели отображения](../analysis-services/media/l7-kpi-2.gif "шаблон пустой KPI на панели отображения")  
