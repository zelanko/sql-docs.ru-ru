---
title: "Тестирование и проверка (интеллектуальный анализ данных) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  ...
  - "сравнение моделей интеллектуального анализа данных"
  - "диаграммы непрерывных атрибутов"
  ...
  - "прогнозы [службы Analysis Services], сравнение моделей интеллектуального анализа данных"
  - "вычисление [интеллектуальный анализ данных]"
  - "диаграммы точности прогнозов [службы Analysis Services]"
...
|Узнайте о типах диаграмм точности, имеющихся в [!INCLUDE[ssASCurrent](../../includes/ssascurrent-md.md)].|[Диаграмма точности прогнозов (службы Analysis Services — интеллектуальный анализ данных)](../../analysis-services/data-mining/lift-chart-analysis-services-data-mining.md)<br /><br /> [Диаграмма роста прибыли (службы Analysis Services — интеллектуальный анализ данных)](../../analysis-services/data-mining/profit-chart-analysis-services-data-mining.md)<br /><br /> [Точечная диаграмма (службы Analysis Services — интеллектуальный анализ данных)](../../analysis-services/data-mining/scatter-plot-analysis-services-data-mining.md)|  
