...
### <a name="lift-chart-with-target-value"></a>Диаграмма точности прогнозов с целевым значением  
 ...
 ![две модели отображение диаграммы точности прогнозов](../../analysis-services/data-mining/media/newliftchart-tm30-30.gif "отображающая две модели диаграммы точности прогнозов")  
...
### <a name="lift-chart-for-model-with-no-target-value"></a>Диаграмма точности прогнозов для модели без целевого значения  
 ...
 ![Поднимите правильными прогнозами отображение диаграммы](../../analysis-services/data-mining/media/lift1.gif "диаграммы точности прогнозов с правильными прогнозами")  
