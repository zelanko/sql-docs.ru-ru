---
title: "конструктор интеллектуального анализа данных | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  ...
  - "структуры интеллектуального анализа данных [службы Analysis Services], изменение"
  - "редактор интеллектуального анализа данных [службы Analysis Services]"
  - "конструктор интеллектуального анализа данных"
  - "интеллектуальный анализ данных [службы Analysis Services], изменение"
...
## Вкладка «Структура интеллектуального анализа данных»  
...
## Вкладка «Модели интеллектуального анализа данных»  
...
## Вкладка «Средство просмотра модели интеллектуального анализа данных»  
...
## Вкладка «Диаграмма точности интеллектуального анализа»  
...
## Вкладка «Прогноз модели интеллектуального анализа данных»  
