---
title: "Технический справочник по алгоритму дерева принятия решений (Майкрософт) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
|4|Эквивалент Дирихле метода Байеса (BDE) с однородной априорной оценкой<br /><br /> (по умолчанию).|  
 ...
 Обзор трех данных методов количественной оценки см. в разделе [Feature Selection](../Topic/Feature%20Selection.md).  
