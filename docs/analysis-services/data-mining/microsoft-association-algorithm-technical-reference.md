---
title: "Технический справочник по алгоритму взаимосвязей (Майкрософт) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "MINIMUM_ITEMSET_SIZE, параметр"
  - "MAXIMUM_SUPPORT, параметр"
  - "алгоритмы взаимосвязей [службы Analysis Services]"
  - "MINIMUM_SUPPORT, параметр"
  - "OPTIMIZED_PREDICTION_COUNT, параметр"
  - "взаимосвязи [службы Analysis Services]"
  - "MAXIMUM_ITEMSET_COUNT, параметр"
  - "MAXIMUM_ITEMSET_SIZE, параметр"
  - "MINIMUM_PROBABILITY, параметр"
