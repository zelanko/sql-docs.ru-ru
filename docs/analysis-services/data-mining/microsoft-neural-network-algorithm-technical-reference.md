---
title: "Технический справочник по алгоритму нейронной сети (Майкрософт) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "HIDDEN_NODE_RATIO, параметр"
  - "MAXIMUM_INPUT_ATTRIBUTES, параметр"
  - "HOLDOUT_PERCENTAGE, параметр"
  ...
  - "функция активации [интеллектуальный анализ данных]"
  - "сеть дельта-правила с обратным распространением"
  - "neural network model [Analysis Services]"
  - "кодирование [интеллектуальный анализ данных]"
  - "HOLDOUT_SEED, параметр"
