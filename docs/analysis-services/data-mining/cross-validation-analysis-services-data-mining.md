...
### <a name="setting-the-number-of-partitions"></a>Установка числа секций  
 ...
 ![Как перекрестная проверка сегментирует данные](../../analysis-services/data-mining/media/xvoverviewmain.gif "как перекрестная проверка сегментирует данные")  
