---
title: "Примеры запросов моделей взаимосвязей | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
###  <a name="bkmk_Query4"></a> Пример запроса 4: получение списка наборов элементов и продуктов  
