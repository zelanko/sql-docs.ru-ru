...
##  <a name="bkmk_Holdout"></a> Развертывание моделей с контрольными данными  
 При создании структуры интеллектуального анализа данных, который содержит контрольную секцию для тестирования моделей интеллектуального анализа данных, структуры интеллектуального анализа данных можно развернуть на экземпляре SQL Server 2005, но сведения о секции будут потеряны.  
...
##  <a name="bkmk_Filter"></a> Развертывание моделей с фильтрами  
 При применении фильтра к модели интеллектуального анализа данных, модель может быть развернута на экземпляре SQL Server 2005, но не будут применяться фильтр.  
