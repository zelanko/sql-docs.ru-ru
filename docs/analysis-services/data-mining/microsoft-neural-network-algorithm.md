---
title: "Алгоритм нейронной сети (Майкрософт) | Microsoft Docs"
ms.custom: ""
ms.date: "03/02/2016"
...
helpviewer_keywords: 
  ...
  - "нейроны [службы Analysis Services]"
  - "алгоритмы классификации [службы Analysis Services]"
  - "нейронные сети"
  - "многоуровневая перцептронная сеть нейронов [службы Analysis Services]"
  - "скрытые нейроны"
