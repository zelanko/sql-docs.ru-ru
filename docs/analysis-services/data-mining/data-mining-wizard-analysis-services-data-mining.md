...
-   **Auto - определение типов данных**: Мастер исследует уникальность и распределение значений в столбцах и затем рекомендует наилучший тип данных и тип использования данных. Эти предложения можно отвергнуть и выбрать значения из списка.  
