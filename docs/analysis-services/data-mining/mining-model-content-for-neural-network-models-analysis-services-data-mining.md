---
title: "Содержимое моделей интеллектуального анализа данных для моделей нейронных сетей (службы Analysis Services — интеллектуальный анализ данных) | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "выходные нейроны [службы Analysis Services]"
  - "алгоритмы нейронной сети [службы Analysis Services]"
  - "выходной слой [интеллектуальный анализ данных]"
  - "скрытый слой"
  - "скрытые нейроны"
  - "входной слой [интеллектуальный анализ данных]"
  - "входные нейроны [службы Analysis Services]"
  - "содержимое моделей интеллектуального анализа данных, модели нейронных сетей"
