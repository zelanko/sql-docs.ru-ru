---
title: "Просмотр формулы для модели временных рядов (интеллектуальный анализ данных) | Microsoft Docs"
ms.custom: ""
ms.date: "03/02/2016"
...
helpviewer_keywords: 
  ...
  - "средство просмотра временных рядов [службы Analysis Services]"
...
---
# Просмотр формулы для модели временных рядов (интеллектуальный анализ данных)
...
### Просмотр формулы регрессии ARTXP для модели временных рядов  
...
### Просмотр формулы ARIMA для модели временных рядов  
...
### Получение коэффициентов и членов уравнения  
...
2.  Кроме того, можно просмотреть модели временных рядов и найти члены и коэффициенты, используя [Средство просмотра деревьев содержимого общего вида (Майкрософт)](../Topic/Microsoft%20Generic%20Content%20Tree%20Viewer%20\(Data%20Mining\).md).  
