---
title: "Примеры запросов моделей временных рядов | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  ...
  - "прогнозы [службы Analysis Services], временные ряды"
  - "EXTEND_MODEL_CASES, параметр"
  - "REPLACE_MODEL_CASES, параметр"
...
|ARIMA (2,0,7)x(1,0,2)(12)|R250 Europe:Quantity(Periodicity)|12|  
 ...
 Дополнительные сведения об интерпретации этой информации см. в разделе [Интеллектуальный анализ содержимого моделей временных рядов (службы Analysis Services — интеллектуальный анализ данных)](../../analysis-services/data-mining/mining-model-content-for-time-series-models-analysis-services-data-mining.md).  
