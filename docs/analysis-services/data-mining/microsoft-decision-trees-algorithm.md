---
title: "Алгоритм дерева принятия решений (Майкрософт) | Microsoft Docs"
ms.custom: ""
ms.date: "03/02/2016"
...
helpviewer_keywords: 
  ...
  - "дискретные столбцы [службы Analysis Services]"
...
### Прогнозирование непрерывных столбцов  
 ...
 ![Линии множественной регрессии, показывающие нелинейность](../../analysis-services/data-mining/media/regression-tree1.png "Линии множественной регрессии, показывающие нелинейность")  
