---
title: "Основные понятия интеллектуального анализа данных | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Службы Analysis Services в SQL Server, интеллектуальный анализ данных"
  - "очистка данных"
  - "прогнозирующий анализ"
  - "обучающие алгоритмы"
  - "интеллектуальный анализ данных [службы Analysis Services], концепции"
  - "индуктивное обучение"
  - "интеллектуальный анализ данных [службы Analysis Services], сведения об интеллектуальном анализе данных"
  - "модели интеллектуального анализа данных [службы Analysis Services]"
  - "доступ к данным [службы Analysis Services]"
  - "компьютерные обучающие алгоритмы [службы Analysis Services]"
  - "модели интеллектуального анализа данных [службы Analysis Services], сведения об интеллектуальном анализе данных"
  - "SSAS, интеллектуальный анализ данных"
...
6.  [Развертывание и обновление моделей](#DeployingandUpdatingModels)  
 ...
 Пример применения средств [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] в бизнес-сценарии см. в разделе [Учебник по основам интеллектуального анализа данных](../Topic/Basic%20Data%20Mining%20Tutorial.md).  
...
##  <a name="DefiningTheProblem"></a> Постановка задачи  
 ...
 ![Первый этап интеллектуального анализа данных: определение проблемы](../../analysis-services/data-mining/media/dmprocess-defining.gif "Первый этап интеллектуального анализа данных: определение проблемы")  
...
##  <a name="BuildingModels"></a> Построение моделей  
 ...
 ![Четвертый этап интеллектуального анализа данных: создание моделей интеллектуального анализа](../../analysis-services/data-mining/media/dmprocess-building.gif "Четвертый этап интеллектуального анализа данных: создание моделей интеллектуального анализа")  
...
##  <a name="ValidatingModels"></a> Исследование и проверка моделей  
 ...
 ![Пятый этап интеллектуального анализа данных: проверка моделей интеллектуального анализа](../../analysis-services/data-mining/media/dmprocess-validating.gif "Пятый этап интеллектуального анализа данных: проверка моделей интеллектуального анализа")  
...
##  <a name="DeployingandUpdatingModels"></a> Развертывание и обновление моделей  
 ...
 ![Шестой этап интеллектуального анализа данных: развертывание моделей интеллектуального анализа](../../analysis-services/data-mining/media/dmprocess-deploying.gif "Шестой этап интеллектуального анализа данных: развертывание моделей интеллектуального анализа")  
...
-   Использование служб [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)] для создания пакета, в котором модель интеллектуального анализа данных используется для интеллектуального распределения входящих данных по разным таблицам. Например, если база данных постоянно обновляется за счет добавления потенциальных клиентов, модель интеллектуального анализа данных может использоваться совместно со службами [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)] для разбиения входящих данных на клиентов, которые с высокой долей вероятности купят товар, и клиентов, которые с высокой долей вероятности не купят товар. Дополнительные сведения см. в статье [Типовое использование служб Integration Services](http://msdn.microsoft.com/ru-ru/3b97897a-d418-4ef4-b5a4-5aabf4fa6bca).  
