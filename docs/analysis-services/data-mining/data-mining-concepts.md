...
-   **Рекомендации по**: определение продуктов, которые с высокой долей вероятности могут быть проданы вместе, создание рекомендаций  
...
##  <a name="BuildingModels"></a> Построение моделей  
 ...
 ![Четвертый этап интеллектуального анализа данных: Создание моделей интеллектуального анализа](../../analysis-services/data-mining/media/dmprocess-building.gif "Четвертый этап интеллектуального анализа данных: построение моделей интеллектуального анализа данных")  
...
-   Использование служб [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)] для создания пакета, в котором модель интеллектуального анализа данных используется для интеллектуального распределения входящих данных по разным таблицам. Например, если база данных постоянно обновляется за счет добавления потенциальных клиентов, модель интеллектуального анализа данных может использоваться совместно со службами [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)] для разбиения входящих данных на клиентов, которые с высокой долей вероятности купят товар, и клиентов, которые с высокой долей вероятности не купят товар. Дополнительные сведения см. в статье [Типовое использование служб Integration Services](http://msdn.microsoft.com/3b97897a-d418-4ef4-b5a4-5aabf4fa6bca).  
