---
title: "Создание реляционной структуры интеллектуального анализа данных | Microsoft Docs"
ms.custom: ""
ms.date: "03/13/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "измерения [службы Analysis Services], интеллектуальный анализ данных"
  ...
  - "модели интеллектуального анализа данных OLAP [службы Analysis Services]"
