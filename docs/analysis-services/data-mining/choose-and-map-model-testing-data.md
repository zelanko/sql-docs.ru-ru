---
title: "Выбрать и сопоставить данные проверки модели | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "столбцы [интеллектуальный анализ данных], диаграммы точности интеллектуального анализа данных"
  - "диаграмма точности интеллектуального анализа данных [службы Analysis Services], сопоставления столбцов"
  - "сопоставление входных столбцов [службы Analysis Services]"
  - "сопоставление входных столбцов [службы Analysis Services]"
