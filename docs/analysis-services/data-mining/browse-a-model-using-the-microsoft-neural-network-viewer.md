---
title: "Просмотр модели с помощью средства просмотра нейронных сетей (Майкрософт) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  ...
  - "классификационная модель интеллектуального анализа данных [службы Analysis Services]"
  - "Средство просмотра нейронных сетей (Microsoft)"
  - "алгоритмы регрессии [службы Analysis Services]"
  - "средство просмотра нейронных сетей (Microsoft) [службы Analysis Services]"
  - "модель нейронной сети [службы Analysis Services]"
...
---
# Просмотр модели с помощью средства просмотра нейронных сетей (Майкрософт)
