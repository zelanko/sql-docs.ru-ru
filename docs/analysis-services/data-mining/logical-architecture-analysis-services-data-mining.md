---
title: "Логическая архитектура (службы Analysis Services — интеллектуальный анализ данных) | Microsoft Docs"
ms.custom: ""
ms.date: "03/13/2017"
...
helpviewer_keywords: 
  ...
  - "логическая архитектура [интеллектуальный анализ данных]"
  - "архитектура [службы Analysis Services], модели интеллектуального анализа данных"
