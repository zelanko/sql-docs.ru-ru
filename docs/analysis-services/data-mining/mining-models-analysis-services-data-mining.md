...
-   Выберите столбцы из структуры, который будет использоваться в модели и как их следует использовать, в результате столбец содержит результата, который требуется предсказать, какие столбцы — только входные данные, и т. д.  
...
|Программируемые интерфейсы интеллектуального анализа данных.|[Разработка объектов управления аналитикой (объекты AMO)](https://docs.microsoft.com/bi-reference/amo/developing-with-analysis-management-objects-amo)<br /><br /> [Справочник по расширениям интеллектуального анализа данных (расширения интеллектуального анализа данных)](../../dmx/data-mining-extensions-dmx-reference.md)|  
