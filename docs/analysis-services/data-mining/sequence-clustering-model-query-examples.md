...
###  <a name="bkmk_Query1"></a> Образец запроса 1. Использование набора строк схемы интеллектуального анализа данных для определения параметров модели  
...
###  <a name="bkmk_Query2"></a> Образец запроса 2. Получение списка последовательностей для состояния  
...
###  <a name="bkmk_Query3"></a> Образец запроса 3. Использование системных хранимых процедур  
...
#### <a name="cluster-characteristics-and-cluster-discrimination"></a>Характеристики кластера и сравнение кластеров  
 Вкладка **Характеристики кластера** содержит сводную информацию об основных атрибутах каждого кластера, ранжированную по вероятностям. Чтобы узнать сколько случаев принадлежит к кластеру, и выглядит распределение вариантов в кластере: У каждой характеристики есть некоторые поддержке. Чтобы увидеть характеристики конкретного кластера, нужно знать его идентификатор.  
...
###  <a name="bkmk_Query4"></a> Образец запроса 4. Прогноз следующего состояния или состояний  
