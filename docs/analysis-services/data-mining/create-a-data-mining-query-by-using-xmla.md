---
title: "Создание запроса интеллектуального анализа данных с помощью XMLA | Microsoft Docs"
ms.custom: ""
ms.date: "03/04/2017"
...
2.  На панели **Запрос** поместите курсор после элемента **\<Список ограничений>** и нажмите клавишу ВВОД, чтобы добавить новую строку.  
  
3.  Поместите курсор в пустую строку и введите **\<SchemaName>DMSCHEMA_MINING_MODEL_CONTENT\</SchemaName>**.  
