---
title: "Создание прогнозирующего запроса с помощью построителя прогнозирующих запросов | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
helpviewer_keywords: 
  ...
  - "Прогнозирование моделей интеллектуального анализа [службы Analysis Services], прогнозирующие запросы"
