---
title: "Типы данных (интеллектуальный анализ данных) | Microsoft Docs"
ms.custom: ""
ms.date: "03/02/2016"
...
helpviewer_keywords: 
  ...
  - "столбцы [интеллектуальный анализ данных], типы данных"
  - "интеллектуальный анализ данных [службы Analysis Services], типы данных"
