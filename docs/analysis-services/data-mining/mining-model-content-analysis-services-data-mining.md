---
title: "Содержимое модели интеллектуального анализа данных (службы Analysis Services — интеллектуальный анализ данных) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  ...
  - "степень достоверности [интеллектуальный анализ данных]"
  - "модели интеллектуального анализа данных [службы Analysis Services]"
  - "дисперсия"
  - "компьютерные обучающие алгоритмы [службы Analysis Services]"
  - "содержимое модели"
...
|2|Существующая|Указывает, что данные вариантов содержат значение для этого атрибута.|  
