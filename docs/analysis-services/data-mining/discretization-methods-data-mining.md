---
title: "Методы дискретизации (Интеллектуальный анализ данных) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  ...
  - "столбцы [интеллектуальный анализ данных], дискретизация"
  - "THRESHOLDS, метод"
  - "CLUSTERS, метод"
  - "DiscretizationBuckets, свойство"
  - "AUTOMATIC, метод"
  - "EQUAL_AREAS, метод"
