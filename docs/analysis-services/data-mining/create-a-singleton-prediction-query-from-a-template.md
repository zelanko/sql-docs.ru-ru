---
title: "создать одноэлементный прогнозирующий запрос из шаблона | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "прогнозы с одноэлементными запросами [расширения интеллектуального анализа данных]"
...
## См. также  
 [Создание прогнозов (учебник по интеллектуальному анализу данных — начальный уровень)](../Topic/Creating%20Predictions%20\(Basic%20Data%20Mining%20Tutorial\).md)  
