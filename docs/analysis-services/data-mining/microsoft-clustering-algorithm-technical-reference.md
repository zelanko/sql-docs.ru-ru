---
title: "Технический справочник по алгоритму кластеризации (Майкрософт) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  ...
  - "CLUSTER_SEED, параметр"
  - "MODELLING_CARDINALITY, параметр"
  - "MINIMUM_SUPPORT, параметр"
  - "STOPPING_TOLERANCE, параметр"
  - "MAXIMUM_STATES, параметр"
  - "SAMPLE_SIZE, параметр"
  - "CLUSTERING_METHOD, параметр"
  - "мягкая кластеризация [интеллектуальный анализ данных]"
  - "алгоритмы кластеризации [службы Analysis Services]"
  - "CLUSTER_COUNT, параметр"
