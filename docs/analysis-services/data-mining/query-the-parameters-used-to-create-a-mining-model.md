---
title: "запросить параметры, используемые для создания модели интеллектуального анализа данных | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
## Пример  
 Следующий программный код возвращает список параметров, которые использовались в учебнике [Basic Data Mining Tutorial](../Topic/Basic%20Data%20Mining%20Tutorial.md)при создании модели интеллектуального анализа данных. В число этих параметров входят все значения по умолчанию, используемые службами интеллектуального анализа данных и предоставляемые поставщиками на сервере.  
