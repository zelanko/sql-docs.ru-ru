---
title: Интеллектуальный анализ данных наборы строк схемы (службы SSAs) | Документация Майкрософт
ms.date: 05/01/2018
ms.prod: sql
