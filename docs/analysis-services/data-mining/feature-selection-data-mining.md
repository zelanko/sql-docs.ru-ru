---
title: "Выбор компонентов (интеллектуальный анализ данных) | Microsoft Docs"
ms.custom: ""
ms.date: "03/02/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "модели интеллектуального анализа данных [службы Analysis Services], выбор компонентов"
  - "атрибуты [интеллектуальный анализ данных]"
  - "алгоритмы выбора компонентов [службы Analysis Services]"
  - "интеллектуальный анализ данных [службы Analysis Services], выбор компонентов"
...
## Зачем выполнять выбор компонентов?  
...
## Работа выбора компонентов при интеллектуальном анализе данных SQL Server  
...
### Методы выбора компонентов для алгоритма  
