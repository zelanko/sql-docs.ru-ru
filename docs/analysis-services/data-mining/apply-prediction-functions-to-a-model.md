---
title: "Применение функций прогнозирования к модели | Microsoft Docs"
ms.custom: ""
ms.date: "03/02/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "прогнозирование моделей интеллектуального анализа [службы Analysis Services], выбор моделей интеллектуального анализа данных"
...
1.  Если у вас нет модели кластеризации для создания этого образца запроса, создайте модель [TM_Clustering] с помощью [Учебника по основам интеллектуального анализа данных](../Topic/Basic%20Data%20Mining%20Tutorial.md).  
