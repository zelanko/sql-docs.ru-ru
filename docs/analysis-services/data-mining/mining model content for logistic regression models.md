---
title: "Содержимое моделей интеллектуального анализа данных для моделей логистической регрессии (службы Analysis Services — интеллектуальный анализ данных) | Microsoft Docs"
ms.custom: ""
ms.date: "03/23/2017"
...
helpviewer_keywords: 
  ...
  - "Содержимое моделей интеллектуального анализа данных, модели логистической регрессии"
...
## Основные сведения о структуре модели логистической регрессии  
 ...
 ![структура содержимого для модели логистической регрессии](../../analysis-services/data-mining/media/skt-modelcontentstructure-logregc.gif "структура содержимого для модели логистической регрессии")  
...
|Выходной узел|Имя выходного атрибута|  
 ...
 NODE_NAME  
 Тип узла. В текущей версии этот столбец содержит то же значение, что и NODE_UNIQUE_NAME, но такое соответствие может измениться в следующих версиях.  
...
|Выходной узел|Фрагмент XML-кода, содержащий те же сведения, что и столбец NODE_DESCRIPTION.|  
 ...
 NODE_DISTRIBUTION  
 Вложенная таблица, содержащая статистические данные для узла. Подробные сведения о содержимом этой таблицы для каждого типа узла см. в разделе "Основные сведения о таблице NODE_DISTRIBUTION" статьи [Содержимое моделей интеллектуального анализа данных для моделей нейронных сетей (службы Analysis Services — интеллектуальный анализ данных)](../../analysis-services/data-mining/mining-model-content-for-neural-network-models-analysis-services-data-mining.md).  
