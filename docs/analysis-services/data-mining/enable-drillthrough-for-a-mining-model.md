---
title: "включить детализацию для модели интеллектуального анализа данных | Microsoft Docs"
ms.custom: ""
ms.date: "03/06/2017"
...
helpviewer_keywords: 
  ...
  - "детализация [службы Analysis Services]"
...
### Включение детализации в модели интеллектуального анализа данных  
...
### Включение кэширования для структуры интеллектуального анализа данных  
