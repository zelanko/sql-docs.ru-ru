---
title: "Применение фильтра к модели интеллектуального анализа данных | Microsoft Docs"
ms.custom: ""
ms.date: "03/19/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "фильтр модели [интеллектуальный анализ данных]"
  - "фильтры [интеллектуальный анализ данных]"
  - "фильтрация входных строк [службы Analysis Services]"
  - "фильтрация данных [службы Analysis Services]"
...
1.  В диалоговом окне **Фильтр модели \<имя>** щелкните пустую строку в сетке под текстовым полем **Столбец структуры интеллектуального анализа данных**.  
