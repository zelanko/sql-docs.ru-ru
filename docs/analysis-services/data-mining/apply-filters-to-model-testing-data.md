---
title: "Применение фильтров к данным проверки модели | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "фильтрация входных строк [SQL Server]"
  - "фильтрация входных строк [службы Analysis Services]"
  - "Диаграмма точности интеллектуального анализа данных [службы Analysis Services], фильтрация входных строк"
