...
## <a name="understanding-the-structure-of-a-clustering-model"></a>Основные сведения о структуре модели кластеризации  
 ...
 ![Структура содержимого моделей для кластеризации](../../analysis-services/data-mining/media/modelcontentstructure-clust.gif "структура содержимого моделей для кластеризации")  
