---
title: "Технический справочник по алгоритму временных рядов (Майкрософт) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  - "ARTXP"
  - "HISTORICAL_MODEL_GAP, параметр"
  - "AUTO_DETECT_PERIODICITY, параметр"
  - "алгоритмы временных рядов [службы Analysis Services]"
  - "ARIMA"
  - "INSTABILITY_SENSITIVITY, параметр"
  - "PERIODICITY_HINT, параметр"
  - "MAXIMUM_SERIES_VALUE, параметр"
  - "временные ряды [службы Analysis Services]"
  - "MINIMUM_SUPPORT, параметр"
  - "HISTORIC_MODEL_COUNT, параметр"
  - "FORECAST_METHOD, параметр"
  - "MISSING_VALUE_SUBSTITUTION, параметр"
  - "MINIMUM_SERIES_VALUE, параметр"
  - "COMPLEXITY_PENALTY, параметр"
  - "PREDICTION_SMOOTHING, параметр"
