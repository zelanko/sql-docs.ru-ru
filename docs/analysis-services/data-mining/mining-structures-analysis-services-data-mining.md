---
title: "Структуры интеллектуального анализа данных (службы Analysis Services — интеллектуальный анализ данных) | Microsoft Docs"
ms.custom: ""
ms.date: "03/13/2017"
...
helpviewer_keywords: 
  ...
  - "структуры интеллектуального анализа данных [службы Analysis Services], о структурах интеллектуального анализа данных"
  - "структуры интеллектуального анализа данных [службы Analysis Services]"
  - "интеллектуальный анализ данных [службы Analysis Services], структура"
  - "службы Analysis Services, объекты интеллектуального анализа данных"
  - "интеллектуальный анализ данных [службы Analysis Services], модели"
  - "алгоритмы [интеллектуальный анализ данных]"
  - "интеллектуальный анализ данных [службы Analysis Services], объекты"
  - "модели интеллектуального анализа данных [службы Analysis Services]"
  - "модели интеллектуального анализа данных [службы Analysis Services], о моделях интеллектуального анализа данных"
...
### Просмотр структур интеллектуального анализа данных  
 ...
 Инструкция `SELECT * FROM <model>.CASES` возвращает те же столбцы, но только для вариантов в этой определенной модели. Дополнительные сведения см. в разделе [SELECT FROM &#60;структура&#62;.CASES](../Topic/SELECT%20FROM%20%3Cstructure%3E.CASES.md) и [SELECT FROM &#60;модель&#62;.CASES (расширения интеллектуального анализа данных)](../Topic/SELECT%20FROM%20%3Cmodel%3E.CASES%20\(DMX\).md).  
...
|Работа со структурами интеллектуального анализа данных, основанными на кубах OLAP|[создать новую структуру интеллектуального анализа OLAP](../../analysis-services/data-mining/create-a-new-olap-mining-structure.md)<br /><br /> [отфильтровать исходный куб для структуры интеллектуального анализа данных](../Topic/Filter%20the%20Source%20Cube%20for%20a%20Mining%20Structure.md)|  
