...
##  <a name="bkmk_RelMD"></a> Реляционные и многомерные решения  
 Решения интеллектуального анализа данных может быть основано либо на многомерных данных — то есть существующего куба- или Excel на чисто реляционных данных, таких как таблицы и представления в хранилище данных, или текстовые файлы, книги или других внешних источников данных.  
...
## <a name="see-also"></a>См. также  
 [Учебники по интеллектуальному анализу данных (службы Analysis Services)](../../analysis-services/data-mining/data-mining-tutorials-analysis-services.md)  
