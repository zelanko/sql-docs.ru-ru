---
title: 'Дополнительное занятие для учебника по Analysis Services: динамическая безопасность | Документация Майкрософт'
ms.date: 05/08/2018
ms.prod: sql
