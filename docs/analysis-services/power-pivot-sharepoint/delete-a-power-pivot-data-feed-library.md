---
title: "Удаление библиотеки каналов данных Power Pivot | Документы Microsoft"
ms.custom: 
ms.date: 03/01/2017
...
[!INCLUDE[ssas-appliesto-sqlas](../../includes/ssas-appliesto-sqlas.md)]Необходимо быть владельцем сайта для удаления библиотеки каналов данных. Если в библиотеке содержатся элементы, они будут удалены вместе с библиотекой.  
  
 Для удаления библиотеки каналов данных необходимо знать ее имя.  
  
### <a name="delete-a-data-feed-library"></a>Удаление библиотеки каналов данных  
