---
title: "Справочник по параметрам конфигурации (Power Pivot для SharePoint) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
---
# Справочник по параметрам конфигурации (Power Pivot для SharePoint)
...
|Название|По умолчанию|Допустимые значения|Description|  
|----------|-------------|------------------|-----------------|  
