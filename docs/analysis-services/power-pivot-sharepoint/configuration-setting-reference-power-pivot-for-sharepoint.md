---
title: (Power Pivot для SharePoint) Справочник по параметрам конфигурации | Документация Майкрософт
ms.date: 05/02/2018
ms.prod: sql
...
|Name|Значение по умолчанию|Допустимые значения|Описание|  
|----------|-------------|------------------|-----------------|  
