---
title: Настройка или восстановление Power Pivot для SharePoint 2013 | Документация Майкрософт
ms.date: 05/02/2018
ms.prod: sql
...
|**Создание приложения службы [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)]**|Имя приложения службы|Значение по умолчанию|[!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] . Именем по умолчанию является **По умолчанию [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] Service Application**. В средстве можно указать другое значение.|  
...
||URL|По умолчанию (при необходимости)|Средство создает URL-адрес на основании имени сервера с использованием соглашений об именах файлов, принятых в SharePoint.|  
...
|**Развертывание решения веб-приложения**|URL|По умолчанию (при необходимости)|URL-адрес по умолчанию берется из веб-приложения по умолчанию.|  
...
||Passphrase|Вводимые пользователем данные|Для шифрования данных используется главный ключ. По умолчанию для формирования ключа используется та же парольная фраза, с помощью которой выполняется подготовка новых серверов в ферме. Парольную фразу по умолчанию можно заменить на уникальную парольную фразу.|  
...
## <a name="verify-the-configuration"></a>Проверка конфигурации  
 См. в разделе «Проверка [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] конфигурации» раздела [Настройка Power Pivot и развертывание решений &#40;SharePoint 2013&#41;](../../analysis-services/instances/install-windows/configure-power-pivot-and-deploy-solutions-sharepoint-2013.md).  
...
1.  На сайте SharePoint 2013, щелкните значок "Параметры" ![параметры SharePoint](../../analysis-services/media/as-sharepoint2013-settings-gear.gif "параметры SharePoint") и нажмите кнопку **параметры сайта**.  
