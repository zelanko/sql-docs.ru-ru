---
title: Power Pivot потоков данных | Документация Майкрософт
ms.date: 05/02/2018
ms.prod: sql
...
## <a name="related-tasks"></a>Связанные задачи  
 [Создание или настройка библиотеки веб-каналов данных (PowerPivot для SharePoint)](../../analysis-services/power-pivot-sharepoint/create-or-customize-a-data-feed-library-power-pivot-for-sharepoint.md)  
