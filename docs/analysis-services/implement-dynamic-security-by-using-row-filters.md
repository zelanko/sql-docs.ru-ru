---
title: "Реализация динамической безопасности с помощью фильтров строк | Microsoft Docs"
ms.custom: ""
ms.date: "02/27/2017"
...
2.  Скопируйте следующую таблицу, включая строку заголовка, и вставьте ее в электронную таблицу.  
    ...
    |---------------|----------------------|--------------|-------------|------------|  
    |1|2|<user first name>|<user last name>|\<домен\имя_пользователя>|  
    |1|3|<user first name>|<user last name>|\<домен\имя_пользователя>|  
    |2|4|<user first name>|<user last name>|\<домен\имя_пользователя>|  
    |3|5|<user first name>|<user last name>|\<домен\имя_пользователя>|  
...
4.  Сохраните лист с именем **Выборка сотрудников**.  
...
7.  В диалоговом окне **Просмотр вставки** в поле **Имя таблицы** введите **Безопасность сотрудников**.  
...
8.  Для таблицы **Безопасность сотрудников** введите приведенную ниже формулу в столбце **Фильтр DAX**.  
