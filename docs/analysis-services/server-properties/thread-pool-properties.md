---
title: "Свойства пула потоков | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "reference"
helpviewer_keywords: 
  - "PriorityRatio, свойство"
  - "потоки [службы Analysis Services]"
  - "MinThreads, свойство"
  - "NumThreads, свойство"
  - "MaxThreads, свойство"
...
|Название|Тип|Description|По умолчанию|Руководство|  
|----------|----------|-----------------|-------------|--------------|  
...
##  <a name="bkmk_groupaffinity"></a> Установите свойство GroupAffinity, чтобы связать потоки с ЦП в группе процессоров  
...
##  <a name="bkmk_pernumanode"></a> Установите свойство PerNumaNode, чтобы связать потоки ввода-вывода с ЦП в узле NUMA  
 ...
 **Задание PerNumaNode=0**  
 ...
 ![Соответствие NUMA, процессора и пула потоков](../../analysis-services/server-properties/media/ssas-threadpool-numaex0.PNG "Соответствие NUMA, процессора и пула потоков")  
 ...
 **Задание PerNumaNode=1**  
 ...
 ![Соответствие NUMA, процессора и пула потоков](../../analysis-services/server-properties/media/ssas-threadpool-numaex1.PNG "Соответствие NUMA, процессора и пула потоков")  
 ...
 **Задание PerNumaNode=2**  
 ...
 ![Соответствие NUMA, процессора и пула потоков](../../analysis-services/server-properties/media/ssas-threadpool-numaex2.PNG "Соответствие NUMA, процессора и пула потоков")  
