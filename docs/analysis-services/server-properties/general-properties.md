---
title: Общие свойства Analysis Services | Документация Майкрософт
ms.date: 07/24/2019
ms.prod: sql
...
[!INCLUDE[ssas-appliesto-sqlas-all-aas](../../includes/ssas-appliesto-sqlas-all-aas.md)]
 ...
 Эти свойства применяются к многомерному и табличному режиму сервера, если не указано иное.  
...
**Клиенткачерефрешполици** Для табличных моделей в службах SSAS и Azure Analysis Services это свойство переопределяет запланированный параметр **обновления кэша** для всех Power BI наборов данных. Все отчеты о реальном подключении будут наблюдать за параметрами уровня сервера независимо от настроек уровня набора данных или рабочей области, в которой они находятся.

Значение этого свойства по умолчанию равно-1, что позволяет обновлять кэш в фоновом режиме, как указано в параметре запланированного обновления кэша для набора данных. Чтобы запретить все обновления фонового кэша, укажите ноль (0).
