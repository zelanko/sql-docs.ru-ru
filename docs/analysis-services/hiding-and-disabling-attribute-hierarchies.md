---
title: "Скрытие и отключение иерархий атрибутов | Microsoft Docs"
ms.custom: ""
ms.date: "02/27/2017"
...
[Сортировка элементов атрибута по вторичному атрибуту](../analysis-services/sorting-attribute-members-based-on-a-secondary-attribute.md)  
