---
title: "Определение секций в моделях DirectQuery (табличные службы SSAS) | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "03/01/2017"
...
---
# Определение секций в моделях DirectQuery (табличные службы SSAS)
