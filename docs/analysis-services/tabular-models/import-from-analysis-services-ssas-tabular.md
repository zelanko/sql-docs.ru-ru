---
title: "Импорт из служб Analysis Services (табличные службы SSAS) | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
---
# Импорт из служб Analysis Services (табличные службы SSAS)
...
## Создание новой модели путем импорта метаданных из существующей модели в службах Analysis Services  
...
#### Создание новой модели путем импорта метаданных из существующей модели  
