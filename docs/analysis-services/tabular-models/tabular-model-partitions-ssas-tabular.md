---
title: Службы Analysis Services табличной модели секции | Документация Майкрософт
ms.date: 05/07/2018
ms.prod: sql
...
|SalesOld|Все финансовые годы перед последними десятью финансовыми годами.|  
 ...
 При переходе к 2012 финансовому году, в таблице Sales добавляется новая секция Sales2012. Затем секцию Sales2011 можно объединить с секцией Sales2010-2001 и переименовать новую секцию в Sales2011-2002. Данные за финансовый год 2001 удаляются из секции Sales2011-2002 и перемещаются в секцию SalesOld. Затем все секции обрабатываются для отражения изменений.  
  
 Как реализовать стратегию секционирования для табличных моделей организации во многом будет зависеть от требований к обработке конкретной модели и доступных ресурсов.  
