---
title: "Настройка моделирования данных по умолчанию и свойств развертывания (табличные службы SSAS) | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
---
# Настройка моделирования данных по умолчанию и свойств развертывания (табличные службы SSAS)
...
#### Настройка свойства уровня совместимости по умолчанию для новых проектов модели  
...
#### Настройка параметров свойства сервера развертывания по умолчанию для новых проектов модели  
