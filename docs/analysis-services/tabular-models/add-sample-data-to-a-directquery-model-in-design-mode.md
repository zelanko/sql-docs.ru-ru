---
title: "Добавление демонстрационных данных в модель DirectQuery в режиме конструктора | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
---
# Добавление демонстрационных данных в модель DirectQuery в режиме конструктора
...
2.  Выберите меню **Таблица** > **Свойства**, чтобы открыть диалоговое окно "Управление секциями".  
    ...
    Обратите внимание на то, что секция по умолчанию называется **(Direct Query) \<имя_таблицы>**. Это полное представление данных. Не удаляйте эту секцию. Она будет использоваться при развертывании модели.  
