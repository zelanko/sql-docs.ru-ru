---
title: "Импорт из потока данных (табличные службы SSAS) | Microsoft Docs"
ms.custom: ""
ms.date: "03/23/2017"
...
manager: "erikre"
---
# Импорт из потока данных (табличные службы SSAS)
...
#### Импорт данных из набора данных Azure DataMarket  
...
#### Импорт данных из открытых или корпоративных веб-каналов данных  
...
#### Импорт каналов данных из списка SharePoint  
...
4.  В поле «URL-адрес потока данных» введите адрес службы списка данных, заменив местозаполнитель \<имя_сервера> реальным именем сервера SharePoint:  
...
#### Импорт данных отчета из опубликованного отчета служб Reporting Services  
