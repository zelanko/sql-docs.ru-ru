---
title: Совместимость формул в режиме Analysis Services DirectQuery | Документация Майкрософт
ms.date: 05/07/2018
ms.prod: sql
