---
title: Службы Analysis Services табличной модели, таблицы и столбцы | Документация Майкрософт
ms.date: 05/07/2018
ms.prod: sql
...
|[Скрытие или закрепление столбцов](../../analysis-services/tabular-models/hide-or-freeze-columns-ssas-tabular.md)|Описывает, как скрыть столбцы, которые не нужно отображать и способ сохранения область модели видимой при прокрутке к другой области модели путем закрепления (блокировки) конкретных столбцов в одной области.|  
