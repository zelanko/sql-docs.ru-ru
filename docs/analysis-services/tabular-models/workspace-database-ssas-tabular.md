---
title: База данных рабочей области в SQL Server Data Tools | Документы Microsoft
ms.custom: ''
ms.date: 03/30/2018
