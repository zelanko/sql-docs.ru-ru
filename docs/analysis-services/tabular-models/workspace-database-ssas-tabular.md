...
|**База данных рабочей области**|Name|Имя базы данных рабочей области. Это свойство невозможно изменить, если для параметра **Режим интегрированной рабочей области** задано значение **True**.|  
