---
title: "Импорт из Power Pivot (табличные службы SSAS) | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
---
# Импорт из Power Pivot (табличные службы SSAS)
...
## Создание новой табличной модели из файла Power Pivot для Excel  
...
#### Создание нового проекта табличной модели из файла Power Pivot для Excel  
...
## См. также  
 ...
 [Копирование и вставка данных (табличные службы SSAS)](../../analysis-services/tabular-models/copy-and-paste-data-ssas-tabular.md)  
