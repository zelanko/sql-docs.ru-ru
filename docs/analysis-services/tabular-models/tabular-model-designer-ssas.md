---
title: "Конструктор табличных моделей (службы SSAS) | Microsoft Docs"
ms.date: "03/14/2017"
 ...
 **Табличный проект служб Analysis Services**  
 Этот шаблон можно использовать для создания нового пустого проекта табличной модели. Уровни совместимости указываются при создании проекта. Выберите значение по умолчанию **SQL Server 2016 RTM (1200)**, чтобы использовать все функции, встроенные в [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)].  
 ...
 **Импорт с сервера (табличного)**  
 ...
 Старые модели имеют старые значения уровней совместимости. Уровень совместимости можно обновить до 1200, изменив соответствующее свойство после импорта определения модели.  
...
### Окно просмотра кода  
 Код файла Model.bim можно просмотреть, щелкнув файл правой кнопкой мыши в обозревателе решений и выбрав пункт **Просмотреть код**. Для табличных моделей на уровне совместимости 1200 определение модели представляется в формате JSON.  
...
### Обозреватель табличных моделей
  Обозреватель табличных моделей, впервые появившийся в выпуске [SQL Server Data Tools](https://msdn.microsoft.com/mt186501) за август 2016 г. (14.0.60812.0), позволяет просматривать объекты метаданных в табличных моделях 1200.
