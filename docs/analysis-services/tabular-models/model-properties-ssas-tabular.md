---
title: Свойства модели | Документы Microsoft
ms.date: 05/07/2018
ms.prod: sql
...
|**Направление фильтрации по умолчанию**|Однонаправленная|Определяет направление фильтра по умолчанию для новых отношений.| 
