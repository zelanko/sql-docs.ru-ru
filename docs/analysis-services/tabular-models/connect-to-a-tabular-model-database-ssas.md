---
title: "Соединение с табличным шаблоном баз данных (SSAS) | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
#### Предоставление административного доступа на сервере  
...
5.  Выберите базу данных. При правильном выборе появится один куб **Модель** для базы данных. Нажмите кнопку **Далее** , а затем кнопку **Готово**.  
 ...
 После успешного соединения данные можно будет использовать для создания сводной таблицы или сводной диаграммы. Дополнительные сведения см. в разделе [Анализ в Excel (табличные службы SSAS)](../../analysis-services/tabular-models/analyze-in-excel-ssas-tabular.md).  
 ...
 **При попытке установить соединение с внешним источником данных произошла ошибка. Следующие соединения не удалось обновить: \<имя модели> Sandbox**  
