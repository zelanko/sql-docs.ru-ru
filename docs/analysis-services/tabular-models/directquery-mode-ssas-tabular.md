---
title: "Режим DirectQuery (табличные службы SSAS) | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "03/01/2017"
...
# Режим DirectQuery (табличные службы SSAS)
  В этом разделе описывается *режим DirectQuery* для табличных моделей служб Analysis Services на уровне совместимости 1200. Режим DirectQuery можно включить для моделей, разрабатываемых в среде SSDT. Для уже развернутых табличных моделей можно переключиться в режим DirectQuery в среде SSMS. Перед выбором режима DirectQuery важно понять его преимущества и ограничения.
...
## Поддерживаемые источники данных для DirectQuery
Табличные модели DirectQuery при уровне совместимости 1200 совместимы с указанными далее источниками данных и поставщиками.
...
[Совместимость формул DAX в режиме DirectQuery](../../analysis-services/tabular-models/dax-formula-compatibility-in-directquery-mode-ssas-2016.md)
