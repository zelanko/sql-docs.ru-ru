---
title: Изменение сопоставлений фильтров строк, столбцов и таблицу табличной модели служб Analysis Services | Документация Майкрософт
ms.date: 05/07/2018
ms.prod: sql
...
ms.locfileid: "53071761"
---
# <a name="change-table-column-or-row-filter-mappings"></a>Изменение сопоставлений фильтров таблиц, столбцов и строк 
[!INCLUDE[ssas-appliesto-sqlas-aas](../../includes/ssas-appliesto-sqlas-aas.md)]
  В этой статье описывается изменение таблицы, столбца или сопоставления фильтров строк с помощью **изменение свойств таблицы** диалогового окна в [!INCLUDE[ssBIDevStudio](../../includes/ssbidevstudio-md.md)].  
