...
# [Переводы ](translations-in-tabular-models-analysis-services.md)
# [Роли](roles-ssas-tabular.md)
# [Иерархии](hierarchies-ssas-tabular.md)
# [Создание ролей и управление ими](create-and-manage-roles-ssas-tabular.md)
# [Вычисляемые столбцы](calculated-columns-ssas-tabular.md)
...
# [Настройка набора полей по умолчанию для отчетов Power View](configure-default-field-set-for-power-view-reports-ssas-tabular.md)
...
# [Создание вычисляемого столбца](create-a-calculated-column-ssas-tabular.md)
...
# [Настройка свойств работы таблицы для отчетов Power View](configure-table-behavior-properties-for-power-view-reports-ssas-tabular.md)
...
# [Создание и управление секциями в базе данных рабочей области](create-and-manage-partitions-in-the-workspace-database-ssas-tabular.md)
