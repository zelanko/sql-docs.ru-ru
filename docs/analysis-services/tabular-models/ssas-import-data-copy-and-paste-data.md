---
title: "Копирование и вставка данных (табличные службы SSAS) | Документы Microsoft"
ms.custom: 
ms.date: 05/22/2017
...
---
# <a name="import-data---copy-and-paste-data"></a>Импорт данных — копирование и вставка данных
