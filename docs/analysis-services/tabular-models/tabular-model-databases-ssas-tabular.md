---
title: Службы Analysis Services табличной модели баз данных | Документация Майкрософт
ms.date: 05/07/2018
ms.prod: sql
...
ms.locfileid: "53072251"
---
# <a name="manage-deployed-tabular-model-databases"></a>Управление базами данных развернутой табличной модели
...
## <a name="in-this-section"></a>в этом разделе  
 ...
 [Роли табличных моделей](../../analysis-services/tabular-models/tabular-model-roles-ssas-tabular.md)  
 ...
 [Восстановление из Power Pivot](../../analysis-services/tabular-models/restore-from-power-pivot.md)  
