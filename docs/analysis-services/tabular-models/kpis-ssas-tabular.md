...
[!INCLUDE[ssas-appliesto-sqlas-aas](../../includes/ssas-appliesto-sqlas-aas.md)]Объект *ключевого показателя Эффективности* (ключевой показатель эффективности,) в табличной модели, которые используются для оценки производительности значения, определенного *базы* измерения, от *целевой* значения, также определенного мера или абсолютным значением. В этом разделе автор табличной модели может почерпнуть основные сведения о ключевых показателях эффективности в табличной модели.  
