...
-   Некоторые символы нельзя использовать в именах столбцов. Дополнительные сведения см. в статье "Требования к именованию" [справочника по синтаксису DAX](/dax/dax-syntax-reference).  
