---
title: "Перспективы (табличные службы SSAS) | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
|Раздел|Description|  
|-----------|-----------------|  
|[Создание перспектив и управление ими (табличные службы SSAS)](../../analysis-services/tabular-models/create-and-manage-perspectives-ssas-tabular.md)|Содержит описание порядка создания и управления перспективами с помощью диалогового окна «Перспективы» в конструкторе моделей.|  
