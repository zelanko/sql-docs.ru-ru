---
title: Создание иерархий и управление ими в табличных моделях служб Analysis Services | Документация Майкрософт
ms.date: 05/07/2018
ms.prod: sql
...
[!INCLUDE[ssas-appliesto-sqlas-aas](../../includes/ssas-appliesto-sqlas-aas.md)]
 ...
 Эта статья содержит следующие задачи:  
...
2.  Введите имя иерархии.  
 ...
 Дополнительные столбцы можно перетаскивать в родительский уровень иерархии, содержащий копии столбцов. Перетащите дочерний уровень в то место, где он должен появиться в иерархии.  
