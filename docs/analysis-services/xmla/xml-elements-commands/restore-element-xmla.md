...
|Реляционный OLAP (ROLAP)|Метаданные|  
 ...
 Во время **восстановить** команды на устанавливается монопольная блокировка [!INCLUDE[ssASnoversion](../../../includes/ssasnoversion-md.md)] базы данных, указанной в **DatabaseName** элемент. Блокировка снимается после выполнения команды **Restore** .  
