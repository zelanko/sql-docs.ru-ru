---
title: Элемент Description (XML для Аналитики) | Документы Microsoft
ms.custom: ''
ms.date: 03/04/2017
...
---
# <a name="description-element-xmla"></a>Элемент Description (XML для аналитики)
[!INCLUDE[ssas-appliesto-sqlas-aas](../../../includes/ssas-appliesto-sqlas-aas.md)]Содержит описание родительского [ошибка](../../../analysis-services/xmla/xml-elements-properties/error-element-xmla.md) элемента.  
