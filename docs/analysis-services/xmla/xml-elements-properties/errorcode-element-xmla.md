...
[!INCLUDE[ssas-appliesto-sqlas-aas](../../../includes/ssas-appliesto-sqlas-aas.md)]Содержит числовой код возврата родительского [ошибка](../../../analysis-services/xmla/xml-elements-properties/error-element-xmla.md) элемента.  
