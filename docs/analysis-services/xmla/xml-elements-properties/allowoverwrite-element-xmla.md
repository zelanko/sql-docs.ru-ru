...
ms.locfileid: "37973000"
---
# <a name="allowoverwrite-element-xmla"></a>Элемент AllowOverwrite (XML для аналитики)
[!INCLUDE[ssas-appliesto-sqlas-aas](../../../includes/ssas-appliesto-sqlas-aas.md)]
  Определяет ли родительский [резервного копирования](../../../analysis-services/xmla/xml-elements-commands/backup-element-xmla.md) или [восстановить](../../../analysis-services/xmla/xml-elements-commands/restore-element-xmla.md) предпринимается попытка перезаписать целевой файл или базу данных.  
...
## <a name="remarks"></a>Примечания  
 ...
 Для **восстановить** элементов, **AllowOverwrite** элемент определяет, может ли команда Перезаписать базу данных служб Analysis Services, указанный в **DatabaseName** элемент.  
