 ...
 **Привязка** элементы определяют привязки вне строки, отличающиеся от источников данных и представления источников данных, для [!INCLUDE[ssASnoversion](../../../includes/ssasnoversion-md.md)] объекты обрабатываться **пакета** или **процесс** команды. Дополнительные сведения об обработке объектов см. в разделе [обработка объектов &#40;XMLA&#41;](../../../analysis-services/multidimensional-models-scripting-language-assl-xmla/processing-objects-xmla.md).  
  
 Дополнительные сведения о привязках вне строки, см. в разделе [источники данных и привязки &#40;многомерных моделей SSAS&#41;](../../../analysis-services/multidimensional-models/data-sources-and-bindings-ssas-multidimensional.md).  
