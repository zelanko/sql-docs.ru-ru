...
-   Последняя версия SQL Server Management Studio. [Получить последнюю версию](../../ssms/download-sql-server-management-studio-ssms.md). 
...
|[Занятие 3. Пометить как таблицу дат](lesson-3-mark-as-date-table.md)|3 минуты|  
|[Занятие 4. Создание связей](lesson-4-create-relationships.md)|10 минут.|  
|[Занятие 5. Создание вычисляемых столбцов](lesson-5-create-calculated-columns.md)|15 минут|
|[Занятие 6. Создание мер](lesson-6-create-measures.md)|30 минут|  
|[Занятие 7. Создание ключевых показателей эффективности](lesson-7-create-key-performance-indicators.md)|15 минут|  
|[Занятие 8. Создание перспектив](lesson-8-create-perspectives.md)|5 минут|  
|[Занятие 9. Создание иерархий](lesson-9-create-hierarchies.md)|20 минут|  
|[Занятие 10. Создание секций](lesson-10-create-partitions.md)|15 минут|  
|[Занятие 11. Создание ролей](lesson-11-create-roles.md)|15 минут|  
|[Занятие 12. Анализ в Excel](lesson-12-analyze-in-excel.md)|20 минут| 
|[Занятие 13. Развертывание](lesson-13-deploy.md)|5 минут|  
  
## <a name="supplemental-lessons"></a>Дополнительные занятия  
Этот учебник также включает дополнительные занятия. Ознакомление с содержащимися здесь разделами не требуется для прохождения этого учебника, но может оказаться полезным для лучшего освоения функций для работы с расширенной табличной моделью.  
  
|Занятие|Предположительное время выполнения|  
|----------|------------------------------|  
|[Реализация динамической безопасности с помощью фильтров строк](supplemental-lesson-implement-dynamic-security-by-using-row-filters.md)|30 минут|  
