...
Этот раздел является частью учебника по табличному моделированию, который необходимо изучать по порядку. Перед выполнением задач на этом занятии, необходимо завершить предыдущее занятие: [Занятие 8. Создание перспектив](lesson-8-create-perspectives.md).  
...
5.  Щелкните правой кнопкой мыши **ModelName** столбец > **добавьте иерархию**, а затем выберите **категории**. Сделайте то же самое **EnglishProductName**. Переименовать эти столбцы в иерархии **модели** и **продукта**.  
    ...
    ![как табличные lesson9-категории](media/as-tabular-lesson9-category.png)
...
Перейдите к следующему занятию: [Занятие 10. Создание секций](lesson-10-create-partitions.md). 
