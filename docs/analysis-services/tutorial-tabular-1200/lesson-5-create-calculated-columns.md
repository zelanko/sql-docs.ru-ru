...
ms.locfileid: "65404186"
---
# <a name="lesson-5-create-calculated-columns"></a>Занятие 5.: Создание вычисляемых столбцов
[!INCLUDE[ssas-appliesto-sql2016-later-aas](../../includes/ssas-appliesto-sql2016-later-aas.md)]

На этом занятии мы создадим новые данные в модели путем добавления вычисляемых столбцов. Вычисляемый столбец основывается на данных, которые уже существуют в модели. Дополнительные сведения см. в разделе [Calculated Columns](../tabular-models/ssas-calculated-columns.md).  
...
Этот раздел является частью учебника по табличному моделированию, который необходимо изучать по порядку. Перед выполнением задач на этом занятии, необходимо завершить предыдущее занятие: [Занятие 4. Создание связей](lesson-4-create-relationships.md). 
...
5.  Переименуйте этот столбец в **MonthCalendar**. 
    ...
    ![как табличных lesson5-newcolumn](media/as-tabular-lesson5-newcolumn.png) 
...
5.  Перетащите столбец между столбцами **SalesAmount** столбца и **TaxAmt** столбца. 
      ...
      ![как табличных lesson5-newmargin](media/as-tabular-lesson5-newmargin.png)
      
    Вычисляемый столбец Margin используется для анализа маржи для каждой продажи.  
  
## <a name="whats-next"></a>Дальнейшие действия
Перейдите к следующему занятию: [Занятие 6. Создание мер](lesson-6-create-measures.md).
