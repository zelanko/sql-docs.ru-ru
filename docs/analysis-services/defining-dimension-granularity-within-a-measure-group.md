---
title: "Определение степени гранулярности измерения в группе мер | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
8.  В фильтре установите флажок «Выбрать все», чтобы сбросить все выбранные элементы, а затем выберите только **North America**.  
    ...
    ![Панель «Фильтр» для выбора North America](../analysis-services/media/l5-granularity-1b.png "Панель «Фильтр» для выбора North America")  
...
11. Внутри сводной таблицы щелкните стрелку вниз рядом с названием «Метки строк». Снимите флажки для всех годов, кроме **FY 2008**.  
    ...
    ![Значения Sales Amount Quota](../analysis-services/media/l5-granularity-3.png "Значения Sales Amount Quota")  
...
8.  Последовательно разверните элементы **FY 2008**, **H1 FY 2008**и **Q1 FY 2008**.  
    ...
    ![Группа мер «Квота продаж», правильно разнесенная по измерениям](../analysis-services/media/l5-granularity-7.gif "Группа мер «Квота продаж», правильно разнесенная по измерениям")  
