---
title: "Определение ссылочной связи | Microsoft Docs"
ms.custom: ""
ms.date: "03/04/2017"
...
3.  Из измерения **География** на панели метаданных перетащите определяемую пользователем иерархию **География** в область **Перетащите сюда поля строк** на панели данных.  
    ...
    ![Измеренная мера Reseller Sales-Sales Amount](../analysis-services/media/l5-referencedrelationship-1.gif "Измеренная мера Reseller Sales-Sales Amount")  
...
8.  Нажмите кнопку с многоточием (**…**) в ячейке **Полное имя** на пересечении измерения **Заказчик** и группы мер **Продажи через Интернет**.  
    ...
    ![Диалоговое окно «Задание связи»](../analysis-services/media/l5-referencedrelationship-4.gif "Диалоговое окно «Задание связи»")  
...
3.  На панели метаданных разверните элемент **География торгового посредника**, щелкните правой кнопкой мыши пункт **Географии** и выберите команду **Добавить в область строк**.  
    ...
    ![Диалоговое окно «Задание связи»](../analysis-services/media/l5-referencedrelationship-5.gif "Диалоговое окно «Задание связи»")  
