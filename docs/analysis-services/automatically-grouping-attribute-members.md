---
title: "Автоматическое группирование элементов атрибута | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
После выбора метода группирования необходимо указать количество групп, используя свойство **DiscretizationBucketCount** . Дополнительные сведения см. в разделе [Группирование элементов атрибутов (дискретизация)](../analysis-services/multidimensional-models/group-attribute-members-discretization.md).  
...
9. В списке полей разверните измерение **Сотрудник** , затем узел **Организация**, а затем перетащите **Часы отсутствия по болезни** в область **Метки столбцов**.  
    ...
    ![Таблица Sales, разбитая на измерения по количеству часов отпуска сотрудников по болезни](../analysis-services/media/l4-discretizationmethod-2.gif "Таблица Sales, разбитая на измерения по количеству часов отпуска сотрудников по болезни")  
...
## См. также:  
[Группирование элементов атрибутов (дискретизация)](../analysis-services/multidimensional-models/group-attribute-members-discretization.md)  
