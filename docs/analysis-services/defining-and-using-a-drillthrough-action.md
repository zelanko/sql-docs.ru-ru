---
title: "Определение и использование действия детализации | Microsoft Docs"
ms.custom: ""
ms.date: "03/04/2017"
...
6.  В списке **Возвращаемые столбцы** установите флажки **Описание элемента** и **Номер заказа**, а затем нажмите кнопку **ОК**. На следующем рисунке показано, как выглядит шаблон действия в этот момент времени данной процедуры.  
    ...
    ![Поле «Столбцы детализации»](../analysis-services/media/l8-action3.gif "Поле «Столбцы детализации»")  
  
7.  Разверните поле **Дополнительные свойства**, как показано на рисунке ниже.  
  
    ![Поле «Дополнительные свойства»](../analysis-services/media/l8-action4.gif "Поле «Дополнительные свойства»")  
...
9. В поле **Заголовок** введите **Детализация сведений о заказе**.  
    ...
    ![Поле «Дополнительные свойства»](../analysis-services/media/l8-action5.gif "Поле «Дополнительные свойства»")  
...
10. В поле **Столбцы детализации** установите флажки, добавив в список **Возвращаемые столбцы** перечисленные ниже столбцы, и нажмите кнопку **ОК**.  
    ...
    ![Поле «Столбцы детализации»](../analysis-services/media/l8-action7.gif "Поле «Столбцы детализации»")  
...
[Определение связи фактов](../analysis-services/defining-a-fact-relationship.md)  
