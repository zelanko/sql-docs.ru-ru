---
title: "Определение представления источников данных | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
### Определение нового представления источников данных  
...
8.  Нажмите кнопку **Развернуть**, чтобы развернуть окно среды разработки [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[vsprvs](../includes/vsprvs-md.md)].  
...
[Изменение имен таблиц по умолчанию](../analysis-services/modifying-default-table-names.md)  
