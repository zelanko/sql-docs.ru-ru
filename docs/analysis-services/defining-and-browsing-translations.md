---
title: "Определение и просмотр переводов | Microsoft Docs"
ms.custom: ""
ms.date: "03/04/2017"
...
1.  Перейдите в конструктор кубов к кубу учебника по [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] и откройте вкладку **Переводы**.  
    ...
    ![Язык по умолчанию на вкладке «Переводы»](../analysis-services/media/l9-translations-5.gif "Язык по умолчанию на вкладке «Переводы»")  
...
5.  На панели инструментов выберите в списке **Язык** значение **испанский (Испания)**.  
    ...
    ![Повторно заполненная панель «Метаданные»](../analysis-services/media/l9-translations-6.png "Повторно заполненная панель «Метаданные»")  
...
9. На панели метаданных щелкните правой кнопкой мыши **Mes del Ano** и выберите команду **Добавить в запрос**.  
    ...
    ![Названия месяцев по-испански на панели даты](../analysis-services/media/l9-translations-7.gif "Названия месяцев по-испански на панели даты")  
