---
title: "Преобразования валюты (службы Analysis Services) | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "конвертации нескольких валют"
  - "денежные данные [SQL Server]"
  - "валюта [службы Analysis Services]"
  - "конвертация валюты"
  - "конвертации валют «один ко многим»"
  - "конвертации валют «многие ко многим» [службы Analysis Services]"
  - "конвертации валют «многие к одному» [службы Analysis Services]"
...
---
# Преобразования валюты (службы Analysis Services)
...
## Терминология конвертации валют  
...
## Определение нескольких конвертаций валют  
...
### Идентификация конвертаций валют  
