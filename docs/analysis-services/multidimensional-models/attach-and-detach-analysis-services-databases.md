---
title: "Подключение и отключение баз данных служб Analysis Services | Microsoft Docs"
ms.custom: ""
ms.date: "03/06/2017"
...
helpviewer_keywords: 
  - "базы данных [службы Analysis Services], подключение"
  - "базы данных [службы Analysis Services], отключение"
