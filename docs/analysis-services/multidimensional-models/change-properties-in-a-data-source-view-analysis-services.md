...
[!INCLUDE[ssas-appliesto-sqlas](../../includes/ssas-appliesto-sqlas.md)]После определения представления источников данных с помощью мастера представлений источников данных и добавления таблиц, представлений, именованных вычислений и просмотреть именованные запросы к источнику данных, может потребоваться изменить свойства, связанные с:  
