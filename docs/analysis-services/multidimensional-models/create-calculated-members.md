...
[!INCLUDE[ssas-appliesto-sqlas](../../includes/ssas-appliesto-sqlas.md)]
 ...
 Определения вычисляемых элементов хранятся, но их значения существуют только в памяти. В приведенном выше примере значения в евро, отображаются для конечных пользователей, но не хранятся как данные куба.  
