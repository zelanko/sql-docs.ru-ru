---
title: "Объединение секций в службах Analysis Services (SSAS — многомерные данные) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "секции [службы Analysis Services], слияние"
  - "слияние секций [службы Analysis Services]"
...
2.  Щелкните **Слияние секций**, чтобы открыть диалоговое окно **Слияние секций \<имя секции>**.  
