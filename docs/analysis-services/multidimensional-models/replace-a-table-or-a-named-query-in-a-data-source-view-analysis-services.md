---
title: "Замена таблицы или именованного запроса в представлении источника данных (службы Analysis Services) | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
helpviewer_keywords: 
  ...
  - "именованные запросы [службы Analysis Services], замена таблиц"
  - "таблицы [службы Analysis Services], представления источников данных"
  - "секции [службы Analysis Services], именованные запросы"
