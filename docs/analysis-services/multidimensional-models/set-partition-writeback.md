---
title: "Настройка обратной записи секции | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "секции, доступные для записи [службы Analysis Services]"
  - "секции [службы Analysis Services], обратная запись"
  - "секции [службы Analysis Services], доступные для записи"
  - "обратная запись [службы Analysis Services], секции"
...
## Обзор данных обратной записи в секции  
...
## Удаление данных обратной записи или отключение обратной записи  
...
## Преобразование данных обратной записи в секцию  
...
## См. также  
 [Секции, доступные для записи](../Topic/Write-Enabled%20Partitions.md)   
