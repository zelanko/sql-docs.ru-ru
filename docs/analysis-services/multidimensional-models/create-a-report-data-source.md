---
title: "Создание источника данных отчета | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
## Создание соединения источника данных отчета (RSDS) в многомерной модели  
...
#### Создание RSDS-файла общего источника данных отчета (SharePoint 2010)  
