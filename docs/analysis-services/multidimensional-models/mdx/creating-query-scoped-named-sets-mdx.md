---
title: "Создание именованных наборов с областью действия запроса (многомерные выражения) | Microsoft Docs"
ms.custom: ""
ms.date: "03/23/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "именованные наборы с областью действия запроса [многомерные выражения]"
  - "WITH, ключевое слово"
...
### Использование функций с ключевым словом WITH  
...
## См. также  
 ...
 [Создание именованных наборов с областью действия сеанса (многомерные выражения)](../../../analysis-services/multidimensional-models/mdx/creating-session-scoped-named-sets-mdx.md)  
