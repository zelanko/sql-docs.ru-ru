---
title: "Обратная запись в куб (многомерные выражения) | Microsoft Docs"
ms.custom: ""
ms.date: "03/23/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "обратная запись [службы Analysis Services], кубы"
  - "кубы [службы Analysis Services], изменение"
  - "изменение кубов"
  - "UPDATE CUBE, инструкция"
  - "кубы [службы Analysis Services], обратная запись"
...
## См. также  
 [Изменение данных (многомерные выражения)](../../../analysis-services/multidimensional-models/mdx/modifying-data-mdx.md)  
