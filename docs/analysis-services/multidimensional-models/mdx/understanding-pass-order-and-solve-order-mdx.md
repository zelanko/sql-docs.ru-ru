---
title: "Основные сведения о порядке этапов и порядке вычисления (многомерные выражения) | Microsoft Docs"
ms.custom: ""
ms.date: "03/23/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "порядок вычисления [многомерные выражения]"
  - "порядок вычисления [многомерные выражения]"
  - "SOLVE_ORDER, свойство"
  - "запросы [многомерные выражения], порядок разрешения"
  - "порядки вычисления [многомерные выражения]"
  - "этапы вычисления [многомерные выражения]"
  - "выражения [многомерные выражения], порядок разрешения"
