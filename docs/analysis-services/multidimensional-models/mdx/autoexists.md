---
title: "Автоматическая проверка существования | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "03/16/2017"
...
|**HL Mountain Frame**|**$ 3 365 069,27**|**$ 174,11**|**0,01 %**|  
 ...
 Поведение автоматической проверки существования можно изменить с помощью параметра AUTOEXISTS=[1|2|3] в строке подключения. Сведения об использовании этого параметра см. в разделах [Поддерживаемые свойства XMLA (XMLA)](../Topic/Supported%20XMLA%20Properties%20\(XMLA\).md) и <xref:Microsoft.AnalysisServices.AdomdClient.AdomdConnection.ConnectionString%2A>  
