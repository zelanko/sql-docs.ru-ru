---
title: Определение содержимого оси среза (многомерные Выражения) | Документация Майкрософт
ms.date: 05/02/2018
ms.prod: sql
...
ms.locfileid: "68208738"
---
# <a name="mdx-query-and-slicer-axes---specify-the-contents-of-a-slicer-axis"></a>Запрос многомерных выражений и ось среза — указание содержимого оси среза
