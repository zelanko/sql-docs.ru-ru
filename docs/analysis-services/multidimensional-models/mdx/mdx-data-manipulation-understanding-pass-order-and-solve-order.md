...
ms.locfileid: "68176572"
---
# <a name="mdx-data-manipulation---understanding-pass-order-and-solve-order"></a>Обработка данных многомерных Выражений — Общие сведения о Pass заказа и порядок вычисления
