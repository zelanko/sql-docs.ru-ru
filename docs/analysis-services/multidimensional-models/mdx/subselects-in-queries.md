...
-   Предложение NON EMPTY нельзя использовать в предложении оси, вместо него следует применять выражение функции [NonEmpty (многомерные выражения)](../../../mdx/nonempty-mdx.md).  
