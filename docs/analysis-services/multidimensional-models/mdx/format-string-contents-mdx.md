---
title: "Строка формата FORMAT_STRING (многомерные выражения) | Microsoft Docs"
ms.custom: ""
ms.date: "03/23/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "форматы [Analysis Services], строковые значения"
  - "VALUE, свойство"
  - "форматы [Analysis Services], числовые значения"
  - "FORMATTED_VALUE, свойство"
...
|**ddddd**|Вывод полной даты (включая день, месяц и год), отформатированной в соответствии с системным сокращенным форматом даты.<br /><br /> В Microsoft Windows по умолчанию используется следующий сокращенный формат даты: **д/м/гг**.|  
...
## См. также  
 [Взаимодействие свойств LANGUAGE и FORMAT_STRING для построения свойства FORMATED_VALUE](../../../analysis-services/multidimensional-models/mdx/language-and-format-string-on-formated-value.md)   
