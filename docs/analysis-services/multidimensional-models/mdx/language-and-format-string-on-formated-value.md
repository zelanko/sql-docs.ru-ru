---
title: "Взаимодействие свойств LANGUAGE и FORMAT_STRING для построения свойства FORMATED_VALUE | Microsoft Docs"
ms.custom: ""
ms.date: "03/23/2017"
...
## См. также  
 [Содержание строки FORMAT_STRING (многомерные выражения)](../../../analysis-services/multidimensional-models/mdx/format-string-contents-mdx.md)   
