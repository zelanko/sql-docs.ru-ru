---
title: "Удаленная обработка (службы Analysis Services) | Microsoft Docs"
ms.custom: ""
ms.date: "03/04/2017"
...
---
# Удаленная обработка (службы Analysis Services)
...
## Удаленная обработка по запросу  
...
## Планирование удаленной обработки с помощью службы агента SQL Server  
...
#### Предоставьте учетной записи агента SQL Server разрешения администратора на службы SSAS.  
