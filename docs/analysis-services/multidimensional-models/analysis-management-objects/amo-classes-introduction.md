...
# <a name="amo-classes---introduction"></a>Классы AMO — введение
 ...
 ![Классы, описываемые в разделы по основным понятиям AMO](../../../analysis-services/multidimensional-models/analysis-management-objects/media/amo-reviewedclasses.gif "классы, описываемые в разделы по основным понятиям AMO")  
