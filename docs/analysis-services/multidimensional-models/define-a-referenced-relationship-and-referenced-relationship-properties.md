---
title: "Определение ссылочной связи и свойств ссылочной связи | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "ссылочная связь измерений"
  - "связи [службы Analysis Services], измерения, на которые указывает ссылка"
