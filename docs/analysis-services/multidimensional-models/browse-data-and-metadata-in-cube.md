---
title: "Просмотр данных и метаданных в кубе | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
---
# Просмотр данных и метаданных в кубе
...
-   В столбце **Измерение** области **Фильтр** щелкните элемент **\<Выберите измерение>** и выберите измерение в списке, а затем щелкните элемент **\<Выберите иерархию>** в столбце **Иерархия** и выберите иерархию в списке.  
