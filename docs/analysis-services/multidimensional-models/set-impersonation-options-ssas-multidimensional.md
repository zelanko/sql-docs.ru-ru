---
title: "Задание параметров олицетворения (службы SSAS — многомерные) | Microsoft Docs"
ms.custom: ""
ms.date: "03/13/2017"
...
helpviewer_keywords: 
  - "диалоговое окно «Сведения об олицетворении»"
 ...
 **Использовать указанные имя пользователя и пароль**  
 Выберите этот параметр, чтобы объект [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] использовал данные из учетной записи пользователя Windows для безопасного доступа, заданные в следующем формате: *\<имя домена>***\\***\<имя учетной записи пользователя>*.  
