---
title: "Основные сведения о схемах баз данных | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "мастер формирования схем, схема базы данных"
  - "схема базы данных [службы Analysis Services]"
  - "реляционная схема [службы Analysis Services], схема базы данных"
  - "параметры схемы предметной области [службы Analysis Services]"
  - "параметры схемы промежуточной области [службы Analysis Services]"
  - "ненормализованные схемы"
...
---
# Основные сведения о схемах баз данных
...
## Конвертация типов данных и длины по умолчанию  
