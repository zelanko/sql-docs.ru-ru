---
title: Работа с проектами и базами данных в разработке служб Analysis Services | Документация Майкрософт
ms.date: 05/02/2018
ms.prod: sql
...
ms.locfileid: "62743120"
---
# <a name="work-with-analysis-services-projects-and-databases-in-development"></a>Работа с проектами и базами данных в разработке служб Analysis Services
