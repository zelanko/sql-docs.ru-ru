---
title: "Основные сведения о добавочном создании | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "добавочное создание [службы Analysis Services]"
  - "мастер формирования схем, постепенное создание"
  - "реляционная схема [службы Analysis Services], постепенное создание"
...
## Поддержка изменений источника данных и представления источников данных  
