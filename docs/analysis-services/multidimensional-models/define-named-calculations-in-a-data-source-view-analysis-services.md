---
title: "Определение именованных вычислений в представлении источника данных (службы Analysis Services) | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "изменение именованных вычислений"
  - "представления источников данных [службы Analysis Services], именованные вычисления"
  - "именованные вычисления [службы Analysis Services]"
