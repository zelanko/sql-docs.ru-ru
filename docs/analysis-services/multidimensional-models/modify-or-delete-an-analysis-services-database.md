---
title: "Изменение или удаление базы данных служб Analysis Services | Microsoft Docs"
ms.custom: ""
ms.date: "03/06/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "базы данных [службы Analysis Services], изменение"
  - "удаление баз данных"
  - "удаление баз данных"
  - "удаление баз данных"
  - "базы данных [службы Analysis Services], удаление"
