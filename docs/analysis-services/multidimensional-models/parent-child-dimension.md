---
title: Родитель потомок измерения | Документация Майкрософт
ms.date: 05/02/2018
ms.prod: sql
...
ms.locfileid: "52510211"
---
# <a name="parent-child-dimension"></a>Измерение "родители-потомки"
...
## <a name="dimension-schema"></a>Схема измерения  
 ...
 ![Содержат ссылки на себя соединение в таблице DimOrganization](../../analysis-services/multidimensional-models/media/dimorganization.gif "содержат ссылки на себя соединение в таблице DimOrganization")  
...
## <a name="hierarchies-and-levels"></a>Иерархии и уровни  
 ...
 Иерархии типа «родители-потомки» не создают имена для уровней в иерархии типа «родители-потомки» на основе атрибутов, используемых для создания иерархии. Вместо этого такие измерения создают имена уровней автоматически с помощью выражения: строку шаблона именования можно указать на уровне родительского атрибута, который управляет процессом формирования иерархии атрибута. Дополнительные сведения о задании шаблона имен для родительского атрибута см. в разделе [Атрибуты и иерархии атрибутов](../../analysis-services/multidimensional-models-olap-logical-dimension-objects/attributes-and-attribute-hierarchies.md).  
