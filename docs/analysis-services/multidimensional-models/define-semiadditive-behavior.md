---
title: "Определение полуаддитивного режима | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
helpviewer_keywords: 
  - "полуаддитивные"
  - "расширения бизнес-аналитики [службы Analysis Services], полуаддитивное поведение"
  - "меры [службы Analysis Services], полуаддитивные"
...
## Определить полуаддитивный режим  
 ...
 **Мастер определил измерение счетов «Учетная запись», в которой содержатся полуаддитивные элементы. Сервер будет проводить статистическое вычисление элементов этого измерения согласно полуаддитивному режиму, назначенному каждому типу учетной записи.**  
