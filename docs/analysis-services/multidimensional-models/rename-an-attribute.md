---
title: "переименовать атрибут | Microsoft Docs"
ms.custom: ""
ms.date: "03/23/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "имена [службы Analysis Services], атрибуты"
  - "переименование атрибутов"
  - "атрибуты [службы Analysis Services], переименование"
  - "Name, свойство"
...
# переименовать атрибут
 ...
 Дополнительные сведения о переименовании атрибута см. в разделе [Привязка атрибута к ключевому столбцу](../../analysis-services/multidimensional-models/bind-an-attribute-to-a-key-column.md).  
