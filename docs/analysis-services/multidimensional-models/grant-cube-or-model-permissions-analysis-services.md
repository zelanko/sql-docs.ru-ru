---
title: "Предоставление разрешений кубу или модели (службы Analysis Services) | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
helpviewer_keywords: 
  - "права доступа пользователя [службы Analysis Services], кубы"
  - "кубы [службы Analysis Services], безопасность"
  - "разрешения на чтение и запись"
  - "разрешения [службы Analysis Services], кубы"
