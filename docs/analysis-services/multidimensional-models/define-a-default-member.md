---
title: "Определение элемента по умолчанию | Microsoft Docs"
ms.custom: ""
ms.date: "03/23/2017"
...
helpviewer_keywords: 
  ...
  - "элементы [службы Analysis Services], по умолчанию"
  - "DefaultMember, свойство "
...
## См. также  
 [Настройка уровня "Все" для иерархий атрибутов](../../analysis-services/multidimensional-models/configure-the-all-level-for-attribute-hierarchies.md)  
