---
title: "Вычисления в многомерных моделях | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "вычисления [службы Analysis Services], создание"
  - "удаление вычислений"
  - "вычисления [службы Analysis Services], скрипты"
  - "Конструктор кубов"
  - "изменение скриптов"
  - "удаление вычислений"
  - "вычисления [службы Analysis Services], удаление"
  - "скрипты [службы Analysis Services], вычисления"
  - "кубы [службы Analysis Services], вычисления"
  - "порядки разрешения [службы Analysis Services]"
