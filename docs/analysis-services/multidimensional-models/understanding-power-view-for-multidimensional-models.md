---
title: "Основные сведения о Power View для многомерных моделей | Microsoft Docs"
ms.custom: ""
ms.date: "03/06/2017"
...
---
# Основные сведения о Power View для многомерных моделей
 ...
 **Группы мер в списке полей Power View**  
 ...
 ![Список полей в Power View](../../analysis-services/multidimensional-models/media/daxmd-powerviewfieldlist.gif "Список полей в Power View")  
 ...
 **Меры и ключевые показатели эффективности в группе мер**  
 ...
 ![Группа мер в списке полей Power View](../../analysis-services/multidimensional-models/media/daxmd-fieldlist-group.gif "Группа мер в списке полей Power View")  
 ...
 **Измерения, атрибуты и иерархии в SQL Server Data Tools (SSDT) и список полей Power View**  
 ...
 ![Измерения в SSDT и в списке полей Power View](../../analysis-services/multidimensional-models/media/daxmd-ssdt-dimensions.gif "Измерения в SSDT и в списке полей Power View")  
 ...
 **Географические типы атрибутов измерений в SSDT и списке полей Power View**  
 ...
 ![Атрибуты измерения типа geography](../../analysis-services/multidimensional-models/media/daxmd-ssdt-attribute-geog-types.gif "Атрибуты измерения типа geography")  
