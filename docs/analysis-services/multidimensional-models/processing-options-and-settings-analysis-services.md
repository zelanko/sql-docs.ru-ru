...
> [!NOTE]  
>  Данный раздел относится к многомерным решениям и решениям для интеллектуального анализа данных. Сведения о табличных решениях см. в разделе [Обработка базы данных, таблицы или секции (службы Analysis Services)](../../analysis-services/tabular-models/process-database-table-or-partition-analysis-services.md).  
...
|Режим|Область применения|Description|  
|----------|----------------|-----------------|  
...
|Параметр обработки|Description|Значение параметра|  
|-----------------------|-----------------|------------------|  
