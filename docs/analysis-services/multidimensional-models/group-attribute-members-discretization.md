---
title: "Группирование элементов атрибутов (дискретизация) | Microsoft Docs"
ms.custom: ""
ms.date: "03/23/2017"
...
helpviewer_keywords: 
  ...
  - "DiscretizationNumber, свойство"
  - "порядки сортировки [службы Analysis Services]"
  - "DiscretizationMethod, свойство"
  - "добавление элементов к группам"
  - "количество групп элементов"
  - "элементы [службы Analysis Services], группы"
  - "имена [службы Analysis Services], группы элементов"
