---
title: "Включение обратной записи в измерение | Microsoft Docs"
ms.custom: ""
ms.date: "03/23/2017"
...
helpviewer_keywords: 
  - "изменение измерений"
  - "обратная запись [службы Analysis Services], настройка"
  - "измерения [службы Analysis Services], расширения бизнес-аналитики"
  - "расширения бизнес-аналитики [службы Analysis Services], обратная запись"
  - "измерения [службы Analysis Services], обратная запись"
  - "обратная запись [службы Analysis Services]"
  - "измерения [службы Analysis Services], изменение"
  - "ручное изменение структуры измерения"
...
## Установка возможности обратной записи в измерение  
