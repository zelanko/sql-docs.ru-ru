...
## <a name="security"></a>безопасность  
 ...
 Для сборок разрешение на выполнение передается со свойством **PermissionSet** в объекте **Assembly** . Разрешения, получаемые управляемым кодом, обусловлены действующей политикой безопасности. Уже существует три уровня политики, действующие в не - [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] , размещенных в среде: предприятие, компьютер и пользователя. Действительный список разрешений, получаемых кодом, определяется на основании пересечения разрешений, полученных указанными тремя уровнями.  
