---
title: "Управление сборками многомерной модели | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "разрешения [службы Analysis Services], сборки"
  - "вызов пользовательских функций"
  - "олицетворение пользователя [службы Analysis Services]"
  - "олицетворение [службы Analysis Services]"
  - "расширения интеллектуального анализа данных [службы Analysis Services], сборки"
  - "многомерные выражения [службы Analysis Services], сборки"
  - "пользовательские функции [службы Analysis Services]"
  - "объекты служб Analysis Services, сборки"
  - "сборки [службы Analysis Services]"
  - "домены приложений [службы Analysis Services]"
