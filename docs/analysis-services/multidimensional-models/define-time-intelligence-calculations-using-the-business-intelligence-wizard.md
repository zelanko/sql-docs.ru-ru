---
title: "Определение вычислений логики операций со временем с использованием мастера бизнес-аналитики | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "рост за период [службы Analysis Services]"
  - "параллельные сравнения периодов [службы Analysis Services]"
  - "расширения бизнес-аналитики [службы Analysis Services], логика операций со временем"
  - "представления времени [службы Analysis Services]"
  - "иерархии [службы Analysis Services], время"
  - "периоды времени [службы Analysis Services]"
  - "скользящие средние"
  - "время [службы Analysis Services]"
  - "период к дате [службы Analysis Services]"
  - "вычисления [службы Analysis Services], время"
  - "иерархии времени [службы Analysis Services]"
