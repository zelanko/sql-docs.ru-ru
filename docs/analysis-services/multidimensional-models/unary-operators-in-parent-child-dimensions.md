---
title: "Унарные операторы в измерениях типа &#171;родители-потомки&#187; | Microsoft Docs"
ms.custom: ""
ms.date: "03/23/2017"
...
helpviewer_keywords: 
  ...
  - "атрибуты [службы Analysis Services], унарные операторы"
  - "унарные операторы"
...
manager: "erikre"
---
# Унарные операторы в измерениях типа &#171;родители-потомки&#187;
...
## См. также  
 ...
 [Операторы пользовательской свертки в измерениях типа «родители-потомки»](../../analysis-services/multidimensional-models/custom-rollup-operators-in-parent-child-dimensions.md)   
 [Запуск мастера бизнес-аналитики в конструкторе измерений](../../analysis-services/multidimensional-models/start-the-business-intelligence-wizard-in-dimension-designer.md)  
