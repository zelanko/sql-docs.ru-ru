---
title: "Синхронизация баз данных служб Analysis Services | Microsoft Docs"
ms.custom: ""
ms.date: "03/06/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "развертывания служб Analysis Services, мастер синхронизации баз данных"
  - "развертывание [службы Analysis Services], мастер синхронизации баз данных"
...
## Предварительные требования  
 ...
 И исходный и целевой серверы должны быть одной версии. Выпуск каждой установки должен поддерживать синхронизацию баз данных. В [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]синхронизация базы данных поддерживается в выпусках Enterprise, Developer и Business Intelligence. Дополнительные сведения о функциях каждого из выпусков см. в разделе [Функции, поддерживаемые различными выпусками SQL Server 2016](../Topic/Features%20Supported%20by%20the%20Editions%20of%20SQL%20Server%202016.md).  
