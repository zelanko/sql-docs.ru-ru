...
## <a name="in-this-section"></a>В этом разделе  
 ...
 [Расширение функциональных возможностей OLAP](../../analysis-services/multidimensional-models/extending-olap/extending-olap-functionality.md)  
