---
title: "Измерения &#171;родители-потомки&#187; | Microsoft Docs"
ms.custom: ""
ms.date: "03/23/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "иерархии [службы Analysis Services], родители-потомки"
  - "измерения [службы Analysis Services], родители-потомки"
  - "родительские атрибуты [службы Analysis Services]"
  - "элементы данных [службы Analysis Services]"
  - "иерархии [службы Analysis Services], многоуровневые"
  - "самосоединения"
  - "связи, ссылающиеся на себя"
...
## Схема измерения  
 ...
 ![Ссылающееся на себя соединение в таблице DimOrganization](../../analysis-services/multidimensional-models/media/dimorganization.png "Ссылающееся на себя соединение в таблице DimOrganization")  
