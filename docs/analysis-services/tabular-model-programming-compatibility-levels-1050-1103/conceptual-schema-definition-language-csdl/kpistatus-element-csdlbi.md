...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]Элемент KpiStatus определяет ссылку на столбец, содержащий значение, используемое в качестве индикатора состояния в ключевого индикатора производительности (KPI).  
