...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]Элемент Property в CSDLBI имеет сложный тип, предоставляющий дополнения к элементу языка CSDL Property для поддержки моделей данных бизнес-аналитики.  
