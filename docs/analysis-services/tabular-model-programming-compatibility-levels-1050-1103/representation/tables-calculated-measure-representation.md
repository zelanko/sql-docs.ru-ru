...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]Вычисляемая мера — это именованное выражение DAX, вычисляемое каждый раз при его использовании.  
