...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]В табличных моделях иерархия представляет собой путь навигации от одного атрибута к другому в зависимости от значения, выбранного пользователем.  
