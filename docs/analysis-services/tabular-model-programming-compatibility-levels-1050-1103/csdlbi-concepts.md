 ...
 **Атрибуты измерения:** , выходные данные в CSDLBI атрибуты измерения поддерживаются и автоматически помечаются как необрабатываемые статистически.  
