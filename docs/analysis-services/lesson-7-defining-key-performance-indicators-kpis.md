---
title: "Занятие&#160;7. Определение ключевых показателей эффективности | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
[Определение и поиск ключевых показателей эффективности](../analysis-services/defining-and-browsing-kpis.md)  
