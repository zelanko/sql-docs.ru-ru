---
title: "Введение в мониторинг служб Analysis Services при помощи приложения SQL Server Profiler | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  ...
  - "производительность [службы Analysis Services]"
  - "производительность [службы Analysis Services], SQL Server Profiler"
