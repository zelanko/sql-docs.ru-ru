---
title: "Управление экземплярами служб Analysis Services | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "03/14/2017"
...
|[Создание скриптов для административных задач в службах Analysis Services](../../analysis-services/instances/script-administrative-tasks-in-analysis-services.md)|Сведения о том, как автоматизировать многие задачи администрирования, включая обработку.|  
