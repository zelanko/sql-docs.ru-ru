---
title: "Планирование задач администрирования служб SSAS с помощью агента SQL Server | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
7.  В поле **Сервер** введите **localhost** для экземпляра служб [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] по умолчанию или **localhost\\**\<*имя экземпляра*> для именованного экземпляра.  
     ...
     Если задание будет выполняться с удаленного компьютера, используйте имя сервера и имя экземпляра, в котором будет выполняться задание. Используйте формат \<*имя сервера*> для экземпляра по умолчанию и \<*имя сервера*>\\<*имя экземпляра*> для именованного экземпляра.  
