---
title: "Поставщики данных, используемые для соединений со службами Analysis Services | Microsoft Docs"
ms.custom: ""
ms.date: "03/04/2017"
...
#### Поиск поставщиков данных на сайте загрузок  
  
1.  Перейдите в [центр загрузки Майкрософт](http://go.microsoft.com/fwlink/p/?LinkID=296473).  
  
2.  Разверните **инструкции по установке**. ADOMD.NET, поставщик OLE DB и объекты AMO включены в список. Каждая библиотека имеет 32- или 64-разрядную версию. Для серверов и новых рабочих станций, работающих под управлением 64-разрядной операционной системы, потребуется 64-разрядная версия.  
...
##  <a name="bkmk_ADOMD"></a> ADOMD.NET  
 ...
 Дополнительные сведения о подключении программным путем см. в разделе [Establishing Connections in ADOMD.NET](../Topic/Establishing%20Connections%20in%20ADOMD.NET.md).  
