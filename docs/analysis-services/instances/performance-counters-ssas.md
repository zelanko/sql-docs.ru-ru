---
title: "Счетчики производительности [службы SSAS] | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
---
# Счетчики производительности [службы SSAS]
...
|Записи в хранилище файлов/с|Записи страниц хранилища файлов/с.  Операции записи асинхронны.|  
|Записи в хранилище файлов в КБ/с|Записано в хранилище файлов в КБ/с.  Операции записи асинхронны.|  
