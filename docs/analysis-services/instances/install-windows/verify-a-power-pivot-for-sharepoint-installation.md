---
title: "Проверка установки PowerPivot для SharePoint | Microsoft Docs"
ms.custom: ""
ms.date: "03/20/2017"
...
---
# Проверка установки PowerPivot для SharePoint
...
## Проверка интеграции на уровне сайта  
...
## Проверка доступа к данным на сервере  
...
8.  В поле "Имя сервера" введите **\<имя_сервера>\powerpivot**, где **\<имя_сервера>** — это имя компьютера, на котором установлен [!INCLUDE[ssGemini](../../../includes/ssgemini-md.md)] для SharePoint.  
