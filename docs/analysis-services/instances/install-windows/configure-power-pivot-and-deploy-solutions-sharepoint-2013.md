...
4.  На вкладке **Параметры** выполните следующие действия.  
    ...
    4.  **[!INCLUDE[ssGemini](../../../includes/ssgemini-md.md)] Сервер для служб Excel**: Введите имя [!INCLUDE[ssASnoversion](../../../includes/ssasnoversion-md.md)] сервера в режиме SharePoint. При развертывании в конфигурации с одиночным сервером последний совпадает с сервером базы данных. `[ServerName]\powerpivot`  
