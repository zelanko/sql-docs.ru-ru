---
title: "Регистрация имени участника-службы для экземпляра служб Analysis Services | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
> [!TIP]  
>  Проверьте, было ли создано имя участника-службы для сервера Analysis Services, запустив командлет `Setspn -L <domain account>` или `Setspn -L <machinename>`в зависимости от способа регистрации имени участника-службы. В списке должно быть имя MSOLAPSVC.3/\<имя_узла>.  
...
## См. также  
 ...
 [Как настроить использование проверки подлинности Kerberos в службах SQL Server 2008 Analysis Services и SQL Server 2005 Analysis Services](http://support.microsoft.com/kb/917409)   
