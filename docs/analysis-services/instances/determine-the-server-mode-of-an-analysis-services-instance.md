---
title: "Определение режима работы сервера экземпляра служб Analysis Services | Microsoft Docs"
ms.custom: ""
ms.date: "03/03/2017"
...
## Значки сервера в обозревателе объектов  
 ...
 ![Значки обозревателя объекто�� для каждого режима сервера](../../analysis-services/instances/media/ssas-ssms-servermodes.gif "Значки обозревателя объекто�� для каждого режима сервера")  
