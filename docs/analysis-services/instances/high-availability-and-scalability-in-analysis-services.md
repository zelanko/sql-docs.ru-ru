---
title: "Высокий уровень доступности и масштабируемость в службах Analysis Services | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
## Достижение высокой доступности и избыточности с помощью WSFC  
...
## См. также  
 ...
 [Пример внедрения служб Analysis Services: использование табличных моделей в крупномасштабных коммерческих решениях](https://msdn.microsoft.com/library/dn751533.aspx)  
