---
title: "Свойства строки подключения (службы Analysis Services) | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "03/07/2017"
...
##  <a name="a-namebkmkcommona-connection-parameters-in-common-use"></a><a name="bkmk_common"></a> Часто применяемые параметры соединения  
...
##  <a name="a-namebkmkautha-authentication-and-security"></a><a name="bkmk_auth"></a> Проверка подлинности и безопасность  
...
##  <a name="a-namebkmkspeciala-special-purpose-parameters"></a><a name="bkmk_special"></a> Специальные параметры  
...
##  <a name="a-namebkmkreserveda-reserved-for-future-use"></a><a name="bkmk_reserved"></a> Зарезервировано для использования в будущем.  
...
##  <a name="a-namebkmkexamplesa-example-connection-strings"></a><a name="bkmk_examples"></a> Примеры строк подключения  
...
##  <a name="a-namebkmksupportedstringsa-connection-string-formats-used-in-analysis-services"></a><a name="bkmk_supportedstrings"></a> Форматы строк подключения, используемые в службах Analysis Services  
...
##  <a name="a-namebkmkencrypta-encrypting-connection-strings"></a><a name="bkmk_encrypt"></a> Шифрование строк соединения  
