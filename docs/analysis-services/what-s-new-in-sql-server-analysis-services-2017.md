...
Службы аналитики SQL Server 2017 г. Некоторые из наиболее важных усовершенствованиях видит с SQL Server 2012. Построение на успех табличном режиме (впервые появился в SQL Server 2012 Analysis Services), этот выпуск делает эффективнее, чем когда-либо табличные модели.
...
Когда речь заходит о передаче данных из источников данных в табличной модели, SQL Server Data Tools (SSDT) вводит современном **получить данные** взаимодействия для моделей на уровне совместимости 1400. Он основан на аналогичном интерфейсе в Power BI Desktop и Microsoft Excel 2016. Современные возможности получения данных обеспечивает преобразования огромную данных и возможности анализа данных с помощью построителя запросов на получение данных и выражений M.

Современные получение данных возникают предоставленный поддержка широкий спектр дополнительный источник данных. Будущие обновления будут поддерживать дополнительных источников данных.

![AS_Get_Data_in_SSDT](../analysis-services/media/as-get-data-in-ssdt.png)

 Выбор данных и проще, чем когда-либо возможности преобразования и анализа данных упростить мощный и интуитивно понятный пользовательский интерфейс.

![Дополнительно гибридного веб-приложения](../analysis-services/media/as-get-data-advanced.png)


Возникают в современных получение данных и возможности гибридного M не применяются к существующей ugraded табличных моделей уровня совместимости 1200 1400. Новые возможности применяется только для новых моделей, созданных на уровне совместимости 1400.
