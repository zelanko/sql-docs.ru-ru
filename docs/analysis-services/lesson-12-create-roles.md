---
title: "Занятие&#160;12. Создание ролей | Microsoft Docs"
ms.custom: ""
ms.date: "02/27/2017"
...
2.  Щелкните новую роль, затем столбец **Имя** и переименуйте роль в **Администратор интернет-продаж**.  
...
## Следующие шаги  
Чтобы продолжить изучение этого учебника, перейдите к следующему занятию: [Занятие 13. Анализ в Excel](../analysis-services/lesson-13-analyze-in-excel.md).  
