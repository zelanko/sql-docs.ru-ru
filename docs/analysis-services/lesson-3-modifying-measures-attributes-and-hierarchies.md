...
[Изменение измерения «продукт»](../analysis-services/lesson-3-3-modifying-the-product-dimension.md)  
...
[Изменение измерения «Дата»](../analysis-services/lesson-3-4-modifying-the-date-dimension.md)  
