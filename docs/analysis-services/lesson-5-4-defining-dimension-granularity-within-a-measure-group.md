...
8.  В фильтре установите флажок «Выбрать все», чтобы сбросить все выбранные элементы, а затем выберите только **North America**.  
    ...
    ![Область фильтра для выбора North America](../analysis-services/media/l5-granularity-1b.png "область фильтра для выбора North America")  
...
8.  Последовательно разверните элементы **FY 2008**, **H1 FY 2008**и **Q1 FY 2008**.  
    ...
    ![Группе Sales Quota правильно распределена элементам](../analysis-services/media/l5-granularity-7.gif "группа мер Sales quota правильно распределена по измерениям")  
