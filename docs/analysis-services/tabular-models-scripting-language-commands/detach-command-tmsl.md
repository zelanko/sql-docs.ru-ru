...
[!INCLUDE[ssas-appliesto-sqlas-aas](../../includes/ssas-appliesto-sqlas-aas.md)]Отсоединяет базу данных служб Analysis Services на сервере.  
...
|База данных|[Обязательно]|Имя объекта базы данных для отсоединения.|  
