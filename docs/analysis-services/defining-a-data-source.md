---
title: "Определение источника данных | Microsoft Docs"
ms.custom: ""
ms.date: "02/27/2017"
...
### Определение нового источника данных  
...
[Определение представления источников данных](../analysis-services/defining-a-data-source-view.md)  
