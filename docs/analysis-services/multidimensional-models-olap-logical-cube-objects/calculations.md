...
```  
 ...
 Чтобы создать вычисляемые элементы, используйте **вычисления**вкладку в конструкторе кубов. Дополнительные сведения см. в разделе [Создание вычисляемых элементов](../../analysis-services/multidimensional-models/create-calculated-members.md)  
