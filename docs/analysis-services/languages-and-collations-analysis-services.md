---
title: "Языки и параметры сортировки (службы Analysis Services) | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  - "параметры сортировки Windows [службы Analysis Services]"
  ...
  - "языки по умолчанию"
  - "параметры сортировки [службы Analysis Services]"
