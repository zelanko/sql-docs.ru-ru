...
[!INCLUDE[ssas-appliesto-sqlas-aas](../includes/ssas-appliesto-sqlas-aas.md)]
 ...
 В многомерной модели (только) эти свойства можно задать в базе данных или куба — можно также настраивать их в переводах, создаваемых для объектов в кубе. В табличной модели язык и параметры сортировки наследуются от операционной системы сервера виртуальных машин.  
 ...
 **Язык** и **параметры сортировки** свойства часто используются вместе — где вы можете задать **языка**, можно также задать **параметры сортировки**.  
