---
title: "Использование измененной версии проекта Analysis Services Tutorial | Microsoft Docs"
ms.custom: ""
ms.date: "02/27/2017"
...
manager: "erikre"
---
# Использование измененной версии проекта Analysis Services Tutorial
...
## Загрузка и извлечение файла проекта  
...
## Загрузка и обработка улучшенной версии проекта  
...
[Определение свойств родительского атрибута в иерархии «родители-потомки»](../analysis-services/defining-parent-attribute-properties-in-a-parent-child-hierarchy.md)  
