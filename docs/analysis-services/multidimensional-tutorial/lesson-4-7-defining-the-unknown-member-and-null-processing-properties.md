...
4.  Просмотрите свойства конфигурации ошибок ключа и ошибок ключа NULL, однако не вносите изменения.  
    ...
    ![Коллекция свойств ErrorConfiguration](../media/l4-productdimensionerrorconfig-1.gif "коллекция свойств ErrorConfiguration")  
...
6.  Разверните узел **Components**, а затем разверните немаркированный элемент уровня **Model Name** .  
    ...
    ![Компоненты сборки, используемые для создания других компонентов](../media/l4-productdimensionerrorconfig-2.gif "компоненты сборки, используемые для создания других компонентов")  
...
4.  Щелкните запрос SELECT DISTINCT, а затем **Просмотр подробностей**.  
    ...
    ![Предложение SELECT DISTINCT, показывающее предложение WHERE](../media/l4-productnametraceline-1.gif "предложение SELECT DISTINCT, показывающее предложение WHERE")  
...
4.  Разверните элемент **Assembly Components** на уровне **Category** , а затем разверните элемент **Assembly Components** на уровне **Subcategory** .  
    ...
    ![Уровень имя продукта, с компонентами сборки](../media/l4-assemblycomponents-1.gif "уровень название продукта, с компонентами сборки")  
