...
4.  В окне свойств установите для свойства **AttributeHierarchyEnabled** выбранных атрибутов значение **False** .  
    ...
    ![Значение False свойства AttributeHierarchyEnabled](../media/l4-hierarchyenabled-1.gif "значение False свойства AttributeHierarchyEnabled")  
...
4.  В окне свойств установите для свойства **AttributeHierarchyEnabled** выбранных атрибутов значение **False** .  
    ...
    ![Значение False свойства AttributeHierarchyVisible](../media/l4-hierarchyvisible-1.gif "значение False свойства AttributeHierarchyVisible")  
