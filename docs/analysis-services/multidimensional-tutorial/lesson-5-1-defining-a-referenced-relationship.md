...
ms.locfileid: "65404136"
---
# <a name="lesson-5-1---defining-a-referenced-relationship"></a>Урок 5 – 1-Определение ссылочной связи
...
3.  Из измерения **География** на панели метаданных перетащите определяемую пользователем иерархию **География** в область **Перетащите сюда поля строк** на панели данных.  
    ...
    ![Распределяться меры Reseller Sales-Sales Amount](../media/l5-referencedrelationship-1.gif "распределяться меры Reseller Sales-Sales Amount")  
...
8.  Нажмите кнопку с многоточием (**...** ) в **полное имя** ячейку на пересечении **клиента** измерения и **Интернет-продажи** группы мер.  
    ...
    ![Диалоговое окно Определение связи](../media/l5-referencedrelationship-4.gif "диалоговое окно «Задание связи»")  
...
3.  На панели метаданных разверните элемент **География торгового посредника**, щелкните правой кнопкой мыши пункт **Географии**и выберите команду **Добавить в область строк**.  
    ...
    ![Диалоговое окно Определение связи](../media/l5-referencedrelationship-5.gif "диалоговое окно «Задание связи»")  
