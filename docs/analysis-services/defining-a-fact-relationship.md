---
title: "Определение связи фактов | Microsoft Docs"
ms.custom: ""
ms.date: "03/04/2017"
...
2.  Нажмите кнопку обзора (**…**) в ячейке **Описание позиции** на пересечении группы мер **Продажи через Интернет** и измерения **Подробности заказа через Интернет**, чтобы просмотреть свойства связи фактов.  
    ...
    ![Диалоговое окно «Задание связи»](../analysis-services/media/l5-factrelationship-2.gif "Диалоговое окно «Задание связи»")  
...
[Определение связи «многие ко многим»](../analysis-services/defining-a-many-to-many-relationship.md)  
