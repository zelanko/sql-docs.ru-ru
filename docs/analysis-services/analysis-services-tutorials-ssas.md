...
### <a name="project-and-completed-model-database-samples"></a>Проект и готовой модели образцы баз данных
Примеры проектов моделирования данных и баз данных модели готовый пример можно найти по адресу [Adventure Works для служб Analysis Services на сайте GitHub](https://github.com/Microsoft/sql-server-samples/releases/tag/adventureworks-analysis-services).

### <a name="code-samples"></a>Примеры кода
Откройте примеры кода и проекты сообщества, доступные в [репозитория служб Analysis Services на сайте GitHub](https://github.com/Microsoft/Analysis-Services).
...
Доступны образцы баз данных Adventure Works и Wide World Importers [репозиторий с примером SQL Server на сайте GitHub](https://github.com/Microsoft/sql-server-samples).
