...
1. [Обратная совместимость служб Analysis (SQL 2017 г.)](analysis-services-backward-compatibility-sql2017.md)
2. [Безопасность на уровне объекта](tabular-models/object-level-security.md)
