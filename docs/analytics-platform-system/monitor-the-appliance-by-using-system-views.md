---
title: Мониторинг с помощью системных представлений - Analytics Platform System | Документация Майкрософт
description: В этой статье приводятся системные представления, которые можно использовать для мониторинга устройства системы платформы аналитики.
author: mzaman1
manager: craigg
ms.prod: sql
...
ms.locfileid: "62639982"
---
# <a name="monitor-the-appliance-with-system-views---analytics-platform-system"></a>Мониторинг устройства с помощью системных представлений - Analytics Platform System
В этой статье приводятся системные представления, которые можно использовать для мониторинга SQL Server PDW.  
  
## <a name="to-monitor-the-appliance-by-using-system-views"></a>Мониторинг устройства с помощью системных представлений  
SQL Server PDW включает в себя комплексное системных представлений, которые позволяют получить подробные сведения о работоспособности устройства, состояние и производительность. Эта таблица содержит ссылки на системные представления, которые могут использоваться для каждой возможности мониторинга.  
