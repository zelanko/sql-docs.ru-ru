---
title: Монитор с системные представления — Analytics Platform System | Документы Microsoft
description: В этой статье перечислены системные представления, которые можно использовать для наблюдения за устройством системы платформы аналитики.
author: mzaman1
manager: craigg
ms.prod: sql
...
ms.locfileid: "31539064"
---
# <a name="monitor-the-appliance-with-system-views---analytics-platform-system"></a>Монитор устройств с помощью системных представлений - система платформы аналитики
