...
4.  Выберите группу серверов устройства, созданный в [настройки Windows Server Update Services &#40; WSUS &#41; &#40; Система платформы аналитики &#41; ](configure-windows-server-update-services-wsus.md).  
...
1.  Откройте консоль администратора, перейдите на вкладку состояние устройства. В разделе [отслеживать устройства с помощью консоли администрирования &#40; Система платформы аналитики &#41; ](monitor-the-appliance-by-using-the-admin-console.md).  
