---
title: Режим блокировки - Parallel Data Warehouse | Документы Microsoft
description: Узнайте, как параллельное хранилище данных использует блокировки для обеспечения целостности транзакций и поддержания согласованности баз данных, когда несколько пользователей имеют доступ к данным, в то же время.
author: mzaman1
manager: craigg
ms.prod: sql
...
ms.locfileid: "31539464"
---
# <a name="locking-behavior-in-parallel-data-warehouse"></a>Режим блокировки в Parallel Data Warehouse
Узнайте, как параллельное хранилище данных использует блокировки для обеспечения целостности транзакций и поддержания согласованности баз данных, когда несколько пользователей имеют доступ к данным, в то же время.  
