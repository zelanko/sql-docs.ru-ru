---
title: Параллельные компоненты хранилища данных — Analytics Platform System | Документы Microsoft
description: Этой статьи описывается программное обеспечение устройства и компоненты программного обеспечения не является специализированным Analytics Platform System.
author: mzaman1
manager: craigg
ms.prod: sql
...
ms.locfileid: "31544926"
---
# <a name="parallel-data-warehouse-components---analytics-platform-system"></a>Параллельные компоненты хранилища данных — система платформы аналитики
Этой статьи описывается программное обеспечение устройства и компоненты программного обеспечения не является специализированным Analytics Platform System.  
