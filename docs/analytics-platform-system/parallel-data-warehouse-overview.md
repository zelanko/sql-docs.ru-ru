...
## <a name="appliance-software---query-processing-and-user-data-storage"></a><a name="sec1"></a>Программное обеспечение устройства — обработка запросов и хранилище данных пользователя  
...
## <a name="non-relational-data"></a><a name="sec2"></a>Нереляционные данные
