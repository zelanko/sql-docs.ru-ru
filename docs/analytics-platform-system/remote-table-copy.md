...
## <a name="understand-remote-table-copy-for-sql-server-pdw"></a><a name="BasicsPDE"></a>Сведения об удаленном копировании таблицы для SQL Server PDW  
...
## <a name="requirements-for-using-remote-table-copy"></a><a name="BasicsPrerequisites"></a>Требования для использования копирования удаленной таблицы  
...
## <a name="configure-remote-table-copy"></a><a name="ConfigureRemote"></a>Настройка копирования удаленной таблицы  
...
## <a name="perform-a-remote-table-copy"></a><a name="PerformRemote"></a>Выполнить удаленное копирование таблицы  
