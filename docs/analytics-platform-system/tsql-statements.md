...
* [УДАЛИТЕ ВНЕШНИЙ ИСТОЧНИК ДАННЫХ](../t-sql/statements/drop-external-data-source-transact-sql.md)
...
* [Присвоение псевдонима](../t-sql/queries/aliasing-azure-sql-data-warehouse-parallel-data-warehouse.md)
