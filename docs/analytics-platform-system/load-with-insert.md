...
## <a name="insert-literals-into-binary-types"></a><a name="InsertingLiteralsBinary"></a>Вставка литералов в двоичные типы  
...
## <a name="insert-literals-into-date-and-time-types"></a><a name="InsertingLiteralsDateTime"></a>Вставка литералов в типы даты и времени  
...
## <a name="insert-literals-into-numeric-types"></a><a name="InsertLiteralsNumeric"></a>Вставка литералов в числовые типы  
...
## <a name="inserting-literals-into-string-types"></a><a name="InsertLiteralsString"></a>Вставка литералов в строковые типы  
...
[Распределенные данные](/azure/synapse-analytics/sql-data-warehouse/massively-parallel-processing-mpp-architecture)  
