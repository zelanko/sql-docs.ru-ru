...
description: Элементы языка T-SQL для аналитической системы платформы (ТД) SQL Server Parallel Data Warehouse (PDW).
author: mzaman1
ms.prod: sql
...
* [УНИЧТОЖИТЬ](../t-sql/language-elements/kill-transact-sql.md)
* [Решение для свойства IDENTITY](../t-sql/statements/create-table-transact-sql-identity-property.md)
...
* [НАЧАТЬ... КОНЦЕ](../t-sql/language-elements/begin-end-transact-sql.md)
...
* [Оператор](../t-sql/language-elements/raiserror-transact-sql.md)
...
* [+ (Добавить)](../t-sql/language-elements/add-transact-sql.md)
...
* [>= (отлично от или равно)](../t-sql/language-elements/greater-than-or-equal-to-transact-sql.md)
...
* [Например](../t-sql/language-elements/like-transact-sql.md)
...
* [ПРОСТО](../t-sql/functions/abs-transact-sql.md)
* [ACOS](../t-sql/functions/acos-transact-sql.md)
* [СИМВОЛ](../t-sql/functions/ascii-transact-sql.md)
...
* [СИТУАЦИИ](../t-sql/language-elements/case-transact-sql.md)
* [Приведение и преобразование](../t-sql/functions/cast-and-convert-transact-sql.md)
* [ТОЛОК](../t-sql/functions/ceiling-transact-sql.md)
* [ТИПА](../t-sql/functions/char-transact-sql.md)
* [CHARINDEX](../t-sql/functions/charindex-transact-sql.md)
* [ВЫЧИСЛЕН](../t-sql/functions/checksum-transact-sql.md)
* [ОБЪЕДИНЕНИЕ](../t-sql/language-elements/coalesce-transact-sql.md)
...
* [СЦЕПЛЕН](../t-sql/functions/concat-transact-sql.md)
* [COS](../t-sql/functions/cos-transact-sql.md)
* [COT](../t-sql/functions/cot-transact-sql.md)
* [РАСЧЕТА](../t-sql/functions/count-transact-sql.md)
...
* [ФУНКЦИЯ DATENAME](../t-sql/functions/datename-transact-sql.md)
* [ДАТЫ](../t-sql/functions/datepart-transact-sql.md)
...
* [Ежедневные](../t-sql/functions/day-transact-sql.md)
...
* [РАЗНИЦЫ](../t-sql/functions/difference-transact-sql.md)
...
* [РАСШИРЕНИЕМ](../t-sql/functions/exp-transact-sql.md)
* [FIRST_VALUE](../t-sql/functions/first-value-transact-sql.md)
* [ФАБРИЧ](../t-sql/functions/floor-transact-sql.md)
...
* [Функция ISDATE](../t-sql/functions/isdate-transact-sql.md)
* [ISNULL](../t-sql/functions/isnull-transact-sql.md)
* [ISNUMERIC](../t-sql/functions/isnumeric-transact-sql.md)
* [ЗАДЕРЖКА](../t-sql/functions/lag-transact-sql.md)
* [LAST_VALUE](../t-sql/functions/last-value-transact-sql.md)
* [ПРИВЕСТИ](../t-sql/functions/lead-transact-sql.md)
* [LEFT](../t-sql/functions/left-transact-sql.md)
* [LEN](../t-sql/functions/len-transact-sql.md)
* [ЖУРНАЛЬ](../t-sql/functions/log-transact-sql.md)
* [LOG10](../t-sql/functions/log10-transact-sql.md)
* [СОКРАЩЕНИЕ](../t-sql/functions/lower-transact-sql.md)
* [LTRIM](../t-sql/functions/ltrim-transact-sql.md)
* [МАКСИМАЛЬНОЙ](../t-sql/functions/max-transact-sql.md)
* [МИНИМУМ](../t-sql/functions/min-transact-sql.md)
* [МЕСЯЦ](../t-sql/functions/month-transact-sql.md)
...
* [оибжектпропертекс](../t-sql/functions/objectpropertyex-transact-sql.md)
* [Скалярные функции ODBC](../t-sql/functions/odbc-scalar-functions-transact-sql.md)
...
* [Отключение](../t-sql/functions/power-transact-sql.md)
* [ФУНКЦИЕЙ](../t-sql/functions/quotename-transact-sql.md)
* [RADIANS](../t-sql/functions/radians-transact-sql.md)
* [RAND](../t-sql/functions/rand-transact-sql.md)
* [Рейтинг](../t-sql/functions/rank-transact-sql.md)
* [ВОССТАНОВИТЬ](../t-sql/functions/replace-transact-sql.md)
* [REPLICATE](../t-sql/functions/replicate-transact-sql.md)
* [Отмена](../t-sql/functions/reverse-transact-sql.md)
* [RIGHT](../t-sql/functions/right-transact-sql.md)
* [ОКРУГЛО](../t-sql/functions/round-transact-sql.md)
...
* [ПИСАТЬ](../t-sql/functions/sign-transact-sql.md)
...
* [МОДУЛЬ](../t-sql/functions/space-transact-sql.md)
* [SQL_VARIANT_PROPERTY](../t-sql/functions/sql-variant-property-transact-sql.md)
* [МНИМ](../t-sql/functions/sqrt-transact-sql.md)
* [ТЕКАНИЯ](../t-sql/functions/square-transact-sql.md)
* [STATS_DATE](../t-sql/functions/stats-date-transact-sql.md)
* [СТАНДОТКЛОН](../t-sql/functions/stdev-transact-sql.md)
* [STDEVP](../t-sql/functions/stdevp-transact-sql.md)
* [STR](../t-sql/functions/str-transact-sql.md)
* [ОТНОСИТСЯ](../t-sql/functions/stuff-transact-sql.md)
* [ПОДСТРОКИ](../t-sql/functions/substring-transact-sql.md)
* [ФУНКЦИИ](../t-sql/functions/sum-transact-sql.md)
...
* [ТАНГЕНС](../t-sql/functions/tan-transact-sql.md)
...
* [ГРАНИЦ](../t-sql/functions/upper-transact-sql.md)
* [НАЖАТ](../t-sql/functions/user-transact-sql.md)
...
* [ГОД](../t-sql/functions/year-transact-sql.md)
...
* [ЗАДАТЬ ANSI_DEFAULTS](../t-sql/statements/set-ansi-defaults-transact-sql.md)
* [ЗАДАТЬ ANSI_NULL_DFLT_OFF](../t-sql/statements/set-ansi-null-dflt-off-transact-sql.md)
* [ЗАДАТЬ ANSI_NULL_DFLT_ON](../t-sql/statements/set-ansi-null-dflt-on-transact-sql.md)
* [ЗАДАТЬ ANSI_NULLS](../t-sql/statements/set-ansi-nulls-transact-sql.md)
* [ЗАДАТЬ ANSI_PADDING](../t-sql/statements/set-ansi-padding-transact-sql.md)
* [ЗАДАТЬ ANSI_WARNINGS](../t-sql/statements/set-ansi-warnings-transact-sql.md)
* [SET ARITHABORT](../t-sql/statements/set-arithabort-transact-sql.md)
* [ЗАДАТЬ ARITHIGNORE](../t-sql/statements/set-arithignore-transact-sql.md)
* [ЗАДАТЬ CONCAT_NULL_YIELDS_NULL](../t-sql/statements/set-concat-null-yields-null-transact-sql.md)
...
* [ЗАДАТЬ FMTONLY](../t-sql/statements/set-fmtonly-transact-sql.md)
* [ЗАДАТЬ IMPLICIT_TRANSACITONS](../t-sql/statements/set-implicit-transactions-transact-sql.md)
* [ЗАДАТЬ LOCK_TIMEOUT](../t-sql/statements/set-lock-timeout-transact-sql.md)
* [ЗАДАТЬ NUMBERIC_ROUNDABORT](../t-sql/statements/set-numeric-roundabort-transact-sql.md)
* [ЗАДАТЬ QUOTED_IDENTIFIER](../t-sql/statements/set-quoted-identifier-transact-sql.md)
* [SET ROWCOUNT](../t-sql/statements/set-rowcount-transact-sql.md)
* [SET TEXTSIZE](../t-sql/statements/set-textsize-transact-sql.md)
* [ЗАДАНИЕ УРОВНЯ ИЗОЛЯЦИИ ТРАНЗАКЦИИ](../t-sql/statements/set-transaction-isolation-level-transact-sql.md)
* [ЗАДАТЬ XACT_ABORT](../t-sql/statements/set-xact-abort-transact-sql.md)

## <a name="next-steps"></a>Дальнейшие действия
Дополнительные справочные сведения см. в статьях [инструкции t-SQL](tsql-statements.md) и [системные представления t-SQL](tsql-system-views.md).
