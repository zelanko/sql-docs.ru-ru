---
title: Настройте часовой пояс - система платформы аналитики | Документы Microsoft
description: Страница часовой пояс позволяет задать часовой пояс для всех узлов на устройстве Analytics Platform System (APS).
author: mzaman1
manager: craigg
ms.prod: sql
...
ms.locfileid: "31544666"
---
# <a name="appliance-time-zone-configuration---analytics-platform-system"></a>Конфигурация часового пояса устройства - система платформы аналитики
