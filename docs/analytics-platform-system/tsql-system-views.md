...
| sys.dm_pdw_nodes_os_dispatchers |Документация по Transact-SQL не доступен. |
...
| sys.dm_pdw_nodes_os_memory_node_access_stats |Документация по Transact-SQL не доступен. |
...
| sys.dm_pdw_nodes_os_spinlock_stats |Документация по Transact-SQL не доступен. |
...
## <a name="sql-server-2016-polybase-dmvs-available-in-parallel-data-warehouse"></a>SQL Server 2016 PolyBase динамические административные представления доступны в Parallel Data Warehouse
