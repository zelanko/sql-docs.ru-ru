...
description: Системные представления для аналитической системы платформы (ТД) SQL Server Parallel Data Warehouse (PDW).
author: mzaman1
ms.prod: sql
...
ms.locfileid: "74399800"
---
# <a name="system-views-for-analytics-platform-system-parallel-data-warehouse"></a>Системные представления для параллельного хранилища данных платформы аналитики
Системные представления для аналитической системы платформы (ТД) SQL Server Parallel Data Warehouse (PDW).

## <a name="parallel-data-warehouse-catalog-views"></a>Представления каталога параллельных хранилищ данных
...
## <a name="parallel-data-warehouse-dynamic-management-views-dmvs"></a>Динамические административные представления параллельного хранилища данных (DMV)
...
## <a name="sql-server-dmvs-applicable-to-parallel-data-warehouse"></a>SQL Server динамические административные представления, применимые к хранилищу данных Parallel Data
Следующие динамические административные представления применимы к параллельному хранилищу данных, но должны выполняться путем подключения к базе данных **master** .
...
* [sys. процедуры](https://msdn.microsoft.com/library/ms188737.aspx)
...
* [sys. синонимы](../relational-databases/system-catalog-views/sys-synonyms-transact-sql.md)
...
* [sys. таблицу sysreferences](../relational-databases/system-compatibility-views/sys-sysreferences-transact-sql.md)
...
## <a name="sql-server-dmvs-available-in-parallel-data-warehouse"></a>SQL Server динамические административные представления, доступные в параллельном хранилище данных
Параллельное хранилище данных предоставляет многие SQL Server динамические административные представления (DMV). Эти представления при запросе в Parallel Data Warehouse сообщают о состоянии SQL Server баз данных, выполняющихся в распределениях.

Каждое из этих DMV содержит конкретный столбец с именем pdw_node_id. Это идентификатор для расчетного узла. 

> [!NOTE]
> Чтобы использовать эти представления, вставьте в имя "pdw_nodes_", как показано в следующей таблице.
> 
> 

| Имя динамического административного представления в хранилище параллельных данных | Ссылка на SQL Server раздел T-SQL |
|:--- |:--- |
...
## <a name="sql-server-2016-polybase-dmvs-available-in-parallel-data-warehouse"></a>SQL Server 2016ных динамических административных представлений, доступных в параллельном хранилище данных
...
* [СТОЛБЦЕ](../relational-databases/system-information-schema-views/columns-transact-sql.md)
* [ПАРАМЕТРЫ](../relational-databases/system-information-schema-views/parameters-transact-sql.md)
* [ПОДПРОГРАММЫ](../relational-databases/system-information-schema-views/routines-transact-sql.md)
* [SCHEMATA](../relational-databases/system-information-schema-views/schemata-transact-sql.md)
* [ТАБЛИЦЕ](../relational-databases/system-information-schema-views/tables-transact-sql.md)
...
* [Представления](../relational-databases/system-information-schema-views/views-transact-sql.md)
