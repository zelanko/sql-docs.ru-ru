...
В командном окне или в пакетном файле `errorlevel` используйте для отображения кода возврата. Например:  
...
|Тип таблицы|Множественная транзакция<br />Mode (-m)|Таблица пуста|Поддерживается параллелизм|Ведение журналов|  
|--------------|-----------------------------------|------------------|-------------------------|-----------|  
...
### <a name="a-simple-dwloader-example"></a>а. Пример простого dwloader  
...
### <a name="b-load-data-into-an-adventureworks-table"></a>B. Загрузка данных в таблицу AdventureWorks  
...
### <a name="c-load-data-from-the-command-line"></a>C. Загрузка данных из командной строки  
