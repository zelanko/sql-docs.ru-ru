...
DNS-сервер пересылки можно настроить на узлах доменных служб Active Directory (***appliance_domain*-AD01** и  ***appliance_domain*-AD02**) вашего устройства Analytics Platform System, чтобы разрешить выполнение скриптов и приложений для доступа к внешним серверам.  
