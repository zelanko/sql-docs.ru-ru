...
|---------------|-------------------|----------------------------------|  
|Строковый литерал|Формат: "строка символов"<br /><br />Пример: "ABC"| Нет данных |  
|Строковый литерал в Юникоде|Формат: Н'чарактер строка "<br /><br />Пример: Н'абк '| Нет данных |  
|Целочисленный литерал|Формат: ффффффффффн<br /><br />Пример: 321312313123| Нет данных |  
|Десятичный литерал|Формат: FFFFFF. fffffff<br /><br />Пример: 12344,34455| Нет данных |  
