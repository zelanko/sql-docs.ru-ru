...
|---------------------------|---------------|  
|Подготовьте сервер как сервер резервного копирования.|[Приобретение и настройка резервного сервера](acquire-and-configure-backup-server.md)|  
