...
## <a name="HowToDeployPackage"></a>Методы для запуска пакета Integration Services  
...
## <a name="Locks"></a>Поведение блокировки  
...
### <a name="Walkthrough"></a>Конкретного. Простая загрузка из неструктурированного файла  
...
5.  Введите сведения о сервере, пользователе, пароле и целевой базе данных с информацией, относящейся к устройству. (Примеры показаны ниже). Затем нажмите кнопку **ОК**.  
