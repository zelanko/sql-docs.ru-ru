...
|видны узлы|Нажмите кнопку **оповещения**. Дополнительные сведения см. в разделе [консоли администрирования основные сведения об оповещениях &#40;Analytics Platform System&#41;](understanding-admin-console-alerts.md).|  
