...
Перед использованием Hadoop с SQL Server PDW следует связаться с администратором устройства для установки среды выполнения Java на SQL Server PDW. Инструкции см. в разделе [Настройка подключения к PolyBase для внешних данных &#40; Система платформы аналитики &#41; ](configure-polybase-connectivity-to-external-data.md) в операциях Appliance руководства.  
