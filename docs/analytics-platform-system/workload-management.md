...
## <a name="Basics"></a>Основы управления рабочей нагрузкой  
...
## <a name="RC"></a>Описания классов ресурсов  
В следующей таблице описаны классы ресурсов и их распределение системных ресурсов.  
  
|Класс ресурсов|Важность запроса|Максимальное использование памяти *|Слоты выдачи (максимум = 32)|Description|  
|------------------|----------------------|--------------------------|---------------------------------------|---------------|  
|значение по умолчанию|Средний|400 МБ|1|По умолчанию для каждого имени входа разрешен небольшой объем памяти и ресурсы параллелизма для запросов.<br /><br />При добавлении имени входа в класс ресурсов новый класс имеет приоритет. При удалении имени входа из всех классов ресурсов имя входа возвращается к выделению ресурсов по умолчанию.|  
