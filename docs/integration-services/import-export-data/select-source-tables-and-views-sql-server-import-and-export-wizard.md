---
description: Выбор исходных таблиц и представлений (мастер импорта и экспорта SQL Server)
...
В этом примере список **Источник** содержит все таблицы из образца базы данных AdventureWorks. Выделенная строка показывает, что пользователь хочет скопировать таблицу **Sales.Customer** из источника в новую таблицу **Sales.CustomerNew** в месте назначения. 
 ...
 ![Снимок экрана: страница выбора таблиц в мастере импорта и экспорта при копировании таблиц.](../../integration-services/import-export-data/media/select-tables1.png "Страница "Выбор таблиц" в мастере импорта и экспорта")
...
В этом примере пользователь хочет скопировать результаты запроса в таблицу **Sales.CustomerNew** в месте назначения.  
 ...
 ![Снимок экрана: страница выбора таблиц в мастере импорта и экспорта при предоставлении запроса.](../../integration-services/import-export-data/media/select-tables2.png "Страница "Выбор таблиц" в мастере импорта и экспорта")  
