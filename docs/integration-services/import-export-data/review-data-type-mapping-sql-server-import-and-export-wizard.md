---
description: Просмотр сопоставления типов данных (мастер импорта и экспорта SQL Server)
...
## <a name="screen-shot-of-the-review-data-type-mapping-page"></a>Снимок экрана: страница "Просмотр сопоставления типов данных"
 ...
 ![Страница "Просмотр сопоставления типов данных" мастера импорта и экспорта](../../integration-services/import-export-data/media/review-mapping.png "Страница "Просмотр сопоставления типов данных" мастера импорта и экспорта") 
