...
-   Запись в блоге [Компонент скрипта назначения XML](https://agilebi.com/jwelch/2007/06/02/xml-destination-script-component/)на сайте agilebi.com  
