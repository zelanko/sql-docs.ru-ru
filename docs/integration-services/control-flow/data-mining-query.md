---
title: "Запрос интеллектуального анализа данных | Microsoft Docs"
ms.custom: ""
ms.date: "03/06/2017"
...
## Параметры  
 ...
 Для переключения на панель конструктора щелкните значок ![Значок конструктора](../../integration-services/control-flow/media/ssis-designicon.png "Значок конструктора").  
  
 Для переключения на панель запросов щелкните значок ![Значок SQL](../../integration-services/control-flow/media/ssis-queryicon.png "Значок SQL").  
...
## См. также  
 ...
 [Справочник по расширениям интеллектуального анализа данных (расширения интеллектуального анализа данных)](../Topic/Data%20Mining%20Extensions%20\(DMX\)%20Statement%20Reference.md)  
