---
title: "Параметры запроса профиля включения значений (задача &#171;Профилирование данных&#187;) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
## Основные сведения о выборе столбцов для свойства InclusionColumns  
...
## Основные сведения о настройке пороговых значений  
...
#### Параметры SubsetTableOrView и SupersetTableOrView  
 **Схема**  
...
|Значение|Description|  
|-----------|-----------------|  
|**Нет**|Не задает пороговое значение. Стойкость ключа указывается независимо от значения.|  
...
|Значение|Description|  
|-----------|-----------------|  
|**Нет**|Не задает пороговое значение. Интенсивность включения отмечается независимо от стойкости ключа столбца надмножества.|  
