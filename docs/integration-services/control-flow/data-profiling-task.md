---
description: Задача «Профилирование данных»
...
|Профили, предназначенные для анализа отдельных столбцов|Описание|  
|----------------------------------------------|-----------------|  
...
|Профили, предназначенные для анализа нескольких столбцов|Описание|  
|--------------------------------------------|-----------------|  
