...
-   Если выбрать просмотр профиля потенциальных ключей, на панели запросов отображаются четыре столбца: **Тип профиля**, **Таблица или представление**, **Столбцы ключей** и **Идентификатор запроса**.  
...
-   Если выбрать просмотр профиля включения значений, на панели запросов отображаются шесть столбцов: **Тип профиля**, **Таблица или представление подмножества**, **Таблица или представление надмножества**, **Побочные столбцы подмножества**, **Побочные столбцы надмножества** и **Идентификатор запроса**.  
