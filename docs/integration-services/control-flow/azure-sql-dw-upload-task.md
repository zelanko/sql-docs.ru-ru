...
>
> Чтобы использовать Azure Data Lake 2-го поколения для промежуточного хранения или в качестве источника, можно подключиться с помощью диспетчера подключений службы хранилища Azure с типом службы хранилища BLOB-объектов.
