---
title: "Поток управления | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "поток управления [службы Integration Services], элементы"
  - "элементы потока управления служб SSIS"
  - "элементы потока управления служб SQL Server Integration Services"
...
## Реализация потока управления  
 ...
 ![Снимок экрана: конструктор потока управления с пакетом](../../integration-services/control-flow/media/samplecontrolflow.gif "Снимок экрана: конструктор потока управления с пакетом")  
...
-   Добавление диспетчеров соединений.  
 ...
 [!INCLUDE[ssIS](../../includes/ssis-md.md)] Конструктор служб также включает много возможностей разработки, которые можно использовать для управления областью конструктора и производить самодокументирование потока управления.  
