...
# <a name="control-flow"></a>Поток управления
  Пакет состоит из потока управления, а также, одного или нескольких потоков данных (необязательно). [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)][!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)] предоставляют три различных типа элементов управления, элементов потока: контейнеры, которые обеспечивают структуры в пакетах, задачах, которые предоставляют функциональные возможности и ограничения очередностью, соединяющие исполняемые объекты, контейнеры и задачи в упорядоченный поток управления.  
 ...
 ![Управление ходом выполнения с шестью задачами и контейнером](../../integration-services/control-flow/media/ssis-controlflowelmt.gif "управления потоком с шестью задачами и контейнером")  
...
-   Добавление диспетчеров соединений.  
 ...
 [!INCLUDE[ssIS](../../includes/ssis-md.md)]Конструктор также включает множество функций во время разработки, которые можно использовать для управления областью конструктора и самодокументирование потока управления.  
