---
description: Контейнер «цикл по каждому элементу»
...
-   Перечислитель файлов Data Lake Storage 2-го поколения по циклу Foreach для перечисления файлов в каталоге Azure Data Lake Store 2-го поколения.
 ...
 ![Контейнер "цикл по каждому элементу", перечисляющий элементы папки](../../integration-services/control-flow/media/ssis-foreachloop.gif "Контейнер "цикл по каждому элементу", перечисляющий элементы папки")  
