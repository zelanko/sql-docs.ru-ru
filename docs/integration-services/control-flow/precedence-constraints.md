---
title: "Ограничение очередностью | Документы Microsoft"
ms.custom: 
ms.date: 03/01/2017
...
# <a name="precedence-constraints"></a>Управление очередностью
 ...
 ![Исполняемые файлы, подключенные с очередностью](../../integration-services/control-flow/media/ssis-pcsimple.gif "исполняемые файлы, подключенные с очередностью")  
...
## <a name="set-the-properties-of-a-precedence-constraint-with-the-precedence-constraint-editor"></a>Задание свойств элементов управления очередностью с Редактор ограничений очередностью  
...
## <a name="set-the-properties-of-a-precedence-constraint-in-properties-window"></a>Задайте свойства элементов управления очередностью в окне "Свойства"  
...
## <a name="set-the-value-of-a-precedence-constraint-with-the-shortcut-menu"></a>Установка значения элементов управления очередностью с помощью контекстного меню  
...
## <a name="add-expressions-to-precedence-constraints"></a>Добавление выражений к элементам управления очередностью
 ...
 ![Ограничение очередностью между двумя задачами](../../integration-services/control-flow/media/mw-dts-03.gif "ограничение очередности между двумя задачами")  
...
### <a name="add-an-expression-to-a-precedence-constraint"></a>Добавление выражения к управлению очередностью  
...
## <a name="complex-constraint-scenarios-with-multiple-precedence-constraints"></a>Сложных сценариев ограничений с несколько ограничений очередностью 
Объект управления очередностью соединяет два исполняемых объекта: две задачи, два контейнера или задачу и контейнер. Они известны как приоритетный исполняемый объект и исполняемый объект с ограничением. Исполняемый объект с ограничениями может иметь несколько элементов управления очередностью. Дополнительные сведения см. в статье [Precedence Constraints](../../integration-services/control-flow/precedence-constraints.md).  
 ...
 ![Задачи, связанные с помощью ограничений очередностью](../../integration-services/control-flow/media/precedenceconstraints.gif "задачи связаны с помощью ограничений очередностью")  
...
## <a name="set-the-default-value-for-precedence-constraints"></a>Значением по умолчанию для ограничений очередностью  
...
## <a name="create-a-default-precedence-constraint"></a>Создание ограничения очередностью по умолчанию  
