---
title: "Средство просмотра профиля данных | Документы Microsoft"
ms.custom: 
ms.date: 03/01/2017
...
-   В папке  *\<диска >*: \Program Files (x86) | Программа Files\Microsoft SQL Server\110\DTS\Binn, запустите DataProfileViewer.exe.  
...
##### <a name="column-length-distribution-profile---column-pane"></a>Профиль распределения длины столбцов - \<столбца > области  
 **Минимальная длина**  
...
##### <a name="column-null-ratio-profile---column-pane"></a>Профиль соотношения значений Null столбца - \<столбца > области  
...
##### <a name="column-pattern-profile---column-pane"></a>Профиль шаблона столбцов — \<столбца > области  
 **Количество строк**  
 Отображает число строк в таблице или представлении.  
...
##### <a name="column-statistics-profile---column-pane"></a>Профиль статистики столбцов — \<столбца > области  
 **Минимальные**  
...
##### <a name="column-value-distribution-profile---column-pane"></a>Профиль распределения значений столбцов - \<столбца > области  
...
##### <a name="candidate-key-profile---table-pane"></a>Профиль потенциальных ключей — \<таблицы > области  
 **Ключевые столбцы**  
 ...
 **Число нарушений**  
 Отображает число строк, в которых определяющий столбец не определяет зависимый столбец. (Это строки, в которых зависимым является значение, показанное в  **\<имя зависимого столбца >** столбца.)  
