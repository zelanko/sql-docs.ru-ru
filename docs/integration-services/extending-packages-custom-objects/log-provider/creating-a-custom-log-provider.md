---
title: "Создание пользовательского регистратора | Документы Microsoft"
ms.custom: 
ms.date: 03/14/2017
...
-   Настраиваемые пользовательские интерфейсы для пользовательских регистраторов не реализованы в [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] [!INCLUDE[ssISnoversion](../../../includes/ssisnoversion-md.md)].  
...
> [!NOTE]  
>  Многие [!INCLUDE[ssISnoversion](../../../includes/ssisnoversion-md.md)] регистраторов иметь пользовательский интерфейс, который реализует <xref:Microsoft.SqlServer.Dts.Runtime.Design.IDtsLogProviderUI> и заменяет **конфигурации** текстовое поле в **Настройка журналов служб SSIS** диалоговое окно с фильтруемый раскрывающийся список доступных диспетчеров соединений. Однако пользовательские интерфейсы для пользовательских регистраторов не реализуются в службах [!INCLUDE[ssISnoversion](../../../includes/ssisnoversion-md.md)].  
  
### <a name="applying-the-dtslogprovider-attribute"></a>Применение атрибута DtsLogProvider  
 Примените к созданному классу атрибут <xref:Microsoft.SqlServer.Dts.Runtime.DtsLogProviderAttribute>, чтобы определить его в качестве регистратора. Этот атрибут содержит сведения для времени разработки, например, имя и описание регистратора. **DisplayName** и **описание** свойства атрибута соответствуют **имя** и **описание** столбцов, отображаемых в **Настройка журналов служб SSIS** редактора, который отображается при настройке ведения журнала для пакета в [!INCLUDE[ssBIDevStudioFull](../../../includes/ssbidevstudiofull-md.md)].  
