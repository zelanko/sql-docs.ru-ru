---
title: "Диспетчер соединений MSMQ | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "подключения [службы Integration Services], очереди сообщений"
  - "диспетчеры подключений [службы Integration Services], MSMQ"
  - "диспетчер соединений MSMQ"
  - "соединения очереди сообщений [службы Integration Services]"
