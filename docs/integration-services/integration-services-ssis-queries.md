---
title: "В службах Integration Services (SSIS) запросы | Документы Microsoft"
ms.custom: 
ms.date: 03/14/2017
...
Можно указать инструкцию SQL, одним из следующих способов:
1.   Введите его непосредственно в конструкторе.
2.   Укажите соединение с файлом содержит инструкцию.
3.   Укажите переменную, содержащую инструкцию.  
...
|**Запустите**|Выполняет запрос. Результаты отображаются на панели результатов.|  
