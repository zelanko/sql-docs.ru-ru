---
title: "Работа со службой CDC Oracle | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
|type|Содержит одно из следующих значений:<br /><br /> ERROR<br /><br /> INFO<br /><br /> TRACE|  
...
###  <a name="BKMK_dboxcbcdc_add_service"></a> dbo.xcbcdc_add_service(svcname,sqlusr)  
 ...
 Для использования процедуры **dbo.xcbcdc_add_service\<имя службы, имя пользователя>** пользователь должен быть членом роли **db_owner** указанной базы данных экземпляра CDC или членом одной из следующих предопределенных ролей сервера: **sysadmin** или **serveradmin**.  
