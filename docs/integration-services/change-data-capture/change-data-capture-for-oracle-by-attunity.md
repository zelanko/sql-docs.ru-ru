---
title: "Система отслеживания измененных данных для Oracle от Attunity | Документы Microsoft"
ms.custom: 
ms.date: 03/02/2017
...
---
# <a name="change-data-capture-for-oracle-by-attunity"></a>Система отслеживания измененных данных для Oracle от Attunity
Измененных данных для Oracle от Attunity загрузки включает в себя следующие компоненты 2.
...
-   [Служба Service для Oracle от Attunity для отслеживания измененных данных](../../integration-services/change-data-capture/change-data-capture-service-for-oracle-by-attunity.md)   

## <a name="get-the-change-data-capture-for-oracle-by-attunity-download"></a>Получить измененных данных для Oracle компании Attunity загрузки
