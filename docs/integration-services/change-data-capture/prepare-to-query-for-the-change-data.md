---
title: "Подготовка к запросу информации об изменениях | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "добавочная загрузка [службы Integration Services], подготовка запроса"
...
---
# Подготовка к запросу информации об изменениях
