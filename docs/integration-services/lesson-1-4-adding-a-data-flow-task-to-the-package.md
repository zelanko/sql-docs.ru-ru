---
title: "Шаг 4: Добавление задачи потока данных пакета | Документы Microsoft"
ms.custom: 
ms.date: 03/14/2017
...
---
# <a name="lesson-1-4---adding-a-data-flow-task-to-the-package"></a>Занятие 1-4-Добавление в пакет задачу потока данных
