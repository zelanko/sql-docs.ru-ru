---
title: "Занятие 3: Добавление ведения журнала с помощью служб SSIS | Документы Microsoft"
ms.custom: 
ms.date: 03/14/2017
...
Ведение журнала обеспечивается регистратором. Каждый регистратор может сохранять данные журналов в разных форматах и на разных типах носителей. Службы [!INCLUDE[ssISnoversion](../includes/ssisnoversion-md.md)] предоставляют следующие регистраторы:  
