---
title: "Контроль доступа для конфиденциальных данных в пакетах | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  ...
  - "уровни защиты для пакетов [службы Integration Services]"
  - "файлы конфигурации [Integration Services]"
  - "шифрование [службы Integration Services]"
  - "криптография [службы Integration Services]"
