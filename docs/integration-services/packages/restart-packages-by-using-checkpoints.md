---
title: "Перезапуск пакетов с помощью контрольных точек | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
