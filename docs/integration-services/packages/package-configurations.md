---
title: "Конфигурации пакета | Microsoft Docs"
ms.custom: ""
ms.date: "08/25/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "синтаксис конфигурации пакета [службы Integration Services]"
  ...
  - "синтаксис настройки [службы Integration Services]"
  - "косвенные конфигурации [службы Integration Services]"
  - "конфигурации [службы Integration Services]"
  - "прямые конфигурации [службы Integration Services]"
...
-   Нельзя использовать параметр **/ConfigFile** для загрузки конфигураций, которые заменяют параметры, указанные во время разработки.  
 ...
 Дополнительные сведения об этих параметрах и о различиях в их работе между службами [!INCLUDE[ssISCurrent](../../includes/ssiscurrent-md.md)] и более ранними версиями см. в разделе [Изменения в работе служб Integration Services в SQL Server 2016](../Topic/Behavior%20Changes%20to%20Integration%20Services%20Features%20in%20SQL%20Server%202016.md).  
