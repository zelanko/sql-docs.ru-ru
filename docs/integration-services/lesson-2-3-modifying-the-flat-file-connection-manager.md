...
2.  В окне **Свойства** щелкните пустую ячейку в области **Выражения**, а затем нажмите кнопку с многоточием **(...)**.  
  
3.  В диалоговом окне **Редактор выражений свойств** в столбце **Свойство** выберите **ConnectionString**.  
