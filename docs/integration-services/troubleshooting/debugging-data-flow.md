---
title: "Отладка потока данных | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  ...
  - "поток данных [службы Integration Services], отладка"
  - "отладка [службы Integration Services], поток данных"
  - "подсчет строк"
...
-   [Добавление средства просмотра данных к потоку данных](../../integration-services/troubleshooting/add-a-data-viewer-to-a-data-flow.md)  
