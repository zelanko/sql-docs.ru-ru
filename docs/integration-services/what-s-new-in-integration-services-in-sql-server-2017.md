...
-   **Горизонтальное увеличение масштаба**. Легко распределяйте выполнение пакетов SSIS между несколькими компьютерами с рабочей ролью и управляйте выполнениями и рабочими ролями с одного главного компьютера. Дополнительные сведения см. в разделе [Горизонтальное увеличение масштаба служб Integration Services](../integration-services/scale-out/integration-services-ssis-scale-out.md).
...
### <a name="new-and-changed-features-in-scale-out-for-ssis"></a>Новые и измененные функции в развертывании с горизонтальным увеличением масштаба для служб SSIS
...
-   Чтобы получить приложение для управления компонентом горизонтального увеличения масштаба SSIS, [скачайте SQL Server Management Studio (SSMS)](https://docs.microsoft.com/sql/ssms/download-sql-server-management-studio-ssms) 17.1 или более поздней версии.
...
### <a name="scale-out-for-ssis"></a>Горизонтальное увеличение масштаба для служб SQL Server Integration Services

Функция горизонтального увеличения масштаба значительно упрощает выполнение [!INCLUDE[ssIS_md](../includes/ssis-md.md)] на нескольких компьютерах. 
...
Дополнительные сведения см. в статье [Горизонтальное увеличение масштаба служб Integration Services](../integration-services/scale-out/integration-services-ssis-scale-out.md).
