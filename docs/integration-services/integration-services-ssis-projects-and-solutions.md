...
![Снимок экрана: папки проекта в обозревателе решений.](media/ssis-solution-explorer.png)
...
3.  В диалоговом окне **Создать проект** выберите раздел **Бизнес-аналитика** и шаблон **Проект Integration Services** .  
  ...
  ![Снимок экрана: диалоговое окно "Создать проект" с выделенным шаблоном "Проект Integration Services — Бизнес-аналитика".](media/ssis-ssdt-new-project.png)
