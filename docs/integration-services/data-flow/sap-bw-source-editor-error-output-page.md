---
title: "Редактор источников SAP BW (страница &#171;Вывод ошибок&#187;) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
---
# Редактор источников SAP BW (страница &#171;Вывод ошибок&#187;)
 ...
 **Столбец**  
 Просмотрите внешние (исходные) столбцы, выбранные на странице **Столбцы** диалогового окна **Редактор источников SAP BW**. Дополнительные сведения об этом диалоговом окне см. в разделе [Редактор источников SAP BW (страница "Столбцы")](../../integration-services/data-flow/sap-bw-source-editor-columns-page.md).  
