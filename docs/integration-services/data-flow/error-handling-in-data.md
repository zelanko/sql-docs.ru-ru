---
title: "Обработка ошибок в данных | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "03/04/2017"
...
helpviewer_keywords: 
  - "усечение данных"
  - "ошибки преобразования данных [службы Integration Services]"
  ...
  - "Поток данных [службы Integration Services], ошибки"
  - "Выражения [службы Integration Services], ошибки"
