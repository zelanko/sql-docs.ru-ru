---
title: "Сортировка данных для преобразований &#171;Слияние&#187; и &#171;Соединение слиянием&#187; | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "атрибуты сортировки [службы Integration Services]"
  - "выходные столбцы [службы Integration Services]"
