---
title: "Редактор диспетчера соединений с кэшем | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
-   [Вкладка «Общие»](../../../integration-services/data-flow/transformations/cache-connection-manager-editor.md#generaltab)  
  
-   [Вкладка «Столбцы»](../../../integration-services/data-flow/transformations/cache-connection-manager-editor.md#columnstab)  
