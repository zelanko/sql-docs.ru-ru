---
title: "Получение значений столбцов с помощью преобразования &#171;Производный столбец&#187; | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "столбцы [службы Integration Services]"
  - "производные столбцы"
  - "столбцы [службы Integration Services], значения"
