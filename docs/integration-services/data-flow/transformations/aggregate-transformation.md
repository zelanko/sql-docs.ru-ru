---
title: "Преобразование &#171;Статистическая обработка&#187; | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  - "IsBig, свойство"
  - "агрегатные функции [службы Integration Services]"
  - "преобразование «Статистическая обработка» [службы Integration Services]"
  - "данные большого объема, преобразования SSIS"
...
|---------------|-----------------|  
|Group by|Разделение наборов данных на группы. Для группирования могут быть использованы столбцы любого типа данных. Дополнительные сведения см. в разделе [GROUP BY (Transact-SQL)](../Topic/GROUP%20BY%20\(Transact-SQL\).md).|  
