---
title: "Преобразование &#171;Многоадресная доставка&#187; | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
helpviewer_keywords: 
  - "несколько выходов"
  - "преобразование «Многоадресная доставка»"
  - "наборы данных [службы Integration Services], несколько выходов"
...
## Настройка преобразования «Многоадресная доставка»  
 ...
 Сведения о свойствах, которые можно задать программно, см. в разделе [Common Properties](../Topic/Common%20Properties.md).  
