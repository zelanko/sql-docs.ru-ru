---
title: "Пользовательские свойства преобразований | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  ...
  - "преобразование «Счетчик строк», пользовательские свойства [службы Integration Services]"
  - "Преобразования [службы Integration Services], свойства"
  ...
  - "преобразование «Условное разбиение», пользовательские свойства [службы Integration Services]"
  - "пользовательские свойства [службы Integration Services]"
  - "преобразование «Аудит»"
  - "преобразование «Уточняющий запрос термина»"
  - "преобразование «Компонент скрипта», пользовательские свойства [службы Integration Services]"
  - "преобразование «Производный столбец»"
  - "преобразование «Команда OLE DB»"
  - "преобразование «Копирование столбцов», пользовательские свойства [службы Integration Services]"
  - "преобразование «Таблица символов», пользовательские свойства [службы Integration Services]"
...
# Пользовательские свойства преобразований
 ...
 Этот раздел содержит список и описание пользовательских свойств различных преобразований потока данных. Дополнительные сведения о свойствах, общих для большинства объектов потока данных, см. в разделе [Common Properties](../Topic/Common%20Properties.md).  
  
 Некоторые свойства преобразований можно устанавливать с помощью выражений свойств. Дополнительные сведения см. в разделе [Свойства потока данных, которые можно задавать с помощью выражений](../Topic/Data%20Flow%20Properties%20that%20Can%20Be%20Set%20by%20Using%20Expressions.md).  
...
|Свойство|Тип данных|Description|  
|--------------|---------------|-----------------|  
|Connectionmanager|Строковые значения|Определяет имя диспетчера соединений.|  
...
|AvailableInputColumns|Строковые значения|Список доступных входных столбцов.|  
|InputColumns|Строковые значения|Список выбранных входных столбцов.|  
|CacheColumnName|Строковые значения|Определяет имя столбца, сопоставленного с выбранным входным столбцом.<br /><br /> Имя столбца, указанное в свойстве CacheColumnName, должно быть согласовано с именем соответствующего столбца, указанным на странице **Столбцы** **редактора диспетчера соединений с кэшем**.<br /><br /> Дополнительные сведения см. в разделе [Cache Connection Manager Editor](../../../integration-services/data-flow/transformations/cache-connection-manager-editor.md).|  
...
|ParameterMap|Строковые значения|Разделенный точками с запятой список идентификаторов, соответствующих параметрам, использованным в инструкции **SqlCommand**.|  
|ReferenceMetaDataXML|Строковые значения|Метаданные для столбцов в таблице подстановки, которые преобразование копирует в свой выход.|  
|SqlCommand|Строковые значения|Инструкция SELECT, заполняющая таблицу уточняющих запросов.|  
|SqlCommandParam|Строковые значения|Параметризованная инструкция SQL, заполняющая таблицу уточняющих запросов.|  
...
|Свойство|Тип данных|Description|  
|--------------|---------------|-----------------|  
|CopyFromReferenceColumn|Строковые значения|Имя столбца в ссылочной таблице, из которого копируется данный столбец.|  
|JoinToReferenceColumns|Строковые значения|Имя столбца в ссылочной таблице, с которым соединен исходный столбец.|  
...
|Свойство|Тип данных|Description|  
|--------------|---------------|-----------------|  
|CurrentRowWhere|Строковые значения|Предложение WHERE в инструкции SELECT, которое позволяет выбрать текущую строку среди строк с одинаковыми бизнес-ключами.|  
...
|InferredMemberIndicator|Строковые значения|Имя столбца для выводимого элемента.|  
|SQLCommand|Строковые значения|Инструкция SQL, которая используется для создания набора строк схемы.|  
...
|OutTermColumn|Строковые значения|Имя столбца, содержащего термины-исключения.|  
|OutTermTable|Строковые значения|Имя таблицы, содержащей столбец с терминами-исключениями.|  
...
|RefTermColumn|Строковые значения|Имя столбца, содержащего термины уточняющего запроса.|  
|RefTermTable|Строковые значения|Имя таблицы, содержащей столбец с терминами уточняющего запроса.|  
...
## См. также  
 ...
 [Свойства потока данных можно задавать с помощью выражений](../Topic/Data%20Flow%20Properties%20that%20Can%20Be%20Set%20by%20Using%20Expressions.md)  
