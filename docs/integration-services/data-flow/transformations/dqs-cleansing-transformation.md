...
-   [Открытие, разблокировка, переименование и удаление проекта служб DQS](/sql-docs/docs/data-quality-services/open-unlock-rename-and-delete-a-data-quality-project)  
