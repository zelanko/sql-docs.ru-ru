---
title: "Преобразование &#171;Нечеткое группирование&#187; | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  ...
  - "столбцы [службы Integration Services], стандартизация"
  - "пороги подобия [службы Integration Services]"
  - "очистка данных [службы Integration Services]"
...
-   [Редактор преобразования "Нечеткое группирование" (вкладка "Диспетчер соединений")](../../../integration-services/data-flow/transformations/fuzzy-grouping-transformation-editor-connection-manager-tab.md)  
  
-   [Редактор преобразования "Нечеткое группирование" (вкладка "Столбцы")](../../../integration-services/data-flow/transformations/fuzzy-grouping-transformation-editor-columns-tab.md)  
  
-   [Редактор преобразования "Нечеткое группирование" (вкладка "Дополнительно")](../../../integration-services/data-flow/transformations/fuzzy-grouping-transformation-editor-advanced-tab.md)  
