---
title: "Редактор назначения &#171;SQL&#187; (страница &#171;Диспетчер соединений&#187;) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
# Редактор назначения &#171;SQL&#187; (страница &#171;Диспетчер соединений&#187;)
 ...
 Дополнительные сведения о назначении «SQL Server» см. в разделе [SQL Server Destination](../../integration-services/data-flow/sql-server-destination.md).  
