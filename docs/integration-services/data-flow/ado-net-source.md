---
title: "Источник ADO NET | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  - "ADO.NET, источник"
  - "источники [службы Integration Services], ADO.NET"
  - "источники [службы Integration Services], поставщик DataReader"
  - ".NET Framework, платформа [службы Integration Services]"
  - "DataReader, источник "
...
## Поддержка типов данных  
 ...
 Тип данных DT_NTEXT можно изменить на тип DT_WSTR, а DT_WSTR на DT_NTEXT. Типы данных меняются установкой свойства **DataType** в диалоговом окне **Расширенный редактор** источника ADO NET. Дополнительные сведения см. в статье [Common Properties](../Topic/Common%20Properties.md).  
