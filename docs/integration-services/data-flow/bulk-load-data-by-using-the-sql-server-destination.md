---
title: "Массовая загрузка данных с помощью назначения SQL Server | Документы Microsoft"
ms.custom: 
ms.date: 03/14/2017
