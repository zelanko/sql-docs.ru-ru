---
description: Пользовательские свойства источника «ODBC»
...
|TableName|Строка|Имя таблицы с данными, которая используется, если для AccessMode задано значение «Имя таблицы».|  
