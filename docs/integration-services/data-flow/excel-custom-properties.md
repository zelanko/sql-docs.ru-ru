---
description: Пользовательские свойства Excel
...
|OpenRowset|Строка|Если свойство AccessMode имеет значение **OpenRowset**, то это значение — имя таблицы или представления, к которому имеет доступ назначение "Excel".|  
|OpenRowsetVariable|Строка|Если свойство AccessMode имеет значение **OpenRowset из переменной**, то это имя переменной, содержащей имя таблицы или представления, к которому обращается назначение "Excel".|  
|SqlCommand|Строка|Если свойство AccessMode имеет значение **Команда SQL**, то это инструкция языка Transact-SQL, которую использует назначение "Excel" для указания целевых столбцов данных.|  
