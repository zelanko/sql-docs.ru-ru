---
title: "Источник &#171;Необработанный файл&#187; | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
helpviewer_keywords: 
  - "источники [службы Integration Services], необработанный файл"
  - "необработанные данные [службы Integration Services]"
...
## Настройка источника «Необработанный файл»  
...
## См. также  
 [Назначение «Необработанный файл»](../../integration-services/data-flow/raw-file-destination.md)   
