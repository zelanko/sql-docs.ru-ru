---
title: "Установление свойств компонента потока данных | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "компоненты [службы Integration Services], свойства"
...
### Задание свойств компонента потока данных с помощью редактора компонентов  
...
### Задание свойств компонента потока данных с помощью окна «Свойства»  
...
### Задание свойств компонента потока данных с помощью расширенного редактора  
