---
title: "Извлечение информации об изменениях с использованием источника CDC | Документы Microsoft"
ms.custom: 
ms.date: 03/14/2017
...
8.  Выберите режим обработки, который в наилучшей степени соответствует конкретным потребностям обработки. Возможными вариантами являются следующие.  
    ...
    -   **Суммарные с маской обновления**: этот режим аналогичен обычному режиму Net, но он также добавляет столбцы логических значений с шаблоном имени **__ $\<имя столбца >\__Changed** , указывающие на измененные столбцы в текущей строке изменения.  
