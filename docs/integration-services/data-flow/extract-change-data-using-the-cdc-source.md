---
title: "Извлечение информации об изменениях данных с помощью источника CDC | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
8.  Выберите режим обработки, который в наилучшей степени соответствует конкретным потребностям обработки. Возможными вариантами являются следующие.  
    ...
    -   **Суммарные с маской обновления**: этот режим аналогичен обычному режиму "Суммарные", но предусматривает также добавление столбцов логических значений с шаблоном имени **__$\<имя_столбца>\___Changed**, которые указывают измененные столбцы в текущей строке изменения.  
