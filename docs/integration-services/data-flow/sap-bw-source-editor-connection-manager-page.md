---
title: "Редактор источников SAP BW (страница &#171;Диспетчер соединений&#187;) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
---
# Редактор источников SAP BW (страница &#171;Диспетчер соединений&#187;)
...
## Динамические параметры режима выполнения  
  
> [!NOTE]  
>  Если вы не знаете все значения, необходимые для настройки источника, может потребоваться связаться с администратором SAP.  
  
### Режим выполнения = p — цепь обработки триггера.  
...
### Режим выполнения — W = Ожидать уведомления  
...
### Режим выполнения = E — только извлечение  
