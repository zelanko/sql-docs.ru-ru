 ...
 **Входной столбец**  
 Просмотрите входные столбцы, выбранные ранее в этом разделе. Сопоставления можно изменить с помощью списка **Доступные входные столбцы**. Выберите **\<ignore>** , чтобы исключить столбец из вывода.  
