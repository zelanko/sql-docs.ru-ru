---
title: "Пользовательские свойства OLE DB | Документы Microsoft"
ms.custom: 
ms.date: 03/04/2017
...
|OpenRowset|Строковые значения|Если свойство AccessMode имеет значение **OpenRowset**, то это значение — имя таблицы или представления, к которому имеет доступ назначение "OLE DB".|  
|OpenRowsetVariable|Строковые значения|Если свойство AccessMode имеет значение **OpenRowset из переменной**, то это имя переменной, содержащей имя таблицы или представления, к которому обращается назначение "OLE DB".|  
|SqlCommand|Строковые значения|Если свойство AccessMode имеет значение **Команда SQL**, то это инструкция языка Transact-SQL, которую использует назначение "OLE DB" для указания целевых столбцов данных.|  
