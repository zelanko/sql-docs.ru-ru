...
|BatchSize|Целочисленный|Размер пакета для массовой загрузки. Это количество записей, извлекаемых в виде массива. <br>Это свойство можно задать только в диалоговом окне **Расширенный редактор**.|
|DefaultCodePage|Целочисленный|Кодовая страница, которая используется, если для источника данных нет сведений о кодовой странице. <br>Это свойство можно задать только в диалоговом окне **Расширенный редактор**.|
|PreFetchCount|Целочисленный|Количество предварительно получаемых строк. <br>Это свойство можно задать только в диалоговом окне **Расширенный редактор**.|
