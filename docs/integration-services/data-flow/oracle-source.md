...
|PreFetchCount|Целочисленный|Число предварительно получаемых строк. <br>Это свойство можно задать только в диалоговом окне **Расширенный редактор**.|
