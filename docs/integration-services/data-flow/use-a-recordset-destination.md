---
description: использовать назначение «Набор записей»
...
[!INCLUDE[sqlserver-ssis](../../includes/applies-to-version/sqlserver-ssis.md)]
 ...
 Назначение «Набор записей» можно использовать во многих различных случаях. Ниже приводится несколько примеров.  
