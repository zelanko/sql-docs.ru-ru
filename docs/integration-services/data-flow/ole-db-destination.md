---
title: "Назначение «OLE DB» | Документы Microsoft"
ms.custom: 
ms.date: 03/14/2017
...
|----------------------|-----------------|  
|KILOBYTES_PER_BATCH|Устанавливает размер в килобайтах для вставки. Параметр имеет форму **KILOBYTES_PER_BATCH** = \<положительное целое значение**>**.|  
