---
title: "Пакеты служб Integration Services (SSIS) | Microsoft Docs"
ms.custom: ""
ms.date: "08/31/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "пакеты служб SQL Server Integration Services, о пакетах"
  - "пакеты [службы Integration Services], о пакетах"
  - "пакеты служб SSIS, о пакетах"
  - "пакеты служб SSIS"
  - "пакеты служб SQL Server Integration Services"
  - "контейнеры [службы Integration Services], пакеты"
  - "пакеты [службы Integration Services]"
  - "пакеты служб Integration Services, о пакетах"
...
-   [мастер импорта и экспорта SQL Server](SQL%20Server%20Import%20and%20Export%20Wizard.md)  
