---
title: "Идентификаторы (службы SSIS) | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "обычные идентификаторы [службы Integration Services]"
  - "переменные [службы Integration Services], выражения"
  - "идентификаторы [службы Integration Services]"
  - "выражения [службы Integration Services], переменные"
  - "идентификаторы журнала обращений и преобразований"
  - "столбцы [службы Integration Services], идентификаторы"
  - "имена [службы Integration Services]"
  - "выражения [службы Integration Services], идентификаторы"
  - "квалифицированные идентификаторы [службы Integration Services]"
...
## Уникальные имена переменных  
 ...
 Все переменные имеют область и принадлежат какому-нибудь пространству имен. Переменные могут иметь области пакета или контейнера либо задачи в пакете. Построитель выражений в конструкторе служб [!INCLUDE[ssIS](../../includes/ssis-md.md)] поддерживает только список переменных, принадлежащих к области. Дополнительные сведения см. в разделах [Переменные в службах Integration Services (SSIS)](../../integration-services/integration-services-ssis-variables.md) и [Использование переменных в пакетах](../Topic/Use%20Variables%20in%20Packages.md).  
