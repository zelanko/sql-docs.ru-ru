---
title: "Литералы (службы SSIS) | Microsoft Docs"
ms.custom: ""
ms.date: "03/23/2017"
...
helpviewer_keywords: 
  - "string literals"
  - "числовые литералы [службы Integration Services]"
  - "логические литералы"
  - "выражения [службы Integration Services], литералы"
  - "литералы [службы Integration Services]"
  - "сопоставление литералов [службы Integration Services]"
