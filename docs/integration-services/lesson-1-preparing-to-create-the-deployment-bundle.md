---
title: "Урок 1. Подготовка к созданию пакета развертывания | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
---
# Урок 1. Подготовка к созданию пакета развертывания
...
-   [Шаг 1. Создание рабочих папок и переменных среды](../integration-services/step-1-creating-working-folders-and-environment-variables.md)  
...
-   [Шаг 4. Добавление конфигурации пакета](../integration-services/step-4-adding-package-configurations.md)  
