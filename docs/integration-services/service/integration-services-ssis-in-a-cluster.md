---
title: "Службы Integration Services (SSIS) в кластере | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
## <a name="related-tasks"></a>Связанные задачи  
 Пошаговые инструкции по настройке службы Integration Services в кластере см. в разделе [Настройка служб Integration Services на работу в качестве ресурса кластера](../../integration-services/service/configure-the-integration-services-service-as-a-cluster-resource.md).  
