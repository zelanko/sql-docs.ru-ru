---
title: "Службы Integration Services (службы SSIS) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "службы Integration Services, о службах Integration Services"
  - "SQL Server Integration Services, службы"
  - "служба [службы Integration Services], о службах Integration Services"
  - "служба [службы Integration Services]"
  - "SQL Server Integration Services, службы"
...
## Тип запуска службы Integration Services  
