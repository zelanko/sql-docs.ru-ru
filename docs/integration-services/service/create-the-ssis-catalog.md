---
title: "Создание каталога служб SSIS | Microsoft Docs"
ms.custom: 
  - "ssisdev020617"
ms.date: "11/16/2016"
...
1.  Выполните следующий скрипт PowerShell.  
    ...
    ```  
     ...
     Дополнительные примеры использования Windows PowerShell и пространства имен <xref:Microsoft.SqlServer.Management.IntegrationServices> см. в записи блога [Службы SSIS и Powershell в SQL Server 2012](http://go.microsoft.com/fwlink/?LinkId=242539) на сайте blogs.msdn.com. Общие сведения о пространстве имен и примеры кода см. в записи блога [Обзор модели управляемых объектов каталога служб SSIS](http://go.microsoft.com/fwlink/?LinkId=254267)на сайте blogs.msdn.com.  
  
## См. также раздел  
 [Каталог служб SSIS](../../integration-services/service/ssis-catalog.md)   
