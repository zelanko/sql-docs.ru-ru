...
## <a name="get-the-files-you-need-to-connect-to-excel"></a>Получение файлов, необходимых для подключения к Excel
...
## <a name="excel-file-and-file-path"></a>Файл Excel и путь к нему
...
## <a name="first-row-has-column-names"></a>Первая строка содержит имена столбцов
...
## <a name="worksheets-and-ranges"></a>Листы и диапазоны
...
## <a name="issues-with-data-types"></a>Проблемы с типами данных
...
## <a name="issues-with-importing"></a>Проблемы с импортом
...
## <a name="issues-with-exporting"></a>Проблемы с экспортом
