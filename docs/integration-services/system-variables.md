---
title: "Системные переменные | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "контейнеры [службы Integration Services], переменные"
  - "задачи [службы Integration Services], переменные"
  - "системные переменные [службы Integration Services]"
  - "обработчики событий [службы Integration Services], переменные"
  - "переменные [службы Integration Services], система"
