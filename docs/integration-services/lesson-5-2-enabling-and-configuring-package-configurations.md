...
17. Мастер создаст файл конфигурации с именем SSISTutorial.dtsConfig, в котором содержатся настройки конфигурации для **значения** переменной, задающей свойство перечислителя **Directory**.  
