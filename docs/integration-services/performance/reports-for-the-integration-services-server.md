---
title: "Отчеты для сервера служб Integration Services | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
## См. также  
[Наблюдение за выполнением пакетов и других операций](../../integration-services/performance/monitor-running-packages-and-other-operations.md)
