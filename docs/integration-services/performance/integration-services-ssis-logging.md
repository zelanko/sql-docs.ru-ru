---
title: "В службах Integration Services (SSIS) ведения журнала | Документы Microsoft"
ms.custom: 
ms.date: 03/14/2017
...
4.  В **конфигурации** столбец, выберите диспетчер соединений или щелкните  **\<создать соединение >** для создания нового соединения диспетчера подходящего типа для регистратора. В зависимости от выбранного регистратора может использоваться один из следующих диспетчеров соединений.  
