---
title: "Пользовательские сообщения для ведения журнала | Microsoft Docs"
ms.custom: ""
ms.date: "08/26/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "журналы [службы Integration Services], пользовательские"
  - "запись строк журнала"
  - "пакеты служб SSIS, журналы"
  - "пользовательские сообщения для ведения журнала [службы Integration Services]"
