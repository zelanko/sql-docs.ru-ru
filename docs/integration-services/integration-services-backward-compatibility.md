...
## <a name="breaking-changes-to-integration-services-features-in-sql-server-2016"></a>Критические изменения в функциях служб Integration Services в SQL Server 2016
...
## <a name="behavior-changes-to-integration-services-features-in-sql-server-2016"></a>Изменения в работе служб Integration Services в SQL Server 2016
