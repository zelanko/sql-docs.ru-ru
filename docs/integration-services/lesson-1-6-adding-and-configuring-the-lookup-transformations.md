...
2.  Щелкните источник неструктурированного файла **Извлечь данные валют образца** и перетащите синюю стрелку на вновь добавленное преобразование **Уточняющий запрос**, соединив эти два компонента.  
