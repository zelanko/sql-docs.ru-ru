...
description: В этой статье описывается устранение распространенных неполадок в развертывании SSIS с горизонтальным увеличением масштаба.
