---
title: "Синтаксический анализ текстовых файлов нестандартного формата в компоненте скрипта | Документы Microsoft"
ms.custom: 
ms.date: 03/17/2017
...
1.  Создайте и сохраните текстовый файл с именем **rowdelimiteddata.txt** , содержащий следующие исходные данные:  
...
7.  Добавить задачу потока данных пакета и нажмите кнопку **потока данных** конструктора служб SSIS.  
  
8.  Добавьте к потоку данных источник «Неструктурированный файл» и настройте его на использование диспетчера соединений RowDelimitedData. На **столбцы** страница **Редактор источника неструктурированного файла**, выберите единственный доступный внешний столбец.  
...
10. Дважды щелкните компонент скрипта для отображения **редактор преобразования «скрипт»**.  
  
11. На **входные столбцы** страница **редактор преобразования «скрипт»**, выберите единственный доступный входной столбец.  
...
13. На **сценарий** страница **редактор преобразования «скрипт»**, нажмите кнопку **изменить скрипт** и введите код, показанный в **ScriptMain** класс объекта Пример. Закройте среду разработки скриптов и **редактор преобразования «скрипт»**.  
...
1.  Создайте и сохраните текстовый файл с именем **parentchilddata.txt** , содержащий следующие исходные данные:  
...
8.  Добавьте к потоку данных источник «Неструктурированный файл» и настройте его на использование диспетчера соединений ParentChildData. На **столбцы** страница **Редактор источника неструктурированного файла**, выберите единственный доступный внешний столбец.  
...
12. На **входы и выходы** страница **редактор преобразования «скрипт»**, выберите выход 0, переименуйте его в ParentRecords и задайте его **SynchronousInputID** значение None. Создайте 2 выходные столбцы:  
...
13. Создайте второй вывод и установите для него имя ChildRecords. **SynchronousInputID** нового выхода уже присвоено значение None. Создайте 3 выходных столбца.  
...
14. На **сценарий** страница **редактор преобразования «скрипт»**, нажмите кнопку **изменить скрипт**. В **ScriptMain** класса, введите код, показанный в примере. Закройте среду разработки скриптов и **редактор преобразования «скрипт»**.  
