---
title: "Шаг&#160;2. Добавление и настройка контейнера &quot;цикл по каждому элементу&quot; | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
manager: "jhubbard"
---
# Шаг&#160;2. Добавление и настройка контейнера &quot;цикл по каждому элементу&quot;
...
5.  В диалоговом окне **Выбор папки** выберите папку на компьютере, в которой находятся файлы Currency_*.txt.  
    ...
    3.  Щелкните ГИПЕРССЫЛКУ "http://msftisprodsamples.codeplex.com/downloads/get/578097" на файл SQL2012.Integration_Services.Create_Simple_ETL_Tutorial.Sample.zip.  
