---
title: "Обновление служб Integration Services | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "службы Integration Services, обновление"
  - "службы SSIS, обновление"
  - "службы SQL Server Integration Services, обновление"
...
# Обновление служб Integration Services
 ...
 Вместе с этой параллельной установкой устанавливается несколько версий программы dtexec. Чтобы убедиться в том, что запускается правильная версия программы, в командной строке запустите программу, введя полный путь (\<drive>:\Program Files\Microsoft SQL Server\\<version\>\DTS\Binn). Дополнительные сведения о программе dtexec см. в разделе [dtexec Utility](../../integration-services/packages/dtexec-utility.md).  
...
>   
>  Дополнительные сведения о других нерекомендуемых функциях см. в разделе [Нерекомендуемые возможности служб Integration Services в SQL Server 2016](../Topic/Discontinued%20Integration%20Services%20Functionality%20in%20SQL%20Server%202016.md).  
...
## Обновление служб Integration Services вместе с компонентом ядра СУБД до [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]  
...
## Обновление до [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]  
 В этом разделе описаны последствия, к которым может привести обновление со следующими критериями.  
