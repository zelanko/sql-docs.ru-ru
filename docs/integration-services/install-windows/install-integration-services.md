---
title: "Установка служб Integration Services | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "службы Integration Services, установка"
  - "SSIS, установка"
  - "установка служб Integration Services, об установке служб Integration Services"
  - "службы SQL Server Integration Services, установка"
  - "установка [службы Integration Services], об установке служб Integration Services"
  - "установка служб Integration Services"
  - "программа установки [службы Integration Services]"
...
>     
>  Инструкции о том, как предоставлять разрешения, см. в статье [Предоставление разрешений службам Integration Services](../../integration-services/service/grant-permissions-to-integration-services-service.md).    
