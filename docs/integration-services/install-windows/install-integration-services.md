...
>     
>  Инструкции о том, как предоставлять разрешения, см. в статье [Службы Integration Services (службы SSIS)](../../integration-services/service/integration-services-service-ssis-service.md).    
