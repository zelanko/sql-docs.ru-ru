...
#### <a name="column-length-distribution-profile---column-pane"></a>Профиль распределения длины столбцов — \<column> панель  
 **Минимальная длина**  
...
#### <a name="column-null-ratio-profile---column-pane"></a>Профиль соотношения значений NULL в столбцах — \<column> панель  
...
#### <a name="column-pattern-profile---column-pane"></a>Панель профиль шаблона столбца \<column>  
 **Число строк**  
 Отображает число строк в таблице или представлении.  
...
#### <a name="column-statistics-profile---column-pane"></a>Профиль статистики столбцов — \<column> панель  
 **Минимум**  
...
#### <a name="column-value-distribution-profile---column-pane"></a>Профиль распределения значений столбцов — \<column> панель  
...
#### <a name="candidate-key-profile---table-pane"></a>Профиль потенциальных ключей — \<table> область  
 **Ключевые столбцы**  
 ...
 **Число нарушений**  
 Отображает число строк, в которых определяющий столбец не определяет зависимый столбец. (Это строки, в которых зависимым значением является значение, показанное в **\<dependent column name>** столбце.)  
