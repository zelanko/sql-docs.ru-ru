...
|[КВАДРАТ &#40;выражение служб SSIS&#41;](square-ssis-expression.md)|Возвращает квадрат числового выражения.|  
...
|Компонент|Описание|  
|--------------|-----------------|  
|[Кодовая точка &#40;выражение служб SSIS&#41;](codepoint-ssis-expression.md)|Возвращает значение кода Юникод самого первого символа в символьном выражении.|  
...
|[НИЖНИЙ &#40;выражение служб SSIS&#41;](lower-ssis-expression.md)|Возвращает символьное выражение после преобразования всех символов верхнего регистра в нижний.|  
...
|[ОБРАТНЫЙ &#40;выражение служб SSIS&#41;](reverse-ssis-expression.md)|Возвращает символьное выражение в обратном порядке.|  
|[СПРАВА &#40;выражение служб SSIS&#41;](right-ssis-expression.md)|Возвращает указанное количество символов из крайней правой части заданного символьного выражения.|  
...
|[ОБРЕЗАТЬ &#40;выражение служб SSIS&#41;](trim-ssis-expression.md)|Возвращает символьное выражение после удаления начальных и конечных пробелов.|  
|[Верхний &#40;выражение служб SSIS&#41;](upper-ssis-expression.md)|Возвращает символьное выражение после преобразования символов в нижнем регистре в символы верхнего регистра.|  
