...
|[&#42;&#40;Умножить&#41; &#40;выражение служб SSIS&#41;](multiply-ssis-expression.md)|Умножает два числовых выражения.|  
|[Разделите &#40;выражение служб SSIS&#41;](divide-ssis-expression.md)|Делит первое числовое выражение на второе.|  
...
|[^ &#40;Побитового исключающего или&#41; &#40;выражение служб SSIS&#41;](bitwise-exclusive-or-ssis-expression.md)|Выполняет побитовую исключающую операцию ИЛИ для двух целочисленных значений.|  
...
|[&#62;&#40;Больше&#41; &#40;выражение служб SSIS&#41;](greater-than-ssis-expression.md)|Выполняет сравнение с целью определения, является ли первое выражение больше второго.|  
