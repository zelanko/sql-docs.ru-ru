---
title: Редактор диспетчера соединений (страница «Дополнительно») с несколькими неструктурированными файлами | Документация Майкрософт
ms.custom: ''
ms.date: 06/13/2017
...
|**TextQualified**|Указывает, обработаны ли текстовые данные символом ограничителя текста. Допустимые значения:<br /><br /> **Значение true,**: Текстовые данные в неструктурированном файле обработаны квалификатором.<br /><br /> **False**: Текстовые данные в неструктурированном файле не обработаны квалификатором.|  
|**Name**|Введите имя столбца. По умолчанию, используется нумерованный список столбцов, однако можно выбрать любое уникальное описательное имя.|  
