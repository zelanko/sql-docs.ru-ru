...
|**тексткуалифиед**|Указывает, обработаны ли текстовые данные символом ограничителя текста. Допустимые значения:<br /><br /> **True**: текстовые данные в неструктурированном файле являются полными.<br /><br /> **False**: текстовые данные в неструктурированном файле не являются полными.|  
