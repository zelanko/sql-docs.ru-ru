...
|[!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]Таблица|Таблица в базе данных [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] содержит конфигурацию. Таблица может включать несколько конфигураций.|  
