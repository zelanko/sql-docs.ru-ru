---
title: Создание нового проекта служб Integration Services | Документы Microsoft
ms.custom: ''
ms.date: 03/06/2017
...
8.  Нажмите кнопку **ОК** Чтобы добавить решение в **обозревателе**r и добавьте проект в решение.  
