 ...
 **Открытие страницы диспетчера соединений редактора источника ODBC**  
...
||**Имя таблицы или представления**: выберите доступную таблицу или представление из списка или введите регулярное выражение для обнаружения таблицы.|  
