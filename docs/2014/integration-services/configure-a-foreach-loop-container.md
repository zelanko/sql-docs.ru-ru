...
6.  При необходимости нажмите кнопку обзора **(...)** в текстовом поле **выражения** на странице **коллекция** , чтобы создать выражения, которые обновляют значения свойств. Дополнительные сведения см. в разделе [Добавление или изменение выражение свойства](expressions/add-or-change-a-property-expression.md).  
...
7.  При необходимости нажмите **Сопоставления переменной** для сопоставления свойств объектов со значениями коллекции, затем выполните следующие действия.  
    ...
    1.  В списке **переменные** выберите переменную или щелкните **\<New Variable>** , чтобы создать новую переменную.  
