...
## <a name="saving-a-package-programmatically"></a>Сохранение пакета программным образом  
 Чтобы сохранить пакет программным способом, вызовите один из следующих методов [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)] <xref:Microsoft.SqlServer.Dts.Runtime.Application> класса:  
