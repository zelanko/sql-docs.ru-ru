...
2.  В **редакторе задачи "Скрипт"** на вкладке **Скрипт** щелкните свойство **ReadOnlyVariables** и введите значение свойства одним из следующих способов:  
    ...
    -   Нажмите кнопку с многоточием (**...** ) рядом с полем свойства и в **Выбор переменных** диалоговом окне выберите `ExcelFile` переменной.  
...
3.  Щелкните свойство **ReadWriteVariables** и введите значение свойства одним из следующих способов:  
    ...
    -   Нажмите кнопку с многоточием (**...** ) рядом с полем свойства и в **Выбор переменных** диалоговом окне выберите `ExcelFileExists` переменной.  
...
2.  В **редакторе задачи "Скрипт"** на вкладке **Скрипт** щелкните свойство **ReadOnlyVariables** и введите значение свойства одним из следующих способов:  
    ...
    -   Нажмите кнопку с многоточием (**...** ) рядом с полем свойства и в **Выбор переменных** диалоговом окне выберите `ExcelTable` и `ExcelFile` переменные.  
...
3.  Щелкните свойство **ReadWriteVariables** и введите значение свойства одним из следующих способов:  
    ...
    -   Нажмите кнопку с многоточием (**...** ) рядом с полем свойства и в **Выбор переменных** диалоговом окне выберите `ExcelTableExists` переменной.  
