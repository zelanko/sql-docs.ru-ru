...
# <a name="working-with-excel-files-with-the-script-task"></a>Работа с файлами Excel в задаче "Скрипт"
 ...
 [Example1: Проверьте, существует ли файл Excel](#example1)  
  
 [Пример 2. Проверка наличия таблицы Excel](#example2)  
  
 [Пример 3. Получение списка файлов Excel в папке](#example3)  
  
 [Пример 4. Получение списка таблиц в файле Excel](#example4)  
  
 [Отображение результатов выборок](#testing)  
...
3.  **Операторы Imports**. Для большинства образцов кода необходимо импортировать одно из следующих пространств имен платформы [!INCLUDE[dnprdnshort](../../includes/dnprdnshort-md.md)] либо оба пространства в начале файла скрипта:  
...
##  <a name="example1"></a>Пример 1. Описание: Проверьте, существует ли файл Excel  
...
##  <a name="example2"></a>Пример 2. Описание: Проверка наличия таблицы Excel  
...
##  <a name="example3"></a>Пример 3. Описание: получение списка файлов Excel в папке  
...
##  <a name="example4"></a>Пример 4 Описание: получение списка таблиц в файле Excel  
...
##  <a name="testing"></a>Отображение результатов выборок  
