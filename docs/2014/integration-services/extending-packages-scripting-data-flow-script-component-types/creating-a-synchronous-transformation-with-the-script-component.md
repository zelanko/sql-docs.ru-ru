...
```
 ...
 В этом примере компонент скрипта создает методы **метод DirectRowTo \<OutputBufferX> ** , основываясь на именах настроенных выходов. Можно использовать аналогичный код для направления строк ошибок в имитированный вывод ошибок.
