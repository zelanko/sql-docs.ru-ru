...
2.  В окне заметки введите или вставьте копированием следующий текст.  
     ...
     **Поток данных извлекает данные из файла, находит значения в столбце CurrencyKey в таблице DimCurrency и столбец DateKey в таблице DimDate и записывает данные в таблицу NewFactCurrencyRate.**  
