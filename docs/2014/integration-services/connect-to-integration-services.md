---
title: Подключение к службам Integration Services | Документация Майкрософт
ms.custom: ''
ms.date: 06/13/2017
...
### <a name="to-open-connect-to-integration-services-service"></a>Чтобы установить соединение со службой Integration Services  
