...
1.  [Открытие диалогового окна «Настройка журналов служб SSIS»](#open_dialog)  
  
2.  [Настройка параметров на панели «контейнеры»](#container)  
  
3.  [Настройка параметров на вкладке Поставщики и журналы](#provider)  
  
4.  [Настройка параметров на вкладке «сведения»](#detail)  
  
##  <a name="open_dialog"></a>Открытие диалогового окна «Настройка журналов служб SSIS»  
...
##  <a name="detail"></a>Настройка параметров на вкладке «сведения»  
...
|**ИД**|Глобальный уникальный идентификатор (GUID) пакета, контейнера или задачи, в котором произошло записываемое в журнал событие.|  
...
|**Байты**|Зарезервирован для использования в будущем.|  
