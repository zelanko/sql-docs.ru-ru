...
##  <a name="open-the-configure-ssis-logs-dialog-box"></a><a name="open_dialog"></a>Открытие диалогового окна «Настройка журналов служб SSIS»  
...
##  <a name="configure-the-options-on-the-details-tab"></a><a name="detail"></a>Настройка параметров на вкладке «сведения»  
...
|Применение|Описание|  
|-----------|-----------------|  
|**Компьютерами**|Имя компьютера, на котором произошло записываемое в журнал событие.|  
