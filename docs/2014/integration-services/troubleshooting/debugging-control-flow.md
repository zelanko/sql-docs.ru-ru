...
ms.locfileid: "62926700"
---
# <a name="debugging-control-flow"></a>Отладка потока управления
  [!INCLUDE[ssBIDevStudioFull](../../../includes/ssbidevstudiofull-md.md)]и [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssISnoversion](../../../includes/ssisnoversion-md.md)] включают функции и средства, которые можно использовать для устранения неполадок в потоке управления [!INCLUDE[ssISnoversion](../../../includes/ssisnoversion-md.md)] в пакете.  
...
## <a name="breakpoints"></a>Точки останова  
 [!INCLUDE[ssIS](../../../includes/ssis-md.md)]Конструктор служб предоставляет диалоговое окно **Установка точек останова** , в котором можно задать точки останова, включив условия останова и указав количество случаев, когда выполнение пакета будет приостановлено. Точки останова могут быть установлены на уровне пакета или на уровне компонента. Если условия останова включены на уровне задачи или контейнера, рядом с задачей или контейнером в области конструктора на вкладке **поток управления** отображается значок точки прерывания. Если в пакете включены условия останова, на вкладке " **поток управления** " отображается значок точки прерывания.  
 ...
 [!INCLUDE[ssISnoversion](../../../includes/ssisnoversion-md.md)]предоставляет десять условий останова, которые можно включить для всех задач и контейнеров. В диалоговом окне **Задание точек останова** можно установить точки останова по следующим условиям.  
...
|Задача или контейнер получает событие `OnVariableValueChanged`.|Вызывается средой во время выполнения служб [!INCLUDE[ssISnoversion](../../../includes/ssisnoversion-md.md)] , когда изменяется значение переменной. Для вызова этого события RaiseChangeEvent переменной должно быть задано `true` значение.<br /><br /> **&#42;&#42; предупреждение &#42;&#42;** Переменная, связанная с этой точкой останова, должна быть определена в области **контейнера** . Если переменная определена в области пакета, точка останова не достигается.|  
...
## <a name="progress-reporting"></a>Отчет о состоянии  
 [!INCLUDE[ssIS](../../../includes/ssis-md.md)]Конструктор служб включает два типа отчетов о состоянии: выделение цветом в области конструктора на вкладке **поток управления** и сообщения о ходе выполнения на вкладке **выполнение** .  
...
## <a name="debug-windows"></a>Окна отладки  
 [!INCLUDE[ssBIDevStudioFull](../../../includes/ssbidevstudiofull-md.md)]содержит множество окон, которые можно использовать для работы с точками останова, а также для отладки пакетов, содержащих точки останова. Чтобы получить больше информации по каждому из окон, откройте окно и нажмите клавишу F1 для получения справки.  
