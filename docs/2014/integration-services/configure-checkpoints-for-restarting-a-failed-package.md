---
title: Настройка контрольных точек для повторного запуска при неудачном выполнении пакета | Документы Microsoft
ms.custom: ''
ms.date: 06/13/2017
...
5.  Значение свойства SaveCheckpoints `True`.  
...
8.  Настройте задачи и контейнеры, из которых пакет может быть перезапущен.  
    ...
    -   Свойство FailPackageOnFailure равно `True` для каждой выбранной задачи или контейнера.  
