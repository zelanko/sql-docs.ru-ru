...
1.  В **области элементов служб SSIS**разверните **узел Общие**и перетащите **компонент Скрипт** в область конструктора на вкладке **поток данных** . Поместите **Скрипт** справа от преобразования **Поиск ключа валюты** .  
...
9. В `Name` свойстве введите **ErrorDescription** и задайте `DataType` для свойства значение **строка Юникода [DT_WSTR]**.  
