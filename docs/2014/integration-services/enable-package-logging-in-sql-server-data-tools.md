...
4.  В столбце **Конфигурация** выберите Диспетчер соединений или щелкните **\<New connection>** , чтобы создать новый диспетчер соединений соответствующего типа для регистратора. В зависимости от выбранного регистратора может использоваться один из следующих диспетчеров соединений.  
