...
## <a name="specify-excel"></a>Укажите Excel
...
## <a name="excel-file"></a>Файл Excel и путь к файлу
...
## <a name="issues-exporting"></a>Проблемы при экспорте
...
[Импорт данных из Excel в SQL Server или базу данных SQL Azure](/sql/relational-databases/import-export/import-data-from-excel-to-sql)  
