...
description: Узнайте, как для импорта или экспорта данных Excel с SQL Server Integration Services (SSIS), а также условия, ограничения и известные проблемы.
ms.date: 04/10/2018
ms.prod: sql
