...
7.  В **плоский редактор диспетчера подключения файлов**в **имя диспетчера соединений** введите `Error Data`.  
...
9. В **откройте** диалоговом для **имя файла**, тип `ErrorOutput.txt`и нажмите кнопку **откройте**.  
