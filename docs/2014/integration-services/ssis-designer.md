...
ms.locfileid: "62766436"
---
# <a name="ssis-designer"></a>конструктор служб SSIS
  
  [!INCLUDE[ssIS](../includes/ssis-md.md)] Конструктор служб — это графическое средство, с помощью которого можно создавать и обслуживать пакеты служб [!INCLUDE[ssISnoversion](../includes/ssisnoversion-md.md)] . 
  [!INCLUDE[ssIS](../includes/ssis-md.md)] Конструктор служб доступен из среды [!INCLUDE[ssBIDevStudioFull](../includes/ssbidevstudiofull-md.md)] в составе проекта служб [!INCLUDE[ssISnoversion](../includes/ssisnoversion-md.md)] .  
...
### <a name="control-flow-tab"></a>Вкладка «Поток управления»  
 Поток управления в пакете создается в области конструктора на вкладке **поток управления** . Перетащите элементы из **области элементов** в область конструктора и соедините их с потоком управления, щелкнув значок элемента, а затем перетащив стрелку с одного элемента на другой.  
...
### <a name="data-flow-tab"></a>Вкладка «Поток данных»  
 Если в пакете содержится задача потока данных, в него можно добавлять потоки данных. Потоки данных в пакете создаются в области конструктора на вкладке **поток данных** . Перетащите элементы из **области элементов** в область конструктора и соедините их с потоком данных, щелкнув значок элемента, а затем перетащив стрелку с одного элемента на другой.  
...
##### <a name="connection-managers-area"></a>Область диспетчеров соединений  
 Добавление и изменение диспетчеров соединений, используемых пакетом, выполняется в области **Диспетчеры соединений** . 
  [!INCLUDE[ssISnoversion](../includes/ssisnoversion-md.md)] включает диспетчеры соединений, используемые для подключения к различным источникам данных, например текстовым файлам, базам данных OLE DB и поставщикам .NET.  
