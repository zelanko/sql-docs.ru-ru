 ...
 **Переменная источника объекта ADO **  
 Выберите определяемую пользователем переменную в списке или нажмите кнопку, \<**New variable...**> чтобы создать новую переменную.  
 ...
 **Соединение**  
 Выберите Диспетчер соединений ADO.NET в списке или щелкните, \<**New connection...**> чтобы создать новый диспетчер соединений ADO.NET.  
 ...
 **DocumentSource**  
 ...
 Если **DocumentSourceType** имеет значение **соединение с файлом**, выберите Диспетчер соединения файлов или щелкните, \<**New connection...**> чтобы создать новый диспетчер соединений.  
 ...
 **См. также:** [File Connection Manager](connection-manager/file-connection-manager.md), [File Connection Manager Editor](../../2014/integration-services/file-connection-manager-editor.md)  
 ...
 Если **DocumentSourceType** имеет значение **переменная**, выберите существующую переменную или нажмите кнопку, \<**New variable...**> чтобы создать новую переменную.  
...
|**Переменная**|В качестве источника задайте переменную, содержащую XML-документ.|  
 ...
 Если **OuterXPathStringSourceType** имеет значение **соединение с файлом**, выберите Диспетчер соединения файлов или щелкните, \<**New connection...**> чтобы создать новый диспетчер соединений.  
  
 **См. также:** [File Connection Manager](connection-manager/file-connection-manager.md), [File Connection Manager Editor](../../2014/integration-services/file-connection-manager-editor.md)  
  
 Если **OuterXPathStringSourceType** имеет значение **переменная**, выберите существующую переменную или нажмите кнопку, \<**New variable...**> чтобы создать новую переменную.  
...
|**Переменная**|В качестве источника задайте переменную, содержащую XML-документ.|  
 ...
 Если **InnerXPathStringSourceType** имеет значение **соединение с файлом**, выберите Диспетчер соединения файлов или щелкните, \<**New connection...**> чтобы создать новый диспетчер соединений.  
  
 **См. также:** [File Connection Manager](connection-manager/file-connection-manager.md), [File Connection Manager Editor](../../2014/integration-services/file-connection-manager-editor.md)  
  
 Если **InnerXPathStringSourceType** имеет значение **переменная**, выберите существующую переменную или нажмите кнопку, \<**New variable...**> чтобы создать новую переменную.  
 ...
 **Соединение**  
 Выберите существующий диспетчер соединений ADO.NET или щелкните, \<**New connection...**> чтобы создать новый диспетчер соединений.  
