 ...
 **Выражения**  
 Щелкните или разверните узел **Выражения** , чтобы посмотреть список существующих выражений свойств. Нажмите кнопку с многоточием **(...)** , чтобы добавить выражение свойства для свойства перечислителя, или измените и вычислите существующее выражение свойства.  
...
>   
>  Для указания файлов, включаемых в коллекцию, можно использовать выражение, развернув **выражения** на странице **коллекция** , выбрав свойство **FileSpec** , а затем нажав кнопку с многоточием (...), чтобы добавить выражение свойства. Дополнительные сведения о динамическом выборе указанных файлов см. в разделе [SSIS-динамическое задание файла mask: FileSpec](https://rajsudeep.blogspot.com/2010/09/ssisdynamically-set-file-mask-filespec.html)  
 ...
 **Переменная источника объекта ADO **  
 Выберите в списке определяемую пользователем переменную или нажмите кнопку \< **создать переменную...**>, чтобы создать новую переменную.  
 ...
 **Соединен**  
 Выберите Диспетчер соединений ADO.NET в списке или нажмите кнопку \< **создать соединение...**>, чтобы создать новый диспетчер соединений ADO.NET.  
 ...
 **DocumentSource**  
 Если **DocumentSourceType** имеет значение **Direct input**, укажите XML-код или нажмите кнопку с многоточием (...), чтобы указать XML с помощью диалогового окна **Document Source редактор**r.  
  
 Если **DocumentSourceType** имеет значение **соединение с файлом**, выберите Диспетчер подключения файлов или нажмите кнопку \< **создать соединение...**>, чтобы создать новый диспетчер соединений.  
 ...
 **См. также:** [File Connection Manager](connection-manager/file-connection-manager.md), [File Connection Manager Editor](../../2014/integration-services/file-connection-manager-editor.md)  
 ...
 Если **DocumentSourceType** имеет значение **переменная**, выберите существующую переменную или нажмите кнопку \< **создать переменную...**>, чтобы создать новую переменную.  
...
|**Переменная**|В качестве источника задайте переменную, содержащую XML-документ.|  
 ...
 Если **OuterXPathStringSourceType** имеет значение **соединение с файлом**, выберите Диспетчер подключения файлов или нажмите кнопку \< **создать соединение...**>, чтобы создать новый диспетчер соединений.  
  
 **См. также:** [File Connection Manager](connection-manager/file-connection-manager.md), [File Connection Manager Editor](../../2014/integration-services/file-connection-manager-editor.md)  
  
 Если **OuterXPathStringSourceType** имеет значение **переменная**, выберите существующую переменную или нажмите кнопку \< **создать переменную...**>, чтобы создать новую переменную.  
...
|**Переменная**|В качестве источника задайте переменную, содержащую XML-документ.|  
 ...
 Если **InnerXPathStringSourceType** имеет значение **соединение с файлом**, выберите Диспетчер подключения файлов или нажмите кнопку \< **создать соединение...**>, чтобы создать новый диспетчер соединений.  
  
 **См. также:** [File Connection Manager](connection-manager/file-connection-manager.md), [File Connection Manager Editor](../../2014/integration-services/file-connection-manager-editor.md)  
  
 Если **InnerXPathStringSourceType** имеет значение **переменная**, выберите существующую переменную или нажмите кнопку \< **создать переменную...**>, чтобы создать новую переменную.  
 ...
 **Соединен**  
 Выберите существующий диспетчер соединений ADO.NET или нажмите кнопку \< **создать соединение...**>, чтобы создать новый диспетчер соединений.  
