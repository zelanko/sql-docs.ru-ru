...
|**Свойство offlinemode**|Логическое|Указывает, работает ли пакет в режиме «вне сети». Режим «вне сети» не может запрашивать соединения к источникам данных.|  
...
|**Код ошибки**|Int32|Идентификатор ошибки.|Обработчик события OnError<br /><br /> Обработчик события OnInformation<br /><br /> Обработчик события OnWarning|  
...
|**ексекутионстатус**|Логическое|Текущее состояние выполнения.|Обработчик события OnExecStatusChanged|  
...
|**прогрессдескриптион**|String|Описание хода выполнения.|Обработчик события OnProgress|  
