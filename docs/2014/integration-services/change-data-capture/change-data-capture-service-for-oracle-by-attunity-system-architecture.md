...
|Конфигурация службы Oracle CDC Service. Это оснастка консоли управления (MMC), которая создает службу Windows и настраивает ее конфигурацию.|[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Клиент: Клиент SQL ADO.NET, поставляемое с .NET framework версии 4.|  
