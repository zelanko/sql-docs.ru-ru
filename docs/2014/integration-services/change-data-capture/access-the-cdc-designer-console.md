 ...
 **Шифровать соединение**  
 Выберите **шифровать соединение** для обмена данными между Oracle CDC Service и целевым [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] экземпляра по зашифрованному соединению. **Advanced**: Нажмите кнопку **Дополнительно** и при необходимости введите любые дополнительные свойства подключения в диалоговом окне "Дополнительные свойства подключения".  
