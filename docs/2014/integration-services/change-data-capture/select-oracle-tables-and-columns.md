...
-   **Экземпляр системы отслеживания**. Имя экземпляра системы отслеживания, который используется для именования объектов системы отслеживания измененных данных изменений с определенным экземпляром. Значение экземпляра отслеживания не может быть равно NULL.  
...
-   **Роль безопасности**. Имя шлюзовой роли базы данных используются для управления доступом для изменения данных.  
