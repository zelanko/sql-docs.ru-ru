 ...
 **Шаг 1. Разработка потока управления** В потоке управления в пакете необходимо определить следующие задачи.
...
-   Вычисление начального и конечного значения `datetime` для интервала изменений в исходных данных, которые необходимо получить.
     ...
     Дополнительные **сведения:**[Указание интервала для данных об изменениях](specify-an-interval-of-change-data.md)  
...
-   Определение готовности измененных данных в выбранном временном интервале. Этот шаг необходим потому, что процесс асинхронного сбора, возможно, еще не дошел до выбранной конечной точки.
     ...
     Дополнительные **сведения:**[Определение готовности измененных данных](determine-whether-the-change-data-is-ready.md)  
...
-   Подготовка строки запроса, которая будет использована для запроса измененных данных.
     ...
     Дополнительные **сведения:**[Подготовка к запросу данных об изменениях](prepare-to-query-for-the-change-data.md)  

 **Шаг 2. Настройка запроса на изменение данных** Создайте возвращающую табличное значение функцию, которая будет запрашивать данные.

 Для разработки и сохранения запроса используйте среду [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)] .

 Дополнительные **сведения:**[Получение и понимание измененных данных](retrieve-and-understand-the-change-data.md)  

 **Шаг 3. Проектирование потока данных** В потоке данных пакета необходимо определить следующие задачи.
...
-   Разбиение изменений на операции вставки, обновления и удаления для обработки.
     ...
     Дополнительные **сведения:**[Обработка вставок, обновлений и удалений](process-inserts-updates-and-deletes.md)  
...
-   Применение операций вставки, удаления и обновления к назначению.
     ...
     Дополнительные **сведения:**[применение изменений к назначению](apply-the-changes-to-the-destination.md)  
...
-   [Пример записи данных Readme_Change для указанного интервала](https://go.microsoft.com/fwlink/?LinkId=133507)

-   [Выборка данных Readme_Change с момента последнего запроса пакета](https://go.microsoft.com/fwlink/?LinkId=133508)
