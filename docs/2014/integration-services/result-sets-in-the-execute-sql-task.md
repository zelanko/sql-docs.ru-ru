---
title: Результирующие наборы в задача «Выполнение SQL» | Документы Microsoft
ms.custom: ''
ms.date: 06/13/2017
...
-   [Настройка результирующих наборов в редакторе Выполнение SQL задач](#Configure_result_sets)  
  
##  <a name="Result_set_type"></a> Указание результирующего набора  
...
##  <a name="Configure_result_sets"></a> Настройка результирующих наборов в задача «Выполнение SQL»  
