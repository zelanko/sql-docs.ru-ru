...
-   Если выбрать просмотр одного из пяти профилей столбцов, на панели запросов отображаются состоит из четырех столбцов: **Тип профиля**, **Таблица или представление**, **Столбец** и **Идентификатор запроса**.  
  
-   Если выбрать Просмотр профиля потенциальных ключей, на панели запросов отображаются состоит из четырех столбцов: **Тип профиля**, **Таблица или представление**, **Столбцы ключей** и **Идентификатор запроса**.  
  
-   Если выбрать Просмотр профиля функциональной зависимости, на панели запросов отображаются имеет пять столбцов: **Тип профиля**, **Таблица или представление**, **Определяющие столбцы**, **Зависимый столбец** и **Идентификатор запроса**.  
  
-   Если выбрать Просмотр профиля включения значений, на панели запросов отображаются имеет шесть столбцов: **Тип профиля**, **Таблица или представление подмножества**, **Таблица или представление надмножества**, **Побочные столбцы подмножества**, **Побочные столбцы надмножества** и **Идентификатор запроса**.  
