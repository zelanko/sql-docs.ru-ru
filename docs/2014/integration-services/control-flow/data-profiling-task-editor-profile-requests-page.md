...
-   Если выбрать Просмотр **все запросы**, на панели запросов содержит два столбца: **Тип профиля** и **идентификатор запроса**.  
  
-   Если выбрать просмотр одного из пяти профилей столбцов, на панели запросов отображаются четыре столбца: **Тип профиля**, **таблицы или представления**, **столбец**, и **идентификатор запроса**.  
  
-   Если выбрать просмотр профиля потенциальных ключей, на панели запросов отображаются четыре столбца: **Тип профиля**, **таблицы или представления**, **KeyColumns**, и **идентификатор запроса**.  
  
-   Если выбрать просмотр профиля функциональной зависимости, на панели запросов отображаются пять столбцов: **Тип профиля**, **таблицы или представления**, **определяющие столбцы**, **зависимого столбца**, и **идентификатор запроса**.  
  
-   Если выбрать просмотр профиля включения значений, на панели запросов отображаются шесть столбцов: **Тип профиля**, **таблицы подмножества или представления**, **представление или таблица надмножества**, **побочные столбцы подмножества**, **побочные столбцы надмножества**, и **идентификатор запроса**.  
