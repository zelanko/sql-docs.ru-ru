...
-   В окне **Переменные** создайте и настройте следующие две переменные пакета.  
    ...
    -   Введите имя, `ProfileConnectionName`, для одной из переменных и задать тип этой переменной значение **строка**.  
  
    -   Введите имя, `AddressLine2NullRatio`, для переменной и задайте тип этой переменной значение **двойные**.  
