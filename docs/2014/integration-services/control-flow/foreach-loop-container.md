...
# <a name="foreach-loop-container"></a>Контейнер «цикл по каждому элементу»
 ...
 В [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] [!INCLUDE[ssISnoversion](../../../includes/ssisnoversion-md.md)] доступны следующие типы перечислителей.  
...
-   Перечислитель файлов foreach ADLS для перечисления файлов в каталоге ADLS.
 ...
 ![Контейнер "цикл по каждому элементу", перечисляющий элементы папки](../media/ssis-foreachloop.gif "Контейнер "цикл по каждому элементу", перечисляющий элементы папки")  
