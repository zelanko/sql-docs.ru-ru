...
-   Укажите действие, которое задача выполняет при истечении времени ожидания запроса WMI. Вы можете регистрировать время ожидания и состояние после истечения времени ожидания или создать пользовательское [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)] событие, указывающее, что время ожидания события WMI истекло, и в нем регистрируется время ожидания и время ожидания.  
  
-   Определите, как задача реагирует на время ожидания. Задача может быть настроена на выполнение или сбой, или же задача может просто наблюдать за событием.  
