...
-   [Массовая вставка редактор задачи &#40;страница «соединение»&#41;](../bulk-insert-task-editor-connection-page.md)  
  
-   [Массовая вставка редактор задачи &#40;страница «Параметры»&#41;](../bulk-insert-task-editor-options-page.md)  
