...
## <a name="evaluation-operations"></a>Операции вычисления  
 [!INCLUDE[ssISnoversion](../../../includes/ssisnoversion-md.md)]предоставляет следующие операции оценки:  
