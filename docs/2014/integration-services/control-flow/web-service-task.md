...
## <a name="related-content"></a>См. также  
 ...
 Курируемый ответ [Consume Web Services in SSIS using Scripts](http://go.microsoft.com/fwlink/?LinkId=321996)(Использование веб-служб в SSIS с помощью скриптов) на curatedviews.cloudapp.net.  
