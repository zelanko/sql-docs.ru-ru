...
> [!NOTE]  
>  В этом разделе описывается только функции и требования задачи «профилирование данных». Пошаговое руководство по использованию задачи "Профилирование данных" см. в разделе [Задачи профилирования и просмотра данных](data-profiling-task-and-viewer.md).  
