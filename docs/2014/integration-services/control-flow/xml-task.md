...
|Слияние|Выполняет слияние двух XML-документов. Операция Merge берет исходный XML-документ в качестве основного и добавляет к нему содержимое второго документа. Можно задать место в основном документе, куда будут вставлены данные.|  
|Исправление|Добавляет в указанный в XML-документ выходной документ операции Diff (документ Diffgram), чтобы получился новый документ, включающий в себя содержимое документа Diffgram.|  
...
|**игнорексмлдекларатион**|Значение параметра указывает, нужно ли сравнивать XML-декларации.|  
|**игнореордерофчилделементс**|Значение параметра указывает, нужно ли сравнивать порядок дочерних элементов. Если этот параметр имеет значение `true`, то дочерние элементы, отличающиеся только по позиции одноуровневых элементов, считаются идентичными.|  
|**игноревхитеспацес**|Значение параметра указывает, нужно ли сравнивать пробелы.|  
|**игнорепроцессингинструктионс**|Значение параметра указывает, нужно ли сравнивать инструкции по обработке.|  
|**игноредтд**|Значение параметра указывает, нужно ли пропускать DTD.|  
...
-   [Проверка XML с помощью задачи «XML»](xml-task.md)  
  
-   [Страница "выражения"](../expressions/expressions-page.md)  
  
 Дополнительные сведения об установке этих свойств в конструкторе служб [!INCLUDE[ssIS](../../includes/ssis-md.md)] см. в следующем разделе.  
  
-   [Задание свойств задачи или контейнера](../set-the-properties-of-a-task-or-container.md)  
