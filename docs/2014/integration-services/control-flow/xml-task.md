...
|**IgnoreNamespaces**|Значение параметра указывает, нужно ли сравнивать URI пространства имен элемента и его имен атрибутов. Если этот параметр имеет значение `true`, два элемента, имеющие одинаковое локальное имя, но различные пространства имен, считаются идентичными.|  
...
### <a name="validation-operation"></a>Операция Validation  
 ...
 Включить `ValidationDetails` для получения подробных сведений об ошибках. Дополнительные сведения см. в разделе [Validate XML with the XML Task](xml-task.md).  
