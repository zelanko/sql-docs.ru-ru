...
## <a name="options"></a>Параметры  
 ...
 Чтобы переключиться в область конструктора, щелкните значок ![конструктора](../media/ssis-designicon.gif "Значок конструктора") .  
  
 Чтобы переключиться на панель запросов, щелкните значок ![SQL](../media/ssis-queryicon.gif "Значок SQL") .  
