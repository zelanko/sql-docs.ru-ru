...
-   **Символы** по умолчанию список **символы** содержит следующие символы: `,.;:-"'`~ = & / @!? [] () <>{}| #* ^ %`. For example, if the symbols are "`()-"», значение «(425) 123-4567» размечается следующим ["(","425",")», «123», «-«, «4567»,»)»].  
