...
8.  На странице Выбор типа конфигурации нажмите кнопку **Далее**.  
...
6.  На странице Выбор типа конфигурации выберите **XML-файл конфигурации** в списке **тип конфигурации** , выберите **Расположение конфигурации хранится в переменной среды** , введите `LoadXMLData` или выберите переменную `LoadXMLData` среды в списке.  
