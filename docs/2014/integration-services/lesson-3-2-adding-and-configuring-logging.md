...
4.  В **имя** введите `Lesson 3 Log File`.  
  
5.  При желании измените столбец **Описание**.  
  
6.  В **конфигурации** столбец, нажмите кнопку  **\<создать соединение >** для указания назначения, в который будут записываться сведения журнала.  
...
7.  В **выбрать файл** диалогового **имя файла** введите `TutorialLog.log`и нажмите кнопку **откройте**.  
...
13. На **поставщики и журналы** вкладке **имя** выберите `Lesson 3 Log File`. Как только будет создан регистратор для пакета, при желании можно отменить его выбор, чтобы временно прекратить регистрацию. При этом регистратор не надо удалять и создавать заново.  
