...
|**TextQualified**|Указывает, окружен ли текстовые данные символами-квалификаторами текста например кавычки. Допустимые значения:<br /><br /> **True**. Текстовые данные в неструктурированном файле обработаны квалификатором.<br /><br /> **False**. Текстовые данные в неструктурированном файле не обработаны квалификатором.|  
