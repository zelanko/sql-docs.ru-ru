...
###  <a name="BulkInsert"></a>Задача «инструкции по вставке»  
...
###  <a name="ExecuteDTS200"></a>Задача "выполнение служб DTS 2000"  
...
###  <a name="TransferDatabase"></a>Задача «перенос базы данных»  
...
###  <a name="TransferErrorMessages"></a>Задача "переносить сообщения об ошибках"  
...
###  <a name="TransferJobs"></a>Задача «перенос заданий»  
...
###  <a name="TransferLogins"></a>Задача «Перемещение имен входа»  
...
###  <a name="TransferMasterStoredProcedures"></a>Задача «перенос главных хранимых процедур»  
...
###  <a name="TransferSQLServerObjects"></a>Задача «перемещение SQL Server объектов»  
...
###  <a name="WebServices"></a>Задача «веб-службы»  
...
###  <a name="WMIEventWatcher"></a>Задача «наблюдатель событий WMI»  
