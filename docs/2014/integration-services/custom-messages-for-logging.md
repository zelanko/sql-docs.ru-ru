...
# <a name="custom-messages-for-logging"></a>Пользовательские сообщения для ведения журнала
 ...
 [Задача "выполнение служб DTS 2000"](#ExecuteDTS200)  
...
###  <a name="package"></a><a name="Package"></a>Пакеты  
...
###  <a name="bulk-insert-task"></a><a name="BulkInsert"></a>Задача «инструкции по вставке»  
...
###  <a name="transfer-database-task"></a><a name="TransferDatabase"></a>Задача «перенос базы данных»  
...
###  <a name="transfer-error-messages-task"></a><a name="TransferErrorMessages"></a>Задача "переносить сообщения об ошибках"  
...
###  <a name="transfer-jobs-task"></a><a name="TransferJobs"></a>Задача «перенос заданий»  
...
###  <a name="transfer-logins-task"></a><a name="TransferLogins"></a>Задача «Перемещение имен входа»  
...
###  <a name="transfer-master-stored-procedures-task"></a><a name="TransferMasterStoredProcedures"></a>Задача «перенос главных хранимых процедур»  
...
###  <a name="transfer-sql-server-objects-task"></a><a name="TransferSQLServerObjects"></a>Задача «перемещение SQL Server объектов»  
...
###  <a name="wmi-event-watcher-task"></a><a name="WMIEventWatcher"></a>Задача «наблюдатель событий WMI»  
