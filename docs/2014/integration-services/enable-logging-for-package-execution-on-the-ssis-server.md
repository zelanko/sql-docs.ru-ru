---
title: Включить ведение журнала для выполнения пакета на сервере служб SSIS | Документы Microsoft
ms.custom: ''
ms.date: 06/13/2017
