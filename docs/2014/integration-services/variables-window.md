...
> [!NOTE]  
>  Значения `Name` и `Namespace` свойства должно начинаться с буквы алфавита, в соответствии с определением стандарта Юникод 2.0 или символ подчеркивания (_). Далее могут следовать буквы или цифры по определению стандарта Юникод 2.0 или символ подчеркивания (\_).  
 ...
 **Value**  
 ...
 `Namespace`  
 Посмотреть имя пространства имен. Пользовательские переменные изначально создаются в **пользователя** пространства имен, но можно изменить имя пространства имен в `Namespace` поле. Для вывода этого столбца щелкните **Параметры сетки**.  
