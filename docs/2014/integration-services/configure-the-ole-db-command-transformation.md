...
6.  На вкладке **Диспетчеры соединений** выберите диспетчер соединений OLE DB в списке **Диспетчер соединений** . Дополнительные сведения см. в разделе [OLE DB Connection Manager](connection-manager/ole-db-connection-manager.md).  
...
## <a name="see-also"></a>См. также  
 [Преобразование «Команда OLE DB»](data-flow/transformations/ole-db-command-transformation.md)   
