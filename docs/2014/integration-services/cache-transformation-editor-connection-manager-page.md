...
# <a name="cache-transformation-editor-connection-manager-page"></a>Редактор преобразования «Кэш» (страница «Диспетчер соединений»)
 ...
 Чтобы больше узнать о преобразовании «Конвертация данных кэш», см. раздел [Cache Transform](data-flow/transformations/cache-transform.md).  
