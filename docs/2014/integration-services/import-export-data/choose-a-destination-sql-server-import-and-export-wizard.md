...
|с полями фиксированного размера;|Столбцы имеют фиксированную ширину.|  
 ...
 **Путь к файлу Excel**  
 Укажите путь и имя файла для книги, в которой должны храниться данные (например, К:\мидата.кслс, \\\салес\датабасе\норсвинд.кслс). Или нажмите кнопку **Обзор** , чтобы найти книгу.  
