...
|**Destination**|Отображает имя целевой таблицы.|  
...
|**Convert**|Указывает, следует ли продолжать планируемое преобразование.<br /><br /> Чтобы продолжить планируемое преобразование, установите этот флажок.<br /><br /> Чтобы отменить преобразование типа данных, снимите флажок.|  
...
|**При усечении**|Укажите порядок обработки усечений мастером:<br /><br /> Используйте параметр **On Truncate (Global)** .<br /><br /> завершить работу с ошибкой и прекратить процесс импорта или экспорта;<br /><br /> пропустить усечение.|  
