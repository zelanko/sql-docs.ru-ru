...
> [!NOTE]  
>  Если выбирается параметр «Копирование таблицы», необязательно копировать все столбцы таблицы. Выбрав целевую таблицу, нажмите кнопку изменить сопоставления, чтобы открыть диалоговое окно **сопоставления столбцов** . Выберите ** \<игнорировать>** в столбце **назначение** диалогового окна **сопоставления столбцов** для столбцов, которые необходимо пропустить.  
 ...
 **Изменить сопоставления**  
 Используйте диалоговое окно **сопоставления столбцов** , чтобы указать целевые столбцы для получения исходных данных. Можно скопировать только подмножество столбцов, выбрав \<пропустить> в столбце **назначение** диалогового окна **сопоставления столбцов** для столбцов, которые нужно пропустить.  
