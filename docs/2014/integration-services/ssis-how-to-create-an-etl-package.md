---
title: 'Учебник по службам SSIS: Создание простого ETL-пакета | Документы Microsoft'
ms.custom: ''
ms.date: 06/13/2017
