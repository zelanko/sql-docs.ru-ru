---
title: Руководство по службам SSIS. Создание простого ETL-пакета | Документация Майкрософт
ms.custom: ''
ms.date: 06/13/2017
...
---
# <a name="ssis-tutorial-creating-a-simple-etl-package"></a>Руководство по службам SSIS. Создание простого пакета ETL
