...
-   **/Rep[orting]** _уровень_ [ *;GUID_или_имя_события*[ *;GUID_или_имя_события*[...]]: Необязательный параметр. Определяет, какие типы сообщений включаются в отчет. Ниже приводятся доступные параметры отчета для *level* .  
