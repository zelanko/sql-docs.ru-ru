...
# <a name="execute-package-utility-dtexecui-ui-reference"></a>Программа выполнения пакетов справочника по пользовательскому интерфейсу (DtExecUI)
  ...
  **Программа выполнения пакетов** используется для запуска пакетов служб [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)] . Программа запускает пакеты, которые хранятся в одном из трех расположений: [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] база данных, [!INCLUDE[ssIS](../../includes/ssis-md.md)] хранилище пакетов и файловая система. Этот пользовательский интерфейс, который можно открыть [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)] или ввести `dtexecui` в командной строке, является альтернативой запуску пакетов с помощью программы командной строки **dtexec** .  
