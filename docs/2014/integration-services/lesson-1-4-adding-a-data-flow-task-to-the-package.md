...
3.  На **поток управления** область конструктора, щелкните правой кнопкой мыши добавленный **задачи потока данных**, нажмите кнопку **переименование**и измените имя на `Extract Sample Currency Data`.  
...
4.  Щелкните правой кнопкой мыши задачу потока данных, нажмите кнопку **свойства**и в окне «Свойства» убедитесь, что `LocaleID` свойству **английский (США)**.  
