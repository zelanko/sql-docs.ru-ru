---
title: Просмотр отчетов для сервера служб Integration Services | Документация Майкрософт
ms.custom: ''
ms.date: 06/13/2017
...
## <a name="see-also"></a>См. также  
 [Отчеты для сервера служб Integration Services](../../2014/integration-services/reports-for-the-integration-services-server.md)   
