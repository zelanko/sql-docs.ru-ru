...
-   [Как: Настройка пакет SQL Server Integration Services для Microsoft Dynamics AX](http://msdn.microsoft.com/library/bb986852)  
