 ...
 **Имя переменной**  
 Сопоставьте результирующий набор с переменной, выбрав переменную или нажав кнопку, \<**New variable...**> чтобы добавить новую переменную с помощью диалогового окна **Добавление переменной** .  
