...
6.  Выберите один из следующих выводов.  
    ...
    -   Удаление выходных данных: Выходные данные, в который направляются строки изменения DELETE.  
  
    -   Вывод вставки: Выходные данные, в который направляются строки изменения INSERT.  
  
    -   Вывод обновления. Вывод, где перед и после изменения UPDATE и строки изменения Merge строки направляются.  
