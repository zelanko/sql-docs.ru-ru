...
7.  В списке **производный столбец** выберите, **\<add as new column>** чтобы записать результат вычисления выражения в новый столбец, или выберите существующий столбец для обновления результатов оценки.  
