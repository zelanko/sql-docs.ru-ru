...
4.  Выберите тип изменения для каждого столбца.  
    ...
    -   **Изменяемый атрибут** перезаписывает существующие значения в записях.  
  
    -   **Атрибут с предысторией** создает новые записи вместо обновления существующих записей.  
  
    -   **Атрибут fixed** указывает, что значение столбца не должно изменяться.  
