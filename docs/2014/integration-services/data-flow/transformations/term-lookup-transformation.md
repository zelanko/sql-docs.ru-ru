...
|Выходные данные|Windows|  
 ...
 Преобразование «Уточняющий запрос термина» может сопоставлять существительные и субстантивные словосочетания, которые содержат специальные символы, и данные в ссылочной таблице также могут содержать эти символы. Ниже приведены специальные символы:%, @, &, $, #, \* ,:,;,.,,, **,** !,?, \<, > , +, =, ^, ~, |, \\ ,/, (,), [,], {,}, "и".  
