...
-   [Редактор преобразования запроса интеллектуального анализа данных &#40;вкладка модели интеллектуального анализа данных&#41;](../../data-mining-query-transformation-editor-mining-model-tab.md)  
