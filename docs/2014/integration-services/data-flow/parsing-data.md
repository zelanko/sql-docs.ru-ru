...
## <a name="types-of-parsing"></a>Типы синтаксического анализа  
 [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)] предоставляет два типа анализа для преобразования данных. Быстрый и стандартный синтаксический анализ.  
