...
-   Запись в блоге, [Подключение к Excel (XLSX) в SSIS](https://microsoft-ssis.blogspot.com/2014/02/connecting-to-excel-xlsx-in-ssis.html).  
