...
-   [Редактор источника «Excel» &#40;страницы диспетчера соединений&#41;](../excel-source-editor-connection-manager-page.md)  
  
-   [Редактор источника «Excel» &#40;страница «столбцы»&#41;](../excel-source-editor-columns-page.md)  
  
-   [Редактор источника «Excel» &#40;страницы вывода ошибок&#41;](../excel-source-editor-error-output-page.md)  
...
-   Запись в блоге [Using XLSX files in SSIS](http://go.microsoft.com/fwlink/?LinkId=233704), на сайте sqlservergeeks.com.  
