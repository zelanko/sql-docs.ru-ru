 ...
 **Входной столбец**  
 ...
 Для сопоставления другого входного столбца с тем же целевым столбцом выберите другой входной столбец в списке. Чтобы удалить сопоставление, выберите этот параметр, **\<ignore>** чтобы исключить входной столбец из выходных данных.  
