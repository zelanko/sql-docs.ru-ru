...
|OpenRowset|String|Если свойство AccessMode — `OpenRowset`, имя таблицы или представления, к которому обращается назначение Excel.|  
|OpenRowsetVariable|String|Если свойство AccessMode — `OpenRowset from Variable`, имя переменной, содержащей имя таблицы или представления, к которому обращается назначение Excel.|  
|SqlCommand|String|Если свойство AccessMode — `SQL Command`, инструкции Transact-SQL, который использует назначение «Excel» для указания целевых столбцов данных.|  
