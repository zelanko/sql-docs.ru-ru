...
7.  Выберите метод доступа к данным.  
    ...
    -   **Таблица или просмотреть — Быстрая загрузка** выберите таблицу или представление базы данных, содержащий данные, а затем определите параметры быстрой загрузки: **Сохранять ИД**, **сохранять значения null**, **блокировка таблицы**, **проверочное ограничение**, **строк в пакете**, или **максимальное фиксируемый размер вставок**.  
