...
-   **Построчный.** В этом режиме назначение ODBC подготавливает инструкцию INSERT с параметрами и использует задачу **Выполнение SQL** для поочередной вставки строк.  
