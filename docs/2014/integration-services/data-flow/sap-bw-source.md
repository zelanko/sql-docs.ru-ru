...
ms.locfileid: "62901077"
---
# <a name="sap-bw-source"></a>Источник SAP BW
  Источник SAP BW — это компонент источника Connector 1.1 для SAP BW [!INCLUDE[msCoName](../../includes/msconame-md.md)] . Таким образом, источник SAP BW извлекает данные из системы SAP NetWeaver BW версии 7 и делает эти данные доступными для потока данных в [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)] пакете.  
...
-   [Страница "&#40;столбцов" редактора источника SAP BW&#41;](sap-bw-source-editor-columns-page.md)  
