...
-   [Открытие мастера преобразования Integration Services проектов](#open_dialog)  
  
-   [Задание параметров на странице «Размещение пакетов»](#locate)  
...
-   [Задание параметров на странице «Выбор конфигураций»](#configurations)  
...
-   [Задание параметров на странице «Проверка»](#review)  
  
-   [Задание параметров для выполнения преобразования](#conversion)  
  
##  <a name="open_dialog"></a>Открытие мастера преобразования Integration Services проектов  
...
##  <a name="locate"></a>Задание параметров на странице «Размещение пакетов»  
...
##  <a name="configurations"></a>Задание параметров на странице «Выбор конфигураций»  
 ...
 **Удалить конфигурации из всех пакетов после преобразования**  
...
##  <a name="review"></a>Задание параметров на странице «Проверка»  
...
##  <a name="conversion"></a>Задание параметров для выполнения преобразования  
