 ...
 **Входной столбец**  
 Просмотрите входные столбцы, выбранные ранее в этом разделе. Сопоставления можно изменить с помощью списка **Доступные входные столбцы**. Выберите ** \<игнорировать>** , чтобы исключить столбец из выходных данных.  
