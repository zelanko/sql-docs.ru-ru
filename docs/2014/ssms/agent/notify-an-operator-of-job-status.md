...
4.  Если нужно оповещать оператора по электронной почте, установите флажок **Электронная почта**, выберите из списка оператора, а затем выберите одно из следующих значений:  
    ...
    -   **При** успешном выполнении задания уведомить оператора о завершении задания.  
  
    -   **Если задание не может** уведомить оператора о том, что задание завершилось неудачно.  
  
    -   **При завершении задания** , чтобы уведомить оператора, независимо от состояния завершения.  
