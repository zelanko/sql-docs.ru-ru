...
ms.locfileid: "62510958"
---
# <a name="job-step-properties-new-job-step-general-page"></a>Свойства шага задания: создание шага задания (страница "Общие")
  Эта страница используется для просмотра и изменения свойств [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] шага задания агента, а также для определения нового шага задания.  
 ...
 **Переопределить параметры перезапуска**  
...
## <a name="see-also"></a>См. также:  
 ...
 [Задания агент SQL Server для пакетов](../../integration-services/packages/sql-server-agent-jobs-for-packages.md)   
