...
||**TSX = 7.0**|**TSX = 8.0 &LT; SP3**|**TSX = 8.0 SP3 или более поздней версии**|**TSX = 9.0**|**TSX = 10.0**|**TSX = 10,5**|**TSX = 11.0**|  
|-|--------------------|---------------------------|----------------------------------|--------------------|--------------------|---------------------|---------------------|  
|**MSX = 7.0**|Да|Да|Нет|Нет|Нет|Нет|Нет|  
|**MSX = 8.0 &LT; SP3**|Да|Да|Нет|Нет|Нет|Нет|Нет|  
|**MSX = 8.0 SP3 или более поздней версии**|Нет|Нет|Да|Да|Да|Да|Да|  
...
|Описание|Раздел|  
|-----------------|-----------|  
|Описывает, как создать главный сервер.|[Создание главного сервера](make-a-master-server.md)|  
...
|Описывает, как исключить несколько целевых серверов из главного.|[Отключение нескольких целевых серверов от главного](defect-multiple-target-servers-from-a-master-server.md)|  
