...
-   **Чтобы создать SQL Server шаги задания с помощью Analysis Services команд и запросов, выполните следующие действия.**  
