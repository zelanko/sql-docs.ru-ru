...
6.  В поле **Просмотр отправленных пользователю уведомлений по**выберите **Предупреждения** , чтобы просмотреть список предупреждений, отправляемых этому оператору, либо **Задания** , чтобы просмотреть список заданий, отправляющих уведомления этому оператору. Выберите один или несколько перечисленных ниже флажков, чтобы определить метод уведомления для каждого из уведомлений при необходимости: **По электронной почте**, **пейджер**, или **Net send**.  
