...
# <a name="modify-a-sql-server-agent-master-job"></a>Изменение задания агента главного сервера SQL Server
  В следующих разделах описано, как изменить главное задание агента [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] .  
