...
ms.locfileid: "48143595"
---
# <a name="alert-properties-history-page"></a>Свойства предупреждения (страница журнала)
  Воспользуйтесь этой страницей для просмотра и изменения журнала предупреждений агента [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] .  
