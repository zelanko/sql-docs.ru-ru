...
## <a name="updating-job-steps-to-use-macros"></a>Обновление шагов заданий для использования маркеров  
 ...
 Скрипт см. в статье базы знаний [!INCLUDE[msCoName](../../includes/msconame-md.md)] 915845: [Шаги задания агента сервера SQL, использующие токены ошибкой в SQL Server 2005 с пакетом обновления 1](https://support.microsoft.com/kb/915845). Этот сценарий можно использовать, чтобы обновить все шаги задания, использующие токены с **ESCAPE_NONE** макрос. После применения этого скрипта рекомендуется как можно скорее просмотреть шаги заданий, в которых используются токены, и заменить макрос **ESCAPE_NONE** экранирующим макросом, который соответствует контексту шага задания.  
