---
title: Параметры (службы Analysis конструкторы конструкторы Общие) | Документация Майкрософт
ms.custom: ''
ms.date: 03/06/2017
...
ms.locfileid: "63283649"
---
# <a name="options-designers-analysis-services-designers-general"></a>Параметры (службы Analysis конструкторы конструкторы Общие)
