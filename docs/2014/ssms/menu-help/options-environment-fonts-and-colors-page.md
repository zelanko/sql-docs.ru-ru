...
|План выполнения|Изменения стиля, размера и параметров отображения шрифта для этого элемента повлияют на внешний вид текста в плане [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] выполнения запросов и [!INCLUDE[ssEW](../../includes/ssew-md.md)] .|  
 ...
 **Шрифт (полужирный тип обозначает шрифты фиксированной ширины)**  
