...
ms.locfileid: "62510323"
---
# <a name="save-as"></a>Сохранить как
  Используйте это диалоговое окно, чтобы сохранить экземпляр текущего элемента в указанном расположении и в файле указанного формата. Чтобы открыть это диалоговое окно, нажмите кнопку **сохранить** * \<файл>* **как** в меню **файл** (где * \<файл>* — имя текущего элемента) или нажмите клавиши ALT + F, A в редакторе кода.  
