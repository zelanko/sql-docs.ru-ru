 ...
 **Объекты, от которых** **зависит** _ \< выбранный объект>_      
 После нажатия этой кнопки на экран выводится список объектов, которые отслеживаются по зависимостям и зависят от выбранного объекта.  
  
 **Зависимости**  
 Если выбраны **объекты, зависящие** от _ \< выбранного объекта,>_ отображается иерархическое представление объектов, зависящих от выбранного объекта. Если щелкнуть **объекты** , от которых **зависит** _ \< выбранный объект>_ , отображается иерархическое представление объектов, от которых зависит выбранный объект.  
