 ...
 **Объекты, от которых***\<выбранного объекта >***зависит от обстоятельств**   
 После нажатия этой кнопки на экран выводится список объектов, которые отслеживаются по зависимостям и зависят от выбранного объекта.  
  
 **Зависимости**  
 Если **объектов, зависящих от**  *\<выбранного объекта >* — это нажатии Отображает иерархическое представление объектов, зависящих от выбранного объекта. Если **объекты, от которых**  *\<выбранного объекта >* **зависит от** — это нажатии Отображает иерархическое представление объектов, от которых зависит выбранный объект .  
