 ...
 **Выберите типы объектов**  
 Отображает список типов, к которым принадлежат выбираемые объекты. Типы включают в [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] себя субъекты уровня уровня и базы данных, а также защищаемые объекты. Это окно заполняется значениями, которые были выбраны в диалоговом окне **Выбор типов объектов** , доступном при нажатии кнопки **Тип объектов** .  
