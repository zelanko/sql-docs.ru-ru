...
3.  В [!INCLUDE[ssManStudio](../../includes/ssmanstudio-md.md)]щелкните правой кнопкой мыши узел в обозревателе объектов, наведите указатель на пункт **отчеты**и выберите пункт Пользовательские отчеты. В диалоговом окне **Открытие файла** перейдите в папку пользовательских отчетов, выберите файл отчета и нажмите кнопку **Открыть**.  
