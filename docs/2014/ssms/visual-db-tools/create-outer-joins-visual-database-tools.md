...
2.  Выберите линию соединение на панели Диаграмма, а затем в меню **конструктора запросов** выберите **пункт Выбрать все строки \<из>TableName **, выбрав команду, включающую таблицу, дополнительные строки которой необходимо включить.  
