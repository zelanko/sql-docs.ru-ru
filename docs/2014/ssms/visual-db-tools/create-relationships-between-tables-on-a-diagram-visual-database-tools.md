...
4.  **Имя связи** имеет предоставленное системой имя в формате FK_*локальнаятаблица*_*таблицавнешнегоключа*. Можно изменить это значение.  
...
7.  Нажмите кнопку **ОК**.  
     ...
     Открывается диалоговое окно **Связь по внешнему ключу** . **Выбранная связь** показывает созданную связь.  
