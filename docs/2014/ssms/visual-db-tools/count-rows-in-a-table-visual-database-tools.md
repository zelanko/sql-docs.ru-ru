...
3.  Выберите ** \* (все столбцы)** в прямоугольнике, представляющем таблицу или возвращающий табличное значение объект.  
...
3.  Выберите ** \* (все столбцы)** в прямоугольнике, представляющем таблицу или объект, структурированный табличным.  
