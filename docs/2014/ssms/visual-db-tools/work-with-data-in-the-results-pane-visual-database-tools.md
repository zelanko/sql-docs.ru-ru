...
-   Типы данных binary часто неудобны для людей, работающих с панелью результатов; их загрузка может занять огромное количество времени. Поэтому они представлены * \<двоичными данными>* или *null*.  
  
-   Сохранение точности и масштаба не всегда возможно. Например, панель результатов поддерживает точность 27. Если данные имеют тип данных с большей точностью, данные могут быть усечены или могут быть представлены с помощью * \<невозможности считать данные>*.  
