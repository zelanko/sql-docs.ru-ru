...
-   Типы данных binary часто неудобны для людей, работающих с панелью результатов; их загрузка может занять огромное количество времени. Поэтому они представлены  *\<двоичных данных >* или *Null*.  
  
-   Сохранение точности и масштаба не всегда возможно. Например, панель результатов поддерживает точность 27. Если данные являются типом данных с большей точностью, данные могут быть усечены или представлены как  *\<не удалось прочитать данные >*.  
