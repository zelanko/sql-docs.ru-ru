...
|**Значок линии подключения**|**Описание**|  
|------------------------|---------------------|  
...
|**Значок на конце линии объединения**|**Тип объединения**|  
|-----------------------------------|----------------------|  
...
-   **Предложение WHERE сравнивает столбцы в обеих таблицах**.   Предложение WHERE появляется тогда, когда база данных не поддерживает синтаксис JOIN (или если WHERE введено вручную). Если используется предложение WHERE для создания соединения, то названия обеих таблиц появляются в предложении FROM.  
