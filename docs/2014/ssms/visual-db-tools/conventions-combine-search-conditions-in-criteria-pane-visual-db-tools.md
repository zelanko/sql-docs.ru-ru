...
```  
 ...
 ![Приоритет предложений OR в области условий](../../database-engine/media//vs-criteriapane1.gif "Приоритет предложений OR в области условий")  
...
```  
 ...
 ![Связанные предложения OR в области условий](../../database-engine/media//vs-criteriapane3.gif "Связанные предложения OR в области условий")  
