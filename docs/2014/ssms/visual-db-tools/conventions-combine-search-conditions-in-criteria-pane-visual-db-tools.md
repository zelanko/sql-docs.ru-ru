...
```  
 ...
 ![Очередность предложений OR на панели критериев](../../database-engine/media//vs-criteriapane1.gif "Очередность предложений OR на панели критериев")  
...
```  
 ...
 ![Несколько предложений AND и OR на панели критериев](../../database-engine/media//vs-criteriapane2.gif "Несколько предложений AND и OR на панели критериев")  
...
```  
 ...
 ![Связанные предложения OR, определенные на панели критериев](../../database-engine/media//vs-criteriapane3.gif "Связанные предложения OR, определенные на панели критериев")  
