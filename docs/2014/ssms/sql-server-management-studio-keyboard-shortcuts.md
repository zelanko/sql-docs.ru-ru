...
# <a name="sql-server-management-studio-keyboard-shortcuts"></a>Сочетания клавиш среды SQL Server Management Studio
  Среда [!INCLUDE[ssManStudioFull](../includes/ssmanstudiofull-md.md)] предлагает пользователям две схемы сочетаний клавиш на выбор. По умолчанию используется [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)] схема с сочетаниями клавиш, основанными на [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] 2010. Среда [!INCLUDE[ssManStudio](../includes/ssmanstudio-md.md)] также предлагает схему сочетаний клавиш, аналогичную стандартной схеме из [!INCLUDE[ssKilimanjaro](../includes/sskilimanjaro-md.md)]. Чтобы изменить схему сочетаний клавиш или добавить новые сочетания клавиш, выберите в меню **Сервис** пункт **Параметры**. Выберите предпочтительную клавиатурную схему на вкладке **Среда**страницы **Клавиатура** .  
...
|Перейти к окну следующего средства|ALT + F6<br /><br /> или диспетчер конфигурации служб<br /><br /> F6 в редакторе запросов [!INCLUDE[ssDE](../includes/ssde-md.md)]|ALT + F6|  
...
|Перейти к окну, выбранному в предыдущий раз|SHIFT + ALT + F6<br /><br /> или диспетчер конфигурации служб<br /><br /> SHIFT + F6 в редакторе запросов [!INCLUDE[ssDE](../includes/ssde-md.md)]|SHIFT + ALT + F6|  
...
|Если текущая закладка размещена в папке, то будет осуществлен переход к следующей закладке в данной папке. Закладки, размещенные за пределами папки, пропускаются.<br /><br /> Если текущая закладка находится за пределами папки, то будет выполнен переход к следующей закладке на том же уровне.<br /><br /> Если окно «Закладки» содержит папки, то закладки в папках пропускаются.|CTRL + SHIFT + K, CTRL + SHIFT + N|Нет эквивалента|  
|Перейти к предыдущей закладке|CTRL + K, CTRL + P|CTRL + K, CTRL + P|  
|Если текущая закладка размещена в папке, то будет осуществлен переход к следующей закладке в данной папке. Закладки, размещенные за пределами папки, пропускаются.<br /><br /> Если текущая закладка находится за пределами папки, то будет выполнен переход к следующей закладке на том же уровне.<br /><br /> Если окно «Закладки» содержит папки, то закладки в папках пропускаются.|CTRL + SHIFT + K, CTRL + SHIFT + P|Нет эквивалента|  
...
|Отменить последнее действие по изменению кода|CTRL+Z<br /><br /> или диспетчер конфигурации служб<br /><br /> ALT + BACKSPACE|CTRL+Z|  
|Восстановить отмененное действие|CTRL + SHIFT + Z<br /><br /> или диспетчер конфигурации служб<br /><br /> CTRL+Y<br /><br /> или диспетчер конфигурации служб<br /><br /> ALT + SHIFT + BACKSPACE|CTRL + SHIFT + Z<br /><br /> или диспетчер конфигурации служб<br /><br /> CTRL+Y<br /><br /> или диспетчер конфигурации служб<br /><br /> ALT + SHIFT + BACKSPACE|  
|Сохранить выбранный элемент|CTRL+S|CTRL+S|  
|Сохранить все|CTRL + SHIFT + S|CTRL + SHIFT + S|  
|Закрыть|CTRL + F4|CTRL + F4|  
|Оператор print|CTRL + P|CTRL + P|  
|Выход|ALT + F4|ALT + F4|  
|Открытие текущего файла в браузере|CTRL + SHIFT + W|Нет эквивалента|  
...
|Отобразить диалоговое окно **Перейти к** .|CTRL + ЗНАК «ПЛЮС» (+)|Нет эквивалента|  
...
|Откройте [!INCLUDE[ssSqlProfiler](../includes/sssqlprofiler-md.md)].|CTRL + ALT + P|CTRL + ALT + P|  
...
|Удалить символ, расположенный слева от курсора|BACKSPACE<br /><br /> или диспетчер конфигурации служб<br /><br /> SHIFT +<br /><br /> BACKSPACE|BACKSPACE<br /><br /> или диспетчер конфигурации служб<br /><br /> SHIFT +<br /><br /> BACKSPACE|  
|Удаление пробела в выделенном блоке или удаление пробела, расположенного рядом с курсором, если ничего не выделено|CTRL + K, C|Нет эквивалента|  
...
|Перемещение строки, в которой находится курсор, под следующую строку|SHIFT + ALT + T|Нет эквивалента|  
|Применение расстановки отступов и форматирования интервалов к языку, заданному на языковой панели **Форматирование** раздела **Текстовый редактор** в диалоговом окне **Параметры** . Доступно только в текстовом редакторе.|CTRL + K, CTRL + D|Нет эквивалента|  
|Выполнение смещения выделенных строк кода в соответствии со строками, которые расположены рядом|CTRL + K, CTRL + F|Нет эквивалента|  
|Установка или удаление ярлыка в текущей строке|CTRL + K, CTRL + H|Нет эквивалента|  
|Удаление синтаксиса комментария из текущей строки|CTRL + K, CTRL + U|Нет эквивалента|  
|Отображение или скрытие пробелов и табуляций|CTRL + R, CTRL + W|Нет эквивалента|  
|Включение или отключение переноса слов в редакторе|Alt + F, CTRL + W|Нет эквивалента|  
|Сворачивание всех областей структуры для отображения в иерархии только внешних групп|CTRL + M, CTRL + A|Нет эквивалента|  
|Сворачивание текущей выделенной области структуры|CTRL + M, CTRL + S|Нет эквивалента|  
|Разворачивание всех областей структуры на странице|CTRL + M, CTRL + X|Нет эквивалента|  
|Разворачивание выделенной области структуры|CTRL + M, CTRL + E|Нет эквивалента|  
|Сворачивание существующих областей структуры|CTRL + M, CTRL + O||  
|Скрытие выделенного текста. Расположение скрытого текста помечается сигнальным значком|CTRL + M, CTRL + H|Нет эквивалента|  
|Переключение всех текстовых разделов, которые ранее были отмечены как скрытые, из скрытого состояния в отображаемое и наоборот.|CTRL + M, CTRL + L|Нет эквивалента|  
|Переключение выделенных текстовых разделов из скрытого состояния в отображаемое и наоборот.|CTRL + M, CTRL + M|Нет эквивалента|  
|Удаление всех содержащихся в документе структурных сведений|CTRL + M, CTRL + P|Нет эквивалента|  
|Удаление структурных сведений из выделенной области|CTRL + M, CTRL + U|Нет эквивалента|  
...
|Действие|[!INCLUDE[ssCurrent](../includes/sscurrent-md.md)]|[!INCLUDE[ssKilimanjaro](../includes/sskilimanjaro-md.md)]|  
|------------|-----------------------------|---------------------------------|  
|Вырезать (удалить выделенный элемент и поместить его в буфер обмена)|CTRL+X<br /><br /> или диспетчер конфигурации служб<br /><br /> SHIFTRLT + DELETE|CTRL+X<br /><br /> или диспетчер конфигурации служб<br /><br /> SHIFT + DELETE|  
|Вырезать все выделенные строки или текущую строку, если ничего не выделено.|CTRL + L<br /><br /> или диспетчер конфигурации служб<br /><br /> CTRL+SHIFT+L|Нет эквивалента|  
|Скопировать данные в буфер обмена|CTRL+C<br /><br /> или диспетчер конфигурации служб<br /><br /> CTRL + INSERT|CTRL+C<br /><br /> или диспетчер конфигурации служб<br /><br /> CTRL + INSERT|  
|Вставить данные из буфера обмена в позицию вставки|CTRL+V<br /><br /> или диспетчер конфигурации служб<br /><br /> SHIFT + INSERT|CTRL+V<br /><br /> или диспетчер конфигурации служб<br /><br /> SHIFT + INSERT|  
|Вставка элемента из буфера обмена в позицию ввода с его автоматическим выделением|CTRL + SHIFT + V<br /><br /> или диспетчер конфигурации служб<br /><br /> CTRL + enseSHIFT + INSERT|Нет эквивалента|  
  
## <a name="log-viewer-keyboard-shortcuts"></a>Сочетания клавиш средства просмотра журналов  
  
|Действие|[!INCLUDE[ssCurrent](../includes/sscurrent-md.md)]|[!INCLUDE[ssKilimanjaro](../includes/sskilimanjaro-md.md)]|  
|------------|-----------------------------|---------------------------------|  
|Обновить|Нет эквивалента|F5|  
|Переключаться между панелями **Выбор журналов** и **Сведения о файле журнала**|Нет эквивалента|F6,|  
|Перейти на панель **Сведения о файле журнала**|Нет эквивалента|ALT + S|  
|Загрузить новый журнал|Нет эквивалента|CTRL+SHIFT+L|  
|Экспортировать журнал|Нет эквивалента|CTRL + SHIFT + E|  
|Отфильтровать журнал|Нет эквивалента|CTRL + SHIFT + F|  
|Поиск в журнале|Нет эквивалента|CTRL + SHIFT + S|  
...
|Отображение сетки в области конструктора|ВВОД|Нет эквивалента|  
