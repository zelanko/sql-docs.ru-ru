---
title: Введение в SQL Server Management Studio для бизнес-аналитики | Документы Microsoft
ms.custom: ''
ms.date: 03/06/2017
...
## <a name="managing-analysis-services-solutions-using-sql-server-management-studio"></a>Управление решениями Analysis Services в среде SQL Server Management Studio  
 ...
 Дополнительные сведения об использовании [!INCLUDE[ssManStudioFull](../includes/ssmanstudiofull-md.md)], в разделе [проекта скриптов служб Analysis Services в SQL Server Management Studio](../analysis-services/instances/analysis-services-scripts-project-in-sql-server-management-studio.md).  
