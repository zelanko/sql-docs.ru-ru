...
|Значение не содержит|Допустимы только значения, которые не содержатся в операнде.|Пример операнда: A1<br /><br /> Допустимые значения: 1A, AA<br /><br /> Недопустимые значения: A1, AA1|  
...
|Значение является датой/временем|Допустимы только значения с типом данных «дата-время» SQL Server, в том числе datetime, time, date и т. д.|Пример операнда: Н/Д<br /><br /> Допустимые значения: 1916-06-04; 1916-06-04 18:24:24; 21 марта 2001 г.; 18 17.05.2011; 18:24:24<br /><br /> Недопустимые значения: March 213, 2006 г.|  
