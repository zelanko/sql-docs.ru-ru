...
4.  В контекстном меню вы можете выбрать следующее:  
    ...
    2.  **Разблокировать**. Вы можете разблокировать базу знаний, если вы являетесь пользователем, который работал над базой знаний, в одном из этапов управления доменами, обнаружения знаний и действия политики сопоставления и закрыли ее. Если вы выгрузите базу знаний, другой пользователь сможет открыть ее и работать с ней. Эта команда недоступна, если база знаний не находится в состоянии деятельности. Дополнительные сведения см. в разделе [Open a Knowledge Base](../../2014/data-quality-services/open-a-knowledge-base.md).  
