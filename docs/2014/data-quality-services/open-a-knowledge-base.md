...
-   **Управление доменами**: данные были введены для домена в базе знаний, но база знаний не была опубликована, и работа остается в действии управления доменами. Действия с набором знаний недоступны. Это происходит в том случае, если была нажата кнопка **Закрыть** на экране **Управление доменами** .  
