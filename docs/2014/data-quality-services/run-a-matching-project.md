...
1.  На **Экспорт** выберите место для экспорта в соответствующие данные назначения **конечный тип**: **SQL Server**, **CSV-файл**, или **файл Excel**.  
...
-   **Новый**: Количество новых сопоставлений и их процентная доля от общего количества  
