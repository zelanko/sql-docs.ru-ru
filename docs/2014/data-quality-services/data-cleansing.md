...
##  <a name="computer-assisted-cleansing"></a><a name="ComputerAssisted"></a> Автоматическая очистка  
...
##  <a name="interactive-cleansing"></a><a name="Interactive"></a> Интерактивная очистка  
...
##  <a name="leading-value-correction"></a><a name="Leading"></a> Исправление начального значения  
...
##  <a name="standardize-cleansed-data"></a><a name="Standardize"></a> Стандартизация очищенных данных  
...
##  <a name="related-tasks"></a><a name="Related"></a> Связанные задачи  
