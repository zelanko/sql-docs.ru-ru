...
-   **Очистка**с помощью компьютера. службы DQS используют набор знаний из выбранной базы знаний для проекта очистки, чтобы предложить исправления и предложения для значений в источнике данных.  
  
-   **Интерактивная очистка**. Диспетчер данных может выполнить интерактивный процесс очистки, чтобы изменить или дополнить исправления данных, которые были предложены процессом очистки данных с помощью компьютера. Диспетчер данных делает это с помощью уровней достоверности и статистики, определенной процессом очистки данных, или путем ввода вручную собственных изменений проекта.  
...
##  <a name="Admin"></a>Основные понятия администрирования качества данных  
