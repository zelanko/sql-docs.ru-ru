...
-   **Автоматическая очистка**. Службы DQS используют набор знаний из выбранной базы знаний для проекта очистки, чтобы предложить исправления и предложения для значений в источнике данных.  
