...
1.  **Настройка сведений о поставщиках ссылочных данных в DQS**. Прежде чем можно будет использовать справочные данные в DQS, необходимо настроить сведения о службе ссылочных данных в DQS.  
...
2.  **Сопоставление домена/составного домена в базе знаний со службой ссылочных данных**. Сопоставьте домен или составной домен с соответствующей службой ссылочных данных, подписанной или добавленной на шаге 1.  
