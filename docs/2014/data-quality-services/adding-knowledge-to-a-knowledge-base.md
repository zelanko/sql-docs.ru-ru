...
-   Дополнительные сведения в документации см. в разделе [изменение значений домена](../../2014/data-quality-services/change-domain-values.md).  
...
-   Дополнительные сведения в документации см. в разделе [с помощью базы знаний DQS по умолчанию](../../2014/data-quality-services/using-the-dqs-default-knowledge-base.md).  
