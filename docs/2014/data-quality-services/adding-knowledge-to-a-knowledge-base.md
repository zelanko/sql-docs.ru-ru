...
-   [Импорт набора знаний из проекта обратно в базу знаний](#Project)  
  
-   [Использование базы знаний DQS по умолчанию](#Default)  
  
##  <a name="Discovery"></a>Выполнить обнаружение знаний  
...
##  <a name="Project"></a>Импорт набора знаний из проекта обратно в базу знаний  
