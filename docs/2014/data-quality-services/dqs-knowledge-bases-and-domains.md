...
##  <a name="Matching"></a> Сопоставление данных  
 ...
 Дополнительные сведения о базе знаний и сопоставлении данных см. в разделе [Data Matching](../../2014/data-quality-services/data-matching.md).  
