...
|**Дочерние элементы**|[Элемент DTAInput &#40;DTA&#41;](dtainput-element-dta.md)<br /><br /> `DTAOutput` Элемент (см. [схеме XML помощника по настройке ядра СУБД](http://schemas.microsoft.com/sqlserver/) сведения)|  
...
## <a name="see-also"></a>См. также  
 [Входные XML-ссылку на файл &#40;помощник по настройке компонента Database Engine&#41;](xml-input-file-reference-database-engine-tuning-advisor.md)   
