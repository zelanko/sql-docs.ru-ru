...
|/CTLRSTARTUPTYPE<br /><br /> **Необязательно**|Тип запуска службы контроллера распределенного воспроизведения.|Автоматически<br /><br /> Отключен<br /><br /> Вручную|  
...
|/CLTSTARTUPTYPE<br /><br /> **Необязательно**|Тип запуска службы клиента распределенного воспроизведения.|Автоматически<br /><br /> Отключен<br /><br /> Вручную|  
