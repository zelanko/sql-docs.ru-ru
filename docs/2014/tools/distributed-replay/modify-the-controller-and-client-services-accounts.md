...
3.  В окне ** [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] свойства контроллера распределенное воспроизведение** на вкладке **Вход** в систему выберите **Эта учетная запись**, введите или нажмите кнопку **Обзор** , чтобы ввести новую учетную запись входа, а затем нажмите кнопку **ОК**.  
...
3.  В окне ** [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] свойства клиента распределенное воспроизведение** на вкладке **Вход** в систему выберите **Эта учетная запись**, введите или нажмите кнопку **Обзор** , чтобы ввести новую учетную запись входа, а затем нажмите кнопку **ОК**.  
