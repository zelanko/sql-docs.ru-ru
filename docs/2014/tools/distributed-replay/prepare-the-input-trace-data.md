...
2.  **Запуск этапа предварительной обработки**: Для подготовки входных данных трассировки, необходимо запустить средство администрирования с **предварительной обработки** параметр. Дополнительные сведения см. в разделе [Параметр предварительной обработки (средство администрирования распределенного воспроизведения)](preprocess-option-distributed-replay-administration-tool.md).  
