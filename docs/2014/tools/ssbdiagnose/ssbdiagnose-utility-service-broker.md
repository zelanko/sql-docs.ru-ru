 ...
 **TO SERVICE** *имя_службы*[, *идентификатор\_брокера* ]  
 ...
 **-TIMEOUT** *интервал_времени_ожидания*  
