...
-   Если условия фильтрации установлены в столбцах данных **StartTime** и **EndTime** на вкладке «Выбор событий», убедитесь в том, что выполняются следующие условия:  
    ...
    -   В диалоговом окне **Общие параметры** **следует использовать региональные параметры для вывода значений даты и времени** . Чтобы открыть диалоговое окно **Общие параметры** , в меню [!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)] **приложения** выберите пункт **Параметры**.  
