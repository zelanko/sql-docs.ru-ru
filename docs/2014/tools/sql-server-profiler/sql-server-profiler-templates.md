...
## <a name="default-template"></a>Шаблон по умолчанию  
 ...
 Чтобы перейти в диалоговое окно **Свойства шаблона трассировки**, в меню [!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)]Файл**в** выберите пункт **Шаблоны**, а затем выберите пункт **Создать шаблон** или **Изменить шаблон**.  
