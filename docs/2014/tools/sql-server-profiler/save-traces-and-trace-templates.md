 ...
 **Сохранение трассировки в файле**  
 ...
 [Сохранение результатов трассировки в файл &#40;SQL Server Profiler&#41;](save-trace-results-to-a-file-sql-server-profiler.md)  
