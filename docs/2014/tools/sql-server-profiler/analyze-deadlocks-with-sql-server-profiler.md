...
## <a name="deadlock-graphs"></a>Графы взаимоблокировок  
 ...
 Ребро  
 Связь между процессом и ресурсом. Объект `request` возникает, когда процесс ожидает ресурса. `owner` Возникает, когда ресурс ожидает процесс. В описание ребра включен режим блокировки. Например, **Режим: X**.  
