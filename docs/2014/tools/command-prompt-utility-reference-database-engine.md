...
|[Приложение sqlagent90](sqlagent90-application.md)|Используется для запуска агента [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] из командной строки.|\<drive>: \Program Files\Microsoft SQL Server \\ < *instance_name*> \MSSQL\Binn|  
