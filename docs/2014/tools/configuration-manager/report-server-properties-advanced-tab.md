...
# <a name="report-server-properties-advanced-tab"></a>Свойства сервера отчетов (вкладка «Дополнительно»)
  Эта служба — [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]. Если определены пользовательские свойства, они отображаются на этой вкладке вместе со значениями.  
