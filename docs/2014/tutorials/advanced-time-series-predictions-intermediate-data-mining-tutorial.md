...
1.  [Подготовка расширенных данных о продажах (для прогнозирования)](#bkmk_newExtendData)  
  
2.  [Подготовка агрегированных данных (для создания модели)](#bkmk_newReplaceData)  
  
3.  [Подготовка данных ряда (для перекрестного прогнозирования)](#bkmk_CrossData2)  
  
4.  [Прогнозирование с помощью расширения](../../2014/tutorials/time-series-predictions-using-updated-data-intermediate-data-mining-tutorial.md)  
...
6.  [Прогнозирование с помощью функции Replace](../../2014/tutorials/time-series-predictions-replacement-data-intermediate-data-mining.md)  
  
7.  [Обзор новых прогнозов](../../2014/tutorials/comparing-predictions-for-forecasting-models-intermediate-data-mining-tutorial.md)  
  
##  <a name="bkmk_newExtendData"></a>Создание новых данных расширенных продаж  
...
###  <a name="bkmk_newReplaceData"></a>Создание представления источника данных с помощью новых данных о продажах  
...
7.  В диалоговом окне **Создание именованного запроса** в поле **имя**, `AllRegions`тип и **Описание**введите **Sum и Average для продаж по всем моделям и регионам**.  
...
9. Щелкните `AllRegions` правой кнопкой мыши таблицу и выберите **Просмотр данных**.  
  
###  <a name="bkmk_CrossData"></a>Создание данных ряда для перекрестного прогнозирования  
...
2.  В окне мастера представлений источников данных выберите указанные ниже элементы.  
     ...
     **Выбор таблиц и представлений**: Не выбирайте таблицы  
...
## <a name="next-task-in-lesson"></a>Следующая задача занятия  
 [Прогнозирование временных рядов с использованием &#40;обновленного учебника по интеллектуальному анализу данных&#41;](../../2014/tutorials/time-series-predictions-using-updated-data-intermediate-data-mining-tutorial.md)  
