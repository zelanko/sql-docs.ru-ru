---
title: Дополнительные прогнозы временных рядов (учебник по интеллектуальному анализу данных — средний) | Документы Microsoft
ms.custom: ''
ms.date: 06/13/2017
...
##  <a name="bkmk_newExtendData"></a> Создание расширенных данных о продажах  
...
4.  В области конструктора представления источника данных щелкните правой кнопкой мыши NewSalesData и выберите **Просмотр данных** для проверки правильности данных.  
...
6.  После этого щелкните правой кнопкой мыши область конструктора представления источника данных и выберите **новым именованным запросом**.  
  
7.  В **Создание именованного запроса** диалоговом для **имя**, тип `AllRegions`и для **описание**, тип **сумма и среднее значение продаж для всех моделей и области**.  
...
4.  Щелкните правой кнопкой мыши по пустой области конструктора **T1000 Pacific Region.dsv**, а затем выберите **новым именованным запросом**.  
...
6.  В области конструктора представления источника данных щелкните правой кнопкой мыши T1000 Pacific и выберите **Просмотр данных** чтобы убедиться, что данные отфильтрованы правильно.  
