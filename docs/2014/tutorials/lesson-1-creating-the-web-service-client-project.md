...
6.  [!INCLUDE[clickOK](../includes/clickok-md.md)]В обозреватель решений отображается свернутое представление проекта.  
     ...
     Раскройте узел проекта в обозревателе решений. В проект добавлен файл с именем по умолчанию Program.cs (Module1. [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[vbprvb](../includes/vbprvb-md.md)]VB для).  
