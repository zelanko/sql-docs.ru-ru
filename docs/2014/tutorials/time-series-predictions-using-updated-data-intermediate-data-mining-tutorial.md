---
title: Прогнозы временных рядов с использованием обновленных данных (промежуточный Data Mining Tutorial) | Документы Microsoft
ms.custom: ''
ms.date: 03/09/2017
...
## <a name="creating-predictions-using-the-extended-sales-data"></a>Создание прогнозов с помощью расширенных сведений о продажах  
 ...
 Создание прогнозов временных рядов, использующих новые данные можно легко: просто добавьте параметр EXTEND_MODEL_CASES для [PredictTimeSeries &#40;расширений интеллектуального анализа данных&#41; ](/sql/dmx/predicttimeseries-dmx) функцию, определите источник новых данных и указать количество прогнозы, которые требуется получить.  
...
1.  Если модель еще не открыт, дважды щелкните структуру Прогнозирование и в конструкторе интеллектуального анализа данных щелкните **модель интеллектуального анализа данных** вкладки.  
  
2.  В **модель интеллектуального анализа данных** области, модели прогнозирования должен быть установлен. Если не выбран, щелкните **Выбор модели**и выделите эту модель прогнозирования.  
  
3.  В **Выбор входных таблиц** области, нажмите кнопку **выбрать таблицу вариантов**.  
  
4.  В **Выбор таблицы** диалогового окна выберите источник данных, [!INCLUDE[ssAWDWsp](../includes/ssawdwsp-md.md)].  
...
6.  С помощью **изменение сопоставления** диалогового окна поле, сопоставить столбцы модели со столбцами во внешних данных следующим образом:  
  
    -   Сопоставьте столбец ReportingDate в модели интеллектуального анализа данных в столбец NewDate во входных данных.  
  
    -   Сопоставление столбца Amount модели интеллектуального анализа данных к столбцу NewAmount во входных данных.  
  
    -   Сопоставьте столбцом количества в модели интеллектуального анализа данных в столбец NewQty во входных данных.  
  
    -   Сопоставьте столбец ModelRegion в модели интеллектуального анализа данных столбец рядов во входных данных.  
...
7.  Теперь вы создадите прогнозирующий запрос.  
    ...
    2.  В **поле** столбец, выберите область модели и для **псевдоним**, тип `Model Region`.  
...
9. Нажмите кнопку **результатов** и просмотрите результаты.  
...
1.  Построитель прогнозирующих запросов, щелкните **запроса** для переключения в режим расширений интеллектуального анализа данных.  
  
2.  Найдите DMX-инструкцию, содержащую функцию PredictTimeSeries, и измените ее следующим образом.  
  
     `PredictTimeSeries([Forecasting 12].[Quantity],4,6,EXTEND_MODEL_CASES)`  
  
3.  Нажмите кнопку **результатов** и просмотрите результаты.  
