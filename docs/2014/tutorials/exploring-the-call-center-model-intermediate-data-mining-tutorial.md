...
2.  Для **значение 2**, выберите диапазон с самыми высокими значениями. Например, диапазон со значением > = 0,12 представляет самый высокий показатель вызовов, таким образом самым низким уровнем службы. Другими словами, 12 % клиентов, позвонивших за эту смену, повесили трубку до разговора с представителем компании.  
