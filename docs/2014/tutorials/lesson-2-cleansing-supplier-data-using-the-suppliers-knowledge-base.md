...
-   **Минимальный показатель для автоматического исправления:** Минимальная Оценка или уровень доверия, используемый службами DQS для автоматического исправления значения.  
 ...
 См. в разделе [настройка пороговых значений для очистки и сопоставления](http://msdn.microsoft.com/library/hh510415.aspx) подробные сведения о настройке этих параметров.  
