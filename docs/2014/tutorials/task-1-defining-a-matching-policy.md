...
3.  Нажмите кнопку **Обзор**, убедитесь, что для фильтра задано значение **Книга Excel**, и выберите файл **очищенный список поставщиков. xls** , экспортированный после выполнения действия Очистка.  
