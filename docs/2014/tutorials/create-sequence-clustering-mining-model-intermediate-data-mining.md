...
6.  На странице **Выбор типов таблиц** установите флажок Case ( **регистр** ) рядом с таблицей **vAssocSeqOrders** и установите флажок **Nested (вложенный** ) рядом с таблицей **vAssocSeqLineItems** . Нажмите кнопку **Далее**.  
