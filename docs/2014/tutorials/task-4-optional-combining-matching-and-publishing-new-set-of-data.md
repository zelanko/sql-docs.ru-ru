...
5.  В **обозреватель основных данных** выберите **поставщики** в раскрывающемся списке для **модели**. Вы увидите, что модель имеет одну сущность: **Поставщик**.  
