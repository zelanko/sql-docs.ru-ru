---
title: Средний уровень учебник по интеллектуальному анализу данных (службы Analysis Services — Интеллектуальный анализ данных) | Документы Microsoft
ms.custom: ''
ms.date: 03/06/2017
...
-   **Прогнозирование:** вы создадите *временные ряды* модели для прогнозирования продаж продукции в различных регионах по всему миру. Будет разработать отдельные модели для каждого региона и сведения об использовании *Перекрестное прогнозирование*.  
  
-   **Анализ потребительской корзины:** вы создадите *модели взаимосвязей*для анализа группирования продуктов, приобретаемых при посещении [!INCLUDE[ssSampleDBCoFull](../includes/sssampledbcofull-md.md)] сайт электронной коммерции. На основании этой модели потребительской корзины можно рекомендовать продукты клиентам.  
  
-   **Анализ последовательностей:** построении *модели кластеризации последовательностей*для анализа порядка, в котором клиенты покупают продукты. На основании этой модели можно планировать изменения дизайна веб-сайта или предложений новых продуктов.  
  
-   **Коэффициент analysis:** используется *нейронной сети* модель для исследования возможных причин плохого качества обслуживания в центре обработки вызовов. Пользуясь знаниями, полученными с подготовительной моделью, вы создадите *модель логистической регрессии* для прогнозирования стратегий по повышению качества обслуживания клиентов.  
...
## <a name="what-you-will-learn"></a>Обзор учебника  
 ...
 На этом занятии рассматривается создание моделей интеллектуального анализа данных, которые можно использовать в сценарии прогнозирования. Будет также исследовать модели интеллектуального анализа данных, построенные с [!INCLUDE[msCoName](../includes/msconame-md.md)] алгоритма временных рядов.  
...
-   [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] с базой данных [!INCLUDE[ssSampleDBDWobject](../includes/sssampledbdwobject-md.md)] .  
 ...
 В целях повышения безопасности образцы баз данных по умолчанию не установлены. Чтобы установить официальные образцы баз данных для [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)], посетите [образцы баз данных SQL Microsoft](http://go.microsoft.com/fwlink/?LinkId=88417) и выберите соответствующую версию образца базы данных.  
