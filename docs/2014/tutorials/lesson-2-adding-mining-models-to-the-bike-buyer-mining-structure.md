...
## <a name="next-lesson"></a>Следующее занятие  
 [Урок 3. Обработка структуры интеллектуального анализа данных "Покупатель велосипеда"](../../2014/tutorials/lesson-3-processing-the-bike-buyer-mining-structure.md)  
