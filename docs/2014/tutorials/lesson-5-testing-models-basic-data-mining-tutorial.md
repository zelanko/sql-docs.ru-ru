...
ms.locfileid: "56025625"
---
# <a name="lesson-5-testing-models-basic-data-mining-tutorial"></a>Занятие 5. Проверка моделей (учебник по интеллектуальному анализу данных — начальный уровень)
