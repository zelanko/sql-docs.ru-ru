...
> [!NOTE]  
>  Чтобы выполнить оценку рекомендаций по запросу для выполняемых [!INCLUDE[ssVersion2005](../includes/ssversion2005-md.md)]экземпляров, необходимо использовать процедуру, описанную в разделе [выполнение оценки по запросу с помощью компонента зарегистрированные серверы](../../2014/tutorials/perform-an-on-demand-evaluation-by-using-registered-servers.md).  
