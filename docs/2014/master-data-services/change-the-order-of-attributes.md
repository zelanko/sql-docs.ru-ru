...
4.  Выберите строку сущности, содержащую атрибуты, порядок которых необходимо изменить.  
  
5.  Щелкните **Изменить выбранную сущность**.  
  
6.  На странице **Изменение сущности** в **атрибутах конечных элементов**, **атрибутах консолидированных элементов**или атрибутах **коллекции**выберите атрибут, порядок которого нужно изменить, а затем щелкните стрелку вверх или стрелку вниз, чтобы изменить порядок следования.  
