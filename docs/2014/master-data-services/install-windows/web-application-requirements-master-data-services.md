...
|[!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] (64-разрядная) Developer x64|[!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] (64-разрядная) Enterprise x64|[!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] Business Intelligence x64 (64-разрядная версия)|  
|-------------------------------------------------------|--------------------------------------------------------|-------------------------------------------------------------------|  
...
> [!NOTE]  
>  На [!INCLUDE[wiprlhext](../../includes/wiprlhext-md.md)] и операционные системы Windows 7, использовать **программы и компоненты** на панели управления для включения этих параметров в **функции Windows** диалоговое окно.  
...
### <a name="features-windows-server-2008-or-windows-server-2008-r2-windows-7-operating-systems"></a>Компоненты (операционные системы Windows Server 2008 или Windows Server 2008 R2, Windows 7)  
 На [!INCLUDE[firstref_longhorn](../../includes/firstref-longhorn-md.md)] или Windows Server 2008 R2, можно использовать **диспетчера серверов** приведенные компоненты можно установить следующие компоненты.  
...
## <a name="see-also"></a>См. также  
 ...
 [Диспетчер основных данных веб-приложение &#40;службы Master Data Services&#41;](create-a-master-data-manager-web-application-master-data-services.md)   
