...
-   коллекция должна существовать. Дополнительные сведения см. в разделе [Создание коллекции (службы Master Data Services)](create-a-collection-master-data-services.md).  
