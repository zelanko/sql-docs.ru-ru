...
3.  На **обслуживание модели** страницы, в сетке щелкните строку для модели с именем, вы хотите изменить.  
  
    > [!NOTE]  
    >  Имя модели метаданных изменить нельзя.  
  
4.  Нажмите кнопку **изменить выбранную модель**.  
  
5.  В **имя_модели** введите новое имя модели.  
