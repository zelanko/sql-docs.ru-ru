...
2.  Откройте командную строку, перейдите в каталог, где находится служба, и запустите службу в консольном режиме вводом следующей команды: Microsoft.MasterDataServices.Workflow.exe -console.  
