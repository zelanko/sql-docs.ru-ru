...
-   Создание копии атрибута с суффиксом «_old», которая не содержит никаких значений. Это называется **устаревшими** атрибута.  
 ...
 **Удаление устаревшего атрибута**  
 ...
 Чтобы удалить атрибут, в разделе [удаление атрибута &#40;службы Master Data Services&#41;](../delete-an-attribute-master-data-services.md)  
