...
|Имя элемента управления|Описание|  
|------------------|-----------------|  
|Атрибут|Отображает атрибут, по которому необходимо фильтровать. Если в списке нет атрибутов, это означает, что они не добавлены.<br /><br /> Примечание. Можно выполнять фильтрацию по атрибутам, которые не планируется показывать на листе.|  
