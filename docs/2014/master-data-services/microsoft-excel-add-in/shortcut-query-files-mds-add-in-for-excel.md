...
## <a name="queryopener-application"></a>Приложение QueryOpener  
 ...
 Расположением по умолчанию для приложения является *диск*: \PROGRAM Files\Microsoft SQL Server\120\Master Data сервицес\ексцел Add-In\Microsoft.MasterDataServices.QueryOpener.exe.  
