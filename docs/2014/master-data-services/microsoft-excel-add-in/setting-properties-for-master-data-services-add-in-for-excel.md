...
|Параметры: Ведение журнала|Включение ведения подробного журнала|Включите ведение журнала для процесса загрузки основных данных из MDS в надстройку Excel таким образом, что записывается результат каждой команды в службе.|  
