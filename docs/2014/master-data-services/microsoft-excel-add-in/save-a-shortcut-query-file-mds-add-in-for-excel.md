...
-   Активный лист должен содержать данные, управляемые MDS, в необходимом формате. Например, столбцы должны быть подготовлены для просмотра в необходимом порядке, а также должны быть применены все необходимые фильтры. Дополнительные сведения см. в разделе [Фильтрация данных перед Загрузкой &#40;надстройка MDS для Excel&#41;](filter-data-before-exporting-mds-add-in-for-excel.md) и [Переупорядочение столбцов &#40;надстройка MDS для Excel&#41;](reorder-columns-mds-add-in-for-excel.md).  
