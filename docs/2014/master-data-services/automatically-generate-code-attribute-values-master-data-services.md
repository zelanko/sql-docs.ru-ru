...
## <a name="see-also"></a>См. также:  
 ...
 [Автоматически формировать значения атрибутов, отличные от Code &#40;Master Data Services&#41;](../../2014/master-data-services/automatically-generate-attribute-values-other-than-code-master-data-services.md)  
