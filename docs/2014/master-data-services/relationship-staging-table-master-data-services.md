...
|**RelationshipType**<br /><br /> Обязательно|Задаваемый тип связи. Возможны следующие значения:<br /><br /> **1**: Родительский элемент<br /><br /> **2**: Того же уровня (на одном уровне)|  
