...
### <a name="to-change-an-attribute-name"></a>Изменение имени атрибута  
...
4.  Щелкните строку сущности, содержащую атрибут, имя которого необходимо изменить.  
