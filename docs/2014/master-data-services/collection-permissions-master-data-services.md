...
|**Обновление**|Отображаются все коллекции, и пользователь может добавлять и удалять коллекции.<br /><br /> Пользователь также может добавлять и удалять элементы из коллекции.|  
|**Deny**|Для сущности не отображается ни одна коллекция.|  
