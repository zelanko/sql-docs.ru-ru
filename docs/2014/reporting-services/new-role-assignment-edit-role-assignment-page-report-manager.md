 ...
 **Имя группы или пользователя**  
 Введите имя группы или учетную запись пользователя, для которой создается назначение ролей. Имя группы или пользователя должно быть допустимой учетной записью домена Windows. Введите учетную запись в следующем формате \<: домен \\><\>учетной записи.  
