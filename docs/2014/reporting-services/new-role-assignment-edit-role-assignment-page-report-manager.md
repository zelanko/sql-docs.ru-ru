---
title: 'Создание назначения ролей: Изменение назначения «роль» (диспетчер отчетов) | Документы Microsoft'
ms.custom: ''
ms.date: 03/06/2017
