---
title: Руководство. Создание отчета в свободной форме (построитель отчетов) | Документация Майкрософт
ms.custom: ''
ms.date: 06/13/2017
...
ms.locfileid: "78175025"
---
# <a name="tutorial-creating-a-free-form-report-report-builder"></a>Руководство. Создание отчета в свободной форме (построитель отчетов)
...
2.  В `Name` поле введите: **ListDataSource** .
...
4.  Убедитесь в том, что выбран тип соединения Microsoft SQL Server, а затем в поле **Строка подключения** введите **Data Source = \<имя_сервера>**.
     ...
     \<ServerName>, например Report001, указывает компьютер, на котором установлен экземпляр ядро СУБД SQL Server. Поскольку данные отчета не извлекаются из базы данных SQL Server, не нужно указывать имя базы данных. Для синтаксического анализа запроса используется база данных по умолчанию на указанном сервере.
...
2.  В `Name` поле введите: **ListDataset.**
...
2.  Щелкните внутри списка, щелкните правой кнопкой мыши на вершине списка и выберите **Свойства табликса**.
     ...
     ![Список добавления](../../2014/tutorials/media/tutorial-addinglistwithnumbers.png "Список добавления")

3.  В раскрывающемся списке **Имя набора данных** выберите пункт **ListDataset**.

4.  [!INCLUDE[clickOK](../includes/clickok-md.md)]

5.  Щелкните правой кнопкой мыши внутри списка, затем выберите **Свойства прямоугольной области**.

     ![Команда "Свойства прямоугольника"](../../2014/tutorials/media/tutorial-rectanglepropertiescommand.png "Команда "Свойства прямоугольника"")
...
1.  На панели «Группы строк» щелкните правой кнопкой мыши группу подробностей, выберите пункт **Добавить группу**, затем **Родительская группа**.
     ...
     ![Команда "Родительская группа"](../../2014/tutorials/media/tutorial-parentgroupcommand.png "Команда "Родительская группа"")
...
5.  Выберите **Удалить только столбцы**.
     ...
     ![Диалоговое окно «Удаление столбцов»](../../2014/tutorials/media/tutorial-deletecolumnsdialog.png "диалоговое окно «Удаление столбцов»")
...
7.  Нажмите кнопку **удалить только группу**.

8.  [!INCLUDE[clickOK](../includes/clickok-md.md)]

##  <a name="Graphics"></a>3. Добавление графики
...
4.  В раскрывающемся списке **Цвет заливки** нажмите **Другие цвета**и выберите **темно-серый** цвет.
     ...
     ![Выбор цвета заливки](../../2014/tutorials/media/tutorial-selectfillcolorwithnumbers.png "Выбор цвета заливки")
...
##  <a name="Text"></a>4. Добавление текста свободной формы
...
4.  Перетащите поле Territory в текстовое поле и поместите его после текста, введенного в шаге 3.
     ...
     ![Добавление поля "Территория"](../../2014/tutorials/media/tutorial-addterritorialfield.png "Добавление поля "Территория"")
...
10. Перетащите поле FullName в текстовое поле и поместите его после текста, введенного в шаге 9, а затем поставьте запятую (,).
     ...
     ![Добавление поля "Полное имя"](../../2014/tutorials/media/tutorial-addfullnamefield.png "Добавление поля "Полное имя"")
...
20. Поместите курсор ниже текста, вставленного в шаге 15, а затем введите **Congratulations on your total sales of** .
...
22. Выделите поле Sales (продажи), щелкните правой кнопкой мыши поле и выберите пункт **выражение**.
...
24. [!INCLUDE[clickOK](../includes/clickok-md.md)]
     ...
     ![Добавление выражения в поле продаж](../../2014/tutorials/media/tutorial-addexpressiontosalesfield.png "Добавление выражения в поле продаж")
...
29. Выберите `[Sum(Sales)]` и на вкладке **Главная** , в группе **Число** нажмите кнопку **Валюта** .
     ...
     ![Добавление символа валюты](../../2014/tutorials/media/tutorial-addcurrencysymbol.png "Добавление символа валюты")
...
##  <a name="Table"></a>5. Добавление таблицы для отображения сведений о продажах
...
13. Нажмите кнопку **Выполнить** для предварительного просмотра отчета.
 ...
 ![Объем продаж в отчете](../../2014/tutorials/media/tutorial-reportsalestotals.png "Объем продаж в отчете")
...
2.  Выберите ячейки таблицы, которые содержат `[Sum(SalesSales)]` , и на вкладке **Главная** в группе **Число** нажмите кнопку **Валюта** .
     ...
     ![Добавление символа валюты в сумму продаж](../../2014/tutorials/media/tutorial-sumsales-currencysymbol.png "Добавление символа валюты в сумму продаж")
...
4.  Нажмите кнопку **Выполнить** для предварительного просмотра отчета.
 ...
 ![Формат объема продаж в отчете](../../2014/tutorials/media/tutorial-reportsalestotals-formatted.png "Формат объема продаж в отчете")
...
##  <a name="Visualization"></a>9. добавление визуализации сводных данных (необязательно)
...
9. Перетащите диаграмму в прямоугольник.
     ...
     ![Добавление круговой диаграммы](../../2014/tutorials/media/tutorial-addpiechart.png "Добавление круговой диаграммы")
...
2.  На странице **Выбор набора данных** щелкните **ListDataset**, а затем нажмите кнопку **Далее**.

3.  Выберите **Столбец**, а затем нажмите кнопку **Далее**.

4.  На странице Расположение полей диаграммы перетащите поле Product в **категории**.
...
9. Перетащите диаграмму внутрь прямоугольника ниже круговой диаграммы.
     ...
     ![Добавление гистограммы](../../2014/tutorials/media/tutorial-addcolumnchart.png "Добавление гистограммы")

10. Щелкните правой кнопкой мыши заголовок диаграммы и выберите пункт **Свойства заголовка**.
...
3.  В области **Свойства** убедитесь, что `Parent` свойство содержит имя прямоугольника.

     ![Родительское свойство для круговой диаграммы](../../2014/tutorials/media/tutorial-piechart-parentproperty.png "Родительское свойство для круговой диаграммы")
...
2.  Выделив обе диаграммы, щелкните правой кнопкой мыши, укажите **Макет**и выберите команду **Установить ту же ширину**.
     ...
     ![Придание одинаковой ширины диаграмме](../../2014/tutorials/media/tutorial-makechartssamewidth.png "Придание одинаковой ширины диаграмме")
...
## <a name="see-also"></a>См. также:
 [Учебники &#40;построитель отчетов&#41;](report-builder-tutorials.md) [построитель отчетов в SQL Server 2014](report-builder/report-builder-in-sql-server-2016.md)
