...
##  <a name="3-add-graphics"></a><a name="Graphics"></a>3. Добавление графики
...
##  <a name="4-add-free-form-text"></a><a name="Text"></a>4. Добавление текста свободной формы
...
##  <a name="5-add-a-table-to-show-sales-details"></a><a name="Table"></a>5. Добавление таблицы для отображения сведений о продажах
...
##  <a name="6-format-data"></a><a name="Format"></a>6. Форматирование данных
...
1.  Нажмите кнопку **конструктор** , чтобы перейти в режим конструктора.
...
##  <a name="8-optional-add-a-line-to-separate-areas-of-the-report"></a><a name="Line"></a>8. Добавление строки в отдельные области отчета (необязательно)
...
##  <a name="9-optional-add-summary-data-visualization"></a><a name="Visualization"></a>9. добавление визуализации сводных данных (необязательно)
