...
17. При необходимости установите флажок, находящийся рядом с полем **Остановить предупреждение в**, а затем выберите дату окончания использования предупреждающего сообщения.  
    ...
    > [!NOTE]  
    >  При остановке предупреждающего сообщения не происходит удаления определения предупреждения. После остановки предупреждающего сообщения его можно запустить повторно, обновив даты запуска и остановки. Сведения об удалении определений предупреждений см. в разделе [управление Мои предупреждения об изменении данных в диспетчере предупреждений об изменении данных](manage-my-data-alerts-in-data-alert-manager.md).  
