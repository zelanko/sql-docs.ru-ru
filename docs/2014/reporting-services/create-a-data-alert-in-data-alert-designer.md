...
6.  При необходимости измените параметр данных по умолчанию из **содержит некоторые данные в поток данных** для **данные в поток данных не имеет**.  
