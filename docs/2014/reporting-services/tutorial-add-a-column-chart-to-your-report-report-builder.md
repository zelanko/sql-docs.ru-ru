...
1.  [Создайте диаграмму с помощью мастера диаграмм](#Chart)  
  
2.  [Выберите тип диаграммы](#ChartType)  
  
3.  [Форматирование и задание меток горизонтальной оси](#Horizontal)  
  
4.  [Перемещение условных обозначений](#Legend)  
  
5.  [Заголовок диаграммы](#ChartTitle)  
  
6.  [Форматирование и задание меток по вертикальной оси](#Vertical)  
...
##  <a name="Chart"></a> 1. Создание отчета с диаграммой с помощью мастера диаграмм  
 Из **Приступая к работе** диалоговое окно, используйте мастер диаграмм для создания внедренного набора данных, выберите общий источник данных и создайте гистограмму.  
...
5.  На **Выбор стиля** страницы, в поле «Стили» выберите стиль.  
...
4.  В **параметры оси** в разделе **диапазон оси и интервал**, тип **3** для **интервал**. На диаграмме отобразится каждая третья дата.  
  
5.  Щелкните **Метки**.  
  
6.  В **изменить параметры автоподбора размера метки оси**выберите **отключить автоподбор**.  
...
3.  Для **макет и положение**, выберите другое положение. Например, можно выбрать параметр, соответствующий расположению посередине в нижней части.  
...
2.  Выделите слова **заголовок диаграммы** в верхней части диаграммы, а затем введите следующий текст: **итоги заказа продаж магазина**.  
...
3.  На ленте на **Главная** вкладке **номер** щелкните **валюты** кнопки. Метки оси изменятся, отображая формат валюты.  
  
4.  На ленте на **Главная** вкладке **номер** щелкните **уменьшить число десятичных разрядов** кнопку два раза, чтобы показать число, округленное до ближайшего целого числа.  
  
5.  Щелкните правой кнопкой мыши вертикальную ось и выберите **свойства вертикальной оси**.  
  
6.  Выберите **Число**. Обратите внимание, что **валюты** уже выделена в **категории** поле, и **десятичных разрядов** уже **0** (ноль).  
  
7.  В **Показывать значения в** щелкните **тысяч**.  
  
8.  [!INCLUDE[clickOK](../includes/clickok-md.md)]  
  
9. Щелкните правой кнопкой мыши заголовок вертикальной оси сбоку диаграммы и нажмите кнопку **свойства заголовка оси**.  
  
10. Замените текст в **заголовок текста** поле со следующим текстом: **общее продаж (в тысячах)**. Можно также указать несколько параметров, связанных с форматом заголовка.  
...
3.  Тип **Диаграмма продаж**, нажмите клавишу ВВОД, а затем введите **Январь — декабрь 2009 г.**, поэтому он выглядит следующим образом:  
  
     **Диаграмма продаж**  
  
     **Январь — декабрь 2009 г.**  
  
4.  Выберите **Диаграмма продаж**и нажмите кнопку **Полужирный** кнопку в **шрифта** статьи на **Главная** ленты.  
  
5.  Выберите **Январь — декабрь 2009 г.** и в **шрифта** статьи на **Главная** задайте размер шрифта **10**.  
  
6.  (Необязательно) Может потребоваться внести **заголовок** высоту для размещения двух строк текста, перетащите вниз двусторонние стрелки при нажатии кнопки в середине нижнего края текстового поля.  
