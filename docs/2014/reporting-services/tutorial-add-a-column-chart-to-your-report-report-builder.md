...
##  <a name="Horizontal"></a>3. форматирование и пометка горизонтальной оси  
...
##  <a name="ChartTitle"></a>5. заголовком диаграммы  
...
##  <a name="Vertical"></a>6. форматирование и пометка вертикальной оси  
