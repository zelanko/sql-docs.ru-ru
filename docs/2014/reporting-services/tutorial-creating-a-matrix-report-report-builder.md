...
1.  [Создание матричного отчета и набор данных с помощью новой таблицы или мастер матриц](#CreateMatrix)  
  
2.  [Организация данных, Выбор макета и стиля в новый мастер таблиц или матриц](#Groups)  
...
1.  Нажмите кнопку **Пуск**, наведите курсор на пункты **Все программы**, **Построитель отчетов Microsoft SQL Server 2012**и выберите пункт **Построитель отчетов**.  
    ...
    > [!NOTE]  
    >  Должно открыться диалоговое окно **Приступая к работе** . Если это не так, с помощью кнопки построителя отчетов щелкните **New**.  
...
6.  На **Выбор соединения с источником данных** страницы, выберите существующий источник данных или перейдите к серверу отчетов и затем выберите источник данных. Если отсутствуют доступные источники данных или доступ к серверу отчетов, можно воспользоваться внедренным источником данных. Дополнительные сведения о создании внедренного источника данных см. в разделе [учебник: создание простого табличного отчета &#40;построитель&#41;](../reporting-services/tutorial-creating-a-basic-table-report-report-builder.md).  
...
4.  Перетащите поле Product в **группы столбцов** и поместите ниже поля Subcategory.  
...
5.  В **номер** группу, в раскрывающемся списке выберите **даты**.  
...
> [!NOTE]  
>  Если бы данные охватывали другие дни, в отчет вошли бы столбцы и для них. Каждый столбец имеет заголовок столбца `Sales`и итоги продаж по территории.  
...
5.  Щелкните угловую ячейку правой кнопкой мыши и выберите **свойства текстового поля**.  
  
6.  Перейдите на вкладку **Заливка** .  
  
7.  Нажмите кнопку (***fx***) кнопку для **цвет заливки**.  
...
3.  На **вставить** вкладку на ленте щелкните **заголовок** и нажмите кнопку **Добавление заголовка**.  
...
7.  В **свойства текста** диалоговое окно, нажмите кнопку **шрифта**.  
  
8.  В **шрифта** выберите **Times New Roman**, в **размер** выберите **24 pt**в **цвет** выберите  **Каштановый**и в **стиль** выберите **курсив**.  
...
3.  В панели «Свойства» найдите свойство свойство WritingMode и в раскрывающемся списке выберите **поворот на 270 градусов**.  
  
     Если панель свойств не открыта, перейдите на вкладку **Вид** ленты и установите флажок **Свойства**.  
  
4.  Убедитесь, что значение свойства CanGrow `True`.  
