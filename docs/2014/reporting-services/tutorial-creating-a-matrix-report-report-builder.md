...
##  <a name="Groups"></a> 2. Организация данных и Выбор макета и стиля в новую таблицу или мастер матриц  
...
13. Нажмите кнопку **Готово**.  
     ...
     Матрица добавляется в область конструктора. Области групп строк показаны две группы строк: Territory и SalesDate. В области группы столбцов показаны две группы столбцов: Subcategory и Product. Подробные данные — это все данные, которые извлекаются с помощью запроса к набору данных.  
