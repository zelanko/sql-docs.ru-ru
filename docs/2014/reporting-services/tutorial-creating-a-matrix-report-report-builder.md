...
##  <a name="CreateMatrix"></a>1. Создание матричного отчета и набора данных с помощью мастера создания таблицы или матрицы  
...
##  <a name="Groups"></a>2. Организация данных и выбор макета и стиля в мастере создания таблицы или матрицы  
...
3.  На вкладке **Главная** в группе **Число** нажмите кнопку **Валюта**. Ячейки изменятся, отображая содержимое в формате валюты.  
     ...
     Если региональным параметром является английский (США), то текст примера по умолчанию — [**$12 345,00**]. Если значение валюты не отображается, щелкните ссылку **Стили заполнителя** в группе **Числа** , а затем нажмите кнопку **Образцы значений**.  
...
##  <a name="HeaderTitle"></a>7. Добавление заголовка отчета и заголовка отчета  
