...
10. Выберите **Проверить**. Перед продолжением необходимо выполнить проверку запроса. При появлении сообщения **Проверка завершена успешно** нажмите кнопку **Далее**.  
