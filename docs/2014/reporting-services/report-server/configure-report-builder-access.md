...
# <a name="configure-report-builder-access"></a>настроить доступ к построителю отчетов
  Построитель отчетов — это средство автоматизированной нерегламентированной отчетности, [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] которое устанавливается с сервером отчетов, настроенным для собственного режима или режима интеграции с SharePoint.  
