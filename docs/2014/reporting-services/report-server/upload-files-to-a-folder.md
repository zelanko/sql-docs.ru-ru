...
значок модели отчета  
 ...
 ![универсальный значок ресурса](../media/hlp-16file.gif "универсальный значок ресурса")  
...
## <a name="see-also"></a>См. также:  
 [Диспетчер отчетов &#40;служб SSRS в собственном режиме&#41;].. /report-manager-ssrs-native-mode.md)   
