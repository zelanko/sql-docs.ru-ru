...
##  <a name="summary-of-native-mode"></a><a name="bkmk_sum"></a> Общие сведения о собственном режиме  
...
##  <a name="referencing-an-image-resource-from-a-report"></a><a name="bkmk_referenceimage"></a>Ссылка на ресурс изображения из отчета  
