...
|----------|-------------------|  
|![Report icon](../media/hlp-16doc.gif "Значок отчета")|Report|  
...
|![Shared data source icon](../media/hlp-16datasource.png "Значок общего источника данных")|Общий источник данных|  
||Общий набор данных|  
