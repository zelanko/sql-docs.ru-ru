...
1.  Запуск [диспетчера отчетов &#40;собственный режим служб SSRS&#41;]... / отчетов — диспетчер ssrs-машинный код mode.md).  
