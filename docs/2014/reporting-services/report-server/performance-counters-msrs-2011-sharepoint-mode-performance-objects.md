...
##  <a name="bkmk_windowsservice"></a> MSRS 2014 Windows SharePoint счетчики производительности службы режиме  
 ...
 В следующей таблице перечислены счетчики, включенные в `MSRS 2014 Windows Service SharePoint mode` объект производительности.  
