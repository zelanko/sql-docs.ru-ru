...
-   Консоль производительности  
 ...
 Консоль производительности и средство просмотра событий можно использовать для создания журналов и предупреждений об обработке отчетов и потреблении ресурсов. Сведения о событиях Windows, созданных [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)], в разделе [в журнале приложений Windows](windows-application-log.md). Дополнительные сведения о консоли производительности см. в подразделе «Счетчики производительности Windows», далее в этом разделе.  
...
## <a name="in-this-section"></a>в этом разделе  
 [Счетчики производительности для веб-службы MSRS 2014 и объекты производительности компонента MSRS 2014 Windows Service &#40;собственный режим&#41;](performance-counters-msrs-2011-web-service-performance-objects.md)  
