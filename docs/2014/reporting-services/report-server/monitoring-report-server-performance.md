...
## <a name="sources-of-performance-data"></a>Источники данных производительности  
 Для получения всеобъемлющих сведений о работе системы используется комбинация определенных технологий и средств. [!INCLUDE[msCoName](../../includes/msconame-md.md)]Операционные системы Windows Server предоставляют сведения о производительности с помощью следующих средств:  
...
-   Консоль производительности  
 ...
 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]Служебные программы также предоставляют сведения о базе данных сервера отчетов и временных базах данных, используемых для кэширования и управления сеансами.  
...
## <a name="reporting-services-performance-objects"></a>Объекты производительности служб Reporting Services  
 [!INCLUDE[ssRSCurrent](../../includes/ssrscurrent-md.md)]включает следующие объекты производительности:  
...
|Объект производительности|Заметки|  
|------------------------|-----------|  
|`.NET CLR Data`перетаскивани`.NET CLR Memory`|Диспетчер отчетов использует счетчики производительности [!INCLUDE[vstecasp](../../includes/vstecasp-md.md)] . Дополнительные сведения см. в статье по улучшению производительности и стабильности приложений .NET (Improving .NET Application Performance and Scalability) в MSDN.|  
