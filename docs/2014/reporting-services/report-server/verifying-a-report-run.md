...
|-----------------------------|-----------------------------------------------|-----------------------------------------------|  
|Отчет, который выполняется как моментальный снимок отчета.|На странице «Содержание». Дополнительные сведения см. в разделе [Страница "Содержимое" (диспетчер отчетов)](../contents-page-report-manager.md).|1. Определите расположение папки, которая содержит отчет.<br />2. Укажите папку в представлении "Подробности".<br />(3) 3) Обратите внимание на дату и время в **время запуска** столбца.|  
