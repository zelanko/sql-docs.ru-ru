...
3.  Найти `UrlRoot`. Этот элемент не указывается в файле конфигурации, но по умолчанию используется URL-адрес в следующем формате: http:// или https://\<*computername*>/\<*reportserver*>, где \< *reportserver*> — это имя виртуального каталога сервера веб-службы отчетов.  
