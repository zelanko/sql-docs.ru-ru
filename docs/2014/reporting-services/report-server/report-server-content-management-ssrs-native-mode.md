...
##  <a name="folders"></a><a name="bkmk_Folders"></a>Папку
...
##  <a name="resources"></a><a name="bkmk_Resources"></a>Источников
...
|& (амперсанд)|[amp]|*имя_пользователя*@*company*Company&*Company.com* принимает *имя пользователя*[at]*компания*[amp]*Company.com*|
|$ (знак доллара)|[dollar]|*User* $*Имя* пользователя преобразуется в*имя* *пользователя*[] [доллар]|
