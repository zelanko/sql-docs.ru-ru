...
-   Предоставление разрешений на выполнение задач управления с использованием стандартных ролей: **Системный администратор** и **диспетчера содержимого**. Эффективное управление содержимым сервера отчетов требует назначения обеих ролей.  
...
|Операция|Тип файла|  
|---------------|---------------|  
|Передать|Чтобы передать ресурс, необходимо использовать диспетчер отчетов, если сервер отчетов работает в собственном режиме, или страницу приложения на сайте SharePoint, если сервер работает в режиме интеграции с SharePoint. Дополнительные сведения см. в разделе [передача файла или отчета &#40;диспетчера отчетов&#41; ](../reports/upload-a-file-or-report-report-manager.md) или [отправка документов в библиотеку SharePoint &#40;служб Reporting Services в режиме интеграции с SharePoint&#41;]... / upload-documents-to-a-sharepoint-library-reporting-services-in-sharepoint-mode.md).|  
