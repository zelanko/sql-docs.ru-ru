...
-   Предоставьте разрешение на выполнение задач управления с помощью стандартных ролей: **Системный администратор** и **диспетчера содержимого**. Эффективное управление содержимым сервера отчетов требует назначения обеих ролей.  
