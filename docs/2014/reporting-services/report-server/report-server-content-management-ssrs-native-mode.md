...
|Character|Управляющий символ|Пример|  
|---------------|------------------|-------------|  
|(пробел)|[ ]|*FirstName LastName* превращается в *FirstName [] LastName*|  
|\ (обратная косая черта)|Заменяется одним пробелом|*Имя_домена* \ *имя_пользователя \ имя пользователя имя_домена*|  
|@ (символ at)|[at]|*username* @hotmail.com принимает *имя пользователя*[at] Hotmail. com|  
|& (амперсанд)|[amp]|*имя_пользователя*@** Company&*Company.com* принимает *имя пользователя*[at]*компания*[amp]*Company.com*|  
|$ (знак доллара)|[dollar]|** $*Имя* пользователя преобразуется в*имя* *пользователя*[] [доллар]|  
...
## <a name="tasks"></a>Задания  
 ...
 [Создание, удаление и изменение папки &#40;диспетчер отчетов&#41;](create-delete-or-modify-a-folder-report-manager.md)  
  
 [Обновление диспетчер отчетов &#40;ресурсов&#41;](update-a-resource-report-manager.md)  
