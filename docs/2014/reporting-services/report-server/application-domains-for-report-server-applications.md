...
-   Операции очистки, инициированные [!INCLUDE[vstecasp](../../includes/vstecasp-md.md)] , влияют только [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] [!INCLUDE[vstecasp](../../includes/vstecasp-md.md)] на приложения: веб-служба сервера отчетов и диспетчер отчетов. [!INCLUDE[vstecasp](../../includes/vstecasp-md.md)]выполняет перезапуск доменов приложений на основе изменений отслеживаемых файлов. Операции очистки, которые инициированы [!INCLUDE[vstecasp](../../includes/vstecasp-md.md)] , как правило, являются независимыми от операций очистки, относящихся к приложениям фоновой обработки.  
