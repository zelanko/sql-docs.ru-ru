...
ms.locfileid: "63265061"
---
# <a name="how-to-debug-custom-assemblies"></a>Практическое руководство. Отладка пользовательских сборок
  [!INCLUDE[msCoName](../../includes/msconame-md.md)] Предоставляет несколько средств отладки, которые могут помочь в анализе кода пользовательской сборки и обнаружении ошибок в [!INCLUDE[dnprdnshort](../../includes/dnprdnshort-md.md)] нем. Выбор наиболее подходящего средства отладки зависит от того, какая цель должна быть достигнута. В этом примере используется [!INCLUDE[vsOrcas](../../includes/vsorcas-md.md)].  
