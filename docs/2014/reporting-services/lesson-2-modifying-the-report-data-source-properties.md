...
7.  Введите имя пользователя (в виде *домен\имя*) и пароль. Если у вас нет разрешения на доступ к [!INCLUDE[ssSampleDBobject](../includes/sssampledbobject-md.md)] базы данных, укажите имя входа, выполняющий.  
  
8.  Установите флажок **Использовать учетные данные Windows при соединение с источником данных**и нажмите кнопку **ОК**. Если вы не используете учетную запись домена (например, в том случае, если вы используете [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] входа), не устанавливайте этот флажок.  
  
9. Нажмите кнопку **Проверить соединение** , чтобы проверить соединение с источником данных.  
  
10. Нажмите кнопку **Применить**.  
  
11. Просмотрите отчет, чтобы убедиться, что он выполняется с указанными учетными данными. Чтобы просмотреть отчет, щелкните вкладку **Просмотр** . Обратите внимание, что если отчет уже открыт, необходимо выбрать имя сотрудника и нажмите кнопку **просмотреть отчет** кнопку, чтобы просмотреть отчет.  
...
6.  Нажмите кнопку **ОК**. Параметр будет добавлен в область **Данные отчета** и будет выглядеть, как на следующем изображении:  
     ...
     ![Добавить новый параметр в области данных отчета](../../2014/tutorials/media/ssrs-tutorial-datadriven-parameter.gif "новый параметр добавлен в область данных отчета")  
