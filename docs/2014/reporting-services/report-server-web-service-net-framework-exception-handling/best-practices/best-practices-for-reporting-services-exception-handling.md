...
|Раздел|Описание|  
|-----------|-----------------|  
|[Предотвращение недопустимых запросов](preventing-invalid-requests.md)|Описывает методики предотвращения отправки недопустимых запросов на сервер отчетов.|  
