...
## <a name="creating-a-system-level-role-assignment"></a>Создание назначения ролей на уровне системы  
 ...
 Дополнительные сведения см. в разделе [Grant User Access to a Report Server &#40;Report Manager&#41;](grant-user-access-to-a-report-server.md) и [Стандартные роли](role-definitions-predefined-roles.md).  
