...
## <a name="creating-an-item-level-role-assignment"></a>Создание назначения роли на уровне элемента  
 ...
 Дополнительные сведения смдолжно быть включено весьма небольшое число пользователей. в разделе Grant User Access to a Report Server &#40;Report Manager&#41;должно быть включено весьма небольшое число пользователей.  
...
## <a name="creating-a-system-level-role-assignment"></a>Создание назначения ролей на уровне системы  
 ...
 Дополнительные сведения см. в разделе [предоставление доступа пользователя к серверу отчетов &#40;диспетчера отчетов&#41; ](grant-user-access-to-a-report-server.md) и [стандартные роли](role-definitions-predefined-roles.md).  
