...
##  <a name="predefined-role-definitions"></a><a name="bkmk_rolelist"></a>Стандартные определения ролей  
...
##  <a name="content-manager-role"></a><a name="bkmk_content"></a>Роль диспетчера содержимого  
...
##  <a name="publisher-role"></a><a name="bkmk_publisher"></a>Роль издателя  
...
##  <a name="browser-role"></a><a name="bkmk_browser"></a>Роль браузера  
...
##  <a name="report-builder-role"></a><a name="bkmk_reportbuilder"></a>Роль построитель отчетов  
...
##  <a name="system-administrator-role"></a><a name="bkmk_systemadministrator"></a>Роль системного администратора  
...
##  <a name="system-user-role"></a><a name="bkmk_systemuser"></a>Роль "Системный пользователь"  
