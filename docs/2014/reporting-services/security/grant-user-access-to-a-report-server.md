---
title: Предоставление пользователям доступа к серверу отчетов (диспетчер отчетов) | Документы Microsoft
ms.custom: ''
ms.date: 06/13/2017
...
## <a name="see-also"></a>См. также  
 ...
 [Страница свойств «безопасность», элементы &#40;диспетчера отчетов&#41;](../security-properties-page-items-report-manager.md)   
