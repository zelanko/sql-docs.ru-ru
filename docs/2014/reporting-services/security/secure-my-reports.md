...
-   отключения папки «Мои отчеты» на странице «Параметры сайта». Дополнительные сведения см. в разделе [Включение и отключение Мои отчеты](../report-server/enable-and-disable-my-reports.md).  
