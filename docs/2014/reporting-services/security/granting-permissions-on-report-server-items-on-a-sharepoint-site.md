...
-   Разрешение позволяет выполнить конкретную задачу. [!INCLUDE[SPF2010](../../includes/spf2010-md.md)]предоставляет 33 предустановленных разрешений, которые можно комбинировать в уровне разрешений.  
