...
##  <a name="connection-string-examples"></a><a name="ConnectionString"></a>Примеры строк подключения  
...
##  <a name="creating-data-sources"></a><a name="Creating"></a>Создание источников данных  
