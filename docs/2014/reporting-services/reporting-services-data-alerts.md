...
-   **Доставка предупреждений об изменении данных получателям** — служба оповещений создает экземпляр предупреждения об изменении данных и отправляет предупреждающее сообщение получателям по электронной почте.
 ...
 ![Рабочий процесс в системе оповещений Reporting Services](media/rs-alertingworkflow.gif "Рабочий процесс в системе оповещений Reporting Services")
...
##  <a name="support-for-ssl"></a><a name="SupportForSSL"></a> Поддержка SSL.
...
## <a name="see-also"></a>См. также:
 Диспетчер предупреждений [данных](../../2014/reporting-services/data-alert-designer.md) Data [Manager для оповещения](../../2014/reporting-services/data-alert-manager-for-alerting-administrators.md) [Диспетчер предупреждений об изменении данных для пользователей SharePoint](../../2014/reporting-services/data-alert-manager-for-sharepoint-users.md)
