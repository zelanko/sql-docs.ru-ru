...
1.  [Создайте круговую диаграмму с помощью мастера диаграмм](#Chart)  
...
4.  На **Выбор стиля** на панели «Стили» выберите стиль.  
...
3.  Щелкните правой кнопкой мыши метку и выберите **свойства метки ряда**.  
...
2.  На **представление** вкладке **Показать или скрыть** группы выберите **свойства**.  
...
2.  Если панель свойств еще не открыта, на **представление** выберите **свойства**.  
...
5.  Задать **PieDrawingStyle** для **SoftEdge**.  
...
3.  Выберите **продажи фотоаппаратов и видеокамер**и нажмите кнопку **Полужирный** кнопку **шрифта** раздел **Главная** ленты.  
  
4.  Выберите **как процент от общего объема продаж**и в **шрифта** статьи на **Главная** задайте размер шрифта **10**.  
