...
# <a name="reporting-services-tutorials-ssrs"></a>Учебники по службам Reporting Services (SSRS)
  Этот раздел содержит учебники [!INCLUDE[ssSQL11](../includes/sssql11-md.md)] [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)]по.  
 ...
 Выполните действия, описанные в этом руководстве, чтобы узнать, [!INCLUDE[ssRSCurrent](../includes/ssrscurrent-md.md)] как получить доступ к веб-службам из приложения, созданного с помощью [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[vbprvb](../includes/vbprvb-md.md)] или [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[csprcs](../includes/csprcs-md.md)].  
 ...
 Выполните действия, описанные в этом руководстве, чтобы узнать, как использовать средство определения схемы XML (XSD. exe) для создания классов, позволяющих сериализовать и десериализовать файлы определения отчета (RDL и RDLC) с [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[dnprdnshort](../includes/dnprdnshort-md.md)]помощью.  
