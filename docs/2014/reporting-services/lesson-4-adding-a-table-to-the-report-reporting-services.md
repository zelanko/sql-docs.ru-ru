---
title: 'Занятие 4: Добавление таблицы в отчет (службы Reporting Services) | Документация Майкрософт'
ms.custom: ''
ms.date: 03/08/2017
...
7.  Добавьте поле «LineTotal» тем же способом, создав пятый столбец.  
    ...
    >  Заголовок столбца «Линейный итог». Конструктор отчетов автоматически создает понятное имя для столбца, разбивая LineTotal на два слова.  
     ...
     Следующей схеме показана табличная область данных, заполнив эти поля: Даты заказа, продукта, количество и линейный итог.  
