...
> [!NOTE]  
>  Администратор сервера отчетов должен предоставить пользователю необходимые разрешения для просмотра сервера отчетов, чтобы выбрать общие источники данных (или модели), а также чтобы открыть или сохранить отчеты. Дополнительные сведения см. в разделе [Установка, удаление и поддержка построитель отчетов](../../2014/reporting-services/install-uninstall-and-report-builder-support.md).  
