 ...
 **Создание назначения ролей**  
 Нажмите, чтобы открыть страницу «Создание назначения ролей», позволяющую создать для текущего элемента дополнительные назначения ролей. Дополнительные сведения см. в разделе [новое назначение роли: изменить страницу назначения роли &#40;диспетчера отчетов&#41;](../../2014/reporting-services/new-role-assignment-edit-role-assignment-page-report-manager.md).  
