---
title: Учебник. Добавление в отчет ключевого показателя эффективности (построитель отчетов) | Документация Майкрософт
ms.custom: ''
ms.date: 03/08/2017
...
12. Нажмите кнопку **Готово**.  
     ...
     Таблица добавляется в область конструктора. Таблица содержит пять столбцов и пять строк. В области групп строк показаны три группы строк: SalesDate, Subcategory и Details. Подробные данные — это все данные, которые извлекаются с помощью запроса к набору данных.  
...
2.  В **заполнения**, нажмите кнопку **fx** рядом с пунктом **цвет заливки** параметр и введите следующее выражение в **задать выражение для: BackgroundColor**.  
