---
title: Страница «Общие свойства», модели (диспетчер отчетов) | Документы Microsoft
ms.custom: ''
ms.date: 03/06/2017
 ...
 **Скрывать при просмотре списка**  
 Установите этот флажок, чтобы скрыть элемент, когда папка выбрана в представлении списка. Представление списка — режим просмотра содержимого папок, поддерживаемый диспетчером отчетов. Этот параметр можно задать в [!INCLUDE[ssManStudio](../includes/ssmanstudio-md.md)] позволяет управлять просмотром данного элемента в диспетчере отчетов. Дополнительные сведения о режимах просмотра в диспетчере отчетов см. в разделе [страница «содержимое» &#40;диспетчера отчетов&#41;](../../2014/reporting-services/contents-page-report-manager.md).  
