...
ms.locfileid: "37258100"
---
# <a name="setdatabaselogontimeout-method-wmi-msreportserverconfigurationsetting"></a>Метод SetDatabaseLogonTimeout (WMI MSReportServer_ConfigurationSetting)
