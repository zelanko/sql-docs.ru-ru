...
|**Indented**|Показывает, создается ли XML-код с отступами. Значение по умолчанию `false` приводит к возникновению ошибки без отступов сжатый XML-код.|  
...
|**Схема**|Показывает, выводится ли в XML-код схема XSD или фактические XML-данные. Значение `true` показывает, что XML-схемы. Значение по умолчанию — `false`.|  
