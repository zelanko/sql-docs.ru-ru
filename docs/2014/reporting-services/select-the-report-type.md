 ...
 **Матрица**  
 Создать отчет, содержащий матрицу. Матрица — это область данных, в которой данные организованы в столбцы и строки. Матрицы обеспечивают функциональность, подобную перекрестным и сводным таблицам. В отличие от таблицы, которая имеет фиксированный набор столбцов, столбцы матрицы могут быть динамическими.  
