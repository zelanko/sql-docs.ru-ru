...
-   Гистограмма имеет уникальное свойство — возможность отображения в виде гистограммы или диаграммы Парето. Для этого задайте для свойства Шовколумнас значение `Histogram` или `Pareto` в поле окно свойств значение. `true`  
