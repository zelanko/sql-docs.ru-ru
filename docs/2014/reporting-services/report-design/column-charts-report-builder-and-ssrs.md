...
-   Гистограмма имеет уникальное свойство — возможность отображения в виде гистограммы или диаграммы Парето. Чтобы сделать это, присвойте свойству ShowColumnAs `Histogram` или `Pareto` в окне «Свойства» для `true`.  
