...
|Символ|Description|Сценарии использования|  
|------------|-----------------|-----------------|  
...
|![rs_IconMapTileLayer](../media/rs-iconmaptilelayer.gif "rs_IconMapTileLayer")|Мозаичный слой|Добавление слоя карты, отображающего элементы мозаики Bing Map, соответствующие области видимости текущей карты, определенной областью просмотра.|  
 ...
 Дополнительные сведения см. в разделе [Maps &#40;Report Builder and SSRS&#41;](maps-report-builder-and-ssrs.md).  
  
> [!NOTE]  
>  [!INCLUDE[ssRBRDDup](../../includes/ssrbrddup-md.md)]  
  
##  <a name="AddLayer"></a>Добавление слоя с помощью мастера «слой карт»  
...
##  <a name="ChangeLayer"></a>Изменение параметров слоя с помощью мастера «слой карт»  
  
-   Запустите мастер «Слой карты». Этот мастер используется для изменения параметров слоя, созданного с помощью мастера «Слой карты». На панели «Схема» щелкните правой кнопкой мыши слой и на панели инструментов нажмите кнопку мастера слоев (![rs_IconMapLayerWizard](../../tutorials/media/rs-iconmaplayerwizard.gif "rs_IconMapLayerWizard")).  
  
     Дополнительные сведения см. в разделе [Мастер карт и мастер слоев карт (построитель отчетов и службы SSRS)](map-wizard-and-map-layer-wizard-report-builder-and-ssrs.md).  

##  <a name="AddVectorLayer"></a>Добавление слоя точки, линии или многоугольника с панели инструментов панели «Схема»  
...
2.  На панели инструментов нажмите кнопку **Добавить слой** и выберите в раскрывающемся списке тип добавляемого слоя: **Точка**, **Линия**или **Многоугольник**.  
    ...
    > [!NOTE]  
    >  Хотя слой карты можно добавить и настроить вручную, для добавления новых слоев рекомендуется использовать мастер слоя. Чтобы запустить мастер с панели инструментов панели «Схема», нажмите кнопку мастера слоев (![rs_IconMapLayerWizard](../../tutorials/media/rs-iconmaplayerwizard.gif "rs_IconMapLayerWizard")).  
...
##  <a name="ESRI"></a>Указание ESRI фигуры в качестве источника пространственных данных  
...
##  <a name="DrawingOrder"></a>Изменение порядка отображения слоя  
...
##  <a name="Transparency"></a>Изменение прозрачности слоя многоугольника, линии или точки  
  
1.  Щелкните карту, чтобы отобразить панель «Карта».  
  
2.  Щелкните правой кнопкой мыши слой и выберите пункт **Данные слоя**.  
  
3.  Щелкните `Visibility`.  
...
##  <a name="Language"></a>Указание языка для меток плиток  
...
##  <a name="ConditionalHide"></a>Для условного скрытия слоя на основе масштаба окна просмотра  
