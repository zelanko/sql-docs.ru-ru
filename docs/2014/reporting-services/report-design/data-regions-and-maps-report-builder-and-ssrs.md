...
## <a name="see-also"></a>См. также  
 ...
 [Отчеты, элементы отчета и определений отчетов &#40;отчетов построителя отчетов и службы SSRS&#41;](reports-report-parts-and-report-definitions-report-builder-and-ssrs.md)   
