...
## <a name="multiple-data-regions-linked-to-the-same-dataset"></a>Несколько областей данных, связанных с одним и тем же набором данных  
 К одному и тому же набору данных можно привязать несколько областей данных для различного представления одних и тех же данных. Например, можно показать одни и те же данные в таблице и на диаграмме. Можно создавать отчеты с интерактивными кнопками для сортировки таблицы, причем при сортировке таблицы автоматически сортируется и диаграмма. Дополнительные сведения см. в разделе [Linking Multiple Data Regions to the Same Dataset &#40;Report Builder and SSRS&#41;](linking-multiple-data-regions-to-the-same-dataset-report-builder-and-ssrs.md).  
...
## <a name="see-also"></a>См. также:  
 ...
 [Макет страницы и подготовка к просмотру &#40;построитель отчетов и SSRS&#41;](page-layout-and-rendering-report-builder-and-ssrs.md)   
