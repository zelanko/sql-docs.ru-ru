...
### <a name="defining-group-variables"></a>Определение групповых переменных  
 ...
 Дополнительные сведения см. в разделе [Report и Group Variables Collections References &#40;Report Builder и SSRS&#41;](built-in-collections-report-and-group-variables-references-report-builder.md) и [Expression Scope for Totals, Aggregates, и Built-in Collections &#40;Report Builder и SSRS&#41;](expression-scope-for-totals-aggregates-and-built-in-collections.md).  
  
### <a name="groups-and-scope-in-data-regions"></a>Группы и область в областях данных  
 Для создания нескольких представлений данных из одного и того же набора данных можно задать одни и те же выражения группы для каждой области данных. Например, можно отобразить данные по категориям в таблице, чтобы показать все подробные данные, и в круговой диаграмме, чтобы показать обобщенные данные, а также показать каждую категорию относительно всего набора данных. Дополнительные сведения см. в разделе [Linking Multiple Data Regions to the Same Dataset &#40;Report Builder and SSRS&#41;](linking-multiple-data-regions-to-the-same-dataset-report-builder-and-ssrs.md).  
...
### <a name="sorting-data-in-a-dataset-query"></a>Сортировка данных в запросе к набору данных  
 ...
 [!INCLUDE[msCoName](../../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Для типа источника данных можно добавить предложение ORDER BY в запрос набора данных. Например, в следующем запросе [!INCLUDE[tsql](../../../includes/tsql-md.md)] выполняется сортировка столбцов Sales и Region по значениям Sales в нисходящем порядке в таблице SalesOrders: `SELECT Sales, Region FROM SalesOrders ORDER BY Sales DESC`. Дополнительные сведения см. в разделе «Сортировка строк при помощи предложения ORDER BY» [электронной документации по SQL Server](https://go.microsoft.com/fwlink/?linkid=98335).  
...
##  <a name="HowTo"></a> Инструкции  
 ...
 [Установка сообщения об отсутствии данных для области данных &#40;построитель отчетов и служб SSRS&#41;](../report-data/set-a-no-data-message-for-a-data-region-report-builder-and-ssrs.md)  
  
 [Создание группы рекурсивной иерархии &#40;построитель отчетов и SSRS&#41;](create-a-recursive-hierarchy-group-report-builder-and-ssrs.md)  
