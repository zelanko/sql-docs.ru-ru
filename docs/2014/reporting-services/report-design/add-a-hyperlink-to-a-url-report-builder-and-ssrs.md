...
>  [!INCLUDE[ssRBRDDup](../../includes/ssrbrddup-md.md)]  
 ...
 Можно также задавать URL-адреса отчетов на любом сервере отчетов, на котором имеется разрешение на чтение с помощью URL-запросов к серверу отчетов. Например, можно указать отчет и скрыть схему документа, когда пользователь впервые просматривает этот отчет. Дополнительные сведения см. в разделе [Доступ по URL-адресу (SSRS)](../url-access-ssrs.md) [документации по службам Reporting Services](http://go.microsoft.com/fwlink/?linkid=121312), входящей в состав электронной документации по [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)].  
