...
##  <a name="BuildingConfiguringTableMatrixList"></a>Сборка и настройка таблицы, матрицы или списка  
...
##  <a name="ChangingBetweenTablixTemplates"></a>Изменение между шаблонами табликса  
...
-   [Добавление группы подробностей &#40;построитель отчетов и SSRS&#41;](add-a-details-group-report-builder-and-ssrs.md)  
...
-   [Изменение элемента в ячейке &#40;построитель отчетов и SSRS&#41;](change-an-item-within-a-cell-report-builder-and-ssrs.md)  
  
-   [Изменение высоты строки или ширины столбца &#40;построитель отчетов и SSRS&#41;](change-row-height-or-column-width-report-builder-and-ssrs.md)  
  
-   [Вставка или удаление столбца &#40;построитель отчетов и служб SSRS&#41;](insert-or-delete-a-column-report-builder-and-ssrs.md)  
  
-   [Вставка или удаление построитель отчетов &#40;строк и служб SSRS&#41;](insert-or-delete-a-row-report-builder-and-ssrs.md)  
  
-   [Объединение ячеек в области данных &#40;построитель отчетов и SSRS&#41;](merge-cells-in-a-data-region-report-builder-and-ssrs.md)  
...
-   [Создание пошагового отчета &#40;построитель отчетов и SSRS&#41;](create-a-stepped-report-report-builder-and-ssrs.md)  
  
-   [Добавление, перемещение или удаление таблицы, матрицы или списка &#40;построитель отчетов и служб SSRS&#41;](add-move-or-delete-a-table-matrix-or-list-report-builder-and-ssrs.md)  
...
##  <a name="InThisSection"></a> в этом разделе  
 ...
 [Добавление данных в область данных табликса &#40;построитель отчетов и SSRS&#41;](adding-data-to-a-tablix-data-region-report-builder-and-ssrs.md)  
 ...
 [Управление заголовками строк и столбцов &#40;построитель отчетов и SSRS&#41;](controlling-row-and-column-headings-report-builder-and-ssrs.md)  
