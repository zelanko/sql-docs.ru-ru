...
-   Если в том же самом теге существуют и атрибут, и атрибуты стиля CSS, то свойство CSS имеет более высокий приоритет. Например, если текст имеет ** \<вид p Style = "Text-aligned: right" выровняйте = "Left" >**, будет применен только атрибут Text-Aligned, и текст будет выставляться по правому краю.  
