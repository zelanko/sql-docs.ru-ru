...
##  <a name="DataboundImages"></a>Изображения с привязкой к данным  
...
## <a name="see-also"></a>См. также:  
 [Экспорт в файл изображения &#40;построитель отчетов и SSRS&#41;](../report-builder/exporting-to-an-image-file-report-builder-and-ssrs.md)   
