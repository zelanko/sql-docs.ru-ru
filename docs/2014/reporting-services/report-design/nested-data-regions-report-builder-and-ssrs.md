...
-   **Угловой табликса** Область представляет собой данные в области данных, связанной с областью данных табликса, после применения выражений фильтрации и сортировки для набора данных и внешнего табликса.  
  
-   **Группа столбцов табликса** Данные в самой внутренней группе столбцов после применения фильтров и выражений сортировки для набора данных, внешнего табликса и групп столбцов.  
...
-   **Текст табликса** Данные в самой внутренней группе, представленной пересечением групп строк и групп столбцов, после применения выражений фильтрации и сортировки для набора данных, внешнего табликса и групп строк и столбцов.  
