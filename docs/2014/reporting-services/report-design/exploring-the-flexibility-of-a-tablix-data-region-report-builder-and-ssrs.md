...
# <a name="exploring-the-flexibility-of-a-tablix-data-region-report-builder-and-ssrs"></a>Изучение возможностей области данных табликса (построитель отчетов и службы SSRS)
 ...
 При удалении группы строк или столбцов имеется возможность удаления строк и столбцов, используемых для отображения значений группы. Строки и столбцы можно также добавлять и удалять вручную. Сведения об использовании строк и столбцов для отображения сведений и как группировать данные, см. в разделе [область данных Табликса &#40;построитель отчетов и службы SSRS&#41;](../tablix-data-region-report-builder-and-ssrs.md).  
