...
## <a name="changing-a-default-list-to-a-grouped-list"></a>Преобразование списка по умолчанию в список групп  
 По умолчанию список содержит строки детализации и не содержит группы. Чтобы изменить список в целях использования строки группы, переименуйте группу подробностей и укажите выражение группы. Дополнительные сведения см. [в разделе Добавление или удаление группы в области данных &#40;построитель отчетов и SSRS&#41;](add-or-delete-a-group-in-a-data-region-report-builder-and-ssrs.md)  
