...
##  <a name="DataGrouping"></a> Изменение группирования данных для слоя  
 ...
 Дополнительные сведения см. в разделе [советы по применению карт: Как импортировать файлы фигур в SQL Server и агрегировать Пространственные данные](https://go.microsoft.com/fwlink/?LinkID=214991).  
