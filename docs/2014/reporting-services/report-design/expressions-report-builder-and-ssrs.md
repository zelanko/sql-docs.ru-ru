...
## <a name="DisplayText"></a>Основные сведения о символах префикса в простых выражениях  
...
[Справочник по выражениям &#40;построитель отчетов и SSRS&#41;](expression-reference-report-builder-and-ssrs.md)  
