...
## <a name="see-also"></a>См. также  
 [Форматирование диапазонов на датчике &#40;отчетов построителя отчетов и службы SSRS&#41;](formatting-ranges-on-a-gauge-report-builder-and-ssrs.md)   
