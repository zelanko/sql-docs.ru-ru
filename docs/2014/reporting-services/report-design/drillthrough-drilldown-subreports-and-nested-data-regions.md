...
###  <a name="Datasets"></a>Используемые ими наборы данных  
...
###  <a name="RetrieveData"></a>Получение данных  
...
###  <a name="Reusability"></a>Возможность многократного использования  
...
##  <a name="InThisSection"></a> в этом разделе  
 ...
 [Указание путей к внешним элементам &#40;построитель отчетов и SSRS&#41;](specifying-paths-to-external-items-report-builder-and-ssrs.md)  
