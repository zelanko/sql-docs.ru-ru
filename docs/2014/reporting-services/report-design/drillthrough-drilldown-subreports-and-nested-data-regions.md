...
##  <a name="summary-of-characteristics"></a><a name="SummaryCharacteristics"></a> Сводка характеристик  
...
|Характерная особенность|Подотчет|Детализация|вложена|  
|-----------|---------------|------------------|------------|  
...
##  <a name="details-of-characteristics"></a><a name="Details"></a> Сведения о характеристиках  
  
###  <a name="datasets-they-use"></a><a name="Datasets"></a> Используемые наборы данных  
...
###  <a name="retrieving-data"></a><a name="RetrieveData"></a> Извлечение данных  
...
###  <a name="processing-and-rendering"></a><a name="ProcessRender"></a> Обработка и подготовка к просмотру  
...
###  <a name="use-of-parameters"></a><a name="Parameters"></a> Использование параметров  
...
###  <a name="reusability"></a><a name="Reusability"></a> Повторное использование  
...
###  <a name="location"></a><a name="Location"></a> Местоположение  
...
###  <a name="display"></a><a name="Display"></a> Отобразить  
