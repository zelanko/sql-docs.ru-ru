...
##  <a name="Embedded"></a>Проблемы с размером определения отчета  
...
##  <a name="Spatial"></a>Проблемы с пространственными данными  
...
##  <a name="Viewport"></a>Проблемы с центром и просмотром окна просмотра  
...
##  <a name="Legend"></a>Проблемы условных обозначений, цветовой шкалы и правила  
...
##  <a name="Tooltip"></a>Проблемы с подсказкой и меткой  
