...
##  <a name="KindsofSparklines"></a>Типы спарклайнов  
...
-   Гистограммы [&#40;построитель отчетов и SSRS&#41;](charts-report-builder-and-ssrs.md): базовый, с накоплением и 100% гистограмм с накоплением.  
  
-   Графики [&#40;построитель отчетов и SSRS&#41;](line-charts-report-builder-and-ssrs.md): все, Кроме трехмерного графика.  
  
-   [Диаграммы с областями &#40;построитель отчетов и SSRS&#41;](area-charts-report-builder-and-ssrs.md): все, кроме трехмерных диаграмм с областями  
  
-   [Круговые диаграммы &#40;построитель отчетов и SSRS&#41;](pie-charts-report-builder-and-ssrs.md): и кольцевые диаграммы, как плоские, так и трехмерные, но не другие фигуры, такие как воронка и пирамидальные диаграммы.  
  
-   [Диаграммы диапазонов &#40;построитель отчетов и службы SSRS&#41;](range-charts-report-builder-and-ssrs.md): "акции", "японские свечи", "план погрешности" и "блочная диаграмма".  
...
-   [Линейчатые диаграммы &#40;построитель отчетов и SSRS&#41;](bar-charts-report-builder-and-ssrs.md): базовый, с накоплением и 100% линейчатых диаграмм с накоплением.  
  
-   Гистограммы [&#40;построитель отчетов и SSRS&#41;](charts-report-builder-and-ssrs.md): базовый, с накоплением и 100% гистограмм с накоплением. Гистограмма может быть и спарклайном и гистограммой.  

##  <a name="AlignDatainTableMatrix"></a>Выровняйте данные спарклайна в таблице или матрице  
...
##  <a name="UnderstandScope"></a>Основные сведения о данных, предоставляемых для спарклайна или гистограммы  
...
##  <a name="ConvertSparklinetoChart"></a>Преобразование спарклайна или гистограммы в полную диаграмму  
...
##  <a name="HowTo"></a>Разделы руководства  
 [Добавление спарклайнов и гистограмм &#40;построитель отчетов и SSRS&#41;](sparklines-and-data-bars-report-builder-and-ssrs.md)  
...
### <a name="other-how-to-topics-for-charts"></a>Другие инструкции для диаграмм  
 ...
 [Добавление или удаление полей из диаграммы &#40;построитель отчетов и служб SSRS&#41;](add-or-remove-margins-from-a-chart-report-builder-and-ssrs.md)  
  
 [Изменение типа диаграммы &#40;построитель отчетов и SSRS&#41;](change-a-chart-type-report-builder-and-ssrs.md)  
