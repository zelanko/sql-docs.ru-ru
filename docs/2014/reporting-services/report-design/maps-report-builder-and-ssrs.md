...
# <a name="maps-report-builder-and-ssrs"></a>Карты (построитель отчетов и службы SSRS)
 ...
 Дополнительные сведения об использовании карты см. в разделах [Учебник. Отчет-карта (построитель отчетов)](../tutorial-map-report-report-builder.md) или [Образцы отчетов (построитель отчетов и службы SSRS)](http://go.microsoft.com/fwlink/?LinkId=198283).  
...
-   **Пользовательские местоположения.** Можно вручную добавлять местоположения в виде внедренных точек на слое внедренных точек. Дополнительные сведения см. в разделе [Добавление настраиваемых расположений на карту &#40;построитель отчетов и службы SSRS&#41;](add-custom-locations-to-a-map-report-builder-and-ssrs.md).  
