...
# <a name="maps-report-builder-and-ssrs"></a>Карты (построитель отчетов и службы SSRS)
 ...
 Для немедленного использования карт см. в разделе [руководства: Отчет-карта &#40;построитель отчетов&#41; ](../tutorial-map-report-report-builder.md) или [образцов (построитель отчетов и службы SSRS) отчетов](https://go.microsoft.com/fwlink/?LinkId=198283).  
...
##  <a name="Troubleshooting"></a> Устранение неполадок карт  
 ...
 Дополнительные сведения о проблемах см. в разделе [Устранение неполадок в отчетах: Отчеты-карты &#40;построитель отчетов и службы SSRS&#41;](troubleshoot-reports-map-reports-report-builder-and-ssrs.md)  
