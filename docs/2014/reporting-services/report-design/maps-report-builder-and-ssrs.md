...
# <a name="maps-report-builder-and-ssrs"></a>Карты (построитель отчетов и службы SSRS)
 ...
 Дополнительные сведения об использовании карты см. в разделах [Учебник. Отчет-карта (построитель отчетов)](../tutorial-map-report-report-builder.md) или [Образцы отчетов (построитель отчетов и службы SSRS)](https://go.microsoft.com/fwlink/?LinkId=198283).  
...
##  <a name="Process"></a>Добавление в отчет карту  
...
##  <a name="AddingData"></a>Добавление данных в карту  
...
-   **Географическая** Указывает геодезические координат на сферической поверхности с использованием долготы и широты. Если используются географические пространственные данные, следует задать проекцию. Проекция — это набор правил, которые определяют, как отображать объекты со сферическими координатами на плоской поверхности. Географические данные можно сравнивать или комбинировать, только если у них одна и та же проекция.  
  
-   **Плоская** Задает геометрические координаты на плоской поверхности с помощью X и Y.  
...
-   **Отчеты галереи карт.** Пространственные данные внедряются в отчеты, находящиеся в коллекции карт. По умолчанию коллекция карт устанавливается в * \<папку диск>*: \Program Files\Microsoft SQL Server\Report Builder builder\mapgallery.  
...
-   **Пользовательские местоположения.** Можно вручную добавлять местоположения в виде внедренных точек на слое внедренных точек. Дополнительные сведения см. в разделе [Add Custom Locations to a Map &#40;Report Builder and SSRS&#41;](add-custom-locations-to-a-map-report-builder-and-ssrs.md).  
...
-   Из источника пространственных данных:  
    ...
    -   **Безымян.** . Поле, содержащее название города.  
...
##  <a name="Viewport"></a>Основные сведения о окне просмотра карт  
...
-   Использовать ли безопасное соединение для извлечения мозаики из веб-службы Bing Maps.  
 ...
 Пошаговые инструкции см. в разделе [Add, Change, or Delete a Map or Map Layer &#40;Report Builder and SSRS&#41;](add-change-or-delete-a-map-or-map-layer-report-builder-and-ssrs.md).  
...
##  <a name="MapLayers"></a>Основные сведения о слоях карт и элементах карт  
...
-   **Слой точек.** Отображает маркеры для местоположений точек.  
 ...
 Дополнительные сведения о слоях карты см. в разделе [Add, Change, or Delete a Map or Map Layer &#40;Report Builder and SSRS&#41;](add-change-or-delete-a-map-or-map-layer-report-builder-and-ssrs.md).  
...
##  <a name="Legends"></a>Основные сведения о условных обозначениях, цветовой шкале и шкале расстояний  
...
-   [Добавление пользовательских расположений в построитель отчетов &#40;Map и службы SSRS&#41;](add-custom-locations-to-a-map-report-builder-and-ssrs.md)  
