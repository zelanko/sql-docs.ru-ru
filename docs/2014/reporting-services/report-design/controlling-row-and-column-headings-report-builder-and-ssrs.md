...
###  <a name="TableRowGroupsGroupHeader"></a> Таблица с группами строк и областью групп строк  
 ...
 Представлены элементы табликса: **Статические**, (**статический**), категории, и (**сведения**). Если элемент табликса заключен в скобки, это означает, что отсутствует соответствующий заголовок группы. Чтобы повторить или закрепить заголовки столбцов, выберите верхний элемент табликса «Статический» и задайте свойства в панели свойств.  
...
-   Обновите отчет, созданный для предыдущей версии языка определения отчетов, когда не использовались области данных табликса.  
 ...
 ![Предварительный просмотр, таблица содержит группу строк, но не заголовок группы](../media/rs-tableheaderdynamicwithnogroupheadercellpreview.gif "Предварительный просмотр, таблица содержит группу строк, но не заголовок группы")  
 ...
 На панели групп строк показаны следующие элементы табликса: (**Статический**), (категория), (**статический**), и (**сведения**). Чтобы повторить или закрепить заголовки столбцов, выберите верхний элемент табликса (**Статический**) и задайте свойства в панели свойств.  
