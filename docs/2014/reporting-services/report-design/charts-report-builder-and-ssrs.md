...
ms.locfileid: "36098818"
---
# <a name="charts-report-builder-and-ssrs"></a>Диаграммы (построитель отчетов и службы SSRS)
  При необходимости сведения данных в визуальный формат используется диаграммная область данных. Диаграммы позволяют представлять большие объемы статистических данных для быстрого просмотра. Важно внимательно подготовить и осмыслить данные перед созданием диаграммы, так как это поможет создавать диаграммы быстро и качественно. Дополнительные сведения см. в разделе [Добавление диаграммы в отчет (построитель отчетов и службы SSRS)](add-a-chart-to-a-report-report-builder-and-ssrs.md). Чтобы начать использовать диаграмму немедленно, см. строки, столбца, спарклайн и учебники круговой диаграммы в [учебники &#40;построитель&#41; ](../report-builder-tutorials.md) или строка и учебники круговой диаграммы в [миграции служб Reporting Services &#40;SSRS&#41;](../reporting-services-tutorials-ssrs.md).  
...
##  <a name="InThisSection"></a> в этом разделе  
 ...
 [NULL и пустые точки данных в диаграммах &#40;отчетов построителя отчетов и службы SSRS&#41;](charts-report-builder-and-ssrs.md)  
