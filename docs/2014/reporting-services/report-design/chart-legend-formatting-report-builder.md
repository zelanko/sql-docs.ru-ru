...
## <a name="ordering-legend-items-in-the-legend"></a>Упорядочивание элементов условных обозначений  
 ...
 В условных обозначениях можно скрыть любой ряд. Если используется группирование рядов, будут скрыты все ряды, связанные со скрытым полем данных. Дополнительные сведения см. в разделе [скрыть элементы условных обозначений на диаграмме &#40;построитель отчетов и службы SSRS&#41;](chart-legend-hide-items-report-builder.md).  
...
## <a name="formatting-the-legend-text"></a>Форматирование текста условных обозначений  
 ...
 По умолчанию текст условных обозначений не оптимизируется для совпадения с областью условных обозначений. Текст условных обозначений автоматически совпадал с размером выделенного пространства, задайте свойства для свойства AutoFitTextDisabled значение `False` и задайте минимальный размер шрифта для свойства MinFontSize наименьший размер шрифта, которая будет готовое представление и также позволяет использовать условные обозначения Оптимизация.  
  
## <a name="see-also"></a>См. также  
 [Диалоговое окно «Свойства условных обозначений» — Общие &#40;отчетов построителя отчетов и службы SSRS&#41;](../legend-properties-dialog-box-general-report-builder-and-ssrs.md)   
