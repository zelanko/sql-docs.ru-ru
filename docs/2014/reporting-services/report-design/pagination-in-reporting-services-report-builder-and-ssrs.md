...
### <a name="margins"></a>Поля  
 ...
 ![Физическая страница с полями и полезной площадью.](../media/rspagemargins.gif "Физическая страница с полями и полезной площадью.")  
