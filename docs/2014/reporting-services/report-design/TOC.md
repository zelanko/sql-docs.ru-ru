...
## [Матрицы](create-a-matrix-report-builder-and-ssrs.md)
## [Списки](create-invoices-and-forms-with-lists-report-builder-and-ssrs.md)
...
## [Проверка наличия обновлений или отключение обновлений (построитель отчетов и службы SSRS)](../check-for-updates-or-turn-updates-off-report-builder-and-ssrs.md)
...
## [Установка интервала привязки в датчике](../set-a-snapping-interval-on-a-gauge-report-builder-and-ssrs.md)
## [Задание изображения для указателя на датчике](../specify-an-image-as-a-pointer-on-a-gauge-report-builder-and-ssrs.md)
...
## [План поддержки отчетов-карт](../plan-for-map-report-support.md)
...
## [Справка F1 для "Карты"](../map-f1-help.md)
### [Диалоговое окно "Правила цвета карты" — "Общие"](../map-color-rules-dialog-box-general.md)
### [Диалоговое окно "Свойства внедренной точки карты", вкладка "Маркер"](../map-embedded-point-properties-dialog-box-marker.md)
### [Диалоговое окно "Свойства меридианов карты", вкладка "Метки"](../map-meridian-properties-dialog-box-labels.md)
### [Диалоговое окно "Свойства параллелей карты", вкладка "Метки"](../map-parallel-properties-dialog-box-labels.md)
### [Диалоговое окно "Свойства окна просмотра карты", вкладка "Общие"](../map-viewport-properties-dialog-box-general.md)
### [Диалоговое окно "Свойства окна просмотра карты", вкладка "Центрирование и масштабирование"](../map-viewport-properties-dialog-box-center-and-zoom.md)
### [Диалоговое окно "Свойства окна просмотра карты", вкладка "Оптимизация"](../map-viewport-properties-dialog-box-optimization.md)
# [Изображения, текстовые поля, прямоугольники и линии](images-text-boxes-rectangles-and-lines-report-builder-and-ssrs.md)
## [Справка F1 по изображениям, текстовым полям, прямоугольникам, линиям](../image-text-box-rectangle-line-f1-help.md)
...
## [Справочник по агрегатным функциям](report-builder-functions-aggregate-functions-reference.md)
### [Агрегатная функция](report-builder-functions-aggregate-function.md)
### [Функция Avg](report-builder-functions-avg-function.md)
### [Функция Count](report-builder-functions-count-function.md)
### [Функция CountDistinct](report-builder-functions-countdistinct-function.md)
### [Функция CountRows](report-builder-functions-countrows-function.md)
### [Функция First](report-builder-functions-first-function.md)
### [Функция InScope](report-builder-functions-inscope-function.md)
### [Функция Last](report-builder-functions-last-function.md)
### [Функция Level](report-builder-functions-level-function.md)
### [Функция Lookup](report-builder-functions-lookup-function.md)
### [Функция LookupSet](report-builder-functions-lookupset-function.md)
### [Функция Max](report-builder-functions-max-function.md)
### [Функция Min](report-builder-functions-min-function.md)
### [Функция Multilookup](report-builder-functions-multilookup-function.md)
### [Функция Previous](report-builder-functions-previous-function.md)
### [Функция RowNumber](report-builder-functions-rownumber-function.md)
### [Функция RunningValue](report-builder-functions-runningvalue-function.md)
### [Функция StDev](report-builder-functions-stdev-function.md)
### [Функция StDevP](report-builder-functions-stdevp-function.md)
### [Функция Sum](report-builder-functions-sum-function.md)
### [Функция Union](report-builder-functions-union-function.md)
### [Функция Var](report-builder-functions-var-function.md)
### [Функция VarP](report-builder-functions-varp-function.md)
...
### [Встроенные глобальные значения и ссылки на пользовательские поля](built-in-collections-built-in-globals-and-users-references-report-builder.md)
### [Ссылки на коллекцию параметров](built-in-collections-parameters-collection-references-report-builder.md)
### [Ссылки на коллекцию полей набора данных](built-in-collections-dataset-fields-collection-references-report-builder.md)
### [Ссылки на коллекции DataSources и DataSets](built-in-collections-datasources-and-datasets-references-report-builder.md)
### [Ссылки на коллекции переменных отчета и группы](built-in-collections-report-and-group-variables-references-report-builder.md)
### [Ссылки на коллекцию ReportItems](built-in-collections-reportitems-collection-references-report-builder.md)
