...
##  <a name="understanding-data-scope-and-data-hierarchy"></a><a name="DataScope"></a> Общие сведения об области данных и иерархии данных  
...
##  <a name="cell-scope-and-expressions"></a><a name="Aggregates"></a> Выражения и область ячейки  
...
##  <a name="example-aggregate-expressions-for-a-table-data-region"></a><a name="Examples"></a> Примеры статистических выражений для табличной области данных  
...
##  <a name="synchronizing-scales-for-sparklines"></a><a name="Sparklines"></a> Синхронизация шкал для sparkline-графиков  
...
##  <a name="synchronizing-ranges-for-indicators"></a><a name="Indicators"></a> Синхронизация диапазонов для индикаторов  
...
##  <a name="specifying-scopes-from-the-page-header-or-page-footer"></a><a name="Page"></a> Указание областей для верхних и нижних колонтитулов  
...
##  <a name="specifying-a-toggle-item-for-drilldown-and-conditional-visibility"></a><a name="Toggles"></a> Указание переключаемых элементов для углубленной детализации и условной видимости  
...
##  <a name="specifying-a-sort-expression-to-synchronize-sort-order"></a><a name="Sort"></a> Указание выражений сортировки для синхронизации порядка сортировки  
...
##  <a name="suppressing-null-or-zero-values-in-a-cell"></a><a name="Nulls"></a> Подавление значения NULL или нулевых значений в ячейках  
