...
# <a name="matrices-report-builder-and-ssrs"></a>Матрицы (построитель отчетов и службы SSRS)
 ...
 Чтобы быстро приступить к работе с матрицами, см. в разделе [руководства: Создание матричного отчета &#40;построитель отчетов&#41;](../tutorial-creating-a-matrix-report-report-builder.md).  
