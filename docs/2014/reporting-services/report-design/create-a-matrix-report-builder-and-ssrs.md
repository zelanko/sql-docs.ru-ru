...
# <a name="matrices-report-builder-and-ssrs"></a>Матрицы (построитель отчетов и службы SSRS)
 ...
 Чтобы быстро приступить к работе с матрицами, см. [Учебник. Создание матричного отчета (построитель отчетов)](../tutorial-creating-a-matrix-report-report-builder.md).
...
>  Мастер доступен только в [!INCLUDE[ssRBDenali](../../includes/ssrbdenali-md.md)].
 ...
 ![Просмотр подготовленной для просмотра матрицы с развернутыми группами](../media/rs-basicmatrixpreview.gif "Просмотр подготовленной для просмотра матрицы с развернутыми группами")
