...
-   **Какую структуру вы хотите использовать для представления данных в отчете?**  
...
-   **Какие данные должны видеть читатели? Следует ли фильтровать данные или формат для разных аудиторий?**  
...
-   **Нужно ли создавать собственные вычисления?**  
...
-   **Вы хотите скрыть элементы отчета изначально?**  
...
-   **Как вы собираетесь доставлять отчет?**  
