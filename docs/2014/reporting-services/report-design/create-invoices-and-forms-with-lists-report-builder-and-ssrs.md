...
>  Списки можно публиковать отдельно от отчета как элементы отчета. [!INCLUDE[ssRBrptparts](../../includes/ssrbrptparts-md.md)]  
 ...
 Чтобы быстро приступить к работе со списками, см. [Учебник. Создание отчета в свободной форме (построитель отчетов)](../tutorial-creating-a-free-form-report-report-builder.md).  
...
##  <a name="DisplayingLayout"></a> Отображение данных в макете свободной формы  
 ...
 На следующем рисунке показана список, отображающий сведения о заказе, в том числе поля: Дата, Order, Qty, продукта, LineTotal и изображение.  
