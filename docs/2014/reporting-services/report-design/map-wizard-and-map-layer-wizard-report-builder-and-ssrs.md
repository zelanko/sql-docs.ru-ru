...
1.  [Выбор источника пространственных данных](#SpatialDataSource). Пространственные данные могут поступать из галереи карт, Environmental Systems Research Institute, Inc. или из реляционной базы данных [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)], содержащей пространственные данные.  
...
3.  [Выбор параметров визуализации карты](#Visualization). Выберите тип создаваемой карты.  
    ...
    -   **Выбор параметров визуализации карты: Строки**  
...
5.  **Конструирование запроса**. Сконструируйте запрос, который определяет аналитические данные.  
