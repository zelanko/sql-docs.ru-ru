...
-   **Пространственные данные.** Поле источника пространственных данных, которое содержит набор координат, указывающих местоположение.  
...
##  <a name="BackToTop"></a>Мастера карт и страницы мастера слоев карт  
...
2.  [Выберите пространственные данные и параметры представления карт](#MapView). Задайте представление и разрешение карты, укажите, внедрять ли пространственные данные в отчет и включать ли мозаичный фон [!INCLUDE[msCoName](../../../includes/msconame-md.md)] Bing Map.  
...
4.  **Выберите соединение с источником данных**. Выберите соединение с источником данных или создайте таковое для внешнего источника данных, который содержит аналитические данные, предназначенные для отображения на карте.  
  
5.  **Создание запроса**. Сконструируйте запрос, который определяет аналитические данные.  
  
6.  [Выберите набор аналитических данных](#AnalyticalData). Укажите источник аналитических данных.  
  
    -   [В чем разница между пространственными и аналитическими данными?](#Diff)  
  
7.  [Укажите поля соответствия для пространственных и аналитических данных](#SpecifyMatchFields). Постройте связь между пространственными и аналитическими данными, что позволит изменять внешний вид элементов карты в зависимости от данных.  
  
    -   [Что такое поле сопоставления?](#MatchFields)  
  
8.  [Выберите цветовую тему и визуализацию данных](#ThemeandVisualization). Чтобы определить на этой странице способ визуализации данных на фоне карты, укажите тему карты, визуализируемые поля и изменяемые параметры: цвет, размер и тип маркера.  
 ...
 Дополнительные сведения о картах см. в разделе [Maps &#40;Report Builder and SSRS&#41;](maps-report-builder-and-ssrs.md). Пошаговые инструкции по добавлению карты в отчет см. в разделе [Учебник. Отчет-карта (построитель отчетов)](../tutorial-map-report-report-builder.md).  
...
###  <a name="MapGallery"></a>Что такое коллекция карт?  
...
###  <a name="Shapefile"></a>Что такое фигуры ESRI?  
...
###  <a name="GetShapefiles"></a>Где можно получить ESRI-файлы ESRI?  
...
###  <a name="SqlServerSpatial"></a>Что такое SQL Server пространственный запрос?  
...
##  <a name="MapView"></a>Выбор пространственных данных и параметров представления карт  
...
###  <a name="Viewport"></a>Что такое представление отображения или окно просмотра?  
...
###  <a name="Resolution"></a>Что такое разрешение и оптимизация карт?  
...
###  <a name="Embed"></a>Что делает внедрение пространственных данных?  
...
##  <a name="Visualization"></a>Выбор визуализации карт  
...
###  <a name="MapType"></a>В чем разница между базовой картой, пузырьковой картой и аналитической картой?  
 ...
 Дополнительные сведения см. в разделе [Plan a Map Report &#40;Report Builder and SSRS&#41;](plan-a-map-report-report-builder-and-ssrs.md).  
...
##  <a name="SpecifyMatchFields"></a>Указание полей соответствия  
...
##  <a name="ThemeandVisualization"></a>Выбор цветовой темы и визуализации данных  
...
###  <a name="Legends"></a>Что такое условные обозначения и шкалы в предварительной версии Map для?  
...
## <a name="see-also"></a>См. также:  
 ...
 [Планирование &#40;построитель отчетов отчетов и служб SSRS&#41;](plan-a-map-report-report-builder-and-ssrs.md)   
