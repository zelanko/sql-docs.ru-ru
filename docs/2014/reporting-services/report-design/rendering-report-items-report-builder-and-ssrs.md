...
-   Повторяющиеся заголовки столбцов и строк.  
     ...
     Верхние колонтитулы имеют приоритет над нижними. Внутренние повторяющиеся группы имеют приоритет над внешними. Элементы `RepeatWith` свойству, установленные ближе к целевой области данных имеют приоритет перед элементами, расположенными дальше от области данных.  
  
-   Маленькие элементы отчета, например текстовые поля или прямоугольники, с помощью явного свойства KeepTogether для `true`.  
  
-   Большие элементы отчета, например вложенные отчеты или элементы табликса, не являющиеся самыми внутренними, с помощью явного свойства KeepTogether для `true`.  
  
-   Значение в области данных Табликса с явной KeepTogether свойством `true`.  
