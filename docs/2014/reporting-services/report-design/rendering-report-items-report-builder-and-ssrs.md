...
-   Небольшие элементы отчета, такие как текстовые поля или прямоугольники, для которых явно задано свойство не `true`разрывать на.  
  
-   Большие элементы отчета, например вложенные отчеты или элемент табликса, не являющийся самым внутренним, с явно заданным свойством `true`не разрывать.  
  
-   Области данных табликса с явно заданным свойством, `true`равным.  
