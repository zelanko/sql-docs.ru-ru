...
-   Щелкните правой кнопкой мыши указатель датчика и выберите команду **Свойства указателя**. Для `Value`выберите поле из раскрывающегося списка или определите выражение поля, нажав кнопку **выражение** (*FX*).
...
### <a name="defining-a-group-on-a-gauge"></a>Определение группы в датчике
 ...
 Если, например, в таблице или списке, в котором необходимо отобразить данные, прошедшие статистическую обработку в группе, уже отображается несколько датчиков, то в датчик потребуется добавить группу. Дополнительные сведения см. [в разделе Добавление или удаление группы в области данных &#40;построитель отчетов и служб SSRS&#41;](add-or-delete-a-group-in-a-data-region-report-builder-and-ssrs.md).


##  <a name="positioning-elements-in-a-gauge"></a><a name="PositioningData"></a>Размещение элементов в датчике
...
-   [Установка интервала привязки на датчике &#40;построитель отчетов и SSRS&#41;](../set-a-snapping-interval-on-a-gauge-report-builder-and-ssrs.md)

-   [Укажите изображение в качестве указателя на датчике &#40;построитель отчетов и SSRS&#41;](../specify-an-image-as-a-pointer-on-a-gauge-report-builder-and-ssrs.md)
...
## <a name="see-also"></a>См. также:
 [Выражения &#40;построитель отчетов и службы ssrs&#41;](expressions-report-builder-and-ssrs.md) [фильтровать, группировать и сортировать данные &#40;построитель отчетов и SSRS&#41;](filter-group-and-sort-data-report-builder-and-ssrs.md) [параметры отчета &#40;построитель отчетов и конструктор отчетов](report-parameters-report-builder-and-report-designer.md)&#41;[диаграммы &#40;построитель отчетов](charts-report-builder-and-ssrs.md) и списки SSRS&#41;&#40;[Построитель отчетов и SSRS&#41;](tables-matrices-and-lists-report-builder-and-ssrs.md)
