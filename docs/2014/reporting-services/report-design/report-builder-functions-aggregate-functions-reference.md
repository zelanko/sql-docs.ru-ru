...
-   [Ограничения вложенных статистических выражений](#NestedRestrictions)  
  
-   [Вычисление текущих значений](#CalculatingRunningValues)  
  
-   [Получение количества строк](#RetrievingRowCounts)  
  
-   [Поиск значений из другого набора данных](#LookupFunctions)  
  
-   [Получение значений, зависящих от сортировки](#RetrievingPostsortValues)  
  
-   [Получение серверных статистических выражений](#RetrievingServerAggregates)  
...
|**Функций**|**Описание**|  
|------------------|---------------------|  
|[Обращения](report-builder-functions-avg-function.md)|Возвращает среднее значение всех числовых значений, отличных от NULL, заданных выражением, вычисляемым для данной области.|  
|[Расчета](report-builder-functions-count-function.md)|Возвращает количество значений, отличных от NULL, определяемое выражением, вычисляемым в контексте данной области.|  
...
|[Максимальной](report-builder-functions-max-function.md)|Возвращает максимальное значение всех числовых значений, отличных от NULL, заданных выражением, вычисляемым в контексте данной области. Можно использовать для задания максимального значения оси диаграммы при управлении масштабом.|  
|[Минимум](report-builder-functions-min-function.md)|Возвращает минимальное значение всех числовых значений, отличных от NULL, заданных выражением, вычисляемым в контексте данной области. Можно использовать для задания минимального значения оси диаграммы при управлении масштабом.|  
|[СТАНДОТКЛОН](report-builder-functions-stdev-function.md)|Возвращает стандартное отклонение всех числовых значений, отличных от NULL, заданных выражением, вычисляемым для данной области.|  
...
|[Функции](report-builder-functions-sum-function.md)|Возвращает сумму всех числовых значений, отличных от NULL, заданных выражением, вычисляемым для данной области.|  
|[Наборов](report-builder-functions-union-function.md)|Возвращает объединение всех значений пространственных данных типа `SqlGeometry` или `SqlGeography`, не равных NULL и указанных с помощью выражения, которое вычисляется в заданной области.|  
...
##  <a name="NestedRestrictions"></a>Ограничения вложенных статистических выражений  
...
|Контекст|RunningValue|RowNumber|Первый<br /><br /> Последний|Предыдущий|Sum и другие функции предварительной сортировки|Агрегаты ReportItem|Функции поиска|Агрегатная функция|  
|-------------|------------------|---------------|--------------------|--------------|-------------------------------------|---------------------------|----------------------|------------------------|  
|Текущее значение|нет|нет|нет|нет|Да|нет|Да|нет|  
|Первый<br /><br /> Последний|нет|нет|нет|нет|Да|нет|нет|нет|  
|Предыдущий|Да|Да|Да|нет|Да|нет|Да|нет|  
...
##  <a name="RetrievingRowCounts"></a>Получение количества строк  
...
##  <a name="LookupFunctions"></a>Поиск значений из другого набора данных  
...
##  <a name="RetrievingPostsortValues"></a>Получение значений, зависящих от сортировки  
...
|**Функций**|**Описание**|  
|------------------|---------------------|  
|[Началь](report-builder-functions-first-function.md)|Возвращает первое значение указанного выражения для заданной области.|  
...
|[Прошлом](report-builder-functions-previous-function.md)|Возвращает значение или значение статистического выражения для предыдущего экземпляра элемента внутри заданной области.|  
  
##  <a name="RetrievingServerAggregates"></a>Получение серверных статистических выражений  
...
|**Функций**|**Описание**|  
|------------------|---------------------|  
|[Множеств](report-builder-functions-aggregate-function.md)|Возвращает пользовательские статистические данные заданного выражения в соответствии с определением поставщика данных.|  
...
|--------------|-----------------|  
|[Функция InScope](report-builder-functions-inscope-function.md)|Указывает, входит ли текущий экземпляр элемента в пределы указанной области действия.|  
