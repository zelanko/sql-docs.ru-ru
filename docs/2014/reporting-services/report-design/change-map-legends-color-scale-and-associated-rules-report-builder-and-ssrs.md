...
2.  Щелкните правой кнопкой мыши слой, на котором находятся нужные данные, и выберите пункт _ \<правило цвета типа\>элемента Map_.**Color Rule**  
...
2.  Щелкните правой кнопкой мыши слой, на котором находятся нужные данные, и выберите пункт _ \<\>правило типа элемента Map_.**Rule**  
