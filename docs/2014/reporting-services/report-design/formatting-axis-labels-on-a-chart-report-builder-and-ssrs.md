...
|Дата и время|Категории отображаются в хронологическом порядке вдоль оси X.|Отчет по продажам по месяцам отображает по оси X отформатированные даты.|
|строк|Категории отображаются вдоль оси X в том порядке, в котором они встречаются в источнике данных.|Отчет по продажам по региону отображает названия регионов по оси X.|
...
## <a name="see-also"></a>См. также:
 [Форматирование диаграммы &#40;построитель отчетов и ssrs&#41;](formatting-a-chart-report-builder-and-ssrs.md) [диаграммы &#40;построитель отчетов и SSRS&#41;](charts-report-builder-and-ssrs.md) [Форматирование точек данных на диаграмме &#40;построитель отчетов и SSRS&#41;](formatting-data-points-on-a-chart-report-builder-and-ssrs.md)
