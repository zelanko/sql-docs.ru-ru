...
-   **Обрабатывать.** Пузырьковые диаграммы демонстрируют разницу между двумя значениями точки данных с помощью размера пузырька. Чем больше пузырек, тем больше разница.  
