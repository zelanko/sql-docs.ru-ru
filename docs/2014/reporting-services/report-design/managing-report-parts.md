...
|--------------|-----------------|---------------------------------------------|  
|name|Это один из критериев поиска в галерее элементов отчетов.|Да|  
...
|Добавление, удаление, изменение свойств элементов и загрузка элементов отчетов|Проектирование<br /><br /> Участие|  
