...
```  
 ...
 Следующий пример содержит ссылку на код и код реализации функции `FixSpelling`, которая заменяет текст `"Bicycle"` всех вхождений текста «Bike» в `SubCategory` поля.  
