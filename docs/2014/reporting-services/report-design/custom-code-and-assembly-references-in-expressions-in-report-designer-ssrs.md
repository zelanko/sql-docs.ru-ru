...
##  <a name="RB3"></a>Работа с пользовательским кодом в построитель отчетов  
...
##  <a name="Common"></a>Включение ссылок на часто используемые функции  
...
##  <a name="NotCommon"></a>Включение ссылок на менее часто используемые функции  
...
##  <a name="External"></a>Включение ссылок на внешние сборки  
...
|Description|Ссылки в выражении|Определение пользовательского кода|  
|-----------------|-----------------------------|----------------------------|  
