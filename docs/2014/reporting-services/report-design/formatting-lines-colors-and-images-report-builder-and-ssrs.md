...
## <a name="borders-lines-and-gridlines"></a>Границы, линии и сетки  
 ...
 Границу можно также добавить в сам отчет. Дополнительные сведения см. в разделе [Add a Border to a Report &#40;Report Builder and SSRS&#41;](add-a-border-to-a-report-report-builder-and-ssrs.md).  
