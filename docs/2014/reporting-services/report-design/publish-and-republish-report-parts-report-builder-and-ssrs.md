...
3.  Измените имя и описание элемента отчета: Дважды щелкните имя, чтобы изменить его и щелкните **описание** поля для добавления описания.  
