...
##  <a name="SizingIndicatators"></a> Изменение размера индикаторов для улучшения визуального восприятия  
 ...
 Можно использовать выражения для динамического изменения размера звездочек на основе значений поля, используемого индикатором. Дополнительные сведения см. в разделе [Указание размера индикатора с помощью выражения &#40;построитель отчетов и службы SSRS&#41;](specify-the-size-of-an-indicator-using-an-expression-report-builder-and-ssrs.md).  
...
-   [Добавление или удаление индикатора &#40;отчетов построителя отчетов и службы SSRS&#41;](add-or-delete-an-indicator-report-builder-and-ssrs.md)  
...
-   [Указание размера индикатора с помощью выражения &#40;отчетов построителя отчетов и службы SSRS&#41;](specify-the-size-of-an-indicator-using-an-expression-report-builder-and-ssrs.md)  
  
-   [Добавление индикаторов и датчиков на панель датчиков &#40;отчетов построителя отчетов и службы SSRS&#41;](include-indicators-and-gauges-in-a-gauge-panel-report-builder-and-ssrs.md)  
