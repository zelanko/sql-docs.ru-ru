...
-   [Открытие страниц управления приложениями службы](#bkmk_openpages)

-   [Страница «системные параметры»](#bkmk_systemsettings)
...
##  <a name="bkmk_openpages"></a>Открытие страниц управления приложениями службы
...
##  <a name="bkmk_systemsettings"></a>Страница «системные параметры»
...
-   [Параметры системы для ведения журнала](#bkmk_logging_settings_section)
...
|Время ожидания отчета EDLX|По умолчанию это 1800 секунд.|

###  <a name="bkmk_logging_settings_section"></a>Параметры системы для ведения журнала
...
###  <a name="bkmk_client_settings_section"></a>Параметры клиента
 ...
 **Укажите учетную запись выполнения** Выберите, чтобы указать учетную запись.
 ...
 **Подтверждение пароля** Введите пароль снова.

##  <a name="bkmk_email"></a>Параметры электронной почты
 ...
 **Исходящий SMTP-сервер** Укажите SMTP-сервер или шлюз для использования. Можно использовать локальный сервер или SMTP-сервер.
...
##  <a name="bkmk_provisionsubscriptions"></a>Подготавливайте подписки и оповещения
