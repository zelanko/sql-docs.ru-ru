...
##  <a name="UpdateNames"></a>2. обновление имен по умолчанию для источника данных и набора данных  
...
##  <a name="Concatenate"></a>3. Отображение имени, начального и последнего имени  
...
##  <a name="Gender"></a>4. Использование изображений для вывода пола  
...
##  <a name="Lookup"></a>5. Поиск имени в названии "страна"  
...
##  <a name="Count"></a>6. Подсчет дней с момента последней покупки  
...
##  <a name="Indicator"></a>7. Использование индикатора для отображения сравнения продаж  
...
##  <a name="GreenBar"></a>8. Сделайте отчет отчетом «зеленая полоса»  
...
##  <a name="DateFormat"></a>используемых Форматировать столбец даты  
...
##  <a name="Title"></a>используемых Добавление заголовка отчета  
...
##  <a name="Save"></a>используемых Сохранение отчета  
