...
##  <a name="what-is-report-manager"></a><a name="bkmk_whatis_report_manager"></a>Что такое диспетчер отчетов?
...
##  <a name="start-and-use-report-manager"></a><a name="bkmk_start_report_manager"></a>Запуск и использование диспетчер отчетов
...
##  <a name="icon-descriptions"></a><a name="bkmk_icon_descriptions"></a>Описания значков
...
- [Управление содержимым сервера отчетов &#40;служб SSRS в собственном режиме&#41;](report-server/report-server-content-management-ssrs-native-mode.md) 
 [Диспетчер отчетов Справка F1](../../2014/reporting-services/report-manager-f1-help.md)