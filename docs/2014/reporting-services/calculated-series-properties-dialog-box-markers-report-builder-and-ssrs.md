 ...
 **Тип маркера**  
 Выберите тип маркера, если на диаграмме включены маркеры. По умолчанию этот параметр имеет значение **Круг**.  
  
 **Размер маркера**  
 Выберите размер маркера для точки данных.  
  
 **Цвет маркера**  
 Выберите цвет маркеров для точек данных.  
  
 **Ширина границы маркера**  
 Выберите ширину рамки маркеров для точек данных.  
