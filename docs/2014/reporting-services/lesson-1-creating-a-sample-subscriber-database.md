...
# <a name="lesson-1-creating-a-sample-subscriber-database"></a>Занятие 1. Создание образца базы данных подписчика
 ...
 В этом занятии предполагается [!INCLUDE[ssManStudio](../includes/ssmanstudio-md.md)] , что вы [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)] используете для создания базы данных.  
