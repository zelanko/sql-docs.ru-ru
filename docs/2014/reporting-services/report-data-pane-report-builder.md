---
title: Область данных (построитель отчетов) отчета | Документы Microsoft
ms.custom: ''
ms.date: 06/13/2017
