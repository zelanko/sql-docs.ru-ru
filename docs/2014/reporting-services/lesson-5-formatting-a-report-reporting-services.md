...
-   [Форматирование даты](#bkmk_format_date)  
  
-   [Форматирование валюты](#bkmk_format_currency)  
  
-   [Изменение стиля текста и ширины столбцов](#bkmk_change_textstyle)  
  
##  <a name="format-the-date"></a><a name="bkmk_format_date"></a>Форматирование даты  
...
##  <a name="format-the-currency"></a><a name="bkmk_format_currency"></a>Форматирование валюты  
...
4.  Чтобы просмотреть отчет, перейдите на вкладку **Предварительный просмотр** . Он должен выглядеть примерно так:  
     ...
     ![Просмотр таблицы с заголовками столбцов, выделенными полужирным](../../2014/tutorials/media/rs-basictabledetailsformattedpreview.gif "Предварительный просмотр таблицы с заголовками столбцов, выделенными полужирным")  
