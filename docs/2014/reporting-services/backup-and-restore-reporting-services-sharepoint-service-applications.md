---
title: Резервное копирование и восстановление служб отчетности SharePoint сервисные приложения (ru) Документы Майкрософт
ms.custom: ''
ms.date: 06/13/2017
...
-   [Резервное копирование Приложение Службы](#bkmk_backup)  
...
##  <a name="backup-the-service-application"></a><a name="bkmk_backup"></a>Резервное копирование Приложение Службы  
...
### <a name="backup-the-encryption-keys-using-central-administration"></a>Выполните резервное копирование ключей шифрования, с помощью центра администрирования  
 Для получения информации [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)] о резервном копировании ключей [Manage a Reporting Services SharePoint Service Application](../../2014/reporting-services/manage-a-reporting-services-sharepoint-service-application.md)шифрования см.  
  
###  <a name="backup-the-service-application-using-sharepoint-central-administration"></a><a name="bkmk_centraladmin"></a>Резервное копирование приложения службы с помощью Центрального администрирования SharePoint  
...
1.  В Центральном управлении SharePoint нажмите **«Управление сервисом»** в группе **управления приложениями.**  
  
2.  Нажмите на имя вашего приложения службы, а затем нажмите **Управление** в SharePoint Лента.  
...
### <a name="restore-the-encryption-keys-using-central-administration"></a>Восстановление ключей шифрования с помощью центра администрирования  
 Информацию о [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)] восстановлении ключей шифрования можно узнать в разделе "Ключи шифрования" в разделе [Управление сервисом Reporting Services SharePoint Service.](../../2014/reporting-services/manage-a-reporting-services-sharepoint-service-application.md)  
...
1.  В Центральном администрировании SharePoint нажмите **На управление приложениями управления** в группе управления **приложениями.**  
