 ...
 **Учетная запись выполнения.** Чтобы проверить, используется ли ваше служебное приложение учетную запись выполнения:  
 ...
 **Проверка подлинности базы данных:** Чтобы убедиться, что приложение службы использует проверку подлинности Windows для проверки подлинности базы данных:  
 ...
 **Учетная запись выполнения.** Если служба в приложении используется учетная запись выполнения, выполните следующие действия для ее настройки:  
 ...
 **Проверка подлинности базы данных:** Если служба в приложении используется проверка подлинности Windows для завершения проверки подлинности базы данных следующие действия:  
