...
##  <a name="bkmk_backup"></a>Создание резервной копии приложения службы  
...
###  <a name="bkmk_centraladmin"></a>Резервное копирование приложения службы с помощью центра администрирования SharePoint  
...
5.  Повторите описанный выше процесс, но вместо выбора приложения службы, разверните узел **Прокси серверы общих служб** и выберите прокси-сервер приложения службы. Оно будет иметь тип **Прокси-сервер приложения службы SQL Server Reporting Services**.  
 ...
 [Резервное копирование приложения службы (SharePoint Server 2010)](https://technet.microsoft.com/library/ee428318.aspx)  
 ...
 **Учетная запись выполнения:** Чтобы проверить, использует ли приложение службы учетную запись выполнения, выполните следующие действия.  
 ...
 **Проверка подлинности базы данных:** Чтобы проверить, использует ли приложение службы проверку подлинности Windows для проверки подлинности базы данных, выполните следующие действия.  
 ...
 **Учетная запись выполнения:** Если приложение службы использует учетную запись выполнения, выполните следующие действия, чтобы настроить ее.  
 ...
 **Проверка подлинности базы данных:** Если приложение службы использует проверку подлинности Windows для проверки подлинности базы данных, выполните следующие действия.  
