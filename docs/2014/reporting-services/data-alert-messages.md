...
##  <a name="data-alert-messages"></a><a name="DataAlertMessages"></a>Сообщения предупреждений об изменении данных
 ...
 **Сообщение с результатами**
 ...
 ![Предупреждение, отправленное по электронной почте, о данных с результатами](media/rs-alertmessageresults.gif "Предупреждение, отправленное по электронной почте, о данных с результатами")

 **Сообщение об ошибке**

 ![Предупреждение о данных с сообщением об ошибке](media/rs-alertmessageerrror.gif "Предупреждение о данных с сообщением об ошибке")
