...
# <a name="reporting-services-concepts-ssrs"></a>Основные понятия служб Reporting Services (SSRS)
  В этом разделе содержится краткая сводка [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)] основных понятий.  
...
-   [Основные понятия об отчетах и связанных элементах](#bkmk_ReportsandRelatedItemConcepts)  
 ...
 **Связанные отчеты**  
 ...
 Дополнительные сведения см. в разделах [Create a Linked Report](reports/create-a-linked-report.md).  
 ...
 **Кэшированные отчеты**  
 ...
 Результаты запросов общего набора данных также могут кэшироваться. Дополнительные сведения см. в разделе [Cache Shared Datasets &#40;SSRS&#41;](report-server/cache-shared-datasets-ssrs.md).  
...
##  <a name="bkmk_StagesofReports"></a>Этапы разработки отчетов  
 ...
 ![Диаграмма обработки отчетов](media/report-execution.gif "диаграмма обработки отчета")  
...
## <a name="see-also"></a>См. также:  
 [Reporting Services функции и задачи &#40;службы SSRS&#41;](reporting-services-features-and-tasks-ssrs.md)   
