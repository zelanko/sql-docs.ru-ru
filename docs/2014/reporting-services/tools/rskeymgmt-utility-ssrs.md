 ...
 **-r**  *installationID*  
 ...
 `-v`  *Пароль*  
 (Требуется для `-u`) указывает пароль для учетной записи администратора на удаленном компьютере, который необходимо присоединить к масштабного развертывания.  
