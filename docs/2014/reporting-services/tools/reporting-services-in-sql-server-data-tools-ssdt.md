...
# <a name="reporting-services-in-sql-server-data-tools-ssdt"></a>Службы Reporting Services в SQL Server Data Tools (SSDT)
  [!INCLUDE[ssBIDevStudioFull](../../../includes/ssbidevstudiofull-md.md)][!INCLUDE[msCoName](../../../includes/msconame-md.md)] —этосредасусовершенствованиями,характернымидля[!INCLUDE[vsprvs](../../../includes/vsprvs-md.md)] решений бизнес-аналитики. Среда [!INCLUDE[ssBIDevStudioFull](../../../includes/ssbidevstudiofull-md.md)] входит в состав [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)].  
...
-   **Вид**. Переключение между двумя вкладками конструктора отчетов: Проектирование и предварительный просмотр.  
