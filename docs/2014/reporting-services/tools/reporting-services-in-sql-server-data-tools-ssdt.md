...
##  <a name="bkmk_ReportDesignerWindowsandPanes"></a> Окна и панели конструктора отчетов  
 Конструктор отчетов поддерживает два представления: **разработки** для определения данных отчета и макет отчета и **предварительной версии** позволяющее просмотреть подготовленный отчет. В каждом представлении можно вывести несколько окон для удобства конструирования или просмотра отчета.  
