...
##  <a name="bkmk_ConfigurationandDeploymentProperties"></a>Свойства конфигурации и развертывания  
...
-   TargetServerVersion — это свойство развертывания, которое определяет ожидаемую версию [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] , установленную на целевом сервере отчетов, указанном в свойстве "передающее".  
...
|Тип проекта или файла|Версия|Разработка отчетов|Публикация отчетов|Заметки|  
|--------------------------|-------------|--------------------|---------------------|-----------|  
