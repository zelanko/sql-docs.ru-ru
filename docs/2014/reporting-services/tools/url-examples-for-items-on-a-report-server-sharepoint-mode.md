...
### <a name="file-names"></a>Имена файлов  
 ...
 Если не указать расширение файла для элементов, передаваемых на сайт SharePoint, возникнет ошибка `rsInvalidDataSourceReference`. Имена файлов не могут содержать символы, которые воспринимаются приложениями SharePoint как недопустимые в именах файлов. Не включайте следующие символы: #% & *: \< >? / { | }.  
