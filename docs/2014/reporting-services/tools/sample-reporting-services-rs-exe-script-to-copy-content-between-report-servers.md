---
title: Скрипт rs.exe для переноса содержимого между серверами отчетов служб отчетов образца | Документы Microsoft
ms.custom: ''
ms.date: 07/27/2015
...
-   [!INCLUDE[ssKilimanjaro](../../../includes/sskilimanjaro-md.md)]  
 ...
 Скрипт может копировать содержимое между серверами отчетов, работающих в одном или разных режимах. Например, можно запустить скрипт, чтобы скопировать содержимое из [!INCLUDE[ssKilimanjaro](../../../includes/sskilimanjaro-md.md)] сервера отчетов в собственном режиме для [!INCLUDE[ssSQL11SP1](../../includes/sssql11sp1-md.md)] сервер отчетов в режиме интеграции с SharePoint. Можно запустить скрипт с любого сервера, на котором установлена программа RS.exe. Например, в таком развертывании можно сделать следующее.  
...
|сервер С|SharePoint|  
 ...
 Дополнительные сведения о программе RS.exe см. в разделе [RS.exe Utility &#40;SSRS&#41;](rs-exe-utility-ssrs.md).  
...
-   SOURCE_URL и TARGET_URL должен быть допустимый отчет сервера URL-адреса, указывающие на исходном и целевом [!INCLUDE[ssRSnoversion](../../../includes/ssrsnoversion-md.md)] сервера отчетов. В собственном режиме URL-адрес сервера отчетов выглядит следующим образом:  
