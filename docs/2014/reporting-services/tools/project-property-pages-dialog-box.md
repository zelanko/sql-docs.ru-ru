 ...
 **диспетчер конфигураций**  
 Служит для управления конфигурациями всего решения или добавления новых конфигураций. Дополнительные сведения см. в [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] документации.  
