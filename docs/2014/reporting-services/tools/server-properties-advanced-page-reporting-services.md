 ...
 **StoredParametersThreshold**  
 Указывает максимальное число значений параметров, которые могут быть сохранены на сервере отчетов. Допустимы следующие значения: `-1` и от `+1` до `2,147,483,647`. Значение по умолчанию — `1500`.  
