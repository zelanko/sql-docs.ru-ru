...
##  <a name="rendering-extension-types"></a><a name="RendererTypes"></a>Типы модулей подготовки отчетов  
...
##  <a name="export-formats"></a><a name="ExportFormats"></a>Форматы экспорта  
...
##  <a name="exporting-a-report"></a><a name="ExportingReport"></a>Экспорт отчета  
...
##  <a name="generating-data-feeds-from-a-report"></a><a name="GeneratingDataFeedsFromReport"></a>Создание веб-каналов данных из отчета  
...
##  <a name="troubleshooting-exported-reports"></a><a name="Troubleshooting"></a>Устранение неполадок экспортированных отчетов  
...
##  <a name="other-ways-of-exporting-reports"></a><a name="OtherWaysExportingReports"></a>Другие способы экспорта отчетов  
