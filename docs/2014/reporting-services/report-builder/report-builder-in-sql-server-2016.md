...
-   **Начните с мастера таблиц, матриц или диаграмм**. Выберите соединение с источником данных, перетащите поля, чтобы создать запрос к набору данных, выберите макет и стиль и настройте отчет.  
  
-   **Начните с мастера карт** , чтобы создать отчеты, отображающие агрегированные данные относительно географического или геометрического фона. На карте могут размещаться пространственные данные из запроса [!INCLUDE[tsql](../../includes/tsql-md.md)] или из файла фигуры ESRI (Environmental Systems Research Institute, Inc.). Файл фигуры (ESRI). Также можно добавлять мозаичный фон карты [!INCLUDE[msCoName](../../../includes/msconame-md.md)] Bing.  
...
-   **Добавление диаграмм, датчиков, спарклайнов и индикаторов** для суммирования данных в визуальном формате и представления больших объемов агрегированных данных на самом взгляде.  
  
-   **Добавьте интерактивные функции** , такие как схемы документов, кнопки Показать/скрыть, а также ссылки детализации на вложенные отчеты и детализированный отчет. С помощью параметров и фильтров можно отфильтровать данные для пользовательских представлений.  
  
-   **Внедрять или ссылаться на изображения** и другие ресурсы, включая внешнее содержимое.  
  

  
##  <a name="ManageRpt"></a>Управление отчетом  
  
-   **Сохраните определение отчета** на компьютере или на сервере отчетов, где вы можете управлять им и использовать его совместно с другими пользователями.  
  
-   **Выберите формат представления** при открытии отчета или после открытия отчета. Можно выбрать следующие формы представления отчета: веб-страница, страница документа и приложение. Доступны следующие форматы: HTML, MHTML, PDF, XML, CSV, TIFF, Word и Excel.  
...
-   **Создание веб-каналов данных** из отчета с помощью модуля подготовки отчетов Reporting Services Atom.  
...
##  <a name="InThisSection"></a> в этом разделе  
 ...
 [Учебник. Создание отчета с быстрой диаграммой в автономном режиме](tutorial-create-a-quick-chart-report-offline-report-builder.md)  
 ...
 [Планирование построитель отчетов &#40;отчетов&#41;](../report-design/planning-a-report-report-builder.md)  
 ...
 [Представление конструктора общего набора данных &#40;построитель отчетов&#41;](shared-dataset-design-view-report-builder.md)  
