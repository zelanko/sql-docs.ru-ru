...
##  <a name="TwoWays"></a>Два способа работы с этим руководством  
  
-   [Создание круговой диаграммы с XML-данными](#CreatePieChartXML)  
...
##  <a name="AfterWizard"></a>После запуска мастера  
