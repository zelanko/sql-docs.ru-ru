...
##  <a name="WordBenefits"></a> Преимущества использования модуля подготовки Word  
 Помимо внесения функций, которые были добавлены в [!INCLUDE[ofprword](../../includes/ofprword-md.md)] 2007-2010, можно экспортировать отчеты, файлы экспортированных отчетов в файл с расширением DOCX, как правило, требует меньше места. Отчеты, экспортированные с использованием модуля подготовки отчетов Word, обычно намного меньше, чем такие же отчеты, экспортированные с использованием модуля подготовки отчетов Word 2003.  
...
##  <a name="Differences"></a> Различия между Word и модули подготовки отчетов Word 2003  
