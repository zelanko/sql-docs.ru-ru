...
### <a name="insert-tab"></a>Вкладка «Вставить»  
 ...
 Щелкнув **элементы отчета** при вставке вкладка открывается в галерее элементов отчетов. Можно выполнить поиск элементов отчетов, сохраненных на сервере отчетов. Дополнительные сведения см. в разделе [Элементы отчета (построитель отчетов и службы SSRS)](../report-parts-report-builder-and-ssrs.md).  
...
### <a name="run-tab"></a>Вкладка «Выполнить»  
 При нажатии кнопки **запуска** на вкладке "Главная" выполнить предварительный просмотр отчета в средстве просмотра HTML и появится вкладка «выполнить» вместо вкладки «Главная».  
 ...
 Чтобы вернуться в представление конструктора отчетов на **запуска** щелкните **конструктора**.  
...
-   [Встроенные глобальные значения и ссылки на &#40;отчетов построителя отчетов и службы SSRS&#41;](../report-design/built-in-collections-built-in-globals-and-users-references-report-builder.md)  
