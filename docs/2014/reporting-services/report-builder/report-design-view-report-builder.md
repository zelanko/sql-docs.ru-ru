...
### <a name="insert-tab"></a>Вкладка «Вставить»  
 ...
 При выборе **элементов отчета** на вкладке Вставка открывается Галерея элементов отчетов. Можно выполнить поиск элементов отчетов, сохраненных на сервере отчетов. Дополнительные сведения см. в разделе [Report parts &#40;построитель отчетов and SSRS&#41;](../report-parts-report-builder-and-ssrs.md).  
...
##  <a name="RptDesignSurface"></a>область конструктора отчета  
...
##  <a name="ReptPartGallery"></a>Коллекция элементов отчетов  
...
>  Для просмотра галереи элементов отчетов необходимо подключение к серверу отчетов.  
 ...
 Результаты поиска можно просматривать в виде миниатюр или списка, а также сортировать результаты поиска по именам, датам создания и изменения или именам пользователей, создавших части отчетов. Дополнительные сведения см. в разделе [Report parts &#40;построитель отчетов and SSRS&#41;](../report-parts-report-builder-and-ssrs.md).  
  
  
##  <a name="PropertiesPane"></a>Панель "Свойства" (построитель отчетов)  
