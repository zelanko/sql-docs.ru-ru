...
##  <a name="ReportDataAsDataFeeds"></a>Отчеты как веб-каналы данных  
...
##  <a name="DataFeeds"></a>Веб-каналы данных  
...
### <a name="data-section"></a>Раздел данных  
 ...
 В следующем XML-коде показан `entry` элемент <> из этого отчета в веб-канале данных. Обратите внимание, `entry` что элемент> <включает в себя итоги продаж и заказов для группы, а также итоги по продажам и заказам для всех групп. Элемент> `entry` <включает все значения отчета.  
...
##  <a name="FlatteningReportData"></a>Сведение данных отчета  
...
-   Значения параметров отчета включаются в каждую выходную строку.  
 ...
 Иерархические и группированные данные должны быть переведены в плоский формат, чтобы их можно было представить в формате, соответствующем Atom. Модуль подготовки отчетов делает отчет плоским, преобразуя его в древовидную структуру, отображающую вложенные группы области данных. Формирование плоского отчета происходит следующим образом.  
...
##  <a name="AtomRendering"></a>Правила подготовки к просмотру Atom  
