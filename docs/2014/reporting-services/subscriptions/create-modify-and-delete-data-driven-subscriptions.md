...
##  <a name="bkmk_run_subscription"></a> Запуск подписки  
 ...
 ![Примечание](../media/rs-fyinote.png "Примечание") Хотя возможность отсутствует пользовательский интерфейс, который можно использовать для немедленного запуска подписки, можно использовать простой сценарий Windows PowerShell для запуска подписки. Дополнительные сведения см. в разделе «сценарий: запуск (вызов) одной подписки» раздела [использование PowerShell для изменения и список Reporting Services Subscription Owners and Run a Subscription](manage-subscription-owners-and-run-subscription-powershell.md).  
