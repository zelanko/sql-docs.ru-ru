---
title: Создание, изменение и удаление управляемой данными подписки | Документы Microsoft
ms.custom: ''
ms.date: 06/13/2017
...
-   [Определите запрос, который получает сведения о подписке](#bkmk_define_query)  
...
3.  Выберите подписку, которую хотите изменить. Управляемая данными подписка обозначается следующим значком: ![Значок подписки, управляемой данными](../media/hlp-16subscriptiondd.gif "Значок подписки, управляемой данными")  
...
##  <a name="bkmk_define_query"></a> Определите запрос, который получает сведения о подписке  
...
##  <a name="bkmk_run_subscription"></a> Запуск подписки  
 ...
 ![Примечание](../media/rs-fyinote.png "Примечание") пока отсутствует возможность в пользовательском интерфейсе, который можно использовать для немедленного запуска подписки, можно использовать простой сценарий Windows PowerShell для запуска подписки. Дополнительные сведения см. в разделе «сценарий: запуск (вызов) одной подписки» раздела [изменений и список Reporting Services Subscription Owners и выполнения подписки с помощью PowerShell](manage-subscription-owners-and-run-subscription-powershell.md).  
...
## <a name="see-also"></a>См. также  
 ...
 [Страница "Подписки" (диспетчер отчетов)](../subscriptions-page-report-manager.md)   
