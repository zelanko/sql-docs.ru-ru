...
## <a name="setting-delivery-options"></a>Настройка параметров доставки  
 ...
 путь  
 Указывает полный URL-адрес библиотеки SharePoint, включая имя сайта и веб-приложения SharePoint. Например: <http://mySharePointWeb/MySite/MyDocLib>; где "<http://mySharePointWeb>" обозначает веб-приложение, "сайт" является сайтом SharePoint, а "Библиотека" — это библиотека SharePoint, в которой будет доставлен отчет.  
