...
-   **Папка файла:** Можно доставлять документа, основанного на исходном отчете, в общую папку в файловой системе. Следует выбрать существующую папку, доступную через сетевое подключение.  
