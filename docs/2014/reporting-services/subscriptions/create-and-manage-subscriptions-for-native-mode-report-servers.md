...
###  <a name="bkmk_create_fileshare_subscription"></a>Создание подписки на общую папку  
...
9. В текстовых полях **имя пользователя** и **пароль** укажите учетные данные, необходимые для доступа к общей папке, используя формат * \<домен>* \\ * \<имя пользователя>* имя пользователя.  
...
## <a name="see-also"></a>См. также:  
 ...
 [Использовать «Мои подписки»](use-my-subscriptions-native-mode-report-server.md)  
