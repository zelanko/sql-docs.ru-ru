...
##  <a name="characteristics-of-a-report-that-is-delivered-to-a-shared-folder"></a><a name="bkmk_Characteristics"></a>Характеристики отчета, доставляемого в общую папку  
...
##  <a name="target-folders"></a><a name="bkmk_target_folders"></a>Целевые папки  
...
##  <a name="file-formats"></a><a name="bkmk_file_formats"></a> Форматы файлов  
...
##  <a name="file-options"></a><a name="bkmk_file_options"></a> Параметры файла  
