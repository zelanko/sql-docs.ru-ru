...
##  <a name="bkmk_sharepoint"></a>Просмотр и отмена заданий (режим интеграции с SharePoint)  
...
## <a name="see-also"></a>См. также:  
 [Отмена &#40;Management Studio заданий сервера отчетов&#41;](../tools/cancel-report-server-jobs-management-studio.md)   
 [Свойства задания &#40;Management Studio&#41;](../tools/job-properties-management-studio.md)   
