...
##  <a name="bkmk_native"></a>Создание общих расписаний и управление ими (собственный режим)  
...
7.  Выберите дату запуска расписания (необязательно). Значение по умолчанию — текущий день. Можно отложить запуск расписания, выбрав более позднюю дату.  
...
1.  В диспетчере отчетов щелкните **Настройки сайта**на главной панели инструментов.  
    ...
    > [!NOTE]  
    >  Если **Параметры сайта** недоступны, у вас нет разрешения на доступ к параметрам сайта.  
...
5.  Выберите дату запуска расписания (необязательно). Значение по умолчанию — текущий день.  
