...
-   [Создание общих расписаний и управление ими (режим интеграции с SharePoint)](#bkmk_sharepoint)  
  
-   [Создание общих расписаний и управление ими (собственный режим)](#bkmk_native)  
  
##  <a name="overview-of-managing-shared-schedules"></a><a name="bkmk_overview"></a>Общие сведения об управлении общими расписаниями  
 Для управления общими расписаниями для собственного режима используйте страницу «Расписания» диспетчера отчетов или папку «Общие расписания» среды [!INCLUDE[ssManStudio](../../includes/ssmanstudio-md.md)]. Для режима интеграции с SharePoint используйте страницы управления для приложения служб [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] .  
...
##  <a name="create-and-manage-shared-schedules-sharepoint-mode"></a><a name="bkmk_sharepoint"></a>Создание общих расписаний и управление ими (режим интеграции с SharePoint)  
...
##  <a name="create-and-manage-shared-schedules-native-mode"></a><a name="bkmk_native"></a>Создание общих расписаний и управление ими (собственный режим)  
...
1.  В диспетчере отчетов щелкните **Настройки сайта**на главной панели инструментов.  
    ...
    > [!NOTE]  
    >   Если кнопка **Настройки сайта** недоступна, значит отсутствуют разрешения для доступа к настройкам веб-сайта.  
