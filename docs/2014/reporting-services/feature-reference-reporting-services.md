...
## <a name="in-this-section"></a>в этом разделе  
 ...
 Предоставляет справку для диалоговых окон, используемых для управления отчетами и [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] [!INCLUDE[ssManStudio](../includes/ssmanstudio-md.md)]серверами отчетов в.  
