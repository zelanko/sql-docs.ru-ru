...
##  <a name="bkmk_SecureReportsSummary"></a>Защита отчетов  
...
## <a name="upgrade-reports"></a>Upgrade Reports  
 [!INCLUDE[ssRSnoversion](../../../includes/ssrsnoversion-md.md)]поддерживает несколько версий определений отчетов, серверов отчетов и сайтов SharePoint. Обновить отчет можно следующим образом.  
