...
|`DpiX`|Горизонтальное разрешение изображения вывода. Значение по умолчанию — **96**. Применяется к `BMP`выходным `PNG`форматам `TIFF` , `GIF`, и.|  
|`DpiY`|Вертикальное разрешение изображения вывода. Значение по умолчанию — **96**. Применяется к `BMP`выходным `PNG`форматам `TIFF` , `GIF`, и.|  
