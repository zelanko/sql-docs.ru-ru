...
6.  Чтобы просмотреть отчет в выбранном для экспорта формате, выберите **Открыть**.  
     ...
     **Примечание** . Если программа не может открыть отчет в выбранном формате из-за отсутствия программы, связанной с этим типом файлов, будет предложено сохранить экспортированный отчет или найти программу в Интернете, чтобы открыть отчет.  
