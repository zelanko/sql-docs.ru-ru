...
# <a name="report-parts-report-builder-and-ssrs"></a>Элементы отчета (построитель отчетов и службы SSRS)
  Элементы отчета, такие как таблицы, матрицы, диаграммы и изображения, можно публиковать как *элементы отчета*. Части отчета — это элементы отчета, опубликованные отдельно на сервере отчетов, которые можно повторно использовать в других отчетах. Элементы отчета имеют расширение RSC.  
...
##  <a name="UpdatingComponents"></a>Обновление элементов отчета с изменениями с сервера  
...
##  <a name="RepublishingComponents"></a>Обновление элементов отчета, уже насуществующих на сервере  
...
##  <a name="RptPartsRptDesigner"></a>Работа с элементами отчета в конструктор отчетов  
...
##  <a name="HowTo"></a>Разделы руководства  
 [Публикация и повторная публикация элементов отчетов &#40;построитель отчетов и SSRS&#41;](report-parts-report-builder-and-ssrs.md)  
