...
##  <a name="HowTo"></a> Инструкции  
 [Опубликовать и переиздать элементы отчета &#40;отчетов построителя отчетов и службы SSRS&#41;](report-parts-report-builder-and-ssrs.md)  
 ...
 [Проверка наличия обновлений или отключение обновлений, &#40;отчетов построителя отчетов и службы SSRS&#41;](../../2014/reporting-services/check-for-updates-or-turn-updates-off-report-builder-and-ssrs.md)  
...
## <a name="see-also"></a>См. также  
 ...
 [Инструкции: создание многократно используемые элементы отчетов с помощью построителя отчетов SQL Server (видео)](http://technet.microsoft.com/sqlserver/ff634166.aspx)  
