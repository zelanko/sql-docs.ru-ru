...
2.  Выберите заголовок столбца в табликсе, щелкните правой кнопкой мыши выделенную серым цветом ячейку, которая появляется над заголовком столбца и нажмите кнопку **свойства Табликса**.  
  
3.  Щелкните **фильтры** и нажмите кнопку **добавить**.  
  
4.  В **выражение** выберите `ProductID` из раскрывающегося списка. Это столбец, к которому применяется фильтр.  
  
5.  Нажмите кнопку равенства (**=**) оператор в **оператор** раскрывающегося списка.  
  
6.  Нажмите кнопку выражения рядом с **значение** щелкните **параметры** в **категории** области, а затем дважды щелкните `productid` в  **Значения** области. Поле **Задать выражение для: Значение** теперь должно содержать выражение, аналогичное **=Parameters!productid.Value**.  
  
7.  Нажмите кнопку **ОК,** и **ОК** еще раз в **свойства Табликса** диалоговое окно.  
...
3.  На **свойства** области, нажмите кнопку **события** значок.  
