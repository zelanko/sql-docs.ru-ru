...
## <a name="reporting-services-style-sheets"></a>Таблицы стилей служб Reporting Services  
 В следующей таблице описаны файлы таблиц стилей (CSS) стилей, которые используются в [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)] установки.  
