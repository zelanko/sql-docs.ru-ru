---
title: Внедренные и общие подключения к данным или источники данных (построитель отчетов и службы SSRS) | Документы Microsoft
ms.custom: ''
ms.date: 06/13/2017
...
## <a name="shared-data-sources"></a>Общие источники данных  
 ...
 Следующий значок обозначает общего элемента источника данных в иерархии папок сервера отчетов: ![общий значок источника данных](media/hlp-16datasource.png "общий значок источника данных")  
