...
## <a name="shared-data-sources"></a>Общие источники данных  
 ...
 Следующий значок обозначает общего элемента источника данных в иерархии папок сервера отчетов: ![значок общего источника данных](media/hlp-16datasource.png "значок общего источника данных")  
