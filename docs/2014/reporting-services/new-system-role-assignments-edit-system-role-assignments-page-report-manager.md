---
title: 'Создание назначений системной роли: Изменение системы роли «назначения» (диспетчер отчетов) | Документы Microsoft'
ms.custom: ''
ms.date: 03/06/2017
 ...
 **Roles**  
 ...
 В диспетчере отчетов не отображаются задачи каждой роли и не предусмотрено способа добавления или изменения задач. Роли следует использовать в том виде, в каком они были определены. Для создания, изменения, или удаление ролей, используйте [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] [!INCLUDE[ssManStudio](../includes/ssmanstudio-md.md)]. Дополнительные сведения см. в разделе [создать, удалить или изменить роль &#40;Management Studio&#41;](security/role-definitions-create-delete-or-modify.md).  
