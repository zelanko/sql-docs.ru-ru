...
|Свойство|Тип|RW|Значение по умолчанию|Описание|  
|--------------|----------|--------|-------------|-----------------|  
...
|Культура|Int32|RW|Локаль браузера|Указывает код локали (код языка). Это значение определяет единицы измерения для вводимых пользователем значений. Например, если пользователь вводит `3`, значение будет иметь измеряется в миллиметрах для французского языка или в дюймах, если язык не английский (США). Допустимы следующие значения. 1028, 1031, 1033, 1036, 1040, 1041, 1042, 2052, 3082.|  
|UICulture|String|RW|Client culture|Определяет локализацию текста в диалоговом окне. Текст в диалоговом окне печати локализована на следующие языки: Китайский (упрощенное письмо), китайский традиционный, английский, французский, немецкий, итальянский, японский, корейский и испанский. Допустимы следующие значения. 1028, 1031, 1033, 1036, 1040, 1041, 1042, 2052, 3082.|  
