...
1.  [Создание нового отчета из Приступая к работе](#CreateTable)  
...
3.  [Формат данных в формат даты](#FormatDate)  
...
3.  В **имя**, тип **продажи продукта** имя источника данных.  
  
4.  Убедитесь, что в поле **Выберите тип соединения**выбран тип **Microsoft SQL Server** .  
  
5.  В **строка подключения**, введите следующий текст, где  *\<имя_сервера >* — имя экземпляра [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]:  
...
##  <a name="Query"></a> 1b. Создание запроса в мастере таблиц  
...
1.  На **Выбор стиля** на панели «Стили» выберите Аквамарин.  
...
3.  На **Главная** вкладке **номер** нажмите кнопку вызова диалогового окна.  
...
##  <a name="Export"></a> 7. Экспорт отчета  
 Отчеты можно экспортировать в различные форматы, например Microsoft Excel или CSV. Дополнительные сведения см. в разделе [экспорта отчетов &#40;построитель отчетов и службы SSRS&#41;](report-builder/export-reports-report-builder-and-ssrs.md).  
...
3.  . В панели «Свойства» найдите свойство InitialPageName и введите **продажи продукта Excel**.  
  
    > [!NOTE]  
    >  Если панель свойств не отображается, щелкните вкладку «Вид» на ленте и нажмите кнопку **свойства**.  
...
4.  В **имя файла** введите **продажи продукта Excel**.  
  
5.  Убедитесь, что тип файла **книга Excel**.  
