...
##  <a name="CreateTable"></a>1. Создание нового отчета на основе начало работы  
...
##  <a name="DataConnection"></a>SR1a. Указание подключения к данным в мастере таблиц  
...
##  <a name="Subtotals"></a>1д. Добавление строк подытога и итога в мастере таблиц  
...
##  <a name="FormatDate"></a>3. Форматирование данных в формате даты  
...
1.  Откройте папку **документы** и дважды щелкните **продукт Sales Excel. xlsx**.  
