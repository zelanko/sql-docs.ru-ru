...
ms.locfileid: "68892358"
---
# <a name="what39s-new-reporting-services"></a>Новые&#39;(Reporting Services)
  
  
||  
|-|  
|Выпуск [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)] служб [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)] добавляет поддержку браузера Google Chrome. Дополнительные сведения о поддерживаемых браузерах см. в разделе [Планирование поддержки Reporting Services и Power View браузера &#40;Reporting Services 2014&#41;](../../2014/reporting-services/browser-support-for-reporting-services-and-power-view.md).|  
...
## <a name="see-also"></a>См. также:  
 ...
 [Обновление и миграция Reporting Services](install-windows/upgrade-and-migrate-reporting-services.md)   
