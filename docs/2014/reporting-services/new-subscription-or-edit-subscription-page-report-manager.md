...
3.  В раскрывающемся меню выполните одно из следующих действий.  
    ...
    -   Нажмите кнопку **Управление**. Откроется страница свойств отчета «Общие». Затем перейдите на вкладку **Подписки** . На панели инструментов выберите **Создать подписку**или выберите существующую подписку и выберите **Изменить**.  
