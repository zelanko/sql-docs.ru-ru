 ...
 **Информационные работники**— разрешения должны включать разрешения SharePoint создание предупреждений и просмотр элементов. Встроенные уровне разрешений SharePoint — «Создание», «Участие», «Чтение» и «Только просмотр» — включают разрешения SharePoint на создание предупреждений и просмотр элементов. Также можно создать собственный уровень разрешений, включающий разрешения, необходимые для поддержки пользователей, создающих, изменяющих, запускающих и просматривающих предупреждения данных.  
...
3.  Щелкните **Предоставить разрешение**  
