...
2.  На панели свойств введите текст, который будет отображаться в сообщении `NoRowsMessage` поля свойства.  
...
## <a name="see-also"></a>См. также  
 [Вложенные отчеты &#40;отчетов построителя отчетов и службы SSRS&#41;](../report-design/subreports-report-builder-and-ssrs.md)   
