...
###  <a name="PWD"></a> Модуль обработки данных параллельного хранилища данных Microsoft SQL Server  
 ...
 [!INCLUDE[ss_dtbi](../../includes/ss-dtbi-md.md)] автоматически различает **SQL Server параллельные хранилища данных** и **Microsoft SQL Server** типы источников данных и открывает графический конструктор запросов, связанный с типом источника данных.  
