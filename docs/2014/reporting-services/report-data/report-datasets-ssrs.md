...
##  <a name="QuickStart"></a>Добавление данных с элементами отчета  
...
##  <a name="HowTo"></a> Инструкции  
 ...
 [Создание запроса в конструкторе реляционных запросов &#40;построитель отчетов и SSRS&#41;](build-a-query-in-the-relational-query-designer-report-builder-and-ssrs.md)  
  
 [Отображение скрытых наборов данных для значений параметров многомерных &#40;построитель отчетов и служб SSRS&#41;](show-hidden-datasets-for-parameter-values-multidimensional-data.md)  
  
 [Добавление фильтра в набор данных &#40;построитель отчетов и SSRS&#41;](add-a-filter-to-a-dataset-report-builder-and-ssrs.md)  
  
 [Установка сообщения об отсутствии данных для области данных &#40;построитель отчетов и служб SSRS&#41;](set-a-no-data-message-for-a-data-region-report-builder-and-ssrs.md)  
  
 [Свяжите параметр запроса с параметром отчета &#40;построитель отчетов и SSRS&#41;](associate-a-query-parameter-with-a-report-parameter-report-builder-and-ssrs.md)  
