...
### <a name="custom-properties"></a>Пользовательские свойства  
 Пользовательские свойства полей поддерживаются поставщиками данных и могут быть указаны в базовом запросе многомерных выражений для набора данных отчета, однако не отражаются на панели наборов данных отчета в виде полей. Например, **Long Names** — это свойство элемента, определенное для уровня измерения. Чтобы включить это значение в текстовое поле, используйте выражение `=Fields!` * \<FieldName>. * `("Long Names")` Имена полей в выражении учитывают регистр символов.  
