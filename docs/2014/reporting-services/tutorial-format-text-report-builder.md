...
### <a name="set-up-the-report"></a>Настройка отчета  
 ...
 2. [Добавить поле в область конструктора отчетов (неправильным способом, затем правильно)](#AddField)  
...
### <a name="pick-and-choose"></a>Выбор разделов  
 ...
 [Повернуть текст в отчете](#RotateText)  
...
2.  Нажмите кнопку **Запустить**.  
     ...
     Обратите внимание, что только одна запись **Fernando Ross**, которая по алфавиту является первой записью в запросе. Поле не повторяется и не показывает другие записи.  
...
1.  На **вставить** меню, нажмите кнопку **таблицы**, а затем нажмите кнопку **мастера таблиц**.  
...
3.  На **размещение полей** перетащите **территории**, **LinkText**, и **продукта** поля **группыстрок**, перетащите **продажи** на **значения**, а затем нажмите кнопку **Далее**.  
  
4.  На **Выбор макета** снимите **развернуть/свернуть группы** флажок, чтобы была видна вся таблица и нажмите кнопку **Далее**.  
  
5.  На **Выбор стиля** щелкните **материала**, а затем нажмите кнопку **Готово**.  
...
10. Выберите пустую ячейку под `[LinkText]` ячейки, удерживая нажатой клавишу SHIFT и выберите две ячейки справа: **общее** ячейки в **продукта** столбца и `[Sum(Sales)]` ячейки в  **Продажи** столбца.  
  
11. Эти три ячейки, щелкните правой кнопкой мыши одну из трех ячеек и щелкните **удалить строку**.  
...
3.  В **свойства текстового поля** щелкните **действия**.  
  
4.  Нажмите кнопку **перейдите на URL-адрес**.  
  
5.  В **Выбор URL-адреса** щелкните **[URL]**, а затем нажмите кнопку **ОК**.  
  
6.  Обратите внимание, что текст ничем не отличается. Необходимо сделать так, чтобы текст выглядел как текст ссылки.  
  
7.  Выберите `[LinkText]`.  
  
8.  В **шрифта** раздел **Главная** щелкните **подчеркивание** кнопку, а затем щелкните стрелку раскрывающегося списка рядом с **цвет** кнопки и нажмите кнопку **синей**.  
...
##  <a name="RotateText"></a> Повернуть текст в отчете  
...
5.  Найдите свойство свойство WritingMode в панели «Свойства».  
...
6.  В поле со списком выберите **поворот на 270 градусов**.  
  
7.  На **Главная** вкладку в **абзаца** щелкните **средней** и **Center** кнопки для размещения текста по центру ячейки как по вертикали или горизонтали.  
...
6.  На **Общие** в разделе **тип разметки**, нажмите кнопку **HTML — интерпретировать теги HTML как стили**.  
...
4.  (Необязательно) На **Главная** вкладке **номер** щелкните **стили заполнителя** и нажмите кнопку **образцы значений** чтобы увидеть, как будет чисел отформатировать.  
...
## <a name="next-steps"></a>Следующие шаги  
 Существует несколько способов форматирования текста в построителе отчетов [учебник: Создание отчета в свободной форме &#40;построитель&#41; ](../reporting-services/tutorial-creating-a-free-form-report-report-builder.md) содержит дополнительные примеры.  
