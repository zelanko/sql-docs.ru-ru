...
##  <a name="add-a-field-to-the-report-design-surface"></a><a name="AddField"></a>Добавление поля в отчет область конструктора  
...
##  <a name="add-a-table-to-the-report-design-surface"></a><a name="AddTable"></a>Добавление таблицы в отчет область конструктора  
...
##  <a name="rotate-text-in-the-report"></a><a name="RotateText"></a>Поворот текста в отчете  
...
##  <a name="displaying-text-with-html-formatting"></a><a name="FormatHTML"></a>Отображение текста с форматированием HTML  
...
##  <a name="format-currency"></a><a name="FormatCurrency"></a>Формат валюты  
