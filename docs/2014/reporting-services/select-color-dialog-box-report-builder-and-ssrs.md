...
-   **Выбор цвета-Цветовая окружность** Выберите цвет с помощью цветовых значений «цветовой тон/насыщенность/яркость» (HSB).  
  
-   **Средство выбора — цветовой квадрат** Выберите цвет, используя значения цвета красный/зеленый/синий (RGB).  
  
-   **Палитра — стандартные цвета** Выберите цвет из предопределенного списка цветовых значений.  
