---
title: Страница «подписки» (диспетчер отчетов) | Документы Microsoft
ms.custom: ''
ms.date: 06/13/2017
