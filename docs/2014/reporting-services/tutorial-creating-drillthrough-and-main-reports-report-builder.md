...
##  <a name="DSparkline"></a>3. Добавление столбцов для отображения значений продаж в спарклайнах  
...
##  <a name="DReportTitle"></a>4. Добавление заголовка отчета с названием категории продукта  
...
##  <a name="DParameter"></a>5. свойства параметров обновления  
...
4.  Выберите команду **Сохранить**.  
     ...
     **Последние сайты и серверы** содержат библиотеки на сайте SharePoint.  
...
6.  В поле **имя сервера**введите имя сервера, на котором установлен экземпляр [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] .  
...
##  <a name="MGrandTotal"></a>2. Удаление строки общего итога  
...
##  <a name="MDrillthrough"></a>3. действие "настроить текстовое поле" для детализации  
...
##  <a name="MParameter"></a>5. свойства параметров обновления  
