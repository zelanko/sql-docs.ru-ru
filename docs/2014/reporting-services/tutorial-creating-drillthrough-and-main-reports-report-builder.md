...
1.  [Создание детализированного матричного отчета и набор данных из мастера таблицы или матрицы](#DMatrixAndDataset)  
  
    1.  [Выбор подключения к данным](#DConnection)  
  
    2.  [Создать запрос многомерных Выражений](#DMDXQuery)  
  
    3.  [Организация данных в группы стилей](#DLayout)  
...
3.  [Добавление столбцов значения продаж спарклайн](#DSparkline)  
  
4.  [Добавление заголовка отчета с именем категории продукта](#DReportTitle)  
  
5.  [Обновление свойств параметров](#DParameter)  
  
6.  [Сохранить отчет в библиотеке SharePoint](#DSave)  
...
1.  [Создание основного матричного отчета и набора данных из мастера таблицы или матрицы](#MMatrixAndDataset)  
    ...
    3.  [Организация данных в группы](#MLayout)  
  
    4.  [Добавление подытогов и итогов](#MTotals)  
  
    5.  [Выбор стиля](#MStyle)  
  
2.  [Удалите строка общего итога](#MGrandTotal)  
  
3.  [Настройка действия для детализации текста](#MDrillthrough)  
...
7.  [Сохранить отчет в библиотеке SharePoint](#MSave)  
  
8.  [Запуск основного и детализированные отчеты](#MRunReports)  
...
1.  Нажмите кнопку **запустить**, пункты **программы**, пункты [!INCLUDE[ssCurrentUI](../includes/sscurrentui-md.md)] **построитель**и нажмите кнопку **построитель**.  
     ...
     Откроется диалоговое окно **Приступая к работе** . Если нет, из **построитель** , выберите элемент **New**.  
...
1.  На **Выбор стиля** на панели «Стили» выберите материала.  
