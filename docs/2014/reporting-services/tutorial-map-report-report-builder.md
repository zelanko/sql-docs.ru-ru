...
## <a name="next-steps"></a>Следующие шаги  
 ...
 Дополнительные сведения см. в разделе [Maps &#40;построитель отчетов и службы SSRS&#41; ](report-design/maps-report-builder-and-ssrs.md) и в записи блога [Cartographic Adjustment of Spatial Data для SQL Server Reporting Services](http://go.microsoft.com/fwlink/?LinkId=152771) на сайте blogs.msdn.com.  
