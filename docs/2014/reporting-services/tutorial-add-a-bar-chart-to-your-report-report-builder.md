...
6.  В **выражение**, тип **[Sum(SalesYear2009)]**. Это создает базовое выражение `=Sum(Fields!SalesYear2009.Value)`, который можно увидеть, если щелкнуть **fx** кнопки.  
