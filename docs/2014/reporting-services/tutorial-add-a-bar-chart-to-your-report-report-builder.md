...
7.  [Форматирование и задание меток горизонтальной оси](#Horizontal)  
  
8.  [Добавить фильтр для отображения 5 максимальных значений](#Filter)  
...
##  <a name="Chart"></a> 1. Создание отчета с диаграммой с помощью мастера диаграмм  
 Из **Приступая к работе** диалоговое окно, создайте внедренный набор данных, выберите общий источник данных и создайте линейчатую диаграмму с помощью мастера диаграмм.  
...
2.  Нажмите кнопку **Линейчатая**, а затем кнопку **Далее**.  
     ...
     На **размещение полей диаграммы** есть четыре поля в **доступные поля** панели: «имя», «Фамилия», «salesyear2009» и SalesYear2008.  
...
7.  На **Выбор стиля** на панели «Стили» выберите стиль.  
...
2.  Щелкните правой кнопкой мыши вертикальную ось и выберите **свойства вертикальной оси**.  
  
3.  В области **Диапазон и интервал оси**в поле **Интервал** введите значение **1**.  
  
4.  [!INCLUDE[clickOK](../includes/clickok-md.md)]  
  
5.  Щелкните правой кнопкой мыши вертикальную **заголовок оси** и снимите **показывать название оси** флажок.  
...
5.  В сортировке, нажмите кнопку выражения (**Fx**) кнопки.  
  
6.  Введите следующее выражение: `=Fields!LastName.Value & ", " & Fields!FirstName.Value`  
  
7.  Нажмите кнопку **ОК**.  
  
8.  На **свойства группы категорий** страницы в **порядок** раскрывающемся списке выберите **от я до А**. При этом будет выбран обратный алфавитный порядок и имена будут отображаться сверху вниз.  
  
9. [!INCLUDE[clickOK](../includes/clickok-md.md)]  
  
10. Нажмите кнопку **Выполнить** для предварительного просмотра отчета.  
  
 Имена по горизонтальной оси сортируются в обратном порядке при **Alerca** в верхней и **Zeng** внизу.  
...
2.  Щелкните горизонтальную ось в нижней части диаграммы, чтобы выбрать ее.  
     ...
     На ленте на **Главная** вкладке **номер** щелкните **валюты** кнопки. Метки на горизонтальной оси изменятся на валюту.  
...
8.  В **заголовок текста** введите **продажи в тысячах** и нажмите кнопку **ОК**.  
...
6.  В **выражение**, тип **[Sum(SalesYear2009)]**. Это создает базовое выражение `=Sum(Fields!SalesYear2009.Value)`, которую можно увидеть, если щелкнуть **fx** кнопки.  
...
2.  Тип **линейчатая диаграмма продаж**, нажмите клавишу ВВОД, а затем введите **пять менеджеров за 2009 г.**, поэтому он выглядит следующим образом:  
  
     **Линейчатая диаграмма продаж**  
  
     **Пять менеджеров за 2009 г.**  
  
3.  Выберите **Линейчатая диаграмма продаж**и нажмите кнопку **Полужирный** .  
  
4.  Выберите **пять менеджеров за 2009 г.** и в **шрифта** статьи на **Главная** задайте размер шрифта **10**.  
