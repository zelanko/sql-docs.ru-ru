...
##  <a name="AllValues"></a>3. изменение отображаемых имен на вертикальной оси  
...
###  <a name="CategoryExpression"></a>Отображать фамилию и имя на вертикальной оси  
...
##  <a name="Sort"></a>4. изменение порядка сортировки для имен на вертикальной оси  
...
##  <a name="ChartTitle"></a>6. заголовком диаграммы  
...
##  <a name="Horizontal"></a>7. форматирование и пометка горизонтальной оси  
...
##  <a name="Filter"></a>8. Добавление фильтра для вывода пяти верхних значений  
