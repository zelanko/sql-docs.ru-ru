---
title: Резервирование URL-адресов для нескольких экземпляров отчета развертывание сервера (диспетчер конфигурации служб SSRS) | Документы Microsoft
ms.custom: ''
ms.date: 06/13/2017
