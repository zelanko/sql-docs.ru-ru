---
title: Настройка развертывания горизонтального масштабирования сервера отчетов собственного режима (диспетчер конфигурации служб SSRS) | Документация Майкрософт
ms.custom: ''
ms.date: 06/13/2017
