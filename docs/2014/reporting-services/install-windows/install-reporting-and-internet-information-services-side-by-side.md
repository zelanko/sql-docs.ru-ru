...
|http:\//123.234.345.456:80|Получает любой запрос, который задает http:\//123.234.345.456 или http://\<имя_компьютера > Если служба доменных имен способна разрешить IP-адрес в это имя узла.|  
