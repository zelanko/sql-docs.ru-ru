...
-   Если URL-адреса создаются или изменяются при помощи программы настройки служб [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] , для них можно принять значения по умолчанию, либо указать пользовательские значения. При задании URL-адреса на странице появляется проверочная ссылка с URL-адресом; таким образом, можно убедиться, что указанные настройки приводят к допустимому соединению. Пошаговые инструкции по настройке и проверке URL-адрес см. в разделе [настроить URL-адрес &#40;диспетчер конфигурации служб SSRS&#41;](configure-a-url-ssrs-configuration-manager.md).  
...
## <a name="in-this-section"></a>в этом разделе  
 ...
 [Развертывание сервера отчетов резервирование URL-адресов для нескольких экземпляров &#40;диспетчер конфигурации служб SSRS&#41;](url-reservations-for-multi-instance-report-server-deployments.md)  
...
## <a name="see-also"></a>См. также  
 [Настройка URL-адрес &#40;диспетчер конфигурации служб SSRS&#41;](configure-a-url-ssrs-configuration-manager.md)   
 [URL-адрес службы веб- &#40;собственный режим служб SSRS&#41;](../../sql-server/install/web-service-url-ssrs-native-mode.md)  
