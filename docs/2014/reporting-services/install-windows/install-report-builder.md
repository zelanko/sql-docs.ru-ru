...
# <a name="install-the-stand-alone-version-of-report-builder-report-builder"></a>Установка изолированной версии построителя отчетов (построитель отчетов)
  Вы можете установить построитель отчетов из пакета [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] дополнительных компонентов в [центре загрузки Майкрософт](https://www.microsoft.com/download/details.aspx?id=53613) или в папку, например в общую папку, в которую загружен ReportBuilder3_x86. msi, пакет установщик Windows для построитель отчетов.  
