...
-   **С пакетом обновления 1 надстройка.**  [Microsoft® SQL Server® 2012 SP1 Reporting Services надстройки для Microsoft® SharePoint®](https://www.microsoft.com/download/details.aspx?id=35583)(https://www.microsoft.com/download/details.aspx?id=35583).  
  
-   **С ПАКЕТОМ ОБНОВЛЕНИЯ 1:**  [Microsoft® SQL Server® 2012 пакетом обновления 1 (SP1)](https://go.microsoft.com/fwlink/p/?LinkID=255906) (https://go.microsoft.com/fwlink/p/?LinkID=255906).  
...
##  <a name="bkmk_sql2008sp2"></a> SQL Server 2008 SP2 Reporting Services Add-in for 2007 продуктов и технологий SharePoint  
 ...
 Последняя версия этого файла доступна в Центре загрузки Майкрософт [!INCLUDE[msCoName](../../includes/msconame-md.md)] на странице [Надстройка служб Microsoft SQL Server 2008 с пакетом обновления 2 (SP2) Reporting Services для технологий Microsoft SharePoint](https://go.microsoft.com/fwlink/?LinkID=204594).  
