...
##  <a name="bkmk_sql14"></a>[!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] Reporting Services надстройку для продуктов SharePoint  
...
##  <a name="bkmk_sql11sp1"></a>[!INCLUDE[ssSQL11SP1](../../includes/sssql11sp1-md.md)] Reporting Services надстройку для продуктов SharePoint  
...
-   **Надстройка с пакетом обновления 1 (SP1):**  [microsoft® SQL Server® 2012 SP1 Reporting Services Надстройка для Microsoft® SharePoint®](https://www.microsoft.com/download/details.aspx?id=35583)(https://www.microsoft.com/download/details.aspx?id=35583).  
...
##  <a name="bkmk_sql11"></a>[!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] Надстройка Reporting Services для продуктов SharePoint 2010  
