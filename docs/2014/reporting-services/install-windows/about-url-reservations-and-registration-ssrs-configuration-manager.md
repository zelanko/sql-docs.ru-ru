...
##  <a name="ReportingServicesURLs"></a>URL-адреса в Reporting Services  
...
##  <a name="URLPermissionsAccounts"></a>Проверка подлинности и удостоверение службы для Reporting Services URL-адресов  
