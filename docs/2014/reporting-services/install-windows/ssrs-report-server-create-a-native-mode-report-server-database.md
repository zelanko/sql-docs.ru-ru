...
3.  Откройте **SQL Server сетевая конфигурация**.  
...
3.  Щелкните **создать новую базу данных сервера отчетов**, а затем нажмите кнопку **Далее**.  
...
## <a name="see-also"></a>См. также:  
 ...
 [База данных &#40;служб SSRS в собственном режиме&#41;](../../sql-server/install/database-ssrs-native-mode.md)   
