...
## <a name="see-also"></a>См. также:  
 [Управление доступом для кода в Reporting Services](code-access-security-in-reporting-services.md)   
 [Безопасная &#40;разработки Reporting Services&#41;](secure-development-reporting-services.md)  
