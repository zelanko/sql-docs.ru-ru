...
2.  Веб-служба вызывает метод <xref:ReportService2010.ReportingService2010.LogonUser%2A> метод расширения безопасности, в частности, класс, реализующий **IAuthenticationExtension**.  
