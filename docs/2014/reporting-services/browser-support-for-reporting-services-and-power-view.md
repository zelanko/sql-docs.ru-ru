...
|||||||||  
|-|-|-|-|-|-|-|-|  
|**Браузер**|**Windows 8** и **Windows 8.1**|**Windows 7**|**Windows Server 2012** и **2012 R2**|**Windows Server 2008** и **2008 R2**|**Windows Server 2003**|**Mac OS X 10,6-10,9**|**Заметки о**|  
