...
### <a name="alert-name"></a>Имя оповещения
...
-   Выручка от продаж **превышает** 1500,00,
     ...
     **и** Количество проданных единиц **меньше** 500

     Дата возврата **раньше** 01.01.2010,

-   Выручка от продаж **больше или равна** 1500,00,

     **и** Дата возврата **— после** 1/1/2010

     **и** Количество **проданных единиц превышает 500**
...
-   Дата возврата **позже** 01.01.2010
     ...
     **и** Территория сбыта **является** Центральной
...
##  <a name="EditAlert"></a>Изменение определения предупреждения об изменении данных
...
## <a name="see-also"></a>См. также:
 [](../ssms/agent/alerts.md) [Диспетчер предупреждений](../../2014/reporting-services/data-alert-manager-for-alerting-administrators.md) об изменении данных Reporting Services Data Alerts для администраторов
