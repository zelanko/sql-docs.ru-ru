---
title: Электронная документация по SQL Server 2014 | Документы Microsoft
ms.date: 05/25/2017
...
ms.locfileid: "36193710"
---
# Электронная документация по SQL Server 2014
  Добро пожаловать в [!INCLUDE[msCoName](../includes/msconame-md.md)]® электронной документации для [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)]®. Электронной документации приведено описание задач, а также справочная документация, в которых описывается выполнение рабочих данных и бизнес-аналитики с помощью [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)].  
...
|||  
|-|-|  
|![Значок ядра базы данных](media/database-engine.gif "значок компонента Database Engine")|[Ядро СУБД](../database-engine/sql-server-database-engine-overview.md)<br /><br /> Компонент Database Engine представляет собой основную службу для хранения, обработки и обеспечения безопасности данных. Этот компонент обеспечивает управляемый доступ к ресурсам и быструю обработку транзакций, что позволяет использовать его даже в самых требовательных корпоративных приложениях обработки данных. Кроме того, ядро СУБД предоставляет разносторонние средства поддержания высокого уровня доступности.|  
...
-   [Центр разработчиков данных платформы](http://go.microsoft.com/fwlink/?LinkId=17386)  
