...
|**Чтение зафиксировано**|нет|Да|Да|  
...
##  <a name="locking-in-the-database-engine"></a><a name="Lock_Engine"></a>Блокировка в ядро СУБД  
...
|------|---------------------------|------|------|------|------|------|  
|**Запрашиваемый режим**|**РЕКОМЕНДУЕТСЯ**|**S**|**U**|**IX**|**SIX**|**X**|  
|**Намеренная разделяемая (IS)**|Да|Да|Да|Да|Да|Нет|  
...
|**Совмещаемая с намерением монопольного доступа (SIX)**|Да|нет|нет|Нет|Нет|Нет|  
...
|**Блокировка обновления (U)**|Да|нет|нет|Да|нет|Да|Нет|  
...
#### <a name="a-working-with-snapshot-isolation"></a>А) Работа с изоляцией моментального снимка  
