...
##  <a name="in-this-guide"></a><a name="Top"></a>В этом пошаговом окне  
...
###  <a name="index-sort-order-design-guidelines"></a><a name="Sort_Order"></a>Рекомендации по проектированию порядка сортировки индексов  
...
##  <a name="clustered-index-design-guidelines"></a><a name="Clustered"></a>Рекомендации по проектированию кластеризованных индексов  
...
####  <a name="use-included-columns-to-extend-nonclustered-indexes"></a><a name="Included_Columns"></a>Использование включаемых столбцов для расширения некластеризованных индексов  
...
##  <a name="filtered-index-design-guidelines"></a><a name="Filtered"></a>Рекомендации по проектированию фильтруемых индексов  
