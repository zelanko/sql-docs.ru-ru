...
##  <a name="Top"></a> В этом руководстве  
 ...
 [Рекомендации по проектированию индексов Общие](#General_Design)  
...
```  
 ...
 ![План выполнения показывает, что используется оператор SORT. ] (media/indexsort1.gif "План выполнения показывает операции СОРТИРОВКИ, используется оператор.")  
...
```  
 ...
 ![План выполнения показывает операции СОРТИРОВКИ, не используется оператор](media/insertsort2.gif "план выполнения показывает операции СОРТИРОВКИ, оператор не используется.")  
 ...
 ![Значок стрелки, используемый с обратно к верхней](media/uparrow16x16.gif "значок стрелки, используемый с обратно к верхней") [в данном руководстве](#Top)  
...
-   Неключевые столбцы нельзя изменять, за исключением следующих операций:  
    ...
    -   Увеличение длины `varchar`, `nvarchar`, или `varbinary` столбцов.  
