...
##  <a name="Top"></a> В этом руководстве  
 ...
 [Общие правила проектирования индекса](#General_Design)  
...
```  
 ...
 ![План выполнения показывает, что используется оператор SORT. ](media/indexsort1.gif "План выполнения показывает SORT, оператор используется.")  
...
```  
 ...
 ![План выполнения показывает SORT, оператор не используется](media/insertsort2.gif "план выполнения показывает SORT, оператор не используется.")  
