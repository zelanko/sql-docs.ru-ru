...
##  <a name="bcpDataFormatAttr"></a>Атрибуты формата данных bcp  
...
##  <a name="FieldSpecificPrompts"></a>Общие сведения о запросах, относящихся к полям  
...
##  <a name="FieldByFieldNonXmlFF"></a>Хранение данных по полям в файле форматирования в формате, отличном от XML  
...
## <a name="see-also"></a>См. также:  
 ...
 [Форматы данных для &#40;SQL Server импорта или экспорта&#41;](data-formats-for-bulk-import-or-bulk-export-sql-server.md)   
