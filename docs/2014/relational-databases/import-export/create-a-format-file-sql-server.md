 ...
 **Формат** **bcp** _table_or_view_ NUL **-f**_format_file_name_  
...
|----------------|-----------------|  
|**форматнул-f** _format_file_|Задает файл форматирования в формате, отличном от XML.|  
...
## <a name="creating-an-xml-format-file"></a>Создание XML-файла форматирования  
 ...
 формат **bcp** _table_or_view_ **NUL-f** _format_file_name_ **-x**  
...
|Квалификаторы|Description|  
|----------------|-----------------|  
|**форматнул-f** _format_file_ **-x**|Задает XML-файл форматирования.|  
|**-c**|Задает символьные данные.|  
