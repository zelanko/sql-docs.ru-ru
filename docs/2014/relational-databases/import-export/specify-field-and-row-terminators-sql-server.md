...
## <a name="specifying-terminators-for-bulk-export"></a>Задание признаков конца полей и строк при массовом экспорте  
 При выполнении операции с массовым экспортом `char` или `nchar` данными и необходимости использования признака конца, отличного от значения по умолчанию, необходимо указать признак конца для команды **bcp** . Это можно сделать одним из следующих способов:  
