...
##  <a name="Structure"></a> Структура файлов форматирования в формате, отличном от XML  
 ...
 ![Идентифицирует поля файла форматирования в формате, отличном от XML](../../database-engine/media/mydepart-fmt-ident-c.gif "Идентифицирует поля файла форматирования в формате, отличном от XML")  
