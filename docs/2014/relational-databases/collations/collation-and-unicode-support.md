...
###  <a name="Code_Page_Defn"></a>Кодовая страница  
...
###  <a name="Sort_Order_Defn"></a>Порядок сортировки  
...
-   **Клиенты в Юникоде** , использующие OLE DB и ODBC версии 3,7 или более поздней версии.  
  
-   **Клиенты не в Юникоде** , использующие DB-Library и ODBC версии 3,6 или более ранней версии.  
...
##  <a name="Related_Content"></a> См. также  
 ...
 ["SQL Server Best Practices Migration to Unicode" (на английском языке)](https://go.microsoft.com/fwlink/?LinkId=113890)  
  
 [Веб-сайт консорциума Unicode](https://go.microsoft.com/fwlink/?LinkId=48619)  
