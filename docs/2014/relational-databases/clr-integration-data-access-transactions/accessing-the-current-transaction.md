...
-   Управляемая процедура или функция может активизировать пользовательское исключение. Вызывающая [!INCLUDE[tsql](../../includes/tsql-md.md)] процедура может перехватить исключение, созданное управляемой процедурой или функцией в блоке try/catch, и выполнить `ROLLBACK TRANSACTION` .  
