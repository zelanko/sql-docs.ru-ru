...
##  <a name="CreateStatistics"></a>Время создания статистики  
...
##  <a name="UpdateStatistics"></a>Время обновления статистики  
...
##  <a name="DesignStatistics"></a>Запросы, которые эффективно используют статистику  
