...
5.  В диалоговом окне **Создание статистики по таблице**_имя_таблицы_ на странице **Общие** нажмите кнопку **Добавить**.  
...
7.  В диалоговом окне **Создание статистики по таблице**_имя_таблицы_ нажмите кнопку **ОК**.  
