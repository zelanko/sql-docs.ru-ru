...
-   Автоматическое заполнение  
    ...
    -   [создать ПОЛНОТЕКСТОВЫЙ индекс](/sql/t-sql/statements/create-fulltext-index-transact-sql) ... С CHANGE_TRACKING AUTO  
  
    -   [изменить ПОЛНОТЕКСТОВЫЙ индекс](/sql/t-sql/statements/alter-fulltext-index-transact-sql) ... ЗАДАТЬ CHANGE_TRACKING АВТО  
...
-   [создать ПОЛНОТЕКСТОВЫЙ индекс](/sql/t-sql/statements/create-fulltext-index-transact-sql) ... С CHANGE_TRACKING OFF  
  
-   [изменить ПОЛНОТЕКСТОВЫЙ индекс](/sql/t-sql/statements/alter-fulltext-index-transact-sql) ... УСТАНОВКА CHANGE_TRACKING ВЫКЛЮЧЕНА  
