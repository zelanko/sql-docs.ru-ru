...
##  <a name="registering-word-breakers"></a><a name="register"></a>Регистрация разделителей слов  
...
##  <a name="choosing-the-language-for-an-indexed-column"></a><a name="lang"></a>Выбор языка для индексированного столбца  
...
##  <a name="obtaining-information-about-word-breakers"></a><a name="info"></a>Получение сведений о разделителях слов  
...
##  <a name="troubleshooting-word-breaking-time-out-errors"></a><a name="tshoot"></a>Устранение ошибок превышения времени ожидания при разбиении по словам  
...
##  <a name="understanding-the-impact-of-new-word-breakers"></a><a name="impact"></a>Основные сведения о влиянии новых разделителей слов  
