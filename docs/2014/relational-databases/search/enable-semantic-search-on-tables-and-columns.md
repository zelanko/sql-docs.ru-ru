...
-   Для столбцов типа `varbinary(max)` можно указать любой тип документа, поддерживаемый для полнотекстового индексирования. Дополнительные сведения см. в разделе [How To: Определить, какие типы документов могут быть проиндексированы](#doctypes) в этом разделе.  
 ...
 **Пример. Добавление семантического индексирования на столбец, который уже есть полнотекстовое индексирование**  
...
##  <a name="BestPracticeFilegroup"></a> Лучшие методики: создайте отдельную файловую группу для полнотекстового и семантического индексов  
