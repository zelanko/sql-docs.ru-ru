...
###  <a name="HowToEnableCreate"></a> Инструкции: Создание семантического индекса, если нет полнотекстового индекса  
...
###  <a name="HowToEnableAlter"></a> Инструкции: Создать семантический индекс, при наличии существующего полнотекстового индекса  
...
###  <a name="drophow"></a> Инструкции: Удаление семантического индекса  
...
###  <a name="HowToCheckEnabled"></a> Инструкции: Проверьте, включен ли семантический поиск по объектам базы данных  
...
###  <a name="HowToCheckLanguages"></a> Инструкции: Проверьте, какие языки поддерживаются для семантического поиска  
