...
-   Можно создать семантический индекс по столбцам с любым типом данных, поддерживаемым для полнотекстового индексирования. Дополнительные сведения см. в разделе [Создание и управление полнотекстовыми индексами](create-and-manage-full-text-indexes.md).  
  
-   Можно указать любой тип документа, поддерживаемый для полнотекстового индексирования для `varbinary(max)` столбцов. Дополнительные сведения см. в подразделе [Практическое руководство. Определение того, какие типы документов могут быть проиндексированы](#doctypes) этого раздела.  
...
###  <a name="HowToEnableCreate"></a> Практическое руководство: Создание семантического индекса, если нет полнотекстового индекса  
...
###  <a name="HowToEnableAlter"></a> Практическое руководство: Создание семантического индекса, при наличии существующего полнотекстового индекса  
...
###  <a name="drophow"></a> Практическое: удаление семантического индекса  
...
###  <a name="HowToCheckEnabled"></a> Практическое руководство: Проверка, включен ли семантический поиск по объектам базы данных  
...
###  <a name="HowToCheckLanguages"></a> Практическое руководство: Проверка, какие языки поддерживаются для семантического поиска  
...
###  <a name="doctypes"></a> Практическое руководство: Определить, какие типы документов могут быть проиндексированы  
...
##  <a name="BestPracticeFilegroup"></a> Рекомендация: Рекомендуется создать отдельную файловую группу для полнотекстового и семантического индексов  
