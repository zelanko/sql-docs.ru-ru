...
-   Можно указать любой тип документа, который поддерживается для полнотекстового индексирования для `varbinary(max)` столбцов. Дополнительные сведения см. в подразделе [Практическое руководство. Определение того, какие типы документов могут быть проиндексированы](#doctypes) этого раздела.  
 ...
 **Создать новый семантический индекс с помощью SQL Server Management Studio**  
...
###  <a name="HowToCheckEnabled"></a> Как Проверить, включен ли семантический поиск по объектам базы данных  
...
###  <a name="doctypes"></a> Практическое руководство: Определение, какие типы документов могут быть проиндексированы  
