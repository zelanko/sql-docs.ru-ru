...
|Название|`System.Title`|F29F85E0-4FF9-1068-AB91-08002B27B3D9|2|Заголовок элемента. Например, заголовок документа, тема сообщения, подпись к фотографии или название музыкальной композиции.|  
...
##  <a name="filtdump"></a>Поиск сведений о доступных свойствах с помощью FILTDUMP. ПРОГРАММЫ  
...
##  <a name="propdesc"></a>Поиск значений для свойства поиска из описания свойства Windows  
