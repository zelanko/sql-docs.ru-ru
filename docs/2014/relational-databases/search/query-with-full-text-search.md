...
##  <a name="Using_Boolean_Operators"></a>Использование логических операторов AND, OR и NOT IN-in CONTAINS и CONTAINSTABLE  
...
##  <a name="Additional_Considerations"></a>Дополнительные рекомендации для полнотекстовых запросов  
...
##  <a name="varbinary"></a>Запросы к столбцам varbinary (max) и XML  
...
### <a name="varbinarymax-or-varbinary-data"></a>данные типа varbinary(max) и varbinary  
 В одном столбце типа `varbinary(max)` или `varbinary` могут храниться документы различных типов. 
...
##  <a name="supported"></a>Поддерживаемые формы терминов запроса  
...
###  <a name="Prefix_Term"></a>Выполнение поиска префикса (префиксное выражение)  
...
###  <a name="Inflectional_Generation_Term"></a>Поиск форм-слов определенного слова (терм поколения)  
...
###  <a name="Weighted_Term"></a>Поиск слов или фраз с использованием взвешенных значений (взвешенное выражение)  
...
##  <a name="tokens"></a>Просмотр результатов разметки для сочетания "средство разбиения по словам", тезауруса и списка стоп-слов  
...
## <a name="see-also"></a>См. также:  
 ...
 [Создание запросов полнотекстового поиска &#40;визуальных инструментов для баз данных&#41;](../../ssms/visual-db-tools/visual-database-tools.md)   
