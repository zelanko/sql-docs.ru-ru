...
|X64|_F_ **=** _число диапазонов сканирования_ **&#42;** 10 **&#42;** 8|_M_ **=** _T_ T **-** _F_ F **-** 500|  
 ...
 **Пример. Оценка требований к памяти fdhost.exe**  
 ...
 При следующем вычислении получается оптимальное значение `max server memory` -для *M*. *T*Общий объем физической памяти, доступной в этой системе в МБ-*t*, — `8192`.  
