---
title: Устаревшие функции полнотекстового поиска в SQL Server 2014 | Документы Microsoft
ms.custom: ''
ms.date: 03/06/2017
...
## <a name="see-also"></a>См. также  
 ...
 [Критические изменения полнотекстового поиска](../../database-engine/breaking-changes-to-full-text-search.md)   
