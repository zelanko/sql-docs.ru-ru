...
7.  Выберите один из следующих вариантов:  
    ...
    -   **Создание из существующего списка свойств поиска**  
 ...
 **Добавление свойства в список свойств поиска в Management Studio**  
 ...
 **Связывание списка свойств поиска с полнотекстовым индексом с Management Studio**  
  
 Укажите значение **Список свойств поиска** на странице **Общие** диалогового окна **Свойства полнотекстового индекса** .  
  
  
  
##  <a name="Ov_CONTAINS_using_PROPERTY"></a>Запрос свойств поиска с помощью CONTAINS  
