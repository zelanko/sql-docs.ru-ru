---
title: Поддержка типов табличное значение параметра OLE DB (свойства) | Документация Майкрософт
ms.custom: ''
ms.date: 03/06/2017
