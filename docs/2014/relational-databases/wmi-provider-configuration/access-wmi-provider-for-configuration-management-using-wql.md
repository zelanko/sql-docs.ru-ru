...
4.  Нажмите кнопку **запроса**. Введите запрос, возвращающий список служб, эксплуатируемых в настоящее время на локальном компьютере: **ВЫБЕРИТЕ \* из SqlService.** Нажмите кнопку **Применить**.  
