---
title: Использование WQL и языков сценариев с поставщиком WMI для управления конфигурацией | Документы Microsoft
ms.custom: ''
ms.date: 03/06/2017
...
## <a name="see-also"></a>См. также  
 [Поставщик WMI доступа для управления конфигурацией с использованием WQL](access-wmi-provider-for-configuration-management-using-wql.md)   
