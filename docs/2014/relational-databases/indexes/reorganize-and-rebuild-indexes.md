...
При определенных условиях перестроение кластеризованного индекса автоматически перестраивает любой некластеризованный индекс, ссылающийся на ключ кластеризации, если необходимо изменить физические или логические идентификаторы, содержащиеся в некластеризованных записях индекса.
