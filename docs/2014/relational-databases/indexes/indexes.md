...
|Индекс на вычисляемых столбцах|Индекс на столбце, являющемся производным от одного или нескольких других столбцов или нескольких детерминированных источников.|[Индексы вычисляемых столбцов](indexes-on-computed-columns.md)|  
