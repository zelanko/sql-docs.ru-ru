...
7.  В диалоговом окне **Выбор столбцов из**_имя_таблицы_ установите флажки для столбцов таблицы, добавляемых к индексу.  
  
8.  Нажмите кнопку **ОК**.  
  
9. На вкладке **Включенные столбцы** нажмите кнопку **Добавить…** .  
  
10. В диалоговом окне **Выбор столбцов из**_имя_таблицы_ установите флажки для столбцов таблицы, добавляемых в индекс в качестве неключевых столбцов.  
