 ...
 **В этом разделе:**  
 ...
 [Страница "Общие свойства индекса"](#General)  
  
 [Диалоговое окно «Выбор столбцов (индекса)»](#Columns)  
  
 [Страница "хранение свойств индекса"](#Storage)  
  
 [Пространственный веб-страница свойств индекса](#Spatial)  
  
 [Страница фильтра свойств индекса](#Filter)  
  
##  <a name="General"></a>Страница "Общие свойства индекса"  
 ...
 **Примечание** . Для каждой таблицы допускается только один кластеризованный индекс. Для каждой таблицы можно использовать только один индекс Columnstore, оптимизированный для памяти xVelocity.  
 ...
 **Добавление**  
 Добавляет столбец к ключу индекса. Выберите столбцы таблицы из диалогового окна **Выбор столбцов из** * \<имени таблицы>* , которое появляется при нажатии кнопки **Добавить**. После выбора одного столбца эта кнопка становится недоступной для пространственного столбца.  
...
##  <a name="Storage"></a>Параметры страницы хранилища  
...
##  <a name="Spatial"></a>Параметры индекса пространственных страниц  
