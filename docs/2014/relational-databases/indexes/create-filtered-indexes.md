...
6.  В разделе **Ключевые столбцы индекса**нажмите кнопку **Добавить...**.  
  
7.  В диалоговом окне **Выбор столбцов из**_имя_таблицы_ установите флажки для столбцов таблицы, добавляемых к уникальному индексу.  
