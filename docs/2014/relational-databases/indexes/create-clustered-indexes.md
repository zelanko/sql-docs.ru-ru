...
5.  В диалоговом окне **Выбор столбцов из**_table_name_ установите флажок для столбца таблицы, который будет добавлен в кластеризованный индекс.  
