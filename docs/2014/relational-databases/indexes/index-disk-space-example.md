...
|---------------------|---------------------------------------------------------------------------|  
|Операция с индексами вне сети при SORT_IN_TEMPDB = ON|Общее пространство во время операции: 1018 МБ:<br /><br /> -Существующая таблица и индексы: 363 МБ\*<br /><br /> -<br />                    **tempdb**: 202 МБ *<br /><br /> -Новые индексы: 453 МБ<br /><br /> Общий объем необходимого места после операции: 453 МБ|  
|Операция с индексами вне сети при SORT_IN_TEMPDB = OFF|Общее пространство во время операции: 816 МБ:<br /><br /> -Существующая таблица и индексы: 363 МБ *<br /><br /> -Новые индексы: 453 МБ<br /><br /> Общий объем необходимого места после операции: 453 МБ|  
|Операция с индексами в режиме в сети при SORT_IN_TEMPDB = ON|Общее пространство во время операции: 1058 МБ:<br /><br /> -Существующая таблица и индексы: 363 МБ\*<br /><br /> -**tempdb** (включая индекс сопоставления): 242 МБ *<br /><br /> -Новые индексы: 453 МБ<br /><br /> Общий объем необходимого места после операции: 453 МБ|  
|Операция с индексами в режиме в сети при SORT_IN_TEMPDB = OFF|Общее пространство во время операции: 856 МБ:<br /><br /> -Существующая таблица и индексы: 363 МБ *<br /><br /> — Временный индекс сопоставления: 40 МБ\*<br /><br /> -Новые индексы: 453 МБ<br /><br /> Общий объем необходимого места после операции: 453 МБ|  
