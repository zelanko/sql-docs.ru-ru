...
|12|Семантика преобразования версий ранее [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] для типа DBTYPE_DATE. Доли секунды усекаются до нуля.|  
|13|Семантика преобразования версий ранее [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] для типа DBTYPE_FILETIME. Если вы используете Windows FileTimeToSystemTime API, точность в долях секунды ограничивается 1 миллисекунда.|  
