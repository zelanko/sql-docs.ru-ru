...
```  
 ...
 Обратите внимание `updg:id` , что атрибут связывает первый экземпляр элемента \<HumanResources. Shift> в блоке ** \<Before>** со вторым экземпляром элемента> \<HumanResources. Shift в блоке ** \<After>** .  
