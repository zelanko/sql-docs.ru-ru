...
## <a name="updgid-attribute"></a>Атрибут updg:id  
 Если диаграмма обновления только добавляет записи, атрибут `updg:id` не требуется. Дополнительные сведения о `updg:id`, см. в разделе [обновление данных с помощью диаграмм обновления XML &#40;SQLXML 4.0&#41;](updating-data-using-xml-updategrams-sqlxml-4-0.md).  
