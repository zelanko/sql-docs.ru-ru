...
```  
 ...
 Диаграмма обновления указывает на `xsi:nil` элемент ** \< fname>** в блоке ** \< After>** . Поэтому при выполнении этой диаграммы обновления значение NULL вставляется для столбца first_name таблицы.  
