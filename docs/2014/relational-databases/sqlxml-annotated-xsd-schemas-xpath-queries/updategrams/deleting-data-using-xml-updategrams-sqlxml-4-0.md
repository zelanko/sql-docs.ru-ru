...
```  
 ...
 Можно опустить  **\<после >** тег, если диаграмма обновления выполняет операцию удаления. Если не указан необязательный `mapping-schema` атрибута  **\<ElementName >** указанный в диаграмме обновления, соответствует таблице базы данных и дочерние элементы и атрибуты соответствуют столбцам в таблице.  
