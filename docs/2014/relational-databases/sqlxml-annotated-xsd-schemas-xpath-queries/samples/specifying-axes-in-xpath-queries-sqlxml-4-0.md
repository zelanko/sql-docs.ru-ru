...
### <a name="c-use--to-specify-the-parent-axis"></a>В. Использование символов . для указания родительской оси  
 Следующий запрос получает все **\<Order>** элементы с родительским **\<Customer>** элементом со значением атрибута **CustomerID** , равным 1. В запросе используется `child` ось в предикате для поиска родителя **\<Order>** элемента.  
