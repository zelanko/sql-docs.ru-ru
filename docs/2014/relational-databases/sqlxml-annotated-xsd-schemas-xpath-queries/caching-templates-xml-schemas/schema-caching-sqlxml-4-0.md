...
>  [!INCLUDE[ssNoteRegistry](../../../includes/ssnoteregistry-md.md)]  
 ...
 Дополнительные сведения об установке side-by-side см. в разделе [новые возможности SQLXML 4.0 с пакетом обновления 1](../../sqlxml/what-s-new-in-sqlxml-4-0-sp1.md).  
