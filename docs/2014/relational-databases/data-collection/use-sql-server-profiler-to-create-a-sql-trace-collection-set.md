...
3.  В данном случае убедитесь, что настроено отображение значений продолжительности в миллисекундах (по умолчанию). Для этого выполните следующие действия.  
...
8.  В правом нижнем углу щелкните **Фильтры столбцов** . Откроется диалоговое окно **Изменение фильтра** . В окне **Изменение фильтра** выполните следующие действия.  
    ...
    2.  В окне логический оператор разверните узел **больше или равно** , введите `80` в качестве значения и нажмите кнопку **ОК**.  
...
5.  В обозревателе объектов проверьте успешность создания набора элементов сбора. Для этого выполните следующие действия.  
    ...
    2.  Разверните узел **Управление**, затем **Сбор данных**.  
     ...
     Набор `SPROC_CollectionSet` сбора отображается на том же уровне, что и узел **наборы сбора системных данных** . По умолчанию этот набор элементов сбора отключен.  
