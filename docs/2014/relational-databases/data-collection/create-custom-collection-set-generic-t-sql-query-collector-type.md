---
title: Создание пользовательского набора сбора, использующего тип сборщика запроса универсального T-SQL (Transact-SQL) | Документы Microsoft
ms.custom: ''
ms.date: 06/13/2017
