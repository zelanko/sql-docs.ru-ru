...
4.  
  [Мастер настройки хранилища данных управления](#Wizard) предназначен для создания хранилища данных , настройки имен входа, включения сбора данных и запуска **наборов элементов сбора системных данных**.  
 ...
 **Страница "Настройка хранилища хранилища данных управления"**  
 ...
 **Страница "сопоставленные имена входа и пользователи"**  
 ...
 **Завершение работы со страницей мастера**  
 ...
 **Страница "Настройка выполнения мастера сбора данных"**  
