...
|----------------------|-----------|  
|[Мониторинг компонентов SQL Server](monitor-sql-server-components.md)|Приводятся необходимые действия, необходимые для эффективного мониторинга любого компонента [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)].|  
|[Средства контроля и настройки производительности](performance-monitoring-and-tuning-tools.md)|Перечисляет [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] средства контроля и настройки.|  
