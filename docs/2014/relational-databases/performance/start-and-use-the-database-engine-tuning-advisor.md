...
##  <a name="Initialize"></a>Инициализация помощник по настройке ядра СУБД  
...
##  <a name="Start"></a>Запуск помощник по настройке ядра СУБД  
...
###  <a name="SSMS"></a>Создание рабочих нагрузок скрипта Transact-SQL  
...
###  <a name="Profiler"></a>Создание рабочих нагрузок файлов и таблиц трассировки  
...
####  <a name="PlanCache"></a>Настройка базы данных с помощью кэша планов  
...
7.  Нажмите кнопку **Начать анализ**.  
    ...
    -   **Остановить анализ (с рекомендациями)** останавливает сеанс настройки и предлагает решить, следует ли помощник по настройке ядра СУБД создавать рекомендации на основе анализа, выполненного до этого момента.  
  
    -   **Остановить анализ** останавливает сеанс настройки без создания рекомендаций.  
...
##  <a name="XMLInput"></a>Создание входного XML-файла  
 ...
 **Выбор рабочей нагрузки [файл или таблица]**  
 ...
 **Выбор баз данных и таблиц для настройки**  
...
> [!NOTE]  
>  Помощник по настройке ядра СУБД не обновляет автоматически сведения о строках для таблиц, отображаемых на вкладке **Общие** . Вместо этого он основывается на метаданных в базе данных. Если есть основания считать, что данные о строках устарели, выполните команду DBCC UPDATEUSAGE для соответствующих объектов.  
 ...
 **Определите максимальное число. место для рекомендаций (МБ)**  
 ...
 **Создавать рекомендации в Интернете, когда это возможно**  
 ...
 **Создавать только рекомендации в Интернете**  
 ...
 **Поддерживать секционирование с согласованием**  
