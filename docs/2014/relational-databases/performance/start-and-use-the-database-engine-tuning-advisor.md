...
###  <a name="to-create-transact-sql-script-workloads"></a><a name="SSMS"></a>Создание рабочих нагрузок скрипта Transact-SQL  
...
###  <a name="to-create-trace-file-and-trace-table-workloads"></a><a name="Profiler"></a>Создание рабочих нагрузок файлов и таблиц трассировки  
...
####  <a name="to-tune-a-database-by-using-the-plan-cache"></a><a name="PlanCache"></a>Настройка базы данных с помощью кэша планов  
...
2.  Чтобы изменить число событий, используемых для анализа, укажите параметр **-n** . В следующем примере увеличивается число элементов кэша до 2 000.  
