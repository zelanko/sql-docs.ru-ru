 ...
 **Включить отфильтрованные индексы**  
 Включает рекомендации по добавлению отфильтрованных индексов. Этот параметр доступен, если выбран один из этих структур физического проектирования: **Индексы и индексированные представления**, **Индексы** или **Некластеризованные индексы**.  
