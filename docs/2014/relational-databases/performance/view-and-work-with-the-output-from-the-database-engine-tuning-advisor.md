 ...
 **Сведения**  
 Описание пункта **Цель рекомендации**. Возможные значения: кластеризованное, индексированное представление или пустое значение, указывающее на некластеризованный индекс. Показывает также, является ли данный индекс уникальным.  
