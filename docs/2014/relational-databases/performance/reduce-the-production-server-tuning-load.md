...
4.  Примените рекомендацию, полученную при настройке тестового сервера, на рабочем сервере.  
 ...
 ![Использование тестового сервера в помощнике настройки ядра СУБД](../../database-engine/media/testsvr.gif "Использование тестового сервера в помощнике настройки ядра СУБД")  
