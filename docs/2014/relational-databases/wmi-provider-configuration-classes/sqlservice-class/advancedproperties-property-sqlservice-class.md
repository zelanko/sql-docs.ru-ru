...
## <a name="property-valuereturn-value"></a>Значение свойства/возвращаемое значение  
 Массив [класс SqlServiceAdvancedProperty](../sqlserviceadvancedproperty-class/sqlserviceadvancedproperty-class.md) объекты, содержащие дополнительные свойства для `SqlService` объекта.  
