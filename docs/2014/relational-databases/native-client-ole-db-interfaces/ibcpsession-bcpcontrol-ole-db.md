...
## <a name="remarks"></a>Remarks  
 ...
 Этот метод также применяется, чтобы указать на использование инструкции SELECT при массовом копировании данных из [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]. Можно задать `eOption` для аргумента значение BCP_OPTION_HINTS и `iValue` аргумент, чтобы иметь указатель на строку расширенных символов, содержащую инструкцию SELECT.  
