...
## <a name="return-code-values"></a>Значения кода возврата  
 ...
 E_UNEXPECTED  
 Непредвиденный вызов метода. Например [IBCPSession::BCPInit](ibcpsession-bcpinit-ole-db.md) не был вызван метод перед вызовом этой функции.  
