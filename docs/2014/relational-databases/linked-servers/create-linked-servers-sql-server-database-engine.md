...
##  <a name="follow-up-steps-to-take-after-you-create-a-linked-server"></a><a name="FollowUp"></a>Дальнейшие действия. шаги, выполняемые после создания связанного сервера  
