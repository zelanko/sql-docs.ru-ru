...
### <a name="permissions"></a>Разрешения  
 При использовании [!INCLUDE[tsql](../../includes/tsql-md.md)] инструкций, требует `ALTER ANY LINKED SERVER` разрешение на сервер или членство в **setupadmin** предопределенной роли сервера. При использовании [!INCLUDE[ssManStudio](../../includes/ssmanstudio-md.md)] требует `CONTROL SERVER` разрешения или членства в **sysadmin** предопределенной роли сервера.  
...
## <a name="see-also"></a>См. также  
 [Связанные серверы (компонент Database Engine)](linked-servers-database-engine.md)   
