...
## <a name="in-this-section"></a>в этом разделе  
 ...
 [Руководство по программированию управляющих объектов SQL Server (SMO)](server-management-objects-smo/sql-server-management-objects-smo-programming-guide.md)  
