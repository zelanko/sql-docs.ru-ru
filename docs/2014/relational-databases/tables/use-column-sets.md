...
## <a name="inserting-or-modifying-data-in-a-column-set"></a>Вставка или изменение данных в наборе столбцов  
 ...
 При вставке или обновлении с помощью набора XML-столбцов значений разреженных столбцов значений, вставляемых в лежащие в основе разреженные столбцы производится неявное преобразование из `xml` тип данных. Для числовых столбцов пустые значения в XML-столбцах преобразуются в пустые строки. Поэтому в числовые столбцы вставляются значения 0, как это показано в следующем примере.  
