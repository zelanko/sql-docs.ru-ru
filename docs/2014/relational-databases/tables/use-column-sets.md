...
|`nvarchar`|-1|'Default'|0|0|4000|Не применяется|Неприменимо|  
|`decimal`, `float`, `real`|Не применяется|Неприменимо|Неприменимо|Неприменимо|Неприменимо|18|0|  
|`integer`, `bigint`, `tinyint`, `smallint`|Не применяется|Неприменимо|Неприменимо|Неприменимо|Неприменимо|Неприменимо|Неприменимо|  
|`datetime2`|Неприменимо|Не применяется|Неприменимо|Неприменимо|Неприменимо|Неприменимо|7|  
|`datetime offset`|Неприменимо|Не применяется|Не применяется|Неприменимо|Неприменимо|Неприменимо|7|  
|`datetime`, `date`, `smalldatetime`|Неприменимо|Не применяется|Не применяется|Неприменимо|Неприменимо|Неприменимо|Неприменимо|  
|`money`, `smallmoney`|Неприменимо|Неприменимо|Не применяется|Неприменимо|Неприменимо|Неприменимо|Неприменимо|  
|`time`|Неприменимо|Неприменимо|Неприменимо|Не применяется|Неприменимо|Неприменимо|7|  
