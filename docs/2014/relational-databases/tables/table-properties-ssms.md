...
##  <a name="ChangeTracking"></a>Страница Отслеживание изменений  
 **Отслеживание изменений**  
 Указывает, разрешено ли отслеживание изменений для этой таблицы. По умолчанию используется значение `False`.  
 ...
 **Трассировка обновленных столбцов**  
 ...
 **Параметры сортировки столбца имен FileTable**  
...
##  <a name="Storage"></a>Страница "хранилище"  
 ...
 **Секции, использующие сжатие страниц**  
 ...
 **Секции, использующие сжатие строк**  
...
## <a name="see-also"></a>См. также:  
 ...
 [Изменение столбцов &#40;ядро СУБД&#41;](../tables/modify-columns-database-engine.md)  
