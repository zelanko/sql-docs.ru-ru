...
##  <a name="Check"></a> Ограничения CHECK  
 ...
 Проверочные ограничения подобны ограничениям внешнего ключа, так как они управляют значениями, которые присваиваются столбцу. Разница заключается в том, как они определяют, какие значения допустимы: Ограничения ВНЕШНЕГО ключа получают список допустимых значений из другой таблицы, а ПРОВЕРОЧНЫЕ ограничения определяют допустимые значения по логическому выражению.  
