...
|Компонент|SQLEngine|  
|Символическое имя|HK_UNSUPPORTED_TABLE_VALUED_FUNCTIONS|  
|Текст сообщения|Возвращающие табличное значение функции не поддерживаются для "*конструкция*".|  
  
## <a name="user-action"></a>Действие пользователя  
 Не используйте возвращающие табличное значение функции.  
