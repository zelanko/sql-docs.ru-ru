# [Справочник по ошибкам и событиям](errors-and-events-reference-database-engine.md)
# [Справочник по логическим и физическим операторам Showplan](../showplan-logical-and-physical-operators-reference.md)
# [Справочник по классам событий SQL Server +](../event-classes/sql-server-event-class-reference.md)
