 ...
 **Необычная возможная причина**  
  
 Причина ошибки **при попытке входа с использованием проверки подлинности SQL. Сервер настроен только для проверки подлинности Windows.** Это сообщение возвращается в следующих ситуациях.  
