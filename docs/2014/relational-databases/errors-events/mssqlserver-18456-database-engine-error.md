...
## <a name="explanation"></a>Объяснение  
 Если попытка соединения отклоняется из-за сбоя проверки подлинности, имени или неправильный пароль, клиенту возвращается сообщение, аналогичное приведенному ниже:  "Ошибка входа пользователя <имя_пользователя>. (Microsoft SQL Server, ошибка: 18456)".  
