...
|Текст сообщения|Предварительная проверка системных таблиц: Идентификатор объекта O_ID содержит связи межобъектных цепочек. Страница P_ID1 указывает на P_ID2 в единице распределения с идентификатором A_ID1 (должно быть A_ID2). Инструкция проверки прервана из-за неустранимой ошибки.|  
