...
|Идентификатор события|2539|  
|Источник события|MSSQLSERVER|  
|Компонент|SQLEngine|  
|Символическое имя|DBCC_ALLOCATION_SUMMARY_FOR_DATABASE|  
|Текст сообщения|Суммарное число экстентов = EXTENTS, использованных страниц = USED_PAGES, зарезервированных страниц = RESERVED_PAGES.|  
