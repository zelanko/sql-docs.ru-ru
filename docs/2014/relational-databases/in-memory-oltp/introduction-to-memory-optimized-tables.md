...
|Признак|Доступ с помощью хранимой процедуры, скомпилированной в собственном коде|Интерпретируемый доступ [!INCLUDE[tsql](../../../includes/tsql-md.md)]|Доступ по CLR-адресу|  
|-------------|-------------------------------------------------------|-------------------------------------------|----------------|  
