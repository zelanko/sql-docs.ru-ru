...
```  
 ...
 Следующие сообщения об ошибке, относящиеся к таблицам с оптимизацией для памяти, указывают на неудачу транзакции. Если они встречаются в атомарном блоке, это приведет к прерыванию транзакции: 10772, 41301, 41302, 41305, 41325, 41332 и 41333.  
