 ...
 **Примечание.** Невозможно изменить размер массива использующегося хэш-индекса. Чтобы изменить размер массива хэш-индекса, нужно удалить таблицу, изменить значение bucket_count и повторно создать таблицу.  
