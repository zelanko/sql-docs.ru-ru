...
##  <a name="example-memory-optimized-table"></a><a name="bkmk_ExampleTable"></a>Пример таблицы, оптимизированной для памяти  
...
##  <a name="memory-for-growth"></a><a name="bkmk_MemoryForGrowth"></a>Память для роста  
