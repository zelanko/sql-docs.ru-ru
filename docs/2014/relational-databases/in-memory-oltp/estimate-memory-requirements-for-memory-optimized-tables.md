...
-   [Пример таблицы, оптимизированной для памяти](#bkmk_ExampleTable)  
...
-   [Память для роста](#bkmk_MemoryForGrowth)  
  
##  <a name="bkmk_ExampleTable"></a>Пример таблицы, оптимизированной для памяти  
...
##  <a name="bkmk_MemoryForGrowth"></a>Память для роста  
