...
|Categories|Дисковая таблица|Долговечная, оптимизированная для памяти таблица|  
|----------------|-----------------------|-------------------------------------|  
