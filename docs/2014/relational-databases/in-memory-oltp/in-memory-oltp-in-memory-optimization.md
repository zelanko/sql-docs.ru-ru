...
|Управление состоянием сеанса.|Частый ввод, обновление и поиск точки.<br /><br /> Большая нагрузка от многочисленных веб-серверов.|Устранение конкуренции.<br /><br /> Эффективное извлечение данных.<br /><br /> Дополнительное снижение или удаление операций ввода-вывода при использовании не устойчивых таблиц|  
 ...
 Дополнительные сведения о сценариях где [!INCLUDE[hek_2](../../../includes/hek-2-md.md)] приведет к наибольшему росту производительности, см. в разделе [In-Memory OLTP — стандартные шаблоны рабочей нагрузки и вопросы миграции](https://msdn.microsoft.com/library/dn673538.aspx).  
...
-   Блокирует свободные объекты, которые устраняют все физические блокировки и защелки Потоки, выполняющие транзакционную работу не используйте блокировки или кратковременные блокировки для управления параллелизмом.  
...
-   [Microsoft?? SQL Server?? Руководство по продукту 2014](https://www.microsoft.com/download/confirmation.aspx?id=39269)  
...
-   [Общие сведения об интервалах SQL Server In-Memory OLTP](https://download.microsoft.com/download/8/3/6/8360731A-A27C-4684-BC88-FC7B5849A133/SQL_Server_2016_In_Memory_OLTP_White_Paper.pdf)  
    <!--
