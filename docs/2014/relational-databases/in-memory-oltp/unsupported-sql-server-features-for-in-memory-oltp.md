...
-   [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]Управляющие объекты. Дополнительные сведения см. в разделе [Поддержка управляющих объектов SQL Server SMO для In-Memory OLTP](sql-server-management-objects-support-for-in-memory-oltp.md).  
...
-   [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]Оболочк. Дополнительные сведения см. в разделе [Обзор SQL Server PowerShell](https://msdn.microsoft.com/library/cc281954\(SQL.105\).aspx).  
...
|Триггеры DDL|Триггеры DDL уровня базы данных и уровня сервера не поддерживаются для таблиц OLTP в памяти и хранимых процедур, скомпилированных в собственном коде.|  
