...
|Повторная компиляция вручную|Не поддерживается. Решение, позволяющее обойти эти ограничения, заключается в удалении и повторном создании хранимой процедуры.|C помощью `sp_recompile`. Можно вручную удалить план из кэша при помощи инструкции DBCC FREEPROCCACHE. Можно также создать хранимую процедуру с параметром WITH RECOMPILE; такая хранимая процедура будет повторно компилироваться при каждом выполнении.|  
...
### <a name="compilation-and-query-processing"></a>Компиляция и обработка запросов  
 ...
 ![Компиляция хранимых процедур в собственном режиме.](../../database-engine/media/hekaton-query-plan-6.gif "Компиляция хранимых процедур в собственном коде.")  
...
5.  Созданная библиотека DDL загружается в память.  
 ...
 ![Выполнение хранимых процедур, скомпилированных в собственном виде.](../../database-engine/media/hekaton-query-plan-7.gif "Выполнение хранимых процедур, скомпилированных в собственном коде.")  
