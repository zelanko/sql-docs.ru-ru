...
####  <a name="Permissions"></a> Permissions  
 Эта процедура должна выполняться пользователем с `sysadmin` разрешения; те же разрешения, необходимые для создания точки управления служебной Программой.  
