...
-   **Включение регулятора ресурсов с помощью:**  [Обозреватель объектов](#RGOnObjEx), [свойства регулятора ресурсов](#RGOnProp), [Transact-SQL](#RGOnTSQL)  
