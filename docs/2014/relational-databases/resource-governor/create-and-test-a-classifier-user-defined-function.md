...
3.  Запретите блокирование таблицы подстановки.  
    ...
    5.  При обновлении содержимого таблицы обязательной используйте транзакцию уровня изоляции моментального снимка, чтобы запись не блокировала чтение. Обратите внимание, что может также помочь использование указания `NOLOCK` .  
