...
-   **Создание рабочей нагрузки группы, с использованием:**  [SQL Server Management Studio](#CreWGProp), [Transact-SQL](#CreWGTSQL)  
...
##  <a name="CreWGProp"></a> Создание группы рабочей нагрузки в среде SQL Server Management Studio  
...
##  <a name="CreWGTSQL"></a> Создание группы рабочей нагрузки с помощью Transact-SQL  
