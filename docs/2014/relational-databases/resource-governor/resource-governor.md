...
ms.locfileid: "62704867"
---
# <a name="resource-governor"></a>Resource Governor
  [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]Resource Governor является компонентом, который можно использовать для управления [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] рабочей нагрузкой и потреблением ресурсов системы. Resource Governor позволяет задать ограничения на объем ресурсов ЦП, памяти и количество физических операций ввода-вывода, которые могут использоваться для входящих запросов приложений.  
...
|Описывает, как создать и проверить определяемую пользователем функцию-классификатор.|[Resource Governor Classifier Function](resource-governor-classifier-function.md)|  
...
## <a name="see-also"></a>См. также:  
 [Экземпляры ядро СУБД &#40;SQL Server&#41;](../../database-engine/configure-windows/database-engine-instances-sql-server.md)  
