...
-   **Чтобы изменить параметры для рабочей нагрузки группы, с использованием:**  [SQL Server Management Studio](#ChgWGProp), [Transact-SQL](#ChgWGTSQL)  
