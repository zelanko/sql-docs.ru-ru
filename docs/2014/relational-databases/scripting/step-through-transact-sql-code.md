...
|Действие|Процедура|  
|------------|---------------|  
|Выполнить все инструкции от текущей инструкции до следующей точки останова|На **отладки** меню, нажмите кнопку **Продолжить**.<br /><br /> На **отладки** инструментов, нажмите кнопку **Продолжить** кнопки.|  
|Перейти в следующую инструкцию или модуль|На **отладки** меню, нажмите кнопку **шаг с заходом**.<br /><br /> На **отладки** инструментов, нажмите кнопку **шаг с заходом** кнопки.<br /><br /> Нажмите клавишу F11.|  
|Перейти через следующую инструкцию или модуль|На **отладки** меню, нажмите кнопку **шаг с обходом**.<br /><br /> На **отладки** инструментов, нажмите кнопку **шаг с обходом** кнопки.<br /><br /> Нажмите клавишу F10.|  
|Выйти из модуля|На **отладки** меню, нажмите кнопку **шаг с выходом**.<br /><br /> На **отладки** инструментов, нажмите кнопку **шаг с выходом** кнопки.<br /><br /> Нажмите сочетание клавиш SHIFT+F11.|  
