...
|------------|---------------|  
|Выполнить все инструкции от текущей инструкции до следующей точки останова|В меню **Отладка** выберите пункт **продолжить**.<br /><br /> На панели инструментов " **Отладка** " нажмите кнопку **продолжить** .|  
...
|Перейти через следующую инструкцию или модуль|В меню **Отладка** выберите **Шаг с обходом**.<br /><br /> На панели инструментов **Отладка** нажмите кнопку **Шаг с обходом** .<br /><br /> Нажмите клавишу F10.|  
