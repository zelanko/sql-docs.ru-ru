...
3.  **Использование цвета состояния:**  [Откройте редактор запросов, с помощью цвета сервера](#OpenServerColor), [откройте редактор запросов цвета состояния](#OpenSpecColor)  
