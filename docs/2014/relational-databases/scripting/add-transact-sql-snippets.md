...
## <a name="examples"></a>Примеры  
 В следующем примере создается `TRY-CATCH` внутри фрагмента кода и импортирован в [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)].  
