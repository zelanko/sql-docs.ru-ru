...
|ESC|
  \|Совпадает с символом после обратной косой черты (\\) в качестве литерала. Это позволяет искать символы, имеющие специальное значение в регулярных выражениях, таких как { или ^. Например, \\^ ищет символ ^.|  
...
|Выравнивание по левому краю|
  \\(-w,n)|В выражении **Замена** выравнивает по левому краю n-е выражение, заключенное в теги, в поле шириной, по крайней мере, *w* символов.|  
