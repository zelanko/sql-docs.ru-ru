...
5.  Нажмите кнопку **Заменить** , чтобы заменить текущее совпадение на текст, указанный в поле **Заменить на** . Отдельные совпадения можно пропустить, нажав кнопку **Найти следующее** . Чтобы пропустить целый файл, нажмите кнопку **Пропустить файл**.  
    ...
    > [!NOTE]  
    >  **Заменить все** заменяет все совпадения, включая те, которые находятся в файлах, пропущенных с помощью **Пропустить файл** или **Найти далее**. С помощью кнопки **Отменить** можно отменить замены только для тех файлов, которые остались открытыми после операции замены.  
