...
-   Команда **отменить** доступна только для документов, открытых после операции замены.  
  
-   **Отмена** операции " **заменить все** ", охватывающей более одного файла, считается единичным массовым действием во всех затронутых файлах. При этом нельзя отменить изменения в одних файлах, сохранив их в других.  
