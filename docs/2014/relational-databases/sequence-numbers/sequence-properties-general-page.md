 ...
 **Минимальное значение**  
 Указывает граничные значения для объекта последовательности. По умолчанию минимальным значением для нового объекта последовательности служит минимальное значение для типа данных объекта последовательности. Это ноль, для `tinyint` тип данных и другие типы данных — отрицательное число.  
