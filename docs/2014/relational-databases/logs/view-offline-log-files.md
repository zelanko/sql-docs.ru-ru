...
1.  Откройте оснастку «Элемент управления WMI». Для этого выполните одно из следующих действий в зависимости от операционной системы.  
    ...
    -   Нажмите кнопку **запустить**, тип `wmimgmt.msc` в **начать поиск** поле и нажмите клавишу ВВОД.  
  
    -   Нажмите кнопку **запустить**, нажмите кнопку **запуска**, тип `wmimgmt.msc`, и нажмите клавишу ВВОД.  
