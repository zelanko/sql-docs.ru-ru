...
-   После успешного выполнения фиксации транзакции изменений, внесенные транзакцией, становятся видимыми для других транзакций в системе. См. в разделе [уровни изоляции транзакций](../../database-engine/transaction-isolation-levels.md) для получения дополнительной информации.  
 ...
 **Записи журналов транзакций обнаружено узкое место.**  
 ...
 **Под нагрузкой имеют отличается высокой частотой конфликтов.**  
