...
-   ALTER ANY \<*Server Securable*> , где *защищаемый объект сервера* может быть любым защищаемым сервером.  
