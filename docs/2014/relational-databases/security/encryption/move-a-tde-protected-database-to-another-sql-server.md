...
9. В **расположение файлов базы данных -** _имя_сервера_ диалоговом окне выберите файл базы данных для присоединения к новому серверу и нажмите кнопку **ОК**.  
