...
7.  В обозревателе объектов в [!INCLUDE[ssManStudioFull](../../../includes/ssmanstudiofull-md.md)]щелкните правой кнопкой мыши папку **базы данных** и выберите команду **Присоединить...**.  
...
9. В диалоговом окне " **Размещение файлов базы данных —**_server_name_ " выберите файл базы данных, который нужно присоединить к новому серверу, и нажмите кнопку " **ОК**".  
     ...
     **"** _<database_name>_ **"сведения о базе данных**  
     Отображаются имена файлов, которые необходимо присоединить. Чтобы проверить или изменить путь к файлу, нажмите кнопку **обзора** (**...**).  
