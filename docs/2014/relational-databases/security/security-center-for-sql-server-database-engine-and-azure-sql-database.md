...
|Проверка подлинности: Ты кто?|Авторизация: Что можно сделать?|Шифрование: Хранение секретных данных|Безопасность подключения: Ограничения и обеспечение безопасности|Аудит. Доступ на запись|  
|----------------------------------|-------------------------------------|-------------------------------------|---------------------------------------------------|--------------------------------|  
