 ...
 **Проверка подлинности в базе данных пользователя**  
 ...
 **Столбцов, данных и ключа шифрования**  
...
-   [Шифрование с парольной фразой](/sql/t-sql/functions/encryptbypassphrase-transact-sql)  
 ...
 ![Небольшой значок папки](../../integration-services/media/filefolder-small.gif "небольшой значок папки") **авторизация: что вам можно делать?**  
