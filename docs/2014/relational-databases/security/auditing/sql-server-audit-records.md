...
|**успешно**|Показывает, было ли успешным действие, запустившее событие.|`bit`-1 = успешное завершение, 0 = сбой|Да|  
...
|**Идентификатор object_**|Основной идентификатор сущности, над которой произведен аудит. А именно:<br /><br /> объекты серверов;<br /><br /> databases<br /><br /> Объекты базы данных<br /><br /> объекты схемы;|`int`|нет|  
...
|**object_name**|Имя сущности, для которой проводился аудит. А именно:<br /><br /> объекты серверов;<br /><br /> databases<br /><br /> Объекты базы данных<br /><br /> объекты схемы;<br /><br /> инструкция TSQL (если имеется)|`sysname`|нет|  
|**баланс**|инструкция TSQL (если имеется)|`nvarchar(4000)`|нет|  
