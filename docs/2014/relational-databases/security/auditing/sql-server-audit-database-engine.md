...
## <a name="topics-closely-related-to-auditing"></a>Темы, тесно связанные с аудитом  
 ...
 [Microsoft TechNet: технический центр SQL Server: Защита и обеспечение безопасности SQL Server 2005](https://go.microsoft.com/fwlink/?LinkId=101152)  
