...
4.  В диалоговом окне **Пользователь базы данных — создание** на странице **Общие** выберите один из следующих типов пользователей в списке **Тип пользователя**: **Пользователь SQL с именем входа**, **пользователь SQL без имени входа**, **пользователь, сопоставленный с сертификатом**, **пользователь, сопоставленный с асимметричным ключом**, или **пользователя Windows** .  
 ...
 **Новый пользователь базы данных** диалоговое окно также предлагает варианты на четырех дополнительных страницах: **Собственные схемы**, **членства**, **защищаемые объекты**, и **расширенные свойства**.  
