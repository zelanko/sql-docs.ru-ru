...
3.  В диалоговом окне **Имя входа — создание** на странице **Общие** введите имя пользователя в поле **Имя для входа**. Также можно нажать кнопку **Поиск...**, чтобы открыть диалоговое окно **Выбор пользователя или группы**.  
    ...
    1.  В разделе **выберите тип объекта**, нажмите кнопку **типы объектов...**  открыть **типы объектов** диалогового окна выберите любые или все из следующих: **Встроенные субъекты безопасности**, **группы**, и **пользователей**. **Встроенные субъекты безопасности** и **Пользователи** выбираются по умолчанию. После завершения нажмите кнопку **ОК**.  
 ...
 **Создание имени входа** диалоговое окно также предлагает варианты на четырех дополнительных страницах: **Роли сервера**, **сопоставление пользователя**, **защищаемые объекты**, и **состояние**.  
...
2.  В **Добавление объектов** диалоговое окно, выберите один из следующих вариантов: **Конкретные объекты...** , **Все объекты типов...** , или **сервера**_имя_сервера_. [!INCLUDE[clickOK](../../../includes/clickok-md.md)]  
...
3.  При выборе параметра **Конкретные объекты...**  
    ...
    2.  В **Выбор типов объектов** диалоговом окне выберите любые или все из следующих типов объектов: **Конечные точки**, **имена входа**, **серверы**, **групп доступности**, и **ролей сервера**. [!INCLUDE[clickOK](../../../includes/clickok-md.md)]  
...
4.  При выборе **все объекты типов...** в **Выбор типов объектов** диалоговом окне выберите любые или все из следующих типов объектов: **Конечные точки**, **имена входа**, **серверы**, **групп доступности**, и **ролей сервера**. [!INCLUDE[clickOK](../../../includes/clickok-md.md)]  
