...
-   Содержит ли описание этого носителя метку MTF или описание носителя.
    ...
    > [!NOTE]
    >  Все носители, используемые для операции резервного копирования или восстановления, используют стандартный формат резервного копирования с именем [!INCLUDE[msCoName](../../includes/ssnoversion-md.md)] сохраняет все метки носителей MTF, записанные другим приложением, но не записывают метки носителей MTF.
