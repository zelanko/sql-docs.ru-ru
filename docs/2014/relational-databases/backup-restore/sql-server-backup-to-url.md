...
-   При создании контейнера для службы хранилища BLOB-объектов Azure рекомендуется установить доступ к **частному**. Если задать для доступа значение частный, пользователи или учетные записи смогут предоставлять необходимую информацию для проверки подлинности в учетной записи Azure.  
