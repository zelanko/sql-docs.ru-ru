...
###  <a name="OpenTapes"></a> Управление открытыми магнитными лентами  
 ...
 Если лента была случайно оставлена открытой, самый быстрый способ освободить ленту — использовать следующую команду: RESTORE REWINDONLY FROM TAPE **=** _имя_устройства_резервного_копирования_. Дополнительные сведения см. в разделе [RESTORE REWINDONLY (Transact-SQL)](/sql/t-sql/statements/restore-statements-rewindonly-transact-sql).  
