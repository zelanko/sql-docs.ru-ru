...
##  <a name="backup-encryption-methods"></a><a name="Methods"></a>Методы шифрования резервных копий  
...
##  <a name="recommended-practices"></a><a name="RecommendedPractices"></a>Рекомендуемые методики  
