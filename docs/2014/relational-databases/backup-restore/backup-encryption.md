...
-   **Алгоритм шифрования:** Поддерживаются алгоритмы шифрования: AES 128, AES 192, AES 256 и Triple DES  
...
1.  Шифрование резервных копий базы данных помогает обезопасить данные: SQL Server предоставляет возможность шифрования данных при создании резервной копии.  
