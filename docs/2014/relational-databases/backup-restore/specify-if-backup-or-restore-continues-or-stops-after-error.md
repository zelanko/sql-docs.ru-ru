---
title: Укажите ли резервного копирования или восстановления продолжается или останавливается после возникновения ошибки (SQL Server) | Документация Майкрософт
ms.custom: ''
ms.date: 06/13/2017
