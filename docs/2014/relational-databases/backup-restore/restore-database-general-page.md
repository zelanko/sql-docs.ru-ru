 ...
 **Использование SQL Server Management Studio для восстановления резервной копии базы данных**  
...
> [!NOTE]  
>  Если задача восстановления выполняется в среде [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)], можно создать соответствующий сценарий [!INCLUDE[tsql](../../includes/tsql-md.md)][RESTORE](/sql/t-sql/statements/restore-statements-transact-sql) script by clicking **Script** and then selecting a destination for the script.  
