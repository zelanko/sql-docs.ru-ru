...
|**Тип**|Объект резервной копии: База данных, файл или  *\<пустой >* (для журналов транзакций).|  
|**Компонент**|Тип выполненного резервного копирования: Полное, разностное или резервное копирование журнала транзакций.|  
