...
-   [Резервные копии баз данных в простой модели восстановления](#DbBuRMs)  
  
-   [Резервные копии баз данных в модели полного восстановления](#DbBuRMf)  
  
-   [Использование полной резервной копии базы данных для восстановления базы данных](#RestoreDbBu)  
  
-   [Связанные задачи](#RelatedTasks)  
  
##  <a name="DbBuRMs"></a>Резервные копии баз данных в простой модели восстановления  
...
##  <a name="DbBuRMf"></a>Резервные копии баз данных в модели полного восстановления  
...
##  <a name="RestoreDbBu"></a>Использование полной резервной копии базы данных для восстановления базы данных  
