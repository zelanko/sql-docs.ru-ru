...
14. В разделе **надежность** при необходимости установите флажок:  
    ...
    -   **Рассчитать контрольную сумму перед записью на носитель** и дополнительно **Продолжить в случае ошибки контрольной суммы**. Дополнительные сведения о контрольных суммах см. в разделе [Возможные ошибки носителей во время резервного копирования и восстановления (SQL Server)](possible-media-errors-during-backup-and-restore-sql-server.md).  
...
#### <a name="a-creating-a-file-backup-of-two-files"></a>А) Создание резервной копии двух файлов  
