...
# <a name="back-up-and-restore-of-sql-server-databases"></a>Резервное копирование и восстановление баз данных SQL Server
 ...
 Помимо локального хранилища для хранения резервных копий, SQL Server также поддерживает резервное копирование и восстановление из службы хранилища BLOB-объектов Azure. Дополнительные сведения см. в статье [SQL Server резервное копирование и восстановление с помощью службы хранилища BLOB-объектов Azure](sql-server-backup-and-restore-with-microsoft-azure-blob-storage-service.md).  
...
-   Создание резервных копий баз данных [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] , выполнение проверочных процедур восстановления резервных копий и хранение резервных копий в безопасном месте вне рабочей площадки помогают предотвратить возможную необратимую потерю данных.  
    ...
    -   стихийные бедствия. Используя SQL Server резервное копирование в службу хранилища BLOB-объектов Azure, можно создать автономную резервную копию в регионе, отличном от региона локального расположения, чтобы использовать его в случае стихийной аварии, влияющей на локальное расположение.  
