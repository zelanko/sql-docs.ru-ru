...
3.  **Создайте резервную копию базы данных:** Укажите алгоритм шифрования и сертификат для использования. Скопируйте следующий пример в окно запроса и нажмите кнопку **Выполнить**.  
...
-   Учетная запись хранения Windows и контейнер. Дополнительные сведения можно найти в разделе [Занятие 1. Создание объектов службы хранилища Azure](../../tutorials/lesson-1-create-windows-azure-storage-objects.md).  
...
1.  **Создание учетных данных SQL Server:** Чтобы создать SQL Server учетные данные, подключитесь к ядро СУБД, откройте новое окно запроса, скопируйте и вставьте следующий пример и нажмите кнопку **выполнить**.  
...
2.  **Создайте главный ключ базы данных.** Выберите пароль для шифрования копии главного ключа, которая будет храниться в базе данных. Подключитесь к ядру СУБД, откройте новое окно запроса, скопируйте в него следующий пример и нажмите кнопку **Выполнить**.  
...
4.  **Создайте резервную копию базы данных:** Укажите алгоритм шифрования и сертификат для использования. Скопируйте следующий пример в окно запроса и нажмите кнопку **Выполнить**.  
