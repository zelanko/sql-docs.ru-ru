...
|Восстановление страниц**\***|Поддерживается полностью.|Порой.**\*\***|Отсутствует.|  
...
##  <a name="restore-under-the-bulk-logged-recovery-model"></a><a name="RMblogRestore"></a>Восстановление в модели восстановления с негрупповым протоколированием  
...
##  <a name="database-recovery-advisor-sql-server-management-studio"></a><a name="DRA"></a>Помощник по восстановлению базы данных (SQL Server Management Studio)  
