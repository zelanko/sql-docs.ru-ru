 ...
 **Добавить к существующему резервному набору данных**  
 ...
 **Проверка имени набора носителей и срока действия резервного набора данных**  
 ...
 **Проверять резервную копию после завершения**  
 Проверка полноты резервного набора данных и читаемости всех томов.  
  
 **Выполняйте контрольную сумму перед записью на носитель**  
 ...
 **Перемотка ленты перед выгрузкой**  
