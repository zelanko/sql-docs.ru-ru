...
### <a name="compression"></a>Сжатие  
 [!INCLUDE[ssEnterpriseEd10](../../../includes/ssenterpriseed10-md.md)] (и более поздние версии) поддерживает [сжатие резервной копии](backup-compression-sql-server.md).  
