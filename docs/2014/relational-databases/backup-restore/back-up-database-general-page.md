 ...
 **Использование SQL Server Management Studio для создания резервной копии**  
 ...
 **Резервная копия только для копирования**  
 Выбирается для создания резервной копии только для копирования. 
