---
title: Восстановление резервной копии базы данных (SQL Server Management Studio) | Документы Microsoft
ms.custom: ''
ms.date: 03/06/2017
...
3.  Щелкните правой кнопкой мыши базу данных, выберите пункт **задачи**, пункты **восстановить**и нажмите кнопку **базы данных**, откроется **Restore Database** диалоговое окно.  
