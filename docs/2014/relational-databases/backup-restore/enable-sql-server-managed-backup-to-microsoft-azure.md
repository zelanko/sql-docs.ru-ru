...
6.  **Просмотр конфигурации расширенных событий по умолчанию:** Просмотрите параметры расширенных событий, для этого запустите приведенную ниже инструкцию Transact-SQL.  
