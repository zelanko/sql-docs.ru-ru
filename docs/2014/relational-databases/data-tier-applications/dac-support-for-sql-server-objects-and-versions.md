...
##  <a name="supported-sql-server-objects"></a><a name="SupportedObjects"></a>Поддерживаемые объекты SQL Server  
...
##  <a name="data-tier-application-support-by-the-versions-of-sql-server"></a><a name="SupportByVersion"></a>Поддержка приложений уровня данных в версиях SQL Server  
...
##  <a name="data-deployment-limitations"></a><a name="DeploymentLimitations"></a>Ограничения на развертывание данных  
...
##  <a name="additional-considerations-for-deployment-actions"></a><a name="Considerations"></a> Дополнительные замечания по операциям развертывания  
