...
##  <a name="UsingDeployDACWizard"></a> С помощью мастера приложений уровня данных развертывания  
 ...
 **\< Предыдущие** — возврат на **обновление конфигурации** страницу, чтобы изменить выбранные параметры.  
...
5.  Задать `DatabaseDeploymentProperties`.  
