...
-   **Выпуск [!INCLUDE[ssSDS](../../includes/sssds-md.md)]**  — укажите [!INCLUDE[ssSDS](../../includes/sssds-md.md)] Business или [!INCLUDE[ssSDS](../../includes/sssds-md.md)] Web. Дополнительные сведения о выпусках [!INCLUDE[ssSDS](../../includes/sssds-md.md)]см. на веб-сайте [SQL Database](http://www.windowsazure.com/home/tour/database/) .  
