...
-   **Далее** — переход на страницу **Параметры развертывания** .  
...
##  <a name="Progress"></a>Страница "выполнение"  
 ...
 **Развертывание базы данных с помощью методов методов DacStore Export () и Import () в приложении .NET Framework.**  
