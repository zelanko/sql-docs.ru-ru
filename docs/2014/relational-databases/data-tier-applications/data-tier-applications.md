...
-   **Экспорт**. пользователь может экспортировать схему и данные базы данных в BACPAC-файл.  
  
-   **Импорт** . пользователь может импортировать схему и данные в новую базу данных на сервере узла.  
...
|Описывает процедуру обновления существующей базы данных до экземпляра DAC. Определение DAC строится и хранится в системной базе данных.|[Регистрация базы данных в качестве DAC](register-a-database-as-a-dac.md)|  
