...
2.  **Для обновления приложения уровня данных, с помощью:**  [Просмотр содержимого приложения уровня данных](#ViewDACContents), [Просмотр изменений базы данных](#ViewDBChanges), [Просмотр действий по обновлению](#ViewUpgradeActions), [сравнение приложений уровня данных](#CompareDACs)  
