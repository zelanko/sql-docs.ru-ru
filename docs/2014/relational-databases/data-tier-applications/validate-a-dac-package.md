 ...
 **Действия по обновлению отчетов с помощью мастера**  
 ...
 **Действия по обновлению отчетов с помощью PowerShell**  
...
##  <a name="CompareDACs"></a>Сравнить приложений уровня данных  
