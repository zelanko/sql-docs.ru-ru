...
###  <a name="select-data-page"></a><a name="SelectData"></a>Страница «Выбор данных»  
...
###  <a name="set-properties-page"></a><a name="SetProperties"></a>Страница «Задание свойств»  
...
###  <a name="validation-and-summary-page"></a><a name="ValidateSummary"></a>Страница «Проверка и сводка»  
...
###  <a name="build-package-page"></a><a name="BuildPackage"></a>Страница «сборка пакета»  
...
##  <a name="extract-a-dac-using-powershell"></a><a name="ExtractDACPowerShell"></a>Извлечение приложения уровня данных с помощью PowerShell  
