...
-   **Для извлечения приложения уровня данных, используя:**[извлечения мастера приложений уровня данных](#UsingDACExtractWizard), [PowerShell  ](#ExtractDACPowerShell)  
