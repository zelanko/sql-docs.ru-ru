...
##  <a name="unpack-data-tier-application-dialog"></a><a name="UnpackDACDial"></a> диалоговое окно распаковки приложения уровня данных  
...
###  <a name="unpack-microsoft-sql-server-dac-package-file"></a><a name="Unpack"></a> Распаковать файл пакета Microsoft SQL Server DAC  
...
###  <a name="browse-for-folder"></a><a name="Browse"></a> Выбор папки  
...
##  <a name="examine-the-contents-of-a-dac-package"></a><a name="ExamDACPack"></a> изучение содержимого пакета приложения уровня данных  
