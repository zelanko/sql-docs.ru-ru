...
5.  Выполните шаги в диалоговых окнах мастера.  
    ...
    -   [Страница параметров экспорта](#Export_settings)  
...
##  <a name="Export_settings"></a>Страница параметров экспорта  
 ...
 **Экспорт приложения уровня данных с помощью метода Export () в приложении .NET Framework.**  
