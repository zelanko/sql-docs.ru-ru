...
##  <a name="Validation"></a> Страница «Проверка»  
 Используйте страницу «Проверка» для поиска любых проблем, блокирующих операцию. Для продолжения устраните критически препятствия, приводящие к блокированию, и нажмите кнопку **Повторить проверку** для обеспечения успешного завершения проверки.  
