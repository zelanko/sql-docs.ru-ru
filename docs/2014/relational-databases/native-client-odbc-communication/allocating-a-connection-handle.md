---
title: Выделение дескриптора соединения | Документы Microsoft
ms.custom: ''
ms.date: 03/06/2017
...
ms.locfileid: "36189974"
---
# <a name="allocating-a-connection-handle"></a>Выделение дескриптора соединения
  Прежде, чем приложение может подключиться к источнику данных или драйверу, оно должно выделить дескриптор соединения. Это делается путем вызова **SQLAllocHandle** с *HandleType* имеющим значение SQL_HANDLE_DBC и *InputHandle* указывающим на инициализированный дескриптор среды.  
