...
|*Домен имени пользователя*@*Domain*|Прямое указание учетной записи домена.<br /><br /> *Username* — имя учетной записи пользователя Windows.<br /><br /> *Domain* — имя домена Windows или полное имя домена.|  
|*MachineName*$@*Домен* MachineName|Прямое указание учетной записи компьютера<br /><br /> (Если сервер, к которому вы подключаетесь, работает под учетной записью локальной системы или сетевой службы, для `ServerSPN` получения проверки подлинности Kerberos может использоваться формат*домена* *MachineName*$@.)|  
