...
|**имя_базы_данных**|`nvarchar`|Имя базы данных, где произошло укрупнение уровня блокировки.|35|Да|  
|**EventClass**|`int`|Тип события = 60.|27|нет|  
|**EventSubClass**|`int`|Причина укрупнения блокировки:<br /><br /> **0 — LOCK_THRESHOLD** указывает, что инструкция превысила пороговое значение блокировки.<br /><br /> **1 — MEMORY_THRESHOLD** указывает, что инструкция превысила пороговое значение памяти.|21|Да|  
...
|**ИД**|`int`|Присваиваемый системой идентификатор таблицы, для которой сработало укрупнение блокировки.|22|Да|  
