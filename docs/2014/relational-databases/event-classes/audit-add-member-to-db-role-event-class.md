...
|**имя_базы_данных**|**nvarchar**|Имя базы данных, в которой изменено членство в роли.|35|Да|  
...
|**таржетусернаме**|**nvarchar**|Имя пользователя, для которого изменяется членство в роли.|11,9|Да|  
