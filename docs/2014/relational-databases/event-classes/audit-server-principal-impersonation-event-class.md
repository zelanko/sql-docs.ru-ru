...
ms.locfileid: "85030942"
---
# <a name="audit-server-principal-impersonation-event-class"></a>Audit Server Principal Impersonation, класс событий
  Класс событий **Audit Server Principal Impersonation** возникает, когда в области сервера используется олицетворение, например EXECUTE AS \<*login*> .  
