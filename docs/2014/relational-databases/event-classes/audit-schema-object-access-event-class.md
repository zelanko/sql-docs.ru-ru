...
|**Разрешений**|**int**|Указывает, было ли установлено разрешение на доступ к столбцу. Для определения примененных разрешений проанализируйте текст инструкции. 1 = да, 0 = нет.|44|Да|  
...
|**ИмяОбъекта**|**nvarchar**|Имя объекта, разрешения на который проверяются.|34|Да|  
