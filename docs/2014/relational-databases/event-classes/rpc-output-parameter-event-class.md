...
## <a name="rpc-output-parameter-event-class-data-columns"></a>Столбцы данных класса событий RPC Output Parameter  
...
|EventClass|`int`|Тип события = 100.|27|Нет|  
...
|ObjectName|`nvarchar`|Имя параметра, на который имеется ссылка.|34|Да|  
...
|TextData|`ntext`|Выходные значения параметров RPC.|1|Да|  
