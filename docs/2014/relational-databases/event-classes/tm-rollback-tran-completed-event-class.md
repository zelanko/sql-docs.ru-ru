...
|Успех|`int`|1 = успешное завершение. 0 = неуспешное завершение (например значение 1 показывает, что проверка разрешений прошла успешно, а 0 — проверка завершилась ошибкой).|23|Да|  
