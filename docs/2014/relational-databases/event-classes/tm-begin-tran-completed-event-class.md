---
title: TM. BEGIN Tran Completed, класс событий | Документация Майкрософт
ms.custom: ''
ms.date: 06/13/2017
...
ms.locfileid: "63061238"
---
# <a name="tm-begin-tran-completed-event-class"></a>TM. Класс события Begin Tran Completed
  TM: BEGIN Tran Completed, класс событий указывает, что запрос BEGIN TRANSACTION завершен. Запрос был отправлен клиентом через интерфейс управления транзакциями.  
  
## <a name="tm-begin-tran-completed-event-class-data-columns"></a>TM. BEGIN Tran столбцы данных класса событий Completed  
