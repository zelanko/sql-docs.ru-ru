...
|**Длитель**|**bigint**|Длительность события (в микросекундах).|13|Да|  
...
|**Success**|**int**|0 = ошибка.<br /><br /> 1 = успешное завершение.<br /><br /> 2 = пропущено из-за приостановки сервера (выпуск MSDE).|23|Да|  
