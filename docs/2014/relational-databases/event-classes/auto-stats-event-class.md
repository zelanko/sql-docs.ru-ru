...
|**EventSubClass**|**int**|Тип подкласса событий:<br /><br /> 1: Статистика создана или обновлена синхронно; **TextData** столбца указывает, какая именно статистика и ли они были созданы и обновлены.<br /><br /> 2: Асинхронное обновление статистики; Задание поставлено в очередь.<br /><br /> 3: Асинхронное обновление статистики; задание запускается.<br /><br /> 4: Асинхронное обновление статистики; Задание выполнено.|21|Да|  
