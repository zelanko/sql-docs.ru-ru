...
|**EventSubClass**|`nvarchar`|Конкретное действие, о котором сообщает это событие. Одно из следующих значений:<br /><br /> **Запуск**: <br />                [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] запустил хранимую процедуру активации.<br /><br /> **завершен**: хранимая процедура завершила работу нормально активации.<br /><br /> **прервана**: активации хранимой процедуры, завершился с ошибкой.|21|Нет|  
