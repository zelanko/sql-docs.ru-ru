...
|**BinaryData**|**image**|Количество процессоров, которые используются для завершения этого процесса на основе следующих значений:<br /><br /> 0x00000000L Указывает на последовательный план, исполняемый последовательно.<br /><br /> 0x01000000 указывает параллельный план, исполняемый последовательно.<br /><br /> >= 0x02000000: Указывает параллельный план параллельного выполнения.|2|Нет|  
