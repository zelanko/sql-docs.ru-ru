...
# <a name="cursorexecute-event-class"></a>CursorExecute, класс событий
  Класс событий **CursorExecute** описывает события выполнения курсоров, возникающие в курсорах API. События выполнения курсора происходят [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssDE](../../includes/ssde-md.md)] при создании и заполнении курсора из плана выполнения, созданного событием подготовки курсора.  
...
|**евентсекуенце**|**int**|Последовательность классов событий **CursorExecute** в пакете.|51|нет|  
|**GroupID**|**int**|Идентификатор группы рабочей нагрузки, в которой запускается событие трассировки SQL.|66|Да|  
|**Справиться**|**int**|Целочисленное значение, используемое ODBC, OLE DB или DB-Library для координации работы с сервером.|33|Да|  
