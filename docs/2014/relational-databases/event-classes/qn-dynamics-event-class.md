...
|LoginName|`nvarchar`|Имя учетной записи пользователя (имя входа [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] безопасности или учетные данные входа Windows в формате *домен \ имя_пользователя*).|11|нет|  
