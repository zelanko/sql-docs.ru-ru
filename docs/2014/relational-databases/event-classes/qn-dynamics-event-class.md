...
|EventSubClass|`nvarchar`|Тип подкласса событий, предоставляющий дополнительные сведения о каждом классе события. Данный столбец может содержать следующие значения.<br /><br /> Выполнение запущено часов: Был запущен фоновый поток в компоненте [!INCLUDE[ssDE](../../includes/ssde-md.md)], который планирует очистку таблиц параметров с истекшими сроками действия.<br /><br /> Запустить готовое часов: Был завершен фоновый поток в компоненте [!INCLUDE[ssDE](../../includes/ssde-md.md)], который планирует очистку таблиц параметров с истекшими сроками действия.<br /><br /> Начата задача очистки master: Определяет, когда будет запущена очистка (сборка мусора), удаляющая данные подписки на уведомления о запросах с истекшим сроком давности.<br /><br /> Задача очистки master завершена: Определяет, когда будет завершена очистка (сборка мусора), удаляющая данные подписки на уведомления о запросах с истекшим сроком давности.<br /><br /> Master cleanup задача пропущена. Указывает на то, что компонентом [!INCLUDE[ssDE](../../includes/ssde-md.md)] не была выполнена очистка (сборка мусора) для удаления данных подписки на уведомления о запросах с истекшим сроком давности.|21|Да|  
