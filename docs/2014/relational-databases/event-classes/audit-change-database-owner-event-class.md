...
|**Успех**|**int**|1 = успешное завершение. 0 = неуспешное завершение. Например, значение 1 означает успешную проверку наличия разрешения, а 0 означает ошибку при этой проверке.|23|Да|  
|**таржетлогиннаме**|**nvarchar**|Имя целевого имени входа для действий, направленных на имя входа.|42|Да|  
|**таржетлогинсид**|**Эскиз**|Идентификатор безопасности целевого имени входа для действий, направленных на имя входа.|43|Да|  
