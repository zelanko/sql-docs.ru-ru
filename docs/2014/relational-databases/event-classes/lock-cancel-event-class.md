...
|**имя_базы_данных**|`nvarchar`|Имя базы данных, в которой была запрошена блокировка.|35|Да|  
...
|**ИД**|`int`|Идентификатор объекта, на который отменена блокировка, если доступен и может быть использован.|22|Да|  
