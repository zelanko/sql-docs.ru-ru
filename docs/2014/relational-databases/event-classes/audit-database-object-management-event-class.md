...
ms.locfileid: "48155190"
---
# <a name="audit-database-object-management-event-class"></a>Audit Database Object Management, класс событий
...
> [!NOTE]  
>  Для действий, связанных с открытым ключом, аудит не проводится.  
  
## <a name="audit-database-object-management-event-class-data-columns"></a>Столбцы данных класса событий Audit Database Object Management  
...
|**EventSubClass**|**int**|Тип подкласса события.<br /><br /> 1 = создать<br /><br /> 2 = изменить<br /><br /> 3 = удалить<br /><br /> 4 = создать дамп<br /><br /> 10 = открыть<br /><br /> 11 = загрузить<br /><br /> 12 = доступ|21|Да|  
