...
|LoginName|`nvarchar`|Имя входа [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] пользователя (либо имени входа безопасности, либо учетные данные входа Windows в формате *домен*\\*имя_пользователя*).|11|нет|  
