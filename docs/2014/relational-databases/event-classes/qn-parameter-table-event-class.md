...
|EventSubClass|`nvarchar`|Тип подкласса событий, предоставляющий дополнительные сведения о каждом классе события. Данный столбец может содержать следующие значения.<br /><br /> Таблица, созданная: Указывает таблицу параметров был создан в базе данных.<br /><br /> Попытка удаления таблицы: Указывает, что база данных пыталась автоматически удалить неиспользуемую таблицу параметров для высвобождения ресурсов.<br /><br /> Удаление таблицы не удалось: Указывает, что базы данных попыталась удалить неиспользуемую таблицу параметров завершилась ошибкой. [!INCLUDE[ssDE](../../includes/ssde-md.md)] автоматически спланирует повторную попытку удаления таблицы параметров для высвобождения ресурсов.<br /><br /> Таблица удалена: Указывает, что база данных успешно удалила таблицу параметров.<br /><br /> Таблица закреплена: Указывает, что таблица параметров помечена для текущего использования для внутренней обработки.<br /><br /> Закрепление таблицы отменено: Указывает, что таблицы параметров отменено. Использование таблицы для внутренней обработки завершилось.<br /><br /> Количество пользователей увеличилось: Указывает, что количество подписок на уведомления запросов, ссылающихся на таблицу параметров, увеличилось.<br /><br /> Количество пользователей уменьшилось: Указывает, что количество подписок на уведомления запросов, ссылающихся на таблицу параметров, уменьшилось.<br /><br /> Сброс счетчика LRU: Указывает, что счетчик использования таблицы параметров сброшен.<br /><br /> Начата задача очистки: указывает началась Очистка всех подписок в этой таблице параметров. Это происходит при запуске базы данных или при удалении таблицы, являющейся базовой для подписок в этой таблице параметров.<br /><br /> Задача очистки завершена: Указывает, что очистка всех подписок в этой таблице параметров выполнена.|21|Да|  
