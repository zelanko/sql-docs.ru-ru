...
## <a name="sqlcoptssfailoverpartner"></a>SQL_COPT_SS_FAILOVER_PARTNER  
 ...
 Дополнительные сведения см. в разделе [использование зеркального отображения базы данных](../native-client/features/using-database-mirroring.md).  
...
|SQL_MARS_ENABLED_YES|Режим MARS включен.|  
 ...
 Дополнительные сведения о режиме MARS см. в разделе [с помощью множественные активные результирующие наборы &#40;MARS&#41;](../native-client/features/using-multiple-active-result-sets-mars.md).  
...
## <a name="sqlcoptssconnectiondead"></a>SQL_COPT_SS_CONNECTION_DEAD  
 ...
 Дополнительные сведения об атрибуте SQL_COPT_SS_CONNECTION_DEAD см. в разделе [SQLGetConnectAttr](sqlgetconnectattr.md) и [соединение с источником данных &#40;ODBC&#41;](../native-client-odbc-communication/connecting-to-a-data-source-odbc.md).  
