...
# <a name="sqldescribecol"></a>SQLDescribeCol
  Для выполненных инструкций драйверу ODBC для [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] собственного клиента не требуется запрашивать сервер для описания столбцов в результирующем наборе. В этом случае `SQLDescribeCol` не вызывает обмен данными с сервером. Как и [SQLColAttribute](sqlnumresultcols.md), `SQLDescribeCol` вызов на подготовленных, но не выполненных инструкциях создает обмен данными между серверами.  
