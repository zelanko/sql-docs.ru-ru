...
## <a name="operations-functions-and-null-values"></a>Операции, функции и значения NULL  
 Все арифметические операторы (+, -, \*, /, %), битовые операторы (~ &, и |), и большинство функций возвращают NULL, если любой из операндов или аргументов `SqlTypes` имеют значение NULL. Свойство `IsNull` всегда возвращает значение TRUE или FALSE.  
