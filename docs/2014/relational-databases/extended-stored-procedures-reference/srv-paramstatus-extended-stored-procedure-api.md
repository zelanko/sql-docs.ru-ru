...
## <a name="returns"></a>Возвращает  
 Целое число `int`, содержащее флаги состояния параметра. В настоящее время имеется только один флаг: Если биту 0 задано значение 1, то параметр является возвращаемым параметром. Если отсутствует *n*-й параметр или удаленная хранимая процедура, то возвращается значение -1.  
