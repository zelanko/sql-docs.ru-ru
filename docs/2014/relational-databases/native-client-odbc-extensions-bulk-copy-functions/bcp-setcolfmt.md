...
# <a name="bcp_setcolfmt"></a>bcp_setcolfmt
  Функция **bcp_setcolfmt** заменяет функцию [bcp_colfmt](bcp-colfmt.md). При указании параметров сортировки столбца необходимо использовать функцию **bcp_setcolfmt** . [bcp_setbulkmode](bcp-setbulkmode.md) можно использовать для указания более чем одного формата столбца.  
