...
-   Несколько профилей. Компонент Database Mail позволяет создавать множество профилей в [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] экземпляра. Дополнительно можно выбрать профиль, который будет использовать компонент Database Mail при отправке сообщения.  
...
-   Отключено по умолчанию: Чтобы уменьшить контактную зону [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)], хранимых процедур отключены по умолчанию.  
...
-   Интегрированная конфигурация. Компонент Database Mail хранит информацию для учетных записей электронной почты в [!INCLUDE[ssDEnoversion](../../includes/tsql-md.md)].  
