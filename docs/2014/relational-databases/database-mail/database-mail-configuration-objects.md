...
##  <a name="VisualElement"></a>Связь объектов конфигурации Database Mail  
...
##  <a name="DBAccount"></a>Учетная запись Database Mail  
...
-   Тип сервера электронной почты. Для [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]это всегда простой протокол обмена электронной почтой (SMTP).  
...
##  <a name="DBProfile"></a>Профиль Database Mail  
...
##  <a name="RelatedTasks"></a>Задачи настройки Database Mail  
...
##  <a name="Add_Tasks"></a>Дополнительные задачи по настройке базы данных (системные хранимые процедуры)  
