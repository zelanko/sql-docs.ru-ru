 ...
 **Настройка Database Mail с помощью мастера**  
 ...
 **Далее** — переход к странице **Выбор задачи по настройке** .  
 ...
 **Настройте Database Mail, выполнив следующие задачи.**  
 ...
 **Управление учетными записями и профилями Database Mail**  
...
###  <a name="NewAccount"></a>Страница «Создание учетной записи»  
 ...
 **Описание**  
 Введите описание учетной записи. Поле "Описание" заполнять необязательно.  
 ...
 **Проверка подлинности Windows с использованием учетных данных ядро СУБД службы**  
 ...
 **Описание**  
 Просмотр или обновление описания учетной записи. Поле "Описание" заполнять необязательно.  
  
 **Адрес электронной почты**  
 Просмотр или обновление адреса электронной почты для этой учетной записи. Это адрес электронной почты отправителя. Например, учетная запись для агента Microsoft SQL Server может отправить сообщение электронной почты по **SqlAgent@Adventure-Works.com**адресу.  
...
###  <a name="NewProfile"></a>Страница «Создание профиля»  
 ...
 **Описание**  
 Просмотр или изменение описания выбранного профиля. Поле "Описание" заполнять необязательно.  
...
###  <a name="AccountsProfiles"></a>Страница «Управление учетными записями и профилями»  
 Используйте эту страницу для выбора задачи с целью управления профилем или учетной записью.  
  
 **Создание учетной записи**  
 Создать новую учетную запись.  
  
 **Просмотр, изменение или удаление существующей учетной записи**  
...
###  <a name="ProfileSecurityPublic"></a>Управление безопасностью профиля, вкладка «общедоступная»  
...
###  <a name="ProfileSecurityPrivate"></a>Управление безопасностью профиля, вкладка "частный"  
 ...
 **Показывать только существующие личные профили для этого пользователя**  
 Установите этот флажок, чтобы отображать только профили, к которым указанный пользователь или роль имеют доступ.  
  

  
###  <a name="SystemParameters"></a>Настройка системных параметров  
 ...
 **Количество повторных попыток учетной записи**  
 ...
 **Задержка между попытками применения учетной записи (в секундах)**  
 ...
 **Запрещенные расширения файлов вложений**  
 ...
 **Минимальное время жизни исполняемого объекта Database Mail (в секундах)**  
...
###  <a name="CompleteWizard"></a>Завершение работы со страницей мастера  
...
###  <a name="TestEmail"></a>Страница отправки тестового электронного сообщения  
 Страница **Отправка тестового сообщения с** _<instance_name>_ используется для отправки сообщения электронной почты с использованием указанного профиля Database Mail. Только члены предопределенной роли сервера **sysadmin** могут отправлять тестовые сообщения электронной почты с этой страницы.  
