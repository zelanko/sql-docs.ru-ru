 ...
 **Сетевые адреса серверов**  
 Для каждого из экземпляров сервера предусмотрен аналогичный параметр: **Основной**, **Зеркальный** и **Следящий**.  
