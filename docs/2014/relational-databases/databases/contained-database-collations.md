...
## <a name="contained-databases"></a>Автономные базы данных  
 ...
 Параметры сортировки базы данных сохраняются, но используются только в качестве параметров сортировки по умолчанию для пользовательских данных. По умолчанию параметры сортировки базы данных совпадают с параметрами сортировки базы данных model, но могут быть изменены пользователем с помощью команды `CREATE` или `ALTER DATABASE` , как и при работе с неавтономными базами данных.  
