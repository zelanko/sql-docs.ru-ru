...
3.  Щелкните правой кнопкой мыши имя базы данных, укажите пункт **Задачи**, а затем выберите команду **Отсоединить**. Появится диалоговое окно **Отсоединение базы данных** .  
     ...
     **Состояние**  
     Отображает одно из следующих состояний: **Готовы** или **неготовности**.  
    ...
    -   Если базы данных имеется один или несколько активных соединений, **состояние** — **неготовности** и **сообщение** столбце отображаются _< число_активных_соединений >_**Активных соединений:** — например: **Активных соединений: 1**. Прежде чем можно будет отсоединить базу данных, необходимо отключить активные соединений, выбрав команду **Удалить соединения**.  
...
> [!NOTE]  
>  Отсоединенная база данных отображается в узле **Базы данных** обозревателя объектов до тех пор, пока не будет обновлено представление. Обновить его можно в любой момент, для этого Щелкните панель обозревателя объектов и в строке меню выберите пункт **представление** и затем **обновить**.  
