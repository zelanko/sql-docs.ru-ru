...
> [!NOTE]  
>  Отсоединенная база данных отображается в узле **Базы данных** обозревателя объектов до тех пор, пока не будет обновлено представление. Обновить его можно в любое время: Щелкните панель обозревателя объектов и в строке меню выберите пункт **представление** и затем **обновить**.  
