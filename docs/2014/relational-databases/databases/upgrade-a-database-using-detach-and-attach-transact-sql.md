...
-   **Обновление базы данных SQL Server:**  
...
##  <a name="SSMSProcedure"></a>Обновление базы данных с помощью отсоединения и присоединения  
...
3.  Присоедините скопированные файлы к экземпляру [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]. Дополнительные сведения см. в статье [Присоединение базы данных](attach-a-database.md).  
