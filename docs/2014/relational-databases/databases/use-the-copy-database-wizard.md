...
9. Мастер копирования баз данных создает [!INCLUDE[ssIS](../../includes/ssis-md.md)] пакет для передачи базы данных из **, настройте пакет** странице, внесите изменения в пакет, при необходимости.  
