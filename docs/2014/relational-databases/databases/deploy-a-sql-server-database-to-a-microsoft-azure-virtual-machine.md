...
-   Отключите конфигурацию усиленной безопасности.  Используйте диспетчер сервера > локальный сервер, чтобы установить в Internet Explorer конфигурацию усиленной безопасности (ESC) в значение **Off**.  
  
-   Включить JavaScript:  Internet Explorer > Свойства обозревателя > Безопасность > уровень клиента > Сценарии > активные сценарии: **Включить**.  
