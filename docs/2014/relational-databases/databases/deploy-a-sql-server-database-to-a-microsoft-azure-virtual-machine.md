...
###  <a name="filestream"></a>Рекомендации по развертыванию базы данных с поддержкой FILESTREAM на виртуальной машине Azure  
...
###  <a name="geography"></a>Рекомендации по географическому распределению ресурсов  
...
-   **Путь по умолчанию для файла конфигурации** —:%LocalAppData%\SQL "to to SQL in WA vm\deploymentsettings.XML".  
...
-   **Далее** — переход к странице **Параметры источника** .  
