...
##  <a name="launch_wizard"></a>Использование мастера развертывания базы данных в виртуальной машине Azure  
...
-   Нажмите кнопку **Подключить...** , а затем укажите сведения о подключении для экземпляра [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)], на котором размещена база данных для развертывания.  
...
##  <a name="Azure_sign-in"></a>Вход в Azure  
...
## <a name="see-also"></a>См. также статью  
 ...
 [Развертывание SQL Server в виртуальных машинах Azure](https://msdn.microsoft.com/library/dn133141.aspx)   
 [Подготовка к переходу на SQL Server на виртуальных машинах Azure](https://msdn.microsoft.com/library/dn133142.aspx)  
