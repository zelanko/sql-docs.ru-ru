...
-   Выключите улучшенную конфигурацию безопасности:  Используйте диспетчер серверов > локальный сервер, чтобы установить Internet Explorer конфигурация усиленной безопасности (ESC) **OFF**.  
