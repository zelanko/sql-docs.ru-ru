...
5.  Расчет размера индексной строки:  
     ...
     ***Leaf_Row_Size***  = ****** Fixed_Leaf_Size + ****** Variable_Leaf_Size + ***Leaf_Null_Bitmap*** + 1 (для служебных данных заголовков строк индекса) + 6 (для указателя на идентификатор дочерней страницы)  
...
2.  Вычислите количество неконечных страниц индекса:  
     ...
     ***Num_Index_Pages*** = ∑ (уровень***Num_Leaf_Pages/Index_Rows_Per_Page***<sup></sup>), где 1 <= уровень <= ***уровни***  
