...
##  <a name="containment"></a><a name="containment"></a> Автономность  
...
###  <a name="partially-contained-database"></a><a name="partial"></a>Частично автономная база данных  
...
##  <a name="benefits-of-using-partially-contained-databases"></a><a name="benefits"></a>Преимущества использования частично автономных баз данных  
...
##  <a name="identifying-database-containment"></a><a name="Identifying"></a> Определение состояния включения базы данных  
