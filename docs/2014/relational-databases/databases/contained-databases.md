...
-   [Определение включения базы данных](#Identifying)  
...
##  <a name="Concepts"></a>Основные понятия частично автономных баз данных  
 ...
 Частично автономной базой данных является автономная база данных, в которой допускается пересечение границы базы данных определенными функциями. 
  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] доступна возможность определения пересечения границы включения.  
...
###  <a name="partial"></a>Частично автономная база данных  
...
##  <a name="Identifying"></a>Определение включения базы данных  
...
## <a name="related-content"></a>См. также  
 [Измененные функции &#40;автономной базы данных&#41;](modified-features-contained-database.md)  
 ...
 [Миграция в частично автономную базу данных](migrate-to-a-partially-contained-database.md)  
