...
-   **Перед началом работы**  
     ...
     [Лучшие методики: Присвоение имен моментальным снимкам базы данных](#Naming)  
...
-   [Лучшие методики: Ограничение количества моментальных снимков базы данных](#Limiting_Number)  
  
-   [Лучшие методики: Подключения клиентов к моментальному снимку базы данных](#Client_Connections)  
  
####  <a name="Naming"></a> Лучшие методики: Присвоение имен моментальным снимкам базы данных  
...
####  <a name="Limiting_Number"></a> Лучшие методики: Ограничение количества моментальных снимков базы данных  
...
####  <a name="Client_Connections"></a> Лучшие методики: Клиентские соединения с моментальным снимком базы данных  
