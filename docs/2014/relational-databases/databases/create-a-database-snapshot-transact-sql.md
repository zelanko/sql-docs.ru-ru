...
##  <a name="TsqlProcedure"></a>Создание моментального снимка базы данных (с помощью Transact-SQL)  
...
2.  Используйте инструкцию CREATE DATABASE для файлов с помощью предложения AS SNAPSHOT OF. Создание моментального снимка требует указания логического имени каждого файла базы данных-источника. Синтаксис выглядит так:  
...
-   A. [Создание моментального снимка в базе данных AdventureWorks](#Creating_on_AW)  
  
-   Б. [Создание моментального снимка в базе данных Sales](#Creating_on_Sales)  
  
####  <a name="Creating_on_AW"></a>Конкретного. Создание моментального снимка по базе данных AdventureWorks  
...
####  <a name="Creating_on_Sales"></a>&. Создание моментального снимка по базе данных Sales  
