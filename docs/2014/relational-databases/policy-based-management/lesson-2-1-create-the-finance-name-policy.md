...
2.  В диалоговом окне **Управление категориями политики** в поле **имя**введите `Finance` пустое поле и снимите флажок затребовать **подписки базы данных**. Принудительные **подписки базы данных** принуждает каждую базу данных в экземпляре подписываться на политики, принадлежащие этой категории политики. В рамках этого занятия только база данных Finance должна быть подписана на политику "Finance Name".  
