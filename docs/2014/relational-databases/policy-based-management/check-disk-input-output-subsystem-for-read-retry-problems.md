---
title: Проверьте наличие проблем повторного чтения дисковой подсистемы ввода-вывода | Документы Microsoft
ms.custom: ''
ms.date: 03/06/2017
...
---
# <a name="check-disk-input-output-subsystem-for-read-retry-problems"></a>Проверьте наличие проблем повторного чтения дисковой подсистемы ввода-вывода
