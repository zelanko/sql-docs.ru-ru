...
ms.locfileid: "37190314"
---
# <a name="check-disk-input-output-subsystem-for-read-retry-problems"></a>Проверка на наличие проблем повторного чтения подсистеме ввода-вывода диска
