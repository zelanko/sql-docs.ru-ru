...
См. в разделе [задание параметров сортировки пользовательских баз данных совпадают с главной и базами данных модели](../../database-engine/set-collation-user-defined-databases-match-master-model-databases.md).
