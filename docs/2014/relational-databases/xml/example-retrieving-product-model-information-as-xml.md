...
```  
 ...
 При необходимости можно указать `TYPE` директивы для извлечения результатов в виде `xml` типа. Директива `TYPE` не изменяет содержимое результата. Изменяется только тип данных результата.  
