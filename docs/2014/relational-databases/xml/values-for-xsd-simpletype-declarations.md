...
|-----------------|----------------|  
|`duration`|Значение года должно быть в диапазоне от -2<sup>^</sup>31 до 2<sup>^</sup>31-1. Месяц, день, час, минута и секунда должны задаваться в диапазоне от 0 до 9999. Значение секунд имеет дополнительные три цифры точности справа от десятичной запятой.|  
