...
```  
 ...
 Вы можете явно cast() строка `xml` типа:  
...
```  
 ...
 Предыдущий пример неявно преобразовывает строку `xml` тип данных и присваивает его `xml` переменной типа.  
