...
-   Компоненты-шаблоны элемента. Они представлены **\<xsd:any>** элементом.  
  
-   Компоненты-шаблоны атрибута. Они представлены **\<xsd:anyAttribute>** элементом.  
