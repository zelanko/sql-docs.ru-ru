...
##  <a name="query"></a> Задание обязательных параметров запроса  
 При запросе `xml` столбцов или переменных с помощью типа `xml` методы типа данных, следующие параметры должны быть установлены следующим образом.  
...
|QUOTED_IDENTIFIER|ON|  
 ...
 Если параметры не заданы, как указано, запросы и изменения на `xml` методы типа данных не удастся.  
