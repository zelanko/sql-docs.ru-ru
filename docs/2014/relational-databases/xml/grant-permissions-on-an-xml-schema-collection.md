...
-   Разрешение EXECUTE необходимо для проверки значений, вставленных или обновленных участником, по коллекции схем XML, которая типизирует или ограничивает `xml` столбцов, переменных и параметров типа. Это разрешение требуется также для запросов к XML-данным, хранящимся в этих столбцах и переменных.  
