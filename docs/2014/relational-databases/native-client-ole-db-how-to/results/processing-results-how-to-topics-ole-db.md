---
title: Разделы руководства по обработке результатов (OLE DB) | Документация Майкрософт
ms.custom: ''
ms.date: 06/13/2017
...
-   [Выполнение хранимой процедуры &#40;с помощью синтаксиса вызова ODBC&#41;, а затем обработка кодов возврата и выходных параметров &#40;OLE DB&#41;](execute-stored-procedure-with-odbc-call-and-process-output.md)  
  
-   [Выполнение хранимой процедуры &#40;с помощью синтаксиса RPC&#41;, а затем обработка кодов возврата и параметров вывода &#40;OLE DB&#41;](execute-stored-procedure-with-rpc-and-process-output.md)  
  
-   [Выполнение определяемой пользователем функции и кода возврата &#40;OLE DB&#41;](execute-a-user-defined-function-and-process-return-code-ole-db.md)  
