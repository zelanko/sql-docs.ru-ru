...
### <a name="security"></a>безопасность  
 Для доступа к данным отслеживания изменений с помощью [функций отслеживания изменений](/sql/relational-databases/system-functions/change-tracking-functions-transact-sql)участник должен иметь следующие разрешения.  
