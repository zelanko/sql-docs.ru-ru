...
##  <a name="transactional-replication"></a><a name="TransReplication"></a>Репликация транзакций  
...
##  <a name="restoring-or-attaching-a-database-enabled-for-change-data-capture"></a><a name="RestoreOrAttach"></a>Восстановление или присоединение базы данных, для которой включена система отслеживания измененных данных  
