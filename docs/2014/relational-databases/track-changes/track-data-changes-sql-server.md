...
-   Отслеживание изменений основано на зафиксированных транзакциях. Порядок изменений основан на времени фиксации транзакции. Это позволяет получить надежные результаты при наличии долго выполняемых и перекрывающихся транзакций. Пользовательские решения, использующие `timestamp` значения должны быть специально для обработки таких ситуаций.  
...
##  <a name="Capture"></a> Change Data Capture  
 ...
 ![Блок-схема фиксации изменений данных](../../database-engine/media/cdcart1.gif "Блок-схема фиксации изменений данных")  
 ...
 **Конфигурация и администрирование**  
 Чтобы включить или отключить изменений системы отслеживания измененных данных для базы данных, код, вызывающий [sys.sp_cdc_enable_db &#40;Transact-SQL&#41; ](/sql/relational-databases/system-stored-procedures/sys-sp-cdc-enable-db-transact-sql) или [sys.sp_cdc_disable_db &#40;Transact-SQL&#41; ](/sql/relational-databases/system-stored-procedures/sys-sp-cdc-disable-db-transact-sql)должен быть членом фиксированной серверной `sysadmin` роли. Включение и отключение отслеживания измененных данных на уровне таблиц пользователь, вызывающий процедуры [sys.sp_cdc_enable_table &#40;Transact-SQL&#41; ](/sql/relational-databases/system-stored-procedures/sys-sp-cdc-enable-table-transact-sql) и [sys.sp_cdc_disable_table &#40;Transact-SQL&#41; ](/sql/relational-databases/system-stored-procedures/sys-sp-cdc-disable-table-transact-sql) должен быть членом роли sysadmin или членом базе `database db_owner` роли.  
  
 Использование хранимых процедур для администрирования заданий отслеживания измененных данных ограничено членами серверной `sysadmin` и членами роли `database db_owner` роли.  
...
-   Если база данных присоединяется или восстанавливается с параметром `KEEP_CDC` на любом выпуске, отличном от выпуска Enterprise, то эта операция будет заблокирована, поскольку для системы отслеживания измененных данных требуется выпуск [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Enterprise. Отображается сообщение об ошибке 932.  
 ...
 ![Блок-схема отслеживания изменений данных](../../database-engine/media/cdcart2.gif "Блок-схема отслеживания изменений данных")  
...
## <a name="see-also"></a>См. также  
 [Функции системы отслеживания измененных данных (Transact-SQL)](/sql/relational-databases/system-functions/change-data-capture-functions-transact-sql)   
 [Функции отслеживания изменений (Transact-SQL)](/sql/relational-databases/system-functions/change-tracking-functions-transact-sql)   
