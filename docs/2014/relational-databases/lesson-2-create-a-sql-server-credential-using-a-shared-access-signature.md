---
title: 'Занятие 3: Создание учетных данных SQL Server | Документы Microsoft'
ms.custom: ''
ms.date: 06/13/2017
...
> [!IMPORTANT]  
>  Требования для создания учетных данных SQL Server, описанные ниже относятся к [SQL Server Data Files в Windows Azure](databases/sql-server-data-files-in-microsoft-azure.md) компонентов. Сведения о создании учетных данных для резервного копирования процессов в хранилище Azure см. в разделе [Lesson 2: создание учетных данных SQL Server](../tutorials/lesson-2-create-a-sql-server-credential.md).  
...
4.  Скопируйте и вставьте следующий пример в окно запроса (при необходимости измените). В следующей инструкции создаются учетные данные SQL Server для хранения сертификата общего доступа контейнера хранилища.  
    ...
    ```  
     ...
     Дополнительные сведения см. в разделе [CREATE CREDENTIAL &#40;Transact-SQL&#41; ](/sql/t-sql/statements/create-credential-transact-sql) в электронной документации по SQL Server.  
