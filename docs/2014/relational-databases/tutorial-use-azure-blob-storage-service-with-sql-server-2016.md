---
title: Учебник. SQL Server файлы данных в службе хранилища Azure | Документация Майкрософт
ms.custom: ''
ms.date: 06/13/2017
 ...
 **[Занятие 1. Создание учетной записи хранения Azure и контейнера](../tutorials/lesson-1-create-windows-azure-storage-account-and-container.md)**  
 На этом занятии вы создадите учетную запись хранения Azure и контейнер.  
  
 **[Занятие 2. Создание политики для контейнера и создание ключа &#40;SAS&#41; для подписанного URL-доступа](lesson-1-create-stored-access-policy-and-shared-access-signature.md)**  
 ...
 **[Занятие 5. &#40;Необязательное&#41; шифрование базы данных с помощью TDE](../relational-databases/lesson-4-restore-database-to-virtual-machine-from-url.md)**  
