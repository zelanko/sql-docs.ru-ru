 ...
 **Применить фильтр**  
 Чтобы применить фильтр, нажмите кнопку **применить фильтр** и нажмите кнопку **ОК**. Чтобы сохранить параметры фильтра в **настройки фильтра** диалоговое окно, но без их применения, снимите флажок **применить фильтр**, а затем нажмите кнопку **ОК**, чтобы отобразить все строки.  
