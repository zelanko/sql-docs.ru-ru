 ...
 **Базы данных**  
 Укажите базы данных, для которых должна выполняться эта задача. При выборе раскрывающийся список содержит следующие параметры: **Все базы данных**, **все системные базы данных**, **все пользовательские базы данных**, **определенные базы данных**.  
