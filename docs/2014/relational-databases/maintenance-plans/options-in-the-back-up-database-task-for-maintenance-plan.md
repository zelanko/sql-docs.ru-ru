 ...
 **Создание задачи «резервное копирование базы данных»**  
 ...
 **Резервное копирование баз данных в одном или нескольких файлах**  
 ...
 **Создание подкаталога для каждой базы данных**  
 ...
 **Создать резервную копию заключительного фрагмента журнала и оставить базу данных в состоянии RESTORING**  
 ...
 **Настройка сжатия резервных копий**  
