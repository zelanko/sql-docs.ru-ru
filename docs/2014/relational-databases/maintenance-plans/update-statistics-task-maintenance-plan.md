 ...
 **Примечание** . Планы обслуживания выполняются только для баз данных, для которых установлен уровень совместимости 80 или выше. Базы данных с уровнем совместимости 70 или ниже не отображаются.  
