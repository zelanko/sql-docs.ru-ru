 ...
 **Создание отчета с текстовым файлом**  
 Укажите, нужно [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] ли писать отчет с текстовым файлом.  
 ...
 **Отправить отчет получателю электронной почты**  
 ...
 **Ведение журнала расширенной информации**  
