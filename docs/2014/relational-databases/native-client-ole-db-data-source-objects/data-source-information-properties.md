...
|SSPROP_UNICODELCID|Тип: VT_I4 R/W: Чтение<br /><br /> Описание. Идентификатор языкового стандарта Unicode<br /><br /> Это локаль, используемый для сортировки данных в Юникоде.|  
