...
##  <a name="Top"></a> в этом разделе  
 ...
 [Мастер управления секциями (страница «Выбор действия секции»)](#SelectPartitionAction)  
  
 [Мастер управления секциями (страница переключения)](#SwitchIn)  
  
 [Мастер управления секциями (страница исключается)](#SwitchOut)  
  
 [Мастер управления секциями (страница «Выбор параметров промежуточной таблицы»)](#StagingTableOptions)  
  
 [Мастер управления секциями (страница «Выбор параметров вывода»)](#OutputOption)  
...
##  <a name="SelectPartitionAction"></a>Страница «Выбор действия секции»  
 ...
 **Создать промежуточную таблицу для переключения секций**  
 ...
 **Управление секционированными данными в сценарии со скользящим окном**  
 ...
 ![Значок стрелки, используемый для ссылки "назад на начало](../../2014-toc/media/uparrow16x16.gif "Значок стрелки, используемый со ссылкой "В начало"") " [в этом разделе](#Top)  
...
##  <a name="SwitchOut"></a>Страница "Выбор параметров исходящих переключений секций"  
 ...
 **Таблица исходящих переключений**  
 ...
 **Enabled**  
 Включите или отключите расписание.  
 ...
 **Отчет**  
 Создание отчета, содержащего результаты **мастера управления секциями**. Доступны следующие параметры.  
