...
-   [Профилирование данных производительности драйвера &#40;ODBC&#41;](profiling-odbc-driver-performance-data.md)  
  
-   [Журнал длительно выполняющихся запросов &#40;ODBC&#41;](profiling-odbc-driver-performance-data-log-long-running-queries.md)  
