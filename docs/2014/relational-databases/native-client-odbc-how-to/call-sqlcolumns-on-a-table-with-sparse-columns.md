---
title: Вызов SQLColumns для таблиц с разреженными столбцами | Документы Microsoft
ms.custom: ''
ms.date: 06/13/2017
...
# <a name="call-sqlcolumns-on-a-table-with-sparse-columns"></a>Вызов SQLColumns для таблиц с разреженными столбцами
 ...
 Дополнительные сведения о разреженных столбцах см. в документации по [Sparse Columns Support in SQL Server Native Client](../native-client/features/sparse-columns-support-in-sql-server-native-client.md).  
