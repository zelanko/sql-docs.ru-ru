...
```  
 ...
 Кроме того, необходимо создать виртуальный каталог для базы данных tempdb- и виртуальное имя шаблона из `template` тип с именем «template».  
