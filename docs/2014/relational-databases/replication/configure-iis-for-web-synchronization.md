...
6.  На странице **Сведения виртуального каталога** выполните следующие действия:  
    ...
    2.  Введите путь виртуального каталога в поле **Путь** . `websync1` Например, если ввести в поле **псевдоним** , введите `C:\Inetpub\wwwroot\websync1` в поле **путь** . Щелкните **Далее**.  
