...
6.  На странице **Сведения виртуального каталога** выполните следующие действия:  
    ...
    2.  Введите путь виртуального каталога в поле **Путь** . `websync1` Например, если ввести в поле **псевдоним** , введите `C:\Inetpub\wwwroot\websync1` в поле **путь** . Нажмите кнопку **Далее**.  
...
11. Если службы IIS работают на компьютере под управлением 64-разрядной версии Windows, библиотека replisapi.dll должна быть скопирована в соответствующий каталог.  
    ...
    1.  Нажмите кнопку **Пуск** и выберите команду **Выполнить**. В поле **Открыть** введите `iisreset`, а затем нажмите кнопку **ОК**.  
    ...
    3.  Нажмите кнопку **Пуск** и выберите команду **Выполнить**. В поле **Открыть** введите `cmd`, а затем нажмите кнопку **ОК**.  
...
3.  Зарегистрируйте файл replisapi.dll:  
    ...
    1.  Нажмите кнопку **Пуск** и выберите команду **Выполнить**. В поле **Открыть** введите `cmd`, а затем нажмите кнопку **ОК**.  
...
5.  Свяжите учетную запись с этим пулом приложений:  
    ...
    3.  В диалоговом окне ** \<свойства> аппликатионпулнаме** на вкладке **удостоверение** щелкните **Настраиваемый**.  
...
1.  Убедитесь, что параметры локальной сети на подписчике установлены правильно:  
    ...
    1.  В [!INCLUDE[msCoName](../../includes/msconame-md.md)] Internet Explorer в меню **Сервис** выберите **Свойства обозревателя**.  
