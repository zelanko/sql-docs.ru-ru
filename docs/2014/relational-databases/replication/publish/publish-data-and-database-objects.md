...
-   [Delete an Article](delete-an-article.md) (Удаление статьи)  
...
-   Функции, содержащие указание `NOEXPAND` на индексированных представлениях, невозможно опубликовать в той же публикации, что и ссылочные таблицы и индексированные представления. Это обусловлено порядком их доставки агентом распространения. Чтобы обойти эту проблему, поместите создание таблицы и индексированного представления в первую публикацию, добавьте функции с указанием `NOEXPAND` в на индексированных представлениях во вторую публикацию, которую следует опубликовать после завершения первой публикации. Или, создавать скрипты для этих функций и передать скрипт с помощью *@post_snapshot_script* параметр `sp_addpublication`.  
...
## <a name="see-also"></a>См. также:  
 ...
 [Scripting Replication (Скрипты репликации)](../scripting-replication.md)   
