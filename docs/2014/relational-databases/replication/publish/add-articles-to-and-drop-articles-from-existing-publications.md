...
3.  После создания моментального снимка синхронизируйте подписку, чтобы скопировать схему и данные для новой статьи.  
    ...
    -   Дополнительные сведения о синхронизации принудительной подписки см. в [этой](../synchronize-a-push-subscription.md) статье.  
  
    -   Дополнительные сведения о синхронизации подписки по запросу см. в [этой](../synchronize-a-pull-subscription.md) статье.  
