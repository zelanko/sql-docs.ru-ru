...
|Изменение фильтра столбцов.|**sp_articlecolumn**|**\@столбец**<br /><br /> **\@операция**|Создание моментального снимка.<br /><br /> Повторная инициализация подписок.|  
...
|Удаление фильтра строк.|**sp_articlefilter**|**\@статья**|Создание моментального снимка.<br /><br /> Повторная инициализация подписок.|  
...
|Изменение сопоставление типов данных (применимо только к публикации Oracle).|**sp_changearticlecolumndatatype**|**Тип \@**<br /><br /> **Длина \@**<br /><br /> **точность \@**<br /><br /> **масштабирование \@**|Создание моментального снимка.<br /><br /> Повторная инициализация подписок.|  
...
|Изменение фильтра соединения или логической записи.|**sp_changemergefilter**|**\@, свойство**<br /><br /> **\@value**|Создание моментального снимка.<br /><br /> Повторная инициализация подписок.|  
...
|Включение в состав ранее не опубликованного фильтра столбцов.|**sp_mergearticlecolumn**|**\@столбец**<br /><br /> **\@операция**|Создание моментального снимка.<br /><br /> Повторная инициализация подписок.|  
