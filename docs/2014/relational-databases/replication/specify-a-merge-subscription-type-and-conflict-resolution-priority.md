...
1.  В **свойствах подписки — \<Publisher> \<PublicationDatabase> ** на издателе введите значение (от 0,00 до 99,99) для параметра **приоритет** .  
