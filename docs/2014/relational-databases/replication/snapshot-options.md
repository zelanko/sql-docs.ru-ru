...
1.  На странице **Издатели** диалогового окна **Свойства распространителя — \<>распространителя** нажмите кнопку свойств (**...**) для издателя, для которого нужно изменить расположение моментальных снимков по умолчанию.    
