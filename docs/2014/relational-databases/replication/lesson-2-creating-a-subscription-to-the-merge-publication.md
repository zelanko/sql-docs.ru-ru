...
6.  На странице «Подписчики» выберите имя экземпляра сервера подписчика, а также в разделе **базы данных подписки**выберите  **\<новая база данных >** из списка.  
...
4.  В **Добавление секции данных** диалоговом `adventure-works\pamela0` в **значение HOST_NAME** , а затем щелкните **ОК**.  
