---
title: Свойства публикации репликации серверов сервера S'L - Документы Майкрософт
ms.custom: ''
ms.date: 06/13/2017
...
ms.locfileid: "80380725"
---
# <a name="sql-server-replication-publication-properties"></a>Свойства публикации репликации серверов сервера 
  В этом разделе содержится информация на всех страницах диалогового окна **Publication Properties.** 
 ...
 **Уровень совместимости**  
 [!INCLUDE[msCoName](../../includes/msconame-md.md)][!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)] и только более поздние версии; объединить только публикации. Выберите минимально допустимую версию [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] , необходимую подписчикам для синхронизации с этой публикацией. Существует ряд правил, связанных с определением уровня совместимости.  
...
-   Устанавливать свойства доставки моментального снимка по протоколу FTP. Для получения дополнительной информации смотрите [снимки передачи через](transfer-snapshots-through-ftp.md) документацию FTP Windows для получения дополнительной информации.  
...
-   Выберите **Поместить файлы в папку по умолчанию** , чтобы использовать папку по умолчанию для моментальных снимков издателя. В этом диалоговом окне расположение папки моментальных снимков доступно только для чтения, потому что его можно изменить только для издателя в диалоговом окне **Свойства распространителя** . Для получения дополнительной информации [см.](snapshot-options.md#snapshot-folder-locations)   
...
## <a name="see-also"></a>См. также  
 ...
 [Рекомендации по безопасности репликации](security/replication-security-best-practices.md)   
 [Безопасность репликации серверов сервера S'L](security/view-and-modify-replication-security-settings.md)  
