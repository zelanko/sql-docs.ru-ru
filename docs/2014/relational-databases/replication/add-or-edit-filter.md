...
2.  **Завершите инструкцию Filter, чтобы узнать, какие строки таблицы будут получены подписчиками.**  
