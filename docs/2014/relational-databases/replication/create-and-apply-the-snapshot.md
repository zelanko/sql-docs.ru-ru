...
-   [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)]. [Задайте местоположение моментальных снимков по умолчанию](snapshot-options.md#snapshot-folder-locations)
