...
-   **Создание скрипта SQL**, доступного из контекстного меню папки **репликации** и всех вложенных папок в [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)]. Это диалоговое окно позволяет создавать скрипты для всех объектов репликации на экземпляре [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)].  
  
-   **Создайте скрипт \<SQL ObjectName>**, доступный в контекстном меню для публикаций и подписок. С помощью этого диалогового окна в скрипт можно помещать отдельные объекты.  
 ...
 **Создание или включение компонентов** и **Удаление или отключение компонентов**  
 Указывает, должен ли скрипт включать команды для создания или удаления объектов репликации. 
  [!INCLUDE[msCoName](../../includes/msconame-md.md)] рекомендует использовать это диалоговое окно для создания набора скриптов, осуществляющих включение и отключение компонентов.  
