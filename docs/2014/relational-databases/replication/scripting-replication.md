...
1.  На странице **Действия мастера** установите флажок, соответствующий мастеру.  
    ...
    -   **Создание файла скрипта с шагами по созданию публикации**  
  
    -   **Создать файл скрипта, содержащий шаги по созданию подписок**  
  
    -   **Создание файла скрипта с инструкциями по настройке распространения**  
