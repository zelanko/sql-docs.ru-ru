 ...
 **В этом разделе**  
 ...
 [Как работает репликация моментальных снимков](#HowWorks)  
  
 [агент моментальных снимков](#SnapshotAgent)  
  
 [Агенты распространителя и слияния](#DistAgent)  
  
##  <a name="HowWorks"></a>Как работает репликация моментальных снимков  
...
##  <a name="DistAgent"></a>агент распространения и агент слияния  
