...
## <a name="breaking-changes-made-in-sql-server-2014"></a>Критические изменения, внесенные в SQL Server 2014  
 [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] не поддерживает репликацию данных с клиента или на [!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)] или [!INCLUDE[ssEW](../../includes/ssew-md.md)].  
