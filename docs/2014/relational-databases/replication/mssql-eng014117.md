...
1.  Создайте скрипт конфигурации распространения. Дополнительные сведения см. в статье [Scripting Replication](scripting-replication.md).  
