...
11. Для агента моментальных снимков щелкните **Настройки безопасности**, введите \<_Имя_компьютера>_**\repl_snapshot** в поле **Учетная запись процесса**, укажите пароль для этой учетной записи и нажмите кнопку **ОК**.  
...
## <a name="next-steps"></a>Следующие шаги  
 Публикация транзакций успешно создана. Далее будет создана подписка на эту публикацию. См. в разделе [Урок 2: Создание подписки на публикацию транзакций](lesson-2-creating-a-subscription-to-the-transactional-publication.md).  
