...
-   **Список наблюдения за подписками** . Эта вкладка предназначена для отображения сведений о подписках из всех публикаций, доступных на выбранном издателе, с ошибками, предупреждениями или низкой производительностью. Эта вкладка не отображается для распространителей, использующих [!INCLUDE[msCoName](../../../includes/msconame-md.md)] [!INCLUDE[ssVersion2005](../../../includes/ssversion2005-md.md)]версии, более ранние, чем.  
