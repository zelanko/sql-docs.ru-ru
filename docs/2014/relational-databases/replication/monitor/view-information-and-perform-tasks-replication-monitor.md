...
-   **Предупреждения** (для распространителей [!INCLUDE[ssVersion2005](../../../includes/ssversion2005-md.md)] , выполняющихся и более поздних версий)   
    -   Эта вкладка позволяет задать предупреждения для агентов.  
  
-   **Трассировочные токены** (только для репликации транзакций, для распространителей, выполняющихся [!INCLUDE[ssVersion2005](../../../includes/ssversion2005-md.md)] и более поздних версий)  
