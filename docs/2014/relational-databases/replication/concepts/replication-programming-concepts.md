...
|---------------|-----------------|----------|  
|[Основные понятия объекты Replication Management Objects](replication-management-objects-concepts.md)|Управляемый код|Администрирование, текущее наблюдение и синхронизация.|  
...
|[Основные понятия исполняемых файлов агента репликации](replication-agent-executables-concepts.md)|Написание сценариев|Синхронизация.|  
