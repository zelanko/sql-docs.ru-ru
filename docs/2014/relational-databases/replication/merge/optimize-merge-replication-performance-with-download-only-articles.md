...
## <a name="download-only-articles"></a>статьи только для загрузки  
 ...
 Чтобы указать, что статья предназначена только для загрузки, см. раздел [Указание того, что статья таблицы публикации слиянием предназначена только для загрузки](../publish/specify-that-a-merge-table-article-is-download-only.md).  
