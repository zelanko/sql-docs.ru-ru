...
-   база данных **msdb** и **Главная** база данных на издателе, распространителе и на всех подписчиках  
