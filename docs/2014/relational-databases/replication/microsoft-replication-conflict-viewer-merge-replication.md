 ...
 **Отображать данные о столбце** (**…**)  
 Щелкните, чтобы просмотреть сведения о столбце: **Имя таблицы**, **Имя столбца**, **Тип данных** и **Значение столбца**. **Значение столбца** может быть изменено, если не показано как доступное только для чтения.  
