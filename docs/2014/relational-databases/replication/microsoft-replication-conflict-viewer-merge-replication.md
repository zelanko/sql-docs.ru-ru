 ...
 **Отобразить сведения о столбце** (**...**)  
 Щелкните для просмотра данных о столбце: **Имя таблицы**, **Имя столбца**, **Тип данных**и **Значение столбца**. **Значение столбца** доступно для редактирования, если только значение не отображается как доступное только для чтения.  
  
 **Отправить победитель**  
 ...
 **Записать в журнал сведения о конфликте**  
