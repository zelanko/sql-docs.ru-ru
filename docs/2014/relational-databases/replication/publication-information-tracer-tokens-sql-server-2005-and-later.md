---
title: Сведения о публикации, трассировочные маркеры (публикация транзакций, SQL Server 2005 и более поздние версии) | Документы Microsoft
ms.custom: ''
ms.date: 06/13/2017
