...
### <a name="options-for-all-subscriptions"></a>Параметры для всех подписок  
 **Инициализация опубликованных данных из моментального снимка**  
...
-   **Расположение по умолчанию**: расположение по умолчанию, которое определяется при настройке распространителя. Дополнительные сведения см. [в разделе Указание расположения моментальных снимков по умолчанию](snapshot-options.md#snapshot-folder-locations).    
-   **Альтернативная папка**: альтернативное расположение, которое можно указать в диалоговом окне **Свойства публикации** . Дополнительные сведения см. в разделе [Alternate Snapshot Folder Locations](alternate-snapshot-folder-locations.md).    
-   **Папка динамических моментальных снимков**: расположение моментальных снимков для публикаций слиянием, использующих параметризованные фильтры строк. Дополнительные сведения см. в статье [Snapshots for Merge Publications with Parameterized Filters](snapshots-for-merge-publications-with-parameterized-filters.md).  
-   **FTP-папка**: папка, доступная для сервера протокол FTP (FTP). Дополнительные сведения см. в статье [Передача моментальных снимков через FTP](transfer-snapshots-through-ftp.md).  
 ...
 **Использование диспетчера синхронизации Windows**  
