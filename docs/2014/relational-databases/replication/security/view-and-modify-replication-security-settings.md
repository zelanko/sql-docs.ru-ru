...
2.  Страница « **Безопасность агента** » диалогового окна « **Свойства публикации — \<Publication> ** ». Дополнительные сведения о доступе к этому диалоговому окну см. в разделе [Просмотр и изменение свойств публикации](../publish/view-and-modify-publication-properties.md).  
...
4.  Диалоговое окно **свойства \<Distributor> распространителя —** и **свойства \<Database> базы данных распространителя —** диалоговые окна. Дополнительные сведения о доступе к этим диалоговым окнам см. в разделе [Просмотр и изменение свойств издателя и распространителя](../view-and-modify-distributor-and-publisher-properties.md).  
...
1.  На странице **Безопасность агента** диалогового окна **Свойства публикации — \<Publication> ** нажмите кнопку **Параметры безопасности** рядом с текстовым полем **Агент моментальных снимков** .  
...
3.  Укажите контекст, в условиях которого агент должен подключаться с распространителя к издателю. Если вы выбрали **С использованием следующего имени входа SQL Server**, то вы также должны задать имя входа:  
    ...
    > [!NOTE]  
    >  Если издатель является издателем Oracle, то контекст соединения указывается в диалоговом окне **Свойства распространителя \<Distributor> — **. Процедура изменения контекста приведена ниже.  
...
1.  На странице **Безопасность агента** диалогового окна **Свойства публикации — \<Publication> ** нажмите кнопку **Параметры безопасности** рядом с текстовым полем **Агент чтения журнала** .  
...
3.  Укажите контекст, в условиях которого агент должен подключаться с распространителя к издателю. Если вы выбрали **С использованием следующего имени входа SQL Server**, то вы также должны задать имя входа:  
    ...
    > [!NOTE]  
    >  Если издатель является издателем Oracle, то контекст соединения указывается в диалоговом окне **Свойства распространителя \<Distributor> — **. Измените контекст с использованием следующей процедуры.  
...
1.  В диалоговом окне **свойства \<Subscription> подписки —** на издателе можно внести следующие изменения:  
...
1.  В диалоговом окне **свойства \<Subscription> подписки —** на подписчике можно внести следующие изменения:  
...
1.  На странице **Общие** диалогового окна **Свойства распространителя \<Distributor> —** нажмите кнопку Свойства (**...**) рядом с базой данных распространителя.  
  
2.  В диалоговом окне **Свойства базы \<Database> данных распространителя —** нажмите кнопку **Параметры безопасности** рядом с текстовым полем **учетная запись процесса агента** .  
