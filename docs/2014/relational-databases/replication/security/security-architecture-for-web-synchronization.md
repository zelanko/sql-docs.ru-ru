...
# <a name="security-architecture-for-web-synchronization"></a>Архитектура безопасности для веб-синхронизации
 ...
 ![Компоненты и подключения в веб-синхронизации](../media/websyncarchitecture.gif "Компоненты и подключения в веб-синхронизации")  
