...
|Агент|Имя задания|  
|-----------|--------------|  
|агент моментальных снимков|**\<Издатель>-\<база данных публикации>-\<Publication> —\<Integer>**|  
...
|Агент чтения журнала.|**\<> издателя —\<база данных публикации>-\<Integer>**|  
...
|Агент распространителя для принудительных подписок|**\<\<\<Издатель>-база данных публикации>-публикация> — подписчик>-\<Integer>1 \<** <sup>1</sup>|  
|Агент распространителя для подписок по запросу|**\<\<\<\<Издатель>-база данных публикации>-publication> — подписчик>-субскриптиондатабасе>-\<GUID>2 \<** <sup>2</sup>|  
...
|Агент чтения очереди.|**[\<Распространитель>]. \<целочисленное>**|  
  
 <sup>1</sup> для принудительных подписок на публикации Oracle имя задания — ** \<Publisher>-\<Publisher**> вместо ** \<издателя>-\<база данных публикации>**.  
  
 <sup>2</sup> для подписок по запросу на публикации Oracle имя задания — ** \<Publisher>-\<DistributionDatabase**> вместо ** \<издателя>-\<база данных публикации>**.  
