...
|Агент моментальных снимков для секции публикации слиянием|**Dyn_\<издатель>-\<база данных публикации>-\<publication>-\<GUID>**|  
