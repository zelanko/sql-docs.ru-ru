...
1.  На издателе в базе данных публикации выполните хранимую процедуру [sp_grant_publication_access](/sql/relational-databases/system-stored-procedures/sp-grant-publication-access-transact-sql). В поле ** \@публикация**укажите имя публикации. а для параметра ** \@login**укажите имя входа или добавляемой группы.  
