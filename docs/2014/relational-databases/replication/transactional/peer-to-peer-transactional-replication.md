...
-   Свойство статьи  **\@replicate_ddl** должно иметь значение `true`;  **\@identityrangemanagementoption** должно иметь значение `manual`; и  **\@состояние** требуется соответствующий параметр **24** имеет значение.  
...
## <a name="see-also"></a>См. также  
 ...
 [Publication Types for Transactional Replication](transactional-replication.md) (Типы публикации для репликации транзакций)  
