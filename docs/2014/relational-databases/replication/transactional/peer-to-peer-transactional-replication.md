...
-   Все базы данных, участвующие в одноранговой репликации, должны содержать идентичные схемы и данные.  
    ...
    -   Публикации для реплицирования должны разрешать изменения схемы. (Это значение равно **1** для свойства публикации **replicate_ddl**, которое является значением по умолчанию.) Дополнительные сведения см. [в разделе внесение изменений схемы в базы данных публикации](../publish/make-schema-changes-on-publication-databases.md).  
...
## <a name="see-also"></a>См. также:  
 ...
 [Типы публикаций для репликации транзакций](transactional-replication.md)  
