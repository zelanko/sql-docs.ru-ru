...
-   **sp_MSins_ \<** *tablename* **> **, обрабатывающий операции вставки.  
  
-   **sp_MSupd_ \<** *tablename* **> **, который обрабатывает обновления.  
  
-   **sp_MSdel_ \<** *tablename* **> **, который обрабатывает удаления.  
  
 Объект, **\<***tablename***>** используемый в процедуре, зависит от того, как статья была добавлена в публикацию и содержит ли база данных подписки таблицу с тем же именем с другим владельцем.  
