...
-   **sp_MSdel_\<** *имя_таблицы* **>**, обрабатывающая операции удаления.  
 ...
 Значение ** \< ***tablename*** TableName> ** , используемое в процедуре, зависит от того, как статья была добавлена в публикацию, а также от того, содержит ли база данных подписки таблицу с тем же именем с другим владельцем.  
