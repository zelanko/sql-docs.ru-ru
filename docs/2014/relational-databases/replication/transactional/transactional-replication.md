...
Репликация транзакций поддерживает четыре типа публикации:  
...
|публикация транзакций с обновляемыми подписками;|Ниже приведены характеристики этого типа публикации:<br /><br /> -Каждое расположение содержит идентичные данные, с помощью одного издателя и одного подписчика. <br /> -Это возможность обновления строк на подписчике<br /> -Эта топология лучше всего подходит для серверных сред, требующих высокого уровня доступности и чтения масштабируемости.<br /><br />Дополнительные сведения см. в разделе [обновляемых подписок](../../../relational-databases/replication/transactional/updatable-subscriptions-for-transactional-replication.md).|  
|Peer-to-peer топологии|Ниже приведены характеристики этого типа публикации:<br /> -Каждое расположение содержит идентичные данные и действует как издатель и подписчик.<br /> -Же строка может быть изменена только в одном расположении за раз.<br /> — Поддерживает [обнаружение конфликтов](../../../relational-databases/replication/transactional/peer-to-peer-conflict-detection-in-peer-to-peer-replication.md)  <br />-Эта топология лучше всего подходит для серверных сред, требующих высокого уровня доступности и чтения масштабируемости.<br /><br />Дополнительные сведения см. в разделе [Peer-to-Peer Transactional Replication](../../../relational-databases/replication/transactional/peer-to-peer-transactional-replication.md).|  
|Двунаправленная репликация транзакций|Ниже приведены характеристики этого типа публикации:<br />Двунаправленная репликация аналогичен Peer-to-Peer репликации, однако она предоставляет разрешения конфликтов. Кроме того двунаправленная репликация не более 2 сервера. <br /><br /> Дополнительные сведения см. в разделе [двунаправленная репликация транзакций](../../../relational-databases/replication/transactional/bidirectional-transactional-replication.md) |  
