 ...
 **Разрешать параметризованные фильтры**  
 Устанавливается на основании использования публикацией параметризованных фильтров. Данный параметр всегда доступен только для чтения. Дополнительные сведения см. в статье [Parameterized Row Filters](merge/parameterized-filters-parameterized-row-filters.md).  
