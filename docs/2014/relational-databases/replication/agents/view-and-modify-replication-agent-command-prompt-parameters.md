...
|Агент моментальных снимков для секции публикации слиянием|**Dyn_\<издатель>-\<база данных публикации>-\<publication>-\<GUID>**|[агент моментальных снимков репликации](replication-snapshot-agent.md)|  
...
|Агент слияния для подписок по запросу|**\<Издатель>-\<база данных публикации>-\<Publication> —\<подписчик>-\<субскриптиондатабасе>-\<Integer>**|[агент слияния репликации](replication-merge-agent.md)|  
|Агент слияния для принудительных подписок|**\<Издатель>-\<база данных публикации>-\<публикация> —\<подписчик> —\<целое число>**|[агент слияния репликации](replication-merge-agent.md)|  
|Агент распространителя для принудительных подписок|**\<\<\<Издатель>-база данных публикации>-публикация> — подписчик>-\<Integer>1 \<** <sup></sup>|[агент распространения репликации](replication-distribution-agent.md)|  
|Агент распространителя для подписок по запросу|**\<\<\<\<Издатель>-база данных публикации>-publication> — подписчик>-субскриптиондатабасе>-\<GUID>2 \<** <sup></sup>|[агент распространения репликации](replication-distribution-agent.md)|  
