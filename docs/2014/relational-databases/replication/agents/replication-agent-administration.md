...
|[агент распространения репликации](replication-distribution-agent.md)|distrib.exe|  
...
|[агент слияния репликации](replication-merge-agent.md)|replmerg.exe|  
