...
1.  На странице **Общие** диалогового окна **Свойства распространителя \<Distributor> —** щелкните **Параметры профиля по умолчанию**.  
...
3.  Просмотрите параметры и значения в диалоговом окне ** \<ProfileName> свойства профиля** .  
