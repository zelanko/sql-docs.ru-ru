 ...
 **-DefinitionFile** _def_path_and_file_name_  
 ...
 _Распространитель_ **распространителя**  
 ...
 **-Еррорфиле** _error_path_and_file_name_  
 ...
 **-Фтпусернаме**  _ftp_user_name_  
 Имя пользователя для соединения со службой FTP. Если этот режим не указан, используется **anonymous** .  
 ...
 **-Субскриптионтабленаме** _subscription_table_  
 ...
 **-TransactionsPerHistory** [ **0**| **1**|... **10000**]  
 Указывает интервал транзакций для регистрации журналов. Сообщение записывается в журнал, как только число зафиксированных транзакций после последней записи в журнал превысило значение этого параметра. Количество по умолчанию — 100. 
  **0** означает бесконечное значение **TransactionsPerHistory**. См. предыдущий параметр **-MessageInterval**.  
