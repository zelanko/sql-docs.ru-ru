...
##  <a name="HowToEnumerate"></a> Инструкции: Получение списка таблиц Filetable и связанных объектов  
...
###  <a name="HowToDisable"></a> Инструкции: Отключение и повторное включение нетранзакционного доступа на уровне базы данных  
...
###  <a name="visible"></a> Инструкции: Обеспечение видимости таблиц filetables в базе данных  
...
###  <a name="HowToEnableNS"></a> Инструкции: Отключение и повторное включение пространства имен FileTable на уровне таблицы  
...
###  <a name="HowToListOpen"></a> Инструкции: Получить список дескрипторов открытых файлов, связанных с таблицей FileTable  
...
###  <a name="HowToKill"></a> Инструкции: Уничтожить открытые дескрипторы файлов связанных с таблицей FileTable  
...
###  <a name="HowToIdentifyLocks"></a> Инструкции: Определение блокировок хранящихся в таблицах Filetable  
