...
##  <a name="HowToEnumerate"></a> Инструкции: получить список таблиц FileTable и связанных объектов  
...
###  <a name="HowToDisable"></a> Инструкции: отключить и снова включить нетранзакционный доступ на уровне базы данных  
...
###  <a name="visible"></a> Инструкции: обеспечить видимость таблиц FileTables в базе данных  
...
###  <a name="HowToEnableNS"></a> Инструкции: отключить и снова включить пространство имен FileTable на уровне таблицы  
...
###  <a name="HowToListOpen"></a> Инструкции: получить список открытых дескрипторов файлов, связанных с таблицей FileTable  
...
###  <a name="HowToKill"></a> Инструкции: уничтожить открытые дескрипторы файлов, связанные с таблицей FileTable  
...
###  <a name="HowToIdentifyLocks"></a> Инструкции: определить блокировки, имеющиеся в таблицах FileTable  
