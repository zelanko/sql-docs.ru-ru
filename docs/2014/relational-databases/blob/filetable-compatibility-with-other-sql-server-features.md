...
##  <a name="select-into-and-filetables"></a><a name="OtherSelectInto"></a>Выбор и таблицы FileTable  
...
##  <a name="readable-secondary-databases"></a><a name="readsec"></a>Доступные для чтения базы данных-получатели  
