...
## <a name="see-also"></a>См. также  
 [Сопоставление параметров данных среды CLR](../clr-integration-database-objects-types-net-framework/mapping-clr-parameter-data.md)   
