...
|-----------------------------|-----------------|  
|**Счетчик пользователей 1**|Определяется хранимой процедурой **sp_user_counter1**.|  
|**Счетчик пользователей 2**|Определяется хранимой процедурой **sp_user_counter2**.|  
|**Счетчик пользователей 3**|Определяется хранимой процедурой **sp_user_counter3**.|  
|...||  
|**Счетчик пользователей 10**|Определяется хранимой процедурой **sp_user_counter10**.|  
 ...
 **sp_user_counter** доступен для всех пользователей, но может быть ограничен для любого счетчика запросов.  
