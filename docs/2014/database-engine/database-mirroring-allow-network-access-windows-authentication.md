---
title: Разрешение сетевого доступа к базе данных с использованием проверки подлинности Windows (SQL Server) конечной точки зеркального отображения | Документы Microsoft
ms.custom: ''
ms.date: 06/13/2017
