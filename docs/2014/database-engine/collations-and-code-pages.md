...
-   Усечение данных UTF-16, неподдерживаемых внутри хранимых процедур, скомпилированных в собственном коде. Это означает*n*, что значения n (VAR) char (*n*) не могут быть преобразованы в тип n (VAR) char (*i*), если *i* < параметры сортировки имеют _SC свойство. Например, следующее выражение не поддерживается:  
