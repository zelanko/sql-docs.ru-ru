...
3.  Обновите схему баз данных DQS.  
    ...
    4.  Установщик предложит создать резервную копию базы данных DQS, прежде чем продолжить. Если вы уже резервные копии баз данных DQS, введите `Y` или `Yes`, а затем нажмите клавишу ВВОД, чтобы продолжить обновление.  
