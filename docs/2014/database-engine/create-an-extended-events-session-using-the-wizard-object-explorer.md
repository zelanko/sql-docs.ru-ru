...
##  <a name="BKMK_SetSessionProperties"></a>Задание свойств сеанса  
...
##  <a name="BKMK_SelectEventsToCapture"></a>Выбор событий для захвата  
...
##  <a name="BKMK_CaptureGlobalFields"></a>Захватить глобальные поля  
...
##  <a name="BKMK_SpecifySessionDataOutput"></a>Укажите хранилище данных сеанса  
