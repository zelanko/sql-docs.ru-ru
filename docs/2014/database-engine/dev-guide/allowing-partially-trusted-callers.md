...
### <a name="description"></a>Описание  
 ...
 В инструкциях по построению этого образца предполагается, что файлы с исходным кодом находятся в каталоге c:\samples.  Если используется другой каталог, то необходимо изменить скрипты [!INCLUDE[tsql](../../includes/tsql-md.md)]. [!INCLUDE[tsql](../../includes/tsql-md.md)] Скриптов также необходимы базы данных AdventureWorks. Можно загрузить образец базы данных AdventureWorks из [Microsoft SQL Server Samples and Community Projects](https://go.microsoft.com/fwlink/?LinkID=85384) домашнюю страницу.  
