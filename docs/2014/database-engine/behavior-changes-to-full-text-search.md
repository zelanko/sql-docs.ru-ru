...
-   Интегрированное хранение и управление — компонент Full-text search теперь интегрирован непосредственно с присущие хранения и управления функциями [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)], и служба MSFTESQL больше не существует.  
