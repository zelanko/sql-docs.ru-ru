...
# <a name="view-file-history"></a>Просмотр журнал файла
  Для просмотра журнала версий файлов, управляемых системой управления версиями, можно использовать команду **History** . Этот журнал содержит дату и время добавления или возврата файла в систему управления версиями.  
...
3.  В диалоговом окне **Журнал файла** выполните любое из следующих действий.  
