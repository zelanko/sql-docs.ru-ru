 ...
 **Использовать региональные параметры для вывода значений даты и времени**  
 ...
 **Начать трассировку немедленно после установления соединения**  
 ...
 **Загружать все файлы продолжения по порядку без запроса**  
 ...
 **Интервал ожидания монитора исправности по умолчанию (сек)**  
