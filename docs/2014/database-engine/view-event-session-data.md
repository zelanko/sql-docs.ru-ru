...
### <a name="group-results"></a>Группирование результатов  
 Группировки результатов эквивалентны функциональные возможности `GROUP BY` предложение в [!INCLUDE[tsql](../includes/tsql-md.md)]. В таблице целевых данных данные будут сгруппированы с возможностью разворачивания и сворачивания.  
...
-   в CSV-файл  
 ...
 Можно экспортировать результаты трассировки. XEL файл, таблица, или. CSV-файл, выбрав **экспортировать** из **расширенных событий** пункт меню в [!INCLUDE[ssManStudioFull](../includes/ssmanstudiofull-md.md)].  
