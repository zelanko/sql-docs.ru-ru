...
4.  В поле **Искать в** выберите в раскрывающемся списке расположение, где должен осуществляться поиск указанного текста. Можно использовать следующие параметры для поиска:  
    ...
    -   **Подробные сведения**. Используйте этот параметр для поиска всех столбцов (с повышенным уровнем и не с повышенным уровнем) в окне трассировки, которые были выбраны перед раскрытием **найти в расширенных событиях** диалоговое окно.  
