...
## <a name="overview-of-ss_smartbackup-built-in-debugging"></a>Обзор встроенной отладки [!INCLUDE[ss_smartbackup](../includes/ss-smartbackup-md.md)]  
...
### <a name="configure-monitoring-parameters-for-ss_smartbackup"></a>Настройка параметров наблюдения для [!INCLUDE[ss_smartbackup](../includes/ss-smartbackup-md.md)]  
