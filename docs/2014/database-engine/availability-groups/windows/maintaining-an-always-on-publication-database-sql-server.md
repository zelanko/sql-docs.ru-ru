---
title: Обслуживание базы данных публикации AlwaysOn (SQL Server) | Документы Microsoft
ms.custom: ''
ms.date: 06/13/2017
...
-   Если в базе данных публикации на уровне первоначального издателя удаляется из первичной реплики группы доступности, необходимо выполнить `sp_redirect_publisher` без указания значения для *@redirected_publisher* параметр для удаления перенаправление для пары «издатель-база данных».  
