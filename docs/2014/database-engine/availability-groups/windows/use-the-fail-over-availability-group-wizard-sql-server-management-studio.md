...
11. После принудительной отработки отказа см. подраздел «Дальнейшие действия. После принудительной отработки отказа» в разделе [принудительно другой ресурс вручную для группы доступности &#40;SQL Server&#41;](perform-a-forced-manual-failover-of-an-availability-group-sql-server.md).  
