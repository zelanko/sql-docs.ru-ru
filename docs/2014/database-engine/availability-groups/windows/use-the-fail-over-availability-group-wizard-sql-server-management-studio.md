...
##  <a name="BeforeYouBegin"></a> Перед началом  
 ...
 Перед принудительной отработки отказа впервые, см. в разделе «перед началом работы» и «дальнейшие действия: Основные задачи после принудительной отработки отказа" статьи [Выполнение принудительного перехода на другой ресурс вручную для группы доступности &#40;SQL Server&#41;](perform-a-forced-manual-failover-of-an-availability-group-sql-server.md).  
...
11. После принудительной отработки отказа, см. в разделе «Дальнейшие действия: После принудительной отработки отказа" статьи [Выполнение принудительного перехода на другой ресурс вручную для группы доступности &#40;SQL Server&#41;](perform-a-forced-manual-failover-of-an-availability-group-sql-server.md).  
