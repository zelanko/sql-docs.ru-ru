...
-   **[!INCLUDE[ssAoFoAgWiz](../../../includes/ssaofoagwiz-md.md)]см**  
     ...
     [Страница подтверждения возможной потери данных](#ConfirmPotentialDataLoss) (далее в этом разделе)  
...
###  <a name="Prerequisites"></a>Необходимые условия для использования мастера отработки отказа группы доступности  
 ...
 **Использование мастера отработки отказа группы доступности**  
...
###  <a name="ConfirmPotentialDataLoss"></a>Страница подтверждения возможной потери данных  
