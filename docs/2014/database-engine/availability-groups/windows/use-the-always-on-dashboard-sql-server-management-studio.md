...
##  <a name="AvGroupsView"></a>Сводка по группе доступности  
...
##  <a name="AvGroupDetails"></a>Сведения о группе доступности  
 ...
 **Дополнительный режим подключения**  
 ...
 **Номер последней ошибки соединения.**  
 ...
 **Метка времени последней ошибки соединения**  
...
##  <a name="AvDbDetails"></a>Группировка сведений о группе доступности  
 ...
 **Номер LSN последнего повторного завершения**  
 ...
 **Время последнего повторного завершения**  
