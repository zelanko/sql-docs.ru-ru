...
|[Прослушиватель](#Listener)|Если эта вкладка доступна, ее можно использовать для создания прослушивателя группы доступности. По умолчанию прослушиватель не создается.<br /><br /> Примечание. Эта вкладка доступна только при использовании [!INCLUDE[ssAoNewAgWiz](../../../includes/ssaonewagwiz-md.md)].|  
...
##  <a name="backup-preferences-tab"></a><a name="BackupPreferencesTab"></a>Вкладка настроек резервного копирования  
