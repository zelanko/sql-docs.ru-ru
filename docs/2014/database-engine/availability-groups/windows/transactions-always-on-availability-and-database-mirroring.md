---
title: Межбазовые транзакции не поддерживается для зеркального отображения базы данных или AlwaysOn группы доступности (SQL Server) | Документы Microsoft
ms.custom: ''
ms.date: 03/06/2017
