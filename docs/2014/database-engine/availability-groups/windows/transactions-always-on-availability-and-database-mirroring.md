...
-   Для распределенных транзакций: После отработки отказа новый основной сервер/основная реплика не удается подключиться к координатору распределенных транзакций на предыдущей основной сервер/основная реплика. Поэтому новый основной сервер/основная реплика не сможет получить состояние транзакции.  
