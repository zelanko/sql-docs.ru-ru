...
-   Клиенты для прослушивателя группы доступности должны иметь возможность подключения к Интернету, если они хотят поддерживать подключение к прослушивателю при отработки отказа группы доступности на реплику Azure.  
