...
> [!IMPORTANT]  
>  После добавления реплики, см. в разделе «Дальнейшие действия: После добавления реплики" в статье [Добавление вторичной реплики в группу доступности (SQL Server)](add-a-secondary-replica-to-an-availability-group-sql-server.md).  
