...
4.  На странице **Подключение к существующим вторичным репликам** установите соединение со всеми вторичными репликами в группе доступности. Дополнительные сведения см. в разделе [подключение к странице существующих вторичных реплик &#40;мастер добавления реплики и мастер добавления баз данных&#41;](connect-to-existing-secondary-replicas-page.md).  
...
> [!IMPORTANT]  
>  После добавления реплики обратитесь к разделу "Продолжение: после добавления реплики" в статье [Добавление вторичной реплики к группе доступности (SQL Server)](add-a-secondary-replica-to-an-availability-group-sql-server.md).  
