...
6.  На странице **Выбор начальной синхронизации данных** выберите, как именно необходимо создать новые базы данных-получатели и присоединить их к группе доступности. Выберите один из следующих вариантов:  
...
> [!IMPORTANT]  
>  После добавления реплики обратитесь к разделу "Продолжение: после добавления реплики" в статье [Add a Secondary Replica to an Availability Group &#40;SQL Server&#41;](add-a-secondary-replica-to-an-availability-group-sql-server.md).  
