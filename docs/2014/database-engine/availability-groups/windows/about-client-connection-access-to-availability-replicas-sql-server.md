...
|Первичный|Все (поведение по умолчанию первичной реплики).|С намерением только чтения, чтения-записи или назначение соединения не указано|Успех|  
|Первичный|Чтение и запись|Назначение — только чтение|Failure|  
|Первичный|Чтение и запись|С намерением чтения-записи или назначение соединения не указано|Успех|  
...
|-------------|-----------------|------------------|------------------------------------------|----------------------------------------|  
|Реплика1|Синхронная|Первичный|None|Чтение и запись|  
|Реплика2|Синхронная|Вторичная|Отсутствуют|Чтение и запись|  
