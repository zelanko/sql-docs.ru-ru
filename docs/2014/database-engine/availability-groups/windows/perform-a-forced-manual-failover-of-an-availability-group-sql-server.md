...
1.  Подключитесь к экземпляру сервера, на котором размещена реплика, роль которой находится в состоянии SECONDARY или RESOLVING в группе доступности, которую необходимо выполнить отработку отказа.  
