---
title: Укажите страницу имени группы доступности (группы доступности мастер/базы данных мастер добавления) | Документация Майкрософт
ms.custom: ''
ms.date: 06/13/2017
...
##  <a name="PageOptions"></a> Указание параметров имени группы доступности  
