...
-   **Видео. Введение в AlwaysOn.**  [Серия AlwaysOn в Microsoft SQL Server с рабочим названием "Denali", часть 1. Представляем решение высокого уровня доступности следующего поколения](http://channel9.msdn.com/Events/TechEd/NorthAmerica/2011/DBI302)  
  
-   **Видео. Глубокое погружение в AlwaysOn.**  [Серия AlwaysOn в Microsoft SQL Server с рабочим названием "Denali", часть 2. Построение критически важных решений с высоким уровнем доступности с помощью AlwaysOn](http://channel9.msdn.com/Events/TechEd/NorthAmerica/2011/DBI404)  
...
-   **Блоги**  [Блог команды разработчиков SQL Server AlwaysOn: официальный блог по SQL Server AlwaysOn](http://blogs.msdn.com/b/sqlalwayson/)  
