...
##  <a name="interoperability-and-coexistence-with-other-database-engine-features"></a><a name="Interoperability"></a>Взаимодействие и сосуществование с другими ядро СУБДными функциями  
