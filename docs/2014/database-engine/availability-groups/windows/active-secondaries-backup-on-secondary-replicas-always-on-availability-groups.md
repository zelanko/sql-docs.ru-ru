---
title: 'Активные вторичные реплики: Резервное копирование на вторичных репликах (для групп доступности AlwaysOn) | Документы Microsoft'
ms.custom: ''
ms.date: 06/13/2017
...
-   Резервное копирование базы данных-получателя, должен иметь возможность взаимодействовать с первичной репликой вторичная реплика и должен быть `SYNCHRONIZED` или `SYNCHRONIZING`.  
