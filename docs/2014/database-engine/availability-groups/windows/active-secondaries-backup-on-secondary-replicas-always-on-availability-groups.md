---
title: Активные вторичные реплики. Резервного копирования во вторичных репликах (группы доступности AlwaysOn) | Документация Майкрософт
ms.custom: ''
ms.date: 06/13/2017
