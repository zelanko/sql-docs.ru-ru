...
-   Строки подключения, устанавливающие свойство `MultiSubnetFailover` в значение true.  
     ...
     Сведения о кластеризации с несколькими подсетями см. в разделе [SQL Server Multi-Subnet Clustering &#40;SQL Server&#41;](../../../sql-server/failover-clusters/windows/sql-server-multi-subnet-clustering-sql-server.md).  
