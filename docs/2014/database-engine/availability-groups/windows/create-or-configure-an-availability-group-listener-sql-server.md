...
-   [HYPERLINK "https://support.microsoft.com/kb/307532" Устранение неполадок с учетной записью службы кластеров, если она изменяет объекты компьютеров](https://support.microsoft.com/kb/307532)  
  
-   [HYPERLINK "https://technet.microsoft.com/library/cc904295(WS.10).aspx" квоты Active Directory](https://technet.microsoft.com/library/cc904295\(WS.10\).aspx)  
...
-   При отсутствии разрешения на работу с ресурсами кластера измените время ожидания соединения на 30 секунд (это означает 20 секунд ожидания TCP плюс 10-секундный буфер).  
     ...
     **Специалисты**: В случае отработки отказа по нескольким подсетям обеспечивается быстрое восстановление клиента.  
...
1.  Создайте прослушиватель, используя одно из следующих средств:  
    ...
    -   **Использование диспетчера отказоустойчивого кластера WSFC.**  
        ...
        3.  Добавление зависимости в ресурс группы доступности WSFC.  
         ...
         Сведения о диалоговых окнах и вкладках диспетчера отказоустойчивости кластеров см. в разделе [пользовательский интерфейс: Оснастки Диспетчер кластеров отработки отказа](https://technet.microsoft.com/library/cc772502.aspx).  
...
-   [Блог группы AlwaysOn SQL Server: Официальный блог группы SQL Server AlwaysOn](https://blogs.msdn.com/b/sqlalwayson/)  
