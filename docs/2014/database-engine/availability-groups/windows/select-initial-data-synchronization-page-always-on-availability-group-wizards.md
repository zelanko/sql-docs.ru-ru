...
##  <a name="full"></a><a name="Full"></a>Полный  
...
##  <a name="to-prepare-secondary-databases-manually"></a><a name="PrepareSecondaryDbs"></a>Подготовка баз данных-получателей вручную  
