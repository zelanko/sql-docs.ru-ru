 ...
 **Если предварительные условия не выполняются**  
 ...
 **При соблюдении предварительных требований**  
 ...
 **Укажите общее сетевое расположение, доступное для всех реплик**  
...
##  <a name="PrepareSecondaryDbs"></a>Подготовка баз данных-получателей вручную  
