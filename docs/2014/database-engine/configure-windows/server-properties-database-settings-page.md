 ...
 **Коэффициент заполнения индекса по умолчанию**  
 ...
 **Срок хранения носителей резервных копий по умолчанию (в днях)**  
