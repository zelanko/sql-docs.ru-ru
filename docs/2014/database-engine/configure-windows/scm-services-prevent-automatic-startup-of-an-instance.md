---
title: Отключение автоматического запуска экземпляра SQL Server (диспетчер конфигурации SQL Server) | Документы Microsoft
ms.custom: ''
ms.date: 03/06/2017
...
4.  В **SQL Server \< ***instancename***> свойства** диалогового **свойства** установите значение **режим запуска**для **вручную**.  
