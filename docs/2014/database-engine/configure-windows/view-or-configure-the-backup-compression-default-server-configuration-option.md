...
-   **Дальнейшие действия.**  [После настройки параметра backup compression default](#FollowUp)  
...
##  <a name="FollowUp"></a> Дальнейшие действия: После завершения настройки параметра сжатия резервных копий по умолчанию  
