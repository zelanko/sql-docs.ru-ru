...
ms.locfileid: "62813682"
---
# <a name="affinity-input-output-mask-server-configuration-option"></a>Параметр конфигурации сервера "affinity Input-Output mask"
  Для одновременного выполнения множества задач операционные системы [!INCLUDE[msCoName](../../includes/msconame-md.md)] Windows 2000 и Windows Server 2003 иногда распределяют потоки обработки задач по различным процессорам. Несмотря на эффективность работы с точки зрения операционной системы, это действие может снизить [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] производительность при высоких нагрузках на систему, так как каждый кэш процессора многократно перезагружается данными. В этих условиях назначение определенного потока задач процессору может улучшить производительность, поскольку количество перезагрузок процессора будет снижено; такая связь между определенным потоком задач и процессором называется соответствием процессоров.  
  
 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]поддерживает соответствие процессоров с помощью двух параметров сходства: **маска сходства** (также известная как **маска сходства ЦП**) и **Маска ввода-вывода**. Дополнительные сведения о параметре **affinity mask** см. в разделе [Параметр конфигурации сервера "affinity mask"](affinity-mask-server-configuration-option.md). Поддержка соответствия процессоров и ввода-вывода для серверов с числом ЦП от 33 до 64 требует также использования параметров [Параметр конфигурации сервера "affinity64 mask"](affinity64-mask-server-configuration-option.md) и [Параметр конфигурации сервера "affinity64 I/O mask"](affinity64-input-output-mask-server-configuration-option.md) соответственно.  
...
## <a name="see-also"></a>См. также:  
 [Мониторинг использования ресурсов &#40;системном мониторе&#41;](../../relational-databases/performance-monitor/monitor-resource-usage-system-monitor.md)   
