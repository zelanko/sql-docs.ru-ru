...
## <a name="virtual-backup-device-interface-vdi"></a>Интерфейс виртуальных устройств резервного копирования (VDI)  
 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]предоставляет API, именуемый интерфейсом виртуального устройства резервного копирования (VDI), который позволяет [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] независимым поставщикам программного обеспечения интегрироваться в свои продукты для обеспечения поддержки операций резервного копирования и восстановления. Эти функции API обеспечивают максимальную надежность и производительность, а также поддерживают все функции резервного копирования и восстановления [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] , включая полный набор возможностей оперативного и моментального резервного копирования.  
