...
2.  В поле **Открыть** введите `mmc -a` , чтобы открыть консоль [!INCLUDE[msCoName](../../includes/msconame-md.md)] управления в режиме автора.  
...
12. В меню **файл** выберите команду **Сохранить как**и сохраните файл в нужной папке с соответствующим именем с расширением `.msc` файла. Закройте консоль управления (MMC) [!INCLUDE[msCoName](../../includes/msconame-md.md)] .  
