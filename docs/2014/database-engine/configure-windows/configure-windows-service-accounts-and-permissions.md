...
-   [Службы, установленные SQL Server](#Service_Details)  
...
-   [Разрешения службы](#Serv_Perm)  
    ...
    -   [Разрешение файловой системы, предоставленное другим учетным записям или группам пользователей Windows](#File_System_Other)  
