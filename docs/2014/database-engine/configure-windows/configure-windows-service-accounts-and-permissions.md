...
##  <a name="contents"></a><a name="Top"></a>Содержимое  
...
-   [Провизионирование](#Provisioning)  
    ...
    -   [Провизионирование служб SSAS](#SSAS)  
...
##  <a name="services-installed-by-ssnoversion"></a><a name="Service_Details"></a>Службы, установленные[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]  
...
##  <a name="service-properties-and-configuration"></a><a name="Serv_Prop"></a>Свойства и конфигурация службы  
...
|---------------|------------------------------------|---------------------------------------|  
|[!INCLUDE[ssDE](../../includes/ssde-md.md)]|Отсутствует. Укажите учетную запись [пользователя домена](#Domain_User) .|Укажите учетную запись [пользователя домена](#Domain_User) .|  
|Агент[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]|Отсутствует. Укажите учетную запись [пользователя домена](#Domain_User) .|Укажите учетную запись [пользователя домена](#Domain_User) .|  
|[!INCLUDE[ssAS](../../includes/ssas-md.md)]|Отсутствует. Укажите учетную запись [пользователя домена](#Domain_User) .|Укажите учетную запись [пользователя домена](#Domain_User) .|  
...
-   <a name="VA_Desc"></a> **Virtual Accounts**  
    ...
    |[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]Служба агента на экземпляре [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] с именем **PAYROLL**|**NT SERVICE\SQLAGENT$PAYROLL**|  
...
|**[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]Контроллер распределенное воспроизведение:**|**Вход в систему в качестве службы** (SeServiceLogonRight)|  
|**[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]Распределенное воспроизведение клиент:**|**Вход в систему в качестве службы** (SeServiceLogonRight)|  
...
|User (Пользователь)|Instid\MSSQL\binn|Чтение и выполнение|  
...
###  <a name="file-system-permissions-granted-to-other-windows-user-accounts-or-groups"></a><a name="File_System_Other"></a>Разрешения файловой системы, предоставленные другим учетным записям или группам пользователей Windows  
...
###  <a name="file-system-permissions-related-to-unusual-disk-locations"></a><a name="Unusual_Locations"></a>Разрешения файловой системы, связанные с необычными расположениями дисков  
...
###  <a name="registry-permissions"></a><a name="Registry"></a> Разрешения для реестра  
 Куст реестра создается в разделе **HKLM\Software\Microsoft\Microsoft SQL Server\\ ** _<Instance_ID>_ для компонентов, зависящих от экземпляра. Например:  
...
###  <a name="wmi"></a><a name="WMI"></a>ИНТЕРФЕЙСА  
...
##  <a name="provisioning"></a><a name="Provisioning"></a>Подготовки  
...
###  <a name="database-engine-provisioning"></a><a name="DE_Prov"></a>Подготовка ядро СУБД  
...
####  <a name="sql-server-per-service-sid-login-and-privileges"></a><a name="Logins"></a>Учетные данные и привилегии безопасности SQL Server для каждой службы  
...
####  <a name="sql-server-agent-login-and-privileges"></a><a name="Agent"></a>агент SQL Server имя входа и привилегии  
...
####  <a name="sql-writer-and-privileges"></a><a name="Writer"></a>Модуль записи и привилегии SQL  
...
###  <a name="ssas-provisioning"></a><a name="SSAS"></a>Подготовка SSAS  
...
|--------------|----------------------------|------------------------------|---------------------------|--------------------------|  
|Английский<br /><br /> Китайский, упрощенное письмо<br /><br /> Китайский (традиционный)<br /><br /> Корейский<br /><br /> Японский|NT AUTHORITY\LOCAL SERVICE|NT AUTHORITY\NETWORK SERVICE|NT AUTHORITY\SYSTEM|BUILTIN\Administrators|  
