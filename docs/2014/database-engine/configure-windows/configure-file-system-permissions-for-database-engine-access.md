...
8.  В поле имена **групп или пользователей** выберите идентификатор безопасности службы, а затем в поле **разрешения для** \<name> установите флажок **Разрешить** для **полного доступа**.  
