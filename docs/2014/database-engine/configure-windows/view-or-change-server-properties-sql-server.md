...
####  <a name="Permissions"></a> Permissions  
 ...
 Разрешения на выполнение `sp_configure` без параметров или только с первым параметром предоставляются всем пользователям по умолчанию. Для выполнения `sp_configure` с обоими параметрами для изменения параметра конфигурации или выполнения инструкции RECONFIGURE пользователю должно быть предоставлено разрешение ALTER SETTINGS на уровне сервера. Разрешение ALTER SETTINGS неявным образом предоставлено предопределенным ролям сервера **sysadmin** и **serveradmin** .  
