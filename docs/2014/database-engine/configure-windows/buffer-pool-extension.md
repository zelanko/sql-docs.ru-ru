...
## <a name="benefits-of-the-buffer-pool-extension"></a>Преимущества расширения буферного пула  
 ...
 Типичный подход к устранению этих «узких мест» заключается в добавлении дополнительных модулей DRAM или высокопроизводительных шпинделей SAS. Эти параметры могут быть полезны, однако у них есть существенные недостатки: Модули DRAM дороже, чем диски хранения данных, а шпинделей увеличивает капитальные расходы при покупке приобретения оборудования и эксплуатационные расходы за повышения энергопотребления и вероятности сбоя компонента.  
