...
1.  В **Диспетчер конфигурации SQL Server**разверните узел **SQL Server конфигурация сети**, щелкните правой кнопкой мыши **протоколы для** _\<server instance>_ и выберите пункт**Свойства**.  
