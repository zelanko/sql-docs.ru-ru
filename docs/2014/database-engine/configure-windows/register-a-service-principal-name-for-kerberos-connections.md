...
|--------------|---------------------------|  
|Имя участника-службы сопоставляется с правильной учетной записью домена, виртуальной учетной записью, управляемой учетной записью службы или встроенной учетной записью. Например, «Local System» или «NETWORK SERVICE».<br /><br /> Примечание. Правильный означает, что учетная запись, сопоставленный зарегистрированного имени участника-службы является учетная запись, под которой работает служба SQL Server.|Локальные соединения используют протокол NTLM, удаленные — протокол Kerberos.|  
|Имя участника-службы является правильной учетной записью домена, виртуальной учетной записью, управляемой учетной записью службы или встроенной учетной записью.<br /><br /> Примечание. Правильный означает, что учетная запись, сопоставленный зарегистрированного имени участника-службы является учетная запись, под которой работает служба SQL Server.|Локальные соединения используют протокол NTLM, удаленные — протокол Kerberos.|  
