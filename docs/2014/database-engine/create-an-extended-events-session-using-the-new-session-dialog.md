---
title: Создание сеанса расширенных событий, используя диалоговое окно нового сеанса | Документы Microsoft
ms.custom: ''
ms.date: 06/13/2017
...
4.  Ниже перечислены свойства, которые можно указать в зависимости от выбранного целевого объекта.  
    ...
    |**параметр event_counter**|Нет свойств целевого объекта для счетчика событий.|  
