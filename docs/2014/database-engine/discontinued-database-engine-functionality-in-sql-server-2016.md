...
|Варианты настройки|`sp_configure 'user instance timeout'` и `'user instances enabled'`|Использование функции локальной базы данных. Дополнительные сведения см. в разделе [служебная программа SqlLocalDB](../tools/sqllocaldb-utility.md) .|  
...
|Параметры SET|`SET DISABLE_DEF_CNST_CHK`|Отсутствует.|  
