---
title: Расширения AdventureWorks для демонстрации In-Memory OLTP | Документация Майкрософт
ms.custom: ''
ms.date: 06/13/2017
...
## <a name="overview"></a>Обзор  
 Этот пример демонстрирует новый [!INCLUDE[hek_2](../includes/hek-2-md.md)] компонент, входящий в состав из [!INCLUDE[ssSQL14](../includes/sssql14-md.md)]. Он показывает новых таблиц, оптимизированных для памяти и скомпилирован в собственном коде хранимые процедуры и позволяют продемонстрировать преимущества производительности [!INCLUDE[hek_2](../includes/hek-2-md.md)].  
...
1.  Скачайте архив с полной резервной копией базы данных AdventureWorks2014:  
    ...
    1.  Откройте следующие: [ http://msftdbprodsamples.codeplex.com/downloads/get/880661 ](http://msftdbprodsamples.codeplex.com/downloads/get/880661).  
...
5.  Загрузите образец скрипта "[!INCLUDE[ssSQL14](../includes/sssql14-md.md)] RTM [!INCLUDE[hek_2](../includes/hek-2-md.md)] Sample.sql" из [образца SQL Server 2014 RTM In-Memory OLTP](http://go.microsoft.com/fwlink/?LinkID=396372) в локальную папку.  
...
-   *Параметры сортировки BIN2* — столбцы Name и ProductNumber включены в ключи индекса и поэтому должен иметь параметры сортировки BIN2 [!INCLUDE[ssSQL14](../includes/sssql14-md.md)]. Здесь же предполагается, что приложение не опирается на особенности параметров сортировки, например чувствительность к регистру.  
...
#### <a name="functional-validation-of-the-workload"></a>Функциональная проверка рабочей нагрузки  
 Чтобы проверить, все работает, мы начнем с теста образца, 10 параллельных соединений и 5 итераций со вставкой 10 * 5 \* 20 = 1000 заказов на продажу.  
