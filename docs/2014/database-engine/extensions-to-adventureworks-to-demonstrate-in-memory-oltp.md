...
-   *Параметры сортировки BIN2* . Столбцы Name и ProductNumber включены в ключи индекса, поэтому в [!INCLUDE[ssSQL14](../includes/sssql14-md.md)]они должны иметь параметры сортировки BIN2. Здесь же предполагается, что приложение не опирается на особенности параметров сортировки, например чувствительность к регистру.  
