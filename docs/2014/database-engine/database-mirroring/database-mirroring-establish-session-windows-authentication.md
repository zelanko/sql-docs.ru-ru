---
title: Создание с помощью проверки подлинности Windows (Transact-SQL) сеанса зеркального отображения базы данных | Документы Microsoft
ms.custom: ''
ms.date: 05/24/2017
