...
-   Если выключено слежение за изменениями в полнотекстовом индексе, необходимо запустить полное сканирование индекса при помощи следующей инструкции:  
     ...
     ALTER FULLTEXT INDEX ON *table_name* запустить полное заполнение  
...
## <a name="see-also"></a>См. также:  
 ...
 [DROP ПОЛНОТЕКСТОВЫЙ индекс &#40;&#41;Transact-SQL](/sql/t-sql/statements/drop-fulltext-index-transact-sql)   
