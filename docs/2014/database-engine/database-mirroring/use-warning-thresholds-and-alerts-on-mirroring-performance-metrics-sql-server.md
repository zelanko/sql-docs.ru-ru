---
title: Использование пороговых значений предупреждений и оповещений в метриках производительности (SQL Server) зеркального отображения | Документация Майкрософт
ms.custom: ''
ms.date: 06/13/2017
...
-   События изменения состояния  
 ...
 Дополнительные сведения см. в техническом документе о событиях зеркального отображения базы данных на [веб-сайте SQL Server](http://go.microsoft.com/fwlink/?linkid=62373). В нем содержатся сведения о способах настройки предупреждений с помощью агента [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] , о событиях зеркального отображения базы данных WMI и образцы скриптов.  
