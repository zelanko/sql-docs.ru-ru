---
title: Использование пороговых значений предупреждений и оповещений в метриках производительности (SQL Server) зеркального отображения | Документы Microsoft
ms.custom: ''
ms.date: 06/13/2017
