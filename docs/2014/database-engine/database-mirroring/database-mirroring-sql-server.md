...
> [!IMPORTANT]  
>   Сведения о поддержке зеркального отображения баз данных, ограничениях, предварительных требованиях, рекомендациях для настройки серверов-участников и рекомендациях для развертывания зеркального отображения баз данных см. в разделе [Prerequisites, Restrictions, and Recommendations for Database Mirroring](prerequisites-restrictions-and-recommendations-for-database-mirroring.md).  
...
##  <a name="overview-of-database-mirroring"></a><a name="HowWorks"></a>Общие сведения о зеркальном отображении базы данных  
...
###  <a name="concurrent-sessions"></a><a name="ConcurrentSessions"></a>Одновременные сеансы  
...
##  <a name="interoperability-and-coexistence-with-other-database-engine-features"></a><a name="InterOp"></a>Взаимодействие и сосуществование с другими ядро СУБДными функциями  
