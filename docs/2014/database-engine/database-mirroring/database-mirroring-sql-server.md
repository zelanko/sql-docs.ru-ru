 ...
 *Зеркальное отображение базы данных* — это решение для повышения доступности [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] базы данных. Зеркальное отображение каждой базы данных осуществляется отдельно и работает только с теми базами данных, которые используют модель полного восстановления.  
...
##  <a name="HowWorks"></a>Общие сведения о зеркальном отображении базы данных  
...
####  <a name="TxnSafety"></a>Безопасность транзакций и режимы работы  
...
###  <a name="ConcurrentSessions"></a>Одновременные сеансы  
...
###  <a name="ClientConnections"></a> Клиентские соединения  
 Поддержка клиентских соединений для сеансов зеркального отображения базы данных предоставлена поставщиком данных [!INCLUDE[msCoName](../../includes/msconame-md.md)] .NET для [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]. Дополнительные сведения см. в разделе [Подключение клиентов к сеансу зеркального отображения базы данных (SQL Server)](connect-clients-to-a-database-mirroring-session-sql-server.md).  
  
###  <a name="ImpactOfPausing"></a>Влияние приостановки сеанса на основной журнал транзакций  
 ...
 Дополнительные сведения см. в подразделе [Pausing and Resuming Database Mirroring &#40;SQL Server&#41;](database-mirroring-sql-server.md).  
...
##  <a name="InterOp"></a>Взаимодействие и сосуществование с другими ядро СУБДными функциями  
...
##  <a name="InThisSection"></a> в этом разделе  
 ...
 [Приостановка и возобновление &#40;SQL Server зеркального отображения базы данных&#41;](database-mirroring-sql-server.md)  
 ...
 [Удаление SQL Server &#40;зеркального отображения базы данных&#41;](removing-database-mirroring-sql-server.md)  
...
## <a name="see-also"></a>См. также:  
 ...
 [Зеркальное отображение базы данных: взаимодействие и сосуществование &#40;SQL Server&#41;](database-mirroring-interoperability-and-coexistence-sql-server.md)   
 [Предварительные требования, ограничения и рекомендации по зеркальному отображению базы данных](prerequisites-restrictions-and-recommendations-for-database-mirroring.md)   
