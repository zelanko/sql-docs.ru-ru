...
> [!NOTE]  
>   Сведения о режимах функционирования сеансов зеркального отображения см. в разделе [Database Mirroring Operating Modes](database-mirroring-operating-modes.md).  
...
##  <a name="manual-failover"></a><a name="ManualFailover"></a>Отработка отказа вручную  
...
###  <a name="maintaining-availability-during-upgrades"></a><a name="AvailabilityDuringUpgrades"></a>Поддержание доступности во время обновлений  
...
###  <a name="how-manual-failover-works"></a><a name="HowManualFoWorks"></a>Как работает отработка отказа вручную  
...
###  <a name="conditions-required-for-an-automatic-failover"></a><a name="ConditionsForAutoFo"></a>Условия, необходимые для автоматического перехода на другой ресурс  
...
###  <a name="to-disable-automatic-failover-sql-server-management-studio"></a><a name="DisableAutoSSMS"></a>Отключение автоматического перехода на другой ресурс (SQL Server Management Studio)  
...
##  <a name="forced-service-with-possible-data-loss"></a><a name="ForcedService"></a>Принудительное обслуживание (с возможной потерей данных)  
...
###  <a name="typical-case-of-forced-service"></a><a name="TypicalCaseFS"></a>Типичный случай принудительного обслуживания  
...
###  <a name="risks-of-forcing-service"></a><a name="FSrisks"></a>Риски принудительного обслуживания  
