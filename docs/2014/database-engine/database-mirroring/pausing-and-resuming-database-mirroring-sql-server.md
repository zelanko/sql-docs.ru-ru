...
##  <a name="how-pausing-and-resuming-affect-log-truncation"></a><a name="EffectOnLogTrunc"></a>Как приостановка и возобновление влияют на усечение журнала  
...
##  <a name="avoid-a-full-transaction-log"></a><a name="AvoidFullLog"></a>Как избежать переполнения журнала транзакций  
