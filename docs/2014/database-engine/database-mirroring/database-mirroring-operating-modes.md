...
##  <a name="VisualElement"></a>Асинхронное зеркальное отображение базы данных (режим высокой производительности)  
...
###  <a name="WhenUseHighPerf"></a>Когда подходит режим высокой производительности?  
...
###  <a name="WitnessImpactOnHighPerf"></a>Влияние следящего сервера на режим высокой производительности  
...
###  <a name="WhenPrincipalFails"></a>Реагирование на сбой участника  
...
###  <a name="HighSafetyWithOutAutoFailover"></a>Режим высокой безопасности без автоматической отработки отказа  
...
##  <a name="TsqlSettingsAndOpModes"></a>Параметры Transact-SQL и режимы работы зеркального отображения базы данных  
...
|Режим высокой безопасности без автоматической отработки отказа|FULL|NULL (нет следящего сервера)|  
...
###  <a name="ViewWitness"></a>Просмотр параметров безопасности и состояния следящего сервера  
...
|Коэффициент|Столбцы|Description|  
|------------|-------------|-----------------|  
...
###  <a name="FactorsOnLossOfPrincipal"></a>Факторы, влияющие на поведение при утрате основного сервера  
