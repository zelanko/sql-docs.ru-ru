...
|----------|------------|-----------------|  
|Значок предупреждения|**Неизвестно**|Монитор не подключен ни к одному участнику. Единственными доступными данными являются данные, кэшированные монитором.|  
...
|Значок ошибки|**Отключено**|Экземпляр сервера не может подключиться к участнику.|  
