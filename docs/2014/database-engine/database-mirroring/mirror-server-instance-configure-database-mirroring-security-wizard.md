 ...
 **Экземпляр зеркального сервера**  
 Если экземпляр зеркального сервера уже задан (на странице **Зеркальное отображение** диалогового окна **Свойства базы данных** ), то он отображается. Дополнительные сведения см. в разделе [Свойства базы данных &#40;Зеркальное отображение Page&#41;](../../relational-databases/databases/database-properties-mirroring-page.md).  
