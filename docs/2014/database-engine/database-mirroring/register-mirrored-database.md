...
|-----------------|-----------------|  
|**Зарегистрировать**|Проверка каждой базы данных, которую требуется зарегистрировать. Если база данных в настоящий момент настраивается, соответствующий ей флажок установлен и отключен.<br /><br /> Примечание. Чтобы отменить регистрацию базы данных, закройте **Зарегистрированная зеркальная база данных** диалоговое окно, выберите базу данных в дереве навигации и выберите **Unregister** из **действие** меню.|  
