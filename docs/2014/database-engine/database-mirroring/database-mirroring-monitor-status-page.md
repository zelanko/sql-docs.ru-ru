 ...
 **Журнал основной базы (** * \<время>* **)**  
 Состояние журнала на экземпляре основного сервера по местному времени на экземпляре сервера, обозначенное по * \<времени>*. Отображаются следующие параметры.  
 ...
 **Журнал зеркальных данных (** * \<>времени* **)**  
 Состояние журнала на экземпляре зеркального сервера по местному времени на экземпляре сервера, обозначенное по * \<времени>*. Отображаются следующие параметры.  
