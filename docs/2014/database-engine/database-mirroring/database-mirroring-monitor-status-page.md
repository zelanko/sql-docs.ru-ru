 ...
 **Журнал основной базы (** *\<time>* **)**  
 Состояние журнала на экземпляре основного сервера по местному времени на экземпляре сервера, обозначенное *\<time>* . Отображаются следующие параметры.  
 ...
 **Журнал зеркальных отображений (** *\<time>* **)**  
 Состояние журнала на экземпляре зеркального сервера по местному времени на экземпляре сервера, обозначенное *\<time>* . Отображаются следующие параметры.  
