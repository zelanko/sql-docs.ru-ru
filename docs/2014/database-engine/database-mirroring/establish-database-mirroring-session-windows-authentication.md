---
title: Создание с помощью проверки подлинности Windows (среда SQL Server Management Studio) сеанса зеркального отображения базы данных | Документы Microsoft
ms.custom: ''
ms.date: 06/13/2017
