...
|Термин|Определение|  
|----------|----------------|  
|**Название**|Отображает имя модели интеллектуального анализа данных.|  
|**УДОСТОВЕРЕНИЯ**|Отображает идентификатор модели интеллектуального анализа данных.|  
|**Описание**|Отображает описание модели интеллектуального анализа данных.|  
|**Создать отметку времени**|Отображает дату и время создания модели интеллектуального анализа данных.|  
