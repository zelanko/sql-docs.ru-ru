---
title: Приступая к работе с интеллектуального анализа данных (надстройки интеллектуального анализа для Excel данных) | Документы Microsoft
ms.custom: ''
ms.date: 03/06/2017
...
-   Линейная регрессия  
 ...
 Кроме того, надстройки помогают на фазе подготовки данных: Выбор данных, исследование и очистка данных.  
