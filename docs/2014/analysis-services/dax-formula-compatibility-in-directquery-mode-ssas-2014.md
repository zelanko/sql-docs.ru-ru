...
Сведения о правилах, регламентирующих преобразование из строки в **datetime** типы данных в [!INCLUDE[ssGemini](../includes/ssgemini-md.md)] моделей, см. в статье [Справочник по синтаксису DAX] (/ / dax —-Справочник по синтаксису dax
...
Дополнительные сведения о **пустой** тип данных в DAX, см. в статье [Справочник по синтаксису DAX] (/ / dax —-Справочник по синтаксису dax
