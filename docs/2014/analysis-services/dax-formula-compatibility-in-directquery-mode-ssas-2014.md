...
В этом разделе мы будем использовать термин *модели в памяти* для обращения к табличным моделям, который полностью размещаются кэшированные данные в памяти на сервере служб Analysis Services, работающем в табличном режиме. Мы используем *моделей DirectQuery* для обращения к табличным моделям, которые были созданы или развернутой в режиме DirectQuery. Сведения о режиме DirectQuery см. в разделе [режим DirectQuery (табличные службы SSAS)](http://msdn.microsoft.com/45ad2965-05ec-4fb1-a164-d8060b562ea5).  
...
[Хранение строк и параметры сортировки в табличных моделях](http://msdn.microsoft.com/8516f0ad-32ee-4688-a304-e705143642ca)  
...
[Режим DirectQuery (табличные службы SSAS)](http://msdn.microsoft.com/45ad2965-05ec-4fb1-a164-d8060b562ea5)  
