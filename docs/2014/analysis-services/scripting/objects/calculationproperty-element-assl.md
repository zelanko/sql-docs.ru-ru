...
ms.locfileid: "36188109"
---
# <a name="calculationproperty-element-assl"></a>Элемент CalculationProperty (ASSL)
  Содержит коллекцию свойств пользовательского интерфейса для вычисления, используемого в [MdxScript](mdxscript-element-assl.md) элемента.  
