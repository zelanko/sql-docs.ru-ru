...
ms.locfileid: "36095304"
---
# <a name="perspectivemeasure-data-type-assl"></a>Тип данных PerspectiveMeasure (ASSL)
  Определяет тип-примитив, представляющий сведения о мере в [PerspectiveMeasureGroup](perspectivemeasuregroup-data-type-assl.md) элемента.  
...
|Производные элементы|[Меры](../objects/measure-element-assl.md) ([меры](../collections/measures-element-assl.md) коллекцию [PerspectiveMeasureGroup](perspectivemeasuregroup-data-type-assl.md))|  
