...
ms.locfileid: "36100294"
---
# <a name="miningmodelcolumn-data-type-assl"></a>Тип данных MiningModelColumn (ASSL)
  Определяет тип-примитив, представляющий сведения о столбце в [MiningModel](../objects/miningmodel-element-assl.md) элемента.  
...
|Производные элементы|[Столбец](../objects/column-element-assl.md) ([столбцы](../collections/columns-element-assl.md), коллекция [MiningModel](../objects/miningmodel-element-assl.md))|  
