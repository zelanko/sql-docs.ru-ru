...
|Производные элементы|В разделе [измерения](../objects/dimension-element-assl.md) ([измерения](../collections/dimensions-element-assl.md) коллекцию [MeasureGroup](../objects/group-element-assl.md))|  
