---
title: Службы Analysis Services сценариев иерархия элементов XML языка (ASSL) | Документация Майкрософт
ms.custom: ''
ms.date: 06/13/2017
...
## <a name="see-also"></a>См. также  
 [Элементы XML языка сценариев служб аналитики &#40;ASSL&#41;](analysis-services-scripting-language-xml-elements-assl.md)   
 [Иерархия типов данных XML языка сценариев служб Analysis Services &#40;ASSL&#41;](analysis-services-scripting-language-xml-data-type-hierarchy-assl.md)   
