...
ms.locfileid: "36097349"
---
# <a name="granularityattributeid-element-assl"></a>Элемент GranularityAttributeID (ASSL)
  Содержит идентификатор (ID) атрибута, связанного с родительским объектом [MeasureGroupAttributeBinding](../data-type/measuregroupattributebinding-data-type-out-of-line-assl.md) тип данных.  
