...
|--------------------|-----------------|  
|Тип данных и длина|Ниже таблицы типов данных см.|  
...
|[ProactiveCaching](../objects/proactivecaching-element-assl.md)|Любой тип данных, производный от [ProactiveCachingBinding](../data-type/proactivecachingbinding-data-type-assl.md), в зависимости от параметров обработки и уведомления, используемые родительским для `ProactiveCaching` элемента.|  
