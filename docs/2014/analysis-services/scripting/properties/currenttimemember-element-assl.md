...
ms.locfileid: "36190843"
---
# <a name="currenttimemember-element-assl"></a>Элемент CurrentTimeMember (ASSL)
  Определяет текущий элемент измерения времени, связанного с [ключевого показателя эффективности](../objects/kpi-element-assl.md) элемента.  
