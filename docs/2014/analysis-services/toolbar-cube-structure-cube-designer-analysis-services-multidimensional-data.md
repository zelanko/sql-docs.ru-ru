...
|**Zoom**|Нажмите, чтобы пролистать список возможных значений масштаба или выбрать одно из доступных значений для панели **Представление источника данных** .|  
