...
# <a name="query-pane-mining-model-prediction-view"></a>Панель запросов (представление прогноза модели интеллектуального анализа данных)
 ...
 Дополнительные **сведения:** [расширения интеллектуального анализа данных &#40;DMX&#41; инструкции по обработке данных](/sql/dmx/dmx-statements-data-manipulation), [создание DMX-запроса в SQL Server Management Studio](data-mining/create-a-dmx-query-in-sql-server-management-studio.md)  
