 ...
 **Дополнительные сведения:** [алгоритм нейронной сети (Майкрософт](data-mining/microsoft-neural-network-algorithm.md)), [алгоритм логистической регрессии](data-mining/microsoft-logistic-regression-algorithm.md)(Майкрософт),[Просмотр модели с помощью средства просмотра нейронных сетей (Майкрософт](data-mining/browse-a-model-using-the-microsoft-neural-network-viewer.md) )  
...
|-----------|-----------------|  
|**attribute**|Выберите входной атрибут из списка. Если оставить выделенный фрагмент в качестве значения по умолчанию ** \<>**, то на диаграмме будет отображен список всех входных атрибутов, упорядоченных по их влиянию на прогнозируемый атрибут.|  
