...
|**Удаление**|Нажмите, чтобы отобразить диалоговое окно **Удаление объектов** и удалить выбранное действие.<br /><br /> Примечание. Данный параметр доступен, только если выбрана панель **Организатор действий** .|  
