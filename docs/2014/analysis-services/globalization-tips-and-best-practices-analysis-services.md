...
-   [Общие рекомендации по параметрам сортировки](#bkmk_recos)  
  
-   [Чувствительность к регистру идентификаторов объектов](#bkmk_objid)  
  
-   [Тестирование языкового стандарта с помощью Excel и SQL Server Profiler](#bkmk_test)  
  
-   [Написание запросов многомерных выражений в решении, содержащем переводы](#bkmk_mdx)  
  
-   [Написание запросов многомерных выражений, содержащих значения даты и времени](#bkmk_datetime)  
  
##  <a name="use-similar-collations-throughout-the-stack"></a><a name="bkmk_sameColl"></a>Использовать аналогичные параметры сортировки во всем стеке  
...
##  <a name="common-collation-recommendations"></a><a name="bkmk_recos"></a> Общие рекомендации для параметров сортировки  
...
##  <a name="case-sensitivity-of-object-identifiers"></a><a name="bkmk_objid"></a> Чувствительность к регистру идентификаторов объекта  
...
##  <a name="locale-testing-using-excel-sql-server-profiler-and-sql-server-management-studio"></a><a name="bkmk_test"></a> Тестирования языков с помощью Excel, SQL Server Profiler и SQL Server Management Studio  
...
-   Открыть Excel | **Data** | **Существующие соединения**с данными. Отфильтруйте список, чтобы показать только файлы подключений на этом компьютере. Найдите подключение для Adventure Works (внимательно посмотрите на имя, их может быть несколько). открывает подключение;  
  
     Вы увидите переводы на французский из образца базы данных Adventure Works.  
  
     ![Сводная таблица Excel с переводами на французский](media/ssas-localetest-excel.png "Сводная таблица Excel с переводами на французский")  
...
-   В обозревателе объектов |  | **Analysis Services**Analysis Services | **Параметры** **подключения,** перейдите на вкладку **Дополнительные параметры соединения** .  
...
##  <a name="writing-mdx-queries-in-a-solution-containing-translations"></a><a name="bkmk_mdx"></a> Написание MDX-запросов в решении, содержащем переводы  
...
##  <a name="writing-mdx-queries-containing-date-and-time-values"></a><a name="bkmk_datetime"></a> Написание MDX-запросов, содержащих значения даты и времени  
