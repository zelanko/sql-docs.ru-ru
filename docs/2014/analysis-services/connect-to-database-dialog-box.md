---
title: Подключение к базе данных-диалоговое окно | Документация Майкрософт
ms.custom: ''
ms.date: 06/13/2017
...
|Термин|Определение|  
|----------|----------------|  
|**Подключение к существующей базе данных**|Выберите этот параметр для подключения к существующей базе данных. В списке существующих баз данных щелкните ту, к которой необходимо подключиться.|  
|**Создание новой базы данных**|Выберите этот параметр для создания базы данных.|  
