---
title: Набор строк MDSCHEMA_PROPERTIES | Документация Майкрософт
ms.custom: ''
ms.date: 03/06/2017
...
|`PROPERTY_ORIGIN`|`DBTYPE_UI2`||Определяет тип иерархии, к которой применяется свойство.<br /><br /> -   `MD_USER_DEFINED` (`1`) указывает свойство в пользовательской иерархии<br />-   `MD_SYSTEM_ENABLED` (`2`) указывает свойство в иерархии атрибутов<br />-   `MD_SYSTEM_DISABLED` (`4`) указывает свойство в иерархии атрибутов, которая не включена.|  
...
|`PROPERTY_VISIBILITY`|`DBTYPE_UI2`|Битовая карта с одним из следующих допустимых значений (необязательно).<br /><br /> -1 Visible<br />-2 не отображается<br /><br /> Значение по умолчанию для ограничения — 1.|  
