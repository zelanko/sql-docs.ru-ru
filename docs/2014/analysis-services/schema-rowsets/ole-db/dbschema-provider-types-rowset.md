---
title: Набор строк DBSCHEMA_PROVIDER_TYPES | Документация Майкрософт
ms.custom: ''
ms.date: 03/06/2017
...
## <a name="rowset-columns"></a>Столбцы наборов строк  
 `DBSCHEMA_PROVIDER_TYPES` Набор строк содержит следующие столбцы.  
  
|Имя столбца|Индикатор типа|Длина|Описание|  
|-----------------|--------------------|------------|-----------------|  
|`TYPE_NAME`|`DBTYPE_WSTR`||Имя типа данных, связанного с поставщиком.|  
|`DATA_TYPE`|`DBTYPE_UI2`||Индикатор типа данных.|  
...
|`SEARCHABLE`|`DBTYPE_UI4`||Целое число, указывающее способ использования типа данных при поиске, если поставщик поддерживает `ICommandText`; в противном случае — значение `NULL`.<br /><br /> Этот столбец может иметь следующие значения.<br /><br /> -   `DB_UNSEARCHABLE` Указывает, что тип данных не может использоваться в `WHERE` предложение.<br />-   `DB_LIKE_ONLY` Указывает, что тип данных может быть использован в `WHERE` предложение только с `LIKE` предиката.<br />-   `DB_ALL_EXCEPT_LIKE` Указывает, что тип данных может быть использован в `WHERE` предложение со всеми операторами сравнения, за исключением `LIKE`.<br />-   `DB_SEARCHABLE` Указывает, что тип данных может быть использован в `WHERE` предложение с любым оператором сравнения.|  
