---
title: Устранение неполадок с диаграммами интеллектуального анализа данных Visio (SQL Server Data Mining Add-ins) | Документация Майкрософт
ms.custom: ''
ms.date: 03/06/2017
...
## <a name="common-issues"></a>Распространенные проблемы  
 Не удается подключиться к модели  
  ...
  Не удается просмотреть подробные сведения  
