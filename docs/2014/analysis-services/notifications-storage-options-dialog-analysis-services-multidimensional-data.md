...
|**SQL Server**|Использует специализированный механизм [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] трассировки для обнаружения изменений в базовых таблицах для объекта.|  
