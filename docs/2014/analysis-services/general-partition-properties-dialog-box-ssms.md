---
title: Общие (диалоговое окно «Свойства секции») (среда SSMS) | Документы Microsoft
ms.custom: ''
ms.date: 06/13/2017
...
|**Последней обработки**|Отображает дату и время последней обработки секции.|  
...
|**Режим обработки**|Выберите режим обработки для секции. Дополнительные сведения о режимах обработки для [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] объектов, в разделе [многомерной модели обработки объекта](multidimensional-models/processing-a-multidimensional-model-analysis-services.md).|  
