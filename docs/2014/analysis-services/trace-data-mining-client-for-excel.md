---
title: Трассировка (клиент интеллектуального анализа данных для Excel) | Документы Microsoft
ms.custom: ''
ms.date: 03/06/2017
 ...
 **Трассировочные** диалоговое окно служит для наблюдения за инструкциями, которые отправляются на экземпляр [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] , который используется для интеллектуального анализа данных. После создания подключения к экземпляру компонента [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)], в регистрируются все взаимодействия между клиентом и сервером **трассировочные** области, в том числе инструкции создания структур, добавления моделей интеллектуального анализа данных и убедитесь, прогнозы, а также некоторые сообщения, возвращаемые с сервера.  
