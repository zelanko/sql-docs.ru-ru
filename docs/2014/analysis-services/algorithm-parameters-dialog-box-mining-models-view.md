...
|**Range**|Выведите список диапазонов возможных значений, которые можно ввести в столбец **Значение** . Диапазон может быть одним из следующих:<br /><br /> Дискретный список, например 1, 2, 3<br /><br /> Включающий диапазон, например [0, 100]<br /><br /> Эксклюзивный диапазон, например (0,...)<br /><br /> Сочетание, например [0,...)|  
