---
title: Общие сведения о модели табличного объекта | Документы Microsoft
ms.custom: ''
ms.date: 06/13/2017
...
ms.locfileid: "36098498"
---
# <a name="understanding-the-tabular-object-model"></a>Основные сведения о табличной объектной модели
  Табличная модель — это логическое представление таблиц, связей, иерархий, перспектив, мер и ключевых показателей эффективности. В этом разделе представлены сведения о внутренней реализации с помощью объектов AMO. В разделе [разработку с помощью объектов AMO &#40;AMO&#41; ](../../multidimensional-models/analysis-management-objects/developing-with-analysis-management-objects-amo.md) Если вы не использовали объекты AMO, прежде чем.  
...
## <a name="database-representation"></a>Представление базы данных  
 ...
 В разделе [представление базы данных&#40;табличный&#41; ](database-representation-tabular.md) подробные пояснения о том, как создать и управлять ею представление базы данных.  
...
## <a name="connection-representation"></a>Представление соединения  
 ...
 В разделе [представление соединения &#40;табличный&#41; ](connection-representation-tabular.md) подробные пояснения о том, как создать и управлять представлением источника данных.  
...
## <a name="table-representation"></a>Представление таблицы  
 ...
 В разделе [представление таблиц &#40;табличный&#41; ](tables-representation-tabular.md) подробные пояснения о том, как создать и управлять ею представления таблицы.  
...
### <a name="calculated-column-representation"></a>Представление вычисляемого столбца  
 ...
 В разделе [представление вычисляемого столбца &#40;табличный&#41; ](tables-calculated-column-representation.md) подробные пояснения о том, как создать и управлять ею представление вычисляемого столбца.  
...
>  Объекты <xref:Microsoft.AnalysisServices.Measure> не имеют связи с вычисляемыми мерами из табличных моделей и не поддерживаются в них.  
 ...
 В разделе [представление вычисляемой меры &#40;табличный&#41; ](tables-calculated-measure-representation.md) подробные пояснения о том, как создать и управлять ею представление вычисляемой меры.  
...
### <a name="hierarchy-representation"></a>Представление иерархии  
 ...
 В разделе [представление иерархии &#40;табличный&#41; ](tables-hierarchy-representation.md) подробные пояснения о том, как создать и управлять ею представление иерархии.  
...
>  Важным отличием также является отсутствие связи объектов <xref:Microsoft.AnalysisServices.Kpi> с KPI в табличных моделях. Кроме того, они не поддерживаются в табличных моделях.  
 ...
 В разделе [представление показателя производительности ключ &#40;табличный&#41; ](tables-key-performance-indicator-representation.md) подробные пояснения о том, как создать и управлять ею представление ключевого показателя Эффективности.  
...
### <a name="partition-representation"></a>Представление секции  
 ...
 В разделе [представление секции &#40;табличный&#41; ](tables-partition-representation.md) подробные пояснения о том, как создать и управлять ею представление секции.  
...
## <a name="relationship-representation"></a>Представление связи  
 ...
 В разделе [представление связи &#40;табличный&#41; ](relationship-representation-tabular.md) подробные пояснения о том, как создать и управлять ею представление связи.  
...
## <a name="perspective-representation"></a>Представление перспективы  
 ...
 В разделе [представление перспективы &#40;табличный&#41; ](perspective-representation-tabular.md) подробные пояснения о том, как создать и управлять ею представление перспективы.  
