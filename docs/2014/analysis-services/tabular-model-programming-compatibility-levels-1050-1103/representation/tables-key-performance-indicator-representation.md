---
title: Ключ представление показателя эффективности (табличное) | Документация Майкрософт
ms.custom: ''
ms.date: 04/27/2017
