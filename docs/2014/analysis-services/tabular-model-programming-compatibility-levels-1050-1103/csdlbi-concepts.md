 ...
 **Размеры:** Измерение в CSDLBI представляется в виде сущности (таблицы) со столбцами и свойствами. Обратите внимание, что измерение, даже не входящее в перспективу, но включенное в модель, будет представлено в выходе языка CSDL, отмеченное как `Hidden`.  
 ...
 **Члены:** Добавлена поддержка элемента по умолчанию, а значения по умолчанию автоматически добавляются к выходу CSDLBI.  
