...
>  Вид этой страницы меняется в зависимости от того, что было выбрано на странице мастера **Выбор метода определения** : **На основе существующей реляционной базы данных или хранилища данных** или **На основе существующего куба** .  
 ...
 Дополнительные **сведения:** [Мастер интеллектуального анализа данных &#40;Analysis Services-&#41;интеллектуального ](data-mining/data-mining-wizard-analysis-services-data-mining.md)анализа данных, [Конструктор интеллектуального анализа данных](data-mining/data-mining-designer.md), [Создание реляционной структуры интеллектуального анализа](data-mining/create-a-relational-mining-structure.md)  
