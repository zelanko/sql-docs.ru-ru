...
4.  На вкладке **метаданные** панели **средства вычисления** разверните узел **продукт**, разверните **категорию**, разверните `Members`, а затем разверните **все продукты**.  
...
1.  Щелкните правой кнопкой мыши `[Core Products]` на панели **Организатор скриптов** и выберите пункт **создать именованный набор**.  
...
9. В окно свойств измените свойство `DiscretizationMethod` на **автоматически**, а затем измените свойство `DiscretizationBucketCount` на `5`. Дополнительные сведения см. в разделе [Группирование элементов атрибутов (дискретизация)](multidimensional-models/attribute-properties-group-attribute-members.md).  
...
12. На вкладке **метаданные** панели **средства вычисления** разверните узел **число сотрудников** в измерении **Торговый посредник** , разверните `Members`, а затем разверните **все торговые посредники**.  
     ...
     Элементы этой иерархии атрибута группируются, так как свойство DiscretizationBucketCount имеет значение `5` а свойство DiscretizationMethod имеет значение **Automatic**.  
...
6.  На панели **Метаданные** в измерении **Товар** перетащите **Основные товары** в область фильтра.  
     ...
     ![Члены именованного набора "базовый продукт"](../../2014/tutorials/media/l6-named-set-04.gif "Члены именованного набора "базовый продукт"")  
...
7.  На панели **Метаданные** разверните узел **Торговый посредник**, добавьте элемент **Крупные торговые посредники** в область фильтра.  
     ...
     ![Панель фильтра, содержащая два именованных набора](../../2014/tutorials/media/l6-named-set-05.gif "Панель фильтра, содержащая два именованных набора")  
