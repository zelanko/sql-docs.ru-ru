...
1.  Щелкните правой кнопкой мыши панель **Организатор скриптов** и выберите пункт **создать именованный набор.** `[Core Products]`  
...
9. В окно свойств измените `DiscretizationMethod` свойство на **автоматически**, `DiscretizationBucketCount` а затем измените значение свойства на. `5` Дополнительные сведения см. в разделе [Группирование элементов атрибутов (дискретизация)](multidimensional-models/attribute-properties-group-attribute-members.md).  
