...
3.  Из измерения **География** на панели метаданных перетащите определяемую пользователем иерархию **География** в область **Перетащите сюда поля строк** на панели данных.  
     ...
     ![Мера Reseller Sales-Sales Amount Quota распределена по измерениям](../../2014/tutorials/media/l5-referencedrelationship-1.gif "мер, измеренных Товарооборот посредников — сумма продаж")  
...
3.  На панели метаданных разверните `Reseller Geography`, щелкните правой кнопкой мыши **географических регионах**, а затем нажмите кнопку **добавить в область строк**.  
