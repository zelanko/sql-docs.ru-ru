...
ms.locfileid: "66067895"
---
# <a name="tabular-model-solutions-ssas-tabular"></a>Решения табличных моделей (табличные службы SSAS)
...
## <a name="in-this-section"></a>в этом разделе  
 ...
 [Уровень совместимости &#40;SP1 табличные службы SSAS&#41;](tabular-models/compatibility-level-for-tabular-models-in-analysis-services.md)  
 ...
 [Связи (табличные службы SSAS)](tabular-models/relationships-ssas-tabular.md)  
  
 [Вычисления (табличные службы SSAS)](tabular-models/calculations-ssas-tabular.md)  
  
 [Меры (табличные службы SSAS)](tabular-models/measures-ssas-tabular.md)  
  
 [Ключевые показатели эффективности (табличные службы SSAS)](tabular-models/kpis-ssas-tabular.md)  
  
 [Иерархии (табличные службы SSAS)](tabular-models/hierarchies-ssas-tabular.md)  
  
 [Секции (табличные службы SSAS)](tabular-models/partitions-ssas-tabular.md)  
  
 [Перспективы (табличные службы SSAS)](tabular-models/perspectives-ssas-tabular.md)  
  
 [Роли (табличные службы SSAS)](tabular-models/roles-ssas-tabular.md)  
