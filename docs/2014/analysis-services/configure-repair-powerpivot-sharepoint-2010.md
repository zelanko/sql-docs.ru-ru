...
|**Создать приложение службы для служб Excel**|Имя приложения службы||Введите имя приложения службы. Базу данных приложения службы с одинаковым именем будут создаваться на сервере базы данных фермы SharePoint.|  
...
1.  Перейдите к документации требования к оборудованию и программному обеспечению для SharePoint 2010, [определить оборудованию и программному обеспечению (SharePoint 2010)](https://go.microsoft.com/fwlink/?LinkId=169734)  
