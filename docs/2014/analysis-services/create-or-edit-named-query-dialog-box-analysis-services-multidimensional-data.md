---
title: Создание или изменение именованного запроса диалоговое окно «» (службы Analysis Services — многомерные данные) | Документы Microsoft
ms.custom: ''
ms.date: 03/06/2017
