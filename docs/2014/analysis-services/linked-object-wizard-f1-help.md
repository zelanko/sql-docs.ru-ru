...
-   Выбор источника данных служб [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] , из которого должны выполняться связи или импорт объектов.  
  
-   Выбор объектов, от которых должна выполняться связь или импорт.  
