...
7.  В поле « **источник**» выберите « **функция прогнозирования**», добавьте функцию `PredictSupport` и перетащите столбец модели [Bike Buyer] в область **критерий или аргумент** . В столбце **Псевдоним** введите **Support** (Поддержка).  
