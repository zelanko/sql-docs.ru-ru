...
##  <a name="bkmk_Understand"></a>Общие сведения о запросах интеллектуального анализа данных  
 [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)]Интеллектуальный анализ данных поддерживает следующие типы запросов:  
...
##  <a name="bkmk_Interfaces"></a>Средства запросов и интерфейсы  
...
##  <a name="bkmk_ModelTypes"></a>Запросы для различных типов моделей  
...
-   **Пользовательские прогнозирующие функции:** Каждый тип модели предоставляет набор прогнозирующих функций, предназначенных для работы с шаблонами, созданными этим алгоритмом.  
...
-   **Общая статистика:** Существует ряд функций, которые можно использовать практически для любого типа модели, который возвращает стандартный набор описательных статистических данных, например стандартное отклонение.  
...
-   **Пользовательская статистика:** Дополнительные вспомогательные функции предоставляются для каждого типа модели, чтобы сформировать статистику, относящуюся к конкретной аналитической задаче.  
...
-   **Функции содержимого модели:** *Содержимое* всех моделей представлено в стандартизированном формате, который позволяет получать информацию с помощью простого запроса. Запросы к содержимому моделей можно создавать с помощью расширений интеллектуального анализа данных. Некоторые типы содержимого модели также можно получить с помощью наборов строк схемы интеллектуального анализа данных.  
...
##  <a name="bkmk_Reqs"></a>Необходимость  
...
|Задания|Ссылки|  
|-----------|-----------|  
|Просмотрите учебники и пошаговые руководства по запросам интеллектуального анализа данных|[Занятие 6. Создание и работа с прогнозами &#40;учебник по основам интеллектуального анализа данных&#41;](../../tutorials/lesson-6-creating-and-working-with-predictions-basic-data-mining-tutorial.md)<br /><br /> [Учебник по расширениям интеллектуального анализа данных для прогнозирования временных рядов](../../tutorials/time-series-prediction-dmx-tutorial.md)|  
