...
## <a name="model-content-for-a-linear-regression-model"></a>Содержимое для модели линейной регрессии  
 ...
 Сведения о столбцах общего назначения в наборе строк схемы см. в разделе [Содержимое модели интеллектуального анализа данных (службы Analysis Services — интеллектуальный анализ данных)](mining-model-content-analysis-services-data-mining.md).  
...
|Идентификатор типа узла|Type|Описание|  
|------------------|----------|-----------------|  
...
##  <a name="node-distribution-for-continuous-attributes"></a><a name="NodeDist_Regression"></a>Распределение узлов для непрерывных атрибутов  
