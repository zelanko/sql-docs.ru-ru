 ...
 **Корневой узел:** Указывает количество узлов регрессии. Для каждого прогнозируемого атрибута в модели создается один узел регрессии.  
 ...
 **Узел регрессии:** Таблицу, которая содержит элементы, используемые для построения формулы регрессии. Узел регрессии содержит следующие типы значения.  
...
|ATTRIBUTE_NAME|ATTRIBUTE_VALUE|Псевдоним|PROBABILITY|VARIANCE|VALUETYPE|  
|---------------------|----------------------|-------------|-----------------|--------------|---------------|  
