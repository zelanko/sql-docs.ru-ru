...
###  <a name="bkmk_Ex2"></a> Пример 2. Фильтрация на уровне варианта с использованием атрибутов вложенной таблицы  
...
###  <a name="bkmk_Ex3"></a> Пример 3. Фильтрация по нескольким атрибутам вложенной таблицы на уровне вариантов  
...
###  <a name="bkmk_Ex4"></a> Пример 4. Фильтрация по отсутствию атрибутов вложенной таблицы на уровне вариантов  
