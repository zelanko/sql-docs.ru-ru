...
##  <a name="bkmk_Syntax"></a>Синтаксис фильтра  
...
###  <a name="bkmk_Ex1"></a>Пример 1. Типичная фильтрация на уровне вариантов  
...
###  <a name="bkmk_Ex3"></a>Пример 3. Фильтрация на уровне вариантов для нескольких атрибутов вложенной таблицы  
...
###  <a name="bkmk_Ex6"></a>Пример 6. Фильтрация по атрибутам вложенной таблицы и существует  
