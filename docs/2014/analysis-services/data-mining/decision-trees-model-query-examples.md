 ...
 **Запросы содержимого**  
 ...
 [Получение сведений о деревьях в модели с помощью расширений интеллектуального анализа данных](#bkmk_Query2)  
  
 [Получение поддеревьев из модели](#bkmk_Query3)  
  
 **Прогнозирующие запросы**  
  
 [Возврат прогнозов с вероятностями вероятностей](#bkmk_Query4)  
  
 [Прогнозирование взаимосвязей на основе модели дерева принятия решений](#bkmk_Query5)  
...
|NODE_NAME|NODE_CAPTION|T.ATTRIBUTE_NAME|T.ATTRIBUTE_VALUE|ПОДДЕРЖКА|  
|----------------|-------------------|-----------------------|------------------------|-------------|  
...
###  <a name="bkmk_Query4"></a>Пример запроса 4. получение прогнозов с вероятностями вероятностей  
...
###  <a name="bkmk_Query5"></a>Образец запроса 5. Прогнозирование взаимосвязей в модели дерева принятия решений  
