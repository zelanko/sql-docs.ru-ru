...
|-----------------|----------------------|-----------------|  
|**средство просмотра деревьев (Майкрософт)**|Вкладка**Дерево решений** |Щелкните узел дерева.<br /><br /> **Примечание** Избегайте использования детализации на `All` узел, так как он может занять очень много времени для возврата результатов.|  
