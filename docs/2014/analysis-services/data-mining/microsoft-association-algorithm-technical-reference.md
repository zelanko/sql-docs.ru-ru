 ...
 *Поддержка*, которую иногда называют *частотой*, означает количество вариантов, содержащих целевой элемент или сочетание элементов. Элементы включаются в модель, если мощность их несущего множества не меньше заданной величины.  
 ...
 **Примечание** . Можно также управлять количеством наборов элементов в модели интеллектуального анализа данных, указав максимальную длину набора элементов, где длина означает количество элементов.  
 ...
 *OPTIMIZED_PREDICTION_COUNT*  
 ...
 По умолчанию используется значение 0. Если используется значение по умолчанию, алгоритм выполнит столько прогнозов, сколько указано в запросе.  
