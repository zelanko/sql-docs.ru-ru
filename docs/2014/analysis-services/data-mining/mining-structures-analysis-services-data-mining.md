 ...
 **Модель 1** Использует CustomerID, Income, возраст, регион и фильтрует данные по региону.  
  
 **Модель 2** Использует CustomerID, Income, возраст, регион и фильтрует данные по возрасту.  
...
-   Укажите, следует ли разделить исходные данные на обучающий и проверочный набор. Этот шаг не является обязательным.  
