...
# <a name="create-a-dmx-query-in-sql-server-management-studio"></a>Создание DMX-запроса в среде SQL Server Management Studio
  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]предоставляет набор функций, помогающих создавать прогнозирующие запросы, запросы содержимого и запросы определений данных для моделей интеллектуального анализа данных и структур интеллектуального анализа.  
...
## <a name="xmla-query-templates"></a>Шаблоны XMLA-запросов  
 [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)]также предоставляет шаблоны для запросов XMLA.  
...
##  <a name="BKMK_Building_Queries"></a>Сборка и запуск DMX-запроса  
