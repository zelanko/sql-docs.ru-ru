...
##  <a name="bkmk_SourceData"></a>Данные источника интеллектуального анализа данных  
 ...
 **Пользовательские подключаемые алгоритмы**  
 [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)]предоставляет механизм для создания собственных алгоритмов, а также добавления алгоритмов в качестве новой службы интеллектуального анализа данных к экземпляру сервера.  
