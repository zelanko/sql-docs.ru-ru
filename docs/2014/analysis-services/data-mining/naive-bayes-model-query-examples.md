 ...
 **Запросы содержимого**  
 ...
 [Поиск дополнительных сведений об атрибутах](#bkmk_Query3)  
  
 [Использование системных хранимых процедур](#bkmk_Query4)  
  
 **Прогнозирующие запросы**  
  
 [Прогнозирование результатов с помощью одноэлементного запроса](#bkmk_Query5)  
  
 [Получение прогнозов со значениями вероятности и поддержки](#bkmk_Query6)  
...
###  <a name="bkmk_Query3"></a>Образец запроса 3. Поиск дополнительных сведений об атрибутах  
...
###  <a name="bkmk_Query5"></a>Образец запроса 5. Прогнозирование результатов с помощью одноэлементного запроса  
...
###  <a name="bkmk_Query6"></a>Образец запроса 6. получение прогнозов со значениями вероятности и поддержки  
...
###  <a name="bkmk_Query7"></a>Образец запроса 7. Прогнозирование взаимосвязей  
...
|[Прогнозирование &#40;&#41;расширений интеллектуального анализа данных](/sql/dmx/predict-dmx)|Возвращает прогнозируемое значение или набор значений для указанного столбца.|  
