...
|MIN_ITEMSET_SIZE|Размер наименьшего набора элементов, выраженный количеством элементов.<br /><br /> Значение 0 указывает, что `Missing` рассматривалось как независимый элемент.<br /><br /> **Примечание.** По умолчанию параметр *MINIMUM_ITEMSET_SIZE* имеет значение 1.|  
