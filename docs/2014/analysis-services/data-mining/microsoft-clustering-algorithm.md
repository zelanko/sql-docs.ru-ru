...
## <a name="how-the-algorithm-works"></a>Принцип работы алгоритма  
 ...
 ![Точечная диаграмма вариантов в наборе данных](../media/clustering-plot.gif "Точечная диаграмма вариантов в наборе данных")  
