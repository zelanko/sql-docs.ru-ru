...
-   **Средства просмотра моделей** предоставляются как в [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)] , [!INCLUDE[ssBIDevStudioFull](../../includes/ssbidevstudiofull-md.md)]так и для изучения моделей интеллектуального анализа данных после их создания.  Можно просматривать модели с помощью средств, специально созданных для каждого алгоритма, либо выполнить более глубокий анализ с помощью средства просмотра содержания модели.  
...
## <a name="data-mining-wizard"></a>Мастер интеллектуального анализа данных  
 ...
 Дополнительные **сведения:** [Мастер интеллектуального анализа данных &#40;Analysis Services — интеллектуальный анализ данных&#41;](data-mining-wizard-analysis-services-data-mining.md)  
