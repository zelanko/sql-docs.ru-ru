...
###  <a name="BKMK_Profile"></a>Профили кластеров  
 Вкладка **Профили кластера** предоставляет общий вид кластеров, создаваемых алгоритмом в модели. Каждый столбец, идущий за столбцом **Заполнение** в сетке, представляет кластер, обнаруженный моделью. В \<строке атрибут>. Samples представлены различные последовательности данных, которые существуют в кластере, а \<в строке атрибут> описаны все элементы, которые содержит кластер, и их общее распределение.  
...
###  <a name="BKMK_Characteristics"></a>Характеристики кластера  
...
###  <a name="BKMK_Discrimination"></a>Сравнение кластеров  
...
###  <a name="BKMK_Transitions"></a>Переходы кластера  
