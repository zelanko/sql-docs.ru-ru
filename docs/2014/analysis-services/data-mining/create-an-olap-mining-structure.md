...
4.  **Выбор ключа варианта**: В рамках выбранного измерения выберите атрибут (столбец), который будет служить уникальным идентификатором данных варианта.  
  
     Как правило, столбец выбирается автоматически, но можно выбрать и другой столбец, если есть несколько ключей.  
  
5.  **Выбор столбцов уровня варианта**: Здесь необходимо выбрать атрибуты из выбранного измерения и связанные меры, релевантные анализу. Этот шаг соответствует выбору столбцов из таблицы.  
