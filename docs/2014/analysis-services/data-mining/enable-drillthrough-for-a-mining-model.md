...
-   Разрешения на детализацию структуры предоставляют дополнительную возможность включать столбцы структуры в запросы детализации с помощью функции [StructureColumn (DMX)](/sql/dmx/structurecolumn-dmx). Также можно запрашивать обучения и тестовые случаи в структуре с помощью SELECT... ИЗ \<структуры >. ВАРИАНТЫ синтаксиса.  
