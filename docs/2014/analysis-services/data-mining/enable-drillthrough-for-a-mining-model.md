...
-   Разрешения на детализацию структуры предоставляют дополнительную возможность включать столбцы структуры в запросы детализации с помощью функции [StructureColumn (DMX)](/sql/dmx/structurecolumn-dmx). Вы также можете запрашивать обучающие и тестовые варианты в структуре с помощью инструкции SELECT... ИЗ \<structure> . Синтаксис вариантов.  
...
2.  В окнах **свойств** щелкните **AllowDrillthrough**и выберите **значение true**.  
