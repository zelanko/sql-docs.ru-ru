...
# <a name="drillthrough-on-mining-models"></a>Детализация моделей интеллектуального анализа данных
  *Детализация* означает возможность выполнения запросов к модели интеллектуального анализа данных или структуре интеллектуального анализа данных и получать подробные данные, которые не представлены в модели.  
  
 [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]предоставляет два различных варианта детализации данных вариантов. Можно детализировать варианты, которые были использованы для построения данных, либо варианты в структуре интеллектуального анализа данных.  
...
|Включение детализации в мастере моделей интеллектуального анализа данных|[Завершение работы мастера &#40;мастера интеллектуального анализа данных&#41;](../completing-the-wizard-data-mining-wizard.md).|  
