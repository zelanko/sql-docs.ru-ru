...
##  <a name="bkmk_top"></a> Получение сведений о модели логистической регрессии  
 ...
 Для изучения поведения сценариев запроса можно создать модель логистической регрессии, как показано в следующем разделе учебника по интеллектуальному анализу данных среднего уровня: [занятия 5: создание нейронной сети и моделей логистической регрессии &#40; Средний уровень учебник по интеллектуальному анализу данных&#41;](../../tutorials/lesson-5-build-models-intermediate-data-mining-tutorial.md).  
