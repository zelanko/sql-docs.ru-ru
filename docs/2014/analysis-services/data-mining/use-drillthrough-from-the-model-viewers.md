...
3.  Выберите один из следующих вариантов. **Только столбцы модели** или **модели и структуры столбцы**. Без необходимых разрешений вариант может оказаться недоступным.  
...
3.  Выберите **детализацию**, а затем выберите один из следующих вариантов: **Только столбцы модели** или **модели и структуры столбцы**. Без необходимых разрешений вариант может оказаться недоступным.  
