...
## <a name="how-the-algorithm-works"></a>Принцип работы алгоритма  
 [!INCLUDE[msCoName](../../includes/msconame-md.md)] Алгоритма нейронной сети создает сеть, которая состоит из трех слоев нейронов. Такими слоями являются входной слой, необязательный скрытый слой и выходной слой.  
