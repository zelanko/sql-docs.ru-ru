...
##  <a name="BKMK_ChooseRelData"></a> Выбор реляционных данных  
 ...
 Не обязательно использовать все доступные данные, можно выбрать столбцы, которые будут включены в структуру интеллектуального анализа данных. Эти столбцы могут использоваться для всех моделей, основанных на этой структуре, затем или можно пометить определенные столбцы в качестве `Ignore` для конкретной модели. Можно также позволить пользователям модели интеллектуального анализа детализировать результаты модели углублением с целью просмотра дополнительных столбцов структуры интеллектуального анализа данных, не включенных в саму модель.  
...
## <a name="see-also"></a>См. также  
 ...
 [Свойства структуры интеллектуального анализа данных и столбцов](properties-for-mining-structure-and-structure-columns.md)   
