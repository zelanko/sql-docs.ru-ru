...
> [!WARNING]  
>  Учтите, что эта возможность доступна не для всех типов моделей. Например при создании модели прогнозирования, нельзя будет использовать контрольные данные, так как алгоритм временных рядов требуется наличие промежутков в данных. Список типов моделей, поддерживающих наборы контрольных данных, см. в разделе [Обучающие и проверочные наборы данных](training-and-testing-data-sets.md).  
