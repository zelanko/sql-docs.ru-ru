...
|ID|Имя|  
|--------|----------|  
|1|**Двоичный файл:** Указывает, что независимо от фактического числа значений атрибута дерево должно быть разделено на две ветви.|  
|2|**Завершено:** Указывает, что дерево может создать столько разбиений, сколько есть значения атрибутов.|  
|3|**Оба:** Указывает, что Analysis Services может определить, следует ли использовать двоичный или полный разделитель для получения наилучших результатов.|  
