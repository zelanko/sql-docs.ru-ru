---
title: Модель интеллектуального анализа данных для моделей кластеризации последовательностей (службы Analysis Services — Интеллектуальный анализ данных) | Документация Майкрософт
ms.custom: ''
ms.date: 03/06/2017
...
###  <a name="bkmk_NODEDIST"></a> Таблица NODE_DISTRIBUTION  
 ...
 В таблицу переходов всегда добавляется отдельная строка, представляющая возможные значения `Missing`. Сведения о том, что `Missing` означает, что значение, и как она влияет на вычисления, см. в разделе [отсутствующие значения &#40;службы Analysis Services — Интеллектуальный анализ данных&#41;](missing-values-analysis-services-data-mining.md).  
