---
title: Алгоритм временных рядов | Документация Майкрософт
ms.custom: ''
ms.date: 06/13/2017
...
-   Прогнозируемые данные отображаются справа от вертикальной линии и представляют прогноз, подготовленный моделью.  
 ...
 ![Пример временного ряда](../media/time-series.gif "пример временных рядов")  
