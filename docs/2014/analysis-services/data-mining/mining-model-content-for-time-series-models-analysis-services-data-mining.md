...
|30 (ARIMA скользящее среднее)|Значение в момент t<br /><br /> Значение в момент t-1<br /><br /> …<br /><br /> Значение в момент t-n|7|  
 ...
 Значение *порядка скользящего среднего* указывает на число скользящих средних в ряду. Обычно скользящее среднее — вычисляемый n-1 раз, если n условия в последовательность, но число можно сократить для упрощения расчетов.  
