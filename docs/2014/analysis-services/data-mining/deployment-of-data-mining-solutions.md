...
-   Создание отчетов, позволяющих пользователям запрашивать прогнозы, просматривать тенденции и сравнивать модели.  
 ...
 [Развертывание реляционного решения](#bkmk_RelationalSltn)  
  
 [Развертывание многомерного решения](#bkmk_MDSltn)  
...
###  <a name="bkmk_MDSltn"></a>Развертывание многомерного решения  
