 ...
 **Корневой элемент модели** Имя прогнозируемого атрибута.  
  
 **Маржинальная статистика** Неприменимо  
  
 **Прогнозируемый атрибут** Имя прогнозируемого атрибута.  
  
 **Входной атрибут** Имя входного атрибута.  
  
 **Состояние входного атрибута** Имя только входного атрибута. Чтобы получить состояние, используйте столбец MSOLAP_NODE_SHORT_CAPTION.  
 ...
 **Входной атрибут** Имя прогнозируемого атрибута и текущий входной атрибут. Например,  
  
 Bike Buyer -> Age  
  
 **Состояние входного атрибута** Имя прогнозируемого атрибута и текущий входной атрибут плюс значение входных данных. Например,  
 ...
 **Корневой элемент модели** Число прогнозируемых атрибутов в модели плюс 1 для узла граничной статистики.  
  
 **Маржинальная статистика** По определению не имеет дочерних элементов.  
  
 **Прогнозируемый атрибут**  Количество входных атрибутов, связанных с текущим прогнозируемым атрибутом.  
  
 **Входной атрибут** Количество дискретных или дискретных значений для текущего входного атрибута.  
  
 **Состояние входного атрибута** Всегда равно 0.  
 ...
 **Маржинальная статистика** Всегда равно 0.  
  
 **Прогнозируемый атрибут**  Всегда равно 1.  
  
 **Входной атрибут** Всегда равно 1.  
 ...
 **Состояние входного атрибута** Число вариантов в обучающих данных, содержащих только это конкретное значение.  
 ...
 **Прогнозируемый атрибут**  Всегда равно 0.  
 ...
 **Маржинальная статистика** Свобод  
  
 **Прогнозируемый атрибут**  Имя прогнозируемого атрибута.  
  
 **Входной атрибут** Имя входного атрибута.  
  
 **Состояние входного атрибута** Значение или дискретное значение входного атрибута.  
...
###  <a name="bkmk_margstats"></a>Сведения в узле граничной статистики  
...
|Общее количество детей|1|3406|0.19480668|0|4|  
 ...
 Значение `Missing` (VALUE_TYPE = 1) добавляется к каждому входному и выходному атрибуту, представляя возможные значения, которые не присутствовали в обучающих данных. Важно различать строку «missing» и значение `Missing` по умолчанию. Дополнительные сведения см. в разделе [Missing Values &#40;Analysis Services - Data Mining&#41;](missing-values-analysis-services-data-mining.md).  
