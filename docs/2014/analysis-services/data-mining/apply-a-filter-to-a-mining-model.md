...
8.  Щелкните текстовое поле **Значение** и введите значение в поле.  
     ...
     Например, выберите `Income` как столбец, выберите более чем оператор (>), а затем введите `30000`.  
...
11. Выберите оператор и введите значение, как описано в шагах 7 и 8.  
     ...
     Например, выберите `Income` столбца еще раз, выберите оператор (<) меньше, а затем введите `40000`.  
...
1.  Добавьте дополнительные условия, при необходимости, объединив их, выбрав `AND` или `OR` в **и/или** поле в левой части **условия** сетки. [!INCLUDE[clickOK](../../includes/clickok-md.md)]  
