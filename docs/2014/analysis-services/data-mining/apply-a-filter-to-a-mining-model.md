...
8.  Щелкните текстовое поле **Значение** и введите значение в поле.  
     ...
     Например, выберите столбец `Income`, выберите оператор "больше" (>), а затем введите значение `30000`.  
...
11. Выберите оператор и введите значение, как описано в шагах 7 и 8.  
     ...
     Например, снова выберите столбец `Income`, выберите оператор "меньше" (<), а затем введите значение `40000`.  
