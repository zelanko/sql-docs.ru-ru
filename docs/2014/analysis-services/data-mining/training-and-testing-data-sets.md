...
-   **DMX** в языке расширений интеллектуального анализа данных. Инструкция CREATE MINING STRUCTURE расширена и включает предложение WITH удержания.  
  
-   **ASSL** Можно либо создать новую структуру интеллектуального анализа данных, либо добавить проверочный набор в существующую структуру интеллектуального анализа с помощью языка [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] сценариев (ASSL).  
  
-   **Объекты AMO** Можно также просматривать и изменять наборы контрольных данных с помощью объектов AMO.  
...
|Разделы|Ссылки|  
|------------|-----------|  
|Описывает, каким образом фильтры модели взаимодействуют с обучающим и проверочным наборами данных.|[Фильтры для моделей интеллектуального анализа данных &#40;Analysis Services интеллектуального анализа&#41;](mining-models-analysis-services-data-mining.md)|  
|Описывает, как использование обучающих и проверочных данных влияет на перекрестные проверки.|[&#40;перекрестной проверки Analysis Services — интеллектуальный анализ данных&#41;](cross-validation-analysis-services-data-mining.md)|  
...
|Содержит синтаксис DMX для создания контрольных наборов.|[СОЗДАНИЕ СТРУКТУРЫ ИНТЕЛЛЕКТУАЛЬНОГО АНАЛИЗА ДАННЫХ &#40;&#41;РАСШИРЕНИЙ ИНТЕЛЛЕКТУАЛЬНОГО АНАЛИЗА ДАННЫХ](/sql/dmx/create-mining-structure-dmx)|  
