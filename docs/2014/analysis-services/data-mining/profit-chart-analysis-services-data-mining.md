...
## <a name="build-a-profit-chart"></a>Создание диаграммы роста прибыли  
 ...
 Если у вас нет образца модели, ее можно создать с помощью [основам интеллектуального анализа данных](../../tutorials/basic-data-mining-tutorial.md).  
