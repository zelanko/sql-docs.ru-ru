...
-   Улучшение решения интеллектуального анализа данных для поддержки новых данных или изменения в инфраструктуре с учетом текущего анализа.  
 ...
 [Полнотекстовый поиск](#bkmk_FTSetc)  
  
 [семантическое индексирование](#bkmk_SemSearch)  
  
##  <a name="sql-server-integration-services"></a><a name="bkmk_SSIS"></a> Службы SQL Server Integration Services  
...
##  <a name="data-quality-services"></a><a name="bkmk_DQSetc"></a>Службы Data Quality Services  
 ...
 **Автоматизированный процесс сопоставления данных, который анализирует данные и предлагает изменения.**  
 ...
 Дополнительные сведения см. в статье [Сопоставление данных](../../data-quality-services/data-matching.md).  
...
##  <a name="full-text-search"></a><a name="bkmk_FTSetc"></a>Полнотекстовый поиск  
...
##  <a name="semantic-indexing"></a><a name="bkmk_SemSearch"></a>Семантическое индексирование  
