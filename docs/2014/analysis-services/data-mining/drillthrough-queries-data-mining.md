...
-   Детализация до **вариантов структуры**  
 ...
 [Рекомендации по использованию детализации](#bkmk_Considerations)  
...
##  <a name="bkmk_Considerations"></a>Рекомендации по использованию детализации  
...
###  <a name="bkmk_Security"></a>Проблемы безопасности для детализации  
...
###  <a name="bkmk_Limits"></a>Ограничения детализации  
...
|Включение детализации для структуры интеллектуального анализа данных с помощью предложения DMX WITH DRILLTHROUGH|[СОЗДАНИЕ СТРУКТУРЫ ИНТЕЛЛЕКТУАЛЬНОГО АНАЛИЗА ДАННЫХ &#40;&#41;РАСШИРЕНИЙ ИНТЕЛЛЕКТУАЛЬНОГО АНАЛИЗА ДАННЫХ](/sql/dmx/create-mining-structure-dmx)|  
|Сведения о присвоении разрешений, относящихся к детализации структур и моделей интеллектуального анализа данных|[Предоставление разрешений на структуры и модели интеллектуального анализа данных &#40;Analysis Services&#41;](../multidimensional-models/grant-permissions-on-data-mining-structures-and-models-analysis-services.md)|  
