 ...
 **Запросы содержимого**  
 ...
 [Использование набора строк схемы интеллектуального анализа данных для определения параметров, используемых в модели](#bkmk_Query1)  
  
 [Использование расширений интеллектуального анализа данных для возврата формулы регрессии для модели](#bkmk_Query2)  
  
 [Возвращение только коэффициента для модели](#bkmk_Query3)  
  
 **Прогнозирующие запросы**  
  
 [Прогнозирование дохода с помощью одноэлементного запроса](#bkmk_Query4)  
  
 [Использование прогнозирующих функций с моделью регрессии](#bkmk_Query5)  
  
##  <a name="bkmk_top"></a>Поиск сведений о модели линейной регрессии  
 Структура модели линейной регрессии чрезвычайно проста: модель интеллектуального анализа данных представляет данные в виде одного узла, определяющего формулу регрессии. Дополнительные сведения см. в разделе [Mining Model Content for Logistic Regression Models &#40;Analysis Services - Data Mining&#41;](mining-model-content-for-logistic-regression-models.md).  
  
 [Вернуться к началу](#bkmk_top)  
  
###  <a name="bkmk_Query1"></a>Образец запроса 1. Использование набора строк схемы интеллектуального анализа данных для определения параметров, используемых в модели  
...
###  <a name="bkmk_Query2"></a>Образец запроса 2. получение формулы регрессии для модели  
...
###  <a name="bkmk_Query4"></a>Пример запроса 4. Прогнозирование дохода с помощью одноэлементного запроса  
 Проще всего создать отдельный запрос к модели регрессии с помощью диалогового окна **Ввод одноэлементного запроса** . Например, можно создать следующий DMX-запрос, выбрав соответствующую модель регрессии, выбрав **одноэлементный запрос**, а затем введя `20` в качестве значения **Age**.  
...
###  <a name="bkmk_Query5"></a>Образец запроса 5. Использование прогнозирующих функций с моделью регрессии  
...
## <a name="see-also"></a>См. также:  
 ...
 [Содержимое моделей интеллектуального анализа данных для моделей линейной регрессии &#40;Analysis Services-интеллектуальный анализ данных&#41;](mining-model-content-for-linear-regression-models-analysis-services-data-mining.md)  
