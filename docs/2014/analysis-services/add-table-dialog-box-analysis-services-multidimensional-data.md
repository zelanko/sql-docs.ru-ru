---
title: Добавить таблицу-диалоговое окно (службы Analysis Services — многомерные данные) | Документация Майкрософт
ms.custom: ''
ms.date: 03/06/2017
...
|**Добавить**|Нажмите для добавления элемента, выбранного в настоящее время. **Примечание.**  Этот параметр становится доступен только в том случае, если элемент выбран.|  
...
## <a name="see-also"></a>См. также  
 ...
 [Создание или изменение именованного запроса-диалоговое окно &#40;службы Analysis Services — многомерные данные&#41;](create-or-edit-named-query-dialog-box-analysis-services-multidimensional-data.md)   
 [Создание опрашивающего запроса-диалоговое окно &#40;службы Analysis Services — многомерные данные&#41;](create-polling-query-dialog-box-analysis-services-multidimensional-data.md)   
 [Создание обрабатывающего запроса-диалоговое окно &#40;службы Analysis Services — многомерные данные&#41;](create-processing-query-dialog-box-analysis-services-multidimensional-data.md)  
