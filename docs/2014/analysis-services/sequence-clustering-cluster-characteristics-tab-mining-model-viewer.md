...
|Применение|Описание|  
|-----------|-----------------|  
|**Переменная**|Этот столбец показывает, является характеристика значением или переходом.<br /><br /> Если характеристикой является значение, столбец **variable** содержит имя атрибута.<br /><br /> Если характеристика представляет переход состояния, столбец **переменная** содержит текст "переходы".|  
