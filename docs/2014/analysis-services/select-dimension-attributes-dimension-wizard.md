 ...
 **Разрешить обзор**  
 Выберите, чтобы сделать атрибут доступным для просмотра и фильтрации конечным пользователем. Для ключевого атрибута должен быть выбран **параметр Включить просмотр** . Для неключевых атрибутов параметр **Разрешить обзор** по умолчанию не выбран, поэтому неключевые атрибуты отображаются только как свойства элементов.  
