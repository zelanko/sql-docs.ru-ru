...
-   **1100** — это уровень совместимости по умолчанию для режима развертывания 0, для многомерного режима и интеллектуального анализа данных.  
  
-   **1103** — это уровень совместимости по умолчанию для режимов развертывания 1 или 2 для установок, поддерживающих [!INCLUDE[ssGeminiShort](../includes/ssgeminishort-md.md)]табличный режим или.  
...
-   **Двоичный файл** используется для сортировки и сравнения данных на основе битовых шаблонов, определенных для каждого символа. Двоичный порядок сортировки учитывает регистр, то есть нижний регистр предшествует верхнему, а также учитывает диакритические знаки. Это самый быстрый порядок сортировки.  
...
-   **Двоичный 2** используется для сортировки и сравнения данных в Юникоде на основе битовых шаблонов, определенных для каждого символа. Двоичный порядок сортировки учитывает регистр, то есть нижний регистр предшествует верхнему, а также учитывает диакритические знаки. Это самый быстрый порядок сортировки.  
  
-   С **учетом регистра** используется для сортировки и сравнения данных на основе словарных правил для соответствующего языка или алфавита, а также для различения прописных и строчных букв.  
...
-   **С учетом диакритических** знаков используется для сортировки и сравнения данных на основе словарных правил для соответствующего языка или алфавита, а также для различения символов с диакритическими знаками и без них. Например, «a» не равно «á».  
...
-   **С учетом типа японской азбуки** используются для и сравнения данных на основе словарных правил для соответствующего языка или алфавита, а также для различения двух типов символов японской азбуки: хирагана и катакана.  
...
-   **С учетом ширины** символов используется для сортировки и сравнения данных на основе словарных правил для соответствующего языка или алфавита, а также для различения однобайтового символа (половинной ширины) и того же символа, если он представлен в виде двухбайтовых символов (полная ширина).  
