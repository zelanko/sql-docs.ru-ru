 ...
 **Целевой объект**  
 Выберите объект, с которым должно быть связано действие. [!INCLUDE[msCoName](../includes/msconame-md.md)] клиенту только те действия, которые применяются к выбранному [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] объекту. Список доступных объектов ограничивается выбором **Целевого типа**.  
...
|-----------|-----------------|  
|HTML5|Отчет возвращается в формате, совместимом со стандартом HTML 5.0.|  
|HTML3|Отчет возвращается в формате, совместимом со стандартом HTML 3.2.|  
...
|Значение|Description|  
|-----------|-----------------|  
|Пакетная служба Azure|Действие должно выполняться как часть пакетной операции или [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] [!INCLUDE[ssISnoversion](../includes/ssisnoversion-md.md)] задачи.|  
