 ...
 **Имя сервера**  
 Введите имя экземпляра служб [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)] , в котором действие приводит к запуску отчета.  
...
|Значение|Описание|  
|-----------|-----------------|  
|Пакет|Действие должно выполняться как часть пакетной операции или задачи служб [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] [!INCLUDE[ssISnoversion](../includes/ssisnoversion-md.md)] .|  
