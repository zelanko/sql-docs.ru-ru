---
title: Аналитические услуги MDX Конструктор запросов (PowerPivot) Документы Майкрософт
ms.custom: ''
ms.date: 06/13/2017
