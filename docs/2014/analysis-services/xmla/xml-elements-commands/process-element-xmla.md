...
|Дочерние элементы|[Привязки](../xml-elements-properties/bindings-element-xmla.md), [DataSource](../xml-elements-properties/source-element-xmla.md), [DataSourceView](../xml-elements-properties/datasourceview-element-xmla.md), [ErrorConfiguration](../xml-elements-properties/errorconfiguration-element-xmla.md), [объекта](../xml-elements-properties/object-element-xmla.md), [типа Элемент &#40;XMLA&#41;](../xml-elements-properties/type-element-xmla.md), [WriteBackTableCreation](../xml-elements-properties/writebacktablecreation-element-xmla.md)|  
  
## <a name="remarks"></a>Примечания  
 Дополнительные сведения об обработке объектов см. в разделе [обработки объектов &#40;XMLA&#41;](../xml-elements-objects.md).  
