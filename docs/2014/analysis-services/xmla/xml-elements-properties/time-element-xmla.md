---
title: Время элемент (XMLA) | Документация Майкрософт
ms.custom: ''
ms.date: 03/06/2017
...
ms.locfileid: "37151485"
---
# <a name="time-element-xmla"></a>Элемент Time (XML для аналитики)
  Определяет временное ограничение, используемое командой [DesignAggregations](../xml-elements-commands/designaggregations-element-xmla.md) при построении агрегатов.  
