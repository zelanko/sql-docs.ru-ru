...
ms.locfileid: "36101149"
---
# <a name="command-element-xmla"></a>Элемент Command (XML для аналитики)
  Содержит команды для выполнения [Execute](../xml-elements-methods-execute.md) метод.  
