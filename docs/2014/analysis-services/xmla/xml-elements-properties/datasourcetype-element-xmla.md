...
ms.locfileid: "36101596"
---
# <a name="datasourcetype-element-xmla"></a>Элемент DataSourceType (XML для аналитики)
  Указывает ли [расположение](location-element-xmla.md) элемент, указанный для [восстановить](../xml-elements-commands/restore-element-xmla.md) или [Synchronize](../xml-elements-commands/synchronize-element-xmla.md) команда является локальным или удаленным.  
