---
title: CUBE (OlapInfo) (XMLA) элемент | Документация Майкрософт
ms.custom: ''
ms.date: 06/13/2017
...
ms.locfileid: "37308244"
---
# <a name="cube-element-olapinfo-xmla"></a>Элемент Cube (OlapInfo) (XMLA)
  Содержит сведения о кубе для родительского [CubeInfo](cubeinfo-element-xmla.md) элемент.  
