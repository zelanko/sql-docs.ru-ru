...
13. На панели **иерархии** в конструкторе измерений создайте пользовательскую иерархию **Sales reasons** , которая содержит `Sales Reason Type` уровень и **причину покупки** в указанном порядке.
