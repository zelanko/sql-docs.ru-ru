...
2.  Щелкните правой кнопкой мыши в любом месте панели **Организатор диаграмм** , выберите пункт **создать**диаграмму `Internet Sales Order Reasons` и укажите в качестве имени для новой диаграммы.  
...
## <a name="next-task-in-lesson"></a>Следующая задача занятия  
 [Определение степени гранулярности измерения в группе мер](https://docs.microsoft.com/analysis-services/lesson-5-4-defining-dimension-granularity-within-a-measure-group)  
