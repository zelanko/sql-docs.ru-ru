---
title: Диалоговое окно «Свойства» (службы SSAS — многомерные) базы данных | Документы Microsoft
ms.custom: ''
ms.date: 06/13/2017
...
|**Последней обработки**|Отображает дату и время последней обработки базы данных.|  
