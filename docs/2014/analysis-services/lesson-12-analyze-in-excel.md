...
3.  В Excel в **список полей сводной таблицы**, обратите внимание, **даты** и **продажи через Интернет** меры отображаются, а также **клиента**,  **Дата**, **Geography**, **продукта**, **категории продукта**, **Подкатегория продукта**и **Продажи через Интернет** таблицы со всеми соответствующих столбцов отображаются.  
