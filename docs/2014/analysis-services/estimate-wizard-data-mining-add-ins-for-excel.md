---
title: Оценка мастер (интеллектуальный анализ данных надстройки для Excel) | Документы Microsoft
ms.custom: ''
ms.date: 12/29/2017
...
2.  В **Выбор источника данных** диалогового окна выберите источник данных. Можно использовать данные в Excel **таблицы**, Excel **диапазон данных**, или из **внешнего источника данных**.  
...
5.  **Оценки** мастер выбирает оптимальный алгоритм для вашего набора данных. Однако можно нажать кнопку **параметры** Открытие **параметры алгоритма** диалоговое окно и настроить дополнительные параметры.  
  
6.  Если числовые данные, можно использовать метод линейной регрессии можно проверить **Регрессора** поле для любых числовых столбцов, которые вы знаете (или обоснованно предполагается) корреляцию с прогнозируемым значением.  
  
     После этого алгоритм проверит значения в указанном столбце и определит, влияют ли они на исход. Если вы не уверены, нажмите кнопку **предложить** и алгоритм будут все столбцы и автоматическое определение наилучших значений для использования в качестве регрессоров.  
...
8.  На **Готово** страницы, укажите имена для новой структуры интеллектуального анализа данных и модели интеллектуального анализа данных или примите имена по умолчанию, предоставляемые.  
...
9. Задайте параметры для использования модели.  
    ...
    -   Выберите **включить детализацию** чтобы пользователи могли анализа просмотреть базовые данные.  
 ...
 **Оценки** мастер поддерживает использование любого из следующих вариантов:  
...
-   Алгоритм нейронной сети (Майкрософт)  
 ...
 В **параметры алгоритма** диалоговое окно, можно задать дополнительные Дополнительные параметры, в зависимости от того, какой алгоритм выбрано. Подробные сведения о параметрах для каждого из алгоритмов см. в следующих разделах электронной документации по SQL Server:  
...
## <a name="see-also"></a>См. также  
 ...
 [Пошаговое руководство по диаграмме дерева принятия решений &#40;надстройки интеллектуального анализа данных&#41;](decision-tree-diagram-walkthrough-data-mining-add-ins.md)  
