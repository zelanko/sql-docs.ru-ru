---
title: Новое окно базы данных (службы Analysis Services) | Документы Microsoft
ms.custom: ''
ms.date: 06/13/2017
