...
|**Соедините**|Отключает редактор запросов многомерных выражений от экземпляра служб [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] .|  
...
|**Работать**|Выполняет выбранный код или, если код не выбран, выполняет весь код в редакторе запросов многомерных выражений.|  
|**Проанализировать**|Проверяет синтаксис выбранного кода. Если код не выбран, осуществляет проверку синтаксиса всего содержимого окна редактора запросов многомерных выражений.|  
