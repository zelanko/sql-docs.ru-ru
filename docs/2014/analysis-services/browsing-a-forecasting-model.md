---
title: Просмотр модели прогнозов | Документы Microsoft
ms.custom: ''
ms.date: 03/06/2017
...
ms.locfileid: "36190109"
---
# <a name="browsing-a-forecasting-model"></a>Просмотр модели прогнозов
  При открытии модели прогнозирования с помощью окна **Обзор**, модель отображается в интерактивном средстве просмотра, аналогично средство просмотра модели временных рядов в [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)]. Средство просмотра помогает исследовать тенденции, сравнивать ряды, создавать прогнозы и получать информацию о модели и базовых данных.  
  
##  <a name="bkmk_Top"></a> Просмотр модели  
 **Обзор** предоставляет средство просмотра для моделей прогнозирования, представление диаграммы, в котором отображаются тенденции во времени и позволяет создавать прогнозы и представление модели, которое представлено в виде дерева принятия решений или дерева регрессии временных рядов.  
  
-   [Представление диаграммы](#bkmk_charts)  
  
-   [Представление модели](#bkmk_Model)  
  
 Для экспериментов с моделью прогнозирования можно использовать образцы данных на вкладке «прогноз» книги с образцами данных и построить модели ряда времени с помощью [Мастер прогнозов &#40;интеллектуального анализа данных надстройки для Excel&#41; ](forecast-wizard-data-mining-add-ins-for-excel.md) в  **Интеллектуальный анализ данных** ленты, или [прогноз &#40;средства анализа таблиц для Excel&#41; ](forecast-table-analysis-tools-for-excel.md) в **анализ** ленты.  
  
###  <a name="bkmk_charts"></a> Диаграммы  
 **Диаграммы** вкладка отображается тенденция в ряду данных во времени вместе с прогнозируемыми значениями. Вертикальная ось диаграммы представляет значения рядов, а горизонтальная — время.  
...
2.  Нажмите кнопку **этапов прогнозирования** и введите новое значение для управления, сколько будущих временных значений следует отобразить в диаграмме.  
  
     Значение по умолчанию — 5.  
  
3.  Щелкните любую точку линии, будущую или историческую, чтобы увидеть точные значения для этой точки времени, отображаемых в **обозначения интеллектуального анализа данных**.  
...
5.  Выберите **отображать исторические прогнозы** параметр, чтобы получить общее представление о стабильности временных рядов.  
...
6.  Выберите **Отображать отклонения** параметр для отображения на диаграмме погрешностей.  
...
-   Чтобы показать или скрыть **обозначения интеллектуального анализа данных**, щелкните правой кнопкой мыши любую точку на диаграмме.  
...
-   Чтобы скопировать текущую диаграмму, нажмите кнопку **Копировать в Excel**, затем нажмите кнопку на листе Excel. График вставляется в лист со всеми заданными параметрами, включая условные обозначения.  
  
     Однако график статичен, поэтому не может редактировать условные обозначения или просмотреть базовые данные. Если вам требуется более интерактивное представление диаграммы, используйте [средства просмотра Visio](viewing-data-mining-models-in-visio-data-mining-add-ins.md).  
...
3.  Щелкните каждый узел, чтобы просмотреть описательную статистику в **обозначения интеллектуального анализа данных**.  
  
     Если задержать указатель мыши над узлом, в подсказке будет показана та же статистика и полная формула, описывающая узел.  
  
4.  Если вы хотите скопировать информацию **обозначения интеллектуального анализа данных**, щелкните правой кнопкой мыши **обозначения интеллектуального анализа данных**выберите **копирования**и щелкните внутри листа Excel. **Копировать в Excel** копирует график не статистические показатели.  
