...
1.  [Щелкните здесь](https://go.microsoft.com/fwlink/?LinkID=221866) , чтобы открыть страницу загрузки, в которой содержатся примеры проектов, которые можно найти в этом руководстве. Образцы проектов включены в состав пакета для скачивания **Учебник по службам SQL Server 2012 Analysis Services**.  
