...
|-----------|-----------------|  
|**Переключиться в обычный построитель запросов**|Выберите этот пункт, чтобы отображать только параметры, доступные для представления обычного построителя запросов. Отображаются только следующие параметры:<br /><br /> **Панель SQL**<br /><br /> **Панель результатов**<br /><br /> **Панель инструментов**, содержащая только **переключение на построитель VDT-конструктор запросов** и **Запуск**<br /><br /> Примечание. Этот параметр отображается только в том случае, если выбран параметр **Переключиться в построитель VDT-запросов** .|  
