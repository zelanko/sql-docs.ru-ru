...
5.  [!INCLUDE[clickOK](../includes/clickok-md.md)]  
     ...
     На диаграмме появляется значок предупреждения, поскольку эта связь избыточна. **Почтовый индекс** **полного имени** -> **Geography**-> связи уже существовал, и вы только что создали **полный** -> **почтовый индекс**для связи. **Почтовый индекс** отношения **География**-> теперь избыточен, поэтому мы удалим его.  
