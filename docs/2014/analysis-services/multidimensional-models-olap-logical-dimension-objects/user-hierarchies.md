...
|1999|Квартал 4|Dec|  
 ...
 ![Иерархия уровней и элементов для измерения времени](https://docs.microsoft.com/analysis-services/analysis-services/dev-guide/media/as-levelconcepts.gif "Иерархия уровней и элементов для измерения времени")  
...
### <a name="parent-child-hierarchies"></a>Иерархии типа «родители-потомки»  
 ...
 ![Самостоятельное связывание соединения в таблице DimOrganization](https://docs.microsoft.com/analysis-services/analysis-services/dev-guide/media/dimorganization.gif "Самостоятельное связывание соединения в таблице DimOrganization")  
