...
|Раздел|Описание|  
|-----------|-----------------|  
|[Знакомство с измерениями &#40;службы Analysis Services — многомерные данные&#41;](dimensions-analysis-services-multidimensional-data.md)|Содержит обзор основных понятий, связанных с измерениями.|  
