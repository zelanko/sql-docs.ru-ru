...
## <a name="dimension-based-on-a-star-schema-design"></a>Измерение, основанное на структуре схемы «звезда»  
 ...
 ![Логическая схема для связи измерений фактов](https://docs.microsoft.com/analysis-services/analysis-services/dev-guide/media/dimfactrelationship.gif "Логическая схема для связи измерений фактов")  
...
## <a name="dimension-based-on-a-snowflake-schema-design"></a>Измерение, основанное на структуре схемы «снежинка»  
 ...
 ![Таблицы для измерения продукта AdventureWorksAS](https://docs.microsoft.com/analysis-services/analysis-services/dev-guide/media/dimproduct.gif "Таблицы для измерения продукта AdventureWorksAS")  
  
 Чтобы полностью описать продукт, в измерение «Продукт» необходимо включить категорию и подкатегорию продукта. Однако эта информация не находится непосредственно в основной таблице для измерения **DimProduct** . Связь по внешнему ключу от **DimProduct** к **DimProductSubcategory**, которая, в свою очередь, имеет связь по внешнему ключу с таблицей **DimProductCategory** , дает возможность включать сведения о категориях продуктов и подкатегории в измерении Product.  
...
## <a name="snowflake-schema-versus-reference-relationship"></a>Схема «снежинка» и ссылочная связь  
 ...
 ![Логическая схема образца измерения, на который указывает ссылка](https://docs.microsoft.com/analysis-services/analysis-services/dev-guide/media/dimindirect.gif "Логическая схема образца измерения, на который указывает ссылка")  
