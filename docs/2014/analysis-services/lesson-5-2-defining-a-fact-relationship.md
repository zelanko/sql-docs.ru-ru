...
18. На панели **иерархии** создайте пользовательскую иерархию **заказы через Интернет** , содержащую уровни `Order Number` **описания элементов** и в указанном порядке.
