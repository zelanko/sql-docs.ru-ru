...
1.  Откройте в конструкторе кубов куб [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] Tutorial и перейдите на вкладку **Ключевые показатели эффективности** .  
     ...
     ![Ключевые показатели эффективности вкладке конструктора кубов](../../2014/tutorials/media/l7-kpi-1.gif "KPIs tab конструктора кубов")  
...
2.  На панели инструментов вкладки **Ключевые показатели эффективности** нажмите кнопку **Создать ключевой показатель** .  
     ...
     ![Пустой шаблон ключевого показателя Эффективности в панели отображения](../../2014/tutorials/media/l7-kpi-2.gif "шаблон пустой KPI на панели отображения")  
...
2.  В **имя** введите `Product Gross Profit Margin`и убедитесь, что  **\<все >** отображается в **связанная группа мер** списка.  
...
2.  После успешного завершения развертывания нажмите кнопку **Повторное подключение** на панели инструментов вкладки **Ключевые показатели эффективности** , а затем перейдите на панель **Представление браузера**.  
     ...
     `Product Gross Profit Margin` Ключевой показатель Эффективности отобразится значение Показателя для **Q3 CY 2007** и **North America** территории продаж.  
