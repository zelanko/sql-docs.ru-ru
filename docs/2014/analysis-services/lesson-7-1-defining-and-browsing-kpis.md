...
2.  В поле **имя** введите `Product Gross Profit Margin`и убедитесь, что  **\<все >** отображаются в списке **связанная группа мер** .  
...
2.  После успешного завершения развертывания нажмите кнопку **Повторное подключение** на панели инструментов вкладки **Ключевые показатели эффективности** , а затем перейдите на панель **Представление браузера**.  
     ...
     Отобразится KPI и отобразится значение ключевого показателя эффективности для **Q3 CY 2007** и Северная Америка территории продаж. `Product Gross Profit Margin`  
