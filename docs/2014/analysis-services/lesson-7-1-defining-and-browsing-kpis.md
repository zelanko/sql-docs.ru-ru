...
1.  Откройте в конструкторе кубов куб [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] Tutorial и перейдите на вкладку **Ключевые показатели эффективности** .  
     ...
     ![Ключевые показатели эффективности вкладки конструктора кубов](../../2014/tutorials/media/l7-kpi-1.gif "ключевые показатели эффективности вкладки конструктора кубов")  
...
2.  На панели инструментов вкладки **Ключевые показатели эффективности** нажмите кнопку **Создать ключевой показатель** .  
     ...
     ![Пустой шаблон ключевого показателя Эффективности в области отображения](../../2014/tutorials/media/l7-kpi-2.gif "пустой KPI шаблон в области отображения")  
  
3.  В **имя** введите `Reseller Revenue`, а затем выберите **Reseller Sales** в **связанная группа мер** списка.  
...
2.  В **имя** введите `Product Gross Profit Margin`, а затем убедитесь, что  **\<всех >** отображается в **связанная группа мер** списка.  
...
2.  После успешного завершения развертывания нажмите кнопку **Повторное подключение** на панели инструментов вкладки **Ключевые показатели эффективности** , а затем перейдите на панель **Представление браузера**.  
     ...
     `Product Gross Profit Margin` Ключевого показателя Эффективности и отобразится значение Показателя для **Q3 CY 2007** и **Северной Америки** территории продаж.  
