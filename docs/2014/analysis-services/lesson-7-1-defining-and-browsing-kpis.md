...
2.  На панели инструментов вкладки **Ключевые показатели эффективности** нажмите кнопку **Создать ключевой показатель** .  
     ...
     ![Пустой шаблон ключевого показателя эффективности в области экрана](../../2014/tutorials/media/l7-kpi-2.gif "Пустой шаблон ключевого показателя эффективности в области экрана")  
  
3.  В поле **имя** введите `Reseller Revenue`, а затем выберите **Товарооборот посредников** в списке **связанная группа мер** .  
...
2.  В поле **имя** введите `Product Gross Profit Margin` и убедитесь, что в списке **связанная группа мер** отображается **\<All >** .  
...
2.  После успешного завершения развертывания нажмите кнопку **Повторное подключение** на панели инструментов вкладки **Ключевые показатели эффективности** , а затем перейдите на панель **Представление браузера**.  
     ...
     Отобразится `Product Gross Profit Margin` KPI и отобразится значение ключевого показателя эффективности для **Q3 CY 2007** и территории **Северная Америка** Sales.  
