...
2.  Скопируйте следующий пример кода в окно запроса XMLA. Изменение `DatabaseID` значение идентификатора базы данных в текущем соединении.  
