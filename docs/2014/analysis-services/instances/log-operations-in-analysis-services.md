...
|Имя файла или расположение|Тип|Область использования|Включено по умолчанию|  
|---------------------------|----------|--------------|-------------------|  
...
|Файлы sqldmp\<GUID>. mdmp, файлы|Сбои и исключения|Устранение серьезных неполадок|нет|  
