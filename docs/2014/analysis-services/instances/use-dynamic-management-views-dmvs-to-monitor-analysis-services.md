...
##  <a name="benefits-of-using-dmv-queries"></a><a name="bkmk_ben"></a>Преимущества использования запросов динамического административного представления  
...
##  <a name="examples-and-scenarios"></a><a name="bkmk_ex"></a>Примеры и сценарии  
...
##  <a name="query-syntax"></a><a name="bkmk_syn"></a>Синтаксис запроса  
...
##  <a name="tools-and-permissions"></a><a name="bkmk_tools"></a>Средства и разрешения  
...
##  <a name="dmv-reference"></a><a name="bkmk_ref"></a>Ссылка на динамическое административное представление  
...
> [!NOTE]  
>  Если динамическое административное представление недоступно для данного набора строк, сервер возвращает следующую ошибку: " \<schemarowset> тип запроса не распознан сервером". Все остальные ошибки указывают на проблемы с синтаксисом.  
...
|[Набор строк DISCOVER_COMMANDS](https://docs.microsoft.com/analysis-services/instances/analysis-services-schema-rowsets)|Предоставляет сведения по использованию ресурсов и активности для текущей исполняемой команды.|  
...
|[DMSCHEMA_MINING_FUNCTIONS набор строк](https://docs.microsoft.com/bi-reference/schema-rowsets/data-mining/dmschema-mining-functions-rowset)|Возвращает список функций, поддерживаемых алгоритмами интеллектуального анализа данных на сервере.|  
...
|[MDSCHEMA_MEASUREGROUPS набор строк](https://docs.microsoft.com/bi-reference/schema-rowsets/ole-db-olap/mdschema-measuregroups-rowset)|Возвращает список групп мер в текущем соединении.|  
|[Набор строк MDSCHEMA_MEASURES](https://docs.microsoft.com/openspecs/sql_server_protocols/ms-ssas/ab8e721f-9b9c-4ba1-b105-37a5f200d67c)|Возвращает список мер в текущем соединении.|  
