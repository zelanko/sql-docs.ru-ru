 ...
 **Примечание.** Мастер [!INCLUDE[ssCurrent](../../../includes/sscurrent-md.md)] установки устанавливает два различных средства настройки для [!INCLUDE[ssGeminiLong](../../../includes/ssgeminilong-md.md)]. Каждый из них поддерживает разные версии SharePoint.  
 ...
 **Компонент семейства веб-сайтов:**  
