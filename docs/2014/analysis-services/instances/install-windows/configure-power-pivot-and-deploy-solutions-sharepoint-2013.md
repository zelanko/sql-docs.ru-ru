...
##  <a name="run-powerpivot-for-sharepoint-2013-configuration"></a><a name="bkmk_run_configuration_tool"></a>Запуск PowerPivot для SharePoint конфигурации 2013  
...
4.  На вкладке **Параметры** выполните следующие действия.  
    ...
    4.  **Сервер PowerPivot для служб Excel**. Введите имя сервера [!INCLUDE[ssASnoversion](../../../includes/ssasnoversion-md.md)] в режиме интеграции с SharePoint. При развертывании в конфигурации с одиночным сервером последний совпадает с сервером базы данных. `[ServerName]\powerpivot`  
...
1.  Перейдите к URL-адресу сайта, который был создан средством настройки.  
     ...
     Щелкните **Параметры**![SharePoint параметры](https://docs.microsoft.com/analysis-services/analysis-services/media/as-sharepoint2013-settings-gear.gif "Параметры SharePoint")и выберите **Параметры сайта**.  
...
##  <a name="troubleshoot-issues"></a><a name="bkmk_troubleshoot_issues"></a>Устранение неполадок  
