...
1.  [Скачайте](https://go.microsoft.com/fwlink/?LinkID=219108) образец данных для пикника, сопровождающий учебник по Reporting Services. Книгу в этом образце можно использовать для проверки доступа к данным PowerPivot. Извлеките файлы.  
