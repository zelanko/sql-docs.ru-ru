 ...
 **Строка подключения в Excel**  
 ...
 Дополнительные сведения см. в разделе [подключения к данным, источники данных и строки подключения в службах Reporting Services](../../reporting-services/data-connections-data-sources-and-connection-strings-in-reporting-services.md) и [данных проверки подлинности для служб Excel в SharePoint Server 2013](https://go.microsoft.com/fwlink/?LinkId=296350).  
