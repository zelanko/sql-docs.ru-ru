...
# <a name="data-providers-used-for-analysis-services-connections"></a>Поставщики данных, используемые для соединений со службами Analysis Services
 ...
 [Как определить версию поставщиков данных Analysis Services](#bkmk_LibUpdate)  
  
 [Где можно получить новые поставщики данных версии](#bkmk_downloadsite)  
...
##  <a name="bkmk_LibUpdate"></a>Как определить версию поставщиков данных Analysis Services  
...
##  <a name="bkmk_downloadsite"></a>Где можно получить новые поставщики данных версии  
...
##  <a name="bkmk_OLE"></a>Поставщик Analysis Services OLE DB  
