...
|[Обработки](#bkmk_Processing)|Статистические данные, относящиеся к обработке данных.|  
...
###  <a name="bkmk_Connection"></a>Соединен  
...
|Всего запросов|Общее число запросов на подключение.  Поступившие запросы.|  
...
###  <a name="bkmk_MDX"></a>МНОГОМЕРНЫХ выражений  
...
###  <a name="bkmk_Memory"></a>Свободной  
...
###  <a name="bkmk_Processing"></a>Обработки  
...
###  <a name="bkmk_StorageEngineQuery"></a>Запрос к подсистеме хранилища  
...
###  <a name="bkmk_Threads"></a>Многопоточно  
