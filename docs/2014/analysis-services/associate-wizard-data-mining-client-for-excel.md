---
title: Связать мастер (клиент интеллектуального анализа данных для Excel) | Документы Microsoft
ms.custom: ''
ms.date: 12/29/2017
...
# <a name="associate-wizard-data-mining-client-for-excel"></a>Мастер взаимосвязей (клиент интеллектуального анализа данных для Excel)
  ![Мастер взаимосвязей на ленте «Интеллектуальный анализ данных»](media/dmc-associate.gif "связать мастера на ленте «Интеллектуальный анализ данных»")  
  
 Мастер взаимосвязей служит для создания интеллектуального анализа данных модели с помощью [!INCLUDE[msCoName](../includes/msconame-md.md)] алгоритм правил взаимосвязей. Такие модели интеллектуального анализа данных особенно полезны для создания *систем рекомендаций*.  
...
2.  На **Выбор источника данных** , выберите диапазон Excel таблица или данные и нажмите кнопку **Далее**.  
...
4.  Для **элемент**, выберите столбец, содержащий элементы, между которыми нужно найти взаимосвязи.  
...
5.  В **пороговые значения**, можно задать значения, которые управляют или влияет на вывод модели:  
...
8.  В **параметры**, определяют способ работы с моделью после ее завершения:  
    ...
    -   **Обзор**.  Когда модель готова, мастер открывает окно, в котором выводит правила, наборы элементов и диаграмму сети зависимостей с отображением взаимосвязей.  
         ...
         Дополнительные сведения об интерпретации данных в средстве просмотра модели взаимосвязей см. в разделе [просмотр модели правил взаимосвязей](browsing-an-association-rules-model.md).  
