...
# <a name="cube-cells-analysis-services---multidimensional-data"></a>Ячейки куба (службы Analysis Services — многомерные данные)
 ...
 ![Диаграмма куба, определяющая одну ячейку](https://docs.microsoft.com/analysis-services/analysis-services/dev-guide/media/as-cubeintro5.gif "Диаграмма куба, определяющая одну ячейку")  
...
-   Элемента «Посылки».  
 ...
 ![Ячейки третьего и четвертого кварталов элемента второго полугодия](https://docs.microsoft.com/analysis-services/analysis-services/dev-guide/media/as-cubeintro6.gif "Ячейки третьего и четвертого кварталов элемента второго полугодия")  
...
## <a name="empty-cells"></a>Пустые ячейки  
 ...
 ![Диаграмма куба, определяющая пустые ячейки](https://docs.microsoft.com/analysis-services/analysis-services/dev-guide/media/as-cubeintro7.gif "Диаграмма куба, определяющая пустые ячейки")  
