 ...
 **Доступные таблицы**  
 Выбор таблиц, используемых в качестве исходных таблиц для секционирования. 
  **Мастер секционирования** создает одну секцию для каждой таблицы, выбранной из списка **Доступные таблицы**.  
