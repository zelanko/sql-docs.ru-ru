...
-   [Выбор данных и использование образца данных](choosing-data-for-data-mining.md)  
     ...
     Если вы не знакомы с интеллектуальным анализом данных и просто хотите поэкспериментировать с этими средствами, мы рекомендуем воспользоваться книгой с образца данных, которая устанавливается вместе с add-ins. Просмотрев эти данные можно также просмотреть примеры того, как подготовить данные для модели временных рядов или модели взаимосвязей.  
