...
##  <a name="log-file-location"></a><a name="bkmk_filelocation"></a>Расположение файла журнала  
...
##  <a name="modify-diagnostic-logging-levels-for-individual-event-categories"></a><a name="bkmk_modifyloglevels"></a>Изменение уровней ведения журнала диагностики для отдельных категорий событий  
...
##  <a name="how-to-view-sharepoint-log-files"></a><a name="bkmk_how2viewlogfiles"></a>Просмотр файлов журнала SharePoint  
