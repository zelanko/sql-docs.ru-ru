---
title: PowerPivot проверка подлинности и авторизация | Документы Microsoft
ms.custom: ''
ms.date: 03/09/2017
