...
|Участие в доработке|Добавление, изменение, удаление и загрузка книг PowerPivot.<br /><br /> Настройка обновления данных.<br /><br /> Создание новых отчетов или книг на основе книг PowerPivot, расположенных на сайте SharePoint.<br /><br /> Создание сервисных документов данных в библиотеке веб-каналов данных.|  
