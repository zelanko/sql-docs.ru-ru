...
##  <a name="LoadingData"></a>Время ожидания загрузки данных  
...
|Имя|По умолчанию|Допустимые значения|Description|  
|----------|-------------|------------------|-----------------|  
...
##  <a name="ConnectionPool"></a>Пулы подключений  
