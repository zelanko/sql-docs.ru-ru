...
##  <a name="bkmk_twoversions"></a>Две версии средства настройки  
...
###  <a name="bkmk_sum_differences_betweentools"></a>Отличия двух Средства настройки  
