...
4.  В разделе **Обновление данных** задайте для **учетной записи автоматического обновления данных PowerPivot**значение `PowerPivotDataRefresh` и нажмите кнопку **ОК**.  
