...
1.  1.  **SharePoint 2010**: Щелкните **действия сайта** в левом верхнем углу домашней страницы сайта.  
    ...
    1.  **SharePoint 2013**: Щелкните значок параметров ![SharePoint параметры]SharePoint(../media/as-sharepoint2013-settings-gear.gif "Параметры"). Щелкните **Содержание сайта**.  
