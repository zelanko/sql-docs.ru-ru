...
##  <a name="bkmk_ssas"></a>Предоставление Analysis Services административных разрешений для приложений общих служб  
...
##  <a name="bkmk_BISM"></a>Предоставление разрешений на чтение для базы данных табличной модели  
...
##  <a name="bkmk_connect"></a>Создание соединения семантической модели бизнес-аналитики с базой данных табличной модели  
...
##  <a name="bkmk_next"></a>Дальнейшие действия  
