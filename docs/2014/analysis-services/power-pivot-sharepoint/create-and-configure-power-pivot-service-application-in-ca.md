...
##  <a name="determine"></a>Определение необходимости создания нового приложения службы PowerPivot  
...
##  <a name="AssignGSA"></a>Назначение приложения службы PowerPivot веб-приложению  
 После настройки приложения службы PowerPivot можно назначить ее веб-приложению путем добавления в список соединений приложений служб для этого веб-приложения. Это можно осуществить двумя путями:  
  
-   Добавьте его в группу соединения **По умолчанию** . 
  *Группа соединений по умолчанию* — это набор соединений с приложениями служб, которые доступны любому веб-приложению, ссылающемуся на них. В этот список необходимо добавить приложение службы PowerPivot.  
