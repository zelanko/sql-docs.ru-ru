...
9. При необходимости установите флажок для **добавить прокси-сервер для этого приложения службы PowerPivot к группе прокси-сервера по умолчанию для фермы.** . При этом соединение с приложением службы будет добавлено в список группы соединений служб по умолчанию.  
...
6.  В **максимальный размер пула соединения пользователя**, увеличить или уменьшить максимальное число неактивных соединений службы PowerPivot будут создаваться отдельные пулы соединений для каждого пользователя SharePoint, набора данных PowerPivot, измените значение и сочетаний версий.  
