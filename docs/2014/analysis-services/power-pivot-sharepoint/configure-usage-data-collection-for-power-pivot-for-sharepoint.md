 ...
 **В этом разделе:**  
 ...
 [Ограничение времени хранения журнала данных об использовании](#confighist)  
  
 [Определение категорий быстрых, средних и медленных ответов на запросы в целях создания отчетов](#qrh)  
  
 [Укажите частоту передачи статистики запросов в систему сбора данных об использовании](#ttr)  
...
##  <a name="events"></a>Включение сбора данных об использовании и выбор событий, инициирующих сбор данных  
...
5.  Можно также изменить расположение файла журнала. Этот процесс описан в следующем разделе.  
...
##  <a name="configdb"></a>Задать расположение файла журнала  
...
##  <a name="jobs"></a>Настройка заданий таймера, используемых в сборе данных об использовании  
...
2.  Щелкните **проверить определения заданий.** В **Задания таймера** .  
...
##  <a name="confighist"></a>Ограничение времени хранения журнала данных об использовании  
...
##  <a name="qrh"></a>Определение категорий быстрых, средних и медленных ответов на запросы в целях создания отчетов  
...
##  <a name="ttr"></a>Укажите частоту передачи статистики запросов в систему сбора данных об использовании  
...
4.  В меню **действия**выберите пункт **настроить параметры приложения службы**. Откроется страница «Параметры приложения службы PowerPivot».  
...
|-------------|-------------------|----------|-----------------|  
|**Analysis Services событий использования** (подключение, Загрузка, выгрузка, запросы)|\<включенные>|Логическое|Эти значения либо включены, либо выключены.|  
|**Интервал отчетов о запросах**|300 (в секундах)|Целое число|От 1 до любого целого положительного числа. Значение по умолчанию равно 5 минутам.|  
