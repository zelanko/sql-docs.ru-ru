 ...
 **Данные диагностического журнала.** Можно просмотреть данные журнала диагностики SharePoint, связанный с обновлением данных. Сначала проверьте конфигурацию ведения журнала диагностики в разделе **Служба PowerPivot** на странице **Мониторинг** центра администрирования SharePoint. Может потребоваться повысить уровень ведения журнала для «событие наименьшей важности» журнал. Например, временно установите значение **Подробно** и снова выполните операцию обновления данных.  
