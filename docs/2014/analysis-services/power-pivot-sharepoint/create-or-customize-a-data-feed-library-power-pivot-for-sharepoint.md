---
title: Создание или Настройка библиотеки веб-каналов данных (PowerPivot для SharePoint) | Документы Microsoft
ms.custom: ''
ms.date: 03/06/2017
...
-   Визуально определять сервисные документы данных по значкам, что позволяет легко отличать сервисных документов из других документов, хранящихся в той же библиотеке: ![GMNI_IconDataFeed](../media/gmni-icondatafeed.gif "GMNI_IconDataFeed")  
...
5.  Нажмите кнопку **Создать**.  
 ...
 После создания библиотеки с ее помощью можно создавать сервисные документы данных. Дополнительные сведения см. в разделе [веб-каналы данных используйте &#40;PowerPivot для SharePoint&#41;](use-data-feeds-power-pivot-for-sharepoint.md).  
