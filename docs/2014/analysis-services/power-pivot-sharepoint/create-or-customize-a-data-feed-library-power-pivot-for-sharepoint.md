...
-   Визуально определять сервисные документы данных по значкам, что вы можно легко отличать их от других документов, хранящихся в той же библиотеке: ![GMNI_IconDataFeed](../media/gmni-icondatafeed.gif "GMNI_IconDataFeed")  
