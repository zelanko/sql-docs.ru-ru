---
title: Развертывание решений PowerPivot в SharePoint | Документы Microsoft
ms.custom: ''
ms.date: 03/08/2017
...
# <a name="deploy-powerpivot-solutions-to-sharepoint"></a>Развертывание решений PowerPivot в SharePoint
 ...
 [Шаг 2: Развертывание решения PowerPivot веб-приложения центра администрирования](#deployCA)  
...
```  
 ...
 Должно быть возвращено значение **false**. Если это **true**, не может получить доступ к данным PowerPivot с этого веб-приложения.  
...
1.  На сервере, где установлен PowerPivot для SharePoint, откройте консоль управления SharePoint 2010 с помощью **Запуск от имени администратора** параметр.  
...
##  <a name="deployCA"></a> Шаг 2: Развертывание решения PowerPivot веб-приложения центра администрирования  
...
4.  В **развертывание в?**, выберите веб-приложение SharePoint, для которого вы хотите добавить поддержку функции PowerPivot.  
...
3.  Нажмите **Отозвать решение**.  
 ...
 При возникновении проблем развертывания сервера, которые прослеживаются до решения фермы, можно повторно развернуть его, выполнив **восстановления** в средстве настройки PowerPivot. Предпочтительнее выполнять операции восстановления с помощью PowerPivot Configuration Tool, так как они включают меньше шагов. Дополнительные сведения см. в разделе [Настройка или восстановление PowerPivot для SharePoint 2010 &#40;средство настройки PowerPivot&#41;](../configure-repair-powerpivot-sharepoint-2010.md).  
