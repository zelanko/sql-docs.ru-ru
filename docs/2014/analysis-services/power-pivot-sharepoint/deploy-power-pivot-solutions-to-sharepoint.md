...
3.  Нажмите **Отозвать решение**.  
 ...
 При возникновении проблем развертывания сервера, на которые прослеживаются до решения фермы, можно повторно развернуть его, выполнив **восстановления** параметр в средстве настройки PowerPivot. Предпочтительнее выполнять операции восстановления с помощью PowerPivot Configuration Tool, так как они включают меньше шагов. Дополнительные сведения см. в разделе [Настройка или восстановление PowerPivot для SharePoint 2010 &#40;средство настройки PowerPivot&#41;](../configure-repair-powerpivot-sharepoint-2010.md).  
