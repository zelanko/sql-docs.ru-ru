...
##  <a name="pageelements"></a>Использование сведений журнала  
...
|Текущее состояние|В число допустимых значений входят **Запланировано**, **Обновление**, **Выполнено**и **Сбой**.<br /><br /> **Расписание отображается при** первом создании расписания. После первого запуска обновления данных это сообщение о состоянии больше не появляется.<br /><br /> **Обновление** указывает, что выполняется обновление данных. Запрос находится в очереди или выполняется на сервере.<br /><br /> **Успешно** указывает, что последняя операция обновления данных завершена и обновленная книга возвращена в библиотеку SharePoint.<br /><br /> **Сбой** указывает, что последняя операция обновления данных завершилась неудачно. Обновленные данные не были сохранены. Книга содержит те же данные, которые находились в ней до начала обновления данных.|  
