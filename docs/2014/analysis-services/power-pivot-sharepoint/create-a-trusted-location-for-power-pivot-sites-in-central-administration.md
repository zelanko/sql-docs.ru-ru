...
## <a name="prerequisites"></a>предварительные требования  
 ...
 Необходимо знать URL-адрес веб-сайта SharePoint, содержащего галерею PowerPivot или другую библиотеку, в которой хранятся книги. Для получения адреса, откройте сайт с библиотекой, щелкните правой кнопкой мыши **галереи PowerPivot**выберите **свойства**, а затем скопируйте первую часть из адрес (URL), содержащий имя сервера и узел путь.  
