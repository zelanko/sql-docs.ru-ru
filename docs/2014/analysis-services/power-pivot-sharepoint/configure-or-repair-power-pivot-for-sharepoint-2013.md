---
title: Настройка или восстановление PowerPivot для SharePoint 2013 (средство настройки PowerPivot) | Документы Microsoft
ms.custom: ''
ms.date: 06/13/2017
 ...
 **В этом разделе:**  
 ...
 [Использование PowerPivot для средства настройки SharePoint 2013](#bkmk_using)  
...
-   Общие требования для запуска средства настройки [средства настройки PowerPivot](power-pivot-configuration-tools.md).  
  
-   [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] для SharePoint 2013 предпочтительно использовать веб-приложение, настроенное на использования проверки подлинности на основе утверждений. Если средство настройки [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] для SharePoint 2013 создает приложение автоматически, то это приложение настраивается для использования проверки подлинности Windows на основе утверждений. Дополнительные сведения о требования к проверке подлинности см. в разделе [PowerPivot проверки подлинности и авторизации](power-pivot-authentication-and-authorization.md).  
...
##  <a name="bkmk_using"></a> Использование PowerPivot для средства настройки SharePoint 2013  
...
1.  На **запустить** последовательно выберите пункты **все программы**, нажмите кнопку [!INCLUDE[ssCurrentUI](../../includes/sscurrentui-md.md)], нажмите кнопку **средства настройки**, а затем нажмите кнопку **PowerPivot для SharePoint 2013 Конфигурации**.  
...
|**Создание приложения службы PowerPivot**|Имя приложения службы|По умолчанию|[!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] Имя приложения службы, является именем по умолчанию **приложение службы PowerPivot по умолчанию**. В средстве можно указать другое значение.|  
...
## <a name="verify-the-configuration"></a>Проверка конфигурации  
 . В разделе «Проверьте [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] конфигурации» раздела [Настройка PowerPivot и развертывание решений &#40;SharePoint 2013&#41;](../instances/install-windows/configure-power-pivot-and-deploy-solutions-sharepoint-2013.md).  
...
1.  На сайте SharePoint 2013 щелкните значок параметров ![параметры SharePoint](../media/as-sharepoint2013-settings-gear.gif "параметры SharePoint") и нажмите кнопку **параметры сайта**.  
