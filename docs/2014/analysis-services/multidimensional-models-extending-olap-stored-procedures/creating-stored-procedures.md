...
5.  Если для отладочной сборки библиотеки будет использовать для отладки хранимых процедур, выберите **включить отладочные данные** флажок. Дополнительные сведения об отладке хранимых процедур см. в разделе [отладки хранимых процедур](debugging-stored-procedures.md).  
