 ...
 **Выберите реляционных объекты, для которых необходимо установить упреждающее кэширование**  
 Выберите объекты для отслеживания. Данный параметр отображает сетку доступных объектов и их типы, совпадающие с фильтром, заданным на странице **Фильтр** (или все таблицы, если **Фильтр** не установлен), которые пока не отображаются в данной диаграмме.  
