...
-   Все алгоритмы требуют **ключ** столбца. Значения в ключевом столбце должны быть уникальными. Объект **Key Time** столбец является моделей требуется только для прогнозирования или временного ряда. .  
