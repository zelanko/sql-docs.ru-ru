...
## <a name="properties"></a>Свойства  
 ...
 Когда `VertiPaqPagingPolicy` имеет значение 1, то обработки вероятность возникновения ошибок из-за ограничений памяти, поскольку сервер использует подкачку на диск по указанному методу. Установка свойства `VertiPaqPagingPolicy` не гарантирует полное отсутствие ошибок памяти. Ошибки нехватки памяти по-прежнему могут возникать при следующих условиях.  
