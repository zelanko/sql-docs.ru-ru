...
-   `StopLogging` предписывает серверу остановить регистрацию ошибок при достижении предельного количества ошибок, но также разрешить продолжение обработки.  
...
-   `ReportAndStop` Указывает, что сервер для регистрации ошибки и немедленного прерывания обработки, независимо от количества ошибок ключа. Запись, вызвавшая ошибку, пропускается или преобразуется в неизвестный элемент.  
