 ...
 **ErrorLog\KeyErrorLogFile**  
 Это пользовательское имя файла, которое должно иметь расширение LOG и находиться в папке, для которой у учетной записи службы есть разрешения на запись и чтение. Файл журнала будет содержать только ошибки, возникшие во время обработки. Для сбора более подробной информации воспользуйтесь средством «черный ящик».  
