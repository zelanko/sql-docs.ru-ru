---
title: Столбцы данных аудита безопасности | Документация Майкрософт
ms.custom: ''
ms.date: 06/13/2017
...
|**Имя столбца**|**Идентификатор столбца**|**Тип столбца**|**Описание столбца**|  
|---------------------|-------------------|---------------------|----------------------------|  
|EventSubclass|1|1|Подкласс событий предоставляет дополнительные сведения о каждом классе событий:<br /><br /> 1: резервное копирование<br /><br /> 2: восстановление<br /><br /> 3: синхронизация<br /><br /> 4: отсоединение<br /><br /> 5: присоединение<br /><br /> 6: imageLoad<br /><br /> 7: ImageSave|  
|Severity|22|1|Степень серьезности исключения.|  
|Успешно|23|1|1 = успешное завершение.  0 = неуспешное завершение (например, 1 означает, что проверка разрешений проходит, а 0 — что не проходит).|  
|Ошибка|24|1|Номер ошибки для данного события.|  
|ConnectionID|25|1|Уникальный идентификатор соединения.|  
