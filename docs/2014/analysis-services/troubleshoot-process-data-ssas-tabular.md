...
-   [Ограничения для обновляемых источников данных](#bkmk_restrictions)  
  
-   [Ограничения на изменения в источнике данных](#bkmk_rest_changes)  
  
##  <a name="bkmk_how_df_works"></a>Как работает обработка данных  
...
##  <a name="bkmk_det_last_ref"></a>Определение времени последнего обновления данных  
...
##  <a name="bkmk_restrictions"></a>Ограничения для обновляемых источников данных  
...
##  <a name="bkmk_rest_changes"></a>Ограничения на изменения в источнике данных  
...
## <a name="see-also"></a>См. также:  
 ...
 [Изменение существующего соединения с источником данных &#40;табличные&#41;SSAS](edit-an-existing-data-source-connection-ssas-tabular.md)  
