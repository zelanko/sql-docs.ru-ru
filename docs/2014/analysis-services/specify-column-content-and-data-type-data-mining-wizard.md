...
|------------|-----------------|  
|Клавиши|Указать, что столбец содержит уникальный идентификатор для ряда вариантов.|  
...
|Дискретный|Указать, что столбец содержит текст или другие нечисловые значения.|  
