...
2.  На панели инструментов вкладки **Вычисления** нажмите кнопку **Создать вычисляемый элемент**.  
     ...
     ![Форма панели «Выражения вычисления»](../../2014/tutorials/media/l6-calculatedmembers-02.gif "Форма панели «Выражения вычисления»")  
...
6.  В поле **выражение** введите знак плюс (`+`) после **[Measures]. [ Продажи через Интернет — объем продаж]** .  
...
9. В списке **Установленное поведение** установите флажки для показателей **Продажи через Интернет — объем продаж** и **Товарооборот посредников — объем продаж**, а затем нажмите кнопку **ОК**.  
     ...
     ![Панель «заполненные выражения вычисления»](../../2014/tutorials/media/l6-calculatedmembers-03.gif "Панель «заполненные выражения вычисления»")  
...
11. Добавьте новую строку в скрипт вычисления после команды **Calculate;** и перед добавленным скриптом вычислений, а затем введите на отдельной строке скрипта следующий текст:  
    ...
    ```  
     ...
     ![Скрипты на панели «Выражения вычисления»](../../2014/tutorials/media/l6-calculatedmembers-04.gif "Скрипты на панели «Выражения вычисления»")  
...
1.  Убедитесь, `[Total Product Cost]` что на панели **Организатор скриптов** выбрана кнопка **создать вычисляемый элемент** на панели инструментов вкладки **вычисления** .  
...
8.  Добавьте меры **Итоговый коэффициент валовой прибыли**, **Коэффициент валовой прибыли по продажам через Интернет**и **Коэффициент валовой прибыли по товарообороту посредников** в область значений и просмотрите результаты.  
     ...
     ![Область данных, показывающая товарооборот посредников](../../2014/tutorials/media/l6-calculatedmembers-7b.gif "Область данных, показывающая товарооборот посредников")  
