...
2.  На панели инструментов вкладки **Вычисления** нажмите кнопку **Создать вычисляемый элемент**.  
     ...
     ![Вычисление выражения области формы](../../2014/tutorials/media/l6-calculatedmembers-02.gif "выражения вычислений области формы")  
...
6.  В **выражение** введите знак плюс (`+`) после **[меры]. [ Интернет — сумма продаж]**.  
...
9. В списке **Установленное поведение** установите флажки для показателей **Продажи через Интернет — объем продаж** и **Товарооборот посредников — объем продаж**, а затем нажмите кнопку **ОК**.  
     ...
     ![«Выражения вычисления» Populated](../../2014/tutorials/media/l6-calculatedmembers-03.gif "«заполняется выражения вычисления»")  
...
11. Добавьте новую строку в скрипт вычисления после команды **Calculate;** и перед добавленным скриптом вычислений, а затем введите на отдельной строке скрипта следующий текст:  
    ...
    ```  
     ...
     ![Скрипты в панель «выражения вычисления»](../../2014/tutorials/media/l6-calculatedmembers-04.gif "сценариев в панель «выражения вычисления»")  
  
12. На панели инструментов **вычисления** щелкните **представление формы**, убедитесь, что `[Total Sales Amount]` выбран в **Организатор скриптов** , а затем щелкните  **Создать вычисляемый элемент**.  
...
1.  Убедитесь, что `[Total Product Cost]` выбран в **Организатор скриптов** , а затем щелкните **создать вычисляемый элемент** на панели инструментов **вычисления** вкладки.  
...
2.  В **Организатор скриптов** выберите `[Total GPM]`, а затем нажмите кнопку **создать вычисляемый элемент** на панели инструментов **вычисления** вкладки.  
...
8.  Добавьте меры **Итоговый коэффициент валовой прибыли**, **Коэффициент валовой прибыли по продажам через Интернет**и **Коэффициент валовой прибыли по товарообороту посредников** в область значений и просмотрите результаты.  
     ...
     ![Областью данных продаж через торгового посредника](../../2014/tutorials/media/l6-calculatedmembers-7b.gif "панелью данных продаж через торгового посредника")  
