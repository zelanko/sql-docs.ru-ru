---
title: Определение и просмотр перспективы (ru) Документы Майкрософт
ms.custom: ''
ms.date: 06/13/2017
...
3.  Измените имя `Internet Sales`перспективы на .  
...
5.  Снимите флажки для следующих объектов:  
    ...
    -   `Reseller Sales`группа измерения  
...
2.  Измените название новой точки `Reseller Sales`зрения на .  
...
4.  Снимите флажки для следующих объектов:  
    ...
    -   `Internet Sales`группа измерения  
...
2.  Измените название новой точки `Sales Summary`зрения на .  
...
6.  Выберите `Internet Sales` в списке **"Перспектива",** а затем просмотрите измерения и размеры в панели метаданных.  
...
7.  На панели "Метаданные" разверните узел **Меры**.  
     ...
     Обратите внимание, `Internet Sales` что появляется только группа мер, вместе с **Интернет GPM** и **Интернет-продажи Соотношение для всех продуктов** рассчитывается членов.  
