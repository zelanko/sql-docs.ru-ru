...
5.  В строке для **заголовок** для объекта **даты** измерения, введите `Fecha` в **испанский (Испания)** столбца перевода и `Temps` в  **Французский (Франция)** столбца перевода.  
  
6.  В строке для **заголовок** для объекта **название месяца** атрибут, введите `Mes del Año` в **испанский (Испания)** столбца перевода и `Mois d'Année` в **Французский (Франция)** столбца перевода.  
...
1.  Перейдите в конструктор кубов к кубу учебника по [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] и откройте вкладку **Переводы** .  
     ...
     ![Язык в вкладка «Переводы» по умолчанию](../../2014/tutorials/media/l9-translations-5.gif "язык в вкладка «Переводы» по умолчанию")  
...
6.  В строке для **заголовок** для объекта **продажи через Интернет** группы мер, тип `Ventas del lnternet` в **испанский (Испания)** столбца перевода и `Ventes D'Internet` в **французский (Франция)** столбца перевода.  
  
7.  В строке для **заголовок** объекта меры Internet Sales-Sales Amount, тип `Cantidad de las Ventas del Internet` в **испанский (Испания)** столбца перевода и `Quantité de Ventes d'Internet` в **французский () Франция)** столбца перевода.  
...
5.  На панели инструментов выберите в списке **Язык** значение **испанский (Испания)** .  
     ...
     ![Панель «метаданные» Repopulated](../../2014/tutorials/media/l9-translations-6.gif "Repopulated панель «метаданные»")  
  
6.  На панели метаданных щелкните правой кнопкой мыши `Cantidad de las Ventas del Internet` , а затем выберите **добавить запрос**.  
  
7.  В панели «Метаданные» разверните узел `Fecha`, разверните **Fecha.Calendar Date**, щелкните правой кнопкой мыши **Fecha.Calendar Date**, а затем выберите **добавить в фильтр**.  
...
9. На панели метаданных щелкните правой кнопкой мыши **Mes del Ano** и выберите команду **Добавить в запрос**.  
     ...
     ![Названия месяцев на испанском языке в панель «данные»](../../2014/tutorials/media/l9-translations-7.gif "названия месяцев на испанском языке в области данных")  
...
## <a name="next-lesson"></a>Следующее занятие  
 [Урок 10. Определение ролей администрирования](../analysis-services/lesson-10-defining-administrative-roles.md)  
