...
1.  Перейдите в конструктор кубов к кубу учебника по [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] и откройте вкладку **Переводы** .  
     ...
     ![Язык в вкладка «Переводы» по умолчанию](../../2014/tutorials/media/l9-translations-5.gif "Default language в вкладка «Переводы»")  
...
6.  В строке для **заголовок** для объекта **Интернет-продажи** группы мер, тип `Ventas del lnternet` в **испанский (Испания)** столбца перевода и `Ventes D'Internet` в **французский (Франция)** столбца перевода.  
  
7.  В строке для **заголовок** объект меры Internet Sales-Sales Amount, тип `Cantidad de las Ventas del Internet` в **испанский (Испания)** столбца перевода и `Quantité de Ventes d'Internet` в **французский () Франция)** столбца перевода.  
...
7.  В панели «Метаданные» разверните `Fecha`, разверните **Fecha.Calendar Date**, щелкните правой кнопкой мыши **Fecha.Calendar Date**, а затем выберите **добавить в фильтр**.  
...
9. На панели метаданных щелкните правой кнопкой мыши **Mes del Ano** и выберите команду **Добавить в запрос**.  
     ...
     ![Названия месяцев на испанском языке в панель «данные»](../../2014/tutorials/media/l9-translations-7.gif "названия месяцев на испанском языке в панель «данные»")  
