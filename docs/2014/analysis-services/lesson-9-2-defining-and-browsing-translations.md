...
7.  На панели метаданных разверните узел `Fecha`, разверните **Fecha. Calendar Дата**, щелкните правой кнопкой мыши **Fecha. Календарная дата**, а затем выберите **Добавить в фильтр**.  
