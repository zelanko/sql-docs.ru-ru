...
5.  В строке для объекта **Caption** для измерения **Date** введите `Fecha` **Испанский (Испания)** перевод и `Temps` в столбце перевод на **французский (Франция)** .  
...
7.  На панели метаданных разверните узел `Fecha` **Fecha. Calendar Date**, щелкните правой кнопкой мыши **Fecha. Calendar Date**и выберите **Добавить в фильтр**.  
