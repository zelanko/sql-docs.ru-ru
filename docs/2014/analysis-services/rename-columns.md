---
title: Урок 3. Переименование столбцов | Документация Майкрософт
ms.custom: ''
ms.date: 06/13/2017
...
2.  Дважды щелкните **CustomerKey** столбец имени, а затем введите `Customer  Id`, и нажмите клавишу ВВОД.  
    ...
    > [!TIP]  
    >  Вы также можете переименовать столбец в **имя столбца** свойство в столбце **свойства** окне или в представлении диаграммы.  
...
## <a name="next-step"></a>Следующий шаг  
 Чтобы продолжить работу с этим учебником, перейдите к следующему занятию: [Занятие 4. Пометить как таблицу дат](lesson-3-mark-as-date-table.md).  
