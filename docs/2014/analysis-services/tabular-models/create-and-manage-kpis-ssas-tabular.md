...
-   [Удаление ключевого показателя эффективности без сохранения базовой меры](#bkmk_delete_KPI)  
...
###  <a name="bkmk_delete_KPI"></a>Удаление ключевого показателя эффективности без сохранения базовой меры  
...
## <a name="see-also"></a>См. также:  
 ...
 [Создание мер и управление ими &#40;табличные&#41;SSAS](create-and-manage-measures-ssas-tabular.md)  
