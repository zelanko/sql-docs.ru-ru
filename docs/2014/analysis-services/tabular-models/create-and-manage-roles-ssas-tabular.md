...
4.  В поле **Разрешения** щелкните стрелку вниз и выберите один из следующих типов разрешения.  
    ...
    |**Процесс**|Участники могут выполнять операции обработки и массовой обработки, но не могут изменять схему шаблона и запрашивать данные.|  
    |**Административ**|Члены могут вносить изменения в схему модели и просматривать все данные.|  
