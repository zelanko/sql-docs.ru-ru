...
|[Выражения анализа данных &#40;DAX&#41; ссылки](/dax/data-analysis-expressions-dax-reference)|Этот раздел содержит подробное описание синтаксиса языка выражений анализа данных (DAX), операторов и функций.|  
