 ...
 **Общие сведения о учетных данных на стороне сервера**  
...
|Параметр|ImpersonationMode<sup>1</sup>|Description|  
|------------|-----------------------------------|-----------------|  
