...
> [!NOTE]  
>  В следующем подразделе рассматриваются способы оптимизации макета с точки зрения определенного формата представления.  [Оптимизация для конкретных макетов](#bkmk_optimizeforlayout).  
...
## <a name="setting-the-row-identifier-property"></a>Установка свойства «Идентификатор строки».  
 Идентификатор строки в таблице указывает на единичный столбец, который содержит только уникальные значения и не содержит пустых значений. Позволяет изменить группирование таким группы не основан на композиции поле строки, а также на основе фиксированного столбца, который всегда используется для уникальной идентификации строки, вне зависимости от полей, используемых в конкретном макете отчета используется свойство идентификатора строки.  
 ...
 В [!INCLUDE[ssCrescent](../../includes/sscrescent-md.md)] задание идентификатора строки включает следующие дополнительные свойства: **Сохранять уникальные строки** свойство, **метка по умолчанию** свойство, и **изображение по умолчанию** свойство.  
...
### <a name="tables-are-missing-one-or-more-rows"></a>В таблицах отсутствует одна или несколько строк.  
 ...
 ![Группа по умолчанию Консолидация 2 в 1](../media/ssas-jonyang-norowid.gif "группу по умолчанию Консолидация 2 в 1")  
 ...
 **Ранее: Группирование по умолчанию по полям матрицы**  
 ...
 **После: Группирование по идентификатору строки**  
 ...
 **Ранее: Группирование по умолчанию по полям диаграммы**  
 ...
 **После: Группирование по идентификатору строки (идентификатор строки становится осью диаграммы)**  
