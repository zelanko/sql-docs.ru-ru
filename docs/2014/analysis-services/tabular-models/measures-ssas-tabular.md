...
##  <a name="bkmk_properties"></a>Свойства меры  
...
|Раздел|Description|  
|-----------|-----------------|  
|[Создание мер и управление ими &#40;табличные&#41;SSAS](measures-ssas-tabular.md)|Содержит описание порядка создания мер и управления мерами с помощью сетки мер в конструкторе моделей.|  
