...
|Н/Д|Пусто|Тип данных с пустыми значениями в DAX представляет и заменяет пустые значения NULL в SQL. Пустое значение создается с помощью функции BLANK, а проверяется с помощью логической функции ISBLANK.|  
 ...
 Ошибка базы данных в памяти: столбец "\<имя столбца>" таблицы "\<имя таблицы>" содержит значение "7976931348623157E e + 308", которое не поддерживается. Операция была отменена.  
...
||||||  
|-|-|-|-|-|  
|Оператор (+)|INTEGER|CURRENCY|real|Дата и время|  
|INTEGER|INTEGER|CURRENCY|real|Дата и время|  
|CURRENCY|CURRENCY|CURRENCY|real|Дата и время|  
|real|real|real|real|Дата и время|  
...
||||||  
|-|-|-|-|-|  
|Оператор (/)<br /><br /> (Строка/столбец)|INTEGER|CURRENCY|real|Дата и время|  
...
||||||  
|-|-|-|-|-|  
|Оператор сравнения|INTEGER|CURRENCY|real|Дата и время|  
|INTEGER|INTEGER|CURRENCY|real|real|  
|CURRENCY|CURRENCY|CURRENCY|real|real|  
|real|real|real|real|real|  
