...
##  <a name="bkmk_implicit"></a>Явное и явное преобразование типов данных в формулах DAX  
...
##  <a name="bkmk_hand_blanks"></a>Обработка пробелов, пустых строк и нулевых значений  
