...
## <a name="see-also"></a>См. также  
 [Анализ табличной модели в Excel &#40;табличные службы SSAS&#41;](analyze-a-tabular-model-in-excel-ssas-tabular.md)   
