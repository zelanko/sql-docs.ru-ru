...
|Задача|Description|  
|----------|-----------------|  
|[Создание секций табличной модели и управление ими &#40;табличных&#41;SSAS](create-and-manage-tabular-model-partitions-ssas-tabular.md)|Содержит описание обработки секций и управления ими в развернутых табличных моделях в среде [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)].|  
|[Обработка секций табличной модели &#40;табличных&#41;SSAS](process-tabular-model-partitions-ssas-tabular.md)|Содержит описание обработки секций в развернутых табличных моделях с помощью [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)].|  
