...
|-----------|--------------------|  
|Region|= Регион [Страна] = «США»|  
|ProductCategory|= ProductCategory [имя] = «Велосипеды»|  
...
|Компонент|Описание|  
|--------------|-----------------|  
|[USERNAME, функция &#40;DAX&#41;](/dax/username-function-dax)|Возвращает значение вида «домен\имя пользователя» для пользователя, который находится в системе в настоящий момент.|  
|[Функция CUSTOMDATA &#40;DAX&#41;](/dax/customdata-function-dax)|Возвращает свойство CustomData в строке подключения.|  
...
## <a name="see-also"></a>См. также  
 ...
 [Функция CUSTOMDATA &#40;DAX&#41;](/dax/customdata-function-dax)  
