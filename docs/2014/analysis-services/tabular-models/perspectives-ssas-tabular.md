...
-   [Тестирование перспектив](#bkmk_testpersp)  
...
##  <a name="bkmk_testpersp"></a>Тестирование перспектив  
...
|Раздел|Description|  
|-----------|-----------------|  
|[Создание и управление перспективами &#40;табличные&#41;SSAS](perspectives-ssas-tabular.md)|Содержит описание порядка создания и управления перспективами с помощью диалогового окна «Перспективы» в конструкторе моделей.|  
