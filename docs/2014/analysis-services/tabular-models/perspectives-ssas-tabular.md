...
|Раздел|Описание|  
|-----------|-----------------|  
|[Создание и управление перспективами &#40;табличные службы SSAS&#41;](perspectives-ssas-tabular.md)|Содержит описание порядка создания и управления перспективами с помощью диалогового окна «Перспективы» в конструкторе моделей.|  
