...
>   
>  Существует ограничение в 10 000 строк, которые можно добавить к данным, внедренным в модель. При импорте модели из PowerPivot и отображается ошибка «данные были усечены. Вставленные таблицы не может содержать более 10000 строк» необходимо исправить модель PowerPivot, перемещая внедренные данные в другой источник данных, например таблицу SQL Server и затем повторно импортировать.  
