...
3.  В диалоговом окне **Обработка секций** в списке **режим** выберите один из следующих режимов обработки:  
...
## <a name="see-also"></a>См. также:  
 ...
 [Создание секций табличной модели и управление ими &#40;табличных&#41;SSAS](create-and-manage-tabular-model-partitions-ssas-tabular.md)  
