...
-   [С помощью среды SSMS для управления базой данных рабочей области](#bkmk_use_ssms)  
...
|Раздел|Описание|  
|-----------|-----------------|  
|[Свойства модели &#40;табличные службы SSAS&#41;](model-properties-ssas-tabular.md)|Предоставляет описания и шаги настройки свойств базы данных рабочей области модели.|  
