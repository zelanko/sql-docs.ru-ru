...
|**Резервная копия данных**|Не сохранять копию на диск|Указывает, сохраняется ли резервная копия данных модели в файле резервной копии. Обратите внимание, что по умолчанию для этого свойства можно изменить на странице моделирования данных в параметрах сервера анализа данных в диалоговом окне параметрах. Возможны следующие варианты значения этого параметра.<br /><br /> **Сохранять на диск** — резервная копия данных модели сохраняется на диске. При сохранении модели данные также будут сохранены в файле резервной копии (ABF). При выборе этого параметра время сохранения и загрузки модели может увеличиться.<br /><br /> **Не сохранять на диск** — резервная копия данных модели на диске не сохраняется. Этот параметр сведет к минимуму время сохранения и загрузки модели.|  
...
1.  В [!INCLUDE[ssBIDevStudioFull](../../includes/ssbidevstudiofull-md.md)]в **обозревателе решений**, нажмите кнопку **Model.bim** файла.  
