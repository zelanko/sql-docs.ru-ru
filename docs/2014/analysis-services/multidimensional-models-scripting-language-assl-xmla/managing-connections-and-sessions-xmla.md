...
-   Поддержка транзакций в контексте XMLA обеспечивается специфический для поставщика команды, отправляемые с [Execute](../xmla/xml-elements-methods-execute.md) метод.  
