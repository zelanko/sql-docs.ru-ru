 ...
 *Частота*,*набор данных*[,*набор данных*...]  
...
|------------|---------------|-----------------|  
|Действия|Целое число|Число шагов, выполняемых командой перед возвратом управления клиентскому приложению.|  
...
|Агрегаты|Long integer|Число статических схем, определенных командой перед возвратом управления клиентскому приложению.|  
