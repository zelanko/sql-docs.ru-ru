...
1.  С помощью функции "Автосумма" создайте и назовите следующие меры:  
    ...
    |Имя меры|Столбец|Автосумма (∑)|Формула|  
    |------------------|------------|-------------------|-------------|  
    ...
    |Общая маржа для заказов в Интернете|Margin|SUM|=SUM([Margin])|  
