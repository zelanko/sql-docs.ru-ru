...
# <a name="create-a-custom-member-formula-dimension-business-intelligence-wizard"></a>Создание нестандартной формулы элемента (измерение) (мастер бизнес-аналитики)
  Используйте страницу **Создание нестандартной формулы элемента** для выбора измерения, с которым мастер бизнес-аналитики свяжет атрибуты со столбцами нестандартной формулы элемента — столбцы, содержащие инструкции многомерных выражений, определяющие значения элементов для этого атрибута.  
