...
> [!NOTE]  
>  Табличные модели имеют дополнительные уровни совместимости базы данных, неприменимые к многомерным моделям. Для многомерных моделей уровень совместимости `1103` не существует. Дополнительные сведения о `1103` табличных решениях см. [в статье новые возможности табличной модели в SQL Server 2012 с пакетом обновления 1 (SP1) и уровень совместимости](https://go.microsoft.com/fwlink/?LinkId=301727) .  
...
2.  Использование связанных измерений из другой базы данных требует одинакового уровня совместимости. Например, если необходимо использовать связанное [!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)] измерение из базы данных в [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] базе данных, необходимо перенести [!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)] базу данных на [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] сервер и установить уровень совместимости. `1100`  
