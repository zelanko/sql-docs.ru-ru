...
> [!NOTE]  
>  Табличные модели имеют дополнительные уровни совместимости базы данных, неприменимые к многомерным моделям. Для многомерных моделей уровень совместимости `1103` не существует. См. в разделе [новые возможности для табличной модели в SQL Server 2012 с пакетом обновления 1 и уровень совместимости](https://go.microsoft.com/fwlink/?LinkId=301727) Дополнительные сведения о `1103` для табличных решений.  
