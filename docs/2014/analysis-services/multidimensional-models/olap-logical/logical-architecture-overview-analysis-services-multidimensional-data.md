...
### <a name="aggregates"></a>Статистические вычисления  
 ...
 ![Схема мер, организованная по измерению времени](../../dev-guide/media/cubeintro2.gif "Схема мер, организованная по измерению времени")  
