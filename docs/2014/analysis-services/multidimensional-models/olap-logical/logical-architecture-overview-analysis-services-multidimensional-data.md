...
# <a name="logical-architecture-overview-analysis-services---multidimensional-data"></a>Обзор логической архитектуры (службы Analysis Services — многомерные данные)
 ...
 В этом разделе рассматривается основная архитектура служб Analysis Services, применяемая в режиме многомерных данных и интеллектуального анализа данных. Дополнительные сведения о других режимах см. в разделе [табличное моделирование &#40;табличные службы SSAS&#41; ](../../tabular-models/tabular-models-ssas.md) и [сравнение табличных и многомерных решений &#40;SSAS&#41;](../../../analysis-services/comparing-tabular-and-multidimensional-solutions-ssas.md).  
...
## <a name="basic-architecture"></a>Базовая архитектура  
 ...
 ![Связи между объектами AMO во время выполнения](../../../analysis-services/dev-guide/media/amo-runningobjects.gif "связи между объектами AMO во время выполнения")  
...
## <a name="object-inheritance"></a>Наследование объектов  
 Объектная модель ASSL содержит много повторяющихся групп элементов. Например, группа элементов «`Dimensions` содержат `Hierarchies`,» определяет иерархию измерений элемента. И в кубах `Cubes`, и в группах мер `MeasureGroups` содержится группа элементов «`Dimensions` contain `Hierarchies`».  
...
## <a name="example"></a>Пример  
 ...
 ![Пример куба 1](../../../analysis-services/dev-guide/media/cubeintro1.gif "пример куба 1")  
...
### <a name="aggregates"></a>Статистические вычисления  
 ...
 ![Диаграмма мер, упорядоченных по измерению времени](../../../analysis-services/dev-guide/media/cubeintro2.gif "Диаграмма мер, упорядоченных по измерению времени")  
...
|||Четвертый квартал|7818|2126|5692|29-дек-99|22-дек-99|29-дек-99|  
 ...
 После определения куба можно создать новые агрегаты или изменить существующие агрегаты, установив параметры наподобие того, вычисляются ли агрегаты предварительно во время обработки или же вычисляются во время запроса. **См. также:**[агрегаты и статистические схемы](../../multidimensional-models-olap-logical-cube-objects/aggregations-and-aggregation-designs.md).  
