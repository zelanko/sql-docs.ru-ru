...
|||Четвертый квартал|7818|2126|5692|29-дек-99|22-дек-99|29-дек-99|  
 ...
 После определения куба можно создать новые агрегаты или изменить существующие агрегаты, установив параметры наподобие того, вычисляются ли агрегаты предварительно во время обработки или же вычисляются во время запроса. **Связанная Тема:** [Агрегаты и](../../multidimensional-models-olap-logical-cube-objects/aggregations-and-aggregation-designs.md)статистические схемы.  
