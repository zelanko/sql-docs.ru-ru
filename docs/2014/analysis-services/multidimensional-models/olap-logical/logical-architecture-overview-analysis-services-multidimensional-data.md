...
## <a name="basic-architecture"></a>Базовая архитектура
 ...
 Объекты сервера каждый экземпляр рассматривается [!INCLUDE[ssASnoversion](../../../includes/ssasnoversion-md.md)] как другой объект сервера в объектах AMO; каждый экземпляр подключается к <xref:Microsoft.AnalysisServices.Server> объекту с помощью другого соединения. Каждый объект сервера содержит один или несколько источников данных, представлений источников данных и объектов баз данных, а также сборки и роли безопасности.
