...
## <a name="example"></a>Пример  
 ...
 ![Пример Куба 1](https://docs.microsoft.com/analysis-services/analysis-services/dev-guide/media/cubeintro1.gif "Пример Куба 1")  
...
### <a name="aggregates"></a>Статистические вычисления  
 ...
 ![Схема мер, организованная по измерению времени](https://docs.microsoft.com/analysis-services/analysis-services/dev-guide/media/cubeintro2.gif "Схема мер, организованная по измерению времени")  
