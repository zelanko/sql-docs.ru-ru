...
-   В столбце **измерение** панели **Фильтр** щелкните ** \<выбрать измерение>** и выберите измерение из списка, а затем щелкните ** \<выбрать иерархию>** в столбце **Иерархия** и выберите иерархию из списка.  
  
 Задав иерархию, укажите оператор и критерий фильтра. В следующей таблице описаны операторы и критерии фильтра.  
  
|Оператор|Критерий фильтра|Description|  
|--------------|-----------------------|-----------------|  
...
|Входящий|Один или несколько именованных наборов|Значения должны входить в указанный именованный набор.<br /><br /> (Поддерживается только для иерархий атрибутов.)|  
