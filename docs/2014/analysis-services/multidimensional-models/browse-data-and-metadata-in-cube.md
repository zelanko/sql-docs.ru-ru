...
-   В **измерения** столбец **фильтра** области, нажмите кнопку  **\<выберите измерение >** и выберите измерение из списка, а затем нажмите кнопку  **\<Выберите иерархию >** в **иерархии** столбца и выберите иерархию из списка.  
...
|In|Один или несколько именованных наборов|Значения должны входить в указанный именованный набор.<br /><br /> (Поддерживается только для иерархий атрибутов.)|  
