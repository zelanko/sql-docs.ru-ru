...
-   В **измерения** столбец **фильтра** панели щелкните  **\<выберите измерение >** и выберите измерение из списка, а затем нажмите кнопку  **\<Выберите иерархию >** в **иерархии** столбца и выберите иерархию из списка.  
