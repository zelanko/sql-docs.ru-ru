...
# <a name="view-attributes-in-dimension-designer"></a>Просмотр атрибутов в конструкторе измерений
 ...
 Чтобы просмотреть атрибуты в измерении, откройте измерение в конструкторе измерений. На панели **Атрибуты** вкладки **Структура измерения**  конструктора показаны атрибуты измерения. Можно выбрать представление списка, дерева или сетки, выбрав пункт **Показать атрибуты в** на **измерения** меню [!INCLUDE[ssBIDevStudioFull](../../includes/ssbidevstudiofull-md.md)] и затем выбрав одну из команд, представленных в следующей таблице.  
...
|**Сетка**|Отобразите атрибуты в виде сетки. Для просмотра свойств атрибута щелкните строку в сетке.  Это представление используется для создания и настройки атрибутов. Сетка содержит следующие столбцы.<br /><br /> **Имя**: показывает значение **имя** свойства. Для изменения параметра введите другое имя.<br /><br /> **Использование**: Указывает, является ли атрибут Regular, ключ, Parent или AccountType. Для выбора другого параметра щелкните значение в этом столбце.<br /><br /> **Тип**: определяет категорию бизнес-аналитики для атрибута. Щелкните ячейку, чтобы выбрать другой параметр.<br /><br /> **Ключевой столбец**: тип данных OLE DB для **KeyColumn** атрибута. Этот столбец нельзя изменять.<br /><br /> **Имя столбца**: Указывает, является ли **NameColumn** Настройка свойства атрибута является один и тот же столбец значение по **KeyColumn** свойство. Этот столбец нельзя изменять.|  
