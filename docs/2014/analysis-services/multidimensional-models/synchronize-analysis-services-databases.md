...
# <a name="synchronize-analysis-services-databases"></a>Синхронизация баз данных служб Analysis Services
  [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)]включает функцию синхронизации базы данных, которая делает [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] две базы данных эквивалентными, копируя данные и метаданные базы данных на исходном сервере в базу данных на целевом сервере. Используйте функцию синхронизации баз данных для выполнения следующих задач:  
...
3.  Укажите исходный сервер и базу данных-источник. На странице «Выбор базы данных для синхронизации» в полях **Исходный сервер** и **База данных-источник**введите имя исходного сервера и базы данных-источника. Например, при выполнении развертывания из тестовой среды на рабочий сервер источником является база данных на промежуточном сервере.  
     ...
     **Целевой сервер** отображает имя [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] экземпляра, с которым синхронизируются данные и метаданные из базы данных, выбранной в базе данных- **источнике** .  
