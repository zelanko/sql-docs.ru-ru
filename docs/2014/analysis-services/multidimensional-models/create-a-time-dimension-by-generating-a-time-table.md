...
-   **Создание таблицы времени в источнике данных** Выберите этот параметр, если у вас есть разрешение на создание объектов в базовом источнике данных. Мастер создаст таблицу времени и сохранит ее в источнике данных. Затем на основе этой таблицы времени мастер создает измерение времени.  
  
-   **Создание таблицы времени на сервере** Выберите этот параметр, если у вас нет разрешения на создание объектов в базовом источнике данных. Мастер создаст таблицу времени и сохранит ее не в источнике данных, а на сервере. (Измерение, созданное из таблицы времени на сервере, называется *серверным измерением времени*.) Серверное измерение времени мастер создает на основе этой таблицы времени.  
