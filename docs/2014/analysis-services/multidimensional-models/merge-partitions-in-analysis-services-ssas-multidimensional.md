...
##  <a name="bkmk_prereq"></a>Необходимость  
...
##  <a name="bkmk_fact"></a>Особые соображения для секций, сегментированных по таблице фактов или именованным запросам  
...
##  <a name="bkmk_partitionSSMS"></a>Слияние секций с помощью SSMS  
...
##  <a name="bkmk_partitionsXMLA"></a>Слияние секций с помощью XMLA  
