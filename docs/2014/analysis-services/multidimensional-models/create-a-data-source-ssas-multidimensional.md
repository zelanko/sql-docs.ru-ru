...
4.  Для подключения выберите поставщик платформы [!INCLUDE[msCoName](../../includes/msconame-md.md)] .NET Framework или собственный поставщик OLE DB.  
     ...
     Для доступа к другим источникам данных вы можете выбрать другой поставщик. Список поставщиков и реляционных баз данных, поддерживаемых [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)], см. в разделе [Источники данных, &#40;поддерживающие многомерные&#41;службы SSAS](supported-data-sources-ssas-multidimensional.md).  
