...
## <a name="selecting-a-time-hierarchy"></a>Выбор иерархии времени  
 ...
 После выбора иерархии времени выберите в списке **Доступные вычисления времени** вычисления, применяемые к иерархии. Указываемых вычислений зависит от уровней в иерархии, а также на `Type` значение свойства для атрибута каждого уровня. Например, иерархия «Годы» поддерживает вычисления «Год к дате» и «Рост за год», в то время как иерархия «Кварталы» такие вычисления не поддерживает.  
