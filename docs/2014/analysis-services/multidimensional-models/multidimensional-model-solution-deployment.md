...
##  <a name="bkmk_considerations"></a>Рекомендации по развертыванию  
...
|Рассматриваемый вопрос|Ссылка на дополнительные сведения|  
|-------------------|------------------------------|  
...
|Нужно ли предоставлять пользователям доступ к данным служб [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] через Интернет?|[Настройка доступа по протоколу HTTP к Analysis Services на службы IIS &#40;IIS&#41; 8,0](../instances/configure-http-access-to-analysis-services-on-iis-8-0.md)|  
...
|Нужно ли развертывать объекты в распределенной среде при помощи связанных объектов или удаленных секций?|[Создание и управление локальной секцией &#40;Analysis Services&#41;](create-and-manage-a-local-partition-analysis-services.md), [Создание и Управление удаленной секцией &#40;Analysis Services](create-and-manage-a-remote-partition-analysis-services.md)&#41;и [связанных групп мер](linked-measure-groups.md).|  
|Как вы будете обеспечивать безопасность данных служб [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] ?|[Авторизация доступа к объектам и операциям &#40;Analysis Services&#41;](authorizing-access-to-objects-and-operations-analysis-services.md)|  
