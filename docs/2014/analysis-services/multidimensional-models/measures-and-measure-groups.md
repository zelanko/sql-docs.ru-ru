...
|**Ссылка**|**Описание**|  
|--------------|---------------------|  
|[Создание меры и группы мер в многомерных моделях](create-measures-and-measure-groups-in-multidimensional-models.md)|Выберите один из способов создания мер и групп мер.|  
...
## <a name="see-also"></a>См. также  
 ...
 [Создание меры и группы мер в многомерных моделях](create-measures-and-measure-groups-in-multidimensional-models.md)  
