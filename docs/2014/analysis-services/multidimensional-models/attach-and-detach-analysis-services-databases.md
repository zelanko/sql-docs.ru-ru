...
> [!IMPORTANT]  
>  Для выполнения необходимы права администратора базы данных сервера или `Detach` команды.  
