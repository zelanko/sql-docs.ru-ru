...
-   Командный язык, предназначенный для отправки экземпляру служб Analysis Services команд-действий, например `Create`, `Alter` или `Process`. Этот язык рассматривается в [XML для аналитики &#40;XMLA&#41; ссылки](../../xmla/xml-for-analysis-xmla-reference.md).  
...
## <a name="see-also"></a>См. также  
 ...
 [Соглашения XML языка ASSL](assl-xml-conventions.md)   
