...
## <a name="dimension-structure"></a>Структура измерения  
 ...
 Атрибуты в серверном измерении времени имеют особую привязку атрибута времени. [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)]использует типы атрибутов, связанные с датами, например год, месяц или день, для определения элементов атрибутов в измерении времени.  
