...
##  <a name="bkmk_edit"></a>Изменение или удаление диаграммы  
...
##  <a name="bkmk_arrangeobjects"></a>Упорядочивание объектов в диаграмме  
...
##  <a name="bkmk_preserve"></a>Сохранить размещение объектов  
