---
title: Создание и управление ими удаленной секции (службы Analysis Services) | Документация Майкрософт
ms.custom: ''
ms.date: 06/13/2017
...
1.  На главном сервере: В обозревателе решений щелкните правой кнопкой мыши имя решения и выберите **свойства**. В диалоговом окне **Свойства** щелкните **Свойства конфигурации**, **Развертывание**, **Сервер** и укажите имя главного сервера.  
  
2.  На подчиненном сервере: В обозревателе решений щелкните правой кнопкой мыши имя решения и выберите **свойства**. В диалоговом окне **Свойства** щелкните **Свойства конфигурации**, **Развертывание**, **Сервер** и укажите имя подчиненного сервера.  
...
1.  На подчиненном сервере: В [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)], щелкните правой кнопкой мыши подключенный [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] экземпляра в обозревателе объектов и выберите **свойства**. Установите для параметров **Feature\LinkToOtherInstanceEnabled** и **Feature\LinkFromOtherInstanceEnabled** значение **True**.  
  
2.  На подчиненном сервере: Перезапустите сервер, щелкнув правой кнопкой мыши имя сервера в обозревателе объектов и выбрав **перезапустите**.  
  
3.  На главном сервере: В [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)], щелкните правой кнопкой мыши подключенный [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] экземпляра в обозревателе объектов и выберите **свойства**. Установите для параметров **Feature\LinkToOtherInstanceEnabled** и **Feature\LinkFromOtherInstanceEnabled** значение **True**.  
  
4.  На главном сервере: Чтобы перезапустить сервер, щелкните правой кнопкой мыши имя сервера в обозревателе объектов и выберите **перезапустите**.  
...
1.  На подчиненном сервере: Щелкните правой кнопкой мыши хранилище базы данных db-storage, укажите **скрипт для базы данных** | **используя ALTER** | **новое окно редактора запросов**.  
...
1.  На главном сервере: Откройте куб в конструкторе кубов и щелкните **секций** вкладки. Разверните группу мер. Нажмите кнопку **Создать секцию** , если группа мер уже настроена на работу с несколькими секциями, или нажмите кнопку обзора (. . ) в столбце Source, чтобы изменить текущую секцию.  
...
5.  На главном сервере: Щелкните правой кнопкой мыши имя куба в обозревателе решений, выберите **процесс** и проведите полную обработку куба.  
