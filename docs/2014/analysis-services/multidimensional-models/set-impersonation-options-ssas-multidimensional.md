...
##  <a name="impersonation-options"></a><a name="bkmk_options"></a> Параметры олицетворения  
 ...
 **Использовать указанные имя пользователя и пароль**  
 Выберите этот параметр, чтобы [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] объект использовал учетные данные безопасности учетной записи пользователя Windows, указанной в следующем формате: *\<Domain name>***\\***\<User account name>* .  
