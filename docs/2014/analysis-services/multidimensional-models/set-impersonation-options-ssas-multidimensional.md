...
-   Диалоговое окно **Свойства базы данных** с помощью свойства "сведения об олицетворении источника данных".  
  
-   Диалоговое окно **Свойства источника данных** через свойство сведения об олицетворении.  
  
-   Диалоговое окно « **Свойства сборки** » через свойство «сведения об олицетворении».  
 ...
 **Использовать указанные имя пользователя и пароль**  
 Выберите этот параметр [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] , чтобы объект использовал учетные данные безопасности учетной записи пользователя Windows, указанной в следующем формате: * \<доменное ***\\*** \<имя>имя учетной записи пользователя>*.  
...
> [!NOTE]  
>  При обработке модели интеллектуального анализа данных из куба могут возникать ошибки, если учетная запись службы не имеет разрешений администратора на экземпляре служб Analysis Services. Дополнительные сведения см. в статье [Mining Structure: Issue while Processing when DataSource is OLAP Cube](https://go.microsoft.com/fwlink/?LinkId=251610)(Структура интеллектуального анализа данных: проблема при обработке, когда источником данных является куб OLAP).  
 ...
 **Источники данных — параметр inherit**  
...
## <a name="see-also"></a>См. также:  
 ...
 [Задание свойств источника данных &#40;многомерных&#41;SSAS](set-data-source-properties-ssas-multidimensional.md)   
 [Сценарии развертывания DirectQuery &#40;табличных&#41;SSAS](../directquery-deployment-scenarios-ssas-tabular.md)  
