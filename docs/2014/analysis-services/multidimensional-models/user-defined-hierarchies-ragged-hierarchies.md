...
-   [Настройка совместимости многомерных выражений для определения того, как заполнители представлены в клиентских приложениях](#bkmk_Mdx)  
  
##  <a name="bkmk_approach"></a>Подходы к изменению навигации углубленной детализации в неоднородной иерархии  
...
##  <a name="bkmk_Hide"></a>Установка HideMemberIf для скрытия элементов в обычной иерархии  
...
2.  Щелкните правой кнопкой мыши элемент в иерархии и выберите **Свойства**. Установите свойство `HideMemberIf` в одно из описанных далее значений.  
    ...
    |**онличилдвиснонаме**|Элемент уровня скрывается, только когда он является единственным дочерним элементом и его имя не задано (значение NULL или пустая строка).|  
    |**онличилдвиспарентнаме**|Элемент уровня скрывается, только когда он является единственным дочерним элементом и его имя совпадает с именем родительского элемента.|  
    |**Имя неименованного**|Элемент уровня скрывается, если его имя пустое.|  
    |**ParentName**|Элемент уровня скрывается, если его имя совпадает с именем родительского элемента.|  
  
##  <a name="bkmk_Mdx"></a>Настройка совместимости многомерных выражений для определения того, как заполнители представлены в клиентских приложениях  
...
## <a name="see-also"></a>См. также:  
 ...
 [Свойства строки подключения &#40;Analysis Services&#41;](https://docs.microsoft.com/analysis-services/instances/connection-string-properties-analysis-services)  
