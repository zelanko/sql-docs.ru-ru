...
### <a name="query-1-differences-in-income-and-expenses"></a>Запрос 1 — разница в доходах и расходах  
...
### <a name="query-2-percentage-of-income-after-expenses"></a>Запрос 2 — процент чистой прибыли  
...
### <a name="query-3-combined-year-difference-and-net-income-calculations"></a>Разность за год на сочетании 3 и чистой прибыли запросов  
...
## <a name="see-also"></a>См. также  
 [CalculationCurrentPass (многомерные выражения)](/sql/mdx/calculationcurrentpass-mdx)   
 [CalculationPassValue (многомерные выражения)](/sql/mdx/calculationpassvalue-mdx)   
