...
> [!NOTE]  
>  Дополнительные сведения о проблемах производительности, связанных с запросами и вычислениями MDX см в разделе «Написание эффективных многомерных Выражений» [2005 Analysis Services производительности руководство по SQL Server](https://docsbay.net/Microsoft-SQL-Server-2005-Analysis-Services-Performance-Guide).  
...
|[Ограничение запроса с помощью осей запроса и среза &#40;многомерных Выражений&#41;](mdx-query-and-slicer-axes-restricting-the-query.md)|Основные сведения об осях запроса и среза и о том, как их указывать.|  
