...
|**В**|Вывод даты в формате **ддддд** и времени в формате **ввввв**именно в этом порядке.<br /><br /> Если в числе даты нет дробной части, выводятся только сведения о дате. Если в числе даты нет целой части, выводятся только сведения о времени.|  
...
|**НН**|Отображает секунды в виде числа с нулями в начале (00-59).|  
