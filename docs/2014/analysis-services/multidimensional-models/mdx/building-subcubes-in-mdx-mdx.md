...
-   Вложенный куб всегда содержит все элементы `(All)` из данного куба.  
 ...
 Кроме того, явные ссылки на ячейки вне вложенного куба возвращают значения ячеек, вычисленные в контексте всего куба. Пусть создан вложенный куб, ограниченный текущим годом. После этого можно при помощи функции [ParallelPeriod](/sql/mdx/parallelperiod-mdx) сравнить текущий год с предыдущим. Разница в значениях будет возвращена, даже если значение предыдущего года находится за пределами вложенного куба.  
