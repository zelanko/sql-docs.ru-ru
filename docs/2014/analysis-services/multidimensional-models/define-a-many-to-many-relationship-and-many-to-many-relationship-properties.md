...
-   В Adventure Works многие клиенты имеют несколько причин для заказа товара, а причина покупки может быть связана с несколькими заказами.  
 ...
 ![Многие ко многим значок в окне использования измерений](../media/ssas-m2m-icondimusage.png "многие ко многим значок в окне использования измерений")  
 ...
 ![Определить связь кнопки в окне использования измерений](../media/ssas-m2m-btndimusage.png "кнопку Задание связи в окне использования измерений")  
...
2.  Создайте новое измерение на основе существующей таблицы **DimSalesReason**. При указании источника примите все значения по умолчанию.  
     ...
     ![Список атрибутов в новом измерении](../media/ssas-m2m-dimsalesreason.PNG "список атрибутов в новое измерение")  
...
5.  На следующей странице мастера выберите атрибуты. В данном примере можно выбрать только **SalesOrderNumber**.  
     ...
     ![Список атрибутов отображение измерение заказа на продажу](../media/ssas-m2m-dimsalesorderattrib.PNG "атрибут Отображение списка для Sales order измерения")  
  
6.  Переименуйте измерение в **Dim Sales Orders**, придерживаясь согласованного порядка именования измерений.  
  
     ![Страница мастера, отображающая Переименование измерения](../media/ssas-m2m-dimsalesorders.PNG "страницы мастера, отображающая Переименование измерения")  
...
4.  Проанализируйте результаты. Мы используем примеры данных, поэтому на первый взгляд кажется, что все заказы на продажу имеют одинаковые значения. Но если выполнить прокрутку результатов вниз, то можно видеть разброс данных.  
     ...
     ![Лист Excel с агрегаты многие ко многим](../media/ssas-m2m-excel.png "лист Excel с многие ко многим агрегатов")  
...
5.  Выполните прокрутку до нижней части листа. Теперь хорошо видно, что Price (Цена) является самой важной причиной для покупок клиентов по сравнению с другими причинами и общей суммой.  
     ...
     ![Книга Excel, отображение итогов в многие ко многим](../media/ssas-m2m-excelgrandtotal.png "книги Excel, отображение итогов в многие ко многим")  
...
##  <a name="bkmk_Learn"></a> Learn more  
 ...
 [Как определить многие ко многим измерения в службах Analysis Services](../lesson-5-3-defining-a-many-to-many-relationship.md)  
