---
title: Регистрация сборки базы данных-диалоговое окно (службы Analysis Services — многомерные данные) | Документы Microsoft
ms.custom: ''
ms.date: 06/13/2017
...
|Термин|Определение|  
|----------|----------------|  
|**Тип**|Выбирает тип ссылки на сборку. Доступны следующие значения:<br /><br /> **Сборка .NET** <br />                      Ссылка указывает на сборку [!INCLUDE[msCoName](../includes/msconame-md.md)] .NET Framework.<br /><br /> **COM DLL** <br />                      Ссылка на сборку указывает на библиотеку COM.<br /><br /> <br /><br /> **\*\* Примечание по безопасности \* \***  сборок COM может представлять угрозу безопасности. По этой причине, а также по ряду других сборки COM в службах [!INCLUDE[ssASversion10](../includes/ssasversion10-md.md)]являются устаревшими. Поддержка сборок COM в последующих версиях может быть прекращена.|  
