...
###  <a name="sort-order-options"></a><a name="bkmk_sortorder"></a> Параметры порядка сортировки  
...
##  <a name="change-the-default-language-or-collation-on-the-instance"></a><a name="bkmk_defaultLang"></a> Изменение языка по умолчанию и параметров сортировки для экземпляра  
...
1.  В Management Studio щелкните правой кнопкой мыши имя сервера | **Properties** | **Язык и параметры сортировки**свойств.  
