...
-   Заново обработайте разделы и измерения после обновления параметров сортировки.  
 ...
 Чтобы изменить язык по умолчанию или параметры сортировки на уровне сервера, можно использовать SQL Server Management Studio или AMO PowerShell. Кроме того, можно изменить **\<Language>** Параметры и **\<CollationName>** в файле msmdsrv.ini, указав код языка.  
