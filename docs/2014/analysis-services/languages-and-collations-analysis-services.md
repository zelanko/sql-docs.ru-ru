...
# <a name="languages-and-collations-analysis-services"></a>Языки и параметры сортировки (службы Analysis Services)
  [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)]поддерживает языки и параметры сортировки, [!INCLUDE[msCoName](../includes/msconame-md.md)] предоставляемые операционными системами Windows. Свойства `Language` и `Collation` изначально устанавливаются на уровне экземпляра во время установки, но их можно изменить позднее на разных уровнях иерархии объектов.  
...
-   [Объекты, поддерживающие свойства Language и Collation](#bkmk_object)  
  
-   [Поддержка языков в Analysis Services](#bkmk_lang)  
  
-   [Поддержка параметров сортировки в Analysis Services](#bkmk_collations)  
  
-   [Изменение языка или параметров сортировки по умолчанию для экземпляра](#bkmk_defaultLang)  
...
##  <a name="bkmk_object"></a>Объекты, поддерживающие свойства Language и Collation  
 `Language`свойства `Collation` и часто предоставляются вместе `Language`, а также можно задать `Collation`.  
...
###  <a name="bkmk_lcid"></a>Значение свойства Language — это код локали (LCID)  
...
##  <a name="bkmk_collations"></a>Поддержка параметров сортировки в Analysis Services  
 ...
 Параметры сортировки управляют учетом регистра для всех строк в языках, где различаются заглавные и строчные буквы, кроме идентификаторов объектов. При использовании символов верхнего и нижнего регистра символов в идентификаторе объекта помните, что учет регистра в идентификаторах объектов зависит не от параметров сортировки, а от [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)]. Для идентификаторов объектов на английском языке в идентификаторах объектов не учитывается регистр (независимо от параметров сортировки). В языках с кириллическим письмом и в других языках, где различаются строчные и прописные буквы, все наоборот: регистр всегда учитывается. Дополнительные сведения см. в разделе [Globalization Tips and Best Practices &#40;Analysis Services&#41;](globalization-tips-and-best-practices-analysis-services.md) .  
...
##  <a name="bkmk_defaultLang"></a>Изменение языка или параметров сортировки по умолчанию для экземпляра  
...
1.  В Management Studio щелкните правой кнопкой мыши имя сервера | **** | **Язык и параметры сортировки**свойств.  
...
##  <a name="bkmk_cube"></a>Изменение языка или параметров сортировки в Кубе  
...
##  <a name="bkmk_XMLA"></a>Изменение языка и параметров сортировки в модели данных с помощью XMLA  
...
1.  В Management Studio щелкните правой кнопкой мыши базу данных | Создать **скрипт для базы данных как** | **ALTER в** | **новое окно редактора запросов**.  
...
##  <a name="bkmk_enablefast1033"></a>Повышение производительности для английских языковых стандартов через EnableFast1033Locale  
