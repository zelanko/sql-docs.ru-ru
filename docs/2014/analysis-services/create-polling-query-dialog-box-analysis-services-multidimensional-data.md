...
|**Показать/скрыть панель диаграмм**|Показывает или скрывает **Панель диаграмм**.<br /><br /> Примечание. Этот параметр отображается только в том случае, если **переключиться в построитель VDT-запросов** выбран.|  
