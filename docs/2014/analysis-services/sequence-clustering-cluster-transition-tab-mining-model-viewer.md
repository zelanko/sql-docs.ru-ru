 ...
 **Совет.** Можно переименовать кластеры с помощью **Диаграмма кластеров** вкладки. Просто выберите кластер, щелкните его правой кнопкой мыши и выберите команду **Переименовать**. Благодаря переименованию кластеров с назначением более описательных меток упрощается сравнение кластеров на вкладке **Переходы состояния** .  
