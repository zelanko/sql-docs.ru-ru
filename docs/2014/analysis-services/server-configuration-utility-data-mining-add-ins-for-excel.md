...
##  <a name="bkmk_step1"></a>Шаг 1. подключение к Analysis Services  
...
##  <a name="bkmk_step2"></a>Шаг 2. Разрешение временных моделей  
...
##  <a name="bkmk_step4"></a>Шаг 4. предоставление пользователям соответствующих разрешений на доступ к надстройкам  
