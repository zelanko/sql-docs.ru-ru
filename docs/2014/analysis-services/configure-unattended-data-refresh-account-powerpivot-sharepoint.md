 ...
 **[!INCLUDE[applies](../includes/applies-md.md)]**  SharePoint 2010  
 ...
 [Шаг 3: Предоставление разрешения «участие» учетной записи](#bkmk_grant)  
  
 [Шаг 4: Предоставление разрешения на чтение для доступа к внешним источникам данных при обновлении данных](#bkmk_dbread)  
  
 [Шаг 5: Проверка доступности учетной записи в данных обновите страницы настройки](#bkmk_verify)  
...
###  <a name="bkmk_grant"></a> Шаг 3: Предоставление разрешения «участие» учетной записи  
