...
##  <a name="bkmk_features"></a> Средства для создания глобализованного многомерного решения  
 ...
 На уровне клиента Глобализованные приложения, которые используют или управлять [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] многомерных данных можно использовать многоязыковые и интернациональные возможности служб в [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)]:  
