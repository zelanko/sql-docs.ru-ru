---
title: Интеллектуального анализа данных модели представления (конструктор моделей интеллектуального анализа данных) | Документация Майкрософт
ms.custom: ''
ms.date: 06/13/2017
...
# <a name="mining-models-view-data-mining-model-designer"></a>Представление модели интеллектуального анализа данных (конструктор моделей интеллектуального анализа данных)
 ...
 Представление **Модели интеллектуального анализа данных** имеет следующие инструменты и диалоговые окна:  
  
-   [Диалоговое окно «Параметры алгоритма» &#40;представления модели интеллектуального анализа данных&#41;](algorithm-parameters-dialog-box-mining-models-view.md)  
