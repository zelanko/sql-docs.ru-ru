...
2.  В конструкторе моделей щелкните правой кнопкой мыши `Product` таблицу и выберите команду **создать иерархию**. В нижней части окна таблицы появится новая иерархия.  
