...
##  <a name="bkmk_services"></a> Шаг 1. Включение службы Secure Store и создание главного ключа  
...
##  <a name="bkmk_creds"></a> Шаг 2. Отключение параметров учетных данных, поддержка которых не нужна  
...
##  <a name="bkmk_stored"></a> Шаг 3. Создание целевых приложений для сохранения учетных данных, используемых при обновлении данных  
...
##  <a name="bkmk_upgradewrkbk"></a> Шаг 7. Включение обновления данных книги  
