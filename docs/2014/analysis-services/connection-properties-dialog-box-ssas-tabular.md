...
|**УДОСТОВЕРЕНИЯ**|Позволяет отобразить идентификатор объекта источника данных.|  
...
|**Isolation**|Допустимые значения — ReadCommitted или Snapshot. Дополнительные сведения см. в разделе [Элемент Isolation (ASSL)](https://docs.microsoft.com/bi-reference/assl/properties/isolation-element-assl).|  
