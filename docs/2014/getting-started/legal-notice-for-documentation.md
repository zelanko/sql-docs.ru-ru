...
ms.locfileid: "82706923"
---
# <a name="legal-notice-for-documentation"></a>Юридическое уведомление для документации
  Данный документ предоставляется «как есть». Сведения и мнения, содержащиеся в данном документе, включая URL-адреса и другие ссылки на веб-сайты в Интернете, могут быть изменены без уведомления. Вы принимаете на себя риски их использования.  
