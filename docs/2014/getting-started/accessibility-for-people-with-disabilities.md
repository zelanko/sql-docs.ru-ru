...
## <a name="ssnoversion-accessibility-features"></a>Специальные возможности [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]  
...
## <a name="accessibility-in-msconame-windows"></a>Специальные возможности в [!INCLUDE[msCoName](../includes/msconame-md.md)] Windows  
...
## <a name="adjusting-msconame-products-for-people-with-accessibility-needs"></a>Настройка продуктов корпорации [!INCLUDE[msCoName](../includes/msconame-md.md)] для людей, нуждающихся в специальных возможностях  
...
## <a name="msconame-documentation-in-alternative-formats"></a>Документация корпорации [!INCLUDE[msCoName](../includes/msconame-md.md)] в альтернативных форматах  
...
### <a name="obtaining-documentation-for-ssnoversion"></a>Получение документации по [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]  
...
## <a name="obtaining-documentation-for-additional-msconame-products"></a>Получение документации по дополнительным продуктам [!INCLUDE[msCoName](../includes/msconame-md.md)]  
