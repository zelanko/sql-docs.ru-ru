...
# <a name="about-the-sql-server-license-terms"></a>Об условиях лицензионного соглашения SQL Server
 ...
 В имени файла лицензионного соглашения указывается установленный выпуск [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] и языковой выпуск [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]. Имя файла лицензионного соглашения имеет формат: SQLServer2014_License_Edition_\<тип > _\<LCID > .rtf. Например:  
