...
##  <a name="ErrorTypes"></a>Типы ошибок, вызывающие попытки автоматического восстановления страниц  
...
##  <a name="UnrepairablePageTypes"></a>Типы страниц, которые не удается восстановить автоматически  
...
##  <a name="PrimaryIOErrors"></a>Обработка ошибок ввода-вывода в основной или основной базе данных  
...
##  <a name="SecondaryIOErrors"></a>Обработка ошибок ввода-вывода в зеркальной базе данных-получателе  
...
##  <a name="DevBP"></a>Рекомендации для разработчиков  
...
##  <a name="ViewAPRattempts"></a>Пошаговое руководство. Просмотр попыток автоматического восстановления страниц  
