...
-   **Принудительный запуск кластера без кворума с помощью:**  [Использование Диспетчер отказоустойчивости кластеров](#FailoverClusterManagerProcedure)с помощью [PowerShell](#PowerShellProcedure)с [помощью net. exe](#CommandPromptProcedure)  
...
##  <a name="FailoverClusterManagerProcedure"></a>Использование диспетчер отказоустойчивости кластеров  
...
-   Необходимо повторно оценить и настроить значения параметров NodeWeight для правильного построения нового кворума, прежде чем переключать другие узлы обратно в режим «в сети». В противном случае кластер может снова вернуться в режим «вне сети».  
     ...
     Дополнительные сведения см. в статье [Режимы кворума и конфигурация голосования WSFC (SQL Server)](wsfc-quorum-modes-and-voting-configuration-sql-server.md).  
...
-   [Командлет Get-ClusterLog для отказоустойчивого кластера](https://technet.microsoft.com/library/ee461045.aspx)  
...
## <a name="see-also"></a>См. также:  
 ...
 [Командлеты отказоустойчивого кластера в Windows PowerShell, перечисленные в фокусе задач](https://technet.microsoft.com/library/ee619761\(WS.10\).aspx)  
