...
-   **Для просмотра параметров NodeWeight кворума с помощью:** [С помощью Powershell](#PowerShellProcedure), [использование Cluster.exe](#CommandPromptProcedure)  
