 ...
 **Параметр1: Установка интеграции с добавлением узла**  
 ...
 **Вариант 2. Расширенная или Корпоративная установка**  
...
-   [SQL Server кластеризации с несколькими подсетями &#40;SQL Server&#41;](../windows/sql-server-multi-subnet-clustering-sql-server.md)  
...
10. 
  [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] запустит еще один набор правил, который будет определен, исходя из выбранных компонентов, для оценки конфигурации компьютера.  
  
11. На странице «Конфигурация экземпляра» укажите способ установки: как экземпляр по умолчанию или как именованный экземпляр. Дополнительные сведения см. в разделе [Конфигурация экземпляра](../../install/instance-configuration.md).  
  
     Сетевое имя — укажите сетевое имя для нового [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] отказоустойчивого кластера. ** [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] ** Это имя используется для идентификации отказоустойчивого кластера в сети.  
...
18. Используйте вкладку **Конфигурация сервера — параметры сортировки** , чтобы задать параметры сортировки, [!INCLUDE[ssDE](../../../includes/ssde-md.md)] не используемые по умолчанию для и. [!INCLUDE[ssASnoversion](../../../includes/ssasnoversion-md.md)] Дополнительные сведения см. в разделе [Настройка сервера — параметры сортировки](../../install/server-configuration-collation.md).  
