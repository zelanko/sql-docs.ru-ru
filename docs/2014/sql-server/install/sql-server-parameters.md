---
title: Параметры SQL Server | Документы Microsoft
ms.custom: ''
ms.date: 03/06/2017
 ...
 **Путь к файлам трассировки**  
 ...
 При включении **анализировать файлы трассировки**, **Далее** отключена, пока не будет введено имя пути и имени файла.  
  
 **Анализ [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] пакета файлов**  
 Установите этот флажок, чтобы выполнить анализ пакетных файлов [!INCLUDE[tsql](../../includes/tsql-md.md)] в файловой системе.  
  
 **Путь к [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] пакета файлов**  
 ...
 При включении **анализировать пакетные файлы SQL**, **Далее** кнопка становится недоступной, пока не будет введено имя пути и имени файла.  
