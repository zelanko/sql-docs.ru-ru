...
7.  В поле имя сервера введите **\<имя сервера > \PowerPivot**, где **\<Server-name >** — это имя компьютера, на котором установлена установка PowerPivot для SharePoint.  
