...
7.  В поле имя сервера введите **\<server-name > \PowerPivot**, где **\<server-name >** — это имя компьютера, на котором установлена установка PowerPivot для SharePoint.  
