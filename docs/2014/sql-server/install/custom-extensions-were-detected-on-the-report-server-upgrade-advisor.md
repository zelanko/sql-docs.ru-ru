---
title: Пользовательские модули найдены на сервере отчетов (Советник по переходу) | Документы Microsoft
ms.custom: ''
ms.date: 03/06/2017
...
## <a name="description"></a>Описание  
 [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] предоставляет расширяемую архитектуру, которая позволяет разработчикам создавать пользовательские модули обработки данных, доставки, подготовки к просмотру, безопасности и проверки подлинности.  
...
## <a name="corrective-action"></a>Действие по исправлению  
 ...
 [Настраиваемая обработка данных и модули доставки](#dataprocdeliver)  
...
3.  перестройте решение, чтобы привязать модуль.  
 ...
 Если принято решение не продолжать обновление, вместо этого можно предпринять миграцию на службы [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]. Инструкции по миграции пользовательских модулей см. в разделе [Миграция пользовательских модулей](#migrcustext) в этом разделе.  
  
###  <a name="dataprocdeliver"></a> Настраиваемая обработка данных и модули доставки  
...
##### <a name="to-upgrade-custom-security-or-authentication-extensions-from-a-sql-server-2000-report-server"></a>Чтобы обновить пользовательские модули безопасности или проверки подлинности на сервере отчетов SQL Server 2000  
