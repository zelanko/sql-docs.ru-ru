...
-   Значение*nnn.nnn.nnn.nnn* — адрес IPv4 платы сетевого адаптера компьютера. Если в вашей сети используется адресация IPv6, IP-адрес будет 128-битным значением 8 4-Byte, аналогичным следующему формату: \<заголовок >:*nnnn: nnnn: nnnn: nnnn*  
