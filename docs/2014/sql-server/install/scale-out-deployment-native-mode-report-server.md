 ...
 **Удалить**  
 ...
 Если зашифрованные данные больше не нужны или если нет резервной копии ключа, то зашифрованные данные необходимо удалить. Дополнительные сведения см. в разделе [ключи &#40;шифрования службы SSRS&#41;в собственном режиме](../../../2014/sql-server/install/encryption-keys-ssrs-native-mode.md).  
