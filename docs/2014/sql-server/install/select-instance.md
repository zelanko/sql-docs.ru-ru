---
title: Выберите экземпляр | Документы Microsoft
ms.custom: ''
ms.date: 06/13/2017
...
## <a name="see-also"></a>См. также  
 [Использование помощника по обновлению для подготовки обновлений](../../../2014/sql-server/install/use-upgrade-advisor-to-prepare-for-upgrades.md)   
