---
title: 'Контрольный список по развертыванию: Масштабное развертывание путем добавления серверов PowerPivot в ферме SharePoint 2010 | Документация Майкрософт'
ms.custom: ''
ms.date: 06/13/2017
...
ms.locfileid: "52517819"
---
# <a name="deployment-checklist-scale-out-by-adding-powerpivot-servers-to-a-sharepoint-2010-farm"></a>Контрольный список по развертыванию: Масштабное развертывание путем добавления серверов PowerPivot в ферму SharePoint 2010
...
|Настройте второй экземпляр|Можно настроить экземпляр с помощью [Средства настройки PowerPivot](../../analysis-services/power-pivot-sharepoint/power-pivot-configuration-tools.md) или [Настройка PowerPivot с помощью Windows PowerShell](../../analysis-services/power-pivot-sharepoint/power-pivot-configuration-using-windows-powershell.md)<br /><br /> При настройке второго экземпляра необходимо указывать только локальные службы. Все остальные задачи настройки (создание приложений службы, настройка обновления данных и т. д.) выполняются во время первоначальной настройки и используются всеми последующими устанавливаемыми экземплярами.|  
