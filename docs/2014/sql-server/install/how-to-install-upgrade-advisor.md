---
title: Практическое руководство. Установить помощник по обновлению | Документация Майкрософт
ms.custom: ''
ms.date: 03/06/2017
...
---
# <a name="how-to-install-upgrade-advisor"></a>Практическое руководство. Установка помощника по обновлению
