...
## <a name="restore-encryption-key-dialog"></a>Диалоговое окно «Восстановление ключа шифрования»  
 Сведения о том, где найти Configuration Manager [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)], см. [в &#40;Диспетчер конфигурации служб Reporting Services основном&#41;режиме](../../../2014/sql-server/install/reporting-services-configuration-manager-native-mode.md).  
