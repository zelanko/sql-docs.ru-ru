...
> [!NOTE]  
>  Имена входа, подготовленные в качестве членов предопределенной роли сервера **sysadmin** во время установки, подготавливаются как администраторы в базе данных шаблонов. Они являются членами предопределенной роли сервера **sysadmin** на пользовательском экземпляре, если не удалены  
