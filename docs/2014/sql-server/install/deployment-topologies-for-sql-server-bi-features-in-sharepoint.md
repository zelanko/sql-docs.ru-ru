---
title: Развертывание Topologies для функций сервера S'L в SharePoint (ru) Документы Майкрософт
ms.custom: ''
ms.date: 03/06/2017
...
##  <a name="sharepoint-2013-example-deployment-topologies"></a><a name="bkmk_example_deployments_2013"></a>SharePoint 2013 Пример развертывания Topologies  
 ...
 Режим SharePoint требует сервера SharePoint 2013 и использует архитектуру приложения SharePoint. ** [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] **  
  
 В следующих разделах приведены типичные топологии развертывания:  
  
###  <a name="powerpivot-for-sharepoint-2013-and-reporting-services-three-server-deployment"></a><a name="bkmk_bi_Sharepoint2013_3tier"></a>PowerPivot для SharePoint 2013 и отчетных служб Три сервера развертывания  
...
|**(2)**|[!INCLUDE[ssGemini](../../includes/ssgemini-md.md)]Сервисное приложение. Имя по умолчанию — **Приложение службы PowerPivot по умолчанию**.|  
...
|**(5)**|Запустите **spPowerPivot.msi** для установки [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] поставщиков [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] данных, инструмента конфигурации, галереи и обновления расписания данных.|  
...
|**(7)**|Базы данных содержимого SharePoint, конфигурации и приложений службы.|  
 ...
 ![Настройки SharePoint](../../analysis-services/media/as-sharepoint2013-settings-gear.gif "Параметры SharePoint") [Отправить обратную связь и контактную информацию через Microsoft S'L Server Connect](https://connect.microsoft.com/SQLServer/Feedback) ( .https://connect.microsoft.com/SQLServer/Feedback)  
  
###  <a name="powerpivot-for-sharepoint-2013-single-server-deployment"></a><a name="bkmk_powerpivot_sharepoint2013_1server"></a>PowerPivot для развертывания одного сервера SharePoint 2013  
...
###  <a name="powerpivot-for-sharepoint-2013-two-server-deployment"></a><a name="bkmk_powerpivot_sharepoint2013_2server"></a>PowerPivot для SharePoint 2013 Два сервера развертывания  
 ...
 [!INCLUDE[ssGeminiShortvnext](../../includes/ssgeminishortvnext-md.md)]расширяет SharePoint Server 2013, чтобы добавить обработку обновлений данных на стороне сервера, поставщиков данных, [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] галерею и поддержку управления [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] для трудовых книжек и рабочих книг Excel с расширенными моделями данных.  
  
 Пакет установщика доступен в составе пакета дополнительных компонентов [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] . Пакет функций можно загрузить [!INCLUDE[msCoName](../../includes/msconame-md.md)] из центра загрузки в [Microsoft® S'L Server® 2014 PowerPivot® для Microsoft® SharePoint®](https://go.microsoft.com/fwlink/?LinkID=296473) ( HYPERLINK "<https://go.microsoft.com/fwlink/?LinkID=296473>_blank "). <https://go.microsoft.com/fwlink/?LinkID=296473>  
...
###  <a name="powerpivot-for-sharepoint-2013-three-server-deployment"></a><a name="bkmk_powerpivot_sharepoint2013_3server"></a>PowerPivot для SharePoint 2013 Три сервера развертывания  
...
###  <a name="powerpivot-for-sharepoint-2013-and-reporting-services-single-server-deployment"></a><a name="bkmk_powerpivot_ssrs_sharepoint2013_1server"></a>PowerPivot для развертывания SharePoint 2013 и отчетности на одном сервере  
 Развертывание одиночного сервера полезно для тестирования, но не рекомендуется для производственных целей.  
  
 ![SSAS и SSRS SharePoint режим 1 Развертывание сервера](../../../2014/sql-server/install/media/as-and-rs-1server-deployment.gif "SSAS и SSRS SharePoint режим 1 Развертывание сервера")  
...
###  <a name="powerpivot-for-sharepoint-2013-and-reporting-services-two-server-deployment"></a><a name="bkmk_powerpivot_ssrs_sharepoint2013_2server"></a>PowerPivot для SharePoint 2013 и отчетных служб Два сервера развертывания  
 В следующем двухсерверном развертывании ядро СУБД SQL Server и сервер Analysis Services в режиме интеграции с SharePoint работают на сервере, отдельном от SharePoint. Пакет установки PowerPivot для SharePoint 2013 **(spPowerPivot.msi)** должен быть запущен на сервере SharePoint.  
...
##  <a name="sharepoint-2010-example-deployment-topologies"></a><a name="bkmk_example_deployments_2010"></a>SharePoint 2010 Пример развертывания Topologies  
...
##  <a name="single-server-deployments"></a><a name="bkmk_sharepoint2010_1server"></a>Развертывание одного сервера  
 ...
 Чтобы установить все компоненты на одиночный сервер, последовательно установите службы [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] и [!INCLUDE[ssGeminiShort](../../includes/ssgeminishort-md.md)] на один и тот же физический сервер. Для получения инструкций по конфигурации отдельного сервера см. [Контрольный список развертывания: Службы отчетности, Power View и PowerPivot для SharePoint.](deployment-checklist-reporting-services-power-view-power-pivot-for-sharepoint.md)  
  
##  <a name="two-tier-deployment"></a><a name="bkmk_sharepoint2010_2server"></a>Двухуровневое развертывание  
...
##  <a name="three-tier-deployment"></a><a name="bkmk_sharepoint2010_3server"></a>Трехуровневое развертывание  
...
##  <a name="three-tier-scale-out-deployment"></a><a name="bkmk_sharepoint2010_scaleserver"></a>Трехуровневое развертывание масштаба  
...
## <a name="see-also"></a>См. также:  
 ...
 [PowerPivot для установки SharePoint 2013](https://docs.microsoft.com/analysis-services/instances/install-windows/install-analysis-services-in-power-pivot-mode)   
