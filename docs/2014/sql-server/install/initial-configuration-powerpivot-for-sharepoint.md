...
##  <a name="bkmk_redist"></a>Шаг 9. Установка версии SQL Server 2008 R2 поставщика OLE DB на экземпляре SQL Server 2012 PowerPivot для SharePoint  
 ...
 Поставщик можно загрузить со [страницы пакета дополнительных компонентов SQL Server 2008 R2](https://go.microsoft.com/fwlink/?LinkId=159570). Найдите **Microsoft® поставщик Analysis Services OLE DB для Microsoft® SQL Server® 2008 R2**, а затем скачайте пакет `SQLServer2008_ASOLEDB10.msi` x64 программы установки.  
...
6.  В поле имя сервера введите  **\<имя сервера > \PowerPivot**, где  **\<Server-name >** — это имя компьютера, на котором установлена PowerPivot для SharePointная установка.  
