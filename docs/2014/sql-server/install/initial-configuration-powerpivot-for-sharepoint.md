...
##  <a name="Geneva"></a> Шаг 2. Запуск служб на сервере  
 Для развертывания PowerPivot для SharePoint необходимо, чтобы ферма содержала следующие службы: службы вычислений Excel, службу Secure Store и службу Claims to Windows Token Service.  
...
> [!IMPORTANT]  
>  Если служба безопасного хранилища включена, следует проверить, что для нее создан главный ключ. Инструкции см. в части 2: «создание главного ключа» в следующей процедуре.  
...
##### <a name="part-1-enable-secure-store-service"></a>Часть 1. Включение службы Secure Store  
...
##  <a name="bkmk_redist"></a> Шаг 9. Установка поставщика OLE DB версии SQL Server 2008 R2 на экземпляре SQL Server 2012 PowerPivot для SharePoint  
