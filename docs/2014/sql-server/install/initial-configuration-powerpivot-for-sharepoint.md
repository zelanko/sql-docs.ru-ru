...
##  <a name="bkmk_redist"></a> Шаг 9: Установка SQL Server 2008 R2 версии поставщика OLE DB на SQL Server 2012 PowerPivot для экземпляра SharePoint  
 ...
 Вы можете скачать поставщик из [страницы пакета дополнительных компонентов SQL Server 2008 R2](http://go.microsoft.com/fwlink/?LinkId=159570). Найдите **поставщик Microsoft® Analysis Services OLE DB для Microsoft® SQL Server® 2008 R2**, а затем загрузите x64 пакет `SQLServer2008_ASOLEDB10.msi` программы установки.  
