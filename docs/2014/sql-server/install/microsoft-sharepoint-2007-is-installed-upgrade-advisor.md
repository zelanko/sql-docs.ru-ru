...
## <a name="description"></a>Описание  
 [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] не будет обновлена или установлены на SharePoint 2007. Обновление заблокировано.  
...
## <a name="corrective-action"></a>Действие по исправлению  
 ...
 Прямое обновление с SharePoint 2007 до SharePoint 2013 невозможно. но вы можете сделать называется как база данных «двойное подключение» присоединения для обновления с Office SharePoint Server 2007 до SharePoint Server 2010, а затем с SharePoint Server 2010 до SharePoint Server 2013.  
