---
title: Расширенная настройка нескольких веб-сайта (собственный режим SSRS) | Документы Microsoft
ms.custom: ''
ms.date: 03/06/2017
...
# <a name="advanced-multiple-web-site-configuration-ssrs-native-mode"></a>Расширенная настройка нескольких веб-сайтов (службы Reporting Services в собственном режиме)
 ...
 Чтобы открыть **Расширенная настройка нескольких веб-сайт** диалоговое окно, нажмите кнопку **Дополнительно** на **URL веб-службы** или **URL-адрес диспетчера отчетов**страницы в [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] Configuration Manager. Когда диалоговое окно **Расширенная настройка нескольких веб-сайтов** открыто, задать новые URL-адреса или изменить или удалить существующие можно при помощи кнопок **Добавить** или **Изменить** .  
 ...
 **Порт**  
 Определяет порт, на котором сервер отчетов отслеживает запросы. По умолчанию используется порт 80. При использовании порта 80 не нужно указывать его в URL-адресе. При использовании любой другой номер порта, необходимо всегда включить его в URL-АДРЕСЕ (например, http://localhost:8181/reports).  
