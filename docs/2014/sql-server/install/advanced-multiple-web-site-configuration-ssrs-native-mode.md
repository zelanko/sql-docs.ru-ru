...
# <a name="advanced-multiple-web-site-configuration-ssrs-native-mode"></a>Расширенная настройка нескольких веб-сайтов (службы Reporting Services в собственном режиме)
 ...
 Чтобы открыть **Расширенная настройка нескольких веб-сайт** диалоговом окне щелкните **Дополнительно** на **URL веб-службы** или **URL-адрес диспетчера отчетов**странице в [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] Configuration Manager. Когда диалоговое окно **Расширенная настройка нескольких веб-сайтов** открыто, задать новые URL-адреса или изменить или удалить существующие можно при помощи кнопок **Добавить** или **Изменить** .  
