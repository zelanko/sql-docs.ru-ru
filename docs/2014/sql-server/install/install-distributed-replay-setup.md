...
4.  На странице **условия лицензии** прочтите лицензионное соглашение и установите флажок, чтобы принять условия лицензионного соглашения. Чтобы помочь в улучшении [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)], можно также включить параметр наблюдения за использованием компонентов и отправлять отчеты в [!INCLUDE[msCoName](../../includes/msconame-md.md)].  
...
6.  На странице **роль установки** выберите ** [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Установка компонентов**, а затем нажмите кнопку **Далее** , чтобы перейти на страницу **Выбор компонентов** .  
...
8.  При необходимости нажмите кнопку с многоточием (…), чтобы изменить путь к общей папке компонента.  
    ...
    1.  На 32-разрядных компьютерах путь установки по умолчанию — **C:\Program\\ [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Files** .  
  
    2.  На 64-разрядных компьютерах путь установки по умолчанию — **C:\Program Files (\\ [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] x86)**  
  
9. Завершив настройку, нажмите кнопку **Далее**.  
...
11. На странице **требования к месту на диске** вычисляется необходимое место на диске для указанных компонентов. Затем необходимое пространство сравнивается с доступным местом на диске.  
...
14. На странице **Все готово для установки программы** нажмите **Установить**.  
...
## <a name="see-also"></a>См. также  
 ...
 [SQL Server распределенное воспроизведение](../../tools/distributed-replay/sql-server-distributed-replay.md)   
 [Требования к распределенное воспроизведение](../../tools/sql-server-profiler/replay-requirements.md)   
 [Параметры командной строки средства администрирования &#40;распределенное воспроизведение служебной программы&#41;](../../tools/distributed-replay/administration-tool-command-line-options-distributed-replay-utility.md)   
