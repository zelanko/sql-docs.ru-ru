...
-   32-разрядные системы:  
     ...
     \<Share Feature Directory>\Tools \\ (предоставленный пользователем альтернативный каталог общих компонентов)  
...
-   64-разрядные системы:  
     ...
     \<Share Feature Directory (x86)>\Tools \\ (предоставленный пользователем альтернативный каталог общих компонентов (x86))  
