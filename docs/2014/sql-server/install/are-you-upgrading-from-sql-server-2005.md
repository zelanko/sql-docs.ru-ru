...
>  Расширенная поддержка SQL Server 2005 заканчивается 12 апреля 2016 г. Если SQL Server 2005 будет использоваться после 12 апреля 2016 г., вы больше не будете получать обновления для системы безопасности.  
 ...
 Чтобы получить лист данных об обновлении с SQL Server 2005 в формате PDF [щелкните здесь](https://info.microsoft.com/rs/157-GQE-382/images/EN-CNTNT-Infographic-UpgradeSQL2005Datasheet.pdf) (не на эскиз ниже).  
...
## <a name="get-sql-server-2014"></a>Получить SQL Server 2014  
 Чтобы загрузить пробную версию SQL Server 2014 [щелкните здесь](https://www.microsoft.com/en-us/evalcenter/evaluate-sql-server-2014).  
