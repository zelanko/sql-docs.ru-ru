---
title: Обновление в режиме SharePoint (SSRS) служб Reporting Services | Документация Майкрософт
ms.custom: ''
ms.date: 06/13/2017
...
## <a name="see-also"></a>См. также  
 [Просмотр и чтение файлов журналов программы установки SQL Server](http://technet.microsoft.com/library/ms143702\(v=sql.110\).aspx)   
