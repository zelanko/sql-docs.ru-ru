...
-   [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Программа установки  
 ...
 Для отключения отчетов программы улучшения качества программного обеспечения после завершения установки воспользуйтесь средством **[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]Служба отчетов об ошибках и использовании** в меню [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]**Средства настройки**.  
...
-   данные из памяти или файлов процесса, вызвавшего ошибку.  
 ...
 Чтобы отключить отчеты об ошибках или использовании возможностей для всех экземпляров [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] и его компонентов после завершения установки, перейдите в диалоговое окно **Настройки параметров отчета об ошибках и использовании** и снимите флажки для пункта **Использование возможностей**. Если функция **Отчет об ошибках** включена для нескольких компонентов [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] (компонент [!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)], службы [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)], [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] и общие компоненты), ее можно отключить для каждого экземпляра каждого из компонентов (включая общие компоненты, которые перечислены в разделе **Другие**).  
