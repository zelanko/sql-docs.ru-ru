...
|**[!INCLUDE[applies](../../includes/applies-md.md)]** SharePoint 2013 &#124; SharePoint 2010|  
 ...
 ![Примечание](../../../2014/reporting-services/media/rs-fyinote.png "note") . Заметки о текущем выпуске см. в разделе [заметки о выпуске SQL server 2014](https://go.microsoft.com/fwlink/?LinkID=296445).  
