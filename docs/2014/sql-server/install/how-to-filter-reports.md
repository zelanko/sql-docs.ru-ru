...
2.  В **фильтровать по** выберите тип проблемы для просмотра:  
    ...
    -   **Все проблемы при обновлении**. Отображаются все проблемы, связанные с обновлением до [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)].  
  
    -   **Перед обновлением проблемы**. Отображаются все проблемы, которые необходимо решить перед обновлением до [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)].  
  
    -   **Все проблемы при миграции**. Отображаются все проблемы, связанные с переносом данных или приложений на [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)].  
  
    -   **Решенные проблемы**. Отображаются все проблемы, помеченные как решенные.  
