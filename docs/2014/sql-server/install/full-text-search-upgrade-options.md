---
title: Параметры обновления компонент Full-Text Search | Документация Майкрософт
ms.custom: ''
ms.date: 06/13/2017
