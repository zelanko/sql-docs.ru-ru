...
9. Выберите **Указанные локальные порты**. Введите номера портов через запятую и нажмите кнопку **Далее**. В этом примере настраивается порт по умолчанию; Таким образом, введите `1433`.  
