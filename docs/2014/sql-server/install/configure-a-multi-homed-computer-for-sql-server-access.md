 ...
 **В этом примере выполняются следующие общие действия.**  
...
2.  В ** [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Configuration Manager**в области консоли разверните узел ** [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] конфигурация сети**, разверните узел **протоколы для \<имени экземпляра>**, а затем дважды щелкните **TCP/IP**.  
...
2.  Нажмите кнопку **Пуск**, **** выберите команду выполнить `wf.msc`, введите и нажмите кнопку **ОК**.  
...
5.  На левой панели щелкните Правила для **входящих подключений**.  
