...
|[Разрешение проблем при обновлении](../../../2014/sql-server/install/resolving-upgrade-issues.md)|Содержит описания и советы по исправлению выявляемых и невыявляемых проблем обновления версий.|  
