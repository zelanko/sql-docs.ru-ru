...
# <a name="maximum-capacity-specifications-for-sql-server"></a>Задание максимальной вместимости SQL Server
 ...
 [SQL Server ядро СУБД объекты](#Engine)  
  
 [служебная программа SQL Server объекты](#Utility)  
  
 [SQL Server объектов приложения уровня данных](#DAC)  
  
 [Репликация SQL Server объекты](#Replication)  
...
|[!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)][!INCLUDE[ssDE](../includes/ssde-md.md)] объект|Максимальные размеры и [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] числа (32-разрядные)|Максимальный размер или количество [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] (64-разрядная версия)|  
|---------------------------------------------------------|------------------------------------------------------------------|------------------------------------------------------------------|  
...
|Количество байт в строке<br /><br /> Примечание.<br />        
...
|Экземпляров на один компьютер|50 экземпляров на изолированном сервере для всех выпусков [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)].<br /><br /> [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]поддерживает 25 экземпляров в отказоустойчивом кластере при использовании общего диска кластера, так как параметр, используемый для установки [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] кластера, поддерживает 50 экземпляров в отказоустойчивом кластере. Если в качестве варианта хранения для вашей установки кластера выбран параметр хранилище файловые ресурсы SMB, см. раздел [требования к оборудованию и программному обеспечению для установки SQL Server 2014](install/hardware-and-software-requirements-for-installing-sql-server.md).|50 экземпляров на отдельном сервере.<br /><br /> 25 экземпляров в отказоустойчивом кластере при использовании общего диска кластера в качестве места хранения для кластерной установки. [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] поддерживает 50 экземпляров в отказоустойчивом кластере, если выбрать общие папки SMB в качестве места хранения для кластерной установки.|  
...
##  <a name="Utility"></a>[!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] Служебные объекты  
...
|
  [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] Объект программы|Максимальные размеры и [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] числа (32-разрядные)|Максимальный размер или количество [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] (64-разрядная версия)|  
|----------------------------------------------|------------------------------------------------------------------|------------------------------------------------------------------|  
...
##  <a name="DAC"></a>[!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] Объекты приложения уровня данных  
