...
|Длина строки, содержащей инструкции SQL (размер пакета)<br /><br /> Примечание: Размер сетевого пакета — это размер пакетов потока (TDS) табличных данных, используемый для обмена данными между приложениями и компонентом [!INCLUDE[ssDE](../includes/ssde-md.md)]. По умолчанию размер пакета равен 4 КБ, а его настройка осуществляется с помощью параметра конфигурации network packet size.|65 536 * размер сетевого пакета|65 536 * размер сетевого пакета|  
|Блокировок на соединение|Максимальное число блокировок на сервер|Максимальное число блокировок на сервер|  
|Блокировок на экземпляр [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]<br /><br /> Примечание: Это значение равно к статическим блокировкам. Количество динамических блокировок ограничивается только объемом памяти.|до 2 147 483 647|Ограничено только объемом памяти|  
...
|Таблиц на одну базу данных<br /><br /> Примечание: Объекты базы данных включает объекты, такие как таблицы, представления, хранимые процедуры, определяемые пользователем функции, триггеры, правила, значения по умолчанию и ограничения. Суммарное число всех объектов в базе данных не может превышать 2 147 483 647.|Ограничено числом объектов в базе данных|Ограничено числом объектов в базе данных|  
...
|Триггеров на таблицу<br /><br /> Примечание: Объекты базы данных включает объекты, такие как таблицы, представления, хранимые процедуры, определяемые пользователем функции, триггеры, правила, значения по умолчанию и ограничения. Суммарное число всех объектов в базе данных не может превышать 2 147 483 647.|Ограничено числом объектов в базе данных|Ограничено числом объектов в базе данных|  
